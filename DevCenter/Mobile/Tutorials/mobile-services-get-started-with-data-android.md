...
_The Android client library for Mobile Services is currently under development on [GitHub]. We welcome feedback on and contributions to this library._
...
1. Download the GetStartedWithData sample app from <a href="https://github.com/WindowsAzure/azure-mobile-services-pr/tree/docs/docSamples/GetStartedWithData">GitHub</a> and expand the files on your computer. 

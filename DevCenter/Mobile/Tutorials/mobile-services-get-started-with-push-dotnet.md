...
7. Navigate to the [My Apps dashboard] in Dev Center for Windows Store apps and click **Edit** on your app in the **My applications** list.

   ![][4] 

8. In the app settings, click **Advanced Features**. 

   ![][5]

9. In **Advanced Features**, click **Push notifications and Live Connect services info**.

   ![][6] 

10. In **Push notifications and Live Connect services info**, click **Autheticating your service**.

   ![][7]

11.  Make a note of the values of **Client secret** and **Package security identifier (SID)**. You must provide these values to Mobile Services to be able to use WNS.
...
12. Log on to the [Windows Azure Management Portal], click **Mobile Services**, and then click your app.
...
[4]: ../Media/mobile-services-select-win8-app.png

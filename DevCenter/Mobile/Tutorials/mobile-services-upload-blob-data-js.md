<properties linkid="develop-mobile-tutorials-upload-blob-data-js" urlDisplayName="Get Started with Push Notifications" pageTitle="Upload images to Windows Azure Storage by using Mobile Services" metaKeywords="" metaDescription="Learn how to use Mobile Services to upload images to Windows Azure Storage." metaCanonical="" disqusComments="0" umbracoNaviHide="1" />
...
<div class="dev-center-tutorial-selector"> 
	<a href="/en-us/develop/mobile/tutorials/upload-blob-data-dotnet" title="Windows Store C#">Windows Store C#</a>
    <a href="/en-us/develop/mobile/tutorials/upload-blob-data-js" title="Windows Store JavaScript" class="current">Windows Store JavaScript</a>
...
<!-- Images. -->
[1]: ../Media/mobile-add-storage-reference-js.png

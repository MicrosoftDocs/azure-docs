...
Mobile Services supports unique custom id string values. This allows applications to use custom values such as email addresses or usernames for the id column of a Mobile Services table. If a custom id value is not provided when inserting new records into a table, Mobile Services will generate a GUID for the id.
...
Here is an example using a GUID as a unique custom id.
...
[Optimistic Concurrency Tutorial]: http://www.windowsazure.com/en-us/develop/mobile/tutorials/optimistic-concurrent-data-dotnet/
...
<div class="dev-center-tutorial-selector sublanding"> 
	<a href="/en-us/develop/mobile/tutorials/handling-database-write-conflicts-dotnet" title="Windows Store C#" class="current">Windows Store C#</a>
    <a href="/en-us/develop/mobile/tutorials/handling-database-write-conflicts-wp8" title="Windows Phone">Windows Phone</a>
<!--
	<a href="/en-us/develop/mobile/tutorials/handling-database-write-conflicts-js" title="Windows Store JavaScript">Windows Store JavaScript</a>
	<a href="/en-us/develop/mobile/tutorials/handling-database-write-conflicts-html" title="HTML">HTML</a>
	<a href="/en-us/develop/mobile/tutorials/get-started-with-data-ios" title="iOS">iOS</a>
	<a href="/en-us/develop/mobile/tutorials/handling-database-write-conflicts-android" title="Android">Android</a>
-->
</div>	
...
[Get started with Mobile Services]: ./mobile-services-get-started-dotnet.md

...
To connect to the MySQL database that is running in Windows Azure Web Sites, you will need the connection information. To get MySQL connection information, follow these steps:

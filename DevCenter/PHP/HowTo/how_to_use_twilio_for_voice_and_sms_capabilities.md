...
2. Install the  Twilio library for PHP as a PEAR package. It can be installed wtih the following commands:
...
- **Note**: To troubleshoot SSL certificate valitation errors, see [http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html][ssl_validation] 

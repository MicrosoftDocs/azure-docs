...
* SendGrid in a Windows Azure Deployment: [How to Send Email Using SendGrid from Java in a Windows Azure Deployment](../howto/sendgrid-email-service-on-azure.md)

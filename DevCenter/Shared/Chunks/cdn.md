...
<h2 id="Step1"><span class="short-header">Create a storage account</span>Step 1: Create a storage account</h2>
...
<h2 id="Step2"><span class="short-header">Enable CDN</span>Step 2: Enable CDN on your storage account</h2>
...
<h2 id="Step3"><span class="short-header">Access CDN content</span>Step 3: Access your CDN content</h2> 

To access the content on the CDN, go to:

http://<*CDNNamespace*\>.vo.msecnd.net/<*myPublicContainer*\>/<*BlobName*\>

<h2 id="Step4"><span class="short-header">Delete CDN content</span>Step 4: Delete your CDN content</h2>

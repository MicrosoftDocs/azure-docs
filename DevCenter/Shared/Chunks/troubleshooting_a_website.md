...
If you are unsure of the location of your web site, open WebMatrix and right-click AzureWebDiag and select **Show in File Explorer**.
	...
	<div class="dev-callout-new">
		<strong>Note <span>Click to collapse</span></strong>
		<div class="dev-callout-content">
			<p>When an ASP.NET website running on Windows Azure is not configured to display application errors, a web page similar to the following is displayed if an application error occurs:</p> 
		</div>	
	</div>

...
Twilio is a telephony web-service API that lets you use your existing web languages and skills to build voice and SMS applications.

<h2 id="Features">Twilio Features</h2>
...
Information about Twilio pricing is available at [Twilio Pricing] [twilio_pricing].

<h2 id="API">Twilio API</h2>
...
<h2 id="SpecialOffer">Special Twilio Offer for Windows Azure Customers</h2>
For a Twilio special offer for Windows Azure customers, see [To be determined – the link doesn’t exist yet].

<h2 id="AccountID">Twilio Account ID and Authentication Token</h2>
...
<h2 id="VerifyPhoneNumbers">Verifying Phone Numbers</h2>

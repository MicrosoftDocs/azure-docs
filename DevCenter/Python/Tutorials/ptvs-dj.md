...
![New Python Project Templates](../Media/NewProject.png)

**Click OK** and you'll have created your first Django app.

![Visual Studio opened to your first Django project](../Media/FirstProject.png)
...
![Add app to settings.py in INSTALLED_APPS](../Media/InstallApp.png)

Next lets add some code to the app's view.py so that we can return a simple template file:

![Add app to settings.py in INSTALLED_APPS](../Media/FirstView.png)
...
![Add new item to Templates foder](../Media/AddFirstTemplate.png)

You can now select "Django HTML Template" from the template list and enter "index.html" in as the filename:

![Add new item to Templates foder](../Media/NewDjangoTemplate.png)
...
![Template Added to Solution Explorer](../Media/TemplateAdded.png)
...
![Template Intellisense for Django Filters](../Media/TemplateIntellisense.png)
...
![Register URL](../Media/RegisterUrl.png)
...
![Django Hello World in a Browser and the Test Server](../Media/DjangoHelloWorldTestServer.png)
...
![Debugger stopped at a template breakpoint](../Media/TemplateBreakpoint.png)
...
![Add Deployment Project](../Media/AddDeploymentProject.png)

After executing this command you'll see a newly added project in solution explorer:

![After Add Deployment Project](../Media/AfterDeployProjAdded.png)
...
![After Add Deployment Project](../Media/ComputeEmulator.png)
...
![Package App Menu](../Media/PackageApp.png)

After selecting Package you will get some options which can be configured:

![Package Settings](../Media/PackageSettings.png)
...
![New Hosted Service](../Media/PackageCreated.png)
...
![New Hosted Service](../Media/NewHostedService.png)
...
![Your Django app in the cloud](../Media/FirstAppInCloud.png)
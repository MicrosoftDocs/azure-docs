...
[Managing Windows Azure SQL Database using SQL Server Management Studio]: /en-us/develop/other/common-tasks/sql-azure-management/
[Configuring a Custom Domain Name in Windows Azure]: /en-us/develop/other/common-tasks/custom-dns/
[Enabling Remote Desktop in Windows Azure with Visual Studio]: /en-us/develop/other/common-tasks/remote-desktop/
[Configuring SSL for an Application in Windows Azure]: /en-us/develop/other/common-tasks/enable-ssl/
[Using CDN for Windows Azure]: /en-us/develop/other/common-tasks/cdn/

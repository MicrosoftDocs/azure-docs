<properties
linkid=dev-net-how-to-sendgrid-email-service
urlDisplayName=SendGrid Email Service
headerExpose=
pageTitle=SendGrid Email Service - How To - .NET - Develop
metaKeywords=
footerExpose=
metaDescription=
umbracoNaviHide=0
...
<p><a href="#whatis">What is the SendGrid Email Service?</a><br /> <a href="#createaccount">Create a SendGrid Account</a><br /> <a href="#reference">Reference the SendGrid .NET Class Library</a><br /> <a href="#createemail">How to: Create an Email</a><br /> <a href="#sendemail">How to: Send an Email</a><br /> <a href="#addattachment">How to: Add an Attachment</a><br /> <a href="#usefilters">How to: Use Filters to Enable Footers, Tracking, and Analytics</a><br /> <a href="#useservices">How to: Use Additional SendGrid Services</a><br /> <a href="#nextsteps">Next Steps</a></p>
<h2><a id="whatis"></a>What is the SendGrid Email Service?</h2>
...
<h2><a id="createaccount"></a>Create a SendGrid Account</h2>
...
<h2><a id="reference"></a>Reference the SendGrid .NET Class Library</h2>
...
<img src="/media/net/sendgrid01.png" alt="SendGrid NuGet package"/></li>
<li>
...
<ul>
<li><strong>SendGridMail</strong> for creating and working with email items.</li>
<li><strong>SendGridMail.Transport</strong> for sending email using either the <strong>SMTP</strong> protocol, or the HTTP 1.1 protocol with <strong>Web/REST</strong>.</li>
</ul>
...
<h2><a id="createemail"></a>How to: Create an Email</h2>
...
<h2><a id="sendemail"></a>How to: Send an Email</h2>
...
<h2><a id="addattachment"></a>How to: Add an Attachment</h2>
...
<h2><a id="usefilters"></a>How to: Use Filters to Enable Footers, Tracking, and Analytics</h2>
...
<h2><a id="useservices"></a>How to: Use Additional SendGrid Services</h2>

...
2.	Create a team project by navigating to your TFS account page. Your account will have the form: http://&lt;username&gt;.kudutfs.cloudapp.net.  You will need to sign-in using a regular Microsoft account (not the same as the test account you used to log in to the Azure portal).<br>
![][1]
...
8. Accept or change the defaults and choose the OK button.<br>
![][6]
...
![][8]
<br>
Note: You may need to repeat this again after your initial check-in, to “Include All” files.  Click the “Include All” link and click the “Check-in” button again.<br>
![][9]

11. Now that you have a TFS team project with some source code in it, you are ready to connect your team project to Azure.  In the Azure portal, click “Set up TFS publishing” on the Quickstart page (or Dashboard’s “Quick Glance” section).<br>
![][10]

12. In the wizard, type the name of your TFS account in the textbox and click the “Authorize Now” link.<br>
![][11]

13. In the OAuth pop-up dialog, click “Accept” to authorize Windows Azure to configure your team project in TFS.<br>
![][12]

14. When authorization succeeds, you should see a dropdown containing a list of your TFS team projects.  Select the name of team project that you created in the previous steps, and click the wizard’s Finish button.<br>
![][13]

15. When your project is linked, you will see some instructions for checking in changes to your TFS team project.  On your next check-in, TFS will build and deploy your project to Windows Azure.  Try this now by clicking the “Launch Visual Studio” link (or the equivalent “Visual Studio” button in the command-bar).<br>
![][14]
...
![][22]
<br>
You should see that a build has been triggered for your check-in.<br>
![][23]

24. Double-click the name of the build in-progress to view a detailed log as the build progresses.<br>
![][24]

24. While the build is in-progress, take a look at the build definition that was created when you linked TFS-Azure using the wizard.  Open the shortcut menu for the build definition and choose Edit Build Definition.<br>
![][25]
<br>
...
26. If you double-click the build name, you should see a Build Summary, including any test results from associated unit test projects.<br>
![][29]

27. In the [Azure Portal](http://preview.azure.com), you should see an associated deployment.<br>
![][30]

28.	Click the “Browse” button to view your running site.<br>
![][31]
<br>

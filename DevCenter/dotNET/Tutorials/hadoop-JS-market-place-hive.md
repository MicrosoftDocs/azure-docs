<a name="title" />
# Running Hadoop Jobs on Azure, Importing Data from DataMarket, and Analysing the Data with the Excel Hive Add-In #
...
This tutorial shows two ways run MapReduce programs in a Hadoop on Azure cluster and how to analyse data imported into the cluster from Excel using Hive-based connectivity. 
...
4. How to import data from DataMarket into an Hadoop on Azure cluster using the Interactive Hive Console.

5. How to use Excel to query data stored in an Hadoop on Azure cluster. 
...
- [MapReduce][1]
- [Hadoop on Azure][2]
- [Hadoop on Azure Interactive Console for JavaScript and Hive][3]
...
You must have an account to access Hadoop on Azure and have created a cluster to work through this tutorial. To obtain an account and create an Hadoop cluster, follow the instructions outlined in the _Getting started with Microsoft Hadoop on Azure_ section of the _Introduction to Hadoop on Azure_ topic.
...
![PiEstimatorSample](images/piestimatorsample.png?raw=true "Pi Estimator Sample")

On the **Pi Estimator** page, information is provided about the application and downloads are make available for Java MapReduce programs and the jar file that contains the files needed by Hadoop on Azure to deploy the application.
...
![PiEstimatorSampleResult](images/piestimatorsampleresult.png?raw=true "Pi Estimator Sample Result")
...
![InteractiveJsPage](images/interactivejspage.png?raw=true "Interactive JS Page")
...
![WordCountSampleUploadWindow](images/wordcountsampleuploadwindow.png?raw=true "WordCount Sample Upload Window")	
...
![WordCountSampleReadTop10](images/wordcountsamplereadtop10.png?raw=true "WordCount Sample Read Top10")
...
![DataMarketFrontPage](images/datamarketfrontpage.png?raw=true "DataMarketFrontPage")

Click on the **MyAccount** tab and complete the Registration form to open a subscription account.

![DataMarketRegistration](images/datamarketregistration.png?raw=true "Data Market Registration")	
...
![DataMarketAccountKeys](images/datamarketaccountkeys.png?raw=true "Data Market Account Keys")
...
![DataMarketCrimeDataSearch](images/datamarketcrimedatasearch.png?raw=true "DataMarket Crime Data Search")

Select the 2006-2008 Crime in the United States (Data.gov) date.

![DataMarketCrimeData](images/datamarketcrimedata.png?raw=true "Data Market Crime Data")
...
![DataMarketCrimeDataExplore](images/datamarketcrimedataexplore.png?raw=true "DataMarket Crime Data Explore")
...
![DataMarketQueryCrimeData](images/datamarketquerycrimedata.png?raw=true "DataMarket Query Crime Data")
...
![DataMarketQueryCrimeResult](images/datamarketquerycrimeresult.png?raw=true)

Return to your Hadoop on Azure Account page, scroll down to the **Your Cluster** section and click on **Manage Cluster** icon.  
![ManageClosterIconOnAccountPage](images/manageclostericononaccountpage.png?raw=true "Manage Closter Icon On Account Page")

Select the **DataMarket** icon option for importing data from Windows Azure DataMarket. 

![ManageClusterDataMarketOption](images/manageclusterdatamarketoption.png?raw=true "Manage Cluster Data Market Option")
...
![ImportFromDataMarket](images/importfromdatamarket.png?raw=true "Import From Data Market")

The progress made importing is reported on the Data Market Import page that appears.

![CrimeDataImportProgress](images/crimedataimportprogress.png?raw=true "Crime Data Import Progress")
...
![crimedatahiveconsole](images/crimedatahiveconsole.png?raw=true "Crime Data Hive Console")
![crime_data_hive_console1](images/crimedatahiveconsole1.png?raw=true)
...
![CrimeDataHiveConsoleWithQuery](images/crimedatahiveconsolewithquery.png?raw=true "Crime Data Hive Console With Query")
...
![OpenODBCPort10000](images/openodbcport10000.png?raw=true "Open ODBC Port 10000")
...
![DownloadLinkHiveODBC](images/downloadlinkhiveodbc.png?raw=true "Download Link Hive ODBC")

Select the **Run anyway** option from the **SmartScreen Filter** window that pops up.
  
![RunawayHiveODBC](images/runawayhiveodbc.png?raw=true "Runaway Hive ODBC")

Open Excel after the installation completes.  Under data menu click on the **Hive Panel**.

![ExcelDataMenuHivePanel](images/exceldatamenuhivepanel.png?raw=true "Excel Data Menu Hive Panel")

Press the **Enter Cluster Details** button on the **Hive Query** panel on the left.

![ExcelHiveCredentials](images/excelhivecredentials.png?raw=true "Excel Hive Credentials")

Provide a description for your cluster, enter localhost for the Host value and 10000 for the port number. Enter your credentials for your Hadoop on Azure cluster in the Unsername/Password option in the **Authentication** section. Then click **OK**.

![ExcelODBCHiveSetupWindow](images/excelodbchivesetupwindow.png?raw=true "Excel ODBC Hive Setup Window")
...
![ExcelExecuteHiveQuery](images/excelexecutehivequery.png?raw=true "Excel Execute Hive Query")
...
![ExcelHiveQueryResults](images/excelhivequeryresults.png?raw=true "Excel Hive Query Results")
...
In this tutorial, you have seen two ways to run MapReduce jobs using the Hadoop on Azure portal. One used the **Create Job** UI to run a Java MapReduce program using a jar file. The other used the **Interactive Console** to run a MapReduce job using a .js script within a Pig query.

...
![The Echo Nest Taste Profile Subset](images/the-echo-nest-taste-profile-subset.png?raw=true) 
...
![setting command line arguments](images/setting-command-line-arguments.png?raw=true)
...
![program output](images/program-output.png?raw=true)

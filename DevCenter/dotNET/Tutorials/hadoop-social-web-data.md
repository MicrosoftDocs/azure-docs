...
# Tutorial steps to Demo and Process Twitter Movie data using HADOOP on Azure #

<a name="Overview" />
## Overview ##

In this tutorial we will query, explore, and analyze data from twitter using Hadoop on Azure and a Hive query in Excel. Social web sites are one of the major driving forces for Big Data adoption. Public APIs provided by sites like Twitter are a useful source of data for analyzing and understanding popular trends.  
...
- [Apache Hive™][1]
- Excel Hive Add-In
- [Apache Hadoop™-based Services for Windows Azure][2]
...
1. [Request and configure a new Hadoop on an Azure cluster](#segment3).
...
![Figure1](images/Figure1.png?raw=true)
...
<a name="segment3" />
### Request and configure a new Hadoop on an Azure Cluster ###

This step requires access to the CTP for Hadoop-based Services for Windows Azure. Go to <https://www.hadooponazure.com/> and click on the **invitation** link.  If you already have access, click the **Sign in** button.

![Figure7](../media/Figure7.png)  

Request a new cluster.  Below is an example of a large cluster called “mailboxpeak.” Enter a username and password and click the Request cluster button.  If you have questions, refer to the “Apache Hadoop-based Services for Windows Azure How-To and FAQ.”
...
![Figure22](images/Figure22.png?raw=true)
...
![Figure23](images/Figure23.png?raw=true)

Click the Open button.
  
![Figure24](images/Figure24.png?raw=true)
...
![Figure25](images/Figure25.png?raw=true)
...
![Figure26](images/Figure26.png?raw=true)

Navigate to the **c:\Apps\dist\example\data** directory.
  
![Figure27](images/Figure27.png?raw=true)
...
8. Check to see that the file has been updated to HDFS by opening ![Figure28](images/Figure28.png?raw=true) and navigating to 
/example/data.
  
![Figure29](images/Figure29.png?raw=true)
...
This section is copied from the **Apache Hadoop-based Services for Windows Azure How-To and FAQ**, which can be found in the downloads tile ![Figure37](images/Figure37.png?raw=true)
at the Hadoop on Azure portal.
  
![Figure38](images/Figure38.png?raw=true)  

![Figure39](images/Figure39.png?raw=true)

This is also where you can download **HiveODBCSetup** for 64-bit or 32-bit Excel.

**How to connect the Excel Hive Add-In to Hadoop on Azure via HiveODBC**
...
In order to run the installation, you must download the 64-bit Hive ODBC driver MSI file from the Hadoop on Azure portal.  
...
![Figure40](images/Figure40.png?raw=true)
...
![Figure41](images/Figure41.png?raw=true)
...
![Figure42](images/Figure42.png?raw=true)
...
![Figure45](images/Figure45.png?raw=true)
 
Click **Execute Query**.
  
![Figure46](images/Figure46.png?raw=true)
...
In this tutorial we have seen how to query, explore, and analyze data from Twitter using Hadoop on Azure and a Hive query in Excel.
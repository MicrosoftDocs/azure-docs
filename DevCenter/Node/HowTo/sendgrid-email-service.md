...
<div class="dev-callout">
<b>Note</b>
<p>When using the **files** property, the file must be accessible
...
the file to local storage or to a Windows Azure drive before it can be sent as an attachment using the **files** property.</p>
</div>

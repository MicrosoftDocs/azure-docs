<properties
linkid=dev-nodejs-how-to-sendgrid-email-service
urlDisplayName=SendGrid Email Service
headerExpose=
pageTitle=SendGrid Email Service - How To - Node.js - Develop
metaKeywords=
footerExpose=
metaDescription=
umbracoNaviHide=0
...
<p><a href="#whatis">What is the SendGrid Email Service?</a><br /> <a href="#createaccount">Create a SendGrid Account</a><br /> <a href="#reference">Reference the SendGrid Node.js Module</a><br /> <a href="#createemail">How to: Create an Email</a><br /> <a href="#sendemail">How to: Send an Email</a><br /> <a href="#addattachment">How to: Add an Attachment</a><br /> <a href="#usefilters">How to: Use Filters to Enable Footers, Tracking, and Analytics</a><br /> <a href="#updateproperties">How to: Update Email Properties</a><br /> <a href="#useservices">How to: Use Additional SendGrid Services</a><br /> <a href="#nextsteps">Next Steps</a></p>
...
<h2><a id="reference"></a>Reference the SendGrid Node.js Module</h2>
...
<p><strong>Note</strong>: While the above examples show passing in an email object and callback function, you can also directly invoke the send and smtp functions by directly specifying email properties. For example:</p>
...
<h2><a id="updateproperties"></a>How to: Update Email Properties</h2>

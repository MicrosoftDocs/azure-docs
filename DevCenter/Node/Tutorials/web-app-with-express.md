<properties
linkid=dev-nodejs-basic-web-app-with-express
urlDisplayName=Web App With Express
headerExpose=
pageTitle=Web App With Express
...
footerExpose=
metaDescription=An tutorial that builds on the Web app tutorial, and demonstrates how to use the Express module
umbracoNaviHide=0
disqusComments=1
/>
...
<img src="/media/node/node36.png" alt="A web browser displaying Welcome to Express in Windows Azure"/>
...
<p><strong>Note</strong>: By default, the command above installs the latest version of the modules. This tutorial was created with Express version 2.5.5. If you encounter problems using a newer version of Express, you can install the 2.5.5 version by using <strong>npm install express@2.5.5</strong>.</p>
...
<p><img src="/media/nodejs/dev-nodejs-getting-started-16storage.png" alt="Windows PowerShell displaying the output of the npm install express command."/></p>
</li>
</ol>
...
<img src="/media/node/node23.png" alt="The output of the .\node_modules\.bin\express command."/></li>
<li>
...
<img src="/media/nodejs/dev-nodejs-getting-started-17.png" alt="Directory listing of the WebRole1 folder."/>
...
<img src="/media/node/node26.png" alt="The output of the npm install command"/></li>
<li>
...
<img src="/media/node/node27.png" alt="The contents of server.js with the app.listen(3000); and console.log lines selected."/>
<p>This configures Node to listen on the environment PORT value provided by Windows Azure when published to the cloud.</p>
<p><strong>Note</strong>: At the time of this writing, express scaffolding sometimes generated LF-only line breaks (Unix-style). If you’re experiencing this, you can open the file in WordPad or Visual Studio and save, thereby replacing LF with CRLF line breaks. Save the server.js file.</p>
</li>
<li>
<p>Use the following command to run the application in the Windows Azure emulator:</p>
<pre class="prettyprint">PS C:\node\tasklist\WebRole1&gt; Start-AzureEmulator -launch
</pre>
<img src="/media/node/node28.png" alt="A web page containing welcome to express."/></li>
</ol>
...
<img src="/media/nodejs/dev-nodejs-getting-started-19.png" alt="The contents of the index.jade file."/>
...
<img src="/media/node/node31.png" alt="The index.jade file, the last line reads: p Welcome to #{title} in Windows Azure"/></li>
<li>
<p>Save the file and exit Notepad.</p>
</li>
<li>
<p>Refresh your browser and you will see your changes.</p>
<img src="/media/node/node32.png" alt="A browser window, the page contains Welcome to Express in Windows Azure"/></li>
</ol>
...
<img src="/media/node/node33.png" alt="The server.js file, with the app.get('/', routes.index); line highlighted"/>
...
<img src="/media/node/node34.png" alt="The web browser displaying the home page, which states A work in progress"/></li>
</ol>
...
<p><img src="/media/node/node35.png" alt="The output of the publish command"/></p>
...
<p><img src="/media/node/node36.png" alt="A web browser displaying the Express page. The URL indicates it is now hosted on Windows Azure."/></p>
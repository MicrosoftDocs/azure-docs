...
###[How to Create a Custom Virtual Machine](./custom-create-a-vm/)
...
###[How to Set Up Communication with a Virtual Machine](./setup-endpoints/)
...
###[How to Capture an Image of a Virtual Machine Running Windows Server 2008 R2](./capture-an-image/)
...
Learn how to start a Remote Desktop Connection from the Windows Azure (Preview) Management Portal for a virtual machine that is running the Windows Server 2008 R2 operating system.

###[How to Connect Virtual Machines in a Cloud Service](./connect-to-a-cloud-service/)
...
###[How to Quickly Create a Virtual Machine](./quickly-create-a-vm/)
...
###[How to Attach a Data Disk to a Virtual Machine](./attach-a-disk/)

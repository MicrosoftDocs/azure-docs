...
##[How to Create a Custom Virtual Machine](../HowTo/howto-custom-create-vm.md)
...
##[How to Set Up Communication with a Virtual Machine](../HowTo/howto-setup-endpoints-vm.md)
...
##[How to Capture an Image of a Virtual Machine Running Linux](../HowTo/howto-capture-linux-image.md)
...
##[How to Use SSH with Linux on Windows Azure](../HowTo/howto-ssh-linux.md)
 
Learn how to generate SSH keys that are compatible with Windows Azure.
 

##[Windows Azure Linux Agent User Guide](../HowTo/linux-agent-guide.md)
...
##[How to Attach a Data Disk to a Virtual Machine](../HowTo/howto-attach-disk.md)
...
##[How to Connect Virtual Machines in a Cloud Service](../HowTo/howto-connect-vm-cloud-service.md)
...
##[How to use the Windows Azure Command-Line Tools for Mac and Linux](../HowTo/howto-command-line-tools.md)
...
##[How to Log on to a Virtual Machine Running Linux](../HowTo/howto-logon-linux-vm.md)
...
##[How to Prepare a Linux Distribution for Windows Azure](../HowTo/howto-prepare-linux-distribution.md)

Learn how to customize and create images for the different distributions that our partners have tested.



##[How to Quickly Create a Virtual Machine](../HowTo/howto-quick-create-vm.md)
...
##[How to Use the Service Management API](../HowTo/howto-servicemgt-api.md)

...
-	Deploy a VM in the Cloud Service that is part of the virtual network. The VM must be size L or greater in order to attach two data disks to it. The data disks are needed to store:

<properties linkid="manage-services-getting-started-with-sqlds" urlDisplayName="How to sync data" pageTitle="Convert your database to a Premium database in SQL Database - Windows Azure" metaKeywords="" metaDescription="Get started creating and managing SQL Data Sync sync groups in Windows Azure." metaCanonical="" disqusComments="1" umbracoNaviHide="0" />

<div chunk="../chunks/sql-databases-left-nav.md" />

#Convert your database to a Premium database in SQL Database
In this tutorial, you learn the fundamentals of Windows Azure SQL Data Sync using the Windows Azure portal. 

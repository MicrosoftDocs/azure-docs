...
<div class="article blue">
<h3><a href="./other/manage-acs/">Windows Azure Active Directory Access Control</a></h3>
<p>Learn how to create and manage tokens and token-signing certificates used in the Access Control service to provide security and identity functionality to web sites and cloud services.</p>
</div>
</div>
<properties 
   pageTitle="Software requirements" 
   description="This article describes the software requirements for the storage clients that are trying to access your Microsoft Azure StorSimple device." 
   services="StorSimple" 
...
# Software requirements for storage clients accessing StorSimple 

The following software requirements are for the storage clients that access your StorSimple.
...
The following table lists the specific versions of the operating systems that are supported on the storage clients accessing your StorSimple device.

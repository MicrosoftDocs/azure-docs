...
3. Review the errors in the data copy log using the path in **DATA COPY DETAILS**. 
   ...
   - Be sure to fix any configuration issues before you try another upload via a network transfer or a new import order. For guidance, see [Troubleshoot paused data uploads from Azure Data Box and Azure Data Box Heavy devices](../articles/databox/data-box-troubleshoot-data-upload.md).
...
6. When you're ready to complete the upload, select **Proceed**.
   ...
   ![Confirm you've reviewed the errors and are ready to proceed with the upload](media/data-box-verify-upload/upload-paused-03.png)

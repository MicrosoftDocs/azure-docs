...
| Go                   | [MSAL Go](https://github.com/AzureAD/microsoft-authentication-library-for-go)         | [MSAL Go](https://github.com/AzureAD/microsoft-authentication-library-for-go)          | —                                            | ![Library cannot request ID tokens for user sign-in.][n] | ![Library can request access tokens for protected web APIs.][y] | Public preview |
<!--

...
If you completed [Tutorial: Connect a sample IoT Plug and Play device application running on Windows to IoT Hub (Python)](../articles/iot-pnp/tutorial-connect-device.md), you've already cloned the repository.

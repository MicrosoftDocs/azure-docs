| Resource | Free | Shared | Basic | Standard | Premium | Isolated </th> |
| --- | --- | --- | --- | --- | --- | --- |
...
| Custom domain [SSL support](../articles/app-service/app-service-web-tutorial-custom-ssl.md) |Not supported. Wildcard certificate for *.azurewebsites.net available by default.|Not supported. Wildcard certificate for *.azurewebsites.net available by default.|Unlimited SNI SSL connections |Unlimited SNI SSL and 1 IP SSL connections included |Unlimited SNI SSL and 1 IP SSL connections included | |

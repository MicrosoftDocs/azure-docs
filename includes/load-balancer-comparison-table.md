...
| Secure by default | Inbound not permitted for public IP and Load Balancer endpoints (public and internal). A network security group  must explicitly whitelist traffic. | Default open, network security group optional. |

...
<sup>2</sup>Input endpoints allow communications to a virtual machines from outside the virtual machine's cloud service. Virtual machines in the same cloud service or virtual network can automatically communicate with each other. See [How to Set Up Endpoints to a Virtual Machine](../virtual-machines/virtual-machines-set-up-endpoints.md) and [How to Connect Virtual Machines with a Virtual Network or Cloud Service](../virtual-machines/cloud-services-connect-virtual-machine.md).

...
5. Open the `build.gradle` file in the **app** directory, and add the following line under `dependencies`. 
...
1. Open **AndroidManifest.xml**, and then add the following tag to the *application* tag.

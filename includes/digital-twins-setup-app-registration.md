...
>[!TIP]
> As a subscription Owner, you may prefer to set up a new app registration for every new Azure Digital Twins instance, *or* to do this only once, establishing a single app registration that will be shared among all Azure Digital Twins instances in the subscription. This is how it's done in Microsoft's own tenant.

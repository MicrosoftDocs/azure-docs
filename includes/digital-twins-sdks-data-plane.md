...
* `Delete Jobs` - The Delete Jobs API lets you manage a long running, asynchronous action to [delete all models, twins, and relationships in an instance](../articles/digital-twins/concepts-apis-sdks.md#bulk-delete).

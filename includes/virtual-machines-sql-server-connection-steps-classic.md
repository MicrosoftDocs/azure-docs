...
4. In the **Login** box, type a SQL Server username that you created in an earlier task.
5. In the **Password** box, type the password of the username that you created in the earlier task.
6. Click **Connect**.

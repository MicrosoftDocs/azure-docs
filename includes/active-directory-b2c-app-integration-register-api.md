...
1. For **Name**, enter a for the application (for example, **my-api1**). Leave the default values for **Redirect URI**. 
1. Select **Register**.
1. After the app registration is completed, select **Overview**.
1. Record **Application (client) ID** value for later use when you configure the web application.

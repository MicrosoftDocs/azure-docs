...
1. Optionally, [manage access to your Azure Load Testing resource](../articles/load-testing/how-to-assign-roles.md).
    ...
    :::image type="content" source="media/azure-load-testing-create-in-portal/azure-load-testing-not-authorized.png" alt-text="Screenshot that shows an error message in the Azure portal that you're not authorized to use the Azure Load Testing resource.":::

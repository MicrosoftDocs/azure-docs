...
**Virtual Machines**: Ultra SSDs are designed to work with all Premium SSD enabled Azure Virtual Machine SKUs, however as it currently in preview the VM sizes will be limited to the VMs are sized as ES/DS v3.

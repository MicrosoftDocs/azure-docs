...
| Outbound | 443 | AzureMonitor | Used to log monitoring and metrics to App Insights and Azure Monitor. This outbound communication may be used to exfiltrate data. For more information, see [Data exfiltration protection](how-to-prevent-data-loss-exfiltration.md). |
...
You must also allow __outbound__ access to the following fully qualified domain names (FQDN):
* `ml.azure.com`

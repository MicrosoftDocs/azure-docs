...
| Outbound | 443 | AzureMonitor | Used to log monitoring and metrics to App Insights and Azure Monitor. This outbound communication may be used to exfiltrate data. For more information, see [Data exfiltration protection](/azure/machine-learning/how-to-prevent-data-loss-exfiltration). |

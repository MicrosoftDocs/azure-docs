...
1. On the **Create Azure Cosmos DB Account** page, enter the basic settings for the new Azure Cosmos account. 
    ...
    |Notebooks (Preview)|On or off|Select if you want to enable the preview of [built-in Jupyter notebooks](../articles/cosmos-db/cosmosdb-jupyter-notebooks.md) in this account. You can enable notebooks anytime.|

...
1. Click **Finish**. On the **Security Warning** for the certificate installation, select **Yes**. You can feel comfortable selecting 'Yes' because you generated the certificate. The certificate is now successfully imported.
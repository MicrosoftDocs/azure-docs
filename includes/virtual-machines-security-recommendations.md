...
| Keep your VMs current. | You can use the [Update Management](../articles/automation/update-management/update-mgmt-overview.md) solution in Azure Automation to manage operating system updates for your Windows and Linux computers in Azure. | [Yes](../articles/security-center/security-center-apply-system-updates.md) |

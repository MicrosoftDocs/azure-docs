...
|useTablePartitionManagement|false|When set to `true`, uses a partition management algorithm that reduces function costs especially for Azure Storage V2 accounts. Available starting in v2.10.0.|

...
|grpcHttpClientTimeout|100 seconds|Sets the timeout for the HTTP client used by the gRPC client in Durable Functions for .NET Isolated and Java (and may apply to other languages in the future). Applicable on .NET 6 or later.|

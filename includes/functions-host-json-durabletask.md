...
Configuration settings for [Durable Functions](../articles/azure-functions/durable-functions/durable-functions-overview.md).
...
|useAppLease|true|A value that indicates whether apps must acquire an app-level blob lease before processing task hub messages. For more information, see [Disaster recovery and geo-distribution in Durable Functions](../articles/azure-functions/durable-functions/durable-functions-disaster-recovery-geo-distribution.md). This setting is available starting in v2.3.0.|
...
Many of these settings are for optimizing performance. For more information, see [Performance and scale](../articles/azure-functions/durable-functions/durable-functions-perf-and-scale.md).

...
2. Scroll down to **Background Modes**. Check the **Enable Background Modes** box and the **Remote notifications** box.

    ![](./media/app-service-mobile-xamarin-ios-configure-project/mobile-services-ios-push-22.png)
3. Double-click your project in the Solution Panel to open **Project Options**.
4. Under **Build**, choose **iOS Bundle Signing**, and select the corresponding **Identity** and **Provisioning profile** you had just set up for this project.

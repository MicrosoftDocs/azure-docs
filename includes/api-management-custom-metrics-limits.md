...
* API Management enforces a limit of 1,000 active time series per metric namespace. After this limit is reached, attempts to create additional time series are not recorded, and the corresponding metric data is silently dropped.

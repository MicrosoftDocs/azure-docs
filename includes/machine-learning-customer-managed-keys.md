...
> * The default [__Request Units__](../articles/cosmos-db/request-units.md) for this Cosmos DB account is set at __8000__. For more information, see [Request Units in Azure Cosmos DB](../cosmos-db/request-units.md).

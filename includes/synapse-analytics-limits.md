...
| -------- | ------------- | ------------- |
| Synapse Analytics workspaces in an Azure subscription | 800 | 800 |
...
For details of capacity limits for dedicated SQL pools in Azure Synapse Analytics, see [Azure Synapse Analytics SQL pool resource limits](../../synapse-analytics/sql-data-warehouse/sql-data-warehouse-service-capacity-limits.md).

...
- [Stream it to an Event Hub](../articles/azure-monitor/platform/activity-logs-stream-event-hubs.md.md) for ingestion by a third-party service or custom analytics solution such as PowerBI.

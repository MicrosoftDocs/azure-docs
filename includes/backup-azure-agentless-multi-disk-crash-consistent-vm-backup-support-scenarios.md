...
**VM type and size** | - Supported for [VM sizes](/azure/virtual-machines/vm-naming-conventions) that are premium storage capable (VM size that include "*s*" in their name) such as `DSv2`.   <br> - Trusted Launch VMs are supported. <br> - VMs with Ultra Disks, Premium SSD v2, Ephemeral OS disks, Shared disks, and Write Accelerated disks aren't supported. <br> - VM sizes using [Azure Boost](/azure/azure-boost/overview) aren't supported - Intel V6 and above (Dsv6-series, Edsv6-series, Esv6-series, and more) and AMD V7 and above (Dasv7-series, Dadsv7-series, Easv7-series, Faldsv7-series, and more) 

...
| `/B`                  | Runs RoboCopy in the same mode a backup application would use. This switch allows Robocopy to move files that the current user doesn't have permissions for. |

...
1. Connect to the virtual machine with Remote Desktop. For detailed instructions on connecting to the VM, see [Open a SQL VM with Remote Desktop](../articles/sql-database/virtual-machines/windows/create-vm-portal.md#remotedesktop).

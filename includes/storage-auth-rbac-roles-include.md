...
Azure RBAC provides a number of built-in roles for authorizing access to blob and queue data using Azure AD and OAuth. Some examples of roles that provide permissions to data resources in Azure Storage include:

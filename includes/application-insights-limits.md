...
| Data retention Logs | [30 - 730 days](../articles/azure-monitor/logs/data-retention-archive.md)  | This resource is for [Logs](../articles/azure-monitor/logs/log-query-overview.md).
...
For more information, see [About pricing and quotas in Application Insights](../articles/azure-monitor/logs/application-insights-billing.md).
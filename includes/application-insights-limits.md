...
| --- | --- | --- |
| Total data per day | 100 GB | You can reduce data by setting a cap. If you need more, you can increase the limit up to 1000 GB from the portal, for capacities more than 1000 GB mail AIDataCap@microsoft.com.

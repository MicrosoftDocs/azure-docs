...
| Data retention Logs | [30 - 730 days](../articles/azure-monitor/app/pricing.md#change-the-data-retention-period)  | This resource is for [Logs](../articles/azure-monitor/log-query/log-query-overview.md).
| Data retention Metrics | 90 days| This resource is for [Metrics Explorer](../articles/azure-monitor/platform/metrics-charts.md).

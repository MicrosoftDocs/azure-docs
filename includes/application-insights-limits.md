...
| Free data per month<br/> (Basic pricing plan) | 1 GB | Additional data is charged per gigabyte.
...
| [Availability multistep test](../articles/application-insights/app-insights-monitor-web-app-availability.md#multi-step-web-tests) detailed results retention | 90 days | This resource provides detailed results of each step.

...
| [Availability multi-step test](https://docs.microsoft.com/en-us/azure/azure-monitor/app/availability-multistep) detailed results retention | 90 days | This resource provides detailed results of each step.

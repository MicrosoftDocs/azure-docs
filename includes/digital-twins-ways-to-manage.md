...
Another management option is to call the the Azure Digital Twins [**REST APIs**](/rest/api/azure-digitaltwins/) for this topic area directly.

Finally, you can complete the same management operations using the Azure Digital Twins **CLI**. To learn more about using the CLI, see [*How-to: Use the Azure Digital Twins CLI*](how-to-use-cli.md).
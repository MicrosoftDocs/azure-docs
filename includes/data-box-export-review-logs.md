...
1. Download the *copy log*. In the **Connect and copy** page, select **Copy log**. When prompted, save the log on your system. 
    ...
    * If you are using [Azure Storage Explorer](/azure/databox/data-box-deploy-copy-data-via-rest) to download the copy log, you can map your Azure storage account in Azure Storage Explorer and then download the raw file.

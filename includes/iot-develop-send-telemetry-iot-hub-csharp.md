...
- [.NET SDK](https://docs.microsoft.com/dotnet/core/install/) version 3.1. Be sure to install the .NET SDK, not just the .NET runtime. To check your .NET version run `dotnet --version`.

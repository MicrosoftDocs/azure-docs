...
Premium SSD, standard SSD, and standard SSD support snapshots, without any size limit. So you can snapshot even large disks (up to 32 TiB). Ultra disks do not support snapshots.

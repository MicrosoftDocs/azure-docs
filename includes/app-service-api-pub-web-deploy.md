...
9. Click **Publish** to begin the deployment process. 
	...
	If you use another method to deploy an API app, or if you Visual Studio fails to restart the gateway, you might have to restart the gateway manually. The following steps explain how to do that.

...
[!code-cpp[Define data structures for Chiller](~/iot-samples-c/samples/solutions/RemoteMonitoring/RemoteMonitoring.c?name=datadefinition "Define data structures for Chiller")]
...
[!code-cpp[Device method callback](~/iot-samples-c/samples/solutions/RemoteMonitoring/RemoteMonitoring.c?name=devicemethodcallback "Device method callback")]
...
[!code-cpp[Firmware update thread](~/iot-samples-c/samples/solutions/RemoteMonitoring/RemoteMonitoring.c?name=firmwareupdate "Firmware update thread")]
...
[!code-cpp[Send telemetry](~/iot-samples-c/samples/solutions/RemoteMonitoring/RemoteMonitoring.c?name=sendmessage "Send telemetry")]
...
[!code-cpp[Main](~/iot-samples-c/samples/solutions/RemoteMonitoring/RemoteMonitoring.c?name=main "Main")]

...
| Git Sync resources per repository    | Maximum number of resources per repository that you can synchronize with Git Sync.                                                                                  | 10,000 per repository  | 10,000 per repository  | 10,000 per repository  |

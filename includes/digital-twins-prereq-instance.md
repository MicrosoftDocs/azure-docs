...
After you set up your Azure Digital Twins instance, you'll need the **_host name_** for the instance. You can find the name in the [Azure portal](../articles/digital-twins/how-to-set-up-instance-portal.md#verify-success-and-collect-important-values). Make a note of this value so you can use it later to connect to the instance.
...
[!INCLUDE [event-hubs-common-limits](../articles/event-hubs/event-hubs-common-limits.md)]

### Basic vs. standard vs. premium vs. dedicated tiers
[!INCLUDE [event-hubs-tier-limits](../articles/event-hubs/event-hubs-tier-limits.md)]

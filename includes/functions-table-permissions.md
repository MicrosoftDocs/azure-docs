...
<sup>1</sup> If your app is instead connecting to tables in Cosmos DB, using an identity is not supported, and the connection must instead use a connection string.

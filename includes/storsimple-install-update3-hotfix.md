...
2. Select option 1, **Log in to the device with full access**. We recommend that you install the hotfix on the passive controller first.
...
4. After the installation is complete, the controller on which the maintenance mode hotfix was installed restarts. Sign in with option 1, **Log in with full access**, and verify the disk firmware version. Type:

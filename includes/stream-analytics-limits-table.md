...
| --- | --- | --- |
| Maximum number of streaming units per subscription per region |200 |To request an increase in streaming units for your subscription beyond 500, contact [Microsoft Support](https://support.microsoft.com/en-us). |
...
| Maximum number of streaming units per job |192 |There's a hard limit of 120 streaming units per Stream Analytics job. |

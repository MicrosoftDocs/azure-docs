...
|  | [Secure a .NET Web API](active-directory-v2-devquickstarts-dotnet-api.md) | [Daemon apps with the Client Credentials Flow](active-directory-v2-protocols-oauth-client-creds.md) |

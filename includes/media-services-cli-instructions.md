...
If you are using **Azure Cloud Shell**, upload your file to **Azure Cloud Shell**. Then, reference the file like this: `@{FileName}.` You can find the upload/download files button at the top of the shell window. 

...
Versions of the Functions runtime work with specific versions of .NET. To learn more about Functions versions, see [Azure Functions runtime versions overview](functions-versions.md). Version support depends on whether your functions run in-process or out-of-process (isolated). 
...
| Functions runtime version | In-process<br/>([.NET class library](functions-dotnet-class-library.md)) | Out-of-process<br/>([.NET Isolated](dotnet-isolated-process-guide.md)) |
| ---- | ---- | --- |

...
>[!NOTE]
>To change your Functions app runtime verison, follow [these steps](../articles/azure-functions/set-runtime-version.md#l#view-and-update-the-current-runtime-version).

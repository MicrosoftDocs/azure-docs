...
**3. Can customers author applications using a "to-be" retired Azure Cosmos DB SDK during the 12 month period?** 
...
**3. After the retirement date, wht happens to applications that are using the unsupported Azure Cosmos DB SDK?** 
...
New features and functionality will only be added to the latest minor version of the latest SDK. It is recommended to always use the latest version to take advantage of the latest features, performance improvements, and bug fixes. If you are using an old, non-retired, version of the SDK your requests to Azure Cosmos DB will still function, but you will not have access to any new capabilities.  

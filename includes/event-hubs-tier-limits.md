...
The following table shows limits that may be different for basic, standard, and dedicated tiers. In the table CU is [capacity unit](../articles/event-hubs/event-hubs-dedicated-overview.md), PU is [processing unit](../articles/event-hubs/event-hubs-scalability.md#processing-units), TU is [throughput unit](event-hubs-scalability.md#throughput-units). 

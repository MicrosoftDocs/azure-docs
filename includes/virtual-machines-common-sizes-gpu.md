...
## NVv2-series (Preview Closed)
We have doubled the number of vCPU in NVv2 by enabling hyperthreading and updated the VM series to NVv3. Please see below for details of NVv3 series.

...
![Windows Azure components](./media/intro-to-azure/IntroAzure1.png)   
...
![Windows Azure data management](./media/intro-to-azure/IntroAzure3.png)   
...
![Windows Azure networking](./media/intro-to-azure/IntroAzure4.png)   
...
![Windows Azure analytics](./media/intro-to-azure/IntroAzure5.png)   
...
![Windows Azure messaging](./media/intro-to-azure/IntroAzure6.png)   
...
![Windows Azure Caching](./media/intro-to-azure/IntroAzure7.png)   
...
![Windows Azure Media Services](./media/intro-to-azure/IntroAzure8.png)   
...
Now that you have the big-picture, the next step is to write your first Windows Azure application. Choose your language, [get the appropriate SDK](/en-us/downloads/), and go for it. Cloud computing is the new default--get started now.

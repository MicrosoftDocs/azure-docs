...
<sup>2</sup> Partition size varies by [service creation date](vector-search-index-size.md#how-to-determine-service-creation-date). Lower sizes apply to services created before April 1, 2024. Higher partition sizes apply to services created after April 1, 2024 [in supported regions](/azure/search/search-create-service-portal#choose-a-region). 
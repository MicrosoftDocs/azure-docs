...
| Application group                                   | HostPool                                        | 500 * |
| RemoteApp                                           | Application group                               | 500 |
| Role Assignment                                     | Any Azure Virtual Desktop Object                | 200 |
| Session Host                                        | HostPool                                        | 10,000 |

* If you require over 500 Application groups then please raise a support ticket via the Azure portal, this will be automatically approved. If you require over 1,000 Application groups after raising a support ticket we will reach out to discuss your requirements.

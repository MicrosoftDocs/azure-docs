...
* If your P2S User VPN gateway is configured using the Audience values for the manually configured Azure VPN Client app, you can easily [change](../articles/vpn-gateway/point-to-site-entra-gateway-update.md) the gateway and client settings to take advantage of the new Microsoft-registered App ID.
...
[!INCLUDE [Supported Windows versions](vpn-gateway-vwan-azure-vpn-client-windows-supported.md)]

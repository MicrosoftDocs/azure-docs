...
\* Max database size refers to the maximum size of the data files and does not include the space used by log files. Available now for public preview, customers using P11 and P15 databases can now use up to 4 TB of storage at no additional charge.
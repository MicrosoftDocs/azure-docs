In the Azure portal, you can view the connection status by navigating to the connection. The following steps show one way to navigate to your connection and verify.

...
Run the [**Connect-AzureRmAccount**](/powershell/module/azurerm.profile/connect-azurermaccount) cmdlet and you will be presented with a sign in screen to enter your credentials. Use the same credentials that you use to sign in to the Azure portal.

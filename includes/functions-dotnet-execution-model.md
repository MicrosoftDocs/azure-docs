...
| **[Isolated worker process](../articles/azure-functions/create-first-function-cli-csharp.md?tabs=isolated-process)**| Your function code runs in a separate .NET worker process. Check out [.NET supported versions](../articles/azure-functions/dotnet-isolated-process-guide.md#supported-versions) before getting started. To learn more, see [Develop isolated worker process functions in C#](../articles/azure-functions/dotnet-isolated-process-guide.md). |
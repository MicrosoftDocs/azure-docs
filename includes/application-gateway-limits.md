...
<sup>1</sup> For WAF-enabled SKUs with CRS 3.1 or lower, you must limit the number of resources to 40.  For CRS 3.2 or higher, the WAF-enabled SKUs have the same limits as that of Standard SKUs. For more information, see [WAF engine](https://learn.microsoft.com/azure/web-application-firewall/ag/waf-engine).

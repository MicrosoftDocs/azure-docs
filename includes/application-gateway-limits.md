...
| Maximum file upload size (Standard SKU) |V1 - 2 GB<br>V2 - 4 GB |This maximum size limit is shared the with body of the request|
...
| Maximum body size limit Standard SKU (without files)|V1 - 2 GB<br>V2 - 4 GB | |
| Maximum body size limit WAF SKU (without files)|V1 or V2 (with CRS 3.1 and older) - 128 KB<br>V2 (with CRS 3.2 or newer) - 2 MB<sup>3</sup>|8 KB - Minimum Value<br>128 KB - Default value|

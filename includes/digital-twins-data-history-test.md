...
For more information on using the Azure Digital Twins query plugin for Azure Data Explorer, see the [documentation](../articles/digital-twins/concepts-data-explorer-plugin.md), and [blog](https://techcommunity.microsoft.com/t5/internet-of-things/adding-context-to-iot-data-just-became-easier/ba-p/2459987).
...
1. Select **All services** on the left menu.
    ![Azure portal - select All Services](../../includes/media/notification-hubs-portal-create-new-hub/select-all-services.png)
...
1. Type **Notification Hubs** in the **Filter services** text box. Select the star icon next to the service name to add the service to the **FAVORITES** section on the left menu. Select **Notification Hubs**.
      ...
      ![Azure portal - select Notification Hubs](../../includes/media/notification-hubs-portal-create-new-hub/select-notification-hubs.png)

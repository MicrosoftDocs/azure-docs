...
1. Select **All services** on the left menu.
    ![Azure portal - select All Services](../../azure-docs-pr/articles/notification-hubs/create-notification-hub-portal/select-all-services.png)
...
1. Type **Notification Hubs** in the **Filter services** text box. Select the star icon next to the service name to add the service to the **FAVORITES** section on the left menu. Select **Notification Hubs**.
      ...
      ![Azure portal - select Notification Hubs](../../azure-docs-pr/articles/notification-hubs/select-notification-hubs.png)

1. On the **Notification Hubs** page, select **Create** on the toolbar.

      ![Notification Hubs - Add toolbar button](../../azure-docs-pr/articles/notification-hubs/create-toolbar-button.png)
...
1. In the **Basics** tab on the **Notification Hub** page, do the following steps:
    ...
    1. Select a value from the **Location** drop-down list box. This value specifies the location in which you want to create the hub.
       ...
       :::image type="content" source="../../azure-docs-pr/articles/notification-hubs/notification-hub-details.png" alt-text="Screenshot showing notification hub details." lightbox="../../azure-docs-pr/articles/notification-hubs/notification-hub-details.png":::
    ...
    1. Choose a **Disaster recovery** option: **None**, **Paired recovery region**, or **Flexible recovery region**. If you choose **Paired recovery region**, the failover region is displayed. If you select **Flexible recovery region**, use the drop-down to choose from a list of recovery regions. 
       ...
       :::image type="content" source="../../azure-docs-pr/articles/notification-hubs/availability-zones.png" alt-text="Screenshot showing availability zone details." lightbox="../../azure-docs-pr/articles/notification-hubs/availability-zones.png":::

...
>  [!NOTE]
   If you look at the table below we see that for software backed keys we allow 2000 transactions per 10 seconds. And for HSM 1000 transactions per 10 seconds. And the ratio of software backed transactions for 3072 keys to 2048 keys is 500/2000 or 0.4. This means that if a customer does 500 3072 key transactions in 10 seconds they reach their max limit and cannot do any other key operations. 

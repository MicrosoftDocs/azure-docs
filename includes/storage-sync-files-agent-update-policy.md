...
- The lifetime of a minor agent version is bound to the associated major version. For example, when we release agent version 3.0, agent version 2.0 and 2.1 will be expired together.

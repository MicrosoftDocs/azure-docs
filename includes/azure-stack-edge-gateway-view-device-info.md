...
2. Use the `Get-HcsApplianceInfo` to get the information for your device.
    ...
    | Model                          | The model for your Azure Stack Edge or Data Box Gateway device. The model is virtual for Data Box Gateway and physical for Azure Stack Edge.                   |   |
    | FriendlySoftwareVersion        | The friendly string that corresponds to the device software version. For a system running preview, the friendly software version would be Azure Stack Edge 1902. |   |
    | HcsVersion                     | The HCS software version running on your device. For instance, the HCS software   version corresponding to Azure Stack Edge 1902 is 1.4.771.324.            |   |

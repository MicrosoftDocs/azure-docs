...
REST API limits for Azure Time Series Insights Gen1 are specified in the [REST API reference documentation](https://docs.microsoft.com/en-us/rest/api/time-series-insights/dataaccess(preview)/query/getavailability).
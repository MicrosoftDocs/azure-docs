...
> [!IMPORTANT] ASA SDK 2.7.0 is the minimum supported version. If using Unity 2020, ASA SDK 2.9.0 is the minimum supported version. If using the Mixed Reality OpenXR plugin, ASA SDK 2.10.0 is the minimum supported version.

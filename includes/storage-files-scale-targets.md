...
| Maximum size of a file in a file share | 1 TiB (GA and preview) | 1 TiB |
| Maximum number of files in a file share | No limit | No limit |
| Maximum IOPS per share | 1,000 IOPS (GA and preview) | 100,000 IOPS |
| Maximum number of stored access policies per file share | 5 | 5 |
| Target throughput for a single file share | Up to 60 MiB/sec (GA and preview) | See premium file share ingress and egress values|

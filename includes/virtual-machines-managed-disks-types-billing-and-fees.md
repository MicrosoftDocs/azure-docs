...
> [!Note]
> For [constrained core VM sizes](../articles/virtual-machines/constrained-vcpu.md), the reservation fee is based on the actual number of vCPUs and not the constrained cores. For Standard_E32-8s_v3, the reservation fee will be based on 32 cores. 

...
Because the local.settings.json may contain secrets, such as connection strings, you should never store it in a remote repository. Core Tools makes it easy to encrypt this local settings file for improved security. For more information, see [Local settings file](../articles/azure-functions/functions-develop-local.md#local-settings-file).
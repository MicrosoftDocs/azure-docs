...
1. Click the **Sign in** button in the top right of Visual Studio.
...
1. Make sure you have the [Azure Account](https://marketplace.visualstudio.com/items?itemName=ms-vscode.azure-account) extension installed.

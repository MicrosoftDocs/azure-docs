...
<sup>1</sup>For more details on these limits, see [Azure Storage Scalability and Performance Targets](http://azure.microsoft.com/documentation/articles/storage-scalability-targets/).

...
On the **Label categories** page, specify the set of classes to categorize your data. Accuracy and speed are affected for your labelers by their ability to choose among the classes. For instance, instead of spelling out the full genus and species for plants or animals, use a field code or abbreviate the genus.
...
* To create a flat list, select **Add label category** to create each label.
    ...
    :::image type="content" source="../articles/machine-learning/media/how-to-create-labeling-projects/add-flat-labels.png" alt-text="Screenshot that shows how to add a flat structure for labels.":::

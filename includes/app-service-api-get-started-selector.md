...
- [(Node.js | 4. Add user principal auth)](app-service-api-dotnet-user-principal-auth.md#node)
- [(Node.js | 5. Add service principal auth)](app-service-api-dotnet-service-principal-auth.md#node)
...
- [(Java | 4. Add user principal auth)](app-service-api-dotnet-user-principal-auth.md#java)
- [(Java | 5. Add service principal auth)](app-service-api-dotnet-service-principal-auth.md#java)
...
| Distribution | Driver |
| --- | -- | 
| Ubuntu 16.04 LTS, 18.04 LTS<br/><br/> Red Hat Enterprise Linux 7.3, 7.4, 7.5, 7.6, 7.7<br/><br/> CentOS-based 7.3, 7.4, 7.5, 7.6, CentOS-based 7.4 HPC | NVIDIA CUDA 10.1, driver branch R418 |
...
| Distribution | Driver |
| --- | -- |
|Ubuntu 18.04 LTS<br/><br/>Ubuntu 16.04 LTS<br/><br/>Red Hat Enterprise Linux 7.0 to 7.6<br/><br/>CentOS-based 7.0 to 7.6<br/><br/>SUSE Linux Enterprise Server 12 SP2 | NVIDIA GRID 9.1, driver branch R430|

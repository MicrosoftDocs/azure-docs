...
|Distribution|Driver|
| --- | -- |
|Ubuntu 16.04 LTS, 18.04 LTS<br/><br/>Red Hat Enterprise Linux 7.9<br/><br/>SUSE Linux Enterprise Server 15 SP2+, 15 SP2 | NVIDIA GRID 14.1, driver branch [R510](https://go.microsoft.com/fwlink/?linkid=874272)(.exe)|

...
|Rule limits|10,000 unique source/destinations in network and application rules <br><br> Here, "unique source/destinations in network" means sum of (unique source addresses * unique destination addresses for each rule)|

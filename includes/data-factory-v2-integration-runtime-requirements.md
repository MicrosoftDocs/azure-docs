...
If your data store is a managed cloud data service, where the access is restricted to IPs that are whitelisted in the firewall rules, you can use Azure integration runtime and allow list [its IPs](../articles/data-factory/azure-integration-runtime-ip-addresses.md). 

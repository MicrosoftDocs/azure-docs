...
You can deploy the scenario above using [PowerShell](../articles/virtual-network/virtual-networks-create-nsg-classic-ps.md) or the [Azure CLI](../articles/virtual-network/virtual-networks-create-nsg-classic-cli.md).
...
<sup>1</sup> Storage included in the daily rate for each tier. Additional storage may be used at an additional daily rate per GiB. For rate information, see [Azure Container Registry pricing][pricing].

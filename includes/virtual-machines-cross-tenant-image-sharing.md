...
Create a service principal for Tenant 2 to use for accessing the application by requesting a sign-in using a browser. Replace *<Tenant2 ID>* with the tenant ID for the tentant that you would like to share your image gallery with. Replace *<Application (client) ID>* with the application ID of the app registration you created. When done making the replacements, paste the URL into a browser and follow the sign-in prompts to sign into Tenant 2.

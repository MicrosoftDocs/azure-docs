...
> [!NOTE]
> You can add the app setting `WEBSITE_OVERRIDE_PRESERVE_DEFAULT_STICKY_SLOT_SETTINGS` to every slot of the app and set its value to “0” or “false”. With this, you can make all these settings swappable. However, they’re either all swappable or not at all. You can’t make just some settings swappable and not the others.

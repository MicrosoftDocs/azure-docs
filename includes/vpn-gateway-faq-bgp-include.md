...
* Routes learned from other BGP peering sessions connected to the Azure VPN gateway, **except default routes or routes overlapped with any VNet prefix**.

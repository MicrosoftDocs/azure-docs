...
1. On the Virtual Network page, navigate to the tab **Usage Information + Support**. Under **Usage Information**, you see "Deploy with Resource Manager". That is the default for creating a VNet. You do not want this. Select **(change to Classic)** to create a Classic VNet. Then, select the **Overview** tab and select **Create**.

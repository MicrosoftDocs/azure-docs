...
|----|:----:|:----:|:----:|:----:|
|[Local computer](how-to-set-up-training-targets.md#local)| maybe | yes | &nbsp; | &nbsp; |
|[Azure Machine Learning Compute](how-to-set-up-training-targets.md#amlcompute)| yes | yes & <br/>hyperparameter&nbsp;tuning | yes | yes |
...
|[Azure HDInsight](how-to-set-up-training-targets.md#hdinsight)| &nbsp; | &nbsp; | yes | &nbsp; |
|[Azure Batch](how-to-set-up-training-targets.md#azbatch)| &nbsp; | &nbsp; | yes | &nbsp; |

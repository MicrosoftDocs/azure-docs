...
To get the device password, sign into the [Azure portal](https://portal.azure.com). The device password is tied to a specific order in the portal. Go to **General > Device details**. Copy the **Device password**. 

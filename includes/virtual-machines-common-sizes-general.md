...
| Size | vCPU | RAM: GiB | Local SSD: GiB | Base Perf per vCPU | Credits banked / hour | Max Banked Credits | Max data disks | Max local disk: IOPS / MBps | Max uncached disk: IOPS / MBps | Max NICs / Max network perf (Mbps) |
|---------------|-----------|-------------|----------------|----------------------------|-----------------------|--------------------|----------------|----------------------------------------|-------------------------------------------|-------------------------------------------|

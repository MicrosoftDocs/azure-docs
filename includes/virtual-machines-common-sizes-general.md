...
| Size          | vCPU | Memory: GiB | Local SSD: GiB | Base Perf per vCPU | Credits banked / hour | Max Banked Credits | Max data disks | Max local disk throughput: IOPS / MBps | Max uncached disk throughput: IOPS / MBps | Max NICs / Max network perf (Mbps) |
|---------------|-----------|-------------|----------------|----------------------------|-----------------------|--------------------|----------------|----------------------------------------|-------------------------------------------|-------------------------------------------|

...
| Namespace size | Entity | <p>For a premium namespace, the total size limit for a premium namespace per [messaging unit](/azure/service-bus-messaging/service-bus-premium-messaging) is 1 TB. Total size of all entities in a namespace can't exceed this limit.</p><p>The total size limit for a standard namespace is 400 GB.</p>| | 

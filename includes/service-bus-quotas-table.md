...
| Number of messages (sent and received) per connection | Namespace | Subsequent attempts of sending or receiving messages will fail with the error message: `ServiceBusException: Put token failed. status-code 403, status-description: The maximum number of '1000' tokens per connection has been reached` . | 1000 |

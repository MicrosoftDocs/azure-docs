...
ms.author: sngun
---
When you're finished using your web app and Cosmos DB account, you can delete the Azure resources you created so you don't incur more charges. To delete the resources:

...
* If you want to configure secondary location for your APIM, the VNET and subnet region should match with the secondary location you are configuring. If you're adding/removing/enabling Availability zone in Primary region, or changing subnet of primary region, then VIP of APIM will change. Refer IP addresses of Azure API Management service (https://learn.microsoft.com/en-gb/azure/api-management/api-management-howto-ip-addresses#changes-to-the-ip-addresses).

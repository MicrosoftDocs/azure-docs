...
Also refer to the sample [Create a VM with multiple ultra disks](https://aka.ms/UltraSSDTemplate), which shows how to create a VM with multiple ultra disks.
...
## Additional ultra disk scenarios

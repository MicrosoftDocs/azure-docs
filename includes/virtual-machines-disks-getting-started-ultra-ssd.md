...
If you're interested, request access [here](https://aka.ms/UltraSSDPreviewSignUp).  
...
Determine the VM Size to deploy. As part of this preview, only DsV3 and EsV3 VM families are supported. Refer to the second table on this [blog](https://azure.microsoft.com/en-us/blog/introducing-the-new-dv3-and-ev3-vm-sizes/) for additional details about these VM sizes. 
Refer to the sample [Create a VM with multiple Ultra SSD disks](https://aka.ms/UltraSSDTemplate) that shows how to create a VM with multiple Ultra SSD disks.

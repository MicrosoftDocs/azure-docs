...
- The Node.js programming model shouldn't be confused with the Azure Functions runtime.
  ...
  A programming model defines how you author your code and is specific to JavaScript and TypeScript. A runtime defines underlying behavior of Azure Functions and is shared across all languages.
- The version of the programming model is strictly tied to the version of the [`@azure/functions`](https://www.npmjs.com/package/@azure/functions) npm package. It's versioned independently of the [runtime](../articles/azure-functions/functions-versions.md). Both the runtime and the programming model use 4 as their latest major version, but that's a coincidence.

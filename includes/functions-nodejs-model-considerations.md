...
- The Node.js programming model shouldn't be confused with the Azure Functions runtime:
  ...
  - A *programming model* defines how you author your code and is specific to JavaScript and TypeScript.
  - A *runtime* defines underlying behavior of Azure Functions and is shared across all languages.

...
- [How to setup enterprise-class WordPress web app](https://azure.microsoft.com/documentation/articles/web-sites-php-enterprise-wordpress/)
...
- [How to backup your web app](https://azure.microsoft.com/documentation/articles/web-sites-backup/) and [How to restore your web app](https://azure.microsoft.com/documentation/articles/web-sites-restore/)
...
- [How to enabled redis cache](https://azure.microsoft.com/documentation/articles/cache-dotnet-how-to-use-azure-redis-cache/) using [redis cache plugin](https://wordpress.org/plugins/wp-redis/)
- [How to enable memcached object cache for WordPress](https://azure.microsoft.com/documentation/articles/web-sites-connect-to-redis-using-memcache-protocol/) using [memcached plugin](https://wordpress.org/plugins/memcached/)

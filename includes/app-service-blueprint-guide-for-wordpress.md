...
- [Gather usage  telemetry using Azure Application Insights  service](/blog/usage-analytics-for-wordpress-with-azure-app-insights/)
...
- [How to enabled redis cache](cache-dotnet-how-to-use-azure-redis-cache/) using [redis cache plugin](https://wordpress.org/plugins/wp-redis/)

...
- [Regenerate your account key](../articles/storage/common/storage-account-keys-manage.md#regenerate-access-keys) via the Azure portal if you think it could be compromised.

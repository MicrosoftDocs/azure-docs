...
|Once you use a dataset in a labeling project, removing data will cause an error in the project | Don't remove data from the version of the dataset you used in a labeling project. Create a new version of the dataset to use for removing data.|

...
|When reviewing data, newly labeled items are not shown.     |   To load all labeled items, choose the **First** button. The **First** button will take you back to the front of the list, but loads all labeled data.      |

...
3. In the **Add schedule** blade, modify the snapshot type, backup frequency, retention, and start date and time. Click **Add**.<!--1) Find out: How do they "Disable the schedule to stop new backups being taken. Create a new schedule to take new backups."? 2) Verify what changes. Then advise that they can save a maximum of 64 backups per schedule. 3) Find out what else this include is shared with.--> 

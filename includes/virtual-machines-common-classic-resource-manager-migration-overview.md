...
| Compute | VM with backup or snapshot extension | These extensions are installed on a Virtual Machine configured with the Azure Backup service. To migrate these Virtual Machines, follow the guidance [here](../articles/virtual-machines/windows/migration-classic-resource-manager-faq.md.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json#i-backed-up-my-classic-vms-in-a-backup-vault-can-i-migrate-my-vms-from-classic-mode-to-resource-manager-mode-and-protect-them-in-a-recovery-services-vault).  |

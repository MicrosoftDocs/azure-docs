...
This quickstart will guide you through creating an Anomaly Detector resource using the Azure CLI. You can install the CLI with the following commands. See the Azure CLI installation instructions for more information:

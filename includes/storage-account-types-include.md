...
For applications requiring only block or append blob storage, we recommend using Blob storage accounts. See [Azure Blob Storage: Cool and Hot tiers](../articles/storage/storage-blob-storage-tiers.md) for more details.

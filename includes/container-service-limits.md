...
| Maximum nodes per cluster with Virtual Machine Scale Sets and [Standard Load Balancer SKU][standard-load-balancer] | 5000 nodes across all [node-pools][node-pool]. If you are unable to scale upto 5000 nodes in a cluster, [Contact support][Contact Support] for assistance.|

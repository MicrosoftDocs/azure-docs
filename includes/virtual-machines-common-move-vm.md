...
You can move a VM and its associated resources to a different subscription using the Azure portal.
...
7. When you are done, select that you understand that new resource IDs will be created and that the new IDs will need to be used with the VM after it is moved, then click **OK**.

## Use the Azure portal to move a VM to another resource group
You can move a VM and its associated resources to another resource group using the Azure portal.
...
6. When you are done, select that you understand that new resource IDs will be created and that the new IDs will need to be used with the VM after it is moved, then click **OK**.

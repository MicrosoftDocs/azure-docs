...
1. To install the SDK, click the link below. This tutorial requires Visual Studio 2013. If you don't have Visual Studio installed, Visual Studio Express for Web will be installed along with the SDK.

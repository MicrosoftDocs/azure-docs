...
For example, if your virtual network used the address space 10.0.0.0/16, then you could advertise 10.0.0.0/8. But you cannot advertise 10.0.0.0/16 or 10.0.0.0/24.

...
1. Depending on the permission model, configure either [Azure RBAC access](../key-vault/general/rbac-guide.md) or a [key vault access policy](../key-vault/general/assign-access-policy-portal.md).

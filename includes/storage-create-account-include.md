...
You can also create an Azure storage account by using [Azure PowerShell](storage-powershell-guide-full.md), [Azure CLI](storage-azure-cli.md), or the [Storage Resource Provider Client Library for .NET](https://msdn.microsoft.com/library/azure/mt131037.aspx).

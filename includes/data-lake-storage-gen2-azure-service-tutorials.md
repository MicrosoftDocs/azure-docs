...
| Azure service | Step-by-step guide | Article type
|---------------|-------------------|---|---|---|---|
| Azure Data Factory | [Load data into Azure Data Lake Storage Gen2 with Azure Data Factory](../articles/data-factory/load-azure-data-lake-storage-gen2) | Tutorial |
...
| Azure Databricks | [Extract, transform, and load data by using Azure Databricks](../articles/databricks/scenarios/databricks-extract-load-sql-data-warehouse) | Tutorial |
...
| Azure Data Box | [Use Azure Data Box to migrate data from an on-premises HDFS store to Azure Storage](../articles/storage/blobs/data-lake-storage-migrate-on-premises-hdfs-cluster.md) | How to |
| Azure Synapse Analytics | [Get Started with Azure Synapse Analytics](../articles/synapse-analytics/get-started.md) | Tutorial |
...
| Azure Data Explorer | [Query data in Azure Data Lake using Azure Data Explorer](../articles/data-explorer/data-lake-query-data) | How to |
...
> [!NOTE]
> This table doesn't reflect the complete list of Azure services that support Data Lake Storage Gen2. To see a list of supported Azure services, their level of support, see [Azure services that support Azure Data Lake Storage Gen2](../articles/storage/blobs/data-lake-storage-supported-azure-services.md). 

...
| Maximum ingress<sup>1</sup> per general-purpose v2 and Blob storage account (all other regions) | 25 Gbps</sup> |
...
| Maximum egress for general-purpose v2 and Blob storage accounts (all other regions) | 50 Gbps |

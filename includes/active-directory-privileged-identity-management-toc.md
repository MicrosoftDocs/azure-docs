...
- [How to give other admins access to Privileged Identityy Management](../articles/active-directory/active-directory-privileged-identity-management-how-to-give-access-to-pim.md)

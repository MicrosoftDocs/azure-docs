...
The current version of the Cognitive Services Speech SDK is 1.15.0.
...
1. In the window that appears, enter the name and version of the Speech SDK for Android, *com.microsoft.cognitiveservices.speech:client-sdk:1.15.0*. Then select **OK**.

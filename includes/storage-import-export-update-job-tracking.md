...
5. Track the job progress on the portal dashboard. For a description of each job state, go to [View your job status](../articles/import-export/storage-import-export-view-drive-status.md).

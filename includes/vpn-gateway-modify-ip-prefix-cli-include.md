...
If you don't have a gateway connection and you want to add or remove IP address prefixes, you use the same command that you use to create the local network gateway. You can also use this command to update the gateway IP address for the VPN device. 
...
If you have a gateway connection and want to add or remove IP address prefixes, you can update the local network gateway. This results in some downtime for your VPN connection. When modifying the IP address prefixes, you don't need to delete the VPN gateway.

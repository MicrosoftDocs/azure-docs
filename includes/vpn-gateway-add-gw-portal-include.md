...
1. On the **Virtual network gateways** page, select **+ Create**. This opens the **Create virtual network gateway** page.
   ...
   :::image type="content" source="./media/vpn-gateway-add-gw-portal/create.png" alt-text="Screenshot of virtual network gateways page with Create highlighted.":::
1. On the **Basics** tab, fill in the values for **Project details** and **Instance details**.

   :::image type="content" source="./media/vpn-gateway-add-gw-portal/instance-details.png" alt-text="Screenshot of Instance fields.":::
   ...
   * **Generation**: Select the generation. For more information, see [Gateway SKUs](../articles/vpn-gateway/vpn-gateway-about-vpngateways.md#gwsku).

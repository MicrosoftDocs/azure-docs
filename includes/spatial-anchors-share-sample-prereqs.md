...
* One or more devices (iOS or Android) on which to deploy and run an app.
  * If you're using Android, you need to have:
    * <a href="https://developer.android.com/studio/" target="_blank">Android Studio 3.3</a>  or later, <a href="https://unity3d.com/get-unity/download" target="_blank">Unity 2019.4 (LTS)</a>, and <a href="https://git-scm.com/download/win" target="_blank">Git for Windows</a> installed on your Windows computer.
  ...
  * If you're using iOS, you need to have:
    * A macOS computer on which <a href="https://geo.itunes.apple.com/us/app/xcode/id497799835?mt=12" target="_blank">Xcode 10</a> or later, <a href="https://cocoapods.org" target="_blank">CocoaPods</a>, and <a href="https://unity3d.com/get-unity/download" target="_blank">Unity 2019.4 (LTS)</a> are installed.

...
* Click Azure Portal > Mobile Services > your mobile service > Dashboard, and notice the Mobile Service URL value.
...
* Click Azure Portal > Mobile Services > your mobile service > Identity, and enter the app ID and secret value. You're now configured both your app and your mobile service to work with your auth provider. You may optionally repeat all these steps for each additional identity provider you'd like to support.

...
| Data retention | 90 days | This resource is for [Search](../articles/azure-monitor/app/diagnostic-search.md), [Analytics](../articles/azure-monitor/log-query/log-query-overview.md), and [Metrics Explorer](../articles/azure-monitor/platform/metrics-charts.md).

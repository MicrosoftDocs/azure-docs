...
For more information about this script, see [Get the hostname, ports, and keys for Azure Cache for Redis](../articles/azure-cache-for-redis/scripts/cache-keys-ports.md). For more information on Azure CLI see [Install Azure CLI](/cli/azure/install-azure-cli) and [Get started with Azure CLI](/cli/azure/get-started-with-azure-cli).

...
2. Use the **COPY LOG PATH** for a drive to locate the folder with the logs for your drive. The folder will have a copy log. If you chose to save a verbose log, the folder also hstatuas a verbose log.

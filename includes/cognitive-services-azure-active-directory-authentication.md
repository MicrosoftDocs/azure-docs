...
> [!IMPORTANT]
> 1. Currently, **only** the Computer Vision API, Face API, Text Analytics API, and Immersive Reader support authentication using Azure Active Directory (AAD).

...
> [!IMPORTANT]
> Creation of files (irrespective of the storage type) is allowed up to 5 TB. However, a file created whose size is greater than the upload limit defined in the preceding table does not get uploaded. You have to manually delete the file to reclaim the space.
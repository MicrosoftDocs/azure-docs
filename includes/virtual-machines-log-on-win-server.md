...
3. In the **Windows Security** window, select **More choices** and then **Usew a different account**. Type the credentials for an account on the virtual machine and then click **OK**.

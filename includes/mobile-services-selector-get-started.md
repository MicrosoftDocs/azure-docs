...
- [(Windows Phone | .NET)](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-phone-get-started/)
- [(Windows Phone | JavaScript)](/en-us/documentation/articles/mobile-services-windows-phone-get-started/)
- [(Windows Store C# | .NET)](/en-us/documentation/articles/test-mobile-services-dotnet-backend-windows-store-dotnet-get-started/)
- [(Windows Store C# | Javascript)](/en-us/documentation/articles/test-mobile-services-windows-store-get-started/)
- [(Windows Store JavaScript | .NET)](/en-us/documentation/articles/test-mobile-services-dotnet-backend-windows-store-javascript-get-started/)
- [(Windows Store JavaScript | Javascript)](/en-us/documentation/articles/test-mobile-services-windows-store-get-started/)
- [(Xamarin iOS | .NET)](/en-us/documentation/articles/test-mobile-services-dotnet-backend-xamarin-ios-get-started/)

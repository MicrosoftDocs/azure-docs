...
| General-purpose v2 Standard  | Y | Y | Y | Both hot and cool tiers are supported.</br>Azure Data Lake Storage Gen2 (ADLS Gen2) is supported for imports but not for exports.|
...
| General-purpose v1 Standard  | Y | Y | Y | Both hot and cool tiers are supported. |
| General-purpose v1 Premium  |  | Y| | |
| General-purpose v2 Standard  | Y | Y | Y | Both hot and cool tiers are supported. |
| General-purpose v2 Premium  |  |Y | | |
| Azure Premium FileStorage |  |  | Y |  |
| Blob storage Standard |Y | | | Both hot and cool tiers are supported. |
| Block Blob storage Premium |Y | | | Both hot and cool tiers are supported. |

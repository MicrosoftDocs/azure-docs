...
> - Archive blobs are not supported for export. Rehydrate the blobs in archive tier before you export. For more information, see [Rehydrate an archived blob to an online tier](../storage/blobs/storage-blob-rehydration.md#rehydrate-an-archived-blob-to-an-online-tier).

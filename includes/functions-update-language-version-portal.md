...
1. Select **Save** and when notified about a restart select **Continue**. This change updates the [`WEBSITE_NODE_DEFAULT_VERSION`](./functions-app-settings.md#website-node-default-version) application setting.  
::: zone-end  

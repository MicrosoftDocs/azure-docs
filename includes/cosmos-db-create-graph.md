...
1. In the Azure portal, in the left navigation menu, select **Data Explorer (Preview)**.

2. In the **Data Explorer (Preview)** blade, select **New Graph**, and then fill in the page by using the following information:

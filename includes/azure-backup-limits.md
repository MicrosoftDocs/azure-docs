...
|Size of a data source for data stored in Azure vault storage|1.65 TB max|
...
|Number of recovery points that can be created|366<sup>1</sup>|
|Data disks attached to an Azure virtual machine for backup|5|

<sup>1</sup>You can use any permutation to arrive at a number which is less than 366.

...
- Azure Backup is only available through [Azure Disk Backup (preview)](../articles/backup/backup-managed-disks.md?context=/azure/virtual-machines/context/context).

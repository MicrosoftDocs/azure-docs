...
- When using Availability sets and virtual machine scale sets with Azure shared disks, [storage fault domain alignment](../articles/virtual-machines/availability.md#use-managed-disks-for-vms-in-an-availability-set) with virtual machine fault domain is not enforced for the shared data disk.

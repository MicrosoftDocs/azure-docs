...
- Azure Backup is only available through [Azure Disk Backup (preview)](../articles/backup/disk-backup-overview.md?context=/azure/virtual-machines/context/context).

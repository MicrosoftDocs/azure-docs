...
Select **Create a new Azure AD B2C Tenant**. The settings specified in the table below use the ficitious company Contoso as an example. You will need to provide your own organization name and an unique tenant name when creating your tenant.  

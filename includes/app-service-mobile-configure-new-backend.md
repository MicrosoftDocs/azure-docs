...
2. Under **Create a table API**, select your **Backend language**, either C# or Node.js:
	...
	+ **C# (.NET Backend)**:  
		...
		For detailed, step-by-step instructions on deploying the C# project to Azure, see [How to: Publish Server Project with Visual Studio](app-service-mobile-dotnet-backend-how-to-use-server-sdk.md#publish-server-project). 

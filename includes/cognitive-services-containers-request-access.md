...
> [!IMPORTANT]
> You must use an email address associated with either a Microsoft Account (MSA) or an Azure Active Directory (Azure AD) account in the form. For more information on the acceptance criteria, see the [application](aka.ms/cognitivegate).

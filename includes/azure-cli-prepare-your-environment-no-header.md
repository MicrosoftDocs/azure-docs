...
- Prepare your environment for the Azure CLI:
  ...
  - Start [Azure Cloud Shell](/azure/cloud-shell/quickstart) using the bash environment or, if you want to run Azure CLI locally, do a [local install](/cli/azure/install-azure-cli) of the Azure CLI.

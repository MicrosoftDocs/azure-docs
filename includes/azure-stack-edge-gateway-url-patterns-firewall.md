...
|   https://www.msftconnecttest.com/connecttest.txt  |    Required for web proxy test/validation. URL is used to validate connectivity before applying the configuration.  | 

...
4. After the prepare to ship is successfully complete (with no errors), follow these steps:
    ...
    4. If the E-ink is not displaying the shipping label, you can download the [reverse shipment label](/azure/databox/data-box-portal-admin). Make sure you have the shipping label before you shut down and disconnect the device.

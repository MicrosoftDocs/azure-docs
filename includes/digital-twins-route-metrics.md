---
author: baanders
description: include file for Azure Digital Twins route metrics
...
For more on viewing Azure Digital Twins metrics, see [*How-to: View metrics with Azure Monitor*](../articles/digital-twins/how-to-view-metrics.md).
...
6. It takes a few minutes to create the account. you'll see a **Your deployment is underway** message. Wait for the deployment to finish and then select **Go to resource**.

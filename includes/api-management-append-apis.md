...
An API can be composed of APIs exposed by different services, including the OpenAPI Specification, a SOAP API, Azure Web App, Azure Function App, Azure Logic App, and Azure Service Fabric.

...
> 
> SAS is critical to protect as well. While providing granularity SAS grants clients access to the resources in your storage account and should not be shared publically. When sharing is required for troubleshooting reasons consider using a redacted version of the log files and make sure the screenshots don't contain the SAS information.
> 

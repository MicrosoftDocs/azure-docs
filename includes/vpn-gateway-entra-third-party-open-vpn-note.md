...
---
> [!NOTE]
> The steps in this article apply to Microsoft Entra ID authentication with third-party App ID. This type of authentication is supported only for OpenVPN® protocol.
>

...
2. In the left menu, click **New**, click **Data + Storage**, and then click **Azure Cosmos DB**.
   ...
   ![Screen shot of the Azure portal, highlighting More Services, and Azure Cosmos DB](./media/cosmosdb-create-dbaccount-mongodb/create-nosql-db-databases-json-tutorial-1.png)
...
3. In the **New account** blade, specify the desired configuration for the Azure Cosmos DB account. 
    ...
    AP|MongoDB|We'll be programming against the [MongoDB API](../documentdb/documentdb-protocol-mongodb.md) later in this article.|

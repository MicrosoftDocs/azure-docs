...
> [!TIP]
> Don't include the key directly in your code, and never post it publicly. See the Foundry Tools [security](../articles/cognitive-services/security-features.md) article for more authentication options like [Azure Key Vault](../articles/cognitive-services/use-key-vault.md). 

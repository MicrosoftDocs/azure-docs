...
- Tutorials
    ...
    |[Move resources](../articles/azure-resource-manager/resource-manager-tutorial-move-resources.md)|Move resources from one resource group to another resource group. In the tutorial, you run an existing template to create two resource group and one storage account, and then run an Azure PowerShell cmdlets to move the storage account to the other resource group.|

...
Note that the steps in this article assume that you already have SQL Server running on an Azure virtual machine. If not, see [Provision a SQL Server virtual machine in Azure](../articles/azure-sql/virtual-machines/windows/create-sql-vm-portal.md). For other guidance on running SQL Server on Azure VMs, see [SQL Server on Azure Virtual Machines overview](../articles/azure-sql/virtual-machines/windows/sql-on-azure-vm-iaas-what-is-overview.md).

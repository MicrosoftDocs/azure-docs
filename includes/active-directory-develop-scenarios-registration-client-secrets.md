...
- The application secret (also named the client secret) is generated in the app registration portal for the confidential client application. This generation happens when you select **New client secret**. At that point, you must copy the secret string to the clipboard for use in your app, before you select **Save**. This string won't be presented any longer.

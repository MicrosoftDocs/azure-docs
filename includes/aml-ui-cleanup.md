...
In the visual interface where you created your experiment, delete individual assets by selecting them and then selecting the **Delete** button. Datasets can be *unregistered* by selecting each dataset and selecting **Unregister**.

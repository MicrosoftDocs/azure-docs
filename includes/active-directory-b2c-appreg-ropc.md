...
1. Under **Advanced settings**, select **Yes** in the section **Enable the following mobile and desktop flows** to treat the application as a public client. This setting is required for the ROPC flow.
1. Select **Save**.

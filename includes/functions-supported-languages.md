...
|-----------------------------------------|------------|---| --- |
|[C#](../articles/azure-functions/functions-dotnet-class-library.md)<sup>1</sup>|GA (.NET Framework 4.8)|GA (.NET Core 2.1<sup>2</sup>)| GA (.NET Core 3.1)<br/>[Preview (.NET 5.0)](../articles/azure-functions/dotnet-isolated-process-guide.md) |
...
<sup>1</sup> An experimental version of Azure Functions is available that lets you use the .NET 6.0 preview. To learn more, see the [C# class library article](../articles/azure-functions/functions-dotnet-class-library.md#supported-versions).

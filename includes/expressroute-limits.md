...
| --- | --- |
| ExpressRoute circuits per subscription (classic) |10 |
...
| Maximum number of ExpressRoute circuits linked to the same virtual network in the same or different peering locations |4 |

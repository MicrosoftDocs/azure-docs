...
1. Set up a role assignment authorization using the following command, replacing **{MyAppId}** with your **AppId**.
   ...
   To understand roles and permissions, see [Create or update Azure custom roles using Azure PowerShell](https://docs.microsoft.com/en-us/azure/role-based-access-control/custom-roles-powershell).

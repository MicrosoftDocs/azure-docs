...
1. Provide your GitHub user name and password. To confirm access from Azure Logic Apps to your GitHub account, authorize Microsoft (**aaptaps**) to create the connection.

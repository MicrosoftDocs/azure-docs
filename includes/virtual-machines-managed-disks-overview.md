...
Temporary disks are not managed disks, and are not encrypted by Storage Service Encryption. For more more details on temporary disks, see [Disk Roles](#disk-roles).

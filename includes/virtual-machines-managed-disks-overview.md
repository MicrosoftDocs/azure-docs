...
Temporary disks are not managed disks, and are not encrypted by Storage Service Encryption. For more more details, see [Disk Roles: Temporary disk](#temporary-disk).

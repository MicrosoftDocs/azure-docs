...
Managed Disks will allow you to create up to [50,000 VM **disks** of a type in a subscription per region](../articles/azure-subscription-service-limits#virtual-machine-disk-limits), which will enable you to create thousands of **VMs** in a single subscription. This feature also further increases the scalability of [Virtual Machine Scale Sets](../articles/virtual-machine-scale-sets/virtual-machine-scale-sets-overview.md) by allowing you to create up to a thousand VMs in a virtual machine scale set using a Marketplace image. 

...
7. You can now [use the Azure portal to install Update 1.2](#use-the-azure-portal-to-install-update-1). Follow the instructions starting from step 3 of this procedure. After you have installed all the updates, you can re-enable the network interface that you disabled. 

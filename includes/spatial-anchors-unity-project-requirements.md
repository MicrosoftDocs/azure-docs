...
ms.author: parkerra
---
Azure Spatial Anchors can be configured in Unity using the following:
- Unity: <a href="https://unity.com/releases/2019-lts" target="_blank">2019.4 (LTS)</a>
...
- ARCore XR Plugin (Android only): <a href="https://docs.unity3d.com/Packages/com.unity.xr.arcore@3.1/manual/index.html" target="_blank">3.1.3</a>
- ARKit XR Plugin (iOS only): <a href="https://docs.unity3d.com/Packages/com.unity.xr.arkit@3.1/manual/index.html" target="_blank">3.1.3</a>

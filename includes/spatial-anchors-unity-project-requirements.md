...
> [!IMPORTANT] The Mixed Reality OpenXR Plugin is only supported on ASA SDK version 2.10.0 or later
- Mixed Reality OpenXR Plugin: [1.1.2](https://docs.microsoft.com/en-us/windows/mixed-reality/develop/unity/xr-project-setup?tabs=openxr)

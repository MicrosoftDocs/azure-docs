...
1. Once complete, copy the value of the **Application ID** field (see image below) and paste it to a temporary *Notepad* file; this value identifies your Azure Active Directory app. You will use this to configure your sample application in the proceeding sections.
...
1. Open your app registration pane, and click **Settings** > **Required permissions**:
    ...
    - Click **Select an API**, search for **Azure Digital Twins** API, select the **Azure Digital Twins (Azure Smart Spaces Service)** and click **Select**.

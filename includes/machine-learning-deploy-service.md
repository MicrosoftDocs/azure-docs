...
[!notebook-python[] (~/azureml-examples-main/tutorials/deploy-local/2.deploy-local-cli.ipynb?name=deploy-model-code)]

# [Python](#tab/python)


[!notebook-python[] (~/azureml-examples-main/tutorials/deploy-local/1.deploy-local.ipynb?name=deploy-model-code)]

[!notebook-python[] (~/azureml-examples-main/tutorials/deploy-local/1.deploy-local.ipynb?name=deploy-model-print-logs)]

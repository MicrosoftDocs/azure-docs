<properties title="Developer guide for the C device libraries for Azure Intelligent Systems Service" pageTitle="Developer guide for the C device libraries for Azure Intelligent Systems Service" description="Learn how to use the C device libraries for ISS to write a device application." metaKeywords="intelligent systems,iss" services="intelligent-systems" solutions="" documentationCenter="" authors="kevinasg" videoId="" scriptId="" manager="jillfra" />

<tags ms.service="intelligent-systems" ms.devlang="multiple" ms.topic="article" ms.tgt_pltfrm="multiple" ms.workload="tbd" ms.date="11/13/2014" ms.author="kevinasg" />

<!--The next line, with one pound sign at the beginning, is the page title--> 
# Developer guide for the C device libraries for Azure Intelligent Systems Service

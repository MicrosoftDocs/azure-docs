...
- Use [Azure Cloud Shell](../articles/cloud-shell/quickstart.md) via the Bash environment.

   [![Embed launch](media/cloud-shell-try-it/hdi-launch-cloud-shell.png "Launch Azure Cloud Shell")](https://shell.azure.com)  

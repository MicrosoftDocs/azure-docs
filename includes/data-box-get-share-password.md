...
2. In the **Access share and copy data** dialog box, copy the **Password** corresponding to the share. Then select **OK**.
    ...
    ![Screenshot showing the Access Share And Copy Data dialog box in the local Web UI for an SMB share on the Data Box. The Copy icon for the Password and the OK button are highlighted.](media/data-box-get-share-password/get-share-credentials-02.png)<!--Remove box from the copy icon for Storage Account and User Name.-->
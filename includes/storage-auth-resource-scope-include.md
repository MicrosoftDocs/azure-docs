...
> [!IMPORTANT]
> If your subscription includes an Azure DataBricks namespace, then you cannot currently scope an RBAC role assignment for access to Azure Storage blob and queue data to the subscription.
...
![Windows Azure components](./media/intro-to-windows-azure/IntroAzure1.png)   
...
![Windows Azure data management](./media/intro-to-windows-azure/IntroAzure3.png)   
...
![Windows Azure networking](./media/intro-to-windows-azure/IntroAzure4.png)   
...
The owner of an application defines rules that specify how requests from users should be directed to datacenters, then relies on Traffic Manager to carry out these rules. For example, users might normally be directed to the closest Windows Azure datacenter, but get sent to another one when the response time from their default datacenter exceeds the response time from other datacenters. For globally distributed applications with many users, having a built-in service to handle problems like these is useful.
...
![Windows Azure analytics](./media/intro-to-windows-azure/IntroAzure5.png)   
...
![Windows Azure messaging](./media/intro-to-windows-azure/IntroAzure6.png)   
...
![Windows Azure Caching](./media/intro-to-windows-azure/IntroAzure7.png)   
...
![Windows Azure Media Services](./media/intro-to-windows-azure/IntroAzure8.png)   

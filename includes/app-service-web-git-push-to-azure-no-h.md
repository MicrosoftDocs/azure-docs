...
Push to the Azure remote to deploy your app with the following command. When prompted for a credientials by Git Crediential Manager, make sure that you enter the credientials you created in [Configure a deployment user](#configure-a-deployment-user), not the credientials you use to log in to the Azure portal.

...
The **self-service window** lets you start the maintenance on your VMs. During this time which is typically 4 weeks, you can query each VM to see their status and check the result of your last maintenance request.

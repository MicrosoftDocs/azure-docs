...
1. Place the device into Maintenance mode. See [To enter Maintenance mode](#to-enter-maintenance-mode) for instructions on how to enter Maintenance mode.
...
6. After the hotfixes are applied, exit Maintenance mode. See [To exit Maintenance mode](#to-exit-maintenance-mode) for instructions.

...
1. Place the device into Maintenance mode. See [To enter Maintenance mode](storsimple-enter-maintenance-mode.md) for instructions on how to enter Maintenance mode.
...
6. After the hotfixes are applied, exit Maintenance mode. See [To exit Maintenance mode](storsimple-exit-maintenance-mode.md) for instructions.

...
Before you can implement multi NICs in VMs, it is necessary to understand when you can use multi NICs, and how they are used. Read the [multi NIC overview](../articles/virtual-network/virtual-network-deploy-multinic-classic-ps.md) to learn more about VMs with multiple NICs.

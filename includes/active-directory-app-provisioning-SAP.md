...
1. On the **Capabilities** page, fill in the boxes with the values specified in the table below and select **Next**.
     ...
     [![Screenshot that shows the Capabilities page.](.\media\active-directory-app-provisioning-sap\sap-capabilities-1.png)](.\media\active-directory-app-provisioning-sap\sap-capabilities-1.png#lightbox)
...
8. On the **Global** page, fill in the boxes with the values specified in the table that follows the image and select **Next**.
     ...
     [![Screenshot that shows the Global page.](.\media\active-directory-app-provisioning-sap\sap-global-1.png)](.\media\active-directory-app-provisioning-sap\sap-global-1.png#lightbox)
...
1. On the **Object Types** page, fill in the boxes and select **Next**. Use the table that follows the image for guidance on the individual boxes.   
     ...
     [![Screenshot that shows the Object Types page.](.\media\active-directory-app-provisioning-sap\sap-ots-1.png)](.\media\active-directory-app-provisioning-sap\sap-ots-1.png#lightbox)
...
Now you will map attributes between the representation of the user in Azure AD and the representation of the user in SAP ECC 7.

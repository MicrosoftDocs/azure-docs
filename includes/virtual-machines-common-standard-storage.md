...
This article focuses on the use of standard SSD and HDD disks. For more information about the use of storage with blobs, tables, queues, and files, please refer to the [Introduction to Storage](../articles/storage/common/storage-introduction.md).
...
**Standard SSD disks:** Standard SSD disks provide more reliable performance than Standard HDD disks, and are currently available in preview. For more information about region availability of Standard SSD disks, see [](../articles/virtual-machines/windows/faq-for-disks.md#standard-ssds-azure-regions).

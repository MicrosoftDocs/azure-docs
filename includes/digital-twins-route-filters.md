...
| Source | Name of Azure Digital Twins instance | `source = '<host-name>'`| Here are the possible host name values: <br> **For notifications**: `<yourDigitalTwinInstance>.api.<yourRegion>.digitaltwins.azure.net` <br> **For telemetry**: `<yourDigitalTwinInstance>.api.<yourRegion>.digitaltwins.azure.net/<twinId>`|

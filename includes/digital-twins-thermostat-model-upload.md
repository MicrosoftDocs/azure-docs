...
To **upload this model to your twins instance**, run the following Azure CLI command, which uploads the above model as inline JSON. You can run the command in [Azure Cloud Shell](../articles/cloud-shell/overview.md) in your browser by selecting **Bash** environment, or on your machine if you have the CLI [installed locally](/cli/azure/install-azure-cli).

...
As you can see, when using a SAS, you’re not exposing your account name and account key in your application. You can learn more about SAS by checking out [Shared Access Signatures: Understanding the SAS model](./storage-dotnet-shared-access-signature-part-1.md).

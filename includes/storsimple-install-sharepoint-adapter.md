...
3. Double-click the installer. The StorSimple Adapter for SharePoint Setup Wizard starts. Click **Next** to begin the installation.
    ...
    ![StorSimple adapter setup start page](./media/storsimple-adapter-for-sharepoint/HCS_SSASP_Setup1-include.png)
...
4. In the StorSimple Adapter for SharePoint setup configuration page, select an installation location, type the IP address for the DATA 0 network interface on your StorSimple device, and then click **Next**. 
    ...
    ![StorSimple adapter setup configuration page](./media/storsimple-adapter-for-sharepoint/HCS_SSASP_Setup2-include.png) 

5. In the setup confirmation page, click **Install**.

    ![StorSimple adapter setup confirmation page](./media/storsimple-adapter-for-sharepoint/HCS_SSASP_Confirm_Setup-include.png) 

6. Click **Finish** to close the Setup Wizard.

    ![StorSimple adapter setup finished page](./media/storsimple-adapter-for-sharepoint/HCS_SSASP_Setup_finish-include.png) 

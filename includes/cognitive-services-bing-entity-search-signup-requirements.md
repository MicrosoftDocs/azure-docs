...
Start using the Bing Entity Search API by creating one of the Azure resources below.
...
* [Create a Bing Entity Search resource](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingEntitySearch):

...
1. Update the network security group to allow SSH access. The following command assumes the name of the network security group is **contoso-simulation-nsg** -- replace this value with the name of your network security group:
    ...
    Only enable SSH access during test and development. If you enable SSH, [you should disable it again as soon as possible](../articles/security/fundamentals/network-best-practices.md#disable-rdpssh-access-to-virtual-machines).

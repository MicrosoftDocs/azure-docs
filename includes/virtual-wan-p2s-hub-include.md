...
1. Configure the following settings:
   ...
   * **Use Remote/On-premises RADIUS server** - 
       ...
       Note that you must turn on "Use Remote/On-premises RADIUS server" if users will connect to the global VPN profile instead of the hub-based profile. For more information, see [global and hub-level profiles](../virtual-wan/global-hub-profile.md).

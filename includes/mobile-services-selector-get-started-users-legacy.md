...
- [(Windows 8 C# | .NET)](../articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started-users.md)
- [(Windows 8 C# | Javascript)](../articles/mobile-services-windows-store-dotnet-get-started-users.md)
- [(Windows 8 JavaScript | Javascript)](../articles/mobile-services-windows-store-javascript-get-started-users.md)
- [(Windows Phone 8 (Silverlight) | .NET)](../articles/mobile-services-dotnet-backend-windows-phone-get-started-users.md)
- [(Windows Phone 8 (Silverlight) | Javascript)](../articles/mobile-services-windows-phone-get-started-users.md)

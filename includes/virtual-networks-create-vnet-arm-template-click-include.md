...
3. Click **Deploy to Azure**. If necessary, enter your Azure login credentials. Int eh **Parameters** blade, enter the values you want to use to create your new VNet, and then click **OK**. The figure below shows the values for our scenario.

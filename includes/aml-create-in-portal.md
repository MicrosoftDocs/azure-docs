...
In the **ML service workspace** pane, configure your workspace.
   ...
   Subscription |Select the Azure subscription that you want to use. If you have multiple subscriptions, select the subscription that's used for billing.
   ...
   Location | Select the location closest to your users and the data resources. This is where the workspace is created.

...
1. Review your workspace configuration. If it's correct, select **Create**. It can take a few moments to create the workspace.

1. To check on the status of the deployment, select the notifications **bell** icon on the toolbar.
=======
1. Review your workspace configuration, and select **Create**. It can take a few moments to create the workspace.
>>>>>>> 03dea7d1b640e324b2e60970d7ad28d6cb35a63b

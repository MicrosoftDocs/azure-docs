...
1. Select **Create a device** from the **All devices** pane to open the **Create a new device** window. (If you're using an existing application that already has one or more devices, select **+ New** to open the window.)

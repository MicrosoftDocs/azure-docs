...
Open your PowerShell console and connect to your account. For more information, see [Sign in](/azure/install-az-ps.md?view=azps-1.2.0#sign-in)(/powershell/azure/install-az-ps?view=azps-1.4.0#sign-in).

...
---
1. In the Azure portal, on the left side, select **Create a resource** and enter *virtual network gateway* in search. Locate and select **Virtual network gateway** in the search list. On the **Virtual network gateway** page, select **Create** at the bottom of the page to open the **Create virtual network gateway** page.

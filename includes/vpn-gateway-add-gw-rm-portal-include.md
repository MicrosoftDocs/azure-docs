...
14. Click **Create** to begin creating the gateway. The settings will be validated and the gateway will begin deploying. Creating a gateway can take up to 45 minutes.

...
| --- | --- | --- |
| Metric alerts (classic) |100 active alert rules per subscription. <p>Classic alerts are [retired](https://learn.microsoft.com/previous-versions/azure/azure-monitor/alerts/monitoring-classic-retirement) for public cloud users. <p>Classic alerts for Azure Government cloud and Microsoft Azure operated by 21Vianet will retire on 29 February 2024.| Call support. |

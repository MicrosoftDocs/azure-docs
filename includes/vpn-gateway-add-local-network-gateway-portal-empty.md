...
1. On the **Create local network gateway page**, specify the values for your local network gateway.
   ...
   :::image type="content" source="./media/vpn-gateway-add-local-network-gateway-portal-empty/create-ip.png" alt-text="Create a local network gateway with IP address":::

...
- To run Azure CLI commands, do a [local install](/cli/azure/install-azure-cli) of the Azure CLI, or start [Azure Cloud Shell](/azure/cloud-shell/quickstart) using the bash environment.

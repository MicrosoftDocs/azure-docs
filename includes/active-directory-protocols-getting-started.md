...
First, you will need to register your application with your Azure Active Directory (Azure AD) tenant. This will give you a client ID for your application, as well as enable it to receive tokens.
...
* Once you've completed registration, AAD will assign your application a unique client identifier, the Application Id. You will need this value in the next sections, so copy it from the application page.

...
3. After the app registration is successfully created, select the new app name. Select **Next**, and then select **Associate**. This adds the required Windows Store registration information to the application manifest.

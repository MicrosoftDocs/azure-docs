...
Start using the Bing Video Search API by creating one of the Azure resources below.
...
* [Create a Bing Search v7 resource](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7):

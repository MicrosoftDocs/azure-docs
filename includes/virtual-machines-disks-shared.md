...
Because ultra disks offer an additional lock, their reservation flow can work as described in the earlier section, or it can lock and distribute performance more granularly.

...
For information about how to retrieve the storage account access keys, see [Manage storage account access keys](../articles/storage/common/account-keys-manage.md).

...
1. Select **Connect VPN Sites** to open the **Connect sites** page.
   ...
   * Enter a pre-shared key. If you don't enter a key, Azure auto-generates one for you.
...
3. In a few minutes, the site will show the connection and connectivity status.
   ...
   **Connection Status:** This is the status of the Azure resource for the connection which connects the VPN Site to the Azure hub’s VPN gateway. Once this control plane operation is successful, Azure VPN gateway and the on-premises VPN device will proceed to establish connectivity.

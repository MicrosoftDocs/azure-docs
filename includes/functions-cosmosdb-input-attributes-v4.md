...
|**PartitionKey**| Specifies the partition key value for the lookup. May include binding parameters. It is required for lookups in [partitioned](/azure/cosmos-db/partitioning-overview#logical-partitions) containers.|

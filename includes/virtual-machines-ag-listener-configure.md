...
2. [Add the client access point](#addcap).
...
#### <a name="getnet"></a>1. Get the name of the cluster network resource
...
#### <a name="addcap"></a>2. Add the client access point
...
#### <a name="congroup"></a>3. Configure the IP resource for the availability group
...
#### <a name = "dependencyGroup"></a>4. Make the SQL Server availability group resource dependent on the client access point
...
#### <a name="listname"></a>5. Make the client access point resource dependent on the IP address
...
#### <a name="setparam"></a>6. Set the cluster parameters in PowerShell

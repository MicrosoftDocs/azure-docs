...
1. In the **Set Modules** screen from the Edge device details, click the **Configure advanced Edge Runtime settings**, and under **Edge Hub** environment variables add an entry **UpstreamProtocol** with value **MQTT**. Add the same environment variable and value for the **Edge Agent** as well. 

1. Click **Save** and be sure the **Submit** the changes after clicking **Next** two times.

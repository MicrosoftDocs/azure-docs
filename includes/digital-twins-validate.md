...
There is a language-agnostic sample available for validating model documents to make sure the DTDL is correct before uploading it to your instance. It is located here: [**DTDL Validator sample**](/samples/azure-samples/dtdl-validator/dtdl-validator).

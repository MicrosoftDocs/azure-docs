...
Once inside the folder, navigate into *AdtSampleApp\SampleClientApp* and open the *appsettings.json* file. This JSON file contains the necessary configuration variables to run the project.

...
For Azure Digital Twins, this role is **Azure Digital Twins Data Owner**. You can read more about roles and security in [*Concepts: Security for Azure Digital Twins solutions*](../articles/digital-twins/concepts-security.md).

> [!NOTE]
> Note that this role is different from the Azure AD **Owner** role, which can also be assigned at the scope of the Azure Digital Twins instance. These are two distinct management roles, and Owner does not grant access to data plane features that are granted with **Azure Digital Twins Data Owner**.

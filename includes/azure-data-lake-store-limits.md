...
**Azure Data Lake Storage Gen2** is the latest release of capabilities dedicated to big data analytics. It is not a dedicated service or storage account type. These capabilities are available in a general-purpose v2 or BlockBlobStorage storage account, and you can obtain them by enabling the **Hierarchical namespace** feature of the account. For scale targets, see these articles. 

...
3. In the new **SignalR** settings blade, add the following settings for your new SignalR resource:
    ...
    | Resource group | Create a new resource group named *TestSignalRGroup*| Select or create a resource group for your SignalR resource. This is useful for grouping multiple resources that you may want to delete at the same time by deleting the resource group. For more information, see [Using Resource groups to manage your Azure resources](../articles/azure-resource-manager/resource-group-overview.md). |
    ...
    ![Create SignalR settings](media/signalr-create/signalr-create-settings.png) 

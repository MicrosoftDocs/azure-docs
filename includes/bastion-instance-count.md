...
---
Azure Bastion supports manual host scaling. You can configure the number of host instances in order to manage the number of concurrent RDP/SSH connections that Azure Bastion can support. 

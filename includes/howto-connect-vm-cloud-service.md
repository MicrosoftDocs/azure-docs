...
1.	Create the virtual network in the [Azure Portal](http://manage.windowsazure.com). For more information, see [Virtual Network Configuration Tasks](../services/virtual-machines/).

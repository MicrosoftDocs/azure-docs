...
In this section, you'll write a Windows console app that simulates a device sending device-tocloud messages to an IoT hub.

1. In the current Visual Studio solution, create a new Visual C# Desktop App project using the **Console  Application** project template. Name the project **ProcessDeviceToCloudMessages**.

...
| Objects |<ul><li>A maximum of 500,000 objects can be created in a single directory by users of the Free edition of Azure Active Directory.</li><li>A non-admin user can create no more than 250 objects. Both active objects and deleted objects that are still available to restore count toward this quota. Permanently deleted objects count toward this quota at a value of 1/4.</li></ul> |

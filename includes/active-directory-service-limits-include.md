...
| Category | Limits |
| --- | --- |
| Directories |A single user can be a member of a maximum of 500 Azure Active Directory directories.<br/>A single user can create a maximum of 20 directories. |

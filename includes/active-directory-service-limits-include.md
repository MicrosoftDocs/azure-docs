...
| Category | Limits |
| --- | --- |
| Directories | A single user can belong to a maximum of 500 Azure AD directories as a member or as a guest.<br/>A single user can create a maximum of 20 directories. |

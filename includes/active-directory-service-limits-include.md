...
| Category | Limits |
| --- | --- |
| Directories |A single user can be associated with a maximum of 500 Azure Active Directory directories.<br />Examples of possible combinations: <ul> <li>A single user creates 500 directories.</li><li>A single user is added to 500 directories as a member.</li><li>A single user creates 250 directories and later is added by others to 250 different directories.</li></ul> |

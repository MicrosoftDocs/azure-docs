...
| Admin roles and permissions | A group cannot be added as an owner<br>A group cannot be assigned to a role<br>Cannot change default user permissions beyond tenant switches (user settings in Azure AD) |

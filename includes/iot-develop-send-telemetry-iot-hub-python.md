...
- Azure CLI. You have two options for running Azure CLI commands in this quickstart:
    ...
    - Optionally, run Azure CLI on your local machine. The quickstart requires Azure CLI version 2.17.1 or later. Run `az --version` to check the version. Follow the steps in [Install Azure CLI]( /cli/azure/install-azure-cli) to install or upgrade Azure CLI, run it, and log in. If you're prompted, install the Azure CLI extensions on first use.

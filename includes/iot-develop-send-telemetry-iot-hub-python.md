...
- Azure CLI. You have two options for running Azure CLI commands in this quickstart:
    ...
    - Optionally, run Azure CLI on your local machine. The quickstart requires Azure CLI version 2.17.1 or later. If Azure CLI is already installed, run `az --version` to check the version. Run `az upgrade` to upgrade to the latest version. If you're installing Azure CLI for the first time, see [Install Azure CLI]( /cli/azure/install-azure-cli) for directions to install and log in.

...
- If an object that is being copied has the same name as an existing Azure object (such as a blob or a file) in the cloud, Data Box will overwrite the file in the cloud.

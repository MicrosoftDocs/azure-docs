...
- Upload management: 
  ...
  - If the string in the **Data Created** or **Last Write Time** field for a file exceeds the allowable size during an upload, “Fri, 31 Dec 9999 23:59:59” replaces the original date in the data property of the Azure file. The file upload succeeds, and no error is raised.

...
Follow these steps to create a new App Service mobile app.

1.	Log into the [Preview Portal]. At the bottom of the navigation pane, click **+NEW**. Expand **Compute** and **Mobile Service**, then click **Create**.

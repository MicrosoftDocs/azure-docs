...
| Consumer Secret (API Secret) | The shared secret used to authenticate the app with the service provider | Yes | N/A |
| Subdomain | The subdomain name used to identify the Zendesk site URL | Yes | N/A |

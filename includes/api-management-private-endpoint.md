...
> * During the preview period, a private endpoint connection supports only **incoming traffic** to the API Management instance. Outbound traffic isn't supported. 

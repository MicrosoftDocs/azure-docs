...
1. In the left pane, select **IoT Edge** from the menu, then select **Add an IoT Edge device**.
   ...
   :::image type="content" source="./media/iot-edge-register-device/portal-add-iot-edge-device.png" alt-text="Screenshot of how to add an IoT Edge device from the Azure portal.":::

...
4. Find the **Current Stable Release** and select a **64-bit 2008** version in the Windows column.  Locate **Download Source** and save the zip file to the desktop.
5. Right-click on the zip file and select **Extract All...** to a folder of your choice. After the files have been extracted, you may rename the install folder to something simpler.  "MongoDB", for example.

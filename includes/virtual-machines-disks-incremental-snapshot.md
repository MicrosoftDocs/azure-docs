...
```
On Linux, the CLI installation will vary depending on operating system version.  Please see [Install the Azure CLI](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli) for your particular Linux version.

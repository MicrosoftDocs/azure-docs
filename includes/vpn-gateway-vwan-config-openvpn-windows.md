...
1. Export the point-to-site client certificate that you created and uploaded. While many of the steps in this section apply to both VPN Gateway and Virtual WAN configurations, the procedure is different for this step. Use the link that pertains to your environment.

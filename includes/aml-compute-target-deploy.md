...
| [Azure Machine Learning compute clusters](../articles/machine-learning/how-to-run-batch-predictions.md) | (Preview) Batch&nbsp;inference | [Yes](../articles/machine-learning/how-to-run-batch-predictions.md) (machine learning pipeline) | &nbsp;  | Run batch scoring on serverless compute. Supports normal and low-priority VMs. |

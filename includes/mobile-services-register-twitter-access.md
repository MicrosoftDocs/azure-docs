...
1. If you haven't already done so, complete the steps in the topic [Register your apps for Twitter login with Mobile Services](../../includes/mobile-services-how-to-register-twitter-authentication.md). 

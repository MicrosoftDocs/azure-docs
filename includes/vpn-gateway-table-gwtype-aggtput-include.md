...
* Resizing of VpnGw SKUs is allowed within the same generation, except resizing of the Basic SKU. Basic SKU is a legacy SKU and has feature limitations. In order to move from Basic to another VpnGw SKU, you must delete the Basic SKU VPN gateway and create a new Gateway with desired Generation and SKU size combination.

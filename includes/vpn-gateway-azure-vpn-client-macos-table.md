...
|---|---|---|
| 2.7.101 | Aug 2024 | - Auto reconnect on unintentionally disconnects<br> - Released builts for ARM64 and universal<br> - Removed the dependency on Rosetta software<br> - Performance and stability improvements |

...
2. Go to **Set network interfaces**. Make a note of the device IP address for the network interface used to connect to the client.
    ...
    ![Data Box dashboard 2](media/data-box-add-device-ip/data-box-connect-via-rest-2.png)

3. Go to **Connect and copy** and click **Rest**.

    ![Data Box dashboard 3](media/data-box-add-device-ip/data-box-connect-via-rest-3.png)

4. From the **Access Storage account and upload data** dialog, copy the **Blob Service Endpoint**.

    ![Data Box dashboard 4](media/data-box-add-device-ip/data-box-connect-via-rest-4.png)
...
7. For reference, use the following image. Save the **hosts** file.
    ...
    ![Data Box dashboard 5](media/data-box-add-device-ip/data-box-connect-via-rest-5.png)

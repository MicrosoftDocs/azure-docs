...
| Backup capabilities | - You can back up Confidential VMs with OS disk encryption only.  <br> - Backup and restore fail if the CVM v2 opt-out feature flag is enabled for your subscription. <br> - Multi-disk crash consistent backup isn't supported. <br> - Cross Region Restore isn't currently supported as CVM v6 VM size isn't generally available in Azure paired regions.  |

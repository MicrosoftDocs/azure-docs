...
- Not currently available for Ultra Disks.
- Available for Premium SSD v2 managed disks as a preview.
    - Snapshots of Premium SSD v2 managed disks have a delay between when they are initially taken and when they can be used. For details see this section.
    - Premium SSD v2 managed disks can create up to seven incremental snapshots every five minutes for a particular disk.
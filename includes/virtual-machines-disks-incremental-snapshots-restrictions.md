...
- When creating a Premium SSD v2 and Ultra disk from snapshot, customer is able to attach the disk to a running VM right away. However, until the CompletionPercent property of the disk reached 100, you will experience read performance drop on the newly created disk.

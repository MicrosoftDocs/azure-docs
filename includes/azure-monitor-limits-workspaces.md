...
- The Kusto Query Language (KQL) language limits depend on the table tier used in the query. The following KQL limits apply:
   ...
   - Analytics: Supports all KQL commands, except for data reshaping plugins, including [bag unpack](/data-explorer/kusto/query/bag-unpack-plugin), [narrow](/data-explorer/kusto/query/narrow-plugin), and [pivot](/data-explorer/kusto/query/pivot-plugin). Cross-resource, including [workspaces()](/azure/azure-monitor/logs/cross-workspace-query.md#query-across-log-analytics-workspaces-using-workspace), [app()](/azure/azure-monitor/logs/cross-workspace-query.md#query-across-classic-application-insights-applications-using-app), [resource()](/azure/azure-monitor/logs/cross-workspace-query.md#correlate-data-between-resources-using-resource), [ADX()](/azure/azure-monitor/logs/azure-monitor-data-explorer-proxy), and [arg()](/azure/azure-monitor/logs/azure-monitor-data-explorer-proxy) aren't supported in the Private Preview.

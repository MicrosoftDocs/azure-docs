...
| Resource | Limit |
| --- | --- |
| Network Watcher instances per region per subscription | 1 (One Network Watcher instance is created in a region to enable access to the service in that region) |

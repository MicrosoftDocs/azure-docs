...
|Last Known Error|Description/when it occurs|
|-----|-----|
Transient|A transient error has occurred and IoTHub will retry the operation.|
|InternalError|An error occurred while delivering a message to an endpoint.|
|Unauthorized|IoTHub is not authorized to send messages to the specified endpoint.|
|Throttled|IoTHub is being throttled while writing messages into the endpoint.|

...
:::image type="content" source="../digital-twins/media/includes/download-repo-zip.png" alt-text="View of the digital-twins-samples repo on GitHub. The Code button is selected, producing a small dialog box where the Download ZIP button is highlighted." lightbox="../digital-twins/media/includes/download-repo-zip.png":::

> [!IMPORTANT]
> Microsoft Azure BizTalk Services (MABS) is being retired, and replaced with Azure Logic Apps. If you currently use MABS, then [Jon's topic](../articles/logic-apps/logic-apps-for-mabs-users.md) provides some guidance on moving your integration solutions to Logic Apps. 
> 

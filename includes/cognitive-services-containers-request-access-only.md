...
> [!IMPORTANT]
> You must use an email address that's associated with either a Microsoft Account (MSA) or Azure Active Directory (Azure AD) account in the form. For more information on the acceptance criteria, see the [application](aka.ms/cognitivegate).

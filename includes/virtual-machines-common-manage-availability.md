...
## Use Managed Disks for VMs in Availability Set
If you are currently using VMs with unmanaged disks, we highly recommend you [Convert VMs in Availability Set to use Managed Disks](../articles/virtual-machines/virtual-machines-windows-convert-unmanaged-to-managed-disks.md#convert-vms-in-an-availability-set-to-managed-disks-in-a-managed-availability-set).

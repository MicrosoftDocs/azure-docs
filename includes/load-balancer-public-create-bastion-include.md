...
1. Enter or select the following information in **Azure Bastion**:
    ...
    :::image type="content" source="./media/load-balancer-internal-create-bastion-include/enable-bastion.png" alt-text="Screenshot of Basics tab of Create virtual network in the Azure portal":::
...
1. In **Edit subnet**, enter or select the following information:
    ...
    :::image type="content" source="./media/load-balancer-public-create-bastion-include/edit-subnet-window.png" alt-text="Screenshot of default subnet rename and configuration.":::

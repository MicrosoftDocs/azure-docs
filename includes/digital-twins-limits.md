...
| Digital twins | Number of digital twins that can be imported in a single [Jobs API](../articles/digital-twins/concepts-apis-sdks.md#bulk-import-with-the-jobs-api) job | 2,000,000 | No |
...
| Digital twins | Number of relationships that can be imported in a single [Jobs API](../articles/digital-twins/concepts-apis-sdks.md#bulk-import-with-the-jobs-api) job | 10,000,000 | No |
...
| Models | Number of models that can be imported in a single API call (not using the [Jobs API](../articles/digital-twins/concepts-apis-sdks.md#bulk-import-with-the-jobs-api)) | 250 | No |
| Models | Number of models that can be imported in a single [Jobs API](../articles/digital-twins/concepts-apis-sdks.md#bulk-import-with-the-jobs-api) job | 10,000 | No |

...
| Digital twins | Number of digital twins that can be uploaded in a single [Jobs API](../articles/digital-twins/concepts-apis-sdks.md#bulk-import-with-the-jobs-api) bulk job | 2,000,000 | No |
...
| Digital twins | Number of relationships that can be uploaded in a single [Jobs API](../articles/digital-twins/concepts-apis-sdks.md#bulk-import-with-the-jobs-api) bulk job | 10,000,000 | No |
...
| Models | Number of models that can be uploaded in a single API call (not using the [Jobs API](../articles/digital-twins/concepts-apis-sdks.md#bulk-import-with-the-jobs-api)) | 250 | No |
| Models | Number of models that can be uploaded in a single [Jobs API](../articles/digital-twins/concepts-apis-sdks.md#bulk-import-with-the-jobs-api) job | 10,000 | No |
...
| --- | --- | --- | --- |
| Jobs API (bulk import) | Number of requests per second | 1 | Yes |
| Jobs API (bulk import) | Number of bulk import jobs running concurrently | 1 | Yes |

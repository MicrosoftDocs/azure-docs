...
| Digital Twins API | Number of create/update/delete operations per second on a **single twin** | 10 | No |
| Digital Twins API | Number of create/delete operations per second across **all twins and edges** | 50 | Yes |

...
|15.5| To help ensure an efficient validation process, if your add-in contains custom functions, you should provide test notes to validate them on submission. |

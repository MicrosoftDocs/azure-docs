...
|7.3.1| The images submitted with your app or add-in must reflect its functionality, and may not mislead the user. They should be legible and clearly show the value propisition of the app or add-in. For more information on image best practices see  [Craft effective AppSource images](https://docs.microsoft.com/en-us/office/dev/store/craft-effective-appsource-store-image).

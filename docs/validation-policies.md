...
|7.19| Your app or add-in may not use the Microsoft Product name in the app or add-in title. <br/><br/> Note - This may be permitted, on a case by case basis, where the same add-in title is be used across multiple products. <br/><br/> For example: Contoso for SharePoint, Contoso for Outlook, Contoso for Office 365

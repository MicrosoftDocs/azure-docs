...
|14.19| The policies outlined in [Section 2](https://docs.microsoft.com/office/dev/store/validation-policies#2-apps-or-add-ins-can-display-certain-ads) do not apply to Microsoft Teams apps. Microsoft Teams apps may not display ads.

...
|10.8.1| For your Outlook Add-in to be available on iOS, it must follow the Outlook add-in design guidelines. For more information see here: https://docs.microsoft.com/en-us/outlook/add-ins/outlook-addin-design.|

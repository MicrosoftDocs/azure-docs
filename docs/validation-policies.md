...
|7.19| You may not use the Microsoft product name in your app or add-in title. <br/><br/> **Note:** We may make some exceptions in cases where an add-in runs in multiple Microsoft prodcuts; for example, Contoso for SharePoint, Contoso for Outlook, Contoso for Office 365.

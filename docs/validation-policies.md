...
|14.20| Teams apps must use persistent authentication across capabilities. See [here](https://docs.microsoft.com/en-us/microsoftteams/platform/tabs/how-to/authentication/auth-silent-aad) for details on silent authentication.

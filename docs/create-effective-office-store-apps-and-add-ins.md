...
- Your add-in manifest; specifically, the [DisplayName element (OfficeApp complexType) (app manifest schema v1.1)](529159ca-53bf-efcf-c245-e572dab0ef57.md) element (Office Add-in), or the [DisplayName element (OfficeApp complexType) (app manifest schema v1.1)](c4ca4165-ed3a-7ded-d8e3-0a841955d109.md) element (SharePoint Add-in). This specifies the name that is displayed after the user installs the add-in.
...
![An image that shows a good short description next to one that relies on the brand name](..\media\078861fd-794c-410f-a639-bc28644d2dbc.PNG)
...
![An image that shows a clear logo with an Excel chart next to an unclear Fabrikam logo](..\media\d8de904b-0047-41fb-b83c-4e116a486a76.PNG)
...
For Office Add-ins that you are submitting to the Office Store, you have to link to an image by using the [IconUrl element (OfficeApp complexType) (app manifest schema v1.1)](c7dac2d4-4fda-6fc7-3774-49f02b2d3e1e.md) in the manifest. This image represents your add-in within an Office application. 
...
|Localization|[IconUrl element (OfficeApp complexType) (app manifest schema v1.1)](c7dac2d4-4fda-6fc7-3774-49f02b2d3e1e.md.md) supports culture-specific images in the manifest.|[IconUrl element (OfficeApp complexType) (app manifest schema v1.1)](c7dac2d4-4fda-6fc7-3774-49f02b2d3e1e.md.md) supports culture-specific images in the manifest.|
...
![An image that shows an add-in with callouts next to a blank add-in](..\media\dd143a4e-aa72-46f1-8e4c-1e121f2ce6e1.PNG)
...
![An image that shows a request to rate within an add-in next to a request to rate following a tutorial](..\media\2038209a-5d7e-4a0e-a7ea-c12fa02c54a0.PNG)
...
![Screenshot that shows a developer response to a comment with the App provider label under the name](..\media\7f710930-4ecd-4b28-b55d-8507a928995b.PNG)
...
- [Troubleshoot](4e3a5129-5bb8-4aed-b122-200c6410d82c.md) issues and provide technical support to your users.

...
>**Note:** To delete a child (in case of a mistake), click the trash bin icon next to it.
...
2. On the **Entities** page, click **Add custom entity**.
2. In the **Add Entity** dialog box, type "TicketsOrder" in the **Entity name** box, and then select **Composite** from the **Entity type** list. Click on the add child link to add new child.
...
>**Note:** To delete a child (in case of a mistake), click the trash icon next to it.

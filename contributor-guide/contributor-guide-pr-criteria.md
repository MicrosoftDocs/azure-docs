...
|Naming	|New folders introduced into the repo follow the [folder naming guidelines](file-names-and-locations.md).|
...
|Content| Elements that should be numbered lists are numbered, elements that should be bulleted are bulleted. This is basic usability.|
...
|SEO	|The H1 title contains sufficient information to describe the content of the article, differentiate it from other Azure articles, and map to likely customer keywords. For example "Overview" as the H1 title is a fail.|
...
|Site/design functionality|The H2 headings, when rendered in the on-page TOC, should ideally wrap to no more than 2 lines.|
...
|Process|When you delete or rename an article, make sure you follow the process. Pull request reviewers add this comment and link in a comment:<br><br>*Please verify you followed the process in the contributors’ guide for deleting articles: <https://github.com/Azure/azure-content/blob/master/contributor-guide/retire-or-rename-an-article.md> .*|

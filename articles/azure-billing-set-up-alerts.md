<properties title="" pageTitle="Set up billing alerts for your Microsoft Azure subscriptions" description="Describes how you can set up alerts on your Azure bill so you can avoid billing surprises." metaKeywords="" services="" solutions="" documentationCenter="" authors="cabailey" manager="mbaldwin" videoId="" scriptId="" editor=""/>

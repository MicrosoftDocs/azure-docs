<properties pageTitle="Shared access signatures: Understanding the SAS Model | Microsoft Azure" description="Learn about delegating access to blob, queue, and table resources with shared access signatures" services="storage" documentationCenter="" authors="tamram" manager="adinah" editor=""/>

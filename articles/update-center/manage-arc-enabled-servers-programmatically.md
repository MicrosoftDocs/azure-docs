---
title: Programmatically manage updates for Azure Arc-enabled servers
description: This article tells how to use update management center (private preview) using REST API with Azure Arc-enabled servers.
...
Support for Azure REST API to manage Azure Arc-enabled servers is available through the update management center (private preview) virtual machine extension.

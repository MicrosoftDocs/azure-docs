---
title: Programmatically manage updates for Azure Arc-enabled servers in Update management center
...
Support for Azure REST API to manage Azure Arc-enabled servers is available through the update management center virtual machine extension.

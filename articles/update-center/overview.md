...
> - For customers using Automation Update Management, we recommend continuing to use the Log Analytics agent and *not* migrating to the Azure Monitor agent until machines and schedules are migrated to Azure Update Manager.

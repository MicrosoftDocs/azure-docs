---
title: Update manager (preview) overview
description: The article tells what update manager (preview) in Azure is and the system updates for your Windows and Linux machines in Azure, on-premises, and other cloud environments.

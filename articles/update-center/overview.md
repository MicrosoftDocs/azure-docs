...
This article provides a overview of update management center (Preview) and the capabilities it offers to help you assess, manage, and apply security updates for all connected Windows and Linux Servers in Azure, physical or VMs in on-premises environments, and in other cloud environments.

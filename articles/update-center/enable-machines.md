...
### [Azure VM on-demand assessment and on-demand patching](#tab/azure-vm-powershell)
1. Sign in to the Update management center Private Preview portal link: **https://aka.ms/umc-preview**. No onboarding is required for Azure VM On-demand assessment and on-demand patching. 
...
### [Azure VM on-demand assessment and on-demand patching](#tab/azure-vm-cli)
...
### [Azure VM on-demand assessment and on-demand patching](#tab/azure-vm-rest-api)

---
title: Configure Windows Update settings for update management center
description: This article tells how to configure Windows Update settings to work with update management center (private preview).
...
Update management center (private preview) respects many of the settings specified to control the Windows Update client. If you use settings to enable non-Windows updates, Update management center (private preview) will also manage those updates. If you want to enable downloading of updates before an update deployment occurs, update deployment can be faster, more efficient, and less likely to exceed the maintenance window.

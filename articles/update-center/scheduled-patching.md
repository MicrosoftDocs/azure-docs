---
title: Scheduling recurring updates in Update manager (preview)
description: The article details how to use update manager (preview) in Azure to set update schedules that install recurring updates on your machines.

---
title: Manage multiple machines in update manager (preview)
description: The article details how to use update manager (preview) in Azure to manage multiple supported machines and view their compliance state in the Azure portal.
...
# Manage multiple machines with update manager (preview)

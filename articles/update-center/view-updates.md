---
title: Check update compliance in Update management center
description: The article details how to use Azure Update management center in the Azure portal to assess update compliance for supported machines.
...
# Check update compliance with update management center

**Applies to:** :heavy_check_mark: Windows VMs :heavy_check_mark: Linux VMs :heavy_check_mark: On-premises environment :heavy_check_mark: Azure Arc-enabled servers.

This article details how to check the status of available updates on a single VM or multiple machines using update management center.

## Check updates on single VM

>[!NOTE]
> You can check the updates from the Overview or Machines blade in update management center page or from the selected VM.
...
1. In Update management center, **Machines**, select your **Subscription** to view all your machines.
...
1. In Update management center, **Overview**, select your **Subscription** to view all your machines and select **Check for updates**.
...
* To troubleshoot issues, see [Troubleshoot](troubleshoot.md) Azure Update management center.

---
title: Sample query logs and results from Update manager (preview)
description: The article provides details of sample query logs from update manager (preview) in Azure using Azure Resource Graph

---
title: Manage update configuration settings in Update manager (preview)
description: The article describes how to manage the update settings for your Windows and Linux machines managed by Update manager (preview).
...
The article describes how to configure update settings from Update manager (preview) in Azure, to control the update settings on your Azure VMs and Arc-enabled servers for one or more machines.

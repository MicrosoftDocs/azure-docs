---
title: Manage update configuration settings in Update management center
description: The article describes how to manage the update settings for your Windows and Linux machines managed by Update management center.
...
The article describes how to configure update settings from Update management center in Azure, to control the update settings on your Azure VMs and Arc-enabled servers for one or more machines.
...
>[!NOTE]
> You can schedule updates from the Overview blade or Machines blade in update management center page or from the selected VM.

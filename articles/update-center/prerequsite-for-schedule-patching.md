---
title: Configure schedule patching on Azure VMs to ensure business continuity in update manager (preview).
description: The article describes the new prerequisites to configure scheduled patching to ensure business continuity in Update manager (preview).

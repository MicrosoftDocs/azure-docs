...
<div id="main" class="v2">
    <div class="container">
        ...
        <ul class="cardsY panelContent featuredContent">
            <li>
                <a href="http://aka.ms/azuredevgetstarted/index">
                    <div class="cardSize">
            ...
            <li>
                <a href="http://aka.ms/azureitgetstarted/index">
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                <div class="cardImageOuter">
            ...
            <li>
                <a href="https://azure.microsoft.com/en-us/community/training/index">
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                <div class="cardImageOuter">
                        ...
                        <ul id="get-started" class="cardsL">
                            <li>
                                <div class="container intro">
                                    ...
                                    <p>Dive into Azure with our quickstarts, samples, tutorials and technical documentation.</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                            ...
                            <a href="#pivot=services&panel=all" style="position: absolute; bottom:30px; right: 30px;">
                              <button style="cursor: pointer;position: relative; background: #3498db; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">View all services<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 10px;right: 12px;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z"/></svg></button>
                            </a>
                        </ul>
                    </li>
                    <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/dotnet/api">Get the .NET SDK</a>
                                                </h3>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="http://azure-sdk-for-python.readthedocs.io/en/latest/index">Get started</a>
                                                </p>
                                                <p>
                                                    <a href="http://azure-sdk-for-python.readthedocs.io/en/latest/index">API reference</a>
                                                </p>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/articles/azure-cli-arm-commands/index">Reference</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/articles/vs-azure-tools-storage-manage-with-storage-explorer/index">Get Started</a>
                                                </p>
                                                <p>

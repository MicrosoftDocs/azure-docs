                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="/go/azure/">
                                                            <img src="https://docs.microsoft.com/media/logos/logo_gopher.svg" alt="" />
                                                            Go</a>
                                                    </li>
                                                </ul></td></tr></table>
                                               <h4>App Models</h4>
                ...
                <ul id="products">
                    ...
                    <li>
                        ...
                        <ul id="databases" class="cardsA">
                            ...
                            <li>
                                <a href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2fazure%2fvirtual-machines%2fwindows%2fsqlclassic%2ftoc.json">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Server for Virtual Machines</h3>
                                                    <p>Host enterprise SQL Server apps in the cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/nodejs/azure/">Get the Azure libraries for Node.js</a>
                                                </h3>
                                                <p>

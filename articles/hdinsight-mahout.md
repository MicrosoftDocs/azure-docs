...
2. Upload the jar file to __example/jars__ in the default storage for your cluster. The following example uses the send-hdinsight script to upload the file:

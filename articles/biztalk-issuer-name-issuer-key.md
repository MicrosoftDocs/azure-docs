<properties pageTitle="Issuer Name and Issuer Key in BizTalk Services | Azure" description="Learn how to retrieve Issuer Name and Issuer Key for either Service Bus or Access Control (ACS) in BizTalk Services." services="biztalk-services" documentationCenter="" authors="mandiohlinger" manager="dwrede" editor="susanjo"/>

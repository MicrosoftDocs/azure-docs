...
1. Configure Azure resources for a new web app. Follow the steps in [Publish your web app](../app-service/quickstart-dotnetcore.md?tabs=netframework48#2-publish-your-web-ap). Then, return to this tutorial and continue to the next step.

...
2. Obtain the Twilio JAR. At [https://github.com/twilio/twilio-java][twilio_java_github], you can download the GitHub sources and create your own JAR, download it from the [public repository][twilio-java-maven-repo] or configure it as a dependency on your favorite build tool.

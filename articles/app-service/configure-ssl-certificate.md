...
> [!IMPORTANT]
> Because Azure fully manages the certificates on your behalf, any aspect of the certificate, including the root issuer, can be changed at anytime. These changes are outside of your control. You should avoid practices such as "pinning" the certificate or any part of the certificate hierarchy.

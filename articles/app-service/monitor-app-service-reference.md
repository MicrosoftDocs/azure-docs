...
| AppServiceAppLogs | ASP.NET | ASP.NET | Java SE & Tomcat Images | Yes | Java and Tomcat are supported in their default configuration. [Additional code and/or configuration might be required for some logging frameworks](https://github.com/Azure-Samples/SpringBoot3Log4j2AppSvcLogs). |

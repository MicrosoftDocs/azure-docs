...
<ul>
<li>The custom domain configured is missing an A record or a CNAME record. Check if the DNS records are exposed using an [online DNS lookup](https://www.nslookup.io/) tool.</li>

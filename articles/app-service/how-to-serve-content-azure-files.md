---
title: Serve content from Azure Files
description: How to configure and serve content from Azure Files in Windows Container app in Azure App Service.
...
---
# Serve content from Azure Files in a Windows Container on App Service
...
To mount an Azure Files to a directory in your App Service app, you use the [`az webapp config storage-account add`](https://docs.microsoft.com/cli/azure/webapp/config/storage-account?view=azure-cli-latest#az-webapp-config-storage-account-add) command. Storage Type must be AzureFiles.

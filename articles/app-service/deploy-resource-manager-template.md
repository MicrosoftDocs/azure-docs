...
The name for your web app must be globally unique. You can use a naming convention that's likely to be unique, or you can use the [uniqueString function](../azure-resource-manager/management/template-functions-string.md#uniquestring) to assist with generating a unique name.

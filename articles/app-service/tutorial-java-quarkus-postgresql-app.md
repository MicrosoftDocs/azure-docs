...
When you are finished, you will have a [Quarkus](https://quarkus.io) application storing data in [PostgreSQL](https://azure.microsoft.com/en-us/services/postgresql/) database running on [Azure App Service on Linux](overview.md).
...
![Quarkus application storing data in PostgreSQL running remotely](./media/tutorial-java-quarkus-postgresql/quarkus-crud-running-remotely.png)

...
Azure Monitor is a full stack monitoring service in Azure that provides a complete set of features to monitor your Azure resources in addition to resources in other clouds and on-premises. The Azure Monitor data platform collects data into logs and metrics where they can be analyzed using a complete set of monitoring tools. App Service monitoring data can be shipped to Azure Monitor through Diagnostic Settings.

...
> [!WARNING]
> [Azure Managed Identities](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/overview) are not supported in multi-containers at this time.

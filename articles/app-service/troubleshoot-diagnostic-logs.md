...
> [!NOTE]
> In addition to the logging instructions in this article, there's new, integrated logging capability with Azure Monitoring. You'll find this capability in [Diagnostic Settings (Preview)](https://azure.github.io/AppService/). This logging capability supports both Windows and Linux platforms. Log types include: web server, console, application, file & audit. You have the options to send your logs to Blob Storage, Event Hubs, and Log Analytics.
>

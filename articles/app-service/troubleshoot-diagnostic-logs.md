...
|-|-|-|-|
| [Diagnostic Settings (Preview)](https://azure.github.io/AppService/): HTTP, Console, Application, File & Audit Logs | Windows, Linux | Azure Storage blobs, Event Hub, Log Analytics | Azure provides built-in [Diagnostic Settings (Preview)](https://azure.github.io/AppService/) to assist with debugging an App Service app. You have the options to send your logs to Blob Storage, Event Hubs, and Log Analytics. |

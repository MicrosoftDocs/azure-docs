...
| AppServiceAppLogs | ASP.NET, .NET Core, & Tomcat <sup>1</sup> | ASP.NET & Tomcat <sup>1</sup> | .NET Core, Java, SE & Tomcat Blessed Images <sup>2</sup> | .NET Core, Java SE, & Tomcat Blessed Images <sup>2</sup> | Application logs |

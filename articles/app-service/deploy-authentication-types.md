...
|Visual Studio Code|Entra ID authentication |[Quickstart: Deploy an ASP.NET web app](quickstart-dotnetcore.md)<br/> [Working with GitHub in VS Code](https://code.visualstudio.com/docs/sourcecontrol/github) |
...
|Run directly from an uploaded ZIP file |Entra ID authentication |[Run your app in Azure App Service directly from a ZIP package](deploy-run-package.md) |
...
|Azure Web app plugin for Maven (Java) |Entra ID authentication |[Quickstart: Create a Java app on Azure App Service](quickstart-java.md)|
|Azure WebApp Plugin for Gradle (Java) |Entra ID authentication |[Configure a Java app for Azure App Service](configure-language-java.md)|
...
|Azure Migrate App Service discovery/assessment/migration |Entra ID authentication |[Tutorial: Assess ASP.NET web apps for migration to Azure App Service](../migrate/tutorial-assess-webapps.md)<br/>[Modernize ASP.NET web apps to Azure App Service code](../migrate/tutorial-modernize-asp-net-appservice-code.md) |

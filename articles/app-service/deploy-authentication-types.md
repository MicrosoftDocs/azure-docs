...
| Visual Studio | Basic authentication  | [Quickstart: Deploy an ASP.NET web app](quickstart-dotnetcore.md)<br/><br/>[Develop and deploy WebJobs using Visual Studio](webjobs-dotnet-deploy-vs.md)<br/><br/>[Troubleshoot an app in Azure App Service using Visual Studio](troubleshoot-dotnet-visual-studio.md)<br/><br/>[GitHub Actions integration in Visual Studio](/visualstudio/azure/overview-github-actions)<br/><br/>[Deploy your application to Azure using GitHub Actions workflows created by Visual Studio](/visualstudio/deployment/azure-deployment-using-github-actions) |
...
| GitHub with GitHub Actions | Publish profile (basic authentication)<br/><br/>Service principal (Microsoft Entra)<br/>OpenID Connect (Microsoft Entra) | [Deploy to App Service using GitHub Actions](deploy-github-actions.md) |
...
| GitHub with Azure Pipelines as a build engine | Publish profile (basic authentication)<br/><br/>Azure DevOps service connection | [Deploy to App Service using Azure Pipelines](deploy-azure-pipelines.md) |
...
| Azure Repos with Azure Pipelines as a build engine | Publish profile (basic authentication)<br/><br/>Azure DevOps service connection | [Deploy to App Service using GitHub Actions](deploy-github-actions.md) |

...
## Deploy from local Git with Azure DevOps builds
...
Click **Azure DevOps Continuous Delivery** > **Continue**.
...
It takes a few minutes for the Azure DevOps organization to be ready. When it's ready, copy the Git repository URL in the deployment center.
...
Push to the Azure remote to deploy your app with the following command. When prompted by Git Credential Manager, sign in with your visualstudio.com user. For additional authentication methods, see [Azure DevOps authentication overview](/vsts/git/auth-overview?view=vsts).

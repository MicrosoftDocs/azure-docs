...
| [az redis create](https://docs.microsoft.com/cli/azure/redis#az_redis_create) | Create new Redis Cache instance. This is where the data will be stored. |
| [az redis list-keys](https://docs.microsoft.com/cli/azure/redis#az_redis_list_keys) | Lists the access keys for the redis cache instance. |

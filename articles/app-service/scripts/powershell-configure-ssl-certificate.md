---
title: 'PowerShell: Upload and bind SSL'
description: Learn how to use Azure PowerShell to automate deployment and management of App Service. This sample shows how to bind a custom SSL certificate to an app.

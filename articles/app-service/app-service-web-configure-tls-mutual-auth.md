...
App Service requires TLS renegotiation for some client certificate settings to read a request before knowing whether to prompt for a client certificate. Any of the following settings triggers TLS renegotiation:

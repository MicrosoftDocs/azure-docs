...
|  [Create an app and expose your app with a Private Endpoint](./scripts/powershell-deploy-privateendpoint.md?toc=%2fpowershell%2fmodule%2ftoc.json) | Creates an App Service app with a Private Endpoint. |
|**Configure app**||

...
Yes, you can point the domain to a VM. For more information, see [Create a custom FQDN in the Azure portal for a Windows VM](../virtual-machines/windows/portal-create-fqdn.md).

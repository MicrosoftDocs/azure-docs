...
| Cluster storage requirement                             | Must have cluster attached storage class available for use by the extension to        |
|                                                         | support deployment and build of code based apps where applicable                      |

...
- *IntelliJ IDEA*:[Create a Hello World web app for Azure App Service using IntelliJ](https://docs.microsoft.com/en-us/azure/developer/java/toolkit-for-intellij/create-hello-world-web-app)
- *Eclipse*:[Create a Hello World web app for Azure App Service using Eclipse](https://docs.microsoft.com/en-us/azure/developer/java/toolkit-for-eclipse/create-hello-world-web-app)

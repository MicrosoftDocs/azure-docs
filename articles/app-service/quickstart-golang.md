...
If necessary, login to Azure using [az login](https://learn.microsoft.com/cli/azure/authenticate-azure-cli).
...
When no longer needed, you can use the [az group delete](https://docs.microsoft.com/cli/azure/group?view=azure-cli-latest#az-group-delete) command to remove the resource group, and all related resources:

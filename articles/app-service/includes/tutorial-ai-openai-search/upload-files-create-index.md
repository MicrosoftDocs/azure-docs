...
1. Select **Data storage** > **Containers** from the left navigation menu and open the **documents** container.

1. Upload sample documents by clicking **Upload**. You can use the sample documents from the `sample-docs` folder in the repository, or your own PDF, Word, or text files.
...
1. Select **Import data (new)** to start the process of creating a search index.
...
1. In the **Connect to your data** step:
   ...
   - Select **Authenticate using managed identity**.
   - Select **Next**.

1. In the **Vectorize your text** step:
   ...
   - Select the acknowledgment checkbox for additional costs.
   - Select **Next**.
...
1. In the **Vectorize and enrich your images** step:
   - Keep the default settings.
   - Select **Next**.

1. In the **Advanced settings** step:
...
1. In the **Review and create** step:
    - Copy the **Objects name prefix** value. It is your search index name.
    - Select **Create** to start the indexing process.

1. Wait for the indexing process to complete. This might take a few minutes depending on the size and number of your documents.

...
1. Provision the Azure resources with the AZD template:
...
1. Wait for the deployment to complete. This process will:
...
1. After successful deployment, you'll see a URL for your deployed application. Make note of this URL, but don't access it yet because you still need to set up the search index.

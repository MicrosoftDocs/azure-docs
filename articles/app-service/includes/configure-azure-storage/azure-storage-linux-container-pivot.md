...
- Storage account shared access keys are the only means of authentication that are supported; [Entra ID and RBAC Roles](https://learn.microsoft.com/rest/api/storageservices/authorize-with-azure-active-directory#manage-access-rights-with-rbac) are not supported.

...
Redis improves the performance and scalability of an app that uses backend data stores heavily. [Learn more about Azure Cache for Redis.](/azure/azure-cache-for-redis/cache-overview)

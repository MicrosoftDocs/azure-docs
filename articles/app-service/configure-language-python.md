...
- **Azure portal**: select the app's **Configuration** page, then select the **General settings** tab. In the **Startup Command** field, enter either the full text of your startup command or the name of your startup command file. Then select **Save** to apply the changes. See [Configure general settings](configure-common.md#configure-general-settings) for Linux containers.
...
To access logs in the Azure portal, go to your app and select **Monitoring** > **Log stream** in the left pane.

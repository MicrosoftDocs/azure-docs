...
1. **App service resources**: Create a resource group, App Service Plan, and App Service web app to host your application. You can most easily do this by doing an initial deployment of your code through the Azure CLI command [`az webapp up`](/cli/azure/webapp?view=azure-cli-latest#az-webapp-up). Or, you can create the resources as shown in [Tutorial: Deploy a Django web app with PostgreSQL - deploy the code](tutorial-python-postgresql-app.md#6---deploy-your-application-code-to-azure). Replace the names of the resource group, App Service Plan, and the web app to be more suitable for your application.

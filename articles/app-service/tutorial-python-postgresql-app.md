...
++ :::row:::
++    :::column span="2":::
++        **Step 4:** Back in the **Configuration** page, select **New application setting**. Name the setting `SECRET_KEY`. Paste the value from the previous step. Select **OK**.
++    :::column-end:::
++    :::column:::
...
++    :::column-end:::
++    :::column:::
++        :::image type="content" source="./media/tutorial-python-postgresql-app/azure-portal-app-service-app-setting-save.png" alt-text="A screenshot showing how to save the SECRET_KEY app setting in the Azure portal (Flask)." lightbox="./media/tutorial-python-postgresql-app/azure-portal-app-service-app-setting-save.png":::
++    :::column-end:::
++ :::row-end:::

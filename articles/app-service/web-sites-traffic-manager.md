...
* The App Service plan for the App Service must be configured with a standard or premium pricing tier for integration with Traffic Manager to function. If it is not configured on the proper tier, you will likely see a 404 when attempting to view your site with the Traffic Manager alias.

...
Learn how to access Azure Storage on behalf of a web app (not a signed-in user) running on Azure App Service by using managed identities.
...
This creates a new object ID, different than the app ID created in the **Authentication/Authorization** pane. Copy the object ID of the system-assigned managed identity. You'll need it later.

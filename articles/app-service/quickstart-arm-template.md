...
> [!NOTE]
> Starting with ARM API version 2024, sites are created with Basic authentication disabled by default. Users can [manually enable it](https://learn.microsoft.com/en-us/azure/templates/microsoft.web/sites/basicpublishingcredentialspolicies?pivots=deployment-language-arm-template) if required.

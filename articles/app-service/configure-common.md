...
description: Learn how to configure common settings for an Azure App Service app, including app settings, app configuration, connection strings, platform, language stack, and container.

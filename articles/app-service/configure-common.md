...
To configure virtual applications and directories, specify each virtual directory and its corresponding physical path relative to the website root (`D:\home`). Optionally, you can select the **Directory** checkbox to mark a virtual directory as an application.

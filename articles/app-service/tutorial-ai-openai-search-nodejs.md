...
1. Navigate to the GitHub repository at [https://github.com/Azure-Samples/app-service-rag-openai-ai-search-expressjs](https://github.com/Azure-Samples/app-service-rag-openai-ai-search-expressjs).

...
1. If you want to enable zone redundancy on an existing App Service plan, first [check for zone redundancy support for your App Service plan](#check-for-zone-redundancy-support-for-an -app-service-plan). 
...
- [App Service plan overview](../app-service/app-service-plan-overview.md)    
- [Configure zone redundancy for App Service Environment v3](../app-service/environment/configure-zone-redundancy-ase.md)
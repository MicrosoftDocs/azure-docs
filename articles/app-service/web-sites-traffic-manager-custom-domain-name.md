...
> [!NOTE]
> If a record is already in use and you need to pre-emptively bind your apps to it, you can create an additional CNAME record. For example, to pre-emptively bind **www.contoso.com** to your web app, create a CNAME record from **awverify.www** to **contoso.trafficmanager.net**. You can then add "www.contoso.com" to your Web App without changing the "www" CNAME record. For more information, see [Create DNS records for a web app in a custom domain][CREATEDNS].
> 
> 

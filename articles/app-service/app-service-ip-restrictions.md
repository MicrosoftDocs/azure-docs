...
++ For more information about the X-FD-HealthProbe, see [HTTP header filtering for site access restriction rules](#http-header-filtering-for-site-access-restriction-rules).

...
This article shows you how to configure Azure App Service or Azure Functions to use X as an authentication provider.
...
You're now ready to use X for authentication in your app. The provider is now listed on the **Authentication** screen. From there, you can edit or delete this provider configuration.

...
> [!NOTE] 
> To find the managed identity for your web or slot app in the Azure portal, go to the User settings section under Enterprise applications. Usually the slot name would be like `<App Name>/slots/<slot Name>`

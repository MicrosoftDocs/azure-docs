...
In this tutorial, you'll build an intelligent AI application by integrating Azure OpenAI with a .NET application and deploying it to Azure App Service. You'll create a Razor page that sends chat completion requests to a model in Azure OpenAI and streams the response back to the page.

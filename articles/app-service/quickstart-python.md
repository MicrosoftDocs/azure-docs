...
| [!INCLUDE [Create app service step 3](<./includes/quickstart-python/create-app-service-visual-studio-code-3.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-3-240px.png" alt-text="A screenshot of the dialog box used to select the subscription for the new web app in Visual Studio Code." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-3.png"::: |
| [!INCLUDE [Create app service step 4](<./includes/quickstart-python/create-app-service-visual-studio-code-4.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-4-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select Create a new Web App." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-4.png"::: |
| [!INCLUDE [Create app service step 5](<./includes/quickstart-python/create-app-service-visual-studio-code-5.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-5-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select the folder to deploy for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-5.png"::: |
| [!INCLUDE [Create app service step 6](<./includes/quickstart-python/create-app-service-visual-studio-code-6.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-6-240px.png" alt-text="A screenshot of the dialog box in VS Code used to enter the globally unique name for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-6.png"::: |
| [!INCLUDE [Create app service step 7](<./includes/quickstart-python/create-app-service-visual-studio-code-7.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-7-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select the resource group for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-7.png"::: |
| [!INCLUDE [Create app service step 8](<./includes/quickstart-python/create-app-service-visual-studio-code-8.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-8-240px.png" alt-text="A screenshot of the dialog box in VS Code used to enter the resource group name for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-8.png"::: |
| [!INCLUDE [Create app service step 9](<./includes/quickstart-python/create-app-service-visual-studio-code-9.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-9-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select the runtime stack for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-9.png"::: |
| [!INCLUDE [Create app service step 10](<./includes/quickstart-python/create-app-service-visual-studio-code-10.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-10-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select the location for the resources of the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-10.png"::: |
| [!INCLUDE [Create app service step 11](<./includes/quickstart-python/create-app-service-visual-studio-code-11.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-11-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select Create a new App Service plan for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-11.png"::: |
| [!INCLUDE [Create app service step 12](<./includes/quickstart-python/create-app-service-visual-studio-code-12.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-12-240px.png" alt-text="A screenshot of the dialog box in VS Code used to enter name of the App Service plan for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-12.png"::: |
| [!INCLUDE [Create app service step 13](<./includes/quickstart-python/create-app-service-visual-studio-code-13.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-13-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select Create a new App Service plan for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-13.png"::: |
| [!INCLUDE [Create app service step 14](<./includes/quickstart-python/create-app-service-visual-studio-code-14.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-14-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select the pricing tier for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-14.png"::: |
| [!INCLUDE [Create app service step 15](<./includes/quickstart-python/create-app-service-visual-studio-code-15.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-15-240px.png" alt-text="A screenshot of a dialog box in VS Code asking if you want to update your workspace to run build commands." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-15.png"::: |
| [!INCLUDE [Create app service step 16](<./includes/quickstart-python/create-app-service-visual-studio-code-16.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-16-240px.png" alt-text="A screenshot showing the confirmation dialog when the app code has been deployed to Azure." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-16.png"::: |

...
| [!INCLUDE [Create app service step 12](<./includes/quickstart-python/create-app-service-visual-studio-code-12.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-12-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select Create a new App Service plan for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-12.png"::: |
...
| [!INCLUDE [Create app service step 14](<./includes/quickstart-python/create-app-service-visual-studio-code-14.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-14-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select Create a new App Service plan for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-14.png"::: |
| [!INCLUDE [Create app service step 15](<./includes/quickstart-python/deploy-visual-studio-code-15.md>)] | :::image type="content" source="./media/quickstart-python/deploy-visual-studio-code-15-240px.png" alt-text="A screenshot of a dialog box in VS Code asking if you want to update your workspace to run build commands." lightbox="./media/quickstart-python/deploy-visual-studio-code-15.png"::: |
| [!INCLUDE [Create app service step 16](<./includes/quickstart-python/deploy-visual-studio-code-16.md>)] | :::image type="content" source="./media/quickstart-python/deploy-visual-studio-code-16-240px.png" alt-text="A screenshot showing the confirmation dialog when the app code has been deployed to Azure." lightbox="./media/quickstart-python/deploy-visual-studio-code-16.png"::: |

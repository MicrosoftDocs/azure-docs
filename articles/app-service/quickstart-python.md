...
| [!INCLUDE [Create app service step 11](<./includes/quickstart-python/create-app-service-visual-studio-code-11.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-11-240px.png" alt-text="A screenshot of the dialog box in VS Code used to select Create new App Service plan for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-11.png"::: |
...
| [!INCLUDE [Create app service step 13](<./includes/quickstart-python/create-app-service-visual-studio-code-13.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-13-240px.png" alt-text="A screenshot of the dialog box in VS Code used to a pricing tier for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-13.png"::: |
| [!INCLUDE [Create app service step 14](<./includes/quickstart-python/create-app-service-visual-studio-code-14.md>)] | :::image type="content" source="./media/quickstart-python/create-app-service-visual-studio-code-14-240px.png" alt-text="A screenshot of the dialog box in VS Code used to create a new Application Insights resource for the new web app." lightbox="./media/quickstart-python/create-app-service-visual-studio-code-14.png"::: |

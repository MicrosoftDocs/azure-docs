...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [!INCLUDE [Create app service step 1](./includes/tutorial-nodejs-mongodb-app/azure-portal-create-app-cosmos-1.md)] | :::image type="content" source="./media/tutorial-nodejs-mongodb-app/azure-portal-create-app-cosmos-1.png" alt-text="A screenshot showing how to use the search box in the top tool bar to find the Web App + Database creation wizard." lightbox="./media/tutorial-nodejs-mongodb-app/azure-portal-create-app-cosmos-1.png":::
    :::column-end:::
:::row-end:::
:::row:::
    :::column span="2":::
...
:::row:::
    :::column span="2":::
        **Step 3.** The deployment takes a few minutes to complete, and creates the following resources:
        ...
        - **Network interface** &rarr; Represents a private IP address for hte private endpoint.
...
:::row:::
    :::column span="2":::
        **Step 4.** 
        ...
        1. In the menu bar at the top, click **Save**.
...
:::row:::
    :::column span="2":::
        **Step 2.** From the left menu, click **Log stream**.
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        :::image type="content" source="./media/tutorial-nodejs-mongodb-app/azure-portal-inspect-kudu-3.png" alt-text="A screenshot showing how to enable native logs in App Service in the Azure portal." lightbox="./media/tutorial-nodejs-mongodb-app/azure-portal-inspect-kudu-3.png":::
    :::column-end:::
:::row-end:::
:::row:::
    :::column span="2":::
...
:::row:::
    :::column span="2":::
        **Step 5.** From the left menu, click **Log stream**.
        You see the logs for your app, including platform logs and logs from inside the container.
    :::column-end:::
    :::column:::
...
:::row:::
    :::column span="2":::
        **Step 2.** In the resource group page, click **Delete resource group**.
    :::column-end:::
    :::column:::

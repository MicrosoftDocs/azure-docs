...
- Health check will continue to ping the unhealthy instance after it has been removed from the load balancer. If the instance continues to respond unsuccessfully for one hour, it will be replaced with new VM.

...
## Instances
Once Health Check is enabled, you can restart and monitor the status of your application instances through the instances tab. The instances tab will show your instance's name, the status of that application's instance and give you the option to manually restart the instance.

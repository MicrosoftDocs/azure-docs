...
>[!NOTE] If you would rather not use _.htaccess_ rewrite, you can deploy your Laravel application with a [custom Docker image](quickstart-custom-docker-image.md) instead.

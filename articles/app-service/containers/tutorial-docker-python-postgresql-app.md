...
**   Please note it is not advised to leave all ports open to your database, nor to make your database internet-facing.  Please see other [Azure security articles](https://docs.microsoft.com/en-us/azure/security/) to properly secure your new database for production use.  

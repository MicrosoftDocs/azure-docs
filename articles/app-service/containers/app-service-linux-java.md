...
The example configuration snippets in this section use MySQL database. For additional information for other databases, see the configuration docs for [MySQL](https://dev.mysql.com/doc/connector-j/8.0/en/connector-j-usagenotes-tomcat.html) , [SQL Server JDBC], and [PostgreSQL].

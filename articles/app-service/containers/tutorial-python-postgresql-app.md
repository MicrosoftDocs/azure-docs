...
> [!NOTE]
> Before creating an Azure Database for PostgreSQL, please check [here](concepts-pricing-tiers.md) to see which compute generation is available in your region.

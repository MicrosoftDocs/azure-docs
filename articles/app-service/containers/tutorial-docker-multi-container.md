...
In this tutorial, you will learn how to take an existing .yaml file and deploy to Web App for Containers using the Azure Cloud Shell. The multi-container feature requires a custom .yml file similar to that of Docker Compose and Kubernetes.
...
### Sample compose-based configuration
```yaml
version: '3.1'
...
## Optional steps (is this the best area for this?? --mks)
Link to kubernetes sample on github.

## Next steps

> [!div class="nextstepaction"]
> [Learn more about the multi-container configuration options](link-to-yis-blog)

---
title: 'Tutorial: Java Enterprise app on Linux' 
description: Learn how to get a Java Enterprise app working in Wildfly on Azure App Service on Linux, with connection to a PostgreSQL database in Azure.

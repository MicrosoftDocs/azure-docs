...
The Azure WebJobs SDK can be used with WebJobs to simplify many programming tasks. For more information, see [What is the WebJobs SDK](https://github.com/Azure/azure-webjobs-sdk/wiki) and the [WebJobs SDK Cheat Sheet](https://docs.microsoft.com/azure/app-service/media/web-sites-create-web-jobs/webjobs-sdk-cheat-sheet.pdf).

---
title: 'Quickstart: Create a PHP app in the Azure portal'
description: Get started with Azure App Service by deploying your first PHP app to a Linux container in App Service by using the Azure portal.
ms.topic: quickstart
ms.date: 06/15/2022
ms.devlang: php
ms.custom: mode-ui

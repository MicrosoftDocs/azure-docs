...
> [!NOTE]
> Local cache is not supported in Function apps or containerized App Service apps, such as in [Windows Containers](quickstart-custom-container.md) or on [App Service on Linux](overview.md#app-service-on-linux).

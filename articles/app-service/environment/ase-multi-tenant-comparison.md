...
|[Pricing tiers](https://azure.microsoft.com/pricing/details/app-service/windows/) |Isolated v2, Isolated v4        |Free, Basic, Standard, Premium v2, Premium v3, Premium v4        |
...
|Feature  |App Service Environment v3  |App Service public multitenant  |
|---------|---------|---------|
|Virtual network integration|Supported. App Service Environment v3 is deployed into a subnet in your virtual network by default. |Supported, but [must be explicitly enabled](../../app-service/networking-features.md)|
|Private endpoint support|Supported, but [must be explicitly enabled in the App Service Environment](networking.md#private-endpoint)|Supported, but [must be explicitly enabled](../../app-service/networking-features.md#private-endpoint) |
|IP access restrictions for inbound traffic|Supported, but [must be explicitly enabled](../../app-service/networking-features.md#access-restrictions) |Supported, but [must be explicitly enabled](../../app-service/networking-features.md#access-restrictions) |

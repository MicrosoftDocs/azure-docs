...
description: Learn how to create, publish, and scale apps in an Azure App Service Environment. Find the common tasks in one document.
author: ccompy
...
1. Select **Review + create** then select **Create** if the information is correct.

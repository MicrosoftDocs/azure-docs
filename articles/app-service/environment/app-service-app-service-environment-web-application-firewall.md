...
![Diagram shows an optional Azure Traffic Manager connecting to instances of Web Application Firewall in a DMZ, connecting to Network ACL to only allow traffic from WAF in an App Service Environment that contains Web, API, and Mobile App for two regions.][Architecture] 

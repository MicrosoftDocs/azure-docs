...
By using your registrar's domain management tools, create a CNAME record that points the custom domain at the Traffic Manager domain.  The picture below shows an example of what this CNAME configuration looks like:

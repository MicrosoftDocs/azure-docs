...
The addresses noted below can be configured in a route table. This is important when operating your ASE in a force tunneled VNet. For details on how to configure your ASE to operate in an environment where outbound traffic is sent on premises, read [Configure your ASE with forced tunneling][forcedtunnel]

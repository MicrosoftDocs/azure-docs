...
In addition to monitoring resources with Azure Monitor, you can also use built-in diagnostics to assist with debugging an App Service app. You'll find more on this capability in [enable diagnostic logging for apps in Azure App Service](troubleshoot-diagnostic-logs.md).

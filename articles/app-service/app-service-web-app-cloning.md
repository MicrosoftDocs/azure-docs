...
App cloning is supported for Standard, Premium and Isolated app service plans. The new feature uses the same limits as the App Service Backup feature, see [Back up an app in Azure App Service](manage-backup.md).

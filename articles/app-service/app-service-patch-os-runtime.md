...
> [!NOTE]
> Access to registry location `HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Component Based Servicing\Packages`, where information on ["KB" patches]((https://github.com/projectkudu/kudu/wiki/Azure-Web-App-sandbox#writing-to-registry)) is stored, is locked down.
>
>

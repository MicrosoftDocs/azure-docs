...
1) Disable Caching for the authentication workflow
    ...
    See [Disable cache for auth workflow](/azure/static-web-apps/front-door-manual#disable-cache-for-auth-workflow) to learn more on how to confiure rules in Azure Front Door to disable caching for authentication and authorization-related pages.

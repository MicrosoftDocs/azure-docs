...
The following Azure PowerShell cmdlets can be used to monitor and manage Azure Stream Analytics jobs. For the cmdlets, example PowerShell commands are provided.

...
## <a name="privatekey"></a>Connect - manually enter SSH private key
...
1. Optionally, enter the username and select **SSH Private Key**.
...
## <a name="ssh"></a>Connect - SSH private key file

...
1. Use [this link](https://aka.ms/BastionHost) to open the preview portal page for the Azure Bastion. Navigate to the virtual machine that you want to connect to, then click **Connect**. The VM should be a Windows virtual machine when using an RDP connection.

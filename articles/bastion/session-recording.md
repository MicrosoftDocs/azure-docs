...
1. Under **Allowed IP addresses**, please select the IP address or the IP range to accept requests from. For more information, click [here](https://learn.microsoft.com/rest/api/storageservices/create-account-sas#specify-an-ip-address-or-ip-range)

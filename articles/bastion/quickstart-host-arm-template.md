...
> [!NOTE]
> The use of Azure Bastion with Azure Private DNS zones is not supported at this time. Before you begin, make sure that the virtual network where you plan to deploy your Azure Bastion resource is not linked to a private DNS zone.
...
By default, this template creates an Azure Bastion deployment with a resource group, a virtual network, network security group (NSG) settings, an AzureBastionSubnet subnet, an Azure Bastion host, and a public IP address resource that's used for the Azure Bastion host. Here's the purpose of each part of the template:
...
* [Microsoft.Network/publicIpAddresses](/azure/templates/microsoft.network/publicIpAddresses) specifies the public IP address value for the Azure Bastion host.

### Parameters

| Parameter name           | Description                                                                          |
|--------------------------|--------------------------------------------------------------------------------------|
| `Region`                   | Azure region for Azure Bastion and the virtual network.                                        |
...
In this section, you deploy Azure Bastion by using the Azure portal. You don't connect and sign in to your virtual machine or deploy Azure Bastion directly from your VM.
...
To validate the deployment of Azure Bastion:

...
This quickstart article shows you how to configure Azure Bastion based on your VM settings in the Azure portal, and then connect to the VM via private IP address. Once the Bastion service is provisioned, the RDP/SSH experience is available to all of the virtual machines in the same virtual network. 

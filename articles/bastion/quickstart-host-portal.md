...
This quickstart article shows you how to connect to a virtual machine using a private IP address through your browser using Azure Bastion and the Azure portal. In the Azure portal, from your Azure VM, you can deploy Bastion to your virtual network. After deploying the Bastion, you can connect to the VM via the private IP address. Your VM does not need a public IP address. One advantage of creating a Bastion host for your VNet directly from your VM is that many of the settings are prepopulated for you.

...
This quickstart article shows you how to connect to a virtual machine using a private IP address through your browser using Azure Bastion and the Azure portal. The steps in this article help you deploy Bastion to your virtual network from your virtual machine, and then connect to the VM. An advantage of creating a Bastion host for your VNet directly from your VM is that many of the settings are prepopulated for you.

...
For the correct key mappings for your target language, you must set either your local language on your computer or your remote language inside the VM to en-us-qwerty. That is, your local computer language must be set to English (United States) while your remote VM language is set to your target language, or vice versa. You can add English (United States) language to your machine in your computer settings.

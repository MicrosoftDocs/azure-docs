...
description: In this article, learn how copy and paste to an Azure Virtual Machine by using Azure Bastion.
services: bastion
author: cherylmc
...
ms.date: 05/16/2019
ms.author: cherylmc
# Customer intent: I want to copy and paste to a VM by using Azure Bastion.

---

# Copy and paste text across a local device and a remote session using Azure Bastion (preview)

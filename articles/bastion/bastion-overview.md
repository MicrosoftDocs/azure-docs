...
* **Protection again port scanning:** Because you do not need to expose your virtual machines to public Internet, your VMs are protected against port scanning by rogue and malicious users located outside your virtual network.
* **Protect against zero-day exploits and hardening in one place only:** Azure Bastion is a fully platform-managed PaaS service. You don't need to worry about hardening each of the VMs in your virtual network because Bastion sits at the perimeter of the VNet. The Azure platform will keep the Azure Bastion hardened and protects against zero-day exploits by keeping Azure Bastion always up-to-date for you.

...
The following table includes links to JSON samples for Azure Policy. These samples are also found in the [Azure Policy samples repository](https://github.com/Azure/azure-policy).

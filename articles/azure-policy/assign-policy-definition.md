...
In this tutorial, we assume you have a working SQL server. If not, go to the [Create a SQL database](../sql-database/sql-database-get-started-portal.md) in the Azure portal quickstart and create one.

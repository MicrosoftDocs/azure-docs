...
If your high-availability database cluster is using SQL Server AlwaysOn, refer to [Configure one or more Always On Availability Group Listeners](../sql-database/virtual-machines/windows/portal-ps-alwayson-int-listener.md) for step-by-step instructions.

...
If your high-availability database cluster is using SQL Server AlwaysOn, refer to [Configure one or more Always On Availability Group Listeners](../azure-sql/virtual-machines/windows/configure-availability-group-listener-powershell.md) for step-by-step instructions.

...
- For this guide you will need to create Public IP Addresses. To learn how, see [Create a public IP address](../public-ip-addresses/public-ip-address-create-portal.md).

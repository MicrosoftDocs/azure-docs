...
> [!NOTE]
> Azure Web App already provide round-robin load balancing functionality for websites within a Azure Region (contains multiple datacenters). Traffic Manager allows you to specify round-robin traffic routing method for websites in different datacenters.

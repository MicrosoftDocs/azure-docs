...
6. In the **Endpoints** blade, review the failover order for your endpoints. When you select the **Failover** traffic routing method, the order of the selected endpoints matters. The primary endpoint is on top. 
...
10. Test the changes in your configuration.

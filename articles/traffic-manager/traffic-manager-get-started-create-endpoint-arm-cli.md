<properties 
   pageTitle="Create an endpoint for Traffic Manager using the Azure CLI in Resource Manager | Microsoft Azure"
   description="Learn how to create an endpoint for Traffic Manager using the Azure CLI in Resource Manager"
...
# Create an endpoint for Traffic Manager using the Azure CLI
...
[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/learn-about-deployment-models-rm-include.md)] [classic deployment model](traffic-manager-get-started-create-endpoint-classic-cli.md).
...
## Add endpoint for Traffic Manager 
...
### Step 3
Azure CLI must be switched to ARM mode.

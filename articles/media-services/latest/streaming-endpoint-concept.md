...
|--------|--------|--------|  
|**Standard Streaming Endpoint** (recommended)|0|The **Standard** type is the recommended option for virtually all streaming scenarios and audience sizes. For customers with extremely demanding requirements AMS also offer **Premium** streaming endpoints, which can be used to scale out capacity for the largest internet audiences. If you expect large audiences and concurrent viewers, please contact us for guidance on whether you need to move to the **Premium** type. If you expect a concurrent audience size larger than 50,000 viewers, contact us at amsstreaming@microsoft.com.<br/>The **Standard** type scales outbound bandwidth automatically. |
...
There is no specific bandwidth value when adding the CDN because the amount of bandwidth that is needed for a CDN enabled streaming endpoint varies. A lot depends on the type of content, how popular it is, bitrates, and the protocols.  

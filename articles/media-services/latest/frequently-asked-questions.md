...
This section outlines the Azure portal limitations for Media Services v3.
...
* You cannot use the [Azure portal](https://portal.azure.com/) to analyze v3 content, use the Media Services v3 API to analyze.
* You can view jobs in the [Azure portal](https://portal.azure.com/) but to manage Media Services v3 [transforms and jobs](transforms-jobs-concept.md), use the [REST API](https://aka.ms/ams-v3-rest-ref), [CLI](https://aka.ms/ams-v3-cli-ref), or one of the supported [SDKs](media-services-apis-overview.md#sdks).

...
* Notifications have also been enhanced to integrate directly with the Azure Event Grid notification system. You can easily subscribe to events on several resources in Azure Media Services. For example, Job progress or states, or Live Channel start/stop and error events. 
* Customers can now use Resource Manager templates to create and deploy Transforms, Streaming Endpoints, Channels, and more.
...
* Stream sport events, such as the Olympic Games, live. 

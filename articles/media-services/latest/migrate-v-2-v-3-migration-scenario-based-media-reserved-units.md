...
* If you have an account that was created before the 2020-05-01 version of the API, you can still Have access to API’s for managing MRU’s, however none of the MRU configuration that you set will be used to control encoding concurrency or performance. For more information, see [Scaling Media Processing](../previous/media-services-scale-media-processing-overview). You can manage the MRUs using CLI 2.0 for Media Services V3, or using the Azure portal.

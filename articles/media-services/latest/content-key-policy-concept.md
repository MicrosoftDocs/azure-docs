...
The **Content Key Policy** is usually associated with your **Streaming Locator**. Alternatively, you can specify the Content Key Policy inside a Streaming Policy (when creating a custom Streaming Policy for advanced scenarios). 

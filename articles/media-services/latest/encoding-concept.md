...
Videos are typically delivered to devices and applications through [adaptive bitrate streaming](https://en.wikipedia.org/wiki/Adaptive_bitrate_streaming) or by [progressive download](https://en.wikipedia.org/wiki/Progressive_download). 

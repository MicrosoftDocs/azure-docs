...
>
> Media Services account names are used in DNS names, including for Key Delivery, RESTv2, Live Event and Streaming Endpoint names. If you have configured firewalls or proxies to allow Media Services

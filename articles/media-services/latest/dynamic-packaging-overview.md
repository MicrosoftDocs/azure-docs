...
In Media Services, a [Streaming Endpoint](streaming-endpoint-concept.md) is a dynamic packaging service used to deliver media content to client players. Dynamic Packaging is a feature that comes standard on all **Streaming Endpoints** (Standard or Premium). 

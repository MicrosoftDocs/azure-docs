...
You can use the [Azure Media Player demo page](https://ampdemo.azureedge.net/azuremediaplayer.html) to monitor the bitrate of a video stream. The demo page displays diagnostics info on the **Diagnostics** tab:

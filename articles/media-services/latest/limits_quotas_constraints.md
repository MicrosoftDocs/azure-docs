...
| Media reserved units (RUs) per Media Services account |25 (S1)<br/>10 (S2, S3) <sup>(1)</sup> | 
...
<sup>6</sup> There is a limit of 1,000,000 policies for different Media Services policies (for example, for Locator policy or ContentKeyAuthorizationPolicy). 

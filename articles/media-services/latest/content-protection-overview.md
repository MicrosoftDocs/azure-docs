...
|---|---|---|
|All|AES|`https://amsv3account-usw22.streaming.media.azure.net/ignite.ism/manifest(format=m3u8-aapl,encryption=cbc)`|
|MPG2-TS |CBCS (FairPlay) |`https://amsv3account-usw22.streaming.media.azure.net/ignite.ism/manifest(format=m3u8-aapl,encryption=cbcs-aapl)`|
|CMAF(fmp4) |CBCS (FairPlay) |`https://amsv3account-usw22.streaming.media.azure.net/ignite.ism/manifest(format=m3u8-cmaf,encryption=cbcs-aapl)`|
|MPG2-TS |CENC (PlayReady) |`https://amsv3account-usw22.streaming.media.azure.net/ignite.ism/manifest(format=m3u8-aapl,encryption=cenc)`|
|CMAF(fmp4) |CENC (PlayReady) |`https://amsv3account-usw22.streaming.media.azure.net/ignite.ism/manifest(format=m3u8-cmaf,encryption=cenc)`|
...
|CMAF(fmp4)|CENC (Widevine + PlayReady)|`https://amsv3account-usw22.streaming.media.azure.net/ignite.ism/manifest(format=mpd-time-cmaf,encryption=cenc)`|
...
|---|---|---|
|fMP4|AES|`https://amsv3account-usw22.streaming.media.azure.net/ignite.ism/manifest(encryption=cbc)`|

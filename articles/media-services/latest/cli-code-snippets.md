---
title: CLI commands
description: This article contains all the CLI commands available for Media Services.
...
# CLI commands for Media Services

This article contains all the CLI commands available for Media Services.
...
To view all of the details of the Media Services CLI commands, see the Media Services CLI reference.

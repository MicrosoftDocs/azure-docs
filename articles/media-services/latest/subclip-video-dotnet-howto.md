---
title: Sub-clip a video when encoding with Azure Media Services 
description: This topic describes how to sub-clip a video when encoding with Azure Media Services, using .NET SDK

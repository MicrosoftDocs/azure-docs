...
Azure Media Services is now generally available in the following regions: "Germany North", "Germany West Central", "Switzerland North" and "Switzerland West" regions. Custormers can use the Azure portal to deploy Media Services to these regions using the Azure portal.

...
When submitting a job, you can specify to ingest the source video using HTTPS URLs, SAS URLs, or paths to files located in Azure Blob storage. If using HTTPS URLs, the following considerations apply:  

...
| Jobs                    | Jobs are rescheduled in another Availability Zone. There will be a delay in processing time as "processing" Jobs will start over in the Availability Zone. |

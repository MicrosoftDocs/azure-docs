...
| Feature                                                                           | Basic pass-through                                                                                                | Standard pass-through                                                                                             | Standard or Premium1080p Live Event                                                                                                                          |
| --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| Recommended maximum layers in contribution feed  (within ingest bandwidth limits) | Up to 6                                                                                                           | Up to 12                                                                                                          | One audio                                                                                                                                                    |
| Maximum layers in output                                                          | Same as input                                                                                                     | Same as input                                                                                                     | Up to 6 (see System Presets below)                                                                                                                           |
| Maximum aggregate bandwidth of contribution feed                                  | Up to 5 Mbps                                                                                                      | Up to 60 Mbps                                                                                                     | N/A                                                                                                                                                          |
...
| Maximum bitrate for a single layer in the contribution                            | Up to 5 Mbps                                                                                                      | 20 Mbps                                                                                                           | 20 Mbps                                                                                                                                                      |
...
| Support for non-uniform input GOPs                    | Yes | Yes | No – input must have fixed GOP duration                                               |
| Support for variable frame rate input                 | Yes | Yes | No – input must be fixed frame rate. Minor variations are tolerated, for example, during high motion scenes. But the contribution feed cannot drop the frame rate (for example, to 15 frames/second). |

...
To play a different video, paste a different URL and press **Update**.

To configure various playback options (for example, tech, language, or encryption), press **Avanced Options** to configure

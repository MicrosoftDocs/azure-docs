---
title: Connect to Azure Media Services v3 API - Go
description: Learn how to connect to Media Services v3 API with Go.
...
---
# Connect to Media Services v3 API - Go

This article shows you how to connect to the Azure Media Services v3 Go SDK using the service principal sign in method.

In this article, the Visual Studio Code is used to develop an app.

## Prerequisites

- Follow [Writing Go with Visual Studio Code](https://code.visualstudio.com/docs/go/go-tutorial) to install:

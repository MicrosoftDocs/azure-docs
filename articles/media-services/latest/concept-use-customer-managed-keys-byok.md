...
> [!NOTE]
> Double encryption is enabled automatically on the Media Services account. However, you need to configure the customer managed key and double encryption on your storage account separately. See, [Storage encryption](../../storage/common/storage-service-encryption.md).

...
title: Overview of Azure Media Services v3 concepts - Azure | Microsoft Docs
description: This article discusses Azure Media Services v3 concepts.  
...
The **Concepts** section is comprized of topics that give details of important concepts and show workflows for achieving different scenarios with Azure Media Services v3. It also includes topics that talk about how Azure Media Services v3 entities are used in these workflows.
...
|Scenario | Topics |
|---|---|
|Encode content|[Encoding content](encoding-concept.md)|
|Stream live |[Workflow overview](live-streaming-overview.md)|
|Encrypt content|[Content protection overview](content-protection-overview.md)|

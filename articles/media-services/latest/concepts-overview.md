...
|Monitoring with Azure Monitor|Monitor metrics and diagnostic logs that help you understand how your applications are performing with Azure Monitor.|- [Metrics and diagnostic logs](media-services-metrics-diagnostic-logs.md)<br/>- [Diagnostic logs schemas](media-services-diagnostic-logs-schema.md)|

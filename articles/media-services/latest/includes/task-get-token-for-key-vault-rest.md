...
Use the following request to get a token for Key Vault.  Replace the `armEndpoint`, `subscription`, `resourceGroup`,`keyVaultName`, `resourceLocation`, `tenantId`, and `servicePrincipalObjectId` values. 

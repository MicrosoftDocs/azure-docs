...
:::code language="azurecli" source="https://github.com/Azure-Samples/media-services-v3-python/cli/code-snippets.sh" id="CreateStorage" interactive="azurecli-interactive":::
...
This topic shows how to use .NET to encode your assets with Media Encoder Standard (AMS). Media Encoder Standard is configured using one of the encoder presets described [here](http://go.microsoft.com/fwlink/?linkid=618336&clcid=0x409).

...
When you use the Azure Management Portal to publish your assets, the locators are created for you and you are provided with an OnDemant based URL (if your asset contains an .ism file) or a SAS URL.

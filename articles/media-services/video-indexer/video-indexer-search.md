...
1. Search among all videos in your account. 

    You can filter your search by selecting **Filters**. In below example, we choose to search for "Microsoft" an on-screen text only (OCR).
...
1. View and search the summarized insights of the video by clicking **Play** on the video or selecting one of your original search results. You can view, search, edit the **insights**. When you select one of the insights, the player brings you to that exact moment in the video.  
...
You can download the source video, insights of the video, transcripts by clicking **Download** from under your video.

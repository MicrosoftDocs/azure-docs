---
title: Customize a Person model with Video Indexer API
titleSuffix: Azure Media Services
description: Learn how to customize a Person model with the Video Indexer API.
...
Each account has a limit of 50 Person models. If you don't need the multiple Person model support, don't assign a Person model ID to your video when uploading/indexing or reindexing. In this case, Video Indexer uses the default custom Person model in your account.

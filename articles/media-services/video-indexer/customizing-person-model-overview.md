...
You can use the Video Indexer website to edit faces that were detected in a video in your account, as described in  topic in the [Next steps](#next-steps) section. 

...
Azure Media Services Video Indexer supports detection, grouping, and recognition of [characters in animated content](animated-characters-recognition.md), this functionality is available through the Azure portal and through API.

...
Starting with the version 2, the widget base URL includes the accout's region. For example, an account in the West US region generates: `https://wus2.videoindexer.ai/embed/insights/...`.

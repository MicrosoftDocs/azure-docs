...
|locale|The short language code|Controls the insights language. Default is `en`. For example: `language=de`.|
...
|captions|The language code|Fetches the caption in the given language during the widget loading to be available in the captions menu.<br/>Example: `captions=en-US`.|
...
|language|The language code|Controls the player language (default is en-US)<br/>Example: `language=de-DE`.|

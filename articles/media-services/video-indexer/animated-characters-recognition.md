...
1. Fill in the required fields as well as the access token and click **Send**. 
    ...
    For more information about how to get the Video Indexer access token go to the [developer portal](https://api-portal.videoindexer.ai/docs/services/authorization/operations/Get-Account-Access-Token?), and see the [relevant documentation](video-indexer-use-apis.mp#obtain-access-token-using-the-authorization-api).  

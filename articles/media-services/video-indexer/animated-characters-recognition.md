...
1. Tag and train the model.
    ...
    1. After you finished editing all names you want, you need to train the model.
        ...
        Open the customization page and click on the **Animated characters** tab. For the relevant model, click on the **Edit in Custom Vision** link. You will then be forwarded to the model's page in Custom Vision. Click on the **Train** button to train you model. 

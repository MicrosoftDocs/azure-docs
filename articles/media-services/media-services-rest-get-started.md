...
Once you have the AccessPolicy and Locator set, the actual file is uploaded to an Azure block blob storage container using the Azure Storage REST APIs. You can either upload in page or block blobs.

...
### [Protect content with storage encryption](media-services-rest-storage-encryption.md)
### [Protect content with AES-128 encryption](media-services-protect-with-aes128.md)
### [Protect content with PlayReady/Widevine](media-services-protect-with-playready-widevine.md)
### [Protect content with FairPlay](media-services-protect-hls-with-fairplay.md)
### [Protect content with offline PlayReady](https://blogs.msdn.microsoft.com/playready4/2016/10/26/does-azure-media-services-support-offline-mode/)
### [Protect content with offline FairPlay](media-services-protect-hls-with-offline-fairplay.md)
...
### License template overview
#### [PlayReady license template overview](media-services-playready-license-template-overview.md)

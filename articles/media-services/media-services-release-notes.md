...
#### Encoding
1.	You can now use the Premium Encoder to encode your content to H.265(HEVC) video codec. There is no pricing impact for choosing H.265 over other codecs like H.264. Please refer to the [Online Services Terms](https://azure.microsoft.com/en-us/support/legal/) for an important note regarding HEVC patent license(s).

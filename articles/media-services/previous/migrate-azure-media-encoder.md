...
This article discusses the steps for migrating from the legacy Azure Media Encoder (AME) media processor, which is being retired on March 31, 2020, to the Media Encoder Standard media processor.  

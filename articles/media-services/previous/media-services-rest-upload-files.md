...
- Also for more information Review the [Use Azure AD authentication to access the Media Services API with REST](https://docs.microsoft.com/en-us/azure/media-services/previous/media-services-rest-connect-with-aad) article.

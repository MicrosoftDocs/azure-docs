...
| Video Optical Character Recognition | June 1st, 2020 |This media processor was replaced by [Azure Media Services Video Indexer](../video-indexer/index.yml). Also, consider using [Azure Media Services v3 API](../latest/analyze-video-audio-files-concept.md). <br/>See [Compare Azure Media Services v3 presets and Video Indexer](../video-indexer/compare-video-indexer-with-media-services-presets.md). |

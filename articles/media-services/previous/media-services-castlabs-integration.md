...
To play back streaming content protected by CENC (PlayReady and/or Widevine), you can use  [Azure Media Player](http://aka.ms/azuremediaplayer). See [AMP document](https://amp.azure.net/libs/amp/latest/docs/) for details.
...
To play back a video encrypted with common encryption (PlayReady and/or Widevine), you can use the [Azure Media Player](http://aka.ms/azuremediaplayer). When running the console app, the Content Key ID and the Manifest URL are echoed.
...
2. Go to [Azure Media Player](http://aka.ms/azuremediaplayer).

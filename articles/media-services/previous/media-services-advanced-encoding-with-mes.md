...
> [!NOTE] 
> Many of the advanced Media Services v2 features of the Media Encoder Standard are currently not available in v3. For more information, see [feature gaps](../latest//migrate-from-v2-to-v3.md#feature-gaps-with-respect-to-v2-apis).

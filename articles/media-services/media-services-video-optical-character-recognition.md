...
| --- | --- |
|AdvancedOutput| If you set AdvancedOutput to true, the JSON output will contain time fragments. Time fragments will contain separate events comprised of regions, lines, and words, all tagged with positional and language data. If you set AdvancedOutput to false, the output will contain time fragments with text. For more information, see [this blog](https://azure.microsoft.com/blog/azure-media-ocr-simplified-output/).|

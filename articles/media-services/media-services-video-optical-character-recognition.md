...
| --- | --- |
|AdvancedOutput| If you set AdvancedOutput to true, the JSON output will contain time fragments, each of which contained separate events comprised of regions, lines, and words, all tagged with positional and language data. If you set AdvancedOutput to false, the output will contain time fragments which contain text. |

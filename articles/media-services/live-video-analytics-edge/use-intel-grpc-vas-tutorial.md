...
```
> [!TIP]
> Copy the template and store it under a new name for each possible pipeline. This way you can
> switch between models by creating a new deployment based on one these templates.

...
* The internet connection for your development machine should permit AQMP protocol over port 5671 (so that Azure IoT Tools can communicate with Azure IoT Hub).

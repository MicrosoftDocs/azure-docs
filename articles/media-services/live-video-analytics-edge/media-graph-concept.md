...
A media graph lets you define where media should be captured from, how it should be processed, and where the results should be delivered. You accomplish this by connecting components, or nodes n the desired manner. The diagram below provides a graphical representation of a media graph.   

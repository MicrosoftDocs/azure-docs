...
1. Check to see whether the response code is *200-OK*. Other response codes for the [IoT Edge runtime](../../iot-edge/iot-edge-runtime.md) include:
    ...
    * 500 - An error occurred in the IoT Edge runtime.
    ...
    > [!TIP]
    > If you experience issues running Azure IoT Edge modules in your environment, use **[Azure IoT Edge standard diagnostic steps](https://docs.microsoft.com/azure/iot-edge/troubleshoot?view=iotedge-2018-06)** as a guide for troubleshooting and diagnostics.

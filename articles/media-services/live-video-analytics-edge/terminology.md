...
By using [media sraph](#media-graph)s to record videos to an asset in Azure Media Services, you can make use of Media Services streaming capability to deliver video streams in HLS and DASH. You can learn more about that in the [video playback](video-playback-concept.md) article.

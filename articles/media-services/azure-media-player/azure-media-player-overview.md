...
To request new features, provide ideas or feedback, please submit to [UserVoice for Azure Media Player](http://aka.ms/ampuservoice). If you have and specific issues, questions or find any bugs, drop us a line at ampinfo@microsoft.com.

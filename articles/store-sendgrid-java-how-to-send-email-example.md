<properties pageTitle="How to Send Email Using SendGrid from Java in an Azure Deployment" description="" services="" documentationCenter="java" authors="thinkingserious" manager="sendgrid" editor="mollybos"/>

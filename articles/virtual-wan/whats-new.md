...
|4| Disabling branch-to-branch setting on Virtual WAN does not prevent inter-hub on-premises routes from being advertised to local on-premises if Routing Intent is enabled. | | None|

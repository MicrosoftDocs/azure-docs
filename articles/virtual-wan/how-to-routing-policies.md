...
* Scenario-specific troubleshooting:
  ...
  * **If you have route table associated with any subnet of spoke virtual network**, ensure that "Propagate gateway routes" in the route table is set to "Yes". Otherwise the virtual machines in the subnet will not be able to learn the routing intent effective routes from the defaultRouteTable. 

...
|Create alert rule for number of routes advertised to peer nearing limit |**Count Of Routes Advertised to Peer** monitors the number of prefixes advertised from the Virtual WAN ExpressRoute gateway to the circuit. 

...
1. To view your active point to site sessions, click on **Point-to-site Sessions**. 
...
1. This will show you all active point to site users that are connected to your User VPN gateway. To disconnect users from the User VPN gateway, click the ... context menu and click "Disconnect".

...
We also introduce the additional requirement that Azure Firewall should inspect branch-to-VNet and Vnet-to-branch traffic, but **not**  VNet-to VNet-traffic.  

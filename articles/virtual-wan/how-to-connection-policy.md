...
The following document describes how to use connection policoes in Azure Virtual WAN.
...
:::image type="content" source="./media/connection-policy/connection-policy-create-menu.png"alt-text="Screenshot showing the create connection policy experience."lightbox="./media/connection-policy/connection-policy-create-menu.png":::
...
1. Select the Virtual Network connections you want to apply the connection policy to. You can select multiple connections at once. If a connection is already assigned to a connection policy, selecting the connection will move the connection from the current connection policy to the new connection policy.
...
1. Select the Virtual Network connections you want to dissociate from connection polic and select **Save**. This will remove the connection policy settings from the Virtual Network connections and any existing connection-level settings will take effect.

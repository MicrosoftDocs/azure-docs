...
To turn on the EnableInternetSecurity flag, please use the following PowerShell command, substituting the appropriate values for your environment. 
...
3.  In **azureconfig.xml**, there's a field called **version**. If the number between the version tags is **1**,  change the **version** number to **2**.

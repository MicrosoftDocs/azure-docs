...
## FAQs
### What customer benefit does this provide?
...
This can be enabled via the **Virtual WAN** -> **Settings** -> **Configuration** tab. Here you can specify your preferred categories of O365 traffic for direct internet breakout.

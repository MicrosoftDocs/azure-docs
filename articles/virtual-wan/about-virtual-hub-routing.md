...
* **Private Traffic Routing Policy**: When a Private Traffic Routing Policy is configured on a Virtual WAN hub, **all** traffic in and out of the Virtual WAN Hub will be forwarded to the Next Hop resource specified as pat of the Routing Policy. 

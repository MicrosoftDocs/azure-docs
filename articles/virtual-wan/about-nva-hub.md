...
* **Platform-provided lifecycle management**: Upgrades and patches are managed either directly by the customer or as part of the Azure Virtual WAN service. For best practices related to software lifecycle management for NVAs in Virtual WAN, please reach out to your NVA provider or reference provider documentation.

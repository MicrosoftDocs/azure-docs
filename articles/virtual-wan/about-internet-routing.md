...
|SaaS solution| If the SaaS solution is configured to route Internet traffic through the SaaS solution's internal interface, Internet traffic will be processed by the SaaS solution and blackholed. Applications don't have access to the internet via the SaaS solution.|

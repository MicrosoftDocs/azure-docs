...
| **Gateway Inbound Flows** | Number of distinct 5-tuple flows flowing into a VPN Gateway. Limit is 250k flows.|
| **Gateway Outbound Flows** | Number of distinct 5-tuple flows flowing out of a VPN Gateway. Limit is 250k flows.|
...
| **Tunnel Flow Count** | Number of distinct 3-tuple flows created per link connection.|

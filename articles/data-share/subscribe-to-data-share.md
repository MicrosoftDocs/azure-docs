...
* Resource Provider registration for Microsoft.DataShare. See [Azure resource Providers](https://docs.microsoft.com/azure/azure-resource-manager/resource-manager-supported-services) for information on how to do this. 

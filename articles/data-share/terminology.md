...
A data share is a group of datasets that are shared as a single entity. Datasets can be from a number of Azure data sources that are supported by Azure Data Share. Currently, Azure Data Share [supported data stores](https://docs.microsoft.com/azure/data-share/supported-data-stores#supported-data-stores). 

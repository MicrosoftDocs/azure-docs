...
A panel appears on the right side of the page. Select **Add Recipient** and then fill in the email of your new recipient on the blank line. Make sure to use recipient's Azure sign-in email (using their email alias won't work).
...
Select **Add and send invitation**. The new recipients will be sent invitation emails to this share.

...
> [!NOTE] 
> The CSV file format does not support quotechar. So there won't be any single character that would quote column values if it contains column delimiter **comma** `,`.

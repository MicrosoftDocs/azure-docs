...
When you are done with the container, you can remove it by going to the **All resources** tab of the Azure portal, click the checkbox next to the resource and then click **Delete**.

...
description: Start here to learn how to monitor Container Instances.
ms.date: 02/07/2024
...
For more information about the resource types for Container Instances, see [Container Instances monitoring data reference](monitor-container-instances-reference.md).
...
All metrics for Container Instances are in the namespace **Container group standard metrics**. In a container group with multiple containers, you can additionally filter on the  **containerName** dimension to acquire metrics from a specific container within the group.

...
* Container groups cannot use managed identity to authenticate image pulls from Azure container registry's that use [private DNS zones](../zones/priate-ds-privatednszone.md).

...
- Recommended [relocation methods](#relocation-methods).
- Recommended [relocation strategies](#relocation-strategies).
- Recommendations for specific [architectural pattern](#relocation-architectural-patterns) relocations. 

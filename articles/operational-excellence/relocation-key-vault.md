...
First, you must create a new key vault in the region to which you wish to move. You can do so through the [Azure portal](/azure/keyvault/general/quick-create-portal), the [Azure CLI](/azure/keyvault/general/quick-create-cli), or [Azure PowerShell](/azure/keyvault/general/quick-create-powershell).
...
- [Azure Key Vault backup and restore](/azure/keyvault/general/backup)
- [Moving an Azure Key Vault across resource groups](/azure/keyvault/general/move-resourcegroup)
- [Moving an Azure Key Vault to another subscription](/azure/keyvault/general/move-subscription)

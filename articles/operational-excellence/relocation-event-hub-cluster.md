...
See the [Move Event Hubs namespaces across regions](relocate-event-hub.md) article for instructions on moving a namespace from one region to another region. 

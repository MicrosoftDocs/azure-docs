...
|Region|Country Code|Address points<sup>1</sup>|House numbers<sup>2</sup>|Street level|City level|Points of interest|
|--- |--- |--- |--- |--- |--- |--- |
|**Americas**|
|Anguilla|AI| | | |●|●|
|Antarctica|AQ| | | |●|●|
...
|Saint Lucia|LC| | | |●|●|
|Saint Martin|MF| | |●|●|●|
|Saint Pierre and Miquelon, Overseas Collectivity of|PM| | |●|●|●|

---
title: Find route to a point of interest | Microsoft Docs
description: Use Azure Location Based Services to find the route to a point of interest
...
# Use Azure Location Based Services to find the route to a point of interest
...
> [!div class="checklist"]
> * Provide address to Reverse Geocoding API to retrieve coordinates
...
Advance to the next tutorial to learn how to find routes prioritized by mode of travel. 
<!--- 

...
4. One the next page, click **注册开发者 (Registered Developers)** from the top right corner menu. 
...
6. Download and unzip the [Baidu Push Android SDK], open the **libs** folder and copy the *pushservice-x.y.z* jar file in the libs folder and copy the *armeabi* & *mips* folders in the bin folder of your Android application. 
...
8. Add the following configuration within the application element after the .MainActivity activity element:
...
10. Add the following code to it:
		...
		public class ConfigurationSettings {
		    public static String API_KEY = "xxxxxxxxxxxxx";
		}
	Set the value of the API_KEY with what you retrieved from the Baidu cloud project earlier. 
...
You can send notifications using Notification Hubs from any back-end that uses our <a href="http://msdn.microsoft.com/en-us/library/windowsazure/dn223264.aspx">REST interface</a>. 

###To send notifications using a .NET console app:

1. Create a new Visual C# console application: 

2. Add a reference to the Azure Service Bus SDK with the <a href="http://nuget.org/packages/WindowsAzure.ServiceBus/">WindowsAzure.ServiceBus NuGet package</a>. In the Visual Studio main menu, click **Tools**, then **Library Package Manager**, then **Package Manager Console**. Then, run the following command in the console window type:

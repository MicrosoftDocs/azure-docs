...
In this article, you learn how to deploy a security module on your IoT Edge device.

## Deploy security module

Below are the required steps to deploy ASC for IoT security module for IoT Edge.
...
1. Go to the Marketplace in Azure portal.
...
1. Choose your Subscription, IoT Hub and IoT Edge Device Name and click **Create**.

1. Click **Next** twice to Review Deployment.

1. Make sure **edgeHub.settings.createOptions** is as follows:

...
| Does this affect me? | Cause | Resolution |
| --- | --- | --- |
| The affected method is used in the following articles:<br><br>[*Tutorial: Code a client app*](tutorial-code.md)<br><br>[*How-to: Write app authentication code*](how-to-authenticate-client.md)<br><br>[*How-to: Use the Azure Digital Twins APIs and SDKs*](how-to-use-apis-sdks.md) | This is related to an open issue with version **1.2.0** of the `Azure.Identity` library: [*Fail to authenticate when using InteractiveBrowserCredential*](https://github.com/Azure/azure-sdk-for-net/issues/13940). | To resolve, update your applications to use the [latest version](https://www.nuget.org/packages/Azure.Identity) of `Azure.Identity`. After updating the library version, the browser should load and authenticate as expected. |

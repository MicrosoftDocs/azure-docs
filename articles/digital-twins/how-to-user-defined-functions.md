...
Telemetry generated by the sensor described in the topology should trigger the execution of the user-defined function that was uploaded. Once the telemetry is picked up by the data processor, an execution plan is created for the invocation of the user-defined function.

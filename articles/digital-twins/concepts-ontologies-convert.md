...
There's a sample application available that converts an RDF-based model file to [DTDL Version 2 (V2)](https://github.com/Azure/opendigitaltwins-dtdl/blob/master/DTDL/v2/dtdlv2.md). DTDL V2 is supported by Azure Digital Twins, but you can also follow [these instructions](how-to-manage-model.md#convert-v2-models-to-v3) to convert DTDL V2 models to the newer DTDL V3.

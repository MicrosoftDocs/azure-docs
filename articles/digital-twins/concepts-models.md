...
Once you are finished creating, extending, or selecting your models, you can upload them to your Azure Digital Twins instance to make them available for use in your solution. This is done using the [Azure Digital Twins APIs](how-to-use-apis-sdks), as described in [*How-to: Manage DTDL models*](how-to-manage-model.md#upload-models).

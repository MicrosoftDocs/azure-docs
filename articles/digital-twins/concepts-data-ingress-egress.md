...
To send twin data to [Azure Data Explorer (ADX)](/azure/data-explorer/data-explorer-overview), set up a [Data History connection](concepts-data-history.md) that automatically historizes digital twin property updates from your Azure Digital Twins instance to an Azure Data Explorer cluster. You can then query this data in ADX using the [Azure Digital Twins query plugin for Azure Data Explorer](concepts-data-explorer-plugin.md).

...
This version of this article goes through these steps manually, one by one. To run through an automated setup using a deployment script sample, see the scripted version of this article: [Set up an instance and authentication (Scripted)](how-to-set-up-instance-scripted.md)

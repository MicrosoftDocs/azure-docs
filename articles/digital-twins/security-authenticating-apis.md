...
1. Select the **Authorization Tab**, click on **OAuth 2.0**, and select **Get New Access Token**.
    ...
    | Auth URL | https://login.microsoftonline.com/<Your Azure AD Tenant ie Contoso>.onmicrosoft.com/oauth2/authorize?resource=0b07f429-9f4b-4714-9392-cc5e8e80c8b0 |

...
The Azure Digital Twins commands are part of the [Azure IoT extension for Azure CLI](https://github.com/Azure/azure-iot-cli-extension). You can view the full list of commands and their usage as part of the reference documentation for the `az iot` command set: [*az dt*](https://docs.microsoft.com/cli/azure/ext/azure-iot/dt?view=azure-cli-latest).

You can make sure you have the latest version of the extension with these steps. You can run these commands in the [Azure Cloud Shell](../cloud-shell/overview.md) or a [local Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest).
...
* [*az dt* CLI commands](https://docs.microsoft.com/cli/azure/ext/azure-iot/dt?view=azure-cli-latest)

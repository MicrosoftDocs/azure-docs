...
To set up the initialized data, first you'll create a data object to represent the twin and its property data. Then you can use `JsonSerializer` to pass a serialized version of this into the API call for the `initdata` parameter.

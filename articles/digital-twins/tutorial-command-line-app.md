...
:::image type="content" source="media/tutorial-command-line/app/start-button-sample.png" alt-text="The Visual Studio start button (SampleClientApp project)." lightbox="media/tutorial-command-line/app/start-button-sample.png":::
...
:::image type="content" source="media/tutorial-command-line/app/command-line-app.png" alt-text="Welcome message from the command-line app." lightbox="media/tutorial-command-line/app/command-line-app.png":::
...
1. Verify the models were created by running the command `GetModels true`. This will query the Azure Digital Twins instance for all models that have been uploaded, and print out their full information. Look for the edited *Room* model in the results:
    ...
    :::image type="content" source="media/tutorial-command-line/app/output-get-models.png" alt-text="Results of GetModels, showing the updated Room model." lightbox="media/tutorial-command-line/app/output-get-models.png":::
...
1. Run this code in the running project console to create several twins, based on the *Room* model you updated earlier and another model, *Floor*. Recall that *Room* has three properties, so you can provide arguments with the initial values for these. (Initializing property values is optional in general, but they're needed for this tutorial.)
    ...
    :::image type="content" source="media/tutorial-command-line/app/output-create-digital-twin.png" alt-text="Excerpt from the results of CreateDigitalTwin commands, showing floor0, floor1, room0, and room1." lightbox="media/tutorial-command-line/app/output-create-digital-twin.png":::
...
1. Run the following code to add a "contains" relationship from each of the *Floor* twins you created earlier to a corresponding *Room* twin. The relationships are named *relationship0* and *relationship1*.
    ...
    :::image type="content" source="media/tutorial-command-line/app/output-create-relationship.png" alt-text="Excerpt from the results of CreateRelationship commands, showing relationship0 and relationship1." lightbox="media/tutorial-command-line/app/output-create-relationship.png":::
...
1. **What are all the rooms on *floor0* with a temperature above 75?** (compound query)
    ...
    :::image type="content" source="media/tutorial-command-line/app/output-query-compound.png" alt-text="Results of compound query, showing no results." lightbox="media/tutorial-command-line/app/output-query-compound.png":::

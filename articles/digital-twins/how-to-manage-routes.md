...
| Data Schema | DTDL Model ID | `"filter": "dataschema = 'dtmi:example:com:floor4;2'"` | **For telemetry** the schema is the model id of the twin or the component which the telemetry is emitted from.<br>**For notifications** data schema is not supported|

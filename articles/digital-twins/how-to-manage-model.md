...
>[!NOTE]
>During preview, advancing a model version will only allow you to remove fields, not add new ones. To add new fields, you should just [create a brand new model](#create-models).

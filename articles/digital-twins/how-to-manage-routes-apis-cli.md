...
Event routes can be created with the Azure Digital Twins [**EventRoutes data plane APIs**](/rest/api/digital-twins/dataplane/eventroutes) or [az dt route CLI commands](/cli/azure/ext/azure-iot/dt/route?view=azure-cli-latest). The rest of this section walks through the creation process.
...
Routes can also be managed using the [az dt route](/cli/azure/ext/azure-iot/dt/route?view=azure-cli-latest) commands for the Azure Digital Twins CLI. 

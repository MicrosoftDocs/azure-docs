...
This article walks you through the process of creating endpoints and routes with the [Azure Digital Twins **APIs and SDKs**](how-to-use-apis-sdks.md), with some use of the [Azure Digital Twins **CLI**](how-to-use-cli.md).

Alternatively, you can manage endpoints and routes with the [**Azure portal**](https://portal.azure.com). For a version of this article that uses the portal instead, see [*How-to: Manage endpoints and routes (portal)*](how-to-manage-routes-portal.md).

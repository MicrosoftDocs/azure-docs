...
The samples in this section use the [.NET (C#) SDK](/dotnet/api/overview/azure/digitaltwins/client?view=azure-dotnet-preview&preserve-view=true).
...
To add a filter, you can use a PUT request to *https://{Your-azure-digital-twins-hostname}/eventRoutes/{your-event-route-name}?api-version=2020-10-31-preview* with the following body:

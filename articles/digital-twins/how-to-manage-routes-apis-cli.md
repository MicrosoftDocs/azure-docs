...
Endpoints and routes can be managed with the [Event Routes APIs](/rest/api/digital-twins/dataplane/eventroutes), the [.NET (C#) SDK](https://dev.azure.com/azure-sdk/public/_packaging?_a=package&feed=azure-sdk-for-net&view=overview&package=Azure.DigitalTwins.Core&version=1.0.0-alpha.20201030.1&protocolType=NuGet), or the [Azure Digital Twins CLI](how-to-use-cli.md). This article walks you through the process of creating endpoints and routes through these mechanisms.
...
The samples in this section use the latest [.NET (C#) SDK](https://dev.azure.com/azure-sdk/public/_packaging?_a=package&feed=azure-sdk-for-net&view=overview&package=Azure.DigitalTwins.Core&version=1.0.0-alpha.20201030.1&protocolType=NuGet).

...
>[!NOTE]
>The concept of ontologies as it's used in this article is different from [Fabric ontology](/fabric/iq/ontology/overview), a Fabric item for defining an enterprise vocabulary.

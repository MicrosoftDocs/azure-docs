...
>
> Assign the role using the user's Object ID instead. This error might happen for users on personal [Microsoft accounts (MSAs)](https://account.microsoft.com/account). 
>

...
## Integrate events with Event Grid 
In this section, we will set up an [Event Grid](../event-grid/overview.md) to collect events from your Digital Twins instance as the [source](../event-grid/event-sources.md), and redirect them to an [event handler](../event-grid/event-handlers.md) like the Logic App.
...
1. In a command window, navigate to the **_occupancy-quickstart\src_** folder of the Digital Twins sample.

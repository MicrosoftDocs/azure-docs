...
2. Select **Diagnostic settings** from the menu, then **Add diagnostic setting**.
    ...
    :::image type="content" source="media/troubleshoot-diagnostics/troubleshoot-diagnostics.png" alt-text="Screenshot showing the diagnostic settings page and button to add":::

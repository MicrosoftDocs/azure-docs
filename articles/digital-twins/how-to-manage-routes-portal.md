...
This article walks you through how to manage endpoints and routes with the [Azure Digital Twins **APIs and SDKs**](how-to-use-apis-sdks.md), with some use of the [Azure Digital Twins **CLI**](how-to-use-cli.md).

Alternatively, you can manage endpoints and routes with the [Azure Digital Twins **APIs and SDKs**](how-to-use-apis-sdks.md), or the [Azure Digital Twins **CLI**](how-to-use-cli.md). For a version of this article that uses these mechanisms instead, see [*How-to: Manage endpoints and routes (APIs and CLI)*](how-to-manage-routes-apis-cli.md).

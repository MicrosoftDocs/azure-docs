...
The result is a set of open-source DTDL-based ontologies, which learn from, build on, or directly use industry standards. These ontologies provide common ground for modeling based on standards in these industries to avoid the need for reinvention. They are designed to meet the needs of downstream developers, with the potential to be widely adopted and extended by the industry.
...
These are the ontologies that are currently available.

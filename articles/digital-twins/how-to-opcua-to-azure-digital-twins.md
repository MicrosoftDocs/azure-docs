...
Your VM must be reachable over the internet. To keep things simple, you can open all ports and assign the VM a Public IP address. This is a security risk, but it is a proof of concept, and you may be okay with the risk. Consider better security measures for your environment.
...
Copy the Connection Address (UA TCP) and replace the machine name with the Public IP of your VM. You will need this later for the publishednodes.json file.
...
Create an Azure IoT Hub instance by following these steps. Creating a free instance is adequate for this example.

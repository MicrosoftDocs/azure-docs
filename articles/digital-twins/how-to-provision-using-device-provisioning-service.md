...
:::code language="csharp" source="~/digital-twins-docs-samples/samples/csharp/adtIotHub_allocate.cs":::
...
:::code language="csharp" source="~/digital-twins-docs-samples/samples/csharp/adtIotHub_delete.cs":::

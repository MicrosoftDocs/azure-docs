...
You can visualize your Azure Digital Twins graph in [**Azure Digital Twins Explorer**](/samples/azure-samples/digital-twins-explorer/digital-twins-explorer/).

Here's a view of what the visualization looks like:

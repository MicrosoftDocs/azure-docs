...
Otherwise, follow the steps in [Manage endpoints](how-to-manage-endpoints.md) and then [Manage routes and filters](how-to-manage-routes.md). Keep these pointers in mind:

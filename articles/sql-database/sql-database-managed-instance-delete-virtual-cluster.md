...
This article descrives methods to delete VNet after deleting Azure SQL Database managed instance.
...
Deleting the virtual cluster used by the VNet will relese this network resource for further usage. The virtual cluster should not contain any managed instance in order to be deleted. Manual deletion of the virtual cluster is achieved through Azure portal or [virtual cluster API](https://docs.microsoft.com/rest/api/sql/virtualclusters). 

...
> Database diagnostics telemetry is on the other hand available in the form of [diagnostics logs](../azure-sql/database/configure-streaming-export-metrics-diagnostic-telemtry-logging.md#diagnostic-telemetry-for-export). Alerts on diagnostics logs can be setup from within [SQL Analytics](../azure-monitor/insights/azure-sql.md) product using [log alert scripts](../azure-monitor/insights/azure-sql.md#creating-alerts-for-managed-instances) for managed instance.

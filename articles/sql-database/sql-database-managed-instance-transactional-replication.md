...
Transactional replication is usefull in the following scenarios:
...
- Migrate databases from one SQL Server or Managed Instance to another database bu continously publishing the changes.

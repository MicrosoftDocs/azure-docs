...
2. Follow the instructions in the [geo-restore](sql-database-recovery-using-backups.md#geo-restore) topic of the page on restoring Azure SQL Databases from automatic backups.

...
- Create an Azure Key Vault and Key to use for TDE.
   ...
   - [Instructions for using a hardware security module (HSM) and Key Vault](../key-vault/key-vault-get-started.md#a-idhsmaif-you-want-to-use-a-hardware-security-module-hsm.md)

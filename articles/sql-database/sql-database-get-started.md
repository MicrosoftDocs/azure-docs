<properties
	...
	description="Create a first SQL database in minutes in the Azure portal with sample data and using Microsoft's relational database management system (RDBMS)."

...
* [Zone-redundant databases](sql-database-high-availability.md#availability-capabilities)
...
* Identify the logical server in another region to become the new primary server. For geo-restore, this will generally be a server in the [paired region](../best-practices-availability-paired-regions.md) for the region in which your database is located. This will eliminate the additional traffic cost during the geo-restoring operations.

...
This article provides guidance for monitoring and performance tuning in Azure SQL Database.

[!INCLUDE [support-disclaimer](../../includes/support-disclaimer.md)]

## Monitoring and troubleshooting database perfomance

Azure SQL Database enables you to easily monitor your database usage aand identify queries that might cause performance issues. You can monitor database performance using Azure portal or system views. You have the following options for monitoring and troubleshooting database performance:
...
See the [performance guidance topic](sql-database-performance-guidance.md) for detailed monitoring and tuning tips.
...
[Enable automatic tuning](sql-database-automatic-tuning-enable.md) and let Azure SQL database automatically fix identified perfromance issues.

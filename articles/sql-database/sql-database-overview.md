---
title: Create & manage an Azure SQL database | Microsoft Docs
...
# Create and manage an Azure SQL database
...
> [!TIP]
> For valid server names, see [Naming rules and restrictions](https://docs.microsoft.com/azure/architecture/best-practices/naming-conventions).
>

### Single databases, pooled databases, and partitioned databases
...
## Create and manage an Azure SQL database using PowerShell
...
## Create and manage an Azure SQL database using the Azure CLI
...
|[az sql db create](/cli/azure/sql/db#create) |Creates adatabase|
...
## Create and manage an Azure SQL database using Transact-SQL
...
## Create and manage an Azure SQL database using the REST API

To create and manage an Azure SQL Database using the REST API, see [Azure SQL Database REST API](/rest/api/sql/).
...
- For information about specific resource quotas and limitations based on your **service tier**, see [SQL Database service tiers](sql-database-service-tiers.md).

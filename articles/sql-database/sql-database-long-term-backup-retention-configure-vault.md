...
1. Open the **SQL Server** page for your server.
   ...
   ![sql server page](./media/sql-database-single-database-get-started/sql-server-blade.png)
...
2. Open the **SQL database** page for your database.
   ...
   ![new sample db page](./media/sql-database-single-database-get-started/new-sample-db-blade.png)

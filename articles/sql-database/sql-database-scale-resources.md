...
- For information about improving database performance by changing database code, see [Find and apply performance recommendations](../azure-sql/database/find-apply-database-advisor-recommendations-portal.md).

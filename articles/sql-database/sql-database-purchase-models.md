...
- Access performance-tuning recommendations that show actions taken by [SQL Database Advisor](../azure-sql/database/implement-database-advisor-performance-recommendations.md).

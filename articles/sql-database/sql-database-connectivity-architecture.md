...
Details of how traffic shall be migrated to new Gateways in specific regions is in the following article: [Azure SQL Database traffic migration to newer Gateways](sql-database-gateway-migration.md)

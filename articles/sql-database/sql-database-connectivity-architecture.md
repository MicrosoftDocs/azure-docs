...
> [!IMPORTANT]
> When using service endpoints with Azure SQL Database your policy is **Proxy** by default. So to enable connectivity from inside your Vnet you must allow outbound to Azure SQL Database Gateway IP addresses specified in the list below.

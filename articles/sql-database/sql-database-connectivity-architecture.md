...
> [!NOTE]
> This topic applies to Azure SQL Database servers hosting single databases and elastic pools, SQL Data Warehouse databases, Azure Database for MySQL, and Azure Database for PostgreSQL. For simplicity, SQL Database is used when referring to SQL Database, SQL Data Warehouse, Azure Database for MySQL, and Azure Database for PostgreSQL.

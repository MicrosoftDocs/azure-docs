...
< [AZURE.IMPORTANT] To recover using automated backups, you must have at least SQL DB Contributor permissions in the Azure subscription. You can recover using the Azure portal, PowerShell or the REST API. You cannot use Transact-SQL. 

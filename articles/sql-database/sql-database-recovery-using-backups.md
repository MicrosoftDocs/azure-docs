...
For more information about included storage and maximum database size, see [Single database service tiers, performance levels, and storage amounts](sql-database-single-database-resources.md#single-database-service-tiers-performance-levels-and-storage-amounts) and [P11-P15 current limitations](sql-database-single-database-resources.md#current-limitations-of-p11-and-p15-databases-with-maxsize-greater-than-1-tb).  

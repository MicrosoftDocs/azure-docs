...
> [!IMPORTANT]
> Azure SQL Database also now supports a vCore-based resourcing model (preview). For information, see [vCore-based resourcing model (preview)](sql-database-service-tiers.md#vcore-based-resourcing-model-preview).

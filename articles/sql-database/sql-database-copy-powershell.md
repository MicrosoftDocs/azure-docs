---
title: Copy an Azure SQL database using PowerShell | Microsoft Docs
...
* [Azure SQL Database PowerShell Cmdlet Reference](https://msdn.microsoft.com/library/mt574084\(v=azure.300\).aspx)

...
You can use SQL Server Management Studio (SSMS) to administer Azure SQL Database logical servers and databases. This topic walks you through common tasks with SSMS. You should already have a logical server and database created in Azure SQL Database before you begin. See [Create your first Azure SQL Database](sql-database-get-started.md) and the article on how to [Connect and Quiery using SSMS](https://azure.microsoft.com/documentation/articles/sql-database-connect-query-ssms/) for information about how to connect and then run a simple SELECT query.

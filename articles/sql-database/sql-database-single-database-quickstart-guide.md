...
- After creating the database, you would need to [secure your database by configuring firewall rules](sql-database-sql-database-server-level-firewall-rule.md).

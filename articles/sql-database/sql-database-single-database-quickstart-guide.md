...
- [Create and configure a single database using PowerShell](../azure-sql/database/scripts/create-and-configure-database-powershell.md) or [Azure CLI](../azure-sql/database/scripts/create-and-configure-database-cli.md)
- [Update your single database and scale resources using PowerShell](../azure-sql/database/scripts/monitor-and-scale-database-powershell.md) or [Azure CLI](../azure-sql/database/scripts/monitor-and-scale-database-cli.md)

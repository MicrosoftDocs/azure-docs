...
- [Active geo-replication](sql-database-active-geo-replication.md) with Transactional replication. Instead of active geo-replication, use [Auto-failover groups](sql-database-auto-failover-group.md) instead, but the publication has to be [manually deleted](sql-database-managed-instance-transact-sql-information.md#replication) from the primary and recreated on the secondary managed instance after failover.  

...
-   Set up Data Sync
    ...
    - With PowerShell
        ...
        -  [Use PowerShell to sync between a database in SQL Database and a databases in a SQL Server instance](scripts/sql-database-sync-data-between-azure-onprem.md)

...
The [New-AzureRmSqlDatabaseExport](https://msdn.microsoft.com/library/mt707796(v=azure.300\).aspx) cmdlet submits an export database request to the service. Depending on the size of your database, the export operation may take some time to complete.
...
- [New-AzureRmSqlDatabaseExport](https://msdn.microsoft.com/library/mt707796(v=azure.300\).aspx)
- [Get-AzureRmSqlDatabaseImportExportStatus](https://msdn.microsoft.com/library/mt707794(v=azure.300\).aspx)
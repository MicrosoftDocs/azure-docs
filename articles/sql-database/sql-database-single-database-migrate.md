...
In addition to searching the Internet and using these resources, use the [Microsoft Q&A question page for MSDN SQL Server community](https://docs.microsoft.com/answers/topics/azure-synapse-analytics.html) or [StackOverflow](https://stackoverflow.com/).

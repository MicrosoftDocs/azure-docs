...
You can copy a SQL database using the [Azure portal](sql-database-copy-portal.md), [PowerShell](sql-database-copy-powershell.md). or [T-SQL](sql-database-copy-transact-sql.md). 

...
* A configured server-level firewall rule. For more information, see [Create server-level firewall rule](sql-database-sql-database-server-level-firewall-rule.md).

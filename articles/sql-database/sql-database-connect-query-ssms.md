...
- To get started with creating database users and database user administrators, see [Get Started with Azure SQL Database security](sql-database-sql-database-control-access-sql-authentication-get-started.md)

...
To measure lag with respect to changes on the primary database that have been applied on the secondary, i.e. available to read from the geo-secondary,  use *last_commit* column on the secondary database using the same view.

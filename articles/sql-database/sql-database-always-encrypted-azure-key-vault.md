<properties
	...
	keywords="data encryption, encryption keys"	
...
# Protect sensitive data in SQL Database with database encryption and store your encryption keys in the Azure Key Vault

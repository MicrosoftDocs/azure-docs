...
5. Delete the compromised key from Key Vault using the [Remove-AzureKeyVaultKey](/powershell/module/az.keyvault/remove-azurekeyvaultkey) cmdlet. 
...
6. To restore a key to Key Vault in the future using the [Restore-AzureKeyVaultKey](/powershell/module/az.keyvault/restore-azurekeyvaultkey) cmdlet:
   ```powershell

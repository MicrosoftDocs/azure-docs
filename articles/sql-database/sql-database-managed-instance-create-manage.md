...
For a quickstart showing you how to create an SQL Database Managed Instance, see [Quickstart: Create an SQL Managed Instance](sql-database-managed-instance-get-started.md).

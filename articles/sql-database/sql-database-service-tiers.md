...
> [!IMPORTANT]
> Region limitations: 
> The vCore-based purchasing model is not yet available in Australia Southeast. The preview is not available in the following regions" West Europe, France Central, UK South, UK North, and UK West.
> 

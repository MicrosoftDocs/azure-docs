...
> [!IMPORTANT]
> [Hyperscale databases](sql-database-hyperscale.md) are only available with the vCore-based purchasing model for single databases with a logical server or within a Managed Instance. 

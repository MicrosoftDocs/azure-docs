...
See [Use Azure Active Directory Authentication for authentication](../azure-sql/database/aad-authentication-overview.md) to learn how to get access token to your database in Azure SQL Database or Azure SQL Managed Instance.

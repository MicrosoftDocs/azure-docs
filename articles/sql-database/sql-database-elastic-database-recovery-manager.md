...
3. Either a shard or the ShardMapManager database is restored to an earlier point-in time. To learn about point in time recovery using backups, see [Recpvery using backups](sql-database-recovery-using-backups.md).

...
The Decommissioned IP Address will stop accepting traffic and any new connection attempts will be routed to one of the Gateways in the region. Customers using redirection as their connection policy won't see any impact. Similarly, connections to SQL Database from inside Azure and using Service Tags won't be impacted.

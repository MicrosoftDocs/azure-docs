...
> [!IMPORTANT]
> **Product limitation:** Query Performance Insight, as a basic monitoring tool, does not capture **any ad-hoc, DDL, or DML queries** and cannot be used for monitoring of these types of queries.
>

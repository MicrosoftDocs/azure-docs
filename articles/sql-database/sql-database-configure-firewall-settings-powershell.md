...
To create a new server-level firewall rule, execute the [New-AzureRmSqlServerFirewallRule](https://msdn.microsoft.com/library/mt603860(v=azure.300\).aspx) cmdlet. The following example enables a range of IP addresses on the server Contoso.

    New-AzureRmSqlServerFirewallRule -ResourceGroupName 'resourcegroup1' -ServerName 'Contoso' -FirewallRuleName "ContosoFirewallRule" -StartIpAddress '192.168.1.1' -EndIpAddress '192.168.1.10'		

To modify an existing server-level firewall rule, execute the [Set-AzureRmSqlServerFirewallRule](https://msdn.microsoft.com/library/mt603789(v=azure.300\).aspx) cmdlet. The following example changes the range of acceptable IP addresses for the rule named ContosoFirewallRule.

    Set-AzureRmSqlServerFirewallRule -ResourceGroupName 'resourcegroup1' –StartIPAddress 192.168.1.4 –EndIPAddress 192.168.1.10 –RuleName 'ContosoFirewallRule' –ServerName 'Contoso'

To delete an existing server-level firewall rule, execute the [Remove-AzureRmSqlServerFirewallRule](https://msdn.microsoft.com/library/mt603588(v=azure.300\).aspx) cmdlet. The following example deletes the rule named ContosoFirewallRule.
...
* [New-AzureRmSqlServerFirewallRule](https://msdn.microsoft.com/library/mt603860(v=azure.300\).aspx)
* [Remove-AzureRmSqlServerFirewallRule](https://msdn.microsoft.com/library/mt603588(v=azure.300\).aspx)
* [Set-AzureRmSqlServerFirewallRule](https://msdn.microsoft.com/library/mt603789(v=azure.300\).aspx)
* [Get-AzureRmSqlServerFirewallRule](https://msdn.microsoft.com/library/mt603586(v=azure.300\).aspx)

...
You can [export database to BACPAC](../azure-sql/database/database-export.md) and then [import the BACPAC file]( ../azure-sql/database/database-import.md). This is the recommended approach if your database is smaller than 100 GB.
...
One option is to [export the database to a BACPAC](../azure-sql/database/database-export.md) and then [import the BACPAC file](../azure-sql/database/database-import.md). 

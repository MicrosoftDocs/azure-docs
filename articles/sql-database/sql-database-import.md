...
description: Create a new Azure SQL Database from a BACPAC file.
...
To migrate a database into an [Azure SQL Managed Instance](sql-database-managed-instance.md) from a BACPAC file, use SQL Server Management Studio or SQLPackage, using Azure PowerShell is not currently supported.

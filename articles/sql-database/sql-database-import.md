...
> [!NOTE]
> [Azure SQL Database Managed Instance](sql-database-manged-instance.md) supported importing from a BACPAC file, but does not currently support migrating using the Azure portal.

...
> [!NOTE]
> If you are using Premium databases and pools, you can make them resilient to regional outages by converting them to zone redundant deployment configuration (currently in preview). See [Zone-edundant databases](sql-database-high-availability.md#availability-capabilities).  

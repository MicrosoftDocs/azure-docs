...
- Learn more about [Connectivity architecture for SQL Managed Instance](sql-database-managed-instance-connectivity-architecture.md).
- See how to [create VNet where you will deploy SQL Managed Instances](sql-database-managed-instance-create-vnet-subnet.md)

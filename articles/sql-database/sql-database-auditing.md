...
- Audit logs in Event Hub are captured in the body of [Apache Avro](http://avro.apache.org/) format and stored using UTF-8 encoding and JSON formatting. To read the audit logs, you can use [Avro Tools](https://docs.microsoft.com/en-us/azure/event-hubs/event-hubs-capture-overview#use-avro-tools) or similar.

...
- 
- Two Azure SQL Database managed instances, one that will act as the Publisher, and one as the Distributor
...
- [Point to site connectivity](sql-database-managed-instance-configure-p2s.md) between the two managed instances and the SQL Server Subscriber.

...
The Azure SQL Database Hyperscale tier is currently available in the listed under [Azure SQL Database Hyperscale Overview](sql-database-service-tier-hyperscale.md#regions))

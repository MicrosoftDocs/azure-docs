...
* Download the [Elastic DB Tools for Azure SQL - Entity Framework Integration sample](hhttps://github.com/Azure/elastic-db-tools/). Unzip the sample to a location of your choosing.
* Start Visual Studio. 

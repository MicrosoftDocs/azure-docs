...
ATP pricing aligns with Azure Security Center standard tier at $15/node/month, where each protected SQL Database server is counted as one node. The first 60 days after enablement are considered a free trial period and are not charged. Please see the [Azure Security Center pricing page](https://azure.microsoft.com/pricing/details/security-center/) for more details.

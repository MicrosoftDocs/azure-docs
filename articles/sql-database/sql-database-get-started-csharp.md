...
You'll try SQL Database by creating a single database with SQL and C#. To create elastic databases, see [Create an Elastic database pool](sql-database-elastic-pool-create-portal.md).

---
title: SQL In-Memory, Get started | Microsoft Docs
...
> [!NOTE]
> These preview features are available only for [*Premium*](sql-database-service-tiers.md) databases not in elastic pools, and not available for any Basic or Standard databases.  Support for Premium databases in elastic pools is coming soon. 
> 
> 

...
From lift-and-shift migrations, to modernization of existing applications, to building modern cloud services, Azure SQL is a modern SQL platform, powered by an industry leading Microsoft SQL Server engine, that offers several deployment options. Azure SQL is designed to support a wide variety of application patterns with different levels of control over the underlying platform to meet the most demanding migration and modernization requirements. Azure SQL eliminates the complexity of managing diverse collections of SQL Server-based applications at scale by providing a single, unified management experience. 

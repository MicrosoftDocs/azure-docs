...
* [Azure SQL Database](https://azure.microsoft.com/services/sql-database/): A SQL database engine that is optimized for modern application development and that shares the same codebase with the latest SQL Server version. With Azure SQL Database logical server (containing [single databases](sql-database-servers-databases.md) and databases in an [elastic pool](sql-database-elastic-pool.md) sharing resources), Azure SQL Database offers most of SQL Server database-scoped features. With [Azure SQL Database Managed Instance (preview)](sql-database-managed-instance.md), Azure SQL Database offers shared resources for databases and additional instance-scoped features. Additionally, Azure SQL Database adds additional features that are not available in SQL Server, such as built-in intelligence and management. Azure SQL Database Managed Instance supports database migration with minimal to no database change.

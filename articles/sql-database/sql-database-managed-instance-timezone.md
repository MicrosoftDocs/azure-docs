...
Specify timezoneId property in your [ARM template](scripts/sql-managed-instance-create-powershell-azure-resource-manager-template) to set the time zone during instance creation.
...
- Managed Instance’s native [New-AzSqlInstance](https://docs.microsoft.com/en-us/powershell/module/az.sql/new-azsqlinstance) PowerShell cmdlet does not support passing time zone parameter yet. Use PowerShell wrapper with [ARM template](scripts/sql-managed-instance-create-powershell-azure-resource-manager-template) instead.

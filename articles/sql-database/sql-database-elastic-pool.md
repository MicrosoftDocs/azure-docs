...
For available service tiers for each resource model, see the [DTU-based resourcing model](sql-database-service-tiers.md#dtu-based-resourcing-model) or the [vCore-based resourcing model (preview)](sql-database-service-tiers.md#vcore-based-resourcing-model).

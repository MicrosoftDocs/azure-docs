...
-   Set up Data Sync
    - In the portal - [Tutorial: Set up SQL Data Sync to sync data between Azure SQL Database and SQL Server on-premises](../azure-sql/database/data-sync-sql-server-configure.md)
    - With PowerShell
...
-   Data Sync Agent - [Data Sync Agent for Azure SQL Data Sync](../azure-sql/database/data-sync-agent.md)

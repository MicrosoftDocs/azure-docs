...
Running the [Get-Credential](https://msdn.microsoft.com/library/hh849815(v=azure.300\).aspx) cmdlet opens a window asking for your user name and password. Enter the admin login and password for the SQL Database server ($ServerName from above), and not the user name and password for your Azure account.
...
After running [New-AzureRmSqlDatabaseImport](https://msdn.microsoft.com/library/mt707793(v=azure.300\).aspx), you can check the status of the request by running the [Get-AzureRmSqlDatabaseImportExportStatus](https://msdn.microsoft.com/library/mt707794(v=azure.300\).aspx).

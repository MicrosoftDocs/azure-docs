...
| [Add single database to failover group](scripts/sql-database-add-single-db-to-failover-group-cli.md?toc=%2fcli%2fazure%2ftoc.json)| This CLI script creates a database, and a failover group, adds the databse to the failover group and tests failover to the secondary server.|
|||

...
| [Scale an elastic pool](sql-database-scale-pool-cli.md) | The sample script provided here creates an elastic database pool in the North Central US region and scales the performance up.  |
|**Monitor and scale**||

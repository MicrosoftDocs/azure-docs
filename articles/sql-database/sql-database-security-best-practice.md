...
- [Azure SQL Databases](https://docs.microsoft.com/azure/sql-database/sql-database-single-index): [single databases](../azure-sql/database/single-database-overview.md) and [elastic pools](../azure-sql/database/elastic-pool-overview.md) in [servers](../azure-sql/database/logical-servers.md)
...
- Enable [SQL Database Auditing](sql-database-auditing.md) or [Managed Instance Auditing](sql-database-managed-instance-auditing.md) to track database events and write them to an audit log in your Azure Storage account, Log Analytics workspace (preview), or Event Hubs (preview).
...
- By configuring [SQL Database Auditing](sql-database-auditing.md) on your server or [Managed Instance Auditing](sql-database-managed-instance-auditing.md) to audit events, all existing and newly created databases on that server will be audited.
...
- If using a server in SQL Database, set the following options:
  ...
  - Use [Private Link](../azure-sql/database/private-endpoint-overview.md)

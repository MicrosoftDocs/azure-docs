...
- Find resource characteristics (number of cores, IO, memory) of General Purpose/Standard tier in [SQL Managed Instance](sql-database-managed-instance-resource-limits.md#service-tier-characteristics), Single database in [vCore model](../azure-sql/database/resource-limits-vcore-single-databases.md#general-purpose---provisioned-compute---gen4) or [DTU model](../azure-sql/database/resource-limits-dtu-single-databases.md#single-database-storage-sizes-and-compute-sizes), or Elastic pool in [vCore model](../azure-sql/database/resource-limits-vcore-elastic-pools.md#general-purpose---provisioned-compute---gen4) and [DTU model](../azure-sql/database/resource-limits-dtu-elastic-pools.md#standard-elastic-pool-limits).
- Learn about [Business Critical](sql-database-service-tier-business-critical.md) and [Hyperscale](../azure-sql/database/service-tier-hyperscale.md) tiers.

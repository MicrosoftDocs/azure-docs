...
The SQL Database Service includes [transparent data encryption](https://docs.microsoft.com/sql/relational-databases/security/encryption/transparent-data-encryption-with-azure-sql-database), [SQL Threat Detection](sql-database-threat-detection.md), [Always Encrypted](https://docs.microsoft.com/sql/relational-databases/security/encryption/always-encrypted-database-engine), [multi-factor authentication](sql-database-ssms-mfa-authentication.md) .

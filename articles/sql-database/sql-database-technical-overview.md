...
With Microsoft's cloud-first strategy, the newest capabilities of SQL Server are released first to SQL Database, and then to SQL Server itself. This approach provides you with all of the newest SQL Server capabilities with no overhead for patching or upgrading - and fully tested across millions of databases. For information about new capabilities as they are announced, before they ship, see:

- [Azure Roadmap for SQL Database](https://azure.microsoft.com/en-us/roadmap/?category=databases)
...
SQL Database offers four service tiers to support lightweight to heavyweight database workloads: Basic, Standard, Premium, and Premium RS. You can build your first app on a small, single database at a low cost per month and then change its service tier manually or programmatically at any time to meet the needs of your solution. You can do this without downtime to your app or to your customers. Dynamic scalability enables your database to transparently respond to rapidly changing resource requirements and enables you to only pay for the resources that you need when you need them.

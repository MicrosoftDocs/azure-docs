...
SQL Database and SQL Managed Instance both run on the latest stable version of the SQL Server database engine and Windows OS, and most users would not notice that upgrades are performed continuously.

<properties 
	pageTitle="Create and manage a SQL Database elastic database pool" 
...
This article shows you how to create an elastic database pool with [the preview portal](https://portal.azure.com).
...
## Adding databases into an elastic database pool

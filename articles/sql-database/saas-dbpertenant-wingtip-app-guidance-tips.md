...
2. Click **Connect** > **Database Engine...**:
   ...
   ![catalog server](media/saas-dbpertenant-wingtip-app-overview/connect.png)

3. Demo credentials are: Login = *developer*, Password = *P@ssword1*

   ![connection](media/saas-dbpertenant-wingtip-app-overview/tenants1-connect.png)
...
![object explorer](media/saas-dbpertenant-wingtip-app-overview/object-explorer.png)

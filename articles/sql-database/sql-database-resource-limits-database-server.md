...
description: This article provides an overview of the Azure SQL Database server resource limits for standalone databases and elastic pools. It also provides information regarding what happens when those resource limits are hit or exceeded.
...
- Increasing the compute size of the database or elastic pool to provide the database with more compute resources. See [Scale standalone database resources](sql-database-standalone-database-scale.md) and [Scale elastic pool resources](sql-database-elastic-pool-scale.md).
...
- Increasing the max size of the database or elastic pool, or add more storage. See [Scale standalone database resources](sql-database-standalone-database-scale.md) and [Scale elastic pool resources](sql-database-elastic-pool-scale.md).
...
- Increasing the service tier or compute size of the database or elastic pool. See [Scale standalone database resources](sql-database-standalone-database-scale.md) and [Scale elastic pool resources](sql-database-elastic-pool-scale.md).

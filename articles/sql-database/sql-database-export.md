...
* You can copy your Azure SQL database within Azure using the [Azure portal](sql-database-copy-portal.md), [PowerShell](sql-database-copy-powershell.md), or [Transaxct-SQL](sql-database-copy-transactsql.md). See also [Copying an Azure SQL database](sql-database-copy.md).

...
You can use Azure SQL Database [Intelligent Insights](sql-database-intelligent-insights-troubleshoot-performance.d#detectable-database-performance-patterns) or SQL Server [DMVs](sql-database-monitoring-with-dmvs.md) to detect these types of performance bottlenecks.

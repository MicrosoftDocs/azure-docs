...
- Identify any missing indexes using one of these methods:
  ...
  - [Database Advisor](../azure-sql/database/implement-database-advisor-performance-recommendations.md) for single and pooled databases.

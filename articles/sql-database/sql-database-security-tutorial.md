...
6. If you want to customize the audited events, you can do this via PowerShell or REST API - see the [Automation (PowerShell / REST API)](sql-database/sql-database-auditing.md#a-idsubheading-7aautomation-powershell--rest-api) section for more details.

...
|[Run cross-tenant distributed queries](saas-tenancy-adhoc-analytics.md) | Create an ad-hoc analytics database and run real-time distributed queries across all tenants.  |

---
title: PowerShell example-geo-replication failover group-standalone Azure SQL Database | Microsoft Docs
description: Azure PowerShell example script to set up active geo-replication failover group for a standalone database in Azure SQL Database and fail it over.
...
ms.date: 01/25/2019
---
# Use PowerShell to configure an active geo-replication failover group for a standalone database in Azure SQL Database

This PowerShell script example configures an active geo-replication failover group for a standalone database and fails it over to a secondary replica of the database.
...
[!code-powershell-interactive[main](../../../powershell_scripts/sql-database/setup-geodr-and-failover/setup-geodr-and-failover-database-failover-group.ps1?highlight=19-22 "Set up failover group for standalone database")]

...
| Command | Notes |
|---|---|
| [New-AzResourceGroup](https://docs.microsoft.com/powershell/module/az.resources/new-azresourcegroup) | Creates a resource group in which all resources are stored. | [New-AzSqlServer](/powershell/module/az.sql/new-azsqlserver) | Creates a logical server that hosts a database or elastic pool. |
...
|[Remove-AzSqlDatabase](/powershell/module/az.sql/remove-azsqldatabase) | Removes an Azure SQL database. |

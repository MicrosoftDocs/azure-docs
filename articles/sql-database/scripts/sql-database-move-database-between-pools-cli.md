...
description: Azure CLI example script that creates two elastic pools and moves an Azure SQL Database from one elastic pool to another using the Azure CLI.  

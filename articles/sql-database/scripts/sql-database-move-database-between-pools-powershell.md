...
| [New-AzureRmSqlServer](/powershell/module/azurerm.sql/new-azurermsqlserver) | Creates a SQL Databse server that hosts a a standalone database or an elastic pool. |

---
title: PowerShell example- Failover group - Azure SQL Database single database 
...
This example create a single database, creates a failover group, adds the database to it, and tests failover.

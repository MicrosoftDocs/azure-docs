---
title: PowerShell example-monitor-scale-standalone Azure SQL database | Microsoft Docs
description: Azure PowerShell example script to monitor and scale a standalone Azure SQL database
...
ms.date: 01/25/2019
---
# Use PowerShell to monitor and scale a standalone SQL database
...
[!code-powershell-interactive[main](../../../powershell_scripts/sql-database/monitor-and-scale-database/monitor-and-scale-database.ps1?highlight=13-14 "Monitor and scale standalone database")]

...
This PowerShell example configures SQL Data Sync to sync between multiple databases in Azure SQL Database.
...
- Update the sync schema
    - With Transact-SQL - [Automate the replication of schema changes SQL Data Sync in Azure](../sql-database-update-sync-schema.md)

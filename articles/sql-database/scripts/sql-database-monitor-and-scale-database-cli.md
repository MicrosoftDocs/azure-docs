---
title: CLI example-monitor-scale-standalone Azure SQL database | Microsoft Docs
description: Azure CLI example script to monitor and scale a standalone Azure SQL database
...
ms.date: 01/25/2019
---
# Use CLI to monitor and scale a standalone SQL database

This Azure CLI script example scales a standalone Azure SQL database to a different compute size after querying the size information of the database. 
...
[!code-azurecli-interactive[main](../../../cli_scripts/sql-database/monitor-and-scale-database/monitor-and-scale-database.sh "Monitor and scale standalone SQL Database")]
...
| [az sql db show-usage](https://docs.microsoft.com/cli/azure/sql/db#az-sql-db-show-usage) | Shows the size usage information for a standalone or pooled database. |

...
Azure SQL Database and Azure SQL Data Warehouse support connections from SQL Server Management Studio (SSMS) using *Active Directory Universal Authentication*.  
  > [!NOTE]  
  > **Download SSMS** - On the client computer, download the latest version of SSMS, from [Download SQL Server Management Studio (SSMS)](https://msdn.microsoft.com/library/mt238290.aspx). For all the features in this topic, use at least July 2017, version 17.2.  
  ![1mfa-universal-connect](../media/1mfa-universal-connect.png "Completes the User name box.")  
...
* The Schema Designer does not support Universal Authentication.
...
- [Import a BACPAC file to a new Azure SQL Database](../sql-database/sql-database-import)  
- [Export an Azure SQL database to a BACPAC file](../sql-database/sql-database-export)  

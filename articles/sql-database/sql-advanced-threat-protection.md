...
To view and manage Advanced Data Security settings, navigate to **Advanced Data Security** under the **Security** heading for your SQL Database server or managed instance. On this page, you can enable or disable ADS, and modify Threat Detection settings for your entire SQL Database server or managed instance.

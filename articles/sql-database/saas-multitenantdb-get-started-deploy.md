...
2. The app then hashes the tenant name to create a key to access a catalog using [shard map management](../azure-sql/database/elastic-scale-shard-map-management.md).
...
- To learn about elastic pools, see:
  ...
  - [Elastic pools help you manage and scale multiple Azure SQL databases](../azure-sql/database/elastic-pool-overview.md)

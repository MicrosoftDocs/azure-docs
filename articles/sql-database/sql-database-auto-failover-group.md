...
- **Create the secondary instance in the same DNS zone as the primary instance**
  ...
  For more information about creating the secondary instance in the same DNS zone as the primary instance, see [Create a secondary managed instance](sql-database-managed-instance-failover-group-tutorial#3---create-a-secondary-managed-instance).

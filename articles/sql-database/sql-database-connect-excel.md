...
You'll need a SQL Database before you get started. If you don't have one, see [Create an Azure SQL Database](../azure-sql/database/quickstart-create-single-database.md) and [Create server-level IP firewall](../azure-sql/database/quickstart-firewall-create-server-level-portal.md) to get a SQL Database with sample data up and running in a few minutes.
...
* Learn about the benefits of [elastic pools](../azure-sql/database/elastic-pool-overview.md).

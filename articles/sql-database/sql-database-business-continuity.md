...
If the built-in retention period is not sufficient for your application, you can extend it by configuring the Long-term retention policy for your database(s) - see <Long term backup retention for SQL Database> for more details. 

...
| [Sync between SQL Databases](scripts/sql-database-sync-data-between-sql-databases.md) | This PowerShell script configures Data Sync to sync between multiple Azure SQL Databases. |
| [Sync between SQL Database and SQL Server on-premises](scripts/sql-database-sync-data-between-azure-onprem.md) | This PowerShell script configures Data Sync to sync between an Azure SQL Database and a SQL Server on-premises database. |
|||
|||

...
| [Create and manage a Managed Instance](scripts/sql-database-create-and-configure-managed-instance-powershell.md) | This PowerShell script shows you how to create and manage a Managed Instance using the Azure PowerShell |

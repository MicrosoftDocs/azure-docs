...
Long time retention can be enabled for single and pooled databases, and is in limited public preview for Azure SQL Managed Instance. This article provides a conceptual overview of long-term retention. To configure long-term retention, see [Configure Azure SQL Database LTR](sql-database-long-term-backup-retention-configure.md) and [Configure Azure SQL Managed Instance LTR](sql-database-managed-instance-long-term-backup-retention-configure.md). 

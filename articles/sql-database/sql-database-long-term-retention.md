...
> - The timing of the individual backup copies is controlled by Azure SQL Database. The user cannot manually create a backup copy or control the timing of the copy creation.

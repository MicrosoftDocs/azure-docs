...
![Test lab architecture for availability groups in Azure](./media/portal-alwayson-availability-groups/0-EndstateSample.png)
...
* You already know how to use the GUI to provision a SQL Server virtual machine from the virtual machine gallery. For more information, see [Provisioning a SQL Server virtual machine on Azure](create-vm-portal.md).
...
3. On the **New** pane, search for **AlwaysOn**.
   ![Find AlwaysOn Template](./media/portal-alwayson-availability-groups/16-findalwayson.png)
4. In the search results, locate **SQL Server AlwaysOn Cluster**.
   ![AlwaysOn Template](./media/portal-alwayson-availability-groups/17-alwaysontemplate.png)
...
![Basics](./media/portal-alwayson-availability-groups/1-basics.png)
...
![Domain and network settings](./media/portal-alwayson-availability-groups/2-domain.png)
...
![availability group settings](./media/portal-alwayson-availability-groups/3-availabilitygroup.png)
...
![VM size storage settings](./media/portal-alwayson-availability-groups/4-vm.png)
...
![SQL Server settings](./media/portal-alwayson-availability-groups/5-sql.png)
...
![Azure Dashboard](./media/portal-alwayson-availability-groups/11-deploydashboard.png)

...
![SQL Server connectivity](./media/security/sql-vm-connectivity-option.png)
...
![Network security group rules](./media/security/sql-vm-network-security-group-rules.png)

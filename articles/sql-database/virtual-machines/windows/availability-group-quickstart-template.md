...
- One or more domain-joined [VMs in Azure running SQL Server 2016 (or later) Enterprise edition](https://docs.microsoft.com/azure/virtual-machines/windows/sql/virtual-machines-windows-portal-sql-server-provision) that are in the same availability set or availability zone and that have been [registered with the SQL VM resource provider](register-with-resource-provider.md).  
...
4. Select the **Account** tab. If the **User logon name** box is blank, this is the cause of your error. 
    ...
    ![Blank user account indicates missing UPN](./media/availability-group-quickstart-template/account-missing-upn.png)
...
* [Overview of SQL Server VMs](overview.md)
* [FAQ for SQL Server VMs](frequently-asked-questions-faq.md)
* [Pricing guidance for SQL Server VMs](pricing-guidance.md)
* [Release notes for SQL Server VMs](doc-changes-release-notes.md)
* [Switching licensing models for a SQL Server VM](azure-hybrid-benefit-ahb.md)

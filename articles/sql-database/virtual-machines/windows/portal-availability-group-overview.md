...
![Availability Group](./media/portal-availability-group-overview/00-EndstateSampleNoELB.png)
...
To increase redundancy and high availability, the SQL Server VMs should either be in the same [availability set](portal-availability-group-prereq.md#create-availability-sets), or different [availability zones](/azure/availability-zones/az-overview). 
...
| :------ | :-----| :-----| :-----| :-----| :-----| :-----| :-----| :-----| :-----| :-----|
| [SQL VM CLI](availability-group-cli.md) | 2016 | 2017 </br>2016   | Ent | Cloud witness | No | Yes | Yes | Yes | No | No |
| [Quickstart Templates](availability-group-quickstart-template.md) | 2016 | 2017</br>2016  | Ent | Cloud witness | No | Yes | Yes | Yes | No | No |
| [Portal Template](portal-alwayson-availability-groups.md) | 2016 </br>2012 R2 | 2016</br>2014 | Ent | File share | No | No | No | No | No | No |
| [Manual](portal-availability-group-prereq.md) | All | All | All | All | Yes | Yes | Yes | Yes | Yes | Yes |
| &nbsp; | &nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |
...
For more information, see [Use Azure SQL VM CLI to configure Always On availability group for SQL Server on an Azure VM](availability-group-cli.md). 
...
For more information, see [Use Azure Quickstart Template to configure Always On availability group for SQL Server on an Azure VM](availability-group-quickstart-template.md).


## Automatically with an Azure portal template

[Configure Always On availability group in Azure VM automatically - Resource Manager](portal-alwayson-availability-groups.md)
...
- [Configure prerequisites for SQL Server Always On availability groups on Azure Virtual Machines](portal-availability-group-prereq.md)

- [Create Always On Availability Group to improve availability and disaster recovery](portal-availability-group-tutorial.md)

## Next steps

[Configure a SQL Server Always On Availability Group on Azure Virtual Machines in Different Regions](portal-availability-group-dr.md)

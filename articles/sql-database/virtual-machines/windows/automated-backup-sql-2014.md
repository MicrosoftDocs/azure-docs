...
Navigate to the [SQL virtual machines resource](manage-portal.md#access-the-sql-virtual-machines-resource) for your SQL Server 2014 virtual machine and then select **Backups**. 

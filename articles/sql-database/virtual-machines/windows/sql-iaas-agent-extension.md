...
> * [Resource Manager](sql-iaas-agent-extension.md)
...
| **Azure Key Vault integration** |Enables you to automatically install and configure Azure Key Vault on your SQL Server VM. For more information, see [Configure Azure Key Vault integration for SQL Server on Azure Virtual Machines (Resource Manager)](integrate-keyvault-powershell.md). |
...
##  Installation
The SQL Server IaaS extension is installed when you register your SQL Server VM with the [SQL VM resource provider](register-with-resource-provider.md). If necessary, you can install the SQL Server IaaS agent manually using the below PowerShell command: 
...
![Status of the SQL Server IaaS Agent Extension in the Azure portal](./media/sql-iaas-agent-extension/azure-rm-sql-server-iaas-agent-portal.png)
...
![Uninstalling the SQL Server IaaS Agent Extension in Azure portal](./media/sql-iaas-agent-extension/azure-rm-sql-server-iaas-agent-uninstall.png)
...
For more information about running SQL Server on Azure Virtual Machines, see the [What is SQL Server on Azure Virtual Machines?](overview.md).

...
For other SQL Server backup and restore options, see [Backup and Restore for SQL Server in Azure Virtual Machines](../../../active-directory/user-help/backup-recovery.md).

...
SQL Server virtual machines support automated management features with the [SQL Server IaaS Agent Extension](sql-iaas-agent-extension.md). To install the agent on the new VM, and register it with the resource provider, run the [New-AzSqlVM](/powershell/module/az.sqlvirtualmachine/new-azsqlvm) command after the virtual machine is created. Specify the license type for your SQL Server VM, choosing between either pay-as-you-go or bring-your-own-license via the [Azure Hybrid Benefit](https://azure.microsoft.com/pricing/hybrid-benefit/). For more information about licensing, see [licensing model](azure-hybrid-benefit-ahb.md). 
...
- Configure SQL Server settings in the portal for your VM, including:
   ...
   - [Automated management tasks](sql-iaas-agent-extension.md)
- [Configure connectivity](connect.md)

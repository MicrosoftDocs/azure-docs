...
The following instructions take you through steps 1 through 4 from the [Create and configure the load balancer in the Azure portal](../windows/portal-alwayson-int-listener.md#create-and-configure-the-load-balancer-in-the-azure-portal) section of the [Load balancer - Azure portal](../windows/portal-alwayson-int-listener.md) article.
...
> [Configure a load balancer for an availability group on Azure SQL Server VMs](../windows/portal-alwayson-int-listener.md)

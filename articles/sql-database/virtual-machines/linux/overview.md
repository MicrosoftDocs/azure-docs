...
> * [Linux](../../../active-directory-b2c/overview.md)
...
> [!NOTE]
> To see the available Windows SQL Server virtual machine images, see [Overview of SQL Server on Azure Virtual Machines (Windows)](../windows/overview.md).
...
|---|---|---|---|---|---|---|
| RHEL | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![no](./media/overview/no.png) |
| SLES | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![no](./media/overview/no.png) | ![no](./media/overview/no.png) |
| Ubuntu | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) | ![yes](./media/overview/yes.png) |
...
* [Azure SQL Database comparison](../../sql-database-paas-vs-sql-server-iaas.md)

...
> [!NOTE]
> To migrate an individual database into either a standalone database or elastic pool, see [Migrate a SQL Server database to Azure SQL Database](sql-database-cloud-migrate.md).

...
| New-AzureRmSqlServerVirtualNetworkRule | Creates a [*VNet rule*](sql-database-vnet-service-endpoint-rule-overview.md), based on a subnet that is a VNet service endpoint. |

...
- A [single databases](sql-database-single-database-resources.md) with its own set of resources
- Part of a [SQL elastic pool](sql-database-elastic-pool.md) that shares a set of resources

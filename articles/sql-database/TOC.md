...
#### [Export using SQL Package utility](cloud-migrate-compatible-export-bacpac-sqlpackage.md)
...
#### [Import using SQL Package utility](cloud-migrate-compatible-import-bacpac-sqlpackage.md)

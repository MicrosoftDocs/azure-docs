...
Determine the storage cap: consult the [SQL Database Service Tiers article](sql-database-service-tiers.md) for the storage caps of the different Premium service tiers.
...
You can monitor in-memory storage use as a percentage of the storage cap for your performance tier in the Azure [portal](http://portal.azure.com/): 

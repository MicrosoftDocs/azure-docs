...
Once this limit is exceeded, insert and update operations may start failing with error 41823 for standalone databases and error 41840 for elastic pools. At that point you need to either delete data to reclaim memory, or upgrade the service tier or performance level of your database.
...
You can monitor In-memory storage use as a percentage of the storage cap for your performance level in the [Azure portal](https://portal.azure.com/): 

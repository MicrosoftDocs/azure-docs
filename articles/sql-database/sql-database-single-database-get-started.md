...
- To create a single database in the serverless compute tier using Azure Powershell, see [Create serverless database using PowerShell](sql-database-serverless.md#create-new-database-in-serverless-using-powershell)

...
A [single database](../azure-sql/database/single-database-overview.md) is the quickest and simplest deployment option for Azure SQL Database. You manage a single database within a [server](../azure-sql/database/logical-servers.md), which is inside an [Azure resource group](../azure-resource-manager/management/overview.md) in a specified Azure region. In this quickstart, you create a new resource group and server for the new database.

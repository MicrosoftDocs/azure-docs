...
- Confirm your corporate network environment allows inbound communication from the Compute IP address ranges (including SQL ranges) used by the Microsoft Azure Datacenters. It may be necessary to whitelist these IP addresses, see [Microsoft Azure Datacenter IP Ranges](https://www.microsoft.com/en-us/download/details.aspx?id=41653)  

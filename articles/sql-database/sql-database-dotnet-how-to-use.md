...
1. Open a web browser, and browse to [http://azure.microsoft.com/](https://azure.microsoft.com/). To get started with a free account, click free trial in the upper right corner and follow the steps.

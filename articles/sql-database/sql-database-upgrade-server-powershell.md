...
For example, you can set up an email alert on “DTU Percentage” if the average DTU percentage value exceeds 75% over the last 5 minutes. Refer to [Receive alert notifications](../monitoring-and-diagnostics/insightsreceive-alert-notifications.md) to learn more about how to configure alert notifications.

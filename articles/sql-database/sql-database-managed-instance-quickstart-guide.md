...
## Migrating to a managed instance
...
However, in order to migrate your production database or even dev/test databases that you want to use for some performance test, your you need to consider using some additional techniques, such as:
- Performance testing - you should measure baseline performance on your source SQL Server instance and compare them with the perfromance on the destination Managed Instance where you have migrated the database. Learn more about [the best practices for performance comparison in this article](https://techcommunity.microsoft.com/t5/Azure-SQL-Database/The-best-practices-for-performance-comparison-between-Azure-SQL/ba-p/683210)
...
Learn more about the [recommended migration process in this article](sql-database-managed-instance-migrate.md).

...
- **BasePrice** means that you have a valid SQL Server licence that you want to use as part of [Azure Hybrid Benefit](https://azure.microsoft.com/pricing/hybrid-benefit/) and that you want to pay only the base infrastructure cost.
- **LicenseIncluded** means that you either don't have on-premises SQL Server licence, or you don't want to use your on-premises license for database or Managed Instance. In this case, SQL Server license will be included in your bill. 

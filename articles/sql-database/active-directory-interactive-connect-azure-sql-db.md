...
Each Azure SQL standalone database and elastic pool has its own SQL Database server of Azure AD. For our C# scenario, you must set an Azure AD administrator for your Azure SQL server.

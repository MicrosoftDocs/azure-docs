---
title: 'PowerShell:Delete backups in Azure Recovery Services vault | Microsoft Docs'
description: Quick reference on how to use PowerShell to delete long-term retention backups and the Azure Recovery Services vault
...
---
# Delete Azure database backups in Azure Recovery Services vault using PowerShell

In this topic, you learn how to delete Azure database backups in the Azure Recovery Services vault.

...
- You have installed Python and related software for your operating system.
    ...
    - **MacOS**: Install Homebrew and Python, install the ODBC driver and SQLCMD, and then install the Python Driver for SQL Server. See [Step 1.2, 1.3, and 2.1](https://www.microsoft.com/en-us/sql-server/developer-get-started/Python/mac/).

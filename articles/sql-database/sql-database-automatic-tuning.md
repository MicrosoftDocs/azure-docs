...
Automatic tuning options available in Azure SQL Database are:
 ...
 2. **DROP INDEX** - identifies redundant and duplicate indexes, and indexes that were not used for a very long period of time. Please note that at this time this option is incompatible with applications using partition switching and index hints. Default Azure setting for this option is disabled.

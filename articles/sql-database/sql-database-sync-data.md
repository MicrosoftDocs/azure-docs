...
| Disadvantages | - 5 min or more latency<br/>- No transactional consistency<br/>- Higher performance impact | - Can’t publish from Azure SQL Database standalone database or pooled database<br/>-	High maintenance cost |
| | | |

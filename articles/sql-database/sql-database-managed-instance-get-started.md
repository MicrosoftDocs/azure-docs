...
description: Create an Azure SQL Managed Instance, network environment, and client VM for access using the Azure portal in this quickstart. 
...
1. Select **+Add** to open the **Select SQL deployment option** page. You can view additional information about an Azure SQL Managed Instance by selecting **Show details** on the **SQL Managed instance** tile.
1. Select **Create**.

   ![Create a SQL Managed Instance](./media/sql-database-managed-instance-get-started/create-managed-instance.png)
...
- Fill out mandatory information required on the **Basics** tab. This is a minimum set of information required to provision a SQL Managed Instance.
   ...
   !["Basics" tab for creating a SQL Managed Instance](./media/sql-database-managed-instance-get-started/tabs/mi-create-tab-basics.png)
...
- Fill out optional information on the **Networking** tab. If you omit this information, the portal will apply default settings.
   ...
   !["Networking" tab for creating a SQL Managed Instance](./media/sql-database-managed-instance-get-started/tabs/mi-create-tab-networking.png)
   ...
   | **Connection type** | Choose between a proxy and a redirect connection type.|For more information about connection types, see [Azure SQL Managed Instance connection type](sql-database-managed-instance-connection-type.md).|
...
- Fill out optional information on the **Additional settings** tab. If you omit this information, the portal will apply default settings.
   ...
   !["Additional settings" tab for creating a SQL Managed Instance](./media/sql-database-managed-instance-get-started/tabs/mi-create-tab-additional-settings.png)
...
1. Select **Review + create** tab to review your choices before you create the SQL Managed Instance.
   ...
   ![Tab for reviewing and creating a SQL Managed Instance](./media/sql-database-managed-instance-get-started/tabs/mi-create-tab-review-create.png)
...
1. Select the **Notifications** icon to view the status of the deployment.
   ...
   ![Deployment progress of a SQL Managed Instance deployment](./media/sql-database-managed-instance-get-started/in-progress/mi-create-deployment-in-progress.png)
...
1. Open the resource group for your SQL Managed Instance. 
   ...
   ![SQL Managed Instance resources](./media/sql-database-managed-instance-get-started/resources.png)
...
2. In the route table, review the entries to route traffic from and within the SQL Managed Instance's virtual network. If you create or configure your route table manually, ensure to create these entries in the SQL Managed Instance route table.
   ...
   ![Entry for a SQL Managed Instance subnet to local](./media/sql-database-managed-instance-get-started/udr.png)
...
1. Return to the resource group and select your SQL Managed Instance.
   ...
   ![SQL Managed Instance in the resource group](./media/sql-database-managed-instance-get-started/managed-instance.png)

...
| [SQL Server Integration Services (SSIS)](https://docs.microsoft.com/sql/integration-services/sql-server-integration-services) | Yes, with a managed SSIS in Azure Data Factory (ADF) environment, where packages are stored in SSISDB hosted by Managed Instance and executed on [Azure SSIS Integration Runtime](../data-factory/tutorial-deploy-ssis-packages-azure-powershell). | Yes, with a managed SSIS in Azure Data Factory (ADF) environment, where packages are stored in SSISDB hosted by Managed Instance and executed on [Azure SSIS Integration Runtime](../data-factory/tutorial-deploy-ssis-packages-azure-powershell). |

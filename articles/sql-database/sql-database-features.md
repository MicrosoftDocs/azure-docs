...
| [Auto-failover groups](sql-database-auto-failover-group.md) | Yes - General Purpose and Business Critical service tiers only| Yes, in [public preview](sql-database-auto-failover-group.md)|

...
[Files and file groups](https://docs.microsoft.com/sql/relational-databases/databases/database-files-and-filegroups) | Primary file group only | Yes. File paths are automaticaly assigned and the file location cannot be specified in `ALTER DATABASE ADD FILE` [statement](sql-database-managed-instance-transact-sql-information.md#alter-database-statement).  |

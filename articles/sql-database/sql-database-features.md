...
| **SQL Feature** | **Supported in Azure SQL DB single databases/elastic pools** | **Supported in Azure SQL DB Managed Instance** |
| --- | --- | --- |
| [Active geo-replication](sql-database-active-geo-replication.md) | Yes | No, see [Auto-failover groups](sql-database-auto-failover-group.md) |
| [Auto-failover groups](sql-database-auto-failover-group.md) | Yes | Yes, in [public preview](sql-database-auto-failover-group.md)|

...
1. Make sure that TCP IP is enabled as a client protocol on the application server. For more information on how to do this, see [Configure client protocols](http://msdn.microsoft.com/library/ms181035.aspx). On application servers where you do not have SQL Server tools installed, you can check this by running cliconfg.exe (SQL Server Client Network Utility). 
...
1. Check the [Microsoft Azure Service Dashboard](http://go.microsoft.com/fwlink/p/?LinkId=168847) for any known outages. 
2. Test the connectivity by using ping and telnet. For more information about how to do this, see [Troubleshooting SQL Server connectivity issues](http://blogs.msdn.com/b/chaitanya_medikonduri/archive/2011/03/09/sql-server-connectivity-issues-troubleshooting-tips.aspx) and [Diagnostics for connectivity issues](https://azure.microsoft.com/documentation/articles/sql-database-connectivity-issues/#diagnostics).
...
To resolve this issue, contact your service administrator to provide you the valid SQL user name and password. For more information, refer to [Managing Databases and Logins in Azure SQL Database](https://azure.microsoft.com/documentation/articles/sql-database-manage-logins/).
...
2. Make sure that TCP IP is enabled as a client protocol on the application server. For more information on how to do this, see [Configure client protocols](http://msdn.microsoft.com/library/ms181035.aspx). On application servers where you do not have SQL Server tools installed, you can check this by running cliconfg.exe (SQL Server Client Network Utility). 

3. Test the connectivity between the application server and the Azure SQL database by using a UDL file, ping, and telnet. For more information about how to do this, [Troubleshooting SQL Server connectivity issues](http://blogs.msdn.com/b/chaitanya_medikonduri/archive/2011/03/09/sql-server-connectivity-issues-troubleshooting-tips.aspx) and [Diagnostics for connectivity issues](https://azure.microsoft.com/documentation/articles/sql-database-connectivity-issues/#diagnostics).
...
See [Obtain the connection string from the Azure portal](https://azure.microsoft.com/documentation/articles/sql-database-connectivity-issues/#connections-to-azure-sql-database).
2. Make sure that TCP IP is enabled as a client protocol on the application server. For more information on how to do this, see [Configure client protocols](http://msdn.microsoft.com/library/ms181035.aspx). On application servers where you do not have SQL Server tools installed, you can check this by running cliconfg.exe (SQL Server Client Network Utility). 
3. Test the connectivity between the application server and the Azure SQL database by using a UDL file, ping, and telnet. For more information about how to do this, see [Troubleshooting SQL Server connectivity issues](http://blogs.msdn.com/b/chaitanya_medikonduri/archive/2011/03/09/sql-server-connectivity-issues-troubleshooting-tips.aspx) and [Diagnostics for connectivity issues](https://azure.microsoft.com/documentation/articles/sql-database-connectivity-issues/#diagnostics).
4. Try increasing the connection **timeout**. Microsoft recommends using a connection timeout of at least 30 seconds. 
5. As a best practice ensure retry logic is in place. For more information about the retry logic, see [Troubleshoot transient faults and connection errors to SQL Database](https://azure.microsoft.com/documentation/articles/sql-database-connectivity-issues/). 
...
1. Check the [sys.dm_exec_requests](http://msdn.microsoft.com/library/ms177648(v=sql.120).aspx) view to see any blocking requests. To do this, execute the following SQL query:
...
3. Tune the head blocker query.
   ...
   For an in-depth troubleshooting procedure refer to [Is my query running fine in the cloud?](http://blogs.msdn.com/b/sqlblog/archive/2013/11/01/is-my-query-running-fine-in-the-cloud.aspx).

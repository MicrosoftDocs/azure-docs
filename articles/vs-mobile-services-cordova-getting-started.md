...
Update a row in a data table. In this code, when the mobile service responds, the item is removed from the list. Call the done method on the returned Promise object to get a copy of the updated object and handle any errors.

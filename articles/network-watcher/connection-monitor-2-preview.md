...
* Test Group: TG1
* Sources: 3 (A, B, C) These may be Azure VMs or on-premise agents linked to Log Analytics workspaces
* Destinations: 2 (D, E) These may be Azure VMs, URL, IPv4 or IPv6

...
With the [Azure Network Watcher troubleshoot](network-watcher-troubleshoot-overview.md) feature, you are able to diagnose any issues with your Gateway and Connections and within minutes have enough information to make an informed decision to rectify the issue.

...
description: In this tutorial, you'll learn how to use Azure Network Watcher connection monitor to monitor network communication with a virtual machine scale set using the Azure portal.

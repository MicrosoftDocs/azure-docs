...
description: In this tutorial, you'll learn how to use Azure Network Watcher connection monitor to monitor network communication between with a virtual machine scale sets using the Azure portal.

...
| InboundPackets_d | It represents packets sent from the destination to the source of the flow | This is populated only for the Version 2 of NSG flow log schema |
| OutboundPackets_d	 | It represents packets sent from the source to the destination of the flow | This is populated only for the Version 2 of NSG flow log schema |
| InboundBytes_d |	It represents bytes sent from the destination to the source of the flow | This is populated only for the Version 2 of NSG flow log schema |
| OutboundBytes_d |It represents bytes sent from the source to the destination of the flow | This is populated only for the Version 2 of NSG flow log schema |

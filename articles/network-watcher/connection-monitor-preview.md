...
You can create a connection monitor preview using [Azure Portal](connection-monitor-preview-create-using-portal.md) or [ARM Client](connection-monitor-preview-create-using-arm-client.md)

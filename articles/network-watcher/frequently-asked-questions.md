...
See the list of [RBAC permissions required to use Network Watcher](https://docs.microsoft.com/en-us/azure/network-watcher/required-rbac-permissions). For deploying resources, you need contributor permissions to the NetworkWatcherRG (see below).

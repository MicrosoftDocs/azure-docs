...
Navigate to **More Services** > **Network Watchers** and click **Enable All**. You can select all the subscriptions you want to enable Network Watcher for. This action creates a Network Watcher in every region that is available.

...
#CustomerIntent: As an Azure administrator, I want to monitor the communication between two virtual machines in Azure so I can be alerted if the communication fails to take actions. I allow want to know why the communication failed, so that I can resolve the problem. 

...
enabling network security group flow logs, refer to the following article [Introduction to flow logging for network security groups](network-watcher-network security group-flow-logging-overview.md).
...
BI](network-watcher-visualize-network security group-flow-logs-power-bi.md).

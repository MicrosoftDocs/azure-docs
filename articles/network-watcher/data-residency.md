...
The Connection Monitor service stores customer data. This data is automatically stored by Network Watcher in a single region. So Network Watcher automatically satisfies in-region data residency requirements, including those specified in the [Trust Center](https://azuredatacentermap.azurewebsites.net/)

...
> - Microsoft.Storage/* or Microsoft.Compute/* actions listed in [Additional actions](#additional-actions) section.
> - Microsoft.OperationalInsights/workspaces/* actions listed in [Traffic analytics](#traffic-analytics) section.
> - Microsoft.Insights/dataCollectionRules/* or Microsoft.Insights/dataCollectionEndpoints/* actions listed in [Traffic analytics](#traffic-analytics) section. These 
...
Since traffic analytics is enabled as part of the Flow log resource, the following permissions are required in addition to all the [permissions required for Flow logs](flow-logs):

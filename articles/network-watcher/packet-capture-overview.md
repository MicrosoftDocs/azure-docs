...
Note: Prior to uploading, our agent utilizes a /tmp directory as an intermediate storage location for the packet capture file. Once 100% of the packet capture is complete, the file is transferred to the designated destination.

---
title: Create a connection monitor (Preview) - PowerShell
...
* **NW**: Network Watcher resource ID in which a connection monitor will be created

* **Location**: Region in which a connection monitor will be created

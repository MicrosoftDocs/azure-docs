...
In this article, you learn how to create, change, disable, or delete an NSG flow log using Azure PowerShell. You can learn how to manage an NSG flow log using the [Azure portal](nsg-flow-logs-portal.md), [Azure CLI](nsg-flow-logs-cli.md), or [ARM template](nsg-flow-logs-template.md).

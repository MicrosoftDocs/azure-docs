...
In case you ever need to manually delete the flow logs from your storage account, you can use the PowerShell script below.
This script specifically deletes Storage blobs that are older than the existing retention policy specified by the user. 

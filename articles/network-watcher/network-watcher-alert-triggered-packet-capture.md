...
For instructions about downloading files from Azure storage accounts, see [Get started with Azure Blob storage using .NET](../storage/blob/storage-dotnet-how-to-use-blobs.md). Another tool you can use is [Storage Explorer](http://storageexplorer.com/).

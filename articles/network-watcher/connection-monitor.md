...
You must meet the following pre-requisites before completing the steps in this article:
...
7. Connection monitor shows you the average round trip time and % probes that fail. You can view monitor data in a grid, or a graph.

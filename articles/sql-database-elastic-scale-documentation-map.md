...
2. [Azure SQL Database Elastic Scale](./sql-database-elastic-scale-intro.md)
3. [Elastic Scale Glossary](./sql-database-elastic-scale-glossary.md)


## Explore Elastic Scale
1. What is a Shard Map? 
	* [Shard Map Management](/.sql-database-elastic-scale-shardmapmanagement.md)
...
5.   How do I split or merge a shard?
	* [Spliting and Merging Shards with Elastic Scale](./sql-database-elastic-scale-split-and-merge.md)
...
3. [Federations Migration](./sql-database-elastic-scale-federation-migration.md)
4. Shard Elasticity Scripts

## APIs
1. [How To: Add Azure SQL DB Elastic Scale References to a Visual Studio Project](./sql-database-elastic-scale-add-references.md)
2. [MSDN]
...
* [Managing Elastic Scale Credentials](./sql-database-elastic-scale-credentials.md)
* [Azure SQL Database Split and Merge Service Tutorial](./sql-database-elastic-scale-split-and-merge-tutorial.md)
<properties linkid="java-sdk-creating-a-website-on-azure" urlDisplayName="Create a Website on Azure" pageTitle="Create a Website on Azure - Azure SDK for Java" metaKeywords="Azure Java, Azure SDK for Java, Azure Website, Java SDK" description="Learn how to create a website on Azure programmatically." metaCanonical="" services="" documentationCenter="Java" title="Creating a Website on Azure Using the Azure SDK for Java" authors="v-donntr" solutions="" manager="wpickett" editor="jimbe" scriptId="" videoId="" />

<tags ms.service="multiple" ms.workload="na" ms.tgt_pltfrm="na" ms.devlang="Java" ms.topic="article" ms.date="12/17/2014" ms.author="v-donntr" />

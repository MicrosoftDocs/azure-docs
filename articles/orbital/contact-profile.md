...
- To collect telemetry during the contact create an Event Hub. [Learn more about Event Hubs](../event-hubs/event-hubs-about.md)
...
:::image type="content" source="./media/orbital-eos-contactprofile.png" alt-text="Contact Profile Resource Page":::
...
:::image type="content" source="./media/orbital-eos-contactlink.png" alt-text="Contact Profile Links Page":::

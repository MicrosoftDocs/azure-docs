...
> [!NOTE]
> The new contact resource includes two parameters: Provisioning State and Contact Status.
>
...
>
> The value of these parameters can be found under the **Essentials** section of the contact overview page.

...
![Geospatial Overview.](media/geospatial_overview.png)
...
![Geospatial 3rd Party and OSS.](media/geospatial_3rd_oss.png)
...
![Geospatial Static and Streaming.](media/geospatial_esri_static.png)
...
![Esri with ArcGIS Image.](media/geospatial_esri_image.png)
...
![Azure Space and ARD.](media/geospatial_space_ard.png)
...
- [Azure Orbital](https://azure.microsoft.com/services/orbital/) is a fully managed, cloud-based ground station as a service that allows you to streamline your operations by ingesting space data directly into Azure.

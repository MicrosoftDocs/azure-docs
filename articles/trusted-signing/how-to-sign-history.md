...
:::image type="content" source="media/trusted-select-storage-account-subscription.png" alt-text="Screenshot of media/trusted-select-storage-account-subscription." lightbox="media/trusted-select-storage-account-subscription.png":::

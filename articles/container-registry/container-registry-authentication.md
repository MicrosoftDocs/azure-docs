...
| [AD service principal](#service-principal)                  | `docker login`<br/><br/>`az acr login` in Azure CLI<br/><br/> Registry login settings in APIs or tooling<br/><br/> Kubernetes pull secret                                           | Unattended push from CI/CD pipeline<br/><br/> Unattended pull to deployment target in Azure services or external services  | Yes                              | SP password default expiry is 1 year       |                                                           

...
Azure container registry allows you to store container images in different repositories. By storing images in repositories you can have different images (or version of images) in isolated environments. You can specify these repositories when you push images to your registry.
...
* **Pull an image** - Pull an image from the public Docker Hub registry, tag it, and push it to your registry. For guidance on how to accomplish this, see [Push Docker image to Azure private registry](container-registry-get-started-docker-cli.md).


## Viewing repositories in the Portal

Once you have pushed images to your container registry, you'll be able to see a list of the repositories hosting the images in the Azure portal.

If you followed the steps in the [Push Docker image to Azure private registry](container-registry-get-started-docker-cli.md) article, you should now have a Nginx image in your container registry. As part of the instructions, you should've specified a namespace for the image, in the example below the namespace is "samples":

```
docker push myregistry.azurecr.io/samples/nginx
```
This command pushes the NGinx image to a repository named "samples". Azure Container Registry supports multilevel repository namespaces. This feature enables you to group collections of images related to a specific app, or a collection of apps to specific development or operational teams. To read more about repositories in container registries, see [Private Docker container registries in Azure](container-registry-intro.md).

In order to view the container registry repositories:

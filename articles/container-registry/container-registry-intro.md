...
* **Azure services** that support building and running applications at scale, including [Container Service](../container-service/index.yml), [App Service](../app-service/index), [Batch](../batch/index.yml), [Service Fabric](/azure/service-fabric/), and others.

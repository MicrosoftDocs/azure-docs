...
* **Azure services** that support building and running applications at scale, including [Azure Kubernetes Service (AKS)](../aks/index.yml), [App Service](https://azure.microsoft.com/services/app-service/), [Batch](../batch/index.yml), [Service Fabric](/azure/service-fabric/), and others.

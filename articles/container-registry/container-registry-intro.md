...
description: Introduction to the Azure Container Registry service, providing cloud-based, managed Docker registries.
author: stevelas
ms.topic: overview
ms.date: 02/10/2020
ms.author: stevelas
...
Azure Container Registry is a managed Docker registry service based on the open-source Docker Registry 2.0. Create and maintain Azure container registries to store and manage your Docker container images and related artifacts.

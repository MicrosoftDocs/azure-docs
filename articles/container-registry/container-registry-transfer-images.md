...
Use the AzCopy tool or other methods to [transfer blob data](../storage/common/storage-use-azcopy-v10.md#copy-blobs-between-storage-accounts) from the source storage account to the target storage account.

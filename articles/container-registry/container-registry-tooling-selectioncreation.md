...
| Resource Group | As registries are resources used across multiple container hosts, a registry should default to its own resource group | Concatenate the registry name with acr | [name]acr | contosoacr

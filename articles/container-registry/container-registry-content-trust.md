...
Navigate to your registry in the Azure portal, then select **Access control (IAM)** > **Add role assignment**. Under **Add permissions**, select `AcrImageSigner` under **Role**, then **Select** one or more users or service principals, then **Save**.

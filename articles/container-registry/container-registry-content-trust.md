...
* See the [Azure Pipelines](~/azure/devops/pipelines/build/content-trust.md) documentation for an example of using content trust when you build and push a Docker image.

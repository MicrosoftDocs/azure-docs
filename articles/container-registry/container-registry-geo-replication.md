...
* For high availability and resiliency, we recommend creating a registry in a region that supports enabling [zone redundancy](zone-reduncancy.md). Enabling zone redundancy in each replica region is also recommended.

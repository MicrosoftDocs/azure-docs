...
* **Artifacts transfer problems**
  ...
  * To create ACR Transfer resources such as `exportPipelines`,` importPipelines`, and `pipelineRuns`, the user must have at least Contributor access on the ACR subscription. Otherwise, they will see authorization to perform the transfer denied or scope is invalid errors.

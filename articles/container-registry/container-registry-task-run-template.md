...
> [!NOTE]
> [!INCLUDE [pull-image-dockerfile-include](../../includes/pull-image-dockerfile-include.md)] See also [Example: Task run with managed identity](#example--task-run-with-managed-identity), later in this artice.

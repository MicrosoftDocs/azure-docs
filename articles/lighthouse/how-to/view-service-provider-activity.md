...
> [!TIP]
> We also provide Azure Policy built-in policy definitions to restrict delegation to specific managing tenants, and to audit delegation of scopes to a managing tenant. For more info, see [Audit delegations in your environment](view-manage-service-providers.md#audit-delegations-in-your-environment).

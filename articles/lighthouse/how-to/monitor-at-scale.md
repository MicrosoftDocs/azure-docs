...
- Explore this [MVP-built sample workbook](https://github.com/scautomation/Azure-Automation-Update-Management-Workbooks), which tracks patch compliance reporting by [querying Update Management logs](../../automation/automation-update-management-query-logs.md) across multiple Log Analytics workspaces. 

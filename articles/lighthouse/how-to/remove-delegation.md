...
This role can also be selected in an **Authorization** when [creating a Managed Service offer](../../marketplace/plan-managed-service-offer.md#authorization) to publish to Azure Marketplace.

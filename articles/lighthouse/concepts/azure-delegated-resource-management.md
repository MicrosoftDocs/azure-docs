...
> [!NOTE]
> While you can manage resources in multiple tenants spread across Azure public cloud regions, delegation of a subscription between two tenants across separate clouds is not supported.

...
[ :::image type="content" source="./media/troubleshoot-query-performance/obtain-query-metrics.png" alt-text="Getting query metrics"::: ](./media/troubleshoot-query-performance/obtain-query-metrics.png#lightbox)

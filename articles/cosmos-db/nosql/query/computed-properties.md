...
- If you're creating a computed property, removing a computed property, or updating it to use a new query, all indexes on that property name must be dropped first.

...
This enrolls every Azure Cosmos DB resource in your subscription in the vector search preview. The registration request is autoapproved, however it may take several minutes to take effect. After this time, you can follow the subsequent steps. 

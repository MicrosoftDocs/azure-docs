...
If you are provisioning throughput for an Azure Cosmos DB for MongoDB API account, use '/myShardKey' for the partition key path and when provisioning throughput for a Cassandra API account, use '/myPrimaryKey' for the partition key path.

...
The size of reservation should be based on the total amount of throughput used by the existing or soon-to-be-deployed Azure Cosmos DB resources (e.g., databases or containers - collections, tables, graphs). You can determine the required throughput in the following ways:

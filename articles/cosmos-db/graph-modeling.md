...
| Vertex | properties | String, Boolean, Numeric | No | A list of separate properties stored as key-value pairs in each vertex. |
...
| Edge | properties | String, Boolean, Numeric | No | A list of separate properties stored as key-value pairs in each edge. |

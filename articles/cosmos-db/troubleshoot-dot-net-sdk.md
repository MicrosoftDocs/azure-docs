...
| Status Code | Transient/Retry | Description | 
|----------|-------------|-------------|
...
| 408 | Transient | [Request timed out](troubleshoot-dot-net-sdk-request-timeout.md) |
...
| 410 | Transient | Gone exceptions (Transient failure that should not violate SLA) |
...
| 429 | Yes | It is safe to retry on a 429. This can be avoided by following the link to [Too many requests](troubleshoot-request-rate-too-large.md).|

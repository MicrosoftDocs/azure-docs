...
This quick start demonstrates how to create an Azure Cosmos DB account, database, and collection using the Azure portal. You'll then build and deploy a profile app built on the Cassandra .NET API. 

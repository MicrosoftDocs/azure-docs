...
:::image type="content" source="./media/how-to-setup-cmk/key-vault-properties.png" alt-text="Screenshot of the soft delete and purge protection properties for a new Azure Key Vault instance.":::

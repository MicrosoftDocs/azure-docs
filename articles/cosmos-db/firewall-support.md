...
Once IP access control is on, the portal provides switches to enable access to the Azure portal, other Azure services, and the current IP. Additional information about those switches is provided below.

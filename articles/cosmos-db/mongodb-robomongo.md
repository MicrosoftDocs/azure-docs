...
description: Learn how to connect to Cosmos DB using Robo 3T and the Azure Cosmos DB API for MongoDB
keywords: robomongo
services: cosmos-db
author: rimman
...
---
# Use Robo 3T with the Azure Cosmos DB API for MongoDB

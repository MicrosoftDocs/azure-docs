...
[!INCLUDE[appliesto-sql-api](includes/appliesto-sql-api.md)]
 ...
 Returns a Boolean expression indicating whether the GeoJSON object (Point, Polygon, MultiPolygon, or LineString) specified in the first argument intersects the GeoJSON (Point, Polygon, or LineString) in the second argument.  

...
> [!NOTE]
> Follow [these instructions](database-security.md#key-rotation) to rotate and regenerate keys on the Azure Cosmos DB API for Mongo DB, Cassandra API, Gremlin API or Table API.

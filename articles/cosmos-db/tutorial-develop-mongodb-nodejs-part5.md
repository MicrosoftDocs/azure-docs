...
1. In Visual Studio Code, save all your changes. On the left, select the **Debug** button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part5/debug-button.png" alt-text="Debug icon in Visual Studio Code":::, and then select the **Start Debugging** button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part5/start-debugging-button.png" alt-text="Debug icon in Visual Studio Code":::.

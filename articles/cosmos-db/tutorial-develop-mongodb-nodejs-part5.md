...
This multi-part tutorial demonstrates how to create a Node.js app with Express, Angular, and connect it to [Azure Cosmos DB for MongoDB API](mongodb-introduction.md) account.

...
1. On the **Select API option** page, select the **Create** option within the **Core (SQL) - Recommend** section. Azure Cosmos DB has five APIs: SQL, MongoDB, Gremlin, Table, and Cassandra. [Learn more about the SQL API](/azure/cosmos-db/sql/introduction.md).
   ...
   :::image type="content" source="media/create-sql-api-account-portal/cosmos-api-choices.png" lightbox="media/create-sql-api-account-portal/cosmos-api-choices.png" alt-text="Screenshot of select API option page for Azure Cosmos DB.":::
...
1. On the **Create Azure Cosmos DB Account** page, enter the following information:
   ...
   :::image type="content" source="media/create-sql-api-account-portal/new-cosmos-account-page.png" lightbox="media/create-sql-api-account-portal/new-cosmos-account-page.png" alt-text="Screenshot of new account page for Azure Cosmos DB SQL API.":::
...
1. Select **Go to resource** to go to the Azure Cosmos DB account page. 
   ...
   :::image type="content" source="media/create-sql-api-account-portal/cosmos-deployment-complete.png" lightbox="media/create-sql-api-account-portal/cosmos-deployment-complete.png" alt-text="Screenshot of deployment page for Azure Cosmos DB SQL API resource.":::

...
8. In Visual Studio Code, click the **Debug** button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part2/debug-button.png" alt-text="Debug icon in Visual Studio Code":::, click the Gear button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part2/gear-button.png" alt-text="Gear button in Visual Studio Code":::. The new launch.json file opens in Visual Studio Code.
...
9. Click the **Start Debugging** button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part2/start-debugging-button.png" alt-text="Debug icon in Visual Studio Code"::: to run the app.

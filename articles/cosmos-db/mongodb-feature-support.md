...
description: Learn about the feature support the Azure Cosmos DB for MongoDB API provides for MongoDB 3.4.
services: cosmos-db
author: alekseys
...
---
# Azure Cosmos DB for MongoDB API support for MongoDB features and syntax

Azure Cosmos DB is Microsoft's globally distributed multi-model database service. You can communicate with the Azure Cosmos DB for MongoDB API
 through any of the open source MongoDB client [drivers](https://docs.mongodb.org/ecosystem/drivers). The Azure Cosmos DB for MongoDB API
 enables the use of existing client drivers by adhering to the MongoDB [wire protocol](https://docs.mongodb.org/manual/reference/mongodb-wire-protocol).

By using the Azure Cosmos DB for MongoDB API
...
I is compatible with MongoDB Server version **3.2** by default. The supported operators and any limitations or exceptions are listed below. Features or query operators added in MongoDB version **3.4** are currently available as a preview feature. Any client driver that understands these protocols should be able to connect to Azure Cosmos DB for MongoDB API.
...
Azure Cosmos DB for MongoDB API
 provides comprehensive support for MongoDB query language constructs. Below you can find the detailed list of currently supported operations, operators, stages, commands and options.

## Database commands

Azure Cosmos DB supports the following database commands on all Azure Cosmos DB for MongoDB API.
...
Unique indexes are available for all Azure Cosmos DB for MongoDB API accounts.

## Time-to-live (TTL)

Azure Cosmos DB supports a relative time-to-live (TTL) based on the timestamp of the document. TTL can be enabled for Azure Cosmos DB for MongoDB API
 collections through the [Azure portal](https://portal.azure.com).

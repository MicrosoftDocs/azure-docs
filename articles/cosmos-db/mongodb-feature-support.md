...
> [!NOTE]
> This article is for Azure Cosmos DB's API for MongoDB 3.2. For MongoDB 3.6 version, see [MongoDB 3.6 supported features and syntax](mongodb-feature-support-36.md). For MongoDB 4.0 version, see [MongoDB 4.0 supported features and syntax](mongodb-feature-support-40.md).

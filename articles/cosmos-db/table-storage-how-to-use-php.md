...
To use the Storage Table service APIs, you must:
...
## Configure a Storage Table service connection
...
To create any Azure Table service client, you need to use the **TableRestProxy** class. You can:

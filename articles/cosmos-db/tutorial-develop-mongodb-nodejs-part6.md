...
1. In Visual Studio Code, open **routes.js** and **hero.service.js** side by side by pressing the **Split Editor** button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part6/split-editor-button.png" alt-text="Split Editor button in Visual Studio":::.
...
5. Check that everything worked by running the app. In Visual Studio Code, save all your changes, select the **Debug** button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part6/debug-button.png" alt-text="Debug icon in Visual Studio Code"::: on the left side, then select the **Start Debugging** button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part6/start-debugging-button.png" alt-text="Start debugging icon in Visual Studio Code":::.
...
4. Now that we've updated the code, select the **Restart** button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part6/restart-debugger-button.png" alt-text="Restart button in Visual Studio Code"::: in Visual Studio Code.

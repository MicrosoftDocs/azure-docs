...
Azure Cosmos DB delivers schema flexibility and rich indexing by natively supporting [JSON](https://www.json.org) data format and other data models/wire formats (for example, BSON format).

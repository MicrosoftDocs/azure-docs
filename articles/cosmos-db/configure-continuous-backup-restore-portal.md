...
* Configure and manage continuous backup using [Azure CLI](configure-continuous-backup-restore-cli.md), [PowerShell](configure-continuous-backup-restore-powershell.md), or [Azure Resource Manager](configure-continuous-backup-template.md).

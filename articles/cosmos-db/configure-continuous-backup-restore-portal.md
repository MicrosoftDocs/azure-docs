...
* Configure and manage continuous backup using [Azure CLI](continuous-backup-restore-command-line.md), [PowerShell](configure-continuous-backup-restore-powershell.md), or [Azure Resource Manager](configure-continuous-backup-template.md).

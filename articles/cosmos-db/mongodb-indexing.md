---
title: Indexing in Azure Cosmos DB for MongoDB API
description: Presents an overview of the indexing capabilities in Azure Cosmos DB for MongoDB API.
services: cosmos-db
author: orestis-ms

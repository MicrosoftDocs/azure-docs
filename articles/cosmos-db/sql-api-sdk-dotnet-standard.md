...
* New object model, with top-level CosmosClient and methods split across relevant Database, Container and Item classes, and corresponding RequestOptions
* New highly performant stream APIs
* Built-in support for Change Feed processor library APIs
...
* Ability to use partition keys to scale previously non-partitioned containers 

...
This article explains the different ways to create a container in Azure Cosmos DB Gremlin API. If you are using a different API, see [API for MongoDB](mongodb/how-to-create-container-mongodb), [Cassandra API](cassandra/how-to-create-container-cassandra.md), [Table API](table/how-to-create-container.md), and [SQL API](how-to-create-container.md) articles to create the container.

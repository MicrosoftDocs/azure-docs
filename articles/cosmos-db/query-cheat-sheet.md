...
:::image type="content" source="./media/query-cheat-sheet/azure-cosmos-db-cheat-sheet-letter.png" alt-text="Azure Cosmos DB query cheat sheets - letter-sized, with SQL API, JavaScript, MongoDB, Gremlin, and Table API queries and functions":::
...
:::image type="content" source="./media/query-cheat-sheet/azure-cosmos-db-cheat-sheet-a3.png" alt-text="Azure Cosmos DB query cheat sheets - A3-sized, with SQL API, JavaScript, MongoDB, Gremlin, and Table API queries and functions":::
...
* For MongoDB queries, see [Query using Azure Cosmos DB's API for MongoDB](tutorial-query-mongodb.md) and [Azure Cosmos DB's API for MongoDB feature support and syntax](mongodb-feature-support.md)

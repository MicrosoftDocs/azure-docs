...
>[!NOTE]
> Azure Cosmos DB is the premium offering for Azure Storage Tables. In most cases, these commands will also work against a Cosmos DB Table. Please see [Cosmos DB Storage Tables with PowerShell](storage-table-cosmosdb-with-powershell.md) for more information.
>

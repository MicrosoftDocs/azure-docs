...
1. Click the Azure Cosmos DB logo :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part4/azure-cosmos-db-icon.png" alt-text="Azure Cosmos DB icon in the Azure portal"::: on the left bar, and it shows you all the Azure Cosmos DBs you have.

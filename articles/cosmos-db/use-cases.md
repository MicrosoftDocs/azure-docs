...
:::image type="content" source="./media/use-cases/iot.png" alt-text="Azure Cosmos DB IoT reference architecture":::
...
:::image type="content" source="./media/use-cases/event-sourcing.png" alt-text="Azure Cosmos DB ordering pipeline reference architecture":::
...
:::image type="content" source="./media/use-cases/gaming.png" alt-text="Azure Cosmos DB gaming reference architecture":::
...
:::image type="content" source="./media/use-cases/apps-with-global-reach.png" alt-text="Azure Cosmos DB web app reference architecture":::
...
:::image type="content" source="./media/use-cases/personalization.png" alt-text="Azure Cosmos DB web app reference architecture":::

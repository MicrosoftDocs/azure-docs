...
Tom Sawyer Graph Database Browser makes it easy to visualize and analyze data in Azure Cosmos DB - Gremlin API. Graph Database Browser helps users see and understand connections in their data without extensive knowledge of the query language or schema. So, less technical users can interact with the data by loading the neighbors of selected nodes and building the visualization in whatever direction they need. Advanced users can run queries using Gremlin, Cypher, or SPARQL to gain other insights.
...
:::image type="content" source="./media/graph-visualization/tomsawyer/tomsawyer-databrowser-demo.gif" alt-text="Tomsawyer Data browser demo" border="false":::
...
## Graphistry
:::image type="content" source="./media/graph-visualization/graphistry/graphistry-logo.webp" alt-text="Graphistry GPU Based" border="false":::
...
## Graphlytic
:::image type="content" source="./media/graph-visualization/graphlytic/graphlytic-logo.png" alt-text="Graphlytic Logo" border="false":::
...
yFiles product family offers high-quality diagramming for cross-platform Java applications, for applications on the .NET platform and for browser applications based on HTML5 / JavaScript. The family of yFiles visualization software libraries have been integrated by enterprises and small businesses alike around the world since 2001. You will find the biggest and best software development companies of the fortune 500 among yWorks' customers. E.g. Microsoft itself uses yFiles visualizations inside the customer-facing parts of the Azure portal for the visualization of Azure infrastructure.

The extensive .NET class libraries yFiles.NET for Windows Forms, yFiles WPF for the Windows Presentation Foundation, yFiles for Java Swing and yFiles for JavaFX class libraries deliver state-of-the-art component technology which can easily be integrated into all kinds of desktop applications.
JavaScript library yFiles for HTML is a perfect fit for web-based diagramming applications that use state-of-the-art web technologies. Software developers use yFiles to add visualization capabilities to their own applications, dashboards, and reports, or to create new, white-label apps and tools for both in-house and customer facing products.

:::image type="content" source="./media/graph-visualization/yWorks/yWorks-demo-grid.png" alt-text="yWorks demo" border="false":::

yFiles is designed to support software developers with the creation of high-quality visualizations and interactive applications. It has been created with flexibility and extensibility in mind. Whatever use-case for connected data you may have, you can create bespoke reports, dashboards, and complete applications for that data that perfectly suit your use-case. Create meaningful visualizations that help users gain insights into the data quickly and easily. Build interactive user-interfaces that match your company's corporate design and easily connect to existing infrastructure and services. Use highly sophisticated automatic graph layouts to generate clear visualizations of the data hidden in your CosmosDB. Efficient implementations of the most important graph analysis algorithms enable the creation of responsive user interfaces that highlight the information the user is interested in or needs to be aware of. Use yFiles to create interactive apps that work on desktops, and mobile devices alike.

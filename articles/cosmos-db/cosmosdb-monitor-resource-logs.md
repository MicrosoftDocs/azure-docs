...
2. Select `enable`, his setting will then be applied in the next few minutes. All newly ingested logs will see the full-text or PIICommand text for queries.

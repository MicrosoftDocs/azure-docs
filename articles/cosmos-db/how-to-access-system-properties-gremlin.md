...
This property is used for optimistic concurrency control. If application needs to break read and write into separate traversals, it can use eTag property to avoid data loss in concurrent writes.

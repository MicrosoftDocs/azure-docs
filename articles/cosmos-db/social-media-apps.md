...
Azure Cosmos DB will run your queries (including [aggregates](https://techcommunity.microsoft.com/t5/azure/planet-scale-aggregates-with-azure-documentdb/m-p/54217)) across all your partitions transparently, so you don't need to add any logic as your data grows.

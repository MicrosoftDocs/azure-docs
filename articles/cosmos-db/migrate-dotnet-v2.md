...
For more information, see the [Azure Cosmos DB bulk executor library overview](bulk-executor-overview) and the .NET bulk executor library [release notes](sql-api-sdk-bulk-executor-dot-net.md).

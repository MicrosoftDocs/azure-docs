...
### August 2023
* Preview: [Azure Active Directory (Azure AD) authentication](./concepts-authentication.md#azure-active-directory-authentication) is now supported in addition to Postgres roles.
...
* [Azure Active Directory (Azure AD) authentication](./concepts-authentication.md#azure-active-directory-authentication)

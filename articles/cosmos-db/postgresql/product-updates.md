...
### June  2023
* General availability: PgBouncer settings are now available on all clusters.
    * See the list of [the configurable managed PgBouncer parameters](./reference-parameters.md#managed-pgbouncer-parameters).

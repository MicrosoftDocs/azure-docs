...
| `EnableUniqueIndexReIndex` | Enables support for unique index re-indexing for Cosmos DB for MongoDB RU. This capability cannot be enabled on an Azure Cosmos DB for MongoDB accounts with continuous backup  | No |

...
| SLA provides end-to-end coverage | Yes | No: Services, hardware, or software provided by a third party, such as cloud platform services on which MongoDB Atlas runs are not covered. |

...
Azure Cosmos DB provides a [SQL API for querying data](SQL-sql-query.md), without requiring schema or secondary indexes. This article provides the following information for developers:

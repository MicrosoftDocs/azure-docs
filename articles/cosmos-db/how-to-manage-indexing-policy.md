...
> [!NOTE]
> When updating indexing policy, writes to Azure Cosmos DB will be uninterrupted. Learn more about [indexing transformations](/azure/cosmos-db/index-policy#modifying-the-indexing-policy)

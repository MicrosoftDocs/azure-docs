---
title: Find request unit charge for Azure Cosmos DB API for MongoDB queries
...
# Find the request unit charge for queries executed with Azure Cosmos DB API for MongoDB

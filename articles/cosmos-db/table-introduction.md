...
description: Learn how you can use Azure Cosmos DB to store and query massive volumes of key-value data with low latency by using the popular OSS Azure Cosmos DB APIs account for MongoDB.
services: cosmos-db
author: SnehaGunda

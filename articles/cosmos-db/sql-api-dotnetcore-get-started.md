---
title: "Build a .NET Core console app to manage data in Azure Cosmos DB SQL API account "
...
# Build a .NET Core console app to manage data in Azure Cosmos DB SQL API account

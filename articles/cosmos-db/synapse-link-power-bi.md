...
* Create a database within the Azure Cosmos DB account and two containers that have [analytical store enabled.](configure-synapse-link.md#create-analytical-ttl)

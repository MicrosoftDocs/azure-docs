...
The per-document TTL feature can be activated on the Cosmos account configured for MongoDB API.
...
* [Indexing your Cosmos database configured for the MongoDB API](../cosmos-db/mongodb-indexing.md)

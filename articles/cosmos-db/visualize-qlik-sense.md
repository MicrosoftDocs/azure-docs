...
* Azure Cosmos DB API for MongoDB by using the Qlik Sense MongoDB connector (currently in preview).

* Azure Cosmos DB API for MongoDB and SQL API by using REST API connector in Qlik Sense.

...
## Next steps 
* For more information on how to create diagnostic settings for Azure Cosmos DB see [Creating Diagnostics settings](cosmosdb-monitor-resource-logs.md) article.

...
The following image illustrates the support request creation for container(collection/graph/table) restore via azure portal for accidental deletion or updation of data within a container

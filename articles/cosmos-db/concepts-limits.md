...
See the [Autoscale](provision-throughput-autoscale.md#autoscale-limits) article and [FAQ](autoscale-faq.yml#lowering-the-max-rus) for more detailed explanation of the throughput and storage limits with autoscale.

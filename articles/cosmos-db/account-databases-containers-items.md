...
| Azure Cosmos DB entity | SQL API | Cassandra API | Azure Cosmso DB for MongoDB | Gremlin API | Table API |
| --- | --- | --- | --- | --- | --- |
...
| Azure Cosmos entity | SQL API | Cassandra API | Azure Cosmso DB for MongoDB | Gremlin API | Table API |
| --- | --- | --- | --- | --- | --- |
...
| System-defined property | System-generated or user-configurable | Purpose | SQL API | Cassandra API | Azure Cosmso DB for MongoDB | Gremlin API | Table API |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| Cosmos entity | SQL API | Cassandra API | Azure Cosmso DB for MongoDB | Gremlin API | Table API |
| --- | --- | --- | --- | --- | --- |
...
| System-defined property | System-generated or user-defined| Purpose | SQL API | Cassandra API | Azure Cosmso DB for MongoDB | Gremlin API | Table API |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| Operation | SQL API | Cassandra API | Azure Cosmso DB for MongoDB | Gremlin API | Table API |
| --- | --- | --- | --- | --- | --- |

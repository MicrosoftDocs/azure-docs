...
Next, determine how the normalized utilization varies over time. Calculate the average normalized utilization across all hours. If you see that your average utilization is less than 66%, consider enabling autoscale on your database or container. In contrast, if the average utilization is greater than 66%, consider remaining on standard (manual) provisioned throughput.
...
This workload has variable traffic, with normalized RU consumption ranging from 0% to 100%. There are occasional spikes to 100% that are hard to predict, but many hours with low or no utilization. 

TBD: ADD IMAGE

Let's compare the cost of provisioning 30,000 RU/s manual throughput, versus setting autoscale max RU/s to 30,000 (scales between 3000 - 30,000 RU/s). Suppose we have the utilization history as described in the table. Our average utilization across these three hours is 41%. Because the normalized RU consumption averages to less than 66%, we save by using autoscale. 

Note that in hour 1, when there is 0 usage, autoscale will bill RU/s for 10% of the max RU/s. Though the cost of autoscale may be higher than manual throughput in certain hours, as long as the average utilization is less than 66% across all hours, autoscale will be cheaper overall.

|  | Utilization |Billed autoscale RU/s  |Option 1: Manual 30,000 RU/s  | Option 2: Autoscale between 3000 - 30,000 RU/s |
|---------|---------|---------|---------|---------|
|Hour 1  | 0%  |     3000  |  30,000 * 0.008 / 100 = $2.40        |   3000 * 0.012 / 100 = $0.36      |
|Hour 2  | 100%  |     30,000    |  30,000 * 0.008 / 100 = $2.40       |  30,000 * 0.012 / 100 = $3.60      |
|Hour 3 |  24%  |     7200    |  30,000 * 0.008 / 100 = $2.40       |    7200 * 0.012 / 100 = $0.86     |
|**Total**   |  |        |  $7.20       |    $4.82     |

...
:::image type="content" source="./media/continuous-backup-restore-permissions/restore-roles-permissions2.png" alt-text="List of roles required to perform restore operation." lightbox="./media/continuous-backup-restore-permissions/restore-roles-permissions.png" border="false":::

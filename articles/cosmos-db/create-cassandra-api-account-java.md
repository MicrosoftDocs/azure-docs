---
title: Create a Cassandra API account, database and a table by using a Java application | Microsoft Docs
...
# Create a Cassandra API account, database, and a table by using a Java application

...
|4. Reporting on large and live data sets    |  **Option 1:** [Power BI and serverless Synapse SQL pool to analyze Azure Cosmos DB data with Synapse Link](https://docs.microsoft.com/en-us/azure/cosmos-db/synapse-link-power-bi) **Option 2:** [Power BI Azure Analysis Services connector with direct query + Azure Analysis Services](create-real-time-weather-dashboard-powerbi.md/#power-bi-azure-analysis-connector--azure-analysis-services)       |
...
|2. Generating ad-hoc transactional reports with periodic refresh   |  [Power BI connecting to Azure Cosmos DB transactional store with oltp connector, import mode, and scheduled periodic refresh](powerbi-visualize.md)       |
...
|4. Transactional reporting on >= 10 GB data sets    |  [Power BI connecting to Azure Analysis Services with incremental refresh per partition](create-real-time-weather-dashboard-powerbi.md)       |

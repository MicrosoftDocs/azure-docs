...
> [!NOTE]
> If you are using bulk executor, please see the latest version 3.x of the [.NET SDK](sql-api-sdk-dotnet-standard.md), which has bulk executor built into the SDK. 

...
:::image type="content" source="media/rag-data-openai/vector-search-infosheet.png" alt-text="Options for Vector Search with Azure Cosmos DB." lightbox="media/rag-data-openai/vector-search-infosheet.png":::

...
> [!NOTE]
> This example uses JSON as the CLI output format, which is the default. To use another output format, see [Output formats for Azure CLI 2.0 commands](https://docs.microsoft.com/en-us/cli/azure/format-output-azure-cli)

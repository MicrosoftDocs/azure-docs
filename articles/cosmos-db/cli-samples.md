...
| [Create a Azure Cosmos DB account: API for SQL](scripts/create-database-account-collections-cli.md?toc=%2fcli%2fazure%2ftoc.json)| Creates a single Azure Cosmos DB SQL API account, database, and container. |
| [Create a Azure Cosmos DB account: API for MongoDB](scripts/create-mongodb-database-account-cli.md?toc=%2fcli%2fazure%2ftoc.json) | Creates a single Azure Cosmos DB API account for MongoDB, a database, and a collection. |
| [Create a Azure Cosmos DB account: API for Gremlin](scripts/create-gremlin-database-account-cli.md?toc=%2fcli%2fazure%2ftoc.json) | Creates a single Azure Cosmos DB Gremlin API account, database, and graph. |
| [Create a Azure Cosmos DB account: API for Cassandra](scripts/create-cassandra-database-account-cli.md?toc=%2fcli%2fazure%2ftoc.json) | Creates a single Azure Cosmos DB Cassandra API account and database. |
| [Create a Azure Cosmos DB account: API for Table](scripts/create-table-database-account-cli.md?toc=%2fcli%2fazure%2ftoc.json) | Creates a single Azure Cosmos DB Table API account, database, and table. |
...
| [Get the connection string of Azure Cosmos DB API for MongoDB](scripts/secure-mongo-connection-string-cli.md?toc=%2fcli%2fazure%2ftoc.json) | Gets the connection string to connect MongoDB app to your Azure Cosmos DB account.|

...
1. Move data to the destination Cassandra API endpoint. Refer to this [how-to guide](cassandra-migrate-cosmos-db-databricks) for migration with Azure Databricks.

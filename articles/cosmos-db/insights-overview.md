...
1. Search for **Monitor** and select **Monitor**.
    ...
    ![Screenshot that shows the Search box with the word "Monitor" and a dropdown that says Services "Monitor" with a speedometer-style image.](~/reusable-content/ce-skilling/azure/media/insights-overview/search-monitor.png)
...
![Screenshot that shows the metric section pin to dashboard example.](~/reusable-content/ce-skilling/azure/media/insights-overview/pin.png)

To export your data into the Excel format, select the down arrow to the left of the pushpin.

![Screenshot that shows the Export workbook down arrow.](~/reusable-content/ce-skilling/azure/media/insights-overview/export.png)

To expand or collapse all dropdown views in the workbook, select the expand arrow to the left of the down arrow.

![Screenshot that shows the Expand workbook arrow.](~/reusable-content/ce-skilling/azure/media/insights-overview/expand.png)
...
![Screenshot that shows the Customize button.](~/reusable-content/ce-skilling/azure/media/insights-overview/customize.png)
...
![Screenshot that shows the Gallery button.](~/reusable-content/ce-skilling/azure/media/insights-overview/gallery.png)

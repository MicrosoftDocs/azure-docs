...
5. Copy and paste the code snippet into your MongoDB app.
    ...
    :::image type="content" source="./mongodb/media/connect-mongodb-account/QuickStartBlade.png" alt-text="Quick start blade":::
...
4. The **Connection String** blade opens. It has all the information necessary to connect to the account by using a driver for MongoDB, including a preconstructed connection string.
   ...
   :::image type="content" source="./mongodb/media/connect-mongodb-account/ConnectionStringBlade.png" alt-text="Connection String blade" lightbox= "./mongodb/media/connect-mongodb-account/ConnectionStringBlade.png" :::

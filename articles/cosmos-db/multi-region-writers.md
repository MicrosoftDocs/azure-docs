...
**Manual** - This is a manual conflict resolution model. If you don’t expect conflicting writes to happen in first place and you can use this model for explicit control. 

## Next steps  

In this article, we described how you can use globally distributed multi-master with Azure Cosmos DB. Next, take a look at the following resources: 

...
> * [Node.js](sql-api-nodejs-get-started-preview.md)
...
## Next steps
* Want a more complex Node.js sample? See [Build a Node.js web application using Azure Cosmos DB](sql-api-nodejs-application-preview.md).

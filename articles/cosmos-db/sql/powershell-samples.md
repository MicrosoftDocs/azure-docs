...
For PowerShell cmdlets for other APIs see [PowerShell Samples for Cassandra](../cassandra/powershell-samples.md), [PowerShell Samples for MongoDB API](../mongodb/powershell-samples-mongodb.md), [PowerShell Samples for Gremlin](../graph/powershell-samples-gremlin.md), [PowerShell Samples for Table](../table/powershell-samples.md)

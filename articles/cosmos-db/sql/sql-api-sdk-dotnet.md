...
> [!IMPORTANT]  
> On August 31, 2024 the Azure Cosmos DB .NET SDK v2.x
...
> We recommend following these [instructions](migrate-dotnet-v3.md) to migrate to
> the latest version of .NET SDK v3 SDK. 
>

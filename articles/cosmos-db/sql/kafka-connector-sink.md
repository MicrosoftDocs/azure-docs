...
Sign into the [Azure portal](https://portal.azure.com/learn.learn.microsoft.com) and navigate to your Azure Cosmos DB account. Check that the three records from the “hotels” topic are created in your account.

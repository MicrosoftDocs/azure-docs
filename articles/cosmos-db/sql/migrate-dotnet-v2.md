...
For more information, see the [Azure Cosmos DB bulk executor library overview](resource-manager-template-samplesbulk-executor-overview.md) and the .NET bulk executor library [release notes](sql-api-sdk-bulk-executor-dot-net.md).

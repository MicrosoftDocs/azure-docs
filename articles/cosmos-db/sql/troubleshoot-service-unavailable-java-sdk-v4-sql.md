...
The following exception is hit if the SDK is not able to talk to the Azure Cosmos DB instance. This normally points to some security protocol like a firewall rule is blocking the requests.

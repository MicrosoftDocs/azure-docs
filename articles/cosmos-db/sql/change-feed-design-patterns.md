...
📺 [Video: Deploy an event sourcing solution with Azure Functions + .NET in 7 minutes](https://aka.ms/cosmos-db-video-deploy-event-sourcing-solution-with-azure-functions-dotnet)

...
If you're interested in learning how the application works, you can review the code snippets in this section. Otherwise, you can skip ahead to [Run the application](#run-the-application).

The following snippets are taken from the `src/main.rs` file.

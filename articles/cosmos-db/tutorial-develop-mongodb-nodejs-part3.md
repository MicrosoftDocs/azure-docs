...
1. In Visual Studio Code, click the Stop button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part3/stop-button.png" alt-text="Stop button in Visual Studio Code"::: to stop the Node app.
...
2. In Visual Studio Code, click the **Debug** button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part2/debug-button.png" alt-text="Debug icon in Visual Studio Code"::: on the left side, then click the **Start Debugging** button :::image type="content" source="./media/tutorial-develop-mongodb-nodejs-part3/start-debugging-button.png" alt-text="Debug icon in Visual Studio Code":::.

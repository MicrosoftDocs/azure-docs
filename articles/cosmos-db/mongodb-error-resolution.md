...
| Wire driver version issues | - | The older versions of Mongo drivers are unable to detect the Cosmos DB account name in the connection strings. | Append *appName=@accountName@* where accountName is your Cosmos DB account name. |

...
> [!NOTE]
> To use change streams, create the account with version 3.6 or 4.0 of Azure Cosmos DB's API for MongoDB, or a later version. If you run the change stream examples against an earlier version, you might see the `Unrecognized pipeline stage name: $changeStream` error.

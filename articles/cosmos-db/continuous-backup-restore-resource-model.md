...
|gremlinDatabasesToRestore | List of GremlinDatabaseRestoreResource objects to specify which databases and graphs should be restored. Each resource represents a single database and all the graphs under that database, see the [restorable Gremlin  resources](#restorable-gremlin-resources) section for more details. If this value is empty, then the entire account is restored. |

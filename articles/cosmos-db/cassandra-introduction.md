...
**Automatic indexing**: By default, Azure Cosmos DB automatically indexes all the properties within your entities in your Cassandra API database and does not require creation of secondary indices. 

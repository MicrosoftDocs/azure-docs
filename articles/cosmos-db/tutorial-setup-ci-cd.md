...
This article demonstrates how to set up a CI pipeline in Azure DevOps for an ASP.NET application that uses the Cosmos DB emulator build task to run tests. You can use the same steps to set up a CI pipeline for a Node.js or a Python application. 

...
* Geospatial queries. Many mobile apps offer geo-contextual experiences today. With first-class support for [geospatial types](geospatial.md), Cosmos DB makes creating these experiences easy to accomplish.

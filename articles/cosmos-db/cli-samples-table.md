...
| |  |
|---|---|
| [Create an Azure Cosmos account and table](scripts/table/create.md?toc=%2fcli%2fazure%2ftoc.json)| Creates an Azure Cosmos DB account and table for Table API. |
| [Change throughput](scripts/table/throughput.md?toc=%2fcli%2fazure%2ftoc.json) | Update RU/s on a table.|

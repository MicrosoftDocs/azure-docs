...
This article shows the Azure Cosmos DB Emulator release notes and the updates that were made in each release. It also lists the latest version of the emulator to download and use.

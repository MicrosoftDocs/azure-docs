...
| **408** | `"Server timeout"` indicates that traversal took more than **30 seconds** and was cancelled by the server. Optimize your traversals to run quickly by filtering vertices or edges on every hop of traversal to narrow down search scope.|

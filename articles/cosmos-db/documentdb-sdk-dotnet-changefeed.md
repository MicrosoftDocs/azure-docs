---
title: Azure .NET Change Feed Processor SDK & resources | Microsoft Docs
...
* Compatible with [SQL .NET SDK](documentdb-sdk-dotnet.md) versions 1.17.0 and above.
* Compatible with [SQL .NET Core SDK](documentdb-sdk-dotnet-core.md) versions 1.5.1 and above.
...
* Compatible with [SQL .NET SDK](documentdb-sdk-dotnet.md) versions 1.13.2 and above.
...
### <a name="1.0.0"/>1.0.0
* GA SDK
* Compatible with [SQL .NET SDK](documentdb-sdk-dotnet.md) versions 1.14.1 and below.

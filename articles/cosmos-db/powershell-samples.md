...
|[Create a Table API account](scripts/create-and-configure-table-database.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Creates a single Azure Cosmos DB account to use with the Table API. |

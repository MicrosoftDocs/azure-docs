...
Alternatively, you may use the [Azure Cosmos DB lifetime free tier](free-tier.md) to get an account with the first 1000 [RU/s](request-units.md) of throughput and 25 GB of storage free.

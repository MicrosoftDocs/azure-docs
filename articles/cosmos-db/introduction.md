...
- [Get started with Azure Cosmos DB API for Apache Cassandra](cassandra/manage-data-dotnet.md)
- [Get started with Azure Cosmos DB API for Apache Gremlin](create-graph-dotnet.md)

...
2. In the NuGet **Browse** box, type ***Azure DocumentDB***.
    ...
    From the results, install the **Microsoft DocumentDB client library** package. This will download and install the Azure Cosmos DB DocumentDB API package as well as all dependencies, like Newtonsoft.Json. Click **OK** in the **Preview** window, and **I Accept** in the **License Acceptance** window to complete the install.

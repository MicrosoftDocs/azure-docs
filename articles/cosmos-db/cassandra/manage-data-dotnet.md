...
This quickstart shows how to use .NET and the Azure Cosmos DB [API for Cassandra](cassandra-introduction.md) to build a profile app by cloning an example from GitHub. This quickstart also shows you how to use the web-based Azure portal to create an Azure Cosmos DB account.

...
:::image type="content" source="./media/consistency-mapping/account.png" alt-text="Cassandra consistency account level mapping" lightbox="./media/consistency-mapping/account.png" :::

:::image type="content" source="./media/consistency-mapping/dynamic.png" alt-text="Cassandra consistency dynamic mapping" lightbox="./media/consistency-mapping/dynamic.png" :::

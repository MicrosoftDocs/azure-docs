...
:::image type="content" source="~/reusable-content/ce-skilling/azure/media/migration/live-migration.gif" alt-text="Animation that shows the live migration of data to Azure Managed Instance for Apache Cassandra." border="false":::
...
:::image type="content" source="~/reusable-content/ce-skilling/azure/media/migrate-data-databricks/databricks-runtime.png" alt-text="Screenshot that shows finding the Azure Databricks runtime version.":::
...
:::image type="content" source="~/reusable-content/ce-skilling/azure/media/migrate-data-databricks/databricks-search-packages.png" alt-text="Screenshot that shows searching for Maven packages in Azure Databricks.":::

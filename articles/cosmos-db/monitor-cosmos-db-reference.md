...
Azure Cosmos DB uses Kusto tables from Azure Monitor Logs. You can query these tables with Log analytics. For a list of Kusto bales uses, see the [Azure Monitor Logs table reference](../azure-monitor/reference/tables/tables-resourcetype.md#azure-cosmos-db) article.

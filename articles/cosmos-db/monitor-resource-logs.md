...
1. In the **Diagnostic settings** pane, fill the form with your preferred categories. 
    ...
    For a list of log categories, see [Supported resource logs for Microsoft.DocumentDB/DatabaseAccounts](monitor-reference.md#supported-resource-logs-for-microsoftdocumentdbdatabaseaccounts).

...
> [!NOTE]
> The Azure Cosmos DB Data Migration tool is an open source tool desgined for small migrations. For larger migrations, view our [guide for ingesting data](cosmosdb-migrationchoices.md).

The Azure Cosmos DB Data migration tool supports SQL (core) API 
...
* **[Gremlin API](graph-introduction.md)** - The Data Migration tool isn't a supported import tool for Gremlin API accounts. [Learn about migration options for importing data into Gremlin API](cosmosdb-migrationchoices.md#other-apis)

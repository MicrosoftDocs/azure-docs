...
* Azure Cosmos accounts using strong consistency with three or fewer total regions (one write, two read) will lose write availability during a read region outage.

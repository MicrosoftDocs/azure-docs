...
### DocumentDB API
The following sample shows how to create a container (collection) using the DocumentDB API. You can find more details in [Partitioning with DocumentDB API](../documentdb/documendb-partition-data.md).

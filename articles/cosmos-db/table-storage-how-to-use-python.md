...
- [Azure Storage account](https://docs.microsoft.com/en-us/azure/storage/common/storage-create-storage-account#create-a-storage-account) or [Azure Comsos DB account](https://azure.microsoft.com/en-us/try/cosmosdb/)

...
> [!NOTE]
> If you perform a failover operation or add a new region while an asynchronous scale-up operation is in progress, the scale-up operation will be paused. It will resume automatically when the failover or add region operation is complete. 
- **Instant scale-down**

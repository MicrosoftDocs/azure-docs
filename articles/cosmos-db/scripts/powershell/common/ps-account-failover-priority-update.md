...
[!code-powershell[main](../../../../../powershell_scripts/cosmosdb/modify-failover-priority/modify-failover-priority.ps1 "Update failover priority for an Azure Cosmos account")]

---
title: PowerShell script to get Throughput (RU/s) for Azure Cosmos DB Cassandra API resources
...
# Get Throughput (RU/s) for a keyspace or table for Azure Cosmos DB - Cassandra API

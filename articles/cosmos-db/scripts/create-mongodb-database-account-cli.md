...
[!code-azurecli[main](../../../cli_scripts/cosmosdb/create-cosmosdb-mongodb-account/create-cosmosdb-mongodb-account.sh?highlight=15-34 "Create an Azure Cosmos DB MongoDB API account, database, and collection")]

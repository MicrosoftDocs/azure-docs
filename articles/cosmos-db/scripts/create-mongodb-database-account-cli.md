---
title: Azure CLI Script-Create an Azure Cosmos DB for MongoDB API account, database, and collection
description: Azure CLI Script Sample - Create an Azure Cosmos DB for MongoDB API account, database, and collection
author: markjbrown
ms.author: mjbrown
...
# Azure Cosmos DB: Create an Azure Cosmos DB API account for MongoDB using Azure CLI

This sample CLI script creates an Azure Cosmos DB API account for MongoDB, database, and collection.

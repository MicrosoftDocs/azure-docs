...
| [Invoke-AzResourceAction](https://docs.microsoft.com/powershell/module/az.resources/invoke-azresourceaction?view=azurermps-3.8.0) | Invokes an action on the Azure CosmosDB account. |

---
title: Update RU/s for a database and collection for MongoDB API for Azure Cosmos DB
description: Update RU/s for a database and collection for MongoDB API for Azure Cosmos DB
author: markjbrown
ms.author: mjbrown

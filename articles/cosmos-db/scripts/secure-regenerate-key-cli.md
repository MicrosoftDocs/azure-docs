...
[!code-azurecli[main](../../../cli_scripts/cosmosdb/secure-cosmosdb-regenerate-keys/secure-cosmosdb-regenerate-keys.sh?highlight=28-31 "Regenerate Azure Cosmos DB account keys")]
...
| [az cosmosdb create](/cli/azure/cosmosdb/name#create) | Updates an Azure Cosmos DB account. |

...
> [!NOTE]
> This article is about role-based access control for data plane operations in Azure Cosmos DB. See role-based access control applied to your [management plane operations](role-based-access-control.md).

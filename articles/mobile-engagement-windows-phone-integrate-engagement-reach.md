<properties 
	...
	description="How to Integrate Engagement Reach on Windows Phone"				
...
**Short**: You must ask the user to accept to receive push notifications. Then, in your settings, add a way to disable the push notifications.
...
**Short**: You should not use too much push notifications. Engagement will handle that for you.
...
**Short**: Do not rely on MPNS to send criticals informations. Engagement uses MPNS, so this rule also applies for the campaigns created inside the Engagement front-end.

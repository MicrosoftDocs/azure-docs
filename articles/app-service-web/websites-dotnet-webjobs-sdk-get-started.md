...
This tutorial shows you how to create a multi-tier ASP.NET MVC application that uses the WebJobs SDK to work with [Azure queues](http://www.asp.net/aspnet/overview/developing-apps-with-windows-azure/building-real-world-cloud-apps-with-windows-azure/queue-centric-work-pattern) and [Azure blobs](http://www.asp.net/aspnet/overview/developing-apps-with-windows-azure/building-real-world-cloud-apps-with-windows-azure/unstructured-blob-storage) in the Web Apps feature in [Azure App Service](http://go.microsoft.com/fwlink/?LinkId=529714). The application also uses [Azure SQL Database](http://msdn.microsoft.com/library/azure/ee336279).
...
* Run the program as a WebJob in a separate web app dedicated for that purpose. You can then scale your backend web app independently from your front end web app.
* Run the program in an Azure Cloud Service worker role. If you choose this option, you could run the front end in either a Cloud Service web role or a web app.

This tutorial shows you how to run the front end in a web app and the backend as a WebJob in the same web app. For information about how to choose the best environment for your scenario, see [Azure web app, cloud services, and virtual machines comparison](../choose-web-site-cloud-service-vm/).
...
1. To start the web front end of the application, press CTRL+F5.
...
* Deploy to Web Apps. Visual Studio automatically creates a new web app in App Service and SQL Database instance.
...
4. In the **Select existing web app** box, click **Sign In** and enter your credentials if you're not already signed in.
...
> [AZURE.NOTE] For the code specific to the WebJobs SDK, see [Program.cs and Functions.cs](#programcs).

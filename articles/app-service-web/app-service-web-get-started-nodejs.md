...
> The `username` and `password` are at account-level, as such, are different from your Azure Subscription credentials. These credentials are only required to be created once.
>

---
title: Deploy your Node.js web app to Azure in five minutes (CLI 2.0 Preview) | Microsoft Docs
...
4. Next, you get the sample Node.js code you want to deploy. Change to a working directory (`CD`) and clone the sample app like this:

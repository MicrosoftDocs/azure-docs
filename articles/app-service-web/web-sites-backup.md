...
## What gets backed up
App Service can backup the following information:
...
The following steps show how you would exclude these files from the backup.
...
Now, any files and folders that are specified in `_backup.filter` is excluded from the backup. In this example, the log files and the 2013 and 2014 image files are no longer be backed up, and brand.png.

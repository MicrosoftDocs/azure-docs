...
1. From the left menu, select **Resource Groups**, and then select the resource group that you created for this quickstart.
2. Select **Delete**, which deletes all the resources that you created in the quickstart.

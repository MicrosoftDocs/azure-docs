...
To enable HTTPS for a custom domain, such as contoso.com, you must first **[configure a custom domain name in Azure App Service.](https://azure.microsoft.com/en-us/documentation/articles/web-sites-custom-domain-name/)**
...
> See **[Azure Key Vault Pricing Details](https://azure.microsoft.com/en-us/pricing/details/key-vault/)** for more information.
...
1.	Click on **“Step 2: Verify”** Step from the **“Certificate Configuration”** Blade. There are 4 types of domain Verification supported by App Service Certificates.
    ...
    b) **Domain Verification** 
        ...
        1. This is the most convenient process **ONLY IF** you have **[purchased your custom domain from Azure App Service.](https://azure.microsoft.com/en-us/documentation/articles/custom-dns-web-site-buydomains-web-app/)**
...
> [AZURE.NOTE]
> Before performing the steps in this section, you must have associated a custom domain name with your app. For more information, see **[Configuring a custom domain name for a web app.](https://azure.microsoft.com/en-us/documentation/articles/web-sites-custom-domain-name/)**
...
- [Buy and Configure a custom domain name in Azure App Service](https://azure.microsoft.com/en-us/documentation/articles/custom-dns-web-site-buydomains-web-app/)

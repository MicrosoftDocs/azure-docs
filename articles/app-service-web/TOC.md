...
## Python
### [Django and MySQL app with Visual Studio](web-sites-python-ptvs-django-mysql.md)
### [Bottle and Table storage with Visual Studio](web-sites-python-ptvs-bottle-table-storage.md)
### [Flask and Table Storage with Visual Studio](web-sites-python-ptvs-flask-table-storage.md)
### [Django and MySQL on Azure with Visual Studio](web-sites-python-ptvs-django-mysql.md)
### [Django and SQL Database with Visual Studio](web-sites-python-ptvs-django-sql.md)
## Security
...
#### [Configure ApplicationHost.config](web-sites-transform-extend.md)
#### Configure Apache on Linux
#### [Configure Docker image](app-service-linux-using-custom-docker-image.md)

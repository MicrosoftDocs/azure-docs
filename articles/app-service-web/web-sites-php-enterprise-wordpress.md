...
**Enable email** | Enable (SendGrid)[https://azure.microsoft.com/en-us/marketplace/partners/sendgrid/sendgrid-azure/] using the Azure Store.Install the (SendGrid plugin)[http://wordpress.org/plugins/sendgrid-email-delivery-simplified] for WordPress.

...
> [!NOTE]
> While the VNET Integration feature will work with a Site to Site VPN to access on premise resources it currently VNET Integration feature will not integrate to a VNET that has an ExpressRoute Gateway configured in [coexistence mode][VPNERCoex]. This is true when integrating with either a Classic or Resource Manager VNET.  If you need to access resources through an ExpressRoute VPN then you can use an [ASE][ASEVNET] which can run in your VNET.
> 
> 
...
[VPNERCoex]: https://docs.microsoft.com/en-us/azure/expressroute/expressroute-howto-coexist-resource-manager
[ASEVNET]: https://docs.microsoft.com/en-us/azure/app-service-web/app-service-app-service-environment-intro#virtual-network-support

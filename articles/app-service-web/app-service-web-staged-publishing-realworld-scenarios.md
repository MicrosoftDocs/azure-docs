...
2. Deploying a web app to a slot first and swapping it into production ensures that all instances of the slot are warmed up before being swapped into production. This eliminates downtime when you deploy your web app. The traffic redirection is seamless, and no requests are dropped as a result of swap operations. This entire workflow can be automated by configuring [Auto Swap](https://azure.microsoft.com/en-us/documentation/articles/web-sites-staged-publishing/#configure-auto-swap-for-your-web-app) when pre-swap validation is not needed.
...
Assuming you already have a WordPress web app running on Azure Web, login to [Azure Management Preview portal](http://portal.azure.com) and go to your WordPress web app. Apps If not you can create one from the marketplace. To learn more, click [here](https://azure.microsoft.com/en-us/documentation/articles/web-sites-php-web-site-gallery/).
...
#### Setup a staging environment
Create a deployment slot as mentioned above for Umbraco CMS web app, assuming you already have an Umbraco CMS web app up and running. If not you can create one from the marketplace. To learn more, click [here](https://azure.microsoft.com/en-us/documentation/articles/web-sites-gallery-umbraco/).
...
![Update Connection string for staging web app with new staging database][9umbracosetconnectionstring]
...
3. Gives you the ability to do **A/B testing** using [Testing in production](http://azure.microsoft.com/en-us/documentation/videos/introduction-to-azure-websites-testing-in-production-with-galin-iliev/) feature
...
## References
[Agile software development with Azure App Service](https://azure.microsoft.com/en-us/documentation/articles/app-service-agile-software-development/)

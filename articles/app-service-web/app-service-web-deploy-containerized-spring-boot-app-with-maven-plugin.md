---
title: How to use the Maven plugin for Azure App Service to deploy a containerized Spring Boot app to Azure
...
# How to use the Maven plugin for Azure App Service to deploy a containerized Spring Boot app to Azure
...
This article demonstrates using the Maven plugin for Azure App Service to deploy a sample Spring Boot application in a Docker container to Azure App Services.
...
* [How to use the Maven plugin for Azure App Service to deploy a Spring Boot app to Azure App Service ](app-service-web-deploy-spring-boot-app-with-maven-plugin.md)

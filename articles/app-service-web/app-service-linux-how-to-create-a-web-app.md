...
Choosing "deployment options" from the management portal will give you the option to use local a Git repository or a GitHub respoitory to deploy your application. The instructions thereafter are similary to a non-Linux web app and you can follow the instructions in either our [local Git deployment](./app-service-deploy-local-git) or our [continuous deployment](./app-service-continuous-deployment.md) article for GitHub.

...
4. Make sure to start the ssh service. The example [here](https://github.com/Azure-App-Service/node/blob/master/6.9.3/init_container.sh) uses a shell script in */bin* directory.

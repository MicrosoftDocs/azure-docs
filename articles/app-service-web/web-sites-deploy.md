...
* [Using Windows PowerShell Scripts to Publish to Dev and Test Environments](https://azure.microsoft.com/en-us/documentation/articles/vs-azure-tools-publishing-using-powershell-scripts/). How to use Windows PowerShell deployment scripts that Visual Studio generates.

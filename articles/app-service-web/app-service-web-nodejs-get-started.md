...
3. Open the ./config/config.js file from the root of your application and change the production port to `process.env.port`; your production JSON object should look like the following example. Note: If this folder/file path does not exist in the root directory of your application, create a folder named **config** in the root directory of your application and copy the following JSON code into it.

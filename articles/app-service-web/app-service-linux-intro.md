...
## Overview ##
Customers can use App Service on Linux to host web apps natively on Linux for supported application stacks. The features section below lists the currently supported application stacks.
...
The Azure management portal will only show currently supported features for App Service on Linux and hide the rest. As our team enabling more features we will keep reflecting this on the management portal. Some features like VNET integration and AAD / 3rd party authentication or Kudu site extensions do not currently work. But as we get these working we will update our documentation and blog about changes.
...
Follow the links below on getting started with App Service on Linux. Please post questions and concerns on [our forum](https://social.msdn.microsoft.com/forums/azure/home?forum=windowsazurewebsitespreview).

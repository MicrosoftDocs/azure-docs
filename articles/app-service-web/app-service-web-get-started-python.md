...
4. Deploy a sample Python app from GitHub.

        az appservice web source-control config --repo-url "https://github.com/Azure-Samples/app-service-web-python-get-started.git" \

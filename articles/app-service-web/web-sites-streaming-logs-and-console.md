...
Diagnostics are enabled on a per app basis. From within the 
[Azure portal](https://portal.azure.com) browse to the site you would like to enable 
this feature for.  
...
level of traces to capture. You should set this to **Verbose** if you're just 
trying to get familiar with the feature as this will ensure all of your trace 
...
You won't be able to access protected directories or run scripts that require 
elevated permissions.  

![][ConsoleScreenshot]
From settings menu scroll down to **Development Tools** section and click 
on **(1)Console** and the **(2) console will open**.

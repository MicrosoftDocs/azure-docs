...
An App Service Environment can be created in **either** an ARM based virtual network, **or** a classic ASM virtual network.  With a recent change made in June 2016, ASEs can also now be deployed into virtual networks that use either public address ranges, or RFC1918 address spaces (i.e. private addresses). 

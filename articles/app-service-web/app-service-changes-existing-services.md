...
<p><li>Mobile Apps is a new app type in App Service, which integrates all of the functionality of Mobile Services and more.</p>
<p><li>It is easy to [Migrate from Mobile Services to Mobile Apps](../app-service-mobile/app-service-mobile-migrating-from-mobile-services.md).</p>

...
This article uses the Azure Portal to create a web app. You can also use the [Azure Command-Line Interface](../cli-install-nodejs.md) or [Azure PowerShell](/powershell/azureps-cmdlets-docs) to perform the same operations.

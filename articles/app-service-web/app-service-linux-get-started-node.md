...
Before running this sample, install the following prerequisites:
...
To verify the solution works, open a web browser and navigate to the sample.

```bash
http://localhost:1337
```

The sample displays a "Hello World" message.

...
To turn an On Demand WebJob into a scheduled WebJob, simply include a `settings.job` file alongside your WebJob. The file should contain a [CRON expression](https://en.wikipedia.org/wiki/Cron).

The CRON expression is composed of 6 fields: `{second} {minute} {hour} {day} {month} {day of the week}`.

e.g. to trigger your WebJob every 10 minutes, your `settings.job` would have:

...
> [AZURE.IMPORTANT] For **Windows 10 Universal apps**, please use [this recommended method](mobile-engagement-windows-store-advanced-reporting/#recommended-method-overload-your-codepagecode-classes), than the one mentioned above.

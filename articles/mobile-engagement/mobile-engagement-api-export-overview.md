...
We also advise the excellent [Microsoft Azure Storage Explorer](http://storageexplorer.com/), at least during your development as it provides a very easy to use UI for interacting with you storage.
...
Once you created your job, you may check its status to see if it is still running or if it has completed

Once the job is SUCCEEDED, your data file is available on your storage, you may access it.

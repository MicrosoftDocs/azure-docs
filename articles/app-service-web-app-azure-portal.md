...
In addition, the preview portal lets you define other common settings. For example, [resource groups](../azure-preview-portal-using-resource-groups/) make it simple to see and manage related Azure resources. 

<properties 
   pageTitle="Learn Hadoop with a tutorial for HDInsight | Microsoft Azure" 
   description="Get started with a Hadoop tutorial using HDInsight in the cloud. Learn how to provision Hadoop clusters, run a Hive query on data, and output to Excel for analysis." 
   keywords="hadoop tutorial,hadoop cluster,learn hadoop, hive query
   services="hdinsight" 
   documentationCenter="" 
   authors="nitinme" 
   manager="paulettm" 

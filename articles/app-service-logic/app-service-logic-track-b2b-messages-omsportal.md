...
1. In the log search write a query and select **Save**.  [Here](app-service-logic-track-b2b-messages-omsportal-query-to-filter-by-icn.md) are the steps to write a query 
...
3. Select **favorites** to view query   

...
In addition to the inclusion of integration accounts with consumption you can also create standard integration accounts without these limits and with our standard Logic Apps SLA. See [here](https://docs.microsoft.com/en-us/azure/app-service-logic/app-service-logic-pricing?toc=%2fazure%2flogic-apps%2ftoc.json) for further details.
## App Service plans

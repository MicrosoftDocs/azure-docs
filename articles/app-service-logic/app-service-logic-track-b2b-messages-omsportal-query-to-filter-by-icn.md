...
![Select log search](./media/app-service-logic-track-b2b-messages-omsportal-query-to-filter-by-icn/logsearch.png)

2. Type **Type="AzureDiagnostics"** in search window, pulls all data.  click **Add** to filter data  
![Select query](./media/app-service-logic-track-b2b-messages-omsportal-query-to-filter-by-icn/query1.png)

3. Type **interchange**, select **event_record_messageProperties_interchangeControlNumber_s**, and click **Add**  
![Select control number](./media/app-service-logic-track-b2b-messages-omsportal-query-to-filter-by-icn/query2.png)

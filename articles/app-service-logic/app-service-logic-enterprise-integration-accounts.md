<properties 
	pageTitle="Create an Enterprise Integration Pack integration account | Microsoft Azure App Service" 
	description="Create an Enterprise Integration Pack integration account" 

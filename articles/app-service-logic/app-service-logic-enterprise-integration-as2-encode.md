...
Why not give it a try. Click [here](https://azure.microsoft.com/en-us/documentation/templates/201-logic-app-as2-send-receive/) to deploy a fully operational logic app of your own using the Logic Apps AS2 features

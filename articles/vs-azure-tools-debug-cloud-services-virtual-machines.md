...
To debug a cloud service from a remote machine, you must choose the debug functionality when you deploy your cloud service so that the required services (msvsmon.exe, for example) are installed on the virtual machines that run your role instances. If you didn't enable remote debugging when you published the service, you have to republish the service with remote debugging enabled.
...
1. To identify the processes to which the debugger is attached, open the Processes dialog box. On the menu bar, choosing **Debug**, **Windows**, **Processes**. (Keyboard: Ctrl+Alt+Z)To detach a specific process, open its shortcut menu, and then click **Detach Process**. Or, locate the instance node in Server Explorer, find the process, open its shortcut menu, and then click **Detach Process**.
...
1. After the remote debugging extension finishes installing, open the virtual machine's context menu and click **Attach Debugger...** Azure shows you a list of the processes on the virtual machine in the **Attach to Process** dialog box.
...
1. In the **New ASP.NET Project** dialog box, in the Azure section, choose **Virtual Machine** in the dropdown list box. Leave the **Create remote resources** check box selected. Click **OK** to proceed.The **Create virtual machine on Azure** dialog box appears.
...
1. After the project publishes, on the virtual machine's context menu in Server Explorer, click **Attach Debugger...** Azure shows you a list of the processes on the virtual machine in the **Attach to Process** dialog box.

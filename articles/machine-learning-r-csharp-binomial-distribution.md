<properties pageTitle="Binomial Distribution Suite | Azure" description="Binomial Distribution Suite" services="machine-learning" documentationCenter="" authors="jaymathe" manager="paulettm" editor="cgronlun"/>

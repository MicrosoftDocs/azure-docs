...
Developers can also manage the keys directly, by using  APIs. For more information, see [Key Vault Management](https://msdn.microsoft.com/library/azure/dn903625.aspx).

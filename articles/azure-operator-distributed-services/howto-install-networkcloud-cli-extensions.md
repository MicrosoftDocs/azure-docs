...
# Installing NetworkCloud Azure CLI Extensions

This document will guide you through installing the following CLI extensions:
...
## Install hybridaks CLI extension
...
- [Configure NetworkFabric][howto-configure-networkfabric]
- [Deploy Tenant Workloads][quickstarts-tenant-workload-deployment]

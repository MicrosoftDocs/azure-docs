...
* Install the latest version of the [CLI commands](https://learn.microsoft.com/en-us/cli/azure/install-azure-cli)
...
* Terminal server has been [installed and configured](./quickstarts-platform-prerequisites.md#terminal-server-setup-instructions)
...
| resource-name | Name of the FabricResoruce | Austin-Fabric |True | String

---
title: How to guide for running commands for Cluster Manager on AODS
description: Learn to create, view, list, update, delete commands for Cluster Manager on AODS
author: krishnaposa
ms.author: sriposa
ms.date: 01/23/2023
ms.topic: how-to

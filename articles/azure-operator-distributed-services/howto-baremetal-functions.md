...
author: harish6724 #Required; your GitHub user alias, with correct capitalization.
ms.author: harishrao #Required; microsoft alias of author; optional team alias.
ms.service:  Azure Operator Distributed Services #Required;
ms.topic: how-to #Required; leave this attribute/value as-is.
ms.date: 01/27/2023 #Required; mm/dd/yyyy format.
...
* Ensure that you've installed the [Azure CLI](https://learn.microsoft.com/en-us/cli/azure/install-azure-cli).
* Install [`networkcloud` CLI extension](https://aka.ms/aods-nc-cli).
* Install [`networkfabric`CLI extension](https://aka.ms/aods-nf-cli)
* Install [`AKS-hybrid` CLI extension](https://aka.ms/aods-hybridaks-cli)
...
*Note: The reimage operation won't replace the image with a different image ... it will take the current existing image and reinstall it.*

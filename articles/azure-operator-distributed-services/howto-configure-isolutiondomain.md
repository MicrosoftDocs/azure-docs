...
* Install the latest version of [Managed Network Fabric CLI Extension](https://aka.ms/aods-nf-cli)
...
Sign-in to your Azure account and set the subscription to your Azure subscription ID.

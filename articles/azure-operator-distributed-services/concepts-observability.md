...
resources as described in
 <../../../azure/azure-monitor/essentials/monitor-azure-resource#monitoring-data>.
...
<../../../azure/azure-monitor/essentials/resource-logs-schema#top-level-common-schema>.
...
More information about the schema for these tables can be found at
<../../../azure/azure-monitor/reference/tables/tables-resourcetype#azure-arc-enabled-kubernetes>.
...
You can run log analytic queries on data collected in the Log Analytics Workspace as shown in these [sample queries](../../../azure/azure-monitor/containers/container-insights-log-query).

...
- **Storage**
  ...
  - Use [Azure premium storage](../../virtual-machines/disks-types.md#premium-ssds), [premium storage v2](../../disks-types.md#premium-ssd-v2) for all production grade SAP environments and when ensuring high SLA. For some DBMS, Azure NetApp Files can be used for [large parts of the overall storage requirements](planning-guide-storage.md#azure-netapp-files-anf).

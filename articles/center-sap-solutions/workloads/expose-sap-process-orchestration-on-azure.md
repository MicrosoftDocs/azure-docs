...
The following diagrams show two setups as examples. For more information, see the [SAP RISE reference guide](../../virtual-machines/workloads/sap/rise-integration.md#virtual-network-peering-with-sap-riseecs).

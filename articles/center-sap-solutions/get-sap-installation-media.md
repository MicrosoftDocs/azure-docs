---
title: Acquire SAP installation Media (preview)
description: Learn how to acquire SAP Installation Media to carry out SAP software Installation through Azure Center for SAP solutions.
ms.service: azure-center-sap-solutions
ms.topic: how-to
ms.date: 03/02/2023
author: lauradolan
ms.author: ladolan
#Customer intent: As a developer, I want to acquire the SAP installation media such that I can begin software installation on the SAP system whose infrastructure was created by Azure Center for SAP solutions.
---
...
In this how-to guide, you'll learn how to acquire the SAP software installation media through different methods and upload them in a storage account to prepare for SAP system installlation in ACSS. You can either [run a pre-installation script to automate the upload process](#option-1-upload-software-components-with-script) or [manually upload the components](#option-2-upload-software-components-manually). Then, you can [run the software installation wizard](#install-software).

...
- **Integration with logic apps** - API apps that you create can be consumed by [App Service logic apps](app-service-logic-what-are-logic-apps.md).    

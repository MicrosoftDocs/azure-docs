<properties title="Create a workspace" pageTitle="Create a machine learning workspace | Azure" description="Learn how to create a machine learning workspace for Azure Machine Learning." metaKeywords="" services="machine-learning" solutions="" documentationCenter="" authors="derrickv" videoId="" scriptId="" />

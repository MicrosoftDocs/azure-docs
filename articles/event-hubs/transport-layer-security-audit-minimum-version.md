---
title: Use Azure Policy to audit for compliance of minimum TLS version for an Event Hubs namespace
...
# Use Azure Policy to audit for compliance of minimum TLS version for an Event Hubs namespace (Preview)

...
If you're using PowerShell locally, you must run the latest version of PowerShell to complete this quickstart. If you need to install or upgrade, see [Install and Configure Azure PowerShell](https://docs.microsoft.com/powershell/azure/azurerm/install-Az-ps?view=azurermps-5.7.0).
...
[Install and Configure Azure PowerShell]: https://docs.microsoft.com/powershell/azure/azurerm/install-Az-ps
[New-AzResourceGroup]: https://docs.microsoft.com/powershell/module/azurerm.resources/new-Azresourcegroup

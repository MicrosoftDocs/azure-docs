...
For the public preview of this integration, the following Kafka features are not supported in Event Hubs for Kafka Ecosystems:
...
This article provided an introduction to Event Hubs for Kafka Ecosystem. To learn more, see the following links:

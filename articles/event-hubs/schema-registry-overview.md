...
:::image type="content" source="./media/schema-registry-overview/schema-driven-ser-de.png" alt-text="Flow diagram":::
...
:::image type="content" source="./media/schema-registry-overview/schema-registry.png" alt-text="Flow diagram":::
...
:::image type="content" source="./media/schema-registry-overview/information-flow.png" alt-text="Flow diagram":::
...
:::image type="content" source="./media/schema-registry-overview/elements.png" alt-text="Flow diagram":::

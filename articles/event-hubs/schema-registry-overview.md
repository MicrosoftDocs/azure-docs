...
- **Azure CLI** - For an example of adding a schema to a schema group using CLI, see [Adding a schema to a schema group](https://github.com/Azure/azure-event-hubs/tree/master/samples/Management/CLI/AddschematoSchemaGroups).

...
> [!IMPORTANT]
> Virtual networks aren't supported in the **basic** tier. The support for service endpoints will be available in **premium** tier soon.
...
> [!IMPORTANT]
> This feature isn't supported in the **basic** tier. The support for private endpoints will be available in **premium** tier soon. 

...
> - Make sure that you are a member of **Owner**, **Contributor**, or **Schema Registry Contributor** roles. For details about role-based access control, see [Schema Registry overview](schema-registry-overview.md#azure-role-based-access-control).

...
1. You see a query page with values already set for the following fields:
    ...
    1. An **output** alias to refer to your query test results. 
        ...
        >* User must be a member of the [Stream Analytics Query Tester](https://docs.microsoft.com/en-us/azure/role-based-access-control/built-in-roles#stream-analytics-query-tester) role at the Azure subscription level. This role allows user to perform query testing without creating a stream analytics job first.

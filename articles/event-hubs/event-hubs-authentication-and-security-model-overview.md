...
Typically, an event hub employs one publisher per device. All messages that are sent to any of the publishers of an event hub are queued within that event hub. Publishers enable fine-grained access control and throttling.

...
This article lists some of the exceptions generated by the Azure Service Bus messaging API library, which include Event Hubs APIs. This reference is subject to change, so check back for updates.

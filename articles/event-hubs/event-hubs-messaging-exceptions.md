...
This article lists some of the exceptions generated by the Azure Service Bus messaging APIs, which include Event Hubs. This reference is subject to change, so check back for updates.

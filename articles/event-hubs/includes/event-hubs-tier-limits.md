...
The following table shows limits that may be different for basic, standard, and dedicated tiers. 
...
| Number of partitions per event hub | 32 | 32 | 100 per event hub, but there is a limit of 200 per PU at the namespace level.<br/><br/> For example, if a namespace is assigned 2 PUs, the limit for total number of partitions in all event hubs in the namespace is 2 * 200 = 400. | 1024 per event hub<br/> 2000 per CU |

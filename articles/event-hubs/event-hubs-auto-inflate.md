...
When you apply the auto-inflate configuration to increase throughput units, the Event Hubs service emits diagnositc logs that give you information about why and when the throughput increased. 

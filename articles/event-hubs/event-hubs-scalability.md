...
For example, Event Hubs Premium namespace with 1 PUs and 1 Event Hub(100 partitions) can approximately offer core capacity of ~5-10 MB/s ingress and 10-20 MB/s egress for both AMQP or Kafka workloads.

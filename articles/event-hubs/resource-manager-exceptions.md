...
| BadRequest | 40000 | Event Hub Entity cannot be disabled. | Capture feature is enabled for continous flowing of messages. | Disable Capture feature and then try disabling the event Hub entity and it will work. 

...
## Use Data Lake Storage Gen1 with Synapse SQL pool
You can use PolyBase to load data from Data Lake Storage Gen1 into SQL pool. For more information see [Use Data Lake Storage Gen1 with SQL pool](../synapse-analytics/sql-data-warehouse/sql-data-warehouse-load-from-azure-data-lake-store.md).

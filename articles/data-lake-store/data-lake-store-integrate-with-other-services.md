...
## Use Data Lake Storage Gen1 with Azure Synapse Analytics (formerly SQL Data Warehouse)
You can use PolyBase to load data from Data Lake Storage Gen1 into SQL pool. For more information see [Use Data Lake Storage Gen1 with Azure Synapse Analytics](../synapse-analytics/sql-data-warehouse/sql-data-warehouse-load-from-azure-data-lake-store.md).

...
* **Windows SDK**. You can install it from [here](https://dev.windows.com/downloads). You use this to create a security certificate.
...
### Create a self-signed certificate
Make sure you have [Windows SDK](https://dev.windows.com/downloads) installed before proceeding with the steps in this section. You must have also created a directory, such as **C:\mycertdir**, where the certificate will be created.

<properties
   pageTitle="Create HDInsight clusters with Azure Data Lake Store using Resource Manager Templates | Azure"
...
- **Azure PowerShell 1.0 or greater**. See [How to install and configure Azure PowerShell](../powershell-install-configure).

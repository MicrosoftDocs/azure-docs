...
> [!NOTE] You can add both users and other groups to a group in Azure AD using the Azure portal. However, in order to add a service principal to a group, please use Azure AD’s PowerShell module.
> 
> ```powershell

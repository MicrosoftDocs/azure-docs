...
* [Azure Stream Analytics](../stream-analytics/stream-analytics-define-outputs.md#azure-data-lake-store) - Events ingested into Event Hubs can be written to Azure Data Lake Storage Gen1 using an Azure Data Lake Storage Gen1 output.

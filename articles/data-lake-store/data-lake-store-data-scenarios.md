...
| Azure Storage Blob |<ul> <li>[Azure Data Factory](../data-factory/copy-data-to-from-azure-datalake-store.md)</li> <li>[AdlCopy tool](data-lake-store-copy-data-azure-storage-blob.md)</li><li>[DistCp running on HDInsight cluster](data-lake-store-copy-data-wasb-distcp.md)</li> </ul> |
...
* [Azure Data Factory](../data-factory/copy-data-to-from-azure-datalake-store.md)

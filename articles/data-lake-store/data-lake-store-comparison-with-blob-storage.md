...
| Management operations (for example, Account Create) |[Azure role-based access control (Azure RBAC)](../role-based-access-control/overview.md) provided by Azure for account management |[Azure role-based access control (Azure RBAC)](../role-based-access-control/overview.md) provided by Azure for account management |

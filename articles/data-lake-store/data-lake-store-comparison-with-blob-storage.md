...
|    | Azure Data Lake Store<br>![Data Lake Store icon](./media/data-lake-store-comparison-with-blob-storage/azure-data-lake-store.png "Data Lake Store icon") | Azure Blob Storage<br>![Blob storage icon](./media/data-lake-store-comparison-with-blob-storage/storage-blob.png "Blob storage icon")  |
|----|-----------------------|--------------------|

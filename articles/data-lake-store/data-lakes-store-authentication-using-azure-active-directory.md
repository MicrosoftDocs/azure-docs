...
|:---------------------------------------------|:------------|:--------|:----------|:-------------|:---------|:--------|
|End-user (without MFA**)                        |   **[:+1:](data-lake-store-end-user-authenticate-net-sdk.md)** |    ✔    |    ✔      |       ✔      |    **[✔*](data-lake-store-end-user-authenticate-python.md#end-user-authentication-without-multi-factor-authentication)**     |    **[✔*](data-lake-store-end-user-authenticate-rest-api.md)**    |

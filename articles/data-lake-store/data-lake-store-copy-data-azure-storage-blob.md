...
Azure Data Lake Storage Gen1 provides a command line tool, [AdlCopy](https://www.microsoft.com/en-us/download/details.aspx?id=50358), to copy data from the following sources:
...
* **AdlCopy tool**. Install the [AdlCopy tool](https://www.microsoft.com/en-us/download/details.aspx?id=50358).

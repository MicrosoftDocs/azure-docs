...
This section details the terminology used in Service Fabric in order to understand the terms used elsewhere in the documentation.
...
**Programming Models** - There are two .NET Framework programming models available for you to build Service Fabric services:

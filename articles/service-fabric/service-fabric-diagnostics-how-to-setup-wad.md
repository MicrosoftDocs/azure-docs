...
![Visuall Studio Diagnostic Event Viewer Settings](./media/service-fabric-diagnostics-how-to-setup-wad/diagnostic-event-viewer.png)

To collect the events, modify the ARM template to include

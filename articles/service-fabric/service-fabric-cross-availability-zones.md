...
* The second value is **sfZonalUpgradeMode** and is optional. This property can’t be modified if a node type with multiple AZ’s is already present in the cluster.

...
* The second value is the "singlePlacementGroup" property, which must be set to true. **The spanned scale set across 3 AZ's can scale upto 300 VMs even with "singlePlacementGroup = true".**

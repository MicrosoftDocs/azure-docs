...
* The second value is the "singlePlacementGroup" property, which must be set to true. **The AZ spanned scale set can scale upto 300 VMs even with "singlePlacementGroup = true".**

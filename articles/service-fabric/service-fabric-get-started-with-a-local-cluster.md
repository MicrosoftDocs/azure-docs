...
> [!NOTE]
> This feature is available in SDK version 5.2 and above.
> 
> 
...
> [!WARNING]
> When changing cluster mode, the current cluster is being removed from your system and a new cluster is being created. The data you must have stored in the cluster, will be deleted when you change cluster mode.
> 
> 

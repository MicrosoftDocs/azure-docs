...
```
  This  will install the Jenkins container to the cluster you connected. You can monitor your container app using the service-fabric explorer - ``http://PublicIPorFQDN:19080``.
...
> [!NOTE]
> Admin needs to ensure 8081 port is specified as application endpoint port while creating the cluster
>

...
You may want to try changing the versions and moving from version 2.0.0 to version 3.0.0 as an exercise, or even from version 2.0.0 back to version 1.0.0. Play with time-outs and health policies to make yourself familiar with them. When you are deploying to an Azure cluster, the parameters you use will be different than those you use when deploying to a local cluster; it's we recommend that you set the time-outs conservatively.

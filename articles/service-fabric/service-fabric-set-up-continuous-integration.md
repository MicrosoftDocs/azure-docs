...
1.	Extract [ServiceFabricCIAutomationScripts.zip](https://github.com/CawaMS/CISCripts/blob/master/ServiceFabricCIAutomationScripts.zip) to any folder in source control.

...
* The Cluster Resource Manager can recognize and handle subclustering (a situation that sometimes arises when you use placement constraints and balancing). To learn how sub-clustering can affect balancing and how you can handle it, see [here](cluster-resource-manager-subclustering.md)

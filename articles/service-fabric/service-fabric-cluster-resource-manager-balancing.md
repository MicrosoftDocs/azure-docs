...
* The Cluster Resource Manager can recognize and handle sub-clustering (a situation that sometimes aries when you use placement constraints and balancing). To learn how sub-clustering can affect balancing and how you can handle it, see [here](service-fabric-cluster-resource-manager-sub-clustering.md)

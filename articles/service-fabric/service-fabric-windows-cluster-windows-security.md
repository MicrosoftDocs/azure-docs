...
> [!NOTE]
> ClustergMSAIdentity value can not include the domain name, and can only be the group managed service account name. I.E. "mysfgmsa" is correct, and "mydomain//mysfgmsa" is invalid; as the domain is implied by the host machine.

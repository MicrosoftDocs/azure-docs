...
You’ll notice here that there are constraints defined for Upgrade and Fault domains, and also that while the Fault Domain constraint is Hard the Upgrade Domain constraint is Soft. Also there’s this weird “PreferredLocation” constraint with a priority. What is all this stuff?

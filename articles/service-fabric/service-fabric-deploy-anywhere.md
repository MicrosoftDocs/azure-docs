<properties
   ...
   description="Service Fabric clusters will run on Windows Server and Linux, which means you'll be able to deploy and host Service Fabric applications anywhere you can run Windows Server or Linux."
...
* Because there's no vendor lock-in, you can choose where your applications run .
...
* **Azure Resource** Service fabric cluster is a ARM resource, so you can model it like you do other ARM resources in Azure.

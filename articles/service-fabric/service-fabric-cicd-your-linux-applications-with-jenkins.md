...
### Steps
  1. Pull the Service Fabric Jenkins container image: ``docker pull sayantancs/jenkins:v9``
  2. Run the container image: ``docker run -itd -p 8080:8080 sayantancs/jenkins:v9``

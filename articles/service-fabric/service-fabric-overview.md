...
Service Fabric powers many Microsoft services today, including Azure SQL Database, Azure DocumentDB, Cortana, Power BI, Microsoft Intune, Azure Event Hubs, Azure IoT, many core Azure services, and Skype for Business, to name a few.
...
- Develop applications composed of microservices, using the Service Fabric programmming model, or simply host guest executables, and other application frameworks of your choice, such as ASP.NET, Node.js, etc.

...
| --max-node-count     | The maximum number of nodes where Service Fabric reserves capacity     for this application. Note that this does not mean that the services     of this application are placed on all of those nodes.|
...
| --min-node-count     | The minimum number of nodes where Service Fabric reserves capacity     for this application. Note that this does not mean that the services     of this application are placed on all of those nodes.|
...
|Argument|Description|
| --- | --- |
| --app-id             [Required]| The identity of the application. This is typically the full            name of the application without the 'fabric:' URI scheme.|
| --app-version        [Required]| The target application type version (found in the application            manifest) for the application upgrade.|

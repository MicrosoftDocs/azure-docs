...
- Enabled [**Liveness Probe**](/azure/service-fabric/probes-codepackage ) mechanism for containerized    applications. Liveness Probe help announce the liveness of the containerized application and when they do not respond in a timely fashion, it will result in a restart.

...
The full set of REST management APIs for secret resources can be found [here](/rest/api/servicefabric/sfclient-index-meshsecrets), and for secret versions, [here](/rest/api/servicefabric/sfclient-index).

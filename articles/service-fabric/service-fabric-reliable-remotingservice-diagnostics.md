...
| --- | --- |
| Service Fabric Service |Counters specific to Azure Service Service , e.g. average time taken to process request |
| Service Fabric Service Method |Counters specific to methods implemented by Service Fabric Service, e.g. how often an service method is invoked |

...
* Do not apply [parallel](https://learn.microsoft.com/dotnet/standard/parallel-programming/how-to-use-parallel-invoke-to-execute-parallel-operations) 
  or [concurrent](https://learn.microsoft.com/dotnet/api/system.threading.tasks.task.whenall) operations within a transaction. 

...
Read more about [infrastructure level events](service-fabric-diagnostics-event-generation-infra.md) and [application level events](service-fabric-diagnostics-event-generation-app.md) to leverage the monitoring options you have and add further instrumentation.

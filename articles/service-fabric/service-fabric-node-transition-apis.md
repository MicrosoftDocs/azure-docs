---
title: Replacing the Start Node and Stop Node APIs with the Node Transition API | Microsoft Docs
description: Replacing the Start Node and Stop Node APIs with the Node Transition API

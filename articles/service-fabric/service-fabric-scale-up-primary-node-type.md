...
In Windows cluster, the value for property vmImage is ‘Windows’ while value of same property for Linux cluster is name of the OS image used. For e.g. - Ubuntu20_04(use the latest vm image name). To know more about latest RedHat images, kindly refer- [Latest Red Hat Images](https://learn.microsoft.com/azure/virtual-machines/workloads/redhat/redhat-imagelist)

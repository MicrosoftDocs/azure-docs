...
You can read these Syslog events in a monitoring tool such as Log Analytics. You can create a Log Analytics workspace by using the Azure Marketplace using these [instructions](../log-analytics/log-analytics-quick-collect-linux-computer#create-a-workspace.md)
...
* Reference for how to [Log Analytics integration with Syslog](../log-analytics/log-analytics-data-sources-syslog.md).

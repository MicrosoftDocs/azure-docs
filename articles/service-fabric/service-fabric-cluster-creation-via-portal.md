...
![Screenshot the Security page with Basic selected with the Key vault pane and Create key vault pane.][CreateKeyVault]
...
2. Select the "Properties" tab and copy the 'RESOURCE ID'  to "Source key vault" on the other browser window 
    ...
    ![Screenshot of the Properties window for the key vault.][CertInfo0]
...
5. Click on the GUIDs you see under the current Version.
    ...
    ![Screenshot of the Certificate window for the key vault][CertInfo1]
...
7. Copy the 'Secret Identifier' to the "Certificate URL" on other browser window.
    ...
    ![Screenshot of the Certificate Version dialog box with an option to copy the Certificate Identifier.][CertInfo2]

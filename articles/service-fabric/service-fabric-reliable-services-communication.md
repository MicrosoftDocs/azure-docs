...
For a complete walkthrough of how to write an `ICommunicationListener`, see [Get started with Service Fabric Web API services that use OWIN self-hosting](service-fabric-reliable-services-communication-webapi.md)

...
| Error | Description |
| --- | --- |
| System.IO.FileNotFoundException | This error is often due to missing assembly dependencies. Check the CopyLocal property in Visual Studio or the GAC for the node.
...
[Windows Azure Diagnostics](service-fabric-diagnostics-how-to-setup-wad-operational-insights.md) can be configured to upload the application event log for all your nodes automatically.

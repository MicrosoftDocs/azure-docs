...
1.  Ensure that you have installed Eclipse Neon or later and the version 2.2.1 of Buildship (the Service Fabric plug-in is not compatible with older versions of Buildship):

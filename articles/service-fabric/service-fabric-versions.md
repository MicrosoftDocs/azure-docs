...
| 7.1 CU10 <br>7.1.510.9590 |7.0 CU3<br>7.0.466.9590 |N/A | Version 4.1 or earlier | .NET Core >= 2.1 <br> .NET Framework >= 4.5 | [See supported OS version](#supported-windows-versions-and-support-end-date) | July 31, 2021 | [Release notes](https://github.com/microsoft/service-fabric/blob/master/release_notes/Service-Fabric-71CU10-releasenotes.md) |
...
| Service Fabric runtime | Can upgrade directly from | Can downgrade to <sup>1</sup> | Compatible SDK or NuGet package version <sup>2</sup> | Supported .NET runtimes <sup>3</sup> | OS version | End of support | Link to release notes |
| - | - | - | - | - | - | - | - |
| 10.1 CU3<br>10.1.2108.1 | 9.1 CU6<br>9.1.1642.1 | 9.0 | Version 7.1 or earlier | .NET 8 **(.NET 8 runtime support is available starting with Cumulative Update 3.0 (CU3) of version 10.1)**, .NET 7, .NET 6 | N/A | [See supported OS version](#supported-linux-versions-and-support-end-date) | Current version | [Release notes](https://github.com/microsoft/service-fabric/blob/master/release_notes/Service_Fabric_ReleaseNotes_101CU3.md) |
...
| 8.2 CU8<br>8.2.1521.1 | 8.0 CU3<br>8.0.527.1 | N/A | Version 5.2 or earlier | .NET Core >= 2.1 | [See supported OS version](#supported-linux-versions-and-support-end-date) | November 30, 2022 | [Release notes](https://github.com/microsoft/service-fabric/blob/master/release_notes/Service_Fabric_ReleaseNotes_82CU9.md) |
...
| 7.1 CU 6<br>7.1.455.1| 7.0 CU3<br>7.0.465.1 | N/A | Version 4.1 or earlier | .NET Core >= 2.1 | [See supported OS version](#supported-linux-versions-and-support-end-date) | July 31, 2021 | [Release notes](https://github.com/microsoft/service-fabric/blob/master/release_notes/Service-Fabric-71CU6-releasenotes.md) |

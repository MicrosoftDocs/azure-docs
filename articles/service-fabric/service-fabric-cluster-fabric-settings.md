...
|ContainerImagesToSkip|string, image names separated by `|`, default is ""|Static|Name of one or more container images that should not be deleted.  Used with the PruneContainerImages parameter.|

...
Fundamentals of scaling a Service Fabric cluster are covered in documentation on [cluster scaling](./service-fabric-cluster-scale-up-down.md). That article covers how Service Fabric clusters are built on top of virtual machine scale sets and can be scaled either manually or with auto-scale rules. This document looks at programmatic methods of coordinating scaling operations for more advanced scenarios. 

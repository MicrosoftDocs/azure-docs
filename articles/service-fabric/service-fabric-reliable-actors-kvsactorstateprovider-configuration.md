...
KVSActorStateProvider's default configuration can be modified by changing the settings.xml file that is generated in the Microsoft Visual Studio package root under the Config folder for the specified actor.

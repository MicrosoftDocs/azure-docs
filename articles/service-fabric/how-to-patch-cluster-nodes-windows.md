...
-	Stateless nodetypes are the only exception, which have durability as Bronze, but automatic OS image upgrades can still be configured on them. Read more [here](https://docs.microsoft.com/en-us/azure/service-fabric/service-fabric-stateless-node-types).

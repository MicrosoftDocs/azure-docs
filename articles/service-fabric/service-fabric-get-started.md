...
WebPI may already be installed on your computer - search for it using the Windows key. In case it's not present, you can [download it here](https://www.microsoft.com/web/downloads/platform.aspx). **NB** The page mentions that the tool will be retired fairly soon (July 1st 2022), so you may need to look for alternative ways to install this after that date. Stay tuned!

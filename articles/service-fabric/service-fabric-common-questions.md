...
A new platform feature will be available soon for preview, that provides an identity to your application, and integrates with KeyVault for Service Fabric application secrets management. In the meantime, the following are work around options:

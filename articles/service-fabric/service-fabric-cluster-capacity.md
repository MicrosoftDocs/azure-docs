...
> [!IMPORTANT]
> Durability level is set per node type. If there's none specified, *Bronze* tier will be used, however it doesn't provide automatic OS upgrades. Production workloads require a durability level of Silver or Gold.

...
![Screenshot of a cluster that has two Node Types][SystemServices]
...
* The **minimum size of VMs** for non-primary node types is determined by the **durability tier** you choose. The default durability tier is Bronze. For more information, see [The durability characteristics of the cluster](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-capacity#the-durability-characteristics-of-the-cluster).  
...
| Silver           | 5                              | VMs of single core or above with at least 50 GiB of temp storage                   | Can be delayed until approved by the Service Fabric cluster | Cannot be delayed for any significant period of time                                                    |
| Bronze           | 1                              | VMs with at least 50 GiB of temp storage                                           | Will not be delayed by the Service Fabric cluster           | Cannot be delayed for any significant period of time                                                    |
...
Here is the recommendation on choosing the reliability tier.  The number of seed nodes is also set to the minimum number of nodes for a reliability tier.  For example, for a cluster with Gold reliability there are 7 seed nodes.
...
- The recommended VM SKU is Standard D3 or Standard D3_V2 or equivalent with a minimum of 50 GB of local SSD.
...
This guidance of stateless Workloads that you are running on the non-primary node type.
...
**VM SKU:** This is the node type where your application services are running, so the VM SKU you choose for it, must take into account the peak load you plan to place into each Node. The capacity needs of the node type is determined by the workload you plan to run in the cluster. We cannot provide you with qualitative guidance for your specific workload.  However, here is the broad guidance to help you get started.

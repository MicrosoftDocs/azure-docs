...
The process is similar to the [process in Windows](https://azure.microsoft.com/en-us/documentation/articles/service-fabric-application-upgrade-tutorial-powershell/)).

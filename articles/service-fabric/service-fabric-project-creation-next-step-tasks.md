...
Service Fabric provides integration with ASP.NET 5 for building web-based entry points to your application. See [Adding a web front end to your application][add-web-frontend] to learn how to create a REST interface based on ASP.NET Web API.
...
Service Fabric Explorer offers an easy way to visualize your cluster, including deployed applications and physical layout. To learn more, see [Visualizing your cluster using Service Fabric Explorer][visualize-with-sfx].

...
Since managed clusters handles scale scenarios directly from the resource provider and uses managed disks for data we are able to support this for both stateful and stateless secondary node types.

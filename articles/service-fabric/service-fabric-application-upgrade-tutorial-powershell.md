...
<center><a target="_blank" href="https://docs.microsoft.com/shows/building-microservices-applications-on-azure-service-fabric/upgrading-an-application">
Check this page for a training video that also walks you through an application upgrade:

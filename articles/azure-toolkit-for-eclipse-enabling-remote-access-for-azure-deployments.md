...
<!-- Legacy MSDN URL = https://msdn.microsoft.com/en-us/library/azure/hh690951.aspx -->
...
1. When the pop-up dialog box appears:
    1. Specify the Role you for which you want to enable remote access
    1. Click to select the **Enable Remote Desktop** checkbox
    1. Specify a user name and password you want to use for remote access

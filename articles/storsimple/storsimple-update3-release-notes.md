...
| 22 | StorSimple Manager service creation*| If using Internet Explorer as the browser, you cannot create a new StorSimple Manager service. This problem is specific to Internet Explorer only and not seen if Microsoft Edge, Chrome, or Safari are used to create StorSimple Manager service.  | Use Microsoft Edge, Safari, or Chrome to create and manage StorSimple Manager service.|

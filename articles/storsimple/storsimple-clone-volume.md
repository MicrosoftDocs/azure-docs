...
To watch a video that demonstrates how you can use the clone and restore features in StorSimple to recover deleted files, click [here](http://azure.microsoft.com/en-us/documentation/videos/storsimple-recover-deleted-files-with-storsimple/).

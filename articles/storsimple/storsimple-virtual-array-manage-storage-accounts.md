...
4. In the storage account credential **Properties** blade, do the following:
   ...
   2. You can choose to regenerate your storage account credential access keys. For more information, see [Regenerate the storage account keys](../storage/common/storage-account-manage.md#storage-account-access-keys). Supply the new storage account credential key. For an Azure storage account, this is the primary access key.

...
| 8 | Monitoring LEDs | In certain instances, after applying Update 1, the blue light on the active controller turned off thereby making it hard to identify the active controller. In this release, this issue has been fixed.| Yes | No |
...
| 11 | Backups | A bug in Update 1 (software version 6.3.9600.17491) resulted in poor performance for cloud snapshots with low change rates. This bug has been fixed in the patch release Update 1.2 (software version 6.3.9600.17XXX).

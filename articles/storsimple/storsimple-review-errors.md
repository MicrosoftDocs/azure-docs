<properties 
   pageTitle="View and manage StorSimple errors"
   description="Describes StorSimple numbered errors and how to resolve them."
   services="storsimple"
...
[Learn about StorSimple alerts](storsimple-manage-alerts.md).

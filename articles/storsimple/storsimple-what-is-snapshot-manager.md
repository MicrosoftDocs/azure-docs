...
The following table provides links to more information about StorSimple Snapshot Manager features and capabilities.

| To learn about:  | Go to: |
|:-----------------|:-------|
| Deploying or removing StorSimple Snapshot Manager | [Install StorSimple Snapshot Manager](storsimple-snapshot-manager-deployment.md) |
| Using StorSimple Snapshot Manager menus and features | [StorSimple Snapshot Manager user interface](storsimple-use-snapshot-manager.md) |
| Using MMC features included in StorSimple Snapshot Manager | [Use the MMC menu actions in StorSimple Snapshot Manager](storsimple-snapshot-manager-mmc-menu.md)
| Connecting a device and veriying imports, authenticating a device, or disconnecting or replacing a device | [Use StorSimple Snapshot Manager to manage StorSimple devices](storsimple-snapshot-manager-manage-devices.md) |
| Mounting and managing StorSimple volumes | [Use StorSimple Snapshot Manager to view and manage volumes](storsimple-snapshot-manager-manage-volumes.md) |
| Creating volume groups to ensure application consistency | [Use StorSimple Snapshot Manager to create and manage volume groups](storsimple-snapshot-manager-manage-volume-groups.md) |
| Creating and managing backup schedules for local and cloud snapshots | [Use StorSimple Snapshot Manager to create and manage backup policies](storsimple-snapshot-manager-manage-backup-policies.md) |
| Viewing scheduled, currently running, and recent backup jobs | [Use StorSimple Snapshot Manager to view and manage backup jobs](storsimple-snapshot-manager-manage-backup-jobs.md) |
| Using the backup catalog to restore volumes and individual files or using it to delete a backup | [Use StorSimple Snapshot Manager to manage the backup catalog](storsimple-snapshot-manager-manage-backup-catalog.md) |

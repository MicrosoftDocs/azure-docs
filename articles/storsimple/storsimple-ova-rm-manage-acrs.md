...
## Add an ACR
You use **Access control records** blade within the **Configuration** section of your Device Manager service to add ACRs. Typically, you associate one ACR with one volume.

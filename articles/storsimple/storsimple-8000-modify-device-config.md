...
The Azure portal **Device settings** blade contains all the device parameters that you can reconfigure on a StorSimple device that is managed by a StorSimple Device Manager service. This tutorial explains how you can use the **Device settings** blade to perform the following device-level tasks:
...
You can use the Azure portal to change the device name and assign it a unique friendly name of your choice. The friendly name can contain any characters and can be a maximum of 64 characters long.
...
To modify the secondary DNS server, you can use the Azure portal.
...
You can reconfigure Controller 0 and Controller 1 through the Azure portal.

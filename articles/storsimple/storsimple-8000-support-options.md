...
*<text> * Premium coverage is not available in all locations. Please contact Microsoft at SSSupOps@microsoft.com for geographical coverage before purchasing StorSimple Premium Support.*
...
ASAP+ customers can switch to subscription model where standard support is included. Please use the StorSimple pricing calculator for subscription pricing and contact SSSupOps@microsoft.com for any questions. Switching is one way only from ASAP+ to Subscription.

...
| 15 | Locally pinned volumes  | The 'Used storage' displayed for a locally pinned volume may be different in the service and the iSCSI host. | The host has the filesystem  view.<br></br>The device sees the blocks allocated when the volume was at the maximum size. |                                                                                                                                                                                                                                                                                                                                                       

...
> [AZURE.IMPORTANT]  
>
>- This update is not available through Windows Update and cannot be installed like other updates. Your device will not receive this update even if you have applied the updates using the Azure portal. This update will only apply to virtual devices created after January 20, 2015. 
> 

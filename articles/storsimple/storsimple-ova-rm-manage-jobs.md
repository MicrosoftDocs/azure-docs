...
![Jobs blade](./media/storsimple-ova-rm-manage-jobs/ova-jobs-blade.png)
...
2. Select a job from the tabular list of jobs.
    ...
    ![Job blade](./media/storsimple-ova-rm-manage-jobs/ova-jobs-blade.png)
...
4. In the **Details** dialog box, you can view status, details, and time statistics. The following illustration shows an example of the **Backup Job Details** dialog box.
    ...
    ![Job details](./media/storsimple-ova-rm-manage-jobs/ova-jobs-details.png)
...
![Restore job failure](./media/storsimple-ova-rm-manage-jobs/restorejobfailure.png)

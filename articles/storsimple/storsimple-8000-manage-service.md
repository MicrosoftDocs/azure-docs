...
> [!NOTE]
> All classic StorSimple device managers was automatically moved to the new Azure portal. If you have any questions, see [FAQ: Move to Azure portal](storsimple-8000-move-azure-portal-faq.md). The Azure Service Management (ASM) PowerShell cmdlets are not supported after the move to the new Azure portal. Update the scripts to manage your devices, go to the [Use Azure Resource Manager SDK-based scripts to manage StorSimple devices](storsimple-8000-automation-azurerm-scripts.md) for more information. 

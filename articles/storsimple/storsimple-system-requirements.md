...
| VMWare vSphere | Tested with VMware vSphere 5.1 as iSCSI client | VAAI-block feature is tested with VMware vSphere v.5.1 on StorSimple devices. 
| Linux RHEL/CentOS | Versions 5 and 6 | Support for Linux iSCSI clients with open-iSCSI initiator versions 5 and 6 (supported with open-iSCSI initiator only). |
| Linux | SUSE Linux 11 | |

...
|                           |                                                                                                                                                                    |                                                                                                                                                                                         |
| **Proxy (optional)**          | Is this a valid proxy URI and port? </br> Is the authentication mode correct?                                                                                                                                | `wget http://bing.com % {$_.StatusCode}`</br>This command should be run immediately after configuring web proxy. If 200 is returned, it indicates that the connection is successful.                                                                                                                                 |

...
* You have downloaded the virtual array image for Hyper-V from the Azure portal. For more information, see [Step 3: Download the virtual array image](storsimple-ova-deploy1-portal-prep.md#step-3-download-the-virtual-device-image).

...
The StorSimple devices have a mix of hard disk drives and solid state drives for both the 8100 and 8600. The marketed capacity for the 8100 and 8600 are roughly 15 TB and 40 TB respectively. However, the usable capacities (available for customer data) are lower than the marketed capacity. The following table documents the details of SSD, HDD, and cloud capacity in the context of the StorSimple solution capacity.

...
> * We recommend that you install the software and other regular updates via the Azure  classic portal. You should only go to the Windows PowerShell interface of the device (to install updates) if the pre-update gateway check fails in the portal. Depending upon the version you are updating from, the updates may take 1.5-2.5 hours to install. The maintenance mode updates must also be installed via the Windows PowerShell interface of the device. As maintenance mode updates are disruptive updates, these will result in a down time for your device.
...
| --- | --- | --- | --- | --- |
| 1. |KB4011839 |Software update &#42; |Regular <br></br>Non-disruptive |~ 25 mins |
| 2. |KB4011841 |LSI driver and firmware updates|Regular <br></br>Non-disruptive |~ 20 mins |
| 3. |KB4011842 |USM firmware update (version 3.38) |Regular <br></br>Non-disruptive |~ 20 mins |
| 4. |KB4011843 |OS security  updates package |Regular <br></br>Non-disruptive |~ XX mins |
| 5. |KB3103616 |OS updates package |Regular <br></br>Non-disruptive |~ XX mins |
...
> * If updating from Update 3 or 3.1, the total install time is close to 1.1 hours.

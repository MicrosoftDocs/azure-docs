...
Implementing a one-click disaster recovery solution that uses Azure Site Recovery for file shares hosted on StorSimple storage has the following prerequisites:
   ...
   - [Azure Site Recovery services vault](/azure/site-recovery/hyper-v-vmm-azure-tutorial) created in a Microsoft Azure subscription
...
1. [Enable virtual machine protection](/azure/site-recovery/hyper-v-azure-tutorial) of the file server VM from the Azure Site Recovery portal.

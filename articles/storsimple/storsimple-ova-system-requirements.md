...
Only the Azure block blob storage is supported. Page blobs associated with Premium Storage are not supported. More information [about block blobs and page blobs](https://docs.microsoft.com/rest/api/storageservices/fileservices/understanding-block-blobs--append-blobs--and-page-blobs#about-block-blobs).

...
| [Install-DeviceUpdate.ps1](https://raw.githubusercontent.com/anoobbacker/storsimpledevicemgmttools/master/Install-DeviceUpdate.ps1)                 | This script scans the Update server and lets you know if updates are available to install on your StorSimple device.                                                                                          |
...
| [Manage-CloudSnapshots.ps1](https://raw.githubusercontent.com/anoobbacker/storsimpledevicemgmttools/masterManage-CloudSnapshots.ps1)                        | This script starts a manual cloud snapshot and deletes cloud snapshots older than specified retention days.                                                                                                   |
...
*	Azure Powershell installed. To install Azure PowerShell modules:
    ...
    * In a Linux or MacOS environment, follow the steps in [Install and configure Azure PowerShell on MacOS or Linux](https://docs.microsoft.com/en-us/powershell/azure/install-azureps-maclinux?view=azurermps-4.4.0).

...
1. In [Azure AI Studio](https://ai.azure.com), go to **Build** > **AI project settings** to view your Azure AI project resources - for example, Connected resources. There's a link to your Azure Hub resource in Azure AI Studio, and links to view the corresponding project resources in the [Azure portal](https://portal.azure.com).
...
1. Select the Azure Hub name to view your Azure AI hub's projects and connected resources. There's also a link to view the corresponding resources in the [Azure portal](https://portal.azure.com).

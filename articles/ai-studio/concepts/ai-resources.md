...
The preview 'Azure AI' resource used in AI studio can be used to access multiple Azure AI services with a single setup. Previously, different Azure AI services including [Azure OpenAI](../../ai-services/openai/overview.md), [Azure Machine Learning](../../machine-learning/), [Azure Speech](../../ai-services/speech-service/overview.md), required their individual setup. The AI resource provides the working environment for a team to build and manage AI applications, catering to two main user persona:

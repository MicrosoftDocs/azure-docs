...
We recommend implementing the following user-centered design and [user experience (UX) interventions, guidance, and best practices](Aka.ms/HAXToolkit) to guide users to use the system as intended and to prevent overreliance on the AI system:

...
> [!TIP]
> Content filtering (preview) is not available for certain models that are deployed via serverless APIs. These models include embed models and time series models.

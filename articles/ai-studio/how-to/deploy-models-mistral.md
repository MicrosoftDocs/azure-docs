---
title: How to deploy Mistral family of large language models with Azure AI Studio
titleSuffix: Azure AI Studio
description: Learn how to deploy Mistral family of large language models with Azure AI Studio.
manager: scottpolly
...
# How to deploy Mistral family of large language models with Azure AI Studio
...
1. On the model's **Details** page, select **Deploy** and then **Real-time endpoint**.
    ...
    :::image type="content" source="../media/deploy-monitor/mistral/deploy-real-time-endpoint.png" alt-text="A screenshot showing how to deploy a model with the real-time endpoint option." lightbox="../media/deploy-monitor/mistral/deploy-real-time-endpoint.png":::

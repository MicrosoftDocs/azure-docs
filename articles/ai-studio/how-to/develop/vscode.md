...
1. Open the project in VS Code:
    ...
    * If you want to work in your local VS Code instance, choose **Launch project in VS Code (Desktop)**. A new local instance of VS Code opens on your local machine.
    * If you want to work in the browser instead, select the dropdown arrow and choose **Launch project in VS Code (Web)**. A new browser tab connected to *vscode.dev* opens.

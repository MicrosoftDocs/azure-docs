...
The whitepaper also walks you through the following:
 ...
 - Running logic from the database itself, by writing stored procedures (sprocs), triggers, and user defined functions (UDFs) and storing them in the collection.
 - Choosing a consistency option to reliability and performance needs of your application.
 - Selecting a pricing option to meet your throughput requirements.

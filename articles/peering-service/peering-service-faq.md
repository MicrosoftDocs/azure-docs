...
- Assurance that the SP is well connected/or directly connected at all to Microsoft in the required region.  This can result in the incoming and outgoing traffic for Microsoft network being served over a long/suboptimal path with multiple networks involved.The reliability of such a setup with multiple providers is generally low. 

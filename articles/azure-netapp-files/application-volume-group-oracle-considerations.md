...
* Cross-zone and cross-region replication are supported for application volume group for [Oracle with the API only](configure-application-volume-oracle-api.md#configure-cross-region-or-cross-zone-replication). 

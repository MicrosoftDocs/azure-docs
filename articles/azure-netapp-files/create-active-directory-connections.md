...
:::image type="content" source="../media/azure-netapp-files/ad-reset-listview.png" alt-text="Azure volume list with the Reset Active Directory Account button highlighted." lightbox="../media/azure-netapp-files/ad-reset-listview.png":::

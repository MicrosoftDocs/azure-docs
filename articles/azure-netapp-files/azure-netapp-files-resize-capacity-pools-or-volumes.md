...
> [!IMPORTANT]
> Ensure that you have enough headroom in the capacity pools for both the source volume and the destination volume of cross-region replication. When you resize the source volume, the destination volume is automatically resized. But if the capacity pool doesn’t have enough headroom, the automatic resizing of the destination volume will fail. 

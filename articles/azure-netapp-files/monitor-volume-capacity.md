...
You can use the [`az netappfiles volume`](/cli/azure/netappfiles/volume?view=azure-cli-latest) commands of the [Azure command line (CLI) tools](azure-netapp-files-sdk-cli.md) to monitor a volume.

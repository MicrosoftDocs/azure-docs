...
* Wrap/unwrap isn't supported. Customer-managed keys use encrypt/decrypt. For more information, see [RSA algorithms](/azure/key-vault/keys/about-keys-details#rsa-algorithms).

...
- Command line to execute included within backets "()"
  - . /home/azacsnap/.profile = pull in the user's .profile to setup their environment, including
        $PATH, etc.

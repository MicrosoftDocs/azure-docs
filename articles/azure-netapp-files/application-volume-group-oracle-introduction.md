...
:::image type="content" source="./media/application-volume-group-concepts/resource-constrained-layout.png" alt-text="Diagram of resource-constrained volume layout." lightbox="d./media/application-volume-group-concepts/resource-constrained-layout.png":::

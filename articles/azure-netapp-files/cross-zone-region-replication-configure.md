...
- Cross-zone-region replication volumes must abide by the same requirements and considerations as individual [cross-zone replication](replication-requirements.md) and [cross-region replication](replication-requirements.md) volumes.  

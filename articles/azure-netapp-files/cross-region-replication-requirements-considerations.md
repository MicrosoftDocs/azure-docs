...
* You can set up a maximum of five volumes for replication within a single subscription per region. You can open a support ticket to request for an increase in the default quota of ten replication destination volumes (per subscription in a region). 

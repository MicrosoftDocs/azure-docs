...
>[!NOTE]
>To perform a reverse resync with [cross-zone-region replication](replication.md#cross-zone-region-replication), you must break the secondary relationship then perform the reverse resync as described. 
> 

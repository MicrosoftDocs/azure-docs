...
* For LDAP over TLS, upload one public CA certificate per file. Certificate bundles/chains (for example, root and intermediate certificates in the same PEM file) aren't supported.

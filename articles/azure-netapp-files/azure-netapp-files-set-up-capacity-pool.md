---
title: Set up a capacity pool | Microsoft Docs
description: Describes how to create a volume, edit volume attributes, and create a mount target by using Azure NetApp Files xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx

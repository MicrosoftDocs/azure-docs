...
* For volumes with advanced ransomware protection enabled and attached to a backup vault, the service automatically creates "anti-ransomware periodic backups". These backups are generated by the service and are intended to protect against complete volume loss. 

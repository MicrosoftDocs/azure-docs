...
* [Steps for successful quota management in dual-protocol volumes](create-volumes-dual-protocol.md#allow-local-nfs-users-with-ldap-to-access-a-dual-protocol-volume)

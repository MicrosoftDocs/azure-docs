...
>[!IMPORTANT]
>Existing backups not assigned to a backup vault must be migrated. To learn how to migrate, see [Manage backup vaults](configure-backup-vault.md#migrate-backups-to-a-backup-vault).

...
* <a name="Standard"></a>Standard storage
    ...
    * Standard storage with cool access   
        The throughput experience for this service level is the same as the Standard service level for data that is in hot tier, but it may differ when data that resides in the cool tier is accessed. For more information, see [Standard storage with cool access in Azure NetApp Files](cool-access-introduction.md#effects-of-cool-access-on-data). 

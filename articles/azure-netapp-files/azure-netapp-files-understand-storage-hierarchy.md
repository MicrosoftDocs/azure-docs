...
- You can configure a Standard service-level capacity pool with the cool access option. The capacity pool must use the auto QoS type. For more information about cool access, see [Standard storage with cool access](cool-access-introduction.md). 

...
For information on Unicode character support, see [Understand volume languages](understand-volume-languages.md) and [Under path lengths](understand-path-lengths.md).

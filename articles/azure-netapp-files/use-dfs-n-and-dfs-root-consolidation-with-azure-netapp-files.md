...
title: How to use DFS-N with Azure NetApp Files
description: Common DFS-N use cases with Azure NetApp Files
author: seanluce
ms.service: storage
ms.topic: how-to
ms.date: 6/23/2022
ms.author: seanluce
ms.subservice: azurenetappfiles

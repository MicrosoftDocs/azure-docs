...
1. Click **Application volume groups**. Select the volume group you want to delete.
    ...
    ![Screenshot that shows Application Volume Groups list.](../media/azure-netapp-files/application-volume-group-list.png) 

2. To delete the volume group, click **Delete**. If you are prompted, type the volume group name to confirm the deletion.  

    ![Screenshot that shows Application Volume Groups deletion.](../media/azure-netapp-files/application-volume-group-delete.png) 

...
Azure NetApp Files offers [numerous tools](https://azure.github.io/azure-netapp-files/) to help you estimate costs, to understand regional and feature availability, and to maximize 
...
* [ANFCapacityManager](https://github.com/ANFTechTeam/ANFCapacityManager)
    ...
    ANFCapacityManager is an Azure logic app that automatically creates metric alert rules in Azure Monitor to notify you when volumes are approaching their capacity. Optionally, it can increase the volumes' sizes automatically to keep your applications online.

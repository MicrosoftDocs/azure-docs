...
|  Maximum numbers of policy-based (scheduled) backups per volume  | <ul><li> Daily retention count: 1 (minimum) - 1019 (maximum) </li> <li> Weekly retention count: 1 (minimum) - 1019 (maximum) </li> <li> Monthly retention count: 1(minimum) - 1019 (maximum) </ol></li> <br> The maximum daily, weekly, and monthly backup retention counts combined is 1019.  |  N  |

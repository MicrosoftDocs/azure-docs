...
:::image type="content" source="../media/azure-netapp-files/performance-avs-scale-single-datastore.png" alt-text="Diagram that shows IOPS scaling on a single Azure NetApp Files datastore." lightbox="../media/azure-netapp-files/performance-avs-scale-single-datastore.png":::

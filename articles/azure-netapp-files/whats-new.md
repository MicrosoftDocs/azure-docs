...
* [Snapshot policy](snapshot-manage-policy.md) now generally available (GA)  
...
* [Snapshot revert](snapshot-revert-volume.md)
...
* [Hide snapshot path](snapshot-edit-hide-path.md)

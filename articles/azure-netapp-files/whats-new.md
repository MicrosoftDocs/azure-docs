...
* [Cross-zone replication](cross-zone-replication-introduction.md) is now generally available (GA).
    ...
    Cross-zone replication is available in all [regions with availability zone](../reliability/availability-zones-region-support.md) with [Azure NetApp Files presence](https://azure.microsoft.com/explore/global-infrastructure/products-by-region/?products=netapp&regions=all&rar=true).

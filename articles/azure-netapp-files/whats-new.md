...
* [Capacity pool enhancement](azure-netapp-files-set-up-capacity-pool.md) (GA)

    The lower of limit of 2 TiB for a capacity pool with Standard network features is now generally available (GA). 

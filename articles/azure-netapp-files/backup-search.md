...
1. If you have migrated to **Backup Vault**, navigate to **Backup Vault**. Select the backup vault.
    If you have not yet migrated to **Backup Vault**, navigate to **Backups**.
    The **Type** column shows whether the backup is generated by a *Scheduled* (policy-based) or a *manual* backup. 

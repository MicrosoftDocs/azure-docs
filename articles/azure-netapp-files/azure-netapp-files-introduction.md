...
> [!IMPORTANT] 
> All tasks described in this documentation require that you have been granted access to the Azure NetApp Files service. To request access to the service, see [Submit a waitlist request](azure-netapp-files-waitlist.md).

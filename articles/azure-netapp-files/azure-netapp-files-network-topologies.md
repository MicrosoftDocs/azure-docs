...
Subnets with Network Security Groups (NSGs) applied cannot be used as delegated subnets for Azure NetApp Files. Similarly, subnets with User-Defined Routes (UDRs) applied are also not supported. 
...
* On-premises resources VM 1 and VM 2 can connect to Volume 1 in the hub over a site-to-site VPN or an ExpressRoute circuit. 

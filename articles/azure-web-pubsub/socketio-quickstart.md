...
description: An quickstart demonstrating how to use Web PubSub for Socket.IO 
author: siyuanxing
...
Note: Code above is in CommonJS. If you'd like to use ES Module, please refer to [quickstart-esm](https://github.com/Azure/azure-webpubsub/tree/main/experimental/sdk/webpubsub-socketio-extension/examples/chat).
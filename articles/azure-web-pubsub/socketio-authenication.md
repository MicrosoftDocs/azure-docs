...
After using `useAzureSocketIO` to enable the service, the developer should add a negotiation handler to express app. Its `ConfigureNegotiateOptions` is generated by `usePassport()`. 

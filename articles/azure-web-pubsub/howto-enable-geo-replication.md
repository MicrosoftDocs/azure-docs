...
All other configurations are inherited from the primary resource. For example, access keys, identity, application firewall, custom domains, [private endpoints](howto-secure-private-endpoints.md#private-endpoints-with-geo-replication), and access control.

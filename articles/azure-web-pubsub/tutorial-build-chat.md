...
Use the Azure CLI [az webpubsub hub update](/cli/azure/webpubsub/hub#az_webpubsub_hub_update) command to update the event handler settings for the chat hub

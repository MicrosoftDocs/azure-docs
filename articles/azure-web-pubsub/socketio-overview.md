...
| Scaling connections | Customer managed by using a server-side componnet called ["adapter"](https://socket.io/docs/v4/adapter/) | Azure managed with **100k+** client connections out-of-the-box |

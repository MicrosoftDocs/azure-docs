...
- One is called [the simple WebSocket client](#simple-client)
- The other is called [the PubSub WebSocket client](#pubsub-client)
...
1. [Connection manager](#connection_manager)

---
title: Service internal - how does Web PubSub support the Socket.IO library
description: This article explains how Web PubSub supports the Socket.IO library.
author: kevinguo-ed
ms.author: kevinguo
ms.date: 08/1/2023
...
:::image type="content" source="./media/socketio-service-internal/typical-architecture-self-hosted-socketio-app.jpg" alt-text="Diagram of a typical architecture of a self-hosted Socket.IO app.":::

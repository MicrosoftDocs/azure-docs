...
:::image type="content" source="./media/socketio-server-internal/typical-architecture-self-hosted-socketio-app.png" alt-text="Screenshot of a typical architecture of a self-hosted Socket.IO app":::
...
:::image type="content" source="./media/socketio-server-internal/typical-architecture-managed-socketio.png" alt-text="Screenshot of a typical architecture of a fully managed Socket.IO app":::

...
1. On the **System assigned** tab, toggle the **Status** to **On**.
   ![Screenshot of virtual machine - identity](./media/howto-azure-active-directory/identity-virtual-machine.png)
...
2. Click **Next**.
   ...
   ![Screenshot of assigning role to managed identities](./media/howto-azure-active-directory/assign-role-to-managed-identities.png)

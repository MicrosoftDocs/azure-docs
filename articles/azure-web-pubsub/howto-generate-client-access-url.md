...
You could also use Microsoft Entra ID and generate the token by invoking [Generate Client Token REST API](/rest/api/webpubsub/dataplane/webpubsub/generate-client-token/generate-client-token).

...
Azure Web PubSub Service can access your Key Vault in a private network through shared private endpoints. In this way you don't have to expose your Key Vault on public network.

This article shows you how to configure your Web PubSub service instance to route outbound calls to Key Vault go through a shared private endpoint rather than public network.  
...
> You can substitute the resource IDs of your own Azure Web PubSub Service and Azure Key Vault.
...
* [Azure CLI](/cli/azure/install-azure-cli) 2.25.0 or later (if using Azure CLI)._- An Azure Web PubSub Service instance in a **Standard** pricing tier or higher
* An Azure Key Vault resource.

### 1. Create a shared private-link resource to the Key Vault

#### [Azure portal](#tab/azure-portal)

1. In the Azure portal, go to your Azure Web PubSub Service resource page.
1. Select **Networking** from the menu. 
1. Select to **Private access** tab.
...
After the private endpoint connection has been created, you need to approve the connection request from the Azure Web PubSub Service from your key vault resource.
...
1. Select **Shared private link resources**.
    ...
    You should see the shared private link resource in **Succeeded** provisioning state. The connection state is **Approved**.
...
The shared private endpoint between Azure Web PubSub Service and Azure Key Vault is active.

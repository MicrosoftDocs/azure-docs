...
description: Learn how to leverage serverless services from Microsoft to build mobile app backend
author: elamalani
manager: elamalani
...
[Azure Container Instances (ACI)](https://azure.microsoft.com/en-us/services/container-instances/) is a great solution for any scenario that can operate in isolated containers, including simple applications, task automation, and build jobs. Develop apps fast without managing VMs.

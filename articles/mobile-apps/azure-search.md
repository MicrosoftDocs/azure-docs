...
- **User experiences features** with autocomplete, search suggestions, sorting, and paging
...
Find detailed description on Azure Search [Features](https://docs.microsoft.com/en-us/azure/search/search-what-is-azure-search#feature-descriptions).

...
3. ### **Google Play**
    ...
    Google Play is the official app store for Android OS, allowing users to browse and download applications developer with Android SDK and published through Google. 

---
title: Use the REST APIs to manage chaos experiments
...
| --- | --- | --- |
| {apiVersion} | Version of the API to be used when executing the command provided | Can be found in the [API documentation](https://aka.ms/chaosrestapi) |

...
| Property | Value |
|-|-|
| Capability Names | <ul><li><strong>Version 1.0</strong>: Shutdown-1.0</li><li><strong>Version 2.0</strong>: Shutdown-2.0</li></ul> |
| Target type | Microsoft-VirtualMachineScaleSet |
| Supported OS Types | Windows, Linux |
| Description | Shuts down or kills a virtual machine scale set instance during the fault, and restarts the VM at the end of the fault duration or if the experiment is canceled. To use this fault, [automatic upgrade must be enabled](/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-automatic-upgrade) in the VMSS where it runs.<br><br>Note this fault has two versions, Version 1.0 and Version 2.0. Examples for both versions are below. |
| Prerequisites | None. |
| Urn | <ul><li><strong>Version 1.0</strong>: urn:csci:microsoft:virtualMachineScaleSet:shutdown/1.0</li><li><strong>Version 2.0</strong>: urn:csci:microsoft:virtualMachineScaleSet:shutdown/2.0</li></ul> |
...
| instances | Version 1.0 only. A string that is a delimited array of virtual machine scale set instance IDs to which the fault will be applied. |

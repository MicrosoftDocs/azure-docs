...
+ See [Gain insights into your Microsoft Azure resource consumption](billing-usage-rate-card-overview/) for an overview of the Billing Usage and RateCard APIs. 

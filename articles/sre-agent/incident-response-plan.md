...
- **Execution ode** describes the autonomy level of the incident response plan.
- **Customize instructions** give you the opportunity to customize the response plan initially generated by the agent.  
...
To ensure your incident response plan behaves the way you expect, you can test your plan against historical issues.

You can test your plan against historical incidents in your system to see how the type of mitigation the agent generates for your issue.

---
title: Learn to Use Azure SRE Agent Through Chat
...
For a list of sample prompts, see the [prompt library](starter-prompts.md) for more ideas of how to work with the agent.

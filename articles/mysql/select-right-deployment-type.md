...
|:-------------------|:-------------------------------------------|:---------------------------------------------|:---------------------------------------|
| Service-level agreement (SLA) | Offers SLA of 99.99% availability|Offers SLA of 99.99% availability with zone redundant high availability. 99.9% with single availability zone deployment.| 99.99% using Availability Zones with multiple instances in multiple availability sets. Up to 99.95% availability with two or more instances in the same availability set.<br/><br/>See the [Virtual Machines SLA](https://azure.microsoft.com/support/legal/sla/virtual-machines/v1_8/).                        |

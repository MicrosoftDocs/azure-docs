---
title: Azure Database for MySQL connectivity libraries | Microsoft Docs
description: Lists each library or driver that client programs can use when connecting to Azure Database for MySQL.
services: mysql
author: v-chenyh
ms.author: v-chenyh
manager: jhubbard
...
# Connectivity libraries used to connect to Azure Database for MySQL

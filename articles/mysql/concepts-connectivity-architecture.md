...
* You hard code the gateway IP addresses in the connection string of your application. It is **not recommended**. You should use fully qualified domain name (FQDN) of your server name in the format <servername>.mysql.database.azure.com, in the connection string for your application. 

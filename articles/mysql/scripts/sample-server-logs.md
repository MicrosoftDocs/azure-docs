---
title: Azure CLI samples enable and download server logs of an Azure Database for MySQL server | Microsoft Docs
description: This sample CLI script enables and downloads the server logs of an Azure Database for MySQL server.
services: mysql
author: v-chenyh
ms.author: v-chenyh
manager: jhubbard

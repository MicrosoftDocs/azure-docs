---
title: List of built-in policy definitions for Azure Database for MySQL
description: Lists Azure Policy built-in policy definitions for Azure Database for MySQL. These built-ins provide common approaches to managing your Azure resources.
ms.date: 05/01/2020
ms.topic: sample
author: ajlam
ms.author: andrela

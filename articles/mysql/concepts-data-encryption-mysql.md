...
> [!NOTE]
> This feature is available in all Azure regions where Azure Database for MySQL supports "General Purpose" and "Memory Optimized" pricing tiers. For other limitations refer [here](concepts-data-encryption-mysql.md#Limitations).

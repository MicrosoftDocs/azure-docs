...
description: Learn how to configure private link for Azure Database for MySQL server from Azure cli
author: kummanish
ms.author: manishku
ms.service: MySQL
ms.topic: conceptual
...
# Create and manage Private Link for Azure Database for MySQL server (Preview) using CLI

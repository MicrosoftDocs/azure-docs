...
4. On the **Basics** tab, enter the following information: 
    ...
    Availability zone| No preference | If your application VM, VMSS or AKS instance is provisioned in a specific availability zone, you can specify the same availability zone to collocate application and database to improve performance by cutting down network latency across zones.|

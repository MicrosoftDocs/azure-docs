...
If you created your flexible server by using public access (allowed IP addresses), you can add your local IP address to the list of firewall rules on your server. Refer [create or manage firewall rules documnentation](how-to-manage-firewall-portal.md) for step by step guidance.

...
|InvalidParameterValue| An invalid value was given to a parameter.Check the [CLI reference docs](/cli/azure/mysql/flexible-server?view=azure-cli-latest) to see what is the correct values supported for the arguments.|

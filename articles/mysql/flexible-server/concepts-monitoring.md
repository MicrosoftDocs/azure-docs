...
|CPU Credit Consumed|cpu_credits_consumed| Count|**This is for Burstable Tier Only** CPU credit is calculated based on workload, please check this [link](https://learn.microsoft.com/azure/virtual-machines/sizes-b-series-burstable) for more info|
|CPU Credit Remaining|cpu_credits_remaining|Count|**This is for Burstable Tier Only** CPU remaining is calculated based on workload, please check this [link](https://learn.microsoft.com/azure/virtual-machines/sizes-b-series-burstable) for more info|

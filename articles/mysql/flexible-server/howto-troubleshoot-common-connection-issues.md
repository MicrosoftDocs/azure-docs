...
* Encrypted connection using TLS/SSL: Flexible Server only supports encrypted connections using Transport Layer Security (TLS 1.2) and all **incoming connections with TLS 1.0 and TLS 1.1 will be denied**. Note that you cannot disable or change the TLS version. 
...
* Refer to [encrypted connectivity using Transport Layer Security (TLS 1.2) in Azure Database for MySQL - Flexible Server](./how-to-connect-TLS-SSL.md) ro learn more about encrypted connections.

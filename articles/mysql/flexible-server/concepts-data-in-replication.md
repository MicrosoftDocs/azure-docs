...
- It is recommended to have the source and replica server versions must be the same. For example, both must be MySQL version 5.7 or both must be MySQL version 8.0.

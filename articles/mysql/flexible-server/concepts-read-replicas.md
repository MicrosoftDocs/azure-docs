...
Replicas are new servers that you manage similar to your source Azure Database for MySQL flexible servers. You incur billing charges for each read replica based on the provisioned compute in vCores and storage in GB/ month. For more information, see [pricing](./concepts-compute-storage.md#pricing).

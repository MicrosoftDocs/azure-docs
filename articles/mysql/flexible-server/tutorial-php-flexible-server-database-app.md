...
![PHP app running in Azure App Service](media/tutorial-php-database-app/complete-checkbox-published.png)
...
![PHP app running in Azure App Service](media/tutorial-php-database-app/php-mysql-in-azure.png)

...
Flexible Maintenance for Azure Database for MySQL - Flexible Server enables a tailored maintenance schedule to suit your operational rhythm. This feature allows rescheduling of maintenance tasks within a maximum 14 days window and on-demand maintenance initiation, granting you unprecedented control over server upkeep timings. Stay tuned for more customizable experiences in the future. [Learn more](concepts-maintenance.md).

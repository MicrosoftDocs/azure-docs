---
title: How To Use sys_schema for Performance Tuning and Database Maintenance in Azure Database for MySQL | Microsoft Docs
...
There are 52 views in the sys_schema, and each view is prefixed by one of the following:
...
- Statement: Information on SQL statements; this can be statements that resulted in full table scan, or long query time.
...
In this example Azure Database for MySQL spent 53 minutes flushing the slog query log 44579 times. That’s a long time and a lot of IOs. You can reduce this activity by either disable your slow query log or decrease the frequency of slow query log in Azure portal.

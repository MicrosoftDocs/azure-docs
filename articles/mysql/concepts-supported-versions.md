...
Azure Database for MySQL automatically manages patching for minor version updates. Currently, in public preview, major version upgrade is not supported, for example from MySQL 5.6 to MySQL 5.7 upgrade is not supported.

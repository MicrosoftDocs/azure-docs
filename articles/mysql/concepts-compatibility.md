...
| MySQL Connector/NET | [MySQL Connector/NET](https://github.com/mysql/mysql-connector-net) | 8.0, 7.0, 6.10 |  | An encoding bug may fail connections on some non-UTF8 Windows systems. |

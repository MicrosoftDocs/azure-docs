...
- An [Azure Database for MySQL server and database](quickstart-create-server-database-azure-cli.md)
...
For more information about setting these values during create, see the [Azure Database for MySQL server CLI Quickstart](quickstart-create-server-database-azure-cli.md).

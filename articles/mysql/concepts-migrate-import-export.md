...
## Upload Files
With WinSCP you can easily upload and manage the import or dump of your existing MySQL enviornment (Azure or Non-Azure) files on your Local or Microsoft Azure instance/service over SFTP protocol or FTPS protocol for export purpose.

...
See details on all the updates in this [post](https://aka.ms/blogcpp).
...
3.	Confirm a Date | We migrate offers every week on Tuesday from 11am – 12pm PST, and ask to confirm a time to transfer at least 24 hours in advance from the owner of the publishing account. If you need to migrate at a different time such that it doesn’t interfere with your workflow, we will work with you to find the best time.<br/>You can expect an email notification to let you know that the migration is finished, and that you can now continue to work on the new portal.

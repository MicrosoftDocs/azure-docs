...
This article shows how to use Terraform to create a [Azure AI services account](cognitive-services-apis-create-account.md) using [Terraform](/azure/developer/terraform/quickstart-configure).

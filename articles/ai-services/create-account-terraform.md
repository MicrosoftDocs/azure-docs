...
This article shows how to use Terraform to create a [Azure AI services account](cognitive-services-apis-create-account.md) using [Terraform](~/azure-dev-docs-pr/articles/terraform/quickstart-configure.md).

...
1. Paste your key and endpoint into the code where indicated.
    ...
    > [!IMPORTANT]
    > Remember to remove the key from your code when you're done, and never post it publicly. For production, use a secure way of storing and accessing your credentials like [Azure Key Vault](../../../key-vault/general/overview.md). For more information about security, see the Azure AI services [security](../../cognitive-services-security.md) article.

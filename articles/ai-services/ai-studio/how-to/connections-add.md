...
| --- | --- |
| [Azure AI Search](#service-connection-types?tabs=azure-ai-search) | Azure AI Search is an Azure resource that supports information retrieval over your vector and textual data stored in search indexes. |
| [Azure Blob Storage](#service-connection-types?tabs=azure-blob-storage) | Azure Blob Storage is a cloud storage solution for storing unstructured data like documents, images, videos, and application installers. |
| [Azure Data Lake Storage Gen 2](#service-connection-types?tabs=azure-data-lake-storage-gen-2) | Azure Data Lake Storage Gen2 is a set of capabilities dedicated to big data analytics, built on Azure Blob storage. |
| [Azure Content Safety](#service-connection-types?tabs=azure-content-safety) | Azure AI Content Safety is a service that detects potentially unsafe content in text, images, and videos. |
| [Azure OpenAI](#service-connection-types?tabs=azure-openai) | Azure OpenAI is a service that provides access to the OpenAI GPT-3 model. |
| [Microsoft OneLake](#service-connection-types?tabs=microsoft-onelake) | Microsoft OneLake provides open access to all of your Fabric items through Azure Data Lake Storage (ADLS) Gen2 APIs and SDKs. |
| [Git](#service-connection-types?tabs=git) | Git is a distributed version control system that allows you to track changes to files. |
| [API key](#service-connection-types?tabs=api-key) | API Key connections handle authentication to your specified target on an individual basis. This is the most common third-party connection type. |
| [Custom](#service-connection-types?tabs=custom) | Custom connections allow you to securely store and access keys while storing related properties, such as targets and versions. Custom connections are useful when you have many targets that or cases where you would not need a credential to access. LangChain scenarios are a good example where you would use custom service connections. Custom connections don't manage authentication, so you will have to manage authenticate on your own. |

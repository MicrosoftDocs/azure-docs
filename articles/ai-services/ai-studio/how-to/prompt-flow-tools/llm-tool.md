...
1. Select **+ LLM** to add the LLM tool to your flow.
    ...
    :::image type="content" source="../../media/prompt-flow/llm-tool.png" alt-text="Screenshot of the Prompt tool added to a flow in Azure AI Studio" lightbox="../../media/prompt-flow/llm-tool.png":::

...
1. Select **+ More tools** > **Vector DB Lookup** to add the Vector DB Lookup tool to your flow.
    ...
    :::image type="content" source="../../media/prompt-flow/vector-db-lookup-tool.png" alt-text="Screenshot of the playground page of the Azure AI Studio with python sample code in view" lightbox="../../media/prompt-flow/embedding-tool.png":::
...
| vector | list | The target vector to be queried, which can be generated by Vector DB Lookup tool. | Yes |

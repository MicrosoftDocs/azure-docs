...
:::image type="content" source="../media/rag/rag-pattern.png" alt-text="Screenshot of the RAG pattern." lightbox="../media/rag/rag-pattern.png":::
...
:::image type="content" source="../media/rag/rag-pattern-with-index.png" alt-text="Screenshot of the RAG pattern with index." lightbox="../media/rag/rag-pattern-with-index.png":::

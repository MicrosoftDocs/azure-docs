---
title: Create Azure AI services resource using Azure Management client library
titleSuffix: Azure AI services
description: Create and manage Azure AI services resources using the Azure Management client library.

...
1. Create a Speech resource on the [Azure portal](https://portal.azure.com). For more information, see [Create an Azure AI services resource](~/articles/ai-services/multi-service-resource.md?pivots=azportal).

...
- With this update, we have adjusted the pricing of prebuilt neural voices with Azure AI Speech. Check the updated pricing [here](https://azure.microsoft.com/en-us/pricing/details/cognitive-services/speech-services).

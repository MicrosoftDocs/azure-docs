...
- The Chinese (Mandarin, Simplified) voice `zh-CN-XiaoxuanNeural` is retired on December 29, 2023. All service requests to `zh-CN-XiaoxuanNeural` will be redirected to `zh-CN-XiaozhenNeural` automatically as of December 29, 2023. If you're using container Neural TTS, [download](speech-container-ntts.md#get-the-container-image-with-docker-pull) and deploy the latest version. All requests with previous versions won't succeed starting from January 15, 2024.

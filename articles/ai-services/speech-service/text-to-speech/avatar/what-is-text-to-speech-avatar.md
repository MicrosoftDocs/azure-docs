...
Text to speech avatar is a text to speech feature with visual capability that allows you to create synthetic videos of a photorealistic avatar speaking based on input text. You can create a custom text to speech avatar by providing your own video recording data while adhering to responsible AI practices.
...
- Synthesizes text to speech avatar video asynchronously with the [batch synthesis API](./batch-synthesis-create-avatar.md) or in [real-time](./real-time-synthesis-avatar.md).
- Provides a content creation tool in Speech Studio for creating video content without coding.
- Allows you to create a custom text to speech avatar by providing your own video recording data.

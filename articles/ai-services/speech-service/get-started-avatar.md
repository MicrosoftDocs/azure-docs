...
- **Communication Resource:** Create a [Communication resource](https://ms.portal.azure.com/#create/Microsoft.Communication) in the Azure portal (for real-time avatar synthesis only).

...
* **Document Intelligence v2.1-preview.2 has been released and includes the following features:**
  ...
  * **Client library update** - The latest versions of the [client libraries](/azure/ai-services/document-intelligence/how-to-guides/v2-1-sdk-rest-api) for .NET, Python, Java, and JavaScript support the Document Intelligence 2.1 API.
...
* **v2.0** includes the following update:
  ...
  * The [client libraries](/azure/ai-services/document-intelligence/how-to-guides/v2-1-sdk-rest-api) for NET, Python, Java, and JavaScript have entered General Availability.

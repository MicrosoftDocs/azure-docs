...
**Translate text**
  ...
  > [!NOTE]
  > In this example we are using a regional endpoint (default). If you're using the global endpoint, see [Create a Text Translation client](../../create-translator-resource.md#create-a-text-translation-client).

...
| Headers  | Description |
| ------ | ----------- |
| Authentication header(s) <img width=200/>  | **Required request header**.<br/>See <a href="/azure/ai-services/translator/reference/v3-0-reference.md#authentication">available options for authentication</a>. |

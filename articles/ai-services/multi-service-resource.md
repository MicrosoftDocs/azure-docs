...
| ![Custom Vision icon](~/reusable-content/ce-skilling/azure/media/ai-services/custom-vision.svg) [Custom Vision](./custom-vision-service/index.yml) | Customize image recognition for your business. | `AIServices` | `AIServices` (Training and Prediction)<br/>`CustomVision.Prediction` (Prediction only)<br/>`CustomVision.Training` (Training only) |

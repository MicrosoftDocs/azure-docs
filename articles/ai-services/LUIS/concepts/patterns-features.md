...
:::image type="content" source="../media/concepts/patterns-features/chart.png" alt-text="A screenshot showing use of patterns" lightbox="../media/concepts/patterns-features/chart.png":::
...
:::image type="content" source="../media/concepts/patterns-features/ticket-booking-example.png" alt-text="A screenshot showing example entities for a ticket booking application." lightbox="../media/concepts/patterns-features/ticket-booking-example.png":::
...
:::image type="content" source="../media/concepts/patterns-features/ticket-booking-labeling.png" alt-text="A screenshot showing labeling for an example utterance." lightbox="../media/concepts/patterns-features/ticket-booking-labeling.png":::
...
:::image type="content" source="../media/concepts/patterns-features/pizza-example-machine-learning-entity.png" alt-text="A screenshot showing a machine learning entity with different subentities." lightbox="../media/concepts/patterns-features/pizza-example-machine-learning-entity.png":::
...
:::image type="content" source="../media/concepts/patterns-features/pizza-example-example-phrase-lists.png" alt-text="A screenshot showing a machine learning entity many phrase lists as features." lightbox="../media/concepts/patterns-features/pizza-example-example-phrase-lists.png":::

...
If your file upload fails, you can view the error message under “data files” in AI Studio. Hover your mouse over where it says “error” (under the status column) and an explanation of the failure will be displayed.

...
Azure OpenAI is a part of Azure AI services. For a list of all platform metrics collected for Azure AI services and Azure OpenAI, see [Azure AI services supported metrics](../../../azure-monitor/essentials/metrics-supported.md#microsoftcognitiveservicesaccounts).
...
For a list of the types of resource logs available for Azure OpenAI and other Azure AI services, see [Resource provider operations for Azure AI services](/azure/role-based-access-control/resource-provider-operations#microsoftcognitiveservices)

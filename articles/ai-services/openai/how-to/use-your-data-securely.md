...
<!-- 
hide this section, because this adhoc offline script is out-dated, and we have Studio in-product validation experience up-to-date, so no need for the script from the doc
> [!TIP]

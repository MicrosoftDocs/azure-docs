...
The settings to control how fields are processed when using Pinecone.
...
* Define the following environment variables: `AOAIEndpoint`, `ChatCompletionsDeploymentName`, `Environment` and `IndexName`.

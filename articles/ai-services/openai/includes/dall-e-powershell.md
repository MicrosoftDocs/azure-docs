...
- <a href="https://aka.ms/installpowershell" target="_blank">For this task, the latest version of PowerShell 7 is recommended because the examples use new features not available in Windows PowerShell 5.1.</a>

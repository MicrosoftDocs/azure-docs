...
TThis gives you the option to either deploy to a standalone web application, or a copilot in Copilot Studio if you're [using your own data](../concepts/use-your-data.md#deployment) on the model. 

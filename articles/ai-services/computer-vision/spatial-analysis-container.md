...
* Once you have your Azure subscription, <a href="https://portal.azure.com/#create/Microsoft.CognitiveServicesComputerVision"  title="Create a Azure AI Vision resource"  target="_blank">create a Azure AI Vision resource </a> for the Standard S1 tier in the Azure portal to get your key and endpoint. After it deploys, select **Go to resource**.
...
| APIKEY | your API Key| Collect this value from Azure portal from your Azure AI Vision resource. You can find it in the **Key and endpoint** section for your resource. |
| BILLING | your Endpoint URI| Collect this value from Azure portal from your Azure AI Vision resource. You can find it in the **Key and endpoint** section for your resource.|
...
The Spatial Analysis container sends billing information to Azure, using a Azure AI Vision resource on your Azure account. The use of Spatial Analysis in public preview is currently free. 

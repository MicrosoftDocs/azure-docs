...
Alternatively, you can pass in the image as a data array using a [BinaryData](https://learn.microsoft.com/java/api/com.azure.core.util.binarydata) object. For example, read from a local image file you want to analyze.

...
> [!NOTE]
> See [Install and run Document Intelligence containers](../ai-services/document-intelligence/containers/form-recognizer-container-install-run.md) for **Azure AI services Document Intelligence** container instructions and image locations.

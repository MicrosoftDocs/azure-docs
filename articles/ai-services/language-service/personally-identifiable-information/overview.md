...
description: An overview of the PII detection feature in Azure Azure AI services, which helps you extract entities and sensitive information (PII) in text.

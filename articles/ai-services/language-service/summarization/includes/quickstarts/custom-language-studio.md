...
If you need sample data, we've provided some for [document](https://github.com/Azure-Samples/cognitive-services-sample-data-files/tree/master/language-service/Custom%20summarization/sample-docs-and-labels) and [conversation]() scenarios for the purpose of this quickstart.

...
1. Optionally, replace the `"text"` field in the body with your own text you'd like to analyze.
    ...
    >
    > The default maximum length for text submissions is **1K** characters. The minimum length is **110** characters. Protected material detection only runs on the LLM completion.

...
Content Safety Studio not only contains out-of-the-box AI models but also includes Microsoft's built-in terms blocklists to flag profanities and stay up to date with new trends. You can also upload your own blocklists, including regex statements, to enhance the coverage of harmful content that's specific to your use case. 

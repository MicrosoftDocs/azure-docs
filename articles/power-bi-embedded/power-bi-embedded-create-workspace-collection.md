<properties
   pageTitle="Create a Power BI workspace collection | Microsoft Azure"
   description=""
...
2. Select **Active Directory** from the left pane.
     ...
     ![AD](media/power-bi-embedded-create-workspace-collection/power-bi-embedded-active-directory.png)

3. Select the directory that you want to use for creating the new application.

     ![choose  AD](media/power-bi-embedded-create-workspace-collection/power-bi-embedded-active-directory-name.png)

3. To view the applications in your directory, click on **Applications**.

     ![view applications](media/power-bi-embedded-create-workspace-collection/power-bi-embedded-active-directory-applications.png)
...
4. If you haven't created an application in that directory before you should see something similar to following image. Click on **ADD AN APPLICATION**
     ...
     ![add application](media/power-bi-embedded-create-workspace-collection/power-bi-embedded-active-directory-add-application.png)
...
5. Select the type of application you would like to create. For this tutorial, we will not use an application from the gallery.
     ...
     ![new application](media/power-bi-embedded-create-workspace-collection/power-bi-embedded-active-directory-new-application.png)

6.

     ![redirect uri](media/power-bi-embedded-create-workspace-collection/power-bi-embedded-active-directory-redirect.png)

7. 

     ![client  id](media/power-bi-embedded-create-workspace-collection/power-bi-embedded-active-directory-client-id.png)

8.
     ![permissions](media/power-bi-embedded-create-workspace-collection/power-bi-embedded-active-directory-permissions1.png)


9.
    ![permissions](media/power-bi-embedded-create-workspace-collection/power-bi-embedded-active-directory-permissions2.png)

10.
   ![permissions](media/power-bi-embedded-create-workspace-collection/power-bi-embedded-active-directory-permissions3.png)

...
See also [How Azure subscriptions are associated with Azure Active Directory](https://azure.microsoft.com/documentation/articles/active-directory-how-subscriptions-associated-directory/)



### **availability set**  
A collection of virtual machines that are managed together to provide application redundancy and reliability. The use of an [availability set](https://azure.microsoft.com/documentation/articles/virtual-machines-manage-availability/) ensures that during either a planned or unplanned maintenance event at least one virtual machine is available.



### **Azure classic deployment model**  
One of two [deployment models](https://azure.microsoft.com/documentation/articles/resource-manager-deployment-model/) used to deploy resources in Azure (the new model is Azure Resource Manager). Some Azure resources can be deployed in one model or the other, while others can be deployed in both models. Guidance for individual Azure resources detail which model(s) a resource can be deployed with.



### **Azure command line interface (CLI)**  
A [command-line interface](https://azure.microsoft.com/documentation/articles/xplat-cli-install/) that can be used to manage Azure services from Windows, OSX, and Linux PCs.



### **Azure PowerShell**  
A [command-line interface](https://azure.microsoft.com/documentation/articles/powershell-install-configure/) to manage Azure services via a command line from Windows PCs. Some services or service features can be managed only via PowerShell or the CLI. Guidance for each individual Azure resource details which model(s) a resource can be deployed with.   
See also [How to install and configure Azure PowerShell](https://azure.microsoft.com/documentation/articles/powershell-install-configure/)



### **Azure Resource Manager deployment model**  
One of two [deployment models](https://azure.microsoft.com/documentation/articles/resource-manager-deployment-model/) used to deploy resources in Microsoft Azure (the other is the classic deployment model). Some Azure resources can be deployed in one model or the other, while others can be deployed in both models. Guidance for individual Azure resources detail which model(s) a resource can be deployed with.
...
See also [Manage the availability of Windows virtual machines](https://azure.microsoft.com/documentation/articles/virtual-machines-manage-availability/)  
...
See also [Azure Regions](https://azure.microsoft.com/documentation/articles/best-practices-availability-paired-regions/)



### **geo-replication**  
The process of automatically replicating content such as blobs, tables, and queues within a regional pair.  
See also [Active Geo-Replication for Azure SQL Database](https://azure.microsoft.com/documentation/articles/sql-database-geo-replication-overview/)
...
See also [About images for virtual machines](https://azure.microsoft.com/documentation/articles/virtual-machines-images/)
...
See also [Azure subscription and service limits, quotas, and constraints](https://azure.microsoft.com/documentation/articles/azure-subscription-service-limits/)



### **load balancer**  
A resource that distributes incoming traffic among computers in a network. In Azure, a load balancer distributes traffic to virtual machines defined in a load-balancer set. A [load balancer](https://azure.microsoft.com/documentation/articles/load-balancer-overview/) can be internet-facing, or it can be internal.  
...
See also [Azure Resource Manager overview](https://azure.microsoft.com/documentation/articles/resource-group-overview/)
...
See also [Authoring Azure Resource Manager templates](https://azure.microsoft.com/documentation/articles/resource-group-authoring-templates/)
...
See also [RBAC: Built-in roles](https://azure.microsoft.com/documentation/articles/role-based-access-built-in-roles/)
...
See also [About Azure storage accounts](https://azure.microsoft.com/documentation/articles/storage-create-storage-account/)
...
See also [Using tags to organize your Azure resources](https://azure.microsoft.com/documentation/articles/resource-group-using-tags/)
...
See also [About virtual machine extensions and features](https://azure.microsoft.com/documentation/articles/virtual-machines-extensions-features/)



### **virtual network**  
A network that provides connectivity between your Azure resources that is isolated from all other Azure tenants. It can be connected to other Azure virtual networks through an [Azure VPN Gateway](https://azure.microsoft.com/documentation/articles/vpn-gateway-about-vpngateways/) and to your on-premises network using [multiple options](https://azure.microsoft.com/documentation/articles/vpn-gateway-cross-premises-options/). You can fully control the IP address blocks, DNS settings, security policies, and route tables within this network.  
See also [Virtual Network Overview](https://azure.microsoft.com/documentation/articles/virtual-networks-overview/)  

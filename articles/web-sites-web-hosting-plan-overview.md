...
- Individual sites and deployment slots can change their web hosting plan with zero downtime, providing that the target hosting plan exists in the same resource group as the original plan.
...
You can see all of your web hosting plans across all of your subscriptions by using the **Browse** button on the left menu bar and then clicking **Web hosting plans** in the top right of the activity pane that appears on the screen.

![][BrowseEverythingScreenshot]

You can see which web hosting plan each website is associated with by looking at the essentials section that appears at the top of your website blade.  Clicking on the plan will launch a blade that lets you manage your web hosting plan.  [Learn more about managing web hosting plans](http://go.microsoft.com/fwlink/?LinkID=394411).

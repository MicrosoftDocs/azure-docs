...
> [AZURE.NOTE] If you already have a database in the same location as the mobile app backend, you can 
...
The swagger endpoint is located at http://_yoursite_.azurewebsites.net/swagger.  You can access the Swagger 

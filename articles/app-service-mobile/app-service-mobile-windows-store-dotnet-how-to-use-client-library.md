<properties
	pageTitle="Working with the Azure App Service Mobile Apps .NET client library"
...
[AZURE.INCLUDE [app-service-mobile-selector-client-how-to-preview](../../includes/app-service-mobile-selector-client-how-to-preview.md)]

##Overview

This guide shows you how to perform common scenarios in Windows Runtime 8.1 universal app using a .NET client for Azure App Service Mobile Apps. The scenarios covered include querying for data, inserting, updating, and deleting data, authenticating users, and handling errors. If you are new to Azure App Service, you should consider first completing the [Azure Mobile Apps quickstart]() tutorial.

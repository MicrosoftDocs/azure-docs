---
title: Enable offline syncing with your iOS mobile apps | Microsoft Docs
description: Learn how to use Azure App Service mobile apps to cache and sync offline data in your iOS applications.
...
---
# Enable offline syncing with your iOS mobile apps
...
1. In `viewDidLoad`, in **ToDoTableViewController.swift**, comment out the two lines shown here, to stop syncing on app start. At the time of this writing, the Swift Todo app does not update the service when someone adds or completes an item. It updates the service only on app start.

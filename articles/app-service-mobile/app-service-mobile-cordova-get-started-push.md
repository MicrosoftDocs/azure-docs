...
* **On an Android emulator:**
  There are additional configuration steps required when running on an emulator.
    ...
    Make sure you are deploying to a virtual device that has Google APIs set as the target.  This can
    be checked as shown in the Android Virtual Device (AVD) manager.

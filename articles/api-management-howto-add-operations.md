<properties pageTitle="How to add operations to an API in Azure API Management" description="Learn how to add operations to an API in Azure API Management." services="api-management" documentationCenter="" authors="steved0x" manager="dwrede" editor=""/>

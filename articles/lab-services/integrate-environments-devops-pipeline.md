...
2. On the **Tasks** tab, add an Azure DevTest Labs Create Environment task. Configure the task as follows:
    1. For **Azure RM Subscription**, select a connection in the **Available Azure Service Connections** list, or create a more restricted permissions connection to your Azure subscription. For more information, see [Azure Resource Manager service endpoint](../devops/pipelines/library/service-endpoints.md).
...
1. To delete the VM, see [Azure DevTest Labs Tasks](https://marketplace.visualstudio.com/items?itemName=ms-azuredevtestlabs.tasks):
    1. For **Azure RM Subscription**, select a connection in the **Available Azure Service Connections** list, or create a more restricted permissions connection to your Azure subscription. For more information, see [Azure Resource Manager service endpoint](../vsts/build-release/concepts/library/service-endpoints.md).
...
- [VSTS Troubleshooting page](../vsts/build-release/actions/troubleshooting.md).

...
1. In the **New Lab** window, do the following actions:
    ...
    1. Select the **size of the virtual machines** you need for the class. For the list of sizes available, see the [VM Sizes](administrator-guide-2.md#vm-sizing).

---
title: Create Azure Lab Services schedules from Teams
description: Learn how to create Lab Services schedules from Teams. 
ms.topic: article
ms.date: 10/07/2020
---

# Create Lab Services schedules from Teams

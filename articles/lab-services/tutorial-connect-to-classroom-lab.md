...
3. On the **Virtual machine** page, do the following actions: 
...
2. Select **Access control (IAM)** from the menu, and select **+ Add** on the toolbar. 
	![Access control - Add user button](./media/tutorial-create-custom-lab/access-control-add.png)
3. On the **Add permissions** page, do the following actions:

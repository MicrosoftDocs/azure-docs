...
3. You see the **status of publishing** the template on page.  If you're using [lab plans](concept-lab-accounts-versus-lab-plans.md), publishing can take up to 20 minutes.

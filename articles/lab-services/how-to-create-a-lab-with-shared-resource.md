...
> [!NOTE]
> If using a version of Azure Lab Services prior to the [April 2022 Update](lab-services-whats-new.md), see [How to create a lab with a shared resource in Azure Lab Services when using lab accounts](how-to-create-a-lab-with-shared-resource-1.md).

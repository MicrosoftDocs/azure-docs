...
You'll need to estimate the number of virtual machines (VMs) and the [VM sizes](https://docs.microsoft.com/azure/lab-services/administrator-guide#vm-sizing) that your school needs.  Read the following blog post for guidance on how to structure your labs\images.  This blog post will also help you decide the number of VMs and the VM sizes that you'll need:
...
- [How to connect to a virtual network](https://docs.microsoft.com/azure/lab-services/how-to-connect-peer-virtual-network)
...
After you've finished planning, you're ready to set up your lab account.  These same steps are applicable for setting up a lab [Azure Lab Services with Teams](https://docs.microsoft.com/azure/lab-services/lab-services-within-teams-overview).

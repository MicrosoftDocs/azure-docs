...
- To link lab plans, your Azure account needs the following permissions. Learn how to [assign Azure Active Directory roles to users](../active-directory/roles/manage-roles-portal.md).

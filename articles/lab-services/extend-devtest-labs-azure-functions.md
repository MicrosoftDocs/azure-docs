...
When you select the **Select here to refresh** button, the page calls the first Azure function: **UpdateInternalSupportPage**. The function queries the lab for information and then rewrites the **Internal support** page with the new information.

...
Consider saving your template VM for future use.  To save the template VM, see [save an image to Azure Compute Gallery](./how-to-use-shared-image-gallery.md#save-an-image-to-the-shared-image-gallery).

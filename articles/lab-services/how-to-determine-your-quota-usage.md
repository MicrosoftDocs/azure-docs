--- 
title: How to discover your quota usage 
...
1. On the Subscription page, under Settings, select **Usage + quotas**.
   ...
   :::image type="content" source="media/how-to-determine-your-core-usage/subscription-overview.png" alt-text="Screenshot showing the Subscription overview left menu, with Usage + quotas highlighted."::: 
 
1. To view Usage + quotas information about Azure Lab Services, select **Azure Lab Services**.  

   :::image type="content" source="media/how-to-determine-your-core-usage/select-azure-lab-services.png" alt-text="Screenshot showing the Usage + quotas page, Compute drop-down, with Azure Lab Services highlighted.":::    
...
1. In this example, you can see the **Quota name**, the **Region**, the **Subscription** the quota is assigned to, and the **Current Usage**.
   ...
   :::image type="content" source="media/how-to-determine-your-core-usage/example-subscription.png" alt-text="Screenshot showing the Usage + quotas page, with column headings highlighted.":::    

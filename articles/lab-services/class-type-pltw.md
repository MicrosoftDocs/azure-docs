...
> [!NOTE]
> If your school needs to perform content filtering to comply with the [Children's Internet Protection Act (CIPA)](https://www.fcc.gov/consumers/guides/childrens-internet-protection-act), read guidance on [content filtering for Lab Services](./classroom-labs-fundamentals.md#content-filtering).

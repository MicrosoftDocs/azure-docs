...
Enable the settings described in the table below for the lab account. For more information about how to enable marketplace images, see the article on [how to specify Marketplace images available to lab creators](https://docs.microsoft.com/en-us/azure/lab-services/classroom-labs/specify-marketplace-images).
...
After your license server is set up, you'll need to [peer the VNet](https://docs.microsoft.com/en-us/azure/lab-services/classroom-labs/how-to-connect-peer-virtual-network) to your [lab account](https://docs.microsoft.com/en-us/azure/lab-services/classroom-labs/tutorial-setup-lab-account). The network peering must be done *before* creating the lab so that lab virtual machines can access the license server and the other way around.
...
- [Set a static private IP and MAC address](https://docs.microsoft.com/en-us/azure/lab-services/how-to-create-a-lab-with-shared-resource#static-private-ip-and-mac-address) for the Azure VM that hosts your licensing server.
...
Also, read the article on [how to set up a licensing server as a shared resource](https://docs.microsoft.com/en-us/azure/lab-services/how-to-create-a-lab-with-shared-resource) for more information.
...
1. In your physical environment, create the image for the class.
    ...
    b.	[Install and configure OneDrive](https://docs.microsoft.com/en-us/azure/lab-services/how-to-prepare-windows-template#install-and-configure-onedrive) (or other back-up options that your school may use).
    
    c.	[Install and configure Windows Updates](https://docs.microsoft.com/en-us/azure/lab-services/how-to-prepare-windows-template#install-and-configure-updates).

1.  Upload the custom image to the [Shared Image Gallery that is attached to your lab account](https://docs.microsoft.com/en-us/azure/lab-services/how-to-attach-detach-shared-image-gallery).
...
- [Connect from Windows](https://docs.microsoft.com/en-us/azure/lab-services/how-to-use-classroom-lab#connect-to-the-vm)
- [Connect from Mac](https://docs.microsoft.com/en-us/azure/lab-services/connect-virtual-machine-mac-remote-desktop)
- [Connect from Chromebook](https://docs.microsoft.com/en-us/azure/lab-services/connect-virtual-machine-chromebook-remote-desktop)

...
A lab plan administrator can configure this setting for the lab plan in which you create labs. For more information, see [Configure automatic shutdown of VMs for a lab plan](how-to-configure-autoshutdown-lab-plans.md). As a lab owner, you can override the setting when creating a lab or after the lab is created.

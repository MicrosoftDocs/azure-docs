...
You can also see the spending of the storage accounts in the lab, which sometimes can cost you more than you want. For example, if you are using a premium lab, all the custom images that you create are stored in a premium storage and if you forget to delete the old images, they lead to an unwanted cost.

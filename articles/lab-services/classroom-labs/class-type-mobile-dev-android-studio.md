---
title: Set up a lab to teach mobile application development using Android Studio | Microsoft Docs
...
ms.author: enewman
---
# Set up a lab to teach data mobile application development using Android Studio

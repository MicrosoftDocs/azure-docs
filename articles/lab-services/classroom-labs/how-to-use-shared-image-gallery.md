...
After a shared image gallery is attached, a teacher can save or upload an  image to the shared image gallery so that it can be reused by other teachers. For instructions, see [Shared Image Gallery overview](virtual-machines/windows/shared-images.md)

...
2. Confirm that you see the status of VMs and the number of hours the VMs have been running. The time you, as a lab owner, spend on a student VM doesn't count against the usage time shown in the last column. 

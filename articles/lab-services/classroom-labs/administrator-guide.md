...
| Medium (Nested virtualization) | <ul><li>4 Cores</li><li>16 GB RAM</li></ul> | ToDo | This size is best suited for relational databases, in-memory caching, and analytics.  This size also supports nested virtualization. |
| Large | <ul><li>8 Cores</li><li>32 GB RAM</li></ul>  | ToDo | This size is best suited for applications that need faster CPUs, better local disk performance, large databases, large memory caches.  This size also supports nested virtualization. |

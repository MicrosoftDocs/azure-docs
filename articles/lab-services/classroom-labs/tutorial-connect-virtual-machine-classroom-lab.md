...
2. Do one of the following steps: 
    ...
    3. For **Linux** virtual machines, get the SSH connection string from the SSH tab. Use the connection string from an SSH terminal to connect to the virtual machine. Install SSH terminal like Putty if you don't already have it to connect to Linux virtual machines.

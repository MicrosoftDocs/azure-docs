...
To [create a lab](tutorial-setup-lab.md), you need to [create a lab plan](./quick-create-resources.md) for your organization first. The lab plan serves as a collection of configurations and settings that apply to the labs created from it.

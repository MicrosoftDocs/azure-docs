...
> [!NOTE]
> If you're using a version of Azure Lab Services prior to the [April 2022 Update](lab-services-whats-new.md), see [Specify Marketplace images available to lab creators](specify-marketplace-images-1.md).

...
For more information, see [Set up a license server as a shared resource](https://docs.microsoft.com/azure/lab-services/how-to-create-a-lab-with-shared-resource).

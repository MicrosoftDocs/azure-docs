...
description: Learn how to use the SMicrosoft News Recommendation dataset in Azure Open Datasets.
...
The MIND dataset is free to download for research purposes under [Microsoft Research License Terms](https://github.com/msnews/MIND/blob/master/MSR%20License_Data.pdf). Please contact mind@microsoft.com if you have any questions about the dataset.
...
See the following examples of how to use the Microsoft News Recommender datset:

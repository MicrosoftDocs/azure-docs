...
View the confidential healthcare demo with confidential containers. Sample is available [here](../../architecture/example-scenario/confidential/healthcare-inference.md). 

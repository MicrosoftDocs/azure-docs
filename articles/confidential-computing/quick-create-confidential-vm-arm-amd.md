...
description: Learn how to quickly create and deploy an AMD-based DCasv5/ECasv5 -series Azure confidential virtual machine (confidential VM) using an ARM template.
author: RunCai

...
See our Azure Marketplace offer: [AutoPrivacy DataCleanRoom](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/acompany.autoprivacy-datacleanroom).


## AutoPrivacy DataCleanRoom

AutoPrivacy DataCleanRoom (DCR) is a ready-to-use solution for secure data collaboration. It enables multiple parties to combine and analyze data without exposing raw datasets. All computation runs inside Azure confidential computing environments (trusted execution environments, TEEs). DCR supports privacy-aligned workflows in Japan and connects to your existing data warehouses (DWHs), customer data platforms (CDPs), and data management platforms (DMPs).

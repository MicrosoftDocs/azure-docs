...
Fortanix Data Security Manager is a unified Key Management, HSM, Tokenization, and Secrets Management solution secured with Intel® SGX. Fortanix protects sensitive data across public, hybrid, multi-cloud, and private cloud environments with a single point of management and control. Additionally, Azure cluster of Fortanix Data Security Manager can be connected seamlessly to an on-premises cluster of Fortanix Data Security Manager or other 3rd party legacy HSMs as well as Azure managed HSM to achieve FIPS 140-2 Level 3 HSM security with software-defined simplicity

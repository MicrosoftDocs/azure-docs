...
- [Azure Backup](/azure/backup/backup-overview) support for Confidential VMs is currently in public preview [Documentation](https://learn.microsoft.com/en-us/azure/backup/confidential-vm-backup)

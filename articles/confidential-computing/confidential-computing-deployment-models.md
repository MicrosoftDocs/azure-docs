...
![Visual Representation of Trusted Computing Base](./media/confidential-computing-deployment-models/cloud-trust-boundary.png)
...
![Confidential VM Trust Boundary](./media/confidential-computing-deployment-models/cvm-architecture.png)
...
![VMs with App Enclaves Trust Boundary](./media/confidential-computing-deployment-models/enclaves-architecture.png)

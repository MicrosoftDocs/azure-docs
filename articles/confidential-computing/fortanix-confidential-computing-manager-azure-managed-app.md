---
title: Fortanix Confidential Computing Manager (CCM) on an Azure-managed application
description: Learn how to deploy Fortanix CCM in the Azure portal.
author: JBCook
...
# Confidential Computing Manager and Azure-managed applications
...
1. Go to the [Azure portal](https://portal.azure.com/).
   ...
   ![Azure Portal](media/azure-managed-app-files/azure-portal.png)

...
- Confidential VMs using Intel Trust Domain eXtensions (TDX). [DCesv5](/azure/virtual-machines/dcesv5-dcedsv5-series) and [ECesv5](/azure/virtual-machines/ecesv5-ecedsv5-series) enable lift-and-shift of existing workloads and helps protect data from the cloud operator with VM-level confidentiality.

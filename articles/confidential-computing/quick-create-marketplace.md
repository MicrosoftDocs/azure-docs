...
## Sign in to Azure
Here, you'll sign into the Azure portal. Then, you'll open up the Azure confidential computing (Virtual Machine) marketplace deployment. 

1. Sign in to the [Azure portal](https://portal.azure.com/).

1. In the search bar at the top of your screen, type **Azure confidential computing**.
...
1. Click the **Next: Virtual machine settings** button at the bottom of your screen.
    * Wait for the page to update. You **shouldn't** see a message that says *"Confidential Computing DCsv2-series VMs are available in a limited number of regions. If this message persists, return to the previous page and select an available region."* 
    
        If you see this message for longer than 10 seconds, go back and select an available DCsv2-Series region.
...
1. Fill in the following information:
    ...
    * **Select public inbound ports**: Choose **SSH(Linux)/RDP(Windows)**. In this quickstart, this step is necessary to connect to the VM and complete the Open Enclave SDK configuration. 

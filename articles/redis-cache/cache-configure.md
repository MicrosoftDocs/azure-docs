...
> [!IMPORTANT]
> - To use the Redis Console, your computer's proxy/firewall settings must allow outbound tcp traffic on port 10225. If this port is blocked, you receive errors similar to the following when you attempt to issue commands: `undefined` and `Connection closed: your next command will be run on a new connection.`

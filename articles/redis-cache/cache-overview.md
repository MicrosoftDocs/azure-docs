...
It is possible to scale your cache up to a higher tier after it has already been created. Scaling down to a lower tier is not supported. For step-by-step instructions, see [How to Scale Azure Redis Cache](cache-how-to-scale.md) and [How to automate a scaling operation](cache-how-to-scale.md#how-to-automate-a-scaling-operation).
...
| ------------------- | :-----: | :------: | :---: |
| **Service Level Agreement (SLA)** - For supported tiers, we guarantee at least 99.9% of the time that customers will have connectivity between the Cache endpoints and our Internet gateway. For more information, see [SLA details](https://azure.microsoft.com/support/legal/sla/cache/v1_0/).|✔|✔|-|

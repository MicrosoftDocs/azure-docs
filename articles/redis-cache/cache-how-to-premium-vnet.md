...
When your cache is part of a VNET, only clients in the VNET can access the cache, and as a result some cache management features don't work at this time.

...
Some Redis clients don't support SSL, and by default, the non-SSL port is disabled for Azure Redis Cache instances. At the time of this writing, the Jedis client doesn't support SSL. 

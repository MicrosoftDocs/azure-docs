...
* **Shard Elasticity**: This capability enables administrators to automate the vertical and horizontal scaling of their shards via PowerShell scripts and by means of the Azure Automation Service. Vertical Scaling is the scaling up and down. Horizontal Scaling is the process of scaling in and out. For details, see [Shard Elasticity](./sql-database-elastic-scale-elasticity.md).

...
- [Azure Migrate](/azure/cost-management-billing/migrate-services-overview) - Assess your current datacenter workload for insights about what's needed from an Azure replacement solution.

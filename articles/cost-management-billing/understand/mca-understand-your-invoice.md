...
:::image type="content" border="true" source="./media/mca-understand-your-invoice/invoicesummary.png" alt-text="Invoice summary section.":::
...
:::image type="content" border="true" source="./media/mca-understand-your-invoice/billingsummary.png" alt-text="Billing summary section.":::
...
:::image type="content" border="true" source="./media/mca-understand-your-invoice/invoicesectiondetails.png" alt-text="Details by invoice section.":::

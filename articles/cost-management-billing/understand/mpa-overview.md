...
:::image type="content" border="true" source="./media/mpa-overview/mpa-hierarchy.svg" alt-text="Diagram showing the Microsoft Partner Agreement billing hierarchy.":::
...
1. Search on **Cost Management + Billing**.
   ...
   :::image type="content" border="true" source="./media/mpa-overview/search-cmb.png" alt-text="Screenshot shows Azure portal search for Cost Management + Billing.":::

1. Select **Customers** from the left-hand side and then select a customer from the list.

   :::image type="content" border="true" source="./media/mpa-overview/mpa-customers.png" alt-text="Screenshot that shows selecting customer.":::

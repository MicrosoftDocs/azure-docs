...
For more information about your invoice, see [Understand your bill for Microsoft Azure](understand-individual-bill.md). For help with managing your costs, see [Prevent unexpected costs with Azure billing and cost management](../manage/getting-started.md).
...
1. Under **Email Invoice**, select **Update email invoice preference**.
    ...
    ![Screenshot that shows email invoice properties](./media/download-azure-invoice/billingprofile-email1.png)
...
- [Understand the charges on the invoice for your billing profile](mca-understand-your-bill.md)

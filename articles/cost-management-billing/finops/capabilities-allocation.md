...
- Once defined, it's time to implement your cost allocation strategy.
  ...
  - Consider [grouping related resources together with the “cm-resource-parent” tag](../costs/enable-preview-features-cost-management-labs.md#group-related-resources-in-the-resources-view) to view costs together in Cost analysis.

...
:::image type="content" border="true" source="./media/tutorial-export-acm-data/storage-account-page.png" alt-text="Storage account page showing example information and link to Open in Explorer.":::
...
:::image type="content" border="true" source="./media/tutorial-export-acm-data/storage-explorer.png" alt-text="Example information shown in Storage Explorer.":::

The file opens with the program or application set to open CSV file extensions. Here's an example in Excel.

:::image type="content" border="true" source="./media/tutorial-export-acm-data/example-export-data.png" alt-text="Example exported CSV data shown in Excel.":::

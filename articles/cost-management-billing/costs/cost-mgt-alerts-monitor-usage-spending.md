...
:::image type="content" border="true" source="./media/cost-mgt-alerts-monitor-usage-spending/budget-alerts-fullscreen.png" alt-text="Example image of alerts shown in Cost Management.":::
...
:::image type="content" border="true" source="./media/cost-mgt-alerts-monitor-usage-spending/dept-spending-selected-with-credits.png" alt-text="Example image showing spending for a department with alert details.":::
...
:::image type="content" border="true" source="./media/cost-mgt-alerts-monitor-usage-spending/Dismiss-reactivate-options.png" alt-text="Example image showing dismiss and reactivate options.":::

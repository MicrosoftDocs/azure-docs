...
| **BillingProfileId** | The ID of the billing profile that is billed for the subscription's charges. | Unique identifier of the EA enrollment, pay-as-you-go subscription or MCA billing profile.|
| **BillingProfileName** | Name of the EA enrollment, pay-as-you-go subscription or MCA billing profile. | Name of the EA enrollment, pay-as-you-go subscription or MCA billing profile.|

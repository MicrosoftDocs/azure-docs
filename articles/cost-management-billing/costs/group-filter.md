...
The following table lists some of the most common grouping and filtering options available in Cost analysis and and budgets. See the notes column to learn when to use them.
...
| **BillingProfileId** | The ID of the billing profile that is billed for the subscription's charges. | |
...
| **InvoiceSectionId**| Unique identifier for the MCA invoice section. ||
...
| **ProductOrderName** | Name of the purchased product plan. Use meterId and productOrderName to uniquely identify prices. | |
...
| **ReservationId**| In actual costs, use ReservationID to know which reservation the charge is for. | |
| **ReservationName**| In actual costs, use ReservationName to know which reservation the charge is for. | |

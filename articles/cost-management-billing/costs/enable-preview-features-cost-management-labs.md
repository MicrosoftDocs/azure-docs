...
- If you are encountering an issue or are seeing data that doesn't make sense, [create a support request](https://learn.microsoft.com/azure/azure-portal/supportability/how-to-create-azure-support-request). It's the fastest way to investigate and resolve data issues and major bugs.

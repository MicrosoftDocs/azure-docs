...
**Filters** - Service-level filtering is supported, so you can filter based on specific services like virtual machines or SQL databases. However, filtering on reservations isn’t supported.

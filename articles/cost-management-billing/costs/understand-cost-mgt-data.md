...
:::image type="content" border="true" source="./media/understand-cost-mgt-data/offer-and-offer-id.png" alt-text="Example of the Subscription Overview tab showing Offer and Offer ID.":::

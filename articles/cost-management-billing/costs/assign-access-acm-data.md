...
1. Under **Settings**, select the **Policies** menu item and then configure the setting.  
    :::image type="content" border="true" source="./media/assign-access-acm-data/azure-portal-policies-view-charges.png" alt-text="Billing scope policies showing view charges options.":::

...
:::image type="content" border="true" source="./media/tutorial-acm-opt-recommendations/advisor-recommendations.png" alt-text="Cost Management Advisor recommendations shown in the Azure portal.":::
...
:::image type="content" border="true" source="./media/tutorial-acm-opt-recommendations/recommendation-details.png" alt-text="Example of Recommendation details.":::

In the VM details, check the utilization of the virtual machine to confirm that it's a suitable resize candidate.

:::image type="content" border="true" source="./media/tutorial-acm-opt-recommendations/vm-details.png" alt-text="Example VM details showing historical utilization.":::
...
:::image type="content" border="true" source="./media/tutorial-acm-opt-recommendations/resize-vm.png" alt-text="Example recommendation with the option to resize the virtual machine.":::
...
:::image type="content" border="true" source="./media/tutorial-acm-opt-recommendations/choose-size.png" alt-text="Example list of available VM sizes where you can choose a size.":::
...
:::image type="content" border="true" source="./media/tutorial-acm-opt-recommendations/resized-notification.png" alt-text="Successful resized virtual machine notification.":::

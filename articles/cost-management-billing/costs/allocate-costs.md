...
:::image type="content" source="../media/rule-name.png" alt-text="Example showing creating a rule name" lightbox="../media/rule-name.png" :::
...
:::image type="content" source="../media/cost-distribution.png" alt-text="Example showing allocation percentage" lightbox="../media/cost-distribution.png" :::
...
:::image type="content" source="../media/cost-breakdown.png" alt-text="Example showing cost breakdown" lightbox="../media/cost-breakdown.png" :::
...
tagged-costs.png
:::image type="content" source="../media/tagged-costs.png" alt-text="Example showing costs for tagged items" lightbox="../media/tagged-costs.png" :::

...
Azure savings plan for compute is our most flexible savings plan. It lets you save up to 65 percent on pay-as-you-go prices and applies to a broad range of compute services across subscriptions, resource groups, management groups or entire Azure accounts. You can up-front or monthly for the same amount. You select an hourly compute commitment for a one-year or three-year term. The longer the commitment, the more savings you earn. Azure automatically applies the largest savings to your account. 

...
The billing profile, the billing account and the billing subscription scopes are the only applicable scopes that show charges for entitlement and purchase-based products like Azure Marketplace and reservation purchases.

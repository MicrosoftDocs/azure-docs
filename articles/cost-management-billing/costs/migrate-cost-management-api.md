...
:::image type="content" border="true" source="./media/migrate-cost-management-api/invoicesummary.png" alt-text="Example image showing the Invoice Number that corresponds to the InvoiceId.":::

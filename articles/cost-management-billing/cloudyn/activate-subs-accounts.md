...
2. You generate the Azure Enterprise Agreement key for use with Cloudyn. For instructions, see [Register an Azure Enterprise Agreement and view cost data](./quick-register-ea.md).

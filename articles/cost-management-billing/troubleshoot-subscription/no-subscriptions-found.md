...
* Make sure that the correct Azure directory is selected by selecting your account at the top right.
  ...
  :::image type="content" border="true" source="./media/no-subscriptions-found/directory-switch.png" alt-text="Select the directory at the top right of the Azure portal.":::

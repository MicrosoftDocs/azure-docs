...
:::image type="content" border="true" source="./media/troubleshoot-azure-sign-up/2.png" alt-text="Identity verification by phone.":::
...
:::image type="content" border="true" source="./media/troubleshoot-azure-sign-up/3.png" alt-text="Identity verification by card.":::

---
title: Microsoft Customer Agreement partner cost details file schema
...
# Microsoft Customer Agreement partner cost details file schema

This article applies to the Microsoft Customer Agreement partner cost details file schema.

The following information lists the cost details (formerly known as usage details) fields found in Microsoft Customer Agreement partner cost details files. A cost details file is a data file that contains all of the cost details for the Azure services that were used or purchased.
...
|9|partnerTenantId|Identifier for the partner's Azure Active Directory tenant.|
|10|partnerName|Name of the partner Azure Active Directory tenant.|
...
|13|customerTenantId|Identifier of the Azure Active Directory tenant of the customer's subscription.|
|14|customerName|Name of the Azure Active Directory tenant for the customer's subscription.|
...
|37|resourceGroupName|Name of the resource group the resource is in. Not all charges come from resources deployed to resource groups. Charges that don't have a resource group will be shown as null or empty, `Others`, or` Not applicable`.|
...
|60|partnerEarnedCreditApplied|Indicates whether the partner earned credit has been applied.|
...
|63|term|Displays the term for the validity of the offer. For example: In case of reserved instances, it displays 12 months as the Term. For one-time purchases or recurring purchases, Term is one month (SaaS, Marketplace Support). Not applicable for Azure consumption.|

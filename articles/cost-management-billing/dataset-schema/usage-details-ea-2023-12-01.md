---
title: Enterprise Agreement cost details file schema - version 2023-12-01 preview
description: Learn about the data fields available in the Enterprise Agreement cost details file for version 2023-12-01 preview.
author: bandersmsft
ms.reviewer: jojo
...
# Enterprise Agreement cost details file schema - version 2023-12-01 preview

> [!NOTE]
> This article applies to the Enterprise Agreement cost details file schema - version 2023-12-01 preview. For other versions, see the [dataset schema index](schema-index.md).

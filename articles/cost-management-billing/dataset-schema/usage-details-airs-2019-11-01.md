---
title: Azure Internal Registration System (AIRS) cost details file schema
description: Learn about the data fields available in the AIRS cost details file.
author: bandersmsft
ms.reviewer: jojo
...
|ResourceGroup|Name of the resource group the resource is in. Not all charges come from resources deployed to resource groups. Charges that don't have a resource group is shown as null or empty, `Others` or `Not applicable`.|

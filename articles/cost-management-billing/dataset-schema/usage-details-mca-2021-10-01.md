---
title: Microsoft Customer Agreement cost details file schema - version 2021-10-01
description: Learn about the data fields available in the Microsoft Customer Agreement cost details file for version 2021-10-01.
author: bandersmsft
ms.reviewer: jojo
...
# Microsoft Customer Agreement cost details file schema - version 2021-10-01

> [!NOTE]
> This article applies to the Microsoft Customer Agreement cost details file schema - version 2021-10-01. For other versions, see the [dataset schema index](schema-index.md).
...
|benefitId|MISSING.|
|benefitName|MISSING.|
|provider|Identifier for product category or Line of Business. For example, Azure, Microsoft 365, and AWS.|

---
title: Enterprise Agreement cost details file schema
...
# Enterprise Agreement cost details file schema

This article applies to the Enterprise Agreement cost details file schema. For other schema file versions, see the [dataset schema index](schema-index.md).

The following information lists the cost details (formerly known as usage details) fields found in Enterprise Agreement cost details files. The cost details file is a data file that contains all of the cost details for the Azure services that were used.

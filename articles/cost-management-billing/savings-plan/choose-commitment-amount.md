...
For example, you might incur ~$500 in hourly pay-as-you-go compute charges most of the time, but sometimes usage spikes to $700. Azure determines your total costs (hourly savings plan commitment + pay-as-you-go charges) if you had either $500/hour or $700/hour savings plans. Since the $700 usage is sporadic, the recommendation calculation is likely to determine that a $500 hourly commitment provides the greater total savings. As a result, it would be the recommended commitment.

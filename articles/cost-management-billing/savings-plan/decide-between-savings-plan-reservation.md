...
When you opt for reservations, you're making a commitment to use a specific type of instance or instance family, in a specific Azure cloud region, for a set period of time. For example, you might commit to using a D2v4 virtual machine in the Japan East region for one year. An Azure savings plan involves committing to a specific hourly expenditure on eligible services across all Azure regions for a certain period. For instance, you might commit to spending $5.00 per hour for three years. Reservations only apply to the specified service and region combination. Savings plan benefits are applicable to all usage from participating services across the globe, up to the hourly commitment.
...
Opt for savings plans when your workloads are dynamic or evolving, particularly if they use various instance families or services. Or when they're running in or shifting to different datacenter regions. Savings plans provide deep savings, flexible benefit application, and automatic optimization.
...
For general information about savings plans, see [What are Azure savings plans?](savings-plan-overview.md)

...
A savings plan discount only applies to resources associated with Enterprise, CSP and Microsoft Customer Agreements. Resources that run in a subscription with other offer types don't receive the discount.

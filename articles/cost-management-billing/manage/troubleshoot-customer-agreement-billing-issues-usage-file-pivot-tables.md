...
Only Billing profile owners, Contributors, Readers, or Invoice Managers have access to download usage files. For more information, see [Download usage for your Microsoft Customer Agreement](./download-azure-daily-usage.md). 
...
1. Download the usage file using the instructions at [Download usage in Azure portal](./download-azure-daily-usage.md).

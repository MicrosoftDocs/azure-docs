...
:::image type="content" border="true" source="./media/mca-enterprise-operations/mca-post-transition-hierarchy.png" alt-text="Image of ea-mca-post-transition-hierarchy.":::

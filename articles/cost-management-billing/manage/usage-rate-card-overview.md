---
title: Get Azure usage with Azure Billing APIs
...
* **Usage for different offer types** – Usage data is available for offer types like Pay-as-you-go, MSDN, Azure Prepayment (previously called monetary commitment), Azure Prepayment credit, and EA, except [CSP](/partner-center).

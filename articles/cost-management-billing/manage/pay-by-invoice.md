...
1. Sign in to the [Azure portal](https://portal.azure.com/). Select **Help + support** > **New support request**.
    ...
    ![Help and support link](./media/pay-by-invoice/help-and-support.png)
...
1. Search for **Cost Management + Billing**.
    ...
    ![Screenshot that shows search](./media/pay-by-invoice/search.png)
...
1. In the command bar, click the **Pay by invoice** button.
    ...
    ![Screenshot that shows pay by invoice button](./media/pay-by-invoice/pay-by-invoice.png)
...
1. In the menu on the left, click on **Billing profiles**.
    ...
    ![screenshot that shows billing profile in menu](./media/pay-by-invoice/billing-profile.png)

1. Select a billing profile.
1. In the menu on the left, select **Payment methods**.

   ![Screenshot that shows payment methods in menu](./media/pay-by-invoice/billing-profile-payment-methods.png)

1. Click the blue banner that says you're eligible to pay by check/wire transfer.

    ![Screenshot that shows blue banner to switch to check/wire](./media/pay-by-invoice/customer-led-switch-to-invoice.png)

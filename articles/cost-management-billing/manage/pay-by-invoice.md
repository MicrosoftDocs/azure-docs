...
If your request is approved, you can switch your billing profile to use wire transfer as its default payment method. For steps, see [Switch your billing profile to wire transfer](#switch-your-billing-profile-to-wire-transfer).

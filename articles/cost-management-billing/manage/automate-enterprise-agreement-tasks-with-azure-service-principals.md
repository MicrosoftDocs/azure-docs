...
- [Enterprise agreement roles](manage/understand-ea-roles)
- [Sign in with Azure PowerShell](/powershell/azure/authenticate-azureps?view=azps-5.5.0)
...
The parameter is a unique GUID that you need to provide. You can generate a GUID using the [New-Guid](/powershell/module/microsoft.powershell.utility/new-guid?view=powershell-7.1) PowerShell command.

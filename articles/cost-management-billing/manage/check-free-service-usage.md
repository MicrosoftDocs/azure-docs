...
1.  Search for **Subscriptions**.  
    :::image type="content" border="true" source="./media/check-free-service-usage/billing-search-subscriptions.png" alt-text="Screenshot that shows search in portal for subscriptions.":::

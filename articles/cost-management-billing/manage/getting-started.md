...
If you are using Azure through a Microsoft Customer Agreement (MCA), you can also [compare your invoice with the transactions](../../billing/billing-mca-understand-your-bill.md#view-transactions-for-an-invoice-in-the-azure-portal) to understand the charges on your invoice.

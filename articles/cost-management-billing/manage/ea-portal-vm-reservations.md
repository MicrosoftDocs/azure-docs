...
To purchase an Azure reserved virtual machine instance, an Enterprise administrator the _Reserved Instances_ purchase option. For more information, see [View and manage enrollment policies](direct-ea-administration.md#view-and-manage-enrollment-policies).

...
The Azure AD directory (tenant) of the Azure subscriptions that are transferred must match the Azure AD directory of the customer that was selected while establishing the CSP relationship.

...
- Consumption APIs are available to all customers, with a few exceptions. For more information, see [Cost Management automation overview](automation-overview.md). We recommend the provided APIs as the solution for the latest development scenarios.

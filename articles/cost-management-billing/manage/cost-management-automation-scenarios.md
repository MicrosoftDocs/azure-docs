...
- [Cost Allocation API](/rest/api/cost-management/costallocations) – Allocate costs across subscriptions, resource groups, or custom dimensions for internal chargeback and showback scenarios. See [Allocate costs](../costs/allocate-costs.md).
...
- [Benefit Utilization Summaries API](/rest/api/cost-management/generate-savings-plan-utilization-summary) – Retrieve summaries of Azure Savings Plan and Reservations utilization.
...
For a full list of Cost Management APIs and their capabilities, see the [Cost Management REST API reference](https://learn.microsoft.com/rest/api/cost-management/operation-groups?view=rest-cost-management-2025-03-01).

...
# Understand how the Azure virtual machine software reservation discount is applied
...
To buy the right virtual machine software reservation, you need to understand what software plan you run and the number of vCPUs on those VMs.
...
For example, if you buy a virtual machine software reservation for a VM with one vCPU, the ratio for that reservation is 1 and using a two vCPU machine, it will cover 50% of the cost if the ratio is 1:2 based on how the software plan was configured by the publisher.

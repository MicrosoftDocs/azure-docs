...
:::image type="content" border="true" source="media/understand-disk-reservations/reserved-disks-example-scenarios.png" alt-text="Example of underusing, overusing, and tiering capacity.":::

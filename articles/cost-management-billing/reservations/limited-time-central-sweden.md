...
Save up to 50 percent compared to pay-as-you-go pricing when you purchase one-year [Azure Reserved Virtual Machine Instances](https://learn.microsoft.com/en-us/azure/virtual-machines/prepay-reserved-vm-instances?toc=%2Fazure%2Fcost-management-billing%2Freservations%2Ftoc.json) for select Linux VMs in Sweden Central for a limited time. This offer is available between 1 September 2023 – 29 February 2024. 

## Purchasing the limited time offer

To take advantage of this limited-time offer, [purchase](https://portal.azure.com/#create/Microsoft.Reservations) a one-year term for Azure Reserved Virtual Machine Instances for qualified VM instances in the Sweden Central region. 

## Terms and conditions of Limited Time Offer

These Terms and Conditions (hereinafter referred to as "Terms") govern the Limited Time Offer ("Offer") provided by Microsoft to customers purchasing a 1-year Azure Reserved VM Instance in Sweden Central between September 1, 2023 – March 1, 2024, for any of the following VM series: Dadsv5, Dasv5, Ddsv5, Ddv5, Dsv5, Dv5, Eadsv5, Easv5, Ebdsv5, Ebsv5, Edsv5, Edv5, Esv5, and Ev5, providing them with a discount up to 50% compared to pay-as-you-go pricing. Actual savings may vary based on instance type or usage.

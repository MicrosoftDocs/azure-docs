...
For more information about Azure Blob storage and Azure Data Lake storage Gen 2 reserved capacity, see [Optimize costs for Blob storage with reserved capacity](../../storage/blobs/storage-blob-reserved-capacity.md). For more information about Azure Files reserved capacity, see [Optimize scosts for Azure Files with reserved capacity](../../storage/files/reserve-capacity.md).
...
- [Optimize costs for Azure Files with reserved capacity](../../storage/files/understand-storage-charges.md)

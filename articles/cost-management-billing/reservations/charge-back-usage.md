...
:::image type="content" border="true" source="./media/charge-back-usage/amortized-reservation-costs.png" lightbox="./media/charge-back-usage/amortized-reservation-costs.png" alt-text="Example showing reservation resource costs that you can use for chargeback.":::

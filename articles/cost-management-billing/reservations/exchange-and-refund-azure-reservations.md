...
> [!NOTE]
> The ability to exchange an Azure VM reservation will retire on **October 18, 2023**. Microsoft launched Azure savings plan for compute and it's designed to help you save broadly on predictable compute usage. The savings plan provides additional flexibility needed to accommodate changes such as VM series and regions. With savings plan providing the flexibility automatically, we’re adjusting our reservations exchange policy. You can continue to exchange VM sizes (with instance size flexibility) but we'll no longer support exchanging reservations for VMs, Dedicated Hosts, and App Service Plan series or regions. You may trade-in your Azure reservation for compute to purchase a savings plan. Or, you may continue to use and purchase reservations for those predictable, stable workloads where you know the specific configuration you’ll need and want additional savings. Learn more about [Azure savings plan for compute](../savings-plan/index.yml) and how it works with reservations.

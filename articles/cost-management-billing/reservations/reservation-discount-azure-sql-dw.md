...
When you apply a management group scope and you have multiple Synapse Dedicated Pools are running concurrently, your reservation applies to the usage based on first come, first served basis. Any usage beyond what's covered by your reservation is charged at pay-as-you-go rates.

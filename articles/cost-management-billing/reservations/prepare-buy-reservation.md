...
:::image type="content" border="true" source="./media/prepare-buy-reservation/cost-analysis.png" alt-text="Example showing reservation purchase costs in cost analysis.":::

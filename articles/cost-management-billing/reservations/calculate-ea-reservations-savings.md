...
9. In the first cell under TotalUsedSavings, create a formula that calculates (_UnitPrice – EffectivePrice) \* Quantity_.  
    > [!NOTE]
    >  If the unit price is $0.00, make sure that you don’t have any [Cost Allocation rules](../costs/allocate-costs.mds#current-limitations) enabled. If Cost allocation rules are enabled, the unit price isn't displayed.  

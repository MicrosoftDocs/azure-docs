<properties
	...
	description="Learn the basics about Web Apps in Azure App Service"
...
Web Apps in Azure App Service is part of a new paradigm which allows you to build a modern application using a suite of tightly integrated components. To make building applications easier, faster, and cheaper, Azure now gives you App Service. 
...
Web Apps has the tools you need to monitor and troubleshoot your content. Use Web Tests to externally monitor your apps and get an automated warning when something goes wrong. App Insights, New Relic, process explorer and a few other tools help keep you abreast of how well your app is doing. In case something goes wrong, you have access to runtime logs, diagnostics service, and remote debugging. And if all else fails, you can restore your previously backed-up content with the built-in backup and restore functionality. 
...
You can also geo-scale with Azure Traffic Manager. You can integrate with Azure CDN to make sure your content is closest to your customers. 

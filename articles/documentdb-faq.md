<properties title="DocumentDB fundamentals" pageTitle="DocumentDB fundamentals | Azure" description="Answers to frequently asked questions." metaKeywords="NoSQL, DocumentDB,  database, document-orientated database, JSON, faq"   solutions="" documentationCenter=""  authors="bradsev" manager="paulettm" editor="cgronlun" videoId="" scriptId="" />

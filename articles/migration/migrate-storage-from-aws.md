...
| [Migrate data from AWS FSx to Azure Files with Azure Storage Mover (Preview)](/azure/storage-mover/amazon-files-azure-files-migration).                | AWS FSx to Azure Files                   | Provides agentless cloud-to-cloud migration from AWS FSx for Windows File Server (SMB) to Azure Files (SMB).                                                                                                      |

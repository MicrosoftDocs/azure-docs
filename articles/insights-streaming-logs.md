<properties title="How use streaming logs" pageTitle="How use streaming logs" description="Learn how to use web site streaming logs and the console in Azure." authors="adamab"  />

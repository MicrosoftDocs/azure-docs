...
Reliable Stateful Service's default configuration can be modified by changing the "settings.xml" file generated in the Visual Studio package root under the "Config" folder for the specified service in question.
...
>>>>>>> 0efa211763c1695b5f7061ed3f7a05a435b1ce48
...
## Replicator Configuration
Replicator Configurations are used to configure the replicator that is responsible for making the Stateful Service state highly reliable by replicating and persisting the state locally.
### Section Name
ReplicatorConfig
### Configuration Names

...
- Create a [user flow](tutorial-create-user-flows.md), or a [custom policy](custom-policy-get-started.md).
- Then create an application in the Azure AD B2C, as describe in this section. 

...
> [!NOTE]
> HTML form elements will be removed due to security restrictions. If you use login.microsoftonline.com, use b2clogin.com if you want to use HTML form elements in your custom HTML content. See [Use b2clogin.com](b2clogin.md) for other benefits.

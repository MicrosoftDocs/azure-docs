...
#customer intent: As an Azure AD B2C administrator, I want to configure IDEMIA Mobile ID integration with Azure AD B2C. My goal is for users to authenticate using biometric authentication services and benefit from a trusted, government-issued digital ID for conducting transactions securely.
---

...
Applications need to be [registered](../active-directory/develop/azure-ad-dev-glossary.md#application-registration) in your tenant before they can receive [access tokens](../active-directory/develop/azure-ad-dev-glossary.md#access-token) from Azure Active Directory. App registration creates an [application id](../active-directory/develop/azure-ad-dev-glossary.md#application-id-client-id) for the app in your tenant. 
...
1. From the Azure AD B2C portal page, select **Sign-up or sign-in policies** and click **Add**.
    ...
    | **Application claims** | Display Name, Postal Code, User is new, User's Object ID | Select [claims](../active-directory/develop/azure-ad-dev-glossary.md#claim) you want to be included in the [access token](../active-directory/develop/azure-ad-dev-glossary.md#access-token). |
...
1. From the Azure AD B2C portal page, select **Profile editing policies** and click **Add**.
    ...
    | **Application claims** | Display Name, Postal Code, User's Object ID | Select [claims](../active-directory/develop/azure-ad-dev-glossary.md#claim) you want to be included in the [access token](../active-directory/develop/azure-ad-dev-glossary.md#access-token) after a successful profile edit. |
...
1. From the Azure AD B2C portal page, select **Password reset policies** and click **Add**.
    ...
    | **Application claims** | User's Object ID | Select [claims](../active-directory/develop/azure-ad-dev-glossary.md#claim) you want to be included in the [access token](../active-directory/develop/azure-ad-dev-glossary.md#access-token) after a successful password reset. |

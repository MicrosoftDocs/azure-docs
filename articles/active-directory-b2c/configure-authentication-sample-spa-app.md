...
In your own environment, if your SPA app uses MSAL.js 1.3 or earlier and the implicit grant flow, you need to enable the implicit grant flow in the app registration:

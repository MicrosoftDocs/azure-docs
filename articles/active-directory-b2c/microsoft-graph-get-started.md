...
* [Get an access token from Azure AD](https://docs.microsoft.com/en-us/graph/auth-v2-service#4-get-an-access-token)
* [Use the access token to call Microsoft Graph](https://docs.microsoft.com/en-us/graph/auth-v2-service#4-get-an-access-token)

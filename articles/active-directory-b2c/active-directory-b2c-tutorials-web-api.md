...
5. Select **Applications** and then select **Add**.
    ...
    | **App ID URI** | myAPISample | The URI uniquely identifies the API in the tenant. This allows you to register multiple APIs per tenant. [Scopes](../active-directory/develop/azure-ad-dev-glossary.md#scopes) govern access to the protected API resource and are defined per App ID URI. |
...
Your **My Sample Web App** is registered to call the protected **My Sample Web API**. A user [authenticates](../active-directory/develop/azure-ad-dev-glossary.md#authentication) with Azure AD B2C to use the web app. The web app obtains an [authorization grant](../active-directory/develop/azure-ad-dev-glossary.md#authorization-grant) from Azure AD B2C to access the protected web API.

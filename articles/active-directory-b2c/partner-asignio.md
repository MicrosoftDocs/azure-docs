...
#customer intent: I'm a developer integrating Asignio with Azure AD B2C for multifactor authentication. I need to configure an application with Asignio and set it up as an identity provider (IdP) in Azure AD B2C. My goal is to provide a passwordless, soft biometric, and multifactor authentication experience to customers.
---

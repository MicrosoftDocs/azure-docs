...
| BearerTokenTransmissionMethod | No | Specifies how the token is being sent. By default as query string. Set this to `AuthorizationHeader` to send the token as request header. |

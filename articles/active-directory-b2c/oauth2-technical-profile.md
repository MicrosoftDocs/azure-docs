...
|token_signing_algorithm| No | Specifies the signing algorithm used when generating a JWT Assertion in use with the `private_key_jwt` token_endpoint_auth_method. Possible values: `RS256` (default) or `RS512`.|

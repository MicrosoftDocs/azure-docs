...
> [!IMPORTANT]
> **Starting in the second half of 2021**, Google is [deprecating web-view sign-in support](https://developers.googleblog.com/2016/08/modernizing-oauth-interactions-in-native-apps.html). If you’re using Google federation for Azure AD B2B invitations or Azure AD B2C, or if you're using self-service sign-up with Gmail, you should [test your line-of-business native applications for compatibility](../active-directory/external-identities/google-federation.md#deprecation-of-embedded-web-view-sign-in-support).

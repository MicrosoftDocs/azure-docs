...
To enable custom attributes in your policy, provide **Application ID** and Application **Object ID** in the Microsoft Entra ID-Common technical profile metadata. The *Microsoft Entra ID-Common* technical profile is found in the base [Microsoft Entra ID](active-directory-technical-profile.md) technical profile, and provides support for Microsoft Entra user management. Other Microsoft Entra technical profiles include the Microsoft Entra ID-Common to use its configuration. Override the Microsoft Entra ID-Common technical profile in the extension file.

...
In the [Azure AD B2C Samples GitHub](https://github.com/azure-ad-b2c/samples) you will find samples for several enhanced Azure AD B2C Custom CIAM User Journeys such as local account policy enhancements, social account policy enhancements, MFA enhancements, user interface enhancements, generic enhancements, app migration, user migration, conditional access, web test and CI/CD.

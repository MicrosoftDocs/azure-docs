...
1. Create a new user flow policy by following the steps in [Tutorial: Create user flows in Microsoft Entra ID](tutorial-create-user-flows.md). While creating the user flow, select the **Recommended** version.

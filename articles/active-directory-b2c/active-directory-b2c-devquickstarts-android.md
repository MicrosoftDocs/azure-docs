...
If you choose to automatically discover the authorization and token endpoint URI's, you will need to fetch information from the discovery URI. The discovery URI can be generated by replacing the Tenant\_ID and the Policy\_Name in the following URL:

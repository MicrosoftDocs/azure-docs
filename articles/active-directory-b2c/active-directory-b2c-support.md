...
You can file support requests for Azure Active Directory (AD) B2C on the Azure Portal using the following steps:
...
5. In the **Basics** blade, use these details and click **Next**.
    ...
    - Choose **Active Directory** under **Service**.
...
6. In the **Problem** blade, use these details and click **Next**.
    ...
    - Provide the date & time (including time zone) of when the issue occurred in the **Time frame** field.
    - Upload all screenshots and files that you think would assist in resolving the issue under **File upload**.

    ![Support - Problem](./media/active-directory-b2c-support/support-problem.png)

7. In the **Contact** blade, add your contact information. Click **Create**. *Note: During preview, support for Azure AD B2C is only available in English.*

    ![Support - Contact](./media/active-directory-b2c-support/support-contact.png)

8. After submitting your support request, you can monitor it by clicking on **Help + support** on the Startboard and then **Manage support requests**.

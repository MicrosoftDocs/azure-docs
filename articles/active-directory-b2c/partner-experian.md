...
#customer intent: I'm an Azure AD B2C administrator, and I want to integrate Experian CrossCore with Azure AD B2C. This will help me verify user identification and perform risk analysis based on user attributes, during sign-up.
---

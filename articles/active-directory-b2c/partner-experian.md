...
- [An Azure AD B2C tenant](https://review.docs.microsoft.com/azure/active-directory-b2c/tutorial-create-tenant) that is linked to your Azure subscription.
...
![Screenshot for experian-architecture-diagram](.\media\experian-architecture-diagram.png)

...
In this tutorial, learn how to integrate Azure AD business-to-consumer (B2C) with Experian CrossCore, an ID verification service that verifies user identification. It does risk analysis based on information provided by the user during sign-up. CrossCore permits users to sign in, or not.

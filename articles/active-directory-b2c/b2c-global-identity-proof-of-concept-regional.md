...
#customer intent: As a developer implementing Azure Active Directory B2C, I want to configure region-based sign-up, sign-in, and password reset journeys. I need users to be directed to the correct region, and their data managed accordingly.
---

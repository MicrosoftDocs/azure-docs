...
This article shows you how to enable sign-in for users of a LinkedIn account through the use of [custom policies](active-directory-b2c-overview-custom.md).
...
1. Go to the [LinkedIn application management](https://www.linkedin.com/secure/developer?newapp=) website, sign in with your LinkedIn account credentials, and then click **Create Application**.
...
2. On the **Create a New Application** page, do the following:
    ...
    f. At the bottom the page, read and accept the terms of use, and then click **Submit**.
...
4. In the **Authorized Redirect URLs** box, paste **https://login.microsoftonline.com/te/{tenant}.onmicrosoft.com/oauth2/authresp**. Replace {*tenant*} with your tenant's name (for example, contosob2c.onmicrosoft.com). Make sure that you are using the HTTPS scheme. Click **Add**.

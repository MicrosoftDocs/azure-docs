...
## Create a LinkedIn account application
...
## Add your LinkedIn application key to Azure AD B2C
...
## [Optional] Register the LinkedIn account claims provider to Profile-Edit user journey
You may want to add the LinkedIn account identity provider also to your user `ProfileEdit` user journey. To make it available, we repeat the last two steps:

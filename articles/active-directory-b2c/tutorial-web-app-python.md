...
1. Under **Web**, select the **Add URI** link, enter `http://localhost:5000/getAToken`.
...
Now that you've obtained the sample, configure the application to use your Azure AD B2C tenant, application registration, and user flows.

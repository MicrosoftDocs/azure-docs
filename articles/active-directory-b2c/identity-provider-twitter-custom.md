---
title: Set up sign-in with a Twitter account by using custom policies
...
This article shows you how to enable sign-in for users of a Twitter account by using [custom policies](custom-policy-overview.md) in Azure Active Directory B2C (Azure AD B2C).

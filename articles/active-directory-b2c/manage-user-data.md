...
The following is an example of a data deletion flow:
...
4. The token is recieved by the application and the object id is used to delete the user data through a call to Azure AD Graph API. Azure AD Graph API deletes the user data and returns a status code of 200 OK.

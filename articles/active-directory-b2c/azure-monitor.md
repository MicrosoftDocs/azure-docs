...
* A [Log Analytics workspace](../azure-monitor/platform/resource-logs.md#collect-to-log-analytics-workspace) (to analyze data, create dashboards, and alert on specific events).

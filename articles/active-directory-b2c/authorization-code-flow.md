...
| Custom parameters | No| Custom parameters that can be used with [custom policies](custom-policy-overview.md). For example, [dynamic custom page content URI](customize-ui-with-html?pivots=b2c-custom-policy.md#configure-dynamic-custom-page-content-uri), or a [key-value claim resolvers](claim-resolver-overview.md#oauth2-key-value-parameters). |

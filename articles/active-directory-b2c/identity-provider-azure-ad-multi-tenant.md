...
1. Under the **TechnicalProfile** element, update the value for **DisplayName**, for example, `Multi-Tenant AAD login`. This value is displayed on the sign-in button on your sign-in page.

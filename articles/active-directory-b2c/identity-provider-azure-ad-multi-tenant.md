...
1. Under the **TechnicalProfile** element, update the value for **DisplayName**, for example, `My Azure AD/O365 Account`. This value is displayed on the sign-in button on your sign-in page.

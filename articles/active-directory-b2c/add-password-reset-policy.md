...
1. For **Application**, select the web application you wish to test, such as the the one named *webapp1* if you registered that earlier. The **Reply URL** should be `https://jwt.ms`.

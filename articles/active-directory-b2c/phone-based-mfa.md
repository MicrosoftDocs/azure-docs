...
1. In the `BuildingBlocks` section of the **relying party policy** file, add the following code. Make sure to include only the country/region codes relevant to your organization:

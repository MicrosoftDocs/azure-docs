...
## Current limitations
Azure AD B2C does not currently support the following types of apps, but they are on the roadmap. Additional limitations and restrictions related to Azure AD B2C are described in [Limitations and restrictions](active-directory-b2c-limitations.md).

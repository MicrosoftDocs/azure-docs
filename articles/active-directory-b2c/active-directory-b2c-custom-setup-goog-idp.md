...
Communication with Azure AD B2C occurs through an application that you register in your tenant. This section lists optional steps you can complete to create a test application if you haven't already done so.

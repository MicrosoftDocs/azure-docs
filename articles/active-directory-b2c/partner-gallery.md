...
| ![Screenshot of a Grit logo](./media/partner-gallery/grit-logo.png) | [Grit's app proxy](./partner-grit-app-proxy.md) enables to migrate a legacy application using header-based authentication to Azure Active Directory B2C with no application code change. |

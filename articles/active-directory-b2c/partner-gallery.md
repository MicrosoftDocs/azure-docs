...
| ISV partner | Description and integration walkthroughs |
|:-------------------------|:--------------|
| ![Screenshot of a grit IAM logo](./media/partner-gallery/grit-logo.png) | [Grit IAM B2B2C](./partner-grit.md) provides authentication, authorization, profile and role management, and delegated B2B SaaS application administration. Enables RBAC for end-users of Azure AD B2C|

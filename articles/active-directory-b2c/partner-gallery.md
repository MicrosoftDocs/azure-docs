...
| ![Screenshot of a Ping Identity logo](./media/partner-gallery/ping-logo.png) | [Ping Identity](./partner-ping-identity.md) enables secure hybrid access to on-premises legacy application, custom and non-standards-based applications across multiple clouds for Azure AD B2C users. |

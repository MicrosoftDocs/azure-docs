...
|:-------------------------|:--------------|
| ![Screenshot of a deduce logo](./media/partner-gallery/deduce-logo.png) | [Deduce](./partner-deduce.md) is an identity verification and proofing provider focused on stopping account takeover and registration fraud. It helps combat identity fraud and create a trusted user experience. |

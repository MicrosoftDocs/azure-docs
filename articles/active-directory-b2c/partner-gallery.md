...
| ![Screenshot of a Nevis logo.](./media/partner-gallery/nevis-logo.png) | [Nevis](./partner-nevis.md) provides a mobile-first, fully branded end-user experience with Nevis Access app to provide strong customer authentication and comply with Payment Services Directive 2 (PDS2) transaction requirements. |

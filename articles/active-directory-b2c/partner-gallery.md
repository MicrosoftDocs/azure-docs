...
|:-------------------------|:--------------|
| ![Screenshot of a deduce logo](./media/partner-gallery/deduce-logo.png) | [Deduce](./partner-deduce.md) is an identity verification and proofing solution provider that combat identity fraud and create a trusted user experience. |

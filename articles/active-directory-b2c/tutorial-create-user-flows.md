...
description: Learn how to create user flows to enable sign up, sign in, and other user experiences for your applications in Azure Active Directory B2C using the Azure portal.

...
Azure AD B2C currently only supports passing the access token of [OAuth 2.0](authorization-code-flow.md) identity providers, which include [Facebook](identity-provider-facebook.md) and [Google](active-directory-b2c-setup-goog-app.md). For all other identity providers, the claim is returned blank.

---
title: Tutorial to configure Azure Active Directory B2C with Ping
titleSuffix: Azure AD B2C
description: Learn how to integrate Azure AD B2C authentication with Ping proxy 
...
# Tutorial: Configure Ping with Azure Active Directory B2C for secure hybrid access

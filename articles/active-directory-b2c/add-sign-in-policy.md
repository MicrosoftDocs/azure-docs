...
* Password reset
* Users cannot sign up for an Azure AD B2C Local Account. To create an account, an administrator can use [Azure portal](manage-users-portal#create-a-consumer-user), or [MS Graph API](microsoft-graph-operations.md).

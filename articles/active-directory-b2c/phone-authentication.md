---
title: Phone authentication with custom policies
...
## Get the phone authentication starter pack

Start by updating the phone authentication custom policy files to work with your Azure AD B2C tenant.
...
1. Find the [phone authentication custom policy files][starter-pack-phone] in your local clone of the starter pack repo, or download them directly. The XML policy files are located in the `active-directory-b2c-custom-policy-starterpack/scenarios/phone-auth` directory.
...
## Upload the phone authentication policy files
...
## Test the phone authentication custom policy
...
1. Select **Run now**.
1. Sign up using an email address or a phone number.
1. Select **Run now** again.
1. Sign in with the same account to confirm that you have the correct configuration.
1. You can try other policies to change the phone number, reset email password or edit profile

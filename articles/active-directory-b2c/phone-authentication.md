...
To add your own consent information, customize the following sample and include it in the LocalizedResources for the ContentDefinition used by the self-asserted page with the display control ([the Phone-Email-Base.xml file in the phone sign-up & sign-in starter pack][starter-pack-phone]):

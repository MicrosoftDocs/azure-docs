...
Web API resources need to be registered in your tenant before they can accept and respond to [protected resource requests](../active-directory/develop/azure-ad-dev-glossary.md#resource-server) by [client applications](../active-directory/develop/azure-ad-dev-glossary.md#client-application) that present an [access token](../active-directory/develop/azure-ad-dev-glossary.md#access-token) from Azure Active Directory. Registration establishes the [application and service principal object](../active-directory/develop/azure-ad-dev-glossary.md#application-object) in your tenant. 
...
2. In the B2C settings, click **Applications** and then click **Add**.
    ...
    | **App ID URI** | demoapi | The URI uniquely identifies the API in the tenant. This allows you to register multiple APIs per tenant. [Scopes](../active-directory/develop/azure-ad-dev-glossary.md#scopes) govern access to the protected API resource and are defined per App ID URI. |
...
Your **My Sample WPF App** is registered to call the protected **My sample Node.js web API**. A user [authenticates](../active-directory/develop/azure-ad-dev-glossary.md#authentication) with Azure AD B2C to use the WPF deskop app app. The desktop app obtains an [authorization grant](../active-directory/develop/azure-ad-dev-glossary.md#authorization-grant) from Azure AD B2C to access the protected web API.

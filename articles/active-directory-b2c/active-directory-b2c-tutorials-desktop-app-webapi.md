---
title: Tutorial - Grant access to a Node.js web API resource from a desktop application | Microsoft Docs
...
# Tutorial: Grant access to a Node.js web API resource from a desktop application

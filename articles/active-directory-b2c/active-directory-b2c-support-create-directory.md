...
- If the Azure AD B2C tenant does show up in your list of tenants, but you receive an error message, delete the tenant just created and try again. For example, you might receive the following error message: "Could not complete the creation of the B2C tenant 'contosob2c'. Please visit this [link](http://go.microsoft.com/fwlink/?LinkID=624192&clcid=0x409) for more guidance."
- If none of the above resolutions work for you, contact Support. Learn more about [how to file support requests for Azure AD B2C](active-directory-b2c-support.md).

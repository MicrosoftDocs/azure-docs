...
> [!NOTE]
>
>Follow this link for more details about [Basic Authentication in ASP.NET Web API](https://docs.microsoft.com/en-us/aspnet/web-api/overview/security/basic-authentication)

## Prerequisites
Completed the [Integrate REST API claims exchanges in your Azure AD B2C user journey as validation on user input](active-directory-b2c-custom-rest-api-netfw.md) walk-through

## Step 1 Add authentication support

### Add application settings to project's web.config file
...
> [!NOTE]
>
>To generate coplex password, you can run following PowerShell
>```
...
### Add authentication middleware class

...
If you want to get the `family_name` and `given_name` calims from Azure AD, you can configure optional claims for your application through the UI or application manifest. For more infomation, see [How to provide optional claims to your Azure AD app](https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-optional-claims)

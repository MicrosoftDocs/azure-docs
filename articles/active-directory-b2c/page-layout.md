...
- You can now add the `data-preload="true"` attribute [in your HTML tags](https://docs.microsoft.com/en-us/azure/active-directory-b2c/customize-ui-with-html?pivots=b2c-user-flow#guidelines-for-using-custom-page-content)

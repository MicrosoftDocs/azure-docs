...
1. If you have access to multiple tenants, select the **Settings** icon in the top menu to switch to your Entra Workforce tenant from the **Directories + subscriptions** menu.  Currently, technical support cases cannot be created directly from an Azure Active Directory Business to Consumer (B2C) tenant.

...
> [!NOTE]
> This article applies to self-service password reset used in the context of a sign-in user flow. If you need fully customizable password reset user flows invoked from your app, see [this article](active-directory-b2c-reference-policies.md#create-a-password-reset-policy).
> 
> 

...
```java
String mDiscoveryURI = "https://<Tenant_name>.b2clogin.com/<Tenant_ID>/<Policy_Name>/v2.0/.well-known/openid-configuration";
```
...
```java
String mAuthEndpoint = "https://<Tenant_name>.b2clogin.com/<Tenant_ID>/<Policy_Name>/oauth2/v2.0/authorize";

String mTokenEndpoint = "https://<Tenant_name>.b2clogin.com/<Tenant_ID>/<Policy_Name>/oauth2/v2.0/token";
```

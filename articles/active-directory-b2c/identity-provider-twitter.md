...
1. Under **Authentication settings**, select **Edit**
    ...
    Use all lowercase letters when entering your tenant name and user flow id even if they are defined with uppercase letters in Azure AD B2C.

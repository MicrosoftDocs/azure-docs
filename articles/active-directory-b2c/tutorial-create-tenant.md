...
> [!NOTE]
> You can create and link up to 20 tenants per subscription. This threshold is enforced in both the Azure portal and the underlying tenant creation API to help prevent malicious parties from creating an unlimited number of tenants. If you need to create more than 20 tenants, please contact [Microsoft Support](support-options.md).

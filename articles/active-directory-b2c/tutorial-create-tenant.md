...
> [!NOTE]
> When an Azure AD B2C directory is created, an app called `b2c-extensions-app. Do not modify. Used by AADB2C for storing user data.` is automatically created inside the new directory. Learn more about [Azure AD B2C: Extensions app](https://docs.microsoft.com/en-us/azure/active-directory-b2c/extensions-app).

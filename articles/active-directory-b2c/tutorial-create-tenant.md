...
You can link multiple Azure AD B2C tenants to a single Azure subscription for billing purposes. You need to be signed in as a Global administrator to link multiple Azure AD B2C tenants to a single Azure subscription.

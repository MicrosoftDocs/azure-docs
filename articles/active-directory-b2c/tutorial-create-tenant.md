...
1. Add **Microsoft.AzureActiveDirectory** as a resource provider for the Azure subscription in use. See [steps to register a resource provider through the Azure portal](https://docs.microsoft.com/azure/azure-resource-manager/management/resource-providers-and-types?WT.mc_id=Portal-Microsoft_Azure_Support#register-resource-provider-1).

...
7. If your web application will also be calling some web API secured by Azure AD B2C, you'll want to create an **Application Secret** by going to the **Keys** blade and clicking the **Generate Key** button.

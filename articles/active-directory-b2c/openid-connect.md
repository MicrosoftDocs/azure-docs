...
| --------- | -------- | ----------- |
| {tenant} | Yes | Name of your Azure AD B2C tenant |
| {policy} | Yes | The user flow that used in the sign-in flow. For example, if user signed-in with the `b2c_1_sign_in` user flow, specify the `b2c_1_sign_in` in the sign-out request. |

...
| p | Required | Indicates the policy that will be executed.  It is the name of a policy that is created in your B2C directory, whose value should begin with "b2c_1_". Learn more about policies in [Extensible policy framework](active-directory-b2c-reference-policies.md). |

...
To verify the tokens from Azure AD B2C, we will need to generate the public key using the exponent(e) and modulus(n). You will have to determine how to do this in your respective language accordingly. The official docs on Public Key generation via RSA protocol can be found here : https://tools.ietf.org/html/rfc3447#section-3.1

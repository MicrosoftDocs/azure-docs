...
* JavaScript client-side code is supported (currently in preview) in customized pages. Due to security restrictions, both JavaScript code and HTML form elements are removed from custom pages if you use *login.microsoftonline.com*.

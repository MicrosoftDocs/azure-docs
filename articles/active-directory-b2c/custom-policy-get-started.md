...
1. In the left pane, inside **Manage** section, select **Expose an API**.
...
1. In the left pane, inside **Manage** section, select **Authentication**.
...
1. In the left pane, inside **Manage** section, select **API permissions**.

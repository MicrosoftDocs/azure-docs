...
|RefreshTokenUserJourneyId| No | The identifier of a user journey that should be executed during the [refresh an access token](uthorization-code-flow.md#4-refresh-the-token) POST request to the `/token` endpoint. |

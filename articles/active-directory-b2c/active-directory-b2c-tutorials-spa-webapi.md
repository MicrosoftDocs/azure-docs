---
title: Tutorial - Grant access to a ASP.NET Core web API resource from a single-page application | Microsoft Docs
...
# Tutorial: Grant access to a ASP.NET Core web API resource from a single-page application

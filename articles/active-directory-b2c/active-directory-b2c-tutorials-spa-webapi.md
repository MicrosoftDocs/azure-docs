...
2. In the B2C settings, click **Applications** and then click **Add**.
    ...
    | **App ID URI** | HelloCoreAPI | The URI uniquely identifies the API in the tenant. This allows you to register multiple APIs per tenant. [Scopes](../active-directory/develop/azure-ad-dev-glossary.md#scopes) govern access to the protected API resource and are defined per App ID URI. |
...
Your **My sample single page app** is registered to call the protected **Hello Core API**. A user [authenticates](../active-directory/develop/azure-ad-dev-glossary.md#authentication) with Azure AD B2C to use the WPF deskop app app. The desktop app obtains an [authorization grant](../active-directory/develop/azure-ad-dev-glossary.md#authorization-grant) from Azure AD B2C to access the protected web API.

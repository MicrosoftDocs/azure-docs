...
| Follow Security best practices | There are continuous and evolving threats and attacks, and like all owned resources, your Azure AD B2C deployment should follow best practices for security, including guidance on implementing WAFs (defense against DDOS, Bots etc.) and other defense in depth best guidance   [B2C Security Architecture](/azure/active-directory-b2c/security-architecture). |

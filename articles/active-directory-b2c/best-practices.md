...
|--|--|
| Create emergency access account | This emergency access account will help you gain access to your B2C tenant in case the only administrator is unreachable when the credential is needed. [Learn how to create an emergency access account](https://learn.microsoft.com/en-us/azure/active-directory-b2c/tenant-management-emergency-access-account#create-emergency-access-account)  |

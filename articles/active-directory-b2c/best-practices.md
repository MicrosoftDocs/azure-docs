...
<<<<<<< HEAD
<<<<<<< HEAD
| Move to monthly active users billing | Azure AD B2C has moved from monthly active authentications to monthly active users (MAU) billing. Most customers will find this model cost-effective. [Learn more about monthly active users billing](https://azure.microsoft.com/updates/
mau-billing/). |
=======
...
>>>>>>> e512e93fdc4feb22076923c11ddcbfb9df375d88
=======
...
>>>>>>> 97d2f55159d922f3e69c8566565d31ee5fd8882b

## Planning and design
Define your application and service architecture, inventory current systems, and plan your migration to Azure AD B2C.
## New Planning and designs in GIT for Today 
Define your application and service architecture, inventory current systems, and plan your migration to Azure AD B2C. Once you have done this, you are ready to proceed to the next stage.

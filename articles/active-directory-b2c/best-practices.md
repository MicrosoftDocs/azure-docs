...
| Use Identity Protection and Conditional Access | Use these capabilities for significantly greater control over risky authentications and access policies. Azure AD Premium P2 is required. [Learn more](conditional-access-overview.md). |

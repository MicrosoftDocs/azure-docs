---
title: Release notes for custom policies - Azure Active Directory B2C | Microsoft Docs
...
# Release notes for custom policies in Azure Active Directory B2C
...
- Set up active monitoring, and monitor the responsiveness of production environments. For more information about integrating with Application Insights, see [Azure Active Directory B2C: Collecting Logs](active-directory-b2c-troubleshoot-custom.md). 
...
| Pass IDP TOKEN to the application |  | X |  | For example, Facebook. |
...
| Application Insights UserJourney Logs |  | X |  |Used for troubleshooting  |
| Application Insights Event Logs |  | X |  | Used to track user behavior. |

...
description: Notes for developers on configuring and maintaining B2C with custom policies
...
Today, this feature set requires developers to configure the Identity Experience Framework (IEF) directly via XML file editing. This method of configuration is powerful and complex. Advanced identity developers using the IEF should plan to invest some time completing walk-throughs and reading reference documents. 
...
3. Service level agreements (SLAs) do not apply to the new features.
4. Support requests can be filed through the regular support channels.
...
*Set up active monitoring and monitor the responsiveness of their production environments

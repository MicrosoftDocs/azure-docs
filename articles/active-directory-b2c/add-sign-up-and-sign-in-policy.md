...
2. Follow the steps to [handle the flow for "Forgot your password?"](add-password-reset-policy.md#self-service-password-reset-recommended?pivots=b2c-user-flow) within the sign-up or sign-in policy.

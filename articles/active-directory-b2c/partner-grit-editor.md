...
#customer intent: I'm an Azure AD B2C administrator, and I want to use the Visual IEF Editor tool, so I can create, modify, and deploy Azure AD B2C policies easily, without writing code.
---

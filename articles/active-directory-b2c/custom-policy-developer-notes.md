...
[Implicit flow](implicit-flow-single-page-application.md) | GA | GA |  Allows users sign in to single-page applications. The app gets tokens directly without performing a back-end server credential exchange.|

...
| ---- | ----------------------- | --------- | ----- |
| InputClaim | Any string following dot notation. | string | The JsonPath of the JSON where the claim value is to be inserted. |
| InputParameter | Any string following dot notation. | string | The JsonPath of the JSON where the constant string value is to be inserted. |

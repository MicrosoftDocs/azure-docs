...
- InputValidation - This element allows you to perform boolean aggregations that are similar to and and or. Add an InputValidations element to the BuildingBlocks element if it doesn't exist with the following InputValidation element:

...
We currently support Facebook, Google+, LinkedIn, and Amazon out of the box. We will add support for other popular social identity providers based on customer demand.

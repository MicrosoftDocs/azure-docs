...
User accounts for applications must always be created through a sign-up policy or by using the Azure Graph API. User accounts created in the Azure portal are only used for administering the tenant.

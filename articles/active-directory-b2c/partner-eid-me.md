...
> [!NOTE]
> Find supported eID-Me identity claims lists on [OID repository](http://oid-info.com/get/1.3.6.1.4.1.50715) with OIDC identifiers on [well-known/openid-configuration](https://eid-me.bluink.ca/.well-known/openid-configuration).

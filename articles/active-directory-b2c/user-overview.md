...
- **Guest account** - A guest account can only be a Microsoft account or an Azure AD user that is used to share administration responsibilities such as [managing a tenant](tenant-management.md).

...
| p |Required |The user flow to execute. It's the name of a user flow that is created in your Azure AD B2C tenant. The user flow name value should begin with **b2c\_1\_**. For more information, see [Azure AD B2C built-in user flows](active-directory-b2c-reference-policies.md). |
...
| Parameter | Required? | Description |
| --- | --- | --- |
| p |Required |The user flow to use to sign the user out of your application. |

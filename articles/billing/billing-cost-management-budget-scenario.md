...
description: Learn how to use Azure automatation to shutdown VMs based on specific budget thresholds. 
services: 'billing'
documentationcenter: ''
author: Erikre
manager: dougeby

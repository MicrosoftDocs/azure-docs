...
[Guest users](../active-directory/b2b/add-users-administrator) that have been assigned the Co-administrator role might see some differences as compared to member users with the Co-administrator role. Consider the following scenario:

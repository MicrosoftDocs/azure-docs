...
Your Azure free account includes a limited quantity of free services for 12 months. With your account, you've the flexibility to use the free services in various configurations to meet your needs.
...
![Screenshot that shows free services page](./media/billing-create-free-services-included-free-account/billing-freeservices-grid.png)
...
## Next steps
- Learn how to [Check usage of free services included with your Azure free account](billing-check-free-service-usage.md).
- Learn how to [Avoid getting charged for your Azure free account](billing-avoid-charges-free-account.md).

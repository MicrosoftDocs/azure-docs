---
title: Understand Azure reserved instance usage for Pay-As-You-Go subscription | Microsoft Docs
description: Learn how to read your usage to understand how the Azure reserved instance for your Pay-As-You-Go subscription is applied.
services: 'billing'
documentationcenter: ''
...
Use the ReservationId from [Reservation page](https://portal.azure.com/?microsoft_azure_marketplace_ItemHideKey=Reservations&Microsoft_Azure_Reservations=true#blade/Microsoft_Azure_Reservations/ReservationsBrowseBlade) and the usage file from the [Azure Accounts portal](https://account.azure.com) to evaluate your reserved instance usage.

If you are an EA customer, see [Understand  Reserved Instance usage for your Enterprise enrollment.](billing-understand-reserved-instance-usage-ea.md).

This article assumes that the reserved instance is applied to a single subscription. If the reserved instance is applied to more than one subscription, your reserved instance benefit may span multiple usage csv files.

## Reserved instance application for virtual machines

For the following sections, assume that you are running a Standard_DS1_v2 Windows VM in the east US region and your reserved instance information looks like the following table:

...
>This article also assumes that Reserved Instance is applied to a single subscription. If the Reserved Instance is applied to more than one subscription, Reserved Instance benefit may span multiple usage csv files. 

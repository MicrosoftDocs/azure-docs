...
You can use any valid MPN ID except v-org MPN ID. Most partners choose to use the MPN ID for the geography where the customer is based or services are being delivered.

**Where can I find influenced revenue reporting for linked partner ID?**

You can find influenced revenue reporting at [My Insights dashboard](https://partner.microsoft.com/membership/reports/myinsights) by selecting Partner Admin Link as shown.

---
title: Understand Azure reservation usage for Enterprise | Microsoft Docs
...
### Azure reservation usage in csv
...
3. This is the Reservation Meter with $0 cost since cost of running VM is already paid by the reservation. 
...
### Azure reservation usage in usage summary page in EA portal

Reservation usage also shows up in usage summary section of EA portal:
...
1. You are not charged for hardware component of the VM as it is covered by reservation. 

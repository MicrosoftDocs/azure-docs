---
title: Azure Reserve VM Instances Windows software costs - Azure Billing | Microsoft Docs
description: Learn which Windows software meters are not included in Azure Reserved Instance costs.
services: 'billing'
documentationcenter: ''

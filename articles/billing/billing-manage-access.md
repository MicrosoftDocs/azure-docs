...
You can grant access for Azure billing information to members of your team by assigning one of the following user roles to your subscription: Account Administrator, Service Administrator, Co-administrator, Owner, Contributor, Reader, and Billing Reader. Those roles have access to billing information in the [Azure portal](https://portal.azure.com/). They can also use the [Billing APIs](billing-usage-rate-card-overview.md) to programmatically get invoices and usage details. For more information about who can grant roles, and which roles can do what, see [Roles in Azure RBAC](../role-based-access-control/built-in-roles.md).

If you are an Azure customer with an Enterprise Agreement (EA customer) and are the Enterprise Administrator, you can allow the Department Admins and Account Owners to view usage details and costs associated to the Departments and Accounts that they manage. 

## <a name="opt-in"></a> Allow users to download invoices

To allow a Service Administrator, Co-administrator, Owner, Contributor, Reader, and Billing Reader on the subscription to download invoices, the Account Administrator turns on the assess in the Azure portal. Invoices older than December 2016 are available only to the Account Administrator.
...
The Billing Reader feature is in preview, and does not yet support EA customers or non-global clouds.
...
1. In the **Select** textbox, type the a name or email for the user you add.
1. Select **Save**.
...
## Allow Department Admin and Account Owner to view charges for EA customers
...
1. After you select these policies, the Department Admin and/or Account Owners can:
   ...
   - Download reports from **Download Usage** in the the EA portal. The reports include the Usage Detail CSV and Marketplace Charges CSV for their specific department or account.

---
title: Running a Spring Boot Application the Azure App Service | Microsoft Docs
...
# Running a Spring Boot Application the Azure App Service
...
[SB01]: ./media/java-run-spring-boot-web-app-in-azure-app-service/SB01.png
[SB02]: ./media/java-run-spring-boot-web-app-in-azure-app-service/SB02.png

[AZ01]: ./media/java-run-spring-boot-web-app-in-azure-app-service/AZ01.png
[AZ02]: ./media/java-run-spring-boot-web-app-in-azure-app-service/AZ02.png
[AZ03]: ./media/java-run-spring-boot-web-app-in-azure-app-service/AZ03.png
[AZ04]: ./media/java-run-spring-boot-web-app-in-azure-app-service/AZ04.png
[AZ05]: ./media/java-run-spring-boot-web-app-in-azure-app-service/AZ05.png
[AZ06]: ./media/java-run-spring-boot-web-app-in-azure-app-service/AZ06.png
[AZ07]: ./media/java-run-spring-boot-web-app-in-azure-app-service/AZ07.png
[AZ08]: ./media/java-run-spring-boot-web-app-in-azure-app-service/AZ08.png
[AZ09]: ./media/java-run-spring-boot-web-app-in-azure-app-service/AZ09.png
[AZ10]: ./media/java-run-spring-boot-web-app-in-azure-app-service/AZ10.png

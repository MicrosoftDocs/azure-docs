...
In this topic, you will learn how to create an Azure Resource Manager template the deploys an Azure Redis Cache. You will learn how to define which resources are deployed and 

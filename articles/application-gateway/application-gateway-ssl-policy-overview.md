...
- If no TLS policy is defined, a [default TLS policy](application-gateway-ssl-policy-overview.md#default-tls-policy) is applied based on the API version in use.

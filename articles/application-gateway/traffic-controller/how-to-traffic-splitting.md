...
Congratulations, you have installed gateway controller, deployed a backend application and routed traffic to the application via the ingress on Traffic Controller.

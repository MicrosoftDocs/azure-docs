...
>[!NOTE]
> * The certificate added to the application gateway, as shown in the screenshot above, is tied to a specific secret version.
> * Renewing this certificate in KeyVault doesn't automatically make the application gateway listener select the updated certificate.

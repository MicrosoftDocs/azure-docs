...
|Issue|Details|
|--|--|
|Authentication certificate|Not supported. For more information, see [Overview of end to end SSL with Application Gateway](ssl-overview.md#end-to-end-ssl-with-the-v2-sku).|

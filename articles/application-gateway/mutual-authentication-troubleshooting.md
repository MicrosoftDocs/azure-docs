...
* **Unsupported certificate purpose:** The certificate was not provisioned to be a client certificate. Generate a new certificate with the correct object ID [1.3.6.1.5.5.7.3.2](https://oidref.com/1.3.6.1.5.5.7.3.2). 

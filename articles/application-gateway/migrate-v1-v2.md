...
> [!NOTE]
> NTLM and Kerberos passthrough authentication is supported by Application Gateway V2. For more details, refer [Dedicated backend connections](/configuration-http-settings.md?tabs=backendhttpsettings#host-name-override)

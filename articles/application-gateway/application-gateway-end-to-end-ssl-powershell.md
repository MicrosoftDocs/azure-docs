...
7. Upload the certificate to be used on the SSL-enabled back-end pool resources.
   ...
   If you are using the Application Gateway V2 SKU, then create a trusted root certificate. For more information, see [Overview of end to end SSL with Application Gateway](ssl-overview.md#end-to-end-ssl-with-the-v2-sku):

...
> [!NOTE]
> Application Gateway front-end supports dual-stack IP addresses (public preview). You can create up to four front-end IPs: Two IPv4 addresses (public and private) and two IPv6 addresses (public and private).

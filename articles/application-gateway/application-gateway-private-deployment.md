...
1. Private IP address only frontend IP configuration: No public IP address resource is required.
2. Elimination of inbound traffic from GatewayManager service tag via Network Security Groupl.

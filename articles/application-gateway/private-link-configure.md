...
The Private link configuration defines the infrastructure used by Application Gateway to enable connections from Private Endpoints. While creating private link configuration please ensure a listener is actively utilizing the respected frontend IP configuration and complete the following steps:

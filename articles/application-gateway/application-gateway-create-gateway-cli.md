...
Create the virtual network and subnet using [az network vnet create](/cli/azure/vnet#create). Create the public IP address using [az network public-ip create](/cli/azure/public-ip#create).
...
Create the network interfaces with [az network nic create](/cli/azure/network/nic#create). Create the virtual machines with [az vm create](/cli/azure/vm#az_vm_create).
...
Create an application gateway using [az network application-gateway create](/cli/azure/application-gateway#create). When you create an application gateway using the Azure CLI, you specify configuration information, such as capacity, sku, and HTTP settings. The private IP addresses of the network interfaces are added as servers in the backend pool of the application gateway.
...
When no longer needed, you can use the [az group delete](/cli/azure/group#delete) command to remove the resource group, application gateway, and all related resources.

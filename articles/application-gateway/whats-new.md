...
|---------|---------|---------|
| User-Defined Routes (UDR) on v2 (Preview) |User-defined routes now support a subset of scenarios on Application Gateway v2 SKUs. For more information on what is and isn't support, see [User-defined routes supported on the Application Gateway subnet](https://docs.microsoft.com/azure/application-gateway/configuration-overview#user-defined-routes-supported-on-the-application-gateway-subnet). |March 2020 |

...
|Autoscaling, zone redundancy, static VIP support preview     |With the v2 SKU, there are many improvements such as Autoscaling, improved performance, and more. See [What is Azure Application Gateway?](overview.md#v2-sku) for more information.|September 2018|

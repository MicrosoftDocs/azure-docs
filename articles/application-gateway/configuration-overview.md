...
1. Allow incoming traffic from a source IP/IP range and to either the entire Application Gateway subnet, or to the specific configured Private Frontend IP. The NSG does not work on a Public IP.

...
> [!IMPORTANT]
> For API versions >= 2023-02-01, the default TLS policy is set as AppGwSslPolicy20220101. Visit [TLS policy overview](./application-gateway-ssl-policy-overview.md#default-tls-policy) to know more.

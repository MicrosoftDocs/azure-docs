---
title: Configure Application Gateway with a frontend public IPv6 address using an ARM template (Preview)
titleSuffix: Azure Application Gateway
description: In this article, you learn how to use a Resource Manager template to create an Azure Application Gateway with a frontend IPv6 address.
...
# Configure Application Gateway with a frontend public IPv6 address using an ARM template (Preview)

In this article, you use an Azure Resource Manager template (ARM template) to create an Azure Application Gateway. Then you test the application gateway to make sure it works correctly.

[!INCLUDE [About Azure Resource Manager](../../includes/resource-manager-quickstart-introduction.md)]

You can also complete this task using the [Azure portal](ipv6-application-gateway-portal.md) or [Azure PowerShell](ipv6-application-gateway-powershell.md).
...
For the sake of simplicity, this template creates a simple setup with a public IPV6 frontend, a basic listener to host a single site on the application gateway, a basic request routing rule, and two virtual machines in the backend pool.

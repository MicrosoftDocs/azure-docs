...
Once the commands have been executed, you can navigate to your Application Gateway in the Azure portal and select the Listeners tab.  Select Add Lister (or select an existing) and specify the Protocol to HTTPS.

...
Learn how to diagnose and resolve session affinity issues with Application 
...
4.  settings and then click **Save**.
...
![troubleshoot-session-affinity-issues-10](.\media\how-to-troubleshoot-application-gateway-session-affinity-issues\troubleshoot-session-affinity-issues-10.png)

...
For information on WAF Monitoring, see [WAF v2 Metrics](../../web-application-firewall/ag/application-gateway-waf-metrics.md#application-gateway-waf-v2-metrics) 
...
For information on WAF Monitoring, see [WAF v1 Metrics](../../web-application-firewall/ag/application-gateway-waf-metrics.md#application-gateway-waf-v1-metrics)

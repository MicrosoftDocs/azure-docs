...
az role assignment create --assignee-object-id $principalId --scope $resourceGroupId --role "fbc52c3f-28ad-4303-a892-8a056630b8f1" --assignee-principal-type ServicePrincipal

# Delegate Network Contributor permission for join to association subnet
az role assignment create --assignee-object-id $principalId --scope $ALB_SUBNET_ID --role "4d97b98b-1d4f-4787-a291-c67834d212e7" --assignee-principal-type ServicePrincipal
```

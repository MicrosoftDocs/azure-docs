...
[ ![A diagram showing the Application Gateway for Containers returning a redirect URL to a client.](./media/how-to-url-rewrite-ingress-api/url-redirect.png) ](./media/how-to-url-rewrite-ingress-api/url-redirect.png#lightbox)

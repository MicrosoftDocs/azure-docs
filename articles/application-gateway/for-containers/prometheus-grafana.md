...
![A diagram of architecture grid.](./media/prometheus-grafana/agc-monitoring-flowchart.png)
...
1. Navigate to AKS Cluster in the Azure portal.
...
5. Search and Select Prometheus as a data source
6. Select desired metric. For example: alb_controller_total_unhealthy_endpoints that shows any unhealthy endpoints of your backend service. Choose app as alb-controller. Select name of the panel, type of visualization, and time range.
![A screenshot of Prometheus Logging Test.](./media/prometheus-grafana/prometheus-grafana-viewing.png)
7. Save and apply to add into your dashboard. 
...
4. Search and Select Azure Monitor as a data source
5. Query the example:
    ```kusto
    AGCAccessLogs
...
8. Save and apply to add into your dashboard. 

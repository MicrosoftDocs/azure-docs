...
The second one (rule 942130) is the interesting one. You can clearly see in the details that a pattern was matched (1=1), and the field is named **text1**. Follow the same previous steps to exclude the **Request Attribute Name** that **equals** **1=1**.
...
- Disable request body inspection
   ...
   By setting **Inspect request body** to off, the request bodies of all traffic will not be evaluated by your WAF. This may be useful if you know that the body of requests aren’t malicious to your application.

   By disabling this option, only the request body is not inspected. The headers and cookies remain inspected, unless individual one’s are excluded using the exclusion list functionality.

...
These metrics can be used to determine whether the observed slowdown is due the following causes:

- The client network
- Application Gateway performance
- The backend network and backend server TCP stack saturation

<properties pageTitle="How to edit the contents of a page in Azure API Management" description="How to edit the contents of a page in Azure API Management." services="api-management" documentationCenter="" authors="steved0x" manager="dwrede" editor=""/>

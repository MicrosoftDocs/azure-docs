...
Azure Managed Instance for Apache Cassandra supports all of the features in Apache Cassandra for replication and streaming data between data-centers. 

...
| You have existing Cassandra SMEs who can deploy, configure, and maintain your clusters.  | You want to lower your operational overhead for your Apache Cassandra node health, but still maintain control over platform level configurations such as replication and consistency. | You want to eliminate operational overhead by leveraging a fully managed Platform-as-as-service database in the cloud. |

<properties pageTitle="How to configure notifications and email templates in Azure API Management" description="Learn how to configure notifications and email templates in Azure API Management." services="api-management" documentationCenter="" authors="steved0x" manager="dwrede" editor=""/>

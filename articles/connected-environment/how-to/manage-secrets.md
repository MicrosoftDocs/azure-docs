---
title: "How to manage secrets when working with a connected environment | Microsoft Docs"
author: "ghogen"
ms.author: "ghogen"
ms.date: "03/30/2018"
ms.topic: "article"
...
manager: "douge"
---
# How to manage secrets when working with a connected environment
...
Visual Studio Connected Environment (VSCE) provides two recommended options for storing secrets: in the values.dev.yaml file, and inline directly in vsce.yaml. There's also a third option, which is not recommended.
 
## Method 1: values.dev.yaml
1. Open VS Code with your project that has a connected environment.
...
3. Update _vsce.yaml_ to tell VSCE to use your new _values.dev.yaml_ file. To do this, add this configuration under the configurations.develop.container section:
...
## Method 3: values.yaml

> [!WARNING]
> It is not recommended to put the secrets directly in the _values.yaml_ file, because _values.yaml_ should define production configuration, and for connected environment, you should specify development configuration. Also, any secrets put in values.yaml would be checked into source control, which is not a good practice for security.

1.	In _values.yaml_, define Kubernetes secret named *redis* that contains multiple key/value pairs 

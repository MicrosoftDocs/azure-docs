<properties
   pageTitle="Looker | Microsoft Azure"
   description="The solution that Looker provides with SQL Data Warehouse."
...
Business teams get access to the full dataset and can zoom in and out, fold and re-fold the data to answer a wide range of questions with unmatched flexibility. Looker is 100% web-based making it intuitive to use and easy to work together. Data teams curate a single, unified model of the data enabling business teams to spend less time arguing over the ‘right’ data and more time analyzing the results.

Looker can be deployed in the cloud or on-premises. With SQL Data Warehouse and Looker, data teams can set up a modern, powerful data infrastructure--from warehousing to analytics--in hours.
...
[Customer Case Study #1][website2]

[Customer Case Study #2][website3]
...
[logo]:./media/sql-data-warehouse-partners/looker_logo_med.png
...
<!-- External Links -->
[website]: http://www.looker.com/product
[website1]: http://www.looker.com/customers
[website2]: http://try.looker.com/resources/asana-disaggregating-data
[website3]: http://try.looker.com/resources/quirky-customer-lifetime-value

...
1. Go to the *src/cloud-to-device-console-app* folder. Here you see the *appsettings.json* file and a few other files:
    ...
    * **main.py** - The sample program code. This code:
      ...
      * Invokes direct methods that are exposed by the Azure Video Analyzer on IoT Edge module. You can use the module to analyze live video streams by invoking its [direct methods](../../../direct-methods.md).
      <!-- Above link to direct methods may have changed? -->

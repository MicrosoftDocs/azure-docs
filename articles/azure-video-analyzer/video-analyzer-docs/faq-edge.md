...
You can record the inference results along with the media in your video resource. You can use a [widget](add-valid-link.md)<!-- pointer to widget md --> to playback the video with an overlay of the inference data.

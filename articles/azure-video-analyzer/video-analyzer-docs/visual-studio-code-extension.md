...
If you have not set up the extension to connect to your edge device, follow the [Azure Video Analyzer Visual Studio Code extension](./edge/use-vscode-extension.md) quickstart.

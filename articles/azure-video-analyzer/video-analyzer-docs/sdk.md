...
The management SDKs allow you to interact with the resources exposed by Azure Resource Manager. You can create Video Analyzer account, generate provisioning tokes for edge modules, manage access policies for videos and more. The SDKs are built on top of an underlying [REST API].

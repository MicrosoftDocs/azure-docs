...
If you use a file sink node the video will be recorded to the local file system on the edge device. Else if you use an video sink node, the video will be recorded to an Video Analyzer video.

...
> :::image type="content" source="./media/event-based-video-recording-concept/motion-detection.png" alt-text="Event-based recording of live video when motion is detected.":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="./media/event-based-video-recording-concept/other-sources.png" alt-text="Event-based recording of live video when signaled by an external source.":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="./media/event-based-video-concept/external-inferencing-module.png" alt-text="Event-based recording of live video when signaled by an external inferencing module.":::

...
Video Analyzer supports RTSP streams where media and control traffic are [interleaved into a single TCP connection](https://www.informit.com/articles/article.aspx?p=169578&seqNum=3) (UDP is not supported).

...
**appsettings.json**: This file contains the settings needed to run the program that is used in the quickstarts and tutorials. This file will look like this:
   ```
   {
...
**.env**: This file contains properties that Visual Studio Code uses to deploy modules to an edge device. This file will look like this:  
    ```
...
1. Navigate to your **Resource Group** and the **Subscription ID** will be listed at the top of your screen under **Essentials**

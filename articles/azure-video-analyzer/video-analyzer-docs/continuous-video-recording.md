...
This property applies to both the Video Analyzer edge module and the Video Analyzer service. See the [Viewing videos](viewing-videos-how-to.md) article for the effect that `segmentLength` has on playback.

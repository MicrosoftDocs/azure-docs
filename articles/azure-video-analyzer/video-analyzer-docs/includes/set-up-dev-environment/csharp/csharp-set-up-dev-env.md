...
### Get the sample code
1. Clone the [AVA C# samples repository](https://github.com/Azure-Samples/azure-video-analyzer-iot-edge-csharp). <!--TODO: replace this  https://github.com/Azure-Samples/azure-video-analyzer-iot-edge-csharp -->.

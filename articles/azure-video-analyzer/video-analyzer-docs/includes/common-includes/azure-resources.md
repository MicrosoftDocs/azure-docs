...
> [!TIP]
> If you run into issues with Azure resources that get created, please use the manual steps in this [quickstart](../../get-started-detect-motion-emit-events-portal.md).

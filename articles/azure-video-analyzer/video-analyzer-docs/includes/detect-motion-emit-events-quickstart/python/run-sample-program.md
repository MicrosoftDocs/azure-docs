...
1. The *operations.json* file starts off with calls to `pipelineTopologyList` and `livePipelineList`. If you cleaned up resources after you finished previous quickstarts, then this process will return empty lists.

...
1. Go to the *src/cloud-to-device-console-app* folder. Here you see the *appsettings.json* file and a few other files:
    ...
    * ***Program.cs*** - The sample program code. This code:
      ...
      * Invokes direct methods that are exposed by the Video Analyzer edge module. You can use the module to analyze live video streams by invoking its [direct methods](../../../direct-methods.md).

...
* **Program.cs**: The sample program code, which:
    ...
    * Invokes direct methods exposed by the Video Analyzer on IoT Edge module. <!--REDIRECTYou can use the module to analyze live video streams by invoking its [direct methods](direct-methods.md).-->

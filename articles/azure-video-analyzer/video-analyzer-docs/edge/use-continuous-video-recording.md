...
* **Program.cs**: The sample program code, which:
    * Loads the app settings.
    <!--REDIRECT* Invokes direct methods exposed by Video Analyzer edge module. You can use the module to analyze live video streams by invoking its [direct methods](direct-methods.md).-->

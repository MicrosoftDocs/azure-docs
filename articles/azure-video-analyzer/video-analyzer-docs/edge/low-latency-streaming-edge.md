---
title: Low latency video streaming from edge tutorial - Azure Video Analyzer
description: In this tutorial, you'll learn how to use Azure Video Analyzer to stream live video with low latency from the edge.
ms.topic: tutorial
ms.date: 06/01/2021

---
# Tutorial: Low latency video streaming from the edge

In this tutorial, you'll learn how to use Azure Video Analyzer to view the live video feed from any camera connected to the edge device on a remote browser with an end-to-end latency of the order of 2 seconds.

> [!NOTE]
> Overall latency is subject to factors such as camera settings, bandwidth for the connections between the edge device, the cloud service, and the browser, etc.
...
* [Connecting cameras to cloud](../cloud/connect-cameras-to-cloud.md)
* <!-- TODO: add relevant quickstart? -->

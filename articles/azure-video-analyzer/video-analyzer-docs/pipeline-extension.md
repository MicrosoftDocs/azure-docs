...
> :::image type="content" source="./media/quickstarts/ai-inference-results.png" alt-text="Inferencing model":::
...
For advanced users, you can check out some of our [Jupyter notebook](https://github.com/Azure/live-video-analytics/blob/master/utilities/video-analysis/notebooks/readme.md) samples for Azure Video Analyzer. These notebooks will provide you with step-by-step instructions for the pipeline extensions on:

...
* To access the diagnostic logs, navigate to storage explorer then expand your storage account & you will see Blob containers. The 'insights-logs-category' container will have logs in a json file format. 

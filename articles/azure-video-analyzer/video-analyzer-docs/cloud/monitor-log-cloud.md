...
The Video Analyzer service generates metrics for [pipelines](../pipeline.md). You can access the metrics using the Azure portal, navigate to the Monitoring section from the management pane of your Video Analyzer account

...
In this article, you'll learn about events and logs generated by Azure Video Analyzer service. You'll also learn how to consume the logs that the service generates & how to monitor the service events.

## Taxonomy of events

Below diagram represents common taxonomy used for the events or telemetry data emitted by Video Analyzer service:
![Diagram that shows the taxonomy of events.](./media/event-taxonomy-cloud.png)

## Event schema

 Events generated by Video Analyzer service consists of system properties, application properties, and a body.
...
You can save the events & metrics generated by the Video Analyzer service to your storage account, and consume them using Azure monitor.

**Metrics**

The Video Analyzer service generates metrics for [pipelines](../pipeline.md). You can access these metrics using the Azure portal, navigate to the Monitoring section from the management pane of your Video Analyzer account
...
**Activity log** is also generated automatically for the pipeline operations and can be accessed by navigating to 'Activity log' section of  Video Analyzer account on Azure portal.
...
[Troubleshoot Azure Video Analyzer service]<!-- TODO : link to update above --> 

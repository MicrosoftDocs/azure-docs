...
-	**Clean up resources**: In the terminal window, pressing enter will deactivate the pipeline and cleanup the pipeline, topology deployed earlier. Program calls CleanUpResourcesAsync() method to cleanup the deployed resources.

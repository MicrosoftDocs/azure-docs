...
- [Detect motion, record video clips to Azure Media Services]()<!-- TODO: Add links to quickstarts -->
- [Detect motion, record video clips to edge devices]() <!-- TODO: Add links to quickstarts -->

...
> [!NOTE]
> If you would like to work with bicep format, inspect the [bicep file](ahttps://github.com/Azure-Samples/media-services-video-indexer/blob/master/ARM-Samples/Create-Account/avam.template.bicep) on this repo.
...
* [Azure Resource Manager documentation](../../azure-resource-manager.md)
* [Deploy Resources with ARM Template](../../azure/azure-resource-manager/templates/deploy-powershell.md)

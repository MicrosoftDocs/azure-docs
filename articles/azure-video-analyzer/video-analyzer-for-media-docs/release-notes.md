...
Video Analyzer for Media Closed captions file can now include the detected acoustic events. It can be downloaded from the Video Analyzer for Media portal and available as an artifact in the GetArtifact API.

...
You can now turn on a bounding box for deteted faces during indexing. The face bounding box feature is available when indexing your file by choosing the standard, basic, or **advanced** indexing presets.

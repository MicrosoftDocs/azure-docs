...
It means transcription, translation, and search features are also supported for these languagesin in Video Analyzer for Media web applications and widgets.

...
In the next tutorial, [Service-side authorization of Mobile Services users](/en-us/documentation/articles/mobile-services-javascript-backend-service-side-authorization/), you will take the user ID value provided by Mobile Services based on an authenticated user and use it to filter the data returned by Mobile Services. 

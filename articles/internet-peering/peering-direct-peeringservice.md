...
Select the connection you would like to enable for Peering Service. For this example we will use the only connection available.
...
Now save the changes made to the Direct Peering using command below.

...
1. Request Exchange Peering for a peering location using the instructions in [Create and modify an Exchange Peering using PowerShell](howto-exchangepeering-arm.md) article for more details.
...
1. Follow the instructions in [Convert a legacy Exchange Peering to Azure resource](howto-legacyexchange-arm.md)

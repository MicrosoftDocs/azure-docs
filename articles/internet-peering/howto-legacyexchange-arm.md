...
If you prefer, you can complete this guide using the [Azure portal](howto-legacyexchange-arm-portal.md).
...
* [Create or modify an Exchange Peering using PowerShell](howto-exchangepeering-arm.md)

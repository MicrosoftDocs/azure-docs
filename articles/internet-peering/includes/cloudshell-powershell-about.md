...
| Click the **Cloud Shell** button on the menu in the upper right of the Azure portal. | [![Cloud Shell in the Azure portal](../media/cloud-shell-menu.png)](https://portal.azure.com) |
|  |  |
...
If you are using PowerShell on macOS then please follow the steps in [Installing PowerShell Core on macOS.](https://docs.microsoft.com/powershell/scripting/install/installing-powershell-core-on-macos?view=powershell-6)
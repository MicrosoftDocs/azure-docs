<properties 
   pageTitle="Deployment: Deploy Protection for SQL Server with Azure Site Recovery" 
   description="Azure Site Recovery coordinates the replication, failover and recovery of SQL Server" 
   services="site-recovery" 
   documentationCenter="e" 
   authors="raynew" 
   manager="jwhit" 
   editor=""/>
...
# Deployment: Deploy Protection for SQL Server with Azure Site Recovery 

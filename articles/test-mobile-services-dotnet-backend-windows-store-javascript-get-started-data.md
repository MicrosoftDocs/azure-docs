...
<tags ms.tgt_pltfrm="cache-redis" ms.service="cloud-services" ms.service="mobile-services" ms.service="web-sites" ms.topic="article" ms.workload="integration" ms.devlang="multiple" ms.date="06/20/2014" ms.author="mollybos@microsoft.com" />

...
The `ConversionErrorCode` type enumerates these common modes of model conversion failure. These enumerations are useful for error message localization, failure recovery, and tips to the user on how to correct the error.

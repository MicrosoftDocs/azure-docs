...
1. Review the following considerations when you use the **Recurrence** trigger:
   ...
   * For Standard logic app workflows, if you stop the logic app resource (website), and enough time passes to skip one or more recurrence intervals without the website processing any data, restarting the logic app resource within a span of 7 days, causes the **Recurrence** trigger to immediately fire and resume as expected.

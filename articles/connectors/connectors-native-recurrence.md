...
description: Create workflows that run repeating scheduled tasks with the recurrence trigger in logic apps
services: logic-apps
documentationcenter: ''
author: jeffhollan
manager: anneta
...
That way, your logic app runs and repeats after each time interval passes. 

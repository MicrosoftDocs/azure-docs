...
1. For more scheduling options, open the **Add new parameter** list.

   ![More options](./media/connectors-native-recurrence/recurrence-trigger-more-options.png)

1. Now you can select these options, which appear on the trigger after selection:

   * **Time zone**: Specify the time zone that you want to use.

   * **Start time**: Specify a start date and time for firing the trigger.

   * **On these days**: If you select "Week", you can select this option for specifying days of the week.

   * **At these hours** and **At these minutes**: If you select "Day" or "Week" for the frequency, you can select these options for specifying recurrence times.
...
| Name | Required | JSON name | Type | Description |
|----- | -------- | --------- | ---- | ----------- |

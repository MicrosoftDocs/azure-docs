...
| Run at 8:30 AM every day (with start date and time) | 1 | Day | *startDate*T08:30:00Z | {unavailable} | {none} | {none} | This schedule runs at 8:30 AM every day, based on the specified start time. | 
...
| Run every 15 minutes (no start date and time) | 15 | Minute | {none} | {unavailable} | {none} | {none} | This schedule starts running immediately and calculates future recurrences based on the last run time. | 
| Run every 15 minutes at the 15-minute mark (no start date and time) | 1 | Hour | {none} | {unavailable} | {none} | 0, 15, 30, 45 | This schedule doesn't start running until the next specified 15-minute mark. | 
| Run every 15 minutes (with start date and time) | 15 | Minute | *startDate*T*startTime*Z | {unavailable} | {none} | {none} | This schedule doesn't start running until the specified start time and calculates future recurrences based on the last run time. | 
...
| Run every 15 minutes past the hour, every hour (with start date and time) | 1 | Hour | *startDate*T00:15:00Z | {unavailable} | {none} | {none} | This schedule runs at 00:15 AM, 1:15 AM, 2:15 AM, and so on. | 
...
| Run every hour, on the hour (no start date and time) | 1 | Hour | {none} | {unavailable} | {none} | 0 | This schedule starts running at the next hour with a "00" minute mark. <p>If the frequency is "Week" or "Month", this schedule respectively runs only one day per week or one day per month. | 
| Run every hour, on the hour (with start date and time) | 1 | Hour | *startDate*Thh:00:00 | {unavailable} | {none} | {none} | This schedule starts running at the specified start date and time. Future workloads run every hour at the "00" minute mark. <p>If the frequency is "Week" or "Month", this schedule respectively runs only one day per week or one day per month. | 
...
| Run every Saturday at 5 PM (with start date and time) | 1 | Week | *startDate*T17:00:00Z | "Saturday" | {none} | {none} | This schedule doesn't start *any sooner* than the specified start date and time, in this case, September 9, 2017 at 5:00 PM. Future runs happen every Saturday at 5:00 PM. | 

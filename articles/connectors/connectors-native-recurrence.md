...
1. Set the interval and frequency for the recurrence. In this example, set these properties to run your workflow every week.
   ...
   > [!IMPORTANT] 
   > Without any advanced schedule options, future recurrences are based on the last run time. 
   ...
   > specify the values for the **At these hours** and **At these minutes** properties, or use the [Sliding Window trigger](../connectors/connectors-native-sliding-window.md) instead.

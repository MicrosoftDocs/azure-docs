...
> [workflow definition function](https://aka.ms/logicappdocs).
...
> [!TIP]
> You can use a `securestring` parameter and the `@parameters()` [workflow definition function](https://aka.ms/logicappdocs) to use a parameter that won't be readable in the definition after saving.
> 
> 

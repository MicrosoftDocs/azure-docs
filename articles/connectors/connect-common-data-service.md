...
1. In the trigger, from the **Add new parameter** list, select **Attribute Filters**.
   ...
   ![Screenshot shows the When a record is updated window with Attribut Filters selected in the Add new parameter list.](./media/connect-common-data-service/when-record-updated-trigger-add-attribute-filters.png)

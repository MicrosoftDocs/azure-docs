...
The following list describes *only some of the many tasks* that you can accomplish with [built-in triggers and actions](#general-built-in-triggers-and-actions):
...
Azure Logic Apps provides the following generic built-in triggers and actions:

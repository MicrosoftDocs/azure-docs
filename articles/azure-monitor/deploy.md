...
## Configuration goals
The goal of a complete deployment of Azure Monitor is to collect all available data from all of your cloud resources and applications and send it to the locations in Azure Monitor to enable all features. 

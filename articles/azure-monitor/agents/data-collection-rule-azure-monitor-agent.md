...
(Optional) If you need network isolation using private links and data collection endpoints, click **Create endpoint** or select existing endpoints from the same region for the respective resource(s). See [how to create data collection endpoint](./data-collection-endpoint-overview.md).

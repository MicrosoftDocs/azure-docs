...
This article describes how to collect logs generated by Internet Information Services (IIS) on Windows computers, with [Azure Monitor Agent](azure-monitor-agent-overview.md). 
...
1. Create a data collection endpoint for the Azure Monitor agent to connect.
1. Create a data collection rule to define the structure of the log file and destination of the collected data.
1. Associate the data collection rule to the agent.

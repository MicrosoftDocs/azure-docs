...
6. A data collection rule you want to associate with the devices. If it doesn't exist already, [create a data collection rule](../essentials/data-collection-rule-edit.md). **Do not associate the rule to any resources yet**.

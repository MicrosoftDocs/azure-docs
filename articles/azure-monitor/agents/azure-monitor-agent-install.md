...
| September 2021 | <ul><li>Fixed issue causing data loss on restarting the agent</li><li>Addressed regression introduced in 1.1.3.1 for Arc Windows servers</li></ul> | 1.1.3.1 (do not use 1.1.3.1) | 1.12.2.0 |

...
> [!NOTE]
> For an explanation of XPaths that are used to specify event collection in data collection rules, see [Filter events](../agents/data-collection-rule-azure-monitor-agent.md#xpath-queries)

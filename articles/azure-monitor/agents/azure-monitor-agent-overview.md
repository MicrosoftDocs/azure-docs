...
The Azure Monitor Agent replaces the following agents that are currently used by Azure Monitor to collect guest data from virtual machines ([view known gaps](../faq.yml#is-the-new-azure-monitor-agent-at-parity-with-existing-agents)):

...
> [!NOTE]
> This utility is used to discover and remove MMA extensions. This will not remove OMS extensions, OMS will need to be removed manually by running the purge script here: [Purge the Linux Agent](https://learn.microsoft.com/en-us/azure/azure-monitor/agents/agent-linux-troubleshoot#purge-and-reinstall-the-linux-agent)

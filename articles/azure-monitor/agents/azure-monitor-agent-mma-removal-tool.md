...
:::image type="content" source="media/RemovalTool/RemovalTool.png" lightbox="media/RemovalTool/RemovalTool.png" alt-text="List of resource that are created by the Discovery and Removal tool":::

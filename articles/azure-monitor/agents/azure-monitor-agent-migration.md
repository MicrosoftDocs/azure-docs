...
|	Azure Stack HCI Insights	|	Migrate to Azure Monitor Agent 	| Generally available|	[Monitor Azure Stack HCI with Insights](https://learn.microsoft.com/en-us/azure-stack/hci/manage/monitor-hci-single)	|

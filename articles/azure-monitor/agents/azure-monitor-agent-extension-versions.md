...
|:---|:---|:---|:---| 
| August 2022 | <ul><li>Fix in custom log collection to always reflect agent local timestamp</li><li>Improved resiliency: Default lookback (retry) time updated to last 3 days (72 hours) up from 60 minutes, for agent to collect data post interruption. This is subject to default offline cache size of 10gigabytes</li><li>For custom logs, agent collection timestamp is always populated while additional timestamp information, if available, will now be part of raw file content</li><li>Fixed datetime format to UTC</li><li>Fix to use default location for firewall log collection, if not provided</li><li>Reliability and supportability improvements</li></ul> | 1.8.0.0 | Coming soon | 

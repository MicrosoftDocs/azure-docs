...
| Migrate your SCOM environment to SCOM MI. | If your management packs include required logic that you can't convert to Azure Monitor then continue using them and [migrate your SCOM environment to SCOM MI](/system-center/scom/migrate-to-operations-manager-managed-instance) to consolidate your monitoring infrastructure in the cloud. |
...
Some availability features require a [dedicated cluster](../logs/logs-dedicated-clusters.md), which requires a commitment of at least 500 GB per day from all workspaces in the same region. If you don't collect this much data, then you need to weight the cost of this commitment with reliability features that it provides.

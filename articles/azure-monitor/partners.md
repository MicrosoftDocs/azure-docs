...
Nodinite provides you with true end-to-end visibility, support and maintenance tool for all your system integrations and message flows. In addition, Nodinite is the only tool on the market that offers end-to-end [Monitoring](https://docs.nodinite.com/monitoring), [Logging (with a powerful non-events feature)](https://docs.nodinite.com/logging) and [Workflow Documentation](https://docs.nodinite.com/workflow-documentation) in a fixed price package. Nodinite is a Swedish software company developing Nodinite to facilitate predictive support and enable business growth.

To achieve a higher experienced quality when automating the incident process, Nodinite decorates alerts with the CMDB properties set in the [Repository Model](http:/s/docs.nodinite.com/repository-model).
...
- [Dynamics 365 (CRM)](https://docs.nodinite.com/goto/microsoft-dynamics-365)

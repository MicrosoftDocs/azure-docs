...
- Workbooks saved to custom storage cannot be recovered by the support team. Users may be able to recover the workbook content if soft-delete or blob versioning are enabled on the underlying storage account. See [recovering a deleted workbook](workbooks-manage.md#recover-a-deleted-workbook) 

...
|TotalTransactions|Yes|Total Transactions|Count|Total|Total number of transactions.||
...
|FileSystemUsage|Yes|File System Usage|Bytes|Average|Percentage of filesystem quota consumed by the app.||

...
:::image type="content" source="articles/azure-monitor/essentials/media/private-link-data-ingestion/azure-monitor-workspace-data-collection-rule.png" alt-text="A screenshot show the data collection endpoints page for an Azure Monitor workspace." lightbox="articles/azure-monitor/essentials/media/private-link-data-ingestion/azure-monitor-workspace-data-collection-rule.png" :::
...
:::image type="content" source="articles/azure-monitor/essentials/media/private-link-data-ingestion/azure-monitor-workspace-data-collection-rule.png" alt-text="A screenshot show the data collection rules page for an Azure Monitor workspace." lightbox="articles/azure-monitor/essentials/media/private-link-data-ingestion/azure-monitor-workspace-data-collection-rule.png" :::

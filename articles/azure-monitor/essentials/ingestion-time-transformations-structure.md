---
title: Structure of ingestion-time transformations in Azure Monitor (preview)
description: Details on the structure of a transformation and details on KQL limitations when used in a transformation.
ms.topic: conceptual
ms.date: 06/29/2022
ms.reviwer: nikeist
...
# Structure of ingestion-time transformations in Azure Monitor (preview)
[Ingestion-time transformations](data-collection-transformations.md) in Azure Monitor allow you to filter or modify data sent to the ingestion pipeline before it's sent to its destination. This article provides details on the structure of a transformation and details on KQL limitations when used in a transformation.

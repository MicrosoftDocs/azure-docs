...
6. Select on the **Endpoint** to view the Grafana workspace.
7. Select **Configuration** and then **Data source**.
8. Select **Add data source** and then **Prometheus**.
...
12. Scroll to the bottom of the page and select **Save & test**.

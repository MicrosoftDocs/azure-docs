...
- **Workspace transformation DCR)**. Used with a Log Analytics workspace to apply [ingestion-time transformations](../logs/ingestion-time-transformations.md) to workflows that don't currently support DCRs.

...
> [!Note]
> Azure Monitor workspaces differ from Log Analytics workspaces. Log Analytics workspaces contain logs and metrics from multiple Azure resources whereas Azure Monitor workspaces caontial only metrics related to Prometheus.

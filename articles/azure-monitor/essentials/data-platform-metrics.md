...
| **Retrieve** | Access metric values from a command line using  [PowerShell cmdlets](/powershell/module/az.monitor)<br>Access metric values from custom application using [REST API](../platform/rest-api-walkthrough.md).<br>Access metric values from a command line using  [CLI](/cli/azure/monitor/metrics). |

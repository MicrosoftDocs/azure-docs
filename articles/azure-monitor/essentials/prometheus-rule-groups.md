...
* In the [portal home page](https://portal.azure.com/), select **Monitor** > **Alerts**, then select **Prometheus Rule Groups**.
      :::image type="content" source="media/prometheus-metrics-rule-groups/prom-rule-groups-from-alerts" alt-text="Screenshot that shows how to view Prometheus rule groups from the alerts screen.":::
...
1. From the left pane, under **Help**, select **Resource health**.
    :::image type="content" source="media/prometheus-metrics-rule-groups/prom-rule-groups-rh" alt-text="Screenshot that shows how to view resource health state of a Prometheus rule group.":::

...
The Azure Monitor [Diagnostics extension](../essentials/diagnostics-extension-overview.md) (known as "WAD" or "Diagnostics") allows you to collect metrics and logs from the guest operating system (Guest OS) running as part of a virtual machine, cloud service, or Service Fabric cluster. The extension can send telemetry to [many different locations.](../platform/data-platform.md?toc=/azure/azure-monitor/toc.json)

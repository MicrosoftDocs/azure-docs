...
The first thing you see after you sign in to the Microsoft Azure portal is a [dashboard](../../azure-portal/azure-portal-dashboards.md).<br> ![Azure portal dashboard](media/tutorial-logs-dashboards/log-analytics-portal-dashboard.png)
...
To create a dashboard, select the **New dashboard** button next to the current dashboard's name.<br> ![Create new dashboard in Azure portal](media/tutorial-logs-dashboards/log-analytics-create-dashboard-01.png)

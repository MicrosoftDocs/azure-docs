...
1. Add text to the tile's properties and resize it on the dashboard canvas.
	...
	![Edit markdown tile](media/tutorial-app-dashboards/markdown.png)
...
4. That tile is now added to your dashboard. Select **Edit** to change the positioning of the tile. Select and drag it into position and then click **Done customizing**. Your dashboard now has a tile with some useful information.
    ...
    ![Dashboard in edit mode](media/tutorial-app-dashboards/dashboard-edit-mode.png)
...
6. Select **Chart** and then change to a **Doughnut** to visualize the output.
	...
	![Doughnut chart with above query](media/tutorial-app-dashboards/logs-doughnut.png)

6. Select the pin icon ![Pin icon](media/tutorial-app-dashboards/pushpin.png) on the top right to pin the chart to your dashboard and  return to your dashboard.
...
2. You can optionally define specific users who should have access to the dashboard. For more information, see [Share Azure dashboards by using Role-Based Access Control](../../azure-portal/azure-portal-dashboard-share-access).
3. Select **Publish**.

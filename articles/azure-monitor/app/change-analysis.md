...
![Activity Log change history integration](./media/change-analysis/activity_log-change_history.png)
...
![VM insights integration](./media/change-analysis/vminsights.png)

...
> [!NOTE]
> If your hosting environment or resource provider is not listed in the following table, autoinstrumentation is not supported. You can manually instrument your environment or resource provider, by coding against the Application Insights or OpenTelemetry API. For more information, see [Data Collection Basics of Azure Monitor Application Insights](opentelemetry-overview.md).

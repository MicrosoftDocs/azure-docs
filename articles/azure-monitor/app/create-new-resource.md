...
> [!IMPORTANT]
> Classic Application Insights will be deprecated on [**February 29th 2024**](https://azure.microsoft.com/updates/we-re-retiring-classic-application-insights-on-29-february-2024). Please follow these [instructions on how upgrade to workspace-based Application Insights](convert-classic-resource.md). [Newer regions](./create-new-resource.md#create-an-application-insights-resource-1e) do not support creating classic Application Insights resources. When creating a new Application Insights resource, we recommend workspace-based Application Insights.

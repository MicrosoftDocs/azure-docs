...
- [Failures view](failures-and-performance-views.md#tab/failures-view): Identify and analyze failures in your application to minimize downtime.
- [Performance view](failures-and-performance-views.md#tab/performance-view): Review application performance metrics and potential bottlenecks.

...
- [Failures view](failures-and-performance-views.md#tabpanel_1_failures-view): Identify and analyze failures in your application to minimize downtime.
- [Performance view](failures-and-performance-views.md#tabpanel_1_performance-view): Review application performance metrics and potential bottlenecks.

...
Download [applicationinsights-agent-3.0.2-BETA.jar](https://github.com/microsoft/ApplicationInsights-Java/releases/download/3.0.1/applicationinsights-agent-3.0.2-BETA.jar)

**2. Point the JVM to the agent**

Add `-javaagent:path/to/applicationinsights-agent-3.0.2-BETA.jar` to your application's JVM args
...
Or by creating a configuration file named `applicationinsights.json`, and placing it in the same directory as `applicationinsights-agent-3.0.2-BETA.jar`, with the following content:
...
> [!NOTE]
> This feature is only in 3.0.2-BETA and later

...
> 
>    -  Starting from 3.3.0-BETA, `LoggingLevel` is not captured by default as part of Log's custom dimension since that data is already available under SeverityLevel. For details on how to enable this, please see the [config options](./java-standalone-config.md#logginglevel)
>

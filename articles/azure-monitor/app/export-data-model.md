...
| Path | Type | Notes |
| --- | --- | --- |
| event [0] count |integer |100/([sampling](../../application-insights/app-insights-sampling.md) rate). For example 4 =&gt; 25%. |
...
| basicException [0] count |integer |100/([sampling](../../application-insights/app-insights-sampling.md) rate). For example 4 =&gt; 25%. |
...
| remoteDependency [0] count |integer |100/([sampling](../../application-insights/app-insights-sampling.md) rate). For example 4 =&gt; 25%. |
...
| Path | Type | Notes |
| --- | --- | --- |
| request [0] count |integer |100/([sampling](../../application-insights/app-insights-sampling.md) rate). For example: 4 =&gt; 25%. |
...
| Path | Type | Notes |
| --- | --- | --- |
| view [0] count |integer |100/([sampling](../../application-insights/app-insights-sampling.md) rate). For example 4 =&gt; 25%. |
...
| availability [0] count |integer |100/([sampling](../../application-insights/app-insights-sampling.md) rate). For example 4 =&gt; 25%. |
...
Instead of pre-aggregating metrics, you can use [sampling](../../application-insights/app-insights-sampling.md) if you need to reduce the volume of telemetry.

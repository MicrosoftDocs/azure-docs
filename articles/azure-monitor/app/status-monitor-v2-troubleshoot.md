...
Review the [API reference](app/status-monitor-v2-api-reference#get-applicationinsightsmonitoringstatus) for a detailed description of how to use this cmdlet.

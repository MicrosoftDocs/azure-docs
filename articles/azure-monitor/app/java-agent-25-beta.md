---
title: Performance monitoring for Java web apps in Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: Extended performance and usage monitoring of your Java website with Application Insights (2.5.0-BETA).

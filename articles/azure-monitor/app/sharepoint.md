...
> [!NOTE]
> Due to security concerns, you can't directly add the script that's described in this article to your webpages in the SharePoint modern UX. As an alternative, you can use [SharePoint Framework (SPFx)](/sharepoint/dev/spfx/extensions/overview-extensions) to build a custom extension that you can use to install Application Insights on your SharePoint sites. To learn more, view the [NPM based sample for SharePoint](https://github.com/pnp/sp-dev-fx-extensions/tree/master/samples/js-application-appinsights-advanced) that installs Application Insights via [NPM](./javascript.md#npm-based-setup) or the [JavaScript snippet based sample for SharePoint](https://github.com/pnp/sp-dev-fx-extensions/tree/master/samples/js-application-appinsights) that installs the [Application Insights JavaScript snippet](https://github.com/microsoft/ApplicationInsights-JS/tree/master/AISKU/snippet#how-to-inject-javascript-with-sharepoint-framework-extensions-through-snippet-setup).

...
![Exceptions in CodeLens](./media/release-notes-vsix/ExceptionsCodeLens.png)
...
![ASP.NET Core support](./media/release-notes-vsix/NetCoreSupport.png)
...
![Diagnostic Tools support](./media/release-notes-vsix/DiagnosticTools.png)
...
![Project context menu for Windows Forms apps](./media/release-notes-vsix/WinFormContextMenu.png)
...
![Upload complete](./media/release-notes-vsix/LocalSearch.png)
...
![Related items](./media/release-notes-vsix/RelatedItems.png)
...
![New Project dialog](./media/release-notes-vsix/newproject.png)

...
- On-by-default [autoinstrumentation/codeless monitoring](codeless-overview) (for languages) for Azure App Service, Azure Virtual Machines/Azure Virtual Machine Scale Sets, and Azure Functions.

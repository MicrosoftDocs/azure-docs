...
The current SDK Loader Script is version 6 and is shown here. The version is encoded in the SDK Loader Script as sv:"#". The [current version is also available on GitHub](https://go.microsoft.com/fwlink/?linkid=2156318).

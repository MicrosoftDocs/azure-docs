...
To add distributed tracing capabilities to an application with OpenCensus, first [install and configure the Application Insights Local Forwarder](./../../azure-monitor/app/opencensus-local-forwarder.md). From there, configure OpenCensus to route distributed trace data through the Local Forwarder. Both [Python](./../../application-insights/opencensus-python.md) and [Go](./../../azure-monitor/app/opencensus-go.md) are supported.

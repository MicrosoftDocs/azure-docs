...
For more information, see [Use Application Insights Java In-Process Agent in Azure Spring Apps](../../spring-apps/./how-to-application-insights?pivots=sc-standard).

...
> [!CAUTION]
> This article applies to Application Insights Java 2.x, which is [no longer recommended](https://azure.microsoft.com/en-us/updates/application-insights-java-2x-retirement/).
>

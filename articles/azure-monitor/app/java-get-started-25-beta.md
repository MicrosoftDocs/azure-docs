---
title: Java web app analytics with Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: 'Application Performance Monitoring for Java web apps with Application Insights (2.5.0-BETA). '
...
ms.author: lagayhar
---
# Get started with Application Insights in a Java web project (2.5.0-BETA)

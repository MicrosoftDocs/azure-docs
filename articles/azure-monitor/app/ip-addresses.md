...
You can query the list of IP addresses use by Action Groups using the [Get-AzNetworkServiceTag PowerShell command](https://docs.microsoft.com/powershell/module/az.network/Get-AzNetworkServiceTag?view=azps-5.4.0#description).

...
The ApplicationInsights Java Agent monitors CPU, memory and request duration (e.g., a business transaction) and if it breaches a configured threshold a profile is triggered. 

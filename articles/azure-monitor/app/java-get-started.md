...
> [!CAUTION]
> As of November 2020, we recommended Java codeless application monitoring using the Azure Monitor Application Insights 3.0 agent. For more information on how to get started, see [Application Insights Java 3.0 agent](./java-in-process-agent.md).

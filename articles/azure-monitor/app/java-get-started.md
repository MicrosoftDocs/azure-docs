...
The incoming SDK configuration is explained further in our article on [correlation](correlation.md#enable-w3c-distributed-tracing-support-for-classic-asp.net-apps).

...
You can use the [CreateReleaseAnnotation](https://github.com/microsoft/AzureKeyVaultExplorer/blob/master/Vault/Explorer/CreateReleaseAnnotation.ps1) PowerShell script from GitHub to create annotations from any process you like, without using Azure DevOps. 

1. Make a local copy of [CreateReleaseAnnotation.ps1](https://github.com/microsoft/AzureKeyVaultExplorer/blob/master/Vault/Explorer/CreateReleaseAnnotation.ps1).

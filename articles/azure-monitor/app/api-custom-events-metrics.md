...
We recommend using the flush() or flushAsync() methods in the shutdown activity of the Application when using the .NET or [JS](https://github.com/microsoft/ApplicationInsights-JS/blob/master/API-reference.md#flush) SDK.

...
Insert a telemetry initializer by adding the onInit callback function in the [Javascript (Web) SDK Loader Script configuration](./javascript-sdk.md?tabs=sdkloaderscript#sdk-loader-script-configuration):

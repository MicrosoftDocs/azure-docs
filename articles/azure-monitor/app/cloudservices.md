...
If that's all you need, you're done! Next steps are [viewing metrics from your app](../../application-insights/app-insights-metrics-explorer.md), [querying your data with Analytics](../../azure-monitor/app/analytics.md), and maybe setting up a [dashboard](../../azure-monitor/app/app-insights-dashboards.md). You might want to set up [availability tests](../../application-insights/app-insights-monitor-web-app-availability.md) and [add code to your web pages](../../azure-monitor/app/javascript.md) to monitor performance in the browser.

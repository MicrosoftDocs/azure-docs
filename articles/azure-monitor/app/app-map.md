...
1. If you're missing a dependency, make sure it's in the list of [autocollected dependencies](./asp-net-dependencies.md#dependencies). If not, you can still track it manually with a [track dependency call](./api-custom-events-metrics.md#trackdependency).

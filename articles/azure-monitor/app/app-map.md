...
* To learn more about how correlation works in Application Insights consult the [telemetry correlation article](https://docs.microsoft.com/en-us/azure/azure-monitor/app/correlation).

...
Within the profiler user interface, (see [profiler settings](../profiler/profiler-settings.md)) there is a Profile now button. This will immediately request a profile in all agents that are attached to the Application Insights instance.

...
* [Web apps on an IIS server in Azure VM or Azure VMSS](azure-vm-vmss-apps.md)
...
* [Performance Counters](performance-counters.md) - If you use [Status Monitor](monitor-performance-live-website-now.md), [Azure monitoring for App Services](azure-web-apps.md), [Azure monitoring for VM or VMSS](azure-vm-vmss-apps.md), or the [Application Insights collectd writer](java-collectd.md).

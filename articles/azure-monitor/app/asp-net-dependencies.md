...
[autocollected dependencies](opentelemetry-enable.md#distributed-tracing).
...
* Set up custom dependency tracking for [Java](opentelemetry-enable.md#add-custom-spans).

...
[autocollected dependencies](opentelemetry-enable.md#distributed-tracing?tabs=java).
...
* Set up custom dependency tracking for [Java](opentelemetry-enable.md#add-custom-spans?tabs=java).

...
* **Manually instrumenting the application through code** by installing the Application Insights SDK.
    ...
    * This approach is much more customizable, but it requires the following approaches: SDK [for .NetCore](https://docs.microsoft.com/azure/azure-monitor/app/asp-net-core), [.Net](https://docs.microsoft.com/azure/azure-monitor/app/asp-net), [Node.js](https://docs.microsoft.com/azure/azure-monitor/app/nodejs), [Python](https://docs.microsoft.com/azure/azure-monitor/app/opencensus-python), and a standalone agent for [Java](https://docs.microsoft.com/azure/azure-monitor/app/java-in-process-agent). This method, also means you have to manage the updates to the latest version of the packages yourself.

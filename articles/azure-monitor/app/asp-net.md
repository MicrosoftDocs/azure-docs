...
Your telemetry builds up in the Application Insights portal, where you can monitor metrics, search your telemetry, and set up [dashboards](../../azure-monitor/app/app-insights-dashboards.md). You can also use the powerful [Data Explorer query language](https://aka.ms/LogAnalyticsLanguage) to analyze usage and performance, or to find specific events.

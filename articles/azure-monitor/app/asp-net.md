...
Publish your app to your IIS server or to Azure. Watch [Live Metrics Stream](../../azure-monitor/platform/metrics-charts.md#live-metrics-stream) to make sure everything is running smoothly.

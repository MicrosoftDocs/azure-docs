...
* You can select the location when you create a new Application Insights resource. Know more about Application Insights availability per region [here](https://azure.microsoft.com/en-us/global-infrastructure/services/?products=all).

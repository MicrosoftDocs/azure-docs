...
|[Add the JavaScript snippet to your web pages](../../application-insights/app-insights-javascript.md)|[Page performance](../../application-insights/app-insights-usage-overview.md), browser exceptions, AJAX performance. Custom client-side telemetry.|
|[Create availability web tests](../../application-insights/app-insights-monitor-web-app-availability.md)|Get alerts if your site becomes unavailable|

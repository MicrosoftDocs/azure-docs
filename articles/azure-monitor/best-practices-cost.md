...
- See [Set daily cap on Log Analytics workspace](daily-cap.md) to control your costs by setting a daily limit on the amount of data that may be ingested in a workspace.
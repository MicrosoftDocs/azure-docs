...
- **Defender for Cloud**: [Setting the security event option at the workspace level](../defender-for-cloud/extensions-log-analytics-agent.md#setting-the-security-event-option-at-the-workspace-level)

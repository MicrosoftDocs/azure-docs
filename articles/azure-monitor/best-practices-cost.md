...
See [Query Basic Logs in Azure Monitor (Preview)](/azure/azure-monitor/logs/basic-logs-query) for details on query limitations and [Configure Basic Logs in Azure Monitor (Preview)](logs/basic-logs-configure.md) for more details about them.

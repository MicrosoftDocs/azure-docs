...
Essentials|[Collect Prometheus metrics from an AKS cluster (preview)](essentials/kubernetes-monitoring-enable.md#enable-prometheus-and-grafana)|Enabled Windows metric collection metrics add-on.|
...
Essentials|[Collect Prometheus metrics from AKS cluster (preview)](essentials/kubernetes-monitoring-enable.md#enable-prometheus-and-grafana)|Added enabling Prometheus metric collection by using Azure Policy and Bicep.|

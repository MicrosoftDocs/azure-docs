...
Containers|[Query logs from Container insights](https://learn.microsoft.com/azure/azure-monitor/containers/container-insights-log-query)|Now includes log queries for Prometheus data.|
...
Containers|[Collect Prometheus metrics with Container insights](https://learn.microsoft.com/azure/azure-monitor/containers/container-insights-prometheus?tabs=cluster-wide)|Updated to include Azure Monitor managed service for Prometheus.|
Essentials|[Metrics in Azure Monitor](https://learn.microsoft.com/azure/azure-monitor/essentials/data-platform-metrics)|Updated to include Azure Monitor managed service for Prometheus|
Essentials|[Azure Monitor workspace overview (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/azure-monitor-workspace-overview?tabs=azure-portal)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Overview of Azure Monitor Managed Service for Prometheus (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-metrics-overview)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Rule groups in Azure Monitor Managed Service for Prometheus (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-rule-groups)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Remote-write in Azure Monitor Managed Service for Prometheus (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-remote-write-managed-identity)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Use Azure Monitor managed service for Prometheus (preview) as data source for Grafana](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-grafana)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Troubleshoot collection of Prometheus metrics in Azure Monitor (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-metrics-troubleshoot)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Default Prometheus metrics configuration in Azure Monitor (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-metrics-scrape-default)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Scrape Prometheus metrics at scale in Azure Monitor (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-metrics-scrape-scale)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Customize scraping of Prometheus metrics in Azure Monitor (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-metrics-scrape-configuration)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Create, validate and troubleshoot custom configuration file for Prometheus metrics in Azure Monitor (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-metrics-scrape-validate)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Minimal Prometheus ingestion profile in Azure Monitor (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-metrics-scrape-configuration-minimal)|New article. Public preview of Azure Monitor managed service for Prometheus|
Essentials|[Collect Prometheus metrics from AKS cluster (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-metrics-enable)|New article. Public preview of Azure Monitor managed service for Prometheus|
...
Essentials|[Send Prometheus metrics to multiple Azure Monitor workspaces (preview)](https://learn.microsoft.com/azure/azure-monitor/essentials/prometheus-metrics-multiple-workspaces)|New article. Public preview of Azure Monitor managed service for Prometheus|

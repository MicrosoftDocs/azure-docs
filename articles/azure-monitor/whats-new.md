...
Logs|[Cant not read file: https://docs.microsoft.com/azure/azure-monitor/includes/waf-logs-reliability](includes/waf-logs-reliability.md)|Dedicated clusters are now available in all commitment tiers, with a minimum daily ingestion of 100 GB.|

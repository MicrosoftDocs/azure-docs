...
>[!Note]
> Creating a recurring profile with no end time is only supported via the portal and ARM templates. For more information on creating recurring profiles with ARM templates, see [Add a recurring profile using ARM templates](https://learn.microsoft.com/azure/azure-monitor/autoscale/autoscale-multiprofile?tabs=templates#add-a-recurring-profile-using-aim-templates).

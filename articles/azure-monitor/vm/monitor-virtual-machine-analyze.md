...
- **Overview page**: Select the **Monitoring** tab to display [platform metrics](../essentials/data-platform-metrics.md) for the virtual machine host. You can see the number of active alerts on the tab. In the **Monitoring** tab, you get a quick view of:
    - **Alerts:** the alerts triggered in the last 24 hours, with some important statistics about those alerts. If you do not have any alerts set up for this vm, there is a link to  help you quickly create new alerts for your VM. 

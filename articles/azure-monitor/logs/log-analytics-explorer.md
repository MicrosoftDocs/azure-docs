...
You can switch seamlessly move between simple and advance mode, and advanced users can share complex queries, which other users can continue working with in simple mode. 

...
![The Azure Active Directory overview page. Click "App registrations"](images/direct-api/02.png)

Next, click "New application registration":  
![Click "New application registration"](images/direct-api/03.png)
...
![Fill in the name, application type, and sign-on URL](images/direct-api/04.png)
...
![Find the just-created app and click on it to open it's details](images/direct-api/26.png)

First, take note of the Application ID. We'll need it later. Then, click `Required permissions`: ![Write down the application ID, and click "required permissions"](images/direct-api/061.png)

On the required permissions page, press `add`: ![On the required permissions page, press add](images/direct-api/071.png)
...
![Read Log Analytics data as user](images/direct-api/081.png)
...
![Generating an API key](images/direct-api/091.png)
...
![Copy the API Key generated](images/direct-api/101.png)
...
![Copy the Workspace ID on the Log Analytics overview page](images/direct-api/111.png)
...
![Press "Access Control (IAM)" and then "Add"](images/direct-api/131.png)
...
![Results from the sample query shown in the Log Search page](images/direct-api/14.png)
...
![A call to run our query in Fiddler](images/direct-api/18.png)

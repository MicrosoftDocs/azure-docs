...
> [!NOTE]
> The search job feature is currently not supported in workspaces with [customer-managed keys](customer-managed-keys.md). 
> The search job feature is currently not supported in the China East 2 region.

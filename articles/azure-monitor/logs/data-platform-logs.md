...
| Long-term retention | [Extend retention of data in any table](./data-retention-configure.md) for auditing and compliance to up to 12 years. Low-cost, in-workspace, long-term retention lets you reduce costs and easily use data when you need it.|

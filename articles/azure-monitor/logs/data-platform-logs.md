...
| Pricing model                                          | **Ingestion** - Standard cost.<br>**Queries** - Queries included.<br>**Long-term retention** - Prorated monthly long-term retention charge. | **Ingestion** - Reduced cost.<br>**Queries** - Pay per query.<br>**Long-term retention** - Prorated monthly long-term retention charge. | **Ingestion** - Minimal cost.<br>**Queries** - Pay per query.<br>**Long-term retention** - Prorated monthly long-term retention charge. |

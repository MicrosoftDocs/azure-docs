...
| Bring your own analysis | [Create streamlined, multi-step processes on top of data you collect in Azure Monitor Logs](../logs/bring-your-own-machine-learning.md#build-your-own-machine-learning-pipeline-on-data-in-azure-monitor-logs) for purposes such as machine learning pipelines, advanced analysis, and create troubleshooting guides (TSGs) for support needs. |

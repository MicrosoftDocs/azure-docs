...
|**Cost**|No extra cost|-  Cost of the machine learning service you use.<br>-  Depending on how you [implement your machine learning pipeline](#apply-your-own-machine-learning-pipeline-to-data-in-azure-monitor-logs), you might incur charges for exporting data and ingesting data into Azure Monitor Logs.|
|**Data volumes**|Supports several GBs of data, or a few million records.|Supports larger data volumes, depending on how you [implement your machine learning pipeline](#apply-your-own-machine-learning-pipeline-to-data-in-azure-monitor-logs). |
...
|Step|Description|Bring your own analysis to Azure Monitor Logs|Export data|
|-|-|-|-|
...
|**Build and training models**|There are various Azure and open source machine learning libraries you can use to build and train machine learning models on data in Azure Monitor Logs, including [Scikit Learn](https://scikit-learn.org/), [PyTorch](https://pytorch.org/), [Tensorflow](https://www.tensorflow.org/), [Spark MLlib](https://spark.apache.org/docs/latest/ml-guide.html), and [SynapseML](https://github.com/microsoft/SynapseML).|For an example of how to train a machine learning model on data in Azure Monitor Logs, see [Train and test a machine model on historical data in a Log Analytics workspace](../logs/jupyter-notebook-ml-azure-monitor-logs.md#train-and-test-regression-models-on-historical-data)|For an example of how to train a machine learning model on data you export out of Azure Monitor Logs, see  [Train a model in Python with automated machine learning](/azure/synapse-analytics/spark/apache-spark-azure-machine-learning-tutorial).|

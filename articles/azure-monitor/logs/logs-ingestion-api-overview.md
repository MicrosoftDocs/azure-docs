...
:::image type="content" source="../logs/media/logs-ingestion-api-overview/overview-log-ingestion-api.png" lightbox="../logs/media/logs-ingestion-api-overview/overview-log-ingestion-api.png" alt-text="Diagram that shows an overview of logs ingestion API." border="false":::

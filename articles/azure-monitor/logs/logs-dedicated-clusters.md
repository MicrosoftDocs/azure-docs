...
Complete details are billing for Log Analytics dedicated clusters are available [here](../../platform/manage-cost-storage#log-analytics-dedicated-clusters).

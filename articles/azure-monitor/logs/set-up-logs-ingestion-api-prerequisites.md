---
title: Set up resources required to send data to Azure Monitor with Logs Ingestion API
...
# Set up resources required to send data to Azure Monitor using Logs Ingestion API

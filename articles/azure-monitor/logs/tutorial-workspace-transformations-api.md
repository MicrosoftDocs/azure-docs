...
1. From the **Log Analytics workspaces** menu in the Azure portal, select **Diagnostic settings** and then **Add diagnostic setting**.
    ...
    :::image type="content" source="media/media/tutorial-workspace-transformations-portal/diagnostic-settings.png" lightbox="media/media/tutorial-workspace-transformations-portal/diagnostic-settings.png" alt-text="Screenshot of diagnostic settings.":::
...
2. Provide a name for the diagnostic setting and select the workspace so that the auditing data is stored in the same workspace. Select the **Audit** category and  then click **Save** to save the diagnostic setting and close the diagnostic setting page.
    ...
    :::image type="content" source="media/media/tutorial-workspace-transformations-portal/new-diagnostic-setting.png" lightbox="media/media/tutorial-workspace-transformations-portal/new-diagnostic-setting.png" alt-text="Screenshot of new diagnostic setting.":::
...
3. Select **Logs** and then run some queries to populate `LAQueryLogs` with some data. These queries don't need to actually return any data. 
    ...
    :::image type="content" source="media/media/tutorial-workspace-transformations-portal/sample-queries.png" lightbox="media/media/tutorial-workspace-transformations-portal/sample-queries.png" alt-text="Screenshot of sample log queries.":::
...
4. You can verify that the column was added by going to the **Log Analytics workspace** menu in the Azure portal. Select **Logs** to open Log Analytics and then expand the `LAQueryLogs` table to view its columns.
    ...
    :::image type="content" source="media/media/tutorial-workspace-transformations-portal/verify-table.png" lightbox="media/media/tutorial-workspace-transformations-portal/verify-table.png" alt-text="Screenshot of Log Analytics with new column.":::
...
2. Run the following query to view the contents of the `LAQueryLogs` table. Notice the contents of the `RequestContext` column. The transformation will retrieve the workspace name from this column and remove the rest of the data in it. 
    ...
    :::image type="content" source="media/media/tutorial-workspace-transformations-portal/initial-query.png" lightbox="media/media/tutorial-workspace-transformations-portal/initial-query.png" alt-text="Screenshot of initial query in Log Analytics.":::
...
3. Modify the query to the following:
   ...
   - Remove data from the `RequestContext` column to save space.
    ...
    :::image type="content" source="media/media/tutorial-workspace-transformations-portal/modified-query.png" lightbox="media/media/tutorial-workspace-transformations-portal/modified-query.png" alt-text="Screenshot of modified query in Log Analytics.":::

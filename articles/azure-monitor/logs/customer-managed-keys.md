...
[<img src="media/customer-managed-keys/cmk-workbook.png" alt="Screenshot of Workbook save." title="Customer-managed key for workbooks" width="70%"/>](media/customer-managed-keys/grant-key-vault-permissions-rbac-8bit.png#lightbox)

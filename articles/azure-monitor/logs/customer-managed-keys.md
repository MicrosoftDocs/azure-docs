...
Data ingested in the last 14 days is also kept in hot-cache (SSD-backed) for query efficiency and encrypted with Microsoft keys regardless customer-managed key configuration. Your control over access to SSD data applies and adheres to [key revocation](#key-revocation)

...
| OfficeActivity | Partial support in government clouds. Some of the data is ingested via webhooks from Office 365 into Log Analytics. This portion is missing in export currently. |

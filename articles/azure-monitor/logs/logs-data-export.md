...
![Data export overview](media/logs-data-export/data-export-overview.png "Data export flow diagram")
...
![Storage sample data](media/logs-data-export/storage-data.png "Data format in blob storage")
...
![Storage account firewalls and networks](media/logs-data-export/storage-account-network.png "Allow trusted Microsoft services")
...
![export create](media/logs-data-export/export-create-1.png "Data export entry point")
...
![export rules view](media/logs-data-export/export-view-1.png "Data export rules view")

Click a rule for configuration view.

<img src="media/logs-data-export/export-view-2.png" alt="export rule settings" title= "Data export rule configuration view" width="65%"/>
...
![export rule disable](media/logs-data-export/export-disable.png "Disable data export rule")
...
![export rule delete](media/logs-data-export/export-delete.png "Delete data export rule")
...
![export rules](media/logs-data-export/export-view.png "Data export rules view")

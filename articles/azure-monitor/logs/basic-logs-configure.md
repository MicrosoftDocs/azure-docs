...
|Pricing model|**Ingestion** - Standard cost.<br>**Interactive retention** - 31 days free, including unlimited queries. Prorated monthly charge for extended interactive retention, up to 2 years in total.<br>**Auxiliary retention** - Prorated monthly auxiliary retention charge, up to 12 years total retention. |**Ingestion** - Significantly reduced cost.<br>**Interactive retention** - Pay-per-query for 30 days. Can't be extended.<br>**Auxiliary retention** - Prorated monthly auxiliary retention charge, up to 12 years total retention.|**Ingestion** - Minimal cost.<br>**Interactive retention** - Pay-per-query for 30 days. Can't be extended.<br>**Auxiliary retention** - Prorated monthly auxiliary retention charge, up to 12 years total retention.|

...
|[Archiving and quick access to archived log data](../logs/data-retention-archive.md)| Azure Monitor logs provides a cost-effective archive option that keeps your logs in your Log Analytics workspace and lets you access archived log data immediately, when you need it. Archive configuration changes are also effective immediately because data is not physically transferred to external storage. |

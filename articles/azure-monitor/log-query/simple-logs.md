...
## Using Simple Logs
Navigate to any Cosmos DB or Key Vault in your Azure subscription with [diagnostic settings configured to collect logs in a Log Analytics workspace](../platform/resource-logs.md#collect-to-azure-storage). Click **Logs** in the **Monitoring** menu to open the Simple Logs experience.

...
Create a function in log analytics by clicking **Save** and then providing the information in the following table.
...
> [!NOTE]
> Saving a function is possible in log queries, but currently not for Application Insights queries.

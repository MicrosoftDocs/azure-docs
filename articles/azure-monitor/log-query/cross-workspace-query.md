...
* Cross-resource query in log alerts is only supported in the current [scheduledQueryRules API](/rest/api/monitor/scheduledqueryrules). If you are using the legacy Log Alerts API, you will need to [switch to the current API](../platform/alerts-log-api-switch.md).

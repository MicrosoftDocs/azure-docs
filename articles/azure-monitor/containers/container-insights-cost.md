...
- [Diagnostic log collection](../../aks/monitor-aks.md#collect-control-plane-logs) of Kubernetes main node logs in your Azure Kubernetes Service (AKS) cluster to analyze log data generated by main components, such as `kube-apiserver` and `kube-controller-manager`.

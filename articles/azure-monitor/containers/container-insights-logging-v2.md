...
1. For configuring via CLI, use the corresponding [config file](./container-insights-cost-config.md#enable-cost-savings), update the `enableContainerLogV2` field in the config file to be true.

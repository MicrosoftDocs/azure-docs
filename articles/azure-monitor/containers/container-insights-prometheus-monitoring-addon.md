...
This article describes how to configure Container insights to send Prometheus metrics to a Log Analytics workspace.

> [!NOTE]
> This article describes how to send Prometheus metrics to a Log Analytics workspace. You can also send metrics to Azure Monitor managed service for Prometheus which that supports standard Prometheus features such as PromQL and Prometheus alert rules.

...
# Monitoring Azure Kubernetes Service (AKS) - Features
This article is part of the Monitoring AKS in Azure Monitor scenario. It describes the features of Azure Monitor that you'll use to analyze the data collected from your AKS cluster.

...
Checkout the [resource requests and limits section of Helm chart](https://github.com/microsoft/Docker-Provider/blob/ci_dev/charts/azuremonitor-containers/values.yaml) for the available configuration settings.

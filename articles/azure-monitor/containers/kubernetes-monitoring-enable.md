...
[Using the Azure portal](#enable-full-monitoring-with-azure-portal), you can enable all of the features at the same time. You can also enable them individually by using the [Azure CLI](#enable-prometheus-and-grafana?tabs=cli), [Azure Resource Manager template](/azure/azure-monitor/containers/kubernetes-monitoring-enable#enable-prometheus-and-grafana?tabs=arm), [Terraform](/azure/azure-monitor/containers/kubernetes-monitoring-enable#enable-prometheus-and-grafana?tabs=terraform), or [Azure Policy](/azure/azure-monitor/containers/kubernetes-monitoring-enable#enable-prometheus-and-grafana?tabs=policy). Each of these methods is described in this article.

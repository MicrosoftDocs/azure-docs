...
After successful authentication, the Live Data console pane appears within the Live Logs tab. You can view log data here in a continuous stream. If data can be retrieved, it begins streaming to your console.
...
After successful authentication, the Live Data console pane appears within the Live Events tab. If data can be retrieved, it begins streaming to your console.
...
After successful authentication, the Live Data console pane appears within the Live Metrics tab. Metric data is retrieved and begins streaming to your console for presentation in the two charts. The pane title shows the name of the pod the container is grouped with.

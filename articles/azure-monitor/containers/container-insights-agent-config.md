...
| `[log_collection_settings.enable_multiline_logs] enabled =` | String | True or False | This setting controls whether multiline container logs are enabled. They are disabled by default. See [Multi-line logging in Container Insights](https://learn.microsoft.com/en-us/azure/azure-monitor/containers/container-insights-logging-v2?tabs=configure-portal#multi-line-logging-in-container-insights-preview) to learn more. |

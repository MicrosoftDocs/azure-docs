...
# Enable monitoring on your Kubernetes cluster with Azure Monitor
Monitoring of your Kubernetes cluster using Azure Monitor requires enabling both [Container insights](./container-insights-overview.md) to collect logs and [Managed service for Prometheus](../essentials/platform-logs-overview.md) to collect metrics. In addition to these features of Azure Monitor, you should enable [Managed Grafana](../../managed-grafana/overview.md) to visualize Prometheus metrics.

This article provides an overview of the requirements and options that are available for enabling Container insights and Managed Prometheus to monitor the performance of workloads that are deployed to Kubernetes environments. For detailed steps for onboarding your cluster, see the articles linked below for each supported configuration.

...
8. Classic alert rules can no longer be created via PowerShell. Use the new ['Add-AzMetricAlertRule'](/powershell/module/az.monitor/add-azmetricalertrule) command to create a metric alert rule instead.

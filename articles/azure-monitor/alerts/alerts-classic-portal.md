...
- [Create a classic metric alert with a Resource Manager template](../platform/alerts-enable-template.md).
- [Have a classic metric alert notify a non-Azure system using a webhook](../platform/alerts-webhooks.md).

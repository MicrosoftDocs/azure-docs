...
Set the frequency of the alert rule to 15 min or less to get the health status of an alert rule.If your rule runs less frequently than every 15 minutes (30 minutes, 1 hour, etc.), it won’t provide health status updates and an ‘unavailable’ status is to be expected and is not indicative of an issue.|

...
<li>**\<your custom namespace\>**: A custom metric namespace, containing custom metrics sent with the Azure Monitor Metrics API.</li>
...
<li>**Activity Log – Autoscale** The service that provides the ‘Autoscale’ activity log events.</li>
<li>**Activity Log – Security**: The service that provides the ‘Security’ activity log events.</li>
<li>**Resource health**: The service that provides the resource-level health status.</li>
<li>**Service health**: The service that provides the subscription-level health status.</li> </ul>  |

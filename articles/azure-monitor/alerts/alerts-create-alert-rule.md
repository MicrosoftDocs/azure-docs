...
description: Use Azure Monitor to create, view, and manage alert rules
author: AbbyMSFT
...
This article shows you how to create and manage alerts. Learn more about alerts [here](alerts-overview-new.md).
...
1. In the **Monitoring** menu, select **Alerts**.

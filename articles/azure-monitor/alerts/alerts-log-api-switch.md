...
- [PowerShell cmdlets support](./alerts-log.md#manage-log-alerts-using-powershell).
...
- All new rules must be created/edited with the current API. See [sample use via Azure Resource Template](alerts-log-create-templates.md) and [sample use via PowerShell](./alerts-log.md#manage-log-alerts-using-powershell).
...
- Learn how to [manage log alerts using PowerShell](./alerts-log.md#manage-log-alerts-using-powershell).

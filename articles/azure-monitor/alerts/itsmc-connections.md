...
This article provides information about how to configure the connection between your ITSM product/service and the IT Service Management Connector (ITSMC) in Log Analytics to centrally manage your work items. For more information about ITSMC,  see [Overview](../platform/itsmc-overview.md).
...
> [!NOTE]
> We propose our Cherwell and Provance customers to use [Webhook action](../platform/action-groups.md#webhook) to Cherwell and Provance endpoint as another solution to the integration.

## Next steps

* [Troubleshooting problems in ITSM Connector](../platform/itsmc-resync-servicenow.md)
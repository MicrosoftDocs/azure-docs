...
:::image type="content" source="media/tutorial-log-alert/alert-rule-dimensions-2.png" lightbox="media/tutorial-log-alert/alert-rule-condition-2.png"alt-text="Alert rule dimensions with a dimension called Computer set":::

...
1. In the last section of the interface for creating an ITSM action group, if the alert is a log alert, you can define how many work items will be created for each alert. For all other alert types, one work item is created per alert.
    ...
    - If the work item type is **Incident**:
      <!-- convertborder later -->
      :::image type="content" source="media/itsmc-definition/itsm-action-incident.png" alt-text="Screenshot that shows the ITSM Ticket area with an incident work item type." border="false":::
    ...
    - If the work item type is **Event**:
        ...
        <!-- convertborder later -->
        :::image type="content" source="media/itsmc-definition/itsm-action-event.png" alt-text="Screenshot that shoes the ITSM Ticket section with an even work item type." border="false":::
    ...
    - If the work item type is **Alert**:
        ...
        <!-- convertborder later -->
        :::image type="content" source="media/itsmc-definition/itsm-action-alert.png" alt-text="Screenshot that shows the ITSM Ticket area with an alert work item type." border="false":::

...
You can query the alerts for their [essential](../alerts/alerts-common-schema-definitions.md#essentials) fields and [alert context](../alerts/alerts-common-schema-definitions.md#alert-context) fields.

...
Alerts consist of:
 - **Action groups**: These groups can trigger notifications to let users know that an alert has been triggered or an automated workflow. Action groups can include:

...
This article describes how to write and convert [log alert queries](./alert-type.md#log-alerts) to achieve optimal performance. Optimized queries reduce latency and load of alerts, which run frequently.

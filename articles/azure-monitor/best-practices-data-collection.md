...
See [Create diagnostic setting to collect resource logs and metrics in Azure](essentials/diagnostic-settings.md#create-diagnostic-setting) to create a diagnostic setting for an Azure resource. 

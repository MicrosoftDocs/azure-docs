...
Workbooks combine text, log queries, metrics, and parameters into rich interactive reports that allow you to analyze cluster performance. See [Workbooks in Azure Monitor for containers](container-insights-workbooks.md) for a description of the workbooks available for Azure Monitor for containers.

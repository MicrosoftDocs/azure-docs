...
|-----------------|-----------------|---------------|
|Node |This monitor is an aggregate of the all the node monitors. It is a worst of monitor, and its state is the worst state of its child monitors<br> Node CPU<br> Node Memory<br> Node Status | Worst of|

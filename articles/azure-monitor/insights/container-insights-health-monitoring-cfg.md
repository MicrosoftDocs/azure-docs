...
|Cluster (parent of nodes/<br> Kubernetes infrastructure) |This is the top level monitor that matches the state of the child monitor with the worst health state, that is kubernetes infrastructure and nodes. |Worst of |

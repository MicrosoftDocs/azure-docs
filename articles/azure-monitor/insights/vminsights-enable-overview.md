---
title: Deploy Azure Monitor for VMs (preview) overview | Microsoft Docs
...
To enable the Azure Monitor for VMs for the at-scale scenario, first configure the following in your Log Analytics workspace:

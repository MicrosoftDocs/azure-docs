...
- You must have a [Windows](../../azure-monitor/platform/agent-windows.md) or [Operations Manager](../../azure-monitor/platform/om-agents.md) agent on each DNS server that you want to monitor.

...
If you are utilizing [Prometheus metric scraping](container-insights-prometheus-integration.md), ensure you consider the following to limit the amount of metrics that you collect from your cluster:

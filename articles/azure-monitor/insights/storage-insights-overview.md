---
title: Monitor Azure Storage services with Azure Monitor for Storage (preview)| Microsoft Docs
...
When you select a value under any one of the columns in the workbook, you drill down to the **Capacity** workbook for the storage account. Further details about the drill-down report are described in the [Detailed storage KPI workbooks](#detailed-storage-workbooks) section below. 

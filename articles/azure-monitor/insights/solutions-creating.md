...
### Data sources
The first step in designing a solution is determining the data that you require from the Log Analytics repository.  This data may be collected by a [data source](../../log-analytics/log-analytics-data-sources.md) or [another solution]( solutions.md), or your solution may need to provide the process to collect it.

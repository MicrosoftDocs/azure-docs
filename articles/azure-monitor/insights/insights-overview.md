...
See [What is Application Insights?](../apps/app-insights-overview.md).
...
* Learn about the different [data sources used by Azure Monitor](data-sources.md) and the different kinds of data collected by each of the insights.

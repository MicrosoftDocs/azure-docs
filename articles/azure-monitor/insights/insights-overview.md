...
See [Azure Monitor for containers overview](./container-insights-overview.md).
...
See [Monitor resource groups with Azure Monitor (preview)](./resource-group-insights.md).

...
> [!CAUTION]
> Monitoring solutions are no longer in active development.  The replacement technology is called [Azure Monitor Insights](../monitor-reference.md#insights). We suggest you use the insights and not deploy new instances of solutions.  

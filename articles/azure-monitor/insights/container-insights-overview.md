...
- Windows doesn't have a Memory RSS metric and therefore isn't available for Windows node and containers.  Working Set is avalible.  Learn more about [memory management in windows](https://docs.microsoft.com/en-us/windows/win32/memory/working-set).

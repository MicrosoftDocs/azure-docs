...
## Why am I not seeing data if Log Analytics workspace is configured with the Free pricing tier? 

You may have reached the default 500 MB limit or specified a daily cap to control the amount of data to collect daily. To check and manage your data usage, see [Log data usage and cost](../platform/manage-cost-storage.md). 

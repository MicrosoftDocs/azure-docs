...
* Add the VMware Monitoring solution to your subscription using the process described in [Install a management solution](../../azure-monitor/insights/solutions.md#install-a-monitoring-solution).

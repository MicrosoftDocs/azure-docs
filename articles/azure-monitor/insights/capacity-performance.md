...
|---|---|---|
| [Windows agents](../../log-analytics/log-analytics-agent-windows.md) | Yes | The solution collects capacity and performance data information from Windows agents. |
...
| [Azure storage account](../../log-analytics/log-analytics-azure-storage.md) | No | Azure storage does not include capacity and performance data.|

...
## Structure
The basic structure of a management solution file is the same as a [Resource Manager Template](../../azure-resource-manager/templates/template-syntax.md#template-format), which is as follows.  Each of the sections below describes the top-level elements and their contents in a solution.  
...
## Resources
[Resources](../../azure-resource-manager/templates/template-syntax.md#resources) define the different resources that your management solution will install and configure.  This will be the largest and most complex portion of the template.  You can get the structure and complete description of resource elements in [Authoring Azure Resource Manager templates](../../azure-resource-manager/templates/template-syntax.md#resources).  Different resources that you will typically define are detailed in other articles in this documentation. 

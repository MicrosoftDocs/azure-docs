...
Azure Monitor is enabled the moment that you create an Azure subscription and is integrated into the Azure portal with your other services. Resource owners can access the 


 The **Overview** page for many services will include performance charts that are populated by data from Azure Monitor.

Open the [Activity log](essentials/activity-log.md) from a virtual machine to see when it was last stopped or started. 

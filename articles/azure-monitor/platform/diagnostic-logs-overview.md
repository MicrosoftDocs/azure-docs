...
![Diagnostic Logs blade in the portal](./media/diagnostic-logs-overview/diagnostic-settings-nav.png)
...
* [Analyze logs from Azure storage with Azure Monitor](../../azure-monitor/platform/collect-azure-metrics-logs.md)

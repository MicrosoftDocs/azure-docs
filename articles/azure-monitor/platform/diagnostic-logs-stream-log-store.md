...
#### Azure Data Factory  
Azure Data Factory, due to a very detailed set of logs, is a resource that is known to be particularly impacted by this limit. In particular, for any Diagnostic Settings configured before the Resource Specific mode was enabled or explicitly choosing to use the Resource Specific mode for reverse-compatibility reasons:  

...
On the Azure Portal, open your Workspace' menu and select *Linked storage accounts*. This will display the use cases mentioned above (Ingestion over Private Link, applying CMK to saved queries or to alerts).

...
* Outbound port 5671 and 5672 must typically be opened on the compouter or VNET consuming data from the event hub.
...
| [Azure resources](data-sources.md#azure-resources) | Platform metrics<br>Diagnostic logs |Both types of data are sent to an event hub using a resource diagnostic setting. See [Stream Azure Diagnostic logs to an event hub](diagnostic-logs-stream-event-hubs.md) for details. |

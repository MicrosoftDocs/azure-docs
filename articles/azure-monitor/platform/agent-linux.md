...
- [Connect Linux computers to Azure Monitor](#connect-linux-computers-to-azure-monitor)
  - [Agent install package](#agent-install-package)
    - [Agent installation details](#agent-installation-details)
  - [Obtain workspace ID and key](#obtain-workspace-id-and-key)
  - [Install the agent manually](#install-the-agent-manually)
  - [Install the agent using wrapper script](#install-the-agent-using-wrapper-script)

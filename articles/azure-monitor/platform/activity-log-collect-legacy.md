...
# Collect or export Azure Activity log (legacy)

> [!NOTE]
> This article describes the legacy method for configuring the Azure Activity log to be collected in Log Analytics workspace, Azure storage, or Azure Event Hubs. You can now collect the Activity log using a diagnostic setting similar to how you collect resource logs. See [Collect and analyze Azure activity logs in Log Analytics workspace in Azure Monitor](activity-log-collect.md).
...
## Archive Activity Log to storage

...
| Hybrid Linux computer| [Manual install](agent-linux.md)|Install the agent for Linux calling a wrapper-script hosted on GitHub or manually download and install the agent. | 

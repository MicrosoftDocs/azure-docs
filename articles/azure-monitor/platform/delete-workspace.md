...
* If you aren't sure if deleted workspace is in soft-delete state and can be recovered, click [Recover](#recover-workspace) in Log Analytics workspaces page to see a list of soft-deleted workspaces per subscription

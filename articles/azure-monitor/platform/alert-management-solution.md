...
> [!NOTE]
>  Azure Monitor now supports enhanced capabilities for [managing your alerts at scale](./alerts-overview.md), including those generated by [monitoring tools like System Center Operations Manager, Zabbix, or Nagios](./alerts-managing-nagios-zabbix-scom.md?toc=%252fazure%252fazure-monitor%252ftoc.json).
>  

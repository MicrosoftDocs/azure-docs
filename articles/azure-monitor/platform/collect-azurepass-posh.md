...
>
To install the latest version of the Azure Resource Manager modules on your computer, see [Install and configure Azure PowerShell](https://docs.microsoft.com/powershell/azure/azurerm/install-Az-ps?view=azurermps-4.4.1#update-azps).  
...
3. Run `Connect-AzAccount` to create a connection with Azure.   

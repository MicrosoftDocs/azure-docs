...
When a new type of custom data is created from a [custom log](../../log-analytics/../../azure-monitor/platform/data-sources-custom-logs.md) or the [Data Collector API](../../log-analytics/data-collector-api.md), the system creates a dedicated storage container. This is a one-time overhead that occurs only on the first appearance of this data type.

---
title: How to remove the ITSM connector and its action groups
description: This article provides an explanation about how to remove the ITSM connector and its action groups.
ms.subservice: logs
ms.topic: conceptual
author: nolavime
ms.author: v-jysur
...
# Deletion of ITSM connector

In order to delete action group

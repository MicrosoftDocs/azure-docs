...
![Diagram shows servers hosting line of business application and SQL Server associated with central-it-default and lob-app and with central-it-default and sql, respectively.](media/data-collection-rule-azure-monitor-agent/associations.png)

...
- See [Overview of Log Analytics in Azure Monitor](/log-query/log-analytics-overview) for a description of Log Analytics. 
- See [Log Analytics tutorial](/log-query/log-analytics-tutorial) to walk through using Log Analytics features to create a simple log query and analyze its results.

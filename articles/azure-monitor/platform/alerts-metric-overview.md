...
- Aggregation type (a statistic that is run over raw metric values. [Supported time aggregations](metrics-aggregation-explained#aggregation-types) are Minimum, Maximum, Average, Total, Count): Average

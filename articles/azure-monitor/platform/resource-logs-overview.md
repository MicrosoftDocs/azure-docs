...
|:---|:---|:---|
| [Log Analytics workspace](resource-logs-collect-storage.md) | Analyze the logs with other monitoring data and leverage Azure Monitor features such as log queries and alerts. |

...
Learn how to [add role assignments to the storage account](/azure/app-testing/playwright-workspaces/quickstart-advanced-diagnostic-with-playwright-workspaces-reporting?tabs=newworkspace%2Cplaywrightcli#add-role-based-access-control-rbac-roles-for-the-linked-storage-account-1).
...
Reporting isn't enabled for this Playwright Workspace. Learn how to [enable reporting in your Playwright Workspace](/azure/app-testing/playwright-workspaces/quickstart-advanced-diagnostic-with-playwright-workspaces-reporting?tabs=newworkspace%2Cplaywrightcli#enable-reporting-and-link-a-storage-account-to-a-workspace).
...
The trace viewer url isn't accessible from the storage account. Learn how to [allow-list the url in the storage account](/azure/app-testing/playwright-workspaces/quickstart-advanced-diagnostic-with-playwright-workspaces-reporting?tabs=newworkspace%2Cplaywrightcli#only-if-trace-is-enabled-allow-list-public-trace-viewer-in-the-linked-storage-account).

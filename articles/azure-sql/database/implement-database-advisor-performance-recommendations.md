...
![Performance overview for Azure SQL Database](./media/implement-database-advisor-performance-recommendations/performance-overview-annotated.png)

- The **Recommendations** tile provides a breakdown of tuning recommendations for your database (top three recommendations are shown if there are more). Clicking this tile takes you to **[Performance recommendation options](find-apply-database-advisor-recommendations-portal.md#viewing-recommendations)**.
...
- The **Auto-tuning** tile shows the **[auto-tuning configuration](enable-automatic-tuning.md)** for your database (tuning options that are automatically applied to your database). Clicking this tile opens the automation configuration dialog.
...
![Performance recommendations for Azure SQL Database](./media/implement-database-advisor-performance-recommendations/performance-recommendations-annotated.png)

To apply performance recommendations, see [applying recommendations](find-apply-database-advisor-recommendations-portal.md#applying-recommendations). To view the status of recommendations, see [Monitoring operations](find-apply-database-advisor-recommendations-portal.md#monitoring-operations).

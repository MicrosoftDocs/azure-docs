...
|[sys.event_log (Azure SQL Database)](/sql/relational-databases/system-catalog-views/sys-event-log-azure-sql-database)|Returns successful Azure SQL Database database connections and connection failures for Azure SQL Database. You can use this information to track or troubleshoot your database activity.|
|[sys.fn_xe_file_target_read_file (Azure SQL Database)](/sql/relational-databases/system-functions/sys-fn-xe-file-target-read-file-transact-sql)| Returns information for deadlocks for Azure SQL Database. Learn to [Analyze and prevent deadlocks in Azure SQL Database](analyze-prevent-deadlocks.md). |

...
* Learn how to [create a web application that connects to an Azure SQL Database on the back-end](../../app-service/app-service-web-tutorial-dotnet-sqldatabase.md).

...
![Recommendations](./media/find-apply-database-advisor-recommendations-portal/recommendations.png)
...
![Create index](./media/find-apply-database-advisor-recommendations-portal/sql-database-performance-recommendation.png)
...
2. On the **Details** page, click **Apply** button.
   ...
   ![Apply recommendation](./media/find-apply-database-advisor-recommendations-portal/apply.png)
...
1. On the **Recommendations** page, click **Automate**:
   ...
   ![Advisor settings](./media/find-apply-database-advisor-recommendations-portal/settings.png)
2. Select actions to automate:

   ![Recommended Indexes](./media/find-apply-database-advisor-recommendations-portal/server.png)
...
![Recommended Indexes](./media/find-apply-database-advisor-recommendations-portal/operations.png)
...
![Recommended Indexes](./media/find-apply-database-advisor-recommendations-portal/details.png)

## Monitoring performance impact of index recommendations

After recommendations are successfully implemented (currently, index operations and parameterize queries recommendations only), you can click **Query Insights** on the recommendation details page to open [Query Performance Insights](../../sql-database/sql-database-query-performance.md) and see the performance impact of your top queries.

![Monitor performance impact](./media/find-apply-database-advisor-recommendations-portal/query-insights.png)

...
See [Monitoring Azure SQL Database](monitoring-sql-database-azure-monitor.md) for details on collecting and analyzing monitoring data for Azure SQL Database with Azure Monitor.
...
This section lists all the automatically collected platform metrics collected for Azure SQL Database.  
...
<!-- Add additional explanation of reference information as needed here. Link to other articles such as your Monitor Azure SQL Database article as appropriate. -->
...
Azure SQL Database does not have any metrics that contain dimensions.

*OR*

Azure SQL Database has the following dimensions associated with its metrics.
...
This section lists all the resource log category types collected for Azure SQL Database.  

...
| [Azure Web App and Redis Cache with SQL Database](https://github.com/Azure/azure-quickstart-templates/tree/master/201-web-app-redis-cache-sql-database) | This template creates a web app, Redis Cache, and SQL Database instance in the same resource group and creates two connection strings in the web app for the SQL Database instance and Redis Cache.|

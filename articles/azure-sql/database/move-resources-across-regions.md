...
> [!NOTE]
> To move Azure SQL databases and elastic pools to a different Azure region, you can also use Azure Resource Mover (in preview). Refer [this tutorial](https://docs.microsoft.com/en-us/azure/resource-mover/tutorial-move-region-sql) for detailed steps to do the same.

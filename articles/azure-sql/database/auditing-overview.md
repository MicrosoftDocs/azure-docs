...
- Audit logs are .xel format and can be opened with SQL Server Management Studio (SSMS), [available for download here](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms)

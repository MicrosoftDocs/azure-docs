...
In part three of this three-part tutorial series, you'll deploy a clustering model, developed in R, into a database in Azure SQL Database using Azure SQL Database Machine Learning Services (preview).
...
In [part two](clustering-model-build-tutorial.md), you learned how to create and train a K-Means clustering model in R.

## Prerequisites

* Part three of this tutorial series assumes you have completed [**part one**](clustering-model-prepare-data-tutorial.md) and [**part two**](clustering-model-build-tutorial.md).
...
* [Tutorial: Prepare data to train a predictive model in R with Azure SQL Database Machine Learning Services (preview)](predictive-model-prepare-data-tutorial.md)

...
To migrate a database into an [Azure SQL Managed Instance](../../sql-database/sql-database-managed-instance.md) from a BACPAC file, use SQL Server Management Studio or SQLPackage, using the Azure portal or Azure PowerShell is not currently supported.
...
> [!IMPORTANT]
> To connect to Azure SQL Database from behind a corporate firewall, the firewall must have port 1433 open. To connect to SQL Managed Instance, you must have a [point-to-site connection](../../sql-database/sql-database-managed-instance-configure-p2s.md) or an express route connection.
...
> [!NOTE]
> [A SQL Managed Instance](../../sql-database/sql-database-managed-instance.md) does not currently support migrating a database into an instance database from a BACPAC file using Azure PowerShell. To import into a SQL Managed Instance, use SQL Server Management Studio or SQLPackage.
...
- To learn how to connect to and query an Azure SQL Database, see [Quickstart: Azure SQL Database: Use SQL Server Management Studio to connect and query data](connect-query-ssms.md).

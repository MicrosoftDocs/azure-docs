...
- [SQL Server Data Tools in Visual Studio](https://docs.microsoft.com/sql/ssdt/download-sql-server-data-tools-ssdt):
  ...
  A free, downloadable client application for developing SQL Server relational databases, databases in SQL Database, Integration Services packages, Analysis Services data models, and Reporting Services reports.

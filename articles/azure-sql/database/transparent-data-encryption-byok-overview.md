...
To learn more about backup recovery for SQL Database, see [Recover a database in SQL Database](recovery-using-backups.md). To learn more about backup recovery for SQL Pool, see [Recover a SQL Pool](../../synapse-analytics/sql-data-warehouse/backup-and-restore.md). For SQL Server's native backup/restore with a managed instance, see [Quickstart: Restore a database to a managed instance](../managed-instance/restore-sample-database-quickstart.md)

...
Enable Azure Defender by navigating to **Azure Defender for SQL** under the **Security** heading for your server or managed instance.
...
![Enable Azure Defender](./media/advanced-data-security/enable_ads.png)

...
In [part one](tutorial-clustering-model-prepare-data.md), you learned how to prepare the data from an Azure SQL database to perform clustering.
...
* Part two of this tutorial assumes you have completed [**part one**](tutorial-clustering-model-prepare-data.md) and its prerequisites.
...
![Elbow graph](./media/tutorial-clustering-model-build/elbow-graph.png)
...
The four cluster means are given using the variables defined in [part one](tutorial-clustering-model-prepare-data.md#separate-customers):
...
> [Tutorial: Deploy a clustering model in R with Azure SQL Database Machine Learning Services (preview)](tutorial-clustering-model-deploy.md)

...
description: You can enable automatic tuning on your Azure SQL Database easily using the Azure portal.
...
- The [Azure portal](enable-automatic-tuning.md#azure-portal
- [REST API](enable-automatic-tuning.md#rest-api) calls
...
![Server](./media/enable-automatic-tuning/server.png)
...
![Database](./media/enable-automatic-tuning/database.png)

...
>
> For Azure Synapse Analytics dedicated SQL pool limits, see [capacity limits](../synapse-analytics/sql-data-warehouse/sql-data-warehouse-service-capacity-limits.md) and [memory and concurrency limits](../synapse-analytics/sql-data-warehouse/memory-concurrency-limits).

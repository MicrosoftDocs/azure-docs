...
|[Monitor with Azure Monitor logs](../../sql-database/saas-dbpertenant-log-analytics.md) | Learn how to use [Azure Monitor logs](../log-analytics/log-analytics-overview.md) to monitor large amounts of resources across multiple pools. |

...
> * The storage account must be on the same tenant and at the same location as the [logical SQL Server](logical-servers.md) (it is ok to be on different subscriptions).

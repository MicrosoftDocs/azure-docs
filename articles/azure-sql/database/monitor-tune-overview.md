...
[Query Performance Insight](query-performance-use.md) shows the performance in the Azure portal of top consuming and longest running queries for single and pooled databases.

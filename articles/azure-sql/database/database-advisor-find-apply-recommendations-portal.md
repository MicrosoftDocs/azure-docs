...
![Recommendations](./media/database-advisor-find-apply-recommendations-portal/recommendations.png)
...
![Create index](./media/database-advisor-find-apply-recommendations-portal/sql-database-performance-recommendation.png)
...
2. On the **Details** page, click **Apply** button.
   ...
   ![Apply recommendation](./media/database-advisor-find-apply-recommendations-portal/apply.png)
...
1. On the **Recommendations** page, click **Automate**:
   ...
   ![Advisor settings](./media/database-advisor-find-apply-recommendations-portal/settings.png)
2. Select actions to automate:

   ![Recommended Indexes](./media/database-advisor-find-apply-recommendations-portal/server.png)
...
![Recommended Indexes](./media/database-advisor-find-apply-recommendations-portal/operations.png)
...
![Recommended Indexes](./media/database-advisor-find-apply-recommendations-portal/details.png)
...
![Monitor performance impact](./media/database-advisor-find-apply-recommendations-portal/query-insights.png)

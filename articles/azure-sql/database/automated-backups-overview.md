...
|---|---|---|
| **Change backup retention** | [SQL Database](#change-the-short-term-retention-policy-using-the-azure-portal?tabs=sql-database) <br/> [SQL Managed Instance](#change-the-short-term-retention-policy-using-the-azure-portal?tabs=sql-managed-instance) | [SQL Database](#change-the-short-term-retention-policy-using-powershell?tabs=sql-database) <br/>[SQL Managed Instance](#change-the-short-term-retention-policy-using-powershell?tabs=sql-managed-instance) |

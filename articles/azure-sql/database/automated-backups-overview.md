...
| **Use to create new database in another region** | Not Supported | Supported in any Azure region | Supported in any Azure region via PowerShell/REST API/ Azure CLI. |

...
For available service tiers and limits for each resource model, see the [DTU-based purchasing model](../../sql-database/sql-database-service-tiers-dtu.md) or the [vCore-based purchasing model](../../sql-database/sql-database-service-tiers-vcore.md).
...
- **Point-in-time restore**
  ...
  Point-in-time restore uses automatic database backups to recover a database in a pool to a specific point in time. See [Point-In-Time Restore](../../sql-database/sql-database-recovery-using-backups.md#point-in-time-restore)

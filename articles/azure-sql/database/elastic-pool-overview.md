...
For available service tiers and limits for each resource model, see the [DTU-based purchasing model](dtu-service-tiers.md) or the [vCore-based purchasing model](../../sql-database/sql-database-service-tiers-vcore.md).

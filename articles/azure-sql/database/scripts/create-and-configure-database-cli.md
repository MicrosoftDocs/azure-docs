...
:::code language="code-azurecli-interactive" source="~/azure_cli_scripts/sql-database/create-and-configure-database/create-and-configure-database.sh" range="3-150":::

### Run the script 2

:::code language="!code-azurecli-interactive[main]" source="~/cli_scripts/sql-database/create-and-configure-database/create-and-configure-database.sh" range="3-6" highlight="8,12":::

...
- Set up Data Sync
    ...
    - With PowerShell
        - [Use PowerShell to sync between Azure SQL Database and SQL Server](sql-data-sync-sync-data-between-azure-onprem.md)
...
- Update the sync schema
    - With Transact-SQL - [Automate the replication of schema changes SQL Data Sync in Azure](../sql-data-sync-update-sync-schema.md)

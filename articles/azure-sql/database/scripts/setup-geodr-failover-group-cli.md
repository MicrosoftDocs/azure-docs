...
| [az sql failover-group set-primary](/cli/azure/sql/failover-group#az-sql-failover-group-create) | Set the primary of the failover group by failing over all databases from the current primary server |

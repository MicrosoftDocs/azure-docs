...
![replication with SQL Database](./media/transactional-replication-overview/replication-to-sql-database.png)
...
![Single instance as Publisher and Distributor](./media/transactional-replication-overview/01-single-instance-asdbmi-pubdist.png)
...
![Separate instances for Publisher and Distributor](./media/transactional-replication-overview/02-separate-instances-asdbmi-pubdist.png)
...
![Azure SQL Database as subscriber](./media/transactional-replication-overview/03-azure-sql-db-subscriber.png)

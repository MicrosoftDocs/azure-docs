...
Once you've added these metrics, you can continue to view them in the **Monitoring** chart with more information on the **Metric** window. All four metrics show the average utilization percentage relative to the **DTU** of your database. See the [DTU-based purchasing model](../../sql-database/sql-database-service-tiers-dtu.md) and [vCore-based purchasing model](../../sql-database/sql-database-service-tiers-vcore.md) articles for more information about service tiers.  
...
For a comprehensive set of recommendations for tuning performance issues, see: [Tune your database](../../sql-database/sql-database-performance-guidance.md#tune-your-database).

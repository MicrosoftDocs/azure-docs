...
The following features are enabled in the SQL Managed Instance deployment model in H1 2019:
  ...
  - Create instances of SQL Managed Instance with <a href="https://aka.ms/managed-instance-collation">instance-level collation</a> and <a href="https://azure.microsoft.com/updates/managed-instance-time-zone-ga/">time zone</a> of your choice.
  - Instances of SQL Managed Instance are now protected with [built-in firewall](../managed-instance/management-endpoint-verify-built-in-firewall.md).

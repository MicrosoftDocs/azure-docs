...
In [part two](tutorial-predictive-model-build-compare.md), you'll learn how to create and train multiple machine learning models in R, and then choose the most accurate one.
...
> [Tutorial: Create a predictive model in R with Azure SQL Database Machine Learning Services (preview)](tutorial-predictive-model-build-compare.md)

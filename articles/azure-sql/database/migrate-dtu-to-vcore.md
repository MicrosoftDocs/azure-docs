...
This article describes how to migrate your Azure SQL Database from the [DTU-based purchasing model](dtu-service-tiers.md) to the [vCore-based purchasing model](service-tiers-vcore.md). 

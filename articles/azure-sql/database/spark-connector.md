...
The following diagram illustrates the data flow.
   ...
   ![Diagram shows the described flow, with a master node connecting directly to the database and connecitng to three worker nodes, which connect to the database.](./media/spark-connector/architecture.png)

...
|Availability|1 replica, no read-scale replicas, <br/>zone-redundant high availability (HA) (public preview)|3 replicas, 1 [read-scale replica](read-scale-out.md),<br/>zone-redundant high availability (HA)|1 read-write replica, plus 0-4 [read-scale replicas](read-scale-out.md)|

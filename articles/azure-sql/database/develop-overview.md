...
> [!TIP]
> Look at the getting started guides for [Azure SQL Database](quickstart-content-reference-guide.md) and [Azure SQL Managed Instance](../managed-instance/quickstart-content-reference-guide.md) if you need to set up your database.
>
...
Access to Azure SQL Database is protected with logins and firewalls. Azure SQL Database supports both SQL Server and [Azure Active Directory (Azure AD) authentication](aad-authentication-overview.md) users and logins. Azure AD logins are available only in SQL Managed Instance. 

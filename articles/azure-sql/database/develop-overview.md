...
- For networking configuration for a SQL Managed Instance, see [network configuration for SQL Managed Instances](../../sql-database/sql-database-howto-managed-instance.md#network-configuration).

## Next steps

Explore all the [capabilities of SQL Database](../../sql-database/sql-database-technical-overview.md).

...
---
  ...
  | Get connection information | [Azure SQL](../database/connect-query-content-reference-guide#get-server-connection-information)|[Azure SQL](../database/connect-query-content-reference-guide#get-server-connection-information)|||
  |||||

...
|[Oracle to SQL MI - Database Compare utility](https://www.microsoft.com/en-us/download/details.aspx?id=103016)|SSMA for Oracle Tester is the recommended tool to automatically validate the database object conversion, data migration and it is a superset of Data Compare functionality.
If you are looking for an alternative data validation mechanism, Data Compare utility enables you to compare data down to the row/column level in all or selected tables, rows, and column.|

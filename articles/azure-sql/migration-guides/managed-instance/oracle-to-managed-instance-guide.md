...
1. In SSMA for oracle, select Tester followed by New Test Case.
 ![Screenshot that shows new test case.](./media/oracle-to-managed-instance-guide/ssma_tester_new.PNG)
...
Description: Enter any additional information to identify the purpose of the test case.
 ![Screenshot - Initialize a test case .](./media/oracle-to-managed-instance-guide/tester_init_test_case.PNG)

3.In the Oracle object tree located on the left side, select the objects you want to evaluate  during the testing process.
 ![Screenshot - select and configure object .](./media/oracle-to-managed-instance-guide/tester_Select_configure_objects.png)
...
![Screenshot - select and configure affected object .](./media/oracle-to-managed-instance-guide/tester_select_configure_affected.PNG)
...
![Screenshot - ordering object .](./media/oracle-to-managed-instance-guide/test_call_ordering.png)
...
![Screenshot - finalize object .](./media/oracle-to-managed-instance-guide/tester_finalize_case.PNG)
...
![Screenshot - test repo .](./media/oracle-to-managed-instance-guide/tester_test_repo.PNG)
...
![Screenshot - test repo view .](./media/oracle-to-managed-instance-guide/tester_repo_run.PNG)

2.Next, it  will launch run Test case page. Click run.

![Screenshot - test launch .](./media/oracle-to-managed-instance-guide/tester_run_test_case.png)

3.Next, you would be prompted to provide source oracle credentials. Click connect after entering the credentials.

![Screenshot - oracle connect .](./media/oracle-to-managed-instance-guide/tester_oracle_connect.png)

4.In the next step, you need to  provide target SQL Server credentials. Click connect after entering the user details.

![Screenshot - sql target connect .](./media/oracle-to-managed-instance-guide/tester_sqlmi_connect.PNG)
...
![Screenshot - tester test progress .](./media/oracle-to-managed-instance-guide/tester_run_status.png)
...
![Screenshot - tester test report.](./media/oracle-to-managed-instance-guide/tester_test_result.png)

7.Click details to get more information.

![Screenshot - tester success report.](./media/oracle-to-managed-instance-guide/tester_test_success.png)

Example of positive data validation.

![Screenshot - tester failure report.](./media/oracle-to-managed-instance-guide/tester_test_failed.png)

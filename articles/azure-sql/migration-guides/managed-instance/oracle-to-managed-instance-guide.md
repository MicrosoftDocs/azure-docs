...
To migrate your Oracle database to SQL Managed Instance you need: 
...
| [Steps to Run SSMA for Oracle](https://aka.ms/dmj-wp-ssma-oracle-steps)                                                                                 | This document is designed as a Quick Start Guide for migrating the schema and data from Oracle to Azure SQL Managed Instance by using SSMA for Oracle v7.6.0.                                                                                                                                                                                                                                                 |
| [Steps to Run Attunity Replicate for Microsoft Migrations](https://aka.ms/dmj-wp-attunity)                                                              | This document is designed as a Quick Start Guide for migrating the schema and data from Oracle to Azure SQL Managed Instance by using Attunity Replicate for Microsoft Migrations tool.                                                                                                                                                                                                                       |

...
|[Oracle to SQL DB - Database Compare utility](https://www.microsoft.com/en-us/download/details.aspx?id=103016)|SSMA for Oracle Tester is the recommended tool to automatically validate the database object conversion, data migration and it is a superset of Data Compare functionality.

---
title: "SQL Server to SQL Database - Performance analysis"
description: Learn to create and compare a performance baseline when migrating your SQL Server databases to Azure SQL Database. 
...
ms.date: 08/25/2020
---
# Migration performance: SQL Server to SQL Database performance analysis
[!INCLUDE[appliesto-sqldb-sqlmi](../../includes/appliesto-sqlmi.md)]

Create a performance baseline to compare the performance of your workload on a SQL Database with your original workload running on SQL Server. 
...
SQL Database has a built-in automatic plan correction feature that is enabled by default. This feature ensures that queries that worked fine in the past do not degrade in the future. If this feature is not enabled, run the workload with the old settings so SQL Database can learn the performance baseline. Then, enable the feature and run the workload again with the new settings. 
...
SQL Database provides advanced tools for monitoring and troubleshooting, and you should use them to monitor performance on your instance. Some of the key metrics to monitor are: 
...
For more information to optimize your new Azure SQL Database environment, see the following resources: 

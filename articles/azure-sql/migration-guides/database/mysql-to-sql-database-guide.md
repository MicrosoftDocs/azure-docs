...
In this guide, you learn [how to migrate](https://azure.microsoft.com/en-us/migration/migration-journey) your MySQL database to an Azure SQL database by using using [SQL Server Migration](https://azure.microsoft.com/en-us/migration/migration-journey) Assistant for MySQL (SSMA for MySQL). 
...
- For more [cloud migration resources](https://azure.microsoft.com/en-us/migration/resources/), see [cloud migration solutions](https://azure.microsoft.com/en-us/migration).

...
In this guide, you learn [how to migrate](https://azure.microsoft.com/en-us/migration/migration-journey) your SQL Server instance to Azure SQL Database. 
...
For your [SQL Server migration](https://azure.microsoft.com/en-us/migration/migration-journey) to Azure SQL Database, make sure you have the following prerequisites: 
...
After you've verified that your source environment is supported, start with the pre-migration stage. Discover all of the existing data sources, assess migration feasibility, and identify any blocking issues that might prevent your [Azure cloud migration](https://azure.microsoft.com/en-us/migration).
...
- To learn more about [Azure Migrate](https://azure.microsoft.com/en-us/services/azure-migrate) see

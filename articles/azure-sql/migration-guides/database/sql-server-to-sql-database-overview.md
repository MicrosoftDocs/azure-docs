...
Be sure to review the SQL Server database engine features [available in Azure SQL Database](../../database/features-comparison.md) to confirm the supportability of your migration target.  

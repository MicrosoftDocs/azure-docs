...
In this guide, you learn [how to migrate](https://azure.microsoft.com/en-us/migration/migration-journey) your Microsoft Access database to an Azure SQL database by using [SQL Server Migration](https://azure.microsoft.com/en-us/migration/migration-journey) Assistant for Access (SSMA for Access).

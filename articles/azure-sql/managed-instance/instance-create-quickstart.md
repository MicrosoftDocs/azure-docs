...
> [!IMPORTANT]
> For limitations, see [Supported regions](../../azure-netapp-files/resource-limits.md#supported-regions) and [Supported subscription types](../../azure-netapp-files/resource-limits.md#supported-subscription-types).
...
1. Select **Create**.
   ...
   ![Create a SQL Managed Instance](./media/instance-create-quickstart/create-managed-instance.png)
...
- Fill out mandatory information required on the **Basics** tab. This is a minimum set of information required to provision a SQL Managed Instance.
   ...
   | **Password** | Any valid password.| The password must be at least 16 characters long and meet the [defined complexity requirements](../../active-directory-b2c/faq.md#what-are-the-password-requirements-when-creating-a-vm).|
...
- Fill out optional information on the **Networking** tab. If you omit this information, the portal will apply default settings.
   ...
   !["Networking" tab for creating a SQL Managed Instance](./media/instance-create-quickstart/mi-create-tab-networking.png)
...
- Fill out optional information on the **Additional settings** tab. If you omit this information, the portal will apply default settings.
   ...
   !["Additional settings" tab for creating a SQL Managed Instance](./media/instance-create-quickstart/mi-create-tab-additional-settings.png)
...
1. Select **Review + create** tab to review your choices before you create the SQL Managed Instance.
   ...
   ![Tab for reviewing and creating a SQL Managed Instance](./media/instance-create-quickstart/mi-create-tab-review-create.png)
...
1. Return to the resource group and select your SQL Managed Instance.
   ...
   ![SQL Managed Instance in the resource group](./media/instance-create-quickstart/managed-instance.png)

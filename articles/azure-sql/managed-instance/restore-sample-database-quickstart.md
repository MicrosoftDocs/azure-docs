...
- Requires using SSMS to connect to your SQL Managed Instance. See these quickstarts on how to connect:
  - [Enable public endpoint](public-endpoint-configure.md) on SQL Managed Instance - this is recommended approach for this tutorial.
  - [Connect to an SQL Managed Instance from an Azure VM](connect-vm-instance-configure.md)
  - [Configure a point-to-site connection to an SQL Managed Instance from on-premises](point-to-site-p2s-configure.md).

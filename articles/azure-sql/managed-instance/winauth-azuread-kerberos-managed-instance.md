...
## Enable system assigned service principal

## Configure KDC proxy 

The following steps are only required for Active Directory Joined VMs.

### Configure KDC proxy registry value

### Configure KDC proxy using Group Policy

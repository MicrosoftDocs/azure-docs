...
> [!IMPORTANT]
> For limitations, see [supported regions](../../../sql-database/sql-database-managed-instance-resource-limits.md#supported-regions) and [supported subscription types](../../../sql-database/sql-database-managed-instance-resource-limits.md#supported-subscription-types).

...
If you encounter out of memory errors in Azure SQL Managed Instance, you will find them logged in [sys.dm_os_out_of_memory_events](/sql/relational-databases/system-dynamic-management-views/sys-dm-os-out-of-memory-events).

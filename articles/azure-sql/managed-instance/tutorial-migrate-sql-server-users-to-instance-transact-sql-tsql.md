...
- An existing SQL Managed Instance. See [Quickstart: Create a SQL Managed Instance](quickstart-create-instance.md).
...
Follow our [Quickstart: Restore a database to a SQL Managed Instance](quickstart-restore-sample-database.md).

...
![Replication between a SQL MI pub, SQL MI Dist, and a SQL Server sub](./media/replication-two-instances-and-sql-server-configure-tutorial/sqlmi-to-sql-replication.png)
...
For more information about deploying a SQL Server VM to Azure, see [Quickstart: Create SQL Server VM](../virtual-machines/windows/sql-vm-create-portal-quickstart.md).
...
1. Provide the name of your SQL Server VM as well as the private internal IP address.
   ...
   ![Configure A record](./media/replication-two-instances-and-sql-server-configure-tutorial/configure-a-record.png)

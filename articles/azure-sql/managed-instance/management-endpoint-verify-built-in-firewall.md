...
For more information about SQL Managed Instances and connectivity, see [Azure SQL Database Managed Instance Connectivity Architecture](connectivity-architecture-overview.md).
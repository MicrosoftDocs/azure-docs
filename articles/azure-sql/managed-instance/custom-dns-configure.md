...
- For a tutorial showing you how to create a new Managed Instance, see [Creating a Managed Instance](../../sql-database/sql-database-managed-instance-get-started.md).

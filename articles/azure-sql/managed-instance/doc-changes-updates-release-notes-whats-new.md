...
| [Move instance to different subnet](vnet-subnet-move-instance.md)| Move SQL Managed Instance to a different subnet using the Azure portal, Azure PowerShell or the Azure CLI.  |

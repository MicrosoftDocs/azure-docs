...
| [Link feature](managed-instance-link-feature-overview.md)| Online replication of SQL Server databases hosted anywhere to Azure SQL Managed Instance. |
...
| **Link feature guidance** | We've published a number of guides for using the [link feature](managed-instance-link-feature-overview.md) with SQL Managed Instance, including how to [prepare your environment](managed-instance-link-preparation.md), [configure replication](managed-instance-link-use-ssms-to-replicate-database.md), [failover your database](managed-instance-link-use-ssms-to-failover-database.md), and some [best practices](managed-instance-link-best-practices.md) when using the link feature. |

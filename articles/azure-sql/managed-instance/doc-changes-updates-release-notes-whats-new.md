...
| Feature | Details |
| ---| --- |
| [Distributed transactions](../database/elastic-transactions-overview.md) | Execute distributed transactions across cloud databases in Azure SQL Managed Instance. |
...
| ---| --- |--- |
| [16 TB support in General Purpose](resource-limits.md)| November 2021 | Support for allocation up to 16 TB of space for SQL Managed Instance in the General Purpose tier. |
...
| Changes | Details |
| --- | --- |
|**16 TB support for General Purpose** | Deploying a 16 TB instance to the General Purpose service tier is now generally available.  See [resource limits](resource-limits.md) to learn more. | 
| **Azure AD-only authentication** |  Restricting authentication to your Azure SQL Managed Instance only to Azure Active Directory users is now generally available. To learn more, see [Azure AD-only authentication](../database/authentication-azure-ad-only-authentication.md). | 
| | |
...
| **Azure AD-only authentication** | It's now possible to restrict authentication to your Azure SQL Managed Instance only to Azure Active Directory users. This feature is currently in preview. To learn more, see [Azure AD-only authentication](../database/authentication-azure-ad-only-authentication.md). | 
2| **Resource Health monitor** | Use Resource Health to  monitor the health status of your Azure SQL Managed Instance. See [Resource health](../database/resource-health-to-troubleshoot-connectivity.md) to learn more. |

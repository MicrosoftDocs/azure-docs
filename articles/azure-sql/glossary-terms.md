...
||vCore-based purchasing model|[vCore-based purchasing model](database/service-tiers-sqldb-vcore.md)|
...
|Service tier|Basic, Standard, Premium, General Purpose, Hyperscale, Business Critical|For service tiers in the vCore model, see [SQL Database service tiers](database/service-tiers-sqldb-vcore.md#service-tiers). For service tiers in the DTU model, see [DTU model](database/service-tiers-dtu.md#compare-the-dtu-based-service-tiers).|
|Compute tier|Serverless compute|[Serverless compute](database/service-tiers-sqldb-vcore.md#compute-tiers)
||Provisioned compute|[Provisioned compute](database/service-tiers-sqldb-vcore.md#compute-tiers)
|Compute generation|Gen5, M-series, Fsv2-series, DC-series|[Hardware generations](database/service-tiers-sqldb-vcore.md#hardware-generations)
...
|Purchasing model|vCore-based purchasing model|[vCore-based purchasing model](managed-instance/service-tiers-mi-vcore.md)|
...
|Compute tier|Provisioned compute|[Provisioned compute](managed-instance/service-tiers-mi-vcore.md#compute-tiers)|
|Compute generation|Gen5|[Hardware generations](managed-instance/service-tiers-mi-vcore.md#hardware-generations)

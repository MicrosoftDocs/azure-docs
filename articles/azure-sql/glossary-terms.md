...
| Pricing |  | Pricing for SQL Server on Azure VM is based on SQL Server licensing, operating system (OS), and virtual machine cost.  |
...
| Size | VM size | [VM size](/virtual-machines/windows/performance-guidelines-best-practices-vm-size.md) determines processing power, memory, and storage capacity. You can [collect a performance baseline](l/virtual-machines/windows/performance-guidelines-best-practices-collect-baseline.md) to help select the best VM size for your workload.  |

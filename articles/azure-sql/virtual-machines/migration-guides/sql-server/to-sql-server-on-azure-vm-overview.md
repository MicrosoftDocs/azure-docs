...
- **SQL Server Integration Services (SSIS)**: To migrate Integration Services please see [here](/sql/integration-services/install-windows/upgrade-integration-services).
- **SQL Server Reporting Services (SSRS)**: To migrate Reporting Services please see [here](/sql/reporting-services/install-windows/upgrade-and-migrate-reporting-services).
- **SQL Server Analysis Services (SSAS)**: To migrate Analysis Services please see [here](/sql/database-engine/install-windows/upgrade-analysis-services).

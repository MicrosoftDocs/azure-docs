...
To install DxEnterprise on the three Linux based nodes, please follow the DH2i DxEnterprise documentation based on the Linux operating system you choose. You need to install DxEnterprise using any one of the method listed below.
...
 
In this step, we are going to create a virtual host, availability group, and then add a database, all using the DxAdmin UI.   
 
> [!NOTE]
...
After this step, you should have a availability group listener created and mapped to the Internal Azure load balancer.
 
...
1. Expand the Vhost for the Availability Group
1. Right-click on the target node/secondary replica and select Start Hosting on Member to initiate the failover 
 
For more information on additional operations within DxEnterprise, access the [DxEnterprise Admin Guide](https://dh2i.com/wp-content/uploads/DxEnterprise-v20-Admin-Guide.pdf).

## Next Steps
 
- Learn more about [Availability Groups on Linux](sql-server-linux-availability-group-overview.md)

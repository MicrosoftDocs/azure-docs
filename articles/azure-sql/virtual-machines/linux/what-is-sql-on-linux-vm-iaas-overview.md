...
> [!NOTE]
> To see the available Windows SQL Server virtual machine images, see [Overview of SQL Server on Azure Virtual Machines (Windows)](../windows/sql-server-on-azure-vm-iaas-what-is-overview.md).
...
|---|---|---|---|---|---|---|
| RHEL | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![no](./media/what-is-sql-on-linux-vm-iaas-overview/no.png) |
| SLES | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![no](./media/what-is-sql-on-linux-vm-iaas-overview/no.png) | ![no](./media/what-is-sql-on-linux-vm-iaas-overview/no.png) |
| Ubuntu | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) | ![yes](./media/what-is-sql-on-linux-vm-iaas-overview/yes.png) |
...
* [SQL Server on Azure Linux Virtual Machines FAQ](frequently-asked-questions-faq.md)

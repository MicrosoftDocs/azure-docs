...
1. Once the secondary replicas are joined, you can see them in SSMS Object Explorer by expanding the **Always On High Availability** node:
    ...
    ![availability-group-joined.png](./media/tutorial-rhel-ha-stonith/availability-group-joined.png)
...
> [Tutorial: Configure availability group listener for SQL Server on RHEL virtual machines in Azure](tutorial-rhel-ha-listener.md)

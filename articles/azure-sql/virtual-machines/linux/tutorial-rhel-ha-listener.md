...
Completed [**Tutorial: Configure availability groups for SQL Server on RHEL virtual machines in Azure**](tutorial-rhel-ha-stonith.md)

## Create the load balancer in the Azure portal

The following instructions take you through steps 1 through 4 from the [Create and configure the load balancer in the Azure portal](../windows/configure-availability-group-load-balancer-portal.md#create-and-configure-the-load-balancer-in-the-azure-portal) section of the [Load balancer - Azure portal](../windows/configure-availability-group-load-balancer-portal.md) article.
...
6. Select each virtual machine in the environment, and associate the appropriate IP address to each selection.
    ...
    :::image type="content" source="media/tutorial0linux-rhel-ha-listener/add-backend-pool.png" alt-text="Add backend pool":::
...
3. On the **Add load balancing rules** blade, configure the load balancing rule. Use the following settings: 
   ...
   :::image type="content" source="media/tutorial-linux-rhel-ha-listener/add-load-balancing-rule.png" alt-text="Add load balancing rule":::
...
> [Configure a load balancer for an availability group on Azure SQL Server VMs](../windows/configure-availability-group-load-balancer-portal.md)

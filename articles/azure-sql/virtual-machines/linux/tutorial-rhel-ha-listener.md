...
6. Select each virtual machine in the environment, and associate the appropriate IP address to each selection.
    ...
    :::image type="content" source="media/tutorial-rhel-ha-listener/add-backend-pool.png" alt-text="Add backend pool":::
...
3. On the **Add load balancing rules** blade, configure the load balancing rule. Use the following settings: 
   ...
   :::image type="content" source="media/tutorial-rhel-ha-listener/add-load-balancing-rule.png" alt-text="Add load balancing rule":::

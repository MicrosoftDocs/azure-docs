...
1. Then, type or select the following values:
   ...
   * **Change size**: Select this option to pick a machine size and when done, choose **Select**. For more information about VM machine sizes, see [Linux VM sizes](../../virtual-machines/sizes.md).

---
title: How to use Azure PowerShell to provision SQL Server on virtual machines
description: Provides steps and PowerShell commands to use SQL Server virtual machine gallery images on Azure Virtual Machines.
...
ms.reviewer: jroth
---
# How to use PowerShell to provision SQL Server on Azure Virtual Machines

...
For more information, see [Configure availability groups in Azure (GUI)](configure-availability-group-azure-marketplace-template.md).
...
* [Configure an ILB listener for availability groups in Azure](configure-availability-group-listener-powershell.md).

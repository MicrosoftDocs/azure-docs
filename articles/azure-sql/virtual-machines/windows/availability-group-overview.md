...
To increase redundancy and high availability, the SQL Server VMs should either be in the same [availability set](tutorial-prerequisites-manually-configure-availability-group.md#create-availability-sets), or different [availability zones](/azure/availability-zones/az-overview). 
...
| :------ | :-----| :-----| :-----| :-----| :-----| :-----| :-----| :-----| :-----| :-----|
| [SQL VM CLI](configure-availability-group-az-cli.md) | 2016 | 2017 </br>2016   | Ent | Cloud witness | No | Yes | Yes | Yes | No | No |
| [Quickstart Templates](configure-availability-group-quickstart-template.md) | 2016 | 2017</br>2016  | Ent | Cloud witness | No | Yes | Yes | Yes | No | No |
| [Portal Template](configure-availability-group-azure-marketplace-template.md) | 2016 </br>2012 R2 | 2016</br>2014 | Ent | File share | No | No | No | No | No | No |
| [Manual](tutorial-prerequisites-manually-configure-availability-group.md) | All | All | All | All | Yes | Yes | Yes | Yes | Yes | Yes |
| &nbsp; | &nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |&nbsp; |
...
For more information, see [Use Azure SQL VM CLI to configure Always On availability group for SQL Server on an Azure VM](configure-availability-group-az-cli.md). 
...
For more information, see [Use Azure Quickstart Template to configure Always On availability group for SQL Server on an Azure VM](configure-availability-group-quickstart-template.md).


## Automatically with an Azure portal template

[Configure Always On availability group in Azure VM automatically - Resource Manager](configure-availability-group-azure-marketplace-template.md)
...
- [Configure prerequisites for SQL Server Always On availability groups on Azure Virtual Machines](tutorial-prerequisites-manually-configure-availability-group.md)

- [Create Always On Availability Group to improve availability and disaster recovery](tutorial-manually-configure-availability-group.md)

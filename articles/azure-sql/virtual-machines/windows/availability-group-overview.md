...
To increase redundancy and high availability, SQL Server VMs should either be in the same [availability set](../../../virtual-machines/avset-overview.md), or different [availability zones](../../../availability-zones/az-overview.md).

...
![Test lab architecture for availability groups in Azure](./media/configure-availability-group-azure-marketplace-template/0-EndstateSample.png)
...
3. On the **New** pane, search for **AlwaysOn**.
   ![Find AlwaysOn Template](./media/configure-availability-group-azure-marketplace-template/16-findalwayson.png)
4. In the search results, locate **SQL Server AlwaysOn Cluster**.
   ![AlwaysOn Template](./media/configure-availability-group-azure-marketplace-template/17-alwaysontemplate.png)
...
![Basics](./media/configure-availability-group-azure-marketplace-template/1-basics.png)
...
![Domain and network settings](./media/configure-availability-group-azure-marketplace-template/2-domain.png)
...
![availability group settings](./media/configure-availability-group-azure-marketplace-template/3-availabilitygroup.png)
...
![VM size storage settings](./media/configure-availability-group-azure-marketplace-template/4-vm.png)
...
![SQL Server settings](./media/configure-availability-group-azure-marketplace-template/5-sql.png)
...
![Azure Dashboard](./media/configure-availability-group-azure-marketplace-template/11-deploydashboard.png)

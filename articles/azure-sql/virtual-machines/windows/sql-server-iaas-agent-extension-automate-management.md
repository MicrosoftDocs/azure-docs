...
Also, SQL Server IaaS Agent extension is only supported in Lightweight mode when working with failover cluster instances or a named instance in a multi-instance VM. 

...
1. Under **Instance details**:
    ...
    1. For the purpose of this quickstart, leave **Availability options** set to _No infrastructure redundancy required_. To find out more information about availability options, see [Availability](../../../app-service/scripts/availability.md). 
...
1. Under **Administrator account**, provide a username, such as _azureuser_ and a password. The password must be at least 12 characters long and meet the [defined complexity requirements](../../../active-directory-b2c/faq.md#what-are-the-password-requirements-when-creating-a-vm).

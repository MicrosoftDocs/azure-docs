...
1. Register your SQL Server VM with the SQL VM resource provider to enable **SQL virtual machine** manageability in the Azure portal and features associated with the resource provider. For more information, see [Register SQL Server VM with SQL VM resource provider](register-with-sql-resource-provider.md). 
...
* [Overview of SQL Server on a Windows VM](what-is-sql-on-azure-vm-iaas-overview.md)

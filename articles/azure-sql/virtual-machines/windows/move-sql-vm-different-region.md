...
---
# Move a SQL Server virtual machine to another region within Azure with Azure Site Recovery
...
1. Register your SQL Server VM with the SQL virtual machine resource provider to enable **SQL virtual machine** manageability in the Azure portal and features associated with the resource provider. For more information, see [Register SQL Server VM with SQL virtual machine resource provider](sql-vm-resource-provider-register.md). 

...
> [!NOTE]
> In case of SQL Server hive not being present,removal of binaries might be impacted if [resource locks](/azure/governance/blueprints/concepts/resource-locking#locking-modes-and-states) are in place.

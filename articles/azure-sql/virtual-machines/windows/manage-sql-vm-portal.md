...
---
# Manage SQL Server virtual machines in Azure by using the Azure portal
...
- The **SQL virtual machines** resource is available only to SQL Server VMs that have [registered with the SQL virtual machine resource provider](sql-vm-resource-provider-register.md). 
...
The **SQL Server configuration** tab has been deprecated. At this time, it's the only method to manage [end-of-support](sql-server-2008-extend-end-of-support.md) SQL Server VMs, and SQL Server VMs that have not been [registered with the SQL virtual machine resource provider](sql-vm-resource-provider-register.md).

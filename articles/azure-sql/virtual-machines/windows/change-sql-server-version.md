...
> [!NOTE]
> If you have already registered with the SQL IaaS Agent extension, [unregister from the RP](sql-agent-extension-manually-register-single-vm.md#unregister-from-rp) and then [Register the SQL VM resource](sql-agent-extension-manually-register-single-vm.md#register-with-rp) again so that it detects the correct version and edition of SQL Server that is installed on the VM. This updates the metadata and billing information that is associated with this VM.

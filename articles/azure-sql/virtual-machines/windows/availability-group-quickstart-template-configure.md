...
- An internal Azure Load Balancer and an available (not used by any entity) IP address for availability group listener with the same subnet as Azure SQL VMs.

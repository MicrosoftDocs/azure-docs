...
This article describes how to bulk register your SQL Server virtual machines (VMs) in Azure with the SQL VM resource provider by using the `Register-SqlVMs` PowerShell cmdlet.

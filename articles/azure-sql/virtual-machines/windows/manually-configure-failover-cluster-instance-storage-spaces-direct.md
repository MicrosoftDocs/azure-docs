...
![The complete solution](./media/manually-configure-failover-cluster-instance-storage-spaces-direct/00-sql-fci-s2d-complete-solution.png)
...
1. If you're using one of the SQL Server-based virtual machine images, remove the SQL Server instance.
   ...
   1. Remove all features under **Database Engine Services**. Don't remove **Shared Features**. You'll see something like the following screenshot:
      ...
      ![Select Features](./media/manually-configure-failover-cluster-instance-storage-spaces-direct/03-remove-features.png)
...
1. Add storage to the virtual machine. For detailed information, see [add storage](../../../virtual-machines/windows/disks-types.md).
...
1. Under **Test Selection**, select all tests except for **Storage**, as shown here:
   ...
   ![Select cluster validation tests](./media/manually-configure-failover-cluster-instance-storage-spaces-direct/10-validate-cluster-test.png)
...
1. [Create a volume](https://technet.microsoft.com/windows-server-docs/storage/storage-spaces/hyper-converged-solution-using-storage-spaces-direct#step-36-create-volumes).
   ...
   ![Cluster Shared Volume](./media/manually-configure-failover-cluster-instance-storage-spaces-direct/15-cluster-shared-volume.png)
...
1. Select **New SQL Server failover cluster installation**. Follow the instructions in the wizard to install the SQL Server FCI.
   ...
   ![Data directories](./media/manually-configure-failover-cluster-instance-storage-spaces-direct/20-data-dicrectories.png)
...
1. Configure the load balancer with:
 ...
 The following screenshot shows the **Create load balancer** UI:
   ...
   ![Set up the load balancer](./media/manually-configure-failover-cluster-instance-storage-spaces-direct/30-load-balancer-create.png)

...
If you are running SQL Server on-premises, there are steps you can follow to [access Azure Key Vault from your SQL Server on-premises machine](https://msdn.microsoft.com/library/dn198405.aspx). But for SQL Server on Azure VM, you can save time by using the *Azure Key Vault Integration* feature.

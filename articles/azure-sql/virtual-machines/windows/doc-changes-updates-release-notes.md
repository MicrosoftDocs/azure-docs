...
| Changes | Details |
| --- | --- |
| **SQL Assessment** | It is now possible to assess the health of your SQL VM in Azure portal [SQL Assessment](sql-assessment-for-sql-vm.md) in [full mode](sql-agent-extension-manually-register-single-vm.md#full-mode)! This feature is currently in preview. | 

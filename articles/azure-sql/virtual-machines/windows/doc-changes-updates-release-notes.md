...
| **Create AG using PowerShell** | It's now possible to simplify the creation of an availability group by using [PowerShell](availability-group-az-commmandline-configure.md) as well as the Azure CLI. | 

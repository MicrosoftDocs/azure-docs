...
A disk witness is a small clustered disk in the Cluster Available Storage group. This disk is highly available and can fail over between nodes. It contains a copy of the cluster database, with a default size that's usually less than 1 GB. A disk witness is a unique capability of Azure shared disks and might be preferable because it's a familiar part of the on-premises infrastructure. 

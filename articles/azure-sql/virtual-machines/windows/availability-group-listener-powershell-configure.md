...
Add only the primary IP address of the VM to the back-end pool of the load balancer as the [secondary IP address of VM does not support floating IP](/azure/load-balancer/load-balancer-floating-ip).

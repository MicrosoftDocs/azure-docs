...
![Modify the provider](./media/register-with-sql-resource-provider/select-resource-provider-sql.png)
...
1. For SQL Server VMs with the NoAgent or lightweight IaaS mode, select the **Only license type and edition updates are available with the SQL IaaS extension** message.
   ...
   ![Selections for changing the mode from the portal](./media/register-with-sql-resource-provider/change-sql-iaas-mode-portal.png)
...
1. Select the **I agree to restart the SQL Server service on the virtual machine** check box, and then select **Confirm** to upgrade your IaaS mode to full. 
    ...
    ![Check box for agreeing to restart the SQL Server service on the virtual machine](./media/register-with-sql-resource-provider/enable-full-mode-iaas.png)
...
![Verify status with SQL RP registration](./media/register-with-sql-resource-provider/verify-registration-status.png)
...
1. Navigate to the SQL Server VM resource. 
   ...
   ![SQL virtual machines resource](./media/register-with-sql-resource-provider/sql-vm-manage.png)

1. Select **Delete**. 

   ![Delete SQL VM resource provider](./media/register-with-sql-resource-provider/delete-sql-vm-resource-provider.png)

1. Type the name of the SQL virtual machine and **clear the checkbox next to the virtual machine**.

   ![Delete SQL VM resource provider](./media/register-with-sql-resource-provider/confirm-delete-of-resource-uncheck-box.png)

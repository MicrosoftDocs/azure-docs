---
title: Feature interoperability with SQL Server AG & DNN
description: "Learn about the additional considerations when working with certain SQL Server features and a distributed network name (DNN) resource with an Always On availability group on SQL Server on Azure VMs. " 

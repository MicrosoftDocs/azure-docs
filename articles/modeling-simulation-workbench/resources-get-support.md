...
The Azure Modeling and Simulation Workbench documentation and [troubleshooting](./resources-troubleshooting.md) information covers most of the commonly encountered scenarios. If you have a technical issue that isn't covered in the troubleshooting guide and recovery steps, reach out to get help and support.
...
1. NOTE: The log lifetime is 30 days. To access the logs longer than 30 days, select the **Export Activity Logs** option and select one of the available options that displays.

...
You can activate V12 by using the new Microsoft Azure portal at [http://portal.azure.com/](http://portal.azure.com/), instead of the [Microsoft Azure classic portal](http://manage.windowsazure.com/). After you activate V12 for your subscription, the create and upgrade options for V12 become unlocked in the Azure portal. Then users can initiate the [create](sql-database-create.md) workflow from the server blade or the database blade.
...
After you have activated the V12 option privilege, you see the **Yes|No** control that is circled in the following portal screenshot.

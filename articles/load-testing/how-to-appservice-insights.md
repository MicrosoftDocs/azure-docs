...
[App Service Diagnostics](/app-service/overview-diagnostics/) is an intelligent and interactive experience to help you troubleshoot your app with no configuration required. When you do run into issues with your app, App Service diagnostics points out what’s wrong to guide you to the right information to more easily and quickly troubleshoot and resolve the issue.
...
In this section, you'll use [App Service Diagnostics](/app-service/overview-diagnostics/) to get more insights from load testing an Azure App Service workload.

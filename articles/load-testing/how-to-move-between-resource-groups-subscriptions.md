---
title: Move an Azure Load testing resource to resource group or subscription
...
1. Choose the resource group containing the resource that you would like to move.

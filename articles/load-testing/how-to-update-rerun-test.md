...
- You must have a valid test created with at least one test run. You can also use the sample test plan and the app in our tutorial. See [Tutorial: Run a load test to identify performance bottlenecks](./tutorial-identify-bottlenecks-azure-portal.md)  

## Updating Test from the Tests Page  

...
---
# Download load test JMeter logs in the Azure portal

In this article, you'll learn how you can download the Apache JMeter logs with Azure Load Testing Preview in the Azure portal.

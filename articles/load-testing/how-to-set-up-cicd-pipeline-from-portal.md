---
title: Configure a CI/CD pipeline for a load test from Azure portal
...
# Configure a CI/CD pipeline for an existing load test in Azure Load Testing
...
You've configured a CI/CD pipeline for an existing load test. You can view the load test results in the outpu logs after the test run.

- Learn how to [view load test results in CI/CD pipeline](/azure/load-testing/quickstart-add-load-test-cicd?tabs=pipelines#view-load-test-results).
...
1. Once deployment finishes, browse to the running sample application.
...
1. Finally, select the resource group *of the sample application you're testing* and select **OK**.

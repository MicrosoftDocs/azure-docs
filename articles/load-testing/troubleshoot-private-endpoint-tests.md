...
| ------------|-------|
| *.azure.com | Access to this destination is required for the Azure Load Testing service to interact with other Azure services and orchestrate the load test run. |

...
1. To see the application's components, sign in to the [Azure portal](https://portal.azure.com) and go to the resource group you created.  
   ...
   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/resource-group.png" alt-text="Resource groups.":::

Now that you have the application deployed and running, go ahead and start running your first load test against it.  
...
1. Use **Ctrl** + **Shift** + **P** to launch the command palette. Begin typing `Azure load`. You'll see two commands associated with the Azure Load Test extension:  
   ...
   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/azure-load-testing-new-load-test.png" alt-text="Create a new Azure Load Testing test.":::

    - **Run Current File as Load Test in Cloud**: Use this command to run an existing cloud load test at scale in Azure.  
    - **Create New Test**: Use this command to author a new cloud load test from an existing Apache JMeter script.  

1. Select **Create New Test**.  

1. Select the **SampleApp.jmx** test plan.  

   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/browse-for-load-test-plans.png" alt-text="Search for Azure Load Testing plans.":::

   A YAML-based load test with smart defaults opens.  

   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/azure-load-testing-yaml-based-test.png" alt-text="YAML-based load test for Azure Load Testing.":::
...
1. Edit the parameters or comment out the optional parameters if they don’t apply.  
   ...
   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/azure-load-testing-yaml-based-test-updated.png" alt-text="(Updated) YAML-based load test for Azure Load Testing.":::
...
1. Select the subscription from which you'll run your load test.  
   ...
   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/select-a-subscription.png" alt-text="Select an Azure subscription for Azure Load Testing.":::
...
1. Select the resource group *of the sample application you're testing* and select **OK**.  
   ...
   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/app-server-results.png" alt-text="Application's server metrics monitored by Azure Load Testing.":::

   The test will start and the **OUTPUT** section will show status messages.  

   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/azure-load-testing-run-messages.png" alt-text="Azure Load Testing status messages.":::
...
1. Take a look at the client-side metrics.  
   ...
   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/azure-load-testing-client-side-metrics.png" alt-text="Azure Load Testing: Client-side metrics.":::
   ...
   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/azure-load-testing-client-side-metrics-errors.png" alt-text="Errors in Azure Load Testing.":::
...
1. For the App Service Plan metrics, you'll note that the **CPU Percentage** and **Memory Percentage** metrics are within healthy ranges.  
   ...
   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/app-service-metrics-for-load-testing.png" alt-text="App Service Plan metrics.":::

1. Examine metrics for Cosmos DB.  

   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/azure-load-testing-cosmos-db-metrics.png" alt-text="Cosmos DB Metrics.":::

   You'll see that the **Normalized RU Consumption** metric shows that you were running at 100% utilization soon after the load test began.  
...
1. Go to the Cosmos DB resource that was provisioned as part of the sample application deployment.  
   ...
   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/ru-scaling-for-cosmos-db.png" alt-text="RU scaling for Cosmos DB.":::

1. Select the **Scale & Settings** option and set the value to 1200 RU.  

   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/1200-ru-scaling-for-cosmos-db.png" alt-text="Azure Load Testing scale at 1200 RU.":::
...
1. Go to your load test's browser tab, and select **Rerun**.  
   ...
   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/azure-load-testing-rerun-test.png" alt-text="Rerun in Azure Load Testing.":::
...
1. Check the server-side metrics for Cosmos DB and check that performance has improved.  

   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/azure-load-testing-cosmos-db-metrics.png" alt-text="Cosmos DB client-side metrics.":::

   :::image type="content" source="./media/how-to-identify-bottlenecks-vs-code/azure-load-testing-cosmos-db-metrics-post-run.png" alt-text="Cosmos DB client-side metrics after the run.":::

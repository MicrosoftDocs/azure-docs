...
:::image type="content" source="media/concept-azure-load-testing-vnet-injection/azure-load-testing-vnet-injection.svg" alt-text="Diagram that shows the Azure Load Testing VNET injection technical overview." lightbox="media/concept-azure-load-testing-vnet-injection/azure-load-testing-vnet-injection.svg":::
...
:::image type="content" source="media/concept-azure-load-testing-vnet-injection/azure-hosted-private-endpoint.svg" alt-text="Diagram that shows the set-up for load testing a private endpoint hosted on Azure." lightbox="media/concept-azure-load-testing-vnet-injection/azure-hosted-private-endpoint.svg":::
...
:::image type="content" source="media/concept-azure-load-testing-vnet-injection/azure-hosted-public-access-restrictions.svg" alt-text="Diagram that shows the set-up for load testing a public endpoint hosted on Azure with access restrictions." lightbox="media/concept-azure-load-testing-vnet-injection/azure-hosted-public-access-restrictions.svg":::
...
:::image type="content" source="media/concept-azure-load-testing-vnet-injection/onpremises-private-endpoint-expressroute.svg" alt-text="Diagram that shows the set-up for load testing an on-premises hosted, private endpoint connected via Azure ExpressRoute." lightbox="media/concept-azure-load-testing-vnet-injection/onpremises-private-endpoint-expressroute.svg":::

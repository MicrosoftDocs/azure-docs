...
In the code above, the first block of code constructs a map object and sets the authentication mechanism to use the subscription-key. You can see [create a map](./map-create.md) for instructions.

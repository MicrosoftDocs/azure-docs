...
description: Find out how to check whether the Azure Maps Web SDK supports a browser. See which browsers are supported. Learn how to use map services with legacy browsers.
author: rbrundritt
ms.author: richbrun
ms.date: 03/25/2019
ms.topic: conceptual

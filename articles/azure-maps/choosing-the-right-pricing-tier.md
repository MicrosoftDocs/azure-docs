...
### S0 Pricing Tier:
The S0 pricing tier is for customers who are either small or medium sized enterprises. This is a right pricing tier for you if you do not expect high volumes of concurrent users and/or your service requirements are met by the core geospatial APIs as indicated by the table below. This tier is generally available and is applicable for applications ina ll stages of production from proof of concept development and early stage testing to application production and deployment.

...
The Azure Maps [Mobility service](https://aka.ms/AzureMapsMobilityService) improves the development time for applications with public transit features, such as transit routing and search for nearby public transit stops. Users the Mobility service to retrieve detailed information about transit stops, lines, and schedules. The Mobility service also allows users to retrieve stop and line geometries, alerts for lines and service areas, and real-time public transit arrivals. Additionally, the Mobility service provides routing capabilities with multimodal trip planning options. Multimodal trip planning incorporates walking, bicycling, and public transit options, all into one trip. Users can also access detailed multimodal step-by-step itineraries and service alerts.

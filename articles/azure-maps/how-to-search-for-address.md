...
title: Using Azure Maps Search services for geocoding and reverse geocoding  | Microsoft Docs 
description: Learn how to use Azure Maps geocoder and reverse geocoder by calling Azure Maps Search service APIs. Search service APIs allows to search addresses, places, business listings by name or category, and other geographic information. Services can also reverse geocode addresses and cross streets based on latitudes and longitudes.
author: walsehgal
ms.author: v-musehg
ms.date: 01/02/2020
ms.topic: conceptual

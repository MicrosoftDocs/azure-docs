...
title: Find an address using the Azure Maps Search service  | Microsoft Docs 
...
To make any calls to the Maps service APIs, you need a Maps account and key. Follow instructions in [Create an account](./quick-demo-map-app#create-an-account) to create an Azure Maps account subscription and follow the steps in [get primary key](./quick-demo-map-app#get-primary-key) to get the primary key for your account. For more details on authentication in Azure Maps, see [manage authentication in Azure Maps](./how-to-manage-authentication.md).

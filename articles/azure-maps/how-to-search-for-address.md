...
description: Learn about the Azure Maps Search Service. See how to use these APIs for geocoding, reverse geocoding, fuzzy searches, and reverse cross street searches.
author: anastasia-ms
ms.author: v-stharr
ms.date: 07/21/2020
ms.topic: conceptual

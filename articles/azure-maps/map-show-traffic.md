...
description: Find out how to add traffic data to a map. Learn about flow data, and see how to use the Azure Maps web SDK to add incident data and flow data to a map.
author: anastasia-ms
ms.author: v-stharr
ms.date: 07/29/2019
ms.topic: conceptual

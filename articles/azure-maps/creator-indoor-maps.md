---
title: 'Tutorial: Work with indoor maps in Azure Maps Creator'
description: 'Tutorial: This article introduces concepts that apply to Azure Maps Creator services'
author: anastasia-ms
ms.author: v-stharr
ms.date: 05/18/2020
ms.topic: tutorial

...
description: See how to use the web SDK to add a map to a web page. View code samples. Learn about options for animation, style, the camera, services, and user interactions.
author: anastasia-ms
ms.author: v-stharr
ms.date: 07/26/2019
ms.topic: conceptual

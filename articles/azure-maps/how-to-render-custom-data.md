...
To complete the procedures in this article, you first need to create an Azure Maps account and get you maps account key. Follow instructions in [Create an account](./quick-demo-map-app#create-an-account) to create an Azure Maps account subscription and follow the steps in [get primary key](./quick-demo-map-app#get-primary-key) to get the primary key for your account. For more details on authentication in Azure Maps, see [manage authentication in Azure Maps](./how-to-manage-authentication.md).

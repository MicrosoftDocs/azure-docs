---
title: 'Tutorial: Create a store locator application using Azure Maps | Microsoft Docs'
description: 'Tutorial: In this tutorial, you will learn how to create a store locator application by using Azure Maps.'
author: walsehgal
ms.author: v-musehg
ms.date: 11/12/2019
ms.topic: tutorial

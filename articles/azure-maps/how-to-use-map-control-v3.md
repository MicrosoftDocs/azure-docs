...
> [!IMPORTANT]
> If you have existing applications incorporating Azure Maps using version 2 of the [Map Control], it is recomended to start using version 3. Version 3 is backwards compatible and has several benifits including [WebGL 2.0 Compatibility], increased performance and support for [3D tarrain tiles].
...
Starting with Azure Maps Web SDK 3.0, developers can take advantage of 3D terrain visualizations. This feature allows you to incorporate elevation data into your maps, creating a more immersive experience for your users. Whether it's visualizing mountain ranges, valleys, or other geographical features, the 3D terrain support will bring a new level of realism to your mapping applications.
...
[3D tarrain tiles]: 3d-tarrain-tiles
...
[WebGL 2.0 compatibility]: webgl-2.0-compatibility

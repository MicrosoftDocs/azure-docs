...
> * Pakistan
>
> After August 1, 2019, the **View** parameter will define the returned map content for the new countries/regions as listed here. Azure Maps **View** parameter (also referred to as "user region parameter") is a two letter ISO-3166 Country Code that will show the correct maps for that country/region specifying which set of geopolitically disputed content is returned via Azure Maps services, including borders and labels displayed on the map.

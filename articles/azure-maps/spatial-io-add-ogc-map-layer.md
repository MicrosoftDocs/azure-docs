...
The [OGC map layer options] sample demonstrates the different OGC map layer options. You can select the code pen button at the top-right corner to edit the code pen.

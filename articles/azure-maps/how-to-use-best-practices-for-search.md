...
To make any calls to the Maps service APIs, you need a Maps account and key. For information on creating an account, follow instructions in [Create an account](./quick-demo-map-app#create-an-account) and follow the steps in  [get primary key](./quick-demo-map-app#get-primary-key) to retrieve a primary key (subscription) for your account. For more details on authentication in Azure Maps, see [manage authentication in Azure Maps](./how-to-manage-authentication.md).

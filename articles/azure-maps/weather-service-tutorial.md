...
description: 'Tutorial: This tutorial shows you how to join sensor data with weather forecast data from Microsoft Azure Maps weather service by using Azure Notebooks(Python).'
author: walsehgal
ms.author: v-musehg
ms.date: 12/09/2019
ms.topic: tutorial

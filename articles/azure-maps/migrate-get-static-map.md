...
| mapLayer | ml | trafficLayer | FALSE | TrafficTilesetId | Optional Value. If `TrafficLayer` is provided, it returns map image with corresponding traffic layer. For more information, see [tilesetId]. |
...
``` http
https://atlas.microsoft.com/map/static/png?api-version=2022-08-01&style=main&layer=basic&zoom=14&height=500&Width=500&center=-0.113629,51.504810&pins=default|lc003C62||-0.113629%2051.504810&subscription-key={Your-Azure-Maps-Subscription-key}
```

...
The first code block creates a Map object using the anonymous authentication mechanism. See [create a map](./map-create.md) for instructions on how to create a map.

...
This article introduces the [Shape](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.shape?view=azure-iot-typescript-latest) class and shows you how to add a line, a circle, and a polygon to the map. It also shows how to change properties for these shapes using the [shape](https://docs.microsoft.com/en-us/javascript/api/azure-maps-control/atlas.shape?view=azure-iot-typescript-latest) class.

---
title: Add a bar chart layer to the Azure Maps Power BI visual
titleSuffix: Microsoft Azure Maps
description: In this article, you will learn how to use the bar chart layer in the Microsoft Azure Maps Power BI visual.
author: stevemunk

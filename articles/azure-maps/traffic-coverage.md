...
However, Maps does not have the same level of information and accuracy for all countries/regions. The following table provides information about what kind of traffic information you can request from each country/region: 

...
In the code above, the first block of code constructs a Map object. You can see [create a map](./map-create.md) for instructions. It also creates HTML content to be displayed within a popup.

---
title: Manage the Azure Maps Power BI visual within your organization | Microsoft Azure Maps
description: In this article, you will learn how to manage the Microsoft Azure Maps Power BI visual within your organization.
author: anastasia-ms
ms.author: v-stharr
ms.date: 06/26/2020
ms.topic: conceptual
...
![Power BI Options panel showing preview features options for the Azure Maps visual](media/power-bi-visual/preview-options-panel.png)
...
> ![Power BI admin portal showing tenant settings for the Azure Maps visual](media/power-bi-visual/tenant-admin-settings.png)

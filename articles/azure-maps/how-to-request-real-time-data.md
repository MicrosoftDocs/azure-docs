...
description: Learn how to request real-time public transit data, such as arrivals at a transit stop. See how to use Azure Maps Mobility Service for this purpose.
author: anastasia-ms
ms.author: v-stharr
ms.date: 09/06/2019
ms.topic: conceptual

...
The Azure Maps Android SDKs supports Mercator tile layers which can have x/y/zoom notation, quadkey notation, or EPSG 3857 bounding box notation.
...
* [MSFT Q&A page for Azure Maps](https://docs.microsoft.com/en-us/answers/topics/azure-maps.html).

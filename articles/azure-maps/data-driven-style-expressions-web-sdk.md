...
Similarly, the outline of Polygons will render in line layers. To disable this behaviour in a line layer, add a filter that only allows `LineString` and `MultiLineString` features.  

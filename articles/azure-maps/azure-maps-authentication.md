...
For information about viewing your Azure RBAC settings, see [How to configure Azure RBAC for Azure Maps](how-to-manage-authentication#view-role-definitions).
...
> [!div class="nextstepaction"]
> [Use the Azure Maps Map Control](https://aka.ms/amaadmc)

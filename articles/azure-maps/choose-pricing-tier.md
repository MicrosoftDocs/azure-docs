...
For additional pricing information on [Creator for indoor maps](creator-indoor-maps.md), see the *Creator* section in [Azure Maps pricing](https://azure.microsoft.com/pricing/details/azure-maps/).

...
This article shows you how to use map class [events](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.map?view=azure-iot-typescript-latest#addeventlistener) property to highlight events on the map and different layers. 

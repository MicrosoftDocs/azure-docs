...
1. Go to the [Azure Support](http://azure.microsoft.com/support) web site and click **Get Support**. You can also submit an incident from the Microsoft Azure Management Portal or from the Azure Accounts Center.

 * To submit a support ticket from the [Azure Management Portal](https://manage.windowsazure.com/), click your account name, and then click Contact Microsoft Support.

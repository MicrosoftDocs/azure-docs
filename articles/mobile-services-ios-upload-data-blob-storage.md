<properties 
	pageTitle="Use Mobile Services to upload data to blob storage (iOS) | Mobile Services" 
	description="Learn how to use Mobile Services to upload data to Azure Blob Storage." 

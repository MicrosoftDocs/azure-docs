...
:::image type="content" source="./media/vm-attribute/attribute-based-vm-selection-diagram.png" lightbox="./vm-attribute/attribute-based-vm-selection-diagram.png" alt-text="Screenshot that shows the flow diagram for Atrribute Based VM Selection.":::

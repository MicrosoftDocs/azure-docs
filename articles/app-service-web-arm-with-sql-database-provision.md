...
In this topic, you will learn how to create an Azure Resource Manager template the deploys a web app and SQL Database. You will learn how to define which resources are deployed and 

...
| Maximum number of volumes that can be processed in parallel for backup, restore, or clone | 16 | If there are more than 16 volumes, they will be processed sequentially as processing slots become available.<br> New backups of a cloned or a restored volume cannot occur until the operation is finished.|

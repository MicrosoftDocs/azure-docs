...
|Added support for [conditional patch](https://docs.microsoft.com/azure/healthcare-apis/azure-api-for-fhir/fhir-rest-api-capabilities#patch-and-conditional-patch):| Links|
| :----------------------------------- | ------: |
...
|Allow [JSON patch in bundles](https://docs.microsoft.com/azure/healthcare-apis/azure-api-for-fhir/fhir-rest-api-capabilities#patch-in-bundles):| Links|
| :----------------------------------- | ------: |
...
|New audit event sub-types| Links|
| :----------------------------------- | ------: |
...
|Resolved retry 503 error:| Links|
| :----------------------------------- | ------: |

...
## SMART on FHIR(Enhanced) using AHDS Samples OSS
...
> [!NOTE]
> This is another option to using "SMART on FHIR(Enhanced) using AHDS Samples OSS" mentioned above. SMART on FHIR Proxy option only enables EHR launch sequence.

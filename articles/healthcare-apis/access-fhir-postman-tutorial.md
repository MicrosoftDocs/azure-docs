...
- You have granted permissions, for example, "FHIR Data Contributor", to the client application to access the FHIR service. More info at [Configure Azure RBAC for FHIR](https://docs.microsoft.com/en-us/azure/healthcare-apis/configure-azure-rbac)

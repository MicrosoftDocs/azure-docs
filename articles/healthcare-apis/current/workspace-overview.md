...
systems into the Azure Cloud based on the [FHIR](https://www.hl7.org/fhir/index.html) interoperable data standard published by HL7. For more information, see [About Azure API for FHIR](./fhir/overview.md).
...
more information, see [Azure IoT Connector for FHIR (preview)](./fhir/overview.md#azure-iot-connector-for-fhir-preview).

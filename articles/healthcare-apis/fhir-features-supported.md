...
Currently the FHIR Server open source code includes an implementation for [Azure Cosmos DB](../cosmos-db/index-overview.md) and [SQL Database](https://azure.microsoft.com/en-us/services/sql-database/).

...
| search                         | Partial   | Partial   | Partial   | See [Overview of FHIR Search](overview-fhir-search).                           |
...
The Microsoft FHIR Server has a plug able persistence module (see [`Microsoft.Health.Fhir.Core.Features.Persistence`](https://github.com/Microsoft/fhir-server/tree/master/src/Microsoft.Health.Fhir.Core/Features/Persistence)).

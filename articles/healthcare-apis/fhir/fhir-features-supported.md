...
Below is a summary of the supported RESTful capabilities. For more details on the implementation of these capabilities, see [FHIR Rest API capabilities](fhir-rest-api-capabilities.md) 

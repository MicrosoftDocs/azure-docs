...
1. Select **Add a permission**.
    ...
    If you're using the FHIR service, you'll add a permission to the Azure Healthcare APIs by searching for **Azure Healthcare API** under **APIs my organization uses**. The search result for Azure Healthcare API will only return if you've already [deployed the FHIR service](../azure-api-for-fhir/fhir-paas-powershell-quickstart.md).

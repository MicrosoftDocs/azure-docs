...
|`__includeHistory` | No | Allows you to export versioned resources. This is filter does not work with '_typeFilter' query parameter. |
|`_includeDeleted` | No | Allows you to export soft deleted resources. To learn more about delete, refer to [delete using FHIR sepcification](https://www.hl7.org/fhir/http.html#delete). This is filter does not work with '_typeFilter' query parameter. |
> [!NOTE]

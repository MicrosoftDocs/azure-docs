...
- [FHIR Data Loader or FHIRDL](https://github.com/microsoft/healthcare-apis-samples/blob/main/docs/HowToLoadData.md) - This is a console application that loads and converts FHIR data in Azure Storage. Also, it sends simulated device data to IoT in one of the menu options. You can run the tool interactively, or you cn run it using a command line with some code modification.

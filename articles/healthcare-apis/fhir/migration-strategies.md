...
|**Infrastructure**|Supported: <br> • Customer managed keys <br> • Cross region DR<br> |Supported: <br> • Data recovery  <br> • [Customer managed keys](configure-customer-managed-keys.md) <br> Upcoming: <br> • Availability zone support|

...
In this article, you've learned how to obtain an access token for the FHIR service using the Azure CLI. To learn how to access the FHIR API using Postman, proceed to the Postman tutorial.

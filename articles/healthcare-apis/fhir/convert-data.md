...
It's recommended that you host your own copy of templates on ACR. There are six steps involved in hosting your own templates and using them in the `$convert-data` operation:

...
Outside of defining search parameters, you need to load the [required profiles and extensions](validation-against-profiles.md) to pass this test. There are nine profiles used as part of the Da Vinci Plan-Net IG:

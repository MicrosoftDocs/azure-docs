...
On successful validation of existing/ new resource with validate operation, the resource is not persisted into the FHIR service. Use Option 3: Validate on resource CREATE/ UPDATE using header, to persist successfully validated resource to FHIR service.

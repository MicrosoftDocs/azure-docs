...
In this article, you will learn how to deploy the FHIR service within the Azure Healthcare APIs (hear by called the FHIR service) using the Azure Resource Manager template (ARM template). We provide you two options, using PowerShell or using CLI.

...
For example, if you would like to store the `us-core-allergyintolerance` profile, you would do:
...
```
> [!NOTE]
> You'll only see the profiles that you have loaded into the FHIR service.
...
In this article, you have learned about FHIR profiles. Next, you'll learn how you can use $validate to ensure that resources conform to these profiles.

...
Ensure you are granted with application roles - 'FHIR Data Contributor role' and 'FHIR Data exporter role' prior to configuring export. To understand more on application roles, see [Authentication and Authorization for FHIR service](/authentication-authorization#application-roles).

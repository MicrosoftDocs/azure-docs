...
- Azure AD access token to the management resource, not Azure Health Data Services. You can get the access token using an existing tool or using Azure CLI command, ```az account get-access-token --resource  "https://management.azure.com/"```

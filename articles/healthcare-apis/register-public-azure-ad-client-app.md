...
1. Open the **API permissions**. If you are using the Azure API for FHIR, you will add a permission to the Azure Healthcare APIs by searching for that under APIs my organization uses (image 1 below). If you are referencing a different Resource Application, select your [FHIR API Resource Application Registration](register-resource-azure-ad-client-app.md) that you created previously (image 2 below):

    ![Azure portal. New public API permissions - Azure API for FHIR Default](media/public-client-app/api-permissions.png)

    ![Azure portal. New public API Permissions - Custom Resource Application Registration](media/how-to-aad/portal-aad-register-new-app-registration-PUB-CLIENT-API-PERMISSIONS.png)
...
If you set your application in a different Azure AD tenant from your FHIR server, you will need to update the **Authority**. In Azure API for FHIR, you do this under Settings --> Authentication. Set your **Authority** https://login.microsoftonline.com/\<TENANT-ID>.
    ![Azure portal. Authority Update](media/public-client-app/authority-update.png)

...
- [Register the Azure Cosmos DB resource provider for your Azure subscription](https://docs.microsoft.com/en-us/azure/cosmos-db/how-to-setup-cmk#register-resource-provider) 
- [Configure your AKV instance](https://docs.microsoft.com/en-us/azure/cosmos-db/how-to-setup-cmk#configure-your-azure-key-vault-instance)
-  [Add an access policy to your AKV instance](https://docs.microsoft.com/en-us/azure/cosmos-db/how-to-setup-cmk#add-an-access-policy-to-your-azure-key-vault-instance)
- [Generate a key in AKV](https://docs.microsoft.com/en-us/azure/cosmos-db/how-to-setup-cmk#generate-a-key-in-azure-key-vault)
...
:::image type="content" source="media/byok/byok-keypicker.png" alt-text="Create Azure API for FHIR":::

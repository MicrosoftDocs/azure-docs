...
description: This article describes how to deploy a workspace using the Azure portal. 
author: stevewohl
...
:::image type="content" source="../media/create_workspace-preview.png" alt-text="Create Azure Healthcare APIs account." lightbox="create_workspace-preview.png":::
...
* Deploy an IoT Connector service to ingest data from your FHIR service.

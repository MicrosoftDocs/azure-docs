...
:::image type="content" source="/media/healthcareapis-workspace/create-resource.png" alt-text="Create resource.":::
...
:::image type="content" source="/media/healthcareapis-workspace/search-for-heathcare-apis.png" alt-text="Search for Azure Healthcare APIs.":::
...
:::image type="content" source="/media/healthcareapis-workspace/create-workspace-preview.png" alt-text="Create Azure Healthcare APIs account.":::
...
1. Select a **Subscription** and **Resource group** from the drop-down lists or select **Create new**.
   ...
   :::image type="content" source="/media/healthcareapis-workspace/create-healthcare-api-workspace-new.png" alt-text="Create Azure Healthcare APIs workspace.":::
...
3. (**Optional**) Select **Next: Tags >**. Enter a **Name** and **Value**, and then select **Next: Review + create**. 
   ...
   :::image type="content" source="/media/healthcareapis-workspace/tags-new.png" alt-text="Tags.":::
...
4. Select **Create**.
   ...
   :::image type="content" source="/media/healthcareapis-workspace/workspace-terms.png" alt-text="Terms.":::
...
:::image type="content" source="/media/healthcareapis-workspace/healthcare-apis-deploy-services.png" alt-text="Healthcare APIs deploy services.":::

...
- **Cosmos DB throughput:** Azure API for FHIR relies on Cosmos DB as a underlying database. Here you can specify Cosmos DB RU settings for your Azure API for FHIR. You can change this setting later in the Cosmos DB blade. To learn more about Cosmos DB RU please read [Request Units in Azure Cosmos DB](https://docs.microsoft.com/en-us/azure/cosmos-db/request-units)

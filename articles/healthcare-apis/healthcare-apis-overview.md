...
## Examples of new workloads enabled by Azure Health Data Services
...
These are just some of the ways that Azure Health Data Services can help you create new solutions and applications that can improve health care delivery and outcomes.
...
- **Azure API for FHIR** does not have some platform features that are available in **Azure Health Data Services**, such as private link, customer managed keys, and logging. These features enhance the security and compliance of your health data.



## Next steps

To work with Azure Health Data Services, first you need to deploy an [Azure workpace](workspace-overview.md). 

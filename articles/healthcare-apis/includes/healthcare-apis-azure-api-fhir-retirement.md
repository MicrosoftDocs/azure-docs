...
[Azure Health Data Services FHIR service](../healthcare-apis-overview.md) is the evolved version of Azure API for FHIR that enables customers to manage [FHIR](../fhir/overview.md) and [DICOM](../dicom/overview.md) services with integrations into other Azure services.

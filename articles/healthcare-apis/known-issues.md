...
| :------------------------------------- | :------------ | :------------- | :------------- |
|Import functionality is not working as expected when NDJSON file size is greater than 2GB. Customer will see the import job stuck in retry mode| June, 2023| No workaround at this time|TBD|

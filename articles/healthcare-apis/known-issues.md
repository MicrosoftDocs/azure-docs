...
| :------------------------------------- | :------------ | :------------- | :------------- |
|Import functionality is not working as expected when NDJSON file size is greater than 2GB. Customer sees the import job stuck in retry mode.| June, 2023| Suggested workaround is to reduce file size less than 2GB.|--|

...
To change this setting later after you provision the service, you can navigate to Cosmos DB blade and change the setting from initial value to desired value depending on your performance needs. You can change the value to up to 10,000*. If you need a higher value, please contact Azure support.

***Note:** Higher value means higher Cosmos DB throughput thus higher cost of the service.

...
This article provides an overview of data flow in Azure API for IoT Connector. You'll learn about different data processing stages within the IoT connector service that transforms device data into Fast Healthcare Interoperability Resources (FHIR&#174;)*-based [Observation](https://www.hl7.org/fhir/observation.html) resources.

---
title: 'Concepts: Data flow in Azure IoT Connector for FHIR (preview) feature of FHIR service'
description: Understand Azure IoT Connector for FHIR (preview)'s data flow. Azure IoT Connector for FHIR (preview) ingests, normalizes, groups, transforms, and persists IoMT data to FHIR service.
...
## Persist
Once the Observation FHIR resource is generated in the Transform stage, resource is saved into FHIR service. If the FHIR resource is new, it will be created on the server. If the FHIR resource already existed, it will get updated.

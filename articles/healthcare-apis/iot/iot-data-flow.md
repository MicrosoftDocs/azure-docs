...
:::image type="content" source="media/iot-data-flow/iot-data-flow.png" alt-text="IoMT data flow from IoT devices into an event hub. IoMT data ingested by an IoT connector is normalized, grouped, transformed, and persisted in a FHIR service." lightbox="media/iot-data-flow/iot-data-flow.png":::

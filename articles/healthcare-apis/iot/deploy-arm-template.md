...
>
> To learn about the MedTech service resolution types **Create** and **Lookup**, see [Destination properties](deploy-manual-portal.md#configure-the-destination-tab).

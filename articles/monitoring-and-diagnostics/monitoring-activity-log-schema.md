...
## Recommendation
This category contains the record of any new recommendations that are generated for your services. An example of a recommendation would be "Use availability sets for improved fault tolerance." There are 4 types of Recommendation events can be generated: High Availability, Performance, Security, and Cost Optimization. 

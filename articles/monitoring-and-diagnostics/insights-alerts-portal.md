...
description: Trigger emails or notifications, call website URLs (webhooks) or automation when the conditions that you specify are met.
author: rboucher
manager: carmonm
editor: ''
...
2. Select **Alerts (Classic)** under the **MONITORING** section. The text and icon might vary slightly for different resources. If you don't find **Alerts (Classic)**, you might find it in **Alerts** or **Alert Rules**
...
10. Select **OK** when to create the alert.   

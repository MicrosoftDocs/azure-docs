...
| Search Interval Endtime |#searchintervalendtimeutc |End time for the query in UTC format. |
...
| SearchResults |"IncludeSearchResults":true|Records returned by the query as a JSON Table, limited to the first 1,000 records; if "IncludeSearchResults":true is added in custom JSON webhook defination as a top level property. |

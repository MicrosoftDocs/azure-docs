...
> [!NOTE]
>  [The newer alerts](monitoring-overview-alerts.md) offers an enhanced experience when creating and managing activity log alert rules.  [Learn more](monitoring-activity-log-alerts-new-experience.md).

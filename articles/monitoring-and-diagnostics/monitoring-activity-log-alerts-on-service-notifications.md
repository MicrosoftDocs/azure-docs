...
1. In the [portal](https://portal.azure.com), select **Personalized Service Health**.

    ![The "Personalized Service Health" service](./media/monitoring-activity-log-alerts-on-service-notifications/home-servicehealth.png)

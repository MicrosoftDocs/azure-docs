...
- **Signal** - Signals are emitted by the Target resource and can be of several types. This preview supports Metric and Log signal types.
...
| Logs  | Activity Logs | Not supported in Alerts (Preview) experience. |
| Logs  | Application Insights | Not supported in Alerts (Preview) experience. |

...
description:  Top level overview of Azure Monitor feature in Microsoft Azure, which includs alerts, webhooks, autoscale and more.
author: rboucher
manager: carmonm
editor: ''
...
> [!VIDEO https://channel9.msdn.com/Blogs/Azure-Monitoring/Get-Started-with-Azure-Monitor]
>
>

Additional video explaining a scenario where you can use Azure Monitor is available at [Explore Microsoft Azure monitoring and diagnostics](https://channel9.msdn.com/events/Ignite/2016/BRK2234).  

...
| d2c.telemetry.egress.dropped | Dropped telemetry messages | Count | Total | The count of messages dropped by not matching any routes and also having the fallback route disabled |

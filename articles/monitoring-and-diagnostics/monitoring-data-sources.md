...
| Azure Monitor Diagnostic Logs | Events | [See list here](monitoring-and-diagnostics/monitoring-diagnostic-logs-schema.md) | <ul><li>**Storage blob or event hub:** [Diagnostic Settings](monitoring-overview-of-diagnostic-logs.md#resource-diagnostic-settings)</li></ul> |

...
To send data from the Azure Active Directory log into an Event Hubs namespace, you set up a tenant diagnostic setting on your AAD tenant. [Follow this guide](../active-directory/active-directory-reporting-azure-monitor-diagnostics-azure-event-hub.md) to set up a tenant diagnostic setting.

...
All classic monitoring and alerting systems including corresponding [API](https://msdn.microsoft.com/library/azure/dn931945.aspx), [PowerShell](../azure-monitor/platform/alerts-classic-powershell.md), [CLI](../azure-monitor/platform/alerts-classic-cli.md), [Azure portal page](../azure-monitor/platform/alerts-classic-portal.md), and [Resource Template](monitoring-enable-alerts-using-template.md) will remain usable until end of June 2019. 

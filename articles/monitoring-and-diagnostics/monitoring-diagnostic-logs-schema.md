...
| Service | Schema & Docs |
| --- | --- |
| Azure Active Directory | [Overview](../active-directory/active-directory-reporting-azure-monitor-diagnostics-overview.md), [Audit log schema](../active-directory/active-directory-reporting-azure-monitor-diagnostics-audit-log-schema.md) and [Sign Ins schema](../active-directory/active-directory-reporting-azure-monitor-diagnostics-sign-in-log-schema.md) |

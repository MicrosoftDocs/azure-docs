...
First you need to set up a storage account to which the monitoring data will be archived. To do this, [follow the steps here](../common/storage-quickstart-create-account.md).
...
> [Get started with Log Analytics](../azure/log-analytics.md)

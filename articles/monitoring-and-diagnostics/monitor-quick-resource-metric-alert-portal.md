...
For more information on metrics and metric alerts, see  [Azure Monitor metrics overview](../monitoring/monitoring-data-collection.md) and [Azure Monitor alerts overview](./monitoring-overview-alerts.md). 

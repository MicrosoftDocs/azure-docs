...
The following diagram summarizes alerts and what you can do with them in Azure Monitor. Other actions may be available for the services listed previously.

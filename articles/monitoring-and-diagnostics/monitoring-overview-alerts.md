...
|Azure Monitor | [Near Real-Time Metric Alerts](./monitoring-near-real-time-metric-alerts.md)| [Supported resources from Azure Monitor](./monitoring-near-real-time-metric-alerts.md#metrics-and-dimensions-supported) | Receive a notification faster than metric alerts when one or more platform-level metrics meet specified conditions (for example, CPU % on a VM is greater than 90 and Network In is greater than 500 MB for the past 5 minutes). |

...
## [Diagnostic Logs](../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md)
...
### [View events in activity log](../monitoring-and-diagnostics/insights-debugging-with-events.md)
### [Configure webhook on an activity log alert](../monitoring-and-diagnostics/insights-auditlog-to-webhook-email.md)
### [Archive activity log](../monitoring-and-diagnostics/monitoring-archive-activity-log.md)
...
## [Sources of monitoring data](../monitoring-and-diagnostics/monitoring-data-sources.md)

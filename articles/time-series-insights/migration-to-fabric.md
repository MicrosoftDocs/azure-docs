...
> [!NOTE]
> We recommend that you migrate your Time Series Insights to [Eventhouse](/fabric/real-time-intelligence/eventhouse) in Real-Time Intelligence. Eventhouse is a SaaS offering of [Azure Data Explorer](/azure/data-explorer/data-explorer-overview), a service that is trusted by many customers. However, if you want to migrate to Azure Data Explorer, you can use the guidance in the [tsi2rti repository](https://aka.ms/tsi2rti) under **Readiness. The repository also contains tools that can help you migrate to either Eventhouse or Azure Data Explorer. 

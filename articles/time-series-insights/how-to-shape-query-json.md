...
The following two examples demonstrate how to send events to highlight the previous recommendations. Following each example, you can read how the recommendations were applied.

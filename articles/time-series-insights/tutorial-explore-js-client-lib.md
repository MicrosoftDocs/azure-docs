...
=======
2. Later, the application requests an "access token" from Azure AD. The access token is issued for a finite set of permissions, for a specific service/API identifier (https://api.timeseries.azure.com), also known as the token "audience." The token permissions are issued on behalf of the signed-in user. The identifier for the service/API is yet another property contained in the application's Azure AD registration. Once ADAL returns the access token to the application, it is passed as a "bearer token" when accessing the TSI service APIs.
>>>>>>> 3cb031ca10eed5f172d8b40de58643bdc9ec7d94

   [!code-javascript[head-sample](~/samples-javascript/pages/samples/index.html?range=140-199&highlight=4-9,36-39)]
...
[!code-javascript[code-sample1-line-bar-pie](~/samples-javascript/pages/samples/index.html?range=60-74&highlight=1,5,9,13)]
...
[!code-javascript[code-sample2-line-bar-pie](~/samples-javascript/pages/samples/index.html?range=236-257&highlight=13-14,16-17,19-20)]
...
[!code-javascript[code-sample-states-events](~/samples-javascript/pages/samples/index.html?range=332-384&highlight=5,26,51)]
...
[!code-javascript[code-sample-context-menus](~/samples-javascript/pages/samples/index.html?range=456-535&highlight=7,16,29,61-64,78)]
...
[!code-javascript[code-sample-brushes](~/samples-javascript/pages/samples/index.html?range=521-535&highlight=1,13)]

...
* Understand how to optimize and shape your JSON data, as well as the current limitions in preview, by reading [how to shape JSON for ingress and query](./time-series-insights-update-how-to-shape-events.md).

---
title: How to diagnose and troubleshoot The Azure Time Series Insights V2 Update | Microsoft Docs
...
# How to diagnose and troubleshoot The Azure Time Series Insights V2 Update
...
This may occur if your environment doesn’t have a Time Series Model Hierarchy defined. See this article for more information on [authoring a hierarchy and associating it with specific instances]().

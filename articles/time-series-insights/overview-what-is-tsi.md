---
title: 'Overview: What is Azure Time Series Insights Gen 2? - Azure Time Series Insights | Microsoft Docs'
...
Learn more about Azure Time Series Insights Gen 2.
...
A rich operational analytics platform combined with our interactive data exploration capabilities, you can use Azure Time Series Insights to derive more value out of data collected from IoT assets. The Gen 2 offering supports: 
...
* Extensibility and integration support for end-to-end analytics. Azure Time Series Insights provides an extensible analytics platform for a variety of data scenarios. Azure Time Series Insights Power BI connector enables customers to take the queries they do in Azure Time Series Insights directly into Power BI to get unified view of their BI and time series analytics in a single pane of glass.
...
| Custom applications built on the Azure Time Series Insights platform | Azure Time Series Insights supports the [JavaScript SDK](https://github.com/microsoft/tsiclient/blob/master/docs/API.md). The SDK provides rich controls and simplified access to queries. Use the SDK to build custom IoT applications on top of Azure Time Series Insights to suit your business needs. You also can use the Azure Time Series Insights [Query APIs](./time-series-insights-update-tsq.md) directly to drive data into custom IoT applications. |

## Next steps

Get started with Azure Time Series Insights Gen 2:
...
> [!div class="nextstepaction"]
> [Azure Time Series Insights Gen 2 use cases](./time-series-insights-update-use-cases.md)
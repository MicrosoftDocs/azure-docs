---
title: 'Overview: What is Azure Time Series Insights? - Azure Time Series Insights Gen 2 | Microsoft Docs'
...
Azure Time Series Insights has four key functionalities:
...
1. Provision a Azure Time Series Insights environment in the Azure portal.
...
- Explore a demo [Azure Time Series Insights Gen 2 environment](./quickstart-explore-tsi.md).

- Learn more about how to [plan your Azure Time Series Insights environment](./how-to-plan-your-environment.md).

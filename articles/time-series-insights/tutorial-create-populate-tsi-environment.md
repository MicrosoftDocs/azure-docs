...
3. Enter the required parameters on the **New event source** page: 
   ...
   **Timestamp property name** | Specify as "timestamp."
   ...
   When finished, click **Create** to add the event source. Back on the resource **Overview** page, in addition to your TSI environment resource, you will see a new "Time Series Insights event source" resource.

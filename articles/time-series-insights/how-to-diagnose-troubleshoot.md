...
This problem might occur if your environment doesn't have a Time Series Model hierarchy defined. For more information, read about how to [work with Time Series Models](/azure/time-series-insights/concepts-model-overview).
...
- Read about how to [work with Time Series Models](/azure/time-series-insights/concepts-model-overview).

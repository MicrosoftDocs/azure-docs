...
| Arrays of primitive types are stored as the Dynamic type |  ```"values": [154, 149, 147]``` | Dynamic types can only be retreived via the [GetEvents](https://docs.microsoft.com/rest/api/time-series-insights/dataaccessgen2/query/execute#getevents) API | `values_dynamic` |
...
| Arrays containing mixed elements aren't flattened. |  ```"values": ["foo", {"bar" : 149}, 147]``` | Dynamic types can only be retreived via the [GetEvents](https://docs.microsoft.com/rest/api/time-series-insights/dataaccessgen2/query/execute#getevents) API | `values_dynamic` |

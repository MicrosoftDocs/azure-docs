...
Reference data is not joined retroactively, meaning that only current and future ingress data is matched and joined to the reference date set, once is has been configured and uploaded.

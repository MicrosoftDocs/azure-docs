...
> [!NOTE]
> To read more about how to query your warm data, [see here](https://docs.microsoft.com/en-us/rest/api/time-series-insights/dataaccess(preview)/query/execute#uri-parameters).

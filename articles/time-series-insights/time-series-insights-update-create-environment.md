...
This document describes how to provision and manage a new Azure Time Series Insights V2 Update environment in the Azure portal.
...
* As part of the creation process you will need to provide a **Time Series ID**. It can be up to 3 keys. Learn more about [Time Series ID]().
...
Here are the major differences in managing an L1 Time Series Insights environment versus an S1 or S2 environment using the Azure portal:

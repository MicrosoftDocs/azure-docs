---
title: Provision and manage a Gen2 environment - Azure Time Series | Microsoft Docs
description: Learn how to provision and manage an Azure Time Series Insights Gen2 environment.
author: deepakpalled
ms.author: dpalled
manager: diviso
...
Azure Time Series Insights Gen2 environments.
...
1. **(Optional)** Associate each Azure Time Series Insights Gen2 environment with an event source. You will also provide a Timestamp ID property and a unique consumer group to ensure that the environment has access to the appropriate events.
...
To create an Azure Time Series Insights Gen2 environment:
...
1. Create an Azure Storage account by selecting a storage account name and designating a replication choice. Doing so automatically creates an Azure Storage general-purpose v1 account. The account is created in the same region as the Azure Time Series Insights Gen2 environment that you previously selected.

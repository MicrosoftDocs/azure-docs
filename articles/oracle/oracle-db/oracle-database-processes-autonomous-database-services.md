---
title: Database ops processes for Oracle AI Database@Azure
description: Learn about database operations processes for Oracle AI Database@Azure.
author: jjaygbay1
ms.author: jacobjaygbay
ms.topic: concept-article
ms.service: oracle-on-azure
ms.date: 08/01/2024
# Customer intent: "As a database administrator managing Oracle AI Databases in Azure, I want to implement the Autonomous Recovery Service, so that I can ensure seamless backup and recovery while meeting compliance requirements and minimizing operational costs."
---

# Database operations processes for Oracle AI Database@Azure
...
Oracle AI Database Autonomous Recovery Service@Azure is the preferred backup solution to use for Oracle AI Database@Azure resources. Here are some of the key benefits of using Oracle AI Database Autonomous Recovery Service@Azure:
...
* It shortens the backup window via an incremental-forever paradigm that moves smaller amounts of backup data between the database and Oracle AI Database Autonomous Recovery Service@Azure.
...
### High-level steps to enable Oracle AI Database Autonomous Recovery Service@Azure

1. Go to the OCI console for the database you want to enable for Oracle AI Database Autonomous Recovery Service@Azure. Learn how to [access the OCI console](oracle-database-manage-autonomous-database-resources.md).
1. Configure or create an Oracle AI Database Autonomous Recovery Service@Azure protection policy with storage backups in the same cloud provider as the database.
...
* [Support for multicloud Oracle AI Database backup](https://docs.oracle.com/en/cloud/paas/recovery-service/dbrsu/azure-multicloud-recoveryservice.html)

...
Yes, Oracle Base Database service is now generally available on Azure. You can now run any Oracle AI Database service with version flexibility (19c or 23ai).

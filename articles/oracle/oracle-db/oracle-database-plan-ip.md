...
**11 IPs *(virtual machine cluster that has two virtual machines, plus three SCANs)* + 17 IPs *(for networking services)* = 28 IPs**
...
|--------|---|---|---|---|---|---|
|One virtual machine cluster that has two virtual machines *(11 IPs + 17 IPs for networking services = 28)*|1|4|10|21|45|91|
|One virtual machine cluster that has three virtual machines *(15 IPs + 17 IPs for networking services = 32*)|1|3|7|15|33|67|
|One virtual machine cluster that has four virtual machines *(19 IPs + 17 IPs for networking services = 36)*| |2|5|12|26|53|
|Two virtual machine clusters that have two virtual machines each *(22 IPs + 17 IPs for networking services = 39)*| |2|5|10|22|45|
|Two virtual machine clusters that have three virtual machines each *(30 IPs + 17 IPs for networking services = 47)*| |1|3|7|16|33|
|Two virtual machine clusters that have four virtual machines each *(38 IPs + 17 IPs for networking services = 55)*| |1|2|6|13|26|
...
|Scenario|/27|/26|/25|/24|/23|/22|
|--------|---|---|---|---|---|---|
|One virtual machine cluster that has two virtual machines *(11 IPs + 17 IPs for networking services = 28)*|1|2|4|9|18|36|
|One virtual machine cluster that has three virtual machines *(15 IPs + 17 IPs for networking services = 32)*|1|2|4|8|16|32|
|One virtual machine cluster that has four virtual machines *(19 IPs + 17 IPs for networking services = 36)*| |1|3|7|14|28|
|Two virtual machine clusters with two virtual machines each *(22 IPs + 17 IPs for networking services = 39)*| |1|3|6|13|26|
|Two virtual machine clusters with three virtual machines each *(30 IPs + 17 IPs for networking services = 47)*| |1|2|5|10|21|
|Two virtual machine clusters with four virtual machines each *(38 IPs + 17 IPs for networking services = 55)*| |1|2|4|9|18|
...
**Example**: IP addresses required for a backup subnet that has one virtual machine cluster and two virtual machines:

**6 IPs *(virtual machine cluster that has two virtual machines)* + 3 IPs *(for networking services)* = 9 IPs**

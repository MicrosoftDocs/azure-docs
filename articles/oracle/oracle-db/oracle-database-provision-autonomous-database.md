---
title: Provision Oracle Autonomous AI Database
description: Learn how to provision an instance of Oracle Autonomous AI Database in Azure.
author: jjaygbay1
ms.author: jacobjaygbay
ms.topic: concept-article
ms.service: oracle-on-azure
ms.date: 08/01/2024
# Customer intent: As an IT administrator, I want to provision an instance of Oracle Autonomous AI Database in Azure, so that I can efficiently manage my database services within the cloud environment and ensure optimal performance for my applications.
---

# Provision an instance of Oracle AI Database@Azure

You provision and manage basic functions for an Oracle Autonomous AI Database instance on the Oracle Autonomous AI Database@Azure pane in the Azure portal. More management functions are available in the Oracle Cloud Infrastructure (OCI) console via the link to that database on the Oracle Autonomous AI Database@Azure pane.
...
## Provision Oracle AI Database@Azure

To provision an Oracle Autonomous AI Database instance:

1. Go to the Azure portal.
1. Choose one of the following options to begin provisioning your instance of Oracle AI Database@Azure:

   - On the home pane for the Oracle Autonomous AI Database@Azure application, select **Create an Oracle Autonomous AI Database**.
   - On the **Oracle Autonomous AI Database@Azure** pane, select **Create**. The Oracle Autonomous AI Database@Azure pane shows all your existing instances of Oracle Autonomous AI Database@Azure and the current status. To see detailed information about an instance of Oracle Autonomous AI Database@Azure, select the instance in the list.
...
1. On the **Basics** tab, enter or select the following information:
   ...
   1. For **Name**, enter a name for your instance of Oracle AI Database@Azure. The name must be unique within your subscription.
...
1. On the **Configuration** tab, enter or select the following information:
   ...
   1. For **Workload type**, select the relevant option for your Oracle AI Database@Azure instance.
   1. For **Database version**, select from the options that are provided based on your subscription and the currently supported versions of Oracle AI Database@Azure.
...
1. On the **Maintenance** tab, enter or select the following information:
   ...
   1. The value for **Maintenance patch level** is set automatically. Your Oracle Autonomous AI Database is patched on a regular and as-needed basis. Patching is done in a manner that should be unnoticeable to you. *Regular* means that the typical patch schedule is applied. For more information, see [View patch and maintenance window information](https://docs.oracle.com/iaas/autonomous-database-serverless/doc/maintenance-windows-patching.html).
...
1. On the **Tags** tab, optionally set one or more tags for easier management and to track multiple instances of Oracle AI Database@Azure. For more information, see [Use tags to organize your Azure resources and management hierarchy](https://go.microsoft.com/fwlink/?linkid=873112). Then select **Next**.
...
1. On the **Oracle Autonomous AI Database@Azure** pane, view the status of your provisioning process. When the provisioning process succeeds, select the entry in the list.

1. The basic information for your Oracle AI Database@Azure instance is shown. You can complete functions that are shared with Azure. For most administrative functions for the database, under **OCI Database URL**, select the **Go to OCI** link.

For the complete Oracle documentation, see [Using Oracle Autonomous AI Database Serverless](https://docs.oracle.com/en/cloud/paas/autonomous-database/serverless/adbsb/autonomous-intro-adb.html#GUID-8EAA5AE6-397D-4E9A-9BD0-3E37A0345E24).

...
Oracle Database@Azure is an Oracle Database service available in your Azure environment. The service uses hardware colocated in Microsoft Azure data centers. This ensures that the Oracle Database@Azure service has the fastest possible access to Azure resources and applications.

As an Azure customer, you subscribe to this service inside your Azure environment, as you do with other Azure services. Like other Azure services, Oracle Database@Azure systems use an Azure Virtual Network (VNet) for networking, managed within Azure. The service uses the Azure tenancy's identity management and authorization, which can be either the Azure identity service or a federated identity provider.

...
>To use advanced network features, use the following commands (via AZCLI) to register before creating new delegated subnet  for the Oracle Database@Azure deployment.
>

...
Yes. To take advantage of advanced network features for new deployments, you must complete a registration process. Please run the registration commands before creating a new delegated subnet in your existing or new VNet for your Oracle Database@Azure deployments.

...
Oracle AI Database@Azure (OracleDB@Azure) provides you seamless integration of Oracle resources within your Microsoft Azure cloud environment.
...
* [Provision Oracle Autonomous AI Databases](provision-autonomous-oracle-databases.md)
* [Use HashiCorp Terraform to provision Oracle AI Database@Azure](provision-use-terraform-oracle-database.md)
* [Manage resources for Oracle AI Database@Azure](provision-manage-oracle-resources.md)

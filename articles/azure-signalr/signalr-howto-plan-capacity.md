---
title: Howto - plan capacity with Azure SignalR Service
description: A howto guide to plan capacity with Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Plan capacity with Azure SignalR Service
<!---Required:

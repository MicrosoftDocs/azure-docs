---
title: "Tutorial: Develop with IoT edge for real time application"
description: In this tutorial, you learn how to develop real time application with IoT edge, to use Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: tutorial
ms.date: 02/01/2019

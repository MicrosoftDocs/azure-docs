---
title: Howto - monitor Azure SignalR Service with charts
description: A howto guide to monitor Azure SignalR Service with charts.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Monitor Azure SignalR Service with charts
<!---Required:

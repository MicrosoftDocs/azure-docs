---
title: Quickstart - Azure SignalR Service with Java client
description: A quickstart to develop real time application with the Azure SignalR Service and Java client.
author: sffamily
ms.service: signalr
ms.devlang: java
ms.topic: quickstart
...
# Quickstart: Use Java Client with Azure SignalR Service 
<!---Required:

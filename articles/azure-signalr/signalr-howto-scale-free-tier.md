---
title: Howto - scale Azure SignalR Service free tier
description: A howto guide to scale Azure SignalR Service free tier.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Scale Azure SignalR Service free tier
<!---Required:

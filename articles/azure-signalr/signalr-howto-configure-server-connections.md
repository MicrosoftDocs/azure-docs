---
title: Howto - configure server connection with Azure SignalR Service
description: A howto guide to configure server connection with Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Configure server connection with Azure SignalR Service
<!---Required:

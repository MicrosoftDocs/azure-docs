...
## Quick evaluation using metrics
   Before going through the factors that impact the performance, let's first introduce an easier way to monitor the pressure of your service. There's a metrics called **Server Load** on the Portal.
  ![image](./media/signalr-concept-performance/serverload.png)

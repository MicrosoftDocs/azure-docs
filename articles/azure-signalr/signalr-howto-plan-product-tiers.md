---
title: Howto - choose right product tier with Azure SignalR Service
description: A howto guide to choose right product tier with Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Choose right product tier with Azure SignalR Service
<!---Required:

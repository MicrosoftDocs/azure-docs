---
title: Quickstart - provision Azure SignalR Service using Azure CLI
description: A quickstart to provision Azure SignalR Service with Azủre CLI.
author: sffamily
ms.service: signalr
ms.topic: quickstart
ms.date: 02/01/2019
...
# Quickstart: Use Azure CLI to provision Azure SignalR Service instance 
<!---Required:

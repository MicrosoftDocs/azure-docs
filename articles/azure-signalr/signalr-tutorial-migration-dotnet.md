---
title: "Tutorial: Migrate ASP.NET SignalR application to use Azure SignalR Service"
description: In this tutorial, you learn how to migrate existing real time application built with ASP.NET SignalR, to use Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: tutorial
ms.date: 02/01/2019

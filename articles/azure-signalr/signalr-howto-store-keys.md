---
title: Howto - store keys securely with Azure SignalR Service
description: A howto guide to store keys securely with Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Store keys securely with Azure SignalR Service 
<!---Required:

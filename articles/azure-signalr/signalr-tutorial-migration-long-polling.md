---
title: "Tutorial: Migrate Long Polling based real time application to use Azure SignalR Service"
description: In this tutorial, you learn how to migrate existing real time application using Long Polling, to use Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: tutorial
ms.date: 02/01/2019

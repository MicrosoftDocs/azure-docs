---
title: Howto - monitor key metrics with Azure SignalR Service
description: A howto guide to monitor key metrics with Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Monitor key metrics with Azure SignalR Service
<!---Required:

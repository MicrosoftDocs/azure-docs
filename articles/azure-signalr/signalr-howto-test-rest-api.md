---
title: Howto - test Azure SignalR Service for REST APIs
description: A howto guide to test REST API for Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Test REST API with Azure SignalR Service 
<!---Required:

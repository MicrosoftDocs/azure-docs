---
title: Sample for real time data dashboard
description: A sample project using Azure SignalR Service to create a real time data dashboard
author: sffamily
ms.service: signalr
ms.topic: sample
ms.date: 02/01/2019
...
# Sample: Real time data dashboard
<!---Required:

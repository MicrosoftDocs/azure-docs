---
title: Howto - handle disconnection with Azure SignalR Service
description: A howto guide to handle disconnection with Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Handle disconnection with Azure SignalR Service
<!---Required:

---
title: Howto - decide migrate versus build with Azure SignalR Service
description: A howto guide to decide migrate versus build with Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Decide migrate versus build with Azure SignalR Service
<!---Required:

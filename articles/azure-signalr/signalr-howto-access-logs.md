---
title: Howto - access logs with Azure SignalR Service
description: A howto guide to access logs with Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Access logs with Azure SignalR Service
<!---Required:

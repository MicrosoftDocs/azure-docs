---
title: Howto - Test Azure SignalR Service JWT signing
description: A howto guide to test Azure SignalR Service with JWT signing.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Test Azure SignalR Service for JWT signing 
<!---Required:

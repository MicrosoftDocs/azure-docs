---
title: Howto - Set up regions for Azure SignalR Service
description: A howto guide to set up regions for Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: howto
ms.date: 02/01/2019
...
# Howto guide: Set up regions for Azure SignalR Service
<!---Required:

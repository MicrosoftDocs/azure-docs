---
title: Sample for real time IoT dashboard on map
description: A sample project using Azure SignalR Service to create a real time IoT dashboard
author: sffamily
ms.service: signalr
ms.topic: sample
ms.date: 02/01/2019
...
# Sample: Real time IoT dashboard
<!---Required:

...
Azure SignalR Service uses [Azure availability zones](/azure/reliability/availability-zones-overview) to provide high availability and fault tolerance within an Azure region.

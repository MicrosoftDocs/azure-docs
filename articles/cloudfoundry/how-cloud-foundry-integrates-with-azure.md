...
!NOTE from PCF 2.0, BOSH health metrics for VMs are forwarded to the Loggregator Firehose by default, and are integrated with Azure Log Analytics OMS console.

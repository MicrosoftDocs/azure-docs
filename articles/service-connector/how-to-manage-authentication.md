...
- This guide assumes that you already know the basics of connecting services by using Service Connector. To review our quickstarts, go to [App Service](quickstart-portal-app-service-connection.md) or [Azure Spring Apps](quickstart-portal-spring-cloud-connection.md).

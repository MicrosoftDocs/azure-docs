...
> [!IMPORTANT]
> Currently, manual steps are required for complete onboarding. Please see [Manual steps required for SQL database in Microsoft Fabric](../how-to-integrate-fabric-sql.md#manual-steps).

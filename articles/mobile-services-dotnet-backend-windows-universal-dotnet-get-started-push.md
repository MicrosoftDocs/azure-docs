...
<div class="dev-callout"><strong>Note</strong> <p>You can also simplify the generated code by unifying the <code>#if...#endif</code> wrapped MobileServiceClient definitions into a single definition used by both versions of the app.</p></div></li>
</ol>

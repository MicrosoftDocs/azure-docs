...
This article provides instructions on using a custom domain name purchased from DomainDiscover.com  with Azure Web Sites. DomainDiscover.com is part of TierraNet.

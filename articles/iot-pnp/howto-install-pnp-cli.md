---
title: Use the Azure IoT extension for the Azure CLI to interact with IoT Plug and Play devices | Microsoft Docs
description: Install the Azure IoT extension for the Azure CLI and use it to interact with the Plug and Play devices connected to my IoT hub.
author: ChrisGMsft
ms.author: chrisgre
ms.date: 07/10/2019
ms.topic: conceptual

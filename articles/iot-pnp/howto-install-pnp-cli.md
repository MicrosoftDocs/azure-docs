...
> [!NOTE]
> Bug bash: Skip this section - you'll need to get a azure-cli-iot-ext whl file. 
> Remove previously installed IoT CLI Extension: az extension remove --name azure-cli-iot-ext
> Add PnP enabled extension: az extension add -y --source azure_cli_iot_ext-VERSION-py2.py3-none-any.whl
> Verify installation of azure-cli-iot-ext version: az extension list

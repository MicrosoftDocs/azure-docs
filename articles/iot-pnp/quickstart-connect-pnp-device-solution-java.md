...
1. Clone the [Azure IoT Samples for Java](https://github.com/azure-samples/azure-iot-samples-java) GitHub repository:

    ```cmd/sh
    git clone https://github.com/azure-samples/azure-iot-samples-java
    ```

1. In a terminal, go to the root folder of your cloned repository, navigate to the **/azure-iot-samples-node/digital-twins/Quickstarts/Device** folder. Install the required libraries and build the simulated device application by running the following command:
...
1. Open another terminal. Go to the folder of your cloned repository, and navigate to the **/azure-iot-samples-node/digital-twins/Quickstarts/Service** folder. Install the required libraries and build the simulated device application by running the following command:

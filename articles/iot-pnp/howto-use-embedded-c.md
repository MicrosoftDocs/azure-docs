...
The Azure RTOS samples are provided with a variety of IDE and toolchain combinations, such as:
...
For samples that show you how to get started on different devices with Azure RTOS and IoT Plug and Play, see the following:

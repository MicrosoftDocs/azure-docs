...
If you completed [Quickstart: Connect a sample IoT Plug and Play device application running on Windows to IoT Hub (Node)](quickstart-connect-device.md), you've already cloned the repository.

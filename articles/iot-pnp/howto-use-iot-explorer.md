...
In this how-to article, you learned how to install and use Azure IoT explorer to interact with your IoT Plug and Play devices. A suggested next step is to learn how to use the [Azure CLI IoT PnP commands](./howto-use-iot-pnp-cli.md).

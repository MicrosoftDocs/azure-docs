...
1. The following section describes how to set the required environment variable before you run the sample. When you're ready, right-click on the *pnp_temperature_controller* folder in **Solution Explorer** to debug or run the sample.

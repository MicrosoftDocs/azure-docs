...
1. Create a device called *my-mqtt-device* that uses an auto-generated symmetric key.
...
* `PWD` identifier with the correct part of the the SAS token connection string you generated for the device. Use the part of the connection string from `SharedAccessSignature sr=` through to the end.

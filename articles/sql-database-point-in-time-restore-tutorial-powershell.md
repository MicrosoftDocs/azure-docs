...
1. Get the database you want to restore by using the [Get-AzureSqlDatabase](http://msdn.microsoft.com/en-us/library/azure/dn546735.aspx) cmdlet. Specify the following parameters:
...
2. Begin the restore by using the [Start-AzureSqlDatabaseRestore](http://msdn.microsoft.com/en-us/library/azure/dn720218.aspx) cmdlet. Specify the following parameters:	

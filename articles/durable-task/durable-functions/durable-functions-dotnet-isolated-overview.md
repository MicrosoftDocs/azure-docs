...
For the full list of isolated worker benefits, see [Benefits of the isolated worker model](../../azure-functions/dotnet-isolated-process-guide.md#benefits-of-the-isolated-worker-model).

...
- Familiarity with the [.NET isolated worker model](../../azure-functions/dotnet-isolated-process-guide.md)
...
- Familiarity with the [Python v2 programming model](../../azure-functions/functions-reference-python.md)
...
Activity functions in Azure Functions are regular Python functions. Test them directly. For more information, see [Azure Functions Python unit testing](../../azure-functions/functions-reference-python.md#unit-testing).
...
- [Durable Functions overview](../common/what-is-durable-task.md)
...
- [Orchestrator function code constraints](../common/durable-task-code-constraints.md)
- [Develop with the Durable Task Scheduler](../scheduler/develop-with-durable-task-scheduler.md)

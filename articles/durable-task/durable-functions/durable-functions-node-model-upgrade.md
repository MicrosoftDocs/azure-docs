...
> [!IMPORTANT]
> Complete the general [Node.js v4 upgrade guide](../../azure-functions/functions-node-upgrade-v4.md) first. This article covers only the extra Durable Functions-specific changes.
...
- [Azure Functions Runtime](../../azure-functions/functions-versions.md?tabs=v4&pivots=programming-language-javascript) version 4.25+
- [Azure Functions Core Tools](../../azure-functions/functions-run-local.md?tabs=v4) version 4.0.5382+ (if running locally)
...
If you see the following error, make sure you're running at least `v4.25` of the [Azure Functions Runtime](../../azure-functions/functions-versions.md?tabs=v4&pivots=programming-language-javascript) or at least `v4.0.5382` of [Azure Functions Core Tools](../../azure-functions/functions-run-local.md?tabs=v4) if running locally.

...
- [Official Microsoft migration guide (all Azure Functions)](../../azure-functions/migrate-dotnet-to-isolated-model.md)
- [.NET isolated worker process overview](../../azure-functions/dotnet-isolated-process-guide.md)
- [Isolated worker model differences](../../azure-functions/dotnet-isolated-in-process-differences.md)
...
- [Configure Durable Task Scheduler](../scheduler/develop-with-durable-task-scheduler.md)
...
- [Azure Functions Runtime](../../azure-functions/functions-versions.md) v4.16+
- [Azure Functions Core Tools](../../azure-functions/functions-run-local.md) v4.0.5095+ (if running locally)
...
If you're running locally using [Azure Functions Core Tools](../../azure-functions/functions-run-local.md), you should add this setting to your `local.settings.json` file. If you're running in Azure, follow these steps with the tool of your choice:
...
You have two options for installing the SDK package. Use [managed dependencies](./../../azure-functions/functions-reference-powershell.md#managed-dependencies-feature) (recommended for most apps) or [bundle the module with your app content](./../../azure-functions/functions-reference-powershell.md#including-modules-in-app-content) if you need to pin a specific version or your deployment doesn't support managed dependencies. Only one option is needed.

#### Option 1: Use managed dependencies (recommended)

To install the SDK as a managed dependency, follow the [managed dependencies guidance](./../../azure-functions/functions-reference-powershell.md#dependency-management).
...
To bundle the SDK with your app, place the SDK package inside a `".\Modules"` directory at the root of your app. For more information, see [Including modules in app content](./../../azure-functions/functions-reference-powershell.md#including-modules-in-app-content).

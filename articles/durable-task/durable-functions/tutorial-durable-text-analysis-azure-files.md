...
- [Choose a file access strategy for Azure Functions](../../azure-functions/concept-file-access-options.md)
- [Tutorial: Process images by using FFmpeg on a mounted Azure Files share](../../azure-functions/tutorial-ffmpeg-processing-azure-files.md)
- [Flex Consumption plan](../../azure-functions/flex-consumption-plan.md)
- [Storage considerations for Azure Functions](../../azure-functions/storage-considerations.md)

...
The Durable Task Roslyn Analyzer is a live code analyzer that helps you follow [orchestrator code constraints](../common/durable-task-code-constraints.md) in your C# Durable Task SDK apps. It detects common issues like non-deterministic API usage and type mismatches at build time, before your code reaches production.
...
These rules enforce [orchestrator code constraints](../common/durable-task-code-constraints.md) by detecting non-deterministic or unsafe API usage inside orchestration methods.
...
> [Orchestrator function code constraints](../common/durable-task-code-constraints.md)

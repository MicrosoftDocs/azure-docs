---
title: Create an Azure Blockchain Service using CLI
description: Use Azure Blockchain service to create a consortium member using CLI.
...
# Quickstart: Create an Azure Blockchain Service using CLI

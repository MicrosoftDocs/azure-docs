...
1. On the **New Redis Cache** page, configure the settings for your new cache.
   ...
   :::image type="content" source="create/managed-redis-new-cache-basics.png" alt-text="Screenshot showing the Azure Managed Redis Basics tab.":::
...
1. Select **Next: Advanced**.
   ...
   :::image type="content" source="create/managed-redis-advanced-settings.png" alt-text="Screenshot that shows the Azure Managed Redis Advanced tab.":::

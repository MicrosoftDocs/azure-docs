...
- For learning about sharing state into and out of templates, see [Sharing State in Azure Resource Manager Templates](best-practices-resource-manager-design-templates.md)

...
![office365-users-admin-center.png](media\add-office-365-to-existing-azure-account\1-office365-users-admin-center.png)
...
1. Sign up for Azure at [Azure.com](https://azure.microsoft.com/). Click on **Try for free*. On the next page, click **Start now**.
	...
	![azure-signup-try-free](media\add-office-365-to-existing-azure-account\2-azure-signup-try-free.png)

2. Click **Sign in with your organizational account**.

	![sign-in-to-azure](media\add-office-365-to-existing-azure-account\3-sign-in-to-azure.png)

3. Sign in with your Office 365 account. In this case, it is Kelley’s Office 365 account.

	![sign-in-with-org-account](media\add-office-365-to-existing-azure-account\4-sign-in-with-org-account.png)

4. Fill in the information and complete the sign-up process.

	![azure-sign-up-fill-information](media\add-office-365-to-existing-azure-account\5-azure-sign-up-fill-information.png)

5. Click **Start managing my service** and you are good to go.

	![azure-start-managing-my-service](media\add-office-365-to-existing-azure-account\6-azure-start-managing-my-service.png)
...
2. Click **Browse**, and then click **Active Directory**.
	...
	![azure-portal-browse-ad](media\add-office-365-to-existing-azure-account\7-azure-portal-browse-ad.png)

3. Click **USERS**.

	![azure-portal-ad-users-tab](media\add-office-365-to-existing-azure-account\8-azure-portal-ad-users-tab.png)

4. All the users including Kelley are listed as expected.

	![azure-portal-ad-users](media\add-office-365-to-existing-azure-account\9-azure-portal-ad-users.png)
...
![azure-portal-settings-subscription](media\add-office-365-to-existing-azure-account\10-azure-portal-settings-subscription.png)

![azure-portal-ads-users](media\add-office-365-to-existing-azure-account\11-azure-portal-ads-users.png)
...
2. After you select the plan, the following page is displayed. Do not fill in the form. Click **Sign in** on the top right of the page.
	...
	![office-365-trial-page](media\add-office-365-to-existing-azure-account\12-office-365-trial-page.png)

3. Sign in with the credential of your account. In this case, it is Kelley’s account.

	![office-365-sign-in](media\add-office-365-to-existing-azure-account\13-office-365-sign-in.png)

4. Click **Try now**.

	![office-365-confirm-your-order](media\add-office-365-to-existing-azure-account\14-office-365-confirm-your-order.png)

5. On the order receipt page, click **Continue**.

	![office-365-order-receipt](media\add-office-365-to-existing-azure-account\15-office-365-order-receipt.png)
...
2. Expand **USERS**, and then click **Active Users**.
	...
	![office-365-admin-center-users](media\add-office-365-to-existing-azure-account\16-office-365-admin-center-users.png)
...
3. Click **USERS**.
	...
	![azure-portal-default-ad-users](media\add-office-365-to-existing-azure-account\17-azure-portal-default-ad-users.png)

4. Click the user. In this example, Kelley Wall.
5. Notice the field of **ORGANIZATIONAL ROLE**.

	![azure-portal-user-identity](media\add-office-365-to-existing-azure-account\18-azure-portal-user-identity.png)
...
![background-information](media\add-office-365-to-existing-azure-account\19-background-information.png)

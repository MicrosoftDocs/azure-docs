...
7. Select **Download Usage** to download the daily usage data as a CSV file. If you see two versions available, download version 2.</br>![DLusage](./media/billing-download-azure-invoice-daily-usage-date/DLusage.png)

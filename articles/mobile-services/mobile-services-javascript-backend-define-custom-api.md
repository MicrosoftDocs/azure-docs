...
For information on how to invoke a custom API in your app using a Mobile Services client library, see [Call a custom API](./mobile-services-windows-dotnet-how-to-use-client-library/#custom-api) in the client SDK reference.

...
3. Now you need to create an Azure [storage account](storage/storage-create-storage-account.md). We named ours "accessstorage," so pick a name that's meaningful to you (there can be only one "accessstorage").

<properties title="Bottle and Azure Table Storage on Azure with Python Tools 2.1 for Visual Studio" pageTitle="Bottle and Azure Table Storage on Azure with Python Tools 2.1 for Visual Studio" description="Learn how to use the Python Tools for Visual Studio to create a Bottle application that stores data in a Azure Table Storage database instance and can be deployed to a web site." metaKeywords="" services="" solutions="" documentationCenter="Python" authors="huvalo" videoId="" scriptId="" />
...
<!--Image references-->
[1]: ./media/python-ptvs-bottle-table-storage/PollsBottleNewProject.png
[2]: ./media/python-ptvs-bottle-table-storage/PollsBottleExternalPackages.png
[3]: ./media/python-ptvs-bottle-table-storage/PollsCommonAddVirtualEnv.png
[4]: ./media/python-ptvs-bottle-table-storage/PollsBottleInMemoryBrowser.png
[5]: ./media/python-ptvs-bottle-table-storage/PollsCommonAzurePlusNew.png
[6]: ./media/python-ptvs-bottle-table-storage/PollsCommonAzureStorageCreate.png
[7]: ./media/python-ptvs-bottle-table-storage/PollsCommonAzureTableStorageManageKeys.png
[8]: ./media/python-ptvs-bottle-table-storage/PollsBottleAzureTableStorageProjectDebugSettings.png
[9]: ./media/python-ptvs-bottle-table-storage/PollsBottleAzureTableStorageAbout.png
[10]: ./media/python-ptvs-bottle-table-storage/PollsCommonServerExplorer.png
[11]: ./media/python-ptvs-bottle-table-storage/PollsCommonServerExplorerTable.png
[12]: ./media/python-ptvs-bottle-table-storage/PollsCommonPublishWebSiteDialog.png
[13]: ./media/python-ptvs-bottle-table-storage/PollsCommonCreateWebSite.png
[14]: ./media/python-ptvs-bottle-table-storage/PollsCommonWebSiteTopMenu.png
[15]: ./media/python-ptvs-bottle-table-storage/PollsCommonWebSiteConfigureSettingsTableStorage.png
[16]: ./media/python-ptvs-bottle-table-storage/PollsCommonWebSiteConfigureBottomMenu.png
[17]: ./media/python-ptvs-bottle-table-storage/PollsBottleAzureBrowser.png

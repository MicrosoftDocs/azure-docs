...
- [Can i configure Firewall with geo-replication?](#can-i-configure-firewall-with-geo-replication)
...
Yes, you can configure [Firewall](https://docs.microsoft.com/en-us/azure/azure-cache-for-redis/cache-configure#firewall) with geo-replication. For geo-replication to function alongside Firewall, ensure that the secondary cache's IP address is added to the primary cache's firewall rules.

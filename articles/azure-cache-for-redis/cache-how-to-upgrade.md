...
> [!IMPORTANT]
> Following the [standard Redis versioning](https://redis.io/docs/about/releases/), this article only covers upgrades to the _major_ and/or _minor_ version of Redis, not the _patch_ version. Updates to the patch version are made automatically during the normal patching cycle each month.
>

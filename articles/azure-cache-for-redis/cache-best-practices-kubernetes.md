...
When using _Istio_ with an Azure Cache for Redis cluster, consider excluding the potential collision ports with [istio annotation](https://istio.io/latest/docs/reference/config/annotations/)

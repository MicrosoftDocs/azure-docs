...
In order for export to an Azure storage account to work sucessfully, the [SAS token](../storage/common/storage-sas-overview.md) must have the following permissions:
- `read`
- `add`
- `create`
- `write`

...
The E1 SKU, which is intended primarily for dev/test scenarios, is now generally available (GA). The E1 sku runs on smaller, burstable virtual machines. As a result, E1 offers variable performance depending on how much CPU is consumed. Unlike other Enterprise offerings, you can't scale E1 out. However, you can scale up to a larger SKU. The E1 SKU also doesn't support active geo-replication.

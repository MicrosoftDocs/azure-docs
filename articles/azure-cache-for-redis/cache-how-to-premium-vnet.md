...
After the port requirements are configured as described in the previous section, a reboot is necessary in most cases to ensure the changes reflect correctly, otherwise, you might face some connectivity issues. You can verify that your cache is working by following these steps:

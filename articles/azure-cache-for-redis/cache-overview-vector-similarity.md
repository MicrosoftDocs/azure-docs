...
- [Azure Cognitive Search](../search/vector-search-overview)
- [Azure Cosmos DB](../cosmos-db/mongodb/vcore/vector-search) using the MongoDB vCore API
- [Aure Database for PostgreSQL - Flexible Server](../postgresql/flexible-server/how-to-use-pgvector) using `pgvector`

...
ms.topic: quickstart
ms.date: 04/10/2023
#Customer intent: As an enterprise developer who is new to Azure Cache for Redis, I want to create a new cache in the Enterprise tier of Azure Cache for Redis.
---

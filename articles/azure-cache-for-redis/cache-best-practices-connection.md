...
## Retry commands
Configure your client connections to retry commands with exponential backoff. Follow [retry guidelines](https://docs.microsoft.com/azure/architecture/best-practices/retry-service-specific#azure-cache-for-redis) 
...
Get [notified]( https://docs.microsoft.com/azure/azure-cache-for-redis/cache-failover#can-i-be-notified-in-advance-of-a-planned-maintenance) of upcoming planned maintenance 

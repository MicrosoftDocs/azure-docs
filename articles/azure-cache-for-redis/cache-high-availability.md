...
| ------------------- | ------- | ------- | :------: | :---: | :---: |
| [Standard replication](#standard-replication)| Dual-node replicated configuration in a single datacenter with automatic failover | 99.9% (see [SLA](https://azure.microsoft.com/support/legal/sla/cache/v1_0/)) |✔|✔|-|
| [Zone redundancy](#zone-redundancy) | Multi-node replicated configuration across AZs, with automatic failover | Up to 99.99% (see [SLA](https://azure.microsoft.com/support/legal/sla/cache/v1_0/)) |-|Preview|Preview|
| [Geo-replication](#geo-replication) | Linked cache instances in two regions, with user-controlled failover | Up to 99.999% (see [SLA](https://azure.microsoft.com/support/legal/sla/cache/v1_0/)) |-|✔|Preview|

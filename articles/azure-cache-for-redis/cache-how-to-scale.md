...
* You can't scale from a larger size down to the **C0 (250 MB)** size. You can however scale down to any other size within the same pricing tier e.g. you can scale down from a C5 Standard to C1 Standard.

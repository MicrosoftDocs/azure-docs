...
With [active geo-replication](cache-how-to-active-geo-replication.md) configured, you can scale a cache albeit certain limitations. All caches in a geo replication group must be the same size and capacity. Please check the details [here](/azure/azure-cache-for-redis/cache-how-to-active-geo-replication).

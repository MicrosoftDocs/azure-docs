...
Start scaling before the server load or memory usage gets too high. If it is too high, that means Redis server is busy. The busy Redis server does not have enough resources to perform scaling and data redistribution.

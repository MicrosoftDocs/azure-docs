...
To view basic cache metrics, [select your cache](cache-configure.md#configure-azure-cache-for-redis-settings) in the [Azure portal](https://portal.azure.com). On the **Overview** page, you see the predefined monitoring charts **Memory Usage** and **Redis Server Load**. These charts are useful summaries that allow you to take a quick look at the state of your cache.
...
For more in-depth information, you can see more metrics by selecting **Metrics** under the **Monitoring** section of the left navigation menu.
...
The other options under **Monitoring** provide other ways to monitor your caches. For more information, see [Monitor Azure Cache for Redis](monitor-cache.md).

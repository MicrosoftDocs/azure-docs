---
title: Use Azure Policy to audit for compliance of minimum TLS version for a Service Bus namespace
...
# Use Azure Policy to audit for compliance of minimum TLS version for a Service Bus namespace (Preview)

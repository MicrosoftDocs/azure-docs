...
> 
> The important metrics to monitor for any outages for a premium tier namespace are: **CPU usage** and **memory size** per namespace. Set up alerts for these metrics using Azure Monitor.
> 
> The other metric you should monitor is: **throttled requests** (see the **Request metrics** section). It shouldn't be an issue as long as the namespace stays within its memory, CPU, and brokered connections limits. For more information, see [Throttling in Azure Service Bus Premium tier](service-bus-throttling.md#throttling-in-azure-service-bus-premium-tier)

...
|Throttled Requests| No | Count | Total | <p>The number of requests that were throttled because the usage was exceeded.</p><p>MessagingErrorSubCode dimension has the following possible values: <br/><b>CPU:</b> CPU throttling<br/><b>Storage:</b>It indicates throttle because of pending checkpoint operations<br/><b>Namespace:</b>Namespace operations throttling.<br/><b>Unknown:</b> Other resource throttling.</p> |  Entity name<br/>MessagingErrorSubCode |

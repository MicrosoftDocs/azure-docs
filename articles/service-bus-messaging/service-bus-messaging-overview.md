...
Service Bus supports security protocols such as [Shared Access Signatures](service-bus-sas.md) (SAS), [Azure role-based access control (Azure RBAC)](authenticate-application.md) (RBAC) and [Managed identities for Azure resources](service-bus-managed-service-identity.md).

...
This template creates a standard Service Bus namespace. For JSON syntax and properties, see [Microsoft.ServiceBus/namespaces](/azure/templates/microsoft.servicebus/namespaces) template reference.

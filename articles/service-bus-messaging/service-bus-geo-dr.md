...
> [!NOTE]
> The Availability Zones support for Azure Service Bus Premium is only available in [Azure regions](https://azure.microsoft.com/en-us/global-infrastructure/regions/) where availability zones are present.

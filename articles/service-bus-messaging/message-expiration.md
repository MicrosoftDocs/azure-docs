...
We recommend that you set the **time-to-live** value on a message to be in hours or days. If you set it to a low value in seconds or milliseconds, the message may expire before consumers have a chance to consume it. 

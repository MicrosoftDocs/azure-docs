...
When Geo-disaster recovery is enabled for a Service Bus premium-tier namespace, the metadata for queues, topics, and subscriptions is replicated to the secondary namespace in a different region. 

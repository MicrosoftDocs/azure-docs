...
- Ensure that you are a member of one of these roles on the namespace: 
    - [Service Bus Data Owner](../role-based-access-control/built-in-roles#azure-service-bus-data-owner) 
    - [Contributor](../role-based-access-control/built-in-roles#contributor) 
    - [Owner](../role-based-access-control/built-in-roles#owner)

---
title: 'Use Azure Service Bus queues with Python azure-servicebus package version 0.50.3'
description: This article shows you how to use Python azure-servicebus package version 0.50.3 to create, send messages to, and receive messages from Azure Service Bus queues. 
author: spelluru
...
# Quickstart: Use Azure Service Bus queues with Python (azure-servicebus package version 0.50.3)
...
For more information about the Python Azure Service Bus libraries, see [Service Bus libraries for Python](/python/api/overview/azure/servicebus?view=azure-python&preserve-view=true).

> [!WARNING]
> This quickstart uses the 0.50.3 version of the azure-servicebus package. For a quickstart that uses the latest 7.0.0 version of the package, see [Send and receive events using azure-sevicebus (0.50.3 version)](service-bus-python-how-to-use-queues.md). For information about different versions of the azure-servicebus package, See the [Release history](https://pypi.org/project/azure-servicebus/7.0.0b7/#history).

...
- To find the right IP addresses to add to allow list for your connections, see [What IP addresses do I need to add to allow list](service-bus-messaging/service-bus-faq#what-ip-addresses-do-i-need-to-add-to-allow-list). 

...
>- The [premier tier](service-bus-premium-messaging.md) doesn't support partitioning, so we recommend that you use unique message IDs in your applications and not rely on partition keys. This approach will help if you decide to upgrade to premier tier later. 

...
The duplicate detection time history defaults to 10 minutes for queues and 30 seconds for topics, with a maximum value of 40 minutes. You can change this setting in the queue and topic properties window in the Azure portal.

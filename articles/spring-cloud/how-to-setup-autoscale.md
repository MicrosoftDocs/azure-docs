...
For information on the available metrics, see the [User metrics options](https://docs.microsoft.com/en-us/azure/spring-cloud/concept-metrics#user-metrics-options) section of [Metrics for Azure Spring Cloud](https://docs.microsoft.com/en-us/azure/spring-cloud/concept-metrics).

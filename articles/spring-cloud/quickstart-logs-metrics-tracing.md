...
1. In the Azure portal, go to the **service | Overview** page and select **Logs** in the **Monitoring** section. Select **Run** on one of the sample queries for Azure Spring Apps.
   ...
   [ ![Logs Analytics entry](media/quickstart-logs-metrics-tracing/logs-entry.png) ](media/quickstart-logs-metrics-tracing/logs-entry.png#lightbox)
...
1. Then select `Run`, and you will see logs. See [Azure Log Analytics docs](../azure-monitor/logs/get-started-queries.md) for more guidance on writing queries.
   ...
   [ ![Logs Analytics query - Steeltoe](media/quickstart-logs-metrics-tracing/logs-query-steeltoe.png) ](media/quickstart-logs-metrics-tracing/logs-query-steeltoe.png#lightbox)
...
1. In the Azure portal, go to the **service | Overview** page and select **Metrics** in the **Monitoring** section. Add your first metric by selecting one of the .NET metrics under **Performance (.NET)** or **Request (.NET)** in the **Metric** drop-down, and `Avg` for **Aggregation** to see the timeline for that metric.
   ...
   [ ![Metrics entry - Steeltoe](media/quickstart-logs-metrics-tracing/metrics-basic-cpu-steeltoe.png) ](media/quickstart-logs-metrics-tracing/metrics-basic-cpu-steeltoe.png#lightbox)
...
1. Select **Add filter** in the toolbar, select `App=solar-system-weather` to see CPU usage only for the **solar-system-weather** app.
   ...
   [ ![Use filter in metrics - Steeltoe](media/quickstart-logs-metrics-tracing/metrics-filter-steeltoe.png) ](media/quickstart-logs-metrics-tracing/metrics-filter-steeltoe.png#lightbox)
...
1. Dismiss the filter created in the preceding step, select **Apply Splitting**, and select `App` for **Values** to see CPU usage by different apps.
   ...
   [ ![Apply splitting in metrics - Steeltoe](media/quickstart-logs-metrics-tracing/metrics-split-steeltoe.png) ](media/quickstart-logs-metrics-tracing/metrics-split-steeltoe.png#lightbox)
...
1. In the Azure portal, go to the **service | Overview** page and select **Distributed tracing** in the **Monitoring** section. Then select the **View application map** tab on the right.
   ...
   [ ![Distributed Tracing entry - Steeltoe](media/quickstart-logs-metrics-tracing/tracing-entry.png) ](media/quickstart-logs-metrics-tracing/tracing-entry.png#lightbox)

1. You can now see the status of calls between apps.

   [ ![Distributed tracing overview - Steeltoe](media/quickstart-logs-metrics-tracing/tracing-overview-steeltoe.png) ](media/quickstart-logs-metrics-tracing/tracing-overview-steeltoe.png#lightbox)
...
1. Select the link between **solar-system-weather** and **planet-weather-provider** to see more details like slowest calls by HTTP methods.
   ...
   [ ![Distributed tracing - Steeltoe](media/quickstart-logs-metrics-tracing/tracing-call-steeltoe.png) ](media/quickstart-logs-metrics-tracing/tracing-call-steeltoe.png#lightbox)

1. Finally, select **Investigate Performance** to explore more powerful built-in performance analysis.

   [ ![Distributed tracing performance - Steeltoe](media/quickstart-logs-metrics-tracing/tracing-performance-steeltoe.png) ](media/quickstart-logs-metrics-tracing/tracing-performance-steeltoe.png#lightbox)
::: zone-end
...
[ ![Log Streaming from Azure CLI](media/quickstart-logs-metrics-tracing/logs-streaming-cli.png) ](media/quickstart-logs-metrics-tracing/logs-streaming-cli.png#lightbox)
...
1. Go to the **service | Overview** page and select **Logs** in the **Monitoring** section. Select **Run** on one of the sample queries for Azure Spring Apps.
   ...
   [ ![Logs Analytics portal entry](media/quickstart-logs-metrics-tracing/logs-entry.png) ](media/quickstart-logs-metrics-tracing/logs-entry.png#lightbox)
...
[ ![Metrics blade](media/quickstart-logs-metrics-tracing/petclinic-microservices-metrics.jpg) ](media/quickstart-logs-metrics-tracing/petclinic-microservices-metrics.jpg#lightbox)
...
[ ![Custom metrics](media/quickstart-logs-metrics-tracing/petclinic-microservices-custom-metrics.jpg) ](media/quickstart-logs-metrics-tracing/petclinic-microservices-custom-metrics.jpg#lightbox)

You can use the Availability Test feature in Application Insights and monitor
the availability of applications:

[ ![Availability test](media/quickstart-logs-metrics-tracing/petclinic-microservices-availability.jpg) ](media/quickstart-logs-metrics-tracing/petclinic-microservices-availability.jpg#lightbox)

Navigate to the `Live Metrics` blade - you can see live metrics on screen with low latencies < 1 second:
[ ![Live metrics](media/quickstart-logs-metrics-tracing/petclinic-microservices-live-metrics.jpg) ](media/quickstart-logs-metrics-tracing/petclinic-microservices-live-metrics.jpg#lightbox)
...
[ ![Application map](media/quickstart-logs-metrics-tracing/distributed-tracking-new-ai-agent.jpg) ](media/quickstart-logs-metrics-tracing/distributed-tracking-new-ai-agent.jpg#lightbox)

Navigate to the `Performance` blade:
[ ![Performance blade](media/quickstart-logs-metrics-tracing/petclinic-microservices-performance.jpg) ](media/quickstart-logs-metrics-tracing/petclinic-microservices-performance.jpg#lightbox)
...
[ ![Performance/Dependencies blade](media/quickstart-logs-metrics-tracing/petclinic-microservices-insights-on-dependencies.jpg) ](media/quickstart-logs-metrics-tracing/petclinic-microservices-insights-on-dependencies.jpg#lightbox)

Select a SQL call to see the end-to-end transaction in context:
[ ![SQL end-to-end transaction](media/quickstart-logs-metrics-tracing/petclinic-microservices-end-to-end-transaction-details.jpg) ](media/quickstart-logs-metrics-tracing/petclinic-microservices-end-to-end-transaction-details.jpg#lightbox)

Navigate to the `Failures/Exceptions` blade - you can see a collection of exceptions:
[ ![Failures/Exceptions](media/quickstart-logs-metrics-tracing/petclinic-microservices-failures-exceptions.png) ](media/quickstart-logs-metrics-tracing/petclinic-microservices-failures-exceptions.png#lightbox)

Select an exception to see the end-to-end transaction and stacktrace in context:
[ ![Stacktrace end-to-end](media/quickstart-logs-metrics-tracing/end-to-end-transaction-details.jpg) ](media/quickstart-logs-metrics-tracing/end-to-end-transaction-details.jpg#lightbox)

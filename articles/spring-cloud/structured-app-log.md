...
This generally happens on exception logging with deep stacktrace, especially when the [AppInsights In-Process Agent](https://docs.microsoft.com/en-us/azure/spring-cloud/how-to-application-insights) is enabled. We need to apply limit settings to the stacktrace output (see the below configuration samples) to ensure the final output gets parsed properly.

...
title:
description:
dev-owner: Xiaoyun Ding
draft-freeze-date: 2021/11/8
froze: Yes
---

# Enable system-assigned managed identity for Azure Spring Cloud application
...
This article shows how to enable and disable system-assigned managed identities for an Azure Spring Cloud app, using the Azure portal and CLI.

## Prerequisites

- An already provisioned Azure Spring Cloud Enterprise tier. For more information, see [Get started with Enterprise Tier](./01-get-started.md)

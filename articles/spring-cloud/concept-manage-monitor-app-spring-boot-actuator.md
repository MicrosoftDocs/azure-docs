...
This article assumes that you have a Spring Boot 2.x application that can be successfully deployed and booted on Azure Spring Cloud service.  See [Quickstart: Launch an existing application running in Azure Spring Cloud using the Azure portal](./quickstart.md)

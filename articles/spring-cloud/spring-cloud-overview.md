...
Azure Spring Cloud is currently in preview.  For access to this service while it is in preview, please reach out to us by email: azure-spring-cloud@service.microsoft.com.

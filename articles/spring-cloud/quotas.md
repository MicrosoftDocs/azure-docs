...
------- | ------- | ------- | -------
vCPU | per app instance | 1 | 4 | 4
Memory | per app instance | 2 GB | 8 GB | 8GB
Azure Spring Cloud service instances | per region per subscription | 10 | 10 | 10
Total app instances | per Azure Spring Cloud service instance | 25 | 500 | 500
Custom Domains | per Azure Spring Cloud service instance | 0 | 25 | 25
Persistent volumes | per Azure Spring Cloud service instance | 1 GB/app x 10 apps | 50 GB/app x 10 apps | 50 GB/app x 10 apps
Inbound Public Endpoints | per Azure Spring Cloud service instance| 10 <sup>1</sup> | 10 <sup>1</sup> | 10 <sup>1</sup>
Outbound Public IPs | per Azure Spring Cloud service instance| 1 <sup>2</sup> | 2 <sup>2</sup> <br> 1 if using VNet<sup>2</sup> | 2 <sup>2</sup> <br> 1 if using VNet<sup>2</sup>

...
* A deployed Azure Spring Cloud service instance.  Follow our [quickstart on deploying an app via Azure CLI](spring-cloud-quickstart-launch-app-cli.md) to get started.

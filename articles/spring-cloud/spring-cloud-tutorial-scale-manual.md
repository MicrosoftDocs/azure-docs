...
"If you are on the Basic tier, and you are restrained by one or more of these [limits] (#what-service-plans-does-azure-spring-cloud-offer), you can upgrade to the Standard tier. To do this go to the Pricing tier menu by first selecting the Standard tier column and the clicking the **Upgrade** button.

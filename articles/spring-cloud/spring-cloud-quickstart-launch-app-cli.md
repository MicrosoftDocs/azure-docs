...
Azure Spring Cloud enables you to easily run a Spring Boot based microservices application on Azure.  Before running this example, you can try the [basic quickstart](spring-cloud-quickstart).

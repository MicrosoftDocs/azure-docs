...
1. Set **Public Endpoint** to *Enable*.
    ...
    [ ![Deploy to Azure OK](media/spring-cloud-quickstart-java/intellij-deploy-to-azure.png) ](Deploy to Azure OK](media/spring-cloud-quickstart-java/intellij-deploy-to-azure.png#lightbox)

...
In this tutorial you learned how to set up alerts and action groups for an application running in Azure Spring Cloud. To learn more about action groups, see:

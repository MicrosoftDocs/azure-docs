---
title: Bind an Azure Cosmos DB to your application running in Azure Spring Cloud
description: Learn how to bind Azure Cosmos DB to your application running in Azure Spring Cloud
author: karlerickson
...
# Bind an Azure Cosmos DB database to your application running in Azure Spring Cloud
...
In this article, you learned how to bind your application running in Azure Spring Cloud to an Azure Cosmos DB database. To learn more about binding services to your application, see [Bind to an Azure Cache for Redis cache](./how-to-bind-redis.md).

...
Piggymetrics is a sample application that is used in examples to illustrate deployment to Azure Spring Cloud.  This proof-of-concept application is simple way to deal with personal finances.  It demonstrates the Microservice Architecture Pattern using Spring Boot, Spring Cloud and Docker. It includes a user interface.  The following sections describe Piggymetrics services.

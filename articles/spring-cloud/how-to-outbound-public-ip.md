...
This page explains how to view static outbound public IP addresses of applications running in Azure Spring Cloud. Public IPs are used to communicate with external resources, such as databases, storage, and key vaults.

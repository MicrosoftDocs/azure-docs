...
1. Start IntelliJ. If you have opened a project previously, close the project to show the welcome dialog. Select **Configure** from link lower right, and then select **Plugins** to open the plug-in configuration dialog, and select **Install Plugins from disk**.
   ...
   :::image type="content" source="media/spring-cloud-intellij-howto/configure-plugin-1.png" alt-text="Screenshot of IntelliJ IDEA Welcome dialog box with Configure element highlighted.":::

1. Search for Azure Toolkit for IntelliJ. Select **Install**.

   :::image type="content" source="media/spring-cloud-intellij-howto/install-plugin.png" alt-text="Screenshot of IntelliJ IDEA Plugins dialog box with Install button highlighted.":::
...
1. Select the *gs-spring-boot\complete* folder.
   ...
   :::image type="content" source="media/spring-cloud-intellij-howto/import-project-1.png" alt-text="Screenshot of IntelliJ IDEA Open File or Project dialog box with complete folder highlighted." lightbox="media/spring-cloud-intellij-howto/import-project-1.png":::
...
1. Right-click your project in IntelliJ project explorer, and select **Azure** -> **Deploy to Azure Spring Apps**.
   ...
   :::image type="content" source="media/spring-cloud-intellij-howto/deploy-to-azure-1.png" alt-text="Screenshot of IntelliJ IDEA context menu with Deploy to Azure Spring Apps option highlighted." lightbox="media/spring-cloud-intellij-howto/deploy-to-azure-1.png":::
...
1. Select **App:** then click **+** to create an Azure Spring Apps instance.
   ...
   :::image type="content" source="media/spring-cloud-intellij-howto/deploy-to-azure-2.png" alt-text="Screenshot of IntelliJ IDEA Deploy Azure Spring app dialog box with plus button highlighted." lightbox="media/spring-cloud-intellij-howto/deploy-to-azure-2.png":::

1. Enter **App name**, then select **OK**.

   :::image type="content" source="media/spring-cloud-intellij-howto/deploy-to-azure-2a.png" alt-text="Screenshot of IntelliJ IDEA Create Azure Spring App dialog box with App name field in focus.":::

1. Start the deployment by selecting the **Run** button.

   :::image type="content" source="media/spring-cloud-intellij-howto/deploy-to-azure-3.png" alt-text="Screenshot of IntelliJ IDEA showing Run button." lightbox="media/spring-cloud-intellij-howto/deploy-to-azure-3.png":::
...
1. If the app URL is not shown in the output window, get it from the Azure portal. Navigate from your resource group to the instance of Azure Spring Apps. Then select **Apps**. The running app will be listed. Select the app, then copy the **URL** or **Test Endpoint**.
   ...
   :::image type="content" source="media/spring-cloud-intellij-howto/get-test-url.png" alt-text="Screenshot of Azure portal showing the app overview page with the URL and Test Endpoint fields highlighted." lightbox="media/spring-cloud-intellij-howto/get-test-url.png":::

1. Navigate to the URL or Test Endpoint in the browser.

   :::image type="content" source="media/spring-cloud-intellij-howto/navigate-in-browser-2.png" alt-text="Screenshot of the app running in a browser displaying the message Greetings from Spring Boot.":::
...
1. Select **Streaming Log** from the drop-down list.
   ...
   :::image type="content" source="media/spring-cloud-intellij-howto/streaming-logs.png" alt-text="Screenshot of IntelliJ IDEA context menu with the Streaming Log option highlighted.":::

1. Select instance.

   :::image type="content" source="media/spring-cloud-intellij-howto/select-instance.png" alt-text="Screenshot of the IntelliJ IDEA  Select Instance dialog box.":::

1. The streaming log will be visible in the output window.

   :::image type="content" source="media/spring-cloud-intellij-howto/streaming-log-output.png" alt-text="Screenshot of the IntelliJ IDEA showing the streaming log in the output window." lightbox="media/spring-cloud-intellij-howto/streaming-log-output.png":::

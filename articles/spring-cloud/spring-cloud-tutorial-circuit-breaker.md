...
Follow the procedure, [Provision a service instance on the Azure CLI](./spring-cloud-quickstart.md#provision-a-service-instance-on-the-azure-cli).
...
## Next steps
* [Provision a service instance on the Azure CLI](./spring-cloud-quickstart.md#provision-a-service-instance-on-the-azure-cli)

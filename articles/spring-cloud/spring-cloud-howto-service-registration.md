...
For information about how to set up service registration for a Steeltoe app, see [Prepare a Java Spring application for deployment in Azure Spring Cloud](spring-cloud-howto-prepare-app-deployment.md).
::: zone-end

...
- **PowerShell for Authenticode**: To use PowerShell for Artifact Signing, see [Artifact Signing](https://www.powershellgallery.com/packages/ArtifactSigning/) in PowerShell Gallery to install the PowerShell module.

...
- In Azure Data Studio, currently it only support AD/Windows authentication for connecting to the source sql server, for target sql server, currently only sql logins are supported.

...
> [!NOTE]
> The Azure Database Migration Service hybrid installer runs on Microsoft Windows Server 2008 R2, Windows Server 2012, Windows Server 2012R2, Window Server 2016, Windows Server 2019, and Windows 10.

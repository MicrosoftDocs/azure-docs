...
Azure Database Migration Service is a fully managed service designed to enable seamless migrations from multiple database sources to Azure Data platforms with minimal downtime. The service is currently Generally Available, with ongoing development efforts focused on:
...
When migrating from SQL Server, Azure Database Migration Service supports SQL Server 2005 through SQL Server 2017.
...
### Q. Where can I leave feedback about Azure Database Migration Service?

We want to hear from you. Send any feedback and/ideas you have about the Azure Database Migration Service via User Voice, [here](https://feedback.azure.com/forums/906100-azure-database-migration-service), or by contacting the team at [Ask Azure Database Migrations](mailto:AskAzureDatabaseMigrations@service.microsoft.com).

...
- After the migration completes, you can check your Azure Cosmos DB API account for MongoDB to verify that all the collections were migrated successfully.

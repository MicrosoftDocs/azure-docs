...
* An instance of your target database server to host SSISDB. If you don’t already have one, create a [logical SQL server](../sql-database/sql-database-servers.md) (without a database) using the Azure portal by navigating to the SQL Server (logical server only) [form](https://ms.portal.azure.com/#create/Microsoft.SQLServer).

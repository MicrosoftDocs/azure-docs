...
# Tutorial: Migrate Azure DB for PostgreSQL to Azure DB for PostgreSQL online using DMS via the Azure portal

You can use Azure Database Migration Service to migrate the databases from an [Azure Database for PostgreSQL](https://docs.microsoft.com/azure/postgresql/) instance to another [Azure Database for PostgreSQL](https://docs.microsoft.com/azure/postgresql/) instance with minimal downtime. In this tutorial, you migrate the **DVD Rental** sample database from an Azure Database for PostgreSQL v10 to Azure Database for PostgreSQL v11 by using the online migration activity in Azure Database Migration Service.
...
> [!IMPORTANT]
> Migration from Azure Database for PostgreSQL is supported for PostgreSQL version 10 and later. 
...
> [!NOTE]
> The above server parameters are static and will require a reboot of your Azure Database for PostgreSQL instance for them to take effect. 

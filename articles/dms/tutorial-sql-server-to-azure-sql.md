...
- Create a database in Azure SQL Database, which you do by following the detail in the article [Create a database in Azure SQL Database using the Azure portal](../azure-sql/database/single-database-create-quickstart.md).

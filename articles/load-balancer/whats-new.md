...
| ------ |---------|---------|---------|
| SKU | [Basic Load Balancer SKU retiring 30th September 2025](https://azure.microsoft.com/updates/azure-basic-load-balancer-will-be-retired-on-30-september-2025-upgrade-to-standard-load-balancer/) | The Basic Load Balancer SKU will retire on 30th September 2025. Make sure to migrate to Standard SKU before this date. | September 2022 |

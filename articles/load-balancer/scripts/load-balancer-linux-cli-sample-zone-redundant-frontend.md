...
:::code language="azurecli" source="~/azure_cli_scripts/load-balancer/load-balance-across-availability-zones/load-balance-across-availability-zones.sh" id="FullScript":::

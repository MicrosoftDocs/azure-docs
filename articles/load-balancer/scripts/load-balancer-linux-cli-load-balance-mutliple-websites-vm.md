...
| [az network lb frontend-ip create](https://docs.microsoft.com/en-us/cli/azure/network/lb/frontend-ip#create) | Create a frontend IP address for the Load Balancer. |
| [az network lb address-pool create](https://docs.microsoft.com/en-us/cli/azure/network/lb/address-pool#create) | Creates a backend address pool. |

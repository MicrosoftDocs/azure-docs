...
You can find more details creating a SQL AlwaysOn [in deploying SQL AlwaysOn using Azure Resource Manager template](../virtual-machines/virtual-machines-workload-template-sql-alwayson.md) or [Using the Portal Gallery](http://blogs.technet.com/b/dataplatforminsider/archive/2014/08/25/sql-server-alwayson-offering-in-microsoft-azure-portal-gallery.aspx).

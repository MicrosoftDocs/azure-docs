...
- IP fragmenting is not supported. In the event that a packet is fragmented, it will be forwarded based on the 2-tuple [distribution mode](distribution-mode-concepts.md) when enabled on HA ports load-balancing rules.

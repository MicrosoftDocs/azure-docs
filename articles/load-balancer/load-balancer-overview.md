...
* **Outbound connections (SNAT)**
    ...
    * Easier access control list (ACL) management to. ACLs expressed in terms of front-end IPs do not change as services scale up or down or get redeployed.  Translating outbound connections to a smaller number of IP addresses than machines can reduce the burden of whitelisting.

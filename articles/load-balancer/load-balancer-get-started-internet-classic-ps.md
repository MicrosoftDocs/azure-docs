...
[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)] This article covers the classic deployment model. You can also [Get started creating a load balancer with Azure resource manager](load-balancer-get-started-internet-arm-ps.md).

...
Review [Azure cloud design patterns](../architecture/patterns/index.md) to improve the resiliency of your application to failure scenarios.
...
There's no general guidance that one is a better choice than the other without knowing the service architecture.  Review [Azure cloud design patterns](../architecture/patterns/index.md) to improve the resiliency of your application to failure scenarios.
...
- Learn about [Azure cloud design patterns](../architecture/patterns/index.md) to improve the resiliency of your application to failure scenarios.

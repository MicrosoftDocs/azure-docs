...
<Waiting for more info from Chidozie>
...
- [Upgrade a public IP address - Azure portal](../virtual-network/ip-services/public-ip-upgrade-portal.md)
- [Upgrade a public IP address - Azure PowerShell](../virtual-network/ip-services/public-ip-upgrade-powershell.md)
- [Upgrade a public IP address - Azure CLI](../virtual-network/ip-services/public-ip-upgrade-cli.md)
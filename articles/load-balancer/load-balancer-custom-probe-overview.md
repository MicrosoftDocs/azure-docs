...
You must define probes when you are deploying virtual machines behind a load balancer. Virtual machines don't have guest agents like PaaS roles (web role and worker role).

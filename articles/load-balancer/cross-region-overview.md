...
> [!IMPORTANT]
> Cross-region load balancer is currently in preview and can be deployed in Portal. Sign-in to **https://portal.azure.com** to view and deploy the feature.. </br> </br>

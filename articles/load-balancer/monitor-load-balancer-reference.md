...
This section lists all the automatically collected platform metrics collected for Load Balancer.  
...
Load Balancer does not have any metrics that contain dimensions.
...
This section lists the types of resource logs you can collect for Load Balancer. 
...
This section lists all the resource log category types collected for Load Balancer.  
...
Load Balancer uses the [Azure Diagnostics](/azure/azure-monitor/reference/tables/azurediagnostics) table and the [TODO whatever additional] table to store resource log information. The following columns are relevant.

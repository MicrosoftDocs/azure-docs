...
* The script cannot migrate Virtual Machine Scale Set from Basic Load Balancer to Standard Load Balancer. Follow [Update or delete a load balancer used by virtual machine scale sets](https://docs.microsoft.com/azure/load-balancer/update-load-balancer-with-vm-scale-set) to complete the migration.

...
Create a public IP address with [New-AzPublicIpAddress](/powershell/module/az.network/new-azpublicipaddress). The following example creates a zonal public IP address named *myPublicIP* in the *myResourceGroupLoadBalancer* resource group in zone 1.

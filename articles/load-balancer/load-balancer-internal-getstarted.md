...
>[AZURE.IMPORTANT] Monitoring probes from the load balancer to determine health state for VMs in a load balanced set uses IP address 168.63.129.16 The IP address 168.63.129.16 is a virtual public IP address that is used to facilitate a communication channel to internal platform resources for the bring-your-own IP Virtual Network scenario. 

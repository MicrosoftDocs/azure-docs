...
Create a resource group with [az group create](/cli/azure/group#az-group-create). Name the resource group **CreateIntLBQS-rg**, and specify the location as **eastus**.

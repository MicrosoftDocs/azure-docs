---
title: Testing reachability of a load balancer frontend IPv4 address with ping
description: Learn how to test a load balancer frontend IPv4 address for reachability with ping from an Azure VM or an external device.
...
1. In the virtual machine’s menu, select **Networking** and then select **Add inbound port rule**.
    ...
    :::image type="content" source="media/load-balancer-frontend-reachability-testing/virtual-machine-port-rules-thumb.png" alt-text="Image alt text." lightbox="media/load-balancer-frontend-reachability-testing/virtual-machine-port-rules.png":::

...
The Standard SKU load balancer supports easily configurable alerts for multi dimensional metrics. Configure custom thresholds for specific metrics to trigger alerts with varying levels of severity to allow for a touchless resource monitoring experience.

...
* Check the CPU utilization for your resources to check if your instances are in fact healthy
  * You can check this by viewing the resource's Percentage CPU metric via the Metrics blade. To troubleshoot high-CPU related issues, please refer to [Troubleshoot high-CPU issues for Azure virtual machines](../virtual-machines/troubleshoot-high-cpu-issues-azure-windows-vm) for more guidance.

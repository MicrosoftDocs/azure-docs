...
15. Save the **parameters.json** file.
16. To edit the target region where the external load balancer configuration will be moved, open the **template.json** file:
...
18. You can also change other parameters in the template if you choose, and are optional depending on your requirements:
    ...
    * **Probes** - You can add or remove a probe for the load balancer in the configuration by adding or removing entries to 
## Discard 

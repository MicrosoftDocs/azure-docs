...
If [multiple (public) IP addresses are associated with a load balancer backend pool](load-balancer-multivip-overview.md), any one of them may be used for outbound connectivity.c

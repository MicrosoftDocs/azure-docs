...
It is important to remember that the number of SNAT ports available does not translate directly to number of connections. Refer preceeding sections for specifics on when and how SNAT ports are allocated and [how to manage this exhaustible resource](#snatexhaust).

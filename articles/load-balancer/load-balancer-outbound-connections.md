...
* Learn how to [migrate your existing outbound connectivity method to NAT gateway](https://docs.microsoft.com/azure/virtual-network/nat-gateway/tutorial-migrate-outbound-nat?toc=/azure/load-balancer/toc.json)

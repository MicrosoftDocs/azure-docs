---
title: Create a Basic Load Balancer - quickstart- Azure portal | Microsoft Docs
description: In this quickstart, you learn to create a public Basic Load Balancer by using the Azure portal.

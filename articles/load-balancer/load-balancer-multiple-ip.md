<properties
   pageTitle="Load balancing on multiple IP configurations | Microsoft Azure"
...
2. Create a resource group using the following settings:
    ...
    For more information, see Step 2 of [Create a Resource Group](../virtual-machines/virtual-machines-windows-ps-create.md).
...
4. Follow instructions steps 3 through 5 in [Create a Windows VM](../virtual-machines/virtual-machines-windows-ps-create.md) article to prepare the creation of a VM with a single NIC. Execute step 6.1, and use the following instead of step 6.2:
    ...
    Then complete [Create a Windows VM](../virtual-machines/virtual-machines-windows-ps-create.md) steps 6.3 through 6.8.

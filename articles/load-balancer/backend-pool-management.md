...
### Limitations
  ...
  * If backend pools are constantly changing (constant addition or removal of resources), there is a chance that existing connections will get rehashed and sent to a new backend pool member. A workaround for this is to use retries. 

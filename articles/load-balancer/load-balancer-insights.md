...
From the Insights blade of your Load Balancer, you can select More Detailed Metrics to view a pre-configured [Azure Monitor Workbook](../azure-monitor/visualizations/workbooks-overview.md) containing metrics visuals  relevant to specific aspects of your Load Balancer. This dashboard will show the Load Balancer status and links to relevant documentation at the top of the page.
...
* [Create your own workbooks](../azure-monitor/visualizations/workbooks-overview.md), you can take inspiration by clicking on the edit button in your detailed metrics dashboard

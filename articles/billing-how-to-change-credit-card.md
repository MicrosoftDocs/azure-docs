...
2. Under **Click a subscription to view details and usage**, click the subscription that is linked to the credit card.
3. On the right side of the page, click **Change payment method**.
4. On the **Choose payment method** page, click **Edit** next to the credit card number.
...
1. Log on to the [Azure Account Center](https://account.windowsazure.com/Subscriptions) as the Account Administrator.
2. Under **Click a subscription to view details and usage**, click the subscription for which you want to add a new payment method. </br> ![selectsub](./media/billing-how-to-change-credit-card/selectsub.png)
...
4. On the **Choose payment method** page, select “+” to add a new credit card.</br> ![changesub](./media/billing-how-to-change-credit-card/editcard.png)

...
* Track configuration changes with [Azure Automation Change Tracking and Inventory](../automation/automation/automation-change-tracking.md)
* Collection of custom logs from OS and hosted applications such as [FluentD](log-analytics-data-sources-json.md), [custom logs](log-analytics-data-sources-custom-logs.md), [MySQL and Apache](log-analytics-data-sources-linux-applications.md) with Log Analytics

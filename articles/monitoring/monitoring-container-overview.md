...
For web-based applications, it's important to identify issues that impact the usability and responsiveness for the users accessing those applications.  [Application Insights](../application-insights/app-insights-overview.md)
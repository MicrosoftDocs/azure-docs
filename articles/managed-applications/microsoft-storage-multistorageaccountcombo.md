...
A group of controls for creating multiple storage accounts, with names that start with a common prefix. You use this element when [creating an Azure Managed Application](../azure-resource-manager/managed-application-publishing.md).

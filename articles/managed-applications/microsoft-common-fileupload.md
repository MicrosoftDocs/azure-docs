...
A control that allows a user to specify one or more files to upload. You use this element when [creating an Azure Managed Application](../azure-resource-manager/managed-application-publishing.md).

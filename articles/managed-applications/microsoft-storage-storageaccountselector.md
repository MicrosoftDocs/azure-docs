...
A control for selecting a new or existing storage account. You use this element when [creating an Azure Managed Application](../azure-resource-manager/managed-application-publishing.md).

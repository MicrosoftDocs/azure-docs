...
In this article, you will learn how to use SSH to connect to a Hadoop on HDInsight cluster and then interactively submit Hive queries using the Hive Command-Line Interface (CLI).
...
2. Once connected, start the Hive Command-Line Interface (CLI) using the following command.

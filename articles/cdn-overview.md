...
You can enable CDN from your websites to cache your web contents, such as images, scripts, and stylesheets. See [Integrate an Azure Website with Azure CDN](http://azure.microsoft.com/documentation/articles/cdn-websites-with-cdn/).

...
Be aware that some Azure services and Marketplace purchases can incur charges under the payment method (CC) even if a spending limit is set. Examples are Visual studio licenses, Azure Active Directory premium, support plans and most 3rd party branded services sold through the Marketplace.

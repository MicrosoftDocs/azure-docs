...
7. In the **Microsoft Azure** section of the **New ASP.NET Project** dialog box, make sure that **Host in the cloud** is selected and that **App Service** is selected in the drop-down list.
   ...
   ![][19]
8. Click **OK**.
9. Now you must configure Azure resources for a new web app. Follow all the steps in [Create a web application](../app-service-web/app-service-web-get-started-dotnet.md#create-a-web-application) and [Create the Azure resources](../app-service-web/app-service-web-get-started-dotnet.md#create-the-azure-resources). Then, return to this tutorial and proceed to the next step.
...
The next step is to convert the **ProductsPortal** frontend to an Azure web app. First, deploy the **ProductsPortal** project, following all the steps in the section [Deploy the web project to Azure](../app-service-web/app-service-web-get-started-dotnet.md#deploy-the-web-project-to-azure). After deployment is complete, return to this tutorial and proceed to the next step.

...
The Relay APIs generate exceptions that fall into the following categories. Also listed are suggested actions that you can take to help resolve the exceptions.

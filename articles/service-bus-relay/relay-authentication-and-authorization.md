...
You can configure keys for SAS on a Relay namespace. You can also authenticate anonymously to [Hybrid Connections](relay-hybrid-connections-protocol.md), which is part of Azure Relay. 

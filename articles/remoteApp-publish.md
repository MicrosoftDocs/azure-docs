<properties title="Publish an app in RemoteApp" pageTitle="Publish an app in RemoteApp" description="Learn how to publish applications and resources in RemoteApp" metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo"  />

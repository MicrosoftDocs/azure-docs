...
Below are examples to build and deploy static files in a Azure Spring Apps enterprise service instance with build service enabled.
...
For more information, see the [Configure an auto-generated server configuration file](#configure-an-autogenerated-server-configuration-file) section of this article.

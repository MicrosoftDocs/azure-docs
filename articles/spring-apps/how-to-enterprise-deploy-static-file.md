...
> [!NOTE]
>
> To understand the build and deployment scenarios for  kind of service instance you intend to use, Please refer to [Build service on demand section](how-to-enterprise-build-service.md#build-service-on-demand) , and then look into [How to deploy polyglot apps](how-to-enterprise-deploy-polyglot-apps.md) to understand the general deploy guidance there. Here in this article, it focuses on telling web static file specific deployment configurations and troubleshooting.
...
The following examples build and deploy static files in an Azure Spring Apps enterprise service instance with build service enabled.

### Build and Deploy static files directly

Use the following code examples to deploy static files directly using an autogenerated default server configuration file.
...
1. The following command creates a new build:
...
Use the following code examples to deploy a dynamic front-end application from source code.
...
1. The following command deploys the application:

---

### Build and Deploy static files using a customized configuration file

Use the following code examples to deploy static files using a customized server configuration file.
...
Build and deploy in separate commands. In this example, build and deploy are separate commands. A user managed container registry supports deployment only with a custom image. For more information, see [Deploy an application with a custom container image](how-to-deploy-with-custom-container-image.md).

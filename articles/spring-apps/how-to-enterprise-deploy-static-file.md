...
|-------------|--------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|
| NGINX       | *nginx.conf*  under the root path of your source code. | Use environment variable `BP_NGINX_CONF_LOCATION` to specify configuration file name. Place the file under the root path of your source code. |

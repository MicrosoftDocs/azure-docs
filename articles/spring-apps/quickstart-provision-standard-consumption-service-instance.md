---
title: Quickstart - Provision an Azure Spring Apps Standard consumption & dedicated plan service instance
description: Learn how to create a Standard consumption & dedicated plan in Azure Spring Apps for app deployment.
author: karlerickson
ms.author: xuycao
...
# Quickstart: Provision an Azure Spring Apps Standard consumption & dedicated plan service instance
...
This article describes how to create a Standard consumption & dedicated plan in Azure Spring Apps for application deployment.
...
## Provision a Standard consumption & dedicated plan instance

You can use either the Azure portal or the Azure CLI to create a Standard consumption & dedicated plan.
...
1. Create a dedicated workload profile in the Azure Container Apps environment:
...
1. Use the following command to deploy a Standard consumption & dedicated plan for an Azure Spring Apps instance on top of the container environment. Create your Azure Spring Apps instance by specifying the resource of the Azure Container Apps environment you created.
...
> [Create an Azure Spring Apps Standard consumption & dedicated plan instance in an Azure Container Apps environment with a virtual network](./quickstart-provision-standard-consumption-app-environment-with-virtual-network.md)

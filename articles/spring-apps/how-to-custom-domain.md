...
Whenever Azure Spring Apps imports or reloads a certificate for you, an activity log will be generated.  To see activity logs, navigate to your Azure Spring Apps instance in the Azure portal and select **Activity log** in the navigation pane.

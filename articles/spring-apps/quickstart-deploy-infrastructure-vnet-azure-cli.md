...
* If you're deploying Azure Spring Apps Enterprise tier for the first time in the target subscription, check the [special prerequisites for Enterprise tier](./how-to-enterprise-marketplace-offer.md#prerequisites).

...
Follow the steps in the [Provision an instance of Azure Spring Apps](./quickstart.md#32-provision-an-instance-of-azure-spring-apps) section of [Quickstart: Deploy your first application to Azure Spring Apps](quickstart.md).
...
* [Provision an instance of Azure Spring Apps](./quickstart.md#32-provision-an-instance-of-azure-spring-apps) section of [Quickstart: Deploy your first application to Azure Spring Apps](quickstart.md).

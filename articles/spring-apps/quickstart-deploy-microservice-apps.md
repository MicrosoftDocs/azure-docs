...
> 2. The deployed app `admin-server` exposes public access, which is a risk point. Therefore, the production environment needs to secure the Spring Boot Admin application.

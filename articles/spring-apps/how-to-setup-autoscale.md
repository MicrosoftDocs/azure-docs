...
:::image type="content" source="media/spring-cloud-autoscale/custom-autoscale.png" alt-text="Screenshot of Azure portal showing the **Autoscale setting** page with the **Custom autoscale** option highlighted." lightbox="media/spring-cloud-autoscale/custom-autoscale.png":::

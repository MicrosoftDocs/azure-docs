...
----------------------------|----------------|----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
   ...
   :::image type="content" source="../../media/quickstart-deploy-event-driven-app/create-consumption.png" alt-text="Screenshot of the Azure portal showing the consumption tab of the Create Azure Spring Apps page." lightbox="../../media/quickstart-deploy-event-driven-app/create-consumption.png":::
...
1. On the **Create App** page, enter `simple-event-driven-app` for **App name** and select *Use quick start sample app* to create app.

   :::image type="content" source="../../media/quickstart-deploy-event-driven-app/consumption-create-app.png" alt-text="Screenshot of the Azure portal showing the Create App pane with consumption plan." lightbox="../../media/quickstart-deploy-event-driven-app/consumption-create-app.png":::

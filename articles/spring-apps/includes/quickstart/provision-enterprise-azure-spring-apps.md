...
1. Fill out the **Basics** form with the following information:
   ...
   :::image type="content" source="../../media/quickstart/create-enterprise-basics.png" alt-text="Create an Azure Spring Apps service" lightbox="../../media/quickstart/create-enterprise-basics.png":::

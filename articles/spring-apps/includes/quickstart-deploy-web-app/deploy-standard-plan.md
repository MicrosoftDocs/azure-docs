...
1. Fill out the **Basics** form with the following information:
   ...
   | Zone Redundant | Unchecked                        | Indicates whether to create your Azure Spring Apps service in an Azure availability zone. Currently, this feature is supported only in some regions.                                                                                                                                               |

...
- Understand and fulfill the [Prerequisites](how-to-enterprise-marketplace-offer.md#prerequisites) section of [Enterprise Tier in Azure Marketplace](how-to-enterprise-marketplace-offer.md).

...
| Failed to load catalog product vmware-inc.azure-spring-cloud-vmware-tanzu-2 in the Azure subscription market.                                                                                                                                                           | It is because your Azure subscription does not belong to a [billing account](../cost-management-billing/manage/view-all-accounts.md) in a supported geographic location defined in the [Azure Spring Apps Enterprise](https://aka.ms/ascmpoffer) offer in Azure Marketplace. For more information, see the [Supported geographic locations of billing account](#supported-geographic-locations-of-billing-account) section. You can resolve it by either of ways: - Choose another Azure subscription to create the Azure Spring Apps Enterprise. - Create a support ticket to Azure.             |

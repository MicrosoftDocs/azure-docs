...
1. If any custom domain resources are configured, create the CNAME records as described in [Map an existing custom domain to Azure Spring Apps](how-to-custom-domain.md). Make sure the record name is expected for the new service name.

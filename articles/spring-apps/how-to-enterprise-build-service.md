...
## Manage custom builders to deploy an app
### Manage a custom builder
...
The [OS Stack](https://docs.pivotal.io/tanzu-buildpacks/stacks.html) include `Bionic Base`, `Bionic Full`, `Jammy Base`, `Jammy Full`. Bionic based on `Ubuntu 18.04 (Bionic Beaver)` and Jammy based on `Ubuntu 22.04 (Jammy Jellyfish)`. See the base/full usage scenario [here](https://docs.vmware.com/en/VMware-Tanzu-Buildpacks/services/tanzu-buildpacks/GUID-stacks.html#ubuntu-stacks)

...
1. Select **Alerts** in the navigation pane, and then select **Action groups**.
   ...
   :::image type="content" source="media/alerts-action-groups/alerts-page-action-groups.png" alt-text="Screenshot of the Azure portal showing the Alerts page with the Action groups button highlighted." lightbox="media/alerts-action-groups/alerts-page-action-groups.png":::
...
1. Select **Alerts** in the navigation pane, and then select **Alert rules**.
   ...
   :::image type="content" source="media/alerts-action-groups/alerts-page-rules.png" alt-text="Screenshot of the Azure portal showing the Alerts page with the Alert rule button highlighted." lightbox="media/alerts-action-groups/alerts-page-rules.png":::
...
1. On the **Alert rules** page, verify that the new alert rule is enabled.
   ...
   :::image type="content" source="media/alerts-action-groups/alert-rule-enabled.png" alt-text="Screenshot of the Azure portal showing the Alert rules page with the rule that was just created enabled." lightbox="media/alerts-action-groups/alert-rule-enabled.png":::

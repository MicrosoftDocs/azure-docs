...
1. In **FitAssist**, enter *I need a bike for a commute to work* and observe the output that was generated by the Assist Service application:
   ...
   :::image type="content" source="media/quickstart-fitness-store-azure-open-ai/fitassist-question.png" alt-text="Screenshot that shows the 'I need a bike for a commute to work' query and the response from the Fitness Store assistant." lightbox="media/quickstart-fitness-store-azure-open-ai/fitassist-question.png":::

...
The following features aren't supported in Azure Spring Apps due to the limitation of Java Native Image. Azure Spring Apps support them when the Java Native Image and the community overcomes the limitation.

...
- **Support for the PHP Buildpack**: PHP apps can be directly deployed from source code and receive continuous maintenance (CVE fixes) of the automatic built images, see the [Deploy PHP applications](how-to-enterprise-deploy-polyglot-apps.md#deploy-php-applications) section of [How to deploy polyglot apps in the Azure Spring Apps Enterprise plan](how-to-enterprise-deploy-polyglot-apps.md).

...
A Spring Cloud Gateway instance routes traffic according to rules. It supports rich features, and you can customize it using the sections later in this article. Both scale in/out and up/down are supported to meet dynamic traffic load.
...
Use the following sections to configure Spring Cloud Gateway for Kubernetes.

...
:::image type="content" source="media/how-to-managed-identities-key-vault/app-user-managed-identity-key-vault.png" alt-text="Screenshot of Azure portal showing the Managed Identity Properties screen with 'Resource ID', 'Principle ID' and 'Client ID' highlighted." lightbox="media/how-to-managed-identities-key-vault/app-user-managed-identity-key-vault.png":::

...
- `143` - The application exited because it failed to respond to a health check due to an out-of-memory error or some other error.
  ...
  You can also get details from the application log by using the Azure CLI `az spring app logs` command. For more information, see [Stream Azure Spring Apps application console logs in real time](how-to-log-streaming.md).

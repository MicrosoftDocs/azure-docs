...
1. Specify the memory to 2 GB and JVM options: `-Xms2048m -Xmx2048m`.
   ...
   :::image type="content" source="media/quickstart-deploy-apps/memory-jvm-options.png" alt-text="Screenshot of the Create Azure Spring App page that shows the memory and the JVM options." lightbox="media/quickstart-deploy-apps/memory-jvm-options.png":::

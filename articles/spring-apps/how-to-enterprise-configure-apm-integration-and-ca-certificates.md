...
- Configure APM via APM resource. It's the recommended way to configure APM.
...
### [Configure APM via Bindings in builder](#tab/configure-apm-via-bindings-in-builder)

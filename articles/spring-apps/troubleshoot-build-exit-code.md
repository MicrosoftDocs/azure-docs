...
If your application is static file or dynamic frontend application served by web server, refer to [static file common deployment error](/articles/spring-apps/how-to-enterprise-deploy-static-file.md#common-build-error).

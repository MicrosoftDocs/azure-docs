...
When you use your own persistent storage, artifacts generated by your application are uploaded into a storage account that you control. You control the encryption-at-rest policy, the lifetime management policy, and network access. You are responsible for the costs associated with that storage account.
...
The following are frequently asked questions about using your own persistent storage with Azure Spring Apps.

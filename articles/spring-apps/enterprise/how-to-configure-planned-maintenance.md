...
> [!NOTE]
> In compliance with Microsoft’s security standards, we will perform additional security patching for underlying AKS clusters during the second week of each month. Maintenance will occur within an 8-hour window during non-working hours. This will be conducted in a rolling fashion to ensure uninterrupted service.

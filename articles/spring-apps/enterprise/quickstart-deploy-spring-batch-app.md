...
1. Click “View logs” to query the logs of the Job execution.
...
1. Then open the public endpoint of the app to see the billboard UI and do not close it.
...
1. Back to the overview page of the Job “football” and click **Run** button to trigger the execution again.

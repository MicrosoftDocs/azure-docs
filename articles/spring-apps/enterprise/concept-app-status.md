...
:::image type="content" source="media/concept-app-status/apps-ui-status.png" alt-text="Screenshot of the Azure portal that shows the Apps Settings page with some columns highlighted." lightbox="media/concept-app-status/apps-ui-status.png":::

...
:::image type="content" source="media/how-to-scale-manual/scale-up-out.png" alt-text="Screenshot of the Azure portal showing the Scale up page for an app in an Azure Spring Apps instance, with Scale up highlighted." lightbox="media/how-to-scale-manual/scale-up-out.png":::

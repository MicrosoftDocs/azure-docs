...
You can delete the Azure resource group, which includes all the resources in the resource group. Use the following command to delete the entire resource group, including the newly created service:

<properties 
	pageTitle="PHP website with MySQL and WebMatrix - Azure tutorial" 
	description="A tutorial that demonstrates how to use the free WebMatrix IDE to create and deploy a PHP website that stores data in MySQL." 
	services="web-sites" 

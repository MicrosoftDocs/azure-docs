...
* **Sample Labeling Tool Updates** Including better support for on-premise users of the same labeling tool and for API versions. See the [FOTT Changelog](https://github.com/microsoft/OCR-Form-Tools/blob/master/CHANGELOG.md) for full details.

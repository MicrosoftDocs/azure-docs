...
* Complete a [Form Recognizer quickstart](quickstarts/client-library-guide.md) to get started extracting layouts in the development language of your choice.

...
# Managed Identities and Bring Your Own Storage (BYOS)
...
1. In the main window, select the **System assigned** tab →  toggle **Status** to **On** → under *Permissions* select **Azure role assigments**:
...
|------|--------|
|**Scope**| ***Storage***|
|**Subscription**| ***The subscription for your storage resource***|

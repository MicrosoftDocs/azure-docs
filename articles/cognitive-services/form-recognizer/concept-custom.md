...
> [<h2>Assemble your training dataset</h2>](build-training-data-set.md#custom-model-input-requirements)
...
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&#129155;
> [!div class="nextstepaction"]
> [<h2>Train your custom model</h2>](quickstarts/client-library.md#train-a-custom-model)
...
>[!div class="nextstepaction"]
> [<h2>Analyze documents with your custom model</h2>](quickstarts/client-library.md#analyze-forms-with-a-custom-model)
...
> [!div class="nextstepaction"]
> [<h2>Manage your custom models</h2>](quickstarts/client-library.md#manage-custom-models)

...
description: In this quickstart, you'll use the Azure Form Recognizer REST API with Python to train a model and extract data from forms.
...
In this quickstart, you'll use Form Recognizer REST API with Python to train and score forms to extract key-value pairs and tables.

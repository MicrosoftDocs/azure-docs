...
> [!IMPORTANT]
> This quickstart uses the Form Recognizer v1.0 API. If your subscription is in the `westus` or `europe` region, you should follow the v[2.0 API quickstart](./curl-train-extract.md) instead.

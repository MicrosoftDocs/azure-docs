...
> [!IMPORTANT]
> This quickstart uses the Form Recognizer v1.0 API. If your subscription is in the `West US 2` or `West Europe` region, you should follow the v[2.0 API quickstart](./python-train-extract.md) instead.

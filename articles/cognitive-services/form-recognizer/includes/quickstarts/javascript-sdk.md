...
You can use Form Recognizer to analyze tables, lines, and words in documents, without needing to train a model. To analyze the content of a file at a given URI, use the `beginRecognizeContentFromUrl` method.

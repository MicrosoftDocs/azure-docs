...
* **Pre-built Receipt v2.1-preview.3** (Public Preview) only supports invoices in the EN-US locale.
* **Pre-built Receipt v2.1** (GA) only supports invoices in the EN-US locale.

...
> [!CAUTION]
> The Copy API currently does not support model IDs for [composed custom models](https://westcentralus.dev.cognitive.microsoft.com/docs/services/form-recognizer-api-v2-1-preview-2/operations/Compose). Model compose is a preview feature in v2.1-preview.3. 

...
If you use Speech SDK for JavaScript, you need to use `sessionStarted` event of the [Recognizer class](https://learn.microsoft.com/javascript/api/microsoft-cognitiveservices-speech-sdk/recognizer).

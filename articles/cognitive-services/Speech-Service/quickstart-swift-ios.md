...
1. Add the relative path to the bridging header to the Swift project settings for the helloworld target in the *Objective-C Bridging Header* field
...
1. Replace the contents of the autogenerated `AppDelegate.m` file by:
   [!code-swift[Quickstart Code](~/samples-cognitive-services-speech-sdk/quickstart/swift-ios/helloworld/helloworld/AppDelegate.m#code)]
1. Replace the contents of the autogenerated `ViewController.m` file by:
   [!code-swift[Quickstart Code](~/samples-cognitive-services-speech-sdk/quickstart/swift-ios/helloworld/helloworld/ViewController.m#code)]
1. In `ViewController.m`, replace the string `YourSubscriptionKey` with your subscription key.

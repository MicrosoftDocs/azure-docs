...
Quickstarts are also available for [speech synthesis](quickstart-text-to-speech-java-android.md) and [speech assistant](quickstart-speech-assistant-java-android.md).
...
The application is based on the Speech SDK Maven Package, and Android Studio 3.3.

...
The application is based on the Microsoft Cognitive Services Speech SDK Maven Package, version 1.3.0, and Android Studio 3.1.
...
1. In the window that comes up, enter the name and version of our Speech SDK for Android, `com.microsoft.cognitiveservices.speech:client-sdk:1.3.0`. Then select **OK**.

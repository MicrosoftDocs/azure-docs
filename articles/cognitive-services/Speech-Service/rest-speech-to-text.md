...
|Path|Method|Version 3.1|Version 3.0|
|---------|---------|---------|---------|
|`/healthstatus`|GET| ServiceHealth_Get|[GetHealthStatus](https://eastus.dev.cognitive.microsoft.com/docs/services/speech-to-text-api-v3-0/operations/GetHealthStatus)|

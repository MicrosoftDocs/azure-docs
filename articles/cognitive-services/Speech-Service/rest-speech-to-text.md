...
| `AccuracyScore` | Pronunciation accuracy of the given speech. Accuracy indicates how closely the phonemes match a native speaker's pronunciation. Word and full text level accuracy score is aggregated from phoneme level accuracy score. |
...
| `CompletenessScore` | Completeness of the given speech by calculating the ratio of pronounced words towards reference text input. |

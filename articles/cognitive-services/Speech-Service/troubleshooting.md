...
If you entered a valid subscription key, the command will return an authorization token, otherwise an error will be returned.
...
If you entered a valid authorization token, the command will return the transcribtion for your passed audio file, otherwise an error will be returned.

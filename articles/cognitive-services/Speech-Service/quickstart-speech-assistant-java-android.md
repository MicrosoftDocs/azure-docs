---
title: 'Quickstart: Custom speech assistant, Java (Android) - Speech Service'
titleSuffix: Azure Cognitive Services
description: Learn how to create a speech assistant application in Java on Android using the Speech SDK
...
# Quickstart: Create a speech assistant in Java on Android by using the Speech SDK
...
1. In the same file, replace the configuration strings to match your resources:
    ...
    * Replace `YourServiceRegion` with the [region](regions.md) associated with your subscription Only a subset of Speech Services regions are currently supported with Direct Line Speech. For more information, see [regions](regions.md#speech-assistants).

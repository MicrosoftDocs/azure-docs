...
The Microsoft speech recognition API supports the following languages. Different levels of customization are available for each language.  
 ...
 ------|----------|---------------------|---------------------|-------------------------
 ar-EG | Arabic (Egypt), modern standard | Yes | Yes | Yes
 ca-ES | Catalan (Spain) | No | Yes | No
 da-DK | Danish (Denmark) | No | Yes | No
 ...
 es-ES | Spanish (Spain) | Yes | Yes | Yes
 es-MX | Spanish (Mexico) | Yes | Yes | Yes 
 fi-FI | Finnish (Finland) | No | Yes | No 
 fr-CA | French (Canada) | Yes | Yes | Yes 
 fr-FR | French (France) | Yes | Yes | Yes
 hi-IN | Hindi (India) | Yes | Yes | Yes 
 it-IT | Italian (Italy) | Yes | Yes | Yes
 ja-JP | Japanese (Japan) | Yes | Yes | Yes
 ko-KR | Korean (Korea) | No | Yes | No
 nb-NO | Norwegian (Bokmål) (Norway) | No | Yes | No 
 nl-NL | Dutch (Netherlands) | No | Yes | No
 pl-PL | Polish (Poland) | No | Yes | No
 pt-BR | Portuguese (Brazil) | Yes | Yes | Yes
 pt-PT | Portuguese (Portugal) | No | Yes | No
 ru-RU | Russian (Russia) | Yes | Yes | Yes
 sv-SE | Swedish (Sweden) | No | Yes | No 
 zh-CN | Chinese (Mandarin, simplified) | Yes | Yes | Yes
 zh-HK | Chinese (Mandarin, Traditional) | No | Yes | No
 zh-TW | Chinese (Taiwanese Mandarin) | No | Yes | No
 th-TH | Thai (Thailand) | No | Yes | No

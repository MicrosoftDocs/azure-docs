...
| [Text-to-speech](text-to-speech.md) | Prebuilt neural voices | Text-to-speech converts input text into human-like synthesized speech by using the [Speech Synthesis Markup Language (SSML)](speech-synthesis-markup.md). Use neural voices, which are human-like voices powered by deep neural networks. See [Language support](language-support.md). | [Yes](./speech-sdk.md) | [Yes](#reference-docs) |

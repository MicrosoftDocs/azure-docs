...
| [Speech Assistants](speech-assistants.md) | Speech assistants | Speech assistants using Azure Speech Services empower developers to create natural, human-like conversational interfaces for their applications and experiences. The speech assistant service provides fast, reliable interaction between a device and an assistant implementation that uses the Bot Framework's Direct Line Speech channel or the integrated Custom Commands (Preview) service for task completion. | [Yes](speech-assistants.md) | No |
...
* May 2019 - Documentation is now available for [Conversation Transcription](conversation-transcription-service.md), [Call Center Transcription](call-center-transcription.md), and [Speech Assistants](speech-assistants.md).
* May 2019

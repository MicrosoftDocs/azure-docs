...
| | [Multi-device Conversation](overview-multi-device-conversation.md) | Connect multiple devices or clients in a conversation to exchange speech- or text-based languages, with easy support for transcription and translation| Yes | No |

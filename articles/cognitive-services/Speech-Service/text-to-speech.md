...
> [!NOTE]
>
> The traditional/standard voices and non-neural custom voice are deprecated and will no longer be supported in 2024. If your applications, tools, or products are using any of the standard voices and custom voices, we've created guides to help you migrate to the neural version.
>

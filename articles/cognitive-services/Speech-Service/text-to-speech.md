...
* **Prebuilt neural voices**: Microsoft neural text-to-speech capability uses deep neural networks to overcome the limits of traditional speech synthesis with regard to stress and intonation in spoken language. Prosody prediction and voice synthesis happen simultaneously, which results in more fluid and natural-sounding outputs. All the prebuilt neural voices have now been upgraded to high-fidelity voices with 48kHz sample rate. You can use neural voices to:

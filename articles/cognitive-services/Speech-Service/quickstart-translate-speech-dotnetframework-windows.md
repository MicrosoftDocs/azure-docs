...
Quickstarts are also available for [speech-to-text](quickstart-csharp-dotnet-windows.md) and and [text-to-speech](quickstart-text-to-speech-dotnet-windows.md).

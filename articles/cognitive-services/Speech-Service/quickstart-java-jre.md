...
Quickstarts are also available for [speech-to-speech-translation](quickstart-translate-speech-java-jre.md), [speech assistant](quickstart-speech-assistant-java-jre.md), and [speech synthesis](quickstart-text-to-speech-java-jre.md).

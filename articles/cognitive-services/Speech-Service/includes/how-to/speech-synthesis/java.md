...
You can get the [full list](../../../language-support.md?tabs=tts) or try them in a [text-to-speech demo](https://azure.microsoft.com/services/cognitive-services/text-to-speech/#features).

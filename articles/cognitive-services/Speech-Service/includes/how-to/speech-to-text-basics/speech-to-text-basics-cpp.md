...
To use a phrase list, first create a [`PhraseListGrammar`](/cpp/cognitive-services/speech/phraselistgrammar) object. Then add specific words and phrases by using [`AddPhrase`](/cpp/cognitive-services/speech/phraselistgrammar#addphrase). Any changes to [`PhraseListGrammar`](/cpp/cognitive-services/speech/phraselistgrammar) take effect on the next recognition or after a reconnection to the Speech service.

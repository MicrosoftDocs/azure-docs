...
| CN East 2 | `https://cneast2.voice.speech.microsoft.com/cognitiveservices/v1?deploymentId={deploymentId}` |
...
| US Gov Arizona | `https://usgovarizona.voice.speech.microsoft.com/cognitiveservices/v1?deploymentId={deploymentId}` |
| US Gov Virginia | `https://usgovvirginia.voice.speech.microsoft.com/cognitiveservices/v1?deploymentId={deploymentId}` |

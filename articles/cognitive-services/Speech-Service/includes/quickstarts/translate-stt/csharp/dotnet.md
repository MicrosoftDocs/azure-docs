...
Quickstarts are also available for [speech recognition](~/articles/cognitive-services/Speech-Service/from-microphone/speech-to-text-from-microphone.md) and [speech synthesis](~/articles/cognitive-services/Speech-Service/quickstarts/text-to-speech.md?pivots=programming-language-csharp).

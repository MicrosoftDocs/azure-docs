...
- [Quickstart: Recognize speech, Java (Windows, Linux)](~/articles/cognitive-services/Speech-Service/from-microphone/speech-to-text-from-microphone.md?pivots=programming-language-java)

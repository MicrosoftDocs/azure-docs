...
* If this is your first Python project, use this guide to [create an empty sample project](../../../../quickstarts/create-project.md)
* [Install the Speech SDK for your development environment](../../../../quickstarts/setup-platform.md)

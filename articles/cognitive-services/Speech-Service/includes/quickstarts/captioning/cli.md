...
- The preceding command also displayed event results with offset and duration. For more information, see the [Get speech recognition results](~/articles/cognitive-services/speech-service/captioning-concepts.md#caption-output-format) documentation.

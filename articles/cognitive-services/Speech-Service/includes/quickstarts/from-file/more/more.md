...
|--|--|--|
| C# | [From mic][1-mic], [From blob][1-blob] | [.NET Framework][dotnet], [.NET Core][netcore], [UWP][uwp], [Unity][unity], [Xamarin][xamarin] |
| C++ | [From mic][2-mic], [From blob][2-blob] | [Windows][cpp-windows], [Linux][cpp-linux], [macOS][cpp-mac] |
| Java | [From mic][3-mic], [From blob][3-blob] | [Android][java-android], [JRE][java-jre] |
...
[1-mic]: ~/articles/cognitive-services/speech-service/quickstarts/quickstarts/speech-to-text-from-microphone?pivots=programming-language-csharp
[1-blob]: ~/articles/cognitive-services/speech-service/quickstarts/quickstarts/from-blob?pivots=programming-language-csharp
...
[2-mic]: ~/articles/cognitive-services/speech-service/quickstarts/quickstarts/speech-to-text-from-microphone?pivots=programming-language-cpp
[2-blob]: ~/articles/cognitive-services/speech-service/quickstarts/quickstarts/from-blob?pivots=programming-language-cpp
...
[3-mic]: ~/articles/cognitive-services/speech-service/quickstarts/quickstarts/speech-to-text-from-microphone?pivots=programming-language-java
[3-blob]: ~/articles/cognitive-services/speech-service/quickstarts/quickstarts/from-blob?pivots=programming-language-java
...
[4-mic]: ~/articles/cognitive-services/speech-service/quickstarts/quickstarts/speech-to-text-from-microphone?pivots=programming-language-python
[4-blob]: ~/articles/cognitive-services/speech-service/quickstarts/quickstarts/from-blob?pivots=programming-language-python

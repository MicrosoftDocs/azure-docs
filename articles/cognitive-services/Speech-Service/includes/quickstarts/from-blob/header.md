...
In this quickstart you will use the [REST API]() to recognize speech stored in a [SAS blob](). After satisfying a few prerequisites, recognizing speech using a REST API only takes a few steps:
> [!div class="checklist"]

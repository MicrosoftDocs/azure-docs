...
In this quickstart you will use the [Speech SDK](https://aka.ms/ignite2019/speech/placeholder) to convert text to synthesized speech in an audio file. After satisfying a few prerequisites, synthesizing speech into a file only takes five steps:
> [!div class="checklist"]

...
Quickstarts are also available for [text-to-speech](quickstart-text-to-speech-cpp-windows.md) and [speech-to-speech-translation](quickstart-translate-speech-cpp-windows.md).

...
1. In the **Add new voice talent** wizard, describe the characteristics of the voice you are going to create. The scenarios that you specify here must be consistent with what you provided in the application form.
1. Select **Next**.

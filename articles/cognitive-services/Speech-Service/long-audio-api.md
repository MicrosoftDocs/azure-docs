...
The Long Audio API supports a subset of [Public Neural Voices](./language-support.md) and [Custom Neural Voices](./language-support.md).
...
* Replace `<locale>` with the desired output locale. For more information, see [language support](language-support.md).

...
You can use a custom model for some time after it's trained and deployed. You must periodically recreate and adapt your custom model from the latest base model to take advantage of the improved accuracy and quality.
...
- Adaptation is available for one year after the quarter when the base model was created by Microsoft.

...
| SDK | Reference | Platform support |
|----------------------|----------|----------|
| [C# SDK install](quickstarts/setup-platform.md?pivots=programming-language-csharp) <sup>1</sup> | [.NET](/dotnet/api/overview/azure/cognitiveservices/client/speechservice) | Windows, Linux, macOS, Mono, Xamarin.iOS, Xamarin.Mac, Xamarin.Android, UWP, Unity |
| [C++ SDK install](quickstarts/setup-platform.md?pivots=programming-language-cpp) | [C++](/cpp/cognitive-services/speech/) | Windows, Linux, macOS |
| [Go SDK install](quickstarts/setup-platform.md?pivots=programming-language-go) | [Go](https://github.com/Microsoft/cognitive-services-speech-sdk-go) | Linux | 
| [Java SDK install](quickstarts/setup-platform.md?pivots=programming-language-java) | [Java](/java/api/com.microsoft.cognitiveservices.speech) | Android, Windows, Linux, macOS |
| [JavaScript SDK install](quickstarts/setup-platform.md?pivots=programming-language-javascript) | [JavaScript](/javascript/api/microsoft-cognitiveservices-speech-sdk/) | Browser, Node.js |
| [Objective-C SDK install](quickstarts/setup-platform.md?pivots=programming-language-objectivec) | [Objective-C](/objectivec/cognitive-services/speech/) | iOS, macOS |
| [Python SDK install](quickstarts/setup-platform.md?pivots=programming-language-python) | [Python](/python/api/azure-cognitiveservices-speech/) | Windows, Linux, macOS |
| [Swift SDK install](quickstarts/setup-platform.md?pivots=programming-language-swift) <sup>2</sup> | [Objective-C](/objectivec/cognitive-services/speech/) | iOS, macOS |
...
<sup>2 The Speech SDK for C++ shares client libraries and reference documentation with the Speech SDK for Objective-C.</sup>

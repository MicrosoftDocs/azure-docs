...
You will need a simple web endpoint which returns json consisting of list of the devices which can be controlled. The web endpoint should return a json of below format:

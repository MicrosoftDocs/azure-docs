...
> [!NOTE]
> This example uses the `en-US-Aria24kRUS` voice. For a complete list of supported voices, see [Language support](language-support.md#text-to-speech).

```XML
<speak version="1.0" xmlns="https://www.w3.org/2001/10/synthesis" xml:lang="en-US">
    <voice name="en-US-Aria24kRUS">
...
<speak version="1.0" xml:lang="en-US" xmlns:mstts="http://www.w3.org/2001/mstts">
    ...
    <voice name="Microsoft Server Speech Text to Speech Voice (en-US, Aria24kRUS)">

...
Quickstarts are also available for [speech recognition](quickstart-csharp-uwp.md), [speech translation](quickstart-translate-speech-uwp.md), and [voice assistant](quickstart-speech-assistant-csharp-uwp.md).

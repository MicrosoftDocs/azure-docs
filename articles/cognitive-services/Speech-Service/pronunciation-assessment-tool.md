...
- At the symbol-level, pronunciation assessment provides accuracy scores for each syllable. Currently, you can only check it through [JSON file](?tabs=json#scores-within-words).

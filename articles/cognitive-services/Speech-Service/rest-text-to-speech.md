...
- For a complete list of voices, see [Language and voice support for the Speech service](language-support.md).
...
> [!TIP]
> [Voices in preview](language-support.md) are available in only these three regions: East US, West Europe, and Southeast Asia.

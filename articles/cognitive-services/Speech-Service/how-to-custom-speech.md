...
2. Sign-in to the [Custom Speech portal](https://portal.cris.ai/customspeech.html).<< **Please notice the URL is not finalized**>>
2. Select the subscription you need to work on and creat a speech project. 

---
title: Speech-to-text language identification - Speech service
titleSuffix: Azure Cognitive Services
description: Speech-to-text language identification is used to determine the language being spoken when compared against a list of provided languages.

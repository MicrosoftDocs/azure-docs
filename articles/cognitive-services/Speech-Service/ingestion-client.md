...
Both, the Microsoft [Speech SDK](speech-sdk.md) and the [Speech-to-text REST API v3.0](rest-speech-to-text-30.md), can be used to obtain transcripts. The decision does impact overall costs as it is explained in the guide. 

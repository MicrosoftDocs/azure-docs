...
* Ensure that you use a [supported Azure region](https://docs.microsoft.com/azure/cognitive-services/speech-service/regions#speech-assistants).
...
If your issue isn't addressed in the table, see [Speech assistants: Frequently asked questions](faq-speech-assistants.md).
...
* Building and deploying your own voice-enabled bot:
    ...
    * Explore existing [Bot-Framework solutions](https://github.com/microsoft/botframework-solutions): Build a [custom speech assistant](https://docs.microsoft.com/azure/cognitive-services/speech-service/speech-assistants) and [voice-enable it](https://github.com/microsoft/botframework-solutions/blob/master/docs/howto/assistant/csharp/speechenablement.md)

...
|-------------|-------|---|
|{API_KEY} | The API key of the Speech resource. |xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx|
|{ENDPOINT_URI} | The endpoint value including region.|`https://westus.api.cognitive.microsoft.com/sts/v1.0`|

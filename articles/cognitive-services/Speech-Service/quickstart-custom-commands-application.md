...
> * Download the latest version of [Windows Voice Assistant Client](https://github.com/Azure-Samples/Cognitive-Services-Voice-Assistant/releases) (only available on Windows).

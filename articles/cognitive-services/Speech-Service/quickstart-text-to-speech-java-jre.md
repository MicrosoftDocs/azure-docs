...
Quickstarts are also available for [speech recognition](quickstart-java-jre.md), [speech-to-speech-translation](quickstart-translate-speech-java-jre.md), and [speech assistant](quickstart-speech-assistant-java-jre.md).

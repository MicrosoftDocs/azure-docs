...
Before you can train your own Text-to-Speech voice model, you'll need [audio recordings](/azure/cognitive-services/speech-service/record-custom-voice-samples) and the [associated text transcriptions](/azure/cognitive-services/speech-service/how-to-custom-voice-prepare-data#types-of-training-data). On this page, we'll review data types, how they're used, and how to manage each.

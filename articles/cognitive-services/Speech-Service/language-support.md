...
| `fr-FR` | French (France)<sup>1</sup> | `fr-FR` | Plain text<br/><br/>Structured text<br/><br/>Pronunciation<br/><br/>Phrase list | `fr-FR-AlainNeural`<sup>5,6</sup> (Male)<br/>`fr-FR-BrigitteNeural`<sup>5,6</sup> (Female)<br/>`fr-FR-CelesteNeural`<sup>5,6</sup> (Female)<br/>`fr-FR-ClaudeNeural`<sup>5,6</sup> (Male)<br/>`fr-FR-CoralieNeural`<sup>5,6</sup> (Female)<br/>`fr-FR-DeniseNeural`<sup>2,5,6</sup> (Female)<br/>`fr-FR-EloiseNeural`<sup>5,6</sup> (Female)<br/>`fr-FR-HenriNeural`<sup>5,6</sup> (Male)<br/>`fr-FR-JacquelineNeural`<sup>5,6</sup> (Female)<br/>`fr-FR-JeromeNeural`<sup>5,6</sup> (Male)<br/>`fr-FR-JosephineNeural`<sup>5,6</sup> (Female)<br/>`fr-FR-MauriceNeural`<sup>5,6</sup> (Male)<br/>`fr-FR-YvesNeural`<sup>5,6</sup> (Male)<br/>`fr-FR-YvetteNeural`<sup>5,6</sup> (Female) | Custom Neural Voice Pro<br/><br/>Custom Neural Voice Lite (Preview)<br/><br/>Cross-lingual voice (Preview) | 

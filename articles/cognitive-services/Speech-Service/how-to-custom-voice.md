...
> [!IMPORTANT]
> The [Custom Voice portal](https://aka.ms/custom-voice) recently updated! If you've created previous projects with data, models, tests, and published endpoints in the CRIS portal or with APIs, you'll need to create a new project in the new portal in order to connect to these old entities.

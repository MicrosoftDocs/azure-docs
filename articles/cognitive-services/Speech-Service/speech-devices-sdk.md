...
The Speech Devices SDK facilitates a variety of voice-enabled scenarios, such as [conversational voice agents](conversational-voice-agents.md), drive-thru ordering systems, [conversation transcription](conversation-transcription), and smart speakers. You can respond to users with text, speak back to them in a default or [custom voice](how-to-customize-voice-font.md), provide search results, [translate](speech-translation.md) to other languages, and more. We look forward to seeing what you build!

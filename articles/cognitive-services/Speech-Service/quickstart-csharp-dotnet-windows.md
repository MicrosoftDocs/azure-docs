...
Quickstarts are also available for [text-to-speech](quickstart-text-to-speech-dotnet-windows.md) and [speech-to-speech-translation](quickstart-translate-speech-dotnetframework-windows.md).

...
Quickstarts are also available for [speech-recognition](quickstart-cpp-windows.md) and [speech-to-speech-translation](quickstart-translate-speech-cpp-windows.md).

...
|--|--|--|--|
|Princeton Tower ![Princeton Tower](media/speech-devices-sdk/device-princeton.png)|7 Mic Array, Speaker, 360 Camera, ARM SOC, WIFI, Ethernet, ID. </br>Linux|A flagship device for conversation transcription including speaker identification. Available via systems integrators for enterprise deployment. Click [here](http://www.cts.ai/) to learn more.|Conversation Transcription|

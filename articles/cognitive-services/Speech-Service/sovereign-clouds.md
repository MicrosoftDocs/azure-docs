...
| [Speech-to-text REST API v3.0](rest-speech-to-text-30.md) | `https://<REGION_IDENTIFIER>.api.cognitive.microsoft.us/<URL_PATH>` |
...
| [Speech-to-text REST API v3.0](rest-speech-to-text-30.md) | `https://<REGION_IDENTIFIER>.api.cognitive.azure.cn/<URL_PATH>` |

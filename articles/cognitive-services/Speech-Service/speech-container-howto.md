...
| Custom speech-to-text | Using a [Custom Speech model](custom-speech-overview.md), transcribes continuous real-time speech or batch audio recordings into text with intermediate results. | 3.1.0 | Generally available |

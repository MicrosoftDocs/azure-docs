...
* The file `Microsoft.CognitiveServices.Speech.csharp.bindings.dll`, shipped in previous releases, isn't needed anymore. The functionality is now integrate into the core SDK.

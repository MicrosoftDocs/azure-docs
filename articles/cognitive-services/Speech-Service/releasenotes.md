...
- **C++/C#/Java/Python/Objective-C**: Text-to-speech now uses [neural voices](text-to-speech.md#core-features) by default when you don't specify a voice to be used. This gives you higher fidelity output by default, but als increases the default [price](https://azure.microsoft.com/pricing/details/cognitive-services/speech-services/#pricing). You can specify any of our over 70 [standard voices](language-support#standard-voices) or over 130 [neural voices](language-support#neural-voices) to change the default.

...
- Objective-C: `SendMessage` and `SetMessageProperty` methods added to `Connection` object. See documentation [here](https://docs.microsoft.com/en-us/objectivec/cognitive-services/speech/spxconnection).

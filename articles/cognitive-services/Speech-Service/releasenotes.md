...
- `SendMessage` and `SetMessageProperty` methods added to `Connection` object in Objective-C. Documentation [here](https://docs.microsoft.com/objectivec/cognitive-services/speech/).
...
- Added Multi-device conversation quickstarts in C++ and C# .NET [here](quickstarts/multi-device-conversation)

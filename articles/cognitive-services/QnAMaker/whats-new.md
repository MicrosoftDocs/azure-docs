...
* [Metadata: `OR` logical combination of multiple metadata pairs](how-to/query-knowledgebase-with-metadata.md#logical-or-using-strictfilterscompoundoperationtype-property)

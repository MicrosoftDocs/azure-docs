...
* [Metadata: `OR` logical combination of multiple metadata pairs](how-to/query-knowledge-base-with-metadata.md#filter-results-with-strictfilters-for-metadata-tags)

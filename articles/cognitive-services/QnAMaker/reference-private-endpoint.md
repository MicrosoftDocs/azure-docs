...
Azure Private Endpoint is a network interface that connects you privately and securely to a service powered by Azure Private Link. Now, QnA Maker provides you a support to create private endpoint to the Azure Search Service. This functionality is available in QnA Maker managed. 
...
![Managed service Identity](../QnAMaker/media/qnamaker-reference-private-endpoints/private-endpoint-identity1.png)

2. Add the above identity as *Contributer* by going to Azure Search Service IAM tab.
![Managed service IAM](../QnAMaker/media/qnamaker-reference-private-endpoints/private-endpoint-access-control1.png)
...
![Managed QnA maker newtorking](../QnAMaker/media/qnamaker-reference-private-endpoints/private-endpoint-networking2.png)

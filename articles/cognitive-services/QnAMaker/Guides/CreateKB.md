...
Currently the tool can auto-extract question and answer pairs from two types of input:
 ...
 1. **FAQ pages** - We support extraction from following types of FAQ URLs:
	 - Plain FAQ pages: Questions are immediately followed by answers. See an [example](https://support.microsoft.com/en-us/help/17133/windows-8-bitlocker-recovery-keys-frequently-asked-questions)
	 - FAQ pages with section links: Questions are aggregated together and linked to answers on the same page. See an [example](http://support.xbox.com/en-IN/my-account/microsoft-account/manage-your-microsoft-account-faq#0a16820105c847acb050fc1ba7dd2ad3)

...
Knowledge base authoring supports several [role-based access permissions](./concepts/role-based-access-control.md) you apply in the Azure portal to limit the scope of a collaborator's abilities.

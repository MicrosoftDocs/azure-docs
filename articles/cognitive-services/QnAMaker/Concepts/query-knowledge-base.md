...
|2|QnA Maker preprocesses the user query with language detection, spellers, and word breakers. The [stop words](https://github.com/Azure-Samples/azure-search-sample-data/blob/master/STOPWORDS.md) are filtered in this step.|

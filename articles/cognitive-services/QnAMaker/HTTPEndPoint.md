---
title: API v2.0 reference for QnA Maker - Azure Cognitive Services | Microsoft Docs
...
# API V1.0 Reference
Each published QnA Maker service is exposed as an HTTP endpoint that takes a question and responds with the best matched answer and a confidence score.
...
You need the following two GUIDs to access your knowledge base via the HTTP endpoint:
 ...
 - Subscription Key: These are assigned per account and are used for metering. See the subscription keys section for more details.

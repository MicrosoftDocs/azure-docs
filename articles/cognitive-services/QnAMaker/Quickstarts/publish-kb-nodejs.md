...
[!code-go[Add a POST request to publish KB](~/samples-qnamaker-go/documentation-samples/quickstarts/publish-knowledge-base/publish-knowledge-base.java?range=16-47 "Add a POST request to publish KB")]

...
[!code-csharp[Add the required dependencies](https://github.com/Azure-Samples/cognitive-services-quickstart-code/dotnet/QnAMaker/rest/create-kb.cs?range=1-11 "Add the required dependencies")]
...
[!code-csharp[Add the required constants](https://github.com/Azure-Samples/cognitive-services-quickstart-code/dotnet/QnAMaker/rest/create-kb.cs?range=17-26 "Add the required constants")]

## Add the KB definition

After the constants, add the following KB definition:

[!code-csharp[Add the required constants](https://github.com/Azure-Samples/cognitive-services-quickstart-code/dotnet/QnAMaker/rest/create-kb.cs?range=28-58 "Add the knowledge base definition")]

## Add supporting functions and structures
Add the following code block inside the Program class:

[!code-csharp[Add supporting functions and structures](https://github.com/Azure-Samples/cognitive-services-quickstart-code/dotnet/QnAMaker/rest/create-kb.cs?range=60-99 "Add supporting functions and structures")]
...
[!code-csharp[Add PostCreateKB to request via POST](https://github.com/Azure-Samples/cognitive-services-quickstart-code/dotnet/QnAMaker/rest/create-kb.cs?range=145-165 "Add PostCreateKB to request via POST")]

[!code-csharp[Add a POST request to create KB](https://github.com/Azure-Samples/cognitive-services-quickstart-code/dotnet/QnAMaker/rest/create-kb.cs?range=101-122 "Add a POST request to create KB")]
...
[!code-csharp[Add GetStatus to request via GET](https://github.com/Azure-Samples/cognitive-services-quickstart-code/dotnet/QnAMaker/rest/create-kb.cs?range=167-187 "Add GetStatus to request via GET")]

[!code-csharp[Add GET request to determine creation status](https://github.com/Azure-Samples/cognitive-services-quickstart-code/dotnet/QnAMaker/rest/create-kb.cs?range=124-143 "Add GET request to determine creation status")]
...
[!code-csharp[Add CreateKB method](https://github.com/Azure-Samples/cognitive-services-quickstart-code/dotnet/QnAMaker/rest/create-kb.cs?range=189-254 "Add CreateKB method")]

## Add the CreateKB method to Main

Change the Main method to call the CreateKB method:

[!code-csharp[Add CreateKB method](https://github.com/Azure-Samples/cognitive-services-quickstart-code/dotnet/QnAMaker/rest/create-kb.cs?range=256-265 "Add CreateKB method")]

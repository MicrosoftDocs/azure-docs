...
Adding metadata to a question and answer set allows your client application to request filtered answers. This filter is applied after the [first and second rankers](../concepts/knowledge-base.md#ranker-process) are applied.

...
[!code-java[Add a POST request to publish KB](~/samples-qnamaker-java/documentation-samples/quickstarts/get-answer/PublishKB.java?range=32-44 "Add a POST request to publish KB")]

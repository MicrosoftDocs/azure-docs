...
The default answer for a knowledge base is meant to be returned when an answer is not found. If you are using a client application, such as the Azure Bot service, it may also have a separate default answer, indicating no answer met the score threshold.

## Default answer set when you create knowledge base
...
## Change Knowledge base default answer in QnA Maker portal

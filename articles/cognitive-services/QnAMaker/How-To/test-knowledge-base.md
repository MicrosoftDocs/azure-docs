...
You can test the published version of knowledge base in test pane. Once you have published the KB, uncheck the "Test" box and send a query to get results from the published KB.

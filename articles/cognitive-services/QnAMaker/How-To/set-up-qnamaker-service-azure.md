...
1. Link the new Azure search resource to the Custom question answering feature in the [features tab of the Text Analytics resource](./configure-qna-maker-resources.md?tabs=v2#configure-qna-maker-managed-preview-service-to-use-different-cognitive-search-resource) .

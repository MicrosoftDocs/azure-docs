...
* If you enable enable multiple languages for the knowledge base, then instead of having one test index for the service you will have one test index per knowledge base. 

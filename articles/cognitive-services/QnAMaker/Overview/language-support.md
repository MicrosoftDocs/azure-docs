...
This functionality is not supported in our current Generally Available (GA) stable release. Check out question answering(https://docs.microsoft.com/en-us/azure/cognitive-services/language-service/question-answering/overview) to test out this functionality. 

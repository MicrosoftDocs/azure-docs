...
## Use the API asynchronously with the Batch Analysis operation
...
You can also use the Batch Analysis operation to detect PII and key phrase extraction. See the [Batch Analysis sample](https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/textanalytics/azure-ai-textanalytics/samples/sample_analyze_batch_actions.py) on GitHub.

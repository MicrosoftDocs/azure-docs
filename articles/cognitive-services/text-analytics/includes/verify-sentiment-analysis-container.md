...
1. Open a new browser tab and use the IP address -- for example, `http://<IP-address>:5000 (http://55.55.55.55:5000`). The container's home page is displayed, letting you know the container is running.

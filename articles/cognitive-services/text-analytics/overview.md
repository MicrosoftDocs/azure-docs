...
| Maximum number of documents in a request | Up to 1,000 documents ([varies for each feature](https://docs.microsoft.com/en-us/azure/cognitive-services/text-analytics/concepts/data-limits?tabs=version-3)) |

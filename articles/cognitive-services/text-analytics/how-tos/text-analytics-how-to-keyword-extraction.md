...
For more information, see [Supported languages](../text-analytics-supported-languages.md).
...
+ Set the HTTP endpoint for key phrase extraction by using either a Text Analytics resource on Azure or an instantiated [Text Analytics container](text-analytics-how-to-install-containers.md). You must include `/text/analytics/v2.1/keyPhrases` in the URL. For example: `https://your-resource-endpoint.api.cognitive.microsoft.com/text/analytics/v2.1/keyPhrases`.

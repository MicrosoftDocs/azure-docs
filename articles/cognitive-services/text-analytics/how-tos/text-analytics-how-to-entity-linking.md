...
+ Set the HTTP endpoint for entity extraction. You must include `/text/analytics/v2.1/entities` in the endpoint. For example: `https://your-resource-endpoint.api.cognitive.microsoft.com/text/analytics/v2.1/entities`.

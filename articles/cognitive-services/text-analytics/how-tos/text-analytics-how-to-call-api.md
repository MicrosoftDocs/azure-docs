...
2.	Select the region you want to use for your endpoint.  Please note the `/analyze` and `/health` endpoints are only availabe in the `West US 2`, `East US 2`, `Central US`, `North Europe` and `West Europe` regions.

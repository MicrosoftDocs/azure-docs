...
* Endpoints that return and offset value now support the optional parameter `stringIndexType` to adjust the returned offset and length values to match a supported [string index scheme](concepts/text-offsets.md)

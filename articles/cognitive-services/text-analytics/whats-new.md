...
It supports English, French, Italian, Japanese, Simplified-Chinese, Traditional-Chinese, German, Dutch, Portuguese (Portugal) and Spanish, and is available in the following regions: `Australia East`, `Central Canada`, `Central US`, `East Asia`, `East US`, `East US 2`, `North Europe`, `Southeast Asia`, `South Central US`, `UK South`, `West Europe`, and `West US 2`.

...
|-------------|-------|---|
|{BILLING_KEY} | The endpoint key of the `Cognitive Services` resource available on the Azure portal's Text Analytics Keys page. |xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx|

...
> [!NOTE]
> Power BI can use data from a wide variety of sources, such as Facebook or a SQL database. Learn more at [Facebook integration with Power BI](https://www.cdata.com/drivers/facebook/powerbi/) and [SQL Server integration with Power BI](https://powerbi.microsoft.com/integrations/sql-server/).

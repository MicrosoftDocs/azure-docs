...
1. Replace the location in `client.BaseUri` to the endpoint you signed up for. You can find the endpoint on Azure Portal resource. The endpoint typically looks like "https://*.api.cognitive.microsoft.com/text/analytics/v2.0".
1. Run the program.

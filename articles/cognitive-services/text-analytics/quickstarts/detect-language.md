---
title: "Quickstart: Text Analytics client library for Detecting language | Microsoft Docs"
titleSuffix: Azure Cognitive Services
description: In this quickstart, detect language by using the Text Analytics REST API from Azure Cognitive Services.
...
[!INCLUDE [C# quickstart](../includes/quickstarts/detect-language-csharp.md)]

::: zone-end

::: zone pivot="programming-language-python"

[!INCLUDE [Python quickstart](../includes/quickstarts/detect-language-python.md)]

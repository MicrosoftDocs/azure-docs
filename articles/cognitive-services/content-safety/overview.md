...
Content Safety Studio not only contains the out-of-the-box AI models, but also uses Microsoft's built-in terms lists to flag profanities and stay up to date with new trends. You can also upload your own custom lists to enhance the coverage of harmful content that's specific to your industry. 

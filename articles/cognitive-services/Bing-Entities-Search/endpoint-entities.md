...
```
This returns entities that are relevant to the users search query defined by `?q=""`.
...
##Response JSON
The response to a entity search request includes results as JSON objects. For examples of the results, see [Get started](https://docs.microsoft.com/en-us/azure/cognitive-services/bing-entities-search/quick-start).
...
For examples using the Entity search API, see [Get started](https://docs.microsoft.com/en-us/azure/cognitive-services/bing-entities-search/quick-start) and [Resizing and cropping thumbnail images](https://docs.microsoft.com/en-us/azure/cognitive-services/bing-entities-search/resize-and-crop-thumbnails).
...
# Tutorial: Breaking down Bing Visual Search upload
...
With the image and the subscription key in hand, you can make the call to Bing Visual Search to get insights about the image. The call would use the default market and safe search values (en-us and moderate, respectively).

This demo provides the user the option to change these values. Add the following \<div\> below the subscription key div. The demo uses a \<select\> tag to provide a drop-down list for market and safe search values. Both lists display Bing's default value.
...
Here's the complete HTML and JavaScript example.

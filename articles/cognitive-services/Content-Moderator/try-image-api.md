---
title: Test drive the Image API in Azure Content Moderator | Microsoft Docs
description: Use image moderation from the online console
...
# Image moderation from the online console

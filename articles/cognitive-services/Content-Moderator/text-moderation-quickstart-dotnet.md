...
1. Get the required NuGet package. Right-click on your project in the Solution Explorer and select **Manage NuGet Packages**; then find and install the **`Microsoft.Azure.CognitiveServices.ContentModerator` package**. Alternatively, you can run the following command from the solution directory:

...
If you sign up for the review tool, you will find your free tier key in the **Credentials** TAB under **Settings**  as shown below.
...
Use the review API to initiate end-to-end (scan and review) moderation workflows with both image and text content. The moderation job will scan your content by using the image and text moderation APIs and then use the default or custom workflows defined within the review tool to generate reviews for more nuanced cases, within the review tool. Once your human moderators have reviewed the auto-assigned tags and prediction data and submitted their final decision, the review API will submit all information to your API endpoint.
...
Use this API to create, update, and get details of your custom workflows created by your team. You or your team colleagues will define these workflows in the review tool. These workflows can use Content Moderator or even other APIs available as connectors within the review tool.
...
Use this API to create and manage your custom exclusion or inclusion lists of images and text. If enabled, the **Image/Match** and **Text/Screen** operations will do a fuzzy match of the submitted content against your custom lists and skip the ML-based moderation step for efficiency.

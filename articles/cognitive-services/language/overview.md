...
> | [Text Summarization](text-summarization/overview.md)     | This pre-configured feature extracts key sentences that collectively convey the essence of a document. | <ul><li>[**Language Studio**](language-studio.md) <br> • [**REST API and client-library**](text-summarization/quickstart.md) |

...
> * Go to the Azure portal and find the key and endpoint for the Language Services resource you created in the prerequisites. They will be located on the resource's **key and endpoint** page, under **resource management**. Then replace the strings in the code below with your key and endpoint.
To call the Language Services API, you need the following information:

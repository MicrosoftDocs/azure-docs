...
* **Single label classification** - you can assign a single class for each file of your dataset. For example, if a file is a movie script, it could only classified as "Action", "Thriller" or "Romance". 

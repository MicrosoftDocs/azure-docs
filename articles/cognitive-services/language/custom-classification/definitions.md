...
As a prerequisite to creating a Custom entity extraction project, you have to [connect your resource to a storage account](concepts/use-azure-resources.md).

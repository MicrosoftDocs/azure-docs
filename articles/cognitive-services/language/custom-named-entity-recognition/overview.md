...
Language services offers a prebuilt [Named Entity Recognition API](../named-entity-recognition/overview.md) for common named entity types, but custom NER lets you extract specific entities that are more relevant to your needs. 
...
4. **View the model evaluation details**: After training is completed, view model evaluation details and review model performance.

...
## [Supported Markets of `/news/search` Endpoint][#news-search-mkts]
...
## <a id="news-markets"></a>Supported Markets of `/news` Endpoint ## [Supported Markets of `/news` Endpoint][#news-mkts]
...
## [Supported Markets of `/news/trending` Endpoint][#news-trending-mkts]

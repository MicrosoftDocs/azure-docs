...
```
**Request(…)**
<!-- Could you explain what Request(...) mean in this contenxt -->
Below code snippet shows how HttpClient submit your subscription key and data points to the endpoint of the Anomaly Detection API.

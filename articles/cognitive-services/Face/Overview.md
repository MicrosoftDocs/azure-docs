...
Face API can be used to identify people based on a detected face and people database (defined as a LargePersonGroup/PersonGroup) which needs to be created in advance and can be edited over time.
...
For more details about person identification, please refer to the API guides listed as following:

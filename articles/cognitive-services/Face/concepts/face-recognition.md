...
This article explains the concepts of the verification, find similar, grouping, and identification face recognition operations and the underlying data structures. Broadly, recognition describes the work of comparing two different faces to determine if they're similar or belong to the same person.
...
This section details how the four recognition operations use the data structures previously described. See [Overview](../Overview.md) for a broad description of each recognition operation.

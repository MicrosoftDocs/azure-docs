...
* Some input images with JPEG format might contain orientation information in Exchangeable image file format (Exif) metadata. These images will be automatically rotated based on the Exif orientation.

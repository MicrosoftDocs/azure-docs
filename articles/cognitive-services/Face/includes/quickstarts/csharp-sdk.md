...
> [!TIP]
> You can also create a **PersonGroup** from local images. See the [IPersonGroupPerson](https://docs.microsoft.com/en-us/dotnet/api/microsoft.azure.cognitiveservices.vision.face.ipersongroupperson?view=azure-dotnet) methods such as **AddFaceFromStreamAsync**.

...
**Guidance**: Microsoft maintains the time source used for Azure resources such as Cognitive Services for timestamps in the logs.
...
**Guidance**: Not applicable to Cognitive Services. This recommendation is intended for compute resources.
...
**Guidance**: Not applicable to Cognitive Services. It does not process or produce anti-malware related logs.
...
**Guidance**: Not applicable to Cognitive Services. It does not process or produce DNS-related logs.
...
**Guidance**: Microsoft performs vulnerability management on the underlying systems that support Cognitive Services.
...
**Guidance**: Not applicable to Cognitive Services. This recommendation is intended for web applications running on Azure App Service or compute resources.
...
Microsoft anti-malware is enabled on the underlying host that supports Azure services (for example, Cognitive Services), however it does not run on customer content.

...
The Personalizer client is a [PersonalizerClient](https://docs.microsoft.com/en-us/javascript/api/@azure/cognitiveservices-personalizer/personalizerclient) object that authenticates to Azure using Microsoft.Rest.ServiceClientCredentials, which contains your key.

To ask for the single best item of the content, create a [RankRequest](https://docs.microsoft.com/en-us/javascript/api/@azure/cognitiveservices-personalizer/rankrequest), then pass it to [client.Rank](https://docs.microsoft.com/en-us/javascript/api/@azure/cognitiveservices-personalizer/personalizerclient?view=azure-node-latest#rank-rankrequest--msrest-requestoptionsbase-) method. The Rank method returns a RankResponse.

To send a reward to Personalizer, create a [RewardRequest](https://docs.microsoft.com/en-us/javascript/api/@azure/cognitiveservices-personalizer/rewardrequest), then pass it to the [Reward](https://docs.microsoft.com/en-us/javascript/api/@azure/cognitiveservices-personalizer/events?view=azure-node-latest#reward-string--rewardrequest--servicecallback-void--) method on the Events class.

...
Azure Personalizer is a cloud-based API service that allows your application to choose the best experience to show to your users, learning from their real-time behavior.

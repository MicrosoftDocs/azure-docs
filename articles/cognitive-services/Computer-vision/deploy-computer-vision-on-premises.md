...
In v3 container, the liveness probe API is exposed under `/ContainerLiveness` path. A practice of configuring liveness probe for Kubernetes is included in the following deployment example.

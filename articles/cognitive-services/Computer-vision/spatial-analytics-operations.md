...
Spatial Analytics enables the analysis of real-time streaming video from camera devices. For each camera device you configure, the operations for spatial analysis will generate an output stream of JSON messages sent to your instance of Azure IoT Hub. 

The Spatial Analytics container implements the following operations:
...
See the [camera placement](spatial-analytics-camera-placement.md)  guidelines to learn about zone and line configurations.
...
## How to consume output generated by Spatial Analytics container

You may want to consume the detections or events generated by the Spatial Analytics container by integrating these into your application or solution. Here are a few approaches you can investigate to get started: 

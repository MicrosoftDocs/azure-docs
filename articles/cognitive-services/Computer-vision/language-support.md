...
Computer Vision can recognize text in many languages. The Read and OCR APIs do not require you to specify a language code. See [Read text from images and documents](concept-recognizing-text.md) for more information on this functionality and the advantages of each API.

...
## <a name="Tagging"></a>Tagging Images 
...
``` 
## <a name="Categorizing"></a>Categorizing Images
...
## <a name="Identifying"></a>Identifying Image Types 
...
## <a name="Domain-Specific"></a>Domain-Specific Content 
...
## <a name="Descriptions"></a> Generating Descriptions  
...
## <a name="Color"></a>Perceiving Color Schemes 
...
## <a name="Adult"></a>Flagging Adult Content 
...
## <a name="OCR"></a>Optical Character Recognition (OCR) 
...
## <a name="Thumbnails"></a>Generating Thumbnails 

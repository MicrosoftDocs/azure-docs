...
You can also use the [optical character recognition (OCR) API](concept-recognizing-text.md#ocr-optical-character-recognition-api) to extract printed text in several languages. If needed, OCR corrects the rotation of the recognized text and provides the frame coordinates of each word. OCR supports 25 languages and automatically detects the language of the recognized text.

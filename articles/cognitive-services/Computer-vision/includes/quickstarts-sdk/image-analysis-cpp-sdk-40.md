...
[Reference documentation](/cpp/api/azure.ai.vision.imageanalysis) | [Library source code](tbd) | Packages (NuGet): [Core](https://www.nuget.org/packages/Azure.AI.Vision.Core/0.8.1-beta.1) [ImageAnalysis](https://www.nuget.org/packages/Azure.AI.Vision.ImageAnalysis/0.8.1-beta.1) | [Samples](tbd)

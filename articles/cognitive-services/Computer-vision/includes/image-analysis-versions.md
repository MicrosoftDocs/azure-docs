...
>
> You'll also need to use version 3.2 if you want to do image captioning and your Azure Computer Vision resource is outside these Azure regions: East US, France Central, Korea Central, North Europe, Southeast Asia, West Europe, West US, East Asia. The image captioning feature in Image Analysis 4.0 is only supported in these Azure regions. Image captioning in version 3.2 is available in all Computer Vision regions.

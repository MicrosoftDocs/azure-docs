---
title: "Quickstart: OCR with the Computer Vision 3.0 REST API Read Operations - Extract printed and handwritten using C#"
...
ms.custom: seodec18
---
# Quickstart: OCR for printed and handwritten text using the Computer Vision 3.0 REST API Read operations and C#

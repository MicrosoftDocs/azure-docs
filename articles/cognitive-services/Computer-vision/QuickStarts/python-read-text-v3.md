---
title: "Quickstart: Computer Vision 3.0 Preview - Extract printed and handwritten text - REST, Python"
...
ms.custom: seodec18
---
# Quickstart: Extract printed and handwritten text using the Computer Vision REST 3.0 API and Python

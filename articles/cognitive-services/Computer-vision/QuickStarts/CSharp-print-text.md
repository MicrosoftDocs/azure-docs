---
title: "Quickstart: Extract text using the Computer Vision 2.0 OCR REST API and C#"
...
ms.custom: seodec18
---
# Quickstart: Extract text using the Computer Vision 2.0 OCR REST API and C#

...
1. Follow the instructions in [Create an Azure Cognitive Services resource](../../cognitive-services-apis-create-account#single-service-resource) to create a Computer Vision resource.

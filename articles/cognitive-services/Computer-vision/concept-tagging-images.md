...
The tagging feature is part of the [Analyze Image](TBD) API. You can call this API using REST. Include `Tags` in the **Features** query parameter. Then, when you get the full JSON response, parse the string for the contents of the `"tags"` section.

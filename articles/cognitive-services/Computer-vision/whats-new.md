...
### Read API v3.2 Public Preview adds OCR for Japanese
Computer Vision's Read API v3.2 public preview adds these capabilities:
...
> [Learn more about Read API v3.2 Public Preview 2](https://westus2.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-1-preview-2/operations/5d986960601faab4bf452005)

## July 2020

### Read API v3.2 Public Preview with OCR for Simplified Chinese
Computer Vision's Read API v3.2 public preview adds support for Simplified Chinese.
...
> [!div class="nextstepaction"]
> [Learn more about Read API v3.2 Public Preview 1](https://westus.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-1-preview-1/operations/5d986960601faab4bf452005)

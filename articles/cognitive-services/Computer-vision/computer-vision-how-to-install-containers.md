...
|-----------|------------|
| Read | `containerpreview.azurecr.io/microsoft/cognitive-services-read:2.0.013250001-amd64-preview` |
...
```bash
docker pull containerpreview.azurecr.io/microsoft/cognitive-services-read:2.0.013250001-amd64-preview
```

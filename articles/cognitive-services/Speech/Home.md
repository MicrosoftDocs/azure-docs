...
- Supports optimized speech recognition results for **interactive**, **conversation**, and **dictation scenarios**. For user scenarios which require customized language models and acoustic models, [Custom Speech Service](../custom-speech-service/cognitive-services-custom-speech-home) allows you to create speech models that tailored to your application and your users.

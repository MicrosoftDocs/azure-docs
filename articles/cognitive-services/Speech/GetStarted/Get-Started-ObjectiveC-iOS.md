...
If you want to use *Recognition with intent*, you also need to sign up [Language Understanding Intelligent Service (LUIS)](../language-understanding-intelligent-service/).

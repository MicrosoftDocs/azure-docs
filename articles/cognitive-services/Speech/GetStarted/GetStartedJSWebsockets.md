...
To get started with the speech recognition API in JavaScript, we created a working HTML/JS sample ready for you to try. The following steps show you how to get the source code and how to run the sample.

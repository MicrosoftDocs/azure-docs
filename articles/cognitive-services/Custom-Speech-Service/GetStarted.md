...
* 	[Create an acoustic model](#Create)
* 	[Create a language Model](#Create2)
* 	[Create a custom speech endpoint](#Create3)
* 	[Using a custom speech endpoint](#Using)   
...
You can find a detailed description on how to create a custom acoustic model [here](./CustomSpeech-How-to-Topics/HowToCreateAnAcousticModel.md).
...
You can find a detailed description on how to create a custom language model [here](./CustomSpeech-How-to-Topics/HowToCreateALanguageModel.md).
...
You can find a detailed description on how to use a custom speech-to-text endpoint [here](./CustomSpeech-How-to-Topics/HowToUseACustomEndpoint.md).

...
---
<div class="content">
    <h1>Custom Speech Service Documentation</h1>
    <div class="introHolder" style="justify-content: space-between;">
        <div class="intro" style="min-width: 200px">
            <p>Learn how to use Microsoft's custom speech service to customize speech models for Speech-to-Text transcription.</p>
        </div>
        <a href="#">

...
|[Translator Text][tt-containers]|F0, S| **Translator Text** | Translator Text is a cloud-based machine translation service you can use to translate text in near real-time through a simple REST API call. [Request access](https://aka.ms/translatorcontainerform) |

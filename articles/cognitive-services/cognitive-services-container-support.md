...
|---------|----------|----------|-------------|
|[Anomaly detector](anomaly-detector/anomaly-detector-container-howto.md) |F0, S0|**Anomaly-Detector** |The Anomaly Detector API enables you to monitor and detect abnormalities in your time series data with machine learning.<br>[Request access](https://aka.ms/adcontainer)|
...
|[Speech Service API](speech-service/speech-container-howto.md) |F0, S0|**Speech-to-text** |Transcribes continuous real-time speech into text.<br>[Request access](https://aka.ms/speechcontainerspreview/)|
|[Speech Service API](speech-service/speech-container-howto.md) |F0, S0|**Text-to-speech** |Converts text to natural-sounding speech.<br>[Request access](https://aka.ms/speechcontainerspreview/)|

...
| [Text Analytics][ta-containers-sentiment] | F0, S | **Sentiment Analysis v2** ([image](https://go.microsoft.com/fwlink/?linkid=2018654&clcid=0x409)) | Analyzes raw text for clues about positive or negative sentiment. This version of sentiment analysis returns a sentiment score between 0 and 1 for each document, where 1 is the most positive. |
| [Text Analytics][ta-containers-sentiment] | F0, S | **Sentiment Analysis v3** ([image](https://go.microsoft.com/fwlink/?linkid=2018654&clcid=0x409)) | Analyzes raw text for clues about positive or negative sentiment. This version of sentiment analysis returns [sentiment labels](text-analytics/how-tos/text-analytics-how-to-sentiment-analysis.md) (for example *positive* or *negative*) for each document and sentences within it. |

...
- **Automatic language detection**: Video Indexer can automatically detect the language of the video, auto language detection currently support English, Spanish, French, German, Italian, Chinese (Simplified), Japanese, Russian. Will fallback to English when the language can't be detected.

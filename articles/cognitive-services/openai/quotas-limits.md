...
| Requests per minute per model* | Davinci-models (002 and later) including `gpt-3.5`: 120  <br> All other models: 300 |
| Tokens per minute per model* | Davinci-models (002 and later) including `gpt-3.5`: 40,000  <br> All other models: 120,000 |

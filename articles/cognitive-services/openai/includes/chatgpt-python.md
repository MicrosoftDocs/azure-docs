...
- An Azure OpenAI Service resource with the `text-chat-davinci-002` model deployed. This model is currently available in East US and `TODO: Enter other regions if available`. For more information about model deployment, see the [resource deployment guide](../how-to/create-resource.md).

...
- **GPT-4 series models are now available in limited preview on Azure OpenAI**. To request access, existing Azure OpenAI customers can [apply by filling out this form](https://aka.ms/oai/get-gpt4). These models are currently available in East US and South Central US regions.
...
- **ChatGPT (gpt-35-turbo) public preview**. To learn more checkout the [how-to article](./how-to/chatgpt.md).

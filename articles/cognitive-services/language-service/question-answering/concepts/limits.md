...
If you choose to have multiple language KBs in one service, there is a dedicated test index per KB. So the limit is applied per KB in the Language service.

|**Azure Cognitive Search tier** | **Free** | **Basic** |**S1** | **S2**| **S3** |**S3 HD**|
|---|---|---|---|---|---|----|
|Maximum metadata fields per Language service (per KB)|1,000|100*|1,000|1,000|1,000|1,000|

If you don't choose the option to have KBs in multiple langauges, then the limits are applied across all KBs in the Language service.

|**Azure Cognitive Search tier** | **Free** | **Basic** |**S1** | **S2**| **S3** |**S3 HD**|
|---|---|---|---|---|---|----|
|Maximum metadata fields per Language service (across all KBs)|1,000|100*|1,000|1,000|1,000|1,000|

...
* **The throughput you need**:
    * Question answering is a free feature, and the throughput is currently capped at 10 text records per second for both management APIs and prediction APIs.
...
Custom question answering is a free feature, and the throughput is currently capped at 10 text records per second for both management APIs and prediction APIs. To target 10 text records per second for your service, we recommend the S1 (one instance) SKU of Azure Cognitive Search.

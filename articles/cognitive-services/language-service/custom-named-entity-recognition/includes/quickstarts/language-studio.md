...
The provided sample dataset contains 20 loan agreements, each agrement is two parties a Lender and a Borrower. You can use the provided samle tags file to extract relevant information for oth parties, agreement date, loan amount and interest rate.

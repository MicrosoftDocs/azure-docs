...
1. Use the following link to [create a language resource](https://portal.azure.com/#create/Microsoft.CognitiveServicesTextAnalytics?azure-portal=true) using the Azure portal. You will need to sign in using your Azure subscription.

...
| Feature | Value |
|------------------------|---------------|
| Conversation narrative summarization with chaptering, custom conversation summarization and document summarization| 125,000 characters as measured by [StringInfo.LengthInTextElements](/dotnet/api/system.globalization.stringinfo.lengthintextelements).|

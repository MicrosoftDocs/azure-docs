...
* For each document, you can view: labeled text, its respective labeled class and what class it was predicted with. You can also see whether it is a [true positive](../../concepts/evaluation-metrics.md), [false positive](../../concepts/evaluation-metrics.md) or [false negative](../../concepts/evaluation-metrics.md). 
...
*Documents with at least one label*: This view will show the the number of occurrences for this class across the training and testing sets for each sentiment.
...
A [confusion matrix](../../concepts/evaluation-metrics.md#confusion-matrix) is an N x N matrix used for evaluating the performance of a model, where N is the number of target sentiments. The matrix compares the actual target values with those predicted by the machine learning model to show how well the extraction model is performing and what kinds of errors it is making.
...
* All values: Will show the confusion matrix for all sentiments.

* Only errors: Will show the confusion matrix for sentiments with errors only.

* Only matches: Will show the confusion matrix for sentiments with correct predictions only.

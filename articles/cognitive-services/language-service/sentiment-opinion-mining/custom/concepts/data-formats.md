...
Your Labels file should be in the `json` format below. This will enable you to [import](../how-to/create-project.md#import-a-custom-sentiment-analysis-project) your labels into a project.
...
| dataset | `{DATASET}` |  The test set whether this file will be added to the training or testing set. See [How to train a model](../how-to/train-model.md#data-splitting) for more information. Possible values for this field are `Train` and `Test`.      |`Train`|

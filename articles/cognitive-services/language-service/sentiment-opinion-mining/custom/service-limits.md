---
title: Custom sentiment analysis service limits
titleSuffix: Azure Cognitive Services
description: Learn about the data and service limits when using Custom sentiment analysis.
...
ms.date: 05/06/2022
ms.author: aahi
ms.custom: language-service-sentiment-opinion-mining, references_regions
---

# Custom sentiment analysis service limits

Use this article to learn about the data and service limits when using Custom sentiment analysis.
...
The following limits are observed for the Custom sentiment analysis.
...
* [Custom sentiment analysis overview](../overview.md)

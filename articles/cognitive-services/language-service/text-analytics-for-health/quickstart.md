...
> [!IMPORTANT]
> Fast Healthcare Interoperability Resources (FHIR) structuring is available for preview using the Language REST API. The client libraries are not currently supported. [Learn more](./text-analytics-for-health/how-to/call-api.md) on how to use FHIR structuring in your API call.

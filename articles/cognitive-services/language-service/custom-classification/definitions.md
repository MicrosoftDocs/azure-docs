...
As a prerequisite to creating a Custom text classification project, you have to [connect your resource to a storage account](how-to/use-azure-resources.md).

...
|---------|---------|
|Regions     | Make sure your existing resource is provisioned in one of the supported regions, learn more about [region support](../region-support.md). If you don't have a resource, you will need to create a new one in a supported region.        |

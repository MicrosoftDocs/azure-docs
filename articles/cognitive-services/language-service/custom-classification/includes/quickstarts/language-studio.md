...
5. Select your project type. For this quickstart, we will create a multi label classification project. Then click **Next**. You can learn more about project types [here](../../definitions.md#project)

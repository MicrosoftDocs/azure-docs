...
* The selected resource doesn't have proper permission for the storage account. Learn more about [required permissions](../../how-to/create-project.md#using-a-pre-existing-language-resource) for storage account.

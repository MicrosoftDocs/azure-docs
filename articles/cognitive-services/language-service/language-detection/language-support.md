...
> [!NOTE]
> Languages are added as new [model versions](how-to/call-api.md#specify-the-language-detection-model) are released. The current model version for Language Detection is `2022-10-01`. However, to detect Japanese, we recommend you use the previous version `2021-11-20`.

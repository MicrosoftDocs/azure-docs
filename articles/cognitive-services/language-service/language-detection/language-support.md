...
> [!NOTE]
> Languages are added as new [model versions](../concepts/specify-model-version.md) are released for specific Language Services features. The current model version for Language Detection is `2021-01-05`.

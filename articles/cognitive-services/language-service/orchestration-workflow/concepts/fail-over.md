...
Replicating a project means that you export your project metadata and assets and import them into a new project. This only makes a copy of your project settings, intents and utterances. You still need to [train](../how-to/train-model.md) and [deploy](../how-to/deploy-query-model.md) the models to be available for use with [runtime APIs](https://aka.ms/clu-apis).

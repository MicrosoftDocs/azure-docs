...
:::image type="content" source="../media/TrainOrchestration.png" alt-text="A screenshot showing the Train model page for Orchestration workflow projects." lightbox="../media/TrainOrchestration.png":::

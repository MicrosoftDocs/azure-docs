...
* The version 3.1-preview.x REST endpoints and 5.1.0-beta.x client library have been retired. Please upgrade to the general availability version - 3.1 (for SDKs use package version 5.1.0 or higher). See the [migration guide](https://aka.ms/ta-get-started-sdk) for details.

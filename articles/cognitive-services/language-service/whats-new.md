 ...
 * New model version (`2022-10-01`) released for Language Detection. The new model version comes with improvements in language detection quality on short texts. Additionally, with the new model on-premises customers only need 1 container instead of 2. 

 ...
 * New model version (2022-10-05) released for Language Detection. The new model version comes with improvements in short text language detection quality. Also with the new model, on-prem customers only need 1 container instead of 2. 

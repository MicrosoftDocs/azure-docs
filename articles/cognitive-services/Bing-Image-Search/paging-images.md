...
To page through the available images, use the [count](https://docs.microsoft.com/rest/api/cognitiveservices/bing-image-api-v5-reference.md#count) and [offset](https://docs.microsoft.com/rest/api/cognitiveservices/bing-image-api-v5-reference.md#offset) query parameters.  
...
To eliminate duplicate results, use the [nextOffsetAddCount](https://docs.microsoft.com/rest/api/cognitiveservices/bing-image-api-v5-reference.md#totalestimatedmatches) field of the `Images` object. The `nextOffsetAddCount` field tells you the number to add to your next `offset`.
...
>
> Renamed the `nextOffsetAddCount` field of [Images](https://docs.microsoft.com/rest/api/cognitiveservices/bing-image-api-v7-reference.md#images) to `nextOffset`. In v7, you set the `offset` query parameter to the `nextOffset` value.

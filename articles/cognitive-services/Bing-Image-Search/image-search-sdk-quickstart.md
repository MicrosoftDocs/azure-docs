---
title: "Quickstart: Search for images using the Bing Image Search SDK and C#"
description: Use this quickstart to search and find images on the web using the Bing Image Search SDK and C#.
...
# Quickstart: Search for images using the Bing Image Search SDK and C#

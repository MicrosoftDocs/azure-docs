---
title: "Quickstart: Send search queries using the REST API for the Bing Image Search API in Java"
...
ms.author: v-jerkin
---
# Quickstart: Send search queries using the REST API with Java

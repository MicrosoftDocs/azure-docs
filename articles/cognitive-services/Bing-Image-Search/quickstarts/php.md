---
title: "Quickstart: Send search queries using the REST API for the Bing Image Search API in Node.js"
...
ms.author: v-jerkin
---
# Quickstart: Send search queries using the REST API using PHP

---
title: Python Quickstart for Azure Cognitive Services, Bing Image Search API | Microsoft Docs
...
---
# Quickstart for Bing Image Search API with Python

This article shows you how to use the Bing Image Search API, part of Microsoft Cognitive Services on Azure. While this article employs Python, the API is a RESTful Web service compatible with any programming language that can make HTTP requests and parse JSON. 

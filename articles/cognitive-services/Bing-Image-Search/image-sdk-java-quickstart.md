---
title: "Quickstart: Search for images using the Bing Image Search SDK and Java"
description: Use this quickstart to search and find images on the web using the Bing Image Search SDK and Java.
...
# Quickstart: Search for images using the Bing Image Search SDK and Java
...
The source code for this sample is available [on GitHub](https://github.com/Azure-Samples/cognitive-services-java-sdk-samples/tree/master/Search/BingImageSearch) with additional error handling and annotations. 

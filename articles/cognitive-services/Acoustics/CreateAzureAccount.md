...
This article gives a step-by-step walkthrough of recommended settings for creating an Azure Batch account for use with Microsoft Acoustics. For more information about what Microsoft Acoustics is, see the [Introduction to Microsoft Acoustics](What-Is-Acoustics.md). For information about how to incorporate Microsoft Acoustics into your Unity project, see the [Getting Started guide](GettingStarted.md).  

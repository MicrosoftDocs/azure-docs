...
[!code-swift[Constants](~/ImmersiveReaderSdk/iOS/samples/picture-to-immersivereader-swift/picture-to-immersivereader-swift/Constants.swift)]

## Set up the app to run without a storyboard

Open AppDelegate.swift and replace the file with the following code.

[!code-swift[AppDelegate](~/ImmersiveReaderSdk/iOS/samples/picture-to-immersivereader-swift/picture-to-immersivereader-swift/AppDelegate.swift)]
...
[!code-swift[PictureLaunchViewController](~/ImmersiveReaderSdk/iOS/samples/picture-to-immersivereader-swift/picture-to-immersivereader-swift/PictureLaunchViewController.swift)]

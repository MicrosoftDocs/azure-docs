...
Replace `YOUR_SUBSCRIPTION_KEY` with your subscription key, and replace `YOUR_ENDPOINT` with your endpoint. This API endpoint should be secured behind some form of authentication; that work is beyond the scope of this tutorial.

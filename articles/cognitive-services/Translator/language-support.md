...
**Dictionary:** Use the [Dictionary Lookup](v3-0-dictionary-lookup.md) or [Dictionary Examples](v3-0-dictionary-examples.md) operations from the Text Translation feature to display alternative translations from or to English and examples of words in context.
...
* [Text Analytics ](../cognitive-services/text-analytics/language-support.md) 

View all [Cognitive Services](../cognitive-services). 

...
Next, we're going to create a class that's used when deserializing the JSON response returned by the Translator API.

```csharp
/// <summary>
/// The C# classes that represents the JSON returned by the Translator API.
/// </summary>

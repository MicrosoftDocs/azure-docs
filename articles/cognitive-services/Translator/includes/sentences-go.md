...
Let's create a function to determine sentence length. This function will take a single argument, your Translator API subscription key.
...
>[!NOTE]
> For more information about endpoints, routes, and request parameters, see [Translator API 3.0: BreakSentence](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-break-sentence).

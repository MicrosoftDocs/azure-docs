...
func main() {
    ...
    */
     ...
     * the key.
     */
    breakSentence(key, uri)
}
```

## Create a function to determine sentence length

Let's create a function to determine sentence length. This function will take a single argument, your Translator key.

```go
func breakSentence(key string, uri string)
    /*  

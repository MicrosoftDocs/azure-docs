...
Next, we're going to create a set of classes that are used when deserializing the JSON response returned by the Translator API.
...
// Async call to the Translator API

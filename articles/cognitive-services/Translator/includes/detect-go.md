...
Let's create a function to detect the text language. This function will take a single argument, your Translator API subscription key.
...
>[!NOTE]
> For more information about endpoints, routes, and request parameters, see [Translator API 3.0: Detect](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-detect).

...
The Translator API global endpoint is set as the `endpoint`. `path` sets the `breaksentence` route and identifies that we want to hit version 3 of the API.
...
>[!NOTE]
> For more information about endpoints, routes, and request parameters, see [Translator API 3.0: Languages](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-break-sentence).

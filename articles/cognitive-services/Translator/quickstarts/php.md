...
function TranslateArray ($host, $path, $key, $params, $content) {
...
$result = TranslateArray ($host, $path, $key, $params, $content);
...
function GetLanguagesForTranslate ($host, $path, $key, $params) {
...
$result = GetLanguagesForTranslate ($host, $path, $key, $params);
...
function Detect ($host, $path, $key, $params) {
...
$result = Detect ($host, $path, $key, $params);
echo $result;
?>
```
...
function AddTranslation ($host, $path, $key, $params) {
...
$result = AddTranslation ($host, $path, $key, $params);
echo $result;
?>
```
...
function BreakSentences ($host, $path, $key, $params) {
...
$result = BreakSentences ($host, $path, $key, $params);
echo $result;
?>
```

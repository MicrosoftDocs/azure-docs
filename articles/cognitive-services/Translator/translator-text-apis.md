...
|**Ocp-Apim-Subscription-Region**|The region where your resource was created. |<ul><li>***Required*** when using a multi-service Cognitive Services Resource or regional Translator resource.</li><li> ***Optional*** when using a global Translator Resource.</li></ul>|

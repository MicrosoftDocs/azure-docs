---
title: Dynamic Dictionary - Translator API
titleSuffix: Azure Cognitive Services
description: This article explains how to use the dynamic dictionary feature of the Azure Cognitive Services Translator API.

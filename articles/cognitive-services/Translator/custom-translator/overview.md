...
If the appropriate type and amount of training data is supplied, it's not uncommon to see [BLEU score](https://aka.ms/customtranslatorplaceholder) gains between 5 and 10 points by using Custom Translator.

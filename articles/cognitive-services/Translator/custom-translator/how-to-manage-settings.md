...
You need to have a Microsoft Translator API subscription key associated with your workspace to train or deploy models.

If you don’t have a subscription, follow the steps below:

1. Subscribe to the Microsoft Translator API. This article shows how to subscribe for the Microsoft Translator API.

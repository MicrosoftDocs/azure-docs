...
- You can train a model using only dictionary data. Please refer to https://docs.microsoft.com/en-us/azure/cognitive-services/translator/custom-translator/what-is-dictionary.

...
For dictionaries, Custom Translator supports all file formats that are supported for training sets. If you are using an Excel dictionary, please make sure the first line/ row of the spreadsheet contains be language codes.

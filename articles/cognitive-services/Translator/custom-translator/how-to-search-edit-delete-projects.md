...
You can delete a project when you no longer need it. Make sue the project doesn't have models in active state such as deployed, training submitted, data processing, deploying, etc., otherwise, the delete operation would fail. Below steps describe how to delete a project.

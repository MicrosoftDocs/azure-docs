...
The `params` are used to set the input and output scripts. In this sample we're transliterating from Japanese to the Latin alphabet: `jpan` and `latn` respectively.

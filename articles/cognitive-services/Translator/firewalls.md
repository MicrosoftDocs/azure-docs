...
Translator can translate behind firewalls using either domain-name or IP filtering. Domain-name filtering is the preferred method. If you still require IP filtering we suggest you to get the [IP addresses details using service tag](../../virtual-network/service-tags-overview#service-tags-on-premises.md). Translator is under the “CognitiveServicesManagement” service tag. 

---
title: Migrate to V3 - Translator API
titleSuffix: Azure Cognitive Services
description: This article provides the steps to help you migrate from V2 to V3 of the Azure Cognitive Services Translator API.
...
# Translator API V2 to V3 Migration
...
The Microsoft Translator team has released Version 3 (V3) of the Translator API. This release includes new features, deprecated methods and a new format for sending to, and receiving data from the Microsoft Translator Service. This document provides information for changing applications to use V3. 
...
|:-----|:-----|:-----|:-----|:-----|
|Translator API Version 2|	api.microsofttranslator.com|	No	|Yes	|No|
|Translator API Version 3|	api.cognitive.microsofttranslator.com|	Yes|	No|	Yes|

**Translator API Version 3**
...
You are using Version 3 of the Translator API If you are using the api.cognitive.microsofttranslator.com endpoint.

**Translator API Version 2**
...
* You are using Version 2 of the Translator API If you are using the api.microsofttranslator.com endpoint.

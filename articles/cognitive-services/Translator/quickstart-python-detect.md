---
title: "Quickstart: Identify language from text, Python - Translator Text API"
...
ms.author: erhopf
---
# Quickstart: Identify language from text with the Translator Text REST API (Python)

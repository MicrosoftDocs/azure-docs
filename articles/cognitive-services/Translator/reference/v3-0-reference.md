...
|Ocp-Apim-Subscription-Region| The value is the region of the multi-service **translator resource**.</br><ul><li> This value is optional when using a single-service translator resource.</li></ul>|

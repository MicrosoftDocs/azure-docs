...
|Ocp-Apim-Subscription-Region| The value is the region of the multi-service or regional **translator resource**.</br><ul><li> This value is optional when using a global translator resource.</li></ul>|
|Ocp-Apim-ResourceId| The value is the the Resource ID file path for your Translator resource instance.</br><ul><li>You'll find the Resource ID in the Azure portal at **Translator Resource  → Properties**. </li><li>Resource ID file path components: </br>/subscriptions/<**subscriptionId**>/resourceGroups/<**resourceGroupName**>/providers/Microsoft.CognitiveServices/accounts/<**resourceName**>/</li></ul>|

---
title: Translator API Detect Method
titleSuffix: Azure Cognitive Services
description: Identify the language of a piece of text with the Azure Cognitive Services Translator API Detect method.

...
# Text Translation REST API reference guide
...
| Request| Description|
|---------|--------------|
| [**Languages**](v3-0-langauges.md)| This method returns the set of languages currently supported by the **translation**, **transliteration**, and **dictionary** methods. This request does not require authentication headers and you do not need a Translator resource to view the supported language set.|
|[**Translate**](v3-0-translate.md)|This translates text into the target language specified in the request..|

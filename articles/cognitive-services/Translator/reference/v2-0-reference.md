---
title: Translator API v2.0
titleSuffix: Azure Cognitive Services
description: Reference documentation for the Translator API v2.0.
...
> [!IMPORTANT]
> This version of the Translator API has been deprecated. [View documentation for version 3 of the Translator API](v3-0-reference.md).

Version 2 of the Translator API can be seamlessly integrated into your apps, websites, tools, or other solutions to provide multilanguage user experiences. You can use it on any hardware platform and with any operating system to perform language translation and other language-related tasks, like text-language detection and text to speech, according to industry standards. For more information, see [Translator API](../translator-info-overview.md).

## Getting started
To access the Translator API, you need to [sign up for Microsoft Azure](../translator-text-how-to-signup.md).

## Authentication 
All calls to the Translator API require a subscription key for authentication. The API supports three methods of authentication:
...
- A subscription key used directly. Pass your subscription key as a value in the `Ocp-Apim-Subscription-Key` header included with your request to the Translator API. When you use the subscription key directly, you don't have to call the token authentication service to create an access token.
...
> [Migrate to Translator API v3](../migrate-to-v3.md)

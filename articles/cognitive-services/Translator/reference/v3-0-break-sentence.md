---
title: Translator API BreakSentence Method
titleSuffix: Azure Cognitive Services
description: The Translator API BreakSentence method identifies the positioning of sentence boundaries in a piece of text.
...
# Translator API 3.0: BreakSentence

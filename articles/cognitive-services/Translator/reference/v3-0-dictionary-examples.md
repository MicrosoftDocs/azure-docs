---
title: Translator API Dictionary Examples Method
titleSuffix: Azure Cognitive Services
description: The Translator API Dictionary Examples method provides examples that show how terms in the dictionary are used in context.
...
# Translator API 3.0: Dictionary Examples

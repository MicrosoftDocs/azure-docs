---
title: Translator API Languages Method
titleSuffix: Azure Cognitive Services
description: The Languages method gets the set of languages currently supported by other operations of the Translator API.
...
# Translator API 3.0: Languages

Gets the set of languages currently supported by other operations of the Translator API. 

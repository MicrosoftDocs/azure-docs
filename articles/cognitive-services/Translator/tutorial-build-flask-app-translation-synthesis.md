---
title: "Tutorial: Build a Flask app to translate, synthesize, and analyze text - Translator API"
...
> * Create a Flask app
> * Use the Translator API to translate text
...
* Write some Python to call the Translator API and return a response
...
2. Next, add this code to `translate.py`. This function takes two arguments: `text_input` and `language_output`.
   ...
   ```
3. Add your Translator API subscription key and save.
...
* [Translator API reference](https://docs.microsoft.com/azure/cognitive-services/Translator/reference/v3-0-reference)

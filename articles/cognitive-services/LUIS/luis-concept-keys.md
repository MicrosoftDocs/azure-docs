...
When the Azure resource creation process is finished, [assign the key](luis-how-to-azure-subscription.md#assign-endpoint-key) to the app. 
...
* Learn [concepts](luis-how-to-azure-subscription.md#assign-endpoint-key) about authoring and endpoint keys.
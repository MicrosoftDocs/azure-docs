...
After your app gets endpoint utterances, plan to implement prediction improvements with [active learning](luis-how-to-label.md), [phrase lists](luis-concept-feature.md), and [patterns](luis-concept-patterns.md). 

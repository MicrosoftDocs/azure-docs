...
# Location entity
The prebuilt location entity detects names. Because this entity is already trained, you do not need to add example utterances containing location to the application intents. <!--Name entity is supported in [many cultures](luis-reference-prebuilt-entities.md). -->

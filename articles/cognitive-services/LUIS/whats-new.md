...
* [V3 prediction API](luis-migration-api-v3-prediction.md) is now generally available (GA)
...
* [Dynamic list entities](luis-migration-api-v3-prediction.md#dynamic-lists-passed-in-at-prediction-time)

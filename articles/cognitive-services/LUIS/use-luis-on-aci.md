...
# Deploy the Language Understanding (LUIS) container to Azure Container Instances (ACI)
...
[!INCLUDE [Create LUIS Container Instance resource](../containers/includes/create-aci-resource.md)]

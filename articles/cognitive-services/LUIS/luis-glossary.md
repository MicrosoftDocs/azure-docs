...
A collaborator is not the owner of the app, but has the same permissions to add, edit, and delete the intents, entities, utterances, and app.
...
Each app has one owner who is the person that created the app. 

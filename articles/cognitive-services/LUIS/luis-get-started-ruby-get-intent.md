---
title:  Quickstart learning how to call a Language Understanding (LUIS) app using Ruby | Microsoft Docs
description: In this quickstart, you earn to call a LUIS app using Ruby.

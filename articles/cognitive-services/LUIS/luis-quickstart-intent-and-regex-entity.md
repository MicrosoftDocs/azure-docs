...
## Quickstart app
This app demonstrates how to pull data out of an utterance. In the utterance, `[]`, the intent (primary data) is to [] and the list entity (secondary data) is the [].  
...
2. Enter the new intent name `[]`. This intent should be selected any time a user wants [].

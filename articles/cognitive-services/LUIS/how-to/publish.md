...
:::image type="content" source="../media/luis-how-to-publish-app/publish-top-nav-bar.png" alt-text="Publish button in top, right nav bar" lightbox="../media/luis-how-to-publish-app/publish-top-nav-bar.png":::

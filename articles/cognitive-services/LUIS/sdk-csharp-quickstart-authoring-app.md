...
description: Get started with the LUIS 2.x client library for .NET. Follow these steps to install the package and try out the example code for basic tasks.

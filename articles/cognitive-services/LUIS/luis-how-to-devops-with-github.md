...
* **Configure LUIS resources** - Create the [LUIS authoring and prediction resources in Azure](./luis-how-to-azure-subscription.md#create-resources-in-azure-cli) that will be used by the continuous integration workflows.

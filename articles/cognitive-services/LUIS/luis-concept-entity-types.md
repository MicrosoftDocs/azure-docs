...
|<!-- added week of 3/21/08 --> **RegEx** | [RegEx](#regex)|X|Custom regular expression. If the regular expression is too complex, such as using many brackets, you are not able to add the expression to the model. Regular expression matching is applied after spell-check alterations. <br><br>**Example**<br>`kb[0-9]{6,}` matches kb123456.|

...
| -- |--|--|
| Prebuilt |[RegEx](#regex)| Built-in types that represent common concepts like numbers, dates, and email. <br/> For more information, see [Prebuilt entities](./Pre-builtEntities.md).|

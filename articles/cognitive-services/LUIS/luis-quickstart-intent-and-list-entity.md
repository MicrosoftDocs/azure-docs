...
2. Select **Create new intent**. 
    ...
    [ ![Screenshot of Intents page with Create new intent button highlighted](./media/luis-quickstart-intent-and-list-entity/hr-create-new-intent-button.png) ](./media/luis-quickstart-intent-and-list-entity/create-new-intent-button.png#lightbox)

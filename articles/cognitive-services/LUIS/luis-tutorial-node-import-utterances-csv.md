...
* Sign in to the [LUIS](luis-reference-regions.md) website and find your [authoring key](luis-how-to-azure-subscription.md#luis-resources) in Account Settings. You use this key to call the Authoring APIs.

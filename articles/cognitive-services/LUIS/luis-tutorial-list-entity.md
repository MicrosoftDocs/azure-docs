...
> * [AuthoringKey](luis-concept-keys.md), [EndpointKey](luis-concept-keys.md) (if querying many times), app ID, version ID, and [region](luis-reference-regions.md) for the LUIS app.

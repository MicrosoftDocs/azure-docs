...
> [!div class="checklist"]
* Create a list entity in Node.js
...
The following utterances resolve the term for the Prebuilt entity **HomeAutomation.Device**:
...
## Use a list entity
The HomeAutomation.Device entity is great for a small number of devices or with few variations of the names. For an office building or campus, the device names grows beyond the usefulness of the HomeAutomation.Device entity. 
...
## Query the app 
Query the app to prove that the list entity helps LUIS determine the device type.

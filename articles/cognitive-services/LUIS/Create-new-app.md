...
# Create an app
You create a new app in two different ways: [start](#create-new-app) with an empty app and create intents, utterances, and entities, or [import a LUIS app](#import-new-app) from a JSON file that already contains intents, utterances, and entities. 

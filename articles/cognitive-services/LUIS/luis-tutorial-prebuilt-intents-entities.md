...
If you do not have the HumanResources app from the previous tutorial, .

1.  Download and save [app JSON file]((https://github.com/Microsoft/LUIS-Samples/blob/master/documentation-samples/quickstarts/custom-domain-intent-only-HumanResources.json).

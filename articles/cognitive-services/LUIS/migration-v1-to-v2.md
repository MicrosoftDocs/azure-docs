...
### Prebuilt entities 
The [prebuilt entities](luis-prebuilt-entities.md) have changed. Make sure you are using the V2 prebuilt entities. This includes using [datetimeV2](pre-builtentities.md#use-a-prebuilt-datetimev2-entity), instead of datetime. 

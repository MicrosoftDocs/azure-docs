...
LUIS includes a set of prebuilt entities for recognizing common types of information, like dates, times, numbers, measurements and currency. Prebuilt entity support varies by the culture of your LUIS app. For more details on the prebuilt entities see the [prebuilt entity reference](./luis-reference-prebuilt-entities.md).

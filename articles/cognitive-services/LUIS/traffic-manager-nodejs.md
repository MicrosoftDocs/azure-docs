...
1. In the Azure portal, create **Language Understanding** keys. Create as many keys as needed in the pricing tier to solve your endpoint request expectations. 

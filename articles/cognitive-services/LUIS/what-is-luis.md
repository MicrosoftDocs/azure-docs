...
After your LUIS app is published and receives real user utterances, LUIS provides [active learning](luis-concept-review-endpoint-utterances.md) of endpoint utterances to improve prediction accuracy. Review these suggestions as part of your regular maintenance work in your development lifecycle.
...
Language Understanding (LUIS), as a REST API, can be used with any product, service, or framework with an HTTP request. LUIS also provides client libraries (SDKs) for several top programming languages. Learn more about the [developer resources](developer-reference-resource.md) provided.
...
Use the [Azure Bot service](https://docs.microsoft.com/azure/bot-service/?view=azure-bot-service-4.0) with the [Microsoft Bot Framework](https://dev.botframework.com/) to build and deploy a chat bot. Design and develop with the graphical interface tool, [Composer](https://docs.microsoft.com/composer/), or [working bot samples](https://github.com/microsoft/BotBuilder-Samples) designed for top bot scenarios.
...
* [What's new](whats-new.md) with the service and documentation
* [Plan your app](luis-how-plan-your-app.md) with [intents](luis-concept-intent.md) and [entities](luis-concept-entity-types.md).
* [Query the prediction endpoint](luis-get-started-get-intent-from-browser.md).

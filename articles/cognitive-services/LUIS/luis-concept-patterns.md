...
If two or more entities in a pattern are contextually related, patterns use entity [roles](./luis-concept-entity-types.md#entity-role-defines-context) to extract contextual information about entities.

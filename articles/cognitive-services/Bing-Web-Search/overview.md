...
The Bing Web Search API is easy to call from any programming language that can make HTTP requests and parse JSON responses. You can access the service using the [REST API](quickstart/python.md), or available [SDKs](web-sdk-python-quickstart.md).  
...
* Use one of our quickstarts to make your first call to the Bing Web Search API.  

...
Use this quickstart to make your first call to the Bing Web Search API and receive the JSON response. This Ruby application sends a search request to the API, and displays the response. While this application is written in Ruby, the API is a RESTful Web service compatible with most programming languages.

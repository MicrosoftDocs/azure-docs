...
Create a new Java project using Maven or your favorite build automation tool. Assuming that you're using Maven, add the following lines to your [Project Object Model (POM) file](http://maven.apache.org/guides/introduction/introduction-to-the-pom.html). Replace all instances of `mainClass` with your application.

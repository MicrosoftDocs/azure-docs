...
This is the complete source code discussed in the [single-page app tutorial](tutorial-bing-web-search-single-page-app.md) for Bing Web Search. To run the app, copy the source code into Notepad or another text editor and save it as `bing.html`. Then open the saved file in Microsoft Edge or another popular browser.

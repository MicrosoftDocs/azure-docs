...
1. Click on the **PREDICTIONS** tab on the top menu bar.
2. Click on the image you used for the quick test. A new window appears, with the image in the center.
...
4. Click the green **Train** button in the top menu bar. Note that adding one image to your model doesn't lead to significant performance gains. For best results, add a significant number of images to your model before you retrain it.

...
|Domain|Purpose|
|---|---|
|Generic|If none of the other domains are appropriate, or you are unsure of which domain to choose, select the Generic domain. It is well suited for a broad range of image classification tasks.|
...
|Compact domains| The models generated by compact domains can be exported to be run locally. They are optimized for the constraints of real-time classification on mobile devices.|

---
title: "Tutorial: Create an image classification project with the Custom Vision SDK for Python"
...
# Tutorial: Create an image classification project with the Custom Vision SDK for Python

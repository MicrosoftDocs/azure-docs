...
|Domain|Purpose|
|---|---|
|__General__| Optimized for better accuracy with comparable inference time as General Domain. Recommend for larger dataset/harder user scenario. This domain will use more training time. ID: `ee85a74c-405e-4adc-bb47-ffa8ca0c9f31`|
|__General [A1]__| Optimized for a broad range of image classification tasks. If none of the other domains are appropriate, or you're unsure of which domain to choose, select the General domain. ID: `a8e3c40f-fb4a-466f-832a-5e457ae4a344`|
...
|__General [A1]__| Optimized for better accuracy with comparable inference time as General Domain. Recommend for accurate region location need/ larger dataset/harder user scenario. This domain will use more training time, and this domain is not deterministic, can expect a +-1% mAP difference with the same training data provided. ID: `9c616dff-2e7d-ea11-af59-1866da359ce6`|

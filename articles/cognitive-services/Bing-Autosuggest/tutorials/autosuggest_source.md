...
This is the complete source code discussed in the [single-page app tutorial](autosuggest.md) for the Bing Autosuggest API. To run the app, copy the source code into a text editor and save the file as `autosuggest.html`. Then open the saved file in your Web browser.

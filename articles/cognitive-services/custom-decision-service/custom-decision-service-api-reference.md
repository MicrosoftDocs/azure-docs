...
> [!IMPORTANT]
> The callback function must be defined before the call to Ranking API.
...
When parameters are not specified, the HTTP response from Ranking API is a JSONP-formatted string, as follows:

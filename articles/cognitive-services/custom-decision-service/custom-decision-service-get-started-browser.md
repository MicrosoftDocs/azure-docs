...
1.  To start using Custom Decision Service for your application, register it on the portal. In the ribbon, click **My Portal**, as highlighted in the image:

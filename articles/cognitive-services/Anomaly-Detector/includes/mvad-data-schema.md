...
* The `timestamp` values should conform to ISO 8601; the `value` could be integers or decimals with any number of decimal places.
    ...
    >
    > For details, please refer to the ["Timestamp round-up" section](/cognitive-services/anomaly-detector/concepts/best-practices-multivariate#parameters) in the best practices document.

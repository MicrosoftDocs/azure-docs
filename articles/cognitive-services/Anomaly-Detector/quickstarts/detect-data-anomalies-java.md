...
description: In this quickstart, learn how to use the Anomaly Detector API to detect abnormalities in your data series either as a batch or on streaming data.

...
2. Click the button labeled **New custom search**, which brings up the **Create a new custom search instance** window
...
5. Enter the domain name of the site to search
...
3. Ensure the **search preview** pane is displayed by using the **search preview** button
4. Select **Bing** from the drop-down
5. In the text box labeled **Enter a query...** enter a search term relevant to your vertical or topic
6. Press enter or click the Bing icon 
7. Click **Add site** next to a result you would like to include
8. Select **Entire Site**, **Subsite**, or **Exact URL** from the window titled **What do you want to add?** 

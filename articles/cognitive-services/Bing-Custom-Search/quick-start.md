...
5.	To confirm that your instance returns results, enter a query in the preview pane on the right. If there are no results, specify new site. Bing returns results only for public sites that it has indexed.

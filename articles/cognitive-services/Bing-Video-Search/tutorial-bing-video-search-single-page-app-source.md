...
<head>
    <meta charset="UTF-8">
    <title>Bing Video Search API Demo</title>
    <base target="_blank">
    <style type="text/css">
...
<body onload="document.forms.bing.query.focus();">
    ...
    bingSearchOptions(this), getSubscriptionKey())">
        ...
        <div id="query">
            ...
            <h1>Bing Video Search API demo</h1>

            <input type="text" name="query" id="term" placeholder="Search the Web" autocomplete=off>

            <p>
                Modules
                <input type=checkbox name="what" id="all" value="All" checked="checked">
                <label for="all">All</label>
                <input type=checkbox name="what" id="related" value="RelatedVideos">
                <label for="webpages">Related videos</label>

...
To page through the available videos, use the [count](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v5-reference.md#count) and [offset](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v5-reference.md#offset) query parameters.  
...
To eliminate duplicate results, use the [nextOffsetAddCount](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v5-reference.md#videos-nextoffset) field of the `Videos` object. The `nextOffsetAddCount` field tells you the number to add to your next `offset`.
...
> [!NOTE]
> Version 7 changes to paging:
>
> Renamed the `nextOffsetAddCount` field of [Videos](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference.md#videos) to `nextOffset`. In v7, you set the `offset` query parameter to the `nextOffset` value.

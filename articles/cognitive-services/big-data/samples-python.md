...
[Computer Vision](https://docs.microsoft.com/en-us/azure/cognitive-services/computer-vision/) analyzes an image in many different ways. In this sample, we provide image URLs, analyze them using Computer Vision service, and display the content tags - single-word descriptors of various aspects of an image based on recognizable objects, living beings, scenery, and actions - generated by the service.

...
This is the complete source code discussed in the [single-page app tutorial](spellcheck.md) for the Bing Spell Check API. To run the app, copy the source code into a text editor and save the file as `spellcheck.html`. Then open the saved file in your Web browser.

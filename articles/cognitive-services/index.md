        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Vision</h3>
                        <h4 style="font-size: 0.80rem;margin-bottom: 1rem;">Recognize, identify, caption, index, and moderate your pictures, videos, and digital ink content.</h4>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Speech</h3>
                        <h4>Convert speech into text and text into natural-sounding speech. Translate from one language to another and enable speaker verification and recognition.</h4>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Decision API</h3>
                        <h4>Build apps that surface recommendations for informed and efficient decision-making.</h4>

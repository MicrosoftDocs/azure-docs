...
Use this quickstart to begin using the Ink Recognizer API on digital ink strokes. This C# application sends an API request containing JSON-formatted ink stroke data, and gets the responses.

...
You can query job history to understand the state of jobs that you have started. For some example queries, see [**LINK TO AFFAN'S NEW THING**][lnk-job-history].
...
For more samples of querying device job history please see [**LINK TO AFFAN'S NEW THING**][lnk-job-history].
...
- Implement the device-specific firmware update process: this involves writing device-specific logic to download the firmware package and apply the update in the appropriate callbacks listed below. In the simulated sample, this is implemented in [**LINK TO GITHUB**][lnk-github-firmware]:
...
[img-output1]: media/iot-hub-device-management-device-jobs/image3.png
...
[lnk-job-history]: http://TODO
[lnk-get-started]: iot-hub-device-management-get-started.md
[lnk-github-firmware]: http://TODO
[lnk-github-inform-service]: http://TODO
...
| d2c.telemetry.egress.orphaned | The count of messages not matching any routes and also having the fallback route disabled | Overview of how many messages are orphaned given the current configuration of the IoT Hub |

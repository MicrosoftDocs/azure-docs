...
> [!NOTE]
> You can use IoT Hub metrics to view information about Plug and Play devices connected to your IoT Hub. Plug and Play devices are part of the [IoT Plug and Play public preview](../iot-pnp/overview-iot-plug-and-play.md).

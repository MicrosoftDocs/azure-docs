...
* Direct methods: [IoT Hub developer guide - direct methods](iot-hub-devguide-direct-methods.md) and [Quickstart: Use direct methods](/articles/iot-hub/quickstart-control-device?pivots=programming-language-java)
...
* Control devices interactively (such as turning on a fan from a user-controlled app) with the [Use direct methods](/articles/iot-hub/quickstart-control-device?pivots=programming-language-java) quickstart.
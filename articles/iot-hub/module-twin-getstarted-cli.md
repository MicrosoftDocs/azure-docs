...
> [!NOTE]
> For more information about the Azure IoT Hub SDKs you can use to create device and back-end apps for supporting similar tasks, see [Azure IoT Hub SDKs](iot-hub-devguide-sdks.md).

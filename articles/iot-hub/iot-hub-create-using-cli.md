...
In this section, you create a device identity in the identity registry in your IoT hub. A device can't connect to a hub unless it has an entry in the identity registry. For more information, see the [IoT Hub developer guide](iot-hub-devguide-identity-registry.md#identity-registry-operations). This device identity is [IoT Edge](/azure/iot-edge) enabled.

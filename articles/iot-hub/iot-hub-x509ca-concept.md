...
Previous sections above have been building up to device connection.  By simply registering an X.509 CA certificate to IoT Hub one time, how do potentially millions of devices connect and get authenticated from the very first time?  Simple.  Through the same certificate upload and proof-of-possession flow we earlier encountered with registering the X.509 CA certificate.

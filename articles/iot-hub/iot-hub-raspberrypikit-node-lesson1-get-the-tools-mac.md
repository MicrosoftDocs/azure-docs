...
If you experience issues installing Node.js and additional tools on OS X, click [here](iot-hub-raspberrypikit-node-troubleshooting.md) to follow a simple troubleshooting guide.

...
> [!NOTE]
> Routing to a Microsoft Fabric Eventstream endpoint uses the CloudEvents schema instead of the schema described here. For more information, see
[Microsoft Fabric Eventstreams as a routing endpoint](iot-hub-devguide-endpoints.md#microsoft-fabric-eventstreams-as-a-routing-endpoint-preview).
...
* To learn how to create and read IoT Hub messages in various programming languages, see [Tutorial: Send telemetry from an IoT Plug and Play device to Azure IoT Hub](/previous-versions/azure/iot/tutorial-send-telemetry-iot-hub?toc=/azure/iot-hub/toc.json&bc=/azure/iot-hub/breadcrumb/toc.json).

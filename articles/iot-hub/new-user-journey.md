...
By default, the built-in endpoint collects data from your devices. The data is available for a max of 7 days, and can be used to take actions on a device.

...
1. Open the **ReadDeviceToCloudMessages.cs** file in a text editor of your choice.
    ...
    Replace the value of the `iotHubSasKey` variable with the iothubowner primary key you made a note of previously. Then save your changes to the **ReadDeviceToCloudMessages.cs** file.

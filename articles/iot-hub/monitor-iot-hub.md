...
The **Overview** page in the Azure portal for each IoT hub includes charts that provide an overview of the IoT hub usage. These charts are based on IoT Hub platform metrics that track the number of messages used on the IoT hub, the device-to-cloud messages received by the IoT hub, the number of devices connected to the IoT hub, and the total number of devices provisioned on the IoT hub. By default, the charts show data collected over the last day.

This information is useful, but represents only a small amount of the monitoring data is available for an IoT hub. Some of this monitoring data is collected automatically and is available for analysis as soon as you create your IoT hub. You can enable additional types of data collection with some configuration.

...
![Screenshot shows the Visual Studio Code terminal interactive command line.](media/iot-hub-arduino-iot-devkit-az3166-retrieve-twitter-message/cloud-provision.png)
...
![Screenshot shows Visual Studio Code where you can run task cloud-deploy to deploy Azure Functions code.](media/iot-hub-arduino-iot-devkit-az3166-retrieve-twitter-message/cloud-deploy.png)
...
1. VS Code starts verifying and uploading the Arduino sketch to your DevKit:
   ...
   ![Screenshot shows Visual Studio Code verifying and uploading the Arduino sketch.](media/iot-hub-arduino-iot-devkit-az3166-retrieve-twitter-message/device-upload.png)
...
![Diagram shows a mobile device sending an event to Azure I o T Hub which triggers an Azure Function app to request a tweet, which is sent back to the app and forwarded to the hub and to the mobile device.](media/iot-hub-arduino-iot-devkit-az3166-retrieve-twitter-message/diagram.png)
...
4. In the [Azure portal](https://portal.azure.com/){:target="_blank"}, get into the **Resource Group** and find the Azure Function (Type: App Service) for your "Shake, Shake" project. The name always contains 'shake...' string.
   ...
   ![Screenshot of the Azure portal shows an app service for the project.](media/iot-hub-arduino-iot-devkit-az3166-retrieve-twitter-message/azure-function.png)
...
5. Update the code for `run.csx` within **Functions > shakeshake-cs** with your own token:
   ...
   ![Screenshot shows the C# code for the function where you can enter your token.](media/iot-hub-arduino-iot-devkit-az3166-retrieve-twitter-message/twitter-token.png)
...
2. In the [Azure portal](https://portal.azure.com/), find the Azure Functions app you created and restart it:
   ...
   ![Screenshot shows the Azure portal with an Azure Functions app and the Restart button.](media/iot-hub-arduino-iot-devkit-az3166-retrieve-twitter-message/azure-function-restart.png)

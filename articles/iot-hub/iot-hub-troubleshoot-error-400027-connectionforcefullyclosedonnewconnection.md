...
The device created a new connection to IoT Hub, so IoT Hub closed the previous connection. IoT Hub doesn't allow more than one client tries to connect to using the same credentials.

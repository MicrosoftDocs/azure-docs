...
description: Learn about best practices for using automatic device management to minimize repetitive and complex 
tasks involved in managing IoT devices at scale.
author: chrisgre
ms.author: chrisgre
ms.date: 06/28/2019
ms.topic: conceptual

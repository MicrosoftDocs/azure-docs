...
[Device Update for IoT Hub (Preview)](./iot-hub-device-update/understand-device-update.md)  is a comprehensive platform that customers can use to publish, distribute, and manage over-the-air updates for everything from tiny sensors to gateway-level devices. This platform is available in preview in the Western US, Asia, and Europe to keep devices and applications secure and updated. Device Update for IoT Hub allows customers to rapidly respond to security threats as well as deploy features to meet business objectives without incurring the additional development and maintenance costs of building custom update platforms.

...
![IoT Devices tool](media/tutorial-troubleshooting/iot-devices-tool.png)

To register a new device, click **+ Add**, set **Device ID** to **MyTestDevice**, and click **Save**:

![Add new device](media/tutorial-troubleshooting/add-device.png)
...
![Retrieve device connection string](media/tutorial-troubleshooting/copy-connection-string.png)
...
![Simulated device connecting](media/tutorial-troubleshooting/sim-1-connected.png)
...
![Connection error](media/tutorial-troubleshooting/sim-1-fail.png)
...
![Simulated device connecting with token](media/tutorial-troubleshooting/sim-2-connected.png)
...
![Simulated device sending messages](media/tutorial-troubleshooting/sim-3-sending.png)

You can use **Metrics (preview)** in the portal to verify that the telemetry messages are reaching your IoT hub:

![Navigate to IoT Hub metrics](media/tutorial-troubleshooting/metrics-portal.png)
...
![Show IoT Hub metrics](media/tutorial-troubleshooting/metrics-active.png)
...
![Simulated device receives direct method call](media/tutorial-troubleshooting/receive-method-call.png)
...
![View reported properties](media/tutorial-troubleshooting/reported-properties.png)
...
![Receive desired properties](media/tutorial-troubleshooting/desired-properties.png)

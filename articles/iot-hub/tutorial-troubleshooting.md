...
To generate a known-good SAS token using the Azure CLI, run the following command:

```azurecli-interactive
az iot hub generate-sas-token --device-id MyTestDevice --hub-name {YourIoTHubName}
```

Make a note of the full text of the generated SAS token. It looks like this: `SharedAccessSignature sr=youriothubname.azure-devices.net%2Fdevices%2FMyTestDevice&sig=....&se=1524155307`
...
You have now successfully authenticated from a device using a test SAS token generated by the az CLI. The **SimulatedDevice-2.js** file includes sample code that shows you how to generate a SAS token in code.

...
You’ll find in this repository [https://github.com/Azure-Samples/IoTMQTTSample] couple of C/C++ demo project showing how to send telemetry message, receive event, use Plug and Play device with an IoT HUB without using the Azure IoT C SDK. 

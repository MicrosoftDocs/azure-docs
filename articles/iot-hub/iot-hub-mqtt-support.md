...
* For the **Username** field, use `{iothubhostname}/{device_id}/api-version=2018-6-30`, where `{iothubhostname}` is the full CName of the IoT hub.
    ...
    `contoso.azure-devices.net/MyDevice01/api-version=2018-6-30`

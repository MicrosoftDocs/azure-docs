...
* For the **Username** field, use `{iothubhostname}/{device_id}/?api-version=2020-09-30`, where `{iothubhostname}` is the full CName of the IoT hub.
    ...
    `contoso.azure-devices.net/MyDevice01/?api-version=2020-09-30`
...
* If authenticating with username and password, set the username to `<hubname>.azure-devices.net/{device_id}/{module_id}/?api-version=2020-09-30` and use the SAS token associated with the module identity as your password.
...
client.username_pw_set(username=iot_hub_name+".azure-devices.net/" +
                       device_id + "/?api-version=2020-09-30", password=sas_token)
...
client.username_pw_set(username=iot_hub_name+".azure-devices.net/" +
                       device_id + "/?api-version=2020-09-30", password=None)

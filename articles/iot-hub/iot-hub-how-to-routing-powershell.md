...
Let's create a new Service Bus queue resource.
...
1. Create your new Service Bus queue. Use a unique **Name**. Use the same **NamespaceName** you created in the previous step.

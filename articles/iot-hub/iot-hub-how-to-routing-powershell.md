...
This article shows you how to create a route and endpoint in your IoT hub, then delete your route or endpoint. We use the PowerShell to create routes and endpoints to Event Hubs, Service Bus queue, Service Bus topic, and Azure Storage.

...
> [!TIP]
> The article [Using Azure PowerShell with Azure Resource Manager](../azure-resource-manager/manage-resources-powershell.md) provides more information about how to use PowerShell and Azure Resource Manager templates to create Azure resources.
...
5. To verify your application added the new IoT hub, visit the [Azure portal](https://portal.azure.com/) and view your list of resources. Alternatively, use the **Get-AzResource** PowerShell cmdlet.

> [!NOTE]
> This example application adds an S1 Standard IoT Hub for which you are billed. You can delete the IoT hub through the [Azure portal](https://portal.azure.com/) or by using the **Remove-AzResource** PowerShell cmdlet when you are finished.

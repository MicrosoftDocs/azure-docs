...
In most cases, the average increase in latency is less than 500 ms. However, the latency you experience can vary widely from this average increase and will depend on on the tier of your IoT hub and your solution topology. You can monitor the latency using **Routing: message latency for messages/events** or **d2c.endpoints.latency.builtIn.events** IoT Hub metric. Creating or deleting any route after the first one does not impact the end-to-end latency.

...
- [Manage Azure DDoS Protection Basic](/azure/virtual-network/ddos-protection-overview)
...
- [Set up Azure IoT logs](/azure/iot-hub/iot-hub-monitor-resource-health)
...
- [Set up Azure IoT Hub logs](/azure/iot-hub/iot-hub-monitor-resource-health)
...
- [Monitor Azure IoT health](/azure/iot-hub/iot-hub-monitor-resource-health)
- [How to onboard Azure Sentinel](../sentinel/quickstart-onboard.md)
...
- [Monitor Azure IoT Hub health](/azure/iot-hub/iot-hub-monitor-resource-health)
- [How to onboard Azure Sentinel](../sentinel/quickstart-onboard.md)
...
**Guidance**: Enable Azure AD MFA to protect your overall Azure tenant, benefiting all services. IoT Hub service doesn't have MFA support.  
...
**Guidance**: For users accessing IoT Hub, conditional access isn't supported. To mitigate this, use Azure AD named locations to allow access only from specific logical groupings of IP address ranges or countries/regions for your overall Azure tenant, benefitting all services including IoT Hub. 
...
- [Configure diagnostic logs for IoT hub](/azure/iot-hub/iot-hub-monitor-resource-health)

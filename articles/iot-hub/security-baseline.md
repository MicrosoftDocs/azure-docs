...
- [Tenant isolation in Azure](../security/fundamentals/isolation-choices.md#tenant-level-isolation)

- [loT networking best practice](../iot-fundamentals/security-recommendations.md#networking)

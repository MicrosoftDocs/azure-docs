...
Do note that file upload is subject to [Azure storage's firewall settings](../storage/common/storage-network-security.md). Based on your autentication configuration, you will need to ensure your devices can communicate with Azure storage.

...
* To learn how to control devices interactively, such as turning on a fan from a user-controlled app, see the [Use direct methods](/articles/iot-hub/quickstart-control-device?pivots=programming-language-csharp) quickstart.
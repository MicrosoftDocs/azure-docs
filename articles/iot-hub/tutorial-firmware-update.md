...
[!code-javascript[Automatic device management configuration](~/iot-samples-node-preview/iot-hub/Tutorials/FirmwareUpdate/ServiceClient.js?name=configuration "Automatic device management configuration")]
...
[!code-javascript[Create configuration](~/iot-samples-node-preview/iot-hub/Tutorials/FirmwareUpdate/ServiceClient.js?name=createConfiguration "Create configuration")]

After it creates the configuration, the application monitors the firmware update:

[!code-javascript[Monitor firmware update](~/iot-samples-node-preview/iot-hub/Tutorials/FirmwareUpdate/ServiceClient.js?name=monitorConfiguration "Monitor firmware update")]

A configuration reports two types of metric:
...
[!code-javascript[Handle desired property update](~/iot-samples-node-preview/iot-hub/Tutorials/FirmwareUpdate/SimulatedDevice.js?name=initiateUpdate "Handle desired property update")]
...
[!code-javascript[Firmware update flow](~/iot-samples-node-preview/iot-hub/Tutorials/FirmwareUpdate/SimulatedDevice.js?name=firmwareupdateflow "Firmware update flow")]

During the update process, the simulated device reports on progress using reported properties:

[!code-javascript[Reported properties](~/iot-samples-node-preview/iot-hub/Tutorials/FirmwareUpdate/SimulatedDevice.js?name=reportedProperties "Reported properties")]
...
[!code-javascript[Download image phase](~/iot-samples-node-preview/iot-hub/Tutorials/FirmwareUpdate/SimulatedDevice.js?name=downloadimagephase "Download image phase")]

...
description: Learn how to use the MQTT Client library to send messages to an MQTT broken. Also learn how to configure your mXChip IoT DevKit to be an MQTT client.
author: liydu
manager: jeffya
ms.service: iot-hub
services: iot-hub

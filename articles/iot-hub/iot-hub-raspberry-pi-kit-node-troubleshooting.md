...
### iothub-explorer
[iothub-explorer](https://github.com/Azure/iothub-explorer/blob/master/readme.md) is a sample multiplatform CLI tool to manage devices. You can use the tool to manage the devices in the identity registry, monitor device-to-cloud messages, and send cloud-to-device messages.

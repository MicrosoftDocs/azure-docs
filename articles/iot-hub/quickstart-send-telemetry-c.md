...
A device must be registered with your IoT hub before it can connect. In this section, you'll use the Azure Cloud Shell with the [IoT extension](/cli/azure/ext/azure-iot/iot?view=azure-cli-latest&preserve-view=true) to register a simulated device.
...
In this section, you'll use the Azure Cloud Shell with the [IoT extension](/cli/azure/ext/azure-iot/iot?view=azure-cli-latest&preserve-view=true) to monitor the device messages that are sent by the simulated device.

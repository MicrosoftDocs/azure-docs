...
## Retry policy
You use a retry policy to handle [transient errors](https://docs.microsoft.com/en-us/azure/architecture/best-practices/transient-faults) when you connect to a cloud service.

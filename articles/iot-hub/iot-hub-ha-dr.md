...
There is a 99.9% Service Level Agreement (SLA) for IoT Hub. To learn more, see the [SLA for Azure IoT Hub]](https://azure.microsoft.com/support/legal/sla/iot-hub/). The full [Azure SLA](https://azure.microsoft.com/support/legal/sla/) explains the guaranteed availability of Azure as a whole.

...
You can also disable disaster recovery when you create an IoT hub using an [ARM template](/azure/templates/microsoft.devices/iothubs?tabs=bicep#iothubproperties) or [Azure CLI commands](/cli/azure/iot/hub?view=azure-cli-latest).

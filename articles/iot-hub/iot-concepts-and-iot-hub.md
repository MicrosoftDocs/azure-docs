...
IoT Hub supports setting up of custom endpoints for various existing Azure services like  Azure storage containers, Event hubs, Service Bus Queues, Service Bus Topics and Azure Cosmos DB. Once the endpoint has been setup, you can route your IoT Data to any of these endpoints to perform downstream data operations.

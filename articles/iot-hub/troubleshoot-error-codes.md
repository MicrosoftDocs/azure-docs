...
Lastly, consider using the [Purge Queue API](/rest/api/iothub/service/devices/delete-identity) to periodically clean up pending messages before the limit is reached.

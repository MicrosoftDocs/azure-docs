...
IoT Hub only accepts signed leaf certificates that are directly one level below the issuer certificate. When uploading the issuer certificate, please upload only the issuer certificate and not the entire certificate chain.

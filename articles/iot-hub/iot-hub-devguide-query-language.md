...
description: Azure IoT Hub developer guide - description of the SQL-like IoT Hub query language used to retrieve information about device twins, methods, and jobs from your IoT hub
services: iot-hub

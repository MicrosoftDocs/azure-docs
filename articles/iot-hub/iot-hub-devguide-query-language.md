...
The query functionality is exposed by the [C# service SDK](iot-hub-devguide-sdks#azure-iot-hub-service-sdks) in the **RegistryManager** class.
...
The query functionality is exposed by the [Azure IoT service SDK for Node.js](iot-hub-devguide-sdks#azure-iot-hub-service-sdks) in the **Registry** object.

...
* [Twin's reported properties][lnk-twins] for reporting device state information such as available capabilities, conditions, or the state of long-running workflows. For example, configuration and software updates.
...
|  | Device-to-cloud messages | Twin's reported properties | File uploads |
| ---- | ------- | ---------- | ---- |

...
Also make sure the end device certificate (Leaf certificate) has the *Subject Name* set to the **Device ID** used for the IoT device that was created in the Azure IoT Hub. This is required for authentication.

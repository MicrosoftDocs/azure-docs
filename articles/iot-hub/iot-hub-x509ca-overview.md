...
Learn here how to [register your CA certificate](./tutorial-x509-scripts.md#register-x509-ca-certificates-to-your-iot-hub)
...
Learn here how to [manually create a device in IoT Hub](./tutorial-x509-scripts.md#create-an-x509-device-for-your-iot-hub).
...
Learn here how to [complete this device connection step](./tutorial-x509-scripts.md#authenticate-your-x509-device-with-the-x509-certificates).

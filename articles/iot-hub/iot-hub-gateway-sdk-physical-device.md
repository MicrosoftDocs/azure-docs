...
4. The IoT Hub module receives this new message (generated by the identity mapping module) and publishes it to the IoT Hub.
5. The logger module logs all messages from the broker into a disk file.
...
6. The logger module logs all messages from the broker into a disk file.
...
- The **Logger** module will receive and log all messages.
- The **SensorTag** module will send messages to both the **mapping** and **BLE Printer** modules.
- The **mapping** module will send messages to the **IoTHub** module to be sent up to your IoT Hub.
- The **IoTHub** module will send messages back to the **mapping** module.
- The **mapping** module will send messages back to the **SensorTag** module.

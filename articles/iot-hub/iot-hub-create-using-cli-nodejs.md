...
* **sku-name**. The name of the sku, one of: [F1, B1, B2, B3, S1, S2, S3]. For details about each sku, see [Azure IoT Hub pricing](https://azure.microsoft.com/pricing/details/iot-hub/).

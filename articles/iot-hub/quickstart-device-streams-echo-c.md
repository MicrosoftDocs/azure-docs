...
You must register a device with your IoT hub before it can connect. In this section, you use Azure Cloud Shell with the [IoT Extension](/cli/azure/ext/azure-iot/iot?view=azure-cli-latest&preserve-view=true) to register a simulated device.

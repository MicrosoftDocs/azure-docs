...
The following code sample shows you how to generate a [SAS URI](../storage/blob/storage-dotnet-shared-access-signature-part-2.md) with read, write, and delete permissions for a blob container:

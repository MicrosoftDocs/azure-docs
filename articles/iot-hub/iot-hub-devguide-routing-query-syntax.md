...
> [!NOTE]
> To filter a twin notification payload based on what changed, run your query on the message body. For example, to filter a desired property change when the `sendFrequency` is bigger than 10:
>
> ```sql

...
Device identities can also be exported and imported from an IoT Hub via the Service API either via the [REST API](/rest/api/iothub/service/createimportexportjob) or using one of the IoT Hub [Service SDKs](/azure/iot-hub/iot-hub-devguide-sdks#azure-iot-hub-service-sdks).

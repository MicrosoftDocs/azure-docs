...
| deviceScope | optional | The scope of the device. Auto generated and immutable for edge devices and modifiable in leaf devices to create child/parent relationship. For more information, see [IoT Edge as a gateway: Parent and child relationships](/azure/iot-edge/iot-edge-as-gateway#parent-and-child-relationships).|
| parentScope | optional | The scopes of the upper-level edge devices, if applicable. For more information, see [IoT Edge as a gateway: Parent and child relationships](/azure/iot-edge/iot-edge-as-gateway#parent-and-child-relationships). |

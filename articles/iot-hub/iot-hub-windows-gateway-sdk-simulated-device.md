...
```
{
    ...
    [ 
        {
            "module name" : "IoTHub",
            "module path" : "modules\\iothub_http\\Debug\\iothub_http_hl.dll",
            "args" : 
            {
        ...
        {
            "module name" : "mapping",
            "module path" : "modules\\mac_iothub_id_map\\Debug\\mac_iothub_id_map_hl.dll",
            "args" : 
            [
                {
...
2. Run the following command:
    ...
    ```
    Debug\device_cloud_upload.exe ..\samples\device_cloud_upload\src\device_cloud_upload_win.json
    ```

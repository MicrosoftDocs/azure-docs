...
If you've set up [Log Analytics with diagnostic logs](../azure-monitor/platform/resource-logs.md#collect-to-azure-storage), query by looking for logs in the `DistributedTracing` category. For example, this query shows all the traces logged:

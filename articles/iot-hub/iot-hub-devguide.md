...
* [Reference - IoT Hub query language for device twins, methods, and jobs][devguide-query] describes that IoT Hub query language that enables you to retrieve information from your hub about your device twins and jobs.

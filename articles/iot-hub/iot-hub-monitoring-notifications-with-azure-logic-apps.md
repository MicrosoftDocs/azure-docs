...
1. Create an SMTP service connection.
   ...
   1. Enter the SMTP information for your mailbox, and then select **Create**.
      ...
      > [!NOTE]
      > You may need to disable TLS to establish the connection. If this is the case and you want to re-enable TLS after the connection has been established, see the optional step at the end of this section.

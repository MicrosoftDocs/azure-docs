---
title: Troubleshooting Azure IoT Hub error 401002 AuthenticationFailed
description: Understand how to fix error 401002 AuthenticationFailed 
author: jlian
manager: briz
ms.service: iot-hub
services: iot-hub
...
ms.date: 11/01/2019
ms.author: jlian
# As a developer or operator for Azure IoT Hub, I want to resolve 401002 AuthenticationFailed errors.
---

# 401002 AuthenticationFailed

This article describes the causes and solutions for **401002 AuthenticationFailed** errors.

...
* Direct methods: [IoT Hub developer guide - direct methods](iot-hub-devguide-direct-methods.md) and [Quickstart: direct methods](/articles/iot-hub/quickstart-control-device?pivots=programming-language-python)

...
For more information about IoT Hub shared access policies and permissions, see [Access control and permissions](./iot-hub-devguide-sas.md#access-control-and-permissions).

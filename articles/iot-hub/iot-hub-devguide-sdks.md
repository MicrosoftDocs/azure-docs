...
Supported platforms for the SDKs can be found in this [document](./iot-hub-device-sdk-platform-support).
...
* [Auzre IoT SDK platform support](./iot-hub-device-sdk-platform-support)

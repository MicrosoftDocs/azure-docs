...
* [API reference](https://docs.microsoft.com/en-us/azure/iot-hub/iot-c-sdk-ref/)
...
* API reference: see [C API reference](https://docs.microsoft.com/en-us/azure/iot-hub/iot-c-sdk-ref/)

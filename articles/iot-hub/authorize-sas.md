---
title: Authorize access with a shared access signature
titleSuffix: Azure IoT Hub
description: Understand how Azure IoT Hub uses shared access signatures (SAS) to authorize access to IoT hubs and devices. 
author: kgremban
ms.service: iot-hub
services: iot-hub
ms.author: kgremban

...
Before you get started with this walkthrough, you should [set up][lnk-setupdevbox] your C development environment for working with the SDK on either Windows or Linux. 

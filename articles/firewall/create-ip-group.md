...
3. Select **Create IP Groups**.
5. Select a resource group or create a new one.
1. Type a unique name for you IP Group, and then select a region.
...
7. Type an IP address.
  ...
  There are two ways to enter IP addresses:
   ...
   When you type your IP addresses, the portal validates them to check for overlapping, duplicates, and formatting issues.

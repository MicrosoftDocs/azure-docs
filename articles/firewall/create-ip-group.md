...
4. Type a unique name for you IP Group, and then select a region.
...
1. To bulk upload, select **Import from files**. You may either drag your file to the box or select **Browse**.
6. When you type your IP addresses, the portal validates them to check for overlapping, duplicates, and formatting issues.

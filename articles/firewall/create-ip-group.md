...
This example creates an IP Group with a address prefix and an IP address using Azure PowerShell.
...
This example creates an IP Group with a address prefix and an IP address using Azure CLI

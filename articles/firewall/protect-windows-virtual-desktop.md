...
- Create a network rule collection add the following rules:
   ...
   - Allow KMS – allow traffic from your Azure Virtual Desktop virtual machines to Windows Activation Service TCP port 1688. For more information about the destination IP addresses, see [Windows activation fails in forced tunneling scenario](/troubleshoot/azure/virtual-machines/custom-routes-enable-kms-activation#solution).

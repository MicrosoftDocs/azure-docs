...
> | **_US Gov Virginia_** | Premium | - There is zero capacity for Azure Firewall Premium SKU in US Gov Virginia, both zonal and non-zonal deployments are blocked. | Deploy Azure Firewall Standard SKU or deploy Premium SKU to a different region. |

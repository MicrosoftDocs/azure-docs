...
:::code language="json" source="~/quickstart-templates/quickstarts/microsoft.network/101-azurefirewall-create-with-ipgroups-and-linux-jumpbox/azuredeploy.json":::

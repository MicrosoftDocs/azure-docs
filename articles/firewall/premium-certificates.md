...
## Certificate infrastructure auto-generation

For non-production deployments, you can use the Azure Firewall Premium Certification Auto-Generation mechanism. This automatically creates the following three resources, ties them together, and sets up TLS inspection: 

- Managed Identity 
- Key Vault 
- Self-signed intermediate CA certificate

To choose Auto-Generation, for **Managed Identity** select **(new) autoGeneratedManagedIdentity**.

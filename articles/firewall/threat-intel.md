...
>
>Threat intelligence filtering is being added to regions incrementally, and will be available in all regions in the near future.
...
During the initial public preview release, there's no user interface in the Azure portal. By default, threat intelligence-based filtering is enabled in alert mode. You can’t yet turn off this feature or change the mode.

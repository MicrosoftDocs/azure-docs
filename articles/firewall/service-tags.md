...
See [Virtual network service tags](../virtual-network/service-tags-overview#available-service-tags) for a list of service tags that are available for use in Azure firewall network rules.

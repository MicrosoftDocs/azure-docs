...
>[!NOTE]
> To use force tunneling on-premises, you must use UDR 0.0.0.0/0 with the **NextHopType** value set as **Internet**, and then assign it to the **AzureFirewallSubnet**.

<properties linkid="hdinsight-emulator-release-notes" urlDisplayName="HDInsight Emulator release notes" pageTitle="Release notes: Microsoft HDInsight Emulator for Windows Azure | Windows Azure" metaKeywords="hdinsight, Windows Azure hdinsight, hdinsight azure, get started hdinsight, emulator, hdinsight emulator" description="Get late-breaking information about the most recent releases of the HDInsight Emulator" umbracoNaviHide="0" disqusComments="1" editor="cgronlun" manager="paulettm" title="Release notes: Microsoft HDInsight Emulator for Windows Azure" authors="" />

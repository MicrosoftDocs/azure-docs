...
**Information Disclosure:** An attacker might eavesdrop on a broadcast and obtain information without authorization.

**Denial of Service:** An attacker might jam the broadcast signal and deny information distribution.

...
**Related Job View** in ADL Tools for VS helps you accelerate the troubleshooting progress with both cases.

## Step 1: Find recurring jobs and open Related Job View

To use Related Job View troubleshoot recurring job problem, you need to first find the recurring job in VS and then open Related Job View.

### Case 1: You have the URL for the abnormal recurring job

Through **Tools > Data Lake > Job View**, you can paste the job URL to open Job View in VS, and through View Related Jobs to open Related Job View.
...
## Step 2: Analyze statistics report for your recurring job
...
## Step 3: Compare the abnormal job with a normal one
...
* [How to debug and resolve data skew issue](data-lake-analytics-data-lake-tools-data-skew-solutions.md)
* [How to debug U-SQL Jobs with user defined code error](data-lake-analytics-debug-u-sql-jobs)
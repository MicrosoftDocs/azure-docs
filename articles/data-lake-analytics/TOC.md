...
### [Use U-SQL for Visual Studio Code](data-lake-analytics-data-lake-tools-for-vscode.md)
...
### [Local Run and Local debug for Visual Studio Code](data-lake-analytics-data-lake-tools-for-vscode-local-run-and-debug.md)

...
![Data Lake Tools Visual Studio Job Browser](./media/data-lake-analytics-use-job-browser-job-view/data-lake-tools-job-view.png)
...
- Job Summary
    ...
    - Job Status (graph):
        ...
        ![Azure Data Lake Analytics job phases status](./media/data-lake-analytics-use-job-browser-job-view/data-lake-tools-job-phases.png)
    ...
    - Basic Information
        ...
        ![Azure Data Lake Analytics job phases status](./media/data-lake-analytics-use-job-browser-job-view/data-lake-tools-job-info.png)
...
- Job Graph
    ...
    ![Azure Data Lake Analytics job phases status](./media/data-lake-analytics-use-job-browser-job-view/data-lake-tools-logical-to-physical-plan.png)
    ...
    - Stage information
        ...
        ![Azure Data Lake Analytics job graph stage details](./media/data-lake-analytics-use-job-browser-job-view/data-lake-tools-job-graph-stage-details.png)

...
First migrate the project and get the NuGet package. Then you can call the standard MSBuild command line with the following additional arguments to build your U-SQL project: 

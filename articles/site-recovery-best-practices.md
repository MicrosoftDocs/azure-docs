...
- **Retain IP address after failover to Azure**: You can specify the IP to be given to failed over VM in Configure tab of the virtual machine. For details look at how to [configure network properties of the virtual machine](site-recovery-vmm-to-azure/#step-8-enable-protection-for-virtual-machines)

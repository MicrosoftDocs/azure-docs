...
> [!NOTE]
> EventGrid doesn't support RBAC for publishing events to Event Grid topics or domains. Use Shared Access Signature (SAS) key or token to authenticate clients that publish events. For more information, see [Authenticate publishing clients](security-authenticate-publishing-clients.md). 

...
The identity used to make the HTTP Publish request must have the Azure RBAC role [`EventGrid TopicSpaces Publisher`](https://learn.microsoft.com/en-us/azure/event-grid/mqtt-client-microsoft-entra-token-and-rbac) for MQTT message publisher access.

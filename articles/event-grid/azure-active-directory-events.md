...
* For an introduction to Azure Event Grid's Partner Events, see [Partner Events overview](partner-events-overview)
* For information on how to subscribe to Microsoft Graph API to receive Azure AD events, see [subscribe to Azure Graph API events](subscribe-to-graph-api-events).
* For information about Azure Event Grid event handlers, see [event handlers](event-handlers).

...
Define the time to live the outgoing message will have once been delivered to an Azure Storage Queue using the fields provided. If no time is provided, the message’s default time to live is 7 days. Instead, you can set the event to never expire.

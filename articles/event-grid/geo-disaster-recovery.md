...
Microsoft offers options to recover from a failue, you can opt to enable recovery to a paired region where available or disable recovery to a paired region to manage your own recovery. See [Azure cross-region replication pairings for all geographies](../availability-zones/cross-region-replication-azure.md#azure-cross-region-replication-pairings-for-all-geographies) to learn more about the supported paired regions. The failover is nearly instantaneous once initiated, or see [Build your own disaster recovery plan for Azure Event Grid topics and domains](custom-disaster-recovery.md) to learn more about how to implement your own failover strategy.

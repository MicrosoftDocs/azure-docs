...
The [Azure IP Ranges and Service Tags - Public Cloud](https://www.microsoft.com/download/details.aspx?id=56519) document also lists IP addresses **by region**. You can allow address ranges for the **topic's region** and the **paired region** in your corporate firewall or proxy. For a paired region for a region, see [Business continuity and disaster recovery (BCDR): Azure Paired Regions](../availability-zones/cross-region-replication-azure.md). 

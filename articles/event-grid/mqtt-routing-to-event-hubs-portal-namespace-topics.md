...
1. On the **Topics** page, select the namespace topic you created earlier.
   ...
   :::image type="content" source="./media/mqtt-routing-to-event-hubs-portal-namespace-topics/select-topic.png" alt-text="Screenshot that shows the Topics page with the namespace topic selected." lightbox="./media/mqtt-routing-to-event-hubs-portal-namespace-topics/select-topic.png":::

1. On the **Event Grid Namespace Topic** page, select **+ Subscription**.

   :::image type="content" source="./media/mqtt-routing-to-event-hubs-portal-namespace-topics/subscriptions-page.png" alt-text="Screenshot that shows the Subscriptions page." lightbox="./media/mqtt-routing-to-event-hubs-portal-namespace-topics/subscriptions-page.png":::

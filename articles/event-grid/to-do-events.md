...
These events are triggered when a [todoTask](https://learn.microsoft.com/en-us/graph/api/resources/todotask?view=graph-rest-1.0) is created, updated, or deleted by operating over those resources using Microsoft Graph API. Please note you can only subscribe to changes from a specific task list.

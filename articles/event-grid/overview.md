...
Azure Event Grid offers two tiers and uses a pay-per-event pricing model. For details on pricing, see [Azure Event Grid pricing](https://azure.microsoft.com/pricing/details/event-grid/). To learn more about the capabilities for each tier, see [Choosing the right Event Grid tier](choosing-right-tier.md).

...
- Creating an Event Grid topic:  [Create a custom topic using portal](https://learn.microsoft.com/en-us/azure/event-grid/custom-event-quickstart-portal).  While creating the Event Grid topic, ensure to create with Event Schema as Cloud Event Schema v1.0 in the Advanced tab.
...
- Creating an Event Hubs:  [Quickstart - Create an event hub using Azure portal](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-create).

- You can view the Event Hubs data using Stream Analytics:  [Process data from Event Hubs Azure using Stream Analytics](https://learn.microsoft.com/en-us/azure/event-hubs/process-data-azure-stream-analytics).
...
4. If your Event Grid topic doesn't have Event Grid Data Sender permission, you can select **+ Add permission** to add the permission.
    ...
    - You can press the Refresh button to see if the permission assignment is completed.
5. Select **Apply**, once the permissions are granted.
...
2. Navigate to the Event Hubs instance within your Event Subscription on Azure portal.  Process data from your event hub using Azure Stream Analytics.  ([Process data from Event Hubs Azure using Stream Analytics - Azure Event Hubs | Microsoft Learn](https://learn.microsoft.com/en-us/azure/event-hubs/process-data-azure-stream-analytics))  You can see the MQTT messages in the query.

...
You may want check **Is secret?** when providing sensitive data. The visibility of sensitive data on the Azure portal depends upon the user's RBAC permission. 

...
Enrichments are added to your routed CloudEvent’s attributes, and you can filter on them using [Event Subscription’s advanced filtering](https://docs.microsoft.com/en-us/azure/event-grid/event-filtering).

...
> [!IMPORTANT]
> The Azure [CLI Event Grid extension](~/en-us/cli/azure/eventgrid?view=azure-cli-latest) does not yet support namespaces and any of the resources it contains. We will use [Azure CLI resource](~/en-us/cli/azure/resource?view=azure-cli-latest) to create Event Grid resources.
...
Store the client object in client1.json file
...
Store the client object in client2.json file.  

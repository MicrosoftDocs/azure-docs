...
## OMS Services
The functionality of Operations Management Suite (OMS) is provided by the following set of services in Azure.  The process of onboarding OMS is deploying and configuring each of these services depending on the service offerings that you've purchased and the requirements of your environment.
...
## Agents
The following table lists the different agents that 

| Agent | Clients | Description |
|:--|:--|:--|
| Microsoft Management Agent (MMA) | Windows computers<br>Windows virtual machines |
| 

## Microsoft Monitoring Agent (MMA)
The Microsoft Monitoring Agent (MMA) is installed on Windows computers and virtual machines to perform the following functions.

- Collect data from the local computer and deliver to Log Analytics
- Run management packs in Operations Manager and deliver collected data to management server.
- Run OMS solutions 
- Support [Hybrid Runbook Worker]() for running Automation runbooks on-premises. 
...
| Version | Description |
|:--|:--|
| 8.0.10918.0 | SCOM 2016 |
| 8.0.11030.0 | Log Analytics install from Azure |
| 7.1.10184.0 | SCOM 2012 R2 |


### Installation
There are multiple ways to install the MMS depending on the type of computer and what it's connecting to.  There is no difference between the agent provided by Operations Manager and OMS, although different versions of Operations Manager include different versions of the agent.

| Client | Method |
|:--|:--|
| Windows computer or virtual machine | SCOM | Install loca | 

...
## Next steps
- Learn more about [log searches](operations-management-suite-application-dependency-monitor.md] in Log Analytics to retrieve data collected by Application Dependency Monitor.)

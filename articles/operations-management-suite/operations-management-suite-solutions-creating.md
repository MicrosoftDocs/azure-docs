...
- Include the [IngestionAPI module]() in your runbook to simplify writing data to the Log Analytics repository.  Do not contain this module in the solution so that it remains if the solution is removed.  This allows multiple solutions to share the module.

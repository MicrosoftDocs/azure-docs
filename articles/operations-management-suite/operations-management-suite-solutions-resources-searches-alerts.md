...
| Severity | Yes | Severity of the alert record from the following values.<br><br>Allowed values :<br> **Critical**<br>**Warning**<br>**Informational** |
...
| Element name | Required | Description |
|:--|:--|:--|
| Operator | Yes | Operator for the comparison. <br><br>Allowed values :<br>**gt = greater than<br>lt = less than** |
...
| Element name | Required | Description |
|:--|:--|:--|
| TriggerCondition | Yes | Specifies whether the threshold is for total number of breaches or consecutive breaches. <br><br>Allowed values :<br>**Total<br>Consecutive** |
| Operator | Yes | Operator for the comparison. <br><br>Allowed values :<br>**gt = greater than<br>lt = less than** |

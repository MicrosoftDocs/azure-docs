...
Congratulations! Now you can see your Azure and non-Azure machines together in one place. Open the [asset inventory page](asset-inventory.md) and filter to the relevant resource types. These icons distinguish the types:
  ...
  ![ASC icon for non-Azure machine.](./media/quick-onboard-machines/security-center-monitoring-icon1.png) Non-Azure machine

  ![ASC icon for Azure machine.](./media/quick-onboard-machines/security-center-monitoring-icon2.png) Azure VM

  ![ASC icon for Azure Arc server.](./media/quick-onboard-machines/arc-enabled-machine-icon.png) Azure Arc-enabled server

...
For Azure Defender to monitor your AKS nodes, they must be running the Log Analytics agent. We recommend deploying the Log Analytics agent on your AKS nodes using Security Center's auto provisioning functionality.
We currently dot have a solution for monitoring AKS VMSS nodes

...
> [!TIP]
> For a better, richer investigation experience, stream your Azure activity logs to Azure Sentinel as described in [Connect data from Azure Activity log](../sentinel/data-connectors-reference.md#azure-activityazure-activity).

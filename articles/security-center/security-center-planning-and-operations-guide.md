...
- **Security reader**: a user that belongs to this role is be able to view only Security Center configurations, which includes recommendations, alerts, policy, and health, but it won't be able to make changes.

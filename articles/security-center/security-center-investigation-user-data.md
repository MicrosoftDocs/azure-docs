...
This article provides information on how to manage the user data found in Azure Security Center's investigation feature. Investigation data is stored in [Azure Monitor logs](../azure-monitor/logs/log-query-overview.md) and exposed in Security Center. Managing user data includes the ability to delete or export data.

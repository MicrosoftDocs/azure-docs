...
If you are using the Free tier of Security Center, you can disable data collection from virtual machines by turning off data collection in the security policy. Disabling data collection will limit security assessments for your VMs. To learn more, see [Disabling data collection](#disabling-data-collection). VM disk snapshots and artifact collection is enabled even if data collection has been disabled. Data collection is required for subscriptions on the Standard tier of Security Center.

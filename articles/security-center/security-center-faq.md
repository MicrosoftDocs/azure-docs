...
- Azure SQL service
- Partner solutions integrated with your Azure subscription such as a web application firewall on VMs and on [App Service Environment](../app-service-app-service-environments-readme.md)

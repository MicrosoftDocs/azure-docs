...
You can view your Vulnerability assessment results directly from Security Center.
...
1. To drill down for more details:
    ...
    * For an overview of the vulnerabilities grouped by a specific SQL server, click the server of interest. 
    [![Vulnerabilities grouped by SQL server](media/security-center-advanced-iaas-data/sqldb_vulns_rec_details_byserver.png)](media/security-center-advanced-iaas-data/sqldb_vulns_rec_details_byserver.png#lightbox)

    * For an overview of the vulnerabilities grouped by a security check, click the check in which you're interested.
    [![Vulnerabilities grouped by security check](media/security-center-advanced-iaas-data/sqldb_vulns_rec_details.png)](media/security-center-advanced-iaas-data/sqldb_vulns_rec_details.png#lightbox)


### SQL Database Level Overview

Vulnerabilities assessment view related to the selected SQL database

[![Vulnerabilities grouped by SQL database](media/security-center-advanced-iaas-data/sqldb_vulns_rec_details_bydb.png)](media/security-center-advanced-iaas-data/sqldb_vulns_rec_details_bydb.png#lightbox)

The list of security checks is sorted by **Severity**. Click a specific security check to see a details pane with a **Description**, how to **Remediate** it, and other related information such as **Impact** or **Benchmark**:

[![Details of a security check](media/security-center-advanced-iaas-data/security_check_details.png)](media/security-center-advanced-iaas-data/security_check_details.png#lightbox)

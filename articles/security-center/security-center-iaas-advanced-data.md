...
1. Enable advanced data security for SQL machines at the subscription/workspace level:
    ...
    Advanced Data Security for SQL machines will be enabled on all SQL machines connected to the selected workspace or the default workspace of the selected subscription.
...
## Advanced threat protection for SQL machines on Azure VMs alerts

...
Whether an alert is generated by Security Center, or received by Security Center from a different security product, you can export it. To export your alerts to Azure Sentinel (or a third-party SIEM) or any other external locations, follow the instructions in [Exporting alerts to a SIEM](continuous-export.md). 

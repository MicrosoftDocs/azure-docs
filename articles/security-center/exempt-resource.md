...
A core priority of every security team is trying to ensure the analysts can focus on the alerts and incidents that matter to the organization. Security Center has many features to ensure you can keep alert-fatigue at a minimum. Exempting resources is one such feature. 

...
1. Optional: It is highly recommended that you [define the security contact details](security-center-provide-security-contact-details.md) for the subscriptions you onboard, which will be used as the recipients of alerts and notifications generated by Security Center:

...
>   * If Azure Security Center is using another Microsoft Online Service to process the data, then it may store the data in accordance with the geo rules of the other Online Service.

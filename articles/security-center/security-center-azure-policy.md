...
---
# Azure Security Center security policies integration with Azure Policy
This document helps you to configure Azure Security Center policies integration with Azure Policy by guiding you through the necessary steps to perform this task.

...
-	**Threat detection coverage for App Service applications** (public preview) (Security Center standard version only)<br>You can now receive Security Center alerts when threats are detected on App Service applications. For more information, see the blog article [Azure Security Center can identify attacks targeting Azure App Service applications](https://go.microsoft.com/fwlink/?linkid=2004437&clcid=0x409). 

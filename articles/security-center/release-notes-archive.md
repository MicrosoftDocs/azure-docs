...
- [Recommendations to enable Azure Defender for DNS and Resource Manager (in preview)](#recommendations-to-enable-enhanced-security-for-dns-and-resource-manager-in-preview)

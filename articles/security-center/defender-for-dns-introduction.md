...
To protect your DNS layer, enable Azure Defender for DNS for each of your subscriptions as described in [Enable Azure Defender](security-center-pricing.md#enable-azure-defender).

...
> Users are advised to enable Azure Sentinel with one-click onboarding to keep their existing alerts and create new ones, or alternatively re-create their alerts with Azure Monitor log alerts.
>                                      

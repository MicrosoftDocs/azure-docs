...
Once you do, you need to install the [latest](https://www.powershellgallery.com/packages/Azure-Security-Center/0.0.9) Azure Security Center from the PowerShell gallery.

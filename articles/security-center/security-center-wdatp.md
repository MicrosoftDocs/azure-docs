...
![Screen shot of Azure Security Center, showing a list of alerts and general information about each alert.](media/security-center-wdatp/image1.png)
...
To view if Windows Defender ATP integration is enabled, you can select **Security center** > **Security policy** > **Subscription** > **Edit settings**.
  ...
  ![Azure Security Center Policy Management screen shot.](media/security-center-wdatp/policy-management.png)

Here you can see the integrations currently enabled.

  ![Screen shot of Azure Security Center Threat detection settings page with Windows Defender ATP integration enabled.](media/security-center-wdatp/enable-integrations.png)
...
2. At the prompt, copy and run the command below. The command prompt window will close automatically.
   ...
   ![Screen shot of the command above in a command prompt window.](media/security-center-wdatp/image4.jpeg)

...
| Supported versions of Windows:  |  • Defender for Endpoint is built into Windows 10 1703 (and newer) and Windows Server 2019.<br> • Security Center supports detection on Windows Server 2016, 2012 R2, and 2008 R2 SP1.<br> • Server endpoint monitoring using this integration has been disabled for Office 365 GCC customers.<br> • No support for Windows Server 2019 or Linux|

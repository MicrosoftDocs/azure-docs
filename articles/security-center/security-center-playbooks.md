...
> [!NOTE]
> Security Playbook feature has been renamed to workflow automation. Please check the [Workflow automation (Preview)](https://docs.microsoft.com/en-us/azure/security-center/workflow-automation) page for updated content information. This is temporary archived content available to customers who would have previewed this earlier and will be gradually removed. Any feature in preview is guided by [Supplemental Terms of Use for Microsoft Azure Previews](https://azure.microsoft.com/en-us/support/legal/preview-supplemental-terms/)

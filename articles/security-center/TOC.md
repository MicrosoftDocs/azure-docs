...
## [Onboard Windows computers](quick-onboard-windows-computer.md)
## [Onboard Linux computers](quick-onboard-linux-computer.md)
...
# Concepts
## [Role-based access control](/azure/active-directory/role-based-access-control-what-is.md)
## [Data security](security-center-data-security.md)

# How-to guides
## [Upgrade to advanced security](security-center-onboarding.md)

## [Set Security policy](security-center-policies-overview.md)
...
## [Manage security solutions](security-center-partner-integration.md)
### [Connected solutions](security-center-partner-solutions.md)
...
## [Investigate threats](security-center-detection-capabilities.md)
### [Security alerts](security-center-managing-and-responding-alerts.md)
### [Security incidents](security-center-incident.md)
### [Threat reports](security-center-threat-report.md)
### [Alert types](security-center-alerts-type.md)
...
### [Logic Apps playbooks](security-center-playbooks.md)
### [View events](security-center-events-dashboard.md)

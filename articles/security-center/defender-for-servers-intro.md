...
- **Integration with Microsoft Defender Advanced Threat Protection (ATP) (Windows only)** - Azure Defender integrates with Microsoft Defender Advanced Threat Protection (ATP). Together, they provide comprehensive endpoint detection and response (EDR) capabilities.

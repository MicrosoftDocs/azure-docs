...
Health status for [Cloud Services](./cloud-services/cloud-services-how-to-configure.md) is included in the virtual machines security health tile. A recommendation is created when the OS version is out of date as shown below: 

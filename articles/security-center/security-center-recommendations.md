...
<!--[Miri]  I think that we should repharse this section by saying that you first need to review how to set security policies and link to the article in the link above --> 
...
<!--[Miri] remove the fliter. there is no filter-->

* **RECOMMENDATIONS**: The recommendation.
* **SECURE SCORE IMPACT**: <!--[Miri] take description from secure score article-->
* ** Failed RESOURCEs**: Lists the resources to which this recommendation applies.
* **STATUS BARS**:  Describes the severity of that particular recommendation and the number of resources 
...
> After reviewing all recommendations, decide which one you should apply first. We recommend that you use the secure score as the main parameter to evaluate which recommendations should be applied first.

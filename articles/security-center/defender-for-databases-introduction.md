...
| Pricing:                           | **Microsoft Defender for open-source relational databases** is billed as shown on [Defender for Cloud pricing](https://azure.microsoft.com/pricing/details/security-center/)   |

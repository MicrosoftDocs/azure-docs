...
You can upgrade an entire Azure subscription to the Standard tier, which is inherited by all resources within the subscription Applying the Standard tier to a subscription applies to all supported resources in the subscription. Applying the Standard tier to a workspace applies to all resources reporting to the workspace.

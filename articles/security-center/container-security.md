...
To monitor your ARM-based Azure Container Registry, enable [Azure Defender for container registries](defender-for-container-registries-intro.md). When a new image is pushed, Security Center scans the image using a scanner from the industry-leading vulnerability scanning vendor, Qualys.

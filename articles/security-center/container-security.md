...
To monitor your Azure Container Registry, ensure you're on the Security Center's standard tier (see [pricing](pricing.md) and enable the optional Container Registries bundle. When a new image is pushed, Security Center scans the image using a scanner from the industry-leading vulnerability scanning vendor, Qualys.

...
1. Click the **Security alerts** tile and access the **Security alerts** blade.
	...
	> [AZURE.NOTE] For the purpose of this scenario, Judy is going to perform an assessment on the Malicious SQL activity alert, as seen in the preceding figure.

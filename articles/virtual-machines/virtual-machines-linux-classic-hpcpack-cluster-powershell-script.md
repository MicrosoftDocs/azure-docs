...
* For tutorials that use the script to create a cluster and run a Linux HPC workload, see:
  ...
  * [Run OpenFOAM with Microsoft HPC Pack on Linux compute nodes in Azure](linux/classic/hpcpack-cluster-openfoam.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)

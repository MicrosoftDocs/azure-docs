...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] [Resource Manager model]((virtual-machines-windows-nsg-quickstart-portal)). In the Resource Manager model, endpoints are configured using Network Security Groups (NSGs). For more information, see [Allow external access to your VM using the Azure Portal] (virtual-machines-windows-nsg-quickstart-portal).

...
The OMS workspace ID is placed in a public configuration.
...
The OMS VM extension will need an OMS workspace key to onboard the target virtual machine into OMS. This data can be secure in a private configuration property.
...
## Deploy with Resource Manger template
...
Before deploying OmsAgent Extension, you should configure your public.json and protected.json files.
...
The operation log of the extension is locate here:

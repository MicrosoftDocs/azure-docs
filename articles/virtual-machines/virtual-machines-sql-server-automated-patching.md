...
## Configure Automated Patching in the Azure preview portal

You can use the [Azure preview portal](http://go.microsoft.com/fwlink/?LinkID=525040&clcid=0x409) to configure Automated Patching when you create a new SQL Server Virtual Machine. 
...
The following Azure preview portal screenshot shows these options under **OPTIONAL CONFIGURATION** | **SQL AUTOMATED PATCHING**.

![SQL Automatic Patching in Azure preview portal](./media/virtual-machines-sql-server-automated-patching/IC778484.jpg)
...
![Automated Patching Configuration in Azure preview portal](./media/virtual-machines-sql-server-automated-patching/IC792132.jpg)

>[AZURE.NOTE] When you enable Automated Patching for the first time, Azure configures the SQL Server IaaS Agent in the background. During this time, the Azure preview portal will not show that Automated Patching is configured. Wait several minutes for the agent to be installed, configured. After that the Azure preview portal will reflect the new settings.

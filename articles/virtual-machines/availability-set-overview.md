...
**Note:**
**The Fault Domain and Update Domain Values of Availability set cannot be changed once the Availability set is created. Changing the values of FD and UD requires the Availability set to be deleted and recreated with required FD and UD values.**

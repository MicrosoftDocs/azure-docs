...
3. Add the domain user to the HPC Pack cluster as a cluster user. See [Add or remove cluster users](https://technet.microsoft.com/library/ff919330.aspx).

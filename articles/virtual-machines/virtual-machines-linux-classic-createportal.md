...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] For information about creating a Linux virtual machine using the new ure portal, see [Create a Linux VM on Azure using the Portal.md](virtual-machines-linux-quick-create-portal).

...
After you create a virtual machine, it's a good idea to [add a data disk](../articles/virtual-machines/virtual-machines-windows-classic-attach-disk.md) so your services and workloads have a location to store data. 
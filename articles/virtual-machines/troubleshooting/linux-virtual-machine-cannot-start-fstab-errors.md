...
2. Use serial console to take single user mode [single user mode](https://docs.microsoft.com/en-us/archive/blogs/linuxonazure/why-proactively-ensuring-you-have-access-to-grub-and-sysrq-in-your-linux-vm-could-save-you-lots-of-down-time#RH6x)

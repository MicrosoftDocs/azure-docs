---
title: Remote Desktop license server is available when connect to Azure VM | Microsoft Docs
...
# Remote Desktop license server is available when connect to Azure VM

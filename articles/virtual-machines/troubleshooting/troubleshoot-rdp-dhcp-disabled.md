...
description: Learn how to troubleshoot RDP problem that is caused by DHCP in Microsoft Azure.| Microsoft Docs
...
#  Cannot RDP to Azure Virtual Machines because the DHCP is disable

This article describes a problem in which you cannot remote desktop to Azure Windows Virtual Machines (VMs) after the DHCP is disabled in the VM.

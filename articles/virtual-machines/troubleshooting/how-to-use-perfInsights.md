...
4.  Open Windows command prompt as an administrator, and then run PerfInsights.exe to view the available commandline parameters.
    ...
    PerfInsights
    ```
    ![Screenshot of PerfInsights commandline output](media/how-to-use-perfInsights/perfinsights-commandline.png)
...
![Screenshot of PerfInsights Report](media/how-to-use-perfInsights/finding-tab.png)
...
![Screenshot of disk tab](media/how-to-use-perfInsights/disk-tab.png)
...
![Screenshot of volume tab](media/how-to-use-perfInsights/volume-tab.png)

### SQL tab

If the target VM hosts any SQL Server instances, you see an additional tab in the report, named **SQL**:

![Screenshot of SQL tab](media/how-to-use-perfInsights/sql-tab.png)
...
![Screenshot of log information](media/how-to-use-perfInsights/log-info.png)
...
![Screenshot of sample message from Microsoft Support](media/how-to-use-perfInsights/support-email.png)

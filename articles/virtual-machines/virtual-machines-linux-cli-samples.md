...
| [Create a VM using a virtual hard drive](./scripts/virtual-machines-linux-cli-sample-create-vm-custom-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) | Uploads a virtual hard drive to a storage account and uses that to create a virtual machine. |

...
Once the disks are created, [create a new VM](./windows/create-vm-specialized-portal.md#create-a-vm-from-a-disk.md) and [attach these restored disks](./windows/attach-managed-disk-portal.md) to the newly created VM.

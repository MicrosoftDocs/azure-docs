...
![Edit Tags in Azure preview portal](./media/virtual-machines-tagging-arm/edit-tags-in-azure-portal.png)
...
![Tags icon in Azure preview portal](./media/virtual-machines-tagging-arm/azure-portal-tags-icon.png)

Add a new tag through the portal by defining your own Key/Value pair, and save it.

![Add new Tag in Azure preview portal](./media/virtual-machines-tagging-arm/azure-portal-add-new-tag.png)

Your new tag should now appear in the list of tags for your resource.

![New Tag saved in Azure preview portal](./media/virtual-machines-tagging-arm/azure-portal-saved-new-tag.png)
...
![Usage details in Azure preview portal](./media/virtual-machines-tagging-arm/azure-portal-tags-usage-details.png)

Select your billing statement and the **Version 2** usage details:

![Version 2 Preview Usage Details in Azure preview portal](./media/virtual-machines-tagging-arm/azure-portal-version2-usage-details.png)

From the usage details, you can see all of the tags in the **Tags** column:

![Tags column in Azure preview portal](./media/virtual-machines-tagging-arm/azure-portal-tags-column.png)

...
DS-series (along with DSv2-series and GS-series) VMs support [Premium Storage](../storage/storage-premium-storage-preview-portal.md). Premium Storage is recommended for all production workloads.

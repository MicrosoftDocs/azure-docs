...
This article shows you how to create and upload a virtual hard disk (VHD) that contains the FreeBSD operating system so that you can use it as your own image to create a virtual machine (VM) in Azure.

...
3. Prepare the VM for uploading to Azure by following the instructions in [Prepare a SLES or openSUSE virtual machine for Azure](./suse-create-upload-vhd.md#prepare-opensuse-131?toc=/azure/virtual-machines/linux/toc.json). Don't run the last step (deprovisioning the VM) yet.

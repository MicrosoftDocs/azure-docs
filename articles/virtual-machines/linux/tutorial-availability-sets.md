...
* More documentation about both availability sets and availability zones is also available [Availability options for Azure Virtual Machines](../availability.md).

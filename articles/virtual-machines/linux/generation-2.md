...
* [NCv2-series](https://docs.microsoft.com/azure/virtual-machines/linux/sizes-gpu#ncv2-series)
* [NCv3-series](https://docs.microsoft.com/azure/virtual-machines/linux/sizes-gpu#ncv3-series)
...
* **How do I increase the OS disk size?**  
  ...
  * Shut down and deallocate the VM using the **Stop** button.

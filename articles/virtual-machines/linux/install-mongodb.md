...
[MongoDB](http://www.mongodb.org) is a popular open-source, high-performance NoSQL database. This article shows you how to install and configure MongoDB on a Linux VM with the Azure CLI. You can also perform these steps with the [Azure CLI 1.0](install-mongodb-nodejs.md). Examples are shown that detail how to:

...
| [GPU](sizes-gpu.md)            | NV, NC, NCv2, NCv3, ND            | Specialized virtual machines targeted for heavy graphic rendering and video editingm as well as model training and inferencing (ND) with deep learning.. Available with single or multiple GPUs.       |

...
This article details how to create a VM with multiple NICs with the Azure CLI. You can also perform these steps with the [Azure classic CLI](multiple-nics-nodejs.md).

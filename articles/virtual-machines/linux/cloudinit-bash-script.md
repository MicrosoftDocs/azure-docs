---
title: Use cloud-init to run a bash script in a Linux VM | Microsoft Docs
description: How to use cloud-init to run a bash script in a Linux VM during creation with the Azure CLI 2.0
...
Now, create a VM with [az vm create](/cli/azure/vm#create) and specify the bash script file with `--custom-data simple_bash.sh` as follows:

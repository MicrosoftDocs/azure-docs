...
> [!NOTE]
> Azure now has a service, Azure Image Builder (preview), that is built on Packer. Image builder lets you define and create your own custom images. You can even import your existing Packer shell provisioner scripts to use with Azure Image Builder. To get started with Azure Image Builder, see [Create a Linux VM with Azure Image Builder](image-builder.md).

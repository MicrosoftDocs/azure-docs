...
- At the time of the notification, a *self-service window* is made available. During this window which is typically 4 weeks, you can find which of your virtual machines are included in this wave and proactively start maintenance according to your own scheduling needs.

...
This article was last tested on 2/14/2019 using the [Azure Cloud Shell](https://shell.azure.com/bash) and the [Azure CLI](/cli/azure/install-azure-cli) version 2.0.58.

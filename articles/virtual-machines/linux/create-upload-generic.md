...
5. Install the Azure Linux Agent.
   ...
   > [!NOTE]
   > Make sure 'udf' and 'vfat' modules are enable.  Removing/disabling these  modules will cause a provisioning and/or boot failure.  **(_Cloud-init >= 21.2 removes the udf requirement. Please read top of document for more detail)**

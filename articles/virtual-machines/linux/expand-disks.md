...
=======
The default virtual hard disk size for the operating system (OS) is typically 30 GB on a Linux virtual machine (VM) in Azure. You can [add data disks](add-disk.md) to provide for additional storage space, but you may also wish to expand an existing data disk. This article details how to expand managed disks for a Linux VM with the Azure CLI. You can also expand the unmanaged OS disk with the [Azure classic CLI](expand-disks-nodejs.md).
>>>>>>> c8ea134775cf955e65c76bebbe3dfefa343c399c

...
> [!WARNING]
> Always make sure that your filesystem is in a healthy state and back up your data before you perform disk resize operations. For more information, see [Back up Linux VMs in Azure](tutorial-backup-vms.md).

...
# Explore Azure Hybrid Benefit bring-your-own-subscription to pay-as-you-go capability

Azure Hybrid Benefit provides software updates and integrated support directly from Azure for Red Hat Enterprise Linux (RHEL) and SUSE Linux Enterprise Server (SLES) virtual machines. Azure Hybrid Benefit bring-your-own-subscription (BYOS) to pay-as-you-go (PAYG) capability is a licensing benefit that lets you switch RHEL and SLES BYOS virtual machines generated from custom on-premises images or from Azure Marketplace to pay-as-you-go billing model. 

>[!IMPORTANT]
> To do the reverse and switch from a RHEL pay-as-you-go virtual machine or SLES pay-as-you-go virtual machine to a BYOS virtual machine, see [Explore Azure Hybrid Benefit for pay-as-you-go to bring-your-own-subscription capability](./azure-hybrid-benefit-linux.md).
...
Azure Dedicated Host instances and SQL hybrid benefits aren't eligible for Azure Hybrid Benefit if you're already using Azure Hybrid Benefit with Linux virtual machines. Virtual machine scale sets are reserved instances, so they also can't use Azure Hybrid Benefit.
...
If you use Azure Hybrid Benefit for SLES and want more information about moving from SLES pay-as-you-go to BYOS, or moving from SLES BYOS to pay-as-you-go, see [Azure Hybrid Benefit Support](https://aka.ms/suse-ahb) on the SUSE website.

## Frequently asked questions
*Q: What is the licensing cost I pay with Azure Hybrid Benefit BYOS to PAYG capability?*

A: When you start using Azure Hybrid Benefit BYOS to PAYG capability, you'll essentially convert the bring-your-own-subscription billing model to a pay-as-you-go billing model. What you pay will be similar to a software subscription cost for pay-as-you-go virtual machines. 
...
A: No. Hybrid Benefit BYOS to PAYG capability isn't currently available for virtual machine scale sets.

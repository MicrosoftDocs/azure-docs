...
- NVMe disks such as those on High performance computing VM sizes or Storage optimized VM sizes (see: [High performance computing VM sizes](../sizes-hpc) and [Storage optimized virtual machine sizes](../sizes-storage.md)).

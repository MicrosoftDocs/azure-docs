...
## Next steps
After the disk is added, you need to prepare it for use. For more information, see [How to: Initialize a new data disk in Linux](attach-disk.md#initialize-a-new-data-disk-in-linux).

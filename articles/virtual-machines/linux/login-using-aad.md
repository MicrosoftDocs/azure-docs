...
>
> It's not supported to use this extension on Azure Kubernetes Service clusters. For more information, see [Support policies for Azure Kubernetes Service](../../aks/support-policies.md).

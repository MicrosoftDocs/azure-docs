---
title: "CLI: Share gallery images across tenants using an app registration"
description: CLI: Learn how to share Azure Compute Gallery images across Azure tenants using an app registration.

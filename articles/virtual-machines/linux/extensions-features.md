...
| --- | --- | --- |
| Custom Script extension for Linux |Run scripts against an Azure virtual machine |[Custom Script extension for Linux](linux/extensions-customscript.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) |

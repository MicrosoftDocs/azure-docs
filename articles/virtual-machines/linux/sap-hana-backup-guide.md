...
Let&#39;s assume there is an XFS file system that spans four Azure virtual disks. Then these are the steps to achieve a consistent snapshot of all four virtual disks that represent the HANA data area:

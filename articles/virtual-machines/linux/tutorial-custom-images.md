...
In this tutorial, we will create a custom image of the VM. If you don't have a VM to use as the source, you can quickly create a VM using the [Quickstart with Azure CLI](quick-create-cli.md).

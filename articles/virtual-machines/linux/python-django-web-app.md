...
description: Learn how to host a Django-based web application in Azure using a Linux virtual machine.
...
3. Create a new file named **views.py** in the **/var/www/helloworld/helloworld** directory. This contains the view that renders the "hello world" page. Open your editor, and then enter the following:
...
When you're done with this tutorial, close or remove your newly created Azure virtual machine. This frees up resources for other tutorials, and helps you avoid incurring Azure usage charges.

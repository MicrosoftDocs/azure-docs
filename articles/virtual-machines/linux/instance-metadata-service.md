...
The Azure Instance Metadata Service (IMDS) provides information about active virtual machine instances and can be used to manage and configure your virtual machines.

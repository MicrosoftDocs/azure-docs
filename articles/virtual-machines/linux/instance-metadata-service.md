...
### Custom Data
Instance Metadata Service provides the ability for an Azure VM to have access to its custom data. The binary data must be less than 64 KB and is provided to the VM in base64 encoded form.
...
For an Azure Command Line Interface example, see [Custom Data and Cloud-Init on Microsoft Azure](https://azure.microsoft.com/en-us/blog/custom-data-and-cloud-init-on-windows-azure/).

...
* **EnSight** (optional) - To see the results of your OpenFOAM simulation, download and install the [EnSight](https://www.ansys.com/products/platform/ansys-ensight/data-interfaces) visualization and analysis program. Licensing and download information are at the EnSight site.
...
Optionally use [EnSight](http://www.ensight.com/) to visualize and analyze the results of the OpenFOAM job. 

...
* Before starting, review [Plan for the migration to Managed Disks](on-prem-to-azure.md#plan-for-the-migration-to-managed-disks?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).

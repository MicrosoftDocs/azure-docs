--- 
title: HBv3-series VM size performance 
description: Learn about performance testing results for HBv3-series VM sizes in Azure.  
...
Early Access users of HBv3 VMs can expect the following performance figures on common HPC microbenchmarks

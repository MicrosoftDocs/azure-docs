...
The creation of the [SAP system](automation-deployment-framework.md#sap-concepts) is part of the [deployment automation framework](automation-deployment-framework.md) process. The SAP system creates your virtual machines (VMs), and supporting artifacts for your [SAP application](automation-deployment-framework.md#sap-concepts). 

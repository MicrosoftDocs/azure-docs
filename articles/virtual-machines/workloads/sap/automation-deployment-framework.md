...
:::image type="content" source="./media/automation-deployment-framework/automation-framework-diagram.png" alt-text="Diagram of dependency between the Control Plane and Application plane.":::

...
:::image type="content" source="./media/automation-deployment-framework/ControlPlane_SAP_infrastructure.png" alt-text="Diagram of dependency between the Control Plane and Application plane.":::

...
- For SAP J2EE systems, it's not supported to place `/usr/sap/<SID>` on NFS on Azure Files.
...
- We recommend to deploy on RHEL 8.4 or higher to benefit from [NFS client improvements](../../../storage/files/storage-troubleshooting-files-nfs#ls-hangs-for-large-directory-enumeration-on-some-kernels).   

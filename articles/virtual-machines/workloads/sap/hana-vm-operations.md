...
> [!NOTE]
> If you want to benefit from [Azure virtual machine single VM SLA](https://azure.microsoft.com/support/legal/sla/virtual-machines/v1_6/) you need to change all VHDs that are listed as Standard Storage (Sxx) to Premium Storage (Pxx). 

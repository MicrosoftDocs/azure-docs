...
See VM type description [Azure VM sizes - Memory](../../sizes-memory.md)
...
- Details about available Azure disk types can be found [Select a disk type for Azure IaaS VMs - managed disks](../../disks-types.md)
- Details about creating software raid via mdadm can be found [Configure software RAID on a Linux VM](/previous-versions/azure/virtual-machines/linux/configure-raid)
- Details about configuring LVM to create a striped volume for max throughput can be found [Configure LVM on a virtual machine running Linux](/previous-versions/azure/virtual-machines/linux/configure-lvm)
...
found [Azure Write Accelerator](../../how-to-enable-write-accelerator.md)

...
Possible architecture with multi-target replication would look like this:
...
If the organization has requirements for high availability readiness in the the second(DR) Azure region, then the architecture would look like this:

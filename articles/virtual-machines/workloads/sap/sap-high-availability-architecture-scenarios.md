...
- You can't deploy Azure Availability Sets within an Availability Zone. Only possibility to [combine Availability sets and Availability Zones is with Proximity Placement groups](./sap-proximity-placement-scenarios.md#combine-availability-sets-and-availability-zones-with-proximity-placement-groups)

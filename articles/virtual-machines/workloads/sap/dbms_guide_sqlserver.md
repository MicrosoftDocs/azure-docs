...
A more than detailed description of this backup method, which adds numerous advantages of central backup configurations, monitoring, and administration is available [Back up SQL Server databases to Azure](../../../backup/backup-azure-sql-database.md). 

...
- Azure availability zones do not guarantee certain distance between the different zones within one Azure region.
...
- Decide if you want to deploy some dormant dialog instances in each of the zones to be able to immediately get to the former resource capacity, if a zone used by part of your application instances is out of service

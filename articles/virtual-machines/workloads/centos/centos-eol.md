...
- For a full list of endorsed Linux Distributions on Azure see: [Linux distributions endorsed on Azure - Azure Virtual Machines | Microsoft Learn](https://learn.microsoft.com/azure/virtual-machines/linux/endorsed-distros)
...
There are a multitude of CentOS based offers from various publishers available in the Azure marketplace. They range from simple OS only offers to various bundled offers with more software, desktop versions and configurations for specific cases (for example CIS hardened images).

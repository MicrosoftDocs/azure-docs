...
RHEL-SAP-HANA (To be removed  in November 2020) | 6.7       | RAW    | Linux Agent | RHEL 6.7 for SAP HANA. Outdated in favor of the RHEL-SAP images. This image will be removed in November 2020. More details about Red Hat's SAP cloud offerings are available [SAP OFFERINGS ON CERTIFIED CLOUD PROVIDERS](https://access.redhat.com/articles/3751271).
|             | 7.2       | LVM    | Linux Agent | RHEL 7.2 for SAP HANA. Outdated in favor of the RHEL-SAP images. This image will be removed in November 2020. More details about Red Hat's SAP cloud offerings are available [SAP OFFERINGS ON CERTIFIED CLOUD PROVIDERS](https://access.redhat.com/articles/3751271).
|             | 7.3       | LVM    | Linux Agent | RHEL 7.3 for SAP HANA. Outdated in favor of the RHEL-SAP images. This image will be removed in November 2020. More details about Red Hat's SAP cloud offerings are available [SAP OFFERINGS ON CERTIFIED CLOUD PROVIDERS](https://access.redhat.com/articles/3751271).

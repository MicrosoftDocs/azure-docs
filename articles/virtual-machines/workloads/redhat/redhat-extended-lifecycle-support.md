...
1. After purchasing the SaaS offer from Marketplace, implement the steps outlined in [Enabling Red Hat Enterprise Linux 7 Extended Life-cycle Support via Cloud Marketplaces](https://access.redhat.com/articles/rhel-7-els-on-cloud) to configure the ELS add-on repos in Azure RHEL VM.
...
An account will be linked and created if necessary, during the purchasing and provisioning process. 
...
Content comes from the RHT CDN

#### Is the offer available through CSP?
Select CSPs may be enabled for this offer per request / validation of Red Hat partner program membership. CSP customers can purchase ELS directly from Red Hat as well. Please contact Red Hat directly.[Contact Red Hat](https://www.redhat.com/en/contact) 

#### Is the RHEL 7 ELS offer available in GovCloud?
SaaS offers are not available in GovCloud. Please contact Red Hat directly [Contact Red Hat](https://www.redhat.com/en/contact) 

#### Is this offer Microsoft Azure Consumption Commitment (MACC) eligible?
Yes

#### Can I use this offer for any RHEL offer / image deployed in marketplace? (E.g. custom image, CIS image, subscription through reseller, etc.) 
Yes

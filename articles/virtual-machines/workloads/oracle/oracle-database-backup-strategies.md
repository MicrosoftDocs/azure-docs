...
Azure file shares can be mounted in Linux distributions using the Network File System (NFS) v4.1 protocol. While in Preview there are a number of limitations to supported features, which are documented [Mount an Azure NFS file share (preview)](../../../storage/files/storage-files-how-to-mount-nfs-shares.md). 

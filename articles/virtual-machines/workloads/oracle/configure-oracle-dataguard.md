...
Create standby redo logs and ensure they are the same size on both the standby as the primary database, (update the sizes shown in the bash script if required):

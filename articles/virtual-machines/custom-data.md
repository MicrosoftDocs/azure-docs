...
Custom data is not available in IMDS. We suggest using user data though IMDS instead. For more information, see [User data through Azure Instance Metadata Service](./linux/instance-metadata-service?tabs=linux#get-user-data)

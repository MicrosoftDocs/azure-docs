...
:::image type="content" source="media/auto-extension-upgrade.png" alt-text="Screenshot of Azure Portal to enable automatic upgrade of the extension." lightbox="media/auto-extension-upgrade.png":::

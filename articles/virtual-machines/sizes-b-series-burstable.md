...
**A**: **CPU Credits Remaining** metric will allow you to view how many credits your VM has banked and the **CPU Credits Consumed** metric will show how many CPU credits your VM has consumed from the bank. You will be able to view these metrics from the metrics pane in the portal or programmatically through the Azure Monitor APIs.

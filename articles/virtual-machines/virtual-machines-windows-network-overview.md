...
| Azure CLI 2.0 (Preview) | The subnet and the VNet are created at the same time. Provide a **--subnet-name** parameter to [az network vnet create](https://docs.microsoft.com/cli/azure/network/vnet#create) with the subnet name. |
| [Azure CLI](../virtual-network/virtual-networks-create-vnet-arm-cli.md) | Provide a **-n** parameter to **azure network vnet create** with the subnet name. |

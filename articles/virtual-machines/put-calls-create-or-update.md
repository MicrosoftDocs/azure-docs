...
**Create** operations apply default values when appropriate. However, for resource updates done through PUT or PATCH, do not default any properties. Thus, they apply strict PATCH semantics.

...
You must complete this phase before moving on to [Phase 5](virtual-machines-workload-high-availability-LOB-application-phase5.md). See [Deploy a high-availability line of business application in Azure](virtual-machines-windows-lob-overview.md) for all of the phases.

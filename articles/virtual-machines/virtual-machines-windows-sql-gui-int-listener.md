...
1. Why don't we double the indentation
...
1. and then once with tic marks and no indentation
...
1. Run the PowerShell script to configure the IP address and port for the new listener.

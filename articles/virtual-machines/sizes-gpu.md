...
If you choose to install NVIDIA GPU drivers manually, see [N-series GPU driver setup for Windows](/windows/n-series-driver-setup.md) for supported operating systems, drivers, and installation and verification steps.

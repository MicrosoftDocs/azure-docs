...
- The [NC 100 v4-series](nc-a100-v4-series.md) and [ND A100 v4-series](nda100-v4-series.md) sizes are focused on scale-up and scale-out deep learning training and accelerated HPC applications. The NC A100 v4-series offers flexibility to select one, two, or four NVIDIA A100 80GB Tensor Core GPUs per VM to leverage the right-size GPU acceleration for your workload. The ND A100 v4-series uses 8 NVIDIA A100 TensorCore GPUs, each available with a 200 Gigabit Mellanox InfiniBand HDR connection and 40 GB of GPU memory.

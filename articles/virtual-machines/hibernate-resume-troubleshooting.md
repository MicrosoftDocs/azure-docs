...
| Guest fails to hibernate because Power Service is disabled. You can check this by running sc query power | Ensure that Power Service isn't disabled. [Enabling this service should resolve the issue.](/https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.management/set-service?view=powershell-7.4#example-2-change-the-startup-type-of-services)  |

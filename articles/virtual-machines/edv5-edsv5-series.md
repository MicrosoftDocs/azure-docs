...
<sup>3</sup> Instance is [isolated](https://docs.microsoft.com/azure/security/fundamentals/isolation-choices#compute-isolation) to hardware dedicated to a single customer.

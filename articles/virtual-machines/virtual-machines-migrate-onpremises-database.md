...
**Note**: To evaluate the most recent CTP of SQL Server 2016 itself, go to [TechNet Evaluation Center](http://www.microsoft.com/evalcenter/evaluate-sql-server-2016).

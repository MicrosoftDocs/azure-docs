...
- A wave starts with a notification to customers. By default, notification is sent to the Service Admin and Co-Admins. You can add more recipients and messaging options like email, SMS, and webhooks, using [Activity Log Alerts](../service-health/alerts-activity-log-service-notifications-portal.md).  

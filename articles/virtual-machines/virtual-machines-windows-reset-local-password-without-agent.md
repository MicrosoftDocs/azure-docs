...
## Detailed steps
1. Delete the affected VM in Azure portal.
...
8. Create a new VM from the source VM’s OS disk
...
9. After the new VM is running, connect to the VM using Remote Desktop with the new password.

10. From your remote session to the new VM, remove the following files to clean up:
...
## Next steps
If you still cannot connect using Remote Desktop, see the [RDP troubleshooting guide](virtual-machines-windows-troubleshoot-rdp-connection.md). There is also a [detailed RDP troubleshooting guide](virtual-machines-windows-detailed-troubleshoot-rdp.md) that looks at troubleshooting methods rather than specific steps. You can also [open an Azure support request](https://azure.microsoft.com/support/options/).
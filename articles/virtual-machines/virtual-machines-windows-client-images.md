...
For your convenience, we have made certain Windows 10 images available from the Azure Gallery within [eligible dev/test offers](#eligible-offers). Visual Studio subscribers can also [adequately prepare and create](virtual-machines-windows-prepare-for-upload-vhd-image.md) a 64-bit Windows 10 image and then [upload to Azure](virtual-machines-windows-upload-image.md) within any type of offer. The use remains limited to dev/test by active Visual Studio subscribers.

...
* **Option 1: Migrate the VMs to a platform-created virtual network.**
    ...
    The following command displays any warnings and errors that block migration. If validation messages does not contain message of type error, you can move on to the Prepare step.

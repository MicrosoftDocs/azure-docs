<properties title="List of Oracle Virtual Machine Images" pageTitle="List of Oracle Virtual Machine Images" description="Get the list of Oracle images in the Azure gallery and learn how to create an Oracle virtual machine based on one." services="virtual-machines" authors="bbenz"/>

...
- [SSH public and private key files](linux/mac-create-ssh-keys.md)
...
- [Encrypt disks on a Linux VM by using the Azure CLI](linux/encrypt-disks.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)

...
Currently, there are two managed disk types that can burst, premium SSDs, and standard SSDs. [Premium SSDs](disks-types.md#premium-ssd) offer two models of bursting:

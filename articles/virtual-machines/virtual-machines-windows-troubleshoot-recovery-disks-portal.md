...
title: Use a Windows troubleshooting VM in the portal | Microsoft Docs
description: Learn how to troubleshoot Windows virtual machine issues by connecting the OS disk to a recovery VM using the Azure portal

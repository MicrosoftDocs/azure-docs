...
> [!IMPORTANT]
>
> - If enabled for Generation 2 VM, **[Server-side encryption with customer-managed keys](disk-encryption.md)** (SSE-CMK) should be disabled before executing Trusted launch upgrade. You can re-enable SSE-CMK encryption post completion of Trusted launch upgrade.

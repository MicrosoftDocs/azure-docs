...
3. Redeploy the Virtual Machine to new Azure node. See [Redeploy Virtual Machine to new Azure node](https://azure.microsoft.com/en-us/documentation/articles/virtual-machines-windows-redeploy-to-new-node/).<br>

...
We don't recommend certificate pinning for intermediate certs. For further guidance, see [Certificate pinning - Certificate pinning and Azure services](https://learn.microsoft.com/en-us/azure/security/fundamentals/certificate-pinning).
...
Instead, you must follow the centralized [Azure Certificate Authority details](https://learn.microsoft.com/en-us/azure/security/fundamentals/azure-ca-details?tabs=root-and-subordinate-cas-list) article for all future updates.

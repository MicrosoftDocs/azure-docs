<properties title="Configuring Oracle GoldenGate for Azure" pageTitle="Configuring Oracle GoldenGate for Azure" description="Step through a tutorial for setting up and implementing Oracle GoldenGate on Azure Virtual Machines for high availability and disaster recovery." services="virtual-machines" authors="bbenz"/>

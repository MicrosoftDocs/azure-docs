...
This document describes version 3.0 and newer of the Linux Diagnostic Extension. For information about version 2.3 and older, see [this document](./linux/classic/diagnostic-extension.md).

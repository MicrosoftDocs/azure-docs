...
Azure shows VM size recommendations in the purchase experience. When enabled, the **Optimize for instance size flexibility (preview)** groups and sorts recommendations by instance size flexibility.

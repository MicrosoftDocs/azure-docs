...
|VM Guest Patch Operations<br> (Assess & install guest patches)<br>|<a href="/rest/api/compute/virtual-machines/assess-patches?view=rest-compute-2024-03-01&tabs=HTTP">Assess Patches</a><br> <a href="/rest/api/compute/virtual-machines/install-patches?view=rest-compute-2024-03-01&tabs=HTTP">Install Patches</a><br>|2|6|200|600|

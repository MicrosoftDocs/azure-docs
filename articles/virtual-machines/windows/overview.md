...
### Naming
A virtual machine has a [name](/azure/cloud-adoption-framework/ready/azure-best-practices/naming-and-tagging) assigned to it and it has a computer name configured as part of the operating system. The name of a VM can be up to 15 characters.

...
![Screenshot that shows Portal classic cloud service](./media/migration-classic-resource-manager/portal-classic.png)

![Screenshot that shows Portal ARM resources in Prepare](./media/migration-classic-resource-manager/portal-arm.png)

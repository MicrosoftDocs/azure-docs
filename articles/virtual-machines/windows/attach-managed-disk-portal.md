...
description: How to attach new or existing managed data disk to a Windows VM in the Azure portal using the Resource Manager deployment model.
...
---
# How to attach an managed data disk to a Windows VM in the Azure portal

This article shows you how to attach both new and existing managed disks to Windows virtual machines through the Azure portal. Before you do this, review these tips:
...
6. In the **Create managed disk** blade, type in a name for the disk and keep the rest of the defaults. When you are done, click **Create**.
...
After you have attached the data disk, create a remote desktop connection to the virtual machine and initialize the disk.
...
1. Click the **Connect** button on the virtual machine blade. A Remote Desktop Protocol file (.rdp file) is created and downloaded.
    ...
    ![Connect button](./media/quick-create-portal/portal-quick-start-9.png) 

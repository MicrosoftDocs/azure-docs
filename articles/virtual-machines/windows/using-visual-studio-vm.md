...
* All available workloads, including each workload’s recommended optional components. More details on the workloads, components, and SDKs included Visual Studio could be found in the [Visual Studio documentation](https://docs.microsoft.com/en-us/visualstudio/install/workload-and-component-ids)

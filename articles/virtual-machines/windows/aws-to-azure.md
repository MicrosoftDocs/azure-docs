...
- **Generalized VHD** - a generalized VHD has had all of your personal account information removed using Sysprep. If you intend to use the VHD as an image to create new VMs from, you should: 
	...
	* [Prepare a Windows VM](prepare-for-upload-vhd-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).  
...
Follow the instructions in [How Do I Download an Object from an S3 Bucket?](http://docs.aws.amazon.com/AmazonS3/latest/user-guide/download-objects.html) to download the VHD file from the S3 bucket. 

> [!IMPORTANT]
> Data transfer fees are applied when you download the VHD. See [Amazon S3 Pricing](https://aws.amazon.com/s3/pricing/) for more information.
...
If you did not run Sysprep before exporting, the VHD is considered **specialized**. See 

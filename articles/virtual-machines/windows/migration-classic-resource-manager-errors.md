...
description: Learn about the most common errors and mitigations that occur during the migration of IaaS resources from Azure Service Management to the Azure Resource Manager stack.
author: tanmaygore
manager: vashan

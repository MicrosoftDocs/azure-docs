...
3. Select or create a resource group, and select a location.
...
4. Choose a common **Service** from the drop-down menu, such as *HTTP*. You can also select *Custom* to provide a specific port to use. 

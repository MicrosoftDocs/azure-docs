...
|----------|------------|
| **Image source** | This is a resource that can be used used to create an **image version** in an image gallery. You can create a managed image from an existing Azure VM that is either generalized or specialized. You can also create image versions from existing managed images or disk snapshots. |

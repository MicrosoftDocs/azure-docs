...
4. On the top of the page for the virtual machine, click the ![Screenshot of the Azure portal showing how to connect to your VM.](./media/connect-logon/connect.png) button.

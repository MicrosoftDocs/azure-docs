...
8. On the summary page, you should see your image name listed for **Private image**. Select **Ok** to start the virtual machine deployment.


## Use PowerShell

You can use PowerShell to create a VM from an image using the simplified parameter set for the [New-AzureRmVm](/powershell/module/azurerm.compute/new-azurermvm) cmdlet. The image needs to be in the same resource group where you'll create the VM.

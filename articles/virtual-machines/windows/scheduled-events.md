...
- [Platform initiated maintenance](https://docs.microsoft.com/en-us/azure/virtual-machines/windows/maintenance-and-updates) (e.g. VM reboot, live migration or memory preserving updates for host)
- Degraded hardware

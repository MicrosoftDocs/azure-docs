...
Scheduled Events is available for both Linux and Windows VMs. For information about Scheduled Events on Linux, see [Scheduled Events for Linux VMs](../windows/scheduled-events.md).

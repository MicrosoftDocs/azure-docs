...
## Next steps
After you create a virtual machine, it's a good idea to [add a data disk](attach-disk.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json) so your services and workloads have a location to store data. 

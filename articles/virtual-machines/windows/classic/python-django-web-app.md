...
1. Follow the instructions given [here](tutorial.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json) to create an Azure virtual machine of the Windows Server 2012 R2 Datacenter distribution.

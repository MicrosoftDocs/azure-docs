...
> [!NOTE]
> If you don't see the option to toggle "Azure hybrid benefit" under "Congiguration", it is because the VM type isn't yet supported (for example a VM built from custom image or from an image that has additional paid software like SQL Sever or Azure Marketplace 3rd party software).
>

...
### Portal
To create a VM with Azure Hybrid Benefit for Windows Server, scroll to the bottom of the **Basics** tab and under **Licensing** check the box to use an exsisting Windows Server license. 

...
# Create new availability set if it does not exist
    ...
    if (-Not $availSet) {
    $availSet = New-AzureRmAvailabilitySet -Location $originalVM.Location -Name $newAvailSetName -ResourceGroupName $resourceGroup -PlatformFaultDomainCount 2 -PlatformUpdateDomainCount 2 -Sku Aligned
    }
...
# Recreate the VM
    New-AzureRmVM -ResourceGroupName $resourceGroup -Location $originalVM.Location -VM $newVM -DisableBginfoExtension
```

...
- See [Troubleshooting Azure VM Image Build (AIB) Failures](image-builder-troubleshoot.md#template-submission-errors--troubleshooting).
...
If you encounter errors, review [Troubleshooting Azure VM Image Build (AIB) Failures](image-builder-troubleshoot.md#image-build-errors--troubleshooting).

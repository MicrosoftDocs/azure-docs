...
> [!NOTE]
> For the source image, you must always [specify a version](image-builder-troubleshoot.md#image-version-failure), you cannot use `latest`.
...
-  Review these [troubleshooting](image-builder-troubleshoot.md#template-submission-errors--troubleshooting) steps. 
...
If you encounter any errors, please review these [troubleshooting](image-builder-troubleshoot.md#image-build-errors--troubleshooting) steps.

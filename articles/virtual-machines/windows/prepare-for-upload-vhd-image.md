...
VHD file format and that have a fixed-size disk. The maximum size allowed for the OS VHD on a generation 1 VM is 2 TB. You can validate your VHD or VHDX file by refering to [this documentation](/powershell/module/hyper-v/test-vhd?view=windowsserver2022-ps).

...
Ideally, you should keep the machine updated at the *patch level*. If this isn't possible, make sure the following updates are installed.To get the latest updates, see the Windows update history pages:
- [Windows 10 and Windows Server 2019](https://support.microsoft.com/help/4000825)

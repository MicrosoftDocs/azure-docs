...
| [Upload a VHD and create VMs](./../scripts/virtual-machines-windows-upload-generalized-script.md) | Uplaods a local VHD file to Azure, creates and image from the VHD and then creates a VM from that image. |

...
- This article requires the AzureRM module, version 5.6 or later. Run ` Get-Module -ListAvailable AzureRM.Compute` to find your version. If you need to upgrade, see [Install Azure PowerShell module](/powershell/azure/azurerm/install-az-ps).

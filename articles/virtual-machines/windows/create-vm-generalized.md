...
For information about using Managed Disks instead of disks in a storage account, see [Created a managed VM image](capture-image-resource.md) and [Create a VM from a managed image](../virtual-machines-windows-create-vm-generalized-managed.md).

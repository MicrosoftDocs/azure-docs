...
> [!NOTE]
> If multiple subnets are not required for a scenario, it may me more straightforward to utilize multiple IP configurations on a single NIC.  Instructions for this setup can be found [here](..\..\..\articles\virtual-network\ip-services\virtual-network-multiple-ip-addresses-portal.md).

...
![Basic cloud-only virtual network diagram](./media/infrastructure-networking-guidelines/vnet01.png)
...
![Cross-premises virtual network diagram](./media/infrastructure-networking-guidelines/vnet02.png)

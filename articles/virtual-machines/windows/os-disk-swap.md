...
Also ensure that you're not mixing an un-encrypted VM with an encrypted OS Disk as this is unsupported. If the VM doesn't use Azure Disk Encryption, then the OS Disk being swapped should not use Encryption either.

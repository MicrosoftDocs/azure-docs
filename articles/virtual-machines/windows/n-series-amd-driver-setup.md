...
| OS | Driver |
| -------- |------------- |
| Windows 11 64-bit version 21H2, 22H2<br/><br/>Windows 10 64-bit version 21H2, 22H2 <br/><br/>Windows 11 EMS 64-bit 21H2, 22H2<br/><br/> Windows 10 EMS 64-bit 21H2, 22H2<br/><br/>Windows Server 2019 LTSC (version 1909)<br/><br/>Windows Server 2022 64-bit Release 20348 | [Driver Download](https://go.microsoft.com/fwlink/?linkid=2234555) |
...
2. If you need to uninstall the previous driver version, download the [AMD cleanup utility](https://download.microsoft.com/download/4/f/1/4f19b714-9304-410f-9c64-826404e07857/AMDCleanupUtilityni.exe)
3.	Download the EXE file to a local drive<br>
4.	Run setup.exe<br>
5. Reboot the VM

### Verify driver installation
1.	You can verify driver installation in Device Manager. The following example shows successful configuration of the Radeon Pro V620 card on an Azure NGads V620 VM.<br><br>
![NGads driver device manager](https://github.com/isgonzalez-MSFT/azure-docs-pr/assets/135761331/970be944-e588-47ca-abb6-4f462943a022)

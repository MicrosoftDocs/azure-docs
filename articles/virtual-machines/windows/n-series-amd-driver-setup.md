...
| OS | Driver |
| -------- |------------- |
| Windows 11 64-bit 21H2, Windows 10 64-bit 21H1, 21H2, 20H2 (RSX not supported on Win10 20H2)<br/><br/>WWindows 11 EMS 64-bit 21H2 Windows 10 EMS 64-bit 20H2, 21H2, 21H1(RSX not supported on EMS)<br/><br/>Windows Server 2016 (version 1607)<br/><br/>Windows Server 2019 (version 1909) | [22.Q2-1]( https://download.microsoft.com/download/4/1/2/412559d0-4de5-4fb1-aa27-eaa3873e1f81/AMD-Azure-NVv4-Driver-22Q2.exe) (.exe) |

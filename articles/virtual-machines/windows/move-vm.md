...
> [!IMPORTANT]
>Please see [this article](https://docs.microsoft.com/en-us/azure/azure-resource-manager/resource-group-move-resources#virtual-machines-limitations) to move machines backed by Azure Managed Disks.
>

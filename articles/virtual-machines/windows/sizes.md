...
|------|-------|-------------|
| [General purpose](../sizes-general.md) | B, Dsv3, Dv3, Dasv4, Dav4, DSv2, Dv2, Av2, DC, DCv2, Ddv4, Ddsv4, Dv4, Dsv4 | Balanced CPU-to-memory ratio. Ideal for testing and development, small to medium databases, and low to medium traffic web servers. |
...
| [Memory optimized](../sizes-memory.md) | Esv3, Ev3, Easv4, Eav4, Edv4, Edsv4, Ev4, Esv4, Mv2, M, DSv2, Dv2 | High memory-to-CPU ratio. Great for relational database servers, medium to large caches, and in-memory analytics. |

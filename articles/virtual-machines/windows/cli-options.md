...
This document details the ways that the Azure CLI can be install and run on Windows and details syntactical considerations for each. For in depth Azure CLI documentation see, [Azure CLI documentation]( https://docs.microsoft.com/en-us/cli/azure/overview).

...
When no longer needed, you can delete the resource group, virtual machine, and all related resources. Select the resource group for the virtual machine, select **Delete**. Confirm the name of the resource group to finish deleting the resources.

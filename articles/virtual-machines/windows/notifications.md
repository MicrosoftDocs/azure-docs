...
Download the installation a .zip file of the project from [GitHub](https://github.com/microsoft/AzureScheduledEventsService/archive/master.zip), extract the files.

Connect to **myCollectorVM** and copy the SchService.ps1 script to the virtual machine. On your VM, open a PowerShell prompt and setup the service.

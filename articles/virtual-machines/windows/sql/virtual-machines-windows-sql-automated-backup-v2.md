...
For existing SQL Server virtual machines, navigate to the [SQL virtual machine resource](virtual-machines-windows-sql-manage-portal.md#sql-virtual-machine-resource) and then select **Backups** to configure your automated backups.

---
title: Use Azure SQL VM CLI to configure Always On availability group for SQL Server on Azure VM 
...
---
# Use Azure SQL VM CLI to configure Always On availability group for SQL Server on Azure VM

...
| --- | --- |
| **Move SQL VM to different region** | Use Azure Site Recovery to [migrate your SQL Server VM from one region to another](virtual-machines-windows-sql-move-to-new-region.md). |
| &nbsp; | &nbsp; |

...
| --- | --- |
| **Extended SQL 2008 / R2 support** | Learn how to extend support for SQL Server 2008 and 2008 R2 by migrating your SQL Server instance to Azure,or purchasing extended support to keep your instance on-premises. | 
| &nbsp; | &nbsp; |

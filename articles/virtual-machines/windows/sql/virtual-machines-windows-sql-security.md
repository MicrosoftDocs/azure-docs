...
For more information about virtual machine encryption, see the [virtual machines security overview](/azure/security/fundamentals/virtual-machines-overview).

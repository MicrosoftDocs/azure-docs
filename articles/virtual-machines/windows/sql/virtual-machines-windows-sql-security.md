...
- For Resource Manager VMs, you can select **Security** from the [SQL virtual machine resource](virtual-machines-windows-sql-manage-portal.md#sql-virtual-machine-resource). This provides an option to change the port.

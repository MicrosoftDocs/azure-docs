...
## Remarks
 ...
 - Azure Cloud Solution Partner (CSP) customers can utilize the AHB benefit by first deploying a pay-as-you-go VM and then converting it to bring-your-own-license. 

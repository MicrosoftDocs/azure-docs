...
## Register SQL Server VM with the resource provider
In certain situations, customers may need to manually register their SQL Server VM with the SQL VM resource provider. To do so, you may also need to manually register the resource provider with their subscription. 

...
> [!NOTE]
> It is now possible to change the licensing model of a pay-per-usage SQL Server VM to use your own license. For more information, see [Switch licensing model for a SQL VM in Azure](virtual-machines-windows-sql-ahb.md). 
...
To bring your own license, you can either convert an existing pay-per-usage SQL VM, or you can deploy an image with the prefixed **{BYOL}**. For more information about switching your licensing model between pay-per-usage and BYOL, see [Switch licensing model for a SQL VM in Azure](virtual-machines-windows-sql-ahb.md). 

...
## Removal
You can uninstall the extension n the Azure portal by selecting the ellipsis on the **Extensions** window of your virtual machine properties. Then select **Delete**.

...
The cost is the same for all versions of SQL Server (2012 SP3 to 2017). The per-second licensing cost depends on the number of VM cores, which is a standard for all SQL Server licensing.

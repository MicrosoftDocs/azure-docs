...
- Host-only.
- Use another, external time server with or without using host time. For this option follow the [Tyme Mechanism for Active Directory Windows Virtual Machines in Azure](external-ntpsource-configuration.md) guide.

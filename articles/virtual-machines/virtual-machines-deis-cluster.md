 ...
 * [AZURE.INCLUDE [arm-getting-setup-powershell](../../includes/arm-getting-setup-powershell.md)] or [AZURE.INCLUDE [xplat-getting-set-up-arm](../../includes/xplat-getting-set-up-arm.md)].
 * [OpenSSL](https://www.openssl.org/). OpenSSL is used to generate necessary certificates.

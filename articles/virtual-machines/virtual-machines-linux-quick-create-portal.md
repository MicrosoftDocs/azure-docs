...
You need an SSH key pair to complete this quick start. If you have an existing key pair, this step can be skipped. If you are using a Windows machine, follow the instructions found [here](./virtual-machines-linux-ssh-from-windows.md). 

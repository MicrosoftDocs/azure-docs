...
[AZURE.NOTE] If you choose to use a password to secure access to your VM, the password must be greater than 12 characters, and at least one upper case character, at least one lowercase character, at least one special character, and at least one number. 

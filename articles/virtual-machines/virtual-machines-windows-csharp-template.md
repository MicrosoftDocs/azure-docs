...
* Learn how to deploy a virtual machine and its supporting resources by reviewing [Deploy an Azure Virtual Machine Using C#](windows/csharp.md).
* Learn how to manage the virtual machine that you created by reviewing [Manage Azure Virtual Machines using Azure Resource Manager and C#](windows/csharp-manage.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).

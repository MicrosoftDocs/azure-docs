...
- [Dv4 and Dsv4-series](dv4-dsv4-series.md) The Dv4 and Dsv4-series runs on the Intel® Xeon® Platinum 8272CL (Cascade Lake) processors in a hyper-threaded configuration, providing a better value proposition for most general-purpose workloads. It features core Turbo clock speed of 3.4 GHz.

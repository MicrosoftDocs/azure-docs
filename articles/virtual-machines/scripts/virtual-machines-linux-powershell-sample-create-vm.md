...
| [Set-AzVMOperatingSystem](/powershell/module/az.compute/set-azvmoperatingsystem) | Sets operating system properties for a virtual machine. |
| [Set-AzVMSourceImage](/powershell/module/az.compute/set-azvmsourceimage) | Specifies the image for a virtual machine. |

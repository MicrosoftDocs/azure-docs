...
Before running this script, log in to Azure using the `Login-AzureRmAccount` command. Also, you will need to have an SSH public key named `id_rsa.pub` in the .ssh directory of your user profile. Finally, you will need to update the OMS workspace ID and workspace key.

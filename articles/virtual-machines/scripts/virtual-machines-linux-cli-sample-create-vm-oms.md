...
| [azure vm extension set](https://docs.microsoft.com/cli/azure/vm/extension) | Runs a VM extension against a virtual machine. In this case, the Log Analytics agent extension is used to install the Log Analytics agent and enroll the VM in an Log Analytics workspace. |

...
If needed, install the Azure CLI using the instruction found [here](cli/azure/install-azure-cli.md), and then run `az login` to create a connection with Azure. Also, you will need the OMS workspace ID and workspace key in order to run the script.

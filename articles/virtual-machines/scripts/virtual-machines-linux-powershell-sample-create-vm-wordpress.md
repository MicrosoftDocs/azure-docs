...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Add the Custom Script Extension to the virtual machine, which invokes a script to install WordPress. |

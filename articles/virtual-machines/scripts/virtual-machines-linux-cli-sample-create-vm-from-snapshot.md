---
title: Azure CLI Script Sample - Create a VM from a snapshot | Microsoft Docs
...
[!code-azurecli[main](../../../cli_scripts/virtual-machine/create-vm-from-snapshot/create-vm-from-snapshot.sh "Create VM from snapshot")]
...
| [az vm create](https://docs.microsoft.com/cli/azure/vm#create) | Creates a new VM using a managed OS disk |

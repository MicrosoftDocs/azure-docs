...
Additional virtual machine PowerShell script samples can be found in the [Azure Windows VM documentation](../../app-service-web/powershell-samples.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
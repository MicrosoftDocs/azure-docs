...
There are always a multitude of [design considerations](windows/infrastructure-virtual-machine-guidelines.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) when you build out an application infrastructure in Azure. These aspects of a VM are important to think about before you start:
...
### Naming
A virtual machine has a [name](windows/infrastructure-naming-guidelines.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) assigned to it and it has a computer name configured as part of the operating system. The name of a VM can be up to 15 characters.
...
| Client SDKs |[Deploy Azure Resources using C#](windows/csharp.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) |
...
| Client SDKs |For information about using C# to manage VMs, see [Manage Azure Virtual Machines using Azure Resource Manager and C#](windows/csharp-manage.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). |
...
* Learn more about the guidelines around setting up your infrastructure in the [Example Azure infrastructure walkthrough](windows/infrastructure-example.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).

...
| [DnsEvents](/azure/azure-monitor/reference/tables/DnsEvents) | network | [Stream and filter data from Windows DNS servers](/azure/sentinel/data-connectors/dns) | No| [Yes](/azure/azure-monitor/reference/queries/dnsevents)|
| [DnsInventory](/azure/azure-monitor/reference/tables/DnsInventory) | network | [Stream and filter data from Windows DNS servers](/azure/sentinel/data-connectors/dns) | No| -|

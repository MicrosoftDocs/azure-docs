...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] For information on how to detach a disk using the Resource Manager model, see [here](virtual-machines-windows-detach-disk.md).

---
title: Create SQL Server Availability Group | Azure VM 
...
> * [Resource Manager: Manual Prereq](virtual-machines-windows-portal-sql-availability-groups-prereq.md)
...
1. Select the **Networks** node, and note the cluster network name. Use this name in the `$ClusterNetworkName` variable in the PowerShell script.
   ...
   ![Cluster Network Name](./media/virtual-machines-windows-portal-sql-availability-group-tutorial/90-clusternetworkname.png)
...
1. In the **Roles** pane, right-click the Availability Group name and then select **Add Resource** > **Client Access Point**.
   ...
   ![Client Access Point](./media/virtual-machines-windows-portal-sql-availability-group-tutorial/92-addclientaccesspoint.png)
...
1. Click the **Resources** tab, then expand the Client Access Point you created. The client access point is offline.
   ...
   ![Client Access Point](./media/virtual-machines-windows-portal-sql-availability-group-tutorial/94-newclientaccesspoint.png) 
...
1. Under **IP Address**, click **Static IP Address**. Set the IP address to the same address that you used when you set the load balancer address on the Azure portal.
   ...
   ![IP Resource](./media/virtual-machines-windows-portal-sql-availability-group-tutorial/96-ipresource.png) 
...
1. On the **Resources** tab, right-click the availability resource group under **Other Resources** and click **Properties**. 
   ...
   ![IP Resource](./media/virtual-machines-windows-portal-sql-availability-group-tutorial/98-dependencies.png) 
...
1. Click the **Dependencies** tab. Set a dependency on the listener resource name. If there are multiple resources listed, verify that the IP addresses have OR, not AND, dependencies. Click **OK**. 
   ...
   ![IP Resource](./media/virtual-machines-windows-portal-sql-availability-group-tutorial/98-propertiesdependencies.png) 

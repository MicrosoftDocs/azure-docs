...
cloud-based HPC Pack head node VM for a test or proof-ofconcept deployment. The high-level steps are the same as the one to “burst to Azure” to add cloud compute capacity to an

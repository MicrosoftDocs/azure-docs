...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] For a Resource Manager template to deploy a MySQL cluster, see [here](https://azure.microsoft.com/documentation/templates/mysql-replication/).

...
* [Diagnostics configurations schema](../../azure-monitor/essentials/diagnostics-extension-versions.md) explains the various XML configurations options for the diagnostics extension.
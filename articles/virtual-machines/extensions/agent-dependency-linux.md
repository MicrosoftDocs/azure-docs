...
[!INCLUDE [dependency-agent-linux-versions](~/reusable-content/ce-skilling/azure/includes/azure-monitor/includes/vm-insights-dependency-agent-linux-versions.md)]

...
Instructions on manual installation of the drivers and the current supported versions are available [Azure N-series GPU driver setup for Linux](../linux/n-series-driver-setup.md).

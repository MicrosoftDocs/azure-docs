...
> !Note
> The DSC Extension for Linux and the [Azure Monitor virtual machine extension for Linux](/virtual-machines/extensions/oms-linux) currently present a conflict
...
The DSC Linux extension supports all the [Linux distributions endorsed on Azure](/virtual-machines/linux/endorsed-distros) except:

...
Instructions on manual installation of the OFED drivers are available [Enable InfiniBand on HPC VMs](../workloads/hpc/enable-infiniband.md#manual-installation).

...
# Login to Azure first before anything else.
az login
...
The latest version of the extension is *3.0*. *Any old versions (2.x) are deprecated and might be unpublished on or after July 31, 2018*.

...
For details about the supported Linux distributions, refer to the [Overview of Azure Monitor agents](../platform/agents-overview.md#supported-operating-systems) article.

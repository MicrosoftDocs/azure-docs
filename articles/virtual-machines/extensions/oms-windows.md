...
For details about the supported Windows operating systems, refer to the [Overview of Azure Monitor agents](../platform/agents-overview.md#supported-operating-systems) article.

...
## Next steps
If you want to reuse the data disk, you can just [attach it to another VM](windows/attach-disk-portal.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)

...
> [!NOTE]
To create a VM using the Azure CLI 2.0, see [Create a VM with the Azure CLI](linux/quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).

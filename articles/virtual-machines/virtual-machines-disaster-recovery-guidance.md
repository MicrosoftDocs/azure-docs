<properties
	pageTitle="What to do when an Azure service disruption impacts Azure virtual machines | Microsoft Azure"
	description="Learn what to do when an Azure service disruption impacts Azure virtual machines."
...
#What to do when an Azure service disruption impacts Azure virtual machines
...
To restore a new VM from Azure Backup, see [Restore virtual machines in Azure](https://azure.microsoft.com/en-us/documentation/articles/backup-azure-restore-vms/).
...
Learn how to use Azure Site Recovery to orchestrate and automate protection of your on-premises workloads that run on Hyper-V VMs, see [Azure Site Recovery](https://azure.microsoft.com/documentation/learning-paths/site-recovery/).

If the instructions are not clear, or if you would like Microsoft to do the operations on your behalf, contact [Customer Support](https://ms.portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade).

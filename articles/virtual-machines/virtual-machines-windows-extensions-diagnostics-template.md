...
- Deploy the resource manager template using [Azure PowerShell](virtual-machines-windows-ps-manage.md) or [Azure Command Line](virtual-machines-deploy-rmtemplates-powershell.md)

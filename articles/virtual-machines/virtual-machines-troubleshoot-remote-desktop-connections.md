...
If the diagnostic package did not help you fix the RDP problem, or if you are on a different on a non-Windows machine, follow the next steps for a more detailed troubleshooting.
...
## Remote Desktop connection error: Remote Desktop cannot connect to the remote computer for one of these reasons…
...
# Steps before detailed troubleshooting

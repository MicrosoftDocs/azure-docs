...
- **Attestation health assessment** - If your VM has vTPM enabled, an extension of Microsoft Defender for Cloud can remotely validate that your VM booted in a healthy way. This is known as remote attestation. Microsoft Defender for Cloud issues an assessment, indicating the status of remote attestation.

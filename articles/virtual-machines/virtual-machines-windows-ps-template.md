...
- Learn how to manage the virtual machine that you created by reviewing [Manage virtual machines using Azure Resource Manager and PowerShell](windows/ps-manage.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).

...
The following steps show how to create RAID on Azure using the Azure Portal. You can also set up RAID using Windows PowerShell scripts.
In this example we will configure RAID 0 with 4 disks.  

####Step 1: Add a Data Disk to your Virtual Machine  

In the Virtual Machines page of the Azure Portal, click the virtual machine to which you want to add a data disk. In this example, the virtual machine is mysqlnode1.  

...
> [!NOTE]
> Availability Zone can only be configured while deploying a Virtual machine, if you want to add an existing VM to an Availability Zone, as a work-around you can take a snapshot of the OS disk and create a disk by enabiling the Availability Zone option and swap the new disk with the VM.

...
The current Preview is available in all Global Azure Regions.We will be enable the service for Government/China/German clouds in future. This following table is updated when service preview becomes available in the Region.
...
4. Why am I getting error 500 - Internal server error?
   * Currently Instance metadata Preview is available only in Generally Available Global Azure Region and not in Government/China/German clouds. Deploy your VMs in the supported regions. If the issue persists contact azureimds@microsoft.com 

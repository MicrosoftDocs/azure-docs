...
A Service Fabric service instance is a specific named instance of an application name and a service type name (see [Service Fabric Application Lifecycle]../service-fabric-application-lifecycle.md). It is during service creation that you specify the partition scheme ([Partition Service Fabric Services]../srvice-fabric-conepts-partitioning.md) to be used.

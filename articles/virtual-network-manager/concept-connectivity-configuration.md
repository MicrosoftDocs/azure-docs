...
To assist you in understanding the topology of your network group, Azure Virtual Network Manager provides a **Topology View** that shows the connectivity between virtual networks in the network group. You can view the topology of your network group during the creation of your connectivity configuration with the following steps:
    1. Navigate to your network manager.

...
1. To view the available virtual networks from the target managed tenant, select **authenticate** and proceed through the authentication process with an account that has permissions to the target managed tenant.

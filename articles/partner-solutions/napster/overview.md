...
This offering allows you to create and manage Napster Companion API resources as an integrated Azure service. You can build persistent multimodal AI agents (Omniagents) that maintain a consistent identity, knowledge, and memory across video, voice, text, and telephony channels - and get started seamlessly through the Azure portal.

You can set up Napster Companion API resources through a resource provider named `Napster.CompanionAPI`. You can create and manage the billing, resource creation, and authorization of Napster Companion API resources through the Azure portal. Napster owns and runs the Software as a Service (SaaS) application, including the Companion API resources created.
...
## Subscribe to Napster Companion API

[!INCLUDE [subscribe](../includes/subscribe.md)] *Napster Companion API*.

...
In this quickstart, you use the Azure portal and Marketplace to find and create an instance of _Informatica Intelligent Data Management Cloud - Azure Native ISV Service_.

...
:::image type="content" source="media/qumulo-disaster-recovery/disaster-recovery-architecture-on-prem-cloud.png" alt-text="Conceptual diagram that shows solution architecture for cloud andd on premises replication.":::

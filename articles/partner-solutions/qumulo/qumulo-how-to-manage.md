...
To see the details of your Qumulo resource on the Azure portal, select **Overview** on the **Resource** menu.
...
1. On the Azure portal, select your deployment of Azure Native Qumulo Scalable File Service.

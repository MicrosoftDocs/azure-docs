...
Before you proceed, please make sure that your subscription is marketplace purchase enabled. For more information, visit [Purchase validation checks](https://learn.microsoft.com/marketplace/purchase-validation-checks).

...
- To collect metrics you should have owner permission on the subscription. If you are a contributor then please refer to the contributor guide mentioned in the [create section](../../partner-solutions/dynatrace/dynatrace-create.md).

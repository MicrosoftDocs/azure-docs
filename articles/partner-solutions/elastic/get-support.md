...
This article describes how to contact support when working with Elastic Cloud (Elasticsearch) - An Azure Native ISV Service. Before contacting support, see [Fix common errors](troubleshoot.md).

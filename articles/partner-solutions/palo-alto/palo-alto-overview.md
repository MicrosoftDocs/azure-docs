---
title: What is Palo Alto
description: Learn about using the Palo Alto Cloud-Native Observability Platform in the Azure Marketplace.
...
The Palo Alto integration can only be set up by users who have Owner access on the Azure subscription. Ensure you have the appropriate Owner access before starting to set up this integration.

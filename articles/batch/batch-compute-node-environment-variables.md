...
> [!NOTE]
> `AZ_BATCH_AUTHENTICATION_TOKEN` is deprecated ([see announcement for alternative implementation](https://azure.microsoft.com/updates/azure-batch-task-authentication-token-will-be-retired-on-30-september-2024/)).

...
description: Ways in which Azure Batch rendering capabilities can be used
services: batch
author: mscurrell
ms.author: markscu
ms.date: 08/02/2018
...
* APIs:
  * Write code using the REST, C#, Python, Java, or other supported APIs.  Developers can integrate Azure Batch capabilities into their existing applications or workflow, whether cloud or based on-premises.
* Command line tools:
...
For a step-by-step tutorial for using Batch Explorer to perform rendering see the [Blender tutorial]().

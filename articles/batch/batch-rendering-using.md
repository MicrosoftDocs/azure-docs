...
For a step-by-step tutorial for using Batch Explorer to perform rendering see the [Blender tutorial](https://docs.microsoft.com/en-us/azure/batch/tutorial-rendering-batchexplorer-blender).

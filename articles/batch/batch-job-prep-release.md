...
> [!TIP]
> Another way to persist logs and other job and task output data is to use the [Azure Batch File Conventions](batch-task-output.md#use-the-batch-file-conventions-library-for-net) library.

...
If you are creating a new VM for the image, use Azure Batch supported images.

To get a full list of current Azure Batch supported images, use one of the following APIs to return a list of Windows and Linux VM images including the node agent SKU IDs for each image:
...
To create an image requires purchase plan: [Supply Azure Marketplace purchase plan information when creating images](https://learn.microsoft.com/en-us/azure/virtual-machines/marketplace-images)

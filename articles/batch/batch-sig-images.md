...
- **Better performance than using just a managed image as a custom images.** For a Shared Image custom image pool, the time to reach the steady state is up to 25% fasterm and the VM idle latency is up to 30% shorter.

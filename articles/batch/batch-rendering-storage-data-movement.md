...
[Azure File Sync](../storage/filesync/file-sync-planning.md) is available to automatically synchronize files between an on-premises file system and an Azure File share.

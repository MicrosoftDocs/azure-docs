...
> [!NOTE]
> When a VM's temporary disks are all NVMe, Batch initializes them and uses the resulting storage for the node root directory. For details, see [Use temporary NVMe disks on Batch compute nodes](batch-nvme-temp.md).

...
For TLS best practices refer to [TLS best practices for .NET framework](https://docs.microsoft.com/en-us/dotnet/framework/network-programming/tls).
...
1. What happens if I don’t upgrade?<br>
   After the feature retirement, our client application will not work until you upgrade.<br>

1. Will upgrading to TLS 1.2 affect performance?<br>
   Upgrading to TLS 1.2 will not affect performance.<br>

1. How do I know if I’m using TLS 1.0/1.1?<br>
   You can check the Audit Log to determine the TLS version you are using.

## Next steps

For more information, refer to [How to enable TLS 1.2 on clients](https://docs.microsoft.com/en-us/mem/configmgr/core/plan-design/security/enable-tls-1-2-client).

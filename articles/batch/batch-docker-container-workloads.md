...
> the `containerConfiguration` requires `ContainerType` property to be passed and the supported values are: `ContainerType.DockerCompatible` and `ContainerType.CriCompatible`.

...
- **'cloudServiceConfiguration' or 'virtualMachineConfiguration'.**
    'virtualMachineConfiguration' should be used. All Batch features are supported by 'virtualMachineConfiguration' pools; some features are not supported and no new capabilities are being added for 'cloudServiceConfiguration' pools.

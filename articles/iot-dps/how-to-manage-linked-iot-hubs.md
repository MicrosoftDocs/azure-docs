...
1. Follow the steps in [Link an IoT hub](#use-the-azure-portal-to-link-an-iot-hub) to re-link the IoT hub to your DPS instance with the new connection string for the policy.

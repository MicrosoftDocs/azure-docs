...
At some point in the lifecycle of your IoT solution, you will need to roll the certificates in your system. Two of the main reasons for rolling certificates would be to address a security breach, and to address certificate expirations. 

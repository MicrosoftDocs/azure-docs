...
description: This quickstart uses individual enrollments. In this, you create and provision a simulated X.509 device using C device SDK for Azure IoT Hub Device Provisioning Service.
author: wesmc7777
ms.author: wesmc
ms.date: 07/16/2018
ms.topic: quickstart

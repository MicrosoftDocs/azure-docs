...
The registration ID of the individual enrollment that you'll create in the next section will be set to the subject common name on the certificate.  The registration ID for an individual enrollment is a case-insensitive string (up to 128 characters long) of alphanumeric characters plus the special characters: `'-'`, `'.'`, `'_'`, `':'`. The Last character must be alphanumeric or dash (`'-'`). Make sure that the certificate name you supply in the steps below adheres to these requirements.
...
2. Create a _leaf_ X.509 certificate by running the script using your own _certificate-name_. The leaf certificate's common name becomes the [Registration ID](./concepts-service.md#registration-id). The registration ID is a case-insensitive string (up to 128 characters long) of alphanumeric characters plus the special characters: `'-'`, `'.'`, `'_'`, `':'`. The Last character must be alphanumeric or dash (`'-'`). The _certificate-name_ parameter must adhere adhere to this convention.
...
The certificate file has its subject common name (CN) set to `Python-device-o1`. The registration ID of the device enrollment that you'll create in the next section is automatically set to the common name. The registration ID for an enrollment is a case-insensitive string (up to 128 characters long) of alphanumeric characters plus the special characters: `'-'`, `'.'`, `'_'`, `':'`. The Last character must be alphanumeric or dash (`'-'`). The common name must adhere to this naming convention.
...
3. Enter **N** for _Do you want to input common name_. This creates a certificate with a subject common name (CN) of _microsoftriotcore_. The registration ID of the device enrollment that you'll create in the next section is automatically set to the common name. The registration ID for an enrollment is a case-insensitive string (up to 128 characters long) of alphanumeric characters plus the special characters: `'-'`, `'.'`, `'_'`, `':'`. The Last character must be alphanumeric or dash (`'-'`). The common name must adhere to this naming convention.

...
## Quickstarts
### [Setup auto provisioning](quick-setup-auto-provision.md)
### [Create simulated device](quick-create-simulated-device.md)

## Tutorials
### [1 - Set up cloud](tutorial-set-up-cloud.md)
### [2 - Set up device](tutorial-set-up-device.md)
...
# How To
## How-to guides
### [1 - How to use different HSM with DPS Client SDK](how-to-use-hsm-with-SDK.md)

# Reference

# Related
## [Azure IoT Hub](https://azure.microsoft.com/documentation/suites/iot-hub/)

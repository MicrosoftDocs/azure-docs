...
| 415 | The server refuses to accept the request because the payload format is in an unsupported format. For supported formats, see [Iot Hub Device Provisioning Service REST API](https://docs.microsoft.com/en-us/rest/api/iot-dps/) | 415 Unsupported Media Type |

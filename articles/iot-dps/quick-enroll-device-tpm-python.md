...
description: Azure Quickstart - Enroll TPM device to Azure IoT Hub Device Provisioning Service using Python provisioning service SDK. Uses individual enrollment.
author: wesmc7777
ms.author: wesmc
ms.date: 01/26/2018
ms.topic: quickstart

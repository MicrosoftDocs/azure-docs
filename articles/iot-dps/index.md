---
title: Azure IoT DPS Documentation - Quick Starts, Tutorials, API Reference | Microsoft Docs
description: Learn how to use IoT DPS to provision devices to IoT Hub service on a large scale. Tutorials, API references, videos and other documentation.
services: iot-dps
author: carolz
manager: carolz
layout: LandingPage
...
# IoT DPS Documentation 
<!-------------------
Replace Hub specific information from here on with DPS
-->

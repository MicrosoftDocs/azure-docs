...
|------| --------- | ------------| -------------------|
| Manufacturer | Encode identity and registration URL | See the Developer role for details on how you get this information, for encoding into a sample registration application. |  Not applicable for Quickstarts.|
| | Provide device identity | See the Operator role for details on how you get this information, used for enrolling a simulated device. | Not applicable for Quickstarts. |

...
In addition to spanning weeks or months in production implementations, the phases discussed in the previous section also span multiple roles. This section takes takes a deeper look at the various roles and operations related to each phase, then illustrates the flow in a sequence diagram. 

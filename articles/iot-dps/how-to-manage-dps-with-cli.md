---
title: How to use Azure CLI 2.0 and the IoT extension to manage the IoT Hub Device Provisioning Service | Microsoft Docs
description: Learn how to use Azure CLI 2.0 and the IoT extension to manage the IoT Hub Device Provisioning Service
author: chrissie926
ms.author: menchi
ms.date: 01/17/2018
ms.topic: conceptual
...
# How to use Azure CLI 2.0 and the IoT extension to manage the IoT Hub Device Provisioning Service

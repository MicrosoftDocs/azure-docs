<properties pageTitle="How to create web test" description="Learn how to create web tests in Azure." services="application-insights" authors="alancameronwills" manager="kamrani"/>

...
> [!NOTE]
> When running the app, if you don't see the camera as the background (for instance you instead see a blank, blue or other textures) then you need to re-import assets in Unity. Stop the app, then in Unity, from the top menu choose "Assets -> Reimport all". Then run the app again.

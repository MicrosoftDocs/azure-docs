...
- A Windows or macOS machine with [Unity 2019.4 (LTS)](https://unity3d.com/get-unity/download?azure-portal=true), including the **Android Build Support** with **Android SDK & NDK Tools** and **OpenJDK** modules.
  - If running on Windows, you'll also need [Git for Windows](https://git-scm.com/download/win?azure-portal=true) and [Git LFS](https://git-lfs.github.com/?azure-portal=true).
...
- A [developer enabled](https://developer.android.com/studio/debug/dev-options?azure-portal=true) and [ARCore capable](https://developers.google.com/ar/discover/supported-devices?azure-portal=true) Android device.

...
Learn more about the [CloudSpatialAnchorSession](/cpp/api/spatial-anchors/winrt/cloudspatialanchorsession) class.
...
Learn more about the [SessionConfiguration](/cpp/api/spatial-anchors/winrt/sessionconfiguration) class.
...
Learn more about the [TokenRequiredDelegate](/cpp/api/spatial-anchors/winrt/tokenrequireddelegate) delegate.
...
Learn more about the [Start](/cpp/api/spatial-anchors/winrt/cloudspatialanchorsession#start) method.
...
Learn more about the [ProcessFrame](/cpp/api/spatial-anchors/winrt/cloudspatialanchorsession) method.
...
Learn more about the [SessionUpdatedDelegate](/cpp/api/spatial-anchors/winrt/sessionupdateddelegate) delegate.
...
Learn more about the [CloudSpatialAnchor](/cpp/api/spatial-anchors/winrt/cloudspatialanchor) class.
...
Learn more about the [GetSessionStatusAsync](/cpp/api/spatial-anchors/winrt/cloudspatialanchorsession#getsessionstatusasync) method.
...
Learn more about the [AppProperties](/cpp/api/spatial-anchors/winrt/cloudspatialanchor#appproperties) method.
...
Learn more about the [UpdateAnchorPropertiesAsync](/cpp/api/spatial-anchors/winrt/cloudspatialanchorsession#updateanchorpropertiesasync) method.
...
Learn more about the [GetAnchorPropertiesAsync](/cpp/api/spatial-anchors/winrt/cloudspatialanchorsession#getanchorpropertiesasync) method.
...
Learn more about the [Expiration](/cpp/api/spatial-anchors/winrt/cloudspatialanchor#expiration) method.
...
Learn more about the [CreateWatcher](/cpp/api/spatial-anchors/winrt/cloudspatialanchorsession#createwatcher) method.
...
Learn more about the [AnchorLocatedDelegate](/cpp/api/spatial-anchors/winrt/anchorlocateddelegate) delegate.
...
Learn more about the [Reset](/cpp/api/spatial-anchors/winrt/cloudspatialanchorsession#reset) method.

...
> [!NOTE]
> You'll note that we have included `[RequireComponent(typeof(SpatialAnchorManager))]` to the script, so Unity will make sure it has the SpatialAnchorManager script on the same GameObject.

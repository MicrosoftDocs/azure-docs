...
3. On the top menu, click **Applications**. If no apps have been added to your directory, this page only displays the **Add an App** link. Click the link, or alternatively you can click the **Add** button on the command bar.
4. On the **What do you want to do** page, click the link to **Add an application my organization is developing**.
...
Your application has been added, and you are taken to the Quick Start page for your application.
...
2. Scroll down to the **permissions to other applications** section. Click the **Add application** button and select the proxy application that you want to grant the native application access to, and click the check mark in the bottom right corner. From the **Delegated Permissions** drop-down menu, select the new permission.

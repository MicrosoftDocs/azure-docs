...
Application Proxy supports native client apps by accepting Azure AD issued tokens. The Application Proxy service performs authentication on behalf of the users. This solution does not use application tokens for authentication. 

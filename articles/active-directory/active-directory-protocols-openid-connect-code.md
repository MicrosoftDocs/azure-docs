...
| client_id |required |The Application Id assigned to your app when you registered it with Azure AD. You can find this in the Azure Classic Portal. Click **Active Directory**, choose the directory, choose the application, and click **Configure** |

...
4. In the search box, type **Flock**, select **Flock** from result panel then click **Add** button to add the application.
	...
	![Flock in the results list](./media/active-directory-saas-flock-tutorial/tutorial_flock_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as **SAML-based Sign-on** to enable single sign-on.
	...
	![Single sign-on dialog box](./media/active-directory-saas-flock-tutorial/tutorial_flock_samlbase.png)

3. On the **Flock Domain and URLs** section, perform the following steps:

	![Flock Domain and URLs single sign-on information](./media/active-directory-saas-flock-tutorial/tutorial_flock_url.png)
...
4. On the **SAML Signing Certificate** section, click **Certificate(Base64)** and then save the certificate file on your computer.
	...
	![The Certificate download link](./media/active-directory-saas-flock-tutorial/tutorial_flock_certificate.png)

5. Click **Save** button.

	![Configure Single Sign-On Save button](./media/active-directory-saas-flock-tutorial/tutorial_general_400.png)
...
6. On the **Flock Configuration** section, click **Configure Flock** to open **Configure sign-on** window. Copy the **SAML Entity ID and SAML Single Sign-On Service URL** from the **Quick Reference section.**
	...
	![Flock Configuration](./media/active-directory-saas-flock-tutorial/tutorial_flock_configure.png) 
...
8. Select **Authentication** tab from the left navigation panel and then select **SAML Authentication**.
	...
	![Flock Configuration](./media/active-directory-saas-flock-tutorial/configure1.png)

9. In the **SAML Authentication** section, perform the following steps:

	![Flock Configuration](./media/active-directory-saas-flock-tutorial/configure2.png)
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-flock-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-flock-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-flock-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-flock-tutorial/create_aaduser_04.png)
...
2. Click **Manage Team** from the left navigation panel.
    ...
    ![Add Employee](./media/active-directory-saas-flock-tutorial/user1.png)

3. Click **Add Member** tab and then select **Team Members**.

	![Add Employee](./media/active-directory-saas-flock-tutorial/user2.png)

4. Enter the email address of the user like **Brittasimon@contoso.com** and then select **Add Users**.

	![Add Employee](./media/active-directory-saas-flock-tutorial/user3.png)
...
2. In the applications list, select **Flock**.
	...
	![The Flock link in the Applications list](./media/active-directory-saas-flock-tutorial/tutorial_flock_app.png)

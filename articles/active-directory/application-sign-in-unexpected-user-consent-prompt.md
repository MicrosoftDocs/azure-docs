...
-   [Apps, permissions, and consent in Azure Active Directory (v1.0 endpoint)](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-apps-permissions-consent)

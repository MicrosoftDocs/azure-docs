...
4. In the search box, type **Skytap**, select **Skytap** from result panel then click **Add** button to add the application.
	...
	![Skytap in the results list](./media/active-directory-saas-skytap-tutorial/tutorial_skytap_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Single sign-on dialog box](./media/active-directory-saas-skytap-tutorial/tutorial_skytap_samlbase.png)
...
3. On the **Skytap Domain and URLs** section, perform the following steps if you wish to configure the application in **IDP** initiated mode:
	...
	![Skytap Domain and URLs single sign-on information](./media/active-directory-saas-skytap-tutorial/tutorial_skytap_url.png)
...
4. Check **Show advanced URL settings** and perform the following step if you wish to configure the application in **SP** initiated mode:
	...
	![Skytap Domain and URLs single sign-on information](./media/active-directory-saas-skytap-tutorial/tutorial_skytap_url1.png)

    In the **Sign-on URL** textbox, type a URL using the following pattern: `https://sso.connect.pingidentity.com/sso/sp/initsso?saasid=<custom saasID>&idpid=<custom idpid>`
	 
	> [!NOTE] 
	> These values are not real. Update these values with the actual Identifier and Sign-On URL. Contact [Skytap Client support team](mailto:support@skytap.com) to get these values. 

5. On the **SAML Signing Certificate** section, click **Metadata XML** and then save the metadata file on your computer.

	![The Certificate download link](./media/active-directory-saas-skytap-tutorial/tutorial_skytap_certificate.png) 

6. Click **Save** button.

	![Configure Single Sign-On Save button](./media/active-directory-saas-skytap-tutorial/tutorial_general_400.png)
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-skytap-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-skytap-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-skytap-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-skytap-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Skytap**.
	...
	![The Skytap link in the Applications list](./media/active-directory-saas-skytap-tutorial/tutorial_skytap_app.png)  

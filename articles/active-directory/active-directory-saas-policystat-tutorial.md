...
4. In the search box, type **PolicyStat**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-policystat-tutorial/tutorial_policystat_search.png)

5. In the results panel, select **PolicyStat**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-policystat-tutorial/tutorial_policystat_addfromgallery.png)
...
2. In the applications list, select **PolicyStat**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-policystat-tutorial/tutorial_policystat_app.png) 

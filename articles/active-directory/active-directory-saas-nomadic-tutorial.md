...
In this section, you enable Azure AD single sign-on in the Azure Management portal and configure single sign-on in your Nomadic application.
...
3. On the **Nomadic Domain and URLs** section perform the following steps:
	...
	b. In the **Identifer** textbox, type a URL using the following pattern: `https://<company name>.nomadic.fm/auth/saml2/sp`
...
In this section, you enable Britta Simon to use Azure single sign-on by granting her access to Nomadic.

...
* You can enable your users to automatically get signed-on to ICIMS single sign-on (SSO) with their Azure AD accounts
...
* A ICIMS single-sign on (SSO) enabled subscription
...
The objective of this section is to show you how to configure and test Azure AD SSO with ICIMS based on a test user called "Britta Simon".

For SSO to work, Azure AD needs to know what the counterpart user in ICIMS to an user in Azure AD is. In other words, a link relationship between an Azure AD user and the related user in ICIMS needs to be established.  
...
The objective of this section is to enable Azure AD SSO in the Azure classic portal and to configure SSO in your ICIMS application.
...
3. On the **Configure App Settings** dialog page, perform the following steps:
  ...
  1. In the Sign On URL textbox, type the URL used by your users to sign-on to your ICIMS application using the following pattern: `https://<tenant name>.icims.com`
  2. Click **Next**.
...
>[!NOTE]
>If you need to create an user manually, you need to contact the ICIMS support team.
> 

### Assign the Azure AD test user
The objective of this section is to enabling Britta Simon to use Azure SSO by granting her access to ICIMS.

...
3. **[Creating a Zscaler One test user](#creating-a-zscaler-one-test-user)** - to have a counterpart of Britta Simon in Zscaler One that is linked to the Azure AD representation of user.
...
To enable Azure AD users to log in to Zscaler One, they must be provisioned to Zscaler One.  
...
When you click the Zscaler One tile in the Access Panel, you should get login page of Zscaler One application.

...
1. On the top menu, click **Applications**, and then click the application you want to configure. The Quick Start page will appear with single sign-on and other configuration information. Click the **Configure** link at the top of the page, which will take you to the application's configuration page.

1. To add a secret key for your web application's credentials, scroll down to the "Keys" section.  
...
2. To add permission(s) to access resource APIs from your client, scroll down to the "Permissions to other applications" section. 
...
1. When finished, click the **Save** button on the command bar. If you specified a key for your application, it will also be generated after you click Save.

...
You can use the Azure portal to register your application with your Azure Active Directory (Azure AD) tenant. This will give you an Application ID for your application, as well as enable it to receive tokens.
...
6. Once you've completed registration, Azure AD will assign your application a unique client identifier, the Application ID.

## Update application settings from the Azure portal

You can easily modify an existing application's settings using the Azure portal. For example, you may want to configure a reply URL, which is where Azure AD will issue token responses. You may also want to configure permissions to other applications, for instance to allow your application to access the MS Graph API. You can do all this through the application settings page.

1. Sign in to the [Azure Portal](https://portal.azure.com).
2. Choose your Azure AD tenant by clicking on your account in the top right corner of the page.
3. In the left hand navigation pane, click on **Azure Active Directory**.
4. Click on **App Registrations** and choose your application from the list.
5. Click on **Settings** to open up the settings page for the application.
  * The **Properties** page allows you to configure the general information for the application, such as the application name, the sign-on URL and the logout URL.
  * The **Reply URLs** page allows you to add reply URLs, which is where Azure AD will send token responses.
  * The **Owners** page allows you to add application owners.
  * The **Permissions** page allows you to configure permissions for the app. For example, to access the MS Graph API, click on **Add** and select **Microsoft Graph** in the API selector, then choose the permission required, for example **Read Directory Data**.
...
3. In the left hand navigation pane, click on **Azure Active Directory**.
4. Click on **App Registrations** and choose your application from the list.
5. Click on **Manifest** from the application page to open the inline manifest editor.

...
- Review the [built in RBAC roles](../role-based-access-control/built-in-roles.md).
- Learn how to manage access assignments [by user](../role-based-access-control/role-assignments-users.md) or [by resource](../role-based-access-control/role-assignments-portal.md) 

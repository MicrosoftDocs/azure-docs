...
2. Click the check mark icon to run the report.
  - Up to 1000 events will be shown in the Azure Management Portal.

3. If applicable, click **Download** to download the report to a compressed file in Comma Separated Values (CSV) format for offline viewing or archiving purposes.

---
title: Delete a role/policy in the Remediation dashboard in Entra Permissions Management
...
This article describes how you can use the **Remediation** dashboard in Entra Permissions Management (Entra) to delete roles/policies for the Amazon Web Services (AWS), Microsoft Azure, or Google Cloud Platform (GCP) authorization systems.

...
1. From the ellipses **(...)** menu for that report, select **Generate & Download**. A new window appears where you'll provide more information for the report you want to generate.

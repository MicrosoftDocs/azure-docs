...
- You must be eligible for or have an active assignment to the super admin role as a user in that tenant.
...
1. In your browser:
    ...
    1. If you aren't already authenticated, sign in as a super admin user.
    1. If needed, activate the super admin role in your Azure AD tenant.

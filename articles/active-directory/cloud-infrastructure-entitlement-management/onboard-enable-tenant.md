...
:::image type="content" source="media/onboard-enable-tenant/dashboard.png" alt-text="A preview of what the Entra Permissions Management dashboard looks like." lightbox="media/onboard-enable-tenant/dashboard.png":::

...
> Public preview environment will be available only till October 7th, 2022. You will be no longer be able view or access your configuration and data in public preview environment after that date.

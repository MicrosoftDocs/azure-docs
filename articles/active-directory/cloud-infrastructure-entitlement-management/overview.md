...
- Deepen your learning with the [Introduction to Microsoft Entra Permissions Management](../../../../learn-pr/learn-pr/permissions-management/intro-to-entra-permissions-management/includes/1-introduction.md) learn module. 

...
- Deepen your learning with the [Introduction to Microsoft Entra Permissions Management](https://learn.microsoft.com/training/permissions-management/intro-to-entra-permissions-management/) learn module. 

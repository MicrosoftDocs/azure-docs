...
:::image type="content" source="media/overview/key-use-cases.png" alt-text="Screenshot of Microsoft Entra Permissions Management use cases." lightbox="media/overview/key-use-cases.png":::

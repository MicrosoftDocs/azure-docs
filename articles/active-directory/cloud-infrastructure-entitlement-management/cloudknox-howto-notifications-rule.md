...
description: How to wiew notification settings for a rule  in the Autopilot dashboard in CloudKnox Permissions Management.
...
1. To view notification settings for a rule, select **Notification settings**. 
    ...
    CloudKnox displays a list of subscribed users. These users are signed up to receive notification for the selected rule.

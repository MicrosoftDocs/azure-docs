...
19. To edit the policy, click the icon.

20. To save your edits, click the save icon.

21. To copy the policy to the clipboard, click the icon.
...
15. Click each statement to modify the operations (tasks and resources) further, if necessary, then click the icon.
...
18. To see if the policy needs to be split, in the **JSON** tab on the **Preview**screen, view the **character count**.
...
22. To copy the policy to the clipboard, click the icon. Then click **Submit**.
     ...
     - Click the hourglass to view the **Active** tab, which  displays the policies being created. 
       ...
       A green check mark with **Success** displays once the policy has been created, and the task moves to the **Completed** tab.
...
2. On the **Clone** screen, check the appropriate authorization systems or check **Authorization System** to select all.
...
7. For selected authorization systems, if the data collector has not been given controller privileges, the following message displays: 
   ...
   **Note: Only Online/Controller Enabled authorization systems can be submitted for cloning.** 
   ...
   The system administrator can download the script and JSON file to clone this role manually. 
...
3. Click **Delete** to remove the role/AWS policy.
...
1. Filter from the following options at the of the screen:
    ...
    - **Task Usage** - Select **Any**, **Granted**, **Used**, or **Unused**.
        ...
        - **Tasks** - To add tasks, click in this field to view a list of **Available Tasks**, and then click the icon.
...
3. Check the specific users that need their permissions changed.
...
2. Click next to the username to select the user and modify permissions.

     Click next to **Username** to select all users, or select users individually.
...
3. Click one of the following tabs to continue:
    ...
    - **Roles**
        1. Click the **Roles** tab to change users' role assignment.
        2. From the **Add Role** column, click the icon to select the roles you want to give to the user. 
        ...
        3. To move the role into the **Selected to Remove** block, from the **Remove Role** column, select the roles you want to remove and click the icon.
             ...
             Use **Search** at any time to search for a specific role or type of role.
    ...
    - **Tasks**
        ...
        3. To move the task into the **Selected to Revoke** block, from the **Revokable** column, select appropriate tasks that should be removed from the user, click the icon.
             ...
             Use the **Search** bar at any time to search for a specific task or type of task.
...
1. Click the **Role/Policy Template** tab from the top of the screen, and view the following table of information: 
     ...
     - To open the menu to **View/Edit** the template or **Delete** the template, click the icon.

         When choosing **Delete**, the **Delete Alert** pop up opens asking the user if they are sure they want to delete the template. Click **Yes** or **No**.

         The **View/Edit** option takes the user back to the Create screen to make updates. Once saved, **Role/Policy template has been successfully updated** is highlighted in green across the top of the screen.

2. Click **Create Template** from the upper right hand corner.

3. On the **Details** page, Select **AWS**, **Azure**, **GCP**, or **vCenter** from the **Authorization System Type**  drop down list.

4. Enter a name for the template in the **Template Name** box.

5. Click **Next**.

6. On the **Statements** page, the **Statement ID** box will be preloaded. 

     You can edit the pre-filled box if you want.

7. Under **Tasks**, select from the tasks under **Available Tasks** or use the **Search** bar to find a specific task. 
...
9. From the **Resources** section, select between **All Resources**, **Specific Resources**, or **Resource Template**.
     ...
     Hover over each option to view help text.

     For **Resource Template**, the user is provided with an example of what information needs to be included. The ARN, Service, Region, Account ID and Resource ID will need to be replaced with the correct information.
...
12. Click **Next**.
     ...
     The **Role/Policy template has been successfully Saved** message is highlighted in green at the top of the screen once all changes are completed.
...
4. Select the appropriate templates from the **Template Name** column.
...
6. Under **Resources**, update the information appropriately.
     ...
     For **Specific Resources** the user will search by **Resource Name** or **Resource Type** and click the icon under **Available Resources** to add to the **Selected Resources** column. Alternatively, you can enter the ARN and click **Add**. 

     For **Resource Template**, users will update the **region**, **account-id**, and **resource-id** boxes.

7. Under **Effect**, Select **Allow** or **Deny**.

8. Click **Next** and view the details are correct on the **Confirmation** page.

9. Fill in details of the request in the **Request Summary** box.

10. Click **Submit**.

11. **Validate OTP to Create JEP Request** box opens. Enter OTP from email and click **Verify**.

     If One Time Passcode (OTP) validation is disabled by the administrator, this step will not occur. 
     **See:** [Request Settings tab](cloudknox-prod-jep-controller.md#request-settings-tab)
...
1. Click the **Settings** tab from the top of the screen, and view the following table of information:
    ...
    - To open the menu to **View/Edit** the filter or **Delete** the filter, click the icon.

         When choosing **Delete**, the **Delete Alert** pop up opens asking the user if they are sure they want to delete the filter. Click **Yes** or **No**.
...
2. Enter a name for the filter into the **Filter Name** box.

3. In the **Authorization System Type** box, click the icon to view the details or to edit the details.
...
4. In the **Authorization System Is** box, click the icon to view the details 
    ...
    Or, to edit which **Authorization Systems** should be included, click the icon.
...
2. Under **Request Duration** the **Request Duration Limit** section is listed in **Hours** and the user can request the duration up to 4 hours, but not greater than 4 hours. 

     Hover over the information icon to the right of the hours dropdown to view a grid of when the settings will be applied.

3. Click **Save**.

11. Under **Request OTP Settings**, the OTP requirement can be toggled **On** or **Off** for both **Requests** and **My Requests**.
...
Once the request is submitted, then email is sent to the approver for the request, and the request appears in the approver's "Requests" tabs
...
Once the request is approved, CloudKnox will provision the permission for the requestor in the respective account. After the duration of the request has expired, CloudKnox will automatically remove the permission for the requestor
...
1. View the **Pending Requests** section for the following details:
    ...
    - **Tasks/Scope/Policies** - Summarizes the tasks and policies selected.
         ...
         Hover over the number listed to view more detailed information of the selected tasks/role/policy.
    ...
    - To perform the following actions, from the right hand side of the screen:
        - **Details** - Click **Details** to view the details of the request.

            The request can be approved or rejected from the detail view.

        - **Approve** - Click **Approve** to approve the request.

            Enter a reason of approval in **Approve Request** box, if necessary, and click **Confirm**.

        - **Reject** - Click **Reject** to reject the request.
...
2. View the **Approved Requests** section for the following details:
    ...
    - To perform the following actions, click the icon from the right hand side of the screen:
        - **Details** - Click **Details** to view the details of the approval.
        - **Cancel** - Click **Cancel** to cancel the approval.
...
3. View the **Processed Requests** section for the following details:
    ...
    Click the icon from the right hand side of the screen to perform the following actions:

     - **Details** - Click **Details** to view the details of the approval.
     - **Delete** - Click **Delete** to delete the approval.
...
5. Click the **Columns** button to  display or hide certain columns, then click the icon next to the column name.
...
1. View the **Pending Requests** section for the following details:
    ...
    - Click the icon from the right hand side of the screen .to perform the following actions:
        - **Details** - Click **Details** to view the details of the request.
        - **Cancel** - Click **Cancel** to cancel the request.
...
3. Select the appropriate option from the **Auth System** dropdown.
    ...
    - **AWS**
        ...
        4. Select the appropriate policies, tasks, or templates from the **Available Policies** or **Available Tasks** column, and to add them to the **Selected Policies** or **Selected Tasks** column, click the icon.

             Users may search for a specific policy, task, or template using the search bar, and can filter search option by clicking the **All**  drop down list and selecting **All**, **System**, **Custom**, or **CloudKnox Only**.

             To view details about the policy or task, click the icon next to the policy or task name.

        5. View the **Existing Policies** section to see a list of roles that are attached to the select user.
        6. Click **Next**.

             If **Request Task(s)** was selected then the next section will be **Scope**, and the following steps need to be completed:

            - In the **Resource** section, select between **All Resources**, **Specific Resources**, and **Not Resource** can be checked in addition.

                 For **Specific Resources**, click the icon from the **Available Resources** column to move the selection to the **Selected Resources** column. Users may also use the **Search** bar to find a specific resource.

            - From **Request Conditions**, users have the option to click the icon next to **JSON** and enter details in the **Add JSON** box. Click **Done**.
        ...
        9. Click in the **Schedule** section to set schedule details:
            - From the **Frequency**  drop down list, select between **ASAP**, **Once**, **Daily**, **Weekly**, or **Monthly**.

                 If **ASAP** is selected, the user still has to wait for the approver to approve the request; the request is not given immediately.

                Enter **Date** and **Time** details if **Once**, **Daily**, **Weekly**, or **Monthly** was selected.
    ...
    - **Azure/GCP/VCENTER**
        ...
        4. Select the appropriate policies or tasks from the **Select Roles** or **Available Tasks** column and then click the icon to add it to the **Selected Roles** or **Selected Tasks** column.
             ...
             You can search for a specific role or task using **Search**. You can filter your results by clicking the **All**  drop down list and then selecting **All**, **System**, **Custom**, or **CloudKnox Only**.

        5. View the **Existing Roles** section to see a list of roles that are attached to the select user.
        6. Click **Next**.
        7. Enter details in the **Request Summary** field.
        8. Add notes, if needed, to the **Notes (Optional)** field.
        9. Click in the **Schedule** section to set schedule details:
            - From the **Frequency**  drop down list, select between **ASAP**, **Once**, **Daily**, **Weekly**, or **Monthly**.
                ...
                **Note:** Input **Date** and **Time** details if **Once**, **Daily**, **Weekly**, or **Monthly** was selected.

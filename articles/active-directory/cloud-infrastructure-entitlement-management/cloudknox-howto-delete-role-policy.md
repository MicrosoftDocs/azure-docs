---
title: Delete a role/policy in the JEP Controller in CloudKnox Permissions Management 
...
This article describes how you can use the JEP Controller in CloudKnox Permissions Management to delete roles/policies for the Amazon Web Services (AWS), Microsoft Azure, or Google Cloud Platform (GCP) authorization systems. 

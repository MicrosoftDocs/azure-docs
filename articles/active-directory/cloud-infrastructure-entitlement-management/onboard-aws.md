---
title:  Onboard an Amazon Web Services (AWS) account on Entra Permissions Management
description: How to onboard an Amazon Web Services (AWS) account on Entra Permissions Management.
...
1. If your organization has Service Control Policies (SCPs) that govern some or all of the member accounts, set up the master account connection in the **Entra Onboarding - AWS Master Account Details** page.
    ...
    Setting up the master account connection allows Entra to auto-detect and onboard any AWS member accounts that have the correct Entra role.

    - In the **Entra Onboarding - AWS Master Account Details** page, enter the **Master Account ID** and **Master Account Role**.

1. Open another browser window and sign in to the AWS console for your master account.

1.  Return to Entra, and in the **Entra Onboarding - AWS Master Account Details** page, select **Launch Template**.
...
1. If your organization has a central logging account where logs from some or all of your AWS account are stored, in the **Entra Onboarding - AWS Central Logging Account Details** page, set up the logging account connection.
    ...
    In the **Entra Onboarding - AWS Central Logging Account Details** page, enter the **Logging Account ID** and **Logging Account Role**.

1. In another browser window, sign in to the AWS console for the AWS account you use for central logging.

1.  Return to Entra, and in the **Entra Onboarding - AWS Central Logging Account Details** page, select **Launch Template**.
...
1. Return to the **Entra Onboarding - AWS Member Account Details** page, select **Launch Template**.
...
1. Return to Entra, and in the **Entra Onboarding - AWS Member Account Details** page, select **Next**.

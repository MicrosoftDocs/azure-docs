...
| **Additional methods**||
|Password <br>**AND**<br>Hybrid Azure AD Joined or compliant device with hardware protection<sup data-htmlnode="">1 |Memorized secret <br>**AND**<br>Single-factor cryptographic hardware|
...
<sup data-htmlnode="">1</sup>Hardware protection can be achieved by either an embedded processor or execution enviornment such as trusted platform module (TPM) or trusted execution enviornment (TEE).

...
- The licensing requirements differ. For each paid Azure AD license, you can let up to 5 guest users access your paid Azure AD features. To learn more about licensing, see [Azure AD B2B licensing](./external-identities-pricing.md) and ["What is an external user?" in the SharePoint Online external sharing overview](/sharepoint/external-sharing-overview#what-happens-when-users-share).

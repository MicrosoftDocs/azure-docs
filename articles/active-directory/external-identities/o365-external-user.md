...
- The licensing requirements differ. To learn more about licensing, see the [SharePoint Online external sharing overview](https://docs.microsoft.com/sharepoint/external-sharing-overview).

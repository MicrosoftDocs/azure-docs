...
|  **Billing model**  |  Pricing is based on monthly active users (MAU). For details specific to Azure AD B2B, see [External Identities pricing](external-identities-pricing.md).  |  Pricing is based on monthly active users (MAU). For details specific to Azure AD B2B, see [Azure AD B2C billing model](../../active-directory-b2c/billing.md)  |

...
| **Intended for**    | Organizations that want to be able to authenticate users from a partner external organization, regardless of identity provider.    | Providing customers (individual, institutional, or organizational customers) with sign-up and sign-in to your mobile and web apps. Customers are managed in a separate Azure AD directory from your own organization's directory. |

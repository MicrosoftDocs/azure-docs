...
In this article, you prepare your Microsoft Entra External ID for customers tenant for authentication. This tutorial is part of a series that guides you through the steps of building an app that authenticates users against External ID for Customers using the device code flow.

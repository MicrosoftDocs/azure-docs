...
description: Learn how to configure your Microsoft Entra External ID for customers tenant for authentication with a Vanilla JavaScript single-page app (SPA).
...
ms.topic: tutorial
ms.date: 08/17/2023
#Customer intent: As a developer, I want to learn how to configure a Vanilla JavaScript single-page app (SPA) to sign in and sign out users with my Microsoft Entra External ID for customers tenant.
---

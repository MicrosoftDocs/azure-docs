...
During customer tenant creation, the **Country/Region** dropdown menu lists countries and regions where Azure Microsoft Entra ID for customers isn't yet available. If you choose Japan or Australia, tenant creation fails.

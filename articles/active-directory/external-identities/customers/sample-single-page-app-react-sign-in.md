...
1. Open _SPA\src\authConfig.js_ and replace the following with the values obtained from the Microsoft Entra admin center
    ...
    * `authority` - The identity provider instance and sign-in audience for the app. Replace `Enter_the_Tenant_Name_Here` with the name of your Microsoft Entra External ID for customers tenant.

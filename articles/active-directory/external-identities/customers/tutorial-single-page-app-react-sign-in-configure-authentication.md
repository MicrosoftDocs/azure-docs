...
description: Learn how to configure authentication for a React single-page app (SPA) with your Microsoft Entra External ID for customers tenant.
...
#Customer intent: As a developer, I want to learn how to configure a React single-page app (SPA) to sign in and sign out users with my Microsoft Entra External ID for customers tenant.
---

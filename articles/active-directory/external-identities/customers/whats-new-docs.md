...
- [Tutorial: Prepare your customer tenant to authenticate users in a React single-page app (SPA)](tutorial-single-page-application-react-prepare-tenant.md) - Fixed SPA aligning content styling

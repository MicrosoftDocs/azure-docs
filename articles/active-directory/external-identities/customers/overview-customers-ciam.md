...
If you're a new customer, you might be wondering which solution is a better fit, [Azure AD B2C](https://learn.microsoft.com/en-us/azure/active-directory-b2c/) or Microsoft Entra External ID (preview). Opt for the current Azure AD B2C product if:

...
- **Azure AD customer tenant** – Create a tenant specifically for your customer-facing apps and services. Register your customer-facing apps in this tenant, and manage customer identities and access in the dedicated directory.
...
In the Azure portal, you can create an Azure AD customer tenant where you manage customer identities and customer access to your application.

---
title: Sign in users in your own Node.js browserless application by using Microsoft Entra - Overview
description: Learn how to configure a browserless application to sign in and sign out users by using Microsoft Entra - Overview.
...
If you want to run a sample Node.js browserless application rather than building it from scratch, complete the steps in [Sign in users in a sample Node.js browserless application by using Microsoft Entra](how-to-browserless-app-node-sample-sign-in.md)

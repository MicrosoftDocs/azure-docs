...
description: Learn how to configure a Vanilla JavaScript single-page app (SPA) to sign in and sign out users with your Microsoft Entra External ID for customers tenant.
...
1. In the **Create account** window, enter the email address registered to your Microsoft Entra External ID for customers tenant, which starts the sign-up flow as a user for your application.

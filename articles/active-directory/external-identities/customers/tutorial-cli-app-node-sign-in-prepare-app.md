...
description: Learn how to build a Node.js CLI application that signs in users in a Microsoft Entra External ID for customers tenant
...
#Customer intent: As a dev, devops, I want to learn how to build a Node.js CLI application that signs in users in a Microsoft Entra External ID for customers tenant.
---

---
title: "Tutorial: Secure an ASP.NET web API registered in the Microsoft Entra ID for customer's tenant"
description: Learn how to secure a ASP.NET web API registered in the Microsoft Entra ID for customer's tenant
...
#Customer intent: As a dev, I want to secure my ASP.NET Core web API registered in the Microsoft Entra customer's tenant.
---

# Tutorial: Secure an ASP.NET web API registered in the Microsoft Entra ID for customer's tenant

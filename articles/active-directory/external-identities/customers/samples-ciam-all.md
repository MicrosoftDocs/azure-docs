...
> | ASP.NET (MAUI) | &#8226; [Sign in users](how-to-desktop-app-maui-sample-sign-in.md) |&#8226; [Register and configure](tutorial-desktop-app-maui-sign-in-prepare-tenant.md)|
...
> | Language/<br/>Platform | Code sample guide | Build and integrate guide |
> | ----------- | ----------- |----------- |
> | ASP.NET Core MAUI | &#8226; [Sign in users](how-to-mobile-app-maui-sample-sign-in.md) | &#8226; [Register and configure](tutorial-mobile-app-maui-sign-in-prepare-tenant.md)|
...
> | .NET |  ---   |  &#8226; [Register and configure](tutorial-daemon-dotnet-call-api-prepare-tenant.md)  |
...
> | Daemon |  ---   | &#8226; [Register and configure](tutorial-daemon-dotnet-call-api-prepare-tenant.md)   |
...
> | App type | Code sample guide | Build and integrate guide  |
> | ------- | -------- | ------------- |
> | Desktop | &#8226; [Sign in users](how-to-desktop-app-maui-sample-sign-in.md) | &#8226; [Register and configure](tutorial-desktop-app-maui-sign-in-prepare-tenant.md)   |
> | Mobile |  &#8226; [Sign in users](how-to-mobile-app-maui-sample-sign-in.md) | &#8226; [Register and configure](tutorial-mobile-app-maui-sign-in-prepare-tenant.md)   |

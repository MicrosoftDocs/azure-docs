---
title: How-to - Register an app in Microsoft Entra ID for customers
...
To enable your application to sign in with Microsoft Entra ID for customers, you need to register your app in the Microsoft Entra ID for customers. The app registration establishes a trust relationship between the app and Microsoft Entra ID for customers.
During app registration, you specify the redirect URI. The redirect URI is the endpoint to which users are redirected by Microsoft Entra ID for customers after they authenticate. The app registration process generates an application ID, also known as the client ID, that uniquely identifies your app.

Microsoft Entra ID for customers supports authentication for various modern application architectures, for example web app or single-page app. The interaction of each application type with the customer tenant is different, therefore, you must specify the type of application you want to register.
...
Microsoft Entra ID for customers supports authentication for Single-page apps (SPAs).
...
Microsoft Entra ID for customers supports authentication for web apps.

---
title: Call an API in your dotnet daemon application - prepare client app and web API
description: Learn about how to prepare your dotnet client daemon app and ASP.NET web API. The app you here prepare is what you configure later to sign in users, then call the web API.

...
> [!NOTE]
> For the Azure service operated by [21Vianet in China](https://learn.microsoft.com/azure/china/), the sender address is Invites@oe.21vianet.com.  
> For the [Azure AD Government](https://learn.microsoft.com/azure/azure-government/), the sender address is invites@azuread.us.

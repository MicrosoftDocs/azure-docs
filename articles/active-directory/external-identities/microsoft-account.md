...
:::image type="content" source="media/microsoft-account/microsoft-account-invite.png" alt-text="Invite using a Microsoft account":::
...
:::image type="content" source="media/microsoft-account/microsoft-account-user-flow.png" alt-text="Microsoft account in a self-service sign-up user flow":::

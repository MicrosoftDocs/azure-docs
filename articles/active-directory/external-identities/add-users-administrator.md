...
5. On the **New user** page, select **Invite user** and then add the guest user's information.
   ...
   -  **Roles**: If you require Azure AD administrative permissions for the user, you can add them to an Azure AD role by selecting **User** next to **Roles**.  [Learn more](https://docs.microsoft.com/azure/role-based-access-control/role-assignments-external-users) about Azure roles for external guest users.

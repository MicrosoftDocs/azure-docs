...
After you send the invitation, the user account is automatically added to the directory as a guest. The **Sponsor** (preview) field on the guest user account is updated by default with the user, who sends the invitation.

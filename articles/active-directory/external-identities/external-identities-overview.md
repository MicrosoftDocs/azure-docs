...
| **Line-of-business (LOB) apps**  | Sharing business apps with collaborators is supported.  | Lob apps work with direct connect-enabled apps, but they don’t work for B2B direct apps. Remember that B2B direct connect only works with Teams shared channels.  | Works with [RESTful API](../../active-directory-b2c/technical-overview.md#add-your-own-business-logic-and-call-restful-apis).   |

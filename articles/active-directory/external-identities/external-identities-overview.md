...
| **Entitlement management**  | [Supported.](../../active-directory/governance/entitlement-management-overview)  | Not supported. | Not applicable. |
| **Line-of-business (LOB) apps**  | Sharing business apps with collaborators is supported.  | Lob apps work with direct connect-enabled apps, but they don’t work for B2B direct apps. Remember that B2B direct connect only works with Teams shared channels.  | Works with [RESTful API](../../active-directory-b2c/technical-overview#add-your-own-business-logic-and-call-restful-api ).   |
...
| **Microsoft cloud settings**  | [Supported.](cross-cloud-settings.md)  | [Not supported.](cross-cloud-settings.md) | PLACEHOLDER   |
| **Entitlement management**  | [Supported.](../../active-directory/governance/entitlement-management-overview.md)  | Not supported. | PLACEHOLDER   |
| **Line-of-business (LOB) apps**  | Sharing business apps with collaborators is supported.  | Works with direct connect-enabled apps, doesn't work for B2B direct apps. | Works with [RESTful API](../../active-directory-b2c/technical-overview.md#add-your-own-business-logic-and-call-restful-api ).   |

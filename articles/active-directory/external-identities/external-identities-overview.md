...
| **Entitlement management**  | [Supported.](../../active-directory/governance/entitlement-management-overview)  | Not supported. | PLACEHOLDER   |
| **Line-of-business (LOB) apps**  | Sharing business apps with collaborators is supported.  | Works with direct connect-enabled apps, doesn't work for B2B direct apps. | Works with [RESTful API](../../active-directory-b2c/technical-overview#add-your-own-business-logic-and-call-restful-api ).   |
=======
...
>>>>>>> c549a8c6f0faaf2500427c4cecba763bb43810c7

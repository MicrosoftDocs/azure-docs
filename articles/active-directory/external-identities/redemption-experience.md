...
1. Azure AD performs user-based discovery to determine if the user exists in an [existing Azure AD tenant](./what-is-b2b.md#easily-add-guest-users-in-the-azure-ad-portal).

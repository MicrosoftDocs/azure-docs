...
> [!TIP]
> This article applies to workforce tenants. For customer tenant information, see [Add Google as an identity provider](customers/how-to-google-federation-customers.md).

...
> [!TIP]
> This article applies to workforce tenants. For customer tenant information, see [Create a sign-up and sign-in user flow for customers](/customers/how-to-user-flow-sign-up-sign-in-customers.md).

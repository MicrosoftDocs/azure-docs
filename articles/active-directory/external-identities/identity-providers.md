...
> [!TIP]
> This article applies to workforce tenants. For customer tenant information, see [Authentication methods and identity providers for customers](customers/concept-authentication-methods-customers.md).

...
You can [enable integration with SharePoint and OneDrive](/sharepoint/sharepoint-azureb2b-integration.md) to share files, folders, list items, document libraries, and sites with people outside your organization, while using Azure B2B for authentication and management. These recipients will typically be added to your directory as guests. Then permissions and groups work the same for these guests as they do for internal users.

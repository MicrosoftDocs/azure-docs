...
> [!TIP]
> This article applies to workforce tenants. For customer tenant information, see [Add Facebook as an identity provider](customers/how-to-facebook-federation-customers.md).

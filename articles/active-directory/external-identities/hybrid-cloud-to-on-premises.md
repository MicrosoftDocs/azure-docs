...
Note: You must ensure that Delegated Logon Identity must be set to "User principal name" (default) in the Single sign-on configuration for Integrated Windows Authentication (IWA) when configuring Azure AD Application Proxy configuration.

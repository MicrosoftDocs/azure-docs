...
Identity Protection detects sign-ins from unfamiliar locations also for basic authentication / legacy protocols. Because these protocols do not have modern familiar features such as client id, there is less telemetry to reduce false positives. To reduce the number of detectectes risk events, you should move to modern authentication.   
...
![Risk Level](./media/active-directory-reporting-risk-events/01.png)

...
## Custom scheduler
The cmdlets documented in this section are only available in build [1.1.130.0](active-directory-aadconnectsync-connector-version-history.md#11130) and later.
...
In the picture above, the first line is from a state where the sync engine is idle. The second from when the Azure AD Connector is running.

...
3. **[Creating an Adaptive Suite test user](#creating-a-adaptive-suite-test-user)** - to have a counterpart of Britta Simon in Adaptive Suite that is linked to the Azure AD representation of user.

...
4. In the search box, type **SAML 1.1 Token enabled LOB App**, select **SAML 1.1 Token enabled LOB App** from result panel then click **Add** button to add the application.
	...
	![SAML 1.1 Token enabled LOB App in the results list](./media/active-directory-saas-saml-tutorial/tutorial_saml_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Single sign-on dialog box](./media/active-directory-saas-saml-tutorial/tutorial_saml_samlbase.png)
...
5. On the **SAML Signing Certificate** section, click **Certificate (Base64)** and then save the certificate file on your computer.
	...
	![The Certificate download link](./media/active-directory-saas-saml-tutorial/tutorial_saml_certificate.png) 

6. Click **Save** button.

	![Configure Single Sign-On Save button](./media/active-directory-saas-saml-tutorial/tutorial_general_400.png)
...
7. On the **SAML 1.1 Token enabled LOB App Configuration** section, click **Configure SAML 1.1 Token enabled LOB App** to open **Configure sign-on** window. Copy the **Sign-Out URL, SAML Entity ID, and SAML Single Sign-On Service URL** from the **Quick Reference section.**
	...
	![SAML 1.1 Token enabled LOB App Configuration](./media/active-directory-saas-saml-tutorial/tutorial_saml_configure.png) 
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-saml-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-saml-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-saml-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-saml-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **SAML 1.1 Token enabled LOB App**.

	![The SAML 1.1 Token enabled LOB App link in the Applications list](./media/active-directory-saas-saml-tutorial/tutorial_saml_app.png)  
...
[1]: ./media/active-directory-saas-saml-tutorial/tutorial_general_01.png
[2]: ./media/active-directory-saas-saml-tutorial/tutorial_general_02.png
[3]: ./media/active-directory-saas-saml-tutorial/tutorial_general_03.png
[4]: ./media/active-directory-saas-saml-tutorial/tutorial_general_04.png

[100]: ./media/active-directory-saas-saml-tutorial/tutorial_general_100.png

[200]: ./media/active-directory-saas-saml-tutorial/tutorial_general_200.png
[201]: ./media/active-directory-saas-saml-tutorial/tutorial_general_201.png
[202]: ./media/active-directory-saas-saml-tutorial/tutorial_general_202.png
[203]: ./media/active-directory-saas-saml-tutorial/tutorial_general_203.png

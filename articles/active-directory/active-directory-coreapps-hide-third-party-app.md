...
If you have a third-party application (apps published by others than Microsoft) that you do not want to show up on user’s access panels or O365 launchers, there is an option to hide these app tiles. By hiding the app users still have permissions to the app but will not see them appear on their app launchers. You must have the appropriate permissions to manage the enterprise app, and you must be global admin for the directory.

...
4. In the search box, type **Synergi**, select **Synergi** from result panel then click **Add** button to add the application.
	...
	![Synergi in the results list](./media/active-directory-saas-synergi-tutorial/tutorial_synergi_addfromgallery.png)
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-synergi-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Synergi**.
	...
	![The Synergi link in the Applications list](./media/active-directory-saas-synergi-tutorial/tutorial_synergi_app.png)  

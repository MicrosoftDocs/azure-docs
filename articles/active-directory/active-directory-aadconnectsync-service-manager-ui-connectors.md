...
**Error**  
The error page is only visible if there is a problem with the object. See the details on the operations page for more information on how to [troubleshoot synchronization errors](active-directory-aadconnectsync-service-manager-ui-connectors.md#troubleshoot-errors-in-operations-tab).
...
From the lineage tab you can get to the [metaverse object](#metaverse-object-properties).

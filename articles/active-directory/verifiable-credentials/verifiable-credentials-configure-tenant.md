...
If you don't have an instance of Azure Key Vault, follow [these steps](../../key-vault/general/quick-create-portal) to create a key vault by using the Azure portal.

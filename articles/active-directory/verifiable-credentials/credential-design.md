...
## Display definition : Visuals for the credential in the Wallet
...
* **ID token**: When this option is configured, you'll need to provide an Open ID Connect configuration URI and include the claims that should be included in the verifiable credential. Users are prompted to 'Sign in' on the Authenticator app to meet this requirement and add the associated claims from their account. To configure this option, please see this [how to guide](how-to-use-quickstart-idtoken.md)

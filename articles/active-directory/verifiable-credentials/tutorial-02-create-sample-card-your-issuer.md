...
7. In the **Select**: Choose the account that you are using to perform these steps.
...
8. Select **vc-container** from the list of available containers
9. Choose **display-example.json**.
10. From the **Create a new credential** page Select rules file**
11. In **Storage accounts** select **contosovcstorage**
...
1. Open up **Settings** in the verifiable credentials blade in Azure portal. Copy the Issuer identifier.
  ...
  ![copy the issuer identifier](media/tutorial-create-sample-card-your-issuer/ovlIGdJ.png)

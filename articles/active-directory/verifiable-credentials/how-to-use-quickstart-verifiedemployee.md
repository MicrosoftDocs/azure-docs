...
All of the claims in the Verified employee credential come from attributes in the [user's profile](https://docs.microsoft.com/graph/api/resources/user?view=graph-rest-1.0) in Azure AD for the issuing tenant. All claims, except photo, come from the Microsoft Graph Query [https://graph.microsoft.com/v1.0/me](https://docs.microsoft.com/graph/api/user-get?view=graph-rest-1.0&tabs=http). The photo claim comes from the value returned from the Microsoft Graph Query [https://graph.microsoft.com/v1.0/me/photo/$value.](https://docs.microsoft.com/graph/api/profilephoto-get?view=graph-rest-1.0)
...
See full Azure AD user profile properties reference [here](https://docs.microsoft.com/graph/api/resources/user?view=graph-rest-1.0#properties).

...
- We made updates to the Request Service REST API for [issuance](issuance-request-api#callback-type.md?#callback-type) and [presentation](presentation-request-api.md?#callback-type)

...
3. Choose an option to register for by clicking **set it up now**. In this case, I'll demonstrate registering my **authentication phone**. Your administrator may require you to register for more than one option. 

   ![][101]
4. Select your country code from the dropdown and enter your **full phone number including area code** and choose **text me** or **call me** either option will provide you a code in this example I chose text me.
...
4. Choose an option to reset your password. Depending on how your admin has configured the system, you might see one or more of the following choices:
   ...
   * **Answer my security questions** - displays your pre-registered security questions for you to answer.
   ...
   ![][109]
5. We'll use the "text my mobile phone" option as an example. If you are using a phone based option, you'll need to verify your phone number before we'll send a text. Enter your full phone number and then click **Text** to verify it's correct and send a text.
...
10. Once your password is accepted you are good to go! You can now sign in with your new password.

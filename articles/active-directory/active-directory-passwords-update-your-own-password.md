<properties
	pageTitle="How to: Register to reset your Azure AD Password | Microsoft Azure"
	description="Learn how to register for password reset in Azure Active Directory"
...
* [**How to unlock your account**](active-directory-passwords-update-methods.md#how-to-unlock-your-account)
* [**Common problems and their solutions**](active-directory-passwords-update-methods.md#common-problems-and-their-solutions)

## Links to password reset documentation
Below are links to all of the other Azure AD password management documentation pages:

...
* You can enable your users to automatically get signed-on to Skilljar single sign-on (SSO) with their Azure AD accounts
...
* A Skilljar SSO enabled subscription
...
The objective of this section is to show you how to configure and test Azure AD SSO with Skilljar based on a test user called "Britta Simon".

For SSO to work, Azure AD needs to know what the counterpart user in Skilljar to an user in Azure AD is. In other words, a link relationship between an Azure AD user and the related user in Skilljar needs to be established.  
...
The objective of this section is to enable Azure AD single sign-on in the Azure classic portal and to configure SSO in your Skilljar application.

**To configure Azure AD SSO with Skilljar, perform the following steps:**
...
4. On the **Configure single sign-on at Skilljar** page, perform the following steps:
  ...
  2. Copy the **Name Identifier Format** value.
  3. Click **Next**.
...
The objective of this section is to enabling Britta Simon to use Azure SSO by granting her access to Skilljar.

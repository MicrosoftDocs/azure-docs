...
4. Check **Show advanced URL settings** and perform the following step if you wish to configure the application in **SP** initiated mode:
	...
	> [!NOTE] 
	> Sign-on URL value is not a real value. Update this value with the actual Sign-On URL. Contact [ClearCompany Client support team](support@clearcompany.com) to get this value. 
...
8. To configure single sign-on on **ClearCompany** side, you need to send the downloaded **Certificate(Base64)** and **SAML Single Sign-On Service URL** to [ClearCompany support team](support@clearcompany.com). They set this setting to have the SAML SSO connection set properly on both sides.
...
In this section, you create a user called Britta Simon in ClearCompany. Work with [ClearCompany support team](support@clearcompany.com) to add the users in the ClearCompany platform. Users must be created and activated before you use single sign-on.

---
title: Understand user tokens in Azure Active Directory B2B collaboration | Microsoft Docs
...
# Understand user tokens in Azure Active Directory B2B collaboration

If you're interested in knowing what the token looks like for a B2B collaboration user, here are the bearer token details and token content for AAD Guest and MSA Guest in the resource tenant (for tenantid:04dcc6ab-388a-4559-b527-fbec656300ea). You can use [https://jwt.io/](https://jwt.io/) or [http://calebb.net](http://calebb.net/)/ to see the JWT token contents.

## Azure AD guest user token
```

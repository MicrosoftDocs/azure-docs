...
4. In the search box, type **T&E Express**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-t&eexpress-tutorial/tutorial_t&eexpress_search.png)

5. In the results panel, select **T&E Express**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-t&eexpress-tutorial/tutorial_t&eexpress_addfromgallery.png)
...
2. On the **Single sign-on** dialog, as **Mode** select **SAML-based Sign-on** to enable single sign on.
	...
	![Configure Single Sign-On](./media/active-directory-saas-t&eexpress-tutorial/tutorial_t&eexpress_samlbase.png)

3. On the **T&E Express Domain and URLs** section, perform the following steps:

	![Configure Single Sign-On](./media/active-directory-saas-t&eexpress-tutorial/tutorial_t&eexpress_url.png)
...
5. On the **SAML Signing Certificate** section, click **Metadata XML** and then save the XML file on your computer.
	...
	![Configure Single Sign-On](./media/active-directory-saas-t&eexpress-tutorial/tutorial_t&eexpress_certificate.png) 

6. Click **Save** button.

	![Configure Single Sign-On](./media/active-directory-saas-t&eexpress-tutorial/tutorial_general_400.png)
...
9. Under the **Admin** Tab, Click on **SAML domain** to Open the SAML settings page.
	...
	![Configure Single Sign-On](./media/active-directory-saas-t&eexpress-tutorial/T&E-SAML.png)
...
10. Select the **Activar(Activate)** option from **No** to **SI(Yes)**. In the **Identity Provider Metadata** textbox, paste the metadata XML which you have donwloaded from Azure portal.
	...
	![Configure Single Sign-On](./media/active-directory-saas-t&eexpress-tutorial/T&EAdmin.png)
...
1. In the **Azure Management portal**, on the left navigation pane, click **Azure Active Directory** icon.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-t&eexpress-tutorial/create_aaduser_01.png) 

2. Go to **Users and groups** and click **All users** to display the list of users.
	
	![Creating an Azure AD test user](./media/active-directory-saas-t&eexpress-tutorial/create_aaduser_02.png) 

3. At the top of the dialog click **Add** to open the **User** dialog.
 
	![Creating an Azure AD test user](./media/active-directory-saas-t&eexpress-tutorial/create_aaduser_03.png) 

4. On the **User** dialog page, perform the following steps:
 
	![Creating an Azure AD test user](./media/active-directory-saas-t&eexpress-tutorial/create_aaduser_04.png) 
...
2. Under Admin tag, click on Users to open the Users master page.
    ...
    ![Add Employee](./media/active-directory-saas-t&eexpress-tutorial/T&E-adminusers.png)

3. On the home page, click on **+** to add the users.

	![Add Employee](./media/active-directory-saas-t&eexpress-tutorial/T&EUsersHome.png)

4. Enter all the mandatory details as asked in the form and click the save button to save the details.

	![Add Employee](./media/active-directory-saas-t&eexpress-tutorial/T&E-usersadd.png)

	![Add Employee](./media/active-directory-saas-t&eexpress-tutorial/T&E-userssave.png)
...
2. In the applications list, select **T&E Express**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-t&eexpress-tutorial/tutorial_t&eexpress_app.png) 
...
[1]: ./media/active-directory-saas-t&eexpress-tutorial/tutorial_general_01.png
[2]: ./media/active-directory-saas-t&eexpress-tutorial/tutorial_general_02.png
[3]: ./media/active-directory-saas-t&eexpress-tutorial/tutorial_general_03.png
[4]: ./media/active-directory-saas-t&eexpress-tutorial/tutorial_general_04.png

[100]: ./media/active-directory-saas-t&eexpress-tutorial/tutorial_general_100.png

[200]: ./media/active-directory-saas-t&eexpress-tutorial/tutorial_general_200.png
[201]: ./media/active-directory-saas-t&eexpress-tutorial/tutorial_general_201.png
[202]: ./media/active-directory-saas-t&eexpress-tutorial/tutorial_general_202.png
[203]: ./media/active-directory-saas-t&eexpress-tutorial/tutorial_general_203.png

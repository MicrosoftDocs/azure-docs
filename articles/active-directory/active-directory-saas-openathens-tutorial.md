...
- You can enable your users to automatically get signed-on to OpenAthens (Single Sign-On) with their Azure AD accounts.
...
For single sign-on to work, Azure AD needs to know what the counterpart user in OpenAthens is to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in OpenAthens needs to be established.
...
3. **[Create a OpenAthens test user](#create-a-openathens-test-user)** - to have a counterpart of Britta Simon in OpenAthens that is linked to the Azure AD representation of user.
...
1. In the Azure portal, on the **OpenAthens** application integration page, click **Single sign-on**.
...
3. On the **OpenAthens Domain and URLs** section, enter the value: `https://login.openathens.net/saml/2/metadata-sp` in **Identifier** textbox.
...
4. On the **SAML Signing Certificate** section, click **Metadata XML** and then save the metadata file on your computer.
	...
	![The Certificate download link](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_certificate.png) 

5. Click **Save** button.

	![Configure Single Sign-On Save button](./media/active-directory-saas-openathens-tutorial/tutorial_general_400.png)

6. In a different web browser window, log in to your OpenAthens company site as an administrator.

7. Select **Connections** under the **Management** tab. 

	![Configure Single Sign-On](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_application1.png)

8. Select **SAML 1.1/2.0** and click on **Configure** button.

	![Configure Single Sign-On](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_application2.png)
	
9.	Upload the metadata xml file which you have downloaded from Azure portal by clicking on **Browse** button. Click **Add** to add the configuration.

	![Configure Single Sign-On](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_application3.png)

10. Perform the following steps under **Details** tab.
	...
	d. In **Unique user attribute** text box, enther the value `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name`

	e. In **Status**, check all the three check boxes.
...
When you click the OpenAthens tile in the Access Panel, you should get automatically signed-on to your OpenAthens application.

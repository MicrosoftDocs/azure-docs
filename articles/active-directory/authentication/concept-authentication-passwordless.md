...
|:-|:-|:-|:-|
|**Pre-requisite**| Windows 10, version 1809 or later<br>Azure Active Directory<br>Hybrid Azure Active Directory| Microsoft Authenticator app<br>Phone (iOS and Android devices running Android 6.0 or above.)|Windows 10, version 1903 or later<br>Azure Active Directory<br>Windows 10, version 2004 or later<br>Hybrid Azure Active Directory|

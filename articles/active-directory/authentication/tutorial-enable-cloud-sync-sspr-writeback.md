...
- An account with either:
  - *Authentication Policy Admin* and *Hybrid Identity Admin* roles
...
The Azure AD Connect cloud sync gMSA should have the following permissions set to writeback the passwords by default: 

...
- An on-premises AD DS environment configured with Azure AD Connect cloud sync version 1.1.587 or later. See [here](https://docs.microsoft.com/en-us/azure/active-directory/cloud-sync/how-to-automatic-upgrade) to identify the agents current version.  If needed, configure Azure AD Connect cloud sync using [this tutorial](tutorial-enable-sspr.md). 

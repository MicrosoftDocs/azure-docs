...
- A Temporary Access Pass cannot be used with:
   -  The Network Policy Server (NPS) extension and Active Directory Federation Services (AD FS) adapter
   -  During Windows Setup/Out-of-Box-Experience (OOBE)
   -  Autopilot
   -  To deploy Windows Hello for Business

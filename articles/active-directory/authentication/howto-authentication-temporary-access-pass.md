...
A Temporary Access Pass is a time-limited passcode that can be restricted for single use to allow users to onboard other authentication methods including passwordless methods such as Microsoft Authenticator, FIDO2 or Windows Hello for Business. 

...
* When administrators require two methods be used to reset a password, users are able use **EITHER** notification **OR** verification code in addition to any other enabled methods.

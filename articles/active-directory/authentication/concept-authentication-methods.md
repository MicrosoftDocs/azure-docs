...
Programmable OATH TOTP hardware tokens that can accept external secret keys or seeds can also be set up with Azure AD using the secret key obtained in the software token setup flow.

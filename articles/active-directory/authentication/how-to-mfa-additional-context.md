---
title: Use additional context in MFA notifications (Preview) - Azure Active Directory
...
---
# How to use additional context in MFA notifications (Preview) - Authentication Methods Policy
...
When a user receives a Passwordless phone sign-in or MFA push notification in the Microsoft Authenticator app, they will see the name of the application that requests the approval and the app location based on its IP address.
...
We will need to change the **displayAppInformationRequiredState** value from **default** to **enabled.** 
...
To turn off additional context, you will need to PATCH remove **displayAppInformationRequiredState** from **enabled** to **disabled**/**default**.

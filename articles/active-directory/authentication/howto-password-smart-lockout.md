...
description: Azure Active Directory smart lockout helps protect your organization from 
...
When using [pass-through authentication](active-directory/connect/active-directory-aadconnect-pass-through-authentication.md), you need to make sure that:

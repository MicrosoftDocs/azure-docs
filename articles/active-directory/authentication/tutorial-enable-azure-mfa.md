...
Azure Multi-Factor Authentication and Conditional Access policies give the flexibility to enable multi-factor authentication for users during specific sign-in events.

...
Make sure the server that you're using for Azure Multi-Factor Authentication meets the following requirements. If you install on an Azure VM, newer VM processors that run Windows Server 2019 may not work correctly with MFA Server.

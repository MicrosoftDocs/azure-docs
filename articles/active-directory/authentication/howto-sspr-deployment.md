...
> [!NOTE]
> This article explains self service password reset and how to enable it. If you are looking for the self service password reset tool to get back into your account, go to [https://aka.ms/sspr](https://aka.ms/sspr). 

...
When a user reports fraud, the event shows up in the Sign-ins log (as a sign-in that was rejected by the user) and in the Audit logs.

To view fraud reports in the Sign-ins log, click **Azure Active Directory** > **Sign-ins** > **Authentication Details**. The fraud report is now part of the standard Azure AD Sign-ins report and it will show in the **Result Detail** as MFA denied, Fraud Code Entered.

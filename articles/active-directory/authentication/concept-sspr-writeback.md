...
* **Supported administrator operations**
   ...
   * Any administrator-initiated end-user password reset from the [Microsoft Graph API beta](/graph/api/passwordauthenticationmethod-resetpassword?tabs=http).
...
* **Unsupported administrator operations**
   * Any administrator-initiated end-user password reset from PowerShell version 1, version 2, or the Microsoft Graph API (the [Microsoft Graph API beta](/graph/api/passwordauthenticationmethod-resetpassword?tabs=http) is supported).

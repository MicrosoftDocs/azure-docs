...
Prior to this feature bringing cloud-managed support for CBA natively to Azure AD, customers had to implement federated, certificate-based authentication by deploying Active Directory Federation Services (AD FS) to be able to authenticate using X.509 certificates against Azure AD. With Azure AD certificate-based authentication, customers will be able to authenticate directly against Azure AD and eliminate the need for federated AD FS thereby helping simplify their environments and reduce costs.

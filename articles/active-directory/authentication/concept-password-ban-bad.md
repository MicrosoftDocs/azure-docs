...
> [!NOTE]
> On-premises Windows Server Active Directory users that not synchronized to Azure Active Directory also benefits from Azure AD password protection based on existing licensing for synchronized users.

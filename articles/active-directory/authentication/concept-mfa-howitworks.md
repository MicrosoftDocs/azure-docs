...
* **Azure AD Free**, **Azure AD Basic** or standalone **Office 365** licenses - [Conditional Access baseline protection](../conditional-access/concept-baseline-protection.md)

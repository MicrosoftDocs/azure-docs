...
> [!NOTE]
> When alternate login ID is used on a resource tenant endpoint that does not have the functionality enabled, sign-in process will work seamlessly, but SSO will be interrupted.  

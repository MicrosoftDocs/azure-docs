...
| 31034| ServiceBusListenerError| This event indicates there was an error connecting to your tenant's Service Bus listener. If the error mentions "The remote certificate is invalid" check to make sure that your Azure AD Connect server has all the required Root CAs mentioned in [Azure TLS certificate changes](https://docs.microsoft.com/en-us/azure/security/fundamentals/tls-certificate-changes) |

...
To review token lifetimes, [use Azure AD PowerShell to query any Azure AD policies](../develop/configure-lifetimes.md#prerequisites). Disable any policies that you have in place.

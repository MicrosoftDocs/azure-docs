---
title: FAQs for hybrid FIDO2 security keys - Azure Active Directory
...
---
# Frequently asked questions (FAQs) about passwordless for hybrid FIDO2 security key sign-in to on-premises resources with Azure AD (preview)

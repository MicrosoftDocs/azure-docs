...
description: Provides you with a resolution Lists the various available reports for Azure Active Directory preview
...
I performed some actions in the Azure portal and expected to see the audit logs for those actions in the `Activity logs > Audit Logs` screen, but I can’t find them

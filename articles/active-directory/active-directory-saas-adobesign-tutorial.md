...
4. In the search box, type **Adobe Sign**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-adobesign-tutorial/tutorial_adobesign_search.png)

5. In the results panel, select **Adobe Sign**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-adobesign-tutorial/tutorial_adobesign_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Configure Single Sign-On](./media/active-directory-saas-adobesign-tutorial/tutorial_adobesign_samlbase.png)

3. On the **Adobe Sign Domain and URLs** section, perform the following steps:

	![Configure Single Sign-On](./media/active-directory-saas-adobesign-tutorial/tutorial_adobesign_url.png)
...
4. On the **SAML Signing Certificate** section, click **Certificate(Base64)** and then save the Certificate file on your computer.
	...
	![Configure Single Sign-On](./media/active-directory-saas-adobesign-tutorial/tutorial_adobesign_certificate.png) 

5. Click **Save** button.

	![Configure Single Sign-On](./media/active-directory-saas-adobesign-tutorial/tutorial_general_400.png)
...
6. On the **Adobe Sign Configuration** section, click **Configure Adobe Sign** to open **Configure sign-on** window. Copy the **Sign-Out URL, SAML Entity ID, and SAML Single Sign-On Service URL** from the **Quick Reference section.**
	...
	![Configure Single Sign-On](./media/active-directory-saas-adobesign-tutorial/tutorial_adobesign_configure.png) 
...
8. In the menu on the top, click **Account**, and then, in the navigation pane on the left die, click **SAML Settings** under **Account Settings**.
   ...
   ![Account](./media/active-directory-saas-adobesign-tutorial/IC789520.png "Account")

9. In the SAML Settings section, perform the following steps:
   
   ![SAML Settings](./media/active-directory-saas-adobesign-tutorial/IC789521.png "SAML Settings")
...
10. Move on, performing the following steps:
	   ...
	   ![SAML Settings](./media/active-directory-saas-adobesign-tutorial/IC789522.png "SAML Settings")
...
1. In the **Azure portal**, on the left navigation pane, click **Azure Active Directory** icon.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-adobesign-tutorial/create_aaduser_01.png) 

2. To display the list of users, go to **Users and groups** and click **All users**.
	
	![Creating an Azure AD test user](./media/active-directory-saas-adobesign-tutorial/create_aaduser_02.png) 

3. To open the **User** dialog, click **Add** on the top of the dialog.
 
	![Creating an Azure AD test user](./media/active-directory-saas-adobesign-tutorial/create_aaduser_03.png) 

4. On the **User** dialog page, perform the following steps:
 
	![Creating an Azure AD test user](./media/active-directory-saas-adobesign-tutorial/create_aaduser_04.png) 
...
* When Adobe Sign, provisioning is a manual task.
...
2. In the menu on the top, click **Account**, and then, in the navigation pane on the left die, click **Users & Groups**, and then, click **Create a new user**.
   ...
   ![Account](./media/active-directory-saas-adobesign-tutorial/IC789524.png "Account")
   
3. In the **Create New User** section, perform the following steps:
   
   ![Create User](./media/active-directory-saas-adobesign-tutorial/IC789525.png "Create User")
...
2. In the applications list, select **Adobe Sign**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-adobesign-tutorial/tutorial_adobesign_app.png) 
...
When you click the Adobe Sign tile in the Access Panel, you should get login page of Adobe Sign application.
...
[1]: ./media/active-directory-saas-adobesign-tutorial/tutorial_general_01.png
[2]: ./media/active-directory-saas-adobesign-tutorial/tutorial_general_02.png
[3]: ./media/active-directory-saas-adobesign-tutorial/tutorial_general_03.png
[4]: ./media/active-directory-saas-adobesign-tutorial/tutorial_general_04.png

[100]: ./media/active-directory-saas-adobesign-tutorial/tutorial_general_100.png

[200]: ./media/active-directory-saas-adobesign-tutorial/tutorial_general_200.png
[201]: ./media/active-directory-saas-adobesign-tutorial/tutorial_general_201.png
[202]: ./media/active-directory-saas-adobesign-tutorial/tutorial_general_202.png
[203]: ./media/active-directory-saas-adobesign-tutorial/tutorial_general_203.png

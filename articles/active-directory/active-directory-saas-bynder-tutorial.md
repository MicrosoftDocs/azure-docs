...
4. In the search box, type **Bynder**, select **Bynder** from result panel then click **Add** button to add the application.

	![Bynder in the results list](./media/active-directory-saas-bynder-tutorial/tutorial_bynder_addfromgallery.png)
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-bynder-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Bynder**.
	...
	![The Bynder link in the Applications list](./media/active-directory-saas-bynder-tutorial/tutorial_bynder_app.png)  

...
- **Users may join devices to Azure AD** - This setting enables you to select the users who can [join devices](active-directory.md/device-management-introduction#azure-ad-joined-devices) to Azure AD. The default is **All**.

...
| [Implement Azure AD Connect Health](../hybrid/whatis-hybrid-identity.md) | Enable monitoring of key health statistics for your Azure AD Connect servers, AD FS servers, and domain controllers. | Azure AD Premium P1 |

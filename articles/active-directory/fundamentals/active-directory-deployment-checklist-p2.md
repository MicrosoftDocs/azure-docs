...
| [Block legacy authentication to Azure AD with Conditional Access](../conditional-access/block-legacy-authentication.md) | Block legacy authentication protocols like POP, SMTP, IMAP, and MAPI can't enforce MFA, which are preferred entry points for adversaries. | Azure AD Premium P1 |

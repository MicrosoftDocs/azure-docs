...
>[!Important]
>If users are not able to create tenant, review your user settings page to ensure that Tenant Creation is not switched off. If it is switched off, reach out to your global administrators to provide the users access to Tenant Creator role.

...
>[!Note]
>Group-based licensing is a public preview feature of Azure Active Directory (Azure AD) and is available with any paid Azure AD license plan. However, when this feature becomes generally available, some aspects might require one or more Azure AD Premium licenses. For more information about previews, see [Supplemental Terms of Use for Microsoft Azure Previews](https://azure.microsoft.com/support/legal/preview-supplemental-terms/).

...
* Cloud-based Azure environments
   ...
   * [Connect Azure AD Identity Protection data to Azure Sentinel](../../sentinel/data-connectors-reference.md#azure-active-directory-identity-protectionazure-active-directory-identity-protection)

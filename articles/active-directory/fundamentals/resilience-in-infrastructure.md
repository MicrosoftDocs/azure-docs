...
Please also see the documentation for [application developers](https://aka.ms/azureadresilience/developer) and for [Azure AD B2C systems](https://aka.ms/azureadresilience/b2c).

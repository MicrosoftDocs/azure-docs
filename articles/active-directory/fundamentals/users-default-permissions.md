...
* To learn more about how to assign Azure AD administrator roles, see [Assigning administrator roles in Azure Active Directory](../users-groups-roles/directory-assign-admin-roles.md)

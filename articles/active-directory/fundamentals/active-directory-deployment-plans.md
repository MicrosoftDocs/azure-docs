...
|Conditional access [downloadable plan](https://aka.ms/CADPDownload) or [online plan](https://aka.ms/caonlineplan)|With conditional access, you can implement automated access control decisions for who can access your cloud apps, based on conditions.|

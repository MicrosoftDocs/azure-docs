...
We'd love your feedback on the documents. Take this short [survey](aka.ms/deploymentplanfeedback) about how the documents worked for you. 
...
|[Multi-Factor Authentication](aka.ms/MFADPDownload)|Azure Multi-Factor Authentication (MFA) is Microsoft's two-step verification solution. Using admin-approved authentication methods, Azure MFA helps safeguard your access to data and applications, while meeting the demand for a simple sign-in process.|

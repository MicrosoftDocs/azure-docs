...
2. On the left navbar, select **Azure Active Directory**, and then select **Properties**.
    ...
    :::image type="content" source="media/active-directory-properties-area/properties-area.png" alt-text="Properties area highlighting the privacy info area.":::
...
3. Add your privacy info for your employees:
    ...
    - **Privacy statement URL.** Type the link to your organization's document that describes how your organization handles both internal and external guest's data privacy.
        ...
        :::image type="content" source="media/active-directory-properties-area/no-privacy-statement-or-contact.png" alt-text="B2B Collaboration Review Permissions box with message.":::

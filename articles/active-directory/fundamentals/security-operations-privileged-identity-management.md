...
* [**Microsoft Defender for Cloud Apps**](/cloud-app-security/what-is-cloud-app-security) (Defender for Cloud Apps) – enables you to discover and manage apps, govern across apps and resources, and check your cloud apps’ compliance. 

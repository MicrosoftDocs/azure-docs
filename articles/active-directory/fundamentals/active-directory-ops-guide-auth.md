...
> [!NOTE]
> These recommendations are current as of the date of publishing but can change over time. Organizations should continuously evaluate their Identity and Access Management (IAM) practices as Microsoft products and services evolve over time.

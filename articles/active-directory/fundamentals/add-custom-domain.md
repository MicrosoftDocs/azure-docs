...
1. Sign in to the [Azure portal](https://portal.azure.com/) using an account with Owner rights for the subscription for the directory, and then select **Azure Active Directory**. For more information about being subscription roles, see [Classic subscription administrator roles, Azure RBAC roles, and Azure AD administrator roles](../../role-based-access-control/rbac-and-directory-admin-roles#azure-rbac-roles).

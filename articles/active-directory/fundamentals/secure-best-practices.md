...
![Diagram that shows synchronizing admin identities from on-premises.](media/secure-best-practices/admin-id-sync.png)
...
![Diagram that shows monitoring strategy.](media/secure-best-practices/human-identity-provisioning.png)

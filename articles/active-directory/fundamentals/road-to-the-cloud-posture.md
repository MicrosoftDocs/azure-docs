...
:::image type="content" source="media/road-to-cloud-posture/road-to-the-cloud-start.png" lightbox="media/road-to-cloud-posture/road-to-the-cloud-start.png” alt-text="Architectural diagram depicting applications, devices, and users and groups layers, each containing common technologies found within each layer." border="false":::

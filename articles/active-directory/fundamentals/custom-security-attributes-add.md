...
[Custom security attributes](custom-security-attributes-overview.md) is a feature of Azure Active Directory (Azure AD) that enables you to define and assign your own custom security attributes (key-value pairs) to Azure AD objects. This article describes how to add, edit, or deactivate custom security attributes.

...
|Reports and monitoring|Gain insights into the security and usage patterns in your environment. For more information, see [Microsoft Entra ID reports and monitoring](../reports-monitoring/index.yml).|

...
Check out the newly available [expression builder](https://review.docs.microsoft.com/azure/active-directory/cloud-sync/how-to-expression-builder?deploy-the-expression.md&branch=main) for cloud sync, which, helps you build complex expressions as well as simple expressions when you do transformations of attribute values from AD to Azure AD using attribute mapping.

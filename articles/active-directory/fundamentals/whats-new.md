...
>Get notified about when to revisit this page for updates by subscribing to the ![RSS icon](./media/whats-new/feed-icon-16x16.png) [feed](https://docs.microsoft.com/azure/active-directory/fundamentals/whats-new?format=rss)

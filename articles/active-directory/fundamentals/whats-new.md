...
For more details, see the [change notice](../develop/reference-breaking-changes.md). 
 
---

[1305174](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1305174&triage=true&fullScreen=false&_a=edit)
...
[876083](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=876083&triage=true&fullScreen=false&_a=edit)
...
The Public Preview feature for Azure AD Connect Cloud Sync Password writeback provides customers the capability to writeback a user’s password changes in the cloud to the on-premises directory in real time using the lightweight Azure AD cloud provisioning agent.

---
 
[1379295](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1379295&triage=true&fullScreen=false&_a=edit)
...
Learn more: Reference for writing expressions for attribute mappings in Azure Active Directory Application Provisioning | Microsoft Docs
 

---
 

[1424497](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1424497&triage=true&fullScreen=false&_a=edit)
...
[1061372](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1061372&triage=true&fullScreen=false&_a=edit)
...
Previously, Conditional Access policies applied only to users when they access apps and services like SharePoint online or the Azure portal. This preview adds support for Conditional Access policies applied to service principals owned by the organization. You can block service principals from accessing resources from outside trusted named locations or Azure Virtual Networks. 
...
For more information on how to use this feature please visit [View and search your recent sign-in activity from the My Sign-ins page](https://docs.microsoft.com/en-us/azure/active-directory/user-help/my-account-portal-sign-ins-page).
...
[1677962](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1677962&triage=true&fullScreen=false&_a=edit)

### Public preview - New provisioning connectors in the Azure AD Application Gallery - November 2021
...
[1635075](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1635075&triage=true&fullScreen=false&_a=edit)
...
We have recently added additional property to the sign-in logs called "Session Lifetime Policies Applied". This property will list all the session lifetime policies that applied to the sign-in for example, Sign-in frequency, Remember MFA and Configurable token lifetime.
...
[1200850](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1200850&triage=true&fullScreen=false&_a=edit)
...
[1031112](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1031112&triage=true&fullScreen=false&_a=edit)
...
Admins can now enforce Conditional Access policies based off of GPS location from Authenticator. 
 

---
 

[1677792](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1677792&triage=true&fullScreen=false&_a=edit)
...
[1323661](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1323661&triage=true&fullScreen=false&_a=edit)
...
Several user attributes have been added to the list of attributes available to map to claims to bring attributes available in claims more in line with what is available on the user object in Microsoft Graph.  New attributes include mobilePhone,  ProxyAddresses 
...
[1677550](https://identitydivision.visualstudio.com/IAM/IXR/_queries?id=1677550&triage=true&fullScreen=false&_a=edit)

### GA: Updated "switch organizations" user experience in My Account.
...
Updated "switch organizations" user interface in My Account. This visually improves the UI and provides the end-user with clear instructions. Added a manage organizations link to blade per customer feedback. 

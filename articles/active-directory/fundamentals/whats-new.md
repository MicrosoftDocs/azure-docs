...
>Get notified about when to revisit this page for updates by adding this ![RSS icon](./media/whats-new/feed-icon-16x16.png) [feed URL](https://docs.microsoft.com/api/search/rss?search=%22whats%20new%20in%20azure%20active%20directory%22&locale=en-us) to your RSS reader.

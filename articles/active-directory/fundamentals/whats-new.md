...
[List transitiveRoleAssignment - Microsoft Graph beta | Microsoft Docs](https://docs.microsoft.com/graph/api/rbacapplication-list-transitiveroleassignments?view=graph-rest-beta&tabs=http).
...
[List resourceActions - Microsoft Graph beta | Microsoft Docs](https://docs.microsoft.com/graph/api/unifiedrbacresourcenamespace-list-resourceactions?view=graph-rest-beta&tabs=http).

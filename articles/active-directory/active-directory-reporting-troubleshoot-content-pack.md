...
| A refresh can fail due to data issues in the underlying content pack. | File a support ticket. For more details, see [How to get support for Azure Active Directory](fundamentals/active-directory-troubleshooting-support-howto.md).|
...
| Your tenant is not a Premium tenant or doesn't have at least one user with Premium license File. | File a support ticket. For more details, see [How to get support for Azure Active Directory](fundamentals/active-directory-troubleshooting-support-howto.md).|

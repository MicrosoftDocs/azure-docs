...
* ServiceNow
* Workday
* Azure Active Directory ([Azure AD Graph API default attributes](https://msdn.microsoft.com/Library/Azure/Ad/Graph/api/entity-and-complex-type-reference.md#user-entity) and custom directory extensions are supported)

...
6. In the search box, type **EthicsPoint Incident Management**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-ethicspoint-incident-management-tutorial/tutorial_ethicspointincidentmanagement_01.png)

7. In the results pane, select **EthicsPoint Incident Management**, and then click **Complete** to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-ethicspoint-incident-management-tutorial/tutorial_ethicspointincidentmanagement_02.png)
...
3. On the **Configure App Settings** dialog page, perform the following steps:
	...
	![Configure Single Sign-On](./media/active-directory-saas-ethicspoint-incident-management-tutorial/tutorial_ethicspointincidentmanagement_04.png) 
...
4. On the **Configure single sign-on at EthicsPoint Incident Management (EPIM)** page, perform the following steps:
	...
	![Configure Single Sign-On](./media/active-directory-saas-ethicspoint-incident-management-tutorial/tutorial_ethicspointincidentmanagement_05.png)
...
1. In the **Azure classic portal**, on the left navigation pane, click **Active Directory**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-ethicspoint-incident-management-tutorial/create_aaduser_09.png) 
...
5. On the **Tell us about this user** dialog page, perform the following steps:
	![Creating an Azure AD test user](./media/active-directory-saas-ethicspoint-incident-management-tutorial/create_aaduser_05.png) 
...
6.  On the **User Profile** dialog page, perform the following steps:
	![Creating an Azure AD test user](./media/active-directory-saas-ethicspoint-incident-management-tutorial/create_aaduser_06.png) 
...
7. On the **Get temporary password** dialog page, click **create**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-ethicspoint-incident-management-tutorial/create_aaduser_07.png) 

8. On the **Get temporary password** dialog page, perform the following steps:

	![Creating an Azure AD test user](./media/active-directory-saas-ethicspoint-incident-management-tutorial/create_aaduser_08.png) 
...
### Creating an EthicsPoint Incident Management (EPIM) test user

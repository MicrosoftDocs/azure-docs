...
3. On the **EthicsPoint Incident Management (EPIM) Domain and URLs** section, If you wish to configure the application in **IDP** initiated mode:
	...
	> [!NOTE] 
	> These values are not real. Update these values with the actual Reply URL, and Sign-On URL. Contact [EthicsPoint Incident Management (EPIM) Client support team](http://www.navexglobal.com/company/contact-us) to get these values. 

...
3. **[Create a Bpm’online test user](#create-a-bpm’online-test-user)** - to have a counterpart of Britta Simon in Bpm’online that is linked to the Azure AD representation of user.
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-bpmonline-tutorial/create_aaduser_04.png)

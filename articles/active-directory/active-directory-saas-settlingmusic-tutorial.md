...
4. In the search box, type **Settling music**, select **Settling music** from result panel then click **Add** button to add the application.
	...
	![Settling music in the results list](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Single sign-on dialog box](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_samlbase.png)

3. On the **Settling music Domain and URLs** section, perform the following steps:
...
4. On the **SAML Signing Certificate** section, click **Certificate (Base64)** and then save the certificate file on your computer.
	...
	![The Certificate download link](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_certificate.png) 

5. Click **Save** button.

	![Configure Single Sign-On Save button](./media/active-directory-saas-settlingmusic-tutorial/tutorial_general_400.png)

6. On the **Settling music Configuration** section, click **Configure Settling music** to open **Configure sign-on** window. Copy the **Sign-Out URL and SAML Single Sign-On Service URL** from the **Quick Reference section.**

	![Settling music Configuration](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_configure.png) 

7. In a different web browser window, login to Settling music as a Security Administrator.

8. On top of the page, click **management** tab.

	![Settling music step1](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_step1.png)

9. Click on  **System setting** tab.

	![Settling music step2](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_step2.png)

10. Switch to **Security** tab.

	![Settling music step3](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_step3.png)
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-settlingmusic-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-settlingmusic-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-settlingmusic-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-settlingmusic-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Settling music**.
	...
	![The Settling music link in the Applications list](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_app.png)  

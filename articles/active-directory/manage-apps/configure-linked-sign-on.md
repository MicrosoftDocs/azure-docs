...
- Add a link to an app that doesn't require authentication. 
 ...
 Although the **Linked** option doesn't provide sign-on functionality through Azure AD credentials, you can still use other features of **Enterprise applications**. For example, you can use conditional access, audit logs, and user consent.

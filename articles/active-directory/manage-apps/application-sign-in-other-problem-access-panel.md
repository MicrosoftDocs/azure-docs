...
3. Run `(Invoke-MgGraphRequest -Uri '/v1.0/users/<user-id>/appRoleAssignments?$top=999').value.Count` to determine the number of app role assignments the user currently has granted.

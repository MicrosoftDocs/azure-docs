...
Another scenario when this error might occur is when the user assignment is required for the application and no Aministrator Consent was provided at that moment. In this case Administrator has to provide the Administrator Consent first.   

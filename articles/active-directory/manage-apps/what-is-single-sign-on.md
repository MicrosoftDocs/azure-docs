...
To configure a cloud application for password-based single sign-on, see [Configure the application for password single sign-on](app-sign-in-problem-password-sso-gallery.md#configure-the-app-for-sso).

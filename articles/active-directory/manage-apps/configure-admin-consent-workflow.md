...
To approve requests, a reviewer must have the [permissions required](../active-directory/manage-apps/grant-admin-consent?pivots=portal#prerequisites) to grant admin consent for the application requested. Simply designating them as a reviewer doesn't elevate their privileges.

...
# Quickstart: Create aand assign a user account

In this quickstart you use the Azure Active Directory Admin Center to create a user account in your Azure Active Directory (Azure AD) tenant and assign it to the enterprise application that you added.
...
1. In the the [Azure Active Directory Admin Center](https://aad.portal.azure.com), select **Enterprise applications**, and then find and select the application to which you want to assign the user account. For example, the application that you created in the previous quickstart named **Azure AD SAML Toolkit 1**.
...
1. Click **Select**.
1. On the **Add Assignment** pane, click **Assign** at the bottom of the pane.

## Clean up resources

If you are planning to complete the next quickstart, keep the application that you created. If you do not plan to continue using the application, then consider deleting it to clean up your test tenant. For more information, see [Delete an application](delete-application-portal.md).

...
1. On your Azure AD Connect server, open the **Azure AD Connect** app and then select **Configure**.
   ...
   ![Screenshot that shows the Azure AD icon and Configure button.](media/migrate-okta-federation-to-azure-active-directory/configure-azure-ad.png)

2. Select **Change user sign-in** > **Next**.

   ![Screenshot that shows the "Change user sign-in" page.](media/migrate-okta-federation-to-azure-active-directory/change-user-signin.png)
...
2. On the final page, select **Configure** to update the Azure AD Connect server.
   ...
   ![Screenshot that shows the "Ready to configure" page.](media/migrate-okta-federation-to-azure-active-directory/update-azure-ad-connect-server.png)
...
5. Select **Manage groups**.
   ...
   ![Screenshot that shows the "Manage groups" button.](media/migrate-okta-federation-to-azure-active-directory/password-hash-sync.png)
...
9. Record the value and ID of the secret.
   ...
   ![Screenshot that shows where to record the secret's value and ID.](media/migrate-okta-federation-to-azure-active-directory/record-secrets.png)

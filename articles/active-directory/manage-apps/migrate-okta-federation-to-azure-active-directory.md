...
When your organization understands the managed authentication experience, defederate your domain from Okta. Use the following commands to connect to MSOnline PowerShell. If you don't have the MSOnline PowerShell module, download it by entering `install-module MSOnline`.

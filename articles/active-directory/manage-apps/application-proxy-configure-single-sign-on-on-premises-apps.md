...
3. Edit the **Reply URL** configured earlier so that its domain is reachable by Application Proxy. For example, if your **External URL** is https://samlapp.msappproxy.net and the original **Reply URL** was https://samlapp.com/acs, you'll need to update the original **Reply URL** to https://samlapp.msappproxy.net/acs. 

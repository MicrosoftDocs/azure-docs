...
- A custom domain verified in the Azure AD tenant.
- On-premises Active Directory users synchronized with Azure AD Connect, and able to sign-in on Azure.
- An Application Proxy connector installed and running on a machine within the corporate domain.
- This configuration requires 2 URLs:

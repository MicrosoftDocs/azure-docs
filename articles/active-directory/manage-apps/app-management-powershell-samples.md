...
| [Export expiring secrets and certs](scripts/powershell-export-apps-with-expiring-secrets.md) | Export App Registrations with expiring secrets and certificates and their Owners in Azure Active Directory tenant. |

...
To **view your apps and get up to speed quickly** with App Management in Azure, be sure to check out the [Quickstart Series](view-applications-portal.md).

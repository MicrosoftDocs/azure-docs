...
If you are using the application Qlik Sense make sure that you have installed the latest connector. Qlik Sense uses WebSockets and this is only supported on connector versions 1.5.612.0 or later.

...
| --------------------- | ------------------------------ |
| Pre-authentication    | RD Web-  Windows 7/10 using Internet Explorer or [Edge Chromium IE mode](/deployedge/edge-ie-mode) + RDS ActiveX add-on (note that the My Apps portal is no longer supported with IE 11 and Edge must be used) |

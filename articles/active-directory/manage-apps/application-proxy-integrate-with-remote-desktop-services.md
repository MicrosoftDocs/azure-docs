...
| --------------------- | ------------------------------ |
| Pre-authentication    | RD Web-  Windows 7/10 using Internet Explorer or [Edge Chromium IE mode](https://docs.microsoft.com/en-us/deployedge/edge-ie-mode) + RDS ActiveX add-on |

...
| --------------------- | ------------------------------ |
| Pre-authentication    | RD Web-  Windows 7/10 using Internet Explorer (note the My Apps portal only supports Edge Chromium) or [Edge Chromium IE mode](/deployedge/edge-ie-mode) + RDS ActiveX add-on |

...
| [Identity governance for applications](../governance/identity-governance-applications-prepare.md)| If you are migrating an application from a previous identity governance technology to use Azure AD for identity governance for access to that application.|

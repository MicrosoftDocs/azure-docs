...
| [Identity governance for critical applications](../governance/identity-governance-critical-applications-prepare.md)| If you are migrating an application from a previous identity governance technology to use Azure AD for identity governance for access to that application.|

...
| [Migrating apps from Okta to Azure AD](okta-to-azure-active-directory-migration-guide.md) | Upgrade your Identity and Access Management (IAM) solution from Okta to Azure AD using the workloads mentioned in the tutorials. |

...
![Select a single sign-on method](./media/configure-single-sign-on-non-gallery-applications/customapp3.png)

The options are described in the next sections of this article.

## SAML-based single sign-on

Select the **SAML** option to configure SAML-based authentication for the application. This requires that the application support SAML 2.0. You should collect information on how to use the SAML capabilities of the application before continuing. Complete the following sections to configure single sign-on between the application and Azure AD.
...
To set up Azure AD, go to the **Basic SAML Configuration** heading and select its **Edit** icon (a pencil). You can manually enter the values or upload a metadata file to extract the value of the fields.
  ...
  ![Basic SAML configuration](./media/configure-single-sign-on-non-gallery-applications/customapp4.png)

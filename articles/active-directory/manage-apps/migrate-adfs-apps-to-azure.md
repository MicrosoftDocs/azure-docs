...
![Applications connected directly on-premises](media/migrate-adfs-apps-to-azure/migrate1.png)

![Applications federated through Azure AD](media/migrate-adfs-apps-to-azure/migrate2.png)
...
- **Easier admin experience and additional capabilities of Azure AD**
  ...
  - [Automated provisioning](../app-provisioning/user-provisioning.md) of user accounts (in key Azure Marketplace apps) based on Azure AD identities.
...
![Shows the list of attributes you can send as claims](media/migrate-adfs-apps-to-azure/migrate4.png)

Select a specific attribute row to edit, or select **Add attribute** to add a new attribute.

![Shows the "Edit Attribute" pane](media/migrate-adfs-apps-to-azure/migrate5.png)
...
![Shows the "Add Assignment" pane](media/migrate-adfs-apps-to-azure/migrate7.png)
...
#### Example: Support for multiple identity providers
...
If you want Azure AD to directly handle user provisioning for an SaaS app, see [Automate user provisioning and deprovisioning to SaaS applications with Azure Active Directory](../app-provisioning/user-provisioning.md).

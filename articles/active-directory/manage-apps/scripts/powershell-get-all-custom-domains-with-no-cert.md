...
description: PowerShell example that lists all Azure AD Application Proxy applications that are using custom domains but do not have a valid SSL certificate uploaded.

---
title: What is self-service signup for Azure Active Directory? | Microsoft Docs
...
To start the process of a DNS takeover, you can merge the directory after proving ownership  as described in [Add a custom domain name to Azure AD](add-custom-comain.md). The next sections explain the admin experience in more detail, but here's a summary:

...
* **AllowAdHocSubscriptions** controls the ability for users to perform self-service signup. If you set that parameter to $false, no users can perform self-service signup. Flow and PowerApps viral signups are not controlled by the **AllowAdHocSubscriptions** setting:

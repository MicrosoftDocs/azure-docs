...
2.  Select **Browse**, enter User Management in the text box, and then select **Enter**.
    ...
    ![Opening user management](./media/active-directory-create-users-delete-user-azure-portal/create-users-user-management.png)

3.  On the **User Management** blade, select **Users**.

    ![Opening the Users blade](./media/active-directory-create-users-delete-user-azure-portal/create-users-open-users-blade.png)

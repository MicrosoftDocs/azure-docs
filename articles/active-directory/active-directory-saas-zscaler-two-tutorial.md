...
To enable Azure AD users to log in to ZScaler Two, they must be provisioned to ZScaler Two.  
...
When you click the Zscaler Two tile in the Access Panel, you should get login page of Zscaler Two application.

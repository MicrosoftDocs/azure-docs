...
## What can I do with Azure AD Terms of use?
Azure AD Terms of use enables you to do the following:
- Require employees or guests to agree to your term of use before getting access.
...
6. Under **Conditional Access**, you can **Enforce** the uploaded Terms of use by selecting a template from the drop-down or a custom conditional access policy.  Custom conditional access policies enable granular Terms of use, down to a specific cloud application or group of users.  For more information, see [configuring conditional access policies](active-directory-conditional-access-best-practices.md).
...
## View current status for users
The Terms of use blade shows a count for users who have accepted and declined. These counts and who accepted/declined are stored for the life of the Terms of use.
...
## Audit Terms of use
If you want to view historical acceptances and declines and not just the current status, Azure AD Terms of use provides audit logs. Each user consent triggers an event in audit logs that allows you to see who has accepted and when they accepted. These logs are stored for 30 days. You can view these logs in the portal or a .csv file.
...
- The recommended font size in the PDF is 24.
...
1. In upper right corner, click your name and select **Profile** from the drop-down.
...
A: You can click the number under accepted next to your Terms of use.  For more information, see [Viewing current user status](#viewing-current-user-status).  Also, a user accepting the Terms of use is written to the audit log. You can search the Azure AD audit log to see the results.  

...
3. Next to **Organizations**, select the settings icon (gear).
   ...
   ![Screenshot showing user settings in Access Panel](media/active-directory-b2b-leave-the-organization/UserSettings.png) 

3. Under **Organizations**, find the organization that you want to leave, and select **Leave organization**.

   ![Screenshot showing Leave organization option in the user interface](media/active-directory-b2b-leave-the-organization/LeaveOrg.png)

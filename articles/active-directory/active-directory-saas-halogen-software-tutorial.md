...
1. **Configuring Azure Single Single Sign-On** - to enable your users to use this feature.
2. **Creating an Azure AD test user** - to test Azure AD single sign-on with Britta Simon.
4. **Creating a Halogen Software test user** - to have a counterpart of Britta Simon in Halogen Software that is linked to the Azure AD representation of her.

...
3. On the **Halogen Software Domain and URLs** section, perform the following steps:
	...
	b. In the **Identifier** textbox, type a URL using the following pattern: `https://global.halogensoftware.com/<companyname>`, `halogensoftware/primary`, `https://global.hgncloud.com/*`
...
3. On the **New User** dialog page, perform the following steps:
    ...
    c. In the **Username** textbox, type **Brita Simon's user name as in the Azure portal**.

...
4. In the search box, type **Zoho One**, select **Zoho One** from result panel then click **Add** button to add the application.
	...
	![Zoho One in the results list](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_addfromgallery.png)
...
3. On the **Zoho One Domain and URLs** section, perform the following steps if you wish to configure the application in **IDP** initiated mode:
	...
	![Zoho One Domain and URLs single sign-on information](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_url.png)
...
5. On the **SAML Signing Certificate** section, click **Certificate (Base64)** and then save the certificate file on your computer.
	...
	![The Certificate download link](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_certificate.png) 

6. Click **Save** button.

	![Configure Single Sign-On Save button](./media/active-directory-saas-zohoone-tutorial/tutorial_general_400.png)
...
7. On the **Zoho One Configuration** section, click **Configure Zoho One** to open **Configure sign-on** window. Copy the **Sign-Out URL and SAML Single Sign-On Service URL** from the **Quick Reference section.**
	...
	![Zoho One Configuration](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_configure.png) 
...
9. On the **Organization** tab, Click **Setup** under **SAML Authentication**.
	...
	![Zoho One org](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_setup.png)

10. On the Pop-up page perform the following steps:

	![Zoho One sig](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_save.png)
...
11. After saving the SAML Authentication setup, copy the **SAML-Identfier** value and use this value in the **Reply URL** in the Azure portal, under **Zoho One Domain and URLs** section.
	...
	![Zoho One saml](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_samlidenti.png)

12. Go to the **Domains** tab and then click **Add Domain**.

	![Zoho One domain](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_domain.png)

13. On the **Add Domain** page, perform the following steps:

	![Zoho One add domain](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_adddomain.png)
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-zohoone-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-zohoone-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-zohoone-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-zohoone-tutorial/create_aaduser_04.png)
...
2. On the **Users** tab, Click on **user logo**.
	...
	![Zoho One user](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_users.png)

3. On the **Add User** page, perform the following steps:

	![Zoho One add user](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_adduser.png)
...
2. In the applications list, select **Zoho One**.
	...
	![The Zoho One link in the Applications list](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_app.png)  

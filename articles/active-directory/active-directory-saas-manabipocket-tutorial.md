...
4. In the search box, type **Manabi Pocket**, select **Manabi Pocket** from result panel then click **Add** button to add the application.
	...
	![Manabi Pocket in the results list](./media/active-directory-saas-manabipocket-tutorial/tutorial_manabipocket_addfromgallery.png)
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-manabipocket-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Manabi Pocket**.
	...
	![The Manabi Pocket link in the Applications list](./media/active-directory-saas-manabipocket-tutorial/tutorial_manabipocket_app.png)  

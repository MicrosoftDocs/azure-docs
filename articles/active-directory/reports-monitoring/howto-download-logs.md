...
![Screenshot of the audit logs from the Groups page in Azure AD.](./media/howto-download-logs/groups-audit-logs.png)
...
1. The download will process and send the file to your default download location. 

The following screenshot shows the download window found the audit and sign-in log download process. 
...
If your tenant has enabled the [sign-in logs preview](concept-all-sign-ins.md), more options are available after selecting **Download**. The sign-in logs preview now include interactive and non-interactive user sign-ins, service principal sign-ins, and managed identity sign-ins.

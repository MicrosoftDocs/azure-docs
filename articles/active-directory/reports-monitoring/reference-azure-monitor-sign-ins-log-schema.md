---
title: Azure Active Directory sign-in log schema in Azure Monitor | Microsoft Docs
...
* [Read more about Azure diagnostic logs](../../azure-monitor/platform/resource-logs-overview.md)

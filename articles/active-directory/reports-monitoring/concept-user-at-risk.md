...
Azure Active Directory (Azure AD) detects suspicious actions related to your user accounts. For each detected action, a record called a [risk detection](concept-risk-events.md) is created.
...
- Aggregated information about the [risk detection types](concept-risk-events.md) that have been detected

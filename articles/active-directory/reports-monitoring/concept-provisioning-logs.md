...
|AzureActiveDirectoryCannotUpdateObjectsMasteredOnPremises|If the user in the target tenant was originally synchronized from AD to Azure AD and converted to an external user, the source of authority is still on-premises and the user cannot be updated.|

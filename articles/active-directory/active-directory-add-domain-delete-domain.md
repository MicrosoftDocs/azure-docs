...
You can delete a custom domain name that you no longer need to use with your Azure AD directory; for example, a new corporate name, you are using a different Azure AD directory, or similar. You can also delete an unverified domain, such as if you find you mis-typed the name after adding it, or if you did not set the value correctly as to whether the domain will be federated.
...
2.  Open your directory, ad select Domains

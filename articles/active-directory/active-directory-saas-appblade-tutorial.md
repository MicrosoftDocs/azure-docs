...
For single sign-on to work, Azure AD needs to know what the counterpart user in AppBlade to an user in Azure AD is. In other words, a link relationship between an Azure AD user and the related user in AppBlade needs to be established.<br>
...
The objective of this section is to enable Azure AD single sign-on in the Azure AD portal and to configure single sign-on in your AppBlade application.



**To configure Azure AD single sign-on with AppBlade, perform the following steps:**

1. In the Azure AD portal, on the **AppBlade** application integration page, click **Configure single sign-on** to open the **Configure Single Sign-On**  dialog.
...
> [AZURE.NOTE] If you need to create an user manually, you need to contact the AppBlade support team.

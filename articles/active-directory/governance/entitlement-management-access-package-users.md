---
title: Change who can request access to an access package in Azure AD entitlement management (Preview) - Azure Active Directory
description: Learn how to change who can request access to an access package in Azure Active Directory entitlement management (Preview).
...
---
# Change who can request access to an access package in Azure AD entitlement management (Preview)

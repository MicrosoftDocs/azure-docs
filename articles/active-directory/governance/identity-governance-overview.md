...
Increasingly, scenarios require collaboration with people outside your organization. [Azure AD B2B](../b2b/) collaboration enables securely sharing your organization's applications and services with guest users and external partners from any organization, while maintaining control over your own corporate data.
...
When a user attempts to access applications, Azure AD enforces [conditional access](../conditional-access/index.md) policies. For example, conditional access policies can include displaying to the user a [terms of use](active-directory-tou.md) and [ensure the user has agreed to those terms](../conditional-access/require-tou.md),  prior to being able to access an application.

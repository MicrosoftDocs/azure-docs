...
This article discusses how to use roles to manage aspects within Azure AD entitlement management, for controlling access to the entitlement management resources themselves.

---
title: View and remove requests for an access package in Microsoft Entra entitlement management - Azure Active Directory
description: Learn how to view requests and remove for an access package in Microsoft Entra entitlement management.
...
---
# View and remove requests for an access package in Microsoft Entra entitlement management

In Microsoft Entra entitlement management, you can see who has requested access packages, the policy for their request, and the status of their request. This article describes how to view requests for an access package, and remove requests that are no longer needed.

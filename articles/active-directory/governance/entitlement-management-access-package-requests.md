...
description: Learn how to view and cancel requests for an access package in Azure Active Directory entitlement management (Preview).
...
In Azure AD entitlement management, you can see who has requested access packages, their policy, and status. This article describes how to view and cancel requests for an access packages.

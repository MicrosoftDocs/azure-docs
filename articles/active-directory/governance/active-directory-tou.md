...
A: If you have both Azure AD Terms of use and [Intune terms and conditions](/intune/terms-and-conditions-create) configured, the user will be required to accept both. For more information, see [Choosing the right Terms solution for your organization blog post](https://go.microsoft.com/fwlink/?linkid=2010506).

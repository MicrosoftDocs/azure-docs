---
title: 'What is identity lifecycle management with Azure AD? | Microsoft Docs'
...
- [Govern access for external users in Azure AD entitlement management](/azure/active-directory/governance/entitlement-management-external-users.md)

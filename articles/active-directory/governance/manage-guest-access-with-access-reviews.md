...
You can also ask guest users to review their own access. For each paid Azure AD license that you assign to a user, you can invite up to five guest users under the External User Allowance. For more information, see [Azure AD B2B collaboration licensing](../b2b/licensing-guidance.md).

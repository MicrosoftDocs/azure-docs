---
title: Change resources and resource roles for an access package in Azure AD entitlement management (Preview) - Azure Active Directory
description: Learn how to change the resources and resource roles for an existing access package in Azure Active Directory entitlement management (Preview).
...
---
# Change resources and resource roles for an access package in Azure AD entitlement management (Preview)

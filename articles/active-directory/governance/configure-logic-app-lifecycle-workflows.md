...
Now that your Logic app is configured for use with Lifecycle Workflows, you can create a custo task extension via UI or API and use it in a Lifecycle Workflow.

...
1. Integrate the application with Azure AD to ensure only authorized users cannot access the application, and review user's existing access to the application to set a baseline of all users having been reviewed
1. Deploy policies for automating access assignments and monitoring to adjust those policies and access as needed

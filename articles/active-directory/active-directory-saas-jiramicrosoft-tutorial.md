...
*   JIRA also supports 5.2. For more details, click [Microsoft Azure Active Directory single sign-on for JIRA 5.2](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-saas-jira52microsoft-tutorial)

...
* **SharePoint administrator** has administrative access to SharePoint Online through the SharePoint Online admin center, and can perform almost any task in SharePoint Online. *Support for this role is currently in preview. Eligible users may expreience delays using this role within SharePoint after activating in PIM.*

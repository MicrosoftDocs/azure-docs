...
For more information about the network requirements for the connector server, see [Get started with Application Proxy and install a connector](manage-apps/application-proxy-enable.md).
...
* Organizations that limit the outbound traffic must [open required ports](manage-apps/application-proxy-enable.md#open-your-ports).

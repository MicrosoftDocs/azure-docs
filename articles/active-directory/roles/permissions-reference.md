...
The following tables describe the specific permissions in Azure Active Directory given to each role.
...
Can create and manage all aspects of authentication methods and password protection policies.

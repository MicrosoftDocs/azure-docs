...
By default, [Global Administrator](#global-administrator), [Global Reader](#global-reader), [Privileged Role Administrator](#privileged-role-administrator), and [User Administrator](#user-administrator) do not have permissions to read, filter, define, manage, or assign custom security attributes. To work with custom security attributes, you must be assigned one of the custom security attribute roles.

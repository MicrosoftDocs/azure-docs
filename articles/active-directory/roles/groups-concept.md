...
- RoleManagement.ReadWrite.All MS Graph permission is required to be able to be able to manage the membership of such groups; Group.ReadWrite.All won't work.

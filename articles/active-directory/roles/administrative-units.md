...
For example, you might delegate to regional support specialists the [Helpdesk Administrator](permissions-reference.md#helpdesk-administrator) role, which is restricted to managing users only in the region they support.

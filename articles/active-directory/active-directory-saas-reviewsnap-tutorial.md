...
4. In the search box, type **Reviewsnap**, select **Reviewsnap** from result panel then click **Add** button to add the application.
	...
	![Reviewsnap in the results list](./media/active-directory-saas-reviewsnap-tutorial/tutorial_reviewsnap_addfromgallery.png)
...
2. In the applications list, select **Reviewsnap**.
	...
	![The Reviewsnap link in the Applications list](./media/active-directory-saas-reviewsnap-tutorial/tutorial_reviewsnap_app.png)  

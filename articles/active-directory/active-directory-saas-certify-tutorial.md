...
1. On the **Configure single sign-on at Certify** page, perform the following steps:
    ...
    b. Click **Next**.
2. To get SSO configured for your application, contact your Certify support team via support@certify.com. Attach the downloaded certificate file to your mail and share the metadata urls (Entity ID, SSO Sign in URL and Sign Out URL) with Certify team to set up SSO on their side.
3. In the Azure AD classic portal, select the single sign-on configuration confirmation, and then click **Next**.

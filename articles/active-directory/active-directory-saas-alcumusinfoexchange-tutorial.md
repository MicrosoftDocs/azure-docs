...
4. In the search box, type **Alcumus Info Exchange**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_alcumusinfoexchange_search.png)

5. In the results panel, select **Alcumus Info Exchange**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_alcumusinfoexchange_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Configure Single Sign-On](./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_alcumusinfoexchange_samlbase.png)

3. On the **Alcumus Info Exchange Domain and URLs** section, perform the following steps:

	![Configure Single Sign-On](./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_alcumusinfoexchange_url.png)
...
4. On the **SAML Signing Certificate** section, click **Metadata XML** and then save the metadata file on your computer.
	...
	![Configure Single Sign-On](./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_alcumusinfoexchange_certificate.png) 

5. Click **Save** button.

	![Configure Single Sign-On](./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_general_400.png)
...
1. In the **Azure portal**, on the left navigation pane, click **Azure Active Directory** icon.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-alcumusinfoexchange-tutorial/create_aaduser_01.png) 

2. To display the list of users, go to **Users and groups** and click **All users**.
	
	![Creating an Azure AD test user](./media/active-directory-saas-alcumusinfoexchange-tutorial/create_aaduser_02.png) 

3. To open the **User** dialog, click **Add** on the top of the dialog.
 
	![Creating an Azure AD test user](./media/active-directory-saas-alcumusinfoexchange-tutorial/create_aaduser_03.png) 

4. On the **User** dialog page, perform the following steps:
 
	![Creating an Azure AD test user](./media/active-directory-saas-alcumusinfoexchange-tutorial/create_aaduser_04.png) 
...
2. In the applications list, select **Alcumus Info Exchange**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_alcumusinfoexchange_app.png) 
...
[1]: ./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_general_01.png
[2]: ./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_general_02.png
[3]: ./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_general_03.png
[4]: ./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_general_04.png

[100]: ./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_general_100.png

[200]: ./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_general_200.png
[201]: ./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_general_201.png
[202]: ./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_general_202.png
[203]: ./media/active-directory-saas-alcumusinfoexchange-tutorial/tutorial_general_203.png

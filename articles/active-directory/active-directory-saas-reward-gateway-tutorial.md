...
1. On the **Configure single sign-on at Reward Gateway** page, perform the following steps:
   
    ![Configure Single Sign-On](./media/active-directory-saas-reward-gateway-tutorial/tutorial_rewardgateway_05.png)
   
    a. Click **Download metadata**, and then save the file on your computer.
2. To get SSO configured for your application, contact Reward Gateway [support team](mailTo:clientsupport@rewardgateway.com) and provide them with the following:

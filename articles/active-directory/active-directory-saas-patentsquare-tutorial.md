...
1. Adding PatentSQUARE from the gallery
...
4. In the search box, type **PatentSQUARE**, select **PatentSQUARE** from result panel then click **Add** button to add the application.
	...
	![PatentSQUARE in the results list](./media/active-directory-saas-patentsquare-tutorial/tutorial_patentsquare_addfromgallery.png)
...
**To assign Britta Simon to PatentSQUARE, perform the following steps:**
...
2. In the applications list, select **PatentSQUARE**.
	...
	![The PatentSQUARE link in the Applications list](./media/active-directory-saas-patentsquare-tutorial/tutorial_patentsquare_app.png)  

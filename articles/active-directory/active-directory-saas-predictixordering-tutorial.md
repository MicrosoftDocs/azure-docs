...
4. In the search box, type **Predictix Ordering**.

	![Search box](./media/active-directory-saas-predictixordering-tutorial/tutorial_predictixordering_search.png)

5. In the results panel, select **Predictix Ordering**, and then click **Add** button to add the application.

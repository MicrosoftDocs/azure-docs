...
4. In the search box, type **Skyhigh Networks**, select **Skyhigh Networks** from result panel then click **Add** button to add the application.
	...
	![Skyhigh Networks in the results list](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Single sign-on dialog box](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_samlbase.png)
...
3. On the **Skyhigh Networks Domain and URLs** section, perform the following steps if you wish to configure the application in **IDP** initiated mode:
	...
	![Skyhigh Networks Domain and URLs single sign-on information](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_url.png)
...
4. Check **Show advanced URL settings** and perform the following step if you wish to configure the application in **SP** initiated mode:
	...
	![Skyhigh Networks Domain and URLs single sign-on information](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_url1.png)
...
5. On the **SAML Signing Certificate** section, click **Certificate (Base64)** and then save the certificate file on your computer.
	...
	![The Certificate download link](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_certificate.png) 

6. Click **Save** button.

	![Configure Single Sign-On Save button](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_general_400.png)
...
7. On the **Skyhigh Networks Configuration** section, click **Configure Skyhigh Networks** to open **Configure sign-on** window. Copy the **Sign-Out URL, SAML Entity ID, and SAML Single Sign-On Service URL** from the **Quick Reference section.**
	...
	![Skyhigh Networks Configuration](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_configure.png) 
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-skyhighnetworks-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-skyhighnetworks-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-skyhighnetworks-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-skyhighnetworks-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Skyhigh Networks**.
	...
	![The Skyhigh Networks link in the Applications list](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_app.png)  

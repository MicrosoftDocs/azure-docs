...
7. In the results pane, select **SECURE DELIVER**, and then click **Complete** to add the application.<br><br>
![App logo and Name in the gallery](./media/active-directory-saas-securedeliver-tutorial/tutorial_securedeliver_06.png)<br>
...
5. To get SSO configured for your application, contact your SECURE DELIVER support team via [iw-sd-support@fujifilm.com](mailto:iw-sd-support@fujifilm.com) and provide them with the following:<br>

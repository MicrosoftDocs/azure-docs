...
4. **[Creating a SECURE DELIVER test user](#creating-a-SECUREDELIVER-test-user)** - to have a counterpart of Britta Simon in SECURE DELIVER that is linked to the Azure AD representation of her.
...
<br><br>![Configure Single Sign-On](./media/active-directory-saas-securedeliver-tutorial/tutorial_securedeliver_04.png) <br>
    ...
    a. In the Sign On URL textbox, type the URL used by your users to sign-on to your SECURE DELIVER application using the following pattern: **“https://companyname.i-securedeliver.jp/sd/companyname”**. When referencing a generic name that **companyname** needs to be replaced by an actual name.
...
5. To get SSO configured for your application, contact your SECURE DELIVER support team via teruhiko.iwashita@fujifilm.com. Attach the downloaded certificate file to your mail and share the metadata urls (Entity ID, SSO Sign in URL and Sign Out URL) with SECURE DELIVER team to set up SSO on their side.

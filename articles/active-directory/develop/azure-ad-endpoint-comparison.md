...
* If you're migrating or updating an application that relies on SAML, you can't use Microsoft identity platform.
...
For the most up-to-date information about restrictions on redirect URLs for apps that are registered for Microsoft identity platform, see [Redirect URI/reply URL restrictions and limitations](reply-url.md) in the Microsoft identity platform documentation.

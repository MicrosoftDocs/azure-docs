...
You can view your deleted applications, restore a deleted application, or permanently delete an application using the **App registrations** experience under Microsoft Entra ID in the Microsoft Entra admin center.

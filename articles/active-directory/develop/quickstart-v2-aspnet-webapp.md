...
1. Open the Package Manager Console (View -> Other Windows -> Package Manager Console) and type `Update-Package Microsoft.CodeDom.Providers.DotNetCompilerPlatform -r`

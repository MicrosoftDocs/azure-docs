...
> [!div class="sxs-lookup" renderon="portal"]
> [!IMPORTANT]
> If your application is a *single-tenant application* (targeting accounts in this directory only), please also replace the value for `Tenant` from `common` with your *Tenant Id* or *Tenant Name* (i.e. contoso.microsoft.com) in your **Web.config**. You can obtain the tenant name in the *Overview page*.

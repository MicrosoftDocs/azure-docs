...
1. Extract the zip file to a local folder close to the root folder, for example, **C:\Azure-Samples** - this helps avoiding a potential issue related to long file names.

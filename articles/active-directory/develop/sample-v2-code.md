...
> | ------- | -------- | --------------------------- | ------------- | -------------- |
> | ASP.NET Core|[GitHub repo](https://github.com/Azure-Samples/active-directory-aspnetcore-webapp-openidconnect-v2) | ASP.NET Core Tutorial <br/> &#8226; [Signs in users](https://aka.ms/aspnetcore-webapp-sign-in) </p>  &#8226; [Calls Microsoft Graph]((https://aka.ms/aspnetcore-webapp-call-msgraph)) | MSAL.NET | &#8226; Hybrid flow <br/> &#8226; Auth code flow | 

...
> | ASP.NET |[GitHub repo](https://github.com/microsoftgraph/msgraph-training-aspnetmvcapp) | [Microsoft Graph Training Sample](https://github.com/microsoftgraph/msgraph-training-aspnetmvcapp) | [MSAL.NET](https://aka.ms/msal-net) |  |
...
> | Java |[GitHub repo](https://github.com/Azure-Samples/ms-identity-java-webapp) | [Sign in users, call Microsoft Graph](https://github.com/Azure-Samples/ms-identity-java-webapp)| MSAL Java | [Auth code flow](./v2-oauth2-auth-code-flow.md) |
> | Java </p> Spring|[GitHub repo](https://github.com/Azure-Samples/ms-identity-java-webapi) | Sign in users & call Microsoft Graph via OBO </p> &#8226;  [web API](https://github.com/Azure-Samples/ms-identity-java-webapi) | MSAL Java | &#8226; [Auth code flow](./v2-oauth2-auth-code-flow.md) <br/> &#8226; [On-Behalf-Of (OBO) flow](./v2-oauth2-on-behalf-of-flow.md) |
> | Node.js </p> Express |[GitHub repo](https://github.com/Azure-Samples/ms-identity-node) | Express web app sample <br/> &#8226; [Sign in users](https://github.com/Azure-Samples/ms-identity-node) | MSAL Node | [Auth code flow](./v2-oauth2-auth-code-flow.md) |

...
> [!div class="mx-tdCol2BreakAll"]
> | Language/<br/>Platform | Code sample(s) on GitHub | Authentication libraries used | Authentication flow |
> | ------- | --------------------------- | ------------- | -------------- |
...
> | Ruby | Graph Training <br/> &#8226; [Sign in and Microsoft Graph](https://github.com/microsoftgraph/msgraph-training-rubyrailsapp) | | |

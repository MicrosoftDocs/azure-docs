...
> | ASP.NET | [Sign in users and call Microsoft Graph](https://github.com/Azure-Samples/ms-identity-aspnet-webapp-openidconnect) | [MSAL.NET](https://aka.ms/msal-net) | &#8226; OpenID Connect flow <br/> &#8226; Authorization Code |
> | ASP.NET |[Sign in users and call Microsoft Graph](https://github.com/azure-samples/active-directory-dotnet-admin-restricted-scopes-v2) | [MSAL.NET](https://aka.ms/msal-net) | &#8226; OpenID Connect flow <br/> &#8226; Authorization Code  |
> | ASP.NET | [Microsoft Graph Training Sample](https://github.com/microsoftgraph/msgraph-training-aspnetmvcapp) | [MSAL.NET](https://aka.ms/msal-net) | &#8226; OpenID Connect flow <br/> &#8226; Authorization Code |

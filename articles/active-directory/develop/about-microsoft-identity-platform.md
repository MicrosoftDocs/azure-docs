...
* Supported platforms
    ...
    * [ADAL](active-directory-authentication-libraries.md) supports .NET, JavaScript, Apple (iOS and macOS), Android, Java, and Python

...
>
> 1. Go to the <a href="https://aka.ms/aspnetcore-webapp-calls-graph-quickstart-v2" target="_blank">Azure portal - App registrations<span class="docon docon-navigate-external x-hidden-focus"></span></a>.

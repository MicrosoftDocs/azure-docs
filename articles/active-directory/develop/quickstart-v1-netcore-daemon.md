---
title: Acquire token and call Microsoft Graph API with console app's identity (V1) | Microsoft Docs
...
# Quickstart: Acquire token and call Microsoft Graph API with console app's identity (V1) 

...
Microsoft identity platform uses the cloud service's **Metadata URI** to retrieve the signing key and the front-channel logout URL. You can open the app in **Azure AD -> App Registrations**. Under **Manage -> Authentication**, in the **Platform configurations** section, update the front-channel logout URL. This way Microsoft identity platform can send the response to the correct URL. 

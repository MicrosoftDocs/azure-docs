...
public class TodoListController : Controller
{
  ...
  {
    var value = await _downstreamApi.CallForUserAsync(
      ServiceName,
      options =>
      {
...
```csharp
    ...
    public async Task<ActionResult> Details(int id)
    {
        var value = await _downstreamApi.CallForUserAsync<object, Todo>(
            ServiceName,
            null,
            options =>
            {
...
```csharp
    ...
    {
        var downstreamApi = this.GetDownstreamApi();
        var value = await downstreamApi.CallForUserAsync<object, Todo>(
            ServiceName,
            null,
            options =>
            {

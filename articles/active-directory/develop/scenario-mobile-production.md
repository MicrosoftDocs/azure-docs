...
To try out additional samples, see [Desktop public client applications](sample-v2-code.md#desktop-public-applications) and [Mobile public client applications](sample-v2-code.md#mobile-applications).
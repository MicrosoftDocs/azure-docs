...
>
> #### Step 2: Open up the application.properties file
>
> 1. Extract the zip file to a local folder
> 1. If you use an integrated development environment, open up the sample in your favorite IDE (optional).
> 1. Open the *application.properties* file. You will fill these values when you register your application in the next step.

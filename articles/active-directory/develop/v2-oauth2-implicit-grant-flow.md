...
To initially sign the user into your app, you can send an [OpenID Connect](v2-protocols-oidc.md) autentication request and get an `id_token` from the Microsoft identity platform endpoint.

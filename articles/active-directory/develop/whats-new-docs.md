...
- [Add your application to the Azure Active Directory application gallery](v2-howto-app-gallery-listing.md)
- [Get AppSource certified for Azure Active Directory](v2-howto-get-appsource-certified.md)
...
- [Authentication flows](msal-authentication-flows.md)
- [Call the Microsoft Graph API from a Universal Windows Platform application (XAML)](tutorial-v2-windows-uwp.md)

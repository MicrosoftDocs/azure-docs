...
![Side-by-side code for public client applications](./media/msal-compare-msaldotnet-and-adaldotnet/differences.png)
...
![Side-by-side code for confidential client applications](./media/msal-net-migration/confidential-client-application.png)

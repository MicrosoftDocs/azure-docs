...
> * Accounts that don't have passwords can't sign in through ROPC. For this scenario, we recommend that you use a different flow for your app instead. This means that features like SMS sign in, FIDO, and the Authenticator app will not work with ROPC.

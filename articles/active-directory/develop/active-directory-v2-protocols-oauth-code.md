...
| code_challenge_method | optional    | The method used to encode the `code_challenge` parameter. Can be one of `plain` or `S256`.  If excluded, `code_challenge` is assumed to be plaintext if included.  Azure AAD v2.0 supports both `plain` and `S256`. For more information, see the [PKCE RFC](https://tools.ietf.org/html/rfc7636).                                                                                                                                                                                                                                                                                                                      |
...
| code_verifier | optional              | The same code_challenge that was used to acquire the authorization_code.  Required if PKCE was used in the authorization code grant request.  For more information, see the [PKCE RFC](https://tools.ietf.org/html/rfc7636)                                                                                                                                                                                                                                                                                             |
#### Successful response

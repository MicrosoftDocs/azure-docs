...
[meh](../../app-service/networking/app-gateway-with-service-endpoints.md)
[meh](../../third-party-notices.md)
[meh](../overview.md)
[meh](../conditional-access/controls.md)

[meh](./overview.md)
[OAuth 2.0 or OpenID Connect](active-directory-v2-protocols.md)
[OAuth 2.0 or OpenID Connect](http://github.com)
[OAuth 2.0 or OpenID Connect](/azure/active-directory/develop)
...
[1]: v2-oauth2-client-creds-grant-flow.md
[2]: ../overview.md

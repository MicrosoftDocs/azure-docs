...
The client ID is the unique **Application (client) ID** assigned to your app by Microsoft Entra ID when the app was registered. You can find the **Application (Client) ID** in your Azure subscription by Microsoft Entra ID => Enterprise applications => Application ID.

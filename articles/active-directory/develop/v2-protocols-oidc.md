...
1. Select **Microsoft Entra ID** > **App registrations** > *\<your application\>* > **Manifest**.
...
| `client_id` | Required | The **Application (client) ID** that the [Mcirosoft Microsoft Entra admin center – App registrations](https://go.microsoft.com/fwlink/?linkid=2083908) experience assigned to your app. |

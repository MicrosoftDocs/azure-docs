...
| [Azure Resource Manager APIs](active-directory-azure-resource-manager.md)                                                       | How to authenticate to the Azure ARM APIs |
| [Azure API Management](active-directory-azure-api-mgmt.md)                                                                      | How to use Azure AD to secure APIs with Azure API Management |
| [Azure App Services](active-directory-azure-app-services.md)                                                                    | How to use Azure with Azure App Services |
| [Azure Key Vault](active-directory-azure-key-vault.md)                                                                          | How to use Azure AD with Azure Key Vault |

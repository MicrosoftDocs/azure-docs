...
> [!NOTE] 
We will soon no longer support registering and managing converged and Azure AD applications in the [Application Registration Portal](https://apps.dev.microsoft.com/?referrer=https://azure.microsoft.com/). We recommend that you manage your existing applications and register new applications by using the [App registrations (Preview)](https://aka.ms/appregistrations) experience in the Azure portal.

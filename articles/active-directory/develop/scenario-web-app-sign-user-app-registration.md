---
title: Web app that signs-in users - app registration | Azure
...
- the [Web App Quickstarts](#register-an-app-using-the-quickstarts). In addition to being a great first experience with creating application, quickstarts in the portal contain a button named **Make this change for me**. You can use this button to set the properties you need, even for an existing app. You'll however need to adapt the values of these properties to your own case. In particular, the Web API URL for your app is probably going to be different from the proposed default, which will also impact the sign out URI.

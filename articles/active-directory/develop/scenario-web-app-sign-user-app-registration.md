...
You can also register an application with Microsoft Graph PowerShell, using the [New-MgApplication](https://learn.microsoft.com/powershell/module/microsoft.graph.applications/new-mgapplication?view=graph-powershell-1.0).

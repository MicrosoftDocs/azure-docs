...
If you're an ISV building a multi-tenant application, you'd want to check the [Deployment - case of multi-tenant daemon apps](#deployment---case-of-multi-tenant-daemon-apps) paragraph.

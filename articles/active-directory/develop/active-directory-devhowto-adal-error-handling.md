---
title: Error handling best practices for ADAL clients
...
- [Native client](active-directory-dev-glossary.md#native-client) applications (iOS, Android, .NET Desktop, or Xamarin)
- [Web client](active-directory-dev-glossary.md#web-client) applications calling a [resource](active-directory-dev-glossary.md#resource-server) (.NET)

...
- [Native client](developer-glossary.md#native-client) applications (iOS, Android, .NET Desktop, or Xamarin)
- [Web client](developer-glossary.md#web-client) applications calling a [resource](developer-glossary.md#resource-server) (.NET)

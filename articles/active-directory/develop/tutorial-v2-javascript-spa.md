---
title: JavaScript single-page app tutorial | Azure
titleSuffix: Microsoft identity platform
description: In this tutorial, you learn how JavaScript single-page apps (SPAs) can call an API that requires access tokens issued by the Microsoft identity platform.

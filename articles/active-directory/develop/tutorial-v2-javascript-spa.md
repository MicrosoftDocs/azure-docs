...
In summary, this code introduces methods of the application dealing with user access tokens, mostly done by the function `acquireTokenSilent`. For more information on the back-end workings of the application, see [More Information](#more-information).

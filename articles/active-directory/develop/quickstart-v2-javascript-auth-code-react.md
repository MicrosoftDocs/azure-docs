---
title: "Quickstart: Sign in users in JavaScript React single-page apps (SPA) with auth code | Azure"
titleSuffix: Microsoft identity platform
description: In this quickstart, learn how a JavaScript React single-page application (SPA) can sign in users of personal accounts, work accounts, and school accounts by using the authorization code flow.
...
# Quickstart: Sign in users and get an access token in a JavaScript React SPA using the auth code flow

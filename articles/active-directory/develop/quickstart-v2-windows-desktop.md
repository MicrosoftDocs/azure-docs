...
In this quickstart, you download and run a code sample that demonstrates how a Windows desktop .NET (WPF) application can sign users and obtain an access token to call the Microsoft Graph API. 

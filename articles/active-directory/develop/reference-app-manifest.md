...
| `availableToOtherTenants` | boolean | Unsupported. Replaced by `signInAudience`. | |
...
| `displayName` | string | Unsupported. Replaced by `name`. | |
...
| `homePage` | string | Unsupported. Replaced by `signInUrl`. | |
| `objectId` | string | Unsupported. Replaced by `id`. | |
...
| `publicClient` | boolean | Unsupported. Replaced by `allowPublicClient`. | |
| `replyUrls` | String array | Unsupported. Replaced by `replyUrlsWithType`. | |

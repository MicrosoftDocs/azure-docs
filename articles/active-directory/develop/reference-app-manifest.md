...
### Key, Value type: `accessTokenAcceptedVersion`, Nullable Int32 
...
### Key, Value type: `addIns`, Collection 
...
### Key, Value type: `allowPublicClient`, Boolean 
...
### Key, Value type: `availableToOtherTenants`, Boolean 
...
### Key, Value type: `appId`, String 
Specifies the unique identifier for the app that is assigned to an app by Azure AD. 

Example value: 
`"601790de-b632-4f57-9523-ee7cb6ceba95"` 

### Key, Value type: `appRoles`, Collection 
...
### Key, Value type: `displayName`, String 
...
### Key, Value type: `errorUrl`, String 
Unsupported. 

### Key, Value type: `groupMembershipClaims`, String 
...
### Key, Value type: `homepage`, String 
...
### Key, Value type: `identifierUris`, String Array 
...
### Key, Value type: `informationalUrls`, String 
...
### Key, Value type: `keyCredentials`, Collection 
...
### Key, Value type: `knownClientApplications`, String Array 
...
### Key, Value type: `logoUrl`, String 
Read only value that points to the CDN URL to logo that was uploaded in the portal. 

Example value: 
`"https://MyRegisteredAppLogo"` 

### Key, Value type: `logoutUrl`, String 
The URL to log out of the app. 

Example value:  
`"https://MyRegisteredAppLogout"` 

### Key, Value type: `name`, String 
The display name for the app. 

Example value: 
`"MyRegisteredApp"` 

### Key, Value type: `oauth2AllowImplicitFlow`, Boolean 
...
### Key, Value type: `oauth2AllowIdTokenImplicitFlow`, Boolean 
...
### Key, Value type: `oauth2Permissions`, Collection 
...
### Key, Value type: `oauth2RequiredPostResponse`, Boolean 
...
### Key, Value type: `parentalControlSettings`, String 
...
### Key, Value type: `passwordCredentials`, Collection 
...
### Key, Value type: `preAuthorizedApplications`, Collection 
...
### Key, Value type: `replyUrls`, String array 
This multi-value property holds the list of registered redirect_uri values that Azure AD will accept as destinations when returning tokens. <br><br> This property is available only in the **App registrations (Legacy)** experience. Replaced by `replyUrlsWithType` in the [App registrations](https://go.microsoft.com/fwlink/?linkid=2083908) experience. 

### Key, Value type: `replyUrlsWithType`, Collection 
...
### Key, Value type: `requiredResourceAccess`, Collection 
...
### Key, Value type: `samlMetadataUrl`, String 
The URL to the SAML metadata for the app. 

Example value: 
`https://MyRegisteredAppSAMLMetadata` 

### Key, Value type: `signInUrl`, String 
...
### Key, Value type: `tags`, String Array 

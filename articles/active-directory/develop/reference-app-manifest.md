...
| `availableToOtherTenants` | Boolean | true if the application is shared with other tenants; otherwise, false. <br><br> _Note: This is replaced by `signInAudience` in the [App Registrations (Preview)](https://developer.microsoft.com/en-us/graph/blogs/new-app-registration/) experience._ | |
...
| `displayName` | String | The display name for the app. <br><br> _Note: This is replaced by `name` in the [App Registrations (Preview)](https://developer.microsoft.com/en-us/graph/blogs/new-app-registration/) experience._ | `"MyRegisteredApp"` |
...
| `homepage` | String | The URL to the application's homepage. <br><br> _Note: This is replaced by `signInUrl` in the [App Registrations (Preview)](https://developer.microsoft.com/en-us/graph/blogs/new-app-registration/) experience._ | `"https://MyRegisteredApp"` |
| `objectId` | String | The unique identifier for the app in the directory. <br><br> _Note: This is replaced by `id` in the [App Registrations (Preview)](https://developer.microsoft.com/en-us/graph/blogs/new-app-registration/) experience._ | `"f7f9acfc-ae0c-4d6c-b489-0a81dc1652dd"` |
...
| `publicClient` | Boolean | Specifies whether this application is a public client (such as an installed application running on a mobile device). <br><br> _Note: This is replaced by `allowPublicClient` in the [App Registrations (Preview)](https://developer.microsoft.com/en-us/graph/blogs/new-app-registration/) experience._ | |
| `publisherDomain` | String | The verified publisher domain for the application. Read-only. | https://www.contoso.com |
| `replyUrls` | String array | This multi-value property holds the list of registered redirect_uri values that Azure AD will accept as destinations when returning tokens. <br><br> _Note: This is replaced by `replyUrlsWithType` in the [App Registrations (Preview)](https://developer.microsoft.com/en-us/graph/blogs/new-app-registration/) experience._ | |

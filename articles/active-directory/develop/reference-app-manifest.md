...
> |---------|---------|---------|---------|
> | `accessTokenAcceptedVersion` | nullable integer | Specifies the accepted version of the access token for the current API resource. Possible values are 1, 2, null. Defaults to null which will be treated as 2. | `2` |

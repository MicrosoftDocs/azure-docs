...
![Diagram shows UserSync App with three local items connecting to Azure, with Start.Auth acquiring a token interactively to connect to Azure AD, AccountController getting admin consent to connect to Azure AD, and SyncController reading user to connect to Microsoft Graph.](./media/tutorial-v2-aspnet-daemon-webapp/topology.png)

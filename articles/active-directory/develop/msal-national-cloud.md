...
- Azure AD Government: Commonly used if your organization already has an Azure AD Government tenant to support Microsoft 365 (GCC High or DoD) or is creating a new tenant in Azure AD Government.

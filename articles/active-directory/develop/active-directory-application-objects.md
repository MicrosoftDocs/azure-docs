...
When you register an application in the [Azure portal](active-directory-integrating-applications), two objects are created in your Azure AD tenant: an application object, and a service principal object.

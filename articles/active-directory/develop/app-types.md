...
### Registering an app that uses the Azure AD v2.0 endpoint
...
For details, learn how to [register an app with the Azure AD v2.0 endpoint](quickstart-v2-register-an-app.md).

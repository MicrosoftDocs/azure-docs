...
> [!NOTE]
> This article links to Azure AD V1 samples. If you are interested in Azure AD V2 samples, see  [v2.0 code samples by scenario](active-directory-v2-code-samples.md).
>

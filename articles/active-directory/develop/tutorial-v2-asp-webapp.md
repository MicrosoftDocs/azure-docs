---
title: "Tutorial: Add sign-in to Microsoft identity platform ASP.NET web app"
titleSuffix: Microsoft identity platform
description: In this tutorial, you implement Microsoft sign-in in an ASP.NET solution by using a traditional web browser-based application and OpenID Connect.
...
> * Enable sign-in and sign-out functionality
> * Register the app in the Azure portal
> * Test the web app

## Prerequisites

* [Visual Studio 2019](https://visualstudio.microsoft.com/vs/) with the *ASP.NET and web development* workload

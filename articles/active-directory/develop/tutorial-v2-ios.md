...
In this tutorial, you build an iOS or macOS app that integrates with the Microsoft identity platform to sign users and obtain an access token to call the Microsoft Graph API.

---
title: "Tutorial: Microsoft Authentication Library (MSAL) for iOS & macOS | Azure"
titleSuffix: Microsoft identity platform
description: Learn how iOS and macOS (Swift) apps can call an API that requires access tokens by using the Microsoft identity platform
...
This tutorial is applicable to both iOS and macOS apps. Some steps are different between those two platforms.

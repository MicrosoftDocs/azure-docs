...
1. To check the tenant, sign in to the <a href="https://portal.azure.com/" target="_blank">Azure portal</a> with the account you want to use to manage your application.

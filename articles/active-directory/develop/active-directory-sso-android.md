...
The Microsoft Identity platform, along with the Microsoft Identity SDKs, handle this for you and gives you the ability to delight your customers with SSO either within your own suite of applications or, as with the broker capability and Authenticator applications, across the entire device.

This walkthrough will tell you how to configure the SDK within your application to provide this benefit to your customers.

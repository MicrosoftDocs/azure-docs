...
This quickstart uses a code sample to demonstrate an Android application that signs-in personal, work, or school accounts, gets an access token, and calls the Microsoft Graph API.

...
OAuth2 permissions are permission scopes that a Microsoft Entra ID for developers (v1.0) web API (resource) application exposes to client applications. These permission scopes may be granted to client applications during consent. See the section about `oauth2Permissions` in the [Microsoft Entra application manifest reference](reference-app-manifest.md#manifest-reference).
...
- For ADAL (Microsoft Entra v1.0) endpoint with a v1.0 access token (the only possible), aud=resource

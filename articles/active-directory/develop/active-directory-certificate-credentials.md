...
> [!NOTE]
> You must calculate the X5T header by converting it to a base 64 string using the certificate's hash. In C#, you could utilize something like : `System.Convert.ToBase64String(cert.GetCertHash());`

...
|replyUrls     |  String array       |   http:<i></i>//localhost     |  This multivalue property holds the list of registered redirect_uri values that Azure AD will accept as as destinations when returning tokens. |

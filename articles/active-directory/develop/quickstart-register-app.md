...
1. Sign in to the [Azure portal](https://portal.azure.com/)<span class="docon docon-navigate-external x-hidden-focus"></span>
1. Sign in test2 <a href="https://portal.azure.com/"> Azure portal<span class="docon docon-navigate-external x-hidden-focus"></span></a>.
1. Sign in test <a href="https://portal.azure.com/" target="_blank">Azure portal<span class="docon docon-navigate-external x-hidden-focus"></span></a>.

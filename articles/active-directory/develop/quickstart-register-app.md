...
For security reasons, Microsoft currently limits the creation of client secrets that are longer than 24 months and strongly recommends that you set this to a value less than 12 months.

...
It doesn't have a parameter of type `UserAssertion`. If it does, then your app is a web API, and it's using [on behalf of flow](#migrate-on-behalf-of-calls-obo-in-web-apis) scenario.

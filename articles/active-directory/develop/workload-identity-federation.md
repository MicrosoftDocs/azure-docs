...
You can access Azure and Microsoft Graph resources using workload identity federation from GitHub Actions and workloads running on Kubernetes.

Configure a [trust relationship with GitHub](workload-identity-federation-create-trust-github.md) in the Azure portal. For information on setting up your GitHub Actions workflow and accessing Azure resources, see the  [GitHub Actions documentation](https://docs.github.com/actions/deployment/security-hardening-your-deployments/configuring-openid-connect-in-azure).

...
1. Sign in to the <a href="https://entra.microsoft.com/#home" target="_blank"><Microsoft Entra admin center</a>.
...
1. Select **Identity** > **Applications** > **App registrations**, and then select your API's app registration.

...
| API permissions (`requiredResourceAccess`) | Maximum of 50 resources and 400 permissions per application. | Maximum of 50 resources and 400 permissions per application. | Maximum of 50 resources per application and 30 permissions per resource (e.g. Microsoft Graph). Total limit of 200 per application (resources x permissions). | 

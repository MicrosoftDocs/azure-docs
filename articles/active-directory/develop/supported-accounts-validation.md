...
- *AzureADandPersonalMicrosoftAccount*: Accounts in any organizational directory (multi-tenant) and personal Microsoft accounts (e.g. Skype, Xbox, Outlook.com)

For registered applications, you can find the value for Supported account types on the <b>Authentication</b> section of an application. You can also find it under the `signInAudience` property in the <b>Manifest</b>.

The value selected for this property has implications on other app object properties. As a result, changing this property may require you to first change other properties.
...
| Redirect URIs (`replyURLs`) | See [this](https://docs.microsoft.com/en-us/azure/active-directory/develop/reply-url) doc. | | | 

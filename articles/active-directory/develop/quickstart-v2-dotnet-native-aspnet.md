...
1. Under **Manage**, select **Expose an API** section, select **Add a scope**, accept the proposed Application ID URI (`api://{clientId}`) by selecting **Save and Continue**, and then enter the following information:

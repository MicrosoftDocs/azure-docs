...
:::row:::
   ...
   :::column span="":::
      **Web API**
        - [ADAL Java to MSAL Java](/msal/java/advanced/migrate-adal-msal-java)
        - [ADAL Python to MSAL Python](/msal/python/advanced/migrate-python-adal-msal)
        - [ADAL.NET to MSAL.NET](../msal-net-migration.md)
   :::column-end:::
:::row-end:::
...
:::row:::
   :::column span="":::
      **Desktop app**
        - [ADAL Java to MSAL Java](/msal/python/advanced/migrate-adal-msal-java.md)
        - [ADAL Python to MSAL Python](/msal/python/advanced/migrate-python-adal-msal)
        - [ADAL.NET to MSAL.NET](../msal-net-migration.md)
   :::column-end:::
   :::column span="":::

...
1. Enter "app registrations" in the search bar at the top of the Azure portal and select **App registrations** in the results.
...
[Download the sample project](https://github.com/Azure-Samples/ms-identity-python-webapp/archive/master.zip) and extract the contents to a folder on your computer.
...
* Set the value of `TENANT_NAME` to the **Directory (tenant) ID** of the registered application, available on the overview page.

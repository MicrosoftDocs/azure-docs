...
1. Use the **Directories + subscriptions** filter in the top menu to switch to the tenant where the application should be registered.
    ...
    :::image type="content" source="./media/tutorial-dotnet-web-app-register-application/select-tenant.png" alt-text="Select a tenant in Azure Active Directory.":::
...
1. Enter a **Name** for the application, such as *NewWebApp1*.
    ...
    :::image type="content" source="./media/tutorial-dotnet-web-app-register-application/register-application.png" alt-text="Enter a name and select the account type.":::
...
1. Record the values that you located to be used in later steps.
    ...
    :::image type="content" source="./media/tutorial-dotnet-web-app-register-application/record-identifiers.png" alt-text="Record the identifier values on the overview page.":::
...
> [Tutorial: Prepare the application for authentication](tutorial-dotnet-web-app-prepare-application.md)
...
# External user token format for Azure Active Directory B2B collaboration preview
...
The claims that are different for an authenticated external user are as follows:<br/>

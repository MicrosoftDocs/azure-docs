...
4. In the search box, type **iWellnessNow**, select **iWellnessNow** from result panel then click **Add** button to add the application.

	![iWellnessNow in the results list](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_addfromgallery.png)
...
3. **[Create an iWellnessNow test user](#create-an-iwellnessnow-test-user)** - to have a counterpart of Britta Simon in iWellnessNow that is linked to the Azure AD representation of user.
...
5. On the **SAML Signing Certificate** section, click **Metadata XML** and then save the metadata file on your computer.
	...
	![The Certificate download link](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_certificate.png) 

6. Click **Save** button.

	![Configure Single Sign-On Save button](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_general_400.png)
	
7. To configure single sign-on on **iWellnessNow** side, you need to send the downloaded **Metadata XML** to [iWellnessNow support team](mailto:info@iwellnessnow.com). They set this setting to have the SAML SSO connection set properly on both sides.
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-iwellnessnow-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-iwellnessnow-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-iwellnessnow-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-iwellnessnow-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **iWellnessNow**.
	...
	![The iWellnessNow link in the Applications list](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_app.png)  

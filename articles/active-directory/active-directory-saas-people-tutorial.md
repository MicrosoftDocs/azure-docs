...
3. On the **People Domain and URLs** section, perform the following steps:
	...
	a. In the **Sign-on URL** textbox, type the URL: `https://stewartwelsh.peoplehr.com/`

    b. In the **Identifier** textbox, type the URL: `https://www.peoplehr.com`

	c. In the **Reply URL** textbox, type the URL: `https://stewartwelsh.peoplehr.net/Pages/Saml/ConsumeAzureAD.aspx`

...
Azure AD RBAC enables the company to restrict the amount of operations that an individual can do once he has access to the Azure portal. By using RBAC to control access to the portal, IT Admins ca delegate access by using the following access management approaches:
...
Azure Active Directory provides single-sign on and enhanced application access security to thousands of SaaS applications and on-premises web applications. For more information, see [Integrating applications with Azure Active Directory](../../articles/active-directory/develop/active-directory-integrating-applications.md)

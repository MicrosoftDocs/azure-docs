...
4. In the search box, type **Proxyclick**, select **Proxyclick** from result panel then click **Add** button to add the application.
	...
	![Proxyclick in the results list](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as **SAML-based Sign-on** to enable single sign-on.
	...
	![Single sign-on dialog box](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_samlbase.png)
...
3. On the **Proxyclick Domain and URLs** section, perform the following steps if you wish to configure the application in **IDP** initiated mode:
	...
	![Proxyclick Domain and URLs single sign-on information](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_url2.png)
...
4. Check **Show advanced URL settings** and perform the following step if you wish to configure the application in **SP** initiated mode:
	...
	![Proxyclick Domain and URLs single sign-on information](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_url1.png)
...
5. On the **SAML Signing Certificate** section, click **Certificate(Base64)** and then save the certificate file on your computer.
	...
	![The Certificate download link](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_certificate.png) 

6. Click **Save** button.

	![Configure Single Sign-On Save button](./media/active-directory-saas-proxyclick-tutorial/tutorial_general_400.png)
...
7. On the **Proxyclick Configuration** section, click **Configure Proxyclick** to open **Configure sign-on** window. Copy the **SAML Entity ID and SAML Single Sign-On Service URL** from the **Quick Reference section.**
	...
	![Proxyclick Configuration](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_configure.png)

8. In a different web browser window, log in to your Proxyclick company site as an administrator.

9. Select **Account & Settings**.

	![Proxyclick Configuration](./media/active-directory-saas-proxyclick-tutorial/configure1.png)

10. Scroll down to the **INTEGRATIONS** and select **SAML**.

	![Proxyclick Configuration](./media/active-directory-saas-proxyclick-tutorial/configure2.png)

11. In the **SAML** section, perform the following steps:

	![Proxyclick Configuration](./media/active-directory-saas-proxyclick-tutorial/configure3.png)
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_04.png)
...
3. Click **Add Colleague**
	...
	![Add Employee](./media/active-directory-saas-proxyclick-tutorial/user2.png)

4. In the **Add a colleague** section, perform the following steps:

	![Add Employee](./media/active-directory-saas-proxyclick-tutorial/user3.png)
...
2. In the applications list, select **Proxyclick**.
	...
	![The Proxyclick link in the Applications list](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_app.png)  

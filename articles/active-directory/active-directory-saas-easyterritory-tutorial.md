...
4. In the search box, type **EasyTerritory**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-easyterritory-tutorial/tutorial_easyterritory_001.png)

5. In the results panel, select **EasyTerritory**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-easyterritory-tutorial/tutorial_easyterritory_0001.png)
...
4. On the **User** dialog page, perform the following steps:
	...
	![Creating an Azure AD test user](./media/active-directory-saas-easyterritory-tutorial/create_aaduser_04.png) 

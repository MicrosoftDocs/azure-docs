...
This method can also be used to replace the active sync server. Prepare the new server and set it in staging mode. Make sure it is in good state and then disable staging mode and shut down the currently active server.

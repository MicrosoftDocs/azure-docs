...
## Adding Teamwork from the gallery
...
4. In the search box, type **Teamwork**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_001.png)

5. In the results panel, select **Teamwork**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_0001.png)
...
2. Go to **Users and groups** and click **All users** to display the list of users.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-teamwork-tutorial/create_aaduser_02.png) 
...
2. In the applications list, select **Teamwork**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_50.png) 

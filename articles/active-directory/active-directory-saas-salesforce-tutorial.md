...
If you are using a Salesforce Sandbox environment, please see the [Salesforce Sandbox integration tutorial](https://msdn.microsoft.com/en-us/library/azure/dn798671.aspx).

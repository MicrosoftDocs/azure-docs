---
title: 'Tutorial: Azure Active Directory integration with JIRA 5.2 SAML SSO by Microsoft | Microsoft Docs'
description: Learn how to configure single sign-on between Azure Active Directory and JIRA 5.2 SAML SSO by Microsoft.
...
---
# Tutorial: Azure Active Directory integration with JIRA 5.2 SAML SSO by Microsoft

In this tutorial, you learn how to integrate JIRA 5.2 SAML SSO by Microsoft with Azure Active Directory (Azure AD).

Integrating JIRA 5.2 SAML SSO by Microsoft with Azure AD provides you with the following benefits:

- You can control in Azure AD who has access to JIRA 5.2 SAML SSO by Microsoft.
- You can enable your users to automatically get signed-on to JIRA 5.2 SAML SSO by Microsoft (Single Sign-On) with their Azure AD accounts.
...
1. Adding JIRA 5.2 SAML SSO by Microsoft from the gallery
2. Configuring and testing Azure AD single sign-on

## Adding JIRA 5.2 SAML SSO by Microsoft from the gallery
To configure the integration of JIRA 5.2 SAML SSO by Microsoft into Azure AD, you need to add JIRA 5.2 SAML SSO by Microsoft from the gallery to your list of managed SaaS apps.

**To add JIRA 5.2 SAML SSO by Microsoft from the gallery, perform the following steps:**
...
In this section, you configure and test Azure AD single sign-on with JIRA 5.2 SAML SSO by Microsoft based on a test user called "Britta Simon".

For single sign-on to work, Azure AD needs to know what the counterpart user in JIRA 5.2 SAML SSO by Microsoft is to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in JIRA 5.2 SAML SSO by Microsoft needs to be established.

To configure and test Azure AD single sign-on with JIRA 5.2 SAML SSO by Microsoft, you need to complete the following building blocks:

1. **[Configure Azure AD Single Sign-On](#configure-azure-ad-single-sign-on)** - to enable your users to use this feature.
2. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
3. **[Create a JIRA 5.2 SAML SSO by Microsoft test user](#create-a-jira-5.2-saml-sso-by-microsoft-test-user)** - to have a counterpart of Britta Simon in JIRA 5.2 SAML SSO by Microsoft that is linked to the Azure AD representation of user.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Test single sign-on](#test-single-sign-on)** - to verify whether the configuration works.

### Configure Azure AD single sign-on

In this section, you enable Azure AD single sign-on in the Azure portal and configure single sign-on in your JIRA 5.2 SAML SSO by Microsoft application.

**To configure Azure AD single sign-on with JIRA 5.2 SAML SSO by Microsoft, perform the following steps:**

1. In the Azure portal, on the **JIRA 5.2 SAML SSO by Microsoft** application integration page, click **Single sign-on**.

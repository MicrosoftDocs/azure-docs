...
Looking to get started using apps for Single Sign-On? Check out the [Quickstart Series on application management in Azure AD](../manage-apps/view-applications-portal.md).

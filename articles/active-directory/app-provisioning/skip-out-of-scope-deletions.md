...
You should get the output as "Success – Status Code 204". If you receive an error you may need to check that your account has Read/Write permissions on the ServicePrincipleEndpoint. You can find this permission by clicking on the *Modify permissions* tab in Graph Explorer.

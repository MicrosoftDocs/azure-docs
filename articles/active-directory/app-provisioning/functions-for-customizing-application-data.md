...
## Related Articles
<<<<<<< HEAD:articles/active-directory/app-provisioning/functions-for-customizing-application-data.md
* [Automate User Provisioning/Deprovisioning to SaaS Apps](../manage-apps/user-provisioning.md)
* [Customizing Attribute Mappings for User Provisioning](../manage-apps/customize-application-attributes.md)
=======
...
>>>>>>> 2e3429a2f26a27eab3834fc8558a27caf1ae0d67:articles/active-directory/manage-apps/functions-for-customizing-application-data.md

...
description: Learn how to troubleshoot issues faced when saving administrator credentials while configuring user provisioning to an Azure Active Directory Gallery application.

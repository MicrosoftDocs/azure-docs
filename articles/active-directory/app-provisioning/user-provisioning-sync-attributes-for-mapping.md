...
You will need to use an application to extend the schema of your users. List the apps in your tenant to identify the id of the application that you would like to use to extend the user schema. 
...
Update a user with the extension attribute.
```json
PATCH https://graph.microsoft.com/v1.0/users/{id}
Content-type: application/json

{
  "extension_12345_extensionName": "extensionValue"
}
```
Check the user to ensure the attribute was successfully updated.

```json
GET https://graph.microsoft.com/v1.0/users/{id}?$select=displayName,extension_12345_extensionName
```

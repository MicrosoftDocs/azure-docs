...
* [Using System for Cross-Domain Identity Management (SCIM) to automatically provision users and groups from Azure Active Directory to applications](../manage-apps/use-scim-to-provision-users-and-groups.md)

* [Understand the Azure AD SCIM implementation](../manage-apps/use-scim-to-provision-users-and-groups.md)

...
This option should only be used as a temporary workaround to unblock the customer until the GMSA permission issue is investigated and resolved. Our recommendation is to use the GMSA account.

...
- **Matching based on a combination of attributes is not supported:** Most applications don't support querying based on two properties. Therefore, it is not possible to match based on a combination of attributes. It is possible to evaluate single properties on after another.

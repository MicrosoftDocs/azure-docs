...
* Microsoft Teams does not support converting the [userType](../external-identities/user-properties) property on a B2B user from `member` to `guest` or `guest` to `member`.

...
# Doc 3 - Lower level provisioning guidance for developers (Using SCIM and Microsoft Graph to provision and enrich your application with the data it needs)
...
|Azure AD Connect||||
|Azure AD Connect Cloud Provisinoing||||

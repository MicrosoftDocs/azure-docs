...
<<<<<<< HEAD:articles/active-directory/manage-apps/application-provisioning-when-will-provisioning-finish.md
...
=======
-   **User scoping filters.** Scoping filters allow you to fine tune the data that the provisioning service extracts from Azure AD by filtering out users based on specific attribute values. For more information on scoping filters, see [Attribute-based application provisioning with scoping filters](../manage-apps/define-conditional-rules-for-provisioning-user-accounts.md).
>>>>>>> 2e3429a2f26a27eab3834fc8558a27caf1ae0d67:articles/active-directory/app-provisioning/application-provisioning-when-will-provisioning-finish.md

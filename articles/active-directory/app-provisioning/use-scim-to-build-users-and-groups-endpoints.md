...
[[images/appservice_settings.png]]
...
Test the solution locally using the steps described in [Test Your SCIM Endpoint](Test-Your-SCIM-Endpoint).
...
In case of doubt, open an issue in the [issue tracker](https://github.com/AzureAD/SCIMReferenceCode/issues).
...
Go to `https://github.com/AzureAD/SCIMReferenceCode` and select your feature branch. Click the 'Pull Request' button and fill out the form.

...
The objective of this section is to enable Azure AD single sign-on in the Azure AD portal and to configure single sign-on in your Domo application.



**To configure Azure AD single sign-on with Domo, perform the following steps:**

1. In the Azure AD portal, on the **Domo** application integration page, click **Configure single sign-on** to open the **Configure Single Sign-On**  dialog.
...
<br><br>![Configure Single Sign-On](./media/active-directory-saas-domo-tutorial/tutorial_domo_04.png) <br>
    ...
    a. In the Sign On URL textbox, type the URL used by your users to sign-on to your Domo application using the following pattern: **“https://companyname.domo.com/auth/saml”**.

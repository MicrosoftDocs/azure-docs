...
>
>DirSync and Azure AD Sync are deprecated. More information can be found in [here](https://azure.microsoft.com/documentation/articles/active-directory-aadconnect-dirsync-deprecated).

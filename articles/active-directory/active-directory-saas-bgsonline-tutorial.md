...
4. In the search box, type **BGS Online**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-bgsonline-tutorial/tutorial_bgsonline_search.png)

5. In the results panel, select **BGS Online**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-bgsonline-tutorial/tutorial_bgsonline_addfromgallery.png)
...
1. In the **Azure portal**, on the left navigation pane, click **Azure Active Directory** icon.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-bgsonline-tutorial/create_aaduser_01.png) 

2. To display the list of users, go to **Users and groups** and click **All users**.
	
	![Creating an Azure AD test user](./media/active-directory-saas-bgsonline-tutorial/create_aaduser_02.png) 

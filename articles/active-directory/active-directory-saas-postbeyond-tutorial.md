...
1. On the **Configure single sign-on at PostBeyond** page, Click **Download certificate**, and then save the file on your computer. Also, copy the issuer URL, single sign-on service URL and single sign-out service URL values. You will need to share this information with PostBeyond support to get SSO configured.
   
    ![Configure Single Sign-On](./media/active-directory-saas-postbeyond-tutorial/tutorial_postbeyond_08.png)
2. To get SSO configured for your application, contact PostBeyond support team at <mailto:sso@postbeyond.com>. They will assist with the proper channel to configure SSO and provide them the following: 

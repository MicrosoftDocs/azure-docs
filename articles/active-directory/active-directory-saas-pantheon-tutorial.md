---
pageTitle: 'Tutorial: Azure Active Directory integration with Pantheon | Microsoft Docs'
...
6. In the search box, type **Pantheon**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-pantheon-tutorial/tutorial_pantheon_01.png)

7. In the results pane, select **Pantheon**, and then click **Complete** to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-pantheon-tutorial/tutorial_pantheon_02.png)
...
![Configure Single Sign-On](./media/active-directory-saas-pantheon-tutorial/tutorial_pantheon_06.png)
...
2. On the **How would you like users to sign on to Pantheon** page, select **Azure AD Single Sign-On**, and then click **Next**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-pantheon-tutorial/tutorial_pantheon_03.png) 

3. On the **Configure App Settings** dialog page, perform the following steps:

	![Configure Single Sign-On](./media/active-directory-saas-pantheon-tutorial/tutorial_pantheon_04.png) 
...
4. On the **Configure single sign-on at Pantheon** page, perform the following steps:
	...
	![Configure Single Sign-On](./media/active-directory-saas-pantheon-tutorial/tutorial_pantheon_05.png)
...
1. In the **Azure classic portal**, on the left navigation pane, click **Active Directory**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-pantheon-tutorial/create_aaduser_09.png) 
...
5. On the **Tell us about this user** dialog page, perform the following steps:
	![Creating an Azure AD test user](./media/active-directory-saas-pantheon-tutorial/create_aaduser_05.png) 
...
6.  On the **User Profile** dialog page, perform the following steps:
	![Creating an Azure AD test user](./media/active-directory-saas-pantheon-tutorial/create_aaduser_06.png) 
...
7. On the **Get temporary password** dialog page, click **create**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-pantheon-tutorial/create_aaduser_07.png) 

8. On the **Get temporary password** dialog page, perform the following steps:

	![Creating an Azure AD test user](./media/active-directory-saas-pantheon-tutorial/create_aaduser_08.png) 
...
### Creating an Pantheon test user
...
2. In the applications list, select **Pantheon**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-pantheon-tutorial/tutorial_pantheon_50.png) 

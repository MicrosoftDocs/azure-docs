...
4. In the search box, type **Pantheon**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-pantheon-tutorial/tutorial_pantheon_search.png)

5. In the results panel, select **Pantheon**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-pantheon-tutorial/tutorial_pantheon_addfromgallery.png)
...
2. To display the list of users, go to **Users and groups** and click **All users**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-pantheon-tutorial/create_aaduser_02.png) 

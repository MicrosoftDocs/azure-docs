...
4. In the search box, type **Montage Online**, select **Montage Online** from result panel then click **Add** button to add the application.
	...
	![Montage Online in the results list](./media/active-directory-saas-montageonline-tutorial/tutorial_montageonline_addfromgallery.png)
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-montageonline-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Montage Online**.
	...
	![The Montage Online link in the Applications list](./media/active-directory-saas-montageonline-tutorial/tutorial_montageonline_app.png)  

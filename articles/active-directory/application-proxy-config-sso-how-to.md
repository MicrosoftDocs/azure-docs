...
For more information on the Pre-Authentication methods, see step 4 of the [app publishing document](manage-apps/application-proxy-publish-azure-portal.md).

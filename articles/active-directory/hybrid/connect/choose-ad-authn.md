...
* **User experience**. To improve users' sign-in experience, use [Azure AD joined devices](../../devices/concept-azure-ad-join.md) or [Hybrid Azure AD joined devices](../../devices/howto-hybrid-join.md). If you can't join your Windows devices to Azure AD, we recommend deploying seamless SSO with password hash synchronization. Seamless SSO eliminates unnecessary prompts when users are signed in.

...
>[!NOTE]
>Not all releases of AADConnect will be made available for auto upgrade. The release status will indicate whether a release is made available for auto upgrade or for download only. If auto upgrade was enabled on your AADConnect server then that server will automatically upgrade to the latest version of AADConnect that is released for auto upgrade. Note that not all AADConnect configurations are eligible for auto upgrade. Please follow this link to read more about [auto upgrade](https://docs.microsoft.com/en-us/azure/active-directory/hybrid/how-to-connect-install-automatic-upgrade)

...
The cmdlet is part of the [ADSync PowerShell](reference-connect-adsync.md) module that is installed with Azure AD Connect. 
 ...
 [![Screenshot of Get-ADSyncAADCompanyFeature cmdlet](media/concept-azure-ad-connect-group-writeback/pshell-1.png)](media/concept-azure-ad-connect-group-writeback/pshell-1.png#lightbox)
...
You can view the existing writeback settings on M365 groups in the portal.  Navigate to the group and select it's properties.  You can see the Groupwrite back state on the group.
 ...
 [![Screenshot of Get-ADSyncAADCompanyFeature cmdlet](media/concept-azure-ad-connect-group-writeback/group-1.png)](media/concept-azure-ad-connect-group-writeback/group-1.png#lightbox)

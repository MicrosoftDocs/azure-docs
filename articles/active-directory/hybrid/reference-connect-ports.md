...
For a list of URLs and IP addresses you need to open in your firewall, see [Azure AD Connect Health Agent Installation](how-to-connect-health-agent-install.md#outbound-connectivity-to-the-azure-service-endpoints).

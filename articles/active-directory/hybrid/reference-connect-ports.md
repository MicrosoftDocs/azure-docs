...
| SMB | 445 (TCP) |Used by Seamless SSO to create a computer account in the AD forest and also during Password Writeback. See [Change a User Account's Password](https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-adod/d211aaba-d188-4836-8007-8c62f7c9402d) for more information. |

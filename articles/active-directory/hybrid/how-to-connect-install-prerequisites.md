...
#### Hardening you Azure AD Connect server 
...
- If you **cannot install** Azure AD Connect on a Domain Controller then: 
    ...
    - You **should** ensure every machine has a unique local administrator password. The [Local Administrator Password Solution (LAPS)](https://www.microsoft.com/en-us/download/details.aspx?id=46899#:~:text=The%20%22Local%20Administrator%20Password%20Solution,it%20or%20request%20its%20reset.) tool can configure unique random passwords on each workstation and server store them in Active Directory (AD) protected by an ACL. Only eligible authorized users can read or request the reset of these local administrator account passwords. You can obtain the LAPS for use on workstations and servers from the Microsoft Download Center or use the link above. Additional guidance for operating an environment with LAPS and PAWs can be found in [Operational standards based on clean source principle](https://docs.microsoft.com/windows-server/identity/securing-privileged-access/securing-privileged-access-reference-material#operational-standards-based-on-clean-source-principle). 
    - You **should** implement dedicated [Privileged Access Workstations (PAW)](https://docs.microsoft.com/windows-server/identity/securing-privileged-access/privileged-access-workstations) for all personnel with privileged access to your organization's information systems. Additional guidance for PAW deployment can be found in the article Privileged Access Workstations. 
    - You **should** follow these additional guidelines to reduce the attack surface of you Active Directory environment.  

...
* Installing AADC on a Domain Controller is not recommended due to security practices and more restrictive settings that can prevent AADC from installing correctly

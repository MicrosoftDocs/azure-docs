...
> [!NOTE]
> To integrate a Microsoft Active Directory (either on-premises or hosted in a IaaS environment) with the Azure Government cloud, you need to upgrade to the latest release of [Azure AD Connect](https://www.microsoft.com/download/details.aspx?id=47594).

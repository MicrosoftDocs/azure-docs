...
On **October 1, 2023**, Microsoft Entra cloud services will stop accepting connections from Microsoft Entra Connect V1 servers, and identities will no longer synchronize.

If you are still using Microsoft Entra Connect V1 you must take action immediately.

>[!IMPORTANT]
>Microsoft Entra Connect V1 will stop working on October 1st 2023.  You need to migrate to cloud sync or connect sync V2.

##  Migrate to cloud sync
Before moving to Microsoft Entra Connect V2, you should see if cloud sync is right for you instead.  Cloud sync uses a light-weight provisioning agent and is fully configurable through the portal. To choose the best sync tool for your situation, use the [Wizard to evaluate sync options.](https://aka.ms/EvaluateSyncOptions)
...
<a name='migrating-to-azure-ad-connect-v2'></a>

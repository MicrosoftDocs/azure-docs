...
> Group transformation using Regex feature can be used to transform only one group at a time currently. If you need to emit claims based on multiple conditions, refer to [Emitting claims based on conditions](https://docs.microsoft.com/azure/active-directory/develop/active-directory-saml-claims-customization#emitting-claims-based-on-conditions)

...
> [!NOTE]
> If a user has more than 999 transitive (direct + nested) group memberships, independently of the group filtering condition used to restrict the groups emitted in claims, the groups claim will present the same behavior as if reaching the groups limit of 150 for SAML assertions and 200 for JWT.  

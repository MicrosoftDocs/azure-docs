...
**Q: How can I disable Seamless SSO?**
   ...
   **Option B: Disable using PowerShell**
   ...
   At this point Sealess SSO is disabled but the domains will remain configured in case you would like to enable Seamless SSO back. If you would like to remove the domains from Seamless SSO configuration completely, call the following cmdlet after you completed step 5 above: `Disable-AzureADSSOForest -DomainFqdn <fqdn>`.

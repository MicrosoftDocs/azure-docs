...
## Installation
To install Azure AD Connect, you can use the documentation [here](../connect/active-directory-aadconnect.md#install-azure-ad-connect).

## Advanced features and Additional Information
For additional information and guidance on custom settings or advanced configurations, start with [Integrating your on-premises identities with Azure Active Directory](../connect/active-directory-aadconnect.md).  This page provides information and links to additional guidance.

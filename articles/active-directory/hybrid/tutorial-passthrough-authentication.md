---
title: 'Tutorial: Create a hybrid identity Active Directory tenant by using pass-through authentication'
description: Learn how to set up a hybrid identity environment by using pass-through authentication to integrate a Windows Server Active Directory tenant with Azure Active Directory.
...
# Tutorial: Create a hybrid identity Active Directory tenant by using pass-through authentication
...
1. In **Enable single sign-in credentials**, enter the contoso\Administrator user name and password, and then select **Next.**

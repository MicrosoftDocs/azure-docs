...
> [!NOTE]
> Changing your authentication method requires planning, testing, and potentially downtime. [Staged rollout](how-to-connect-staged-rollout.md) provide an alternative way to test and gradually migrate from federation to cloud authentication.

...
> [!IMPORTANT]
> Are you here because can't sign in? If so, see [Reset your work or school password](active-directory-passwords-update-your-own-password.md).
...
2. Enter your username and the password that was provided by your administrator.
3. Depending on how your IT staff have things configured, one or more of the following options should be available for you. All you need to do is configure and verify that the information is correct. If your administrator had your permission to use your information, they can populate some of the information for you:
    * **Office phone**: Can only be set by your administrator.
    * **Authentication Phone**: Set this to another phone number you have access to. An example is a cell phone that can receive a text or phone call.
    * **Authentication Email**: Set this to an alternate email address that you can access without the need to use the password you want to reset.
    * **Security Questions**: A list of questions your administrator has approved for you to answer. You can't use the same question or answer more than once.
4. Provide and verify the information required by your administrator. If more than one option is available, we suggest that you register multiple methods. This gives you flexibility when one of the methods isn't available. An example is when you're traveling and you're unable to access your office phone.

    ![Register authentication methods and select finish][Register]

5. Select **finish** and you can now use SSPR when you need to in the future.

If you enter data in the **Authentication Phone** or **Authentication Email** fields, it's not visible in the global directory. The only people who can see this data are you and your administrators. Only you can see the answers to your security questions.
...
| I get a "we could not verify your account" error after entering my user ID | We could not verify your account. <br> <br> If you'd like, we can contact an administrator in your organization to reset your password for you. | You're seeing this message because you're enabled for password reset, but you haven't registered to use the service. To register for password reset, go to http://aka.ms/ssprsetup after you have regained access to your account. <br> <br> To reset your password, select the **contact an administrator** link to send an email to your company's IT staff. |

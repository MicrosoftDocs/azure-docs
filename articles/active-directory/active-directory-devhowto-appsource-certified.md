...
## Related content
For more information on building applications that support Azure AD sign in, or to get help and support, check out the [Azure AD Developer's Guide][AAD-Dev-Guide].
...
[AAD-QuickStart-Web-Apps]: ./active-directory-developers-guide/#web-application-quick-start-guides

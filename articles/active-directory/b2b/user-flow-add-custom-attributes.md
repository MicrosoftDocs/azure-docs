...
You can find the `<aad-extensions-app-id>` on the **App registrations** page next to **Application (client) ID** for the `aad-extensions-app. Do not modify. Used by AAD for storing user data`. This ID is specific to your tenant.

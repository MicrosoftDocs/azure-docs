...
This feature is currently not supported. If access to your organization's resources require multi-factor authentication, partner organization will need to register for multi-factor authentication in your (the inviting) organization.

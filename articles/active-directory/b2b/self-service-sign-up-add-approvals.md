...
With [API connectors](api-connectors-overview.md), you can integrate your own custom approval system with self-service sign-up so you can manage which user accounts are created in your tenant.

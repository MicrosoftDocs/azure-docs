...
If you invite a user to the directory, the guest user must access a tenanted endpoint (such as https://portal.azure.com/*tenant*.onmicrosoft.com) to view and agree to the privacy terms.

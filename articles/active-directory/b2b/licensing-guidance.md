...
> [!NOTE]
> For details about Azure Active Directory pricing and B2B collaboration features, see [Azure Active Directory pricing](https://azure.microsoft.com/pricing/details/active-directory/).

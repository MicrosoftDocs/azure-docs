...
* You can enable your users to automatically get signed-on to OpsGenie single sign-on (SSO) with their Azure AD accounts
...
* An OpsGenie single sign-on (SSO) enabled subscription
...
The objective of this section is to show you how to configure and test Azure AD SSO with OpsGenie based on a test user called "Britta Simon".

For SSO to work, Azure AD needs to know the counterpart user in OpsGenie to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in OpsGenie needs to be established.
...
To configure and test Azure AD SSO with OpsGenie, you need to complete the following building blocks:
...
The objective of this section is to enable Azure AD SSO in the Azure Classic portal and to configure SSO in your OpsGenie application.
...
3. On the **Configure App Settings** dialog page, perform the following steps:
  ...
  1. In the Sign On URL textbox, type the URL used by your users to sign-on to your OpsGenie application using the following pattern: **“https://app.opsgenie.com/auth/login”**.

    >[!NOTE] 
    >Please contact your [OpsGenie support team](mailto:support@opsgenie.com) if you need your Sign On URL.
    >
...
4. On the **Configure single sign-on at OpsGenie** page, perform the following steps:
  ...
  1. Click **Download Certificate**, and then save the file on your computer. We will need this certificate and Metadata URLs (Entity ID, SSO Sign In URL and Sign Out URL) to set up SSO on OpsGenie side.
  2. Click **Next**.
...
9. On the Azure Active Directory dialog page, perform the following steps:
  ...
  1. In the Azure classic portal, on the **Configure single sign-on at OpsGenie** dialog page, copy the **Single Sign On Service URL** value, and then paste it into the **SAML 2.0 Endpoint** textbox.
  ...
  3. Open your base-64 encoded certificate in notepad, copy the content of it into your clipboard, and then paste it into the **X.500 Certificate** textbox.
...
4. On the **Add User** dialog, perform the following steps:
  ...
  1. In the **Email** textbox, type Britta's email address in Azure Active Directory.
  2. In the **Full Name** textbox, type **Britta Simon**.
  3. Click **Save**. 
...
The objective of this section is to enabling Britta Simon to use Azure SSO by granting her access to OpsGenie.

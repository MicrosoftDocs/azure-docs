...
See [Azure services that support Azure AD authentication](services-support-msi#azure-services-that-support-azure-ad-authentication) for a list of resources that support Azure AD and have been tested with MSI, and their respective resource IDs.

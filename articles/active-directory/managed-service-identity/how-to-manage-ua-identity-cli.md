...
For information on how to assign a user assigned managed identity to an Azure VM see, [Configure Managed identities for Azure resources on an Azure VM using Azure CLI](qs-configure-cli-windows-vm.md#user-assigned-identity)

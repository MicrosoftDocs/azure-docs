...
In this article, you learn how to create, list and delete a user assigned identity using the Azure Portal.
...
3. Click **Add** and enter values in the following fields under **Create user assigned managed** identity pane:
   ...
   - **Resource Group**: Create a new resource group to contain your user assigned identity or choose **Use existing** to create the user assigned managed identity in an existing resource group.

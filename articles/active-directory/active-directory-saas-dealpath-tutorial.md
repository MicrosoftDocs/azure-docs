...
1. Adding Dealpath from the gallery
...
4. In the search box, type **Dealpath**, select **Dealpath** from result panel then click **Add** button to add the application.
	...
	![Dealpath in the results list](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_addfromgallery.png)
...
For single sign-on to work, Azure AD needs to know what the counterpart user in Dealpath is to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in Dealpath needs to be established.

In Dealpath, assign the value of the **user name** in Azure AD as the value of the **Username** to establish the link relationship.
...
9. In the **Set up SAML 2.0 authentication** page, perform the following steps:
	...
	![Dealpath Configuration](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_saml.png) 
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-dealpath-tutorial/create_aaduser_04.png)
...
**To assign Britta Simon to Dealpath, perform the following steps:**
...
2. In the applications list, select **Dealpath**.
	...
	![The Dealpath link in the Applications list](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_app.png)  
...
When you click the Dealpath tile in the Access Panel, you should get automatically signed-on to your Dealpath application.

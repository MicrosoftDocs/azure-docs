...
* You can enable your users to automatically get signed-on to eDigitalResearch single sign-on (SSO) with their Azure AD accounts
...
* A eDigitalResearch SSO enabled subscription
...
The objective of this section is to show you how to configure and test Microsoft Azure AD SSO with eDigitalResearch based on a test user called "Britta Simon".

For SSO to work, Azure AD needs to know what the counterpart user in eDigitalResearch to an user in Azure AD is. In other words, a link relationship between an Azure AD user and the related user in eDigitalResearch needs to be established.
...
To configure and test Microsoft Azure AD SSO with eDigitalResearch, you need to complete the following building blocks:
...
In this section, you enable Microsoft Azure AD SSO in the classic portal and configure SSO in your eDigitalResearch application.
...
The objective of this section is to enabling Britta Simon to use Azure SSO by granting her access to eDigitalResearch.

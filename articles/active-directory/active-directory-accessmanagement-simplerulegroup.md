...
6. Note that you can set up a rule for dynamic membership on security groups or Office 365 groups.  Dynamic memberships for groups require an Azure AD Premium license.

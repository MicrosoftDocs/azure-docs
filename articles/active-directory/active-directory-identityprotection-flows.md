...
Administrators can set a policy that requires users to set up their accounts for additional security verification. This policy will allow users to skip multi-factor authentication registration for up to 14 days. The 14 day grace period is not configurable.

...
Each bulk activity to create a list of group members to download can run for up to one hour. This enables you to download of a list of at least 500,000 members.

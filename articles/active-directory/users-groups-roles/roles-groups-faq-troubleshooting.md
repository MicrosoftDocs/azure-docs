...
\*Group isn't role-eligible; that is, isAssignableToRole = false. If a group is role-eligible, then the person creating the access package must also be owner of the role-eligible group.

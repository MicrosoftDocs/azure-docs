...
1. Sign in to the [Azure AD admin center](https://aad.portal.azure.com) with an account that is a Global Administrator, Intune Service Administrator, or a User Account Administrator.
2. Select **Groups**.

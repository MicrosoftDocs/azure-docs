...
SharePoint Online | [Azure AD admin roles](directory-assign-admin-roles.md)<br>Also [About the SharePoint admin role in Microsoft 365](/sharepoint/sharepoint-admin-role) | [Graph API](/graph/api/overview?view=graph-rest-1.0)<br>[Fetch role assignments](/graph/api/directoryrole-list?view=graph-rest-1.0)

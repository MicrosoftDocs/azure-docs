...
- By default, only Global admins and Privileged role admins can manage the membership of a role-eligible groupBut you can delegate the management of role-eligible groups by adding group owners.

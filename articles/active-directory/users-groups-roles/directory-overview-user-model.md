...
# Overview: Azure Active Directory tools to manage users at scale
...
You can use Azure AD to manage group or user assignments to enterprise apps that are deployed in your Azure AD tenant. If you combine dynamic groups with group assignment to apps, you can almost completely automate how you scale up your user app access assignments. You'll need an Azure Active Directory Premium P1 or Premium P2 license to assign access to enterprise apps.

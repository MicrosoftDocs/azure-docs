...
In this article, you can find the least privileged roles you can assign to restrict a user's administrator permissions in Azure Active Directory (Azure AD).

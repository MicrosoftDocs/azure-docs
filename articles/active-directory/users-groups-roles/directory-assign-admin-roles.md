...
>
>* SharePoint admin center - SharePoint admin center does not support Global reader role. You won't see 'SharePoint' in left pane under Admin Centers in [M365 Admin Center](https://admin.microsoft.com/Adminportal/Home#/homepage), and you'll get access denied when to you try to go to https://{tenant name}-admin.sharepoint.com.
...
>* [M365 Admin Center](https://admin.microsoft.com/Adminportal/Home#/homepage) - Global Reader cannot read customer lockbox requests. You will not find Customer lockbox requests tab under Support in left pane of M365 Admin Center.
...
>* [Privileged Access Management (PAM)](https://docs.microsoft.com/en-us/office365/securitycompliance/privileged-access-management-overview) doesn't support Global Reader.
>

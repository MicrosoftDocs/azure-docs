...
Refer to [this documentation](https://docs.microsoft.com/azure/active-directory/users-groups-roles/roles-admin-units-assign-roles) for the list of built-in roles supported over an administrative unit.

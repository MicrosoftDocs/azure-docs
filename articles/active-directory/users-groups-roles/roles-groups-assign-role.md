...
2. Select Azure Active Directory > Roles and administrators > {Role name} > Add assignment. 



3. Select the group. Only groups that are eligible for role assignment (the cloud groups created with "Eligible for role assignment") are shown in the list, not all groups. 

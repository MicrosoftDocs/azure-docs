...
- Require employees to accept your Terms of use prior to registering personal information in Azure AD self-service password reset (SSPR) and Azure Multi-Factor Authentication (MFA).

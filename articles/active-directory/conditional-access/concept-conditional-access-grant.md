...
- [Require multifactor authentication (Azure Active Directory [Azure AD] multifactor authentication)](../authentication/concept-mfa-howitworks.md)
...
Selecting this checkbox requires users to perform Azure AD multifactor authentication. More information about deploying Azure AD multifactor authentication can be found in [Planning a cloud-based Azure AD Multifactor Authentication deployment](../authentication/howto-mfa-getstarted.md).
...
- The **Require app protection policy** requirement:

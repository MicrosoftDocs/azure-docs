...
:::image type="content" source="media/concept-conditional-access-session/conditional-access-session.png" alt-text="Screenshot of a Conditional Access policy with a grant control that requires an authentication strength of phishing resistant MFA." lightbox="media/concept-conditional-access-session/conditional-access-session.png":::

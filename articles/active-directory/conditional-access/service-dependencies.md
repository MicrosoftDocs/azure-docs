...
> [!TIP]
> Using the [Microsoft 365 (preview)](concept-conditional-access-cloud-apps.md#microsoft-365-preview) app will target all Office apps to avoid issues with service dependencies in the Office stack.
...
A great way to accomplish this with applications in the Office stack is to use the [Microsoft 365 (preview)](concept-conditional-access-cloud-apps.md#microsoft-365-preview) instead of targeting individual applications.

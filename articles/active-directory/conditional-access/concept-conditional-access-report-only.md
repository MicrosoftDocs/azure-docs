...
To see a video summary of how to use the feature, check out our video: [Use the Report Only feature to test Conditional Access policies - Azure Active Directory](https://www.youtube.com/watch?v=NZbPYfhb5Kc).

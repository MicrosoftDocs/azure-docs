...
- In the **second** phase, you are prompted to satisfy the requirements you haven't met. If any one of the policies block access, you are blocked and not prompted to satisfy other policy controls. If policies do not block you, you will be prompted to satisfy other policy controls in the following order:

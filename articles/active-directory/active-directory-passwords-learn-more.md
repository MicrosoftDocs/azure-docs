...
Contact Method Name|Azure Active Directory Data Element|Used / Settable Where?|Format requirements
--|--|--|--
Office Phone|PhoneNumber<p><p>e.g. Set-MsolUser -UserPrincipalName JWarner@contoso.com -PhoneNumber "+1 1234567890x1234"|Used in:<p><p>Password Reset Portal<p><p>Settable from: <p>PhoneNumber is settable from PowerShell, DirSync, Azure Management Portal, and the Office Admin Portal|+ccc xxxyyyzzzz (e.g. +1 1234567890)<p><p>- Must provide a country code<p><p>- Must provide an area code (where applicable)<p><p>- Must have provide a + in front of the country code<p><p>- Must have a space between country code and the rest of the number<p><p>- Extensions are not supported, if you have any extensions specified, we will strip it from the number before dispatching the phone call.
Mobile Phone|AuthenticationPhone<p><p>- OR<p><p> MobilePhone<p><p>(Authentication Phone is used if there is data present, otherwise this falls back to the mobile phone field).<p><p>e.g. Set-MsolUser -UserPrincipalName JWarner@contoso.com -MobilePhone "+1 1234567890x1234"|Used in:<p><p>- Password Reset Portal<p><p>- Registration Portal<p><p>Settable from:<p><p>- AuthenticationPhone is settable from the password reset registration portal or MFA registration portal.<p><p>- MobilePhone is settable from PowerShell, DirSync, Azure Management Portal, and the Office Admin Portal|+ccc xxxyyyzzzz (e.g. +1 1234567890)<p><p>- Must provide a country code.<p><p>- Must provide an area code (where applicable).<p><p>- Must have provide a + in front of the country code.<p><p>- Must have a space between country code and the rest of the number.<p><p>- Extensions are not supported, if you have any extensions specified, we ignore it when dispatching the phone call.
Alternate Email|AuthenticationEmail<p><p>OR<p><p>AlternateEmailAddresses[0]<p><p> (Authentication Email is used if there is data present, otherwise this falls back to the Alternate Email field)<p><p>**Note:** the alternate email field is specified as an array of strings in the directory.  We use the first entry in this array.<p><p>e.g. Set-MsolUser -UserPrincipalName JWarner@contoso.com -AlternateEmailAddresses "email@live.com"|Used in:<p><p>- Password Reset Portal<p><p>- Registration Portal<p><p>Settable from: <p><p>- AuthenticationEmail is settable from the password reset registration portal or MFA registration portal.<p><p>- AlternateEmail is settable from PowerShell, the Azure Management Portal, and the Office Admin Portal|[user@domain.com](mailto:user@domain.com) or 甲斐@黒川.日本<p><p>- Emails should follow standard formatting<p><p>- Unicode emails are supported.
Security Questions and Answers|Not available to modify directly in the directory.|Used in:<p><p>- Password Reset Portal<p><p>- Registration Portal <p><p>Settable from: <p><p>- The only way to set security questions is through the Azure Management Portal.<p><p>- The only way to set answers to security questions for a given user is through the Registration Portal.|Security questions have a max of 200 characters and a min of 3 characters<p><p>- Answers have a max of 40 characters and a min of 3 characters.

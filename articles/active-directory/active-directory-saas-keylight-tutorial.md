...
4. In the search box, type **LockPath Keylight**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-keylight-tutorial/tutorial_lockpathkeylight_search.png)

5. In the results panel, select **LockPath Keylight**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-keylight-tutorial/tutorial_lockpathkeylight_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Configure Single Sign-On](./media/active-directory-saas-keylight-tutorial/tutorial_lockpathkeylight_samlbase.png)

3. On the **LockPath Keylight Domain and URLs** section, If you wish to configure the application in **IDP** initiated mode:

	![Configure Single Sign-On](./media/active-directory-saas-keylight-tutorial/tutorial_lockpathkeylight_url.png)
...
4. On the **SAML Signing Certificate** section, click **Certificate(Raw)** and then save the certificate file on your computer.
	...
	![Configure Single Sign-On](./media/active-directory-saas-keylight-tutorial/tutorial_lockpathkeylight_certificate.png) 
...
6. On the **LockPath Keylight Configuration** section, click **Configure LockPath Keylight** to open **Configure sign-on** window. Copy the **Sign-Out URL and SAML Single Sign-On Service URL** from the **Quick Reference section.**
	...
	![Configure Single Sign-On](./media/active-directory-saas-keylight-tutorial/tutorial_lockpathkeylight_configure.png) 
...
8. On the **Edit SAML Settings** dialog page, perform the following steps:
    ...
    b. Paste the **SAML SSO URL** value into the **Identity Provider Login URL** textbox.

    c. Paste the **Single Sign-Out Service URL** value into the **Identity Provider Logout URL** textbox.
...
2. In the applications list, select **LockPath Keylight**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-keylight-tutorial/tutorial_lockpathkeylight_app.png) 

...
4. In the search box, type **Yodeck**, select **Yodeck** from result panel then click **Add** button to add the application.
	...
	![Yodeck in the results list](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_addfromgallery.png)
...
3. **[Create a Yodeck test user](#create-a-yodeck-test-user)** - to have a counterpart of Britta Simon in Yodeck that is linked to the Azure AD representation of user.
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-yodeck-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Yodeck**.
	...
	![The Yodeck link in the Applications list](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_app.png)  

...
To add an Azure AD tenant in the Azure portal, sign in to [the Azure portal](https://poral.azure.com) with an account that is an Azure AD global adminostrator, and, on the left, select **New**.

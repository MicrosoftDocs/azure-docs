...
4. In the search box, type **Novatus**.

	![Creating an Azure AD test user](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_search.png)

5. In the results panel, select **Novatus**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_addfromgallery.png)
...
2. In the applications list, select **Novatus**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_app.png) 

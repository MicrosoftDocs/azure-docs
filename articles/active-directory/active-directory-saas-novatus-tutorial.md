...
4. **[Creating a Novatus test user](#creating-a-Novatus-test-user)** - to have a counterpart of Britta Simon in Novatus that is linked to the Azure AD representation of her.
...
> [AZURE.NOTE] If you need to create an user manually, you need to contact the Novatus support team.

...
8. To configure single sign-on on **Shmoop For Schools** side, you need to send the **App Federation Metadata Url** to [Shmoop For Schools support team](mailto:support@shmoop.com).

...
4. In the search box, type **Shmoop For Schools**.

	![Creating an Azure AD test user](./media/active-directory-saas-shmoopforschools-tutorial/tutorial_shmoopforschools_search.png)

5. In the results panel, select **Shmoop For Schools**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-shmoopforschools-tutorial/tutorial_shmoopforschools_addfromgallery.png)
...
3. **[Creating a Shmoop For Schools test user](#creating-a-shmoop-for-schools-test-user)** - to have a counterpart of Britta Simon in Shmoop For Schools that is linked to the Azure AD representation of user.
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Configure Single Sign-On](./media/active-directory-saas-shmoopforschools-tutorial/tutorial_shmoopforschools_samlbase.png)
...
8. On the **Shmoop For Schools Configuration** section, click **Configure Shmoop For Schools** to open **Configure sign-on** window. Copy the **SAML Entity ID, and SAML Single Sign-On Service URL** from the **Quick Reference section.**

	![Configure Single Sign-On](./media/active-directory-saas-shmoopforschools-tutorial/tutorial_shmoopforschools_configure.png) 

9. To configure single sign-on on **Shmoop For Schools** side, you need to send the downloaded **Metadata XML, SAML Entity ID, and SAML Single Sign-On Service URL** to [Shmoop For Schools support team](mailto:support@shmoop.com).
...
1. In the **Azure portal**, on the left navigation pane, click **Azure Active Directory** icon.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-shmoopforschools-tutorial/create_aaduser_01.png) 

2. To display the list of users, go to **Users and groups** and click **All users**.
	
	![Creating an Azure AD test user](./media/active-directory-saas-shmoopforschools-tutorial/create_aaduser_02.png) 

3. To open the **User** dialog, click **Add** on the top of the dialog.
 
	![Creating an Azure AD test user](./media/active-directory-saas-shmoopforschools-tutorial/create_aaduser_03.png) 

4. On the **User** dialog page, perform the following steps:
 
	![Creating an Azure AD test user](./media/active-directory-saas-shmoopforschools-tutorial/create_aaduser_04.png) 

    a. In the **Name** textbox, type **BrittaSimon**.

    b. In the **User name** textbox, type the **email address** of BrittaSimon.

	c. Select **Directory role** as **Student** or **Teacher**.

	d. Select **Show Password** and write down the value of the **Password**.
...
2. In the applications list, select **Shmoop For Schools**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-shmoopforschools-tutorial/tutorial_shmoopforschools_app.png) 

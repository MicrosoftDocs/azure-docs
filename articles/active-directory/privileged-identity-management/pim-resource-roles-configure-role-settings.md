...
Use the **Activation maximum duration** slider to set the maximum time, in hours, that a role assignment stays active before the activation request expires. This value can be from one to 24 hours.

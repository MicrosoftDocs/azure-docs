...
This article describes how to invite a guest to your directory and manage their access to Azure resources using Privileged Identity Management.

## When would you invite guests?

Here are a couple example scenarios when you might invite guests to your directory:

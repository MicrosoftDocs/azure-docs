...
You can use Privileged Identity Management (PIM) In Microsoft Entra ID, previously known as Microsoft Entra ID, to have just-in-time membership in the group or just-in-time ownership of the group.

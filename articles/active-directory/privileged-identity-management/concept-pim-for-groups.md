...
Azure AD role-assignable group feature is not part of Azure AD Privileged Identity Management (Azure AD PIM). It requires a Microsoft Entra ID P1, P2, or Micrsoft Entra ID Governance license.

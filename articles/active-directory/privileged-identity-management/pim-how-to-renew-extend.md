...
![Azure D roles - My roles page listing eligible roles with an Action column](media/pim-how-to-renew-extend/pim-extend-link-in-portal .png)
...
![Action column with links to Activate or Extend](media/pim-how-to-renew-extend/aadpim-rbac-extend-within-14.png)

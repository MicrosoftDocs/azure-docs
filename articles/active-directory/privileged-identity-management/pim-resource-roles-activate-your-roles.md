...
1. Click **Activate**.
    ...
    If the role does not require approval, it is activated, and the role appears in the list of active roles. If you want to use the role right away, follow the steps in next section.

...
If this command returns a line in which SkuPartNumber is "AAD_PREMIUM_P2" and IsTrial is "True", this indicates an Azure AD Premium P2 trial is present in the tenant.  If the subscription status is not enabled, and you do not have an Azure AD Premium P2 purchase, then you must purchase an Azure AD Premium P2 subscription to continue using Azure AD Privileged Identity Management.
...
When an Azure AD Premium P2 subscription expires, or an organization that was using Azure AD Privileged Identity Management does not obtain Azure AD Premium P2:

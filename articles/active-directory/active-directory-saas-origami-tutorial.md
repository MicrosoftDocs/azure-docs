...
4. In the search box, type **Origami**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-origami-tutorial/tutorial_origami_search.png)

5. In the results panel, select **Origami**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-origami-tutorial/tutorial_origami_addfromgallery.png)
...
3. **[Creating an Origami test user](#creating-a-origami-test-user)** - to have a counterpart of Britta Simon in Origami that is linked to the Azure AD representation of user.

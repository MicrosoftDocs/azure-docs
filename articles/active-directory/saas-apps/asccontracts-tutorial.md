...
When you click the ASC Contracts tile in the Access Panel, you should get automatically signed-on to your ASC Contracts application. For more information about the Access Panel, see. [Introduction to the Access Panel](../active-directory-saas-access-panel-introduction).

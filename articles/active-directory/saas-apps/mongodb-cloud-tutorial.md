...
1. (Optional) If you would like to authorize users using MongoDB Atlas [role mappings](https://docs.atlas.mongodb.com/security/manage-role-mapping/), add the below group claim to send user's group information within SAML assertion.
        | Name | Source attribute|
	| ---------------| --------- |
	| memberOf | Group ID |

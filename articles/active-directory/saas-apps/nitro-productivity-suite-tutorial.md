...
1. [Configure Nitro Productivity Suite SSO](#configure-nitro-productivity-suite-sso) to configure the single sign-on settings on the application side.
    * [Create a Nitro Productivity Suite test user](#create-a-nitro-productivity-suite-test-user) to have a counterpart of B.Simon in Nitro Productivity Suite, linked to the Azure AD representation of the user.

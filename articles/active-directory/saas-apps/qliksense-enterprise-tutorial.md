---
title: 'Tutorial: Azure Active Directory integration with Qlik Sense Enterprise Client-Managed | Microsoft Docs'
...
# Tutorial: Integrate Qlik Sense Enterprise Client-Managed with Azure Active Directory

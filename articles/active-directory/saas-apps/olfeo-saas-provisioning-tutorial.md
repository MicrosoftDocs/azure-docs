...
This tutorial describes the steps you need to perform in both Olfeo SAAS and Azure Active Directory (Azure AD) to configure automatic user provisioning. When configured, Azure AD automatically provisions and de-provisions users and groups to [Olfeo SAAS](https://www.olfeo.com) using the Azure AD Provisioning service. For important details on what this service does, how it works, and frequently asked questions, see [Automate user provisioning and deprovisioning to SaaS applications with Azure Active Directory](../manage-apps/user-provisioning.md). 
...
1. Determine what data to [map between Azure AD and Olfeo SAAS](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
Add Olfeo SAAS from the Azure AD application gallery to start managing provisioning to Olfeo SAAS. If you have previously setup Olfeo SAAS for SSO you can use the same application. However it is recommended that you create a separate app when testing out the integration initially. Learn more about adding an application from the gallery [here](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
1.  Under the **Admin Credentials** section, input your Olfeo SAAS Tenant URL and Secret Token. Click **Test Connection** to ensure Azure AD can connect to Olfeo SAAS. If the connection fails, ensure your Olfeo SAAS account has Admin permissions and try again.
...
1. Under the **Mappings** section, select **Synchronize Azure Active Directory Users to Olfeo SAAS**.
...
1. To enable the Azure AD provisioning service for Olfeo SAAS, change the **Provisioning Status** to **On** in the **Settings** section.

	![Provisioning Status Toggled On](common/provisioning-toggle-on.png)

1. Define the users and/or groups that you would like to provision to Olfeo SAAS by choosing the desired values in **Scope** in the **Settings** section.

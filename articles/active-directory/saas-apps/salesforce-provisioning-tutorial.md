...
* If you are having issues authorizing access to Salesforce ensure the following:
    * Your credentials have admin access to Salesforce.
    * You are using a version of Salesforce that does not support web access. Ensure that you are using Developer, Enterprise, Sandbox, or Unlimited editions of Salesforce.

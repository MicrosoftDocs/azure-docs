...
1. On the **Basic SAML Configuration** section, enter the values for the following fields:
	...
	> [!NOTE]
	> These values are not real. Update these values with the actual Sign on URL, Reply URL and Identifier. Contact [Samsara Client support team](mailto:support@samsara.com) to get these values or navigate in Samsara to Settings->Single-Sign-On->New SAML Connection to obtain the <ORGID>. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.

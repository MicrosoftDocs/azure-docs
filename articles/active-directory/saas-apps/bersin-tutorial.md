...
3. **[Create a Bersin test user](#create-a-bersin-test-user)** - to have a counterpart of Britta Simon in Bersin that is linked to the Azure AD representation of user.

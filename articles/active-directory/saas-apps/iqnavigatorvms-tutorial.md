...
1. In the search box, type **IQNavigator VMS**.

	![Creating an Azure AD test user](./media/iqnavigatorvms-tutorial/tutorial_iqnavigatorvms_search.png)

1. In the results panel, select **IQNavigator VMS**, and then click **Add** button to add the application.
...
1. On the **IQNavigator VMS Domain and URLs** section, perform the following steps:
...
1. On the **IQNavigator VMS Configuration** section, click **Configure IQNavigator VMS** to open **Configure sign-on** window. Copy the **Sign-Out URL, SAML Entity ID, and SAML Single Sign-On Service URL** from the **Quick Reference section.**

...
When you click the ARC Facilities tile in the Access Panel, you should be automatically signed in to the ARC Facilities for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Try ARC Facilities with Azure AD](https://aad.portal.azure.com/)

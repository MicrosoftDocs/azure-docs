...
1. On the **Basic SAML Configuration** section, if you wish to configure the application in **IDP** initiated mode, enter the values for the following fields:
	...
	| |
	|--|
	| `https://<SUBDOMAIN>.hyperanna.com/userservice/auth/saml` |
	|` https://<SUBDOMAIN>.hyperanna.com/userservice/auth/saml` |
...
1. Click **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
	...
	| |
	|--|
	| `https://<SUBDOMAIN>.hyperanna.com/` |
	| `https://<SUBDOMAIN>.hyperanna.com/` |

	> [!NOTE]
	> These values are not real. Update these values with the actual Reply URL and Sign-On URL. Contact [HyperAnna Client support team](mailto:support@hyperanna.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.
...
When you click the HyperAnna tile in the Access Panel, you should be automatically signed in to the HyperAnna for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

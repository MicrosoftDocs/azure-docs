...
4. In the search box, type **Ariba**.

	![Creating an Azure AD test user](./media/ariba-tutorial/tutorial_ariba_search.png)

5. In the results panel, select **Ariba**, and then click **Add** button to add the application.
...
3. **[Creating an Ariba test user](#creating-an-ariba-test-user)** - to have a counterpart of Britta Simon in Ariba that is linked to the Azure AD representation of user.

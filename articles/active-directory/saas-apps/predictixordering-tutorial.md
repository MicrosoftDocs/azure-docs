...
* An Azure AD subscription. If you don't have an Azure AD environment, you can get a free account [here](https://azure.microsoft.com/pricing/free-trial/).
* Predictix Ordering single sign-on enabled subscription
...
4. In the search box, type **Predictix Ordering**, select **Predictix Ordering** from result panel then click **Add** button to add the application.
	 ...
	 ![Predictix Ordering in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in Predictix Ordering needs to be established.

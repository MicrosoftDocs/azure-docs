...
To configure and test Azure AD SSO with raum]für[raum, complete the following building blocks:
...
1. In the [Azure portal](https://portal.azure.com/), on the **raum]für[raum** application integration page, find the **Manage** section and select **single sign-on**.
...
When you click the raum]für[raum tile in the Access Panel, you should be automatically signed in to the raum]für[raum for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

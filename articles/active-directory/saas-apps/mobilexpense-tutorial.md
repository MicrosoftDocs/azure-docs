...
1. In the search box, type **Mobile Xpense**, select **Mobile Xpense** from result panel then click **Add** button to add the application.
...
1. **[Create a Mobile Xpense test user](#create-a-mobile-xpense-test-user)** - to have a counterpart of Britta Simon in Mobile Xpense that is linked to the Azure AD representation of user.

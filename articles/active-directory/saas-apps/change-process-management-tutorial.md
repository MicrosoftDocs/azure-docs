...
1. On the **Set up single sign-on with SAML** page, enter the values for the following fields:
	...
	> [!NOTE]
	> These values are not real. Update these values with the actual Identifier and Reply URL. Contact [Change Process Management Client support team](mailto:support@realtech-us.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.
...
To configure single sign-on on **Change Process Management** side, you need to send the downloaded **Certificate (Base64)** and appropriate copied URLs from Azure portal to [Change Process Management support team](mailto:support@realtech-us.com). They set this setting to have the SAML SSO connection set properly on both sides.

### Create Change Process Management test user

In this section, you create a user called Britta Simon in Change Process Management. Work with [Change Process Management support team](mailto:support@realtech-us.com) to add the users in the Change Process Management platform. Users must be created and activated before you use single sign-on.

...
1. In the search box, type **O.C. Tanner - AppreciateHub**.

	![Creating an Azure AD test user](./media/oc-tanner-tutorial/tutorial_octannerappreciatehub_search.png)

1. In the results panel, select **O.C. Tanner - AppreciateHub**, and then click **Add** button to add the application.

---
title: 'Tutorial: Azure Active Directory integration with MyVR | Microsoft Docs'
...
# Tutorial: Integrate MyVR with Azure Active Directory
...
1. On the **Basic SAML Configuration** section, if user wish to configure the application in **IDP** initiated mode, the user does not have to perform any step as the app is already pre-integrated with Azure.

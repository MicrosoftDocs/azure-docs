...
## Configure and test Azure AD SSO for MS Azure SSO Access for Ethidex Compliance Office™
...
To configure and test Azure AD SSO with MS Azure SSO Access for Ethidex Compliance Office™, perform the following steps:
...
1. In the Azure portal, on the **MS Azure SSO Access for Ethidex Compliance Office™** application integration page, find the **Manage** section and select **single sign-on**.
...
* Click on Test this application in Azure portal and you should be automatically signed in to the Ethidex Compliance Office™ for which you set up the SSO

* You can use Microsoft My Apps. When you click the Ethidex Compliance Office™ tile in the My Apps, you should be automatically signed in to the Ethidex Compliance Office™ for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](../user-help/my-apps-portal-end-user-access.md).

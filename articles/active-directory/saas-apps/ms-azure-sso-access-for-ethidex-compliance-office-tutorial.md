...
* You can use Microsoft My Apps. When you click the Ethidex Compliance Office™ tile in the My Apps, you should be automatically signed in to the Ethidex Compliance Office™ for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

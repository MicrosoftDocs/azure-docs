...
4. **[Create Innoverse test user](#create-innoverse-test-user)** - to have a counterpart of Britta Simon in Innoverse that is linked to the Azure AD representation of user.

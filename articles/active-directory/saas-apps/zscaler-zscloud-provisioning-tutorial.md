...
description: In this tutorial, you will learn how to configure Azure Active Directory to automatically provision and deprovision user accounts to Zscaler ZSCloud.

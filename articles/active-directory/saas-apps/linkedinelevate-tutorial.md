...
* LinkedIn Elevate supports [**Automated** user provisioning](https://docs.microsoft.com/azure/active-directory/saas-apps/linkedinelevate-provisioning-tutorial).

...
* You can enable your users to be automatically signed-in to Drift (Single Sign-On) with their Azure AD accounts.
...
* Drift single sign-on enabled subscription
...
4. In the search box, type **Drift**, select **Drift** from result panel then click **Add** button to add the application.
	 ...
	 ![Drift in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in Drift needs to be established.
...
2. **[Configure Drift Single Sign-On](#configure-drift-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create Drift test user](#create-drift-test-user)** - to have a counterpart of Britta Simon in Drift that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Drift** application integration page, select **Single sign-on**.
...
9. On the **Set up Drift** section, copy the appropriate URL(s) as per your requirement.
...
### Configure Drift Single Sign-On
...
1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **Drift**.

	![Enterprise applications blade](common/enterprise-applications.png)

2. In the applications list, select **Drift**.

	![The Drift link in the Applications list](common/all-applications.png)
...
When you click the Drift tile in the Access Panel, you should be automatically signed in to the Drift for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

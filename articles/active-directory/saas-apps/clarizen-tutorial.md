...
In this tutorial, you'll learn how to integrate Clarizen with Azure Active Directory (Azure AD). When you integrate Clarizen with Azure AD, you can:

* Control in Azure AD who has access to Clarizen.
* Enable your users to be automatically signed-in to Clarizen with their Azure AD accounts.
...
* Clarizen single sign-on (SSO) enabled subscription.
...
1. In the **Add from the gallery** section, type **Clarizen** in the search box.
1. Select **Clarizen** from results panel and then add the app. Wait a few seconds while the app is added to your tenant.

## Configure and test Azure AD SSO for Clarizen

Configure and test Azure AD SSO with Clarizen using a test user called **B.Simon**. For SSO to work, you need to establish a link relationship between an Azure AD user and the related user in Clarizen.

To configure and test Azure AD SSO with Clarizen, perform the following steps:

1. **[Configure Azure AD SSO](#configure-azure-ad-sso)** - to enable your users to use this feature.
    1. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with B.Simon.
    1. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable B.Simon to use Azure AD single sign-on.
1. **[Configure Clarizen SSO](#configure-clarizen-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Clarizen test user](#create-clarizen-test-user)** - to have a counterpart of B.Simon in Clarizen that is linked to the Azure AD representation of user.
...
1. In the Azure portal, on the **Clarizen** application integration page, find the **Manage** section and select **single sign-on**.
...
In this section, you'll enable B.Simon to use Azure single sign-on by granting access to Clarizen.
...
* Click on Test this application in Azure portal and you should be automatically signed in to the Clarizen for which you set up the SSO.

* You can use Microsoft My Apps. When you click the Clarizen tile in the My Apps, you should be automatically signed in to the Clarizen for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

## Next steps

Once you configure Clarizen you can enforce session control, which protects exfiltration and infiltration of your organization’s sensitive data in real time. Session control extends from Conditional Access. [Learn how to enforce session control with Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).

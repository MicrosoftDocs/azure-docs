...
* You can enable your users to be automatically signed-in to Abintegro (Single Sign-On) with their Azure AD accounts.
...
* Abintegro single sign-on enabled subscription
...
4. In the search box, type **Abintegro**, select **Abintegro** from result panel then click **Add** button to add the application.

	 ![Abintegro in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in Abintegro needs to be established.
...
2. **[Configure Abintegro Single Sign-On](#configure-abintegro-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create Abintegro test user](#create-abintegro-test-user)** - to have a counterpart of Britta Simon in Abintegro that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Abintegro** application integration page, select **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, perform the following steps:
    ...
    `https://dev.abintegro.com/Shibboleth.sso/Login?entityID=<Issuer>&target=https://dev.abintegro.com/secure/`
...
6. On the **Set up Abintegro** section, copy the appropriate URL(s) as per your requirement.
...
### Configure Abintegro Single Sign-On
...
1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **Abintegro**.

	![Enterprise applications blade](common/enterprise-applications.png)

2. In the applications list, select **Abintegro**.

	![The Abintegro link in the Applications list](common/all-applications.png)
...
When you click the Abintegro tile in the Access Panel, you should be automatically signed in to the Abintegro for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

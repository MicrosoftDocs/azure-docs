---
title: 'Tutorial: Azure Active Directory integration with PandaDoc | Microsoft Docs'
...
# Tutorial: Integrate PandaDoc with Azure Active Directory
...
1. On the **Basic SAML Configuration** section, the user does not have to perform any step as the app is already pre-integrated with Azure.
    ...
    ![PandaDoc Domain and URLs single sign-on information](common/preintegrated.png)

1. Click **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:

    ![PandaDoc Domain and URLs single sign-on information](common/metadata-upload-additional-signon.png)

    In the **Sign-on URL** text box, type a URL:
    `https://app.pandadoc.com/sso-login/`

1. PandaDoc application expects the SAML assertions in a specific format. Configure the following claims for this application. You can manage the values of these attributes from the **User Attributes** section on application integration page. On the **Set up Single Sign-On with SAML** page, click **Edit** button to open **User Attributes** dialog.
...
When you select the PandaDoc tile in the Access Panel, you should be automatically signed in to the PandaDoc for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

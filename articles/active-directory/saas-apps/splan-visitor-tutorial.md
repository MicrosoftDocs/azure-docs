---
title: 'Tutorial: Azure Active Directory single sign-on (SSO) integration with Splan Visitor Management | Microsoft Docs'
description: Learn how to configure single sign-on between Azure Active Directory and Splan Visitor Management.
...
# Tutorial: Azure Active Directory single sign-on (SSO) integration with Splan Visitor Management

In this tutorial, you'll learn how to integrate Splan Visitor Management with Azure Active Directory (Azure AD). When you integrate Splan Visitor with Azure AD, you can:
...
Configure and test Azure AD SSO with Splan Visitor by using a test user called **B.Simon**. For SSO to work, you need to establish a link relationship between an Azure AD user and the related user in Splan Visitor.
...
## Configure a Splan Visitor SSO

To configure single sign-on on the Splan Visitor side, you need to send the downloaded **Federation Metadata XML** and appropriate copied URLs from Azure portal to the [Splan Visitor support team](mailto:support@splan.com). They set this setting to have the SAML SSO connection set properly on both sides.

### Create a Splan Visitor test user

Create a user called **Britta Simon** in Splan Visitor. Work with the [Splan Visitor support team](mailto:support@splan.com) to add the users in the Splan Visitor platform. Users must be created and activated before you use single sign-on.

## Test SSO 

Test your Azure AD single sign-on configuration with one of the following options:

* Click **Test this application** in Azure portal to automatically sign in to the Splan Visitor for which you set up SSO.
* Use the Microsoft My Apps portal. When you click the **Splan Visitor** tile in the My Apps portal, you should be automatically signed in to the Splan Visitor for which you set up the SSO. For more information about the My Apps portal, see [Sign in and start apps from the My Apps portal](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
Reach out to [Thrive LXP support](support@thrivelearning.com) to generate your **Tenant url** and **Secret Token**. These values will be entered in the Tenant url and Secret Token field in the Provisioning tab of your Thrive LXP application in the Azure portal.

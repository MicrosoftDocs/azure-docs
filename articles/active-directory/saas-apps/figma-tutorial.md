...
1. In the [Azure portal](https://portal.azure.com/), on the **Figma** application integration page, find the **Manage** section and select **single sign-on**.
...
When you click the Figma tile in the Access Panel, you should be automatically signed in to the Figma for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md).
...
- [Try Figma with Azure AD](https://aad.portal.azure.com/)
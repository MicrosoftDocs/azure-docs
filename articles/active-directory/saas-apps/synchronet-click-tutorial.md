...
When you click the SynchroNet CLICK tile in the Access Panel, you should be automatically signed in to the SynchroNet CLICK for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [How to protect SynchroNet CLICK with advanced visibility and controls](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

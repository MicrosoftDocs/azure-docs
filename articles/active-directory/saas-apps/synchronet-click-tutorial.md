---
title: 'Tutorial: Azure Active Directory single sign-on (SSO) integration with SynchroNet CLICK | Microsoft Docs'
...
# Tutorial: Azure Active Directory single sign-on (SSO) integration with SynchroNet CLICK
...
## Configure and test Azure AD single sign-on for SynchroNet CLICK
...
To configure and test Azure AD SSO with SynchroNet CLICK, complete the following building blocks:
...
1. In the [Azure portal](https://portal.azure.com/), on the **SynchroNet CLICK** application integration page, find the **Manage** section and select **single sign-on**.
...
When you click the SynchroNet CLICK tile in the Access Panel, you should be automatically signed in to the SynchroNet CLICK for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md).
...
- [Try SynchroNet CLICK with Azure AD](https://aad.portal.azure.com/)

- [What is session control in Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [How to protect SynchroNet CLICK with advanced visibility and controls](/cloud-app-security/proxy-intro-aad)
...
1. In the search box, type **Boxcryptor**, select **Boxcryptor** from result panel then click **Add** button to add the application.
...
1. **[Create a Boxcryptor test user](#create-a-boxcryptor-test-user)** - to have a counterpart of Britta Simon in Boxcryptor that is linked to the Azure AD representation of user.

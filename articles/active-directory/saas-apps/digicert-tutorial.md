...
1. Adding DigiCert from the gallery
...
1. In the search box, type **DigiCert**.

	![Creating an Azure AD test user](./media/digicert-tutorial/tutorial_digicert_search.png)

1. In the results panel, select **DigiCert**, and then click **Add** button to add the application.
...
1. **[Creating a DigiCert test user](#creating-a-digicert-test-user)** - to have a counterpart of Britta Simon in DigiCert that is linked to the Azure AD representation of user.
...
When you click the DigiCert tile in the Access Panel, you should get automatically signed-on to your DeigiCert application.

...
4. In the search box, type **Skytap**, select **Skytap** from result panel then click **Add** button to add the application.
...
3. **[Create a Skytap test user](#create-a-skytap-test-user)** - to have a counterpart of Britta Simon in Skytap that is linked to the Azure AD representation of user.

...
> * [Single sign-on](./purecloud-by-genesys-tutorial.md) to PureCloud by Genesys (recommended)
...
3. Determine what data to [map between Azure AD and PureCloud by Genesys](../app-provisioning/customize-application-attributes.md). 

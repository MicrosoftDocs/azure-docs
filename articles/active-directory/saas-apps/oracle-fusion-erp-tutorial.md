...
# Tutorial: Tutorial: Azure Active Directory Single sign-on (SSO) integration with Oracle Fusion ERP
...
## Configure and test Azure AD single sign-on for Oracle Fusion ERP

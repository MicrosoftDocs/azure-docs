...
1. Adding LCVista from the gallery
...
1. In the search box, type **LCVista**.

	![Creating an Azure AD test user](./media/lcvista-tutorial/tutorial_lcvista_search.png)

1. In the results panel, select **LCVista**, and then click **Add** button to add the application.
...
1. **[Creating a LCVista test user](#creating-a-lcvista-test-user)** - to have a counterpart of Britta Simon in LCVista that is linked to the Azure AD representation of user.
...
1. On the **LCVista Domain and URLs** section, perform the following steps:
...
1. On the **LCVista Configuration** section, click **Configure LCVista** to open **Configure sign-on** window. Copy the **SAML Entity ID** and **SAML Single Sign-On Service URL** from the **Quick Reference section.**
...
1. In the **SAML Config** section, check the **Enable SAML login** and enter the details as mentioned in below image. 

...
* Changes on the Workplace side: Previously the Azure AD app was a custom integration in the Workplace. Now you will see Azure AD in the Workplace integrations directory as a third party application. 
...
If your Workplace integration is in quarantine, you will need to supply a valid token again in order for us to migrate you. The admin credentials section will be greyed out, but you can append the following to your URL to save credentials again. 

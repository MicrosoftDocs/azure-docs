...
> [!NOTE]
> We are working closely with the Workplace by Facebook team to ensure that the Azure AD application is approved and meets their new guidelines. The Workplace by Facebook deadline is December 16th and we expect to meet that. No work is expected of customers at that time. By <input date> customers will need to transition to the new integration. We will post here as soon as possible when the migration path is available.     

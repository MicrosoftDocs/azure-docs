...
* A Peripass tenant - contact [Peripass](https://www.peripass.com/) to setup your tenant.
...
5.   Pick the **Userrole** that should be assigned to the provisioned users.

6. Note down your tenant's **SCIM Endpoint** and **SCIM Token** (you will need this later on when configuring the user provisioning in the Azure AD Enterprise Applications and use it as **Peripass Tenant URL** and **Secret Token**).

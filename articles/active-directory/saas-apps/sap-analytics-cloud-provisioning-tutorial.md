...
Assign users as members of the AAD Groups and give them app role assignments

* Start small. Test with a small set of users and groups before rolling out to everyone.

Check the users have the right access in SAP downstream targets and and when they sign in, they have the right roles.

...
1. On the **Basic SAML Configuration** section, enter the values for the following fields:
	...
	> [!NOTE]
	> The value is not real. Update the value with the actual Sign-On URL. Contact [Spintr SSO Client support team](mailto:support@spintr.me) to get the value. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.
...
When you click the Spintr SSO tile in the Access Panel, you should be automatically signed in to the Spintr SSO for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

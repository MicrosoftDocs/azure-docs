...
In this article, you'll learn how to integrate Pinpoint (SAML) with Azure Active Directory (Azure AD). DDI’s Pinpoint platform makes it easy to design, deliver, and track blended learning journeys for leaders. Pinpoint is seamlessly integrated into DDI’s award-winning leadership development solutions. When you integrate Pinpoint (SAML) with Azure AD, you can:

...
2. **[Configure Bright Pattern Omnichannel Contact Center Single Sign-On](#configure-bright-pattern-omnichannel-contact-center-single-sign-on)** - to configure the Single Sign-On settings on application side.

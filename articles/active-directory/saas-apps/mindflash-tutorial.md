...
1. In the search box, type **Mindflash**.

	![Creating an Azure AD test user](./media/mindflash-tutorial/tutorial_mindflash_search.png)

1. In the results panel, select **Mindflash**, and then click **Add** button to add the application.
...
1. **[Creating a Mindflash test user](#creating-a-mindflash-test-user)** - to have a counterpart of Britta Simon in Mindflash that is linked to the Azure AD representation of user.
...
1. On the **Mindflash Domain and URLs** section, perform the following steps:
...
1. To configure single sign-on on **Mindflash** side, you need to send the downloaded **Metadata XML** to [Mindflash support team](https://www.mindflash.com/contact/).

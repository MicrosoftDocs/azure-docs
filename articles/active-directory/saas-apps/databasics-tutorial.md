...
* You can enable your users to be automatically signed-in to DATABASICS (Single Sign-On) with their Azure AD accounts.
...
4. In the search box, type **DATABASICS**, select **DATABASICS** from result panel then click **Add** button to add the application.
	 ...
	 ![DATABASICS in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in DATABASICS needs to be established.
...
2. **[Configure DATABASICS Single Sign-On](#configure-databasics-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create DATABASICS test user](#create-databasics-test-user)** - to have a counterpart of Britta Simon in DATABASICS that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **DATABASICS** application integration page, select **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, perform the following steps:
    ...
    ![DATABASICS Domain and URLs single sign-on information](common/sp-identifier.png)
...
2. In the applications list, select **DATABASICS**.
	...
	![The DATABASICS link in the Applications list](common/all-applications.png)
...
When you click the DATABASICS tile in the Access Panel, you should be automatically signed in to the DATABASICS for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md).

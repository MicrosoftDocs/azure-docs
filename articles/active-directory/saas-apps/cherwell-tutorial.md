...
4. In the search box, type **Cherwell**.

	![Creating an Azure AD test user](./media/cherwell-tutorial/tutorial_cherwell_search.png)

5. In the results panel, select **Cherwell**, and then click **Add** button to add the application.
...
3. **[Creating a Cherwell test user](#creating-a-cherwell-test-user)** - to have a counterpart of Britta Simon in Cherwell that is linked to the Azure AD representation of user.

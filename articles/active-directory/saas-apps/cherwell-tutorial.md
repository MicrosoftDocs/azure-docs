...
1. Adding Cherwell from the gallery
...
1. In the search box, type **Cherwell**.

	![Creating an Azure AD test user](./media/cherwell-tutorial/tutorial_cherwell_search.png)

1. In the results panel, select **Cherwell**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/cherwell-tutorial/tutorial_cherwell_addfromgallery.png)
...
For single sign-on to work, Azure AD needs to know what the counterpart user in Cherwell is to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in Cherwell needs to be established.

In Cherwell, assign the value of the **user name** in Azure AD as the value of the **Username** to establish the link relationship.
...
1. **[Creating a Cherwell test user](#creating-a-cherwell-test-user)** - to have a counterpart of Britta Simon in Cherwell that is linked to the Azure AD representation of user.
...
### Creating a Cherwell test user

To enable Azure AD users to log in to Cherwell, they must be provisioned into Cherwell.

In the case of Cherwell, the user accounts need to be created by your [Cherwell support team](https://csm.cherwell.com/contact).
...
**To assign Britta Simon to Cherwell, perform the following steps:**

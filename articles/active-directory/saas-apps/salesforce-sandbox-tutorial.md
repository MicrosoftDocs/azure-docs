...
- [What is session control in Microsoft Cloud App Security?](/cloud-app-security/protect-salesforce)

- [Configure User Provisioning](salesforce-sandbox-provisioning-tutorial.md)

- [How to protect Salesforce Sandbox with advanced visibility and controls](/cloud-app-security/proxy-intro-aad)
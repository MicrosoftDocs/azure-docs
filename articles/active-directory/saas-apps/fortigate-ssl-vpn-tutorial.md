...
1. On the **Set up Single Sign-On with SAML** page, enter the following values:
	...
	> [!NOTE]
	> These values are just patterns. You need to use the actual **Sign on URL**, **Identifier**, **Reply URL**, and **Logout URL**. Contact the 		Fortinet support (=https://support.fortinet.com) for guidance. You can also refer to the example patterns shown in the Fortinet doc and  	     You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.

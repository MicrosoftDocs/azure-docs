...
4. On the **Set up Single Sign-On with SAML** page, click **Edit** button to open **Basic SAML Configuration** dialog.
    ...
    `https://admin.zscaler.net, https://admin.zscalerone.net, https://admin.zscalertwo.net, https://admin.zscalerthree.net, https://admin.zscloud.net, https://admin.zscalerbeta.net`.

    b. In the **Reply URL** text box, type a URL as per your requirement:
    `https://admin.zscaler.net/adminsso.do, https://admin.zscalerone.net/adminsso.do, https://admin.zscalertwo.net/adminsso.do, https://admin.zscalerthree.net/adminsso.do, https://admin.zscloud.net/adminsso.do, https://admin.zscalerbeta.net/adminsso.do`.

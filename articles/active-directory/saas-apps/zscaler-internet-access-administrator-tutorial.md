...
- You can enable your users to automatically get signed-on to Zscaler Internet Access Administrator (Single Sign-On) with their Azure AD accounts.
...
1. Adding Zscaler Internet Access Administrator from the gallery
...
4. In the search box, type **Zscaler Internet Access Administrator**, select **Zscaler Internet Access Administrator** from result panel then click **Add** button to add the application.
	...
	![Zscaler Internet Access Administrator in the results list](./media/zscaler-internet-access-administrator-tutorial/tutorial_zscaler-internet_addfromgallery.png)
...
For single sign-on to work, Azure AD needs to know what the counterpart user in Zscaler Internet Access Administrator is to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in Zscaler Internet Access Administrator needs to be established.
...
3. **[Creating a Zscaler Internet Access Administrator test user](#creating-a-zscaler-internet-access-administrator-test-user)** - to have a counterpart of Britta Simon in Zscaler Internet Access Administrator that is linked to the Azure AD representation of user.
4. **[Assigning the Azure AD test user](#assigning-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Testing single sign-on](#testing-single-sign-on)** - to verify whether the configuration works.

### Configuring Azure AD single sign-on

In this section, you enable Azure AD single sign-on in the Azure portal and configure single sign-on in your Zscaler Internet Access Administrator application.

**To configure Azure AD single sign-on with Zscaler Internet Access Administrator, perform the following steps:**

1. In the Azure portal, on the **Zscaler Internet Access Administrator** application integration page, click **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, perform the following steps:
	...
	![The Configuration](./media/zscaler-internet-access-administrator-tutorial/tutorial_zscaler-internet_url.png)

	 In the **Identifier** and **Reply URL** textbox, type any of the URL as per your requirement.

	> [!NOTE] 
	> You have to update this value with the actual **Identifier** and **Reply URL**. Contact [Zscaler Internet Access Administrator Client support team](https://help.zscaler.com/) to get these values.
...
7. On the **SAML Signing Certificate** page, in the **SAML Signing Certificate** section, click **Download** to download **Certificate (Base64)** and then save certificate file on your computer.
	...
	![The Certificate download link](./media/zscaler-internet-access-administrator-tutorial/tutorial_zscaler-internet_certificate.png) 

8. On the **Set up Zscaler Internet Access Administrator** section, copy the appropriate URL as per your requirement.
	...
	![Zscaler Internet Access Administrator Configuration](common/configuresection.png)
...
### Creating a Zscaler Internet Access Administrator test user
...
>[!Note]
>If you need to create a user manually, contact [Zscaler Internet Access Administrator support team](https://help.zscaler.com/).
...
2. In the applications list, select **Zscaler Internet Access Administrator**.

	![Configure Single Sign-On](./media/zscaler-internet-access-administrator-tutorial/tutorial_zscaler-internet_app.png)
...
When you click the Zscaler Internet Access Administrator tile in the Access Panel, you should get automatically signed-on to your Zscaler Internet Access Administrator application.

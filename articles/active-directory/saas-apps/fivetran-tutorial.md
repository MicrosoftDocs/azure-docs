...
To configure and test Azure AD SSO with Fivetran, complete the following building blocks:
...
1. In the [Azure portal](https://portal.azure.com/), on the **Fivetran** application integration page, find the **Manage** section and select **single sign-on**.
...
When you click the Fivetran tile in the Access Panel, you should be automatically signed in to the Fivetran for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Try Fivetran with Azure AD](https://aad.portal.azure.com/)

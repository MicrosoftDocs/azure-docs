...
In this article, you will learn how to integrate Imagen with Azure Active Directory (Azure AD). Imagen is the cloud-native media asset management platform built to manage, enrich and distribute your organization large-scale, mission-critical video files and drive value from your content. When you integrate Imagen with Azure AD, you can:

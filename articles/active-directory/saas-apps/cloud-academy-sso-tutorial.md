...
To configure and test Azure AD SSO with Cloud Academy - SSO, you'll take these high-level steps:
...
1. On the **Settings & Integrations** page, go to the **Integrations** tab and select the **SSO** card:

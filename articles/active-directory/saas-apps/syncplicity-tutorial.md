...
* You can enable your users to be automatically signed-in to Syncplicity (Single Sign-On) with their Azure AD accounts.
...
* Syncplicity single sign-on enabled subscription
...
4. In the search box, type **Syncplicity**, select **Syncplicity** from result panel then click **Add** button to add the application.

	![Syncplicity in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in Syncplicity needs to be established.
...
2. **[Configure Syncplicity Single Sign-On](#configure-syncplicity-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create Syncplicity test user](#create-syncplicity-test-user)** - to have a counterpart of Britta Simon in Syncplicity that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Syncplicity** application integration page, select **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, perform the following steps:
    ...
    ![Syncplicity Domain and URLs single sign-on information](common/sp-identifier.png)
...
6. On the **Set up Syncplicity** section, copy the appropriate URL(s) as per your requirement.
...
### Configure Syncplicity Single Sign-On
...
1. On the **Single Sign-On (SSO)** dialog page, perform the following steps:
    ...
    c. In the **Entity Id** textbox, Paste the value of **Azure Ad Identifier** which you have copied from Azure portal.
...
1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **Syncplicity**.
...
When you click the Syncplicity tile in the Access Panel, you should be automatically signed in to the Syncplicity for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

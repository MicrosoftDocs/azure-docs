...
1. On the **Basic SAML Configuration** section, if you wish to configure the application in **IDP** initiated mode, enter the values for the following fields:
    ...
    `https://*.opentext.com/<OTDSTENANT>/<TENANTID>/login`

    b. In the **Reply URL** text box, type a URL using the following pattern:
    `https://*.opentext.com/<OTDSTENANT>/<TENANTID>/login?authhandler=<HANDLERID>`
...
When you click the OpenText Directory Services tile in the Access Panel, you should be automatically signed in to the OpenText Directory Services for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [How to protect OpenText Directory Services with advanced visibility and controls](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

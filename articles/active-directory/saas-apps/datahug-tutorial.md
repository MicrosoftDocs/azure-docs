...
1. In the search box, type **Datahug**.

	![Creating an Azure AD test user](./media/datahug-tutorial/tutorial_datahug_search.png)

1. In the results panel, select **Datahug**, and then click **Add** button to add the application.
...
1. On the **Datahug Configuration** section, click **Configure Datahug** to open **Configure sign-on** window. Copy the **SAML Entity ID** and **SAML Single Sign-On Service URL** from the **Quick Reference section.**
...
1. Type the email of the person you would like to create an account for and click **Add**.

...
5. **[Create Folloze test user](#create-folloze-test-user)** - to have a counterpart of Britta Simon in Folloze that is linked to the Azure AD representation of user.

---
title: 'Tutorial: Azure Active Directory integration with Folloze | Microsoft Docs'
...
---
# Tutorial: Azure Active Directory integration with Folloze

In this tutorial, you learn how to integrate Folloze with Azure Active Directory (Azure AD).
Integrating Folloze with Azure AD provides you with the following benefits:

* You can control in Azure AD who has access to Folloze.
* You can enable your users to be automatically signed-in to Folloze (Single Sign-On) with their Azure AD accounts.
...
4. In the search box, type **Folloze**, select **Folloze** from result panel then click **Add** button to add the application.

	 ![Folloze in the results list](common/search_new_app.png)

## Configure and test Azure AD single sign-on

In this section, you configure and test Azure AD single sign-on with Folloze based on a test user called **Britta Simon**.
For single sign-on to work, a link relationship between an Azure AD user and the related user in Folloze needs to be established.
...
2. **[Configure Folloze Single Sign-On](#configure-folloze-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Create Folloze test user](#create-folloze-test-user)** - to have a counterpart of Britta Simon in Folloze that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Folloze** application integration page, select **Single sign-on**.
...
3. If you need to change to **SAML/WS-Fed** mode from any another mode, click **Change single sign-on mode** on top of the screen.

	  ![Change single sign-on mode](common/change_sso_mode.png)
...
5. On the **Set up Single Sign-On with SAML** page, click **Edit** button to open **Basic SAML Configuration** dialog.
	...
	> [!NOTE]
	> These values are not real. Update these values with the actual Identifier and Reply URL. Contact [Folloze Client support team](mailto:support@folloze.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.
...
6. On the **Set up Folloze** section, copy the appropriate URL(s) as per your requirement.
...
When you click the Folloze tile in the Access Panel, you should be automatically signed in to the Folloze for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

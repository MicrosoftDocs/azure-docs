...
To configure single sign-on on **BigPanda** side, see the Azure AD instructions in the [BigPanda documentation](https://docs.bigpanda.io/docs/azure-ad-active-directory). 

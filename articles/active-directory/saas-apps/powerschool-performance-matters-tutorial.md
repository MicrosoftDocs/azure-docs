...
4. On the **Basic SAML Configuration** section, if you have **Service Provider metadata file**, perform the following steps:
	...
	![Powerschool Performance Matters Domain and URLs single sign-on information](common/sp-identifier.png)

	In the **Sign-on URL** text box, type a URL using the following pattern:
    `https://ola.performancematters.com/ola/?clientcode=<Client Code>,https://unify.performancematters.com/?idp=<IDP>`

	> [!Note]
	> If the **Identifier** value does not get auto polulated, then please fill in the value manually according to your requirement. The Sign-on URL value is not real. Update this value with the actual Sign-on URL. Contact [Powerschool Performance Matters Client support team](mailto:pmsupport@powerschoo.com) to get this value. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.

---
title: 'Tutorial: Azure Active Directory single sign-on (SSO) integration with InformaCast | Microsoft Docs'
...
# Tutorial: Azure Active Directory single sign-on (SSO) integration with InformaCast
...
## Adding InformaCast from the gallery

...
1. Adding SmartLPA from the gallery
...
For single sign-on to work, Azure AD needs to know what the counterpart user in SmartLPA is to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in SmartLPA needs to be established.
...
3. **[Create a SmartLPA test user](#create-a-smartlpa-test-user)** - to have a counterpart of Britta Simon in SmartLPA that is linked to the Azure AD representation of user.
...
**To assign Britta Simon to SmartLPA, perform the following steps:**

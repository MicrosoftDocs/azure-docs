...
1. On the **Set up Single Sign-On with SAML** page, upload the downloaded **Service Provider metadata** file and configure the application in **IDP** initiated mode, by performing the following steps:

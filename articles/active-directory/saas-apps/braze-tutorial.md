---
title: 'Tutorial: Azure Active Directory single sign-on (SSO) integration with Braze | Microsoft Docs'
...
1. **[Configure Braze SSO](#configure-braze-sso)** - to configure the single sign-on settings on application side.
    * **[Create Braze test user](#create-braze-test-user)** - to have a counterpart of B.Simon in Braze that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Braze** application integration page, find the **Manage** section and select **single sign-on**.
...
When you click the Braze tile in the Access Panel, you should be automatically signed in to the Braze for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md).
...
- [Try Braze with Azure AD](https://aad.portal.azure.com/)
...
When you click the YouEarnedIt tile in the Access Panel, you should be automatically signed in to the YouEarnedIt for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

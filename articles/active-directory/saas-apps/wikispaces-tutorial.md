...
1. In the search box, type **Wikispaces**.

	![Creating an Azure AD test user](./media/wikispaces-tutorial/tutorial_wikispaces_search.png)

1. In the results panel, select **Wikispaces**, and then click **Add** button to add the application.
...
1. **[Creating a Wikispaces test user](#creating-a-wikispaces-test-user)** - to have a counterpart of Britta Simon in Wikispaces that is linked to the Azure AD representation of user.
...
1. On the **Wikispaces Domain and URLs** section, perform the following steps:
...
1. To configure single sign-on on **Wikispaces** side, you need to send the downloaded **Metadata XML** to [Wikispaces support team](https://www.wikispaces.com/site/help). You will get a notification as soon as the configuration has been completed.
...
1. Click the **Invite People**.
   
    ![Invite People](./media/wikispaces-tutorial/ic787194.png "Invite People")

1. In the **Invite People** section, perform the following steps:

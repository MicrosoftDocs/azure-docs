...
1. In the search box, type **Lucidchart**.

	![Creating an Azure AD test user](./media/lucidchart-tutorial/tutorial_lucidchart_search.png)

1. In the results panel, select **Lucidchart**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/lucidchart-tutorial/tutorial_lucidchart_addfromgallery.png)
...
1. On the **SAML Authentication Settings** dialog page, perform the following steps:
...
1. To display the list of users, go to **Users and groups** and click **All users**.
	...
	![Creating an Azure AD test user](./media/lucidchart-tutorial/create_aaduser_02.png) 

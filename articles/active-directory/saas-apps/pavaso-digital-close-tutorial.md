...
4. **[Create Pavaso Digital Close test user](#create-pavaso-digital-close-test-user)** - to have a counterpart of Britta Simon in Pavaso Digital Close that is linked to the Azure AD representation of user.

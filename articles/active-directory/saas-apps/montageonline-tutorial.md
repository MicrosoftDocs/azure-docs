...
1. Adding Montage Online from the gallery
...
For single sign-on to work, Azure AD needs to know what the counterpart user in Montage Online is to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in Montage Online needs to be established.
...
**To assign Britta Simon to Montage Online, perform the following steps:**
...
When you click the Montage Online tile in the Access Panel, you should get automatically signed-on to your Montage Online application.

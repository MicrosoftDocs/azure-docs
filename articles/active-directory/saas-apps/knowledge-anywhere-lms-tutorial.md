...
Configure and test Azure AD SSO with Knowledge Anywhere LMS using a test user called **Britta Simon**. For SSO to work, you need to establish a link relationship between an Azure AD user and the related user in Knowledge Anywhere LMS.
...
In this section, you'll enable Britta Simon to use Azure single sign-on by granting access to Knowledge Anywhere LMS.

...
1. Under **SAML authentication setting**, do the following:
	...
	c. In the **Collaboration item** box, paste the claim value that you copied earlier from the Azure portal (that is, **https://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress**).

---
title: 'Tutorial: Azure Active Directory single sign-on (SSO) integration with VMware Horizon - Unified Access Gateway | Microsoft Docs'
...
To configure and test Azure AD SSO with VMware Horizon - Unified Access Gateway, complete the following building blocks:
...
When you click the VMware Horizon - Unified Access Gateway tile in the Access Panel, you should be automatically signed in to the VMware Horizon - Unified Access Gateway for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

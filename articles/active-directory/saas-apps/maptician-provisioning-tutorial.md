...
You can begin the process of connecting your Maptician environment to Azure AD provisioning and single sign-on (SSO) by reaching out to the Maptician support team <support@maptician.com> or directly with your Maptician account manager. You will be provided a document which will contain your **Tenant URL**, along with a **Secret Token**. Maptician support team members can assist you with setting up this integration and are available to answer any questions about its configuration or use.

...
1. On the **Set up single sign-on with SAML** page, enter the values for the following fields:
	...
	> [!NOTE]
	> These values are not real. Update these values with the actual Identifier and Reply URL. Contact [Anyone Home CRM Client support team](mailto:rohan.patil@anyonehome.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.
...
To configure single sign-on on **Anyone Home CRM** side, you need to send the **App Federation Metadata Url** to [Anyone Home CRM support team](mailto:rohan.patil@anyonehome.com). They set this setting to have the SAML SSO connection set properly on both sides.

### Create Anyone Home CRM test user

In this section, you create a user called Britta Simon in Anyone Home CRM. Work with [Anyone Home CRM support team](mailto:rohan.patil@anyonehome.com) to add the users in the Anyone Home CRM platform. Users must be created and activated before you use single sign-on.

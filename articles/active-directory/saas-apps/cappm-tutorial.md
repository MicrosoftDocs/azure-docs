...
1. In the search box, type **CA PPM**.

	![Creating an Azure AD test user](./media/cappm-tutorial/tutorial_cappm_search.png)

1. In the results panel, select **CA PPM**, and then click **Add** button to add the application.
...
1. **[Creating a CA PPM test user](#creating-a-ca-ppm-test-user)** - to have a counterpart of Britta Simon in CA PPM that is linked to the Azure AD representation of user.
...
1. On the **CA PPM Domain and URLs** section, perform the following steps:
...
1. On the **CA PPM Configuration** section, click **Configure CA PPM** to open **Configure sign-on** window. Copy the **SAML Entity ID** from the **Quick Reference section.**

	![Configure Single Sign-On](./media/cappm-tutorial/tutorial_cappm_configure.png) 

1. To configure single sign-on on **CA PPM** side, you need to send the downloaded **Certificate(Base64)** and **SAML Entity ID** to [CA PPM support team](mailto:catechnicalsupport@ca.com).
...
1. On the **User** dialog page, perform the following steps:
	...
	![Creating an Azure AD test user](./media/cappm-tutorial/create_aaduser_04.png) 
...
1. In the applications list, select **CA PPM**.

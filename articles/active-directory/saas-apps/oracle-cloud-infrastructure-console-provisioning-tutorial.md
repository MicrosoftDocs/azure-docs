...
6. To generate a secret token, encode the client ID and client secret as Base64 with line wrapping disabled (base64 -w 0) in the format **client ID:Client Secret**. Save the secret token. This value will be entered in the **Secret Token** field in the provisioning tab of your Oracle Cloud Infrastructure Console application in the Azure portal.

...
1. On the **Basic SAML Configuration** section, the application is pre-configured and the necessary URLs are already pre-populated with Azure. The user needs to save the configuration by clicking the **Save** button.
    ...
    ![Sigstr Domain and URLs single sign-on information](common/preintegrated.png)
...
When you click the Sigstr tile in the Access Panel, you should be automatically signed in to the Sigstr for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

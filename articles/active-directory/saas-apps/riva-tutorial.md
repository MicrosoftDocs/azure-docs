---
title: 'Tutorial: Azure Active Directory single sign-on (SSO) integration with Riva | Microsoft Docs'
...
When you click the Riva tile in the Access Panel, you should be automatically signed in to the Riva for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Try Riva with Azure AD](https://aad.portal.azure.com/)
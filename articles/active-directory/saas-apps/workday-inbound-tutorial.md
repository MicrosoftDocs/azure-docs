---
title: 'Tutorial: Configure Workday for automatic user provisioning with Azure Active Directory (Preview) | Microsoft Docs'
...
* The "Workday to Azure AD" connector is currently not supported on Azure AD tenants where AAD Connect is enabled. 

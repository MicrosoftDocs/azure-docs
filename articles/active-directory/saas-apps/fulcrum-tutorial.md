---
title: 'Tutorial: Azure Active Directory integration with Fulcrum | Microsoft Docs'
...
---
# Tutorial: Azure Active Directory integration with Fulcrum

In this tutorial, you learn how to integrate Fulcrum with Azure Active Directory (Azure AD).
Integrating Fulcrum with Azure AD provides you with the following benefits:

* You can control in Azure AD who has access to Fulcrum.
* You can enable your users to be automatically signed-in to Fulcrum (Single Sign-On) with their Azure AD accounts.
...
4. In the search box, type **Fulcrum**, select **Fulcrum** from result panel then click **Add** button to add the application.

	 ![Fulcrum in the results list](common/search-new-app.png)

## Configure and test Azure AD single sign-on

In this section, you configure and test Azure AD single sign-on with Fulcrum based on a test user called **Britta Simon**.
For single sign-on to work, a link relationship between an Azure AD user and the related user in Fulcrum needs to be established.
...
2. **[Configure Fulcrum Single Sign-On](#configure-fulcrum-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create Fulcrum test user](#create-fulcrum-test-user)** - to have a counterpart of Britta Simon in Fulcrum that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Fulcrum** application integration page, select **Single sign-on**.
...
5. Click **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
    ...
    ![Fulcrum Domain and URLs single sign-on information](common/both-signonurl.png)
...
7. In addition to above, Fulcrum application expects few more attributes to be passed back in SAML response. In the **User Claims** section on the **User Attributes** dialog, perform the following steps to add SAML token attribute as shown in the below table: 
...
2. In the applications list, select **Fulcrum**.
	...
	![The Fulcrum link in the Applications list](common/all-applications.png)
...
When you click the Fulcrum tile in the Access Panel, you should be automatically signed in to the Fulcrum for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

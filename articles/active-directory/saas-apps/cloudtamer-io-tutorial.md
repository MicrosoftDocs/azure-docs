---
title: 'Tutorial: Azure Active Directory single sign-on (SSO) integration with Kion (formerly cloudtamer.io) | Microsoft Docs'
...
# Tutorial: Azure Active Directory single sign-on (SSO) integration with Kion (formerly cloudtamer.io)
...
1. **[Configure Kion SSO](#configure-cloudtamerio-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Kion test user](#create-cloudtamerio-test-user)** - to have a counterpart of B.Simon in Kion that is linked to the Azure AD representation of user.
...
## Configure Kion (formerly cloudtamer.io) SSO

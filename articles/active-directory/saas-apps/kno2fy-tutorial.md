...
In this article, you'll learn how to integrate Kno2fy with Azure Active Directory (Azure AD). Kno2fy empowers healthcare organizations to send, receive, and find patient information across the healthcare ecosystem with just a few quick clicks. When you integrate Kno2fy with Azure AD, you can:

...
* You can enable your users to be automatically signed-in to FloQast (Single Sign-On) with their Azure AD accounts.
...
* FloQast single sign-on enabled subscription
...
4. In the search box, type **FloQast**, select **FloQast** from result panel then click **Add** button to add the application.
	 ...
	 ![FloQast in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in FloQast needs to be established.
...
2. **[Configure FloQast Single Sign-On](#configure-floqast-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create FloQast test user](#create-floqast-test-user)** - to have a counterpart of Britta Simon in FloQast that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **FloQast** application integration page, select **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, If you wish to configure the application in **IDP** initiated mode, perform the following step:
    ...
    ![FloQast Domain and URLs single sign-on information](common/idp-identifier.png)
...
10. On the **Set up FloQast** section, copy the appropriate URL(s) as per your requirement.
...
### Configure FloQast Single Sign-On
...
1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **FloQast**.

	![Enterprise applications blade](common/enterprise-applications.png)

2. In the applications list, select **FloQast**.

	![The FloQast link in the Applications list](common/all-applications.png)
...
When you click the FloQast tile in the Access Panel, you should be automatically signed in to the FloQast for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

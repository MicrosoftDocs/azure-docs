...
1. In the search box, type **Neota Logic Studio**.

	![Creating an Azure AD test user](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_search.png)

1. In the results panel, select **Neota Logic Studio**, and then click **Add** button to add the application.
...
1. In the applications list, select **Neota Logic Studio**.

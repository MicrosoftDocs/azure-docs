...
1. In the search box, type **EFI Digital StoreFront**, select **EFI Digital StoreFront** from result panel then click **Add** button to add the application.
...
1. **[Create a EFI Digital StoreFront test user](#create-a-efi-digital-storefront-test-user)** - to have a counterpart of Britta Simon in EFI Digital StoreFront that is linked to the Azure AD representation of user.
...
1. On the **EFI Digital StoreFront Domain and URLs** section, perform the following steps:
...
1. To configure single sign-on on **EFI Digital StoreFront** side, you need to send the downloaded **Metadata XML** to [EFI Digital StoreFront support team](https://www.efi.com/products/productivity-software/ecommerce-web-to-print/efi-digital-storefront/support/). They set this setting to have the SAML SSO connection set properly on both sides.

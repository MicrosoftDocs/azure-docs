...
When you click the EFI Digital StoreFront tile in the Access Panel, you should be automatically signed in to the EFI Digital StoreFront for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
3. On the **Imagineer WebVision Domain and URLs** section, perform the following steps:
    ...
    a. In the **Sign-on URL** textbox, type a URL using the following pattern: `https://<YOUR SERVER URL>/<LOGIN PAGE>`

	b. In the **Identifier** textbox, type a URL using the following pattern: `https://<YOUR SERVER URL>/<LOGIN PAGE>`

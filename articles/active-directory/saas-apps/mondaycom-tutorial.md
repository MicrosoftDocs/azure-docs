...
1. **[Configure monday.com SSO](#configure-monday.com-sso)** - to configure the single sign-on settings on application side.
    1. **[Create monday.com test user](#create-monday.com-test-user)** - to have a counterpart of B.Simon in monday.com that is linked to the Azure AD representation of user.

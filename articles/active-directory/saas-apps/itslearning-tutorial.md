...
4. In the search box, type **itslearning**.

	![Creating an Azure AD test user](./media/itslearning-tutorial/tutorial_itslearning_search.png)

5. In the results panel, select **itslearning**, and then click **Add** button to add the application.
...
### Creating an itslearning test user

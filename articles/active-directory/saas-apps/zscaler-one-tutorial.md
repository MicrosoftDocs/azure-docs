...
4. In the search box, type **Zscaler One**, select **Zscaler One** from result panel then click **Add** button to add the application.
	...
	![Zscaler One in the results list](./media/zscaler-one-tutorial/tutorial_zscalerone_addfromgallery.png)
...
4. On the **Basic SAML Configuration** section, perform the following steps:
	...
	![Zscaler One Domain and URLs single sign-on information](./media/zscaler-one-tutorial/tutorial_zscalerone_url.png)
...
7. On the **SAML Signing Certificate** page, in the **SAML Signing Certificate** section, click **Download** to download **Certificate (Base64)** and then save certificate file on your computer.
	...
	![The Certificate download link](./media/zscaler-one-tutorial/tutorial_zscalerone_certificate.png) 

8. On the **Set up Zscaler One** section, copy the appropriate URL as per your requirement.
	...
	![Zscaler One Configuration](common/configuresection.png)

9. In a different web browser window, log in to your Zscaler One company site as an administrator.
...
The objective of this section is to create a user called Britta Simon in Zscaler One. Zscaler One supports just-in-time provisioning, which is by default enabled. There is no action item for you in this section. A new user is created during an attempt to access Zscaler One if it doesn't exist yet.
>[!Note]

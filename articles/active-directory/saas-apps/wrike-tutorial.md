...
6. To configure single sign-on on **Wrike** side, you need to send the downloaded **Federation Metadata XML** to [Wrike support team](mailto:support@team.wrike.com). They set this setting to have the SAML SSO connection set properly on both sides.
...
### Creating a Wrike test user

The objective of this section is to create a user called Britta Simon in Wrike. Wrike supports just-in-time provisioning, which is by default enabled. There is no action item for you in this section. A new user is created during an attempt to access Wrike if it doesn't exist yet.
>[!Note]

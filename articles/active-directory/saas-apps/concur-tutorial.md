...
* You can enable your users to be automatically signed-in to Concur (Single Sign-On) with their Azure AD accounts.
...
* Concur single sign-on enabled subscription
...
4. In the search box, type **Concur**, select **Concur** from result panel then click **Add** button to add the application.

	 ![Concur in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in Concur needs to be established.
...
2. **[Configure Concur Single Sign-On](#configure-concur-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create Concur test user](#create-concur-test-user)** - to have a counterpart of Britta Simon in Concur that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Concur** application integration page, select **Single sign-on**.
...
6. On the **Set up Concur** section, copy the appropriate URL(s) as per your requirement.
...
### Configure Concur Single Sign-On
...
1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **Concur**.

	![Enterprise applications blade](common/enterprise-applications.png)

2. In the applications list, type and select **Concur**.

	![The Concur link in the Applications list](common/all-applications.png)
...
In this section, a user called Britta Simon is created in Concur. Concur supports just-in-time user provisioning, which is enabled by default. There is no action item for you in this section. If a user doesn't already exist in Concur, a new one is created after authentication.

...
* You can enable your users to be automatically signed-in to Workpath (Single Sign-On) with their Azure AD accounts.
...
* Workpath single sign-on enabled subscription
...
4. In the search box, type **Workpath**, select **Workpath** from result panel then click **Add** button to add the application.

	 ![Workpath in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in Workpath needs to be established.
...
2. **[Configure Workpath Single Sign-On](#configure-workpath-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create Workpath test user](#create-workpath-test-user)** - to have a counterpart of Britta Simon in Workpath that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Workpath** application integration page, select **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, if you wish to configure the application in **IDP** initiated mode, perform the following steps:
    ...
    ![Workpath Domain and URLs single sign-on information](common/idp-intiated.png)
...
5. Click **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
    ...
    ![Workpath Domain and URLs single sign-on information](common/metadata-upload-additional-signon.png)
...
7. In addition to above, Workpath application expects few more attributes to be passed back in SAML response. In the **User Claims** section on the **User Attributes** dialog, perform the following steps to add SAML token attribute as shown in the below table:
...
9. On the **Set up Workpath** section, copy the appropriate URL(s) as per your requirement.
...
### Configure Workpath Single Sign-On
...
1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **Workpath**.

	![Enterprise applications blade](common/enterprise-applications.png)

2. In the applications list, select **Workpath**.

	![The Workpath link in the Applications list](common/all-applications.png)
...
When you click the Workpath tile in the Access Panel, you should be automatically signed in to the Workpath for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
To configure single sign-on on the Profit.co SAML App side, you need to send the App Federation Metadata URL to the [Profit.co SAML App support team](mailto:support@profit.co). They configure this setting to have the SAML SSO connection set properly on both sides.

### Create a Profit.co SAML App test user

In this section, you create a user called B.Simon in Profit.co SAML App. Work with the [Profit.co SAML App support team](mailto:support@profit.co) to add the users in the Profit.co SAML App platform. You can't use single sign-on until you create and activate users.

...
3. Determine what data to [map between Azure AD and Cofense Recipient Sync](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

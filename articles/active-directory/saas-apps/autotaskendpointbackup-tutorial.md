...
1. In the search box, type **Autotask Endpoint Backup**, select **Autotask Endpoint Backup** from result panel then click **Add** button to add the application.
...
1. **[Create a Autotask Endpoint Backup test user](#create-a-autotask-endpoint-backup-test-user)** - to have a counterpart of Britta Simon in Autotask Endpoint Backup that is linked to the Azure AD representation of user.
...
1. On the **Autotask Endpoint Backup Domain and URLs** section, perform the following steps:

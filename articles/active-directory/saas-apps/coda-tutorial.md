...
1. On the **Set up single sign-on with SAML** page, enter the values for the following fields:
	...
	> [!NOTE]
	> These values are not real. Update these values with the actual Identifier and Reply URL. Contact [Coda Client support team](mailto:support@coda.io) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.
...
To configure single sign-on on **Coda** side, you need to send the downloaded **Certificate (Base64)** and appropriate copied URLs from Azure portal to [Coda support team](mailto:support@coda.io). They set this setting to have the SAML SSO connection set properly on both sides.

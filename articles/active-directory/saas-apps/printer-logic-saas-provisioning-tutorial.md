---
title: 'Tutorial: Configure PrinterLogic SaaS for automatic user provisioning with Azure Active Directory | Microsoft Docs'
...
> * [Single sign-on](https://docs.microsoft.com/azure/active-directory/saas-apps/printerlogic-saas-tutorial) to PrinterLogic SaaS (recommended)
...
3. Determine what data to [map between Azure AD and PrinterLogic SaaS](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

...
* Skills Base supports **SP** initiated SSO only (Skills Base does not support **IdP** initiated SSO).
...
2. In the **Identity Providers** section, select the **edit** button (denoted by a pencil icon) for the Identity Provider record you added.
   ...
   ![Edit Identity Provider button](./media/skillsbase-tutorial/edit-identity-provider.png)

3. In the **Edit identity provider** panel, for **SAML IdP Metadata** select **Upload an XML file**

4. Click **Browse** to choose a file. Select the Federation Metadata XML file that you downloaded from Azure AD and click **Save**.

   ![Edit Identity Provider button](./media/skillsbase-tutorial/browse-and-save.png)
   
5. In the **Authentication** panel, for **Single Sign-On** select the Identity Provider you added.

   ![Edit Identity Provider button](./media/skillsbase-tutorial/select-identity-provider.png)
...
8. click **Save changes**.
   ...
   ![Edit Identity Provider button](./media/skillsbase-tutorial/identity-provider-enabled.png)

...
* You can enable your users to be automatically signed-in to Apptio (Single Sign-On) with their Azure AD accounts.
...
* Apptio single sign-on enabled subscription
...
4. In the search box, type **Apptio**, select **Apptio** from result panel then click **Add** button to add the application.
	 ...
	 ![Apptio in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in Apptio needs to be established.
...
2. **[Configure Apptio Single Sign-On](#configure-apptio-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create Apptio test user](#create-apptio-test-user)** - to have a counterpart of Britta Simon in Apptio that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Apptio** application integration page, select **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, perform the following steps:
    ...
    ![Apptio Domain and URLs single sign-on information](common/idp-identifier.png)

    In the **Identifier** text box,  type the value:
    `urn:federation:apptio`

5. Apptio application expects the SAML assertions in a specific format. Configure the following claims for this application. You can manage the values of these attributes from the **User Attributes** section on application integration page. On the **Set up Single Sign-On with SAML** page, click **Edit** button to open **User Attributes** dialog.
...
8. On the **Set up Apptio** section, copy the appropriate URL(s) as per your requirement.
...
### Configure Apptio Single Sign-On
...
1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **Apptio**.

	![Enterprise applications blade](common/enterprise-applications.png)

2. In the applications list, select **Apptio**.

	![The Apptio link in the Applications list](common/all-applications.png)

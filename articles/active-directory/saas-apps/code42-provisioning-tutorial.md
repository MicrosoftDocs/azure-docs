...
> * [Single sign-on](https://docs.microsoft.com/azure/active-directory/saas-apps/code42-tutorial) to Code42 (recommended)
...
3. Determine what data to [map between Azure AD and Code42](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes).

...
1. In the [Azure portal](https://portal.azure.com/), on the **Rightscale** application integration page, select **Single sign-on**.
...
When you click the Rightscale tile in the Access Panel, you should be automatically signed in to the Rightscale for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md).

...
1. In the search box, type **Rightscale**.

	![Creating an Azure AD test user](./media/rightscale-tutorial/tutorial_rightscale_search.png)

1. In the results panel, select **Rightscale**, and then click **Add** button to add the application.
...
1. In the applications list, select **Rightscale**.

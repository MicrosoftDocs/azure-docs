...
* You can enable your users to be automatically signed-in to SafeConnect (Single Sign-On) with their Azure AD accounts.
...
* SafeConnect single sign-on enabled subscription
...
4. In the search box, type **SafeConnect**, select **SafeConnect** from result panel then click **Add** button to add the application.
	 ...
	 ![SafeConnect in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in SafeConnect needs to be established.
...
2. **[Configure SafeConnect Single Sign-On](#configure-safeconnect-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create SafeConnect test user](#create-safeconnect-test-user)** - to have a counterpart of Britta Simon in SafeConnect that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **SafeConnect** application integration page, select **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, perform the following steps:
    ...
    ![SafeConnect Domain and URLs single sign-on information](common/sp-signonurl.png)
...
6. On the **Set up SafeConnect** section, copy the appropriate URL(s) as per your requirement.
...
### Configure SafeConnect Single Sign-On

To configure single sign-on on **SafeConnect** side, you need to send the downloaded **Federation Metadata XML** and appropriate copied URLs from Azure portal to [SafeConnect support team](mailto:support@impulse.com). They set this setting to have the SAML SSO connection set properly on both sides.
...
1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **SafeConnect**.

	![Enterprise applications blade](common/enterprise-applications.png)

2. In the applications list, select **SafeConnect**.

	![The SafeConnect link in the Applications list](common/all-applications.png)
...
When you click the SafeConnect tile in the Access Panel, you should be automatically signed in to the SafeConnect for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

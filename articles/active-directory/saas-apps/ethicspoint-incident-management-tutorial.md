...
1. In the search box, type **EthicsPoint Incident Management (EPIM)**.

	![Creating an Azure AD test user](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_search.png)

1. In the results panel, select **EthicsPoint Incident Management (EPIM)**, and then click **Add** button to add the application.

...
3. Determine what data to [map between Azure AD and Adobe Identity Management](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

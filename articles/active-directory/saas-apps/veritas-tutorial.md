...
1. In the search box, type **Veritas Enterprise Vault.cloud SSO**.

	![Creating an Azure AD test user](./media/veritas-tutorial/tutorial_veritas_search.png)

1. In the results panel, select **Veritas Enterprise Vault.cloud SSO**, and then click **Add** button to add the application.
...
1. To configure single sign-on on **Veritas Enterprise Vault.cloud SSO** side, you need to send the downloaded **Certificate(Base64)** and **SAML Single Sign-On Service URL** to [Veritas Enterprise Vault.cloud SSO support team](https://www.veritas.com/support/.html).

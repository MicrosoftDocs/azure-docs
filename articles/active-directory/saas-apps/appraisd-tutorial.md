...
* You can enable your users to be automatically signed-in to Appraisd (Single Sign-On) with their Azure AD accounts.
...
* Appraisd single sign-on enabled subscription
...
4. In the search box, type **Appraisd**, select **Appraisd** from result panel then click **Add** button to add the application.
	 ...
	 ![Appraisd in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in Appraisd needs to be established.
...
2. **[Configure Appraisd Single Sign-On](#configure-appraisd-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create Appraisd test user](#create-appraisd-test-user)** - to have a counterpart of Britta Simon in Appraisd that is linked to the Azure AD representation of user.
...
4. On the **Basic SAML Configuration** section, If you wish to configure the application in **IDP** initiated mode, perform the following steps:
    ...
    ![Appraisd Domain and URLs single sign-on information](common/both-preintegrated-advanced-urls.png)
...
8. On the **Set up Appraisd** section, copy the appropriate URL(s) as per your requirement.
...
### Configure Appraisd Single Sign-On
...
1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **Appraisd**.

	![Enterprise applications blade](common/enterprise-applications.png)

2. In the applications list, select **Appraisd**.

	![The Appraisd link in the Applications list](common/all-applications.png)
...
When you click the Appraisd tile in the Access Panel, you should be automatically signed in to the Appraisd for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

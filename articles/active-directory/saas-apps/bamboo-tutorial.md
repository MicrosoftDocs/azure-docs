...
3. **[Create a SAML SSO for Bamboo by resolution GmbH test user](#create-a-saml-sso-for-bamboo-by-resolution-gmbh-test-user)** - to have a counterpart of Britta Simon in SAML SSO for Bamboo by resolution GmbH that is linked to the Azure AD representation of user.
...
3. On the **SAML SSO for Bamboo by resolution GmbH Domain and URLs** section, perform the following steps if you wish to configure the application in IDP initiated mode:
...
7. Sign-on to your SAML SSO for Bamboo by resolution GmbH company site as administrator.

8. On the right side of the main toolbar, click **Settings** > **Add-ons**.

	![The Settings](./media/bamboo-tutorial/tutorial_bamboo_setings.png)

9. Go to SECURITY section, click on **SAML SingleSignOn** on the Menubar.

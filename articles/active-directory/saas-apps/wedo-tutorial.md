...
* Click on **Test this application** in Azure portal. This will redirect to WEDO Sign on URL where you can initiate the login flow.  

* Go to WEDO Sign-on URL directly and initiate the login flow from there.

#### IDP initiated:

* Click on **Test this application** in Azure portal and you should be automatically signed in to the WEDO for which you set up the SSO. 

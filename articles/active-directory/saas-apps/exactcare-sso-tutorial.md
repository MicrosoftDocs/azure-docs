...
When you click the ExactCare SSO tile in the Access Panel, you should be automatically signed in to the ExactCare SSO for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md).
...
- [Try ExactCare SSO with Azure AD](https://aad.portal.azure.com/)
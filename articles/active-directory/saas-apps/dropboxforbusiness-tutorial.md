...
- [What is Conditional Access in Azure Active Directory?](https://docs.microsoft.com/en-us/cloud-app-security/protect-dropbox)

- [How to protect Dropbox with advanced visibility and controls](https://docs.microsoft.com/en-us/cloud-app-security/proxy-intro-aad)
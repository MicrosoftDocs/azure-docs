...
> Before starting this process, make sure SSO is available in your Workspace — check there’s an SSO tab in your Workspace Admin panel.
...
1. On the **Basic SAML Configuration** section, perform the following steps:
    ...
    `sketch-9f06d96e-df01-4de9-9c68-d53f9b7f271c`

    b. In the **Reply URL** textbox, use the `ACS URL` field from the previous step. It looks like:
    `https://sso.sketch.com/saml/acs?id=9f06d96e-df01-4de9-9c68-d53f9b7f271c`

1. Click **Set additional URLs** and perform the following step:    

    In the **Sign-on URL** text box, type the URL:
    `https://www.sketch.com/signin/sso`

1. Sketch application expects the SAML assertions in a specific format, which requires you to add custom attribute mappings to your SAML token attributes configuration. The following screenshot shows the list of attributes. The values in the right column may be different in your case — make sure that you add the right information.
    
    ![Screenshot shows the image of attribute mappings.](media/sketch-tutorial/azure-ad-sso-fields.png "Attributes")
...
2. Use the shortname you configured previously to proceed.
3. Enjoy Sketch!

---
title: 'Tutorial: Azure Active Directory single sign-on (SSO) integration with HighGround | Microsoft Docs'
...
When you click the HighGround tile in the Access Panel, you should be automatically signed in to the HighGround for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [How to protect HighGround with advanced visibility and controls](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

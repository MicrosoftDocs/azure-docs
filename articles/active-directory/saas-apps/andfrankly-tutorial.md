...
4. On the **Basic SAML Configuration** section, If you wish to configure the application in **IDP** initiated mode, perform the following steps:
    ...
    ![&frankly Domain and URLs single sign-on information](common/idp-intiated.png)
...
5. Click **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
    ...
    ![&frankly Domain and URLs single sign-on information](common/metadata-upload-additional-signon.png)
...
To configure finally enable single sign-on Log in to &frankly and go to **Account => User Management** and change Authentication mechanism from Default to **Enterprise Sign-on (SAML)**. Upload the **Federation Metadata XML** that you downloaded in step 6 and press Save.
...
When you click the &frankly tile in the Access Panel, you should be automatically signed in to the &frankly for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
1. Under the **Admin Credentials** section, input your Gong Tenant URL and Secret Token. Click **Test Connection** to ensure Azure AD can connect to Gong. If the connection fails, ensure your Gong account has Admin permissions and try again.

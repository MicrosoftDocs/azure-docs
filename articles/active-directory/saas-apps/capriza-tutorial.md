...
4. In the search box, type **Capriza Platform**.

	![Creating an Azure AD test user](./media/capriza-tutorial/tutorial_caprizaplatform_search.png)

5. In the results panel, select **Capriza Platform**, and then click **Add** button to add the application.
...
When you click the Capriza Platform tile in the Access Panel, you should get automatically signed-on to your Capriza application. For more information about the Access Panel, see [Introduction to the Access Panel](../active-directory-saas-access-panel-introduction.md). 

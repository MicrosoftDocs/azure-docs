...
4. **[Create Slack test user](#create-slack-test-user)** - to have a counterpart of Britta Simon in Slack that is linked to the Azure AD representation of user.
...
4. On the **Basic SAML Configuration** section, perform the following steps:
	...
	> [!NOTE]
	> These values are not real. Update these values with the actual Sign on URL and Identifier. Contact [Slack Client support team](https://slack.com/help/contact) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.

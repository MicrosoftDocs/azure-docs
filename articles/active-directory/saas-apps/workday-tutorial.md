...
5. Click **Set additional URLs** and perform the following step:
    ...
    > Using something like `http://www.myworkday.com` works but `https://myworkday.com` does not. Contact [Workday Client support team](https://www.workday.com/en-us/partners-services/services/support.html) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.

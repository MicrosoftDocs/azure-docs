...
4. **[Create Splunk Enterprise and Splunk Cloud test user](#create-splunk-enterprise-and-splunk-cloud-test-user)** - to have a counterpart of Britta Simon in Splunk Enterprise and Splunk Cloud that is linked to the Azure AD representation of user.
...
When you click the Splunk Enterprise and Splunk Cloud tile in the Access Panel, you should be automatically signed in to the Splunk Enterprise and Splunk Cloud for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

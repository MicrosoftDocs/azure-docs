...
4. On the **Basic SAML Configuration** section, If you wish to configure the application in **IDP** initiated mode, perform the following steps:
    ...
    ![Oneteam Domain and URLs single sign-on information](common/idp-intiated.png)
...
When you click the Oneteam tile in the Access Panel, you should be automatically signed in to the Oneteam for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

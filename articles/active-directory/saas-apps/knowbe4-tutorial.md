...
1. In the search box, type **KnowBe4 Security Awareness Training**, select **KnowBe4 Security Awareness Training** from result panel then click **Add** button to add the application.

	![KnowBe4 Security Awareness Training in the results list](./media/knowbe4-tutorial/tutorial_knowbe4_addfromgallery.png)
...
1. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/knowbe4-tutorial/create_aaduser_04.png)
...
1. In the applications list, select **KnowBe4 Security Awareness Training**.
	...
	![The KnowBe4 Security Awareness Training link in the Applications list](./media/knowbe4-tutorial/tutorial_knowbe4_app.png)  

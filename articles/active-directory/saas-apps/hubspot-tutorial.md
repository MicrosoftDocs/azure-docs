...
* HubSpot supports **SP and IDP** initiated SSO
...
1. In the [Azure portal](https://portal.azure.com/), on the **HubSpot** application integration page, select **Single sign-on**.

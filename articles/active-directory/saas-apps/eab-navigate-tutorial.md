...
When you click the EAB Navigate tile in the Access Panel, you should be automatically signed in to the EAB Navigate for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Try EAB Navigate with Azure AD](https://aad.portal.azure.com/)

...
1. **[Configure Smart Map Pro SSO](#configure-smart-map-pro-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Smart Map Pro test user](#create-smart-map-pro-test-user)** - to have a counterpart of B.Simon in Smart Map Pro that is linked to the Microsoft Entra ID representation of user.
...
* You can use Microsoft My Apps. When you click the Smart Map Pro tile in the My Apps, you should be automatically signed in to the Smart Map Pro for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](../user-help/my-apps-portal-end-user-access.md).

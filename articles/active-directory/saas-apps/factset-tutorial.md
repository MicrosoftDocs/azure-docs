...
4. On the **Basic SAML Configuration** section, perform the following steps:
	...
	> [!NOTE]
	> These values are not real. Update these values with the actual Sign on URL and Identifier. Contact your FactSet account representative to get these values. If you don't know who your FactSet representative is, see [FactSet support nubmers](https://www.factset.com/support-numbers) to learn how to contact them.  You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Azure portal.

...
When you click the C3M Cloud Control tile in the Access Panel, you should be automatically signed in to the C3M Cloud Control for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [How to protect C3M Cloud Control with advanced visibility and controls](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
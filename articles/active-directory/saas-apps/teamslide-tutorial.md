...
1. **[Configure TeamSlide SSO](#configure-teamslide-portal-sso)** - to configure the single sign-on settings on application side.
    1. **[Create TeamSlide test user](#create-teamslide-portal-test-user)** - to have a counterpart of B.Simon in TeamSlide that is linked to the Azure AD representation of user.

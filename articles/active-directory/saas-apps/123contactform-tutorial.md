...
* You can enable your users to be automatically signed-in to 123ContactForm (Single Sign-On) with their Azure AD accounts.
...
4. In the search box, type **123ContactForm**, select **123ContactForm** from result panel then click **Add** button to add the application.

	 ![123ContactForm in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in 123ContactForm needs to be established.
...
2. **[Configure 123ContactForm Single Sign-On](#configure-123contactform-single-sign-on)** - to configure the Single Sign-On settings on application side.
3. **[Create an Azure AD test user](#create-an-azure-ad-test-user)** - to test Azure AD single sign-on with Britta Simon.
4. **[Assign the Azure AD test user](#assign-the-azure-ad-test-user)** - to enable Britta Simon to use Azure AD single sign-on.
5. **[Create 123ContactForm test user](#create-123contactform-test-user)** - to have a counterpart of Britta Simon in 123ContactForm that is linked to the Azure AD representation of user.
...
1. In the [Azure portal](https://portal.azure.com/), on the **123ContactForm** application integration page, select **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, If you wish to configure the application in **IDP** initiated mode, perform the following steps:
    ...
    ![123ContactForm Domain and URLs single sign-on information](common/idp-intiated.png)
...
5. Click **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
    ...
    ![123ContactForm Domain and URLs single sign-on information](common/metadata-upload-additional-signon.png)
...
1. To configure single sign-on on **123ContactForm** side, go to [https://www.123contactform.com/form-2709121/](https://www.123contactform.com/form-2709121/) and perform the following steps:
...
2. In the applications list, select **123ContactForm**.
	...
	![The 123ContactForm link in the Applications list](common/all-applications.png)
...
In this section, a user called Britta Simon is created in 123ContactForm. 123ContactForm supports just-in-time user provisioning, which is enabled by default. There is no action item for you in this section. If a user doesn't already exist in 123ContactForm, a new one is created after authentication.

### Test single sign-on

In this section, you test your Azure AD single sign-on configuration using the Access Panel.

When you click the 123ContactForm tile in the Access Panel, you should be automatically signed in to the 123ContactForm for which you set up SSO. For more information about the Access Panel, see [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
3. Determine what data to [map between Azure AD and Freshservice Provisioning](../app-provisioning/customize-application-attributes.md). 
...
Add Freshservice Provisioning from the Azure AD application gallery to start managing provisioning to Freshservice Provisioning. Learn more about adding an application from the gallery [here](../manage-apps/add-application-portal.md). 

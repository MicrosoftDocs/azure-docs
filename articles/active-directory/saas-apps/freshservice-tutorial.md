...
* You can enable your users to be automatically signed-in to Freshservice (Single Sign-On) with their Azure AD accounts.
...
* Freshservice single sign-on enabled subscription
...
4. In the search box, type **Freshservice**, select **Freshservice** from result panel then click **Add** button to add the application.

	 ![Freshservice in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in Freshservice needs to be established.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Freshservice** application integration page, select **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, perform the following steps:
    ...
    ![Freshservice Domain and URLs single sign-on information](common/sp-identifier.png)
...
7. On the **Set up Freshservice** section, copy the appropriate URL(s) as per your requirement.
...
### Configure Freshservice Single Sign-On
...
In this section, you enable Britta Simon to use Azure single sign-on by granting access to Freshservice.

1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **Freshservice**.

	![Enterprise applications blade](common/enterprise-applications.png)

2. In the applications list, select **Freshservice**.

	![The Freshservice link in the Applications list](common/all-applications.png)

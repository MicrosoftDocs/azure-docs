...
1. In the search box, type **ICIMS**, select **ICIMS** from result panel then click **Add** button to add the application.

	![ICIMS in the results list](./media/icims-tutorial/tutorial_icims_addfromgallery.png)
...
1. **[Create an ICIMS test user](#create-an-icims-test-user)** - to have a counterpart of Britta Simon in ICIMS that is linked to the Azure AD representation of user.
...
1. To display the list of users, go to **Users and groups** and click **All users**.
	...
	![The "Users and groups" and "All users" links](./media/icims-tutorial/create_aaduser_02.png) 
...
1. In the applications list, select **ICIMS**.
	...
	![The ICIMS link in the Applications list](./media/icims-tutorial/tutorial_icims_app.png) 

...
To configure and test Azure AD SSO with LinkedIn Learning, prform the following steps:
...
* Click on **Test this application** in Azure portal. This will redirect to Kronos Sign on URL where you can initiate the login flow.  

* Go to Kronos Sign-on URL directly and initiate the login flow from there.
...
You can also use Microsoft My Apps to test the application in any mode. When you click the Kronos tile in the My Apps, if configured in SP mode you would be redirected to the application sign on page for initiating the login flow and if configured in IDP mode, you should be automatically signed in to the Kronos for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

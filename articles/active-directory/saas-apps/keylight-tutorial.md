...
To configure Azure AD integration with NAVEX IRM (Lockpath/Keylight)t, you need the following items:
...
1. **[Configure NAVEX IRM (Lockpath/Keylight) SSO](#configure-lockpath-keylight-sso)** - to configure the single sign-on settings on application side.
    1. **[Create NAVEX IRM (Lockpath/Keylight) test user](#create-lockpath-keylight-test-user)** - to have a counterpart of B.Simon in NAVEX IRM (Lockpath/Keylight) that is linked to the Azure AD representation of user.

---
title: 'Tutorial: Integrate Azure Active Directory with Kantega SSO for FishEye/Crucible | Microsoft Docs'
description: Learn how to configure single sign-on between Azure Active Directory and FishEye/Crucible using Kantega SSO.
...
ms.author: jeedes
---
# Tutorial: Integrate Azure Active Directory with Kantega SSO for FishEye/Crucible

This tutorial will walk you through the steps of configuring single sign-on for your Azure AD users in FishEye/Crucible. To achieve this, we will be using the Kantega SSO app. Using this configuration, you will be able to:

* Control which users have FishEye/Crucible access from Azure AD.
* Automatically sign in to FishEye/Crucible when you have an active Azure AD session.
...
* A FishEye/Crucible instance. You can [try it for free](https://www.atlassian.com/software/crucible/download).
* Kantega SSO app for FishEye/Crucible from Atlassian Marketplace. You can [try it for free](https://marketplace.atlassian.com/apps/1215263/k-sso-saml-kerberos-openid-connect-oidc-oauth-for-fecru?hosting=server&tab=overview).

## Scenario description

In this tutorial, you will configure and test single sign-on with Azure AD in a FishEye/Crucible test environment.
...
1. Select **Kantega SSO for FishEye/Crucible** from the results panel and then add the app. Wait a few seconds while the app is added to your tenant.
...
1. **[Configure Kantega SSO for FishEye/Crucible SSO](#configure-kantega-sso-for-FishEye/Crucible-sso)** - to configure the single sign-on settings on the application side.
	1. **[Create Kantega SSO for FishEye/Crucible test user](#create-kantega-sso-for-FishEye/Crucible-test-user)** - to have a counterpart of B.Simon in Kantega SSO for FishEye/Crucible linked to the Azure AD representation of the user.
...
5. Click **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
   ...
   > [!NOTE]
   > These values are not real. Update these values with the actual Identifier, Reply URL, and Sign-On URL. These values are received during the configuration of the FishEye/Crucible plugin.
...
* Click on **Test this application** in the Azure portal. This will redirect to Kantega SSO for FishEye/Crucible Sign-on URL, where you can initiate the login flow.

* Go to Kantega SSO for FishEye/Crucible Sign-on URL directly and initiate the login flow.

#### IDP initiated:

* Click on **Test this application** in the Azure portal, and you should be automatically signed in to the Kantega SSO for FishEye/Crucible, for which you set up the SSO.

You can also use Microsoft My Apps to test the application in any mode. When you click the Kantega SSO for FishEye/Crucible tile in the My Apps, you will be redirected to the application sign-on page for initiating the login flow if configured in SP mode. If configured in IDP mode, you should be automatically signed in to the Kantega SSO for FishEye/Crucible, for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

## Next steps

Once you configure Kantega SSO for FishEye/Crucible, you can enforce session control, which protects the exfiltration and infiltration of your organization's sensitive data in real-time. Session control extends from Conditional Access. [Learn how to enforce session control with Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-aad).
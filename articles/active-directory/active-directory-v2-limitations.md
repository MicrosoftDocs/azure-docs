...
For more information on library support for the v2.0 endpoint, refer to [this article](https://azure.microsoft.com/documentation/articles/active-directory-v2-libraries/).

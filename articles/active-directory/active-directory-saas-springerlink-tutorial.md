...
4. In the search box, type **Springer Link**.

	![Creating an Azure AD test user](./media/active-directory-saas-springerlink-tutorial/tutorial_springerlink_search.png)

5. In the results panel, select **Springer Link**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-springerlink-tutorial/tutorial_springerlink_addfromgallery.png)
...
3. **[Creating a Springer Link test user](#creating-a-springerlink-test-user)** - to have a counterpart of Britta Simon in Springer Link that is linked to the Azure AD representation of user.
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Configure Single Sign-On](./media/active-directory-saas-springerlink-tutorial/tutorial_springerlink_samlbase.png)

3. On the **Springer Link Domain and URLs** section, perform the following steps:

	![Configure Single Sign-On](./media/active-directory-saas-springerlink-tutorial/tutorial_springerlink_url.png)

	In the **Identifier** textbox, type a URL using the following pattern: `https://<companyname>.springer.com`

	> [!NOTE] 
	> This value is not real. Update this value with the actual Identifier. Contact [Springer Link Client support team](http://www.springer.com/gp/help/contact) to get this value.

4. On the **SAML Signing Certificate** section, click **Metadata XML** and then save the metadata file on your computer.

	![Configure Single Sign-On](./media/active-directory-saas-springerlink-tutorial/tutorial_springerlink_certificate.png) 

5. Click **Save** button.

	![Configure Single Sign-On](./media/active-directory-saas-springerlink-tutorial/tutorial_general_400.png)

6. To configure single sign-on on **Springer Link** side, you need to send the downloaded **Metadata XML** to [Springer Link support team](http://www.springer.com/gp/help/contact).
> [!TIP]
...
1. In the **Azure portal**, on the left navigation pane, click **Azure Active Directory** icon.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-springerlink-tutorial/create_aaduser_01.png) 

2. To display the list of users, go to **Users and groups** and click **All users**.
	
	![Creating an Azure AD test user](./media/active-directory-saas-springerlink-tutorial/create_aaduser_02.png) 

3. To open the **User** dialog, click **Add** on the top of the dialog.
 
	![Creating an Azure AD test user](./media/active-directory-saas-springerlink-tutorial/create_aaduser_03.png) 

4. On the **User** dialog page, perform the following steps:
 
	![Creating an Azure AD test user](./media/active-directory-saas-springerlink-tutorial/create_aaduser_04.png) 
...
### Creating a Springer Link test user
...
2. In the applications list, select **Springer Link**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-springerlink-tutorial/tutorial_springerlink_app.png) 

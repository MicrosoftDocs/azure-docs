...
Linked Elevate Application supports Just in time user provisioning and after authentication users will be created in the application automatically. You can find more details [here](active-directory-saas-linkedinelevate-provisioning-tutorial.md) on how to configure automatic user provisioning. On the admin settings page on the LinkedIn Elevate portal flip the switch **Automatically Assign licenses** to active to enable Just in time provisioning and this will also assign a license to the user.
...
* [Configure User Provisioning](active-directory-saas-linkedinelevate-provisioning-tutorial.md)

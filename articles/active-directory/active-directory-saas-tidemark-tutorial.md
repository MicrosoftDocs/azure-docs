...
* You can enable your users to automatically get signed-on to Tidemark single sign-on (SSO) with their Azure AD accounts
...
* A Tidemark single-sign on (SSO) enabled subscription
...
The objective of this section is to show you how to configure and test Azure AD SSO with Tidemark based on a test user called "Britta Simon".
...
To configure and test Azure AD SSO with Tidemark, you need to complete the following building blocks:
...
3. On the **Configure App Settings** dialog page, perform the following steps:
  ...
  * In the Sign On URL textbox, type the URL used by your users to sign-on to your Tidemark application using the following pattern: **“https://contoso.tidemark.com/login”** or **"https://contoso.tidemark.net/login"**.
...
>[!NOTE]
>If you need to create an user manually, you need to contact the Tidemark support team. 
> 

### Assign the Azure AD test user
The objective of this section is to enabling Britta Simon to use Azure SSO by granting her access to Tidemark.

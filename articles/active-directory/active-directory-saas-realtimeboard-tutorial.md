...
7. To configure single sign-on on **RealtimeBoard** side, please follow [RealtimeBoard instruction here](https://help.realtimeboard.com/support/solutions/articles/11000023465-saml-based-single-sign-on-) and use the data from your downloaded **Metadata XML**.

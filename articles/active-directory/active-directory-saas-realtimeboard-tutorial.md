...
3. On the **RealtimeBoard Domain and URLs** section, perform the following step:
	...
	In the **Identifier** textbox, type a URL as: `https://realtimeboard.com/sso/saml`
...
6. To configure single sign-on on **RealtimeBoard** side, you need to send the downloaded **Metadata XML** to [RealtimeBoard support team](mailto:support@realtimeboard.com). They set this setting to have the SAML SSO connection set properly on both sides.

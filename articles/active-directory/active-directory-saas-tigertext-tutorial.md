...
## Adding TigerText from the gallery
...
5. On the **Tell us about this user** dialog page, perform the following steps:
    ![Creating an Azure AD test user](./media/active-directory-saas-tigertext-tutorial/create_aaduser_05.png) 
...
### Creating an TigerText test user
In this section, you create a user called Britta Simon in TigerText. Please reach out to TigerText support team at 
[prosupport@tigertext.com](mailTo:prosupport@tigertext.com) to add the users in the TigerText platform.

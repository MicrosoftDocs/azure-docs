...
5. Under the **Admin Credentials** section, input the **Admin Username**, and **Admin Password** of your Samanages's account. Examples of these values are:
	...
	*   In the **Admin Password** field, populate the password corresponding to the admin username  specified previously.
...
13. Review the group attributes that are synchronized from Azure AD to Samanage in the **Attribute Mapping** section. The attributes selected as **Matching** properties are used to match the groups in Samanage for update operations. Select the **Save** button to commit any changes.
...
16. Define the users and/or groups that you would like to provision to Samanage by choosing the desired values in **Scope** in the **Settings** section.

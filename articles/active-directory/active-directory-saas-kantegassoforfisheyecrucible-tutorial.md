...
4. In the search box, type **Kantega SSO for FishEye/Crucible**.

	![Creating an Azure AD test user](./media/active-directory-saas-kantegassoforfisheyecrucible-tutorial/tutorial_kantegassoforfisheyecrucible_search.png)

5. In the results panel, select **Kantega SSO for FishEye/Crucible**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-kantegassoforfisheyecrucible-tutorial/tutorial_kantegassoforfisheyecrucible_addfromgallery.png)
...
9. Under System Settings section, click **Find new add-ons**. 
...
2. To display the list of users, go to **Users and groups** and click **All users**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-kantegassoforfisheyecrucible-tutorial/create_aaduser_02.png) 

...
* An EMEA country such as “France” or “Zambia” has their data hosted in one or of the Azure regions within Europe.  
* A North American country such as “United States” or “Canada” has their data hosted in one or more of the Azure regions within the US.
* An APAC country such as “Australia” or “New Zealand” has their data hosted in one or more of the Azure regions within Asia.

Data from South American and Antarctica regions is hosted in one or more Azure regions within the US. The country/region value is set as part of the Azure AD directory creation process and cannot be subsequently modified. If you need more details on your data storage location, file a ticket with [Azure support](https://azure.microsoft.com/support/options/).

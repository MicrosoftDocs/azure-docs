...
4. In the search box, type **LockPath Keylight**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_lockpathkeylight_search.png)

5. In the results panel, select **LockPath Keylight**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_lockpathkeylight_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Configure Single Sign-On](./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_lockpathkeylight_samlbase.png)

3. On the **LockPath Keylight Domain and URLs** section, If you wish to configure the application in **IDP** initiated mode:

	![Configure Single Sign-On](./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_lockpathkeylight_url.png)
...
4. On the **SAML Signing Certificate** section, click **Certificate(Raw)** and then save the Certificate file on your computer.
	...
	![Configure Single Sign-On](./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_lockpathkeylight_certificate.png) 

5. Click **Save** button.

	![Configure Single Sign-On](./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_general_400.png)
...
6. On the **LockPath Keylight Configuration** section, click **Configure LockPath Keylight** to open **Configure sign-on** window. Copy the **Sign-Out URL and SAML Single Sign-On Service URL** from the **Quick Reference section.**
	...
	![Configure Single Sign-On](./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_lockpathkeylight_configure.png) 

7. To enable SSO in LockPath Keylight, perform the following steps:
   
    1. Sign-on to your LockPath Keylight account as administrator.
    2. In the menu on the top, click **Person**, and select **Keylight Setup**.
   
    ![Configure Single Sign-On](./media/active-directory-saas-lockpathkeylight-tutorial/401.png) 

    3. In the treeview on the left, click **SAML**.
   
    ![Configure Single Sign-On](./media/active-directory-saas-lockpathkeylight-tutorial/402.png) 

    4. On the **SAML Settings** dialog, click **Edit**.
   
    ![Configure Single Sign-On](./media/active-directory-saas-lockpathkeylight-tutorial/404.png) 

8. On the **Edit SAML Settings** dialog page, perform the following steps:
   
    ![Configure Single Sign-On](./media/active-directory-saas-lockpathkeylight-tutorial/405.png) 
   
    1. Set **SAML authentication** to **Active**.
    2. Paste the **SAML SSO URL** value into the **Identity Provider Login URL** textbox.
    3. Paste the **Single Sign-Out Service URL** value into the **Identity Provider Logout URL** textbox.
    4. Click **Choose File** to select your downloaded LockPath Keylight certificate, and then click **Open** to upload the certificate.
...
1. In the **Azure portal**, on the left navigation pane, click **Azure Active Directory** icon.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-lockpathkeylight-tutorial/create_aaduser_01.png) 

2. To display the list of users, go to **Users and groups** and click **All users**.
	
	![Creating an Azure AD test user](./media/active-directory-saas-lockpathkeylight-tutorial/create_aaduser_02.png) 

3. To open the **User** dialog, click **Add** on the top of the dialog.
 
	![Creating an Azure AD test user](./media/active-directory-saas-lockpathkeylight-tutorial/create_aaduser_03.png) 

4. On the **User** dialog page, perform the following steps:
 
	![Creating an Azure AD test user](./media/active-directory-saas-lockpathkeylight-tutorial/create_aaduser_04.png) 
...
2. In the applications list, select **LockPath Keylight**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_lockpathkeylight_app.png) 
...
[1]: ./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_general_01.png
[2]: ./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_general_02.png
[3]: ./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_general_03.png
[4]: ./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_general_04.png

[100]: ./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_general_100.png

[200]: ./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_general_200.png
[201]: ./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_general_201.png
[202]: ./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_general_202.png
[203]: ./media/active-directory-saas-lockpathkeylight-tutorial/tutorial_general_203.png

...
11. In the **General Configuration** section, perform the following steps:
    ...
    b. Paste **SAML Single Sign-On Service URL** into the **IdP Login URL** textbox from Azure portal.
   
    c. Paste **Sign-Out URL** into the **IdP Logout URL** textbox from Azure portal.
   
    d. As **Logout Response and Request HTTP Type**, select **POST**.
   
    e. Open the text file from the downloaded certificate, copy the text and then paste it into the **Public Certificate** textbox.

...
**A**: [Apple announced deprecation](https://developer.apple.com/news/?id=11042019a) of push notifications for iOS devices leveraging its legacy binary interface. To continue to receive push notifications, we recommend that users update their Authenticator app to the latest version of the app. In the meantime, you can work around it by manually checking for notifications in the Authenticator app.

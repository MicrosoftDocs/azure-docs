...
|[Add your non-Microsoft accounts](user-help-auth-app-add-non-ms-account.md)|Describes how to add your personal Microsoft accounts to the Microsoft Authenticator app.|

...
4. In the search box, type **Reflektive**, select **Reflektive** from result panel then click **Add** button to add the application.
	...
	![Reflektive in the results list](./media/active-directory-saas-reflektive-tutorial/tutorial_reflektive_addfromgallery.png)
...
2. In the applications list, select **Reflektive**.
	...
	![The Reflektive link in the Applications list](./media/active-directory-saas-reflektive-tutorial/tutorial_reflektive_app.png)  

...
8.	When this is done, if you are a managed user, Windows will wrap up the setup process and take the user to the desktop through the auto-logon.
9.	If you are a federated user, you will be taken to the Windows logon screen and have to enter your credentials to log on.

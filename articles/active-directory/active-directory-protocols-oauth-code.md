<properties
	...
	description="How to use HTTP messages to authorize access to web applications and web APIs in your tenant using Azure AD and OAuth 2.0."
...
A sample request to the **tenant-specific** endpoint (you can also use the **common** endpoint) get a new access token using a refresh token looks like this:

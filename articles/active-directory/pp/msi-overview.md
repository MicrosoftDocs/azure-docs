...
| Azure App Service  | [Use Managed Service Identity with Azure App Service or Azure Functions](~/articles/app-service/app-service-managed-service-identity.md) |
| Azure Function     | [Use Managed Service Identity with Azure App Service or Azure Functions](~/articles/app-service/app-service-managed-service-identity.md) |

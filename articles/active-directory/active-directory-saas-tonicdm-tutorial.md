...
4. In the search box, type **TonicDM**, select **TonicDM** from result panel then click **Add** button to add the application.
	...
	![TonicDM in the results list](./media/active-directory-saas-tonicdm-tutorial/tutorial_tonicdm_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as	**SAML-based Sign-on** to enable single sign-on.
	...
	![Single sign-on dialog box](./media/active-directory-saas-tonicdm-tutorial/tutorial_tonicdm_samlbase.png)

3. On the **TonicDM Domain and URLs** section, perform the following steps:

	![TonicDM Domain and URLs single sign-on information](./media/active-directory-saas-tonicdm-tutorial/tutorial_tonicdm_url.png)
...
4. On the **SAML Signing Certificate** section, click **Certificate (Base64)** and then save the certificate file on your computer.
	...
	![The Certificate download link](./media/active-directory-saas-tonicdm-tutorial/tutorial_tonicdm_certificate.png) 

5. Click **Save** button.

	![Configure Single Sign-On Save button](./media/active-directory-saas-tonicdm-tutorial/tutorial_general_400.png)
...
6. On the **TonicDM Configuration** section, click **Configure TonicDM** to open **Configure sign-on** window. Copy the **Sign-Out URL, SAML Entity ID, and SAML Single Sign-On Service URL** from the **Quick Reference section.**
	...
	![TonicDM Configuration](./media/active-directory-saas-tonicdm-tutorial/tutorial_tonicdm_configure.png) 
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-tonicdm-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-tonicdm-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-tonicdm-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-tonicdm-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **TonicDM**.
	...
	![The TonicDM link in the Applications list](./media/active-directory-saas-tonicdm-tutorial/tutorial_tonicdm_app.png)  

...
[active-directory-aadconnectsync-understanding-declarative-provisioning.md](Azure AD Connect sync: Understanding Declarative Provisioning)| Describes all the knobs and options available in declarative provisioning.

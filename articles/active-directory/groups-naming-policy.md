...
> [!IMPORTANT]
> Using the Office 365 Groups Naming Policy preview requires Azure Active Directory Premium P1 licenses for each unique user that is a member of one or more Office 365 groups.

...
In this section, you enable Azure AD single sign-on in the classic portal and configure single sign-on in your Atlassian Cloud application.
...
3. On the **Configure App Settings** dialog page, perform the following steps:
    ...
    a. In the **Sign On URL** textbox, type the URL used by your users to sign-on to your Atlassian Cloud application using the following pattern: `https://<instancename>.predictix.com/sso/request`
...
In this section, you enable Britta Simon to use Azure single sign-on by granting her access to Atlassian Cloud.

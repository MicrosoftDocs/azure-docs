...
3. **[Creating a EMPCenter test user](#creating-a-empcenter-test-user)** - to have a counterpart of Britta Simon in EMPCenter that is linked to the Azure AD representation of user.
...
### Creating a EMPCenter test user

<properties pageTitle="Tutorial: Azure Active Directory integration with Slack | Microsoft Azure" description="Learn how to use Slack with Azure Active Directory to enable single sign-on, automated provisioning, and more!." services="active-directory" authors="MarkusVi" documentCenter="na" manager="stevenpo"/>

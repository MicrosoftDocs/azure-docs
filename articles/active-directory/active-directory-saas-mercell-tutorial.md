...
4. In the search box, type **Mercell**, select **Mercell** from result panel then click **Add** button to add the application.
	...
	![Mercell in the results list](./media/active-directory-saas-mercell-tutorial/tutorial_mercell_addfromgallery.png)
...
6. To configure single sign-on on **Mercell** side, you need to send the downloaded **Metadata URL** to [Mercell support team](webmaster@mercell.com). They set this setting to have the SAML SSO connection set properly on both sides.
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-mercell-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-mercell-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-mercell-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-mercell-tutorial/create_aaduser_04.png)
...
>[!Note]
>If you need to create a user manually, contact [Mercell support team](webmaster@mercell.com).
...
2. In the applications list, select **Mercell**.
	...
	![The Mercell link in the Applications list](./media/active-directory-saas-mercell-tutorial/tutorial_mercell_app.png)  

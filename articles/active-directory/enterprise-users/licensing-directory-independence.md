...
To add an Azure AD organization in the Azure portal, sign in to the [Azure portal] portal](https://portal.azure.com) with an account that is an Azure AD global administrator, and select **New**.

...
Clicking **Download** creates a CSV file of the most recent 120K records. If you need more flexibility, you can use the script solution. Clicking **Script** creates a script that includes all the filters you have set. By using the autogenerated script, you can retrieve up to 1 million most recent records (if you don’t use the top operator). By using the top operator, you can retrieve up to 500K records.

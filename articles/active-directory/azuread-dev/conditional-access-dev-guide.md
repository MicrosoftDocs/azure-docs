...
> [!NOTE]
> For the Microsoft identity platform version of this article, see [Developer guidance for Azure Active Directory Conditional Access](/azure/active-directory/develop/v2-conditional-access-dev-guide).

...
![Overview of sign-on to web application](./media/v1-authentication-scenarios/auth_basics_microsoft_identity_platform.svg)
...
![Simplified provisioning flow driven by consent](./media/v1-authentication-scenarios/simplified_provisioning_flow_consent_driven.svg)

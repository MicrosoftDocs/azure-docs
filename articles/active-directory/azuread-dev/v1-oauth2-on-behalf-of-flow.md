...
The following HTTP POST requests an access token for the https://graph.microsoft.com web API. The `client_id` identifies the service that requests the access token.
...
The following HTTP POST requests an access token for the https://graph.microsoft.com web API with a certificate. The `client_id` identifies the service that requests the access token.

...
##I'm a user who needs help with my password
...
| I'm   using a…         |                     |                   | And I want to…             |                            |                                          |
|------------------------|---------------------|-------------------|----------------------------|----------------------------|------------------------------------------|
| Work or School account | Get help logging in | Reset my password | Change my current password | Change my expired password | Get help from my company's administrator |
| Microsoft Account      | Get help logging in | Reset my password | Change my current password | Change my expired password |                                          |

##I'm an admin who wants to use password management in my organization
If you're an admin of an organization that uses Office 365 or Azure Active Directory to manage user identities, click the links below to learn how to get started using password reset in your organization. 

| And I'm   interested in…                         |                                                         |                                                             | And I want to                                                  |                                                 |                                                  |                                                               |                                                                |                                     |
|--------------------------------------------------|---------------------------------------------------------|-------------------------------------------------------------|----------------------------------------------------------------|-------------------------------------------------|--------------------------------------------------|---------------------------------------------------------------|----------------------------------------------------------------|-------------------------------------|
| Enabling or disabling password   reset           | Enable password reset for all users                     | Enable password reset for a specific group of users         | Enable on-premises password reset and change                   | Disable password reset                          | Test password reset                              |                                                               |                                                                |                                     |
| Customizing password reset                       | Change what authentication methods are supported        | Channge number of authentication methods required           | Set up custom security questions                               | Set up pre-canned localized security questions  | Change how many security questions are required  | Customize how a user gets in touch with an admin              | Allow users to unlock AD accounts without resetting a password | Enable password reset notifications |
| Getting my users registered   for password reset | What makes an account configured?                       | Populate user data manually using a portal                  | Synchronize user data from on-premises                         | Send an email instructing users how to register | Enabling enforced registration                   | Creating a custom   password maangement portal for your users |                                                                |                                     |
| Viewing password reset   activity                | See password reset activity                             | See password reset registration activity                    | Use the reporting API to see password activity                 |                                                 |                                                  |                                                               |                                                                |                                     |
| Managing my own password                         | Reset my admin password                                 | Change my current admin password                            | Change my expired admin password                               | Get help from another administrator             |                                                  |                                                               |                                                                |                                     |
| Managing my user's passwords                     | Reset a user's password from the O365 management portal | Reset a user's password from the Azure AD management portal | Reset a user's password from PowerShell                        |                                                 |                                                  |                                                               |                                                                |                                     |
| Setting password policy                          | Set password expiration time                            |                                                             | Set user's passwords to never expire                           |                                                 |                                                  |                                                               |                                                                |                                     |
| Troubleshooting a problem                        | Fix a problem with password reset                       | Fix a problem with password writeback                       | Fix a problem with password reset configuration                | Fix a problem with password reset reports       | Fix a problem with   password reset registration |                                                               |                                                                |                                     |
| Reading a FAQ about password   management        | Read a FAQ about password reset registration            | Read a FAQ about password reset                             | Read a FAQ about password reset reports                        | Read a FAQ about password writeback             |                                                  |                                                               |                                                                |                                     |
| Learning more about password   management        | Learn about what password writeback is                  | Learn about how password writeback works                    | Learn about what scenarios are supported by password writeback | Learn about how password writeback is secured   | Learn how the password reset portal works        | Learn about what data is   used by password reset             |                                                                |                                     |

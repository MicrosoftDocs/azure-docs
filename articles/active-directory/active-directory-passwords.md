...
# Azure AD Password Reset
  ...
  >[AZURE.IMPORTANT] Are you here because you want to reset your Azure or O365 password?  If so, please [skip to this section](#how-to-manage-your-own-password).
...
##ADMINS: Learn about why you should use Azure AD Password Reset
...
## Walkthrough: Get started with Azure AD Password Reset 

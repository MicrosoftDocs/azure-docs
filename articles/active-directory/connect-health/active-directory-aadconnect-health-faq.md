...
See the [Requirements section](active-directory-aadconnect-health-agent-install.md#rrequirements) for the list of firewall ports and other connectivity requirements.

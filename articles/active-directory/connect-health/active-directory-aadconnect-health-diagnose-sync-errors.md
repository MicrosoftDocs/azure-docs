...
The user with conflicting attribute in Azure AD should be cleaned before you can apply fix. Check out [how to delete the user permanantly in Azure AD](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-users-restore) before retrying the fix. The user will also be automatically deleted permanantly after 30 days in soft deleted state. 

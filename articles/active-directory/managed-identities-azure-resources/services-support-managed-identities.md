...
For more information, see [How to enable system-assigned managed identity for Azure Spring Cloud applications](../../spring-cloud/how-to-enable-system-assigned-managed-identity.md).

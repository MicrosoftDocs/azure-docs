...
- [Universal Authentication with SQL Database and Synapse SQL (SSMS support for MFA)](/azure/sql-database/sql-database-ssms-mfa-authentication)
- [Configure and manage Azure Active Directory authentication with SQL Database or Synapse SQL](/azure/sql-database/sql-database-aad-authentication-configure)

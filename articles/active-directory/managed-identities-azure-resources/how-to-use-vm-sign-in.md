...
See [Azure services that support Azure AD authentication](./managed-identities-status.md#azure-services-that-support-azure-ad-authentication) for a list of resources that support Azure AD and have been tested with managed identities for Azure resources, and their respective resource IDs.

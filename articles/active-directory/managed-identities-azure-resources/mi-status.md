...
| Azure Automation                | [Azure Automation account authentication overview](../../automation/automation-security-overview#managed-identities-preview.md)                                       |
...
| Azure Data Explorer             | [Configure managed identities for your Azure Data Explorer cluster](../../data-explorer/managed-identities.md)                                                                                                     |
...
| Azure Image Builder             | [Azure Image Builder overview](../../virtual-machines/image-builder-overview#permissions.md)                                                                                                    |
...
| Azure IoT Hub                   | [IoT Hub support for virtual networks with Private Link and Managed Identity](../../iot-hub/virtual-network-support.md#turn-on-managed-identity-for-iot-hub)                                                                               |
...
| Azure Stack Edge                | [Manage Azure Stack Edge secrets using Azure Key Vault](../../databox-online/azure-stack-edge-gpu-activation-key-vault#recover-managed-identity-access.md)
...
| Azure VM image builder          | [Configure Azure Image Builder Service permissions using Azure CLI](https://docs.microsoft.com/en-us/azure/virtual-machines/linux/image-builder-permissions-cli#using-managed-identity-for-azure-storage-access)|

...
4. In the search box, type **Expensify**.

	![Creating an Azure AD test user](./media/active-directory-saas-expensify-tutorial/tutorial_expensify_search.png)

5. In the results panel, select **Expensify**, and then click **Add** button to add the application.
...
2. In the applications list, select **Expensify**.
	...
	![Configure Single Sign-On](./media/active-directory-saas-expensify-tutorial/tutorial_expensify_app.png) 

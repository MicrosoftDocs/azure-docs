...
**ScreenSteps** will automatically provision users when they log in. They will be associated with the group you assigned to the **Single Sign-on Endpoint** in the previous step.

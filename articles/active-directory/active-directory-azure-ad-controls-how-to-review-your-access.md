...
Please note that denied access is not removed immediately, so if you wish to change your answer and approve, then reset the response, and pick a new response.  You can do this until the access review completes.

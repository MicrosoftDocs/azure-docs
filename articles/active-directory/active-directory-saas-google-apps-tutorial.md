...
4. In the search box, type **G Suite**, select **G Suite** from result panel then click **Add** button to add the application.
	...
	![G Suite in the results list](./media/active-directory-saas-googleapps-tutorial/tutorial_googleapps_addfromgallery.png)
...
3. **[Create a G Suite test user](#create-a-g-suite-test-user)** - to have a counterpart of Britta Simon in G Suite that is linked to the Azure AD representation of user.
...
3. On the **G Suite Domain and URLs** section, perform the following steps:

    a. In the **Sign-on URL** textbox

    * If you want to configure for the Gmail use the following pattern: `https://www.google.com/a/contoso.com/ServiceLogin?continue=https://mail.google.com`
    ...
    * If you want to configure for Google Cloud Platform use the following pattern: `https://www.google.com/a/contoso.com/ServiceLogin?continue=https://console.cloud.google.com`

    ![G Suite Domain and URLs single sign-on information](./media/active-directory-saas-googleapps-tutorial/tutorial_googleapps_urlcloud.png)
...
2. In the applications list, select **G Suite**.
    ...
    ![The G Suite link in the Applications list](./media/active-directory-saas-googleapps-tutorial/tutorial_googleapps_app.png)  

...
4. In the search box, type **Insider Track**, select **Insider Track** from result panel then click **Add** button to add the application.
	...
	![Insider Track in the results list](./media/active-directory-saas-insidertrack-tutorial/tutorial_insidertrack_addfromgallery.png)
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-insidertrack-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Insider Track**.
	...
	![The Insider Track link in the Applications list](./media/active-directory-saas-insidertrack-tutorial/tutorial_insidertrack_app.png)  

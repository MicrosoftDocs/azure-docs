---
title: 'Tutorial: Federate a single AD forest environment to the cloud | Microsoft Docs'
...
- A [custom domain](../../../articles/active-directory/fundamentals/add-custom-domain.md) that can be verified
...
2. On the Connect your directoris screen, click **Add Directory**.  Then select **Create new AD account** and enter the contoso\Administrator username and password and click **OK**.
3. Click **Next**.

...
>[!NOTE]
>Azure AD Connect versions 1.1.557.0, 1.1.558.0, 1.1.561.0 & 1.1.614.0 have an issue related to **Password Hash Synchronization**. Read the [Azure AD Connect release notes](https://docs.microsoft.com/azure/active-directory/connect/active-directory-aadconnect-version-history#116470) to learn more.

...
* [Setting up On-premises Conditional Access using Azure Active Directory Device Registration](../connect/active-directory-aadconnect-feature-device-writeback.md)

...
Ensure that your setup is [high availabile](active-directory-aadconnect-pass-through-authentication.md#ensure-that-your-azure-ad-pass-through-authentication-setup-is-highly-available) before you uninstall Azure AD Connect to avoid breaking user sign-in.

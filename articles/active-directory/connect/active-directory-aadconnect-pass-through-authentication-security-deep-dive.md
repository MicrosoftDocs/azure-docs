...
1. The Authentication Agent periodically pings Azure AD every few hours to check if it's time to renew its certificate. Typically the certificate is renewed 30 days prior to its expiration.

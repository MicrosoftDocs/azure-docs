...
5. Run: `.\csanalyzer.ps1 -xmltoimport export.xml` (Be sure to fully qualify export.xml if not running the script from the same folder as where you created the export.xml in Step 2)

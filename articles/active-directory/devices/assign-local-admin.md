...
> [!IMPORTANT]
> Windows logon with Azure AD supports evaluation of upto 20 groups for administrator privileges. We recommend having no more than 20 Azure AD groups on each device to ensure administrator privileges are correctly assigned. This limitation also applies to nested groups. 

...
> [!IMPORTANT]
> This capability is now generally available. The previous version that made use of device code flow was [deprecated on August 15, 2021](/azure/virtual-machines/linux/login-using-aad). To migrate from the old version to this version, see the section [Migrate from the previous (preview) version](#migrate-from-the-previous-preview-version).

...
> [!NOTE]
>* Deleting devices in your on-premises AD or Azure AD does not remove registration on the client. It will only prevent access to resources using device as an identity (e.g. Conditional Access). Read additional information on how to [remove registration on the client](faq.yml#hybrid-azure-ad-join-faq).
...
>* Read more on [how to unjoin on Azure AD](faq.yml#azure-ad-join-faq) 
...
>* Read more on [how to remove a registration on the client](faq.yml#azure-ad-register-faq)

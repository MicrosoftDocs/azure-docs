...
Hybrid Azure AD join is supported for FIPS-compliant TPMs with version 2.0 and not supported for TPMs with version 1.2 . If your devices have FIPS-compliant TPMs with version 1.2, you must disable them before proceeding with Hybrid Azure AD join. Microsoft does not provide any tools for disabling FIPS mode for TPMs as it is dependent on the TPM manufacturer. Please contact your hardware OEM for support.

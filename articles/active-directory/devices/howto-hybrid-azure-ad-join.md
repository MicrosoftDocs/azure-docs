...
1. In **SCP configuration**, for each forest where you want Azure AD Connect to configure the SCP, complete the following steps, and then select **Next**.
   ...
   ![Azure AD Connect SCP configuration managed domain](./media/howto-hybrid-join/azure-ad-connect-scp-configuration-managed.png)
...
1. On the **SCP** page, complete the following steps, and then select **Next**:
   ...
   ![Azure AD Connect SCP configuration federated domain](./media/howto-hybrid-join/azure-ad-connect-scp-configuration-federated.png)

...
To verify if the device is able to access the above Microsoft resources under the system account, you can use [Test Device Registration Connectivity](https://github.com/mzmaili/TestDeviceRegConnectivity) script.

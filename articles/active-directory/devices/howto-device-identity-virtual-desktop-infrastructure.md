...
For successful execution of some scenarios, it is important to have unique device names in the directory. It can be achieved by proper management of stale device, or guarantee device name uniqueness, by using some pattern in the device naming.

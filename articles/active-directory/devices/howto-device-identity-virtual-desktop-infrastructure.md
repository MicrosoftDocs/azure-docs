...
<sup>1</sup> **Windows current** devices represent Windows 10, Windows Server 2016, and Windows Server 2019.
       </sup> Note: You may not have latest features and product improvement. if you are on Server Version 1607. We did recommend to use Windows Server 2016 v1803 or above future versions.

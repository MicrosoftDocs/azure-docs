...
Verify the AADLoginForWindows extension has not been uninstalled after Azure AD join has completed.

Also, make sure the security policy “Network security: Allow PKU2U authentication requests to this computer to use online identities” is enabled on the server AND client side.

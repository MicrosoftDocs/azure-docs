...
This section performs various tests to help diagnose join failures. The section also includes the details of the previous (?). This information includes the error phase, the error code, the server request ID, server response http status, server response error message.

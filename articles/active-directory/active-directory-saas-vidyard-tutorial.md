...
4. In the search box, type **Vidyard**, select **Vidyard** from result panel then click **Add** button to add the application.
	...
	![Vidyard in the results list](./media/active-directory-saas-vidyard-tutorial/tutorial_vidyard_addfromgallery.png)
...
9. From the Vidyard dashboard, select **Group** > **Security**
	...
	![Vidyard Configuration](./media/active-directory-saas-vidyard-tutorial/configure1.png)
...
2. In the applications list, select **Vidyard**.
	...
	![The Vidyard link in the Applications list](./media/active-directory-saas-vidyard-tutorial/tutorial_vidyard_app.png)  

...
|50000|There is an issue with our sign-in service. Please [open a support ticket](active-directory-troubleshooting-support-howto.md) to resolve this issue.|
...
|50007|Partner encryption certificate was not found for this application. Please [open a support ticket](active-directory-troubleshooting-support-howto.md) with Microsoft to get this fixed|
|50008|SAML assertion are missing or misconfigured in the token. Please contact your federation provider.|
...
|50140|This error occurred due to "Keep me signed in" interrupt when the user was signing-in. Please [open a support ticket](active-directory-troubleshooting-support-howto.md) with Correlation ID, Request ID and Error code to get more details. |
|50143|Session mismatch - Session is invalid because user tenant does not match the domain hint due to different resource. Please [open a support ticket](active-directory-troubleshooting-support-howto.md) with Correlation ID, Request ID and Error code to get more details.|
...
|50172|External claims provider is not approved. Please contact the tenant admin|
|50173|Fresh auth token is needed. Please have the user re-sign using fresh credentials|
...
|51006|Windows Integrated authentication is needed. User logged in using session token that is missing wia claim. Please request the  user to re-login.|
...
|70005|The application returned an unsupported response type due to the following reasons:<ul><li>response type 'token' is not enabled for the application</li><li>response type 'id_token' requires the 'OpenID' scope -contains an unsupported OAuth parameter value in the encoded wctx</li></ul>Please contact the application owner|
...
|70012|A server error occurred while authenticating an MSA (consumer) user. Please retry. If it continues to fail, please [open a support ticket](active-directory-troubleshooting-support-howto.md) |
...
|80014|Authentication agent timed out. Please [open a support ticket](active-directory-troubleshooting-support-howto.md) with the error code, correlation ID and Datetime to get more details on this error|

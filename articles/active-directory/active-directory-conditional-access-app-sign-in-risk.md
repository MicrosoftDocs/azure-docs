...
- **A test account called Alain Charon** - If you don't know how to create a test account, see [Add cloud-based users](add-users-azure-active-directory.md#add-cloud-based-users).

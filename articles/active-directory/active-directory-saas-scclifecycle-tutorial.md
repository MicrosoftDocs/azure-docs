...
4. In the search box, type **SCC LifeCycle**.
	...
	![Creating an Azure AD test user](./media/active-directory-saas-scclifecycle-tutorial/tutorial_scclifecycle_search.png)

5. In the results panel, select **SCC LifeCycle**, and then click **Add** button to add the application.

	![Creating an Azure AD test user](./media/active-directory-saas-scclifecycle-tutorial/tutorial_scclifecycle_addfromgallery.png)

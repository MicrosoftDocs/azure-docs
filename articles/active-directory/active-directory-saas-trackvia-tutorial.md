...
4. In the search box, type **TrackVia**, select **TrackVia** from result panel then click **Add** button to add the application.

	![TrackVia in the results list](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_addfromgallery.png)
...
2. In the applications list, select **TrackVia**.

	![The TrackVia link in the Applications list](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_app.png)  

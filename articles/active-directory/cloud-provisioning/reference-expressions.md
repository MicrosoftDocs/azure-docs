...
The expression mapping allows you to customize attributes using a script-like expression.  This allows you to transfom the on-premises data into an new or different value.  For example, you may want to combine two attributes into a single attribute because this single attribute is used by one of your cloud applications.

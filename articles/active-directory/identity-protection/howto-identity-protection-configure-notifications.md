...
- **The recipients of this email** - By default, recipients include all Global Admins. Global Admins can also add other Global Admins, Security Admins, Security Readers as recipients.
   - Optionally you can **Add additional emails to receive alert notifications** this is a preview feature and those defined must have the appropriate permissions to view the linked reports in the Azure portal.

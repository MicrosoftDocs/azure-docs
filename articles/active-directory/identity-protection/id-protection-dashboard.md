...
---
# Microsoft Entra ID Protection New Dashboard Public Documentation (Preview)
...
1. Browse to Azure Active Directory > Protect & secure > Identity Protection > Dashboard (Preview)

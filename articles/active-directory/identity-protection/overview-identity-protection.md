...
- [Export risk detection data to your SIEM](../../sentinel/data-connectors-reference.md#azure-active-directory-identity-protectionazure-active-directory-identity-protection).
...
Information about integrating Identity Protection information with Azure Sentinel can be found in the article, [Connect data from Azure AD Identity Protection](../../sentinel/data-connectors-reference.md#azure-active-directory-identity-protectionazure-active-directory-identity-protection).

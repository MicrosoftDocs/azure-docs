---
title: Azure Active Directory Identity Protection risk detections reference | Microsoft Docs
description: Azure Active Directory Identity Protection risk detections reference.
...
This risk detection type indicates sign-ins from an anonymous IP address (for example, Tor browser, anonymizer VPNs).
...
This risk detection type indicates that the user’s valid credentials have been leaked.

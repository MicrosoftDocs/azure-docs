...
Organizations can choose to [connect Azure AD data to Azure Sentinel](../../sentinel/data-connectors-reference.md#azure-active-directory-identity-protectionazure-active-directory-identity-protection) as well for further processing.
...
- [Connect data from Azure Active Directory (Azure AD) Identity Protection](../../sentinel/data-connectors-reference.md#azure-active-directory-identity-protectionazure-active-directory-identity-protection)

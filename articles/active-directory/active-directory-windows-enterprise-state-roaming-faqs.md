...
>[AZURE.NOTE]  
>The ability to connect an Microsoft account to a domain account and have all the user’s data sync to the Microsoft account (i.e. Microsoft account roaming via the “connected Microsoft account and Active Directory” functionality) is removed from Windows 10 devices that are joined to a connected Active Directory/Azure AD environment.
...
Enterprise Sync is designed to store settings data in the Azure cloud. UE-V offers an on-premises roaming solution for Windows 10.
...
•	Enterprise Sync is the primary roaming agent on the device. UE-V is being used to supplement the “Win32 gap.” 

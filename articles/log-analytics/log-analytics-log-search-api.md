...
> [!NOTE]
> If your workspace has been upgraded to the [new Log Analytics query language](log-analytics-log-search-upgrade.md), then you should refer to the [documentation for the new version of the API](https://dev.loganalytics.io/).

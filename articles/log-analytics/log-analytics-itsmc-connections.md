...
Learn more: [Create ITSM work items for Log Analytics alerts](log-analytics-itsmc-overview.md#configure-alert-rules-in-azure-log-analytics), [Create ITSM work items from Log Analytics logs](log-analytics-itsmc-overview.md#log-analytics-itsmc-overview.md#Create-itsm-work-items-from-Log-analytics-log-records) and [Create ITSM work items from Azure alerts](log-analytics-itsmc-overview.md#create-itsm-work-items-from-azure-alerts).

...
From here, you can edit the search query to modify it for something specific. For details on creating log searches, see [Find data using log searches in Log Analytics](log-analytics-log-search.md).
...
## Next steps
* Use [Log Searches](log-analytics-log-search.md) in Log Analytics to view detailed VMware host data.

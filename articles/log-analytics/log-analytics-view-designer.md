...
## Concepts
Dashboards created with the View Designer contain the elements in the following table.
...
The View Designer has three panes.  The **Design** pane represents the custom dashboard.  When you add tiles and parts from the **Control** pane to the **Design** pane they are added to the dashboard.  The **Properties** pane will display the properties for the tile or selected part.
...
## Configure Views
A dashboard can include any number of views.  Select the **View** tab and then a view type to add a new view to the dashboard.  The **Properties** pane will display the properties for the selected view.  Configure the view properties according to the detailed information in the View reference and click **Apply** to save changes.

## Delete a dashboard view
You can remove a view from the dashboard by clicking the **X** button in the top right corner of the view.

## Rearrange dashboard views
Dashboards only have one row of views.  Rearrange existing views in a dashboard by clicking and dragging them to a new location.

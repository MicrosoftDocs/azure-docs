...
| `Set-OMSGatewayRelayProxy` |Address<br> Username<br> Password |Sets the address (and credential) of relay (upstream) proxy |1. Set a relay proxy and credential:<br> Set-OMSGatewayRelayProxy -Address http://www.myproxy.com:8080 -Username user1 -Password 123 <br><br> 2. Set a relay proxy that doesn't need authentication: Set-OMSGatewayRelayProxy -Address http://www.myproxy.com:8080 <br><br> 3. Clear the relay proxy setting: Set-OMSGatewayRelayProxy -Address "" |  

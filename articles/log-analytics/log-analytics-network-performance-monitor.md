...
* [￼ExpressRoute Monitor](log-analytics-network-performance-monitor-expressroute.md): You can monitor end-to-end connectivity and performance between your branch offices and Azure over ExpressRoute. 

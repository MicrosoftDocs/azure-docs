...
1. Install the [Microsoft Monitoring Agent (MMA)](log-analytics-agent-windows.md) if the domain controller is not already monitored by System Center 2016 - Operations Manager or Operations Manager 2012 R2.
...
## Next steps
* Use [Log searches in Log Analytics](log-analytics-log-search.md) to learn how to analyze detailed AD Health Check data and recommendations.

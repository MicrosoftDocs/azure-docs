...
Once you connect the OMS IT Service Management Connector solution with your ITSM service, the Log Analytics services starts gathering the data from the connected ITSM products/service.

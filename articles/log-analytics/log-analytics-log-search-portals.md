...
- Walk through a [lesson using the Advanced Analytics portal](../azure-monitor/log-query/get-started-analytics-portal.md) which provides the same experience as the Log Analytics page.

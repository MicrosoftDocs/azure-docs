...
When you enable the Upgrade Management solution, it initiates a number of processes on the Linux agent. But before the process ends, another process is started due to a known issue. 

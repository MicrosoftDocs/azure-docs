...
>[!NOTE]
>If you have already deployed Service Map, or are considering Service Map or [Azure Monitor for VMs](monitoring-vminsights-overview.md), there is a new connection metrics data set they collect and store in Log Analytics that provides comparable information to Wire Data.

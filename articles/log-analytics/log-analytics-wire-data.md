...
Wire data is consolidated network and performance data from computers with OMS agents, including Operations Manager, Windows-connected, and Linux-connected. Network data is combined with your other log data to help you correlate data.

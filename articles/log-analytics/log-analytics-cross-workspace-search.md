...
To reference another workspace in your query, use the [*workspace*](https://docs.microsoft.com/en-us/azure/log-analytics/query-language/workspace-expression) identifier, and for an app from Application Insights, use the [*app*](https://docs.microsoft.com/azure/log-analytics/query-language/app-expression) identifier.  
...
Review the [Log Analytics log search reference](https://docs.microsoft.com/en-us/azure/log-analytics/query-language/kusto) to view all of the query syntax options available in Log Analytics.    

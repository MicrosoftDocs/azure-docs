...
Next, you will either add an existing Log Analytics workspace or create a new one. Detailed instructions for using either method is at [Get started with Log Analytics](../azure/log-analytics.md). Once the Log Analytics workspace is configured, there are two ways to enroll your Surface Hub devices:
...
## Next steps
* Use [Log searches in Log Analytics](log-analytics-log-search.md) to view detailed Surface Hub data.

...
2. Use the following query to list recommendations that have failed for computers in your environment.
    ...
    >[!NOTE]
    > If your workspace has been upgraded to the [new Log Analytics query language](log-analytics-log-search.md), then the above query would change to the following.
    >
...
- [Search logs](log-analytics-log-search.md) to learn how to analyze detailed System Center Operations Manager Health Check data and recommendations.

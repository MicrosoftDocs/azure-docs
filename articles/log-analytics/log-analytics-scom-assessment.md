...
System Center Operations Manager Assessment works with Microsoft System Operations Manager 2012 R2 and 2012 SP1.
...
- Set the run-as account for System Center Operations Manager Assessment Profile. For more information, see [Operations Manager run-as accounts for OMS](#operations-manager-run-as-accounts-for-oms).
- Configure the System Center Operations Manager Assessment rule. For more information, see [Configure the System Center Operations Manager Assessment rule](#configure-the-system-center-operations-manager-assessment-rule)
...
3. Create the Run As Account, following through the Wizard, creating a Windows account. The account to use is the one identified and having all the prerequisites below:
    ...
    - Execute the [script](#sql-script-granting-permissions-to-the-run-as-account) to grant granular permissions to the account on SQL instance used by Operations Manager
...
*I added the assessment solution to my OMS workspace. But I don’t see the recommendations. Why?* After adding the solution, below steps to be followed to see the recommendations on OMS dashboard.

[Set the Run As account for System Center Operations Manager Assessment](#operations-manager-run-as-accounts-for-oms)
[Configure the System Center Operations Manager Assessment rule](#configure-the-system-center-operations-manager-assessment-rule)

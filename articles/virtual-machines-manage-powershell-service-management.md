<properties
   pageTitle="Common VM tasks using Service Management mode in Azure PowerShell"
   description="Gives you commands for common VM tasks using Service Management mode in Azure PowerShell"

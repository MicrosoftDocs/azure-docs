...
2. Email adbops@microsoft.com using the following template to get the return shipment label: 
    * If you have multiple orders, email to ensure individual pickup.
    ...
    ```
3. Print two copies of the reverse shipping label. Affix one label to the outside of the package. Use the second label to obtain a signature from the carrier team as acknowledgment.
4. If you encounter pickup issues:
...
5. Once the device is picked up and scanned by the carrier, the order status in the Azure Portal will update to “Picked Up” and a tracking ID will be displayed.

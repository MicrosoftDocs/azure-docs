...
Even if your data copy tool does not copy ACLs, in Windows the default ACLs on directories and files are transferred to Azure Files. The default ACLs aren't transferred in Linux.

...
- We recommend that you don't use both SMB and NFS simultaneously to copy the same data to same end destination on Azure. In these cases, the final outcome can't be determined.

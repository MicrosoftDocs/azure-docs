...
9. If you have scheduled an appointment for drop off and shared the drop off point of contact's details, then you should now be at **Ready to receive success** state of the Azure portal. The datacenter also should have confirmed that they have the authorization code available. Click **Schedule drop-off** to receive your new authorization code.

...
8. You should now be at **Ready to receive** success state of the Azure portal. This means that you have scheduled an appointment for drop off and shared the drop off point of contact's details. You will also need to confirm that the datacenter also has the authorization code available.
...
9. Customer or point of contact has dropped off the device at the DC and their ID and authorization cod have been verified.

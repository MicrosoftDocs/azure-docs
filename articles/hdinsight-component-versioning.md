...
Azure HDInsight now supports Hadoop 2.2 with HDInsight cluster version 3.0 and Hadoop 2.4 with HDInsight cluster version 3.1 and takes full advantage of these platform to provide a range of significant benefits to customers. These include, most notably:
...
- **Pig, Sqoop, Qozie, Ambari**: Component version upgrades, respectively, for HDInsight cluster versions 3.1 (HDP 2.1/Hadoop 2.4) and 3.0 ((HDP 2.0/Hadoop 2.2) that provide parity with HDInsight cluster version 2.1 (HDP 1.3/Hadoop 1.2). See the version tables below for specifics. Note that HBase, Mahout, Flume are not included.


**Deployment**	
Creation of HDInsight 3.0 and 3.1 clusters on Hadoop 2.2 is supported by the Azure Portal, the HDInsight SDK, and by Azure PowerShell. Note the HDInsight 2.1 clusters are created by default on Hadoop 1.2, so the users must specify HDInsight 3.0 or 3.1 cluster versions to create, respectively, Hadoop 2.2 and 2.4 clusters.
...
Azure HDInsight now supports Hadoop 2.2. It is based on the Hortonworks Data Platform version 2.1 and provides Hadoop services with the component versions itemized in the following table:

<table border="1">
<tr><th>Component</th><th>Version</th></tr>
<tr><td>Apache Hadoop</td><td>2.4.0</td></tr>
<tr><td>Tez</td><td>0.4</td></tr>
<tr><td>Apache Hive</td><td>0.13.0</td></tr>
<tr><td>Apache Pig</td><td>0.12.1</td></tr>
...
<tr><td>Ambari</td><td>1.5.1</td></tr>
</table>
...
## Supported versions
The following table lists the versions of HDInsight currently available, the corresponding Hortonworks Data Platform (HDP) versions that they use, and their release dates. When known, their deprecation dates will also be provided. Highly available clusters with two head nodes are deployed by default for HDInsight 2.1, 3.0 and 3.1 clusters. They are not available for HDInsight 1.6 clusters.

<table border="1">
<tr><th>HDInsight version</th><th>HDP version</a><th>High Availability</th></th><th>Release date</th></tr>
<tr><td>HDI 3.1</td><td>HDP 2.1</td><td>Yes</td><td>04/24/2014</td></tr>
<tr><td>HDI 3.0</td><td>HDP 2.0</td><td>Yes</td><td>02/11/2014</td></tr>
<tr><td>HDI 2.1</td><td>HDP 1.3</td><td>Yes</td><td>10/28/2013</td></tr>
<tr><td>HDI 1.6</td><td>HDP 1.1</td><td>No</td><td>10/28/2013</td></tr>
</table><br/>
...
* The ports used by the HDInsight service have been changed. The port numbers which were being used were within the Windows OS ephemeral port range. Ports are allocated automatically from a predefined ephemeral range for short-lived internet protocol-based communications. The new set of allowed HDP service port numbers are now outside of this range to avoid encountering conflicts that could arise with the ports used by services running on the headnode. The new port numbers should not cause any breaking changes. The numbers used now are as follows:
    ...
    { "Name": "dfs.http.address", "Value": "namenodehost:30070" },

    { "Name": "dfs.datanode.address", "Value": "0.0.0.0:30010" },

    { "Name": "dfs.datanode.http.address", "Value": "0.0.0.0:30075" },
	
    { "Name": "dfs.datanode.ipc.address", "Value": "0.0.0.0:30020" },
	
    { "Name": "dfs.secondary.http.address", "Value": "0.0.0.0:30090" },
	
    { "Name": "mapred.job.tracker.http.address", "Value": "jobtrackerhost:30030" },
	
    { "Name": "mapred.task.tracker.http.address", "Value": "0.0.0.0:30060" },
	
    { "Name": "mapreduce.history.server.http.address", "Value": "0.0.0.0:31111" },
	
    { "Name": "templeton.port", "Value": "30111" }
 


    HDP 2.0 and 2.1:

    { "Name": "dfs.namenode.http-address", "Value": "headnodehost:30070" },

    { "Name": "dfs.namenode.https-address", "Value": "headnodehost:30470" },
    ...
    { "Name": "dfs.namenode.secondary.http-address", "Value": "0.0.0.0:30090" },

    { "Name": "yarn.nodemanager.webapp.address", "Value" : "0.0.0.0:30060" },

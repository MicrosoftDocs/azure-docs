...
No. Network traffic inbound from the internet directly to private clouds isn't allowed by default.  However, you are able to expose Azure VMware Solution virtual machines to the Internet via the [Public IP](https://docs.microsoft.com/en-us/azure/azure-vmware/public-ip-usage) option in your Azure portal for you Azure VMware Solution private cloud.

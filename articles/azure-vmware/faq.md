...
#### Can Azure Load Balancer be used for Azure VMware Solution VMs?
No. Azure Load Balancer only supports Azure IaaS VMs. Azure Load Balancer doesn't support IP-based backend pools; only Azure VMs or virtual machine scale set (VMSS) objects in which Azure VMware Solution VMs aren't Azure objects.

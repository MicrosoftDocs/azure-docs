...
2.  In the **Certificate Import Wizard**, select **Local Machine** as the destination for the certificate, and click **Next**.
...
2.  Review the settings and click **Finish** to start importing the certificate.
...
2.  Click **Add** to add the vCenter to the servers list and click **Next**.
...
2.  On the **Specify Online Protection Data** page, select the VMs or VM folders that you want to back up, and then click **Next**. 
...
3.  On the **Select Recovery Type** page, choose whether to recover to the original instance, or a new location, and then click **Next**.
...
2.  To find the files you want to recover, in the **Path** pane, double-click the item in the **Recoverable item** column to open it, and select the file or folders you want to recover. To select multiple items, press the **Ctrl** key while selecting each item. Use the **Path** pane to search the list of files or folders appearing in the  **Recoverable Item** column.

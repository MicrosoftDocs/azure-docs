...
1. Select the execution you want to view. A tab opens with details about the execution and other tabs for the various types of output generated by the cmdlet.

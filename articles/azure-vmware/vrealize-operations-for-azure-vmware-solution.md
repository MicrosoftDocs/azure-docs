...
:::image type="content" source="media/Aria-operations-manager/Aria-operations-deployment-option-1.png" alt-text="Diagram showing the on-premises Aria Operations managing the Azure VMware Solution deployment." border="false":::

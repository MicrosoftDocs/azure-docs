---
title: VMware Solutions on Azure by CloudSimple 
...
**VMware Solution on Azure by CloudSimple** is a fully managed service that lets you run the VMware platform in Azure. This includes vSphere, vCenter, vSAN, NSX-T, and corresponding tools.
...
+ Solution architectures for customers to consume Azure services in an integrated fashion such as Azure AD, storage, application gateways, and others that take advantage of this unique "VMware cloud in a public cloud” architecture.
...
Here are the benefits of CloudSimple Service:

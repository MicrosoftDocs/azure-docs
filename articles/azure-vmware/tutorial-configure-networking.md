...
1. Validate network design is within Azure VMware Solution limits (https://docs.microsoft.com/en-us/azure/azure-resource-manager/management/azure-subscription-service-limits).

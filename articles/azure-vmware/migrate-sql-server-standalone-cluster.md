...
:::image type="content" source="media/sql-server-hybrid-benefit/migrated-sql-stand-alone-cluster.png" alt-text="Diagram showing the architecture of standalone SQL server for  Azure VMware Solution." border="false"::: 

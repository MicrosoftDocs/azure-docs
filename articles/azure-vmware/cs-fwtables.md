---
title: Firewall Tables - Concepts 
...
You can filter network traffic to and from Private Cloud resources using a firewall table. A firewall table is a collection of rules that are applied to a VLAN/subnet to allow or deny network traffic.  The firewall table allows you to control network traffic between a source network or IP address and a destination network or IP address based on the combination of rules defined in the table.

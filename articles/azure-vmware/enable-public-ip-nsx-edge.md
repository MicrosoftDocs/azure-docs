...
In this article, learn how to enable Public IP on the NSX-T Data Center Edge for your Azure VMware Solution.
...
7. This Public IP should be configured within 20 minutes and show the subnet.

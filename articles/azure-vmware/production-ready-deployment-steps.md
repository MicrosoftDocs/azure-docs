...
>[!NOTE]
>The subscription must be associated with a Microsoft Enterprise Agreement or a Cloud Solution Provider Azure plan. See [How to enable Azure VMware Solution resource](enable-azure-vmware-solution.md) article for the details.

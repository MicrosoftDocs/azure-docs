...
Define whether you want to use an *existing* OR *new* ExpressRoute virtual network gateway.  If you decide to use a *new" virtual network gateway, you'll create it after you create your private cloud. 

...
>[!TIP]
> Explore more about ANF datastores and how to [Attach Azure NetApp datastores to Azure VMware Solution hosts](./attach-azure-netapp-files-to-azure-vmware-solution-hosts?tabs=azure-portal) and [Attach Azure NetApp Files to Azure VMware Solution VMs](./azure/azure-vmware/netapp-files-with-azure-vmware-solution).

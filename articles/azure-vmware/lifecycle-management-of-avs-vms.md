...
Microsoft Azure native tools are typically used to monitor virtual machines (VMs) in the Azure environment. Yet they can also monitor your VMs on Azure VMware Solution and your on-premises VMs. In this overview, we'll look at the integrated monitoring architecture Azure offers, and how you can use its native tools to manage your Azure VMware Solution virtual machines (VMs) throughout their lifecycle.

...
You can use your cloudadmin credentials for connected services like HCX, vRealize Orchestrator, vRealize Operations Manager, or VMware Horizon. For more information about setting up an external identity source (LDAP), which can be found within **Operations > Run Commands**.
...
If you use your cloudadmin credentials for connected services, your connections stop working once you've updated the password. Stop these services before you rotate the password. Otherwise, you'll experience temporary locks on your accounts, as these services sill continuously call your old credentials. 

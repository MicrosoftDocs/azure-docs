...
The following diagram demonstrates a typical architecture of Azure NetApp Files backed NFS datastores attached to an Azure VMware Solution Gen 1 private cloud via ExpressRoute.
...
1. [Deploy Azure VMware Solution](./deploy-azure-vmware-solution.md) private cloud.
    ...
    * **Gen 2**: For [deploying a Azure Vmware Solution Gen 2](./native-create-azure-vmware-virtual-network-private-cloud.md) private cloud, use a subnet in the virtual network provisioned as part of the deployment process or use a subnet in a dedicated virtual network for Azure NetApp Files that is peered with the private cloud's virtual work.

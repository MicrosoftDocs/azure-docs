...
To enable nconnect for Azure NetApp Files datastores in your Azure VMware Solution, submit a support request with following information in the **Add additional details** section:

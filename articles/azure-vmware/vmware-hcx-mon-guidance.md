...
As MON is an enterprise capability of the NE feature, make sure you've [enabled the VMware HCX Enterprise](https://learn.microsoft.com/en-us/azure/azure-vmware/install-vmware-hcx#hcx-license-edition) through Azure Portal. 

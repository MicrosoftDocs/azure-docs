...
You'll first identify and collect the information need to [deploy the target environment](production-ready-deployment-steps.md).
...
2. VM workload backup using [Veritas NetBackup solution](https://vox.veritas.com/t5/Protection/Migrating-VMware-workloads-to-Azure-NetBackup-keeps-your/ba-p/882644).
...
:::image type="content" source="media/move-azure-vmware-solution-across-regions/version-2-expressroute-id.png" alt-text="Screenshot that shows the ExpressRoute ID and authorization key for the Azure VMware Solution private cloud.":::
...
1. [Create the DHCP server or DHCP relay service](/azure/azure-vmware/configure-nsx-network-components-azure-portal#create-a-dhcp-server-or-dhcp-relay-in-the-azure-portal). 

1. [Configure port mirroring](/azure/azure-vmware/configure-nsx-network-components-azure-portal#configure-port-mirroring-in-the-azure-portal).

1. [Configure DNS forwarder](/azure/azure-vmware/configure-nsx-network-components-azure-portal#configure-a-dns-forwarder-in-the-azure-portal).

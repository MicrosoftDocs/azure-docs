...
In this tutorial, you created the NSX-T network segments that are used for VMs in vCenter. You can now [create a content Library to deploy VMs in Azure VMware Solution](tutorial-deploy-vm-content-library.md) and the provision a VM on the network you created in this tutorial.

...
>[!IMPORTANT] For clouds created on or after July 1, 2021, the simplified view of NSX-T operations must be used to configure components on the default Tier-1 Gateway in your environment.

...
First, verify that the certificate used for LDAPS is valid. If you don't already have a certificate, follow the steps to [create a certificate for secure LDAP](configure-identity-source-vcenter.md#create-a-certificate-for-secure-ldap) before you continue.

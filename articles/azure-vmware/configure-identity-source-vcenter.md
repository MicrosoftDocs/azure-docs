...
- If you use FQDN, enable DNS resolution on your on-premises AD.
 ...
 - Enable DNS Forwarder from Azure portal Ref: [Configure DNS forwarder for Azure VMware Solution - Azure VMware Solution | Microsoft Docs](https://docs.microsoft.com/azure/azure-vmware/configure-identity-source-vcenter/)

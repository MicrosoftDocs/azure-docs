...
- Make sure that all routers include the ExpressRoute provider's service supports 4-byte Autonomous System Number (ASN). Azure VMware Solution uses 4-byte public ASNs to advertise routes.

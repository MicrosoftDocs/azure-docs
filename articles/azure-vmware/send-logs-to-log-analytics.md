...
To see how commonly used SQL queries could translate to Kusto, see [SQL to Kusto query translation - Azure Data Explorer | Microsoft Learn](../../../dataexplorer-docs/data-explorer/kusto/query/sqlcheatsheet.md)

...
- Verify you have a Dev/Test private cloud in a [region that Elastic SAN is available in](https://learn.microsoft.com/en-us/azure/storage/elastic-san/elastic-san-create?tabs=azure-portal#limitations).

...
Pure Cloud Block Store for Azure VMware Solution is Generally Available. [Learn more](https://learn.microsoft.com/azure/azure-vmware/configure-pure-cloud-block-store)

...
Azure VMware Solution AV48 node size is now available in the Japan East region. The AV48 node is built on Intal Xeon Gold 6442Y CPUs with a total of 48 physical cores, 1 TB of Memory and 19.2 TB of total storage.

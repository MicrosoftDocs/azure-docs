...
Microsoft Azure native services let you monitor, manage, and protect your virtual machines (VMs) in a hybrid environment (Azure, Azure VMware Solution, and on-premises). In this article, learn how to integrate Azure native services in your Azure VMware Solution private cloud and use the tools to manage your VMs throughout their lifecycle.

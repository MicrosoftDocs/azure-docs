...
> 
> To receive emails related to host replacement, you need to be added to any of the following Azure RBAC roles for subscription: 'ServiceAdmin', 'CoAdmin', 'Owner', 'Contributor'.

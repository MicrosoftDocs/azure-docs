...
- (Optional) Azure NetApp Files volume(s) are created and attached to the Azure VMware Solution private cloud for recovery or failover of protected VMs to Azure NetApp Files backed datastores.  
  ...
  - [Integrate Azure NetApp Files with Azure VMware Solution](./netapp-files-with-azure-vmware-solution.md)
...
- (Optional) Azure NetApp Files volume(s) are created and attached to the Azure VMware Solution private cloud for recovery or failover of protected VMs to Azure NetApp Files backed datastores.
  - [Integrate Azure NetApp Files with Azure VMware Solution](./netapp-files-with-azure-vmware-solution.md) 
  - [Disaster Recovery with Azure NetApp Files, JetStream DR and AVS (Azure VMware Solution)](./netapp-files-with-azure-vmware-solution.md)   

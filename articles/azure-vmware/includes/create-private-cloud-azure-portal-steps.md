...
<!-- Used in tutorial-deploy-azure-vmware-solution.md and tutorial-create-private-cloud.md -->
...
1. On the **Basics** tab, enter values for the fields. 
   ...
   >[!TIP]
   >You gathered this information during the [planning phase](../tutorial-plan-private-cloud-deployment.md) of this quick start.

...
Apply your settings and wait while the instance restarts. While migrations are applied and the instance comes back up, you may continue with the next step, **Configuring Blob Storage for GitHub Actions**.

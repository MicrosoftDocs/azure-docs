...
Azure VMware Solution supports a wide range of operating systems to be used in the guest virtual machines. Based on VMware vSphere, Azure VMware Solution customers can use operating systems currently supported by vSphere for their workloads.
...
In addition to the supported operating systems by VMware for vSphere, we worked with Red Hat, SUSE, and Canonical to extend the support model currently in place for Azure Virtual Machines to the workloads running on Azure VMware Solution. Check the following vendor sites for more information about the benefits of running their operating system on Azure.

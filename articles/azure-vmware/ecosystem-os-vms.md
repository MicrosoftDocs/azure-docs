...
Additionally to the supported operating systems by VMware on vSphere we have worked with Red Hat, SUSE and Canonical to extend the support model currently in place for Azure Virtual Machines to the workloads running on Azure VMware Solution, given the it is a first-party Azure service. You can check below the sites of these vendors for more information about the benefits of running their operating system in Azure.

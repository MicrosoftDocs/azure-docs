---
title: Troubleshoot Run Command in Azure VMware Solution
description: Learn how to troubleshoot and view the status of Run Command executions in Azure VMware Solution.
ms.topic: how-to
ms.service: azure-vmware
ms.date: 06/24/2026
---

# Troubleshoot Run Command
...
1. Select the execution you want to view. A tab opens with details about the execution and other tabs for the various types of output generated by the cmdlet.
   ...
   :::image type="content" source="media/run-command/run-execution-status-example.png" alt-text="Screenshot showing an example of a run execution." lightbox="media/run-command/run-execution-status-example.png":::
   ...
   - **Output** - Messages output by the cmdlet can include progress or the result of the operation. Not all cmdlets have output.
      ...
      :::image type="content" source="media/run-command/run-execution-status-example-output.png" alt-text="Screenshot showing the output of a run execution." lightbox="media/run-command/run-execution-status-example-output.png":::
   ...
   - **Error** - Error messages generated in the execution of the cmdlet in addition to the terminating error message on the details tab.
      ...
      :::image type="content" source="media/run-command/run-execution-status-example-error.png" alt-text="Screenshot showing the errors detected during the execution of a run command." lightbox="media/run-command/run-execution-status-example-error.png":::

   - **Warning** - Warning messages generated during the execution.

      :::image type="content" source="media/run-command/run-execution-status-example-warning.png" alt-text="Screenshot showing the warnings detected during the execution of a run command." lightbox="media/run-command/run-execution-status-example-warning.png":::

   - **Information** - Progress and diagnostic generated messages during the execution of a cmdlet.

      :::image type="content" source="media/run-command/run-execution-status-example-information.png" alt-text="Screenshot showing the overall real-time progress of the cmdlet as it runs." lightbox="media/run-command/run-execution-status-example-information.png":::
...
1. Select **Run command** > **Run execution status** and then select the job you want to cancel.
   ...
   :::image type="content" source="media/run-command/run-execution-cancel-delete-job-method-1.png" alt-text="Screenshot showing how to cancel and delete a run command." lightbox="media/run-command/run-execution-cancel-delete-job-method-1.png":::
...
2. Select **More** (...) for the job you want to cancel and delete.
   ...
   :::image type="content" source="media/run-command/run-execution-cancel-delete-job-method-2.png" alt-text="Screenshot showing how to cancel and delete a run command using the ellipsis." lightbox="media/run-command/run-execution-cancel-delete-job-method-2.png":::

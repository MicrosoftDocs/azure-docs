...
The CloudAdmin group provides the privileges in vCenter. You manage the group locally in vCenter. Another option is through the integration of vCenter LDAP single sign-on (SSO) with Azure Active Directory. You enable that integration after you deploy your private cloud. 

[the old out-of-date cloudsimple table was here]
...
## View privileges granted to the Azure VMware Solution CloudAdmin role on vCenter

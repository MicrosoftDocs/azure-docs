...
:::image type="content" source="media/attach-azure-net-app-files/architecture-netapp-files-nfs-datastores-attached.png" alt-text="Diagram shows the architecture of Azure NetApp Files backed NFS datastores attached to an Azure VMware Solution private cloud using ExpressRoute."lightbox="media/attach-azure-net-app-files/architecture-netapp-files-nfs-datastores-attached.png":::

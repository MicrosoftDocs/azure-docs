...
An NSX-T segment (logical switch) and a managed DHCP service are required to complete this tutorial.  For more information, see the [Configure and manage DHCP for Azure VMware Solution](configure-dhcp-azure-vmware-solution.md) article.  

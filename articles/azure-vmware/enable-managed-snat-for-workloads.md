...
- Have no control of the public IP address used.
- Cannot terminate inbound initiated Internet traffic.
...
4.	Select **Connect using SNAT** button and select **Save**. 
    You successfully enabled outbound Internet access for your Azure VMware Solution private cloud using our Managed SNAT service.  

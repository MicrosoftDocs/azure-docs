...
It's important to take proper measures to secure your Azure VMware Solution deployments. To achieve your security goals, use the information in this article as a high-level guide.
...
| :-- | :-- |
| Review and follow VMware Security Best Practices. | Always stay updated on Azure security practices and [VMware Security Best Practices](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-security-8-0/security-in-the-vsphere-environment/security-best-practices-and-resources.html). |
...
| Recommendation | Comments |
| :-- | :-- |
| Only allow trusted networks. | Only allow access to your environments over Azure ExpressRoute or other secured networks. Avoid exposing your management services like vCenter Server on the internet, for example. |

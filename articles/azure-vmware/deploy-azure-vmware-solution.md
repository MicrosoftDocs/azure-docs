...
1. Use a [virtual machine deployed](/azure/virtual-machines/windows/quick-create-portal#create-virtual-machine) within the Azure Virtual Network where the Azure VMware Solution ExpressRoute terminates (see [Step 2. Connect to Azure Virtual Network with ExpressRoute](#step-2-connect-to-azure-virtual-network-with-expressroute)).  

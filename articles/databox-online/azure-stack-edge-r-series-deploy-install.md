...
* You've completed all the steps in [Prepare to deploy Azure Stack Edge](azure-stack-edge-r-series-deploy-prep.md).
...
- Review the networking requirements for deploying Azure Stack Edge, and configure the datacenter network per the requirements. For more information, see [Azure Stack Edge networking requirements](azure-stack-edge-r-series-system-requirements.md#networking-port-requirements).
...
1. Identify the various ports on the back plane of your device.
    ...
    ![Back plane of a cabled device](./media/azure-stack-edge-r-series-deploy-install/backplane-cabled.png)

2. Locate the disk slots and the power button on the front of the device.

    ![Front plane of a device](./media/azure-stack-edge-r-series-deploy-install/device-front-plane-labeled-1.png)
...
> [Connect and set up Azure Stack Edge](./azure-stack-edge-r-series-placeholder.md)

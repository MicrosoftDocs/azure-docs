---
title: Azure Data Box Gateway & Azure Data Box Edge 1911 release notes| Microsoft Docs
description: Describes critical open issues and resolutions for the Azure Data Box Gateway and Azure Data Box Edge running 1911 release.
services: databox
author: priestlg
...
# Azure Data Box Edge and Azure Data Box Gateway 1911 release notes

The following release notes identify the critical open issues and the resolved issues for the 1911 release for Azure Data Box Edge and Azure Data Box Gateway.
...
There are no new features in the 1911 release, only bug fixes. The 1911 release provides the following improvements and bug fixes:

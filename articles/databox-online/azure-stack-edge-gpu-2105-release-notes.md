...
- **Connect to PowerShell interface via local UI over http** - Starting this release, you can use the local UI to open a remote PowerShell session into a device over *http*. For more information, see how to [Connect to the PowerShell interface](azure-stack-edge-gpu-connect-powershell-interface.md#connect-to-the-powershell-interface) of your device.

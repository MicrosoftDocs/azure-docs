---
title: Tutorial on prepare Azure portal to deploy Data Box Edge | Microsoft Docs
...
| 2. |**[Install Data Box Edge](data-box-edge-install.md)**|Unpack, rack, and cable the Data Box Edge physical device.  |
...
| 5. |**[Transform data with Data Box Edge](data-box-edge-deploy-transform-data.md)** |Configure Edge modules on the device to transform the data as it moves to Azure. |
...
> [Install a Data Box Edge](./data-box-edge-deploy-install-hyperv.md)

...
|**2.**|Azure Kubernetes service on Azure Stack Edge |When updating your device from 2209 to 2210, after the update is complete, the Kubernetes worker node may go down. |Upgrading to 2301 will resolve this issue. |

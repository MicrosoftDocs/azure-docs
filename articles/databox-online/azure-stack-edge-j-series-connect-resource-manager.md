...
1. Run PowerShell Version 5.0. You must have PowerShell version 5.0 or higher. PowerShell core is not supported. To check the version of PowerShell on your system, run the following cmdlet:

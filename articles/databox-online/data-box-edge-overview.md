...
- **Inference Azure Machine Learning** - With Data Box Edge, you can run Machine Learning (ML) models to get quick results that can be acted on before the data is sent to the cloud. The full data set is transferred to continue to retrain and improve your ML models. For more information on how to use the Azure ML hardware accelerated models on the Databox Edge device, see 
[Deploy Azure ML hardware accelerated models on Databox Edge](https://github.com/Azure-Samples/aml-hardware-accelerated-models/tree/master/deploy-to-databox-edge).

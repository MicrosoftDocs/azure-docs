...
2. In the right-pane, select **+ Add schedule**.
    ...
    ![Select Bandwidth](media/azure-stack-edge-r-series-manage-bandwidth-schedules/add-schedule-1.png)
...
3. In the **Add schedule**: 
   ...
   5. Select **Add**.
      ...
      ![Add schedule](media/azure-stack-edge-r-series-manage-bandwidth-schedules/add-schedule-2.png)
...
3. A schedule is created with the specified parameters. This schedule is then displayed in the list of bandwidth schedules in the portal.
    ...
    ![Updated list of bandwidth schedules](media/azure-stack-edge-r-series-manage-bandwidth-schedules/add-schedule-3.png)
...
2. From the list of bandwidth schedules, select and select a schedule that you want to modify.
    ![Select bandwidth schedule](media/azure-stack-edge-r-series-manage-bandwidth-schedules/modify-schedule-1.png)

3. Make the desired changes and save the changes.

    ![Modify user](media/azure-stack-edge-r-series-manage-bandwidth-schedules/modify-schedule-2.png)

4. After the schedule is modified, the list of schedules is updated to reflect the modified schedule.

    ![Modify user](media/azure-stack-edge-r-series-manage-bandwidth-schedules/modify-schedule-3.png)
...
2. From the list of bandwidth schedules, select a schedule that you want to delete. In the **Edit schedule**, select **Delete**. When prompted for confirmation, select **Yes**.
   ...
   ![Delete a user](media/azure-stack-edge-r-series-manage-bandwidth-schedules/delete-schedule-2.png)
...
- Learn how to [Manage shares](azure-stack-edge-r-series-manage-shares.md).

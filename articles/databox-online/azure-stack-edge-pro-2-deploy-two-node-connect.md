---
title: Tutorial to connect to two-node Azure Stack Edge Pro 2 device cluster
description: Learn how you can connect to your two-node Azure Stack Edge Pro 2 device by using the local web UI.
services: databox
author: alkohli
...
ms.date: 02/22/2022
ms.author: alkohli
# Customer intent: As an IT admin, I need to understand how to connect to two-node Azure Stack Edge Pro 2 so I can use it to transfer data to Azure. 
---
# Tutorial: Connect to two-node Azure Stack Edge Pro 2

This tutorial describes how you can connect to your two-node Azure Stack Edge Pro 2 device by using the local web UI.
...
* The back plane of the device looks as follows with Port 1 on the device connected to the laptop: 
...
1. Open a browser window and access the local web UI of the device at `https://192.168.100.10`. 
    ...
    This action may take a few minutes after you've turned on the device. You see an error or a warning indicating that there’s a problem with the website's security certificate. 
...
You're now at the **Overview** page of your device. 

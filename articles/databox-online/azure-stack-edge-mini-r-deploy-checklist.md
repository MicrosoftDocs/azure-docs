---
title: Predeployment checklist to deploy Azure Stack Edge Mini R device
description: This article describes the information that can be gathered before you deploy your Azure Stack Edge Mini R device.
services: databox
author: alkohli

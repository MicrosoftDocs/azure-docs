...
|**15.**|Certificates |Certificate validation takes several seconds and slows down local UI in many scenarios. |The following scenarios in the local UI take 7 seconds or more to load the certificate information.<ul><li>**Certificates** page: The page loads with certificate information but the **Status** column displays **Loading...** for each certificate for about 7 seconds.</li><li>**Get started** page: The **Security** tile takes 7 seconds or more to load the state.</li><li>**Overview** page - This takes 7 seconds or more to load the configuration information.</li></ul>  |

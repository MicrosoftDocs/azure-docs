...
For more information on allowed transactions and corresponding charges, see the [Pricing for Azure Key Vault](https://azure.microsoft.com/pricing/details/key-vault/).

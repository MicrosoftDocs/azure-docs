...
1. Gather the information required in the [Deployment checklist](azure-stack-edge-gpu-deploy-checklist.md). You should use the information that you saved from the previous device configuration. 

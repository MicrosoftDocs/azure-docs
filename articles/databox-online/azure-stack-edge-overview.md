---
title: Microsoft Azure Stack Edge Pro overview | Microsoft Docs
description: Describes Azure Stack Edge Pro, a storage solution that uses a physical device for network-based transfer into Azure.
services: databox
author: alkohli
...
|Supported protocols     | Support for standard SMB and NFS protocols for data ingestion. <br> For more information on supported versions, see [Azure Stack Edge Pro system requirements](azure-stack-edge-system-requirements.md).|

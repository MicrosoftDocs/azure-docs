...
Exception] [HttpError] [HTTP Failed] GET http://168.63.129.16/?comp=versions -- IOError timed out -- 6 attempts made`</li></ol></ol>|To troubleshoot the issue:<ol><li>[Collect guest logs on the VM, and include them in a Support package.](./azure-stack-edge-gpu-troubleshoot-virtual-machine-provisioning.md#collect-guest-logs-for-a-failed-vm).</li><li>[Contact Microsoft Support](azure-stack-edge-contact-microsoft-support.md)</li></ol>|

...
> [!IMPORTANT]
> - Update **2110** is the current update and corresponds to:
>   - Device software version - **2.2.XXXX.XXXX**
...
> - To apply 2110 update, your device must be running 2106. If you are not running the minimal supported version, you'll see this error: *Update package cannot be installed as its dependencies are not met*.
> - This update will apply two updates, first, the device software updates and then the Kubernetes updates.

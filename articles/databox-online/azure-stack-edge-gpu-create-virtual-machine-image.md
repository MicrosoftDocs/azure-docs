...
1. Create a VHD from the image and upload it to an Azure Storage account that you will use with your device. You can then create a VM image and create a VM.

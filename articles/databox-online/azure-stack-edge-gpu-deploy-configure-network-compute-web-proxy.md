...
1. In the **Add virtual network** blade, input the following information:
    ...
    1. Enter a **VLAN ID** as a unique number in 1-4094 range. The VLAN ID that you provide should be in your trunk configuration. For more information on how to configure your switch, refer to the instructions from your physical switch manufacturer.

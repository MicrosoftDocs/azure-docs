...
Small form-factor pluggable (SFP) transceivers in the following SPF+ products are supported.
...
The following copper SFP+ (10 Gbps) transceiver is strongly recommended. Compatible fiberoptic transceivers can be used but have not been tested. 

|SFP+ transceiver type | Supported products | Notes |
|----------------------|--------------------|-------|
|SFP+ Direct-Attach Copper (10GSFP+Cu)|* [FS SFP-10G-DAC](https://www.fs.com/c/fs-10g-sfp-dac-1115) (Available in industrial temperature -40ºC to +85ºC as custom order)<!--Not listed on page because customer order is required?--><br>* [10Gtek CAB-10GSFP-P0.5M](http://www.10gtek.com/10G-SFP+-182)<br>* [Cisco SFP-H10GB-CU1M](https://www.cisco.com/c/en/us/products/collateral/interfaces-modules/transceiver-modules/data_sheet_c78-455693.html) |Also known as SFP+ Twinax DAC cables<br>* This is the recommended option, as it is lowest-power and simplest.<br>* Not supported: autonegotiation, connecting an SFP device to an SFP+ device|

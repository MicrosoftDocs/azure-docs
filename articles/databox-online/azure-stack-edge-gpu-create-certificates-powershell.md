...
You can also use the self-signed certificates that are generated by your device. This article only covers how to create your own certificates using the Azure PowerShell cmdlets. 
...
- You have reviewed the [Certificate requirements for each type of certificate](azure-stack-edge-gpu-certificate-requirements).

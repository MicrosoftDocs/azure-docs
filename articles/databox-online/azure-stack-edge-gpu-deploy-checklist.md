...
|-----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| Device   management               | <li>Microsoft Azure   subscription</li><li>Azure Active Directory Graph API</li><li>Microsoft Azure Storage account</li>|<li>Enabled for Azure Stack Edge Pro/Data Box Gateway, contributor permissions</li><li>Ensure admin or user access</li><li>Need access credentials</li> |
...
| (Optional) MAC Address            | If MAC address needs to be added to the approved list, get the address of the connected port from local UI of the device. |                                                                                                                   |

...
| Network readiness                 | All mandatory and options settings you'll need are configured on the network where you'll deploy your devices. [Use the Azure Stack Network Readiness Checker](azure-stack-edge-deploy-check-network-readiness.md) to test all needed connections.|

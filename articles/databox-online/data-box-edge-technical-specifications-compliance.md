...
For technical specifications for all regional power cords supported by Azure Stack Edge, see [Azure Stack Edge power cord specifications by region](data-box-edge-technical-specifications-powercords-regional.md).
...
Your Data Box Edge device has 6 network interfaces, PORT1- PORT6.

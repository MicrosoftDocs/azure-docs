...
3. You are notified after the trigger is created. The list of triggers is updated to display the newly created trigger. Select the trigger.
...
2. In your IoT Hub resource, go to **IoT Edge device**.

3. Select the device and then, under **Device details**, select **Set Modules**.
...
4. Under **Add Modules**, do the following:
    ...
    c. In the **Container Create Options** box, enter the local mount points for the Edge modules that you copied in the preceding steps for the Edge share and Edge local share.
    > [!IMPORTANT]
    ...
    Also provide any environmental variables here for your module. Environmental variables provide optional information that will help define the environment in which your module will run.
...
7.	Under **Review deployment**, review all the settings, and then select **Submit** to submit the module for deployment.

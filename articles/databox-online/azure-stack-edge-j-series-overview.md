...
- **Device availability** - For a list of all the countries where the Azure Stack Edge Pro R device is available, go to **Azure Stack Edge Pro R** tab in the **Availability** section of [Azure Stack Edge Pro R device availability](https://azure.microsoft.com/pricing/details/azure-stack/edge/#azureStackEdgeProR).

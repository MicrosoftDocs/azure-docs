...
| 5G | <ul><li>To register, deploy, and manage Virtual Network Functions (VNF), your device must be connected.</li><li>Metrics collection (every 1-5 minutes) and VNF heartbeat monitoring to Azure private Multi-access Edge Compute (MEC) (every 10 minutes) also require a connection to Azure.</li></ul> |

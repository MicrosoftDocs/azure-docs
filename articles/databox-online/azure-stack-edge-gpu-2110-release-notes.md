...
- **Remote support** - This release has log collection improvements related to Azure Stack Edge update scenarios.
- **High-performance network virtual machines** - 
- **Certificates for Edge container registry and Kubernetes dashboard** - 

...
- The back plane has:
    ...
    - One network card corresponding to two high-speed ports and two built-in 10/1-GbE ports:
        ...
        - **Mellanox dual port 100 GbE ConnectX-6 Dx network adapter** - Port 3, Port 4. For a full list of supported cables, modules, and switches, see [Firmware compatible products](https://docs.nvidia.com/networking/display/connectx6dxfirmwarev22361010/firmware+compatible+products).

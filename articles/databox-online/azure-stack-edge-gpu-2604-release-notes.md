---
title: Azure Stack Edge 2604 release notes
description: Describes critical open issues and resolutions for the Azure Stack Edge running 2604 release.
services: databox
author: sipastak
...
# Azure Stack Edge 2604 release notes

[!INCLUDE [applies-to-GPU-and-pro-r-and-mini-r-skus](../../includes/azure-stack-edge-applies-to-gpu-pro-r-mini-r-sku.md)]

The following release notes identify critical open issues and resolved issues for the 2604 release for your Azure Stack Edge devices. Features and issues that correspond to a specific model of Azure Stack Edge are called out wherever applicable.
...
This article applies to the **Azure Stack Edge 2604** release, which maps to software version **3.3.2604.3097**.

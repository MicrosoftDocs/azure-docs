---
title: Predeployment checklist to deploy a two node Azure Stack Edge Pro 2 device cluster
description: This article describes the information that can be gathered before you deploy your Azure Stack Edge Pro 2 two-node device cluster.
services: databox
author: alkohli
...
ms.author: alkohli 
---
# Deployment checklist for your two-node Azure Stack Edge Pro 2  

This article describes the information that can be gathered ahead of the actual deployment of your Azure Stack Edge Pro 2 device as a two-node cluster. 

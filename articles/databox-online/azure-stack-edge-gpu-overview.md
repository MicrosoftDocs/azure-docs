...
[Deploy Azure ML hardware accelerated models on Azure Stack Edge Pro GPU](../machine-learning/v1/how-to-deploy-fpga-web-service.md#deploy-to-a-local-edge-server).

...
1. Provide the following information at the prompts:
    ...
    |Prompt| Selection|
    |--|--|
    |**Select an Azure Database Server**| Choose **Core (SQL)** to create a document database that you can query by using a SQL syntax. [Learn more about the Azure Cosmos DB for NoSQL](../cosmos-db/introduction.md). |

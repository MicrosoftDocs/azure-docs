...
# [Confluent (In-process trigger examples)](#tab/confluent/in-process)
...
# [Event Hubs (In-process trigger examples)](#tab/event-hubs/in-process)
...
# [Confluent (Isolated process trigger examples)](#tab/confluent/isolated-process)
...
# [Event Hubs (Isolated process trigger examples)](#tab/event-hubs/isolated-process)

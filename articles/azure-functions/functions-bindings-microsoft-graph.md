...
> [!IMPORTANT]
> The Microsoft Graph preview bindings are now deprecated. Please refer to the [Build Azure Functions with Microsoft Graph](../graph/tutorials/azure-functions.md) tutorial for details on how to use Microsoft Graph with Azure Functions.

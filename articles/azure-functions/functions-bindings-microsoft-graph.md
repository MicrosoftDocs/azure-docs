...
For information about how to set a function app to use the preview 2.0 version of the Functions runtime, see [Target the version 2.0 runtime](functions-versions.md#target-the-version-20-runtime).

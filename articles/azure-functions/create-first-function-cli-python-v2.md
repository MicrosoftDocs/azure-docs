...
description: Learn how to create a Python function using the V2 programming model from the command line, then publish the local project to serverless hosting in Azure Functions.
ms.date: 09/23/2022
ms.topic: quickstart
ms.devlang: python
...
There's also a [Visual Studio Code-based version](create-first-function-vs-code-python-v2.md) of this article.
...
In Azure Functions, a function project is a container for one or more individual functions that each responds to a specific trigger. All functions in a project share the same local and hosting configurations. In this section, you create a function project using the V2 programming model that contains a single function.

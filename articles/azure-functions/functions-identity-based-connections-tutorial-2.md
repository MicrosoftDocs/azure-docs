...
> [!NOTE]
> When using [Azure App Configuration](../../articles/azure-app-configuration/quickstart-azure-functions-csharp.md) to provide settings for Managed Identity connections, setting names should use a `:` separator in place of the `__` to ensure names are resolved correctly.
> 

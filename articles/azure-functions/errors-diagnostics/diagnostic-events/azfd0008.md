...
description: "Learn how to troublshoot the error 'AZFD0008: Failed to read from Blob storage secret repository because its access tier is set to archive.' in Azure Functions"
ms.topic: reference
ms.date: 12/01/2023

...
+ Move your `HttpClient` instantiation to a static instance defined outside of the function, such as in [this example](../../manage-connections.md#client-code-examples).

...
+ Supply an `HttpClient` to your functions using [dependency injection](../../functions-dotnet-dependency-injection.md). This is the recommended approach for fixing this violation.
...
For more information about connection management best practices, see [Manage connections in Azure Functions](../../manage-connections.md).

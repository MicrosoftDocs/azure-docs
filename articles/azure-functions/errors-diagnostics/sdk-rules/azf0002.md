...
+ Supply an `HttpClient` to your functions using [IHttpClientFactory](dotnet/api/system.net.http.ihttpclientfactory?view=dotnet-plat-ext-5.0) through [dependency injection](../../functions-dotnet-dependency-injection.md). This is the recommended approach for fixing this violation.

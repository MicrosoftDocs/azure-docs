...
- To minimize deployment downtime and to be able to roll back deployments, consider using deployment slots. For more information, see [Azure Functions deployment slots](functions-deployment-slots.md).

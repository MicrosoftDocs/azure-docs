...
You have created a function that runs based on a schedule. For more information timer triggers, see [Schedule code execution with Azure Functions](functions-bindings-timer.md).

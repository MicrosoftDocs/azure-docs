...
> [!NOTE]
> If when starting the Functions runtime, you encounter a "No job functions found" error, please [update your Azure Fucntions Core Tools installation](./../functions-core-tools-reference.md). Older versions of core tools do not support .NET isolated.

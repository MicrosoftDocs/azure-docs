...
5. Lastly, [enable compatibility mode](./quickstart-js-vscode.md#enable-compatibility-mode-1) by adding an app setting `FUNCTIONS_V2_COMPATIBILITY_MODE` with value of `true`.

...
|Details|Additional information about a particular event. |
|InstanceId|The instance ID of the orchestration instance or it in the entity ID if this is a durable entity.|
...
|ExecutionId|A execution ID is for the orchestrator function that got reset by `continue-as-new`. It could be useful for debugging orchestration execution.|

---
title: "Quickstart: Create your first TypeScript durable function"
...
# Quickstart: Create your first TypeScript durable function
...
2. Go to a folder to use for your project and choose **Select**.

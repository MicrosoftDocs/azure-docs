...
[!code-javascript[v3.x](~/azure-functions-durable-js-v3/samples-js/functions/sayHello.js?range=1-14)
...
[!code-javascript[v3.x](~/azure-functions-durable-js-v3/samples-js/functions/sayHello.js?range=37-41).

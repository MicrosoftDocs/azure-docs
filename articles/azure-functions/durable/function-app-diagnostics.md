...
1.	Go to your Function App resource. In the left menu, click “Diagnose and solve problems”. 

2.	Search for “Durable Functions” and click on the result.
...
3.	You are now inside the Durable Functions detector, and as the name suggests, it detects potential problems in your Durable Functions application. Go through the various insights in the detector to learn about the application’s health. Examples of what the detector will tell you include: Durable Functions version your app is running on, any errors or warnings, and performance issues. If there are issues, you will see suggestions on how to mitigate and resolve the issue.

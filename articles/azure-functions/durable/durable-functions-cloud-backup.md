...
[!code-javascript[v3.x](~/azure-functions-durable-js-v3/samples-js/functions/backupSiteContent.js?range=1-36)
...
[!code-javascript[v3.x](~/azure-functions-durable-js-v3/samples-js/functions/backupSiteContent.js?range=38-49)
...
[!code-javascript[v3.x](~/azure-functions-durable-js-v3/samples/functions/backupSiteContent.js?range=51-71)

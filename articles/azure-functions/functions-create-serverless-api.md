...
Repeat the steps to [Create a function app](./functions-get-started.md#create-a-function-app) to create a new function app in which you will create your proxy. This new app's URL serves as the frontend for our API, and the function app you were previously editing serves as a backend.

...
1. Blob storage input and output bindings support blob-only accounts. Triggers from Data Lake Storage or hierarchical namespace-enabled storage accounts are not officially supported.

...
>[!Important]When using the Consumption hosting plan, function app content, including function code and binding configuration files, are stored on Azure File storage on the main storage account. If you delete the main storage account, this content is deleted and cannot be recovered.

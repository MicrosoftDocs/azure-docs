...
> [!IMPORTANT]
> Redis triggers aren't currently supported for functions running in the [Consumption plan](consumption-plan.md) or [Flex Consumption plan](/azure/azure-functions/flex-consumption-plan).
>

...
| Durable Functions | [Supported](durable/durable-functions-overview.md) | [Supported](https://review.learn.microsoft.com/azure/azure-functions/durable/durable-functions-dotnet-isolated-overview) | 

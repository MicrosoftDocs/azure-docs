...
1. Open IntelliJ IDEA's **Welcome** dialog, select **New Project** to open a new Project wizard, select **Azure Functions**.
...
1. Navigate to `src/main/java/org/example/functions/HttpTriggerFunction.java` to see the code generated. Beside the line *24*, you will notice that there is a green **Run** button, click it and select **Run 'Functions-azur...'**, you will see that your function app is running locally with a few logs.
...
1. You can try the function by accessing the printed endpoint from browser, like `http://localhost:7071/api/HttpExample?name=Azure`.

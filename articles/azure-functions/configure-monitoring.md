...
+ **Use the correct table plan**:  [Table plans](../azure-monitor/logs/data-platform-logs.md#table-plans) help you manage data costs by controlling how often you use the data in a table and the kind of analysis you need to perform. To reduce costs, you can choose the `Basic` plan, which does lack some features available in the `Analytics` plan.

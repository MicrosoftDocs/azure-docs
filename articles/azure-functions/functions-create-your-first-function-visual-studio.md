...
1. For the **Additional information** settings, use the values in the following table:
    ...
    | ------------ |  ------- |----------------------------------------- |
    | **Functions worker** | **.NET 6** or **.NET 6 (isolated)** | When you chose **.NET 6**, you create a project that runs in-process with version 4.x of the Azure Functions runtime. When you choose **.NET 6 (isolated)**, you create a project that runs in a separate worker process. Azure Functions 1.x supports the .NET Framework. For more information, see [Azure Functions runtime versions overview](./functions-versions.md).   |

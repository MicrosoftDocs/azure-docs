...
* [ASP.NET and web development tools](https://marketplace.visualstudio.com/items?itemName=JacquesEloff.MicrosoftASPNETandWebTools-9689)

* [Azure development tools](https://azure.microsoft.com/en-us/tools/)

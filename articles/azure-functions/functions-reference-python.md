...
> [!IMPORTANT]  
> Python 3.13 is currently supported on the Flex Consumption, Premium, and Dedicated plans. Python 3.13 support on the Consumption plan is pending. Visit [Python 3.13+ in Azure Functions](./python-313-changes.md) to learn more about changes and improvements introduced for Python 3.13+.

...
| 2.x  | _Active LTS_ and _Current_ Node.js versions with 8.11.1 and 10.6.0 recommended. Set the version by using the WEBSITE_NODE_DEFAULT_VERSION [app setting](functions-how-to-use-azure-function-app-settings.md#settings).|

...
At this point, you can add input and output bindings to your function by [modifying the function.json file](functions-develop-vs-code.md&tabs=nodejs#add-a-function-to-your-project) or by [adding a parameter to a C# class library function](functions-develop-vs-code.md&tabs=csharp#add-a-function-to-your-project).

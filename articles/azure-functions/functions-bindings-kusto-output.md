...
This document explains the usage of the output bindings that are supported on  Azure functions for Kusto. Output bindings are used to ingest data to Kusto.

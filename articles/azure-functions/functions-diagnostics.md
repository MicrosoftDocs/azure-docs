...
## Find the line of code causing exceptions or errors

For functions that are not compiled like C# script functions, you can use **Function Execution** and **Errors under Function App Down or Reporting Errors** to narrow down on the line of code causing exceptions or errors. This can be a useful tool for getting to the root cause and fixing issues.

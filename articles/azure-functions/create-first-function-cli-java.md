...
:::code language="java" source="~/functions-quickstart-java/create-first-function-cli-java/fabrikam-functions/src/main/java/com/fabrikam/Function.java":::
...
:::code language="xml" source="~/functions-quickstart-java/create-first-function-cli-java/fabrikam-functions/pom.xml" range="54-94":::

...
To learn more about storage account types, see [Introducing the Azure Storage Services](.azure/storage/storage-introduction#introducing-the-azure-storage-services).

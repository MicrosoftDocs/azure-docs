...
1. Provide the following information at the prompts:
    ...
    |**Select a version of Java**| Choose `Java 21`, `Java 17`, `Java 11` or `Java 8`, the Java version on which your functions run in Azure. Choose a Java version that you've verified locally. |

...
The [C# library](functions-dotnet-class-library.md) uses the SqlTrigger attribute to declare the SQL trigger on the function, which has the following properties:

...
2. Set environment variables for storage connection strings.
	...
	* AzureWebJobsDashboard
	...
	As an alternative, you can use the `connectionStrings` collection of the *app.config* file in the WebJobs.Script.Host project and the web.config file in the WebJobs.Script.WebHost projects.

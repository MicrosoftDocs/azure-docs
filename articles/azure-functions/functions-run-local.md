...
| **`--no-source-control`**<br/>**`-n`** | Prevents the default creation of a Git repository in version 1.x. In version 2.x/3.x, the git repository isn't created by default. |

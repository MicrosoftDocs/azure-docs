...
You can view a stream of log files being generated by your functions in a command-line session on your local computer. This is equivalent to the output seen when you debug your functions locally using Core Tools. 

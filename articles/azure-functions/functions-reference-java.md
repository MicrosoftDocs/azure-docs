...
`ExecutionContext`, defined in the `azure-functions-java-library`, contains helper methods to communicate with the functions runtime. For more information, see the [ExecutionContext referece article](/java/api/com.microsoft.azure.functions.executioncontext).

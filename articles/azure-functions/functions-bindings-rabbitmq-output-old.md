---
title: RabbitMQ output bindings for Azure Functions - Old
description: Learn to send RabbitMQ messages from Azure Functions. - Old
author: cachai2
...
# RabbitMQ output binding for Azure Functions overview - Old

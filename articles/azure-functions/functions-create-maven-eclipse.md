...
-  [Java Developer Kit](https://learn.microsoft.com/en-us/java/openjdk/download#openjdk-17), version 8, 11, 17 or 21. (Java 21 is currently supported in preview only on Linux)

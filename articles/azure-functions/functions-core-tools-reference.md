...
| **`--target-framework`** | This is an optional parameter,  it is valid only when the `--worker-runtime` sets to `dotnet-isolated`. It sets the target framework for dotNet runtime. Supported values are: `net6.0`, `net7.0`, `net48`|
|

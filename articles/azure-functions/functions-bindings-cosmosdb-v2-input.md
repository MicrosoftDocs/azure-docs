...
:::code language="csharp" source="~/azure-functions-dotnet-worker/samples/Extensions/CosmosDB/CosmosInputBindingFunction.cs" id="docsnippet_qtrigger_with_cosmosdb_inputbinding" :::

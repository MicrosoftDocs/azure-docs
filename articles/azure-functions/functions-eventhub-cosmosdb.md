...
If you used Cloud Shell to create your resources, you'll need to recreate some environment variables on your local machine. Run the following commands, replacing the `<value>` placeholders with the same values you used previously.

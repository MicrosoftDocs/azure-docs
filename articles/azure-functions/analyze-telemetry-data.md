...
In addition to telemetry data collected by Application Insights, you can also get data about how the function app is running from [Azure Monitor Metrics](../azure-monitor/platform/data-platform-metrics.md). Along with the usual metrics available to any App Service app, there are two metrics specific to Functions that are of interest:

...
> [!NOTE]
> When a function app that runs on the [Consumption plan](functions-scale.md#consumption-plan) or the [Premium plan](functions-scale.md#premium-plan) is scaled, a new range of outbound IP addresses may be assigned. When running on either of these plan, you may need to add the entire data center to an allow list.

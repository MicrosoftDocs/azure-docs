...
3. Select **Platform features > Properties**.
4. The inbound IP address appears under **Virtual IP address**.
...
To find the available IP addresses available to a function app:

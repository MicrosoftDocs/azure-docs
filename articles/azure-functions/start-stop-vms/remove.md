...
> [!NOTE]
> You may need to manually remove the managed identity associated with the removed Start Stop V2 Function App. You can find this by going to your subscription, then clicking Access Control (IAM). From there you can filter by Type: "App Services or Function Apps". If you notice a managed identity that was left over from your removed Start Stop V2 installation, then please remove it. Leaving the managed identity could interfere with future installations. 
> 
## Next steps

...
> [!NOTE]  
> When using Key Vault, the Vault URI should be the full value displayed in the Key Vault overview tab, including `https://`.
>
> You can also configure the Key Vault with a [user-managed identity or app regestration](https://github.com/Azure/Azure-Functions/issues/2048).

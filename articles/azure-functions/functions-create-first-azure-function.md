...
## Create a new function from the portal quickstart

1. Go to the [Azure Functions portal](https://functions.azure.com/signin) and sign in with your Azure account. 
 
2. Type a unique **Name** for your new function app or accept the autogenerated one, select your preferred **Region**, then click **Create + get started**. Note that a valid name can contain only letters, numbers, and hyphens. Underscore (**_**) is not an allowed character.

...
By definition, Azure Functions executions are stateless. If you need to connect your code to services in a more stateful way, consider instead using [Durable Functions](durable/what-is-durable-task.md) or [Azure Logic Apps](../logic-apps/logic-apps-overview.md). 

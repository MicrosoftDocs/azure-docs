...
- **YAML file**: The YAML file describes the pipeline. The file might have a build steps section and a release section. The YAML file must be in the same repo as the app.
...
You can use the following sample to create a YAML file to build your .NET app:
...
You can use the following sample to create a YAML file to build your JavaScript app:
...
You can use the following sample to create a YAML file to build your Python app. Python is supported only for Linux Azure Functions.
...
You can use the following sample to create a YAML file to package your PowerShell app. PowerShell is supported only for Windows Azure Functions.
...
Use the `az functionapp devops-pipeline create` [command](/cli/azure/functionapp/devops-pipeline#az-functionapp-devops-pipeline-create) to create a build pipeline in Azure. The build pipeline is created to build and release any code changes in your repo. The command generates a new YAML file that defines the build and release pipeline and commits it to your repo. The prerequisites for this command depend on the location of your code.

- If your code is in GitHub:

    - You must have **write** permission to your subscription.

    - You must be the project administrator in Azure DevOps.

    - You must be able to create a GitHub Personal Access Token with sufficient permissions. [GitHub PAT Permission Requirements.](https://aka.ms/azure-devops-source-repos)

    - You must have permissions to commit to the master branch in your GitHub repository to commit the autogenerated YAML file.

- If your code is in Azure Repos:

    - You must have **write** permission to your subscription.

    - You must the project administrator in Azure DevOps.

...
> [!NOTE]
> For a complete walkthrough of this pattern, see [Tutorial: Durable text analysis with a mounted Azure Files share](../durable-task/durable-functions/tutorial-durable-text-analysis-azure-files.md).
...
- [Durable Functions overview](../durable-task/durable-functions/durable-functions-overview.md)

...
|**path** | **BlobPath** |The [container](https://docs.microsoft.com/en-us/azure/storage/blobs/storage-blobs-introduction#blob-storage-resources) to monitor.  May be a [blob name pattern](#trigger---blob-name-patterns). | 

...
There are various ways to install KEDA in any Kubernetes cluster including Helm.  Deployment options are documented on the [KEDA site](https://keda.sh/docs/latest/deploy/).
...
Steps to uninstall KEDA are documented [on the KEDA site](https://keda.sh/docs/latest/deploy/).

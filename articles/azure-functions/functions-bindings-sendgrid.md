...
> [!NOTE]
> Version 2.x does not create the topic or subscription configured in the `ServiceBusTrigger`. Version 2.x is based on [Microsoft.Azure.ServiceBus](https://www.nuget.org/packages/Microsoft.Azure.ServiceBus) and does not handle queue management.

...
|-----------------------------------------|------------|---|
| [Command prompt or terminal](functions-run-local.md) | [C# script (.csx)](functions-reference-csharp.md), [JavaScript](functions-reference-node.md) | [Azure Functions Core Tools] provides the core runtime and templates for creating functions, which enables local development. Version 2.x support development on Linux, MacOS, and Windows. All environments rely on Core Tools for the local Functions runtime.|
...
Each of these local development environments let's you create function apps and use predefined Functions templates to create new functions. Each uses the Core Tools so that you can test and debug your functions against the real Functions runtime on your own machine just as you would any other app. You can also publish you function app project from any of these environments to Azure.  

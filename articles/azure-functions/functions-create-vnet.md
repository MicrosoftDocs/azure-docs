...
5. Move to the networking tab and enter the following information:
...
6. Back in the Networking tab, set the Public IP to "None." This will deploy the VM with access to only the VNET.
...
5. My completed creating blade looked like the following.
...
6.	In the portal for the Function App from the previous step select **Platform features**, then select **Networking**
7.	Select **Click to configure** under VNet Integration

<img src="./media/functions-create-vnet/Networking-1.png" width="450">

8. In the VNET integration page, select **Add VNet (preview)**

<img src="./media/functions-create-vnet/Networking-2.png" width="600"> 
    
9.  Create a new subnet for your Function and App Service plan to use. Note that the subnet size will restrict the total number of VMs you can add to your app service plan. Your VNET will automatically route traffic between the subnets in your VNET, so it does not matter that your Function is in a different subnet from your VM. 
...
2. Create a Proxy by selecting  **Proxies** > **+**

<img src="./media/functions-create-vnet/New-Proxy.png" width="250">

3. Configure the Proxy name and route. I chose /plant as my route.
4. Fill in your wordpress site's IP from earlier and set the Backend URL to `http://{YOUR VM IP}/wp-content/themes/twentyseventeen/assets/images/header.jpg`

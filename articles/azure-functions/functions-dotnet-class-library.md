...
The purpose of this file is to provide information to the scale controller to use for [scaling decisions on the consumption plan](functions-scale.md#How-the-consumption-and-premium-plans-works). For this reason, the file only has trigger info, not input or output bindings.

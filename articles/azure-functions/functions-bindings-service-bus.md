...
|batchOptions.maxMessageCount|1000| The number of messages required to build up before the function is triggered. |
|batchOptions.operationTimeout|??| tbd |
|batchOptions.autoComplete|true| tbd |

...
|webProxy|n/a|The proxy to use for communication over web sockets. A proxy cannot be used for communication over TCP; if web sockets are notin use, specifying a proxy is an invalid option.|

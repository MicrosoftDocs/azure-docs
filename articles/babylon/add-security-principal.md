...
A security principal can be a user, Azure Active Directory group, service principal, or managed identity. Azure Babylon uses Azure's role-based access control (RBAC) to manage permissions for security principals. You use the Azure portal to add or remove security principals from [Babylon's pre-defined roles](./catalog-permissions.md). 
...
To add a security principal to the Data Curator data plane role in an Azure Babylon account:

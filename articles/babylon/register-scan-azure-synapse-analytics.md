...
This article outlines how to register Azure Synapse Analytics in Babylon and set up a scan.

## Supported Capabilities
Azure Synapse Analytics supports the following:
...
## Register an Azure Synapse Analytics account

...
**Set scan rule set**
Select a scan rule set to be used by your scan from the list of available<br />![Screenshot showing scan rule set]

**Review your scan**
Once you click Continue, you will view all the settings for your scan.<br />![Screenshot showing scan rule set]

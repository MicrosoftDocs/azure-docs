...
This tutorial shows how to create a web app on Microsoft Azure using Java, using either the Azure application gallery, or the Azure web app configuration UI. 
...
2. Click **New**, click **Compute**, click **Web Apps**, and then click **From Gallery**.
...
Within a few moments, your web app will be created. To view the web app, within the Azure Management Portal, in the **Web Apps** view, wait for the status to show as **Running** and then click the URL for the web app.
...
1. Log in to the Microsoft Azure Management Portal.
2. Click **New**, click **Compute**, click **Web Apps**, and then click **Quick Create**.
3. Specify the URL name.
4. Select a region. For example, **East US**.
5. Click **Complete**. Within a few moments, your web app will be created. To view the web app, within the Azure Management Portal, in the **Web Apps** view, wait for the status to show as **Running** and then click the URL for the web app.
6. Still within the Azure Management Portal, in the **Web Apps** view, click the name of your web app to open the 
dashboard.
7. Click **Configure**.
...
Within a few moments, your web app will become Java-based. To confirm it is Java-based, within the Azure Management Portal, in the **Web Apps** view, wait for the status to show as **Running** and then click the URL for the web app. Note that the page will provide text stating that the new web app is a Java-based web app.

...
- To use Qualys on a machine, the extension must be installed, and the machine must be able to communicate with the relevant network endpoint:
    - Europe datacenter: <div style="display: inline">https://qagpublic.qg3.apps.qualys.com</div>
    - US datacenter: <div style="display: inline">https://qagpublic.qg3.apps.qualys.com</div>

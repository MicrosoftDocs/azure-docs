...
The specific role required to deploy monitoring extensions depends on the extension you're deploying. Learn more about [monitoring extensions](monitoring-extensions.md).

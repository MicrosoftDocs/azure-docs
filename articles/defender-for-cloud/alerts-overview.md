...
Defender for Cloud assigns a severity to alerts, to help you prioritize how you attend to each alert. Severity is based on how confident Defender for Cloud is in:
- The finding/analytic used to issue the alert.
...
Defender for Cloud correlates alerts and contextual signals into incidents using a Fusion analytics technology.

- Fusion looks at different signals across resources, and combines security knowledge and AI to analyze alerts, discovering new attack patterns as they occur.
...
> [!TIP]
> In the [alerts reference](alerts-reference.md#alerts-fusion), review the list of security incident alerts that can be produced by fusion analytics.

---
title: Support for the Defender for Storage plan
description: Review permissions for enabling Defender for Storage and its features.
ms.topic: limits-and-quotas
ms.date: 08/01/2023
---
# Required permissions for enabling Defender for Storage and its features

This article describes the permissions you need to [enable Defender for Storage](/articles/azure-defender-storage-configure) and use its features.

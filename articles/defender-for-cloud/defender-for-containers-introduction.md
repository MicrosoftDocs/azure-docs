...
|--|--|--|--|--|--|--|
| azuredefender-collector-ds-* | kube-system | [DeamonSet](https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/) | The azuredefender-collector Pod contains a set of containers that focus on collecting inventory and security events from the Kubernetes environment. | Capabilities: <br>"SYS_ADMIN", <br>"SYS_RESOURCE", <br>"SYS_PTRACE" | limits: <br> <br> memory: "64Mi"<br> <br>   cpu: "60m" | No |

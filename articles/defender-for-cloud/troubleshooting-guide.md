...
Defender for Cloud uses the Log Analytics agent to [collect and store data](./extensions-log-analytics-agent.md). The information in this article represents Defender for Cloud functionality after transition to the Log Analytics agent.

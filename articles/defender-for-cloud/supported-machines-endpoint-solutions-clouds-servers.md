...
| - [Deployment of agents and extensions](extensions-overview.md)                                                                                  | GA             | GA                             | GA                             |
...
- Learn how [Defender for Cloud collects data using the Log Analytics Agent](extensions-log-analytics-agent.md).

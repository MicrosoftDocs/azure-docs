...
| Contains sensitive data <br/>Prerequisite: [Enable data-aware security for storage accounts in Defender for CSPM](data-security-posture-enable.md#enable-data-aware-security-posture-in-defender-cspm-for-azure-subscriptions), or [leverage Microsoft Purview Data Catalog to protect sensitive data](https://learn.microsoft.com/azure/defender-for-cloud/information-protection). | Indicates that a resource contains sensitive data. | Azure Storage Account, Azure Storage Account Container, AWS S3 bucket, Azure SQL Server, Azure SQL Database |

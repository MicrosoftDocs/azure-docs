...
| Contains sensitive data | Indicates that a resource contains sensitive data. <br/> Prerequisite: [Enable data-aware security posture](data-security-posture-enable.md). | Azure SQL Server, Azure Storage Account/Container, AWS S3 bucket |

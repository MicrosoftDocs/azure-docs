...
This article is the *fourth* article in the Defender for Servers planning guide series. Before you begin, review the earlier articles:
...
| **[Docker host hardening](harden-docker-hosts.md)** | Assesses containers hosted on Linux machines running Docker containers, and then ompares them with the Center for Internet Security (CIS) Docker Benchmark. | Not supported in Plan 1 | :::image type="icon" source="./media/icons/yes-icon.png" alt-text="Icon that shows it's supported in Plan 2."::: |
...
After you work through these planning steps, [review Azure Arc and agent/extension requirements](plan-defender-for-servers-agents.md).

...
You can learn more by watching this video from the Defender for Cloud in the Field video series about Microsoft Defender for Cloud's new AWS connector [New AWS connector](episode-one.md).

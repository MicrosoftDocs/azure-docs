...
To provide findings for the recommendation, Defender CSPM uses [agentless container scanning](concept-agentless-containers.md) to discover all container registries, repositories and images and correlates that inventory with the vulnerability assessment scan of running images in your Kubernetes clusters. The recommendation shows your running containers with the vulnerabilities associated with the images that are used by each container and provides vulnerability reports and remediation steps. 

...
You can review an integration, or all integrations, in [Azure Resource Graph (ARG)](../governance/resource-graph.md), an Azure service that gives you the ability to query across multiple subscriptions. On the Integrations page, select **Open in ARG** to explore the details in ARG.

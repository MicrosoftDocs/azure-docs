...
3. Activate Defender for Cloud’s automatic agent provisioning which [deploys the Log Analytics agent](extensions-log-analytics-agent.md#auto-provision-mma).

...
- **NOTE:** The Defender for Cloud exemption relies on Microsoft Cloud Security Benchmark initiative to evaluate and retrive resources compliance state on the Defender for cloud portal. If the MCSB is missing the portal will partially work and some resources may not appear.

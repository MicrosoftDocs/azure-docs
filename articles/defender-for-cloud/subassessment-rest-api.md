...
Azure container registry vulnerabilities sub assessments are published to ARG as part of the security resources. For more information about security subassessments see [here](/azure/governance/resource-graph/samples/samples-by-category?tabs=azure-cli#list-container-registry-vulnerability-assessment-results).

...
- **Azure Arc Agent**: Connects your GKE and EKS clusters to Azure, and onboards the Defender extension.
- **Defender extension**: Provides host-level runtime threat protection.  
...
Make sure to check that your clusters meet network requirements so that the Defender extension can connect with Defender for Cloud.

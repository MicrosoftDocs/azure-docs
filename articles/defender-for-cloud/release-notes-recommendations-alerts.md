...
January 4 | New recommendation | [Azure Cosmos DB should disable public network access](recommendations-reference.md#azure-cosmos-db-should-disable-public-network-accesss) | Microsoft Cloud Security Benchmark | 

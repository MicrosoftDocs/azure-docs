...
- [Data collection](extensions-overview.md): agent provisioning and data collection settings.
...
## Data collection and storage
Defender for Cloud uses the Log Analytics agent – this is the same agent used by the Azure Monitor service – to collect security data from your virtual machines. [Data collected](extensions-overview.md) from this agent will be stored in your Log Analytics workspace(s).

...
What permissions do I need for discovery? | Storage account: Subscription Owner<br/> **or**<br/> Microsoft.Storage/storageaccounts/ (read, write) **and** Microsoft.Authorization/roleAssignments/* (read, write, delete) **and** Microsoft.Security/pricings/* (read, write)<br/><br/> Amazon S3 buckets: AWS account permission to run Cloud Formation (to create a role).

...
What permissions do I need for discovery? | Storage account: Subscription Owner or Microsoft.Storage/storageaccounts/{read/write} and Microsoft.Authorization/RoleAssignment/*{write/delete/read} and Microsoft.Security/pricing/* (write/delete/read}<br/><br/> Amazon S3 buckets: AWS account permission to run Cloud Formation (to create a role).

...
Agentless scanning for VMs provides vulnerability assessment and software inventory, both powered by Defender vulnerability management, in Azure and Amazon AWS environments. Agentless scanning is available in both Defender CSPM P1 and [Defender for Servers P2](defender-for-servers-introduction.md).
...
|Pricing:|Requires either Defender CSPM P1 or [Microsoft Defender for Servers Plan 2](defender-for-servers-introduction.md#defender-for-servers-plans)|

...
Yes, you need to enable on the Servers plan on the subscription level and the workspace level. If you only enable the plan on the subscription level you will see the `Microsoft Defender for servers should be enabled on workspaces` recommendation, on the recommendations page. This recommendation will advise you to enable the servers plan on the workspace level as well.

If the Servers plan is not enabled on your workspace, you will not experience the full level of services offered by the Servers plan on your workspace, but you will still be billed as normal. 

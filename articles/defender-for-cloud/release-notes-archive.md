...
You can [deploy the Defender extension](./defender-for-containers-enable.md?pivots=defender-for-container-aks&tabs=aks-deploy-portal%2ck8s-deploy-asc%2ck8s-verify-asc%2ck8s-remove-arc%2caks-removeprofile-api#deploy-the-defender-extension) today on your AKS clusters.
...
- [Add and remove the Defender extension for AKS clusters using the CLI](#add-and-remove-the-defender-extension-for-aks-clusters-using-the-cli)
...
### Add and remove the Defender extension for AKS clusters using the CLI

The Defender extension (preview) is required for Defender for Containers to provide the runtime protections and collects signals from nodes. You can now use the Azure CLI to [add and remove the Defender extension](defender-for-containers-enable.md?tabs=k8s-deploy-cli%2Ck8s-deploy-asc%2Ck8s-verify-asc%2Ck8s-remove-arc%2Ck8s-remove-cli&pivots=defender-for-container-aks#use-azure-cli-to-deploy-the-defender-extension) for an AKS cluster.

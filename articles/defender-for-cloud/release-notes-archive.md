...
Learn more about how auto provisioning works in [Configure auto provisioning for agents and extensions](monitoring-extensions.md).
...
Learn more in [Auto provisioning agents and extensions from Azure Security Center](monitoring-extensions.md).

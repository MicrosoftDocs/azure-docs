...
| Supported destinations:                              | The AKS Defender profile doesn't support AKS clusters that don't have RBAC enabled.                                                                                     | [Any Cloud Native Computing Foundation (CNCF) certified Kubernetes clusters](defender-for-containers-introduction?tabs=defender-for-container-arch-aks#microsoft-defender-for-containers-plan-availability)             |

...
| Aspect                                               | Microsoft Defender DaemonSet agent                                                                                                                                                                                                                          | Azure Policy for Kubernetes clusters                                                                                                                                                                                                                                                                                                                                                                                                           |
|------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Release state:                                       | Preview<br>                                                                                                                                                                                                                                                 | <br> • Azure Policy add-on is generally available (GA)<br> • Azure Policy extension for Azure Arc is in preview.                                                                                                                                                                                                                                                                                                                               |
...
| Supported destinations:                              | :::image type="icon" source="./media/icons/yes-icon.png"::: AKS clusters<br>:::image type="icon" source="./media/icons/yes-icon.png"::: Azure Arc-enabled Kubernetes<br>:::image type="icon" source="./media/icons/yes-icon.png"::: AWS Kubernetes clusters | :::image type="icon" source="./media/icons/yes-icon.png"::: AKS clusters<br>:::image type="icon" source="./media/icons/yes-icon.png"::: Azure Arc-enabled Kubernetes<br>:::image type="icon" source="./media/icons/yes-icon.png"::: AWS Kubernetes clusters                                                                                                                                                                                    |
| Policy-based:                                        | :::image type="icon" source="./media/icons/yes-icon.png"::: Yes                                                                                                                                                                                             | :::image type="icon" source="./media/icons/yes-icon.png"::: Yes                                                                                                                                                                                                                                                                                                                                                                                |
| Clouds:                                              | :::image type="icon" source="./media/icons/yes-icon.png"::: Commercial clouds<br>:::image type="icon" source="./media/icons/no-icon.png"::: Azure Government, Azure China 21Vianet                                                                          | **Azure Policy add-on:**<br>:::image type="icon" source="./media/icons/yes-icon.png"::: Commercial clouds<br>:::image type="icon" source="./media/icons/yes-icon.png"::: Azure Government, Azure China 21Vianet**Azure Policy extension for Azure Arc:**<br>:::image type="icon" source="./media/icons/yes-icon.png"::: Commercial clouds<br>:::image type="icon" source="./media/icons/no-icon.png"::: Azure Government, Azure China 21Vianet |

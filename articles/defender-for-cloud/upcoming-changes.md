...
The Defender for SQL vulnerability assessment email report will still be available and existing eemail configurations won't change after the policy is deprecated.

...
|--|--|--|
| [Deprecation scope of adaptive recommendations](#deprecation-scope-of-adaptive-recommendations) | June 20, 2024 | August 2024 |
...
## Deprecation scope of adaptive recommendations
...
Adaptive Security Recommendations, known as Adaptive Application Controls and Adaptive Network Hardening, will also be discontinued. The current GA version based on the Log Analytics Agent (MMA) and the preview version based on the Azure Monitoring Agent (AMA) will also be deprecated in August 2024.

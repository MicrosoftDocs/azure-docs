...
| Required roles and permissions (subscription-level): |[Owner](/../role-based-access-control.md/built-in-roles.md)| [Owner](../role-based-access-control/built-in-roles.md#owner) |

...
This preview plan merges the existing capabilities of two Microsoft Defender for Cloud plans and provides new and improved features (without deprecating any of the functionality from those plans):

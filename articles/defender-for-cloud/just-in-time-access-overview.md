...
JIT Requires [Microsoft Defender for servers Plan 2](defender-for-servers-introduction.md#what-are-the-defender-for-server-plans) to be enabled on the subscription. 

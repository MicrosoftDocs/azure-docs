...
|Date |Update  |
|---------|---------|
 June 22 | [Public Preview: Private Endpoint support for Malware Scanning in Defender for Storage](#public-preview-private-endpoint-support-for-malware-scanning-in-defender-for-storage)
...
### Public Preview: Private Endpoint support for Malware Scanning in Defender for Storage 

June 22, 2023

Private Endpoint support for Malware Scanning in Defender for Storage is now available in Public Preview. This capability allows enabling Malware Scanning on storage accounts that are using private endpoints. No additional configuration is needed.
...
For storage accounts with private endpoints that already enabled Malware scanning, you will need to disable and enable the plan for this to work.

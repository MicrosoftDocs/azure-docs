...
The ServiceNow integration with Defender for Cloud is now generally available (GA). This integration enables customers to [connect ServiceNow to their Defender for Cloud environment](connect-servicenow.md). As part of this connection, customers [can create/view ServiceNow tickets](create-ticket-servicenow.md) (linked to recommendations) from Defender for Cloud. You can also create governance rules that automatically [assign ownership of specific recommendations or all recommendations with a selected severity level](create-governance-rule-servicenow.md).

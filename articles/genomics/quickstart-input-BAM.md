---
title: 'Quickstart: Submit a workflow using different input file formats, BAM file | Microsoft Docs'
...
# Quickstart: Submit a workflow through the Microsoft Genomics service when your input is a single BAM file

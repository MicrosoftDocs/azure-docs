...
For more information about the `PerformanceCounters` schema element, see the [Azure Diagnostics Schema](../azure-monitor/essentials/diagnostics-extension-schema-windows.md#performancecounters-element).
...
- [Azure Diagnostics Schema - Performance Counters](../azure-monitor/essentials/diagnostics-extension-schema-windows.md#performancecounters-element)
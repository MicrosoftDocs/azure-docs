...
- [How can I block/disable incoming traffic to the default URL of my cloud service](./cloud-services-connectivity-and-networking-faq.yml#how-can-i-blockdisable-incoming-traffic-to-the-default-url-of-my-cloud-service)
...
- [What are the features and capabilities that Azure basic IPS/IDS and DDOS provides](./cloud-services-configuration-and-management-faq.yml#what-are-the-features-and-capabilities-that-azure-basic-ipsids-and-ddos-provides)

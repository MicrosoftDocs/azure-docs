...
* The [Diagnostics Configuration Schema](../azure-monitor/essentials/diagnostics-extension-schema-windows.md) explains the various xml configurations options for the diagnostics extension.

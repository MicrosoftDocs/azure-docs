...
The Diagnostics configuration file defines values that are used to initialize diagnostic configuration settings when the diagnostics agent starts. See the [latest schema reference](../azure-monitor/essentials/diagnostics-extension-versions.md) for valid values and examples.

## Troubleshooting
If you have trouble, see [Troubleshooting Azure Diagnostics](../azure-monitor/essentials/diagnostics-extension-troubleshooting.md) for help with common problems.

## Next Steps
[See a list of related Azure virtual-machine diagnostic articles](../azure-monitor/essentials/diagnostics-extension-overview.md) to change the data you are collecting, troubleshoot problems or learn more about diagnostics in general.

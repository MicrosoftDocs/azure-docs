...
You can create a Virtual Network in Azure using the Azure portal or PowerShell. For this tutorial, we will use PowerShell. To create a Virtual Network using the Azure portal, see [Create Virtual Network](../virtual-network/manage-virtual-network.md#create-a-virtual-network).

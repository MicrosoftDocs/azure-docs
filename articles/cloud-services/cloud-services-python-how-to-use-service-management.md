...
To learn more about how to capture a Linux Virtual Machine in the classic deployment model, see [How to Capture a Linux Virtual Machine.](../virtual-machines/linux/classic/capture-image-classic.md).

To learn more about how to capture a Windows Virtual Machine in the classic deployment model, see [How to Capture a Windows Virtual Machine.](../virtual-machines/windows/classic/capture-image-classic.md).

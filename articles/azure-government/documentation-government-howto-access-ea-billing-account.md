...
1. Select **New user** > **Create new user** from the menu.  
  :::image type="content" source="./media/documentation-government-howto-access-ea-billing-account01.png" alt-text="Screenshot showing the New user option." lightbox="./media/documentation-government-howto-access-ea-billing-account01.png" :::
...
:::image type="content" source="./media/documentation-government-howto-access-ea-billing-account02.png" alt-text="Screenshot showing the Microsoft Azure Government environment." lightbox="./media/documentation-government-howto-access-ea-billing-account02.png" :::
...
1. Search for **Cost Management + Billing**  and select it.  
    :::image type="content" source="./media/documentation-government-howto-access-ea-billing-account03.png" alt-text="Screenshot showing search for Cost Management + Billing." lightbox="./media/documentation-government-howto-access-ea-billing-account03.png" :::
...
:::image type="content" source="./media/documentation-government-howto-access-ea-billing-account04.png" alt-text="Screenshot showing Billing scopes." lightbox="./media/documentation-government-howto-access-ea-billing-account04.png" :::

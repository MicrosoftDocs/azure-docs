...
- To accommodate proper network and workload isolation, deploy your web apps on the **Isolated SKU**. More information can be found [here](../app-service/overview-hosting-plans.md).

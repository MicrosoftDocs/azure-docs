...
- [Encrypt Disks with Virtual Machine Scale Sets](../virtual-machine-scale-sets/disk-encryption-powershell.md)
...
- For workloads requiring isolation from other customer workloads, isolated virtual machines can be used as the agent nodes in an AKS cluster. (https://docs.microsoft.com/en-us/azure/aks/concepts-security#compute-isolation.)

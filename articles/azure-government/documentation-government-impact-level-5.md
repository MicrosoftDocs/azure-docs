...
### [Azure File Sync](../storage/filesync/file-sync-planning.md)

Azure File Sync supports Impact Level 5 workloads in Azure Government with this configuration:

- Configure encryption at rest of content in Azure File Sync by [using customer-managed keys in Azure Key Vault](../storage/filesync/file-sync-planning.md#azure-file-share-encryption-at-rest).

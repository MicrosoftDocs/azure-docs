...
||Form Recognizer|See [Form Recognizer docs](https://docs.microsoft.com/azure/cognitive-services/form-recognizer/quickstarts/client-library#prerequisites)|\*.cognitiveservices.azure.us||

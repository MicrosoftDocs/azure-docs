 ...
 * A list of the Azure Services can be found on the [Azure Services Availability on CSP](../cloud-solution-provider/overview/azure-csp-available-services.md) page.

 ...
 * If you are interested in Office GCC for CSP which is transacted via the CSP for Commercial platform, you can find relevant information in the article titled [Sell Office 365 Government GCC for CSP subscritpions to qualified customers](https://docs.microsoft.com/en-us/partner-center/csp-gcc-overview).

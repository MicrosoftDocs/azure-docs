...
**The same controls for restricting insider access to your data are in place for both Azure and Azure Government. As described in the previous section, all Azure and Azure Government employees in the United States are subject to Microsoft background checks. Azure Government imposes extra personnel background screening requirements, including verification of US citizenship.**

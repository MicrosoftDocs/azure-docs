...
For more information on the encryption options in Azure see the<a href="https://azure.microsoft.com/documentation/articles/storage-security-guide/"> Storage Security Guide </a>.  
...
For more information on isolation in Microsoft Azure see the [Isolation section of the Azure Security Guide](/storage/azure-security-getting-started/#isolation).

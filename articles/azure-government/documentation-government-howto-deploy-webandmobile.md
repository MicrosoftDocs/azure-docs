...
To deploy an app and also have Visual Studio provision a new Azure Web App during the publish process, click "create new" and follow [these steps](../app-service-api/app-service-api-dotnet-get-started.md#createapiapp).

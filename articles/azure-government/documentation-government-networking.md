...
Refer to the [ExpressRoute partners and peering locations](/expressroute/expressroute-locations-providers.md) page for a detailed list of ExpressRoute for AzureGov peering locations.

...
> [!NOTE]
> [Microsoft Azure Storage Explorer] (../../vs-azure-tools-storage-explorer-blobs.md.md) currently doesn't support [Connecting to an Azure Subscription] (../../vs-azure-tools-storage-explorer-blobs.md.md#connect-to-an-azure-subscription) in Azure Government. Use other methods of [Connecting to a storage account] (../../vs-azure-tools-storage-explorer-blobs.md.md#connect-to-a-storage-account-or-service).
When [Attaching to an external storage account] (../../vs-azure-tools-storage-explorer-blobs.md.md#attach-to-an-external-storage-account), at **step 3**, select **Other (specify below)** as Storage endpoint domain and specify **core.usgovcloudapi.net** for Azure Government.
>
>

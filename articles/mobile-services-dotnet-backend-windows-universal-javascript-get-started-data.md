...
<ol start="8"><li><p>In Solution Explorer in the Windows Store app project, expand the **services**, **mobile services**, **&lt;your_service&gt;** folders , open the service.js script file, and notice the new global variable, which looks like the following example:</p> 
...
<p>The same new code file is added to the Windows Phone Store app project. </p></li>
</ol>

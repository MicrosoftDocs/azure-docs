...
1. [Configure the Azure Monitor logs activity solution](../azure-monitor/platform/collect-activity-logs.md#configuration) for your workspace.

1. [View the activity logs](../azure-monitor/platform/collect-activity-logs.md#using-the-solution). A quick way to navigate to the Azure Monitor logs activity Overview page is to click the **Log Analytics** option.

...
1. [Configure the Activity Log Analytics solution](../azure-monitor/platform/activity-log.md#activity-logs-analytics-monitoring-solution) for your workspace.

1. [View the activity logs](../azure-monitor/platform/activity-log.md#activity-logs-analytics-monitoring-solution). A quick way to navigate to the Activity Log Analytics solution Overview page is to click the **Logs** option.

...
1. [Configure the Activity Log Analytics solution](../azure-monitor/platform/activity-log-collect.md#activity-logs-analytics-solution) for your workspace.

1. [View the activity logs](../azure-monitor/platform/activity-log-collection.md#activity-logs-analytics-solution). A quick way to navigate to the Activity Log Analytics solution Overview page is to click the **Log Analytics** option.

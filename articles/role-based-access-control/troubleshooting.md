...
> [!NOTE]
> The role assignments limit for a subscription is currently being increased from **2000** to **4000** over the next several months. Subscriptions that are near the limit will be prioritized first. Additional subscriptions will be increased over time.

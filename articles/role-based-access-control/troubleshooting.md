...
> [!NOTE]
> The role assignments limit for a subscription is currently being increased from **2000** to **4000** over the next several months. The new limit will be increased in phases starting with subscriptions that have over 1800 role assignments.

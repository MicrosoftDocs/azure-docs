...
1. Determine the required permissions
    ...
    To create the permissions you want, you add the operations to the `actions` or `notActions` properties of the [role definition](role-definitions.md). If you have data operations, you add those to the `dataActions` or `notDataActions` properties.
...
3. Test the custom role
    ...
    Once you create the custom role, you have to test the custom role to verify that it works as you expect. If adjustments need to be made, you can update the custom role.

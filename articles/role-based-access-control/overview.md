...
[RBAC built-in roles](../active-directory/role-based-access-built-in-roles.md) lists the roles available in Azure. It specifies the operations and scope that each built-in role grants to users. If you're looking to define your own roles for even more control, see how to build [Custom roles in Azure RBAC](../active-directory/role-based-access-control-custom-roles.md).
...
## Next Steps
* Get started with [Role-Based Access Control in the Azure portal](../active-directory/role-based-access-control-configure.md).

...
> [!NOTE]
> Microsoft 365 subscriptions or Azure Active Directory licenses (for example: Access to Azure Active Directory) provisioned from the Microsoft 365 admin center don't qualify for using RBAC.

...
| --- | --- | --- |
| September 2025 | Roles | Updated role name for Container Instances to [Azure Container Instances Role](./built-in-roles/containers.md#azure-container-instances-contributor-role). |

...
| January 2025 | Roles | Added Azure Container Registry roles. See [Container Registry Configuration Reader and Data Access Configuration Reader](built-in-roles/containers.md#container-registry-configuration-reader-and-data-access-configuration-reader), [Container Registry Contributor and Data Access Configuration Administrator](built-in-roles/containers.md#container-registry-contributor-and-data-access-configuration-administrator), [Container Registry Data Importer and Data Reader](built-in-roles/containers.md#container-registry-data-importer-and-data-reader), [Container Registry Repository Catalog Lister](built-in-roles/containers.md#container-registry-repository-catalog-lister), [Container Registry Repository Contributor](built-in-roles/containers.md#container-registry-repository-contributor), [Container Registry Repository Reader](built-in-roles/containers.md#container-registry-repository-reader), [Container Registry Repository Writer](built-in-roles/containers.md#container-registry-repository-writer), [Container Registry Tasks Contributor](built-in-roles/containers.md#container-registry-tasks-contributor), and [Container Registry Transfer Pipeline Contributor](built-in-roles/containers.md#container-registry-transfer-pipeline-contributor). |

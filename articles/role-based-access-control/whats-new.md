...
| --- | --- | --- |
| September 2025 | Roles | Added Azure Container Instances Contributor Role [Azure Container Instances Role](./built-in-roles/containers.md#azure-container-instances-contributor-role). |

...
- Add users to groups and assign roles to the groups instead. For more information, see [Replace user role assignments with a group](./troubleshoot-resource-graph.md#replace-user-role-assignments-with-a-group).
- Make common role assignments at a higher scope, such as subscription or management group. For more information, see [Replace role assignments at a higher scope](./troubleshoot-resource-graph.md#replace-role-assignments-at-a-higher-scope).
...
Try to reduce the number of custom roles. For more information, see [Find and delete unused Azure custom roles](./troubleshoot-resource-graph.md#find-and-delete-unused-azure-custom-roles).

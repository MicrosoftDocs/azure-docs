...
- Learn how to [create a custom role](../active-directory/role-based-access-control-custom-roles.md).
- Review the [built in RBAC roles](../active-directory/role-based-access-built-in-roles.md).
- Learn how to manage access assignments [by user](../active-directory/role-based-access-control-manage-assignments.md) or [by resource](../active-directory/role-based-access-control-configure.md) 
- Learn how to [View activity logs to audit actions on resources](../azure-resource-manager/resource-group-audit.md)

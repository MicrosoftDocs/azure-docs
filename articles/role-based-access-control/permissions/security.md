...
> | `Microsoft.KeyVault/vaults/certificates/release/action` | Release a certificate using public part of KEK from attestation token. |
...
> | `Microsoft.Security/pricings/action` | Updates batch of pricing settings for the scope |
...
> | `Microsoft.Security/sqlVulnerabilityAssessments/read` | Get SQL Vulnerability Assessment settings. |
> | `Microsoft.Security/sqlVulnerabilityAssessments/write` | Create or update SQL Vulnerability Assessment settings. |
> | `Microsoft.Security/sqlVulnerabilityAssessments/delete` | Delete SQL Vulnerability Assessment settings. |

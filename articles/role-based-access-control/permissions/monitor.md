...
> | `Microsoft.Dashboard/dashboards/dashboardDefinitions/read` | Read dashboard definition |
> | `Microsoft.Dashboard/dashboards/dashboardDefinitions/write` | Write dashboard definition |
> | `Microsoft.Dashboard/dashboards/dashboardDefinitions/delete` | Delete dashboard definition |
...
> | `Microsoft.Dashboard/grafana/grafanaDefinitions/read` | Read Grafana Definitions |
> | `Microsoft.Dashboard/grafana/grafanaDefinitions/write` | Write Grafana Definitions |
> | `Microsoft.Dashboard/grafana/grafanaDefinitions/delete` | Delete Grafana Definitions |
...
> | `Microsoft.Insights/ScheduledQueryRules/networkSecurityPerimeterConfigurations/Reconcile/Action` | Reconciling network security perimeter configuration for scheduled query rules |
> | `Microsoft.Insights/Snapshots/Read` | Read snapshots generated by Snapshot Debugger |
...
> | `Microsoft.Insights/logs/data/read` | Allows you to provide read data access to Azure resource logs, scoped to individual Azure resources or more fine‑grained resource‑level data entities. |
...
> | `microsoft.monitor/accounts/exportRules/read` | Read any Export Rule |
> | `microsoft.monitor/accounts/exportRules/write` | Create or Update any Export Rule |
> | `microsoft.monitor/accounts/exportRules/delete` | Delete any Export Rule |
> | `microsoft.monitor/accounts/issues/read` | Read an Issue |
> | `microsoft.monitor/accounts/issues/write` | Create or Update an Issue |
> | `microsoft.monitor/accounts/issues/delete` | Delete an Issue |
> | `microsoft.monitor/accounts/issues/startInvestigation/action` | Start Investigation for an Issue |
> | `microsoft.monitor/accounts/issues/addOrUpdateAlerts/action` | Add or Update Issue Related Alerts |
> | `microsoft.monitor/accounts/issues/addOrUpdateResources/action` | Add or Update Issue Related Resources |
> | `microsoft.monitor/accounts/issues/fetchInvestigationResult/read` | Fetch Investigation Result for an Issue |
> | `microsoft.monitor/accounts/issues/getInvestigationResult/read` | Get Investigation Result for an Issue |
> | `microsoft.monitor/accounts/issues/listAlerts/read` | List Issue Related Alerts |
> | `microsoft.monitor/accounts/issues/listResources/read` | List Issue Related Resources |
> | `microsoft.monitor/accounts/metricsContainers/read` | Read Monitoring Account Metrics Container |
> | `microsoft.monitor/accounts/metricsContainers/write` | Write Monitoring Account Metrics Container |
...
> | `microsoft.monitor/crossTenantPermissions/read` | Read Cross-Tenant Permissions for the given scope |
> | `microsoft.monitor/crossTenantPermissions/write` | Create or Update Cross-Tenant Permissions for the given scope |
> | `microsoft.monitor/crossTenantPermissions/delete` | Delete Cross-Tenant Permissions for the given scope |
...
> | `microsoft.monitor/settings/read` | Read Azure Monitor settings for the given scope |
> | `microsoft.monitor/settings/write` | Create or Update Azure Monitor settings for the given scope |
> | `microsoft.monitor/settings/delete` | Delete Azure Monitor Settings for the given scope |
...
> | `Microsoft.OperationalInsights/workspaces/networkSecurityPerimeterConfigurations/reconcile/action` | Reconcile operation for Network Security Perimeter Configurations. |
...
> | `Microsoft.OperationalInsights/workspaces/query/AADAgentRiskEvents/read` | Read data from the AADAgentRiskEvents table |
...
> | `Microsoft.OperationalInsights/workspaces/query/AADRiskyAgents/read` | Read data from the AADRiskyAgents table |
...
> | `Microsoft.OperationalInsights/workspaces/query/ACLTransactionLogs/read` | Read data from the ACLTransactionLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/ACLUserDefinedLogs/read` | Read data from the ACLUserDefinedLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/ADGSyslogEvent/read` | Read data from the ADGSyslogEvent table |
...
> | `Microsoft.OperationalInsights/workspaces/query/AGSUpdateEvents/read` | Read data from the AGSUpdateEvents table |
...
> | `Microsoft.OperationalInsights/workspaces/query/AHCIDiagnosticLogs/read` | Read data from the AHCIDiagnosticLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/AMAHealth/read` | Read data from the AMAHealth table |
...
> | `Microsoft.OperationalInsights/workspaces/query/ANFTopClientReadIOPS/read` | Read data from the ANFTopClientReadIOPS table |
> | `Microsoft.OperationalInsights/workspaces/query/ANFTopClientWriteIOPS/read` | Read data from the ANFTopClientWriteIOPS table |
> | `Microsoft.OperationalInsights/workspaces/query/ANFTopFileReadIOPS/read` | Read data from the ANFTopFileReadIOPS table |
> | `Microsoft.OperationalInsights/workspaces/query/ANFTopFileWriteIOPS/read` | Read data from the ANFTopFileWriteIOPS table |
...
> | `Microsoft.OperationalInsights/workspaces/query/ApiManagementGatewayMCPLog/read` | Read data from the ApiManagementGatewayMCPLog table |
...
> | `Microsoft.OperationalInsights/workspaces/query/ASimAgentEventLogs/read` | Read data from the ASimAgentEventLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/ASimAlertEventLogs/read` | Read data from the ASimAlertEventLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/ASimAssetEntityLogs/read` | Read data from the ASimAssetEntityLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/AWSALBAccessLogs/read` | Read data from the AWSALBAccessLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/AWSEKSLogs/read` | Read data from the AWSEKSLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/AWSELBFlowLogs/read` | Read data from the AWSELBFlowLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/AWSGuardDuty/read` | Read data from the AWSGuardDuty table |
> | `Microsoft.OperationalInsights/workspaces/query/AWSNetworkFirewallAlert/read` | Read data from the AWSNetworkFirewallAlert table |
> | `Microsoft.OperationalInsights/workspaces/query/AWSNetworkFirewallFlow/read` | Read data from the AWSNetworkFirewallFlow table |
> | `Microsoft.OperationalInsights/workspaces/query/AWSNetworkFirewallTls/read` | Read data from the AWSNetworkFirewallTls table |
> | `Microsoft.OperationalInsights/workspaces/query/AWSNLBAccessLogs/read` | Read data from the AWSNLBAccessLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/AWSRoute53Resolver/read` | Read data from the AWSRoute53Resolver table |
> | `Microsoft.OperationalInsights/workspaces/query/AWSS3ServerAccess/read` | Read data from the AWSS3ServerAccess table |
...
> | `Microsoft.OperationalInsights/workspaces/query/AZFWDnsFlowTrace/read` | Read data from the AZFWDnsFlowTrace table |
...
> | `Microsoft.OperationalInsights/workspaces/query/AzureSQLAutomaticTuning/read` | Read data from the AzureSQLAutomaticTuning table |
> | `Microsoft.OperationalInsights/workspaces/query/AzureSQLBlocks/read` | Read data from the AzureSQLBlocks table |
> | `Microsoft.OperationalInsights/workspaces/query/AzureSQLDatabaseWaitStatistics/read` | Read data from the AzureSQLDatabaseWaitStatistics table |
> | `Microsoft.OperationalInsights/workspaces/query/AzureSQLDeadlocks/read` | Read data from the AzureSQLDeadlocks table |
> | `Microsoft.OperationalInsights/workspaces/query/AzureSQLErrors/read` | Read data from the AzureSQLErrors table |
> | `Microsoft.OperationalInsights/workspaces/query/AzureSQLQueryStoreRuntimeStatistics/read` | Read data from the AzureSQLQueryStoreRuntimeStatistics table |
> | `Microsoft.OperationalInsights/workspaces/query/AzureSQLQueryStoreWaitStatistics/read` | Read data from the AzureSQLQueryStoreWaitStatistics table |
> | `Microsoft.OperationalInsights/workspaces/query/AzureSQLResourceUsageStats/read` | Read data from the AzureSQLResourceUsageStats table |
> | `Microsoft.OperationalInsights/workspaces/query/AzureSQLTimeouts/read` | Read data from the AzureSQLTimeouts table |
...
> | `Microsoft.OperationalInsights/workspaces/query/ContainerNetworkLogs/read` | Read data from the ContainerNetworkLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/CrowdStrikeIncidents/read` | Read data from the CrowdStrikeIncidents table |
> | `Microsoft.OperationalInsights/workspaces/query/CrowdStrikeVulnerabilities/read` | Read data from the CrowdStrikeVulnerabilities table |
...
> | `Microsoft.OperationalInsights/workspaces/query/DataSetOutput/read` | Read data from the DataSetOutput table |
> | `Microsoft.OperationalInsights/workspaces/query/DataSetRuns/read` | Read data from the DataSetRuns table |
...
> | `Microsoft.OperationalInsights/workspaces/query/DeviceCustomFileEvents/read` | Read data from the DeviceCustomFileEvents table |
> | `Microsoft.OperationalInsights/workspaces/query/DeviceCustomImageLoadEvents/read` | Read data from the DeviceCustomImageLoadEvents table |
> | `Microsoft.OperationalInsights/workspaces/query/DeviceCustomNetworkEvents/read` | Read data from the DeviceCustomNetworkEvents table |
> | `Microsoft.OperationalInsights/workspaces/query/DeviceCustomProcessEvents/read` | Read data from the DeviceCustomProcessEvents table |
> | `Microsoft.OperationalInsights/workspaces/query/DeviceCustomRegistryEvents/read` | Read data from the DeviceCustomRegistryEvents table |
> | `Microsoft.OperationalInsights/workspaces/query/DeviceCustomScriptEvents/read` | Read data from the DeviceCustomScriptEvents table |
...
> | `Microsoft.OperationalInsights/workspaces/query/DurableTaskSchedulerLogs/read` | Read data from the DurableTaskSchedulerLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/EdgeActionConsoleLog/read` | Read data from the EdgeActionConsoleLog table |
> | `Microsoft.OperationalInsights/workspaces/query/EdgeActionServiceLog/read` | Read data from the EdgeActionServiceLog table |
> | `Microsoft.OperationalInsights/workspaces/query/EGNFailedHttpDataPlaneOperations/read` | Read data from the EGNFailedHttpDataPlaneOperations table |
...
> | `Microsoft.OperationalInsights/workspaces/query/EGNSuccessfulHttpDataPlaneOperations/read` | Read data from the EGNSuccessfulHttpDataPlaneOperations table |
...
> | `Microsoft.OperationalInsights/workspaces/query/GCPApigee/read` | Read data from the GCPApigee table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPAuditLogs/read` | Read data from the GCPAuditLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPCDN/read` | Read data from the GCPCDN table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPCloudRun/read` | Read data from the GCPCloudRun table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPCloudSQL/read` | Read data from the GCPCloudSQL table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPComputeEngine/read` | Read data from the GCPComputeEngine table |
...
> | `Microsoft.OperationalInsights/workspaces/query/GCPIDS/read` | Read data from the GCPIDS table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPLoadBalancer/read` | Read data from the GCPLoadBalancer table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPMonitoring/read` | Read data from the GCPMonitoring table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPNAT/read` | Read data from the GCPNAT table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPNATAudit/read` | Read data from the GCPNATAudit table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPResourceManager/read` | Read data from the GCPResourceManager table |
> | `Microsoft.OperationalInsights/workspaces/query/GCPVPCFlow/read` | Read data from the GCPVPCFlow table |
> | `Microsoft.OperationalInsights/workspaces/query/GKEAPIServer/read` | Read data from the GKEAPIServer table |
> | `Microsoft.OperationalInsights/workspaces/query/GKEApplication/read` | Read data from the GKEApplication table |
> | `Microsoft.OperationalInsights/workspaces/query/GKEAudit/read` | Read data from the GKEAudit table |
> | `Microsoft.OperationalInsights/workspaces/query/GKEControllerManager/read` | Read data from the GKEControllerManager table |
> | `Microsoft.OperationalInsights/workspaces/query/GKEHPADecision/read` | Read data from the GKEHPADecision table |
...
> | `Microsoft.OperationalInsights/workspaces/query/IdentityAccountInfo/read` | Read data from the IdentityAccountInfo table |
...
> | `Microsoft.OperationalInsights/workspaces/query/IdentityEvents/read` | Read data from the IdentityEvents table |
...
> | `Microsoft.OperationalInsights/workspaces/query/IlumioInsights/read` | Read data from the IlumioInsights table |
...
> | `Microsoft.OperationalInsights/workspaces/query/KeyVaults/read` | Read data from the KeyVaults table |
...
> | `Microsoft.OperationalInsights/workspaces/query/LAJobLogs/read` | Read data from the LAJobLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/LedgerTransactionLogs/read` | Read data from the LedgerTransactionLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/LedgerUserDefinedLogs/read` | Read data from the LedgerUserDefinedLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/LIATrackingEvents/read` | Read data from the LIATrackingEvents table |
...
> | `Microsoft.OperationalInsights/workspaces/query/MeshControlPlane/read` | Read data from the MeshControlPlane table |
> | `Microsoft.OperationalInsights/workspaces/query/MessageEvents/read` | Read data from the MessageEvents table |
> | `Microsoft.OperationalInsights/workspaces/query/MessagePostDeliveryEvents/read` | Read data from the MessagePostDeliveryEvents table |
> | `Microsoft.OperationalInsights/workspaces/query/MessageUrlInfo/read` | Read data from the MessageUrlInfo table |
...
> | `Microsoft.OperationalInsights/workspaces/query/MicrosoftGraphPolicyLogs/read` | Read data from the MicrosoftGraphPolicyLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/MPCIngestionLogs/read` | Read data from the MPCIngestionLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/MySqlAuditLogs/read` | Read data from the MySqlAuditLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/MySqlSlowLogs/read` | Read data from the MySqlSlowLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/NCCIDRACLogs/read` | Read data from the NCCIDRACLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/NCCKubernetesAPIAuditLogs/read` | Read data from the NCCKubernetesAPIAuditLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/NetworkAccessGenerativeAIInsights/read` | Read data from the NetworkAccessGenerativeAIInsights table |
...
> | `Microsoft.OperationalInsights/workspaces/query/NTANspRuleRecommendation/read` | Read data from the NTANspRuleRecommendation table |
> | `Microsoft.OperationalInsights/workspaces/query/NTARuleRecommendation/read` | Read data from the NTARuleRecommendation table |
...
> | `Microsoft.OperationalInsights/workspaces/query/OAuthAppInfo/read` | Read data from the OAuthAppInfo table |
...
> | `Microsoft.OperationalInsights/workspaces/query/OracleCloudDatabase/read` | Read data from the OracleCloudDatabase table |
> | `Microsoft.OperationalInsights/workspaces/query/OTelEvents/read` | Read data from the OTelEvents table |
> | `Microsoft.OperationalInsights/workspaces/query/OTelLogs/read` | Read data from the OTelLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/OTelResources/read` | Read data from the OTelResources table |
> | `Microsoft.OperationalInsights/workspaces/query/OTelSpans/read` | Read data from the OTelSpans table |
> | `Microsoft.OperationalInsights/workspaces/query/OTelTraces/read` | Read data from the OTelTraces table |
> | `Microsoft.OperationalInsights/workspaces/query/OTelTracesAgent/read` | Read data from the OTelTracesAgent table |
> | `Microsoft.OperationalInsights/workspaces/query/Perf/read` | Read data from the Perf table |
> | `Microsoft.OperationalInsights/workspaces/query/PerfInsightsFindings/read` | Read data from the PerfInsightsFindings table |
> | `Microsoft.OperationalInsights/workspaces/query/PerfInsightsImpactedResources/read` | Read data from the PerfInsightsImpactedResources table |
> | `Microsoft.OperationalInsights/workspaces/query/PerfInsightsRun/read` | Read data from the PerfInsightsRun table |
> | `Microsoft.OperationalInsights/workspaces/query/PFTitleAuditLogs/read` | Read data from the PFTitleAuditLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/PGSQLAutovacuumStats/read` | Read data from the PGSQLAutovacuumStats table |
> | `Microsoft.OperationalInsights/workspaces/query/PGSQLDbTransactionsStats/read` | Read data from the PGSQLDbTransactionsStats table |
> | `Microsoft.OperationalInsights/workspaces/query/PGSQLPgBouncer/read` | Read data from the PGSQLPgBouncer table |
> | `Microsoft.OperationalInsights/workspaces/query/PGSQLPgStatActivitySessions/read` | Read data from the PGSQLPgStatActivitySessions table |
> | `Microsoft.OperationalInsights/workspaces/query/PGSQLQueryStoreQueryText/read` | Read data from the PGSQLQueryStoreQueryText table |
> | `Microsoft.OperationalInsights/workspaces/query/PGSQLQueryStoreRuntime/read` | Read data from the PGSQLQueryStoreRuntime table |
> | `Microsoft.OperationalInsights/workspaces/query/PGSQLQueryStoreWaits/read` | Read data from the PGSQLQueryStoreWaits table |
> | `Microsoft.OperationalInsights/workspaces/query/PGSQLServerLogs/read` | Read data from the PGSQLServerLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/QualysKnowledgeBase/read` | Read data from the QualysKnowledgeBase table |
> | `Microsoft.OperationalInsights/workspaces/query/QuantumProviderAccountJobAuditLogs/read` | Read data from the QuantumProviderAccountJobAuditLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/QuantumProviderAccountQueueAuditLogs/read` | Read data from the QuantumProviderAccountQueueAuditLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/QuantumProviderAccountTargetAuditLogs/read` | Read data from the QuantumProviderAccountTargetAuditLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/QuantumWorkspaceJobAuditLogs/read` | Read data from the QuantumWorkspaceJobAuditLogs table |
> | `Microsoft.OperationalInsights/workspaces/query/Rapid7InsightVMCloudAssets/read` | Read data from the Rapid7InsightVMCloudAssets table |
> | `Microsoft.OperationalInsights/workspaces/query/Rapid7InsightVMCloudVulnerabilities/read` | Read data from the Rapid7InsightVMCloudVulnerabilities table |
...
> | `Microsoft.OperationalInsights/workspaces/query/SalesforceAuditTrail/read` | Read data from the SalesforceAuditTrail table |
> | `Microsoft.OperationalInsights/workspaces/query/SalesforceLoginHistory/read` | Read data from the SalesforceLoginHistory table |
...
> | `Microsoft.OperationalInsights/workspaces/query/SecurityCaseEvent/read` | Read data from the SecurityCaseEvent table |
...
> | `Microsoft.OperationalInsights/workspaces/query/StorageMoverAuditLogs/read` | Read data from the StorageMoverAuditLogs table |
...
> | `Microsoft.OperationalInsights/workspaces/query/WVDMultiLinkAdd/read` | Read data from the WVDMultiLinkAdd table |
...
> | `Microsoft.OperationalInsights/workspaces/query/ZTSJobStatus/read` | Read data from the ZTSJobStatus table |
> | `Microsoft.OperationalInsights/workspaces/query/ZTSRequest/read` | Read data from the ZTSRequest table |
...
> | `Microsoft.OperationalInsights/workspaces/savedSearches/schedules/read` | Get scheduled saved search. |
> | `Microsoft.OperationalInsights/workspaces/savedSearches/schedules/delete` | Delete scheduled saved search. |
> | `Microsoft.OperationalInsights/workspaces/savedSearches/schedules/write` | Create or update scheduled saved search. |
> | `Microsoft.OperationalInsights/workspaces/savedSearches/schedules/actions/read` | Get Management Configuration action. |
> | `Microsoft.OperationalInsights/workspaces/savedSearches/schedules/actions/write` | Delete Management Configuration action. |
> | `Microsoft.OperationalInsights/workspaces/savedSearches/schedules/actions/delete` | Create or update scheduled  search action. |
...
> | `Microsoft.OperationalInsights/workspaces/tables/protectionLevel/write` | Set or change the protection level of a Log Analytics table. |

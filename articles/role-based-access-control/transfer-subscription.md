...
| Azure Resource Locks | Yes | Yes | [List resource locks](/https://learn.microsoft.com/en-us/cli/azure/resource/lock?view=azure-cli-latest#az-resource-lock-list) | Export Azure Resource Locks manually via the Portal or [export via az cli](/https://learn.microsoft.com/en-us/cli/azure/resource/lock?view=azure-cli-latest). |

...
> | | |
> | --- | --- |
> | **Description** | Permits management of storage accounts. Provides access to the account access key, which can be used to access data via Shared Key authorization. |

...
> | [Elastic SAN Network Admin](#elastic-san-network-admin) | Allows for full control of all networking configuration operations for Azure Elastic SANs and volume groups, including changing network security policies to unblock data path access. | new GUID here |
...
Allows for full control of all networking configuration operations for Azure Elastic SANs and volume groups, including changing network security policies to unblock data path access.
...
```json
{
  ...
  "description": "Allows for full control of all networking configuration operations for Azure Elastic SANs and volume groups, including changing network security policies to unblock data path access",

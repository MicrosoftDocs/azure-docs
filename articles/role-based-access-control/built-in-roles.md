...
| [Logic App Contributor](#logic-app-contributor) | Lets you manage a logic app but not change access or permissions. |
| [Logic App Operator](#logic-app-operator) | Lets you read, enable, and disable a logic app, but not edit or update that app. |

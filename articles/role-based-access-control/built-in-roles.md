...
| [Logic App Contributor](#logic-app-contributor) | Lets you manage a logic app but not change permissions or access to that logic app. |
...
> | | |
> | --- | --- |
> | **Description** | Perform management tasks on a logic app but not change permissions or access to that app. |
...
> | | |
> | --- | --- |
> | **Description** | Lets you read, view run history, and enable or disable a logic app. However, you can't edit or update a logic app. |

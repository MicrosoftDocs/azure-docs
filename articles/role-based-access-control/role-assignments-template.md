...
In Azure RBAC, to remove access from an Azure resource, you remove a role assignment. There isn't a way to remove a role assignment using a template. To remove a role assignment, you should use other tools such as:

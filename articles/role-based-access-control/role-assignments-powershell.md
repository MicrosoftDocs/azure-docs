---
title: Add or remove Azure role assignments using Azure PowerShell
...
If you get the error message: "The provided information does not map to a role assignment", make sure that you also specify the `-Scope` or `-ResourceGroupName` parameters. For more information, see [Troubleshoot Azure RBAC](troubleshooting.md#role-assignments-with-unknown-security-principal).

## Next steps

- [List Azure role assignments using Azure PowerShell](role-assignments-list-powershell.md)
- [Tutorial: Grant a group access to Azure resources using Azure RBAC and Azure PowerShell](tutorial-role-assignments-group-powershell.md)

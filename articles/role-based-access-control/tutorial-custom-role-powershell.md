---
title: "Tutorial: Create a Azure custom role with Azure PowerShell"
description: Get started creating a Azure custom role using Azure PowerShell in this tutorial.

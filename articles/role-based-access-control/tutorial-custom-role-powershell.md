---
title: "Tutorial: Create an Azure custom role with Azure PowerShell"
description: Get started creating an Azure custom role using Azure PowerShell in this tutorial.

<properties linkid="develop-mobile-tutorials-upload-blob-data-dotnet" urlDisplayName="Upload Images" pageTitle="Use Mobile Services to upload images to blob storage (Windows Store) | Mobile Services" metaKeywords="" description="Learn how to use Mobile Services to upload images to Windows Azure Blob Storage and access the images from your Windows Store app." metaCanonical="" services="" documentationCenter="Mobile" title="Upload images to Windows Azure Storage by using Mobile Services" authors="glenga" solutions="" manager="" editor="" />
...
[5]: ./media/mobile-services-windows-store-dotnet-upload-data-blob-storage/mobile-app-manifest-camera.png
[6]: ./media/mobile-services-windows-store-dotnet-upload-data-blob-storage/mobile-quickstart-blob-appbar.png
[7]: ./media/mobile-services-windows-store-dotnet-upload-data-blob-storage/mobile-quickstart-blob-camera.png
[8]: ./media/mobile-services-windows-store-dotnet-upload-data-blob-storage/mobile-quickstart-blob-appbar2.png
[9]: ./media/mobile-services-windows-store-dotnet-upload-data-blob-storage/mobile-quickstart-blob-ie.png

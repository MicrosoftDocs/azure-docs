...
2. Select a subscription
  ...
  ![Select a subscription](./media/billing-understand-your-azure-marketplace-charges/external-services-blade.png)
...
3. Use the External Services command to view each of your external service orders, the publisher name, service tier you bought, name you gave the resource, and the current order status.
  ...
  ![use the external services command](./media/billing-understand-your-azure-marketplace-charges/external-services-command.png)

4. From here, you can view past bill amounts including the tax breakdown.

  ![view external services billing history](./media/billing-understand-your-azure-marketplace-charges/billing-history.png)

...
```posh
        ...
        HealthEvents                    :
                                          ...
                                          ...
```
1. Using Windows Explorer, open the **Begin\BasicManagementApp\BasicManagementApp\obj\x64\Debug\Package** folder, which contains the application package:
```
        Package
...
1. Press **F5**, which will trigger Visual Studio to perform a rolling upgrade.

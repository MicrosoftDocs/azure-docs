---
title: .NET example for DocumentDB API for tables | Microsoft Docs
description: Find C# .NET examples on github for common tasks in DocumentDB, including CRUD operations for JSON documents.
services: cosmosdb
author: mimig1
manager: jhubbard
editor: ''
...
---
# DocumentDB API for tables: .NET examples 

*Content below is Document API - need to replace with Tables API*
...
For more information about indexing, see [DocumentDB indexing policies](../documentdb/documentdb-indexing-policies.md).
...
| [Find points within a specified distance](https://github.com/Azure/azure-documentdb-dotnet/blob/7b09c085817e850d683bc59bd864c2f6b552d275/samples/code-samples/Geospatial/Program.cs#L152-L194) |[ST_DISTANCE](../documentdb/documentdb-sql-query.md#BuiltinFunctions)|
| [Find points within a polygon](https://github.com/Azure/azure-documentdb-dotnet/blob/7b09c085817e850d683bc59bd864c2f6b552d275/samples/code-samples/Geospatial/Program.cs#L196-L221) |[ST_WITHIN](../documentdb/documentdb-sql-query.md#BuiltinFunctions)<br>[Polygon](https://msdn.microsoft.com/library/azure/microsoft.azure.documents.spatial.polygon.aspx) |
...
| [Validate point and polygon data](https://github.com/Azure/azure-documentdb-dotnet/blob/7b09c085817e850d683bc59bd864c2f6b552d275/samples/code-samples/Geospatial/Program.cs#L223-L265) |[ST_ISVALID](../documentdb/documentdb-sql-query.md#BuiltinFunctions)<br>[ST_ISVALIDDETAILED](../documentdb/documentdb-sql-query.md#BuiltinFunctions)<br>[GeometryOperationExtensions.IsValid](https://msdn.microsoft.com/library/azure/microsoft.azure.documents.spatial.geometryoperationextensions.isvalid.aspx)<br>[GeometryOperationExtensions.IsValidDetailed](https://msdn.microsoft.com/library/azure/microsoft.azure.documents.spatial.geometryoperationextensions.isvaliddetailed.aspx) |

For more information about working with Geospatial data, see [Working with Geospatial data in Azure DocumentDB](../documentdb/documentdb-geospatial.md).  
...
For more information about writing queries, see [SQL query within DocumentDB](../documentdb/documentdb-sql-query.md).
...
For more information about server-side programming, see [DocumentDB server-side programming: Stored procedures, database triggers, and UDFs](../documentdb/documentdb-programming.md).

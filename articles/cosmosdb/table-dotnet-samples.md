---
title: .NET NoSQL example for DocumentDB API for tables | Microsoft Docs
...
For more information about indexing, see [DocumentDB indexing policies](../articles/documentdb/documentdb-indexing-policies.md).
...
| [Find points within a specified distance](https://github.com/Azure/azure-documentdb-dotnet/blob/7b09c085817e850d683bc59bd864c2f6b552d275/samples/code-samples/Geospatial/Program.cs#L152-L194) |[ST_DISTANCE](../articles/documentdb/documentdb-sql-query.md#BuiltinFunctions)|
| [Find points within a polygon](https://github.com/Azure/azure-documentdb-dotnet/blob/7b09c085817e850d683bc59bd864c2f6b552d275/samples/code-samples/Geospatial/Program.cs#L196-L221) |[ST_WITHIN](../articles/documentdb/documentdb-sql-query.md#BuiltinFunctions)<br>[Polygon](https://msdn.microsoft.com/library/azure/microsoft.azure.documents.spatial.polygon.aspx) |
...
| [Validate point and polygon data](https://github.com/Azure/azure-documentdb-dotnet/blob/7b09c085817e850d683bc59bd864c2f6b552d275/samples/code-samples/Geospatial/Program.cs#L223-L265) |[ST_ISVALID](../articles/documentdb/documentdb-sql-query.md#BuiltinFunctions)<br>[ST_ISVALIDDETAILED](../articles/documentdb/documentdb-sql-query.md#BuiltinFunctions)<br>[GeometryOperationExtensions.IsValid](https://msdn.microsoft.com/library/azure/microsoft.azure.documents.spatial.geometryoperationextensions.isvalid.aspx)<br>[GeometryOperationExtensions.IsValidDetailed](https://msdn.microsoft.com/library/azure/microsoft.azure.documents.spatial.geometryoperationextensions.isvaliddetailed.aspx) |

For more information about working with Geospatial data, see [Working with Geospatial data in Azure DocumentDB](../articles/documentdb/documentdb-geospatial.md).  
...
For more information about writing queries, see [SQL query within DocumentDB](../articles/documentdb/documentdb-sql-query.md).
...
For more information about server-side programming, see [DocumentDB server-side programming: Stored procedures, database triggers, and UDFs](../articles/documentdb/documentdb-programming.md).

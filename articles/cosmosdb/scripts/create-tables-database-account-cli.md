...
[!code-azurecli[main](../../../cli_scripts/cosmosdb/create-cosmosdb-table-account/create-cosmosdb-table-account.sh?highlight=17-39 "Create an Azure Cosmos DB Tables API account, database, and collection")]

...
| :---- | :---- | :---- | :---- | :---- | :---- |
| Container registries should use private link | Azure Private Link lets you connect your virtual network to Azure services without a public IP address at the source or destination. The Private Link service handles the connectivity between the consumer and services over the Azure backbone network. You can map private endpoints to your container registries instead of the entire service, which reduces data leakage risks. Learn more at: `https://aka.ms/acr/private-link`. | 1.0.1 | Built in | Audit | [Link](https://portal.azure.com/#view/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2fproviders%2fMicrosoft.Authorization%2fpolicyDefinitions%2fe8eef0a8-67cf-4eb4-9386-14b0e78733d4) |
...
| Container registries support Private Links | Azure Private Link lets you connect your virtual network to Azure services without a public IP address at the source or destination. The Private Link service handles the connectivity between the consumer and services over the Azure backbone network. You can map private endpoints to your container registries instead of the entire service, which reduces data leakage risks. Learn more at: `https://aka.ms/acr/private-link`. | 1.0.0 | Custom | AuditDeny | N/A |

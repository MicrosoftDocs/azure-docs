...
description: Learn how Azure Enclave uses RBAC role assignments, deny assignments, and deny assignment exclusions to control access at the community, enclave, and workload levels.
author: jadean-msft
ms.author: jadean
...
- `Community Maintenance Mode` - Grants specific users, groups, and service principals deny assignment exclusions over Community managed resources for General or Advanced maintenance mode actions:
...
- `Enclave Maintenance Mode` - Grants specific users, groups, and service principals deny assignment exclusions over Enclave managed resources for General or Advanced maintenance mode actions:
...
- [Built-in RBAC roles in Azure Enclave](./built-in-rbac-roles.md)

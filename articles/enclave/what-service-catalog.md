...
If you need to deploy an Azure service that's not in the service catalog, you can [create a new Azure service template](#create-a-new-azure-service-template) or submit a request for future templates through the Azure Enclave feedback or support methods.

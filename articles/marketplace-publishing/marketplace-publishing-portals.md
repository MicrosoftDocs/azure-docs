...
Ideally, this value is a distribution list or a security group (for example, azurepublishing@*partnercompany*.com). The distribution list or security group **must** be registered as a Microsoft account.
...
This value is the portal that you use to work on the offer and to publish it (marketing, pricing, publishing, certification if applicable, etc.).

### Identity/account used
The above distribution list or security group must be used for the first time to sign in to the publishing portal. Later, other users can be added as co-administrators. This list is how it gets mapped to the Developer Center registration data.

## Azure portal
[Azure portal](https://portal.azure.com)

### Description
This value is the portal where you can view your staged and published offers in the Azure Marketplace (applicable for VMs, solution templates, and Azure Resource Manager-based developer services).

...
As an Azure publisher, you can distribute and sell your innovative solution or service to other developers, ISVs, and IT professionals through the Marketplace. You can reach customers who want to quickly develop their cloud-based applications and mobile solutions. If your solution targets business users, you may want to consider the [AppSource](http://appsource.microsoft.com) marketplace.
...
### Step 1. Nominate your solution for pre-approval
Complete the solution nomination form for **Microsoft Azure Certified for Virtual Machines** [webpage](https://createopportunity.azurewebsites.net).
...
### Step 2. Register your account as a Microsoft seller
...
1. Fulfill the non-technical requirements.
  - [Fulfill the nontechnical prerequisites](marketplace-publishing-pre-requisites.md).
  - [Fulfill the VM technical prerequisites](marketplace-publishing-vm-image-creation-prerequisites.md).
  - [Fulfill the Solution Template technical prerequisites](marketplace-publishing-solution-template-creation-prerequisites.md).
2. Create your offer.
...
## Ways to manage your solution
* [Post-production guide for virtual machine offers](marketplace-publishing-vm-image-post-publishing.md)
* [How to update the nontechnical details of an offer or a SKU](marketplace-publishing-vm-image-post-publishing.md#2-how-to-update-the-non-technical-details-of-an-offer-or-a-sku)

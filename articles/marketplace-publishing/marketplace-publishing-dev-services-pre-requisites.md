...
* [Create a Creating a MSA account](marketplace-publishing-dev-services-pre-requisites-creating-msa-account.md)
...
*  Please refer [here](marketplace-publishing-dev-services-pre-requisites-seller-dashboard.md) for tips on creating Seller Profile.
...
## DEVELOPER SERVICE OFFER PUBLISHING

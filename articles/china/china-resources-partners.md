...
- Consider a global partner solution from the [Azure Marketplace](https://azure.microsoft.com/en-us/marketplace/), but since most solution data is not configured specifically for Azure China 21Vianet, expect to work around migration issues.

...
:::image type="content" source="~/reusable-content/ce-skilling/azure/media/migrate-data-databricks/databricks-runtime.png" alt-text="Screenshot that shows finding the Databricks runtime version.":::

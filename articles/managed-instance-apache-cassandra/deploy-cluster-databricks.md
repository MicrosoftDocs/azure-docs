...
1. In the **New cluster** pane, accept default values for all fields other than the following fields:
   ...
   * **Databricks Runtime Version** - We recommend selecting Databricks runtime version 7.5 or higher, for Spark 3.x support. 
    ...
    :::image type="content" source="../cosmos-db/cassandra/media/cassandra-migrate-cosmos-db-databricks/databricks-runtime.png" alt-text="Select the Databricks runtime version and the Spark Cluster." border="true":::
...
:::image type="content" source="../cosmos-db/cassandra/media/cassandra-migrate-cosmos-db-databricks/databricks-search-packages.png" alt-text="Screenshot that shows searching for Maven packages in Databricks.":::

...
1. In the **New cluster** pane, accept default values for all fields other than the following fields:
   ...
   * **Databricks Runtime Version** We recommend selecting Databricks runtime version 7.5 or higher, for Spark 3.x support.
   ...
   :::image type="content" source="~/reusable-content/ce-skilling/azure/media/migrate-data-databricks/databricks-runtime.png" alt-text="Screenshot shows the New Cluster dialog box with a Databricks Runtime Version selected." border="true":::
...
:::image type="content" source="~/reusable-content/ce-skilling/azure/media/migrate-data-databricks/databricks-search-packages.png" alt-text="Screenshot that shows searching for Maven packages in Databricks.":::

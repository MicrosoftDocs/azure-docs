...
**Active** SQL Data Warehouse databases will automatically be backed at a minimum of every 8 hours and kept for 7 days. This allows you to restore your active database to one of several restore points in the past 7 days. 

When a database is paused, new snapshots will stop and previous snapshots will roll off as they reach 7 days in age.  <!--If a database is paused for more than 7 days, only the last snapshot will be saved.--> 

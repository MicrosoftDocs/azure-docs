...
* A SQL Data Warehouse pre-loaded with the AdventureWorksDW database. To provision a data warehouse, see [Create a SQL Data Warehouse]((../synapse-analytics/sql-data-warehouse/create-data-warehouse-portal.md)) and choose to load the sample data. If you already have a data warehouse but do not have sample data, you can [load WideWorldImportersDW](../synapse-analytics/sql-data-warehouse/load-data-wideworldimportersdw.md).

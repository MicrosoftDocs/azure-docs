...
## Next steps
Now that we've given you some time to warm up with the sample data, see how to [develop](../synapse-analytics/sql-analytics/azure-synapse-development-overview.md) or [load](design-elt-data-loading.md). Or take a look at the [Power BI website](https://www.powerbi.com/).

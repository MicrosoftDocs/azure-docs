...
To connect to a specific instance of SQL DW when using sqlcmd you will need to open the command prompt and enter **sqlcmd** followed by the connection string for your SQL DW database. The connection string will need to contain the following parameters:

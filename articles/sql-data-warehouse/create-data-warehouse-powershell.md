...
* **RequestedServiceObjectiveName**: The amount of [data warehouse units](../synapse-analytics/sql-analytics/azure-synapse-resource-consumption-models.md) you're requesting. Increasing this amount increases compute cost. For a list of supported values, see [memory and concurrency limits](memory-concurrency-limits.md).

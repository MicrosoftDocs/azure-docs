---
title: System views - Azure SQL Analytics | Microsoft Docs
description: Links to the documentation for system views supported in Azure SQL Analytics.
...
# System views supported in Azure SQL Analytics (formerly SQL DW)
...
## SQL Analytics dynamic management views (DMVs)
...
SQL Analytics and Analytics Platform System's Parallel Data Warehouse (PDW) use the same system views. Each DMV has a column called pdw_node_id, which is the identifier for the Compute node. 
...
## Next steps
For more reference information, see [T-SQL statements in Azure SQL Analytics](sql-data-warehouse-reference-tsql-statements.md), and [T-SQL language elements in Azure SQL Analytics](sql-data-warehouse-reference-tsql-language-elements.md).

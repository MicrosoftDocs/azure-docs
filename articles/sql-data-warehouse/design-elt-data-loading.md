...
- [PolyBase with Azure Data Factory (ADF)](sql-data-warehouse-load-with-data-factory.md) is another orchestration tool.  It defines a pipeline and schedules jobs. ADF can parse JSON data and load it into SQL Data Warehouse.
- [PolyBase with Azure DataBricks](../azure-databricks/databricks-extract-load-sql-data-warehouse.md) transfers data from Azure Data Lake Store to SQL Data Warehouse. Azure DataBricks parses Spark and JSON data. 

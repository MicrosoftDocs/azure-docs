...
|       timestamp       |                           datetime                           |
|       timestamp       |                             time                             |
|       **date**        | 1) Load as int and cast to date </br> 2) [Use the Azure Databricks SQL DW connector](https://docs.microsoft.com/azure/azure-databricks/databricks-extract-load-sql-data-warehouse#load-data-into-azure-sql-data-warehouse) with spark.conf.set( "spark.sql.parquet.writeLegacyFormat", "true" ) </br> (**Update coming soon**) |
|        decimal        | [Use the Azure Databricks SQL DW connector](https://docs.microsoft.com/azure/azure-databricks/databricks-extract-load-sql-data-warehouse#load-data-into-azure-sql-data-warehouse) with spark.conf.set( "spark.sql.parquet.writeLegacyFormat", "true" ) </br> (**Update coming soon**) |

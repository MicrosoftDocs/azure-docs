...
The following list shows the data types that SQL DAnalytics does not support and gives alternatives that you can use instead of the unsupported data types.

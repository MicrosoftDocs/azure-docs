...
## Next steps
For more information about developing tables, see the articles on [Table Overview](../synapse-analytics/sql-analytics/azure-synapse-development-tables-overview.md).

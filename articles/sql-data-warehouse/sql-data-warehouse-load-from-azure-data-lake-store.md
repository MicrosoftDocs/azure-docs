---
title: 'Tutorial Load from Azure Data Lake Storage to Azure SQL Analytics | Microsoft Docs'
description: Use PolyBase external tables to load data from Azure Data Lake Storage into Azure SQL Analytics.
...
# Load data from Azure Data Lake Storage to SQL Analytics (formerly SQL DW)
Use PolyBase external tables to load data from Azure Data Lake Storage into Azure SQL Analytics. Although you can run ad hoc queries on data stored in Data Lake Storage, we recommend importing the data into the SQL Analytics for best performance.

> [!div class="checklist"]
> * Create database objects required to load from Data Lake Storage.
> * Connect to a Data Lake Storage directory.
> * Load data into Azure SQL Analytics.
...
By default, SQL Analytics stores the table as a clustered columnstore index. After a load completes, some of the data rows might not be compressed into the columnstore.  There's a variety of reasons why this can happen. To learn more, see [manage columnstore indexes](sql-data-warehouse-tables-index.md).
...
You have successfully loaded data into Azure SQL Analytics. Great job!
...
> * Loaded data into Azure SQL Analytics.
>

Loading data is the first step to developing a data warehouse solution using SQL Analytics. Check out our development resources.

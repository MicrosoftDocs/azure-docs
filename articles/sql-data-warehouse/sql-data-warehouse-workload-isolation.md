...
> [!NOTE] There are specific service level minimum viable values for min_percentage_resource.  For more information, see [Effective Values](https://review.docs.microsoft.com/sql/t-sql/statements/create-workload-group-transact-sql?view=azure-sqldw-latest#effective-values) for further details.

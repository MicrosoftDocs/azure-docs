---
title: Memory and concurrency limits in Azure SQL Analytics | Microsoft Docs
description: View the memory and concurrency limits allocated to the various performance levels and resource classes in Azure SQL Analytics.
...
# Memory and concurrency limits for Azure SQL Analytics (formerly SQL DW)
View the memory and concurrency limits allocated to the various performance levels and resource classes in Azure SQL Analytics. For more information, and to apply these capabilities to your workload management plan, see [Resource classes for workload management](resource-classes-for-workload-management.md). 

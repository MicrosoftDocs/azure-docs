...
Advanced tuning for Azure SQL Data Warehouse (SQL DW) just got simpler with additional data warehouse recommendations and metrics and a redesign of the portal overview blade which provides an integrated experience with Azure Advisor and Azure Monitor. 
...
| Title | Description |
|:---|:---|
| **CETAS to Parquet failures in small resource classes on Data warehouses of DW2000 and more** | This correctly identifies a null reference in the Create External Table As to Parquet codepath. |

...
A data warehouse workload refers to all operations that transpire in relation to a data warehouse. The data warehouse workload encompasses 
...
The depth and breadth of these components depend on the maturity level of the data warehouse. 
...
- To view the resource and concurrency limits for all the performance profiles, see [Memory and concurrency limits](memory-and-concurrency-limits.md).
...
- For more information about workload importance, see [Workload Classification](sql-data-warehouse-workload-importance.md).  
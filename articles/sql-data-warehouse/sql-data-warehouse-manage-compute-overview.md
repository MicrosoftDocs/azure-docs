...
description: Learn about performance scale out capabilities in an Azure Synapse Analytics data warehouse. Scale out by adjusting DWUs, or lower costs by pausing the data warehouse.
...
Learn about managing compute resources in Azure Synapse Analytics data warehouse. Lower costs by pausing the data warehouse, or scale the data warehouse to meet performance demands. 

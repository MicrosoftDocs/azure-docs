...
> [AZURE.NOTE] SQL Data Warehouse with Premium Storage is not currently geo-redundant.  This means that once your Data Warehouse is migrated over to Premium Storage, the data will only reside in your current region.  Once available, Geo-Backups will copy your Data Warehouse every 24 hours to the [Azure paired region][], allowing you to restore from the Geo-Backup to any region in Azure.  Geo-Backup functionality will not be available for self-migrated DWs until sometime in July 2016, but will be announced on our [main documentation site][].  In contrast, automatic migration will not have this limitation.  

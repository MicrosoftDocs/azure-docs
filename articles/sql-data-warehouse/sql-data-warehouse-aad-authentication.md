...
The principal differences between using Azure Active Directory authentication with Azure SQL Database and Azure SQL Data Warehouse is that you must you use SQL Server Data Tools instead of SQL Server Management Studio to connect to SQL Data Warehouse. SQL Data Warehouse requires at least the April 2016 (version 14.0.60311.1) of the SQL Server Data Tools for Visual Studio 2015.

...
1. Create the view dbo.vTableSizes that is shown in the [Tables overview](../synapse-analytics/sql-analytics/azure-synapse-development-tables-overview.md#table-size-queries) article.  

...
However, if you query the Azure SQL Data Warehouse dynamic management views (DMV) you can perform a more detailed analysis. Create this view to have a more detailed view of tables which have data skew.
...
Now that you have created the view, run this query to identify which tables have more than 10% data skew.

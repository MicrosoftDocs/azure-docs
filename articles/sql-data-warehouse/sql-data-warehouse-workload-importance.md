---
title: Workload Importance | Microsoft Docs
...
- For more information about SQL Data Warehouse workload classification, see [SQL Data Warehouse Workload Classification](sql-data-warehouse-workload-classification.md).  

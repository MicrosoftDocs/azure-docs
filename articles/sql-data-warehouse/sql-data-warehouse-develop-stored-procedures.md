---
title: Using stored procedures in Azure SQL Analytics | Microsoft Docs
description: Tips for implementing stored procedures in Azure SQL Analytics for developing solutions.
...
# Using stored procedures in SQL Analytics (formerly SQL DW)
Tips for implementing stored procedures in Azure SQL Analytics for developing solutions.
...
However, to maintain the scale and performance of SQL Analytics there are also some features and functionality that have behavioral differences and others that are not supported.
...
When SQL Analytics executes your stored procedure, the SQL statements are parsed, translated, and optimized at run time. During this process, each statement is converted into distributed queries. The SQL code that is executed against the data is different than the query submitted.

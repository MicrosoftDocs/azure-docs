...
## Next steps
See [Transactions in SQL Data Warehouse](../synapse-analytics/sql-analytics/development-transactions.md) to learn more about isolation levels and transactional limits.  For an overview of other Best Practices, see [SQL Data Warehouse Best Practices](sql-data-warehouse-best-practices.md).

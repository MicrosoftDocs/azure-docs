---
title: Troubleshooting Azure SQL Analytics | Microsoft Docs
description: Troubleshooting Azure SQL Analytics.
...
| Cannot connect with tool or driver                           | SQL Analytics recommends using [SSMS][SSMS], [SSDT for Visual Studio][SSDT for Visual Studio], or [sqlcmd][sqlcmd] to query your data. For more information on drivers and connecting to SQL Analytics, see [Drivers for Azure SQL Analytics][Drivers for Azure SQL Analytics] and [Connect to Azure SQL Analytics][Connect to Azure SQL Analytics] articles. |

## Tools
| Issue                                                        | Resolution                                                   |
| :----------------------------------------------------------- | :----------------------------------------------------------- |
| Visual Studio object explorer is missing AAD users           | This is a known issue.  As a workaround, view the users in [sys.database_principals][sys.database_principals].  See [Authentication to Azure SQL Analytics][Authentication to Azure SQL Analytics] to learn more about using Azure Active Directory with SQL Analytics. |
| Manual scripting, using the scripting wizard, or connecting via SSMS is slow, not responding, or producing errors | Ensure that users have been created in the master database. In scripting options, also make sure that the engine edition is set as “Microsoft Azure SQL Analytics Edition” and engine type is “Microsoft Azure SQL Database”. |
...
| How to implement best practices                              | The best place to start to learn ways to improve query performance is [SQL Analytics best practices][SQL Analytics best practices] article. |
| How to improve performance with scaling                      | Sometimes the solution to improving performance is to simply add more compute power to your queries by [Scaling your SQL Analytics data warehouse][Scaling your SQL Analytics data warehouse]. |
...
[Drivers for Azure SQL Analytics]: sql-data-warehouse-connection-strings.md
[Connect to Azure SQL Analytics]: sql-data-warehouse-connect-overview.md
[Create support ticket]: sql-data-warehouse-get-started-create-support-ticket.md
[Scaling your SQL Analytics]: sql-data-warehouse-manage-compute-overview.md
...
[SQL Analytics best practices]: sql-data-warehouse-best-practices.md

...
| Cannot connect with tool or driver                           | We recommend using [SSMS][SSMS], [SSDT for Visual Studio][SSDT for Visual Studio], or [sqlcmd][sqlcmd] to query your data. For more information on drivers and connecting to SQL Analytics end points, see [Drivers for SQL Analytics end points][Drivers for SQL Analytics end points] and [Connect to SQL Analytics end points][Connect to SQL Analytics end points] articles. |
...
[Connect to Azure SQL Analytics end points]: sql-data-warehouse-connect-overview.md

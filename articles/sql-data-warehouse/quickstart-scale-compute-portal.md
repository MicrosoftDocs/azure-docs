...
## Next steps
To learn more about SQL pool, continue to the [Load data into SQL pool](../synapse-analytics/sql-data-warehouse/load-data-from-azure-blob-storage-using-polybase.md) tutorial. 

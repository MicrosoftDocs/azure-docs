...
Performance for data warehouse units is based on these [SQL Analytics](sql-data-warehouse-overview-what-is
) workload metrics:
...
1. Open the [Azure portal](https://portal.azure.com), open your SQL pool, and click **Scale**.
...
For more information, see [PowerShell cmdlets for SQL pool](sql-data-warehouse-reference-powershell-cmdlets.md)
...
For more REST API examples, see [REST APIs for SQL pool](sql-data-warehouse-manage-compute-rest-api.md).

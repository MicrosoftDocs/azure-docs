...
Azure DevTest Labs enables you control cost and minimize waste in your labs by managing policies (settings) for each lab. In this article, you'll get started with policies by learning how to set two of the most critical policies - configuring auto-shutdown and limiting the number of VMs that can be created by a single user. To view how to set every lab policy, see the article, [Define lab policies in Azure DevTest Labs](devtest-lab-set-lab-policy.md).  

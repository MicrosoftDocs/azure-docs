...
1. Tap **Virtual options**.
	...
	![VNETs can be configured from the lab's Settings blade](lab-settings-vnet.png)
...
1. Tap **+ Add**.
	...
	![Add an existing VNET to your lab](lab-settings-vnet-add.png)
	
1. On the **Virtual network** blade, tap **[Select virtual network]**.

	![Select an existing VNET](lab-settings-vnets-vnet.png)

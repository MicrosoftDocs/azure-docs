...
| targetOsType |Yes |Operating system of the VM where artifact is installed. Supported options are: Windows and Linux. |
...
Create your custom artifact by following these steps:

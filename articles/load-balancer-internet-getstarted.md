...
The load balancer combines the info of the endpoint and the info of the probe, to create a URL in the form of http://{DIP of VM}:80/Probe.aspx that will use to query the health of the service.

...
3. On the **Select machines** blade:
    ...
    ![Select existing VM from list of available VMs](media\virtual-machine-custom-preferences\existing-vm-select-machine.png)

4. Under **Configuration profile**, click **Browse and change profiles and preferences**

![Browse and change profiles and preferences](media\virtual-machine-custom-preferences\existing-vm-quick-create.png)
...
![Browse production configuration profile](media\virtual-machine-custom-preferences\browse-production-profile.png)
...
6. On the chosen profile, under **Configuration preferences** there is a dropdown where you can adjust for certain services
    ...
    ![Fill out configuration preferences](media\virtual-machine-custom-preferences\create-preference.png)
...
![Disabling Automanage on a virtual machine](media\virtual-machine-custom-preferences\disable-step-1.png)

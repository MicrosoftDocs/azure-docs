...
1. In the left menu, under **Inventory**, select **Dependency tracker**.
...
1. In the left menu, under **Assets**, select **Dependency tracker**.
...
1. In the **Dependency tracker** table view, find the dependency that you want to delete.

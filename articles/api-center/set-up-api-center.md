...
description: In this quickstart, set up an API center for API discovery, reuse, and governance. 
author: dlepow
...
# Quickstart: Create your API Center (preview)

Create your [API center](overview.md) to start an inventory of your organization's APIs. API Center enables tracking APIs in a centralized location for discovery, reuse, and governance.

In this tutorial, you learn how to use the portal to:
> [!div class="checklist"]
> * Create an API center

After creating your API center, follow the steps in the following tutorials to add custom metadata, APIs, versions, definitions, and other information.
...
Now you can start adding information to the inventory in your API center. To help you organize your APIs and other information, define custom metadata properties in your API center.

...
To do this, we need to prepare the experiment so that it's ready to be published and then publish it as an Azure web service.
...
To publish a web service derived from our experiment, click **PUBLISH WEB SERVICE** below the canvas and click **YES** when prompted. Machine Learning Studio publishes the experiment as a web service and takes you to the service dashboard.   

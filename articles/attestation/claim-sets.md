...
Below claims are generated by Azure Attestation and can be used by policy authors to define authorization rules in a custom policy:
...
Below parameters are defined by [IETF JWT](https://tools.ietf.org/html/rfc7519) and are included as claims in the attestation token by the service:
...
Below claims are generated by the service for SGX attestation and can be used by policy authors to define authorization rules in a custom policy:

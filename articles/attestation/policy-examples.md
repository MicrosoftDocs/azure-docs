...
Issuance rules section is not mandatory. This section can be used by the users to have additional claims generated in the attestation token with custom names. Please refer [SGX specific outgoing claims](/azure/attestation/claim-sets#outgoing-claims-specific-to-sgx-attestation) for more information on the default claims generated by the service in attestation response.

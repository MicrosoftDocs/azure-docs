...
```
Please refer [claim sets](/azure/attestation/claim-sets) for more information on the incoming claims generated by Azure Attestation. Incoming claims can be used by policy authors to define authorization rules in a custom policy.

Issuance rules section is not mandatory. This section can be used by the users to have additional outgoing claims generated in the attestation token with custom names. Please refer [claim sets](/azure/attestation/claim-sets) for more information on the outgoing claims generated by the service in attestation token.
...
Claims used in default policy are considered deprecated but are fully supported and will continue to be included in the future. It is recommended to use the non-deprecated claim names. Please refer [claim sets](/azure/attestation/claim-sets) for more information on the recommended claim names. 

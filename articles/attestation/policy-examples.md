...
Attestation policy is used to process the attestation evidence and determines whether Azure Attestation shall issue an attestation token. Attestation token generation can be controlled with custom policies.

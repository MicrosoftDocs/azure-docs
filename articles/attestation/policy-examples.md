...
Issuance rules section is not mandatory. This section can be used by the users to have additional claims generated in the attestation token with custom names. Please refer [SGX specific outgoing claims](author-sign-policy.md) for more information on the default claims generated by the service in attestation response.

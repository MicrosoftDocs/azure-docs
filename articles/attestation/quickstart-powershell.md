...
```
 ...
 > [!NOTE]
   ...
   > Please refer [unauthorized exception sceanrios with trouble shooting steps](/azure/attestation/troubleshoot-guide#1-http401--unauthorized-exception) for more information

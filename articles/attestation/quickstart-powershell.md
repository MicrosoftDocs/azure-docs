...
```
 ...
 > [!NOTE]
   ...
   > Please refer [examples of unauthorized exception scenarios with trouble shooting steps](../troubleshoot-guide#1-http401--unauthorized-exception.md) for more information

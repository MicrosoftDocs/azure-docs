...
1. In the filter box, enter the attestation provider name.
1. Select the attestation provider and go to the overview page.
1. Select **Policy signer certificates** on the resource menu on the left side of the window or on the lower pane. If you see a prompt to select certificate for authentication,  please click cancel/ choose a valid certificate option to proceed.
...
1.	In the filter box, enter the attestation provider name.
1.	Select the attestation provider and go to the overview page.
1.	Select **Policy** on the resource menu on the left side of the window or on the lower pane. If you see a prompt to select certificate for authentication, please click cancel/ choose a valid certificate option to proceed.

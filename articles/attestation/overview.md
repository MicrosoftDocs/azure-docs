...
Azure Attestation offers the following benefits:
- As an Azure service, Azure Attestation offers a Service Level Agreement (SLA).
- Azure Attestation performs attestation based on identity and ownership.Azure Attestation uses Azure Active Directory to authenticate client requests.

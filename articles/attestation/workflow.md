...
1. The client has an URI which refers to an instance of Azure Attestation. 
1. The client sends evidence to Azure Attestation. Exact information submitted to the provider depends on the enclave type.

...
You can mix communication types intuitively, for example a single call may have end-users enjoying a browser application and interacting with end-users on traditional telephony devices. To support these PSTN voice and SMS scenarios, ACS lets you acquire phone numbers quickly across a variety of geographies straight from the Azure portal or using ACS APIs and SDKs.

Communication between human users is a subset ACS' capabilities. You can build services and applications to directly interact with the data plane of the voice, video, and chat services, for example Azure Bots to support an interactive voice response systems (IVR).

<properties title="Porting guide for the C device library for Azure Intelligent Systems Service" pageTitle="Porting guide for the C device library for Azure Intelligent Systems Service" description="Learn how to port the C device libraries for ISS to an unsupported platform." metaKeywords="intelligent systems,iss" services="intelligent-systems" solutions="" documentationCenter="" authors="kevinasg" videoId="" scriptId="" manager="jillfra" />
...
# Porting guide for the C device library for Azure Intelligent Systems Service 

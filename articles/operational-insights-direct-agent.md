...
[AZURE.NOTE] For virtual machines running in Azure, install the agent by follow the steps in [Analyze data from servers in Microsoft Azure](operational-insights-analyze-data-azure.md)

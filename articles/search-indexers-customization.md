...
- [Connecting Azure SQL Database to Azure Search using indexers](http://azure.microsoft.com/documentation/articles/search-howto-connecting-azure-sql-database-to-azure-search-using-indexers-2015-02-28/)
- [Connecting DocumentDB with Azure Search using indexers](http://azure.microsoft.com/documentation/articles/documentdb-search-indexer/)

<properties 
   pageTitle="Viewing the Status of a Runbook Job"
   description="Viewing the Status of a Runbook Job"
   services="automation"
   documentationCenter=""
   authors="bwren"
   manager="stevenka"
...
# Viewing the Status of a Runbook Job
...
|Running, waiting for resources|The job has been unloaded because it reached the [fair share](../automation-runbook-execution-in-azure-automation) limit. It will resume shortly from its last checkpoint.|
...
[Get-AzureAutomationJobOutput](http://aka.ms/runbookauthor/getazurejoboutput)

...
* Create [custom locations](./custom-locations.md) as target locations for deploying App Services on Azure Arc (including web, function, and logic apps) and Event Grid on Kubernetes.

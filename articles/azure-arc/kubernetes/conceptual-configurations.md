...
>
> Support for Flux v1-based cluster configuration resources created prior to May 1, 2023 will end on [May 24, 2025](https://azure.microsoft.com/en-us/updates/migrate-your-gitops-configurations-from-flux-v1-to-flux-v2-by-24-may-2025/). During this period, there won't be any feature updates to Flux v1-based configuration resources. Starting on May 1, 2023, you won't be able to create new Flux v1-based cluster configuration resources.

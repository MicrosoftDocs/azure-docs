...
- [Grant VC Permissions to the Build Service](../devops/pipelines/scripts/git-commands.md#version-control )
- [Manage Build Service Account Permissions](../devops/pipelines/process/access-tokens.md#manage-build-service-account-permissions)

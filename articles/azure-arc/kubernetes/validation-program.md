...
| VMware       | [Tanzu Kubernetes Grid](https://tanzu.vmware.com/kubernetes-grid) | TKGm 1.4.0 upstream K8s v1.21.2+vmware.1, TKGm 1.3.1 upstream K8s v1.20.5_vmware.2, TKGm 1.2.1 upstream K8s v1.19.3+vmware.1 |

...
|`https://<region>.obo.arc.azure.com:8084/` | Required when [Azure RBAC](../azure-rbac.md) is configured. |
...
|`https://graph.microsoft.com/` | Required when [Azure RBAC](../azure-rbac.md) is configured. |
|`https://usgovvirginia.obo.arc.azure.us:8084/` | Required when [Azure RBAC](../azure-rbac.md) is configured. |

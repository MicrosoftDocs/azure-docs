...
| `https://*.his.arc.azure.com` (for Azure Cloud), `https://usgv.his.arc.azure.us` and `https://gbl.his.arc.azure.us` (for Azure US Government) |  Required to pull system-assigned Managed Service Identity (MSI) certificates. |

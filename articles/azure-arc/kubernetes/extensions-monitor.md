...
[Azure Monitor Container Insights](../../azure-monitor/containers/container-insights-overview.md) provides rich monitoring experience for Azure Arc enabled Kubernetes clusters.

[!INCLUDE [preview features note](./includes/preview/preview-callout.md)]

## Supported configurations

- Azure Monitor Container Insights supports monitoring Azure Arc enabled Kubernetes (preview) as described in the [Overview](../../azure-monitor/containers/container-insights-overview.md) article, except the live data (preview) feature. Also, users aren't required to have [Owner](../../role-based-access-control/built-in-roles.md#owner) permissions to [enable metrics](../../azure-monitor/containers/container-insights-update-metrics.md)
...
- You've met the pre-requisites listed under the [generic cluster extensions documentation](extensions.md#prerequisites).
- A Log Analytics workspace: Azure Monitor Container Insights supports a Log Analytics workspace in the regions listed under Azure [products by region page](https://azure.microsoft.com/global-infrastructure/services/?regions=all&products=monitor). You can create your own workspace through [Azure Resource Manager](../../azure-monitor/logs/resource-manager-workspace.md), [PowerShell](../../azure-monitor/logs/powershell-sample-create-workspace.md), or [Azure portal](../../azure-monitor/logs/quick-create-workspace.md).
- You need to have [Contributor](../../role-based-access-control/built-in-roles.md#contributor) role assignment on the Azure subscription containing the Azure Arc enabled Kubernetes resource. If the Log Analytics workspace is in a different subscription, then [*Log Analytics Contributor*](../../azure-monitor/logs/manage-access.md#manage-access-using-azure-permissions) role assignment is needed on the Log Analytics workspace.
- To view the monitoring data, you need to have [*Log Analytics reader*](../../azure-monitor/logs/manage-access.md#manage-access-using-azure-permissions) role assignment on the Log Analytics workspace.
...
>[!NOTE]
> The script-based version of deploying Azure Monitor Container Insights (preview) is being replaced by the [cluster extension](extensions.md) form of deployment. Azure Monitor deployed previously via script is only supported till June 2021 and it is thus advised to migrate to the cluster extension form of deployment at the earliest.
...
4. You can now choose the [Log Analytics workspace](../../azure-monitor/logs/quick-create-workspace.md) to send your metrics and logs data to.

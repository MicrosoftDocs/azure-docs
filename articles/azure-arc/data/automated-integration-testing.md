...
There are two files that need to be generated to localize the launcher to run inside a specific environment. Each of these files can be generated by cloning and filling out each of the template (`.tmpl`) files above.
...
# https://docs.microsoft.com/azure/azure-arc/kubernetes/custom-locations#enable-custom-locations-on-your-cluster
...
# https://docs.microsoft.com/azure/azure-arc/data/upload-metrics-and-logs-to-azure-monitor?tabs=windows#create-service-principal
...
#
# Steps: https://docs.microsoft.com/azure/storage/common/storage-sas-overview#account-sas
#

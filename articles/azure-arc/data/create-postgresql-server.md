...
**To deploy a Postgres server named postgres01 that uses the same storage classes as the data controller, run the following command**:

```azurecli
az postgres arc-server create -n postgres01 --k8s-namespace <namespace> --use-k8s
```

...
```
This command will create a usage.json file with all the Azure Arc enabled data resources such as SQL managed instances and PostgreSQL Hyperscale instances etc. that are created on the data controller.
...
## 2.a Upload metrics to Azure Monitor

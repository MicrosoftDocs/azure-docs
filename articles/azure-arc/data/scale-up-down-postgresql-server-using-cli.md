...
```azurecli
az postgres arc-server show -n <server name> --k8s-namespace <namespace> --use-k8s
```
### CLI with kubectl
...
```azurecli
az postgres arc-server edit -n <server name> --memory-limit/memory-request/cores-request/cores-limit <val> --k8s-namespace <namespace> --use-k8s
```
...
```azurecli
 az postgres arc-server edit -n postgres01 --cores-request 1, --cores-limit 2  --k8s-namespace arc --use-k8s
```
...
```azurecli
az postgres arc-server edit -n postgres01 --cores-request '' --k8s-namespace arc --use-k8s
az postgres arc-server edit -n postgres01 --cores-limit '' --k8s-namespace arc --use-k8s
```

or 
```azurecli
az postgres arc-server edit -n postgres01 --cores-request '' --cores-limit '' --k8s-namespace arc --use-k8s
```

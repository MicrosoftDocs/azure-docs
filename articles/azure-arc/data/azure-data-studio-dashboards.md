...
If you are using a LoadBalancer type, you'll want to copy the external IP address and port number 30080.  If you are using NodePort, you'll want to use the IP address of your Kubernetes API server and the port number listed under the PORT(S) column.

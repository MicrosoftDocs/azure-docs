...
- **Connectivity mode** - Connectivity mode determines the degree of connectivity from your Azure Arc enabled data services environment to Azure. Preview currently only supports either indirectly connected or directly connected modes. Chose one. For information, see [connectivity mode](./connectivity.md). 

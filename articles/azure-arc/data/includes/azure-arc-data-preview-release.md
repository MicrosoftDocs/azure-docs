...
|Arc Data extension for Azure Data Studio<br/>`arc`<br/>`azcli`|<br/>1.3.0 ([Download]([https://aka.ms/ads-arcdata-ext](https://azuredatastudioarcext.blob.core.windows.net/stage/arc-1.3.0.vsix)))</br>1.3.0 ([Download]([https://aka.ms/ads-arcdata-ext](https://azuredatastudioarcext.blob.core.windows.net/stage/azcli-1.3.0.vsix)))|

...
```azurecli
az postgres server-arc update --name <server group name> --admin-password --k8s-namespace <namespace> --use-k8s
```
...
2. Run the command:
   ...
   For example
   ```azurecli
   az postgres server-arc update -n postgres01 --admin-password --k8s-namespace <namespace> --use-k8s
   ```

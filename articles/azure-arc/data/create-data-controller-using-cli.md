...
To create the Azure Arc data Controller using the the Azure CLI extension,  you will need to have the CLI installed.

   [Install the CLI](install-client-tools.md)

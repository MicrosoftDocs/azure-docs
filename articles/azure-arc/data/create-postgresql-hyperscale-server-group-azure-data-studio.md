...
This document walks you through the steps for using [Azure Data Studio](https://aka.ms/getazuredatastudio) to provision Azure Arc enabled PostgreSQL Hyperscale server groups.

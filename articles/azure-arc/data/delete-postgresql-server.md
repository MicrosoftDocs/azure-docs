...
```azurecli
az postgres arc-server delete -n <server name> --k8s-namespace <namespace> --use-k8s
```
...
```azurecli
az postgres arc-server delete -n <server name> --force --k8s-namespace <namespace> --use-k8s
```

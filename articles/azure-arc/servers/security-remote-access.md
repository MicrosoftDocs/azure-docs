...
This article describes the Azure Arc connectivity platform, used for communication between the Azure Connected Machine agent and Azure, and explains how to enable and disable remote access.

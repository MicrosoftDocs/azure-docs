...
> [!NOTE]
> While creating the service principal, you need to be an Owner or User Access Administrator on the subscription that you want to use for onboarding. If you do not have sufficient permission to create role assignments, the service principal may be created but will not be able to onboard machines.

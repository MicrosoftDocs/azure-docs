...
description: Lists Azure Policy built-in policy definitions for Azure Arc enabled servers. These built-in policy definitions provide common approaches to managing your Azure resources.
ms.date: 07/10/2020
ms.topic: reference

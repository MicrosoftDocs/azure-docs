...
- Use [Update Management](../../automation/update-management/update-mgmt-overview.md) in Azure Automation to manage operating system updates for your Windows and Linux servers
    ...
    > [!NOTE]
    > At this time, enabling Update Management from the selected Arc enabled server is not supported at this time. See [Enable Update Management from your Automation account](../../automation/update-management/enable-from-automation-account.md) to understand what is required and how to enable for your server.

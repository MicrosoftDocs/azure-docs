...
> [!NOTE]
> The Desired State Configuration VM extension is no longer available for Azure Arc-enabled servers. Alternatively, we recommend [migrating to guest configuration](../../governance/policy/how-to/guest-configuration-azure-automation-migration) or using the Custom Script Extension to manage the post-deployment configuration of your server.

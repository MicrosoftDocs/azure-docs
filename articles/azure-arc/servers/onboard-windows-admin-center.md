...
This method requires that you have administrator rights on the machine to install and configure the agent. On Linux, by using the root account, and on Windows, you are member of the Local Administrators group.

...
|---------|---------|
|[Create](/rest/api/hybridcompute/machine-run-commands/create-or-update?view=rest-hybridcompute-2023-10-03-preview&tabs=HTTP) |The operation to create a run command. This runs the run command. |

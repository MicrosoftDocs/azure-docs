...
* Find out more about [planning for Windows Server and SQL Server end of support](/windows-server/extended-security-updates) and [getting Extended Security Updates](/windows-server/get-started/extended-security-updates-deploy).

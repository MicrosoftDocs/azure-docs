...
3.	Select **Remove from Azure**. 
    :::image type="Virtual Machines" source="media/switch-to-the-new-version/virtual-machines.png" alt-text="Screenshot of virtual machines.":::
...
5.	Once the resources are re-enabled, the VMs are auto switched to the new version. The VM resources will now be represented as **Machine - Azure Arc (SCVMM)**.
    :::image type="Overview" source="media/switch-to-the-new-version/overview.png" alt-text="Screenshot of Overview page.":::
## Next steps

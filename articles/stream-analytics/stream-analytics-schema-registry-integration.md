...
![Event Hubs access control](media/stream-analytics-schema-registry-integration/event-hub-access-control.png)
...
![Event Hubs configuration](media/stream-analytics-schema-registry-integration/event-hub-configuration.png)

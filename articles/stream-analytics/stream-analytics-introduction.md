...
### Security
In term of security, Azure Stream Analytics encrypts all incoming and outgoing communications with TLS 1.2. Built-in checkpoints are also encrypted. Stream Analytics doesn't store the incoming data since all processing is made in-memory. 

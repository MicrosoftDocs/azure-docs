...
There are several data errors that can only be detected after making a call to output sink can slow down processing. To resolve this, change your job's configuration or the query that is causing the data error.

...
Use this link for [Azure Portal](https://ms.portal.azure.com/?Microsoft_Azure_StreamAnalytics_bloboutputcustomdatetimeformats=true). Toggle the feature flag to enable the custom DateTime path patterns for blob storage output preview. This feature will be soon enabled in the main portal.

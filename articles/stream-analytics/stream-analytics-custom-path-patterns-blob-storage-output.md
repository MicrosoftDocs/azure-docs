...
4. If the blob output is [configured as immutable](https://docs.microsoft.com/en-us/azure/storage/blobs/storage-blob-immutable-storage), ASA will create a new blob each time data is sent.

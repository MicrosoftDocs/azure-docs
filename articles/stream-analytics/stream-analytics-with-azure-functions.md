...
The use of [Http routing](https://docs.microsoft.com/en-us/sandbox/functions-recipes/routes?tabs=csharp) on your Azure Functions is currently not supported by Stream Analytics.

...
1. See the [Create a function app](../azure-functions/functions-get-started.md#create-a-function-app) section of the Functions documentation. This section walks you through how to create a function app and an [HTTP-triggered function in Azure Functions](../azure-functions/functions-get-started.md#create-function), by using the CSharp language.  

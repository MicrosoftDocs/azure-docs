...
> [!NOTE]
> Power BI output from Stream Analytics is currently not available in the Microsoft Azure operated by 21Vianet and Azure Germany (T-Systems International) regions.

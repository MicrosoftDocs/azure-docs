...
> [!Important]
Real-time streaming in Power BI is deprecating. For more information about the retirement of real-time streaming in Power BI, see the [blog post](https://powerbi.microsoft.com/en-us/blog/announcing-the-retirement-of-real-time-streaming-in-power-bi/).
As of Oct 31,2024 new users will not be able to create Stream Analytics jobs with Power BI output connector. Your existing jobs will remain unaffected until Oct 31, 2027. Microsoft recommends users to explore Real-Time Intelligence in Microsoft Fabric. If you are interested in migrating to Fabric Real-Time Intelligence, you can use the guidance provided in this [blog post](https://techcommunity.microsoft.com/blog/analyticsonazure/simplifying-migration-to-fabric-real-time-intelligence-for-power-bi-real-time-re/4283180). If you need more migration guidance from Microsoft, such as architecture review, clarification about specific capabilities, please fill out your request [here](https://forms.office.com/r/sQeaA8KLAZ).

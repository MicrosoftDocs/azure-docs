        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Getting started with Stream Analytics with .NET Core</h3>
                    </div>
                </div>
            </div>
        </div>
...
###REST
[Stream Analytics REST API Reference](/rest/api/)

###.NET
[Stream Analytics Managed Reference](https://msdn.microsoft.com/library/azure/mt416943)

...
5.  Eliminate common pitfalls, such as:
    ...
    - A [**CAST**](/azure/stream-analytics/reference/cast-azure-stream-analytics) function fails, causing the job to fail. To avoid type cast failures, use [**TRY_CAST**](/azure/stream-analytics/reference/try-cast-azure-stream-analytics) instead.

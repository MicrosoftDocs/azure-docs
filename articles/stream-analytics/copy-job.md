...
1. Follow the [export a deployed Azure Stream Analytics job to a project instructions](https://docs.microsoft.com/en-us/azure/stream-analytics/stream-analytics-vs-tools#export-jobs-to-a-project). 

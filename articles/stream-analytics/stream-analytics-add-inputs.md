<properties
	...
	description="Learn how to hook up a data source as streaming data input from Event Hubs or reference data from Blog storage to your Stream Analytics job."
...
Learn how to hook up a data source as streaming data input or reference data to your Stream Analytics job.
...
This article is a step in the [Stream Analytics learning path](/learning-paths/stream-analytics/).

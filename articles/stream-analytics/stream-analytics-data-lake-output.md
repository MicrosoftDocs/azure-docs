<properties
	...
	description="Understand configuration of an Azure Data Lake Store in a Stream Analytics job"
	keywords=""
...
Stream Analytics 
[Azure Data Lake Store](https://azure.microsoft.com/services/data-lake-store/) is an enterprise-wide hyper-scale repository for big data analytic workloads. Data Lake Store enables you to store data of any size, type and ingestion speed for operational and exploratory analytics.

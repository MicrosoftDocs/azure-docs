...
The function returns a Record containing all 3 scores as its output. The
properties associated with the different types of anomaly detectors are called:

1.  BiLevelChangeScore
...
threshold is a tradeoff between sensitivity and confidence. For e.g., a lower
...
As noted before, do not skip the FillInMissingValuesStep step for now. Not
having that step will result in a compilation error.
...
<https://msdn.microsoft.com/en-us/library/azure/mt775197.aspx>

<https://docs.microsoft.com/en-gb/azure/machine-learning/machine-learning-apps-anomaly-detection-api>

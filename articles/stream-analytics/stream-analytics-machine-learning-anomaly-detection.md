...
> [!IMPORTANT]
> This functionality is in the process of being deprecated, but will be replaced with new functions. For more information, visit the [Eight new features in Azure Stream Analytics](https://azure.microsoft.com/en-us/blog/eight-new-features-in-azure-stream-analytics/) blog post.

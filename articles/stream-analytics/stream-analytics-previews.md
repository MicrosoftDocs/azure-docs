...
### C# custom deserializer for Azure Stream Analytics on IoT Edge and Cloud (Released May 2019)
...
### Parquet Output (Released May 2019)
...
### One-click integration with Event Hubs (Released May 2019) 
...
### Support for Azure Stack (Released May 2019)

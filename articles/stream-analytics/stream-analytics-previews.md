...
### Visual Studio Code for Azure Stream Analytics (New!)
...
### C# custom deserializer for Azure Stream Analytics on IoT Edge and Cloud (New!)

Developers can now implement custom deserializers in C# to deserialize events received by Azure Stream Analytics. Examples of formats that can be deserialized include Parquet, Protobuf, XML, or any binary format. Sign up for this preview [here](https://aka.ms/asapreview1).

...
![Create an Azure Stream Analytics project](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-create-project-01.png)

You will see a project **Toll** generated in **Solution Explorer**.

![Create an Azure Stream Analytics project](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-create-project-02.png)
...
![Define input sources](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-define-input-01.png)
...
![Define input sources](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-define-input-02.png)
 
10.	In the popped up window, choose **Azure Stream Analytics Input** and change the Name to **ExitStream.json**. Click **Add**.

![Define input sources](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-define-input-03.png)
...
![Define input sources](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-define-input-04.png)

Now you have defined two input streams.

![Define input sources](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-define-input-05.png)
...
![Define input sources](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-define-input-06.png)
...
![Define output](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-define-output-01.png)
...
![Edit query](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-query-01.png)
...
![Add local input](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-add-local-input-01.png)
 
In the pop up window select the sample data from your local path. Click **Save**.

![Add local input](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-add-local-input-02.png)
 
A file named **local_EntryStream.json** will be added automatically to your inputs folder.

![Add local input](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-add-local-input-03.png)
 
3.	Click Run Locally in query editor. Or you can press F5.

![Local run](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-local-run-01.png)

![Local run](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-local-run-02.png)

You can press any key to view the output in ASA Local Run Result window in Visual Studio. 

![Local run](./media/stream-analytics-tools-for-visual-studio/local-testing-output.png)

4.  You can open the result folder to check the output files both in CSV and JSON format.

![Local run](./media/stream-analytics-tools-for-visual-studio/local-testing-files.png)
 

### Sample input
You can also sample input data from input sources to local file. Right click the input config file and select **Sample Data**. 

![Sample data](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-sample-data-01.png)
...
![Sample data](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-sample-data-02.png)
 
You can see the progress in the Output window. 

![Sample data](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-sample-data-03.png)
 
### Submit Azure Stream Analytics query to Azure
In **Query Editor**, click **Submit To Azure in script editor**.

![Submit job](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-submit-job-01.png)
 
Choose Create a New Azure Stream Analytics Job. Input Job Name as below. Choose the correct Subscription. Click Submit.

![Submit job](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-submit-job-02.png)

 
### Start Job
Now your job has been created and job view is automatically opened. Click the **GREEN** button to start the job.

![Start job](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-start-job-01.png)
 
Choose the default setting and click **Start**.
 
![Start job](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-start-job-02.png)

You can see the job status has changed to **Running** and there are input/output events.

![Start job](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-start-job-03.png)
...
2. Click **Show Table Data** to see the output of your job.
    ...
    ![Selection of "Show Table Data" in Server Explorer](media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-check-results.jpg)


### View job metrics
Some basic job statistics can be found in **Job Metrics**. 

![Job metrics](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-job-metrics-01.png)
...
![List jobs](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-list-jobs-01.png)


## Open job view
Expand your job node and double click on the **Job View** node to open job view.

![Job view](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-job-view-01.png)
...
![Export job](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-export-job-01.png)

You will see the gererated project in **Solution Explorer**.

![Export job](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-export-job-02.png)
 
2. In job view, click **Generate Project**.

![Export job](./media/stream-analytics-tools-for-visual-studio/stream-analytics-tools-for-vs-export-job-03.png)

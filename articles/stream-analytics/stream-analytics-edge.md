...
> [!Note]
> You can create Edge jobs in all regions supported by ASA, **except in "West US" and "West US 2" regions**.
...
For more details about IoT Edge deployments, see to [this page](https://docs.microsoft.com/azure/iot-edge/module-deployment-monitoring).
...
In order to run ASA on IoT Edge, you need devices that can run [Azure IoT Edge](https://azure.microsoft.com/campaigns/iot-edge/). 

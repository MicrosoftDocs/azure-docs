...
> [!TIP]
> It is highly recommended to use [Azure Machine Learning Service UDFs](https://docs.microsoft.com/azure/machine-learning/compare-azure-ml-to-studio-classic#about-azure-machine-learning) instead of Azure Machine Learning Studio (classic) UDF for improved performance and realiability.

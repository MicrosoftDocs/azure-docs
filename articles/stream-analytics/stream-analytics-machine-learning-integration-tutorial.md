...
> [!TIP]
> It is highly recommended to use [Azure Machine Learning Service UDFs](azuremlservice-udf.md) instead of Azure Machine Learning Studio (classic) UDF for improved performance and realiability.

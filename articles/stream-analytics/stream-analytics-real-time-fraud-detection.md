...
author: enkrumah, sidramadoss
ms.author: ebnkruma, sidram
...
7. After the deployment is complete, select **Configuration** under **Settings** in your Event Hubs namespace and change the Minimum TLS version to **Version 1.0**.
   ![Change Event hub TLS configuration to version 1.0 in the Azure portal](media/stream-analytics-real-time-fraud-detection/event-hubs-tls-version.png)

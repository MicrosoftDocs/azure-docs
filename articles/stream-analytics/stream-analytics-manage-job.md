---
title: Tutorial - Analyze phone call data with Azure Stream Analytics and visualize results in Power BI dashboard
...
3. Select **Test query**.
    ...
    :::image type="content" source="media/stream-analytics-manage-job/sample-output-passthrough.png" alt-text="Sample output from test query":::

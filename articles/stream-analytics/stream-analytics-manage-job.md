---
title: "Tutorial: Create and manage a Stream Analytics job using Azure portal | Microsoft Docs"
...
2. Select **Create a resource** > **Internet of Things** > **Event Hubs**.  
   ...
   ![Create an Azure Event Hub](media/stream-analytics-manage-job/find-eh.png)
...
4. **Save** the query.  
   ...
   ![Define Stream Analytics query](media/stream-analytics-manage-job/define-query.png)

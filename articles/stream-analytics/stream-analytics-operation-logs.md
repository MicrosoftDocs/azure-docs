...
# Understand Stream Analytics operation logs
...
## Find operation logs in the Azure Classic Portal
...
In the Azure Classic Portal, click on the **Details** button at the bottom of the window to view more details about a selected event. 
...
In the Azure Classic Portal, click on the Search icon and type ‘failed’. This gives a result of all logs with failures. 

...
Please visit the following documentation for guidance on configuring Azure CLI: [Get started with Azure CLI](docs-ref-conceptual/install-azure-cli-windows.md)

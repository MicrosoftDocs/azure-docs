...
![Push Git repo](./media/stream-analytics-tools-for-vs/publishgitrepo.png)
...
![Push Git repo](./media/stream-analytics-tools-for-vs/publishcode.png)
...
![Select source](./media/stream-analytics-tools-for-vs/build-select-source.png)

2. In **Select a template**, click **Empty Process** to start with an empty definition. 
![Choose build template](./media/stream-analytics-tools-for-vs/build-select-template.png) 

3. Under **Triggers**, enable continuous integration by setting **Trigger status**.  Select **Save and queue** to manually start a build.  
![Trigger](./media/stream-analytics-tools-for-vs/build-trigger.png) 
...
![Select agent queue](./media/stream-analytics-tools-for-vs/build-agent-queue.png) 

4. In **Phase 1**, click **+** and add a **NuGet** task.
![Add a NuGet task](./media/stream-analytics-tools-for-vs/build-nuget.png) 

![Configure NuGet task](./media/stream-analytics-tools-for-vs/build-nuget-config.png) 
...
5. In **Phase 1**, click **+** and add a **MSBuild** task.
   ...
   ```
   ![Add a MSBuild task](./media/stream-analytics-tools-for-vs/build-msbuild.png) 
...
![Add an Azure Resource Group Deployment task](./media/stream-analytics-tools-for-vs/build-deploy.png)
![Set properties](./media/stream-analytics-tools-for-vs/build-deploy-2.png)
![Set override parameters](./media/stream-analytics-tools-for-vs/build-deploy-overrride-parameters.png)


7. Click **Save & Queue** to test it.
![Set override parameters](./media/stream-analytics-tools-for-vs/build-save-queue.png)
...
![Commit and push changes](./media/stream-analytics-tools-for-vs/build-push-changes.png)
...
![Commit and push changes](./media/stream-analytics-tools-for-vs/build-push-changes-2.png)

...
* [Azure Stream Analytics provides diagnostic logs and activity data for review](httphttps://docs.microsoft.com/azure/stream-analytics/stream-analytics-job-diagnostic-logs)
...
* [How to enable MFA in Azure](httphttps://docs.microsoft.com/azure/active-directory/authentication/howto-mfa-getstarted)

* [How to monitor identity and access within Azure Security Center](httphttps://docs.microsoft.com/azure/security-center/security-center-identity-access)
...
* [Understand customer data protection in Azure](httphttps://docs.microsoft.com/azure/security/fundamentals/protection-customer-data)

* [How to secure Azure Storage Accounts](httphttps://docs.microsoft.com/azure/storage/common/storage-security-guide)
...
* [How to create alerts for Azure Activity Log events](httphttps://docs.microsoft.com/azure/azure-monitor/platform/alerts-activity-log)
...
* [Understand Azure Security Center recommendations](httphttps://docs.microsoft.com/azure/security-center/recommendations-reference)
...
* [How to create queries with Azure Resource Graph](httphttps://docs.microsoft.com/azure/governance/resource-graph/first-query-portal)

* [How to view your Azure Subscriptions](httphttps://docs.microsoft.com/powershell/module/az.accounts/get-azsubscription?view=azps-3.0.0)

* [Understand Azure RBAC](httphttps://docs.microsoft.com/azure/role-based-access-control/overview)
...
* [How to configure and manage Azure Policy](httphttps://docs.microsoft.com/azure/governance/policy/tutorials/create-and-manage)

* [How to create queries with Azure Graph](httphttps://docs.microsoft.com/azure/governance/resource-graph/first-query-portal)
...
* [How to deny a specific resource type with Azure Policy](httphttps://docs.microsoft.com/azure/governance/policy/samples/not-allowed-resource-types)
...
* [How to view available Azure Policy Aliases](httphttps://docs.microsoft.com/powershell/module/az.resources/get-azpolicyalias?view=azps-3.3.0)
...
* [Understand Azure Policy Effects](httphttps://docs.microsoft.com/azure/governance/policy/concepts/effects)

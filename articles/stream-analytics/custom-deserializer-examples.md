...
Every Stream Analytics input has a **serialization format**. For more information on input options, see the [Input REST API](https://docs.microsoft.com/en-us/rest/api/streamanalytics/stream-analytics-input) documentation.

...
_Please refer to the [Device Update Error Codes](./device-update-error-codes.md#device-update-content-service) documentation for information on parsing error codes._

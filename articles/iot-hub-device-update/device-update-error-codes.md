...
This article lists error codes for Device Update for Azure IoT Hub. Error codes may originate from the Device Update agent, the Delivery Optimization agent, or the Device Update content service.
...
|--|--|--|
| UpdateAlreadyExists | Update with the same identity already exists. | Make sure you're importing an update that wasn't already imported into this instance of Device Update for IoT Hub. |
| DuplicateContentImport | Identical content imported simultaneously multiple times. | Make sure you're importing an update that wasn't already imported into this instance of Device Update for IoT Hub. |

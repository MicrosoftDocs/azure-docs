...
As the Device Update for IoT Hub service releases new versions, you'll want to update your devices for the latest features and security improvements. This article provides information about how to migrate from the [Public Preview release](../../previous-versions/azure/iot-hub-device-update) to the current, [Public Preview Refresh (PPR) release](../iot-hub-device-update). This article also explains the group and UX behavior across these releases. If you do not have devices, groups, and deployments that use the Public Preview release, you can ignore this page.

...
The update manifest is auto generated by creating an import manifest. For more information on how to generate an import manifest, [see here](https://docs.microsoft.com/en-us/azure/iot-hub-device-update/import-update).

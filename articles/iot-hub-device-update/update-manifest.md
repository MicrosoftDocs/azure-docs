...
Device Update for IoT Hub uses an _update manifest_ to communicate actions and also metadata supporting those actions through the
 ...
 Note that the update manifest is auto generated by creating an import manifest. For more information on creating an import manifest, [please see here](https://docs.microsoft.com/en-us/azure/iot-hub-device-update/import-update).

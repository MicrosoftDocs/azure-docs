...
allow the Device Update Agent to verify its authenticity. Please refer to the [Device Update security](./device-update-security.md) documentation for more information on how the update manifest is used to securely import content.

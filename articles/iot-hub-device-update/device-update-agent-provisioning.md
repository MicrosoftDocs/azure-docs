...
If you are using the Device Update agent versions 0.6.0, 0.7.0, 0.8.X, please migrate to the latest agent version 1.0.0 which is the GA version. See [GA agent for changes and how to upgrade](migration-ppr-to-ga.md)

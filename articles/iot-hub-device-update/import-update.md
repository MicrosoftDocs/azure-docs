...
> [!NOTE]
> The instructions below show how to import an update via the Azure portal UI. You can also use the [Device Update for IoT Hub APIs](https://docs.microsoft.com/en-us/rest/api/deviceupdate/updates) to import an update. 

...
- The Device Update [Import Update](/rest/api/deviceupdate/dataplane/duiothub/device-update/import-update?view=rest-deviceupdate-dataplane-duiothub-2026-06-01&preserve-view=true) REST API

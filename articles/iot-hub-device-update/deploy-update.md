...
1. View the update compliance chart and groups list. You should see a new update available for your tag based or default group. You might need to refresh once. [Learn more about update compliance](device-update-compliance.md).
...
1. Confirm the correct group is selected as the target group and click Deploy

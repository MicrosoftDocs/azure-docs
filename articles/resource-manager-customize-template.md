...
You can use either Azure PowerShell or Azure CLI to deploy the customized template and parameter files. If needed, install either [Azure PowerShell](powershell-install-configure.md) 

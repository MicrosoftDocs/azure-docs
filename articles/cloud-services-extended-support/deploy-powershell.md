...
4. Create a storage account and container which will be used to store the Cloud Service package (.cspkg) and Service Configuration (.cscfg) files. You must use a unique name for storage account name. 
...
- Create Cloud Service with role profile and SAS URIs

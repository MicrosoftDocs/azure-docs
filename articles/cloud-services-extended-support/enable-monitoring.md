...
This article explains how to enable monitoring on existing Cloud Service (extended support) deployments. For more information on enabling monitoring during deployment, see [Create a Cloud Service (extended support)](sample-create-cloud-service.md)
...
3. Select the **Alerts** blade. 
        :::image type="content" source="media/enable-monitoring-1.png" alt-text="Image shows selecting the Alerts tab in the Azure portal.":::
...
5. Input the desired conditions and required actions based on what metrics you are interested in tracking. You can define the rules based on the metrics or the activity log. 
     ...
     :::image type="content" source="media/enable-monitoring-2.png" alt-text="Image shows selecting the metrics for monitoring in the Azure portal.":::
     :::image type="content" source="media/enable-monitoring-3.png" alt-text="Image shows selecting the activity log metrics in the Azure portal.":::

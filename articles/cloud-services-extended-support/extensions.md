...
<<<<<<< HEAD
For more information, see [Configure key vault extension for Cloud Service (extended support)](/azure/cloud-services-extended-support/enable-key-vault-virtual-machine)
=======

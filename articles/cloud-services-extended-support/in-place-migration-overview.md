...
- Enables seamless platform orchestrated migration with no downtime for most scenarios. Learn more about [supported scenarios](overview.md#supported-resources-and-features-available-for-migration-associated-with-cloud-services-classic).  

...
|NetworkingInternalOperationError when deploying Cloud Service (extended support) resource| The issue may occur if the Service name is same as role name. The reccomended remidiation is to use diferent names for service and roles|

...
| Virtual Network | vnetname <br><br> Group resourcegroupname <br><br> vnetname |  Virtual network (Non-Portal Created) <br><br> Virtual Network (portal created) <br><br> Virtual Networks (Default) | vnetname <br><br> group-resourcegroupname-vnetname <br><br> DefaultRdfeVnetvnetid|
| - | - | Key Vault | csname | 

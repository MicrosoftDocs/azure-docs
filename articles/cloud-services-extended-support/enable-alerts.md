...
6. When you have finished setting up the monitoring rules and alerts, save the changes and based on the metrics configured you will begin to see the **Alerts** blade populate over time.

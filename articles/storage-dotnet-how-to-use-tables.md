...
<li>Learn how to work with Azure Storage in backend processes for Azure Websites at <a href="http://azure.microsoft.com/en-us/documentation/articles/websites-dotnet-webjobs-sdk-get-started/">Get Started with the Azure WebJobs SDK</a>.</li>

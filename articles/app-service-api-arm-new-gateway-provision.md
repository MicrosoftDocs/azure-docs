...
In this topic, you will learn how to create an Azure Resource Manager template the deploys an Azure API app and a gateway. You will learn how to define which resources are deployed and 
...
Notice that **kind** is set to **gateway** which notifies the Azure portal that this web app is hosting a gateway. The portal will hide the web app from browse web app blade. 

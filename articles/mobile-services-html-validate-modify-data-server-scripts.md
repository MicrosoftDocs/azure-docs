<properties 
	pageTitle="User server scripts to validate and modify data (HTML 5) | Mobile Dev Center" 
	description="Learn how to validate and modify data sent using server scripts from your HTML app." 

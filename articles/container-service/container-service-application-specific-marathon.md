...
[Deploy an instance of Azure Container Service](container-service-deployment.md) with orchestrator type DC/OS, [ensure that your client can connect to your cluster](container-service-connect.md), and [install the DC/OS command-line interface (CLI)](../../includes/container-service-install-dcos-cli-include.md)].

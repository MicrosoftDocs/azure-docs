...
- SSH public key – Add the public key that will be used for authentication against Azure Container Service Virtual Machines.
...
- Agent count – this will be the initial number of agents in the agent scale set.
- Agent virtual machine size – the size of the agent virtual machines.
- Master count – the number of masters in the cluster.
- DNS prefix – a unique name that will be used to prefix key parts of the service. 

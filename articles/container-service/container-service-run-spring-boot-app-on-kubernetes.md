...
# Run a Spring Boot Application on a Kubernetes Cluster in the Azure Container Service
...
[SB01]: ./media/container-service-run-spring-boot-app-on-kubernetes/SB01.png
[SB02]: ./media/container-service-run-spring-boot-app-on-kubernetes/SB02.png

[AR01]: ./media/container-service-run-spring-boot-app-on-kubernetes/AR01.png
[AR02]: ./media/container-service-run-spring-boot-app-on-kubernetes/AR02.png
[AR03]: ./media/container-service-run-spring-boot-app-on-kubernetes/AR03.png
[AR04]: ./media/container-service-run-spring-boot-app-on-kubernetes/AR04.png

[KB01]: ./media/container-service-run-spring-boot-app-on-kubernetes/KB01.png
[KB02]: ./media/container-service-run-spring-boot-app-on-kubernetes/KB02.png
[KB03]: ./media/container-service-run-spring-boot-app-on-kubernetes/KB03.png
[KB04]: ./media/container-service-run-spring-boot-app-on-kubernetes/KB04.png
[KB05]: ./media/container-service-run-spring-boot-app-on-kubernetes/KB05.png
[KB06]: ./media/container-service-run-spring-boot-app-on-kubernetes/KB06.png
[KB07]: ./media/container-service-run-spring-boot-app-on-kubernetes/KB07.png

...
- [Have an Azure DevOps Services organization and project created](https://docs.microsoft.com/vsts/organizations/accounts/create-organization-msa-or-work-student)
...
In this step, you set up a build definition for your Azure DevOps Services project and define the build workflow for your container images

### Initial definition setup

1. To create a build definition, connect to your Azure DevOps Services project and click **Build & Release**. 

1. In the **Build definitions** section, click **+ New**. Select the **Empty** template.

    ![Azure DevOps Services - New Build Definition](./media/container-service-docker-swarm-setup-ci-cd/create-build-vsts.png)
...
1. Configure the new build with a GitHub repository source, check **Continuous integration**, and select the agent queue where you registered your Linux agent. Click **Create** to create the build definition.
    ...
    ![Azure DevOps Services - Create Build Definition](./media/container-service-docker-swarm-setup-ci-cd/vsts-create-build-github.png)

...
Azure Container Service. Explore the DC/OS dashboard and Marathon services [here](dcos-swarm/container-service-mesos-marathon-ui.md). Also install the [Marathon Load Balancer](dcos-swarm/container-service-load-balancing.md).

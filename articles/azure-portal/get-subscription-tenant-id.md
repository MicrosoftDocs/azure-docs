...
> [!TIP]
> You can also find your tenant programmatically by using [Azure Powershell](/azure/active-directory-b2c/tenant-management-read-tenant-name#find-tenant-id-with-powershell) or [Azure CLI](/azure/active-directory-b2c/tenant-management-read-tenant-name#find-tenant-id-with-cli).

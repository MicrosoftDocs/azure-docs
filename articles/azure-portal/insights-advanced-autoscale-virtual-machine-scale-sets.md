...
If you want to have a simple scale in/out setting on a VM Scale Set based on a simple performance metric such as CPU, please refer to the [Linux](../virtual-machine-scale-sets/virtual-machine-scale-sets-linux-autoscale.md) and [Windows](../virtual-machine-scale-sets/virtual-machine-scale-sets-windows-autoscale.md) documents

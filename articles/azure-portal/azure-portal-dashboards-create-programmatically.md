...
Regardless of which tool you use, you’ll need to construct a JSON representation of your dashboard object before you can call any resource creation API. This object contains information about which parts (a.k.a. tiles) are on the dashboard, their sizes, positions, the resources they are bound to, and any user customizations.
...
Below there are two versions of our example dashboard JSON. The first is the version that we exported from the portal that was already bound to a resource. The second is the templatized version that can be programmatically bound to any VM and deployed using Azure Resource Manager.

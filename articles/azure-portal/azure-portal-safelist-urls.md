...
> [!TIP]
> The service tags required to access(including authentication and  resource listing) Azure portal are **AzureActiveDirectory**, **AzureResourceManager**, and **AzureFrontDoor.Frontend**. Access to other services may require additional permissions as described below.  

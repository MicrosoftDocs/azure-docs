...
You can view sample designs for implementing a DMZ between Azure and the internet using an [NVA](/architecture-center/reference-architectures/dmz/secure-vnet-dmz?toc=%2Fazure%2Fvirtual-network%2Ftoc.json) or [network security groups](virtual-networks-dmz-nsg.md).

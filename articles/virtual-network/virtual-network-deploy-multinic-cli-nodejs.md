---
title: Create a VM with multiple NICs using the Azure CLI 1.0 | Microsoft Docs
description: Learn how to create a VM with multiple NICs through Azure Resource Manager using the Azure CLI 1.0.

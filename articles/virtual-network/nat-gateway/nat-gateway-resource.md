...
When you connect your private network to Azure services such as Azure Storage, Azure SQL, Azure Cosmos DB, or other [available Azure services](../../private-link/availability.md), using [Private Link](../../private-link/private-link-overview.md) is recommended.

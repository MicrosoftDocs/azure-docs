...
A NAT gateway will  translate flow 4 to a source port that may already be in use for other destinations as well. See [Scale NAT](#scale-nat) for more discussion on correctly sizing your IP address provisioning.

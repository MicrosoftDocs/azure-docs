...
Alternatively, you can enable and on-board this data to Microsoft Sentinel or a third-party SIEM.
...
**Guidance**: Use Microsoft Defender for Cloud with Log Analytics workspace for monitoring and alerting on anomalous activity found in security logs and events. Instead, you can enable and on-board data to Microsoft Sentinel.

- [How to onboard Microsoft Sentinel](../../sentinel/quickstart-onboard.md) 

- [How to manage alerts in Microsoft Defender for Cloud](../../security-center/security-center-managing-and-responding-alerts.md) 

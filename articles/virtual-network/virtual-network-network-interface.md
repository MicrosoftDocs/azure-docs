...
| **Subnet** | Select a subnet within the virtual network you selected. | Each NIC can be assigned to only one subnet. You can change the subnet the NIC is assigned to after you create the NIC. |

...
| **Subnet** | Select a subnet within the virtual network you selected. | An individual network interface can be assigned to only one subnet. You can change the subnet the network interface is assigned to after you create the NIC. |

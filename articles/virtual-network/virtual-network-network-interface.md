...
## Associate or disocciate a network security group
...
When you're unable to communicate to or from a virtual machine, network security group security rules and/or routes effective for a network interface may be causing the problem. You have the following options to help resolve the issue:
...
5. Review the list of effective routes to determine if the correct routes exist for your required inbound and outbound communication. Learn more about what you see in the list in [Routing overview](virtual-networks-udr-overview).

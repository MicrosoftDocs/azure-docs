...
If you need to add or remove IP addresses for a NIC, read the [Add, change, or remove IP addresses for Azure network interfaces](virtual-network-network-interface-addresses.md) article. If you need to add or remove NICs to or from VMs, read the [Add or remove network interfaces to or from virtual machines](virtual-network-network-interface-vm.md) article. 

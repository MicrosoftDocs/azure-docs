...
If you’re using Azure resources through CSP, you can create a support case through your choice of CSP,  and you can request the CSP to create an unblock case on your behalf if a secure SMTP relay cannot be used.

...
If a VM image does not include a driver for the Mellanox physical NIC, networking capabilities will continue to work at the slower speeds of the virtual NIC, even though the portal, Azure CLI, and Azure Powershell will still show the Accelerated Networking feature as _enabled_.

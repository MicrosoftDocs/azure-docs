...
1. In the search box at the top of the portal, enter *route tables* in the search box. When **Route tables** appears in the search results, click it.
2. Click the route table you want to change. The most common changes are [adding](#create-a-route) or [removing](#delete-a-route) routes and [associating](#associate-a-route-table-to-a-subnet) route tables to, or [dissociating](#dissociate-a-route-table-from-a-subnet) route tables from subnets.
...
3. Click **Subnets** under **SETTINGS**.
4. Click the subnet you want to associate the route table to.
5. Click **Route table**, select the route table you want to associate to the subnet, then click **Save**.
...
3. Click **Subnets** under **SETTINGS**.
4. Click the subnet you want to dissociate the route table from.
5. Click **Route table**, select **None**, then click **Save**.
...
1. In the search box at the top of the portal, enter *route tables* in the search box. When **Route tables** appears in the search results, click it.
2. Click the route table from the list that you want to add a route to.
...
1. In the search box at the top of the portal, enter *route tables* in the search box. When **Route tables** appears in the search results, click it.
2. Click the route table you want to view details of a route for.
3. Click **Routes**.
4. Click the route you want to view details of.
...
1. In the search box at the top of the portal, enter *route tables* in the search box. When **Route tables** appears in the search results, click it.
2. Click the route table you want to change a route for.
3. Click **Routes**.
4. Click the route you want to change.
5. Change existing settings to their new settings, then click **Save**.
...
1. In the search box at the top of the portal, enter *route tables* in the search box. When **Route tables** appears in the search results, click it.
2. Click the route table you want to delete a route for.
3. Click **Routes**.
4. From the list of routes, click **...** on the right-side of the route you want to delete.
...
1. In the search box at the top of the portal, enter *network watcher* in the search box. When **Network Watcher** appears in the search results, click it.

...
| Reverse lookup of internal IPs                                                                       | Name resolution using your own DNS server                                                                                           | - [Name resolution using your own DNS server](https://msdn.microsoft.com/library/azure/jj156088.aspx#bkmk_BYODNS)  - [DNS server requirements](https://msdn.microsoft.comlibrary/azure/jj156088.aspx#bkmk_DNSserver)                                                                                                  |

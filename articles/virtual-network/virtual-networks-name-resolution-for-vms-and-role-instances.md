...
> [!NOTE]
> If you change the DNS settings for a virtual network or virtual machine that is already deployed, you need to perform a DHCP lease renewal on all affected VMs in the virtual network for the new DNS settings to take effect. 
>
>

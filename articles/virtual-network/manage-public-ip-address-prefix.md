...
description: Learn about public IP address prefixes and where to find additional information if you're not familiar with them. Also learn how to create, change, or delete one.

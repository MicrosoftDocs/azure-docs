...
- **[Azure App Service](https://docs.microsoft.com/en-us/azure/app-service/app-service-ip-restrictions)**: Preview available in all Azure regions where App service is available.

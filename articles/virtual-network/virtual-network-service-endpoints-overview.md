...
- **[Azure Data Lake Store Gen 1](../data-lake-store/data-lake-store-network-security.md?toc=%2fazure%2fvirtual-network%2ftoc.json)** (Microsoft.AzureActiveDirectory and user defined routes): Generally available in all Azure regions where ADLS Gen1 is available.
...
- For ADLS Gen 1, the VNet Integration capability is only available for virtual networks within the same region.

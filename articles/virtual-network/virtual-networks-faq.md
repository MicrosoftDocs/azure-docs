...
The [Virtual Network Overview](../articles/virtual-network/virtual-networks-overview.md) article provides a decision table that will help you decide the best network design option for you.

### How do I get started?
Visit the [Virtual Network documentation](https://azure.microsoft.com/documentation/services/virtual-network/) to get started. This content provides overview and deployment information for all the VNet features.
...
Yes. For more information about public IP address ranges, see [Public IP address space in a Virtual Network (VNet)](../articles/virtual-network/virtual-networks-public-ip-within-vnet.md). Your public IP addresses will not be directly accessible from the Internet.

### Is there a limit to the number of subnets in my virtual network?
Yes. Read the [Azure limits](../articles/azure-subscription-service-limits.md#networking-limits) article for details. All the subnets must be fully contained in the virtual network address space and cannot overlap with one another.
...
- An Azure VPN Gateway. Read the [Configure a VNet-to-VNet connection](../articles/vpn-gateway/vpn-gateway-howto-vnet-vnet-resource-manager-portal.md) article for details. 
- VNet peering. Read the [VNet peering overview](../articles/virtual-network/virtual-network-peering-overview.md) article for details.
...
Reference the [Azure limits](../articles/azure-subscription-service-limits.md#networking-limits) article for details.
...
* **Public:** Optionally assigned to NICs attached to VMs deployed through the Azure Resource Manager deployment model. The address can be assigned with the static or dynamic allocation method. All VMs and Cloud Services role instances deployed through the classic deployment model exist within a cloud service, which is assigned a *dynamic*, public virtual IP (VIP) address. A public *static* IP address, called a [Reserved IP address](../articles/virtual-network/virtual-networks-reserved-public-ip.md), can optionally be assigned as a VIP. You can assign public IP addresses to individual VMs or Cloud Services role instances deployed through the classic deployment model. These addresses are called [Instance level public IP (ILPIP](../articles/virtual-network/virtual-networks-instance-level-public-ip.md) addresses and can be assigned dynamically.
...
Yes. You can find more information in the [How to move a VM or role instance to a different subnet](../articles/virtual-network/virtual-networks-move-vm-role-to-subnet.md) article.
...
## VNets and other Azure services

### Can I use Azure App Service Web Apps with Virtual Network?
...
* [Integrate your app with an Azure Virtual Network](../articles/app-service-web/web-sites-integrate-with-vnet.md)
* [Using VNet Integration and Hybrid Connections with Web Apps](../articles/app-service-web/web-sites-integrate-with-vnet.md#hybrid-connections-and-app-service-environments)
...
Yes. You can apply [Network Security Groups](../articles/virtual-network/virtual-networks-nsg.md) to individual subnets within a VNet, NICs attached to a VNet, or both.
...
Yes. See the [Azure Network Security Overview](../articles/security/security-network-overview.md) article for details.
...
- The Azure portal to deploy VNets through the [Azure Resource Manager](../articles/virtual-network/virtual-networks-create-vnet-arm-pportal.md) and [classic](../articles/virtual-network/virtual-networks-create-vnet-classic-pportal.md) deployment models.

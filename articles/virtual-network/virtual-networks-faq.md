...
Currently it is not possible to use the Portal to establish VNet Peering (local and global) if your subscriptions belong to different Azure Active Directory tenants. Please use Azure CLI, Azure PowerShell or templates to do so.

...
| Azure Spring Cloud | [Deploy in Azure virtual network (VNet injection)](../azure/spring-cloud/spring-cloud-tutorial-deploy-in-azure-virtual-network.md)<br/>| No <br/>
| | |

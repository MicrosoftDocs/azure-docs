...
5. In **Create public IP prefix**, enter, or select the following information in the **Basics** tab:
    ...
    :::image type="content" source="./media/create-public-ip-prefix-portal/create-public-ip-prefix-ipv6.png" alt-text="Create public IPv6 address prefix in Azure portal" border="true":::

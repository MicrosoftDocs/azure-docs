---
title: Deploy multi NIC VMs using the Azure CLI in the classic deployment model | Microsoft Docs
...
Learn how to [perform these steps using the Resource Manager model](virtual-network-deploy-multinic-arm-cli.md).

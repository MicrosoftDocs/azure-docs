...
6. <a name="add-peering"></a>Enter or select values for the following settings:
    ...
    Only one peering for this virtual network can have this setting enabled.
        ...
        You cannot use remote gateways if you already have a gateway configured in your virtual network. You cannot enable this option if you're peering virtual networks in different regions.

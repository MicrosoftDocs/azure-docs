...
1. <a name="add-peering"></a>Enter or select values for the following settings, and then select **Add**.
    ...
    | Peering link name | The name of the peering from this virtual network. The name must be unique within the virtual network. |

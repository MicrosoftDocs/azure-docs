---
title: How to create NSGs in ARM mode using the Azure CLI 1.0 | Microsoft Docs
description: Learn how to create and deploy NSGs in ARM using the Azure CLI 1.0

...
- Have an adjustable inbound originated flow idle timeout of 4-30 minutes and fixed outbound originated flow idle timeout of 4 minutes.
...
- Have an adjustable inbound originated and outbound orginated flow idle timeout of 4-66 minutes.

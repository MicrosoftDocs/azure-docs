...
* **Internet** (Resource Manager) (**INTERNET** for classic): This tag denotes the public IP address space, including the IP addresses of public Azure services. The Azure public IP addresses encompassed by this tag are listed in the [Azure owned public IP space](https://www.microsoft.com/download/details.aspx?id=41653) document, which is regularly updated.

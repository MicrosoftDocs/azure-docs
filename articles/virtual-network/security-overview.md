...
* **CorpNetSAW** (Resource Manager only): This tag denotes the address prefixes of the [CorpNetSAW devices](../security/azure-security-iaas.md#use-privileged-access-workstations) operated by Azure. If you specify *CorpNetSAW* for the value, traffic is allowed or denied to CorpNetSAW. 

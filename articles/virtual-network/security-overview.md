...
* **AzureBackup**(Resource Manager only):This tag denotes the address prefixes of the AzureBackup service. If you specify AzureBackup for the value, traffic is allowed or denied to AzureBackup.

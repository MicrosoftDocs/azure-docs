...
* **ApiManagement** (Resource Manager only): This tag denotes the address prefixes of the Azure Api Management Management service. If you specify *ApiManagement* for the value, traffic is allowed or denied from the management interface of ApiManagement.  

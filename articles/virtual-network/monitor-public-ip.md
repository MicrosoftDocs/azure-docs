...
This article should be in your TOC with the name *monitor-Public IP address.md* and the TOC title "Monitor Public IP address". 
Put accompanying reference information into an article in the Reference section of your TOC with the name *monitor-Public IP-reference.md* and the TOC title "Monitoring data". 
...
See [Create diagnostic setting to collect platform logs and metrics in Azure](/azure/azure-monitor/platform/diagnostic-settings) for the detailed process for creating a diagnostic setting using the Azure portal, CLI, or PowerShell. When you create a diagnostic setting, you specify which categories of logs to collect. The categories for *Public IP address* are listed in [Public IP address monitoring data reference](monitor-public-ip-reference.md#resource-logs).
...
For a list of the platform metrics collected for Public IP address, see [Monitoring *Public IP* data reference metrics](monitor-public-ip-reference.md#metrics)  
...
The following table lists common and recommended alert rules for Public IP.
...
- See [Monitoring Public IP data reference](monitor-service-reference.md) for a reference of the metrics, logs, and other important values created by [service name].
*>.

...
| **DevOpsInfrastructure** | The IP addresses for the Management Control Plane for Managed DevOps Pools. Managed DevOps Pools VMs require Outgoing connections to these IPs to operate. | Both | No | Yes |

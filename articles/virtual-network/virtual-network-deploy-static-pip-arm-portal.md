...
6. Select a port, or no ports under **Select a public inbound ports**. Since this is a Windows virtual machine, port 3389 is selected in the following picture, to enable remote connectivity to the virtual machine from the internet. Opening port 3389 from the internet is not recommended for production workloads.

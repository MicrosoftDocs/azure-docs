...
```JSON
          {
            ...
            "properties": {
              ...
              "sourceAddressPrefix": "2001:db8:1234:5678::/64",
              "destinationAddressPrefix": "fd12:3456:789a:bcde:/64",
              "access": "Allow",
              "priority": 1003,
              "direction": "Inbound"
            }
        ...
        "routes": [
          {
            "name": "v6route",
            "properties": {
              "addressPrefix": "fd12:3456:789a:bcde::/64",
              "nextHopType": "VirtualAppliance",
              "nextHopIpAddress": "2001:db8:1234:5678::1"
            }
```

...
Create a resource group in the desired location for provisioning the global range resource. Note that although the global range will be associated with a region, the prefix will be advertised by the Microsoft WAN to the Internet globally.

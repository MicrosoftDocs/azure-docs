...
> [!IMPORTANT]
> There are several differences between how custom IPv4 and IPv6 prefixes are onboarded and utilized.  Please see [Differences between using BYOIPv4 and BYOIPv6](create-custom-ip-address-prefix-portal.md#differences-between-using-byoipv4-and-byoipv6) for more details.

...
:::image type="content" source="./media/routing-preference-unmetered/unmetered.png" alt-text="Screenshot of routing preference unmetered diagram showing direct connectivity between CDN provider and Azure origin.":::
...
:::image type="content" source="./media/routing-preference-unmetered/storage-endpoints.png" alt-text="Screenshot of routing preference for storage accounts showing dual endpoints configuration.":::

...
The command will create a zone-redundant public IP address. To create a zonal or public IP address with no zone, see the instructions later in this article.
...
Use [az network public-ip create](/cli/azure/network/public-ip#az_network_public_ip_create) to create a standard public IPv4 address as a non-zonal resource named **myStandardPublicIP** in **QuickStartCreateIP-rg**. 

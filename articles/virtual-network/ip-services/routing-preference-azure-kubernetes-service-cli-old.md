...
2. In the search box at the top of the portal, enter **Public IP address**. In the search results select **Public IP addresses**.

3. Select **myPublicIP-IR** in **Public IP addresses**.

...
- [Public load balancer](configure-public-ip-load-balancer)
- [Cross-region load balancer](../../load-balancer/tutorial-cross-region-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
- [Application Gateway](configure-public-ip-application-gateway)
- [Site-to-site connection using a VPN gateway](configure-public-ip-vpn-gateway)
- [NAT gateway](configure-public-ip-nat-gateway)
- [Azure Bastion](configure-public-ip-bastion)
- [Azure Firewall](configure-public-ip-firewall)

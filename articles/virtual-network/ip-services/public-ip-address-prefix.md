...
Resource|Scenario|Steps|
|---|---|---|
|Virtual machine scale sets | You can use a public IP address prefix to generate instance-level IPs in a virtual machine scale set, though individual public IP resources won't be created. | Use a [template](https://azure.microsoft.com/resources/templates/vmms-with-public-ip-prefix/) with instructions to use this prefix for public IP configuration as part of the scale set creation. |

...
Use [az network nic ip-config update](/cli/azure/network/nic/ip-config?view=azure-cli-latest#az_network_nic_ip_config_update) to update the network interface configuration.

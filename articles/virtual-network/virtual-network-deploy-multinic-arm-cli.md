...
You can complete this task using the Azure CLI 2.0 (this article) or the [Azure CLI 1.0](../virtual-machines/linux/multiple-nics-nodejs.md). The values in "" for the variables in the steps that follow create resources with settings from the scenario. Change the values, as appropriate, for your environment.

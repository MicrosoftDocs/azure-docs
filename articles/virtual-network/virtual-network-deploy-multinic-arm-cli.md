---
title: Create a VM with multiple NICs using the Azure CLI | Microsoft Docs
description: Learn how to create a VM with multiple NICs through Azure Resource Manager using the Azure CLI.

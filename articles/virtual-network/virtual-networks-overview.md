...
## <a name = "internet"></a>Connecting to the Internet
...
## <a name="within-vnet"></a>Connecting Azure resources
...
## <a name="connect-vnets"></a>Connecting virtual networks
...
## <a name="connect-on-premises"></a>Connecting to an on-premises network
...
## <a name="filtering"></a>Filtering network traffic
...
## <a name="routing"></a>Routing network traffic

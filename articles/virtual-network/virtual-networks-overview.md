...
* **Name resolution**. Azure provides [internal name resolution](../virtual-machines/virtual-machines-linux-static-dns-name-resolution-for-linux-on-azure.md) for IaaS VMs and PaaS role instances deployed in your VNet. You can also deploy your own DNS servers and configure the VNet to use them.

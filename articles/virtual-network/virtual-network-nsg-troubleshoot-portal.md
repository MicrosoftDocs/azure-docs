...
1. Login to the Azure portal at https://portal.azure.com with an Azure account. Your account must be assigned the *Microsoft.Network/networkInterfaces/effectiveNetworkSecurityGroups/action* action. To learn how to assign actions to accounts, see [Create custom roles for Azure Role-Based Access Control](../active-directory/role-based-access-control-custom-roles?toc=%2fazure%2fvirtual-network%2ftoc.json#actions).

...
You may experience VM or VPN connectivity issues and errors when using a 3rd party Network Virtual Appliance (NVA) in Microsoft Azure. This article provides basic steps to help you validate basic Azure Platform requirements for NVA configurations.

...
A VNet is created within the scope of a region. Vnets in same or different regions can be peered (connected) together as long as thier address prefixes are non-overlapping.  

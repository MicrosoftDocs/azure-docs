---
title: Create a VM with a static public IP using the Azure CLI 2.0 | Microsoft Docs
description: Learn how to create a VM with a static public IP address using the Azure CLI 2.0. | Resource Manager.
...
---
# Create a VM with a static public IP using the Azure CLI 2.0

...
|[Tutorial: Create and test a NAT gateway - Azure CLI](../virtual-network/nat-gateway/tutorial-create-nat-gateway-cli.md)|Create and validate a NAT gateway using a source and destination virtual machine. |

...
> [!IMPORTANT]
> Virtual environment is for exploration and evaluation only. For more information, see [validated environments](/azure/iot-operations/deploy-end-to-end-sample/overview-iot-operations#validated-environments) for Azure IoT Operations Preview.
...
1. Create Linux VMs in level 3 and level 4. 
    - Refer to [validated environments](/azure/iot-operations/deploy-end-to-end-sample/overview-iot-operations#validated-environments) for specification of the VM.

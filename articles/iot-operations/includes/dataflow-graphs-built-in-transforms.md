...
| [Throttle](../connect-to-cloud/howto-dataflow-graphs-throttle.md) | `azureiotoperations/graph-dataflow-throttle:1.0.0` | Limit the message rate per MQTT topic pattern. |

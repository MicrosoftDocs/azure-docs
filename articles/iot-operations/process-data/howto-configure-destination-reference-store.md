...
description: Configure a pipeline destination stage to send the pipeline output to the reference data store to use to contextualize messages in other pipelines using the data processor.
author: dominicbetts
ms.author: dobett
...
# Send data to the reference data store using the data processor
...
To configure and use an Azure Data Explorer destination pipeline stage, you need a deployed instance of the data processor that includes the optional data processor component.

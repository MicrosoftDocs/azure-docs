...
To monitor container workload performance, complete the steps to [enable container insights](../../azure-configure-observability-monitoring/containers/container-insights-onboard.md).
...
1. Configure an [Azure Monitor managed service for Prometheus as a data source for Azure Managed Grafana](../../azure-configure-observability-monitoring/essentials/prometheus-grafana.md).

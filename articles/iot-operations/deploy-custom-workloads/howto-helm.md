...
* An Arc-enabled Kubernetes cluster with Azure IoT Orchestrator deployed to it. For more information, see [Deploy Azure IoT Operations](../deploy-azure-iot-operations//howto-deploy-iot-operations.md).

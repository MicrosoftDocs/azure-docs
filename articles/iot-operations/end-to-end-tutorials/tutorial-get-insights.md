...
>[!TIP]
>If data has not arrived in your eventstream, you may want to check your event hub activity to [verify that it's receiving messages](quickstart-configure#verify-data-is-flowing-to-event-hubs). This will help you isolate which section of the flow to debug.

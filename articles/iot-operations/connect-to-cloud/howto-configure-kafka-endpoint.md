...
1. This [single Bicep template file](https://github.com/Azure-Samples/explore-iot-operations/blob/main/samples/quickstarts/kafka-df.bicep) from the *explore-iot-operations* repository deploys a sample dataflow and dataflow endpoint resources for Azure Event Hub. Download the template file and customize it according to your environment.

...
| Snappy | Snappy compression is not supported by [Azure Event Hubs](/azure/event-hubs/event-hubs-for-kafka-ecosystem-overview). | No. Use [Apache Kafka](https://kafka.apache.org) |
| LZ4 | LZ4 compression is not supported by [Azure Event Hubs](/azure/event-hubs/event-hubs-for-kafka-ecosystem-overview). | No. Use [Apache Kafka](https://kafka.apache.org) |

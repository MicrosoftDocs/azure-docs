...
- [An eventstream](/fabric/real-time-intelligence/event-streams/create-manage-an-eventstream#create-an-eventstream).
...
resource fabricRealtimeEndpoint 'Microsoft.IoTOperations/instances/dataflowEndpoints@2026-07-01' = {
  parent: aioInstance
  name: endpointName
  extendedLocation: {

...
- TLS: Enabled
- Trusted CA certificate: The default CA certificate `azure-iot-operations-aio-ca-trust-bundle` from the [default root CA](../deploy-iot-ops/deployment-planning-certificates.md#default-self-signed-issuer-and-root-ca-certificate)

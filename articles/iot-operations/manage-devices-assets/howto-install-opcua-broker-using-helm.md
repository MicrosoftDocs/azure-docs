...
| `opcPlcSimulation.pullPolicy`                | false    | Enumeration      | `Always`                                                | Image pull policy for OPC PLC [IfNotPresent, Always, Never]                                                                                                           |
...
| `supervisor.pullPolicy`                      | false    | Enumeration      | `Always`                                                | Image pull policy for Edge Application Supervisor [IfNotPresent, Always, Never]                                                                                       |
...
| `admissionController.pullPolicy`             | false    | Enumeration      | `Always`                                                | Image pull policy for admission controller [IfNotPresent, Always, Never]                                                                                              |

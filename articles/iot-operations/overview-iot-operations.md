...
* Data flows subscribe to MQTT topics to retrieve messages for processing before sending them to cloud endpoints.
...
| Tanzu Kubernetes release (TKr) on Tanzu Kubernetes Grid 2.5.2| TKr version 1.28.11| General availability|

---
title: "Quickstart: Develop an edge app with Azure IoT Operations SDKs"
description: "Quickstart: Develop an edge app with Azure IoT Operations SDKs to reduce message frequency and size on the edge for efficient data handling."
author: asergaz
ms.author: sergaz
ms.topic: quickstart
ms.date: 04/17/2025

#customer intent: As a developer, I want develop an edge application and deploy it to the Azure IoT Operations cluster.

---

# Quickstart: Develop an edge app with Azure IoT Operations SDKs for efficient data handling

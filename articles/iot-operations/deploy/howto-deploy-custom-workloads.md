...
Once you have Azure IoT Operations deployed to a connected cluster, you can use Azure IoT Orchestrator to deploy custom workloads. This article shows examples for deploying a K8s custom resource and a Helm chart to an Arc-enabled Kubernetes cluster.
...
The following is a Bicep template that deploys a K8s ConfigMap:
...
resource helmChart 'Microsoft.Symphony/targets@2023-05-22-preview' = {

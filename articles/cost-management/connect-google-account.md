---
title: Connect a Google Cloud Platform account to Cloudyn | Microsoft Docs
description: Connect a Google Cloud Platform account to view cost and usage data in Cloudyn repots.

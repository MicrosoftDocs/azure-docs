...
This tutorial shows you how to provision the remote monitoring solution accelerator. You deploy the solution using the CLI. You can also deploy the solution using the web-based UI at azureiotsuite.com, to learn about this option see [Deploy the remote monitoring solution accelerator](iot-solutions-remote-monitoring-deploy.md).

...
This tutorial shows you how to provision the remote monitoring solution accelerator. You deploy the solution from azureiotsuite.com. You can also deploy the solution using the CLI, to learn about this option see [Deploy a solution accelerator from the command line](iot-solutions-remote-monitoring-deploy-cli.md).
...
1. Click **Try Now** on the **Remote Monitoring** tile.
    ...
    ![Choose remote monitoring](./media/iot-solutions-remote-monitoring-deploy/remotemonitoring.png)
...
1. Click **Create Solution** to begin the provisioning process. This process typically takes several minutes to run:
    ...
    ![Remote Monitoring solution details](./media/iot-solutions-remote-monitoring-deploy/createform.png)
...
1. On the **Provisioned solutions** page, choose your new remote monitoring solution:
    ...
    ![Choose new solution](./media/iot-solutions-remote-monitoring-deploy/choosenew.png)
...
1. You can view information about your remote monitoring solution in the panel that appears. Choose **Solution dashboard** to connect to your remote monitoring solution.
    ...
    ![Solution panel](./media/iot-solutions-remote-monitoring-deploy/solutionpanel.png)

...
The article [Azure and the Internet of Things](iot-solutions-what-is-azure-iot.md) describes a typical IoT solution architecture with the following layers:
...
* [Azure IoT solution accelerators](../active-directory-domain-services/index.md) is an enterprise-grade collection of [solution accelerators](iot-solutions-what-are-solution-accelerators.md) built on Azure Platform-as-a-Service (PaaS) that enable you to accelerate the development of custom IoT solutions.
...
* **Azure IoT solution accelerators**: [What are the Azure IoT solution accelerators?](iot-solutions-what-are-solution-accelerators.md)

...
![Alerts showing on the dashboard](./media/iot-solutions-remote-monitoring-maintain/dashboardalarm.png)

To investigate the issue further, choose the **Explore Alert** option next to the alert:

![Explore alert from the dashboard](./media/iot-solutions-remote-monitoring-maintain/dashboardexplorealarm.png)
...
![Alert details](./media/iot-solutions-remote-monitoring-maintain/maintenancealarmdetail.png)
...
![Acknowledge the alerts](./media/iot-solutions-remote-monitoring-maintain/maintenanceacknowledge.png)
...
![List the devices causing the alert](./media/iot-solutions-remote-monitoring-maintain/maintenanceresponsibledevice.png)
...
![View the methods the device supports](./media/iot-solutions-remote-monitoring-maintain/maintenancemethods.png)

Choose **DecreaseTemperature** and set the job name to **DecreaseTemperature**. Then choose **Apply**:

![Create the job to decrease the temperature](./media/iot-solutions-remote-monitoring-maintain/maintenancecreatejob.png)
...
![Monitor the job to decrease the temperature](./media/iot-solutions-remote-monitoring-maintain/maintenancerunningjob.png)

To view the details of a specific job or method call, choose it in the list in the **Jobs** view:

![View job details](./media/iot-solutions-remote-monitoring-maintain/maintenancejobdetail.png)
...
Now you have learned how to manage device issues, the suggested next step is to learn how to [Test your solution with simulated devices](iot-solutions-remote-monitoring-test.md).

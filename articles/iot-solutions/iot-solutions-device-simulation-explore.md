...
If you haven't deployed Device Simulation yet, you should complete the [Deploy Azure IoT Device Simulation](iot-solutions-device-simulation-deploy.md) tutorial.
...
![Target IoT Hub](./media/iot-solutions-device-simulation-explore/targethub.png)
...
![Target IoT hub](./media/iot-solutions-device-simulation-explore/connectionstring.png)
...
![Device model](./media/iot-solutions-device-simulation-explore/devicemodel.png)
...
![Add sensors](./media/iot-solutions-device-simulation-explore/customsensors.png)
...
![Number of devices](./media/iot-solutions-device-simulation-explore/numberofdevices.png)
...
![Telemetry frequency](./media/iot-solutions-device-simulation-explore/frequency.png)
...
![Simulation duration](./media/iot-solutions-device-simulation-explore/duration.png)
...
![Start simulation](./media/iot-solutions-device-simulation-explore/start.png)
...
![Stop simulation](./media/iot-solutions-device-simulation-explore/stop.png)

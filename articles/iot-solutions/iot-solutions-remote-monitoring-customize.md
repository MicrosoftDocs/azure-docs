...
1. Deploy a **basic** instance of the solution accelerator using the **pcs** CLI. Make a note of the name of your deployment and the credentials you provided for the virtual machine. For more information, see [Deploy using the CLI](iot-solutions-remote-monitoring-deploy-cli.md).
...
![Change panel layout](./media/iot-solutions-remote-monitoring-customize/layout.png)
...
![Multiple telemetry panels](./media/iot-solutions-remote-monitoring-customize/multiple-telemetry.png)
...
![Alarms panel updated](./media/iot-solutions-remote-monitoring-customize/reorder-columns.png)
...
![Telemetry chart showing one day](./media/iot-solutions-remote-monitoring-customize/telemetry-period.png)
...
![Warning KPI](./media/iot-solutions-remote-monitoring-customize/new-kpi.png)
...
For more information about customizing the Remote Monitoring solution, see [Customize and redeploy a microservice](iot-solutions-microservices-example.md)

...
See also, the general [FAQ](iot-solutions-faq.md) for IoT solution accelerators.
...
![Bing key](./media/iot-solutions-faq-cf/bing.png)
...
1. [Configure a new station in the Connected Factory topology](iot-solutions-connected-factory-configure.md) in the `ContosoTopologyDescription.json` file.

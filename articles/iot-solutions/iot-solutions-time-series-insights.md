...
* [Deploy the Remote Monitoring preconfigured solution](iot-solutions-remote-monitoring-deploy.md)
...
1. Select **Create a resource** > **Internet of Things** > **Time Series Insights**.
    ...
    ![New Time Series Insights](./media/iot-solutions-time-series-insights/new-time-series-insights.png)
...
1. To create your Time Series Insights environment, use the values in the following table:
    ...
    ![Create Time Series Insights](./media/iot-solutions-time-series-insights/new-time-series-insights-create.png)
...
1. On the left, select **Event Sources**.
    ...
    ![View Event Sources](./media/iot-solutions-time-series-insights/time-series-insights-event-sources.png)

1. Click **Add**.

    ![Add Event Source](./media/iot-solutions-time-series-insights/time-series-insights-event-sources-add.png)
...
1. To configure your IoT hub as a new event source, use the values in the following table:
    ...
    ![Create Event Source](./media/iot-solutions-time-series-insights/time-series-insights-event-source-create.png)
...
1. Click **Go To Environment**, which will open the Time Series Insights explorer web app.
    ...
    ![Time Series Insights Explorer](./media/iot-solutions-time-series-insights/time-series-insights-environment.png)

1. In the time selection panel, select **Last 12 Hours** from the quick times menu and click **Search**.

    ![Time Series Insights Explorer Search](./media/iot-solutions-time-series-insights/time-series-insights-search-time.png)
...
1. In the terms panel on the left, select a Measure value of **temperature** and a Split By value of **iothub-connection-device-id**.
    ...
    ![Time Series Insights Explorer Query](./media/iot-solutions-time-series-insights/time-series-insights-query1.png)

1. Right-click on the chart and select **Explore events**.

    ![Time Series Insights Explorer Events](./media/iot-solutions-time-series-insights/time-series-insights-explore-events.png)

1. The events are rendered in the grid in tabular format.

    ![Time Series Insights Explorer Table](./media/iot-solutions-time-series-insights/time-series-insights-table.png)

1. Click the perspective view button.

    ![Time Series Insights Explorer Perspective](./media/iot-solutions-time-series-insights/time-series-insights-explorer-perspective.png)

1. Click **Add** to create a new query in the perspective.

    ![Time Series Insights Explorer Add Query](./media/iot-solutions-time-series-insights/time-series-insights-new-query.png)

1. Select a quick time of **Last 12 Hours**, a Measure of **Humidity** and a Split By of **iothub-connection-device-id**.

    ![Time Series Insights Explorer Query](./media/iot-solutions-time-series-insights/time-series-insights-query2.png)

1. Click the perspective view button to view your dashboard of device metrics.

    ![Time Series Insights Explorer Dashboard](./media/iot-solutions-time-series-insights/time-series-insights-dashboard.png)

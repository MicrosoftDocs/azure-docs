...
>[!div class="checklist"]
> * [Deploy the remote monitoring preconfigured solution locally](iot-solutions-remote-monitoring-deploy-local.md)
...
![Alive and Well Postman Message](./media/iot-solutions-microservices-example/postman-alive-well.png)
...
![Successful docker image](./media/iot-solutions-microservices-example/successful-docker-image.png)
...
![Docker image in docker hub](./media/iot-solutions-microservices-example/docker-image-in-docker-hub.png)
...
![New Edits Made Here postman message](./media/iot-solutions-microservices-example/new-postman-message.png)
...
The next thing to try is [customizing the device simulator microservice in the Remote Monitoring solution](iot-solutions-remote-monitoring-test.md)

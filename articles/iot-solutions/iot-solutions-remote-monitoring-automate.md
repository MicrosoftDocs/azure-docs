...
![Rules and Actions page](./media/iot-solutions-remote-monitoring-automate/rulesactions_v2.png)

To view only the rules that apply to **Chiller** devices, apply a filter:

![Filter the list of rules](./media/iot-solutions-remote-monitoring-automate/rulesactionsfilter_v2.png)

You can view more information about a rule and edit it when you select it in the list:

![View rule details](./media/iot-solutions-remote-monitoring-automate/rulesactionsdetail_v2.png)

To disable, enable, or delete one or more rules, select multiple rules in the list:

![Select multiple rules](./media/iot-solutions-remote-monitoring-automate/rulesactionsmultiselect_v2.png)

## Create a new rule

To add a new rule that generates a warning when the pressure in a **Chiller** device exceeds 150 PSI, choose **New rule**:

![Create rule](./media/iot-solutions-remote-monitoring-automate/rulesactionsnewrule_v2.png)
...
![Create mult rule](./media/iot-solutions-remote-monitoring-automate/rulesactionsnewrule_mult_v2.png)
...
![Create condition 2](./media/iot-solutions-remote-monitoring-automate/rulesactionsnewrule_mult_cond2_v2.png)
...
![Edit rule](./media/iot-solutions-remote-monitoring-automate/rulesactionsedit_v2.png)
...
![Disable rule](./media/iot-solutions-remote-monitoring-automate/rulesactionsdisable.png)
...
* [Manage and configure your devices](./../iot-suite/iot-suite-remote-monitoring-manage.md).
* [Troubleshoot and remediate device issues](./../iot-suite/iot-suite-remote-monitoring-maintain.md).
* [Test your solution with simulated devices](../iot-suite/iot-suite-remote-monitoring-test.md).

...
To provide an extensible way to manage and configure devices, the remote monitoring solution uses IoT Hub features such as [jobs](../iot-hub/iot-hub-devguide-jobs.md) and [direct methods](../iot-hub/iot-hub-devguide-direct-methods.md). To learn how a device developer implements methods on a physical device, see [Customize the remote monitoring solution accelerator](iot-solutions-remote-monitoring-customize.md).
...
![Provision a simulated device](./media/iot-solutions-remote-monitoring-manage/devicesprovision.png)
...
![Provision a simulated engine device](./media/iot-solutions-remote-monitoring-manage/devicesprovisionengine.png)
...
![View the new simulated engine device](./media/iot-solutions-remote-monitoring-manage/devicesviewnew.png)
...
![Select a telemetry stream to view](./media/iot-solutions-remote-monitoring-manage/devicesvibration.png)
...
![Engine methods](./media/iot-solutions-remote-monitoring-manage/devicesmethods.png)

Choose **FillTank**, set the job name to **FillEngineTank**, and then choose **Apply**:

![Schedule the restart method](./media/iot-solutions-remote-monitoring-manage/devicesrestartengine.png)

To track the status of the job on the **Maintenance** page, choose **Jobs**:

![Monitor the schedules job](./media/iot-solutions-remote-monitoring-manage/maintenancerestart.png)
...
![Reconfigure a device](./media/iot-solutions-remote-monitoring-manage/devicesreconfigure.png)

To make a change, add a name for the job, update the property values, and choose **Apply**:

![Update a device property value](./media/iot-solutions-remote-monitoring-manage/devicesreconfigurephysical.png)

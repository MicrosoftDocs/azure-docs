...
Now you have learned how to customize the device simulation service. The suggested next step is to learn how to [connect a physical device to your remote monitoring solution](iot-solutions-connecting-devices-node.md).

...
![Allocation Diagram](http://acom.azurecomcdn.net/80C57D/blogmedia/blogmedia/2015/03/17/AllocationBlogPost1.png)
...
![Pinned Allocation Failure](http://acom.azurecomcdn.net/80C57D/blogmedia/blogmedia/2015/03/17/AllocationBlogPost2.png)
...
![Pinned Allocation Taxonomy](http://acom.azurecomcdn.net/80C57D/blogmedia/blogmedia/2015/03/17/AllocationBlogPost3.png)

> [AZURE.NOTE] The error listed in each allocation scenario is a short form. Refer to the [Appendix](https://github.com/JiangChen79/azure-content/blob/master/allocationfailure.md/#Appendix) for detailed error strings.
...
If you do not need the Affinity Group, create a new Regional Virtual Network for the new resources you're adding, and then [connect your existing VNet to the new VNet](https://msdn.microsoft.com/en-us/library/azure/dn690122.aspx). See more about [Regional Virtual Network](http://azure.microsoft.com/blog/2014/05/14/regional-virtual-networks/).

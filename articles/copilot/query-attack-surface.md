---
title: Query your attack surface with Defender EASM using Microsoft Copilot in Azure (preview)
description: Learn how Microsoft Copilot in Azure (preview) can help query Attack Surface Insights from Defender EASM.
ms.date: 04/25/2024
ms.topic: conceptual
...
# Query your attack surface with Defender EASM using Microsoft Copilot in Azure (preview)
...
When you ask Microsoft Copilot in Azure (preview) about your attack surface, it automatically pulls context when possible, based on the current conversation or on the page you're viewing in the Azure portal. If the context isn't clear, you'll be prompted to specify which Defender EASM resource to use.

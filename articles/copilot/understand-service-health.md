---
title: Understand service health events and status using Microsoft Copilot in Azure (preview)
description: Learn about scenarios where Microsoft Copilot in Azure (preview) can provide information about service health events.
ms.date: 05/21/2024
ms.topic: conceptual
...
# Understand service health events and status using Microsoft Copilot in Azure (preview)
...
:::image type="content" source="media/understand-service-health/azure-service-health-outage-planned-maintenance.png" alt-text="Screenshot of Microsoft Copilot in Azure (preview) providing information about service issues and planned maintenance.":::

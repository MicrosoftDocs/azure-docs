...
|   |POC1|POC2|
|---------|---------|---------|
|Vnet name     |VNET-01|VNET-02 |
|Vnet address space |10.0.10.0/23|10.0.20.0/23|
|Subnet name     |Subnet-01|Subnet-02|
|Subnet address |10.0.10.0/24 |10.0.20.0/24 |
...
6. In the **IP address** field, type the External BGPNAT address for POC2 that you recorded earlier.
...
5. Select the **Subscription**, **Resource Group** and **Location** and
   click **OK**.
6. In the **Settings** blade, choose **GW1** as the virtual network gateway.
7. Choose the **POC2-GW** as the local network gateway.
...
7. In the **IP address** field, type the External BGPNAT address for POC1 that you recorded earlier..
...
5. Select the **Subscription**, **Resource Group** and **Location** and
   click **OK**.
6. In the **Settings** blade, choose **GW2** as the virtual network gateway..
7. Choose the **POC1-GW** as the local network gateway.
...
### Configure the NAT
You need to follow this procedure for **both** POC environments.
...
6. Click the **Start** menu, right-click **Windows PowerShell**, and select

...
## Install the module
1. Install the required version of the AzureRM PowerShell module, as described in Step 1 of [Install PowerShell for Azure Stack.](azure-stack-powershell-install.md#install-the-required-version).   

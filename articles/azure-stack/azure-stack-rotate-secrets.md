...
|Installed Certificates' CA|CA to Rotate To|Supported?|Azure Stack Versions Supported?|
|-----|-----|-----|-----|-----|
...
<sup>*</sup> Here Public Certificate Authorities are those that are part of the Windows Trusted Root Program. You can find the full list here: https://gallery.technet.microsoft.com/Trusted-Root-Certificate-123665ca

...
1. Make sure you complete all [set up steps before you deploy](azure-stack-sql-rp-deploy-long.md#set-up-steps-before-you-deploy) the resource provider:
   ...
   * In Internet Explorer security settings on the ClientVM, [Internet Explorer enhanced security is turned off and cookies are enabled](azure-stack-sql-rp-deploy-long.md).
...
3. [Run bootstrap.cmd and scripts](azure-stack-sql-rp-deploy-long.md).

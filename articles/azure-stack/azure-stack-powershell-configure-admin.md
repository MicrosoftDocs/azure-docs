...
Run the following prerequisites either from the [development kit](.\asdk\asdk-connect.md#connect-to-azure-stack-with-remote-desktop) or from a Windows-based external client if you are [connected to the ASDK through VPN](.\asdk\asdk-connect.md#connect-to-azure-stack-with-vpn). 

...
4. To review the status of your resource provider deployment in the portal, click **Browse**, click **Resource Groups**, choose the resource group with the name **Microsoft.MySQL-RP1** (name of the resource group generated by the deployment scripts). The Last deployment status should be **Succeeded**.

5. To see your resouirce provider in the portal, click **Browse**, click **Resource Providers**, choose the resource provider with the name **MYSQL-LOCAL** (name of the resource provider generated by the deployment scripts).

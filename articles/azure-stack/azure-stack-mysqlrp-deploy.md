...
5. To see your resouirce provider in the portal, click **Browse**, click **Resource Providers**, choose the resource provider with the name **MYSQL-LOCAL** (the name of the resource provider generated by the deployment scripts).

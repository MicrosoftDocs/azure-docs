...
1. On the Azure Stack POC computer, log in to `https://publicportal.local.azurestack.global` as [an admin](azure-stack-connect-azure-stack.md), and then click **New** > **Data + Storage** > **Storage account**.

...
For anything else, contact Microsoft Support. As an Azure Stack operator for a cloud service provider or enterprise, you must open a support request on behalf of your users. Your users should not contact Support directly.

...
1. On the Azure Stack POC computer, log in to `https://publicportal.local.azurestack.global` as [a tenant](azure-stack-connect-azure-stack.md) and click **Get a Subscription**.

...
This article describes the end-to-end customer experience from purchasing an Azure Stack integrated solution through to a successful on-site deployment by a solution provider. Use this information to ease your journey and to help set expectations on what you, as an Azure Stack customer, should expect when integrating Azure Stack into your datacenter.
...
-   What are the power and cooling requirements?
    ...
    Note that the spreadsheet is *not* intended to be used as a substitute to your own investigation and analysis for hardware solutions that best suit your needs.
...
### Azure Stack connection model and identity provider
...
During this phase, there are steps that must be performed by the partner before being handed off to the customer. In post deployment, validation is important to ensuring the system is deployed and performing correctly. 
...
-   If deployment was completed using [AD FS](https://docs.microsoft.com/en-us/azure/azure-stack/azure-stack-integrate-identity), then the Azure Stack stamp will need to be integrated with customer's own AD FS.
...
-   Integration with an existing monitoring system from the respective partner.
    ...
    -   [System Center Operations Manager Integration](https://docs.microsoft.com/en-us/azure/azure-stack/azure-stack-integrate-monitor) also supports fleet management capabilities.
...
The integrated support experience makes use of a Case Exchange mechanism for bi-directional transfer of support cases and case updates between Microsoft and the Hardware partner. Microsoft Azure Stack will follow the [Modern Lifecycle policy](https://support.microsoft.com/en-us/help/30881).

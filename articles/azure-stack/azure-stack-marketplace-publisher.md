...
## Prerequisites
 ...
 - You must run the toolkit on the Azure Stack host or have [VPN](.\asdk\asdk-connect.md#connect-to-azure-stack-with-vpn) connectivity to the ASDK host from the machine on which you run the tool.

...
6. Create a [service principal](../azure-stack-create-service-principals.md) to work with Azure Stack. Make sure your service principal has [contributor/owner role](../azure-stack-create-service-principals.md#assign-role-to-service-principal.md) on your subscription.

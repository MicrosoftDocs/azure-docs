...
> [!Note]  
> Azure Stack and App Service deployment is required (with proper images syndicated to run on Windows Server and SQL). See the App Service documentation "Prerequisites" section for Azure Stack Operator Requirements.
...
> [!Note]  
> The Azure Stack environment needs the correct images syndicated to run Windows Server and SQL Server. It must also have App Service deployed. Review the App Service documentation "Prerequisites" section for Azure Stack Operator Requirements.

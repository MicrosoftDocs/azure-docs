...
1. Make sure that your Azure Stack operator has added the Windows Server 2016 image to the Azure Stack marketplace.  You can browse the marketplace in the portal to check. 

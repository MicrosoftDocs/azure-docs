...
The current compatible Azure PowerShell module version for Azure Stack is 1.2.11 for the user opearions. It’s different from the latest version of Azure PowerShell. This difference impacts storage services operation:

 ...
 * Deploy a Windows Server 2012 Virtual Machine in the tenant subscription. You will use this server as your build server and running Azure DevOps Services.

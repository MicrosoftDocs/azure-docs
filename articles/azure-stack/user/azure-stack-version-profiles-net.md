...
- [Resource provider API versions supported by profiles](azure-stack-profiles-azure-resource-manager-versions.md)
  ...
  [Finding and installing a package]: ~/nuget/tools/package-manager-ui.md
  ...
  [Run unit tests with Test Explorer.]: ~/visualstudio/test/run-unit-tests-with-test-explorer.md?view=vs-2017

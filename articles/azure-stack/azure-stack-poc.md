...
Microsoft Azure Stack is an extension of Azure that lets you deliver Azure services from your organization’s datacenter.  As a hybrid cloud, Azure Stack is designed to help your modern applications in key scenarios, like meeting security and compliance requirements, or providing Azure resources without Internet connectivity required.  As an example, you may use Azure Stack for edge and disconnected scenarios, like on cruise ships or oil rigs.  Azure Stack is offered in two deployment options to meet your needs.

## Azure Stack integrated system
The Azure Stack integrated system is offered through a partnership of Microsoft and [hardware partners](https://azure.microsoft.com/overview/azure-stack/integrated-systems/), creating a solution which offers cloud-paced innovation balanced with simplicity in management.  Because Azure Stack is offered as an integrated system of hardware and software, you are offered the right amount of flexibility and control, while still adopting innovation from the cloud.  Azure Stack integrated systems range in size from 4-12 nodes, and are supported jointly by the hardware partner and Microsoft.  Use Azure Stack integrated systems to enable new scenarios for your production workloads.    

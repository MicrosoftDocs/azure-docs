...
To deploy the Azure Stack POC, you'll first need to [prepare the deployment machine](azure-stack-run-powershell-script.md/#prepare-the-deployment-machine) and then [run the PowerShell deployment script](azure-stack-run-powershell-script.md/#run-the-powershell-deployment-script).

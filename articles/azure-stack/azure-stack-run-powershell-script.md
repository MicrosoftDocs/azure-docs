...
5. Run the folloiwing script to download the development kit installer file (asdk-installer.ps1) to the c:\AzureStack_Installer folder on your development kit host.
    ```powershell
    # Variables

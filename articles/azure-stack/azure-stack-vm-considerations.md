...
| Virtual Machine quotas | [Quota limits](../azure-subscription-service-limits.md) are set by Microsoft | The Azure Stack administrator must assign quotas before they offer virtual machines to their users. |

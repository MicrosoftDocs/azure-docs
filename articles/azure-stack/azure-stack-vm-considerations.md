...
| Virtual Machine sizes | Azure supports a wide variety of sizes for virtual machines. To learn about the available sizes and options, refer to the [Windows virtual machines sizes](../virtual-machines/virtual-machines-windows-sizes) and [Linux virtual machine sizes](../virtual-machines/linux/sizes) topics. |Azure Stack supports a subset of Virtual Machine sizes that are available in Azure. Refer to the [virtual machine sizes](#virtual-machine-sizes) section of this article to view the list of supported sizes. |
...
| API versions | Azure always has the latest API versions for all the virtual machine features. | Azure Stack supports specific Azure services and specific API versions for these services. Refer to the [API versions](#API-versions) section of this article to view the list of supported API versions. |

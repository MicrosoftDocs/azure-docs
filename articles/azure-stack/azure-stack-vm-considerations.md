...
| Virtual Machine quotas | [Quota limits](../azure-subscription-service-limits.md#service-specific-limits) are set by Microsoft | The Azure Stack administrator must assign quotas before they offer virtual machines to their users. |
...
| Virtual machine storage | Supports [managed disks.](../storage/storage-managed-disks-overview.md) | Managed disks are not yet supported in the Azure Stack. |

...
This article has detailed instructions to configure PowerShell for Azure Stack. If you want to quickly install and configure PowerShell, you can use the script provided in the [Get up and running with PowerShell](azure-stack-powershell-configure-quickstart.md) topic. 

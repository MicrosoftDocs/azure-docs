...
### Post-update steps
After the installation of 1802, install any applicable Hotfixes.  For more information refer to the links below as well as our Servicing Policy (https://docs.microsoft.com/en-us/azure/azure-stack/azure-stack-servicing-policy)

Network Controller API service crashes when you try to install an Azure Stack update (https://support.microsoft.com/en-us/help/4103348)

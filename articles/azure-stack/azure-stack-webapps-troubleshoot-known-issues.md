...
After you have completed the [registration of the Azure Stack Web Apps Provider](azure-stack-app-service-deploy.md#register-the-newly-deployed-azure-stack-app-service-provider-with-azure-resource-manager) if you cannot find the Web + Mobile blade then please try the following:
...
[AppServiceHelperScripts]: https://aka.ms/appsvconmastp2helper

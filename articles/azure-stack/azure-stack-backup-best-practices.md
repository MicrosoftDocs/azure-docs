...
The encryption key is used to encrypt backup data that gets exported to external storage. The key is generated in as part of [enabling backup for Azure Stack with PowerShell.](azure-stack-backup-enable-backup-powershell.md)

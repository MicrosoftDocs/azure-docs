...
The Azure Linux agent (typically called `WALinuxAgent` or `walinuxagent`) is required, and not all versions of the agent work on Azure Stack. You should use version 2.2.20 or later if you create your own image. Note that [cloud-init](https://cloud-init.io/) is not supported on Azure Stack at this time.

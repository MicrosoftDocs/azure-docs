...
Use Visual Studio to deploy Azure Resource Manager templates to the Azure Stack POC.  Before you begin, make sure you've [installed and connected](azure-stack-install-visual-studio.md) to Azure Stack with Visual Studio.

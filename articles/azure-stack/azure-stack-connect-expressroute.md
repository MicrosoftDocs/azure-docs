...
The following Cisco Aggregation Services Router 1000 Series configuration example supports the network infrastructure shown in the *ExpressRoute router configuration* diagram.

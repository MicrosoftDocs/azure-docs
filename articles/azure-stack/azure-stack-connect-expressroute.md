...
For more information about creating virtual networks in Azure, see [Create a virtual network with multiple subnets](../virtual-network/manage-virtual-network.md#create-a-virtual-network).

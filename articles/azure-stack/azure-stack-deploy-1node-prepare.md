<properties
	pageTitle="Prepare your environment for an Azure Stack 1-node deployment | Microsoft Azure"
	description="Prepare your environment for an Azure Stack 1-node deployment."
...
# Prepare the Azure Stack 1-node deployment machine

After you've confirmed your hardware meets the [requirements](azure-stack-deploy-1node-hardware-reqs.md), you must prepare your deployment environment with the appropriate operating system, Azure Active Directory accounts, and networking requirements.
...
[Deploy Azure Stack 1-node](TBD.md)

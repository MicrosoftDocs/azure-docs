...
2. **Provision a virtual machine**
   ...
   a. On the Azure Stack Deployment Kit computer, log in to `https://portal.local.azurestack.external` as a user, and then click **New** > **Virtual machines** > **Windows Server 2016 Datacenter Eval**.  

...
Your original equipment manufacturer (OEM) hardware vendor will also release updates, such as driver and firmware updates. While these updates are delivered as separate packages by your OEM hardware vendor, they are imported, installed and managed the same way update packages from Microsof update packages are imported, installed and managed.

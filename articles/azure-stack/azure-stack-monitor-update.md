---
title: Manage updates in Azure Stack using the privileged endpoint | Microsoft Docs
description: Learn how to use the privileged endpoint to manage Microsoft update packages for Azure Stack integrated systems.
...
---
# Manage updates in Azure Stack using the privileged endpoint

...
| [Register with Azure](azure-stack-register.md) | Use this module to register your Azure Stack POC instance with Azure. After registering, you can download the marketplace items from Azure and use them in Azure Stack. |

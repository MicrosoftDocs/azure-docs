...
A hybrid continuous integration/continuous delivery(CI/CD) pipeline enables you to automatically build, test, and deploy your application across multiple clouds. This means you, as a developer, can spend less time worrying about reliably delivering your code, and more time writing code to empower your users.   
...
### Dev tools
 ...
 - Deploy a [VSTS build agent](https://github.com/Azure/azure-quickstart-templates/tree/master/visual-studio-vstsbuildagent-vm) to Azure Stack

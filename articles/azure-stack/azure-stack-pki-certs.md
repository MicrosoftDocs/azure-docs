...
- Your Azure Stack infrastructure must have network access to the certificate authority's Certificate Revocation List (CRL) location that is published in the certificate. This CRL must be an http endpoint

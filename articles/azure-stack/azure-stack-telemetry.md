...
Azure Stack telemetry automatically uploads system data to Microsoft via the Connected User Experience. The data that is gathered by Azure Stack telemetry is used by Microsoft teams to improve customer experiences, and for security, health, quality, and performance analysis.
...
The telemetry levels are cumulative and are categorized as the following four levels (0-3):

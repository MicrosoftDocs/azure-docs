...
- To enable a user from another directory to access this Azure Stack environment, you must [invite the user as a guest](azure-stack-identity-overview#guest-users) to the tenant directory.  
...
- [Datacenter integration - Identity](azure-stack-integrate-identity)
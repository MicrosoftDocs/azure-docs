...
Self-service databases are provided through the tenant portal experience. A tenant needs a subscription that has an offer, which contains the database service.

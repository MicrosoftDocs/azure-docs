...
- With this release, Azure Stack integrated systems supports configurations of 4-16 nodes. You can use the [Azure Stack Capacity Planner](http://aka.ms/azstackcapacityplanner) to determine the capacity and configuration of your Azure Stack hardware solution.

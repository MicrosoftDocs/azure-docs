<properties
	pageTitle="Add an image to the Platform Image Repository in Azure Stack"
	description="Before you can add an image to the PIR, you must prepare a virtual hard disk image."

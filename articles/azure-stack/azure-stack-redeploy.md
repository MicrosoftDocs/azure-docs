...
5. You no longer need to remove the existing boot entry (the new support script “PrepareBootFromVHD.ps1” takes care of that for you.)

6. Delete the CloudBuilder.vhdx file that was used as part of the previous deployment.

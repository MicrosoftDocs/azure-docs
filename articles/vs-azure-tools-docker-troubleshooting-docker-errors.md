...
A: See [Hosting Web Apps in Docker](vs-azure-tools-docker-hosting-web-apps-in-docker) for information on how to do this.
...
A:  See the section **Provide a Custom Docker Host** in the topic, [Hosting Web Apps in Docker](vs-azure-tools-docker-hosting-web-apps-in-docker).

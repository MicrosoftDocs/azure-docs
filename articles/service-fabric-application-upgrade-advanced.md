...
[AZURE.NOTE] Only for a failed or suspended upgrade, should the Manual Upgrade mode be even considered. The Monitored Automatic mode is the upgrade mode recommended for Service Fabric applications.

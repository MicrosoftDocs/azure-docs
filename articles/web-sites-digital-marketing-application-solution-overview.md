<properties linkid="develop-media-services-resources " urlDisplayName="Resources" pageTitle="Azure Media Services Center - Resources" metaKeywords="" description="Find resources, tutorials, and documentation about how to use Media Services with Azure." metaCanonical="" services="" documentationCenter="" title="Create a Digital Marketing Campaign on Azure Web Sites" authors="jroth" solutions="" manager="paulettm" editor="mollybos" />

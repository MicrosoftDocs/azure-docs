...
1. Install the Azure Command Line Tools by following the instructions here: [How to install the Azure Command Line Tools for Mac and Linux](/en-us/documentation/articles/xplat-cli/#install).

1. Download and import your publish settings file by following the instructions here: [How to download and import publish settings](/en-us/documentation/articles/xplat-cli/#configure).
...
For information about additional options, see [How to create and manage an Azure Web Site](/en-us/documentation/articles/virtual-machines-command-line-tools/#Commands_to_manage_your_web_sites).

...
| [Load balance multiple wesites](../scripts/load-balancer-linux-cli-load-balance-mutliple-websites-vm.md?toc=%2fazure%2fnetworking%2ftoc.json) | Creates two VMs with multiple IP configurations, joined to an Azure Availability Set, accessible through an Azure Load Balancer. |

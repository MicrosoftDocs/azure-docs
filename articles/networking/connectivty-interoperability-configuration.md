...
A second ExpressRoute circuit, in closer proximity to the on-premises Location 2, connects the on-premises Location 2 to the hub VNet. The following figure shows the second ExpressRoute configuration:

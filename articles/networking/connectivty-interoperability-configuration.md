...
The following figure shows the VNet peering details of the hub VNet. If you want the spoke VNet to use the hub VNet gateways, select **Allow gateway transit**.

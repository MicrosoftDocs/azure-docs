...
description: Learn how to use an Azure CLI script to create a virtual network with front-end and back-end subnets that filter inbound and outbound network traffic.

...
1. On the **Add connection** page, configure the connection settings. For information about routing settings, see [About routing](../../../virtual-wan/about-virtual-hub-routing.md).
   ...
   * **Bypass Next Hop IP for workloads within this VNet**: This setting lets you deploy NVAs and other workloads into the same VNet without forcing all the traffic through the NVA. This setting can only be configured when you're configuring a new connection. If you want to use this setting for a connection you've already created, delete the connection, then add a new connection. See [bypass next hop IP documentation](../../../virtual-wan/howto-connect-vnet-hub.md#bypassexplained) for more information about routing behavior related to this setting.

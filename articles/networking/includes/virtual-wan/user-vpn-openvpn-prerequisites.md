...
* You acquired the necessary certificates. You can either [generate client certificates](../../../virtual-wan/certificates-point-to-site.md), or acquire the appropriate client certificates necessary for authentication. Ensure you have both the client certificate and the root server certificate information.
...
The OpenVPN client in this article uses certificates exported with a *.pfx* format. You can export a client certificate to this format by using the Windows instructions. See [Generate and export certificates for User VPN connections](../../../virtual-wan/certificates-point-to-site.md). If you don't have a Windows computer, as a workaround, you can use a small Windows VM to export certificates to the needed *.pfx* format.
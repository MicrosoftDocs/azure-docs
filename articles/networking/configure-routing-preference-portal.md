...
# Configure routing preference for Azure resources using the Azure portal
...
If you prefer, you can complete this tutorial using the [Azure CLI](configure-routing-preference-cli.md) or [PowerShell](configure-routing-preference-powershell.md).
...
To create a public IP Address in the Azure portal, see [Create, change, or delete a public IP address](../virtual-network/virtual-network-public-ip-address.md).  Specify that the **Routing Preference** option is set to **Internet**.

...
[Reach out to the Edge Zones team](aka.ms/customerform) for more information.
...
We have a rich ecosystem of VNF vendors, ISVs, and MSP partners to enable end-to-end solutions using Private Edge Zones. [Reach out to the Private Edge Zones team](aka.ms/partnerform) for more information.
...
[Reach out to the Private Edge Zones team](aka.ms/partnerform) for more information on how to become a partner.
...
* [Edge Zones team](aka.ms/customerform)
* [Private Edge Zones team](aka.ms/partnerform)

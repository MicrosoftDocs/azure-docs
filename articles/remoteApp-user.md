<properties title="Add a user in RemoteApp" pageTitle="Add a user in RemoteApp" description="Learn how to add users in RemoteApp" metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo"  />
...
In order for your users to use the apps in RemoteApp, you have to grant them access. This is the easy part: On the **User Access** tab, enter the account information for the user to grant access to this service.
...
If you are using the Office 365 ProPlus template image in your collection *or* if you created a custom image that uses Office 365, you are only allowed to add Azure Active Directory users that have Office 365 subscriptions for the default domain of your subscription. 
<properties pageTitle="How to customize the look and feel of the developer portal in Azure API Management" metaKeywords="" description="How to customize the look and feel of the developer portal in Azure API Management." metaCanonical="" services="api-management" documentationCenter="API Management" title="How to customize the look and feel of the developer portal in Azure API Management" authors="sdanie" solutions="" manager="dwrede" editor="" />
...
In this section we would like to change the styling of only a specific element - for example, the page headers. Click the **Pick element** option from the styling editor toolbar and then click on **Select an element to customize**. Elements will now become highlighted as you hover over them with the mouse to signify what element's styles you would see if you click. 

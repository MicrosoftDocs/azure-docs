...
- The page [Enabling Diagnostics in Azure Cloud Services and Virtual Machines](https://azure.microsoft.com/en-us/documentation/articles/cloud-services-dotnet-diagnostics/) on the Microsoft website.
...
- The page [How to use Service Bus Queues](https://azure.microsoft.com/en-us/documentation/articles/service-bus-dotnet-how-to-use-queues/) on the Microsoft website.
...
- The pages [Receive alert notifications](https://azure.microsoft.com/en-us/documentation/articles/insights-receive-alert-notifications/) and [Track service health](https://azure.microsoft.com/en-us/documentation/articles/insights-service-health/) on the Microsoft website.
- The [Application Insights](https://azure.microsoft.com/en-us/documentation/articles/app-insights-get-started/) page on the Microsoft website.

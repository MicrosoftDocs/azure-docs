...
Azure Container Apps uses [availability zones](availability-zones-overview.md#zonal-and-zone-redundant-availability-zones) in regions where they're available to provide high-availability protection for your applications and data from data center failures.
...
Azure Container Apps uses [availability zones](availability-zones-overview.md#zonal-and-zone-redundant-availability-zones) in regions where they're available. For a list of regions that support availability zones, see [Availability zone service and regional support](availability-zones-service-support.md).

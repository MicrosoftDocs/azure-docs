...
- **Max spreading (platformFaultDomainCount = 1)**. This is the recommended deployment option, as it provides the best spreading in most cases. If you want to spread replicas across distinct hardware isolation units, we recommend spreading across availability zones and utilize max spreading within each zone.

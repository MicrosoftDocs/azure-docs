...
:::image type="content" source="./media/bastion/bastion-instance-zone-traffic.png" alt-text="Diagram that shows cross-zone traffic. A user request goes to an Azure Bastion instance in zone 2 and is forwarded to a VM in zone 1." border="false"::

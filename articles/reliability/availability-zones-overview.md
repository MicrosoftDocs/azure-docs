...
*Azure Services supporting availability zones* are designed to provide the right level of resiliency and flexibility for their resources. The resources can be configured in two ways. They can be either *zone redundant*, with automatic replication across zones, or *zonal* another words *zone aligned* to a specific zone. You can also combine these approaches across different resources.

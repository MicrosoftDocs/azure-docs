...
Reliability consists of two principles: resiliency and availability. The goal of [reliability ](/azure/reliability/overview)is to return your application to a fully functioning state after a failure occurs. The goal of availability is to provide consistent access to your application or workload be users as they need to.

...
Azure App Service Environment can be deployed across [Availability Zones (AZ)](../reliability/az-service-support.md) to help you achieve resiliency and reliability for your business-critical workloads. This architecture is also known as zone redundancy.

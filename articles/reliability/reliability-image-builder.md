...
description: Learn how to ensure VM image template resilience in Azure Image Builder by using multi-region replication and Azure Resource Graph for recovery.
author: anaharris-ms
ms.author: anaharris

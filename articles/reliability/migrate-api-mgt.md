...
1.	Create a new subnet and public IP address (optional, only in external VNet mode) in the location to migrate to availability zones. Detailed requirements are in [virtual networking guidance](../api-management/api-management-using-with-vnet.md?tabs=stv2#prerequisites).
...
1.	Select the new subnet in the location. In external VNet mode, you can optionally select a new public IP. 
...
If your API Management instance is deployed in a virtual network in the primary location, ensure that you set up a [virtual network](../api-management/api-management-using-with-vnet.md?tabs=stv2), subnet, and public IP address (optional, only in external VNet mode) in any new location where you plan to enable zone redundancy.
...
1. If your API Management instance is deployed in a [virtual network](../api-management/api-management-using-with-vnet.md?tabs=stv2), select the virtual network and subnet that are available in the location. In external VNet mode, you can optionally select a new public IP. 

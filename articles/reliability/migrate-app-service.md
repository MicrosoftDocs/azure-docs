...
Azure App Service can be deployed into [Availability Zones (AZ)](../availability-zones/overview-availability-zones.md) to help you achieve resiliency and reliability for your business-critical workloads. This architecture is also known as zone redundancy.

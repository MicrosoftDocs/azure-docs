...
| :::image type="content" source="media/icon-region-coming-soon.svg"  alt-text="Icon that shows that this region is coming soon." :::image type="content" source="media/icon-region-restricted.svg" alt-text="Icon that shows that this region is access restricted to support specific customer scenarios, such as in-country/region disaster recovery"  border="false"::: Belgium Central  border="false"::: | :::image  alt-text="Yes"  type="content" source="media/icon-checkmark.svg"  border="false"::: | n/a | 	Brussels | Belgium |
...
| :::image type="content" source="media/icon-region-restricted.svg" alt-text="Icon that shows that this region is access restricted to support specific customer scenarios, such as in-country/region disaster recovery" border="false"::: Switzerland West | | Switzerland North | Geneva | Switzerland |

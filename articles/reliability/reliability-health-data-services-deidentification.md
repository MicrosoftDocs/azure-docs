...
description: Learn to protect healthcare data privacy with reliable de-identification services by using active-active configurations and Azure Front Door routing.
author: jovinson-ms
ms.author: jovinson

...
During planned or unplanned failover events, if the server goes down, the service maintains availability of the servers using following automated procedure:

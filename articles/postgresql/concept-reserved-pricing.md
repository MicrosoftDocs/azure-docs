...
> [!IMPORTANT]
> Reserved capacity pricing is available for the Azure Database for PostgreSQL in both [Single server](https://docs.microsoft.com/azure/postgresql/overview#azure-database-for-postgresql---single-server) and [Hyperscale Citus](https://docs.microsoft.com/azure/postgresql/overview#azure-database-for-postgresql---hyperscale-citus) deployment options. For information about RI pricing on Hyperscale (Citus), see [this page](concepts-hyperscale-reserved-pricing.html).

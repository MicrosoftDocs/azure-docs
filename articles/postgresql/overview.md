...
- [Create a PostgreSQL server by using Azure portal](quickstart-create-server-database-portal.md)
- [Create a PostgreSQL server by using Azure CLI](quickstart-create-server-database-azure-cli.md)
...
See Business Continuity for details about the different business continuity features available for different service tiers.

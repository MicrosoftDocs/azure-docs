...
- **Power operations**: You can restart either the primary or the replica, but after replication is setup, you cannot execute power operations (start/stop) on either the primary or the replica; you must first stop replication or delete the replica.

...
|:-:|:-:|:-:|:-:|:-:|:-:|
|Simplified Management|<div align=center; style="width: 20px; height: 20px; border-radius: 50%; background-color: yellow;"></div>|<span style="display: inline-block; width: 20px; height: 20px; border-radius: 50%; background-color: yellow;"></span>|<span style="display: inline-block; width: 20px; height: 20px; border-radius: 50%; background-color: red;"></span>|<span style="display: inline-block; width: 20px; height: 20px; border-radius: 50%; background-color: red;"></span>|<span style="display: inline-block; width: 20px; height: 20px; border-radius: 50%; background-color: green;"></span>|

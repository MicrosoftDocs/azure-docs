...
> [!IMPORTANT]
> Reserved capacity pricing is available for [Azure Database for PostgreSQL single server](../single-server/overview-single.md) and [Azure Database for PostgreSQL flexible server](overview.md) deployment options.

...
> [!IMPORTANT]
> Reserved capacity pricing is available for the Azure Database for PostgreSQL in [Single server](../single-server/overview-single.md) and [Flexible Server](overview.md) deployment options.

...
For more details on setting-up charts with dimensional metrics, see [Metric chart examples](https://learn.microsoft.com/en-us/azure/azure-monitor/essentials/metric-chart-samples).

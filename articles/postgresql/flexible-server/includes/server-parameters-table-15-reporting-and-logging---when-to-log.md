...
| Documentation  | [log_min_duration_statement](https://www.postgresql.org/docs/15/runtime-config-logging.html) |
...
| Parameter type | dynamic        |
| Documentation  | [log_min_error_statement](https://www.postgresql.org/docs/15/runtime-config-logging.html)    |
...
| Allowed values | `debug5,debug4,debug3,debug2,debug1,info,notice,warning,error,log,fatal,panic` |
| Parameter type | dynamic        |
| Documentation  | [log_min_messages](https://www.postgresql.org/docs/15/runtime-config-logging.html)           |

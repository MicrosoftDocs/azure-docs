...
| Documentation  | [autovacuum_work_mem](https://www.postgresql.org/docs/14/runtime-config-resource.html)       |
...
| Documentation  | [huge_pages](https://www.postgresql.org/docs/14/runtime-config-resource.html)                |
...
| Parameter type | static         |
| Documentation  | [shared_buffers](https://www.postgresql.org/docs/14/runtime-config-resource.html)            |
...
| Parameter type | dynamic        |
| Documentation  | [temp_buffers](https://www.postgresql.org/docs/14/runtime-config-resource.html)              |
...
| Parameter type | dynamic        |
| Documentation  | [work_mem](https://www.postgresql.org/docs/14/runtime-config-resource.html)                  |

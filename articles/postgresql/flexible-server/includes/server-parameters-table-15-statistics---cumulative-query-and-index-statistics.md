...
| Documentation  | [track_activities](https://www.postgresql.org/docs/15/runtime-config-statistics.html)          |
...
| Documentation  | [track_activity_query_size](https://www.postgresql.org/docs/15/runtime-config-statistics.html) |
...
| Allowed values | `on,off`       |
| Parameter type | dynamic        |
| Documentation  | [track_counts](https://www.postgresql.org/docs/15/runtime-config-statistics.html)              |
...
| Parameter type | dynamic        |
| Documentation  | [track_functions](https://www.postgresql.org/docs/15/runtime-config-statistics.html)           |
...
| Allowed values | `on,off`       |
| Parameter type | dynamic        |
| Documentation  | [track_io_timing](https://www.postgresql.org/docs/15/runtime-config-statistics.html)           |

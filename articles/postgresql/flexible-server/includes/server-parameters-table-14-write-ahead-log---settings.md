...
| Parameter type | dynamic        |
| Documentation  | [wal_compression](https://www.postgresql.org/docs/14/runtime-config-wal.html)        |
...
| Parameter type | static         |
| Documentation  | [wal_level](https://www.postgresql.org/docs/14/runtime-config-wal.html)              |
...
| Parameter type | dynamic        |
| Documentation  | [wal_writer_delay](https://www.postgresql.org/docs/14/runtime-config-wal.html)       |
...
| Parameter type | dynamic        |
| Documentation  | [wal_writer_flush_after](https://www.postgresql.org/docs/14/runtime-config-wal.html) |

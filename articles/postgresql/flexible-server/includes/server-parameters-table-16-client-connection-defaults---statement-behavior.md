...
| Documentation  | [bytea_output](https://www.postgresql.org/docs/16/runtime-config-client.html)                      |
...
| Parameter type | dynamic        |
| Documentation  | [client_min_messages](https://www.postgresql.org/docs/16/runtime-config-client.html)               |
...
| Parameter type | dynamic        |
| Documentation  | [default_tablespace](https://www.postgresql.org/docs/16/runtime-config-client.html)                |
...
| Allowed values | `on,off`                                                       |
| Parameter type | dynamic        |
| Documentation  | [default_transaction_deferrable](https://www.postgresql.org/docs/16/runtime-config-client.html)    |
...
| Parameter type | dynamic        |
| Documentation  | [default_transaction_isolation](https://www.postgresql.org/docs/16/runtime-config-client.html)     |
...
| Allowed values | `on,off`                                                       |
| Parameter type | dynamic        |
| Documentation  | [default_transaction_read_only](https://www.postgresql.org/docs/16/runtime-config-client.html)     |
...
| Allowed values | `0-2147483647`                                                 |
| Parameter type | dynamic        |
| Documentation  | [lock_timeout](https://www.postgresql.org/docs/16/runtime-config-client.html)                      |
...
| Parameter type | dynamic        |
| Documentation  | [session_replication_role](https://www.postgresql.org/docs/16/runtime-config-client.html)          |
...
| Allowed values | `[A-Za-z._]*`                                                  |
| Parameter type | dynamic        |
| Documentation  | [temp_tablespaces](https://www.postgresql.org/docs/16/runtime-config-client.html)                  |
...
| Parameter type | dynamic        |
| Documentation  | [vacuum_freeze_min_age](https://www.postgresql.org/docs/16/runtime-config-client.html)             |
...
| Parameter type | dynamic        |
| Documentation  | [vacuum_freeze_table_age](https://www.postgresql.org/docs/16/runtime-config-client.html)           |
...
| Allowed values | `0-1000000000`                                                 |
| Parameter type | dynamic        |
| Documentation  | [vacuum_multixact_freeze_min_age](https://www.postgresql.org/docs/16/runtime-config-client.html)   |
...
| Allowed values | `0-2000000000`                                                 |
| Parameter type | dynamic        |
| Documentation  | [vacuum_multixact_freeze_table_age](https://www.postgresql.org/docs/16/runtime-config-client.html) |

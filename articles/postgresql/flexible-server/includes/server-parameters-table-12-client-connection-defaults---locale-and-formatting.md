...
| Documentation  | [client_encoding](https://www.postgresql.org/docs/12/runtime-config-client.html)            |
...
| Parameter type | dynamic        |
| Documentation  | [default_text_search_config](https://www.postgresql.org/docs/12/runtime-config-client.html) |
...
| Allowed values | `-15-3`                                                                                                                                                                                                                                                                                                                                     |
| Parameter type | dynamic        |
| Documentation  | [extra_float_digits](https://www.postgresql.org/docs/12/runtime-config-client.html)         |
...
| Parameter type | dynamic        |
| Documentation  | [lc_monetary](https://www.postgresql.org/docs/12/runtime-config-client.html)                |
...
| Allowed values | `[A-Za-z0-9._ -]+`                                                                                                                                                                                                                                                                                                                          |
| Parameter type | dynamic        |
| Documentation  | [lc_numeric](https://www.postgresql.org/docs/12/runtime-config-client.html)                 |
...
| Allowed values | `[A-Za-z0-9/+_-]+`                                                                                                                                                                                                                                                                                                                          |
| Parameter type | dynamic        |
| Documentation  | [TimeZone](https://www.postgresql.org/docs/12/runtime-config-client.html)                   |

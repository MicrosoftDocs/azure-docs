...
| Documentation  | [ssl_max_protocol_version](https://www.postgresql.org/docs/13/runtime-config-connection.html) |
...
| Allowed values | `TLSv1.2,TLSv1.3`                                                                                                                                                               |
| Parameter type | dynamic        |
| Documentation  | [ssl_min_protocol_version](https://www.postgresql.org/docs/13/runtime-config-connection.html) |

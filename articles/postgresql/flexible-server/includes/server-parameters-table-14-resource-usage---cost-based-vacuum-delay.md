...
| Documentation  | [vacuum_cost_delay](https://www.postgresql.org/docs/14/runtime-config-resource.html)      |
...
| Parameter type | dynamic        |
| Documentation  | [vacuum_cost_limit](https://www.postgresql.org/docs/14/runtime-config-resource.html)      |
...
| Parameter type | dynamic        |
| Documentation  | [vacuum_cost_page_dirty](https://www.postgresql.org/docs/14/runtime-config-resource.html) |
...
| Allowed values | `0-10000`      |
| Parameter type | dynamic        |
| Documentation  | [vacuum_cost_page_miss](https://www.postgresql.org/docs/14/runtime-config-resource.html)  |

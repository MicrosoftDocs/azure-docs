...
| Documentation  | [commit_delay](https://www.postgresql.org/docs/15/runtime-config-wal.html)           |
...
| Parameter type | dynamic        |
| Documentation  | [commit_siblings](https://www.postgresql.org/docs/15/runtime-config-wal.html)        |
...
| Documentation  | [wal_buffers](https://www.postgresql.org/docs/15/runtime-config-wal.html)            |
...
| Parameter type | dynamic        |
| Documentation  | [wal_compression](https://www.postgresql.org/docs/15/runtime-config-wal.html)        |
...
| Parameter type | static         |
| Documentation  | [wal_level](https://www.postgresql.org/docs/15/runtime-config-wal.html)              |
...
| Parameter type | dynamic        |
| Documentation  | [wal_writer_delay](https://www.postgresql.org/docs/15/runtime-config-wal.html)       |
...
| Parameter type | dynamic        |
| Documentation  | [wal_writer_flush_after](https://www.postgresql.org/docs/15/runtime-config-wal.html) |

...
| Documentation  | [max_replication_slots](https://www.postgresql.org/docs/15/runtime-config-replication.html) |
...
| Parameter type | static         |
| Documentation  | [max_wal_senders](https://www.postgresql.org/docs/15/runtime-config-replication.html)       |
...
| Parameter type | static         |
| Documentation  | [track_commit_timestamp](https://www.postgresql.org/docs/15/runtime-config-statistics.html) |

...
| Allowed values | `off`          |
| Parameter type | read-only      |
| Documentation  | [log_executor_stats](https://www.postgresql.org/docs/16/runtime-config-logging.html)  |
...
| Documentation  | [log_statement_stats](https://www.postgresql.org/docs/16/runtime-config-logging.html) |

...
:::image type="content" source="./media/howto-configure-server-parameters-in-portal/3-overview-of-parameters_updt.png" alt-text="Overview Page for Parameters":::

4. Select the **drop down** button to see the possible values for enumerated-type parameters like client_min_messages.
:::image type="content" source="./media/howto-configure-server-parameters-in-portal/4-enum-drop-down_updt.png" alt-text="Enumerate drop down":::
...
:::image type="content" source="./media/howto-configure-server-parameters-in-portal/4-information-button_updt.png" alt-text="information button":::
...
:::image type="content" source="./media/howto-configure-server-parameters-in-portal/5-search_updt.png" alt-text="Search results":::

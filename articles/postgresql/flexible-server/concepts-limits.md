...
- Once configured, storage size cannot be reduced. You would have to create a new server with desired storage size and perform manual dump and restore process to migrate your databases.

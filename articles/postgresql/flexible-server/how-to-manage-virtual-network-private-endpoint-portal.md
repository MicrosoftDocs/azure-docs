...
7. Select **"Add Private Endpoint"** in Private Endpoint section
    :::image type="content" source="./media/how-to-manage-virtual-network-private-endpoint-portal/peselection.png" alt-text="Add Private Endpoint button in Private Endpoint Section." :::

...
1. Add pg_repack extension under Azure extensions as shown below from the server parameters page on the Flexible Server portal

   :::image type="content" source="./media/how-to-perform-fullvacuum-pg_repack/portal.png" alt-text="Screenshot of server parameters blade with azure extensions parameter" lightbox="./media/how-to-perform-fullvacuum-pg_repack/portal.png":::

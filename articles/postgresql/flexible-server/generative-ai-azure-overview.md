---
title: Azure AI Extension in Azure Database for PostgreSQL - Flexible Server -Preview
description: Azure AI Extension in Azure Database for PostgreSQL - Flexible Server -Preview
author: mulander
ms.author: adamwolk
ms.date: 11/01/2023

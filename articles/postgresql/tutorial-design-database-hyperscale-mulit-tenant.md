...
1. Launch the Azure Cloud Shell via the terminal icon on the top navigation pane.
   ...
   ![Azure Database for PostgreSQL - Azure Cloud Shell terminal icon](./media/tutorial-design-database-hyperscale-mulit-tenant/psql-cloud-shell.png)

2. The Azure Cloud Shell opens in your browser, enabling you to type bash commands.

   ![Azure Database for PostgreSQL - Azure Shell Bash Prompt](./media/tutorial-design-database-hyperscale-mulit-tenant/psql-bash.png)

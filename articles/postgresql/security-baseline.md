...
To see how Azure Database for PostgreSQL - Single Server completely maps to the Azure Security Benchmark, see the [full Azure Database for PostgreSQL - Single Server security baseline mapping file](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).

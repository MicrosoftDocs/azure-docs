...
> [!NOTE]
> **Controls** not applicable to Azure Database for PostgreSQL - Single Server, or for which the responsibility is Microsoft's, have been excluded. To see how Azure Database for PostgreSQL - Single Server completely maps to the Azure Security Benchmark, see the **[full Azure Database for PostgreSQL - Single Server security baseline mapping file](https://github.com/MicrosoftDocs/SecurityBenchmarks/raw/master/Azure%20Offer%20Security%20Baselines/1.1/azure-database-for-postgresql-single-server-security-baseline-v1.1.xlsx)**.

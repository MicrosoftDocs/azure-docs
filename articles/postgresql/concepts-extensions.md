...
## Next Steps
Don't see an extension you'd like to use? Let us know through the [MSDN Forums](https://social.msdn.microsoft.com/Forums/home?forum=AzureDatabaseforPostgreSQL) or [@AzureSupport](https://twitter.com/AzureSupport) twitter or by emailing us at [azure-postgres-extensions-request@microsoft.com](mailto:azure-postgres-extensions-request@microsoft.com?subject=Request%20for%20Azure%20Database%20for%20PostgreSQL%20Extension).
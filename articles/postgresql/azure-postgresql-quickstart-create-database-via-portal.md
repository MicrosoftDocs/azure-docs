...
This quick start guide walks through how to create a PostgreSQL database in Azure. Azure Database for PostgreSQL is a “Database-as-a-Service” offering that enables you to run, manage, and scale highly-available PostgreSQL databases in the cloud. This quick start shows you how to get started by creating a new PostgreSQL server using the Azure portal.
...
An Azure PostgreSQL server is created with a defined set of [compute and storage resources](placeholder.md). The database is created within an [Azure resource group](../azure-resource-manager/resource-group-overview.md).
...
![Azure Database for PostgreSQL - Create the database](./media/azure-postgresql-quickstart-create-database-via-portal/1-create-database.png)
...
![Azure Database for PostgreSQL - pick the service tier](./media/azure-postgresql-quickstart-create-database-via-portal/2-service-tier.png)
...
![Azure Database for PostgreSQL - See notifications](./media/azure-postgresql-quickstart-create-database-via-portal/3-notifications.png)
...
![Azure Database for PostgreSQL - Server Properties ](./media/azure-postgresql-quickstart-create-database-via-portal/4-firewall-1.png)
...
![Azure Database for PostgreSQL - Create Firewall Rule](./media/azure-postgresql-quickstart-create-database-via-portal/5-firewall-2.png)
...
![Azure Database for PostgreSQL - Server Admin Login](./media/azure-postgresql-quickstart-create-database-via-portal/6-server-name.png)

2.	Launch the Azure Cloud Console via the terminal icon on the top navigation pane. 
![Azure Database for PostgreSQL - Azure Console terminal icon](./media/azure-postgresql-quickstart-create-database-via-portal/7-cloud-console.png)

3.	This enables a bash shell experience in your browser.
![Azure Database for PostgreSQL - Azure Console Bash Prompt](./media/azure-postgresql-quickstart-create-database-via-portal/8-bash.png)
...
![Azure Database for PostgreSQL - Delete server](./media/azure-postgresql-quickstart-create-database-via-portal/9-delete.png)
...
## Next steps
- To create PostgreSQL server via Azure CLI, see [Create PostgreSQL server – CLI](./placeholder.placeholder.md).
- To connect and query using pgAdmin GUI tool, see [Connect and query with pgAdmin](./placeholder.placeholder.md).
- To connect and query using psql command line utility, see [Connect and query with psql](./placeholder.placeholder.md).
- For a technical overview, see [About the Azure Database for PostgreSQL service] and particularly [Azure Database for PostgreSQL server](./placeholder.placeholder.md).

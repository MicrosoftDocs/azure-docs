...
| `dbsToMigrate` | Required | Specify the list of databases that you want to migrate to Flexible Server. Note only user databases are migrated. System databases or template databases like template0, template1 will not be migrated. |

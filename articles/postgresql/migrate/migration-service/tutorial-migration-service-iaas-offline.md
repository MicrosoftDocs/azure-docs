---
title: "Migrate offline from an Azure VM or an on-premises PostgreSQL server to Azure Database for PostgreSQL with the migration service"
description: "Learn to migrate seamlessly from ozure VM or an on-premises PostgreSQL server to Azure Database for PostgreSQL using the new migration service in Azure."
author: apduvuri

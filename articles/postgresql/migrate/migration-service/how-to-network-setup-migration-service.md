...
- Confirm the settings by clicking "OK".
    ...
    :::image type="content" source="media\how-to-network-setup-migration-service\allow-flexible-server-subnet.png" alt-text="Screenshot of adding a vnet rule in single server." lightbox="media\how-to-network-setup-migration-service\allow-flexible-server-subnet.png":::

...
> [!Important]
> - Scenario 2 and 4 will have significant performance impact on the Azure Database for PostgreSQL server due to the additional layer of infrastructure encryption.

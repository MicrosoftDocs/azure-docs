...
1. Select the **New** button (+) in the upper-left corner of the portal. Select **Databases** > **Azure Database for PostgreSQL**.

   ![The "Azure Database for PostgreSQL" option](./media/howto-restore-server-portal/1-create-database.png)

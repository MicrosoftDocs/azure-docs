...
Automatic upgrade for major versions is not supported. For example, there is not an automatic upgrade from PostgreSQL 10 to PostgreSQL 11. To upgrade to the next major version, you can 

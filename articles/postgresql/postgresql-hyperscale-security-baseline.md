...
### 1.2: Monitor
and log the configuration and traffic of virtual networks, subnets, and NICs
...
**Guidance**: Not applicable; Signing into Azure Database for PostgreSQL - Hyperscale (Citus) is currently not supported using Azure Active Directory (AD). Currently you must use a connection string and password to connect to your database server.

...
[reaching the storage limit](/azure/postgresql/concepts-pricing-tiers#reaching-the-storage-limit) and
...
[Azure Database for PostgreSQL pricing tiers](/azure/postgresql/concepts-pricing-tiers#storage).

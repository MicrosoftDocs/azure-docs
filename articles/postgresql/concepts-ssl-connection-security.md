...
You can use OpenSSL to decode the certificate file needed for your application to connect securely to your database server. For more information about OpenSSL and how to install it, see the [OpenSSL GitHub repository](https://github.com/openssl/openssl).

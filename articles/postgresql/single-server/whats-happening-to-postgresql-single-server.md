...
**A.** Beginning November 30 2023, you'll no longer be able to create new single server instances for PostgreSQL version 11 through the Azure portal. However, you can still [make them via CLI until November 2024](https://azure.microsoft.com/updates/singlepg11-retirement/). We will continue to support single servers through our [versioning support policy.](concepts-version-policy.md) It would be best to start migrating to Azure Database for PostgreSQL - Flexible Server immediately.

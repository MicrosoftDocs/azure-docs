...
|iops|IOPS|Count|See the [definition](../virtual-machines/linux/premium-storage-performance.md#iops) and Hyperscale [throughput](concepts-hyperscale-configuration-options)|

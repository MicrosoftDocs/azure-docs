...
| source-server | mydemoserver | The name or resource ID of the existing master server to replicate from. Use the resource ID if you want the replica and master's resource group to be different. |

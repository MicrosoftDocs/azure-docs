<properties pageTitle="User server scripts to validate and modify data (Windows Store) | Mobile Dev Center" description="Learn how to use server scripts to validate, modify, and augment data for your Windows Store app with Azure Mobile Services." services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>

...
The client address pool is a range of private IP addresses that you specify. The clients that connect over a point-to-site VPN dynamically receive an IP address from this range. Use a private IP address range that doesn't overlap with the on-premises location that you connect from, or the VNet that you want to connect to. If you configure multiple protocols and SSTP is one of the protocols, then the configured address pool is split between the configured protocols equally.
   ...
   :::image type="content" source="./media/point-to-site-gateway-certificate/configuration-address-pool.png" alt-text="Screenshot of Point-to-site configuration page - address pool." lightbox="./media/point-to-site-gateway-certificate/configuration-address-pool.png":::
...
:::image type="content" source="./media/point-to-site-gateway-certificate/configuration-tunnel-type.png" alt-text="Screenshot of Point-to-site configuration page - tunnel type." lightbox="./media/point-to-site-gateway-certificate/configuration-tunnel-type.png":::
...
:::image type="content" source="./media/point-to-site-gateway-certificate/configuration-authentication-type.png" alt-text="Screenshot of Point-to-site configuration page - authentication type." lightbox="./media/point-to-site-gateway-certificate/configuration-authentication-type.png":::

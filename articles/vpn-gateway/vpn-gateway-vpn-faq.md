...
Yes, but the Public IP address of the Point-to-Site client needs to be different than the Public IP address used by the Site-to-Site VPN device, else the Point-to-Site connection will not work.

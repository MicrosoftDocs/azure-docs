...
1. In the [classic portal](https://manage.windowsazure.com), go to **Networks** and click the classic VNet for which you want to create a virtual network gateway. This opens the main page for your VNet.

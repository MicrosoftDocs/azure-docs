...
* For gateways using Basic IP, you will need to migrate your gateway to use Standard IP when the migration tool becoms available. As part of the Basic IP to Standard IP migration, the gateways will be upgraded to Gen2 with no further action needed. 

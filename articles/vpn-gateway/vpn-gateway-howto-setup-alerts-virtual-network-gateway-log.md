...
description: Learn how to set up alerts based on resource log events from Azure VPN Gateway using Azure Monitor Log Analytics and the resource logs available in Azure.

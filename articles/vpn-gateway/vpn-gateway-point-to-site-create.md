...
[AZURE.NOTE] This article applies to virtual networks that were created in the classic deployment mode. At this time, point-to-site connections to virtual networks that are created using the Resource Manager model are not available.

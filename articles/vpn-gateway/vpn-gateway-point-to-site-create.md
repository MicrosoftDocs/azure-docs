...
This article walks you through creating a VNet with a Point-to-Site connection in the **classic deployment model** using the classic portal. Currently, you cannot create this configuration end-to-end in the Azure portal for the classic deployment model. You can create some steps in the Azure portal, but PowerShell is still required for the VPN client configuration download.

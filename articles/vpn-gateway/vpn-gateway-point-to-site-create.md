...
>[AZURE.NOTE] This article applies to point-to-site connections for virtual networks that are created in the classic deployment model. At this time, point-to-site connections for virtual networks that are created using the Resource Manager model are not available.

...
Certificates are used to authenticate VPN clients for Point-to-Site VPNs. You can use both certificates generated by an enterprise certificate solution, as well as self-signed certificates. You can upload up to 20 root certificates to Azure.

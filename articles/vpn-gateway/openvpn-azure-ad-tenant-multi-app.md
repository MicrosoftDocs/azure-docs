...
> [!NOTE]
> Azure AD authentication is supported only for OpenVPN® protocol connections. Azure AD authentication requires the Azure VPN client, which is available only for Windows 10.
>

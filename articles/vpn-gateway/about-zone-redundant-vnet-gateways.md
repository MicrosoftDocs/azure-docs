...
For information about gateway tunnels, connections, and throughput, see [VPN Gateway SKUs](vpn-gateway-about-vpngateways.md#gwsku) and [ExpressRoute Gateway SKUs](../articles/expressroute/expressroute-about-virtual-network-gateways.md#gwsku).

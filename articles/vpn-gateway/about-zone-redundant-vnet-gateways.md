...
The new SKUs are available in Azure regions that have Azure Availability Zones - Central US, East US, East US 2, West US 2, West Europe, North Europe, France Central, UK South, Australia East, Japan East and Southeast Asia regions. Going forward, we will make zone-redundant gateways available to you in other Azure Public Regions.

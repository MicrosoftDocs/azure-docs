...
| Cisco              |ASA       |8.3<br>8.4+ (IKEv2*) |Supported |[Configuration guide*](vpn-gateway-3rdparty-device-config-cisco-asa.md) |
...
| Sophos | XG Next Gen Firewall | XG v17 | | [Configuration guide](https://community.sophos.com/kb/127546)<br>[Configuration guide - Multiple SAs](https://community.sophos.com/kb/en-us/133154) |

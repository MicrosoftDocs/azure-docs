...
| Cisco | CSR | RouteBased: IOS-XE 16.10 | | [Configuration script](vpn-gateway-download-vpndevicescript.md) |
...
| Fortinet |FortiGate |FortiOS 5.6 |  |[Configuration guide](https://cookbook.fortinet.com/ipsec-vpn-microsoft-azure-56/) |
| Hillstone Networks |NGFW/iNGFW/CloudEdge(VFW) |StoneOS 5.5R4 |[Configuration guide](https://www.hillstonenet.com/blog/creating-an-ipsec-tunnel-with-microsoft-azure/) |[Configuration guide](https://www.hillstonenet.com/blog/creating-an-ipsec-tunnel-with-microsoft-azure/) |

...
| P2S VPN | P2S VPN Client| [Azure VPN Client for Linux](#linux)| [Certificate](point-to-site-vpn-client-certificate.md) authentication, [Microsoft Entra ID ](point-to-site-entra-vpn-client-linux.md) authentication.| May 2024 | N/A|

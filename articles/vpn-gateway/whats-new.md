...
|---|---|---|---|---|---|
| P2S VPN | P2S | Azure VPN Client for Linux| [Certificate](point-to-site-certificate-client-linux-azure-vpn-client.md) authentication, [Microsoft Entra ID ](point-to-site-entra-vpn-client-linux.md) authentication| May 2024 | N/A|
| P2S VPN | P2S | [Azure VPN Client versions](azure-vpn-client-versions.md) | Microsoft Entra ID authentication, additional features.  | May 2024 | N/A|

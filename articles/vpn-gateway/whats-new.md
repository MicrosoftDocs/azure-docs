...
|Basic SKU public IP address migration - For Basic SKU Gateway | Impact details to be updated by **Apr 30, 2025** | Migration plan for Basic IP address for Basic Gateway SKU’s will be published by **Apr 30, 2025** | Customer action to be updated by **Apr 30, 2025** | Available when the migration details are released | [Basic SKU public IP address retirement](https://azure.microsoft.com/updates?id=upgrade-to-standard-sku-public-ip-addresses-in-azure-by-30-september-2025-basic-sku-will-be-retired) |

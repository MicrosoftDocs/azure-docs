...
We are aware that makecert has been deprecated and we're working on validating a new method. During this time, you can still use the following method. We'll update this page when we have validated a replacement method to create compatible self-signed certificates for P2S connections.

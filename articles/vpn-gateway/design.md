...
:::image type="content" source="./media/tutorial-site-to-site-portal/diagram.png" alt-text="Site-to-site VPN Gateway cross-premises connection diagram." lightbox="./media/tutorial-site-to-site-portal/diagram.png":::
...
:::image type="content" source="./media/design/multi-site.png" alt-text="Site-to-site VPN Gateway cross-premises connection with multiple sites." lightbox="./media/design/multi-site.png":::
...
:::image type="content" source="./media/vpn-gateway-howto-point-to-site-rm-ps/point-to-site-diagram.png" alt-text="Point-to-site diagram." lightbox="./media/vpn-gateway-howto-point-to-site-rm-ps/point-to-site-diagram.png":::
...
:::image type="content" source="./media/design/expressroute-vpngateway-coexisting-connections-diagram.png" alt-text="ExpressRoute and VPN Gateway coexisting connections example." lightbox="./media/design/expressroute-vpngateway-coexisting-connections-diagram.png":::

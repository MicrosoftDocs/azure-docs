...
If you decide to follow both sets of steps, you will establish two VNet-to-VNet connections as shown in the diagram below:
...
Use the example below. The Allocation Method for this address must be Dynamic. 
...
In this step, you'll create the virtual network gateway for your TestVNet1. VNet-to-VNet configurations require a RouteBased VpnType. Creating a gateway can take a while (20 minutes or more to complete).
...
Before you start, please make sure you are still connected to Subscription 1.
...
The examples below will show you how to verify your connection by using PowerShell. Please be sure to change the values to match your environment.
...
These two elements will have values similar to the following example output:
	...
	VNet1GW
	PS D:\> $vnet1gw.Id
	/subscriptions/b636ca99-6f88-4df4-a7c3-2f8dc4545509/resourceGroups
...
These two elements will have values similar to the following example output:
	...
	VNet5GW
	PS C:\> $vnet5gw.Id
	/subscriptions/66c8e4f1-ecd6-47ed-9de7-7e530de23994/resourceGroups/TestRG5/providers/Microsoft.Network/virtualNetworkGa
	teways/VNet5GW

...
1. Each connection is counted against the maximum number of tunnels for your Azure VPN gateway. See the [Overview](vpn-gateway-about.md#benchmark) page for the latest information about tunnels, connections, and throughput.

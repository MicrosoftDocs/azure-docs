...
If you don't have a Resource Manager VNet and are running these steps as an exercise, you can create a VNet by using [this article](../virtual-network/manage-virtual-network.md#create-a-virtual-network) and the Example values.

...
description: Learn about Azure VPN Gateway supports Border Gateway Protocol, the standard routing protocol used to exchange routing and reachability information.

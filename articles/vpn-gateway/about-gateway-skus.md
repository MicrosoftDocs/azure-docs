...
* Starting December 1, 2023, all gateways SKUs (except the Basic gateway SKU) can only be created using Standard SKU public IP addresses. Because Basic SKU public IP addresses are [announced to retire](https://azure.microsoft.com/updates/upgrade-to-standard-sku-public-ip-addresses-in-azure-by-30-september-2025-basic-sku-will-be-retired/) September 30, 2025, we're no longer permitting new gateways to be created using a Basic SKU public IP address.

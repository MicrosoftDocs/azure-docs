...
Example:
  ...
  ![New AAD tenant](./media/vpn-gateway-openvpn-create-aad-tenant/newtenant.png)
...
1. Locate the Directory ID of the directory that you want to use for authentication. It is listed in the properties section of the Active Directory page.
    ...
    ![Directory ID](./media/vpn-gateway-openvpn-create-aad-tenant/DirectoryID.png)
...
5. Select the **Global Admin** account if prompted.
    ...
    ![Directory ID](./media/vpn-gateway-openvpn-create-aad-tenant/pick.png)

6. Click **Accept** when prompted.

    ![Accept](./media/vpn-gateway-openvpn-create-aad-tenant/accept.jpg)

7. Under your Azure AD, in **Enterprise applications**, you see **Azure VPN** listed.

    ![Azure VPN](./media/vpn-gateway-openvpn-create-aad-tenant/azurevpn.png)
...
8. Enable AAD authentication on the VPN gateway by running the following commands, being sure to modify the command to reflect your own environment:
    ...
    Set-AzVirtualNetworkGateway $gw -AadTenantUri "https://login.microsoftonline.com/<your Directory ID>" -AadAudienceId "41b23e61-6c1e-4545-b367-cd054e0ed4b4" -AadIssuerUri "https://sts.windows.net/<your Directory ID>/"
    ```
...
10. After running the commands, you see a result similar to the one below. Copy the result URL to your browser to download the profile zip file.
    ...
    ![Azure VPN](./media/vpn-gateway-openvpn-create-aad-tenant/profile.png)
...
In order to connect to your virtual network, you must create and configure a VPN client profile. See [Configure a VPN client for P2S VPN connections](vpn-gateway-openvpn-aad-client.md).

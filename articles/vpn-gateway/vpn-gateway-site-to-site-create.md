...
Next, you'll configure the **Virtual Network Gateway** in order to create a secure site-to-site connection. See [Configure a Virtual Network Gateway in the Management Portal](vpn-gateway-configure-vpn-gateway-mp.md).

...
description: Quickly create a route-based Azure VPN gateway using PowerShell, for a VPN connection to your on-premises network or to connect virtual networks.

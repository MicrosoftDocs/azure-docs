...
# Get Started
## [Plan and design](vpn-gateway-plan-design.md)
## [Settings](vpn-gateway-about-vpn-gateway-settings.md)
## [VPN devices for site-to-site connections](vpn-gateway-about-vpn-devices.md)
# [BGP and VPN Gateway](vpn-gateway-bgp-overview.md)
## [Highly-available connections](vpn-gateway-highlyavailable.md)
...
#### [Classic portal](vpn-gateway-site-to-site-create.md)
### Point-to-site
### [Azure portal](vpn-gateway-howto-point-to-site-resource-manager-portal.md)
#### [Azure portal (classic)](vpn-gateway-howto-point-to-site-classic-azure-portal.md)
#### [PowerShell](vpn-gateway-howto-point-to-site-rm-ps.md)
#### [Classic portal](vpn-gateway-point-to-site-create.md)
### VNet-to-VNet
#### [Azure portal](vpn-gateway-howto-vnet-vnet-resource-manager-portal.md)
#### [PowerShell](vpn-gateway-vnet-vnet-rm-ps.md)
#### [Classic portal](virtual-networks-configure-vnet-to-vnet-connection.md)
### VNet-to-VNet connections between different deployment models
...
## [Manage self-signed certificates for point-to-site connections](vpn-gateway-certificates-point-to-site.md)

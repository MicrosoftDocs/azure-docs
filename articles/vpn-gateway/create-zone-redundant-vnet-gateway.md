...
description: Learn how to deploy VPN and ExpressRoute gateways in Azure Availability Zones, adding resiliency, scalability, and higher availability to VNet gateways.

...
[!INCLUDE [Table requirements for old SKUs](../networking/includes/vpn-gateway/table-requirements-legacy-sku.md)]
...
[!INCLUDE [Change to the new SKUs](../networking/includes/vpn-gateway/gwsku-change-legacy-sku.md)]

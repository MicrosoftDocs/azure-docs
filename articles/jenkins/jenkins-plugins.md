...
| [Azure VM agents plugin](https://plugins.jenkins.io/azure-vm-agents)         | A Jenkins Plugin to create Jenkins agents in Azure Virtual Machines (via Azure ARM template). | 

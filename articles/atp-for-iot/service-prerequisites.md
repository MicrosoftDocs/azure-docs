...
ASC for IoT agent supports a growing list of devices and platforms. See the [supported platform list](device-agent-prerequisites.md) to check your existing or planned device library.  

---
title: 'Quickstart: Create a storage task by using Python'
...
# Create a storage task by using Python

This quickstart describes how to create a storage task by using Python.

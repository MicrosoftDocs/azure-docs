---
title: 'Quickstart: Create a storage task by using Terraform'
titleSuffix: Azure Storage Actions
description: Learn how to create a storage task by using Terraform.
...
# Create a storage task by using Terraform

This quickstart describes how to create a storage task by using Terraform.

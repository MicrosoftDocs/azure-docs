...
## Next steps
- Review the requirements for setting up agent-based analysis for [VMware VMs](migrate-support-matrix-vmware.md#dependency-analysis-requirements-agent-based), [physical servers](migrate-support-matrix-physical.md#agent-based-dependency-analysis-requirements), and [Hyper-V VMs](migrate-support-matrix-hyper-v.md#agent-based-dependency-analysis-requirements).
- [Review](migrate-support-matrix-vmware.md#dependency-analysis-requirements-agent-based) the requirements for agentless analysis of VMware VMs.

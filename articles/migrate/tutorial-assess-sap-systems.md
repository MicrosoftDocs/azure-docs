...
1. In **Prizing settings**, select the following options:
...
1. Select **SAP on Azure** from the left pane to view the drill-down assessments details at the SID level.

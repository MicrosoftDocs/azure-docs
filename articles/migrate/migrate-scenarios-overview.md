...
--- | --- | --- | ---
**Scenario 1: Discovery** | Discover and assess on-premises apps and data for migration to Azure | Azure Migrate, Azure Database Management | Available now
...
## Scenario 1: Discovery and assessment

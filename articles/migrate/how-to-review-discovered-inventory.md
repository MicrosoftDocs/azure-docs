...
The **All Inventory** view helps you review all the workloads discovered from your datacenter that includes servers (VMware VMs/Hyper-V VMs/Physical servers/servers running in other public clouds), databases, and web applications which can be found inline by expanding the server.
...
### Perform user actions on web app inventory

...
# Customer intent: As a server admin, I want to assess my Google Cloud Platform VM instances for migration to Azure, so that I can evaluate their readiness, estimate costs, and identify any potential risks in the migration process.
---

...
| **Permissions**           | **Windows:** You need a local or domain user account on all the Windows servers you want to discover. The user account should be a local administrator<br/><br/> **Linux:** You need a root account on the Linux servers that you want to discover. |

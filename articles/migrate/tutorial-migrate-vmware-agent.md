...
17. In **Disks**, specify whether the VM disks should be replicated to Azure, and select the disk type (Premium V2, Ultra & ZRS, standard SSD/HDD or Premium Managed disks) in Azure. Then select **Next**.

...
> [!NOTE]
> In order for the extension to send data to your Azure Migrate project, ensure that the project's system-assigned managed identity is added as "Migrate Arc Discovery Reader - Preview" on the
...
| Extension installation successful, but status later changes to Failed | Project scope incorrect | Verify that the Azure Migrate scope contains your Arc-enabled servers |

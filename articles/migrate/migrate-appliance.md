...
- The appliance can be deployed using a template for servers running in VMware or Hyper-V environment ([OVA template for VMware](tutorial-discover-vmware.md#set-up-the-appliance))or [VHD for Hyper-V](tutorial-discover-hyper-v.md#set-up-the-appliance).

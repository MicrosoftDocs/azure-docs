...
Currently, Azure Migrate only recommends I1, P1v2, and P1v3 SKUs. Premium plans are for production workloads and run on dedicated Virtual Machine instances. Each instance can support multiple applications and domains. The Isolated plans host your apps in a private, dedicated Azure environment and are ideal for apps that require secure connections with your on-premise network.

> [!NOTE]
> There are more SKUs available in Azure App service. [Learn more](https://azure.microsoft.com/pricing/details/app-service/windows/).

### Azure App Service Plan

In App Service, an app always runs in an [App Service plan](https://docs.microsoft.com/azure/app-service/overview-hosting-plans). An App Service plan defines a set of compute resources for a web app to run. At a high level, plan/SKU is determined as per below table.
...
> [!NOTE]
> Your App Service plan can be scaled up and down at any time. [Learn more](https://docs.microsoft.com/azure/app-service/overview-hosting-plans#what-if-my-app-needs-more-capabilities-or-features/).

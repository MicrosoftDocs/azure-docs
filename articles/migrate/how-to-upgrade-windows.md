...
> [!Note]
> Once you migrate and upgrade to Windows Server 2012 in Azure, you get 3 years of free Extended Security Updates in Azure. [Learn more](https://learn.microsoft.com/windows-server/get-started/extended-security-updates-overview).

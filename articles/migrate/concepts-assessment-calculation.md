...
**Azure Reserved Virtual Machine Instances** | Specifies [reserved instances](https://azure.microsoft.com/pricing/reserved-vm-instances/) so that cost estimations in the assessment take them into account.<br/><br/> When any reserved instances is selected, please leave the Discount (%) and VM uptime properties as default.  <br/><br/> Azure Migrate currently supports Azure Reserved VM Instances only for pay-as-you-go offers.
...
**EA Subscription** | Specifies Enterprise Agreement (EA) subscription for cost estimation and will take into account the discount applicable to the subscription. <br/><br/> Please leave the Reserved Instances, Discount (%) and VM uptime properties as default.

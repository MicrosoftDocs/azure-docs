...
# Azure Migrate application and code assessment for Java - Next genereation preview 
...
This tool is open source and is based on a set of components in the CNCF [Konveyor](https://github.com/konveyor) project created and led by Red Hat, and published under the [Apache License](https://github.com/konveyor/kantra?tab=Apache-2.0-1-ov-file#readme).
...
To use the `appcat` CLI, you must download the package specific to your environment, and have a compatible JDK 11 or JDK 17 installation on your computer.

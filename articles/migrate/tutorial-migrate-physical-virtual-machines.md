...
1. In **Target settings**, select the subscription to which you'll migrate (The region is set to your selection the previous step and cannot be modified) . Specify the resource group in which the Azure VMs will reside after migration.

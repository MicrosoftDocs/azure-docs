...
12. In **Disks**, indicate whether the VM disks should be replicated to Azure, and specify the disk type (Premium V2, Ultra & ZRS, standard SSD/HDD or Premium Managed disks) in Azure. Then select **Next**.

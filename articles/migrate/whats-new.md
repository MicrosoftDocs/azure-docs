...
- Public preview: Using the RVTools XLSX (preview), you can import on-premises servers in a VMware environment. [Learn more](migrate-support-matrix-vmware.md#import-servers-using-rvtools-xlsx-preview). 

...
- Migration of UEFI-based VMs and physical servers to Azure generation 2 VMs is now supported. With this release, we will not support the conversion of Gen 2 VMs to Gen 1 VMs.

...
- Discover, assess, and migrate servers over a private network using [Azure Private Link](./azure/private-link/private-endpoint-overview) is now in preview in supported [government cloud geographies.](./azure/migrate/migrate-support-matrix#supported-geographies-azure-government)
...
- Support for Azure [ultra disks](../virtual-machines/disks-types.md#ultra-disk) in Azure VM assessment recommendation.

...
- Support to discover, assess and migrate VMs from multiple vCenter Servers using a single Azure Migrate appliance. [Learn more](tutorial-discover-vmware#start-continuous-discovery)

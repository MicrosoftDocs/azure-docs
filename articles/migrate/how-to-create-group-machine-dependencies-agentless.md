...
- [Review](migrate-support-matrix-vmware.md#adependency-analysis-requirements-agentless) the prerequisites and support requirements for setting up agentless dependency visualization for VMware VMs

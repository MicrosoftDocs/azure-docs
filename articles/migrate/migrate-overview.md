...
- You can only create an Azure Migrate project in West Central US or East US region. This doesn't impact your ability to plan migration to any target Azure location. The location of the migration project is used only to store metadata discovered from the on-premises environment.

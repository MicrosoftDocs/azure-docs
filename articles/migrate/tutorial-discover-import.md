...
- If you import serves by using a CSV file and creating an assessment with sizing criteria as "performance-based":
    ...
    - For Azure VMware Solutiona ssessment, the performance values you specify (CPU utilization, Memory utilization, Storage in use(GB)) are used if you choose performance-based sizing. You will not be able to provide performance history and percentile information. 

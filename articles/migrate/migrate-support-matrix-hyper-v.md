...
| **Support**                | **Details**               
| :-------------------       | :------------------- |
| **Hyper-V host**       | The Hyper-V host can be standalone, or deployed in a cluster.<br/><br/> The Hyper-V host can run Windows Server 2019, Windows Server 2016, or Windows Server 2012 R2. Server core installation of Windows Server 2016 and Windows Server 2012 R2 are also supported. <br/>You can't assess VMs located on Hyper-V hosts running Windows Server 2012.

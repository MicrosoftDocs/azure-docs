...
6. On the **General settings** tab, modify the assessment settings that are applicable across all Azure targets. 
   ...
   | Program/offer  | The Azure offer in which you're enrolled. Assessment estimates the cost for that offer. | - [Pay-as-you-go](https://azure.microsoft.com/pricing/offers/ms-azr-0003p?cid=msft_learn) (default)<br> - [Enterprise Agreement](https://azure.microsoft.com/pricing/offers/enterprise-agreement-support/)<br> - [Microsoft Customer Agreement](/azure/cost-management-billing/understand/mca-overview) |
   ...
   | Azure Hybrid benefit		|  Azure Hybrid Benefit allows Microsoft customers with Windows Server Software Assurance or Windows Server subscriptions to bring their licenses to Azure. [Learn more](https://azure.microsoft.com/pricing/offers/hybrid-benefit?cid=msft_learn) | Specify whether you already have a Windows Server license. This setting is enabled by default. |

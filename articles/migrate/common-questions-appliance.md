...
- **Servers in VMware environment**: [Review](discovered-metadata.md#collected-data---vmware) collected data.
- **Servers in Hyper-V environment**: [Review](discovered-metadata.md#collected-data---hyper-v) collected data.
- **Physical or virtual servers**:[Review](discovered-metadata.md#collected-data---physical) collected data.

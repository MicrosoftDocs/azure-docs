...
This tutorial shows you how to discover, assess, and migrate Amazon Web Services (AWS) virtual machines (VMs) to Azure VMs by using the Azure Migrate: Server Assessment tool and the Migration and modernization tool.

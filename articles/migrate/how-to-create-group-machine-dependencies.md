...
> [!Note]
> [Click here](https://docs.microsoft.com/azure/azure-monitor/logs/private-link-security) to learn how to configure the OMS workspace for private endpoint connectivity.  

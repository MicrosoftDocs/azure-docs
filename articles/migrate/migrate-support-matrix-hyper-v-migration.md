...
| **Host operating system** | Windows Server 2019, Windows Server 2016, or Windows Server 2012 R2 with latest updates. **Note** Server core installation of these operating systems is also supported. |

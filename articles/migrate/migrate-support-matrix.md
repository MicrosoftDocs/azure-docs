...
## Import servers using RVTools XLSX
...
If you're import servers by using an RVTools XLSX (preview) file for creating an assessment with the following criteria:

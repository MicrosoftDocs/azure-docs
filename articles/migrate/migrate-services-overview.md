...
**Azure Database Migration Service** | Migrate on-premises databases to Azure VMs running SQL Server, Azure SQL Database, or an Azure SQL Database managed instance. | [Learn more](https://docs.microsoft.com/azure/dms/dms-overview) about Database Migration Service.

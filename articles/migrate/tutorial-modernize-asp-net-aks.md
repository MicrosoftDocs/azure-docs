...
> [!Important]
> This feature is retired. For guidance on migrating ASP.NET web apps to AKS, refer to the  [Modernize ASP.NET web apps to Azure Kubernetes Service (preview)](tutorial-modernize-asp-net-aks.md) documentation.

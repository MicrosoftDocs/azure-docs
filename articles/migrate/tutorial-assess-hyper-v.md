...
> [!NOTE]
> This article describes how to assess Hyper-V VMs using the latest version of Azure Migrate. If you're using the earlier classic version of Azure Migrate, assessment of Hyper-V VMs isn't supported. How can I check which version I'm using?

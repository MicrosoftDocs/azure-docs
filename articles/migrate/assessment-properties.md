...
|**VM Security Type** | | Specifies if you want to verify readiness for **Trusted Launch Virtual Machines (TVMs)**, **Standard Virtual Machines** and **Confidential Virtual Machines (CVMs)**. By default, readiness is verified for Trusted Launch and Standard Virtual Machines. We recommend migrating eligible VMs to **Trusted Launch**, as TVMs provide enhanced security features, such as secure boot and virtual TPM. </br> For VMs requiring stronger security and compliance, you can also choose **Azure Confidential Virtual Machine (CVM)**, which provide hardware-backed memory encryption and trusted execution environments to help protect data in use. VMs that don't meet Confidential Virtual machine requirements are assigned **Standard** or **Trusted Launch** security type accordingly to ensure migration compatibility. |

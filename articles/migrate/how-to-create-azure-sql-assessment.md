...
**Target deployment type<br/>(in assessment properties)** | **Readiness**   
--- | --- |
**Recommended** |  Ready for Azure SQL Database <br/> Ready for Azure SQL Managed Instance <br/> Potentially ready for Azure VM <br/> Readiness unknown (In case the discovery is in progress or there are some discovery issues to be fixed)
**Azure SQL DB** or <br/> **Azure SQL MI** | Ready for Azure SQL Database or Azure SQL Managed Instance <br/> Not ready for Azure SQL Database or Azure SQL Managed Instance <br/>Readiness unknown (In case the discovery is in progress or there are some discovery issues to be fixed)
...
1. Review the recommended deployment type for the SQL instance which is determined as per the matrix below:
    ...
    - **Target deployment type** (as selected in assessment properties): **Recommended**
        ...
        **Azure SQL DB readiness** | **Azure SQL MI readiness** | **Recommended deployment type** | **Azure SQL configuration and cost estimates calculated?**
         --- | --- | --- | --- |
        Ready | Ready | Azure SQL DB or <br/>Azure SQL MI <br/> [Learn more]() | Yes
        Ready | Not ready or<br/> Unknown | Azure SQL DB | Yes
        Not ready or<br/> Unknown | Ready | Azure SQL MI | Yes
        Not ready | Not ready | Potentially ready for Azure VM <br/>[Learn more]() | No

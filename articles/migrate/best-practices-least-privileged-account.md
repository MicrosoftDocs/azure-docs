...
| Provisioning - Allow read-only disk access  | Allow read-only disk access: opening a disk on a VM to read the disk using the VDDK | Virtual machines  | `VirtualMachine.Provisioning.DiskRandomRead`  |

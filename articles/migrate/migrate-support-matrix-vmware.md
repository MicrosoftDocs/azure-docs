...
**Support** | **Details**
--- | ---
**Assessment limits**| You can discover and assess up to 35,000 VMware VMs in a single [project](migrate-support-matrix.md#azure-migrate-projects).
**Project limits** | You can create multiple projects in an Azure subscription. In addition to VMware VMs, a project can include physical servers and Hyper-V VMs, up to the assessment limits.

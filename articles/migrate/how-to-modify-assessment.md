...
2. Modify the properties in accordance with the following table:
    ...
    **Setting** | **Details** | **Default**
    --- | --- | ---
    **Target location** | The Azure location to which you want to migrate.<br/><br/> Azure Migrate currently supports 30 regions including Australia East, Australia Southeast, Brazil South, Canada Central, Canada East, Central India, Central US, China East, China North, East Asia, East US, Germany Central, Germany Northeast, East US 2, Japan East, Japan West, Korea Central, Korea South, North Central US, North Europe, South Central US, Southeast Asia, South India, UK South, UK West, US DoD Central, US DoD East, US Gov Arizona, US Gov Iowa, US Gov Texas, US Gov Virginia, West Central US, West Europe, West India, West US, and West US2. |  West US 2 is the default location.
    ...
    **Performance history** | The sampling duration to consider for  the performance history of the VMs and disks. | Default is one day.
    **Percentile utilization** | The percentile value of the sample set to be considered for right-sizing. | Default is 95th percentile.
    **VM series** | The VM series that will be considered for right-sizing. For example, if you have a production environment that you do not plan to migrate to A-series VMs in Azure, you can exclude the A-series VMs from the list and the right-sizing will be done only in the selected series. | By default, all the VM-series applicable to the Azure region will be selected.  

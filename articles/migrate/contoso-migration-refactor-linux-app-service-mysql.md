...
[Article 9: Refactor an app on Azure Web Apps and Azure SQL Database](contoso-migration-refactor-web-app.md) | Demonstrates how Contoso migrates the SmartHotel app to an Azure container-based web app, and migrates the app database to Azure SQL Server. | Available

...
The functionality is now in preview in all [public cloud regions.](https://docs.microsoft.com/en-us/azure/migrate/migrate-support-matrix#supported-geographies-public-cloud)

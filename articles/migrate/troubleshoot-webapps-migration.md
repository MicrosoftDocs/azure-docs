...
AddConflict | The role assignment already exists. | This may be due to AKS 1.23+ version. If you are using AKS 1.23+, edit the script as mentioned in [Build container image](tutorial-app-containerization-aspnet-kubernetes.md#build-container-image) before building the docker image.

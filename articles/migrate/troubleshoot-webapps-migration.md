...
AddConflict | <Add error message> | This may be due to AKS 1.23+ version. If you are using AKS 1.23+, edit the script as mentioned in [Troubleshooting](tutorial-app-containerization-aspnet-kubernetes.md) before building the docker image.

...
* Since Trial Matcher is based on TA4H for analyzing unstructured text, please refer to [Text Analytics for health Transparency Note](https://learn.microsoft.com/en-us/legal/cognitive-services/language-service/transparency-note-health)
...
[Text Analytics for Health Transparency Note](https://learn.microsoft.com/en-us/legal/cognitive-services/language-service/transparency-note-health).


## Contact us
Give us feedback on this document [Health Insights Support](HealthDecisionSupport@service.microsoft.com).

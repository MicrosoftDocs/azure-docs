...
The models can receive input in different modalities, from one or more patients, and return a insight inferences as a result, with potential reasoning. 
...
Health and Life Sciences organizations have multiple high-value business problems which require clinical insights inferences that is based on clinical data. 

...
|---------|---------|---------|
|Manually created central VNets not supported|Currently, Azure Firewall Manager supports networks created with Virtual Hubs. Using your own manually created hub VNet is not yet supported.|For now, use Azure Firewall Manager with hub and spoke networks created with Virtual Hubs.
|Third-party NSaaS filtering limitations|V2I traffic filtering with third-party NSaaS providers is not supported with Azure Firewall B2V and V2V.|It is possible to have two secured virtual hubs side by side, where one hub is for V2I with a third-party NSaaS providers and the other is with Azure Firewall for B2V and V2V.|

...
1. In the Azure portal search bar, type **Network Security** and press **Enter**.
1. On the Network Security page, under **Secure your resources**, select **Application Delivery Platforms**.
...
1. On the Network Security page, under **WAF + DDOS**, select **Web Application Firewalls** to view all your policies.
1. Select **Create** to create a new WAF policy or import settings from an existing WAF policy.

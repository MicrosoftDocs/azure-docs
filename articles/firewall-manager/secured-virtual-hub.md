...
You can use a secured virtual hub to filter traffic between virtual networks (V2V), branch-to-branch (B2B), and branch offices (B2V) and traffic to the Internet (B2I/V2I). A secured virtual hub provides automated routing. There's no need to configure your own UDRs (user defined routes) to route traffic through your firewall.
...
You can configure a Virtual WAN to enable inter-hub security and branch-to-branch security (even within the same hub) by configuring routing intent. For more information on routing intent, see [Routing Intent documentation](../virtual-wan/how-to-routing-policies.md).

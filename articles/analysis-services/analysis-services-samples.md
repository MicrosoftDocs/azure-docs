...
Azure Synapse Analytics (SQL Data Warehouse) provides a sample AdventureWorksDW database that can be included in a provisioned resource. To learn more, see [Quickstart: Create and query a dedicated SQL pool in Azure Synapse Analytics ](/azure/sql-data-warehouse/create-data-warehouse-portal).

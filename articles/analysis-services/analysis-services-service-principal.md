...
Analysis Services does not support managed identities. To learn more, see [Managed identities for Azure resources](../active-directory/managed-identities-azure-resources/overview.md) 

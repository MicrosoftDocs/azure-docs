...
-   An [Azure SQL Data Warehouse](../../sql-data-warehouse/create-data-warehouse-portal) with the sample AdventureWorksDW database, or a SQL Server Data Warehouse with the [Adventure Works sample database](http://go.microsoft.com/fwlink/?LinkID=335807).

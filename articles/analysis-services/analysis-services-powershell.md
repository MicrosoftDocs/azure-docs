...
|[Suspend-AzureRmAnalysisServicesServe](https://docs.microsoft.com/en-us/powershell/resourcemanager/azurerm.analysisservices/v3.0.0/suspend-azurermanalysisservicesserver)|Suspends a server instance.| 

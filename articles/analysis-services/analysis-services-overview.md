...
|S2    |    200     |    50     |
|S4    |    400     |    100     |
|S8 <sup>[1](#depr)</sup>, <sup>[2](#reg)</sup>    |    320    |    200     |
|S9 <sup>[1](#depr)</sup>, <sup>[2](#reg)</sup>    |    640    |    400     |
|S8v2 <sup>[1](#depr)</sup>   |    640     |    200     |
|S9v2 <sup>[1](#depr)</sup>    |    1280    |    400     |

<a name="depr">1</a> - Not available in all regions.   
<a name="depr">2</a> - This plan is deprecated. v2 is recommended.
...
|East US 2     |     S8<sup>[2](#reg)</sup>, S9<sup>[2](#reg)</sup>, S8v2, S9v2   |    1    |
...
|West US     |    S8<sup>[2](#reg)</sup>, S9<sup>[2](#reg)</sup>, S8v2, S9v2   |    2  |
|West US2    |    B1, B2, S0, S1, S2, S4, D1    |    3   |
|West US2    |    S8<sup>[2](#reg)</sup>, S9<sup>[2](#reg)</sup>, S8v2, S9v2  |    1     |
...
|West Europe    |   S8<sup>[2](#reg)</sup>, S9<sup>[2](#reg)</sup>, S8v2, S9v2  |  1  |
...
|Australia East     |    S8<sup>[2](#reg)</sup>, S9<sup>[2](#reg)</sup>, S8v2, S9v2    |    1     |
|Australia Southeast     | B1, B2, S0, S1, S2, S4, D1       |    1     |
|Japan East     |   B1, B2, S0, S1, S2, S4, D1       |    1     |
|Southeast Asia     |     B1, B2, S0, S1, S2, S4, S8<sup>[2](#reg)</sup>, S9<sup>[2](#reg)</sup>, S8v2, S9v2, D1     |   1      |

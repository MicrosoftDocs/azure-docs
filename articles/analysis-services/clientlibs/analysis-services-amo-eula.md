...
description: End User License Agreement terms for the MICROSOFT ANALYSIS MANAGEMENT OBJECTS (AMO) redistributable package
...
# Analysis Services AMO redistributable package End User License Agreement (EULA)

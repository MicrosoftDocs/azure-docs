...
>
>To learn more about Logic App IP ranges per region, see [Limits and configuration information for Azure Logic Apps](../logic-apps/logic-apps-limits-and-config#firewall-configuration-ip-addresses.md).

...
* The (unified) gateway described here is not supported in Azure Government. Use the Dedicated On-premises gateway for Azure Analysis Services. The dedicated gateway does not support additional services like Power BI and Power Apps. Dedicated gateway is installed from your servers Quick Start in the portal.

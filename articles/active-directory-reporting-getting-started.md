...
Navigate into each report to see the data being collected and the sign ins processed. You can find a [list of all the reports here](articles/active-directory-reporting-what-it-is).

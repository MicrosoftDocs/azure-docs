...
| Received | After all drives are received at the data center, the job state is set to **Received**.</br>The job status may change several days after the carrier delivers the device, until order processing completes in the datacenter. |

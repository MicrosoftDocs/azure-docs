...
| Received | After all drives are received at the data center, the job state is set to **Received**.</br>The job status may change 1 to 3 days after the carrier delivers the device, when order processing completes in the datacenter. |

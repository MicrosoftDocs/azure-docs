...
> 
> - **.NET** - [Enable diagnostic logging for Azure web apps](/en-us/develop/net/common-tasks/diagnostics-logging-and-instrumentation/)
> - **Node.js** - [How to debug a Node.js application in Azure web apps](/en-us/develop/nodejs/how-to-guides/Debug-Website/)
> 

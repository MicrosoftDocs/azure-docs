...
<properties title="Sample data in SQL Server on Azure" pageTitle="Sample data in SQL Server on Azure| Azure" description="Sample data in SQL Server on Azure" metaKeywords="" services="data-science-process" solutions="" documentationCenter="" authors="liang,mona,fashah" manager="jacob.spoelstra" editor="" videoId="" scriptId="" />

<tags ms.service="data-science-process" ms.workload="data-services" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="01/27/2015" ms.author="liang,mona,fashah,garye" /> 

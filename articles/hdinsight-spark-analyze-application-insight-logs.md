...
# Analyze Application Insights telemetry logs with Spark on HDInsight
 ...
 is an analytics service that monitors your web applications. Telemetry data generated by Application Insights can be exported to Azure Storage, and from there it can be analyzed by HDInsight.
...
* Application Insights telemetry data was generated using a.

...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image1.png)
...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image2.png)
...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image3.png)

Once you find failures under the JOBS view, select the JOB and click
ERROR DETAILS for that job.

![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image4.png)

The error details will help you identify possible cause and
recommendation for the issue.

![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image5.png)
...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image6.png)
...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image7.png)
...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image8.png)
...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image9.png)
...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image10.png)

![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image11.png)
...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image12.png)

In this case *Replication Health* is being indicated as Critical – *View
Replication Health* to see the details.

![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image13.png)
...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image14.png)

An Analytic log is visible under Hyper-V-VMMS

![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image15.png)
...
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image16.png)
...
--------------------------------------------
![](site-recovery-monitoring-and-troubleshooting-for-vmm-and-hyperv-site/image17.png)

...
To learn more about load balancing in Windows Virtual Desktop, see [Configure the Windows Virtual Desktop load-balancing method](configure-host-pool-load-balancing.md).

...
> [AZURE.IMPORTANT] It is recommended to use Network Security Groups (NSGs) instead of ACLs whenever possible. To learn more about NSGs, see [What is a Network Security Group?](../articles/virtual-network-nsg).
...
![Network ACLs and load balanced sets](./media/virtual-network-acl/IC674733.png)

## Next Steps

[How to manage Access Control Lists (ACLs) for Endpoints by using PowerShell](../articles/virtual-network-acl-powershell)
...
You can also [read about all the Resource Manager model commands](virtual-machines/azure-cli-arm-commands.md), and use the CLI to [migrate resources](virtual-machines/virtual-machines-linux-cli-migration-classic-resource-manager.md) from the classic to the Resource Manager model.

...
The Backup and Restore feature in [Azure App Service Web Apps](http://go.microsoft.com/fwlink/?LinkId=529714) lets you easily create backups manually or automatically. You can restore your web app to a previous state, or create a new web app based on one of your original app's backups. 

For information on restoring a web app from backup, see [Restore a web app](../web-sites-restore/).
...
* The Backup and Restore feature requires the app to be in a Standard or Premium tier. For information about scaling your app use a Standard or Premium tier, see [Scale a web app in Azure App Service](../web-sites-scale/). 
...
1. In the Azure portal, choose your web app from the Web Apps blade. This will display the details of your app in a new blade.
2. Select **Settings** option. The **Settings** blade will be displayed allowing you to modify your app.
...
<a name="nextsteps"></a>
## Next Steps
For information on restoring an Azure web app from backup, see [Restore a web app in Azure App Service](../web-sites-restore/).

...
4. In the Add a volume wizard, under **Basic Settings**, do the following:
  ...
  3. From the drop-down list, select the **Usage Type** for your volume. Choose **Archival Volume** if you are working with less frequently accessed archival data. For all other use cases, select the type as **Primary Volume**.
...
Learn how to [clone a volume](storsimple-clone-volume.md)

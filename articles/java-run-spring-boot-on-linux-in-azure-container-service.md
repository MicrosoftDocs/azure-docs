---
title: Deploy a Spring Boot Web App as Linux Web App in Azure Container Service | Microsoft Docs
...
This tutorial will walk you though using Docker to develop and deploy an application to Microsoft Azure. More-specifically, this article will illustrate using *[Spring Boot]* for application development, *[Kubernetes]* for container deployment, and the [Azure Container Service] to host your application.
...
[SB01]: ./media/java-run-spring-boot-on-linux-in-azure-container-service/SB01.png
[SB02]: ./media/java-run-spring-boot-on-linux-in-azure-container-service/SB02.png

[AR01]: ./media/java-run-spring-boot-on-linux-in-azure-container-service/AR01.png
[AR02]: ./media/java-run-spring-boot-on-linux-in-azure-container-service/AR02.png
[AR03]: ./media/java-run-spring-boot-on-linux-in-azure-container-service/AR03.png
[AR04]: ./media/java-run-spring-boot-on-linux-in-azure-container-service/AR04.png

[LX01]: ./media/java-run-spring-boot-on-linux-in-azure-container-service/LX01.png
[LX02]: ./media/java-run-spring-boot-on-linux-in-azure-container-service/LX02.png

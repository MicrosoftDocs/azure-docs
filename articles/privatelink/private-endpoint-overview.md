...
You can connect secure and privately to an Azure Service from your virtual network with a private endpoint. A private endpoint represents a unique network identifier to securely connect to Azure Service, traffic from your VNet to the private link resource is secured by the platform from reaching other resources hosted on the same service. 

...
###Service Bus menu labeled incorrectly
The third page of both the Add Input dialog and the Add Output dialog for Event Hub sources incorrectly label the drop down menu of Service Buses as "Event Hub".
...
[stream.analytics.developer.guide]: ../stream-analytics-scale-jobs/

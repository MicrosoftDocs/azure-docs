...
- **Azure StorSimple cmdlets** – a collection of Windows PowerShell cmdlets that allow you to perform service-level and migration tasks from the command line. For more information about the Azure StorSimple cmdlets, go to the [cmdlet reference](https://msdn.microsoft.com/library/dn920427.aspx).

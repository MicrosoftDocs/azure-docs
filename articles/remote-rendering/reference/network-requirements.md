...
* **Wi-Fi** is the recommended network type since it supports a low latency, high-bandwith, and stable connection. Some mobile networks introduce jitter which can lead to a poor experience. 

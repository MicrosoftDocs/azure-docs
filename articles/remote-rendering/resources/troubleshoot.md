...
..as described in more detail in the [Unity tutorial to set up the project](./../tutorials/unity/view-remote-models/view-remote-models#adjust-the-project-settings).

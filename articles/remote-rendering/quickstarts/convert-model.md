...
From the **"Go to resource"** button above, you get to a page with a panel on the left that contains a list menu. In the middle of the list, under the **"Blob service"** category, click on the **"Containers"** button:

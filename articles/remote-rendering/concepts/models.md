...
The following two code snippets show how to load models with either function. To load a model via the SAS URI, you would use code like the one below:
...
If you want to load a model by directly using its blob storage parameters, you would use code similar to the following snippet:

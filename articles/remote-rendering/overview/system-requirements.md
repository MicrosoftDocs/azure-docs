...
> [!IMPORTANT]
> In addition to the supported versions mentioned below, make sure to check out the [Unity known issues page](https://docs.microsoft.com/windows/mixed-reality/develop/unity/known-issues).

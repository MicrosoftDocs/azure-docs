...
Azure Remote Rendering currently only supports **HoloLens 2** and Windows desktop as a target device. See the see [platform limits](../reference/limits.md#platform-limits) section for further information.

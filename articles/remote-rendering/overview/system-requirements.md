...
> [!IMPORTANT]
> The **WMR (Windows Mixed Reality) plugin for Unity 2020.3** currently has a performance degradation with ARR. We are actively working on a fix. For a better experience, we suggest to either stay on Unity 2019.X until this has been sorted out or switch to the OpenXR version.

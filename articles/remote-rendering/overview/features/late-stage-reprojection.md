...
To mitigate reprojection instability for transparent objects you can force depth buffer writing. See the material flag *transparencyWritesDepth* for the [Color](color-materials.md) and [PBR](pbr-materials.md) materials. Please note that visual quality of transparent/opaque object interaction may suffer when enabling this flag.

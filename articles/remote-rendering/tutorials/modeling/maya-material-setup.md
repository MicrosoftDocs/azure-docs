...
**The Stingray PBR shader** is compatible with many other applications and most closely matches the requirements of `ARR` and it's supported since `Maya 2017`. Also it is convenient that this type of materials visualized in viewport similar to what will be visualized later in the service.

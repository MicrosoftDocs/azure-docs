...
The package is not part of the [samples repository](https://github.com/Azure/azure-remote-rendering), and it is not available from Unity's internal package registry. To add it to a project, you have to manually edit the project's `manifest.md` file to add the following:
```json
{
  "scopedRegistries": [
    {

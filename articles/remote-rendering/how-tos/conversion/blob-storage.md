...
> [!Note]
> When uploading an input model take care to avoid long file names and/or folder structures in order to avoid [Windows path length limit](https://docs.microsoft.com/en-us/windows/win32/fileio/maximum-file-path-limitation) issues on the service. 

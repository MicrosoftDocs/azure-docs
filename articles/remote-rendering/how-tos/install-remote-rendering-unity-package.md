---
title: The Remote rendering Unity package
...
# Install the remote rendering Unity package
...
To add the package to a Unity project, using the 'Add package from disk...' option. For further instructions on its usage, follow the guide to [create a new Unity project](../quickstarts/create-new-unity-project.md).

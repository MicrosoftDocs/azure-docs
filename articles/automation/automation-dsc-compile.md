...
> [!NOTE]
> You may receive an error stating 'The 'Microsoft.PowerShell.Management' module was not imported because the 'Microsoft.PowerShell.Management' snap-in was already imported.' when compilation is complete. This warning can safely be ignored.

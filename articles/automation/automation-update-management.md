...
> [!NOTE]
> Update Management requires certain URLs and ports to be enabled to properly report to the service, see [Network planning for Hybrid Workers](automation-hybrid-runbook-worker#network-planning) to learn more about these requirements.

...
> [!NOTE]
> To be able to be fully managed by Update Management, Operations Manger Agents need to be updated to the Microsoft Monitoring Agent. To learn how to update the agent, see [How to upgrade an Operations Manager agent](/system-center/scom/deploy-upgrade-agents.md).

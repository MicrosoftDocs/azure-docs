...
> [!NOTE]
> The new [Azure PowerShellAz module](/powershell/azure/new-azureps-module-az?view=azurermps-6.13.0) are not supported in Azure Automation. Any scripts downloaded from the PowerShell Gallery with these cmdlets will not work in Azure Automation.

...
The script is available for download from our (GitHub Python 3 runbook repository)[https://github.com/azureautomation/runbooks/blob/master/Utility/Python/import_py3package_from_pypi.py]. 

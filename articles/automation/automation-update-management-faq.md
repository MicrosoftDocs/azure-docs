---
title: Azure Automation Update Management FAQ | Microsoft Docs
description: Answers to frequently asked questions about Azure Automation Update Management solution.
services: automation
ms.subservice: 
ms.topic: conceptual
author: mgoedtel

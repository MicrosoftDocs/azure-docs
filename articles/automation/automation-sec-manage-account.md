...
2. On the **Automation Account** blade, in the **Account properties** pane, under **Account Settings**, select **Run As Accounts**.
    ...
    ![Automation account properties pane](media/automation-sec-manage-account/automation-account-properties-pane.png)
...
4. On the **Properties** blade for the selected account, click **Renew certificate**.
    ...
    ![Renew certificate for Run As account](media/automation-sec-manage-account/automation-account-renew-runas-certificate.png)
...
3. On the **Run As Accounts** properties blade, select either the Run As account or Classic Run As account that you want to delete. Then, on the **Properties** blade for the selected account, click **Delete**.
 ...
 ![Delete Run As account](media/automation-sec-manage-account/automation-account-delete-runas.png)
...
5. After the account has been deleted, you can re-create it on the **Run As Accounts** properties blade by selecting the create option **Azure Run As Account**.
 ...
 ![Re-create the Automation Run As account](media/automation-sec-manage-account/automation-account-create-runas.png)
...
![Incomplete Run As account configuration status](media/automation-sec-manage-account/automation-account-runas-incomplete-config.png)

When you select the Run As account, the account **Properties** pane displays the following error message:

![Incomplete Run As configuration warning message](media/automation-sec-manage-account/automation-account-runas-incomplete-config-msg.png).

...
To check the version of agent-based Linux Hybrid Runbook Worker, go to: *vi/opt/microsoft/omsconfig/modules/nxOMSAutomationWorker/VERSION.* The file *VERSION* has the version number of Hybrid Runbook Worker. 

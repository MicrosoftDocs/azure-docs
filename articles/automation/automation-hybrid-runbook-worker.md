...
|OS  |Deployment Types  |
|---------|---------|
|Windows     | [Automated](automation-windows-hrw-install#automated-deployment)<br>[Manual](automation-windows-hrw-install#manual-deployment)        |
|Linux     | [Automated](automation-linux-hrw-install#installing-linux-hybrid-runbook-worker)        |

...
>[AZURE.NOTE] Hybrid Runbook Worker can only run [Graphical and Windows PowerShell runbooks](automation-runbook-types.md).  You cannot currently start a [Windows Script runbook](automation-runbook-types.md) on a Hybrid Runbook Worker. 

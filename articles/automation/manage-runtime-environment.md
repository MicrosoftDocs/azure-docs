...
* To learn how runtime version support and retirement affect runtime environments and runbooks, see [Language runtime support and retirement policy for Azure Automation](automation-runtime-retirement-policy.md).

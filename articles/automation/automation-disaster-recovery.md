...
Every Automation account that you [create](../automation/quickstarts/create-azure-automation-account-portal.md)
...
- Begin by [creating a replica Automation account](./quickstarts/create-azure-automation-account-portal.md#create-automation-account) in any alternate [region](https://azure.microsoft.com/global-infrastructure/services/?products=automation&regions=all).

...
|---|---------|---------|---|
|Create Azure AD Application|[New-AzureRmADApplication](/powershell/module/azurerm.resources/new-azurermadapplication)     | Application Developer Role        |Active Directory</br>Home > Azure Active Directory > App Registrations|
|Add a credential to the application.|[New-AzureRmADAppCredential](/powershell/module/AzureRM.Resources/New-AzureRmADAppCredential)     | Application administrator or GLOBAL ADMIN         |Active Directory</br>Home > Azure Active Directory > App Registrations|

...
5. Type a **Name** and optionally a **Description** for the new schedule. Your schedule can run **One Time**, **Hourly**, **Daily**, **Weekly**, or **Monthly**.
...
5. If the runbook is not currently linked to a schedule, then you are offered the option to **Link to a New Schedule** or **Link to an Existing Schedule**.  If the runbook is currently linked to a schedule, click **Link** at the bottom of the window to access these options.
6. If the runbook has parameters, you are prompted for their values.  

...
1. In the Azure portal, click **All services** found on the lower left-hand corner. In the list of resources, type **Automation**. As you begin typing, the list filters based on your input. Select **Automation Accounts**.
...
2. In the Azure portal, click **All services** found on the lower left-hand corner. In the list of resources, type **Automation**. As you begin typing, the list filters based on your input. Select **Automation Accounts**.

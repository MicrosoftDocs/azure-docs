...
If you try to [update your Azure Powershell modules](automation-update-azure-modules.md) in your Automation Account to the latest versions it will fail with an authorization error. To get around this you must temporary add the service principal as contributor to the subscription.

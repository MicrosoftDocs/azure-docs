...
4. Your new runbook appears on the **Runbooks** tab.
...
1. In the Azure classic portal, select **Automation** and then select an Automation Account.
2. Click **Import**.
...
5. The new runbook appears on the **Runbooks** tab for the Automation Account.

...
Bash runbooks are text runbooks based on the GNU Bash shell. For information about Bash, see [https://www.gnu.org/software/bash/](https://www.gnu.org/software/bash/).

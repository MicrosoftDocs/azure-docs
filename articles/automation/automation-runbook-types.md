...
# [PowerShell 7.6](#tab/lps74)
**Limitations**
Powershell 7.6 is only available in [runtime environment experience](runtime-environment-overview.md).
...
- The imported PowerShell 7.6 module would be validated during job execution. Ensure that all dependencies for the selected module are also imported for successful job execution.
...
**Limitations**
> [!NOTE]
> Currently, PowerShell 7.4 runtime version is supported for both Cloud and Hybrid jobs in all regions.
...
Currently, Python 3.10 runtime version is supported for both Cloud and Hybrid jobs in all regions.
### Advantages

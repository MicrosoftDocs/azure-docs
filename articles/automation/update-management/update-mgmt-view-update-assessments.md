...
[ ![Update Management assessment view for Arc enabled servers](./media/update-mgmt-view-update-assessment/update-assessment-arc-server.png)](./media/update-mgmt-view-update-assessment/update-assessment-arc-server-expanded.png#lightbox)

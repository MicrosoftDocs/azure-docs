...
You can report and update managed Windows servers by creating and pre-staging software update deployments in Windows Endpoint Configuration Manager, and get detailed status of completed update deployments using [Update Management](update-mgmt-overview.md). If you use Windows Endpoint Configuration Manager for update compliance reporting, but not for managing update deployments with your Windows servers, you can continue reporting to Endpoint Configuration Manager while security updates are managed with Azure Automation Update Management.
...
* You must have [Azure Automation Update Management](update-mgmt-overview.md) added to your Automation account.
...
How you manage clients hosted in Azure IaaS with your existing Windows Endpoint Configuration Manager environment primarily depends on the connection you have between Azure datacenters and your infrastructure. This connection affects any design changes you may need to make to your Windows Endpoint Configuration Manager infrastructure and related cost to support those necessary changes. To understand what planning considerations you need to evaluate before proceeding, review [Configuration Manager on Azure - Frequently Asked Questions](/configmgr/core/understand/configuration-manager-on-azure#networking).
...
To set up an integration schedule, see [Schedule an update deployment](update-mgmt-deploy-updates.md#schedule-an-update-deployment).

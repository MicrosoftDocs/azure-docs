...
You can report and update managed Windows servers by creating and pre-staging software update deployments in Windows Endpoint Configuration Manager, and get detailed status of completed update deployments using [Update Management](update-mgmt-overview.md). If you use Windows Endpoint Configuration Manager for update compliance reporting but not for managing update deployments with your Windows servers, you can continue reporting to the configuration manager while security updates are managed with Azure Automation Update Management.

...
Update Management can be used to natively deploy to machines in multiple subscriptions in the same, or across tenants using [Azure delegated resource management](../../lighthouse/concepts/azure-delegated-resource-management.md).

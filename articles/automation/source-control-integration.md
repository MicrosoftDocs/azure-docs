...
> [!Important]
> Azure Automation Run As Account has retired on **September 30, 2023**. We recommend that you use use [Managed Identities](migrate-run-as-accounts-managed-identity.md).

...
Follow [Step 5 - Add authentication to manage Azure resources](../learn/powershell-runbook-managed-identity.md#step-5---add-authentication-to-manage-azure-resources) to ensure that you are using a Run As account to access Key Vault.

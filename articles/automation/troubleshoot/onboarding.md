...
### Microsoft Monitoring Agent installation timeout
...
### OMS Agent for Linux installation timed out
...
```
Provisioning of VM extension 'OmsAgentForLinux' has timed out. Extension installation may be taking too long, or extension status could not be obtained.
```

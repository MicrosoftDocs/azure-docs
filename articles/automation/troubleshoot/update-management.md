...
* This often happens if machines are configured to get updates from WSUS or Configuration Manager but WSUS and Configuration Manager haven't approved the updates.

...
- To learn how unsupported runtime versions affect runbooks, see [Language runtime support and retirement policy for Azure Automation](automation-runtime-retirement-policy.md).

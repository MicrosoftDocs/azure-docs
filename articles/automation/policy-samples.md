...
description: Lists Azure Policy built-in policy definitions. These built-in policy definitions provide common approaches to managing your Azure resources.
ms.date: 05/13/2020
ms.topic: sample

...
1. Complete the remaining steps as outlined in [Create or update Azure custom roles using the Azure portal](../../role-based-access-control/custom-roles-portal#start-from-json). For [Step 3:Basics](../../role-based-access-control/custom-roles-portal#step-3-basics), note the following:

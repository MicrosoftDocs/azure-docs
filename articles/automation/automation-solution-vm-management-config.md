...
2. On the StartStop_VM_Notification page, click the pencil icon to edit the action details. This opens the **Email/SMS message/Push/Voice** page. Update the email address and click **OK** to save your changes.

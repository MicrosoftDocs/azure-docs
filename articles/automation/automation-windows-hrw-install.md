...
### The computer the hybrid worker is running on has less than the minimum hardware [requirements](automation-offering-get-started.md#hybrid-runbook-worker)
...
### The Microsoft Monitoring Agent service is not running
...
### You see event 4502 in the Operations Manager log

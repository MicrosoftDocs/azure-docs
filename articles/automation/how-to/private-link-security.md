...
- Azure alert (metric, log, and activity log) can't to be used to trigger an Automation webhook when the Automation account is configured with  **Public access** and  **Disable**.

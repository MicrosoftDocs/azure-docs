...
1. If you close the  **MyFirstRunbook_python3** pane, you are back on the **Runbooks** page where you should see an **Authoring Status** of **Published**.

1. Select the **MyFirstRunbook-Python3** name in the list, you'll go back into the **MyFirstRunbook-Python3** pane.
...
1. Close the **All Logs** tab and close the **Job** pane to return to the **MyFirstRunbook-Python3** pane.

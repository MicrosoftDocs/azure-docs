...
workflow Invoke-RunbookUsingAlerts
{
    ...
    if ($WebhookData -ne $null) {   
    	...
    	# [Authenticate to your Azure subscription using Organization ID](https://azure.microsoft.com/en-us/blog/azure-automation-authenticating-to-azure-using-azure-active-directory/) to be able to restart that Virtual Machine. 
        $cred = Get-AutomationPSCredential -Name "MyAzureCredential" 
        Add-AzureAccount -Credential $cred 

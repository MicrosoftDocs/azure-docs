---
title: Configure runbook output and message streams in runbooks
description: This article tells how to implement error handling logic in Azure Automation runbooks.
services: automation

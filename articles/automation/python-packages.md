...
On a Windows 64-bit machine with [python2.7](https://www.python.org/download/releases/2.7/) and [pip](https://pip.pypa.io/stable/installing/) installed, run the following command to download a package and all its dependencies:

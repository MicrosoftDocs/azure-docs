...
We will show you how to create the Automation account from both the Azure portal and Azure PowerShell, and how to authenticate with that service principal in your runbooks.  
...
3. In the Automation Accounts blade, click **Add**.<br>![Add Automation Account](media/automation-sec-configure-azure-runas-account/add-automation-account-properties.png)
...
10. When the runbook job completes, its output is displayed. In our case, we should see a status of **Completed**.<br> ![Security Principal Runbook Test](media/automation-sec-configure-azure-runas-account/runbook-test-results.png)<br>
11. Close the **Test** blade to return to the canvas.

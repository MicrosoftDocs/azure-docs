...
> [!NOTE]
> The Start/Stop VMs during off-hours solution has been tested with the newest versions of the Azure modules that are available. 
...
|AutoStop_VM_Child_ARM | WebHookData | |

...
|AutoStop_CreateAlert_Parent | VMList<br> WhatIf: True or False  | Creates or updates Azure alert rules on VMs in the targeted subscription or resource groups. <br> VMList: Comma-separated list of VMs. For example, *vm1,vm2,vm3*.<br> *WhatIf* validates the runbook logic without executing.|

...
1. In the Modules page of your Automation account, there is an option called **Update Azure Modules**. It is always enabled.<br><br> ![Update Azure Modules option in Modules page](media/automation-update-azure-modules/automation-update-azure-modules-option.png)
  ...
  >
  > The **Update Azure Modules** button is only available in the public cloud. It is not available in the [sovereign regions](https://azure.microsoft.com/global-infrastructure/). Please see [updating modules in the sovereign clouds](#update-modules-in-sovereign-clouds) section to learn more.
...
## Update modules in sovereign clouds

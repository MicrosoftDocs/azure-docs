...
5. If the **Name** field is enabled, then you have the option of changing the runbook name. The name must start with a letter and can contain letters, numbers, underscores, and dashes.
...
3. Click the **Publish** button and then **Yes** in response to the verification message.

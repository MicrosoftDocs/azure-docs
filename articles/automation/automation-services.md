...
Azure Automation orchestrates repetitive processes using graphical, PowerShell, and Python runbooks in the cloud or hybrid environments. It provides a persistent shared assets including variables, connections, and objects that allow orchestration of complex jobs. [Learn more](./automation-runbook-gallery.md).

There are more than 3,000 modules in the PowerShell Gallery, and the PowerShell community continues to grow. Azure Automation based on PowerShell modules can work with multiple applications and vendors, both first party and third party. As more application vendors release PowerShell modules for integration, extensibility, and automation tasks, you could use an existing PowerShell script as-is to execute it as a PowerShell runbook in an automation account without making any changes.
...
Orchestrates repetitive processes using graphical, PowerShell, and Python runbooks in the cloud or hybrid environment. [Learn more](./automation-runbook-types.md).
  ...
  - It provides persistent shared assets, including variables, connections, and objects that allow orchestration of complex jobs.

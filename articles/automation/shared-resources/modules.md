...
* When a runbook imports the module explicitly with the [using module](https://docs.microsoft.com/powershell/module/microsoft.powershell.core/about/about_using?view=powershell-7.1#module-syntax) statement. using module is supported since Windows Powershell 5.0 and supports classes and enum type import

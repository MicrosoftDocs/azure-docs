...
9.  Add **Add-AzureAccount** to the canvas.  Click and drag **Add-AzureAccount** underneath **Get-AutomationPSCredential**.<br>
...
![Runbook with Write-Output](media/automation-first-runbook/write-output-link.png) 

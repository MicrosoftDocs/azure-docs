...
A remote desktop client application like Windows App or Azure Virtual Desktop provides the highest performance and best user experience for heavy workloads. Remote desktop applications also support multi-monitor configuration. For more information, see [Tutorial: Use a Remote Desktop client to connect to a dev box](./tutorial-connect-to-dev-box-with-remote-desktop-app.md).

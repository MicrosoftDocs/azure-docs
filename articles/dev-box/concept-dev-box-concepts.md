...
A dev center is a collection of projects that require similar settings. Dev centers enable dev infrastructure managers to manage the images and SKUs available to the projects using [dev box ](concept-dev-box-concepts.md#dev-box-definition)definitions and configure the networks the development teams consume using [network connections](./concept-dev-box-concepts.md#network-connection).  
## Projects

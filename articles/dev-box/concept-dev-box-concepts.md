...
A dev box definition is a resource associated with a DevCenter. Dev box definitions detail the configuration of the source image and virtual machine size, including compute size and storage size. DevCenter owners can use dev box definitions across projects in a DevCenter. 

---
title: Manage roles in Microsoft Dev Box
description: placeholder for Microsoft Dev Box description.
author: RoseHJM
...
# Manage access to Microsoft Dev Box

In this article, you learn how to manage access (authorization) to an Microsoft Dev Box resource. [Azure role-based access control (Azure RBAC)](../role-based-access-control/overview.md) is used to manage access to Azure resources, such as the ability to create new resources or use existing ones. Users in your Azure Active Directory (Azure AD) are assigned specific roles, which grant access to resources.
...
Microsoft Dev Box resources have three built-in roles that are available by default. When you add users to a resource, you can assign one of the built-in roles to grant permissions:
...
You can manage access to the Microsoft Dev Box resource by using the Azure portal:

1. In the [Azure portal](https://portal.azure.com), go to your Microsoft Dev Box resource.
...
1. Assign one of the Microsoft Dev Box [built-in roles](#default-roles). For details about how to assign roles, see [Assign Azure roles using the Azure portal](../role-based-access-control/role-assignments-portal.md).
...
* Learn more about [Using managed identities](./how-to-1.md).
* Learn more about [Identifying performance bottlenecks (tutorial)](./tutorial-1.md).

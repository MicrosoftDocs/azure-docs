...
In this article, you learn how to use Dev Home Preview to create and customize your dev box. Dev Home is a Windows application that helps you manage and interact with your dev boxes. 
...
Dev Home supports both default and custom-built extensions. The GitHub extension is included with Dev Home by default, however new extensions are in active development.

You need to add the extensions you want to use to Dev Home. To add an extension:
...
1. If the **Dev Home GitHub Extension (Preview)** isn't already installed, select **Get** to install it.
...
1. Open **Dev Home**.
1. From the left menu, select **Machine configuration**, select **Microsoft DevBox**, and then select **Next**.
...
Dev home gives you the opportunity to clone repositories and add software to your new dev box after creations. Dev home uses the Winget catalog to provide a list of software that you can install on your dev box.

1. Open **Dev Home**.
1. From the left menu, select **Machine configuration**, and then select the dev box you want to configure.
...
1. From the list of application Winget provides, choose the software you want to install on your dev box, and then select **Next**.
...
## Launch your dev box from Dev Home

Dev Home provides a way to launch your dev box straight from the app.

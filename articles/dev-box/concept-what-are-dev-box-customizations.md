...
You can use both system and user tasks in your image definition file. The tasks section of the image definition file is divided into system task and user tasks sections, which share the same parameters based on the task definitions in your catalog.

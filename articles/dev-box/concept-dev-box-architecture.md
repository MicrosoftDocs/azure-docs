...
Microsoft Dev Box encrypts the disk by default to protect your data using a platform-managed key. You don't need to enable BitLocker, and doing so can prevent you from accessing your dev box.

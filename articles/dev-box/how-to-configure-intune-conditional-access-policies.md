...
> [!Note]
> The application **Microsoft Developer Portal** was renamed from **Fidalgo Dev Portal Public**, so it is possible for certain tenants to still see the previous name. Even though they have different name, they still have the same application ID, and thus it is the right app. If you want to try fixing this, you can delete and re-add the tenant's service principal for the app.

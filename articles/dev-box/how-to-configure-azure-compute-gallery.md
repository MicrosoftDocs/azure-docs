...
### Attaching a gallery using the Azure Portal
If you are using the Azure Portal to attach the gallery to your Dev center, the necessary role assignments will be created automatically when you attach the gallery.

### Attaching a gallery using the CLI
If you are using the CLI to attach the gallery to your Dev center, you will need to manually create the below role assignments before attempting to attach the gallery.

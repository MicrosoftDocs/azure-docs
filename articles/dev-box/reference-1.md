...
description: placeholder for another Microsoft Dev Box description
...
Learn how to configure your load test in Microsoft Dev Box Preview by using [YAML](https://yaml.org/). You use the test configuration YAML file to create and run load tests from your continuous integration and continuous delivery (CI/CD) workflow.
...
Learn how to build [automated regression testing in your CI/CD workflow](tutorial-1.md).

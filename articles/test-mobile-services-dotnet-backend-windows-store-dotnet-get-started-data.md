...
<tags ms.tgt_pltfrm="cache-redis" ms.service="mobile-services" ms.topic="Article" ms.workload="integration" ms.devlang="multiple" ms.date="na" ms.author="mollybos@microsoft.com" ms.editor="mollybos" />

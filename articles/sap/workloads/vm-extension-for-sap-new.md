...
### [<a name="configure">](#tab/powershell1)
...
### [Deploy manually with Azure PowerShell](#tab/powershell1)
...
```
### [Deploy manually with Azure CLI](#tab/cli1)
...
### [Deploy manually with Terraform](#tab/terraform4)

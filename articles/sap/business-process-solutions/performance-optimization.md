...
For more information on the native execution engine and its performance benefits, see [Native execution engine in Microsoft Fabric](/fabric/data-engineering/native-execution-engine-overview).
...
For more information on high concurrency mode and its performance benefits, see [High concurrency mode in Microsoft Fabric](/fabric/data-engineering/configure-high-concurrency-session-notebooks-in-pipelines)

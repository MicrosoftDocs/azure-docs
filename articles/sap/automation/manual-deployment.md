---
title: Manually deploy SAP Deployment Automation Framework
description: Learn how to manually deploy SAP Deployment Automation Framework using example configuration and sample parameter files.
author: kimforss
ms.author: kimforss
ms.date: 04/14/2026
ms.topic: how-to
...
# Manually deploy SAP Deployment Automation Framework
...
1. [Clone and configure the automation framework repository](#set-up-a-repository) on the deployer.
...
## Reinitialize the deployment

Reinitialize both the [deployer](#reinitialize-the-deployer) and the [SAP library](#reinitialize-the-sap-library).

### Reinitialize the deployer
...
## Deploy the workload virtual network
...
If you experience issues, make sure you [downloaded the SAP software](software.md) to your Azure environment.
...
- [Get started with an automated deployment](get-started.md)

---
title: SAP installation parameters for Ansible configuration
description: Learn about the SAP installation parameters used by Ansible playbooks in SAP Deployment Automation Framework.
author: kimforss
ms.author: kimforss
ms.date: 04/15/2026
...
# SAP installation parameters reference
...
This table contains the identifiers (IDs) for the SAP users and groups for the different platforms.
...
| `ora_version`                | The Oracle version, for example, 19.0.0                                                                           | Required   |
...
- [Configure extra disks](configure-extra-disks.md)

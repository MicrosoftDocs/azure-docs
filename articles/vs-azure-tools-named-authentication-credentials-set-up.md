<properties 
   ...
   description="Setting Up named authentication credentials"
...
1. To upload the certificate to the Management Portal, choose the **Azure Portal **link.
...
1. Choose the cloud service that interests you. The page for that service opens.

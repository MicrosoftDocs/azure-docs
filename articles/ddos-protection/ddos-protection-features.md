...
:::image type="content" source="./media/ddos-best-practices/image-5.png" alt-text="Diagram of how DDoS Protection works, with "Policy Generation" circled." lightbox="./media/ddos-best-practices/image-5.png":::
...
:::image type="content" source="./media/ddos-best-practices/image-7.png" alt-text="Screenshot of available metrics and metrics chart" circled." lightbox="./media/ddos-best-practices/image-7.png":::
...
:::image type="content" source="./media/ddos-best-practices/image-8.png" alt-text="Screenshot of "Under DDoS attack or not" metric and chart." lightbox="./media/ddos-best-practices/image-8.png":::

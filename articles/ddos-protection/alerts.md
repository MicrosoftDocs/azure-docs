...
4. Enter, or select your own values, or enter the following example values, accept the remaining defaults, and then select **Create alert rule**:
    ...
    | Actions | Select **Add actions groups**. Select **Create action group**. Under **Notifications**, under **Notification type**, select **Email/SMS message/Push/Voice** and under **Name** enter _MyUnderAttackEmailAlert_. Click the edit button, then select **Email** and as many of the following options you require, and then select **OK**. Select **Review + create**. | 

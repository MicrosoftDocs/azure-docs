...
Customers can use Azure DDoS Protection service in combination with [Application Gateway WAF SKU](../web-application-firewall/ag/ag-overview.md) to for protection both at the network layer (Layer 3 and 4, offered by Azure DDoS Protection Service) and at the application layer (Layer 7, offered by Application Gateway WAF SKU).

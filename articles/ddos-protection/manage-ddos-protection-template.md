---
title: Manage Azure DDoS Protection Standard using the Azure Resource Manager
...
# Quickstart: Create and configure Azure DDoS Protection Standard by using an ARM template

Learn how to create a DDoS protection plan and link it to a virtual network by using the Azure Resource Manager template. A DDoS protection plan defines a set of virtual networks that have DDoS protection standard enabled, across subscriptions. You can configure one DDoS protection plan for your organization and link virtual networks from multiple subscriptions to the same plan.

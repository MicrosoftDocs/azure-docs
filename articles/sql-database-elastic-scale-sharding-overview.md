<properties title="Sharding Overview" pageTitle="Sharding Overview" description="Reasons for sharding: scale database resources to increase availability or performance." metaKeywords="sharding, scaling, elastic scale, Azure SQL Database" services="sql-database" documentationCenter="" authors="sidneyh@microsoft.com"/>

...
1. Select your application and then click **Manifest**. You can see the two existing [app roles](../architecture/multitenant-identity/app-roles.md) defined for the application:

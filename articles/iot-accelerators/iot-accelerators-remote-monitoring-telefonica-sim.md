...
To connect your device to the Remote Monitoring, you can follow these tutorials using [C](iot-solutions-connecting-devices-linux.md) or [Node](iot-solutions-connecting-devices-node.md). 

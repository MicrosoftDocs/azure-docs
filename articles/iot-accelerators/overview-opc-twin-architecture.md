...
description: This article provides an overview of the OPC Twin architecture. It explains about the discovery, activation, browsing, and monitoring of the server.
author: dominicbetts
ms.author: dobett
ms.date: 11/26/2018
ms.topic: overview

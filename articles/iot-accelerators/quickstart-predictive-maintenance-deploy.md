...
On the **Create Predictive Maintenance solution** page, enter a unique **Solution name** for your Predictive Maintenance solution accelerator.
...
When the deployment to your Azure subscription is complete, you can sign in to your Predictive Maintenance solution accelerator dashboard.
...
To learn more about the solution accelerator, see the article.

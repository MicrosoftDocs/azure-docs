...
To learn how to provision a *physical* device, see [Connect your device to the remote monitoring solution accelerator](iot-solutions-connecting-devices-node.md).
...
* [Connect your device to the remote monitoring solution accelerator](iot-solutions-connecting-devices-node.md).

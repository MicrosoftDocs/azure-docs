...
# As an IT Pro, I need to deploy a cloud-based solution to monitor and manage my industrial IoT devices.
---

# Quickstart: Deploy a cloud-based solution to manage my industrial IoT devices

This quickstart shows you how to deploy the Azure IoT Connected Factory solution accelerator to use as a cloud-based monitoring and management solution for your industrial IoT devices. When you deploy the Connected Factory solution accelerator, it's pre-populated with resources that let you step through a common industrial IoT scenario. Several simulated factories are connected to the solution, they report the data values needed to compute overall equipment efficiency (OEE) and key performance indicators (KPIs). This quickstart shows you how to use the solution dashboard to:
...
On the **Create Connected Factory solution** page, enter a unique **Solution name** for your Connected Factory solution accelerator. This name is the name of the Azure resource group that contains all the solution accelerator resources.
...
When the deployment to your Azure subscription is complete, you can sign in to your Connected Factory solution accelerator dashboard.
...
Click **Accept** to accept the permissions request, the Connected Factory solution dashboard displays in your browser.
...
To learn how to use other features in the dashboard to manage your industrial IoT devices, see the How-to guide:

...
To learn more about the JavaScript file that updates the device state object, see [Understand the device model behavior](iot-solutions-remote-monitoring-device-behavior.md).
...
To learn more about the JavaScript file that implements the behavior of the device, see [Understand the device model behavior](iot-solutions-remote-monitoring-device-behavior.md).
...
Now you have learned about the JSON schema, the suggested next step is to learn how to [implement the behavior of your simulated device](iot-solutions-remote-monitoring-device-behavior.md).

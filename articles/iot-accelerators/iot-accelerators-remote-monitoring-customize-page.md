...
The Remote Monitoring solution accelerator UI code is implemented using the [React](https://reactjs.org/) JavaScript framework. You can find the source code in the **webui** sub-module of either the [.NET](https://github.com/Azure/azure-iot-pcs-remote-monitoring-dotnet) or [Java](https://github.com/Azure/azure-iot-pcs-remote-monitoring-java) Remote Monitoring solution accelerator GitHub repository.
...
To prepare your local development environment, use Git to clone either the [.NET](https://github.com/Azure/azure-iot-pcs-remote-monitoring-dotnet) or [Java](https://github.com/Azure/azure-iot-pcs-remote-monitoring-java) Remote Monitoring solution accelerator repository to your local machine.
...
The **webui/src/walkthrough/components/pages/basicPage** folder contains four files that define a simple page for you to get started with:
...
Create a new folder **webui/src/components/pages/example** and copy these four files into it.

### Add the new page to the web UI

To add the new page into the web UI, make the following changes to existing files:

1. Add the new page container to the **webui/src/components/pages/index.js** file:
...
1. Add the page name to the translations file, **webui/public/locales/en/translations.json**. The web UI uses [i18next](https://www.i18next.com/) for internationalization.
...
1. Open the **webui/src/components/pages/app.js** file that defines the top-level application page. Add the new page to the list of imports:
...
At a command prompt in your local copy of the repository, navigate to the **webui** sub-folder, and run the following commands to install the required libraries and run the web UI locally:
...
To connect your local running copy of the web UI to the Remote Monitoring solution accelerator in the cloud:

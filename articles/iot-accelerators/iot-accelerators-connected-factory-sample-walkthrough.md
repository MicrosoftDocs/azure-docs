...
* Connects to both simulated industrial devices running OPC UA servers in simulated factory production lines, and real OPC UA server devices. For more information about OPC UA, see the [Connected Factory FAQ](iot-solutions-faq-cf.md).
...
For more information, see the [Connected Factory FAQ](iot-solutions-faq-cf.md).

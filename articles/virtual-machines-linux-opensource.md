...
3. [How to: MySQL Clusters](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-mysql-cluster/)
4. [How to: Node.js and Cassandra](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-nodejs-running-cassandra/)
5. [How to: IPython Notebook](http://azure.microsoft.com/documentation/articles/virtual-machines-python-ipython-notebook/)
...
3. [How to: Prepare a Custom CentOS-Based VM for Azure](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-create-upload-vhd-centos/)
...
11. [How to: Install and Run MySQL](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-mysql-use-opensuse/)
12. [How To: Prep a Custom SLES or openSUSE VM](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-create-upload-vhd-suse/)  
...
17. [How to: Install the Azure Linux Agent](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-agent-user-guide/)
...
1. [The Basics: Azure Command-Line Interface (cli)](http://azure.microsoft.com/documentation/articles/xplat-cli/)
4. [The Basics: Certificate Use and Management](http://msdn.microsoft.com/library/azure/gg981929.aspx)
5. [The Basics: Selecting Linux Usernames](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-usernames/)
6. [The Basics: Log on to a Linux VM Using the Azure Portal](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-how-to-log-on/)
7. [The Basics: SSH](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-use-ssh-key/)
8. [The Basics: How to Reset a Password or SSH Properties for Linux](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-use-vmaccess-reset-password-or-ssh/)
9. [The Basics: Using Root](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-use-root-privileges/)
10. [The Basics: Attaching a Data Disk to a Linux VM](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-how-to-attach-disk/)
11. [The Basics: Detaching a Data Disk from a Linux VM](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-how-to-detach-disk/)
...
13. [The Basics: RAID](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-configure-raid/)
14. [The Basics: Capturing a Linux VM to Make a Template](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-capture-image/)
15. [The Basics: The Azure Linux Agent](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-agent-user-guide/)
...
2. Hadoop/Cloudera  
	...
	- [How to: Get Started with Hadoop and Hive using HDInsight](http://azure.microsoft.com/documentation/articles/hdinsight-get-started/)  
...
1. Docker
	- [Docker VM Extension for Linux on Azure](http://azure.microsoft.com/documentation/articles/virtual-machines-docker-vm-extension/)
...
10. Chef
	- [Chef and Virtual Machines](http://azure.microsoft.com/documentation/articles/virtual-machines-windows-install-chef-client/)

...
## Next steps
You have learned how to install Azure FarmBeats in your Azure subscription. Now, learn how to [add users](manage-users.md#manage-users-in-azure-farmbeats) to your Azure FarmBeats instance.

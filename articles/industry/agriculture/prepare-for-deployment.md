...
Once the Accelerator installation is complete you will receive the URL to access Azure FarmBeats User-Interface in the format: *<https://<accelerator-website-name>.azurewebsites.net/>*

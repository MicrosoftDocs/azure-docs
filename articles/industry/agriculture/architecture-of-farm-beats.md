...
Azure FarmBeats is an extensible offering, which enables agribusinesses to add their different historical & real time agriculture datasets into a single platform. Azure FarmBeats helps an agribusiness to normalize, contextualize and aggregate the data in the context of a farm.
...
Once the data is available within your customers’ Azure Azure FarmBeats instance, your customers can builder richer analytics and tools on top of your data.

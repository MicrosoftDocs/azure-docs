...
1. [Create Farms](#create-a-farms)
2. [Assign sensors to Farms](#get-soil-moisture-sensor-data-from-partner-into-azure-farmbeats)
3. [Generate Soil Moisture Heatmap](#generate-soil-moisture-heatmap)

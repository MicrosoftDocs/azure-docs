...
1. Go to your FarmBeats Data hub swagger <code>https://farmbeatswebsite-api.azurewebsites.net/swagger</code>
...
|        Partner   |  Details   |
| ------- | -------             |
|     DockerDetails - imageName         |          Docker image name. For example, docker.io/mydockerimage (image in hub.docker.com) OR myazureacr.azurecr.io/mydockerimage (image in Azure Container Registry) and so on. If no registry is provided, default is hub.docker.com      |

...
- RemoteApp uses multiple [namespaces for kernel objects](https://msdn.microsoft.com/en-us/library/aa382954.aspx); a global namespace is used primarily by services in client/server applications. 
...
- To optimize performance, it is good practice for applications to [detect](https://msdn.microsoft.com/en-us/library/aa380798.aspx) whether they are running in a client session. 

---
title: Deploy Azure IoT Edge modules with CLI | Microsoft Docs 
...
This article shows how to create a JSON deployment manifest, then use that file to push the deployment to an IoT Edge device. 

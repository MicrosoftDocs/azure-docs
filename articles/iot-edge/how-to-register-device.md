...
Use the [az iot hub device-identity create](/cli/azure/iot/hub/device-identity?view=azure-cli-latest#az_iot_hub_device_identity_create) command to create a new device identity in your IoT hub. For example:
...
Use the [az iot hub device-identity list](/cli/azure/iot/hub/device-identity?view=azure-cli-latest#az_iot_hub_device_identity_list) command to view all devices in your IoT hub. For example:
...
When you're ready to set up your device, you need the connection string that links your physical device with its identity in the IoT hub. Use the [az iot hub device-identity connection-string show](/cli/azure/iot/hub/device-identity/connection-string?view=azure-cli-latest#az_iot_hub_device_identity_connection_string_show) command to return the connection string for a single device:

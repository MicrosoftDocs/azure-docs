...
To determine the connectivity of your modules, check their status in the `modules` section of the edgeAgent module twin.
...
## Monitor the module twin for connectivity and health
...
## Monitor module twins in the Azure portal

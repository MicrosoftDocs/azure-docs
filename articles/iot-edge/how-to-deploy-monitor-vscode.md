...
Layered deployments can be created and managed with the Visual Studio Code like any automatic deployment, with just a few differences. Once a layered deployment is created, same Visual Studio Code work for layered deployments the same as any deployment.

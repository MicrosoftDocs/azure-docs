...
To test the Functions module that you build in this tutorial, you need an IoT Edge device. You can use the device that you configured in the quickstart.
...
* [C# Functions module template package - 2.0.0-rc-mcr](https://github.com/Azure/dotnet-template-azure-iot-edge-function/releases/download/v2.0.0-rc-mcr2/Microsoft.Azure.IoT.Edge.Function.2.0.0-rc-mcr.nupkg).
    ...
    ```cmd/sh
    dotnet new -i [path to Microsoft.Azure.IoT.Edge.Function.2.0.0-rc-mcr.nupkg]
    ```

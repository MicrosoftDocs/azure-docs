...
1. Select **IoT Edge**. And click **Next**.
...
1. On the right of the dashboard, select **Browse** to view your running application.
...
1. Select **Build and Release**, then select **Releases**. DevOps Projects creates a release pipeline to manage deployments to Azure IoT Edge. To know more about Azure IoT Edge tasks for CD, you can visit [Configure Azure Pipelines for continuous deployment](https://docs.microsoft.com/azure/iot-edge/how-to-ci-cd#configure-azure-pipelines-for-continuous-deployment).

...
> [!NOTE]
> You might encounter errors while performing below steps, like adding connection to local storage account, or during the creation of containers in local storage account, please ignore and refresh. 

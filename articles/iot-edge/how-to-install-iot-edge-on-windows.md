...
>
>While IoT Edge for Linux on Windows is the recommended experience for using Azure IoT Edge in a Windows environment, Windows containers are still available. If you prefer to use Windows containers, see [the how-to guide on their use](how-to-install-iot-edge-windows-on-windows.md).

...
A full list of the metrics collected by edgeAgent and edgeHub is available in the [Available metrics section of the Access IoT Edge runtime metrics article](how-to-access-iot-edge-runtime-metrics.md#available-metrics). A subset of these metrics is collected by the IoT Edge Agent as part of RQT. Metrics collected as a part of RQT include the tag `ms_telemetry`.
...
[Learn about IoT Edge runtime metrics](how-to-access-iot-edge-runtime-metrics.md)

...
For this tutorial, we create the new device identity using Visual Studio Code. You can also complete these steps using the [Azure portal](how-to-register-device.md), or [Azure CLI](how-to-register-device.md).

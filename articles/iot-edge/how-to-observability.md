...
![Illustration of La Nina solution collecting surface temperature from sensors into Azure IoT Edge](media/how-to-observability/ete-sample-la-nina-high-level.png)
...
![Diagram of La Nina components including IoT Edge device and Azure Services](media/how-to-observability/e2e-sample-la-nina-metrics.png)
...
![Screenshot of IoT Hub monitoring showing the Workbooks | Gallery in the Azure portal](media/how-to-observability/ete-sample-dashboard-path.png)
...
![Screenshot of the monitoring summary report in the Azure portal showing an issue with device coverage and data freshness](media/how-to-observability/ete-sample-glance.png)
...
![Screenshot of the workbook settings in the Azure portal](media/how-to-observability/ete-sample-workbook-settings.png)
...
![Screenshot of message frequency by device](media/how-to-observability/ete-sample-scan.png)
...
![Screenshot of messaging telemetry for a device in the Azure portal](media/how-to-observability/ete-sample-commit.png)
...
![Screenshot of sample messages in the Azure portal](media/how-to-observability/ete-sample-messages.png)
...
![Diagram illustrating an IoT Edge device sending telemetry data to Azure Monitor](media/how-to-observability/e2e-sample-la-nina-detailed.png)
...
![Screenshot of module troubleshooting showing updating FilterModule twin properties](media/how-to-observability/e2e-sample-update-twin.png)

With that in place, we have to restart the `Temperature Sensor` and `Filter` modules:

![Screenshot of module troubleshooting showing Restart FilterModule button](media/how-to-observability/e2e-sample-restart-module.png)
...
![Screenshot of application map in Application Insights](media/how-to-observability/e2e-sample-application-map.png)
...
![ Screenshot of monitoring traces](media/how-to-observability/e2e-sample-traces.png)
...
![Sample JSON showing the logging level and trace sample ratio values](media/how-to-observability/ete-sample-fix-issue.png)
...
![Screenshot of Azure Monitor workbook chart](media/how-to-observability/ete-sample-fixed-workbook.png)
...
![Screenshot of the monitoring summary report in the Azure portal](media/how-to-observability/ete-sample-green-workbook.png)

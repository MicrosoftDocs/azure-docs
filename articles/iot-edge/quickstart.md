...
>
> If you're ready to configure your own Windows device for IoT Edge, follow the steps in [Install the Azure IoT Edge runtime on Windows](how-to-install-iot-edge-windows.md).

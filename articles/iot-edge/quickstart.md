...
>
> If you want to configure your own Windows device for IoT Edge, follow the steps in [Install the Azure IoT Edge runtime](how-to-install-iot-edge.md&tabs=windows).

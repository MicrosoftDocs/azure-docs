...
3. Add your second module into this solution project. This time type and run **Edge: Add IoT Edge module** and select the deployment template file to update. Then select an **Azure Function - C#** with name **SampleFunction** and its Docker image repository to add. 
   ...
   > [!NOTE]
   > You can also add exsiting module published on Azure Container Registry, Docker Hub or other places by selecting **Existing module**.
   > ![Add existing module](./media/tutorial-multiple-modules-in-vscode/existing-module.png)
...
* [Develop and debug a C# module in VS Code](how-to-develop-csharp-module-vscode.md)

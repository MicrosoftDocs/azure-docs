...
>[!NOTE]
>The latest version of IoT Edge for Linux on Windows continuous release (CR), based on IoT Edge version 1.4, is in [public preview](https://azure.microsoft.com/support/legal/preview-supplemental-terms/). A clean installation may be required for devices going into production use if a general availability (GA) release is available. For more information, see [EFLOW versions](./version-history.md).
:::moniker-end
<!-- end iotedge-2020-11 -->

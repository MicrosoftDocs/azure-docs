...
>[!NOTE]
>You can also use [Visual Studio 2017 develop, debug and deploy IoT Edge modules](how-to-visual-studio-develop-csharp-module.md).
...
| - | ------------------ | ------------------ |
| **Windows AMD64** | ![Use VS Code for C# modules on Windows AMD64](./media/tutorial-c-module/green-check.png)<br>\*Debugging functionality in Visual Studio Code isn't available for C# Windows modules | ![Use VS 2017 for C# modules on Windows AMD64](./media/tutorial-c-module/green-check.png) |

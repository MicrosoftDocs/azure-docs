...
* In 1.2, when a backing image is removed from a container, the container will keep running and it will persist across restarts. In 1.1, when a backing image is removed, the container is immediately recreated and the backing image is updated.

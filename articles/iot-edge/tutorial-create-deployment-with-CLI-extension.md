...
title: Create IoT Edge deployment with IoT extension for Azure CLI 2.0 | Microsoft Docs 
description: Create IoT Edge deployment with IoT extension for Azure CLI 2.0
services: iot-edge
keywords: 
author: chrissie926
manager: briz

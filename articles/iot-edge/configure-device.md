...
When **allow_elevated_docker_permissions** is set to **false**, use **allowed_bind_sources** to specify the host paths that modules can use as bind mount sources. Each entry allows the specified path and all its descendants.

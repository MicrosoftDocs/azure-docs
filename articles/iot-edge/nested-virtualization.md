...
1. Create a Windows virtual machine on the VMware ESXi host. For more information, see [How to virtualize Windows on VMware ESXi](https://www.techrepublic.com/article/virtualizing-windows-on-vmware-esxi/).

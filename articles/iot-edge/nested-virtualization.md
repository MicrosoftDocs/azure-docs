...
>[!NOTE]
> Per [VMware KB2009916](https://kb.vmware.com/s/article/2009916), currently nested virtualization is limited to Microsoft Hyper-V, strictly for VBS only and not for virtualizing multiple VMs. We are working with VMware to extend this support to EFLOW. 

...
### Resolution
NOTE: As of version 1.0.7, all modules processes are authorized to connect. If upgrading to 1.0.7 is not possible please follow the steps below. See https://github.com/Azure/iotedge/blob/master/CHANGELOG.md#iotedged-1

...
Securing the intelligent edge is necessary to confer confidence in cloud operations at the edge. As an organization, you need to protect cloud assets and value generated from edge intelligent processing.  Azure IoT Edge is designed for security that is extensible to different risk profiles and deployment scenarios.  Azure IoT Edge offers the same protection that you expect from all Azure services. 
 

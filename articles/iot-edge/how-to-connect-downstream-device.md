...
1. Get the sample for **send_message_downstream** from the [Azure IoT device SDK for Python samples](https://github.com/Azure/azure-iot-sdk-python-preview/tree/master/azure-iot-device/samples/advanced-edge-scenarios).

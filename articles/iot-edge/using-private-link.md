...
:::image type="content" source="./media/using-private-link/IoTEdge_PrivateLink.png" alt-text="Diagram of how IoT Edge runtime sends insights and reporting to IoT Hub.":::

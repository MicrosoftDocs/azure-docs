...
* If you use the [Azure CLI](https://learn.microsoft.com/en-us/cli/azure/install-azure-cli) to create and manage devices, install the [Azure IoT extension](https://github.com/Azure/azure-iot-cli-extension).

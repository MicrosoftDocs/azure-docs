...
9.  Right click on the files and choose “Download Blob” to save it to
    your VM
...
6.  As expected, these messages contain all the sensor data and
...
1.  [Connect a downstream device to an Azure IoT Edge

...
- Autoprovision a Linux on Windows device by using a simulated TPM. This methodology is recommended only as a testing scenario. A simulated TPM doesn't offer the same security as a physical TPM.

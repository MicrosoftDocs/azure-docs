...
1. Choose a target framework. The latest .NET LTS version is preferred (currently .NET 10.0). After you choose a target framework, select **Create**. Visual Studio creates a new console app solution.

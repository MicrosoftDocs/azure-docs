...
If you need guidance, [create a support ticket](work-with-ali-in-the-azure-portal.md) with Azure Customer Support so that Azure ARC Support can help in your setup.

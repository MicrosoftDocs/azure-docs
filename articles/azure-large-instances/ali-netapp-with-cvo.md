...
This article describes the end-to-end setup steps to move data between ALI   NETAPP storage and Azure CVO (NETAPP Cloud volume ONTAP). This setup enables ALI NETAPP storage data backup/restore/update use cases.
...
:::image type="content" source="media/ali-netapp-with-cvo/end-to-end-solution-architecture.png" alt-text="Networking diagram of ALI diagram." lightbox="media/ali-netapp-with-cvo/end-to-end-solution-architecture.png" border="false":::

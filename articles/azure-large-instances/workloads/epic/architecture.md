...
:::image type="content" source="../epic/media/architecture/architecture.png" alt-text="ALI architecture." lightbox="../epic/media/architecture/architecture.png" border="false":::

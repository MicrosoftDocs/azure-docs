...
|[An overview or password-less authentication](https://aka.ms/pwdless-whitepaper)|This document is an overview of the key benefits of password-less authentication using Windows Hello for Business, FIDO2 Security Keys and the Microsoft Authenticator App. It’s recommended for security professionals and CISOs who are interested in understanding how Microsoft can help to go beyond passwords and deploy next generation authentication credentials.|

...
* Azure Disk Encryption will attach a temporary storage volume to the VM - Bek Volume for Windows and /mnt/azure_bek_disk for Linux IaaS VMs. Do not delete or edit any contents in this disk. Do not unmount the disk since the encryption key presence is needed for any encryption operations on the IaaS VM.

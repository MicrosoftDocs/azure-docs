...
* Planned 2019 = indicates the service review is in progress and will achieve cert in 2019.

## Azure public services by audit scope
| _Last Updated: August 2019_ |

| Azure Service| DoD CC SRG IL 2 | FedRAMP Moderate | FedRAMP High | Planned 2019 |
| ------------ |:---------------:|:----------------:|:------------:|:------------:|
...
| [Azure API for FHIR](https://azure.microsoft.com/en-us/services/azure-api-for-fhir/) |  |  |  | :heavy_check_mark: |
...
| [Azure Firewall](https://azure.microsoft.com/en-us/services/azure-firewall/) |  |  |  | :heavy_check_mark: |
...
| [Azure Sentinel](https://azure.microsoft.com/en-us/services/azure-sentinel/) |  |  |  | :heavy_check_mark: |
...
| Azure Service | DoD CC SRG IL 2 | DoD CC SRG IL 4 | DoD CC SRG IL 5 | FedRAMP High | Planned 2019
| ------------- |:---------------:|:---------------:|:---------------:|:------------:|:------------:
...
| [Cognitive Services: Speech Services](https://azure.microsoft.com/services/cognitive-services/directory/speech/) |  |  |  |  | :heavy_check_mark:

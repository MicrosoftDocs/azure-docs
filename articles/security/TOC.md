...
## Scenarios
### [Discover, identify, and classify personal data in Microsoft Azure](how-to-discover-classify-personal-data-azure.md)
### [Manage personal data in Microsoft Azure](manage-personal-data-azure.md)
### [Document protection of personal data with Azure reporting tools](protection-personal-data-azure-reporting-tools.md)
### [Protect personal data in Microsoft Azure](protect-personal-data-azure.md)
### [Azure encryption technologies: Protect personal data at rest with encryption](protect-personal-data-at-rest.md)
### [Protect personal data from breaches and attacks: Azure Security Center](protect-personal-data-azure-security-center.md)
### [Azure Active Directory and Multi-Factor Authentication: Protect personal data with identity and access controls](protect-personal-data-identity-access-controls.md)
### [Azure encryption technologies: Protect personal data in transit with encryption](protect-personal-data-in-transit-encryption.md)
### [Protect personal data with network security features: Azure Application Gateway and Network Security Groups](protect-personal-data-network-security.md)

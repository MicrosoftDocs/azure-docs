...
<td>
Rest API & <a href="https://docs.microsoft.com/azure/monitoring-and-diagnostics/monitoring-overview-activity-logs" target="_blank">Azure Monitor</a>
</td>
...
<td>
	Azure Monitor, <a href="https://docs.microsoft.com/azure/monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs" target="_blank">Stream</a>
</td>
...
<tr>
<td><a href="https://docs.microsoft.com/azure/active-directory/active-directory-reporting-azure-portal" target="_blank">AAD Reporting</a></td>
...
<td><a href="https://docs.microsoft.com/azure/active-directory/develop/active-directory-graph-api-quickstart" target="_blank">Graph API</a>
</td>
...
<tr>
<td><a href="https://docs.microsoft.com/azure/cloud-services/cloud-services-dotnet-diagnostics-storage" target="_blank">Virtual Machine & Cloud Services</a></td>
...
<td>
Windows using <a href="https://docs.microsoft.com/azure/monitoring-and-diagnostics/azure-diagnostics" target="_blank">WAD</a> (Windows Azure Diagnostics storage) and Linux in Azure monitor
</td>
...
<tr>
<td><a href="https://docs.microsoft.com/rest/api/storageservices/fileservices/storage-analytics" target="_blank">Storage Analytics</a></td>
...
<td>
REST API or the <a href="https://msdn.microsoft.com/library/azure/mt347887.aspx" target="_blank">client library</a>
</td>
...
<tr>
<td><a href="https://docs.microsoft.com/azure/network-watcher/network-watcher-nsg-flow-logging-overview" target="_blank">NSG (Network Security Group) Flow Logs</a></td>
...
<td>
<a href="https://docs.microsoft.com/azure/network-watcher/network-watcher-monitoring-overview" target="_blank">Network Watcher</a>
</td>

</tr>

<tr>
<td><a  href="https://docs.microsoft.com/azure/application-insights/app-insights-overview" target="_blank">Application insight</a></td>
...
<td> REST API,
<a href="https://powerbi.microsoft.com/documentation/powerbi-azure-and-power-bi/" target="_blank">Power BI</a>
</td>
...
<td><a href="https://docs.microsoft.com/azure/security-center/security-center-intro" target="_blank")>Azure Security Center Alert</a>,
 <a href="https://docs.microsoft.com/azure/log-analytics/log-analytics-solution-alert-management" target="_blank")> OMS Alert </a>
</td>
...
<img src="media/Logging-And-Auditing-In-Microsoft -Azure/Logging-And-Auditing-In-Microsoft -Azure-Fig1.png" width ="500" height="340" alt ="" align ="right">
...
<img src="media/Logging-And-Auditing-In-Microsoft -Azure/Logging-And-Auditing-In-Microsoft -Azure-Fig2.png" width ="500" height="340" alt ="" align ="right">
...
<img src="media/Logging-And-Auditing-In-Microsoft -Azure/Logging-And-Auditing-In-Microsoft -Azure-Fig3.png" width ="350" height="280" alt ="" align ="right">
...
<img src="media/Logging-And-Auditing-In-Microsoft -Azure/Logging-And-Auditing-In-Microsoft -Azure-Fig7.png" width ="450" height="360" alt ="" align ="right">
...
<img src="media/Logging-And-Auditing-In-Microsoft -Azure/Logging-And-Auditing-In-Microsoft -Azure-Fig8.png" width ="400" height="200" alt ="" align ="right">
...
<img src="media/Logging-And-Auditing-In-Microsoft -Azure/Logging-And-Auditing-In-Microsoft -Azure-Fig9.png" width ="400" height="260" alt ="" align ="right">

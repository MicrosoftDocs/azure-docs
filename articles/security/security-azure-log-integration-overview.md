...
The preferred method for integrating Azure logs is to use your SIEM vendor’s Azure Monitor connector. To use the connector, follow the instructions in [Monitor stream monitoring for data event hubs](../monitoring-and-diagnostics/monitor-stream-monitoring-data-event-hubs.md). 

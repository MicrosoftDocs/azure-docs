...
You can learn more about Azure Virtual Networks by reading the article [Virtual Network Overview](../virtual-network/virtual-networks-overview.md).
...
You can learn more about **Network Security Groups** by reading the article [Network Security Groups](../virtual-network/virtual-networks-nsg.md).
...
To learn more about **User Defined Routes**, please see the article [What are User Defined Routes and IP Forwarding](../virtual-network/virtual-networks-udr-overview.md).
...
To learn more about **point-to-site VPN** connectivity, please see the article [Configure a Point-to-Site Connection to a Virtual Network using PowerShell](../vpn-gateway/vpn-gateway-howto-point-to-site-rm-ps.md).
...
To learn more about **site-to-site VPNs to Azure**, please see the article [Create a Resource Manager VNet with a site-to-site VPN connection using the Azure Portal](../vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-portal.md).

To learn more about how to plan for **VPN-based cross premises connectivity**, please see [Planning and design for VPN gateway](../vpn-gateway/vpn-gateway-plan-design.md).
...
To learn more about **dedicated WAN links** between your on-premises location and Azure Virtual Networks, please read the article [ExpressRoute technical overview](../expressroute/expressroute-introduction.md).
...
For more information about Azure Virtual Network to Azure Virtual Network site-to-site VPNs, please read the article [Configure a VNet-to-VNet Connection by using Azure Resource Manager and PowerShell](../vpn-gateway/vpn-gateway-vnet-vnet-rm-ps.md).
...
For more information about the Azure Application Gateway, please read the article [Application Gateway Overview](../application-gateway/application-gateway-introduction.md).
...
To learn more about the external Azure Load Balancer, please read the article [Internet Facing load balancer between multiple Virtual Machines or services](../load-balancer/load-balancer-internet-overview.md).

To learn more about the internal Azure Load Balancer, please read the article [Internal Load Balancer Overview](../load-balancer/load-balancer-internal-overview.md).
...
To learn more about global load balancing with Azure Traffic Manager, please read the article [What is Traffic Manager?](../traffic-manager/traffic-manager-overview.md)
...
To learn more about Network Security Group logging, please read the article [Log Analytics for Network Security Groups (NSGs)](../virtual-network/virtual-network-nsg-manage-log.md).
...
To learn more about the **Azure Virtual Network DNS server**, please see the article [Virtual Network Overview](../virtual-network/virtual-networks-overview.md).

To learn more about using **your own DNS severs** on an Azure Virtual Network, please see the article [Manage DNS Servers used by a Virtual Network (VNet)](../virtual-network/virtual-networks-manage-dns-in-vnet.md).
...
To learn more about Azure DNS, please read [Azure DNS Overview](../dns/dns-overview.md).
...
To learn more about DMZ designs in Azure, please read the article [Microsoft Cloud Services and Network Security](../best-practices-network-security.md).
...
To learn more about Azure Security Center, please see the article [Introduction to Azure Security Center](../security-center/security-center-intro.md).

...
![The Always Encrypted feature illustrated as a lock and key](./media/database-security-overview/azure-database-fig1.png)
...
![Masking on a number sent between a SQL database and business apps](./media/database-security-overview/azure-database-fig3.png)
...
![Row-Level Security allowing a user to access rows in a table through a client app](./media/database-security-overview/azure-database-fig4.png)

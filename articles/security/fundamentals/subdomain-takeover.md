...
It's clear that when you find a dangling DNS, the easiest solution is to delete the DNS entry. This isn't always the safest or correct approach.
...
- **Create procedures for prevention:**
    ...
    - Perform regular reviews of your DNS records to ensure that your subdomains are correctly mapped to Azure dubdomains such as azurewebsites.net or cloudapp.azure.com (see [this reference list](azure-domains.md)) and ensuring all Azure mappings are in your service catalog
    ...
    - Maintain a service catalog of your Azure FQDN endpoints and the application owner.
...
- **Create procedures for discovery:**
    ...
    - Alternatively, using a user account that has access to all of your Azure subscriptions, run some Azure Graph queries for all resources (to which you have access) of a certain tye:  

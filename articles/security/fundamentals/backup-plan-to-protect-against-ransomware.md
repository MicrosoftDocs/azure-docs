...
[Azure Backup](/azure/backup/backup-overview) provides security to your backup environment, both when your data is in transit and at rest. With Azure Backup, [you can back up](/azure/backup/backup-overview#what-can-i-back-up#what-can-i-back-up):

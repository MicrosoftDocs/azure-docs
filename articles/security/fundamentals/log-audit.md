...
|[Virtual machines and cloud services](../../azure-monitor/vm/quick-collect-azurevm.md)|Windows Event Log service and Linux Syslog|	Captures system data and logging data on the virtual machines and transfers that data into a storage account of your choice.|	Windows (using Windows Azure Diagnostics [[WAD](../../azure-monitor/essentials/diagnostics-extension-overview.md)] storage) and Linux in Azure Monitor|

...
| <li> [Integration with Microsoft Defender for Cloud](./other-threat-protections.md#display-recommendations-in-microsoft-defender-for-cloud-apps-)                                       | GA             | Not Available                  |

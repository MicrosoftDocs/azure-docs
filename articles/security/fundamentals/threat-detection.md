...
- [Responding to today’s threats](../../security-center/security-center-overview.md#respond-threats): Helps identify active threats that target your Azure resources and provides the insights you need to respond quickly.

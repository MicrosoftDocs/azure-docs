...
The [Microsoft cloud security benchmark (MCSB)](/security/benchmark/azure/introduction) provides comprehensive security best practices aligned with industry frameworks that span identity, networking, compute, data protection, and management layers.
...
>
> MCSB v2 includes new guidance for confidential computing workloads. You can enforce and monitor MCSB v2 through Azure Policy. For more information, see [Overview of Microsoft cloud security benchmark v2 (preview)](/security/benchmark/azure/overview).
...
- **Enforce baselines**: Implement [Azure Policy](../../governance/policy/tutorials/create-and-manage.md) to audit and enforce secure configuration baselines based on Microsoft Cloud Security Benchmark v2 (preview) recommendations.

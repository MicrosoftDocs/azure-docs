...
- _FIPS-140_ is a US government standard with different levels of security requirements. For more information, see [Federal Information Processing Standard (FIPS) 140](https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-fips-140-2). 
...
![Key Management Product Flow Chart](./media/choosing-key-management-solutions/Key%20Management%20Product%20Flow%20Chart.png)
...
Below is a list of the key management solutions we commonly see being utilized based on industry. 

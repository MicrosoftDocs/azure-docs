...
> [!IMPORTANT]
> This article was published concurrent with the TLS certificate change, and is not being updated with new information. For up-to-date details about CAs, see [Azure Certificate Authority details](azure-ca-details.md)

...
> [!IMPORTANT]
> This article was published concurrent with the TLS certificate change. For up-to-date information regarding CAs, see [Azure Certificate Authority details](azure-ca-details.md)

...
If your VM runs critical applications that need to have high availability, we strongly recommend that you use multiple VMs. For better availability, use an [availability set](../../virtual-machines/avset-overview.md) or availability [zones](../../availability-zones/az-overview.md).

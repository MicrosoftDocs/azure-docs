...
> [!NOTE]
> To improve the security of Linux VMs on Azure, you can integrate with Azure AD authentication. When you use [Azure AD authentication for Linux VMs](/azure/virtual-machines/linux-vm-connect), you centrally control and enforce policies that allow or deny access to the VMs.
>
>

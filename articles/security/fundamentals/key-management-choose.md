...
| What kind of **tenancy** are you looking for? | Multi Tenant | Multi Tenant | Single Tenant | Single Tenant | Single Tenant | Single Tenant |
...
| I am an IaaS customer wanting to move my application to use Azure VM/HSMs. | Azure Dedicated HSM, Azure Cloud HSM | Azure Dedicated HSM and Azure Cloud HSM support SQL IaaS customers. They are the only solutions that support PKCS11 and custom non-cloud native applications. |

...
- Keys must be stored in a secure location with identity-based access control and audit policies. Data encryption keys are often encrypted with key encryption key in Azure Key Vault to further limit access.

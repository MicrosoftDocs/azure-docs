...
### 3.6: Use secure, Azure-managed workstations for all administrative tasks
...
* [Deploy a secure, Azure-managed workstation](https://docs.microsoft.com/azure/active-directory/devices/howto-azure-managed-workstation)

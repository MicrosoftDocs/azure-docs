...
**Detail**: Document mapping in your organization’s documentation or in the Azure Policy definition itself by adding a reference to the organizational policy in the [Azure Policy definition](../../governance/policy/concepts/definition-structure.md#display-name-and-description) or the [Azure Policy initiative](../../governance/policy/concepts/definition-structure.md#initiatives) description.

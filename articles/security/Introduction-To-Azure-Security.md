...
<table style="width:100%">
  <tr>
    ...
    <td>Features Premium P1 Features</td>
    <td>Premium P2 Features</td>
    <td>Azure Active Directory Join – Windows 10 only related features</td>
  </tr>
  <tr>
...
- [Azure Active Directory B2C](https://azure.microsoft.com/services/active-directory-b2c/) is a highly available, global identity management service for consumer-facing apps that can scale to hundreds of millions of identities and integrate across mobile and web platforms. Your customers can sign in to all of your apps through customizable experiences that use existing social media accounts, or you can create new standalone credentials.

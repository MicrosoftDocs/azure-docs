...
You can learn about IoT security architecture by reading [Internet of Things Security Architecture](../iot-solutions/iot-security-architecture.md).

This article discusses the following topics:

* [Security Starts with a Threat Model](../iot-solutions/iot-security-architecture.md#security-starts-with-a-threat-model)
* [Security in IoT](../iot-solutions/iot-security-architecture.md#security-in-iot)
* [Threat Modeling the Azure IoT Reference Architecture](../iot-solutions/iot-security-architecture.md#threat-modeling-the-azure-iot-reference-architecture)
...
You can learn how to handle security in these areas by reading [Internet of Things security from the ground up](../iot-solutions/securing-iot-ground-up.md).

The article discusses the following topics:

* [Secure infrastructure from the ground up](../iot-solutions/securing-iot-ground-up.md#secure-infrastructure-from-the-ground-up)
* [Microsoft Azure – secure IoT infrastructure for your business](../iot-solutions/securing-iot-ground-up.md#microsoft-azure---secure-iot-infrastructure-for-your-business)
...
You can learn about Internet of Things security best practices by reading [Internet of Things security best practices](../iot-solutions/iot-security-best-practices.md).

The article discusses the following topics:

* [IoT hardware manufacturer/integrator](../iot-solutions/iot-security-best-practices.md#iot-hardware-manufacturerintegrator)
* [IoT solution developer](../iot-solutions/iot-security-best-practices.md#iot-solution-developer)
* [IoT solution deployer](../iot-solutions/iot-security-best-practices.md#iot-solution-deployer)
* [IoT solution operator](../iot-solutions/iot-security-best-practices.md#iot-solution-operator)

...
**Guidance**: Not applicable; An Azure Stack Edge device can not be associated with or deployed into a virtual network.
...
**Guidance**: Use Azure ExpressRoute or Azure virtual private network when deploying Azure Stack Edge devices for a private connection between the Azure datacenters and on-premises infrastructure, in a colocated environment. Review the referenced guidelines to configure virtual private network on your Azure Stack Edge Pro R and Azure Stack Edge Mini R devices.

You can use peering configuration when deploying Azure Stack Edge device, where traffic from local devices to the cloud storage endpoints travels over the Azure ExpressRoute channel.

- [Configure Azure VPN via Azure PowerShell script for Azure Stack Edge Pro R](../../databox-online/azure-stack-edge-pro-r-configure-vpn-powershell.md)

- [Configure Azure VPN via Azure PowerShell script for Azure Stack Edge Mini R](../../databox-online/azure-stack-edge-mini-r-configure-vpn-powershell.md)
...
**Guidance**: Not applicable; Azure Stack Edge does not allow for its
resources to be secured into a private network via the Private Link service or
Service Endpoints.
...
**Guidance**: Secure the private network connected with Azure Stack Edge from external attacks using a network virtual appliance, such as a firewall with advanced distributed denial of service (DDoS) protections. The Azure Stack Edge device incorporates standard Windows Server network protection features, which are not configurable by customers.
...
- [Understand Azure Stack Edge security](../../databox-online/azure-stack-edge-security.md)

- [Port information for Azure Stack Edge](../../databox/data-box-system-requirements.md#port-requirements)

- [Get hardware and software intrusion detection logs](../../databox-online/azure-stack-edge-gpu-troubleshoot.md#gather-advanced-security-logs)
...
**Guidance**: Not applicable; Azure Stack Edge service cannot be
...
**Guidance**: Not
applicable; Azure Stack Edge does not offer domain name service capabilities. The Azure Stack Edge endpoint device uses the existing domain name service environment setup on your on-premise network.
...
Azure Stack Edge devices boot up into a locked state for local access. For the local device administrator account, you will need to connect to your device through the local web user interface or PowerShell interface and set a strong password, no default credentials are present. Store and manage your device administrator credential in a secure location like an Azure Key Vault, rotate the admin password according to your organizational standards.

- [Protect Azure Stack Edge device via password](../../databox-online/azure-stack-edge-security.md#protect-the-device-via-password)

- [Protect Azure Databox Gateway via password](/azure/databox-online/data-box-gateway-security#protect-the-device-via-password)
...
**Guidance**: Strong authentication controls, such as multifactor authentication, is an opt-in feature for the Azure Stack Edge service users. It can be leveraged for supported scenarios such as edge-management of Azure Stack Exchange devices at the Azure portal. Note that local access to the Azure Stack Edge devices does not support multifactor authentication.
...
- [Enable Azure Monitor on your Azure Stack Edge Pro device](../../databox-online/azure-stack-edge-gpu-enable-azure-monitor.md) 

- [Gather a support package](../../databox-online/azure-stack-edge-gpu-troubleshoot.md#collect-support-package)
...
**Guidance**: Azure Active Directory (Azure AD) conditional access is an opt-in feature for authentication to Azure Stack Edge service. For example, Azure Stack Edge resource – a resource in the Azure portal that lets you manage an Azure Stack Edge Pro device from a web interface that you can access from different geographical locations. 
...
- [Azure Stack Edge Pro security and data protection](../../databox-online/azure-stack-edge-security.md)

- [Sync storage keys](../../databox-online/azure-stack-edge-manage-shares.md#sync-storage-keys)
...
- [Password best practices](../../databox-online/azure-stack-edge-security.md#protect-the-device-via-password)
...
- [Information on security for your Azure Stack Edge devices](../../databox-online/azure-stack-edge-security.md)
...
- [Connect remotely to your Azure Stack Edge device](../../databox-online/azure-stack-edge-gpu-connect-powershell-interface.md)
...
- [Gather a support package for Azure Stack Edge](../../databox-online/azure-stack-edge-gpu-troubleshoot.md#collect-support-package)
...
- [Azure Stack Edge Pro security and data protection](../../databox-online/azure-stack-edge-security.md#protect-the-device-via-password)
...
- [Best practices to protect data in flight](../../databox-online/azure-stack-edge-security.md#protect-data-in-flight)
...
- [Protect data at rest for Azure Stack Edge devices](../../databox-online/azure-stack-edge-pro-r-security.md#protect-data-at-rest)
...
- [Set Azure Resource Manager password](../../databox-online/azure-stack-edge-j-series-set-azure-resource-manager-password.md)
...
- [Collect support package for Azure Stack Edge device](../../databox-online/azure-stack-edge-gpu-troubleshoot.md#collect-support-package)
...
- [Azure Stack Edge gather a support package](../../databox-online/azure-stack-edge-gpu-troubleshoot.md#collect-support-package)
...
- [Configure Azure Stack Edge device time settings](../../databox-online/azure-stack-edge-gpu-deploy-set-up-device-update-time.md#configure-time)
...
- [Apply updates on your Azure Stack Edge device](../../databox-online/azure-stack-edge-gpu-install-update.md)

- [Protect data in Edge local shares](../../databox-online/azure-stack-edge-gpu-prepare-device-failure.md#protect-data-in-edge-local-shares)

- [Protect files and folders in virtual machines](../../databox-online/azure-stack-edge-gpu-prepare-device-failure.md#protect-files-and-folders-on-vms)
...
Third-party data protection solutions can also provide a backup solution for the data in the local SMB or NFS shares, such as Cohesity, Commvault and Veritas. 

Additional information is available at the referenced links.

- [Prepare for a device failure](../../databox-online/azure-stack-edge-gpu-prepare-device-failure.md)

- [Protect files and folders on VMs](../../databox-online/azure-stack-edge-gpu-prepare-device-failure.md#protect-files-and-folders-on-vms)
...
- [Recovery procedures for Azure Stack Edge](../../databox-online/azure-stack-edge-gpu-recover-device-failure.md)
...
- [Protect Azure Stack Edge device data in the Azure Storage accounts](../../databox-online/azure-stack-edge-pro-r-security.md#protect-data-in-storage-accounts)

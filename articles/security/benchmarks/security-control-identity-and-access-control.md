...
## Identity and Access Control 3.1

**CIS Control IDs**: 4.1

**Recommendation**: Maintain Inventory of Administrative Accounts
...
## Identity and Access Control 3.2

**CIS Control IDs**: 4.2

**Recommendation**: Change Default Passwords where Applicable
...
## Identity and Access Control 3.3

**CIS Control IDs**: 4.3

**Recommendation**: Ensure the Use of Dedicated Administrative Accounts
...
## Identity and Access Control 3.4

**CIS Control IDs**: 4.4

**Recommendation**: Utilize Single Sign-On (SSO) with Azure Active Directory
...
## Identity and Access Control 3.5

**CIS Control IDs**: 4.5, 11.5, 12.11, 16.3

**Recommendation**: Use Multifactor Authentication for all Azure Active Directory based access.
...
## Identity and Access Control 3.6

**CIS Control IDs**: 4.6, 11.6, 12.12

**Recommendation**: Use of Dedicated Machines (Privileged Access Workstations) for all Administrative Tasks
...
## Identity and Access Control 3.7

**CIS Control IDs**: 4.7

**Recommendation**: Limit users' ability to interact with ARM via scripting tools.
...
## Identity and Access Control 3.8

**CIS Control IDs**: 4.8, 4.9

**Recommendation**: Log and Alert on Suspicious Activity on Administrative Accounts
...
**CIS Control IDs**: 11.7

**Recommendation**: Manage Azure Resource from only Approved Locations
...
**CIS Control IDs**: 16.1, 16.2, 16.4, 16.5, 16.6

**Recommendation**: Utilize Azure Active Directory
...
## Identity and Access Control 3.11

**CIS Control IDs**: 16.9, 16.10
...
## Identity and Access Control 3.12

**CIS Control IDs**: 16.12

**Recommendation**: Monitor Attempts to Access Deactivated Accounts

**Guidance**: Customers have Azure AD Sign in Activity, Audit and Risk Event log sources to monitoring whcih allows customers to integrate with any SIEM / Monitoring tool.<br><br> Customers can streamline this process by creating Diagnostic Settings for Azure Active Directory user accounts, sending the audit logs and sign-in logs to a Log Analytics Workspace. Customer to configure desired Alerts within Log Analytics Workspace.<br><br>How to integrate Azure Activity Logs into Azure Monitor:<br>https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/howto-integrate-activity-logs-with-log-analytics

**Responsibility**: Customer

## Identity and Access Control 3.13

**CIS Control IDs**: 16.13

**Recommendation**: Alert on Account Login Behavior Deviation
...
## Identity and Access Control 3.14

**CIS Control IDs**: 16

**Recommendation**: Regulate third-party access to company data

...
- [Alternatively, you may enable and on-board data to Azure Sentinel or a third-party SIEM. How to onboard Azure Sentinel](https://docs.microsoft.com/azure/sentinel/quickstart-onboard)

...
Azure Advisor does not support deploying directly into a virtual network, because of this you can not leverage certain networking features with the offering's resources such as network security groups, route tables, or other network dependent appliances such as an Azure Firewall.
...
Not applicable; Azure Advisor is not designed to deploy into or be secured to a private network, this control is intended to describe network connectivity and does not apply.
...
Not applicable; Azure Advisor is not designed to deploy into or be secured to a virtual network for access.
...
Not applicable; Azure Advisor does not expose any endpoints to external networks which need to be secured by conventional network protections.
...
Not applicable; Azure Advisor does not support deploying into a virtual network and cannot be configured with an IDS or IPS solution for detecting or preventing threats on the network.
...
Not applicable; This control is intended for offerings that expose DNS configurations.
...
Not applicable; Azure Advisor doesn't support SSO for authentication to its resources.
...
Azure Advisor uses Azure Active Directory that supports strong authentication controls through multi-factor authentication (MFA), and strong passwordless methods.Multi-factor authentication - Enable Azure AD MFA and follow Azure Security Center Identity and Access Management recommendations for some best practices in your MFA setup. MFA can be enforced on all, select users or at the per-user level based on sign-in conditions and risk factors.
...
Azure Advisor is integrated with Azure Active Directory in which provides the following data sources:Sign-ins - The sign-ins report provides information about the usage of managed applications and user sign-in activities.
...
Not applicable; Azure Advisor doesn't allow customer to deploy any persisted data into the running environment.
...
Not applicable; Azure Advisor doesn't access any legacy applications.
...
Not applicable; Azure Advisor doesn't use any administrative accounts.
...
Azure Advisor use Azure RBAC to isolate access to business-critical systems by restricting which accounts are granted privileged access to the subscriptions and management groups they are in.
...
Not applicable; Azure Advisor doesn't support emergency accounts or doesn't need emergency accounts.
...
Not applicable; Azure Advisor doesn't support any automation on account or role management.
...
Not applicable; Azure Advisor doesn't support management from a customer workstation.
...
**Guidance**: Not applicable; Azure Advisor does not store, process or transmit data classified as sensitive.
...
Not applicable; Azure Advisor does not allow for automated asset discovery for access by security teams. Thus it cannot be used with any asset inventory and metadata processes.
...
Not applicable; Azure Advisor does not have assets under management that the customer can configure.
...
Not applicable; customer can not use Azure Advisor capabilities to inventory and manage assets.
...
Not applicable; Azure Advisor does not provide capabilities to customers to limit their users' ability to access Azure Resource Manager. The customer should restrict this access with other means or methods.
...
Not applicable; Azure Advisor is not comprised of any virtual machines or containers which would either expose compute resources or allow customers to install applications on them.
...
Not applicable; Azure Advisor does not currently produce customer facing resource logs that can be used for threat detection.
...
Not applicable; Azure Advisor does not produce any logs related to identity and access management.
...
Not applicable; Azure Advisor either does not: support integrating with networks, or does not expose its network-related activities.
...
Not applicable; Azure Advisor does not produce or expose any logs related to its resources.
...
Azure Advisor does not currently produce any security-related logs, and the customer is unable to set any log retention.
...
Azure Advisor does not support configuring your own time synchronization sources. The Azure Advisor service relies on Microsoft time synchronization sources, and is not exposed to customers for configuration.
...
- [Use the Workflow Automation feature in Security Center to automatically trigger responses via "Logic Apps" on security alerts and recommendations.How to configure Workflow Automation and Logic Apps](../../security-center/workflow-automation.md) 
...
Not applicable; Microsoft performs vulnerability management on the underlying systems that support Azure Advisor.
...
Not applicable; Azure Advisor is not comprised of any virtual machines or containers which would require Endpoint Detection and Response (EDR) protection.
...
Not applicable; Azure Advisor uses Cosmos DB as the data storage with a TTL of 24 hours.
...
Not applicable; Azure Advisor doesn't support any data backup encryption.
...
Not applicable; Azure Advisor doesn't support any data backup and doesn't include customer managed keys.
...
Not applicable; Azure Advisor doesn't manage any keys.

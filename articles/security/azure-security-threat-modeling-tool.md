...
| ----------------- | ----------- |
| [Introduction](#intro) | Learn about the Microsoft Threat Modeling Tool |
| [Links](#links) | Get started today |
| [Partners](#partners) | Check out how a few Microsoft folks are making the tool better |
| [Threats](#threats) | Learn more about the threats generated by the tool |
| [Mitigations](#mitigations) | Learn more about known mitigations to address threats found by the tool |

## <a id="intro"></a>Introduction

| Table of Contents | Description |
| ----------------- | ----------- |
| Core Element of the Microsoft Security Development Lifecycle (SDL) | Threat modeling allows software architects to identify and mitigate potential security issues early, when they are relatively easy and cost-effective to resolve. It greatly reduces the total cost of development |
| Not Just for Security Experts | This tool was not designed for security experts. It makes threat modeling easier for all developers by providing guidance on creating and analyzing threat models |
| Enables anyone to: | <ul><li>Communicate about the security design of their systems</li><li>Analyze those designs for potential security issues using a proven methodology</li><li>Suggest and manage mitigations for security issues</li></ul> |
| Capabilities and Innovations | <ul><li>**Automation:** Guidance and feedback in drawing a model</li><li>**STRIDE per Element:** Guided analysis of threats and mitigations</li><li>**Reporting:** Security activities and testing in the verification phase</li><li>**Unique Methodology:** Enables users to better visualize and understand threats</li></ul> |
| Competitive Advantages | <ol><li>**Designed for Developers and Centered on Software:** many approaches are centered on assets or attackers. We are centered on software. We build on activities that all software developers and architects are familiar with -- such as drawing pictures for their software architecture</li><li>**Focused on Design Analysis:** The term "threat modeling" can refer to either a requirements or a design analysis technique. Sometimes, it refers to a complex blend of the two. The Microsoft SDL approach to threat modeling is a focused design analysis technique</li></ol> |

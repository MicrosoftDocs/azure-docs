...
2. Verify the installed versions of the AzureRM module. If needed, [update the Azure PowerShell module](https://docs.microsoft.com/en-us/powershell/azure/azurerm/install-azurerm-ps?view=azurermps-6.13.0#update-the-azure-powershell-module).

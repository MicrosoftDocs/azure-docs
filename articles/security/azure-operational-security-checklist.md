...
## Next steps
In this document, you were introduced to the Security and Audit solution. To learn more about Security, see the following articles:

- [Azure Monitor overview](https://docs.microsoft.com/azure/operations-management-suite/operations-management-suite-overview).

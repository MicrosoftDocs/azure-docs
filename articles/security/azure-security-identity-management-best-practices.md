...
## Use Azure AD for storage authentication
[Azure Storage](../storage/common/storage-auth-aad.md#rbac-roles-for-blobs-and-queues) supports authentication and authorization with Azure AD for Blob storage and Queue storage. With Azure AD authentication, you can use the Azure role-based access control to grant specific permissions to users, groups, and applications down to the scope of an individual blob container or queue.

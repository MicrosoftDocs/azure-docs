...
|Tenant Level Isolation |[Azure Tenancy](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-howto-tenant) | [AAD & Role-Based Access Controls](https://docs.microsoft.com/en-in/azure/active-directory/active-directory-administer)  | Isolation from Microsoft Administrators & Data Deletion| ||
| -- |     
| [Compute Isolation](https://msenterprise.global.ssl.fastly.net/vnext/PDFs/A01_AzureSecurityWhitepaper20160415c.pdf) | Hyper-V & Root OS Isolation | Advance VM Placement Algorithm & Protection| The Azure Fabric Controller Isolation| [VLAN Isolation](https://azure.microsoft.com/en-us/blog/network-isolation-options-for-machines-in-windows-azure-virtual-networks/) | Isolation of Fabric Controllers|
| [Storage Isolation](https://msenterprise.global.ssl.fastly.net/vnext/PDFs/A01_AzureSecurityWhitepaper20160415c.pdf) | Logical Isolation Between Compute and Storage | [Storage Access Control ](https://docs.microsoft.com/en-us/azure/storage/storage-dotnet-shared-access-signature-part-1) | IP Level Isolation | [Encryption ](https://docs.microsoft.com/en-us/azure/storage/storage-security-guide#encryption-in-transit) ||
| Networking Isolation | [Private Networks](https://docs.microsoft.com/en-us/azure/best-practices-network-security) |[VLAN Isolation](https://azure.microsoft.com/en-us/blog/network-isolation-options-for-machines-in-windows-azure-virtual-networks/) |[Virtual Networks and Firewalls](https://docs.microsoft.com/en-in/azure/security/azure-security-getting-started)|||
|Azure Database Isolation|[SQL Azure Application Model](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-design-patterns-multi-tenancy-saas-applications)|Isolation Through Network Topology|Isolation by Machine Function and Access||||
...
<th><a href="https://docs.microsoft.com/en-us/azure/active-directory/active-directory-howto-tenant" target="_blank">Azure Tenancy</a>
</th>
<th><a href="https://docs.microsoft.com/en-in/azure/active-directory/active-directory-administer" target="_blank">AAD & Role-Based Access Controls</a>
</th>
<th>

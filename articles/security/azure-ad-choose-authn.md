...
* **Business Continuity**. Password Hash Sync is highly available as a cloud service that scales to all Microsoft datacenters. To prepare for disaster recovery, deploy a second Azure AD Connect server in staging mode in a standby configuration.
...
|What user account states are supported?|Disabled accounts<br>(up to 30-minute delay)|Disabled accounts<br>Account locked out<br>Password expired<br>Sign-in hours|Disabled accounts<br>Account locked out<br>Password expired<br>Sign-in hours|

...
![PaaS Web Application for FedRAMP reference architecture diagram](images/fedramp-paas-architecture.png?raw=true) "PaaS Web Application for FedRAMP reference architecture diagram"

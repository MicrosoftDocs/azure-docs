...
![IaaS Web Applicaiton for GDPR reference architecture diagram](images/gdpr-iaaswa-reference-architecture.png?raw=true "IaaS Web Applicaiton for GDPR reference architecture diagram"))

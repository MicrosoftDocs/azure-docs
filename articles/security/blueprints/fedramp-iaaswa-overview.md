...
Log Analytics provides extensive logging of system and user activity, as well as system health. The [Log Analytics](https://docs.microsoft.com/azure/security/azure-security-disk-encryption) solution collects and analyzes data generated by resources in Azure and on-premises environments.
...
Additionally, the following Log Analytics solutions are installed as a part of this architecture. Note that it's the customer's responsibility to configure these solutions to align with FedRAMP security controls:

...
title: UK-OFFICIAL Three-Tier Web Applications Automation - overview
description: UK-OFFICIAL Three-Tier Web Applications Automation - overview
services: security
...
|||
|---|---|
| **Customer** | This blueprint prompts the administrator for which region to deploy Azure resources to. The recommended regions for deployment are UK South or UK West. |
...
|||
|---|---|
| **Customer** | Confidentiality and integrity of all blob storage deployed by this blueprint solution is protected through use of Azure Storage Service Encryption (SSE). SSE safeguards data at rest within Azure storage accounts using 256-bit AES encryption. |

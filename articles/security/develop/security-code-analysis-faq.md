...
### Can I install the extension on my Visual Studio Team Foundation Server (not Azure DevOps) server? 
...
The build tasks filter some user input. Specifically for this question, they update the location of the generated output file to be a common location on the build agent. For more information on this location, see the following questions.

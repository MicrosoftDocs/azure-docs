...
| **References**              | N/A, [Azure IoT hub with .NET](../../iot-hub/quickstart-send-telemetry-dotnet.md), [Getting Started with IoT hub and Node JS](../../iot-hub/quickstart-send-telemetry-node.md), [Securing IoT with SAS and certificates](../../iot-hub/iot-hub-devguide-sas.md), [Git repository](https://github.com/Azure/azure-iot-sdks/) |
...
| **References**              | [Azure IoT Hub Security Tokens](../../iot-hub/iot-hub-devguide-sas.md) |

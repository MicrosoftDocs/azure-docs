...
- Install and configure Windows Azure PowerShell. For the detailed instructions, see [Install and configure Windows Azure PowerShell][Powershel-install-configure].

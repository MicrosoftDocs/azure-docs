...
This article shows you how to restore a website that you have previously backed up by using the Azure Websites Backup feature. For more information, see [Microsoft Azure Web Sites Backups](web-sites-backup.md). 

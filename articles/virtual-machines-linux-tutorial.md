...
- [How to use the Azure Command-Line Tools for Mac and Linux](../virtual-machines-command-line-tools/)

- [Deploy a LAMP app using the Azure CustomScript Extension for Linux](../virtual-machines-linux-script-lamp/)

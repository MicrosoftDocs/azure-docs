...
>
>- Linking an Azure DNS private resolver to the virtual network where the ExpressRoute virtual network gateway is deployed and configuring wildcard rules to forces all name resolution to a target DNS server may cause management connectivity issues and is not recommended.

...
If you want to upgrade your gateway to a higher-capacity gateway SKU, you can use the [Seamless Gateway Migration tool](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-about-virtual-network-gateways) in either the Azure portal or PowerShell. The following upgrades are supported:

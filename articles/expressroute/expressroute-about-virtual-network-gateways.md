...
> [!IMPORTANT]
> Application throughput depends on multiple factors such as the end-to-end latency and the number of traffic flows the application opens and so on. The numbers in the table represent the upper limit that the application can theorectically achieve in an ideal environment. 
> 
>

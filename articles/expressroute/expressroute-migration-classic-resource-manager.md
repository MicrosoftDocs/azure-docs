...
* An ExpressRoute cannot be moved to a new resource group and subscription. See [Services that cannot be moved](../azure-resource-manager/resource-group-move-resources.md#services-that-cannot-be-moved) for more information.

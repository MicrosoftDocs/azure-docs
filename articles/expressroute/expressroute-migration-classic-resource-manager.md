...
* Cross-subscription migration is not supported. For more information, see [Services that cannot be moved](../azure-resource-manager/resource-group-move-resources.md#services-that-cannot-be-moved).

...
Generating the letter of authorization is unavailable from the portal at this time. Use **[PowerShell](expressroute-howto-erdirect.md#authorization)** or **[CLI](expressroute-howto-expressroute-direct-cli.md#authorization)** to obtain the letter of authorization.

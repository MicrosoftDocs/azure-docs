...
We support the [Extended Packet Numbering](https://1.ieee802.org/security/802-1aebw/) version of AES-128 and AES-256. Additionally, we support GCM-AES-128 and GCM-AES-256. Also, you must disable [Secure Channel Identifier (SCI)](https://wikipedia.org/wiki/IEEE_802.1AE) in the MACsec configuration on your device. 

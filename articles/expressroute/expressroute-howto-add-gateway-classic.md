...
# Configure a VNet gateway for ExpressRoute using the classic deployment model and PowerShell
...
This article will walk you through the steps to add, resize, and remove a VNet gateway for an already existing VNet. The steps for this configuration are specifically for VNets that were created using the **classic deployment model** and that will be be used in an ExpressRoute configuration. 

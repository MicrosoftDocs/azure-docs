...
> [!NOTE] 
> Using a site-to-site VPN as a backup may not be suitable when dealing with latency-sensitive, mission-critical, or bandwidth-intensive workloads. In such cases, it's advisable to design for disaster recovery with multi-site resiliency to ensure maximum availability.
>

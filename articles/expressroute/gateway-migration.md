...
- **GatewaySubnet Size**: The GatewaySubnet must have a /27 prefix or larger (for example, /26 or /25) to proceed with migration. For more information, see [Create multiple prefixes for a subnet](../virtual-network/how-to-multiple-prefixes-subnet.md).

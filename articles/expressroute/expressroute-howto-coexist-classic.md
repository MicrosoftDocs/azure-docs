...
- **Force-tunneling cannot be enabled on the site-to-site VPN gateway:** you can only "force" all Internet-bound traffic back to your on-premises network via ExpressRoute. 

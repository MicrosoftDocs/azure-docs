...
# Customer intent: As a network architect, I want to identify ExpressRoute locations and connectivity providers, so that I can plan optimal network connections for Azure services according to geographical coverage and service availability.
---
...
| **Frankfurt2** | [Equinix FR7](https://www.equinix.com/locations/europe-colocation/germany-colocation/frankfurt-data-centers/fr7/) | 1 | Germany West Central | &check; | 1-IX.EU<br/>DE-CIX<br/>Deutsche Telekom AG<br/>Equinix<br/>InterCloud<br/>Telefonica<br/>Zenlayer |
...
| **London** | [Equinix LD5](https://www.equinix.com/locations/europe-colocation/united-kingdom-colocation/london-data-centers/ld5/) | 1 | UK South | &check; | AT&T NetBond<br/>Bezeq International<br/>British Telecom<br/>CenturyLink<br/>Colt<br/>Console Connect (PCCW Global Limited)<br/>Equinix<br/>euNetworks<br/>Intelsat<br/>InterCloud<br/>Internet Solutions - Cloud Connect<br/>Interxion (Digital Realty)<br/>Jisc<br/>Level 3 Communications<br/>Megaport<br/>Momentum Telecom<br/>MTN<br/>NTT Communications<br/>Orange<br/>Tata Communications<br/>Telehouse - KDDI<br/>Telenor<br/>Telia Carrier<br/>Verizon<br/>Vodafone<br/>Vorboss<br/>Zayo |
...
| **Queretaro (Mexico)** | [KIO Networks QR01](https://www.kionetworks.com/es-mx/) | 4 | Mexico Central | &check; | Axtel<br/>Cirion Technologies<br/>C3ntro<br/>DE-CIX<br/>Equinix<br/>Flo Networks<br/>KIO<br/>MCM Telecom<br/>Megaport |
...
| **Vienna** | [Digital Realty VIE1](https://www.digitalrealty.com/data-centers/emea/vienna/vie1) | 1 | &cross; | &check; | A1 Telekom Austria<br/>Digital Realty<br/>Next Layer GmbH |
| **Vienna2** | [NTT Data VIE1](https://services.global.ntt/en-us/services-and-products/global-data-centers/global-locations/emea/vienna-1-data-center) | 1 | &cross; | &check; | A1 Telekom Austria<br/>Next Layer GmbH |

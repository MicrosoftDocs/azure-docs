...
* **ExpressRoute gateway must be configured first and linked to a circuit.** You must create the ExpressRoute gateway first and link it to an ExpressRoute circuit, before you add the Site-to-Site VPN gateway.

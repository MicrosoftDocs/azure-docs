...
2. Log in to your account and set up the environment.
  ...
  $VNetASN = 65010
  ```
3. Create a virtual network including Gateway Subnet. For more information about the virtual network configuration, see [Azure Virtual Network configuration](../virtual-network/manage-virtual-network.md#create-a-virtual-network).

...
* **VPN Gateway ASN must remain as default 65515 when coexisting with an ExpressRoute Gateway.** Azure VPN Gateway supports the BGP routing protocol and it is possible to specify the ASN (AS Number) used. If you don't specify this parameter, the default AS number is 65515. When using VPN Gateway in conjunction with ExpressRoute gateway as part of a coexistence topology, the default ASN of 65515 must be used.

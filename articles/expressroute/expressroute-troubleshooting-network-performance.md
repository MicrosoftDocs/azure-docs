...
>[!NOTE]
>The scenario here is a performance issue, not a connectivity issue. To isolate the connectivity problem to Azure network, follow [Verifying ExpressRotue connectivity](azure-docs-pr/articles/expressroute/expressroute-troubleshooting-expressroute-overview.md) article.
>

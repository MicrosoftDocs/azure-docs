...
* DNS Private Resolver: Azure ExpressRoute FastPath does not support connectivity to [DNS Private Resolver](https://learn.microsoft.com//azure/dns/dns-private-resolver-overview).

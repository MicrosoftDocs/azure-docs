...
Default quotas and limits apply for every ExpressRoute circuit. Refer to the [Azure Subscription and Service Limits, Quotas, and Constraints](../articles/includes/expressroute-limits.md) page for up-to-date information on quotas.

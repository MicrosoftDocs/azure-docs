<properties title="Configure a Directnic domain name for an Azure web site" pageTitle="Configure a Directnic domain name for an Azure web site" metaKeywords="Windows Azure, Windows Azure Web Sites, Directnic" description="Learn how to configure an Azure Web Site to use a custom domain name" services="Web Sites" documentationCenter="" authors="larryfr,jroth" />
...
<div class="dev-center-tutorial-subselector"><a href="/en-us/documentation/articles/web-sites-directnic-custom-domain-name/" title="Web Sites" class="current">Web Site</a> | <a href="/en-us/documentation/articles/web-sites-directnic-custom-domain-name-traffic-manager/" title="Web Site using Traffic Manager">Web Site using Traffic Manager</a></div>

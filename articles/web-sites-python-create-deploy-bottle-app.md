...
![](./media/web-sites-python-create-deploy-bottle-app/portal-deployment-history.png)

Click on **View Log** to see the output of the custom deployment script:

![](./media/web-sites-python-create-deploy-bottle-app/portal-deployment-log.png)

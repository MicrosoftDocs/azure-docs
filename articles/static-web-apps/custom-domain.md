...
1. Once your domain is validated, you can migrate your traffic to static web app. Now you can update your `CNAME`, `ALIAS`, or `A` record to point to your [default host name](./apex-domain-external.md)

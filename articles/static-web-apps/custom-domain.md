...
> [!NOTE]
> Adding a custom domain to a [preview environment](preview-environments.md) is not currently supported. Unicode domains, including Pynocode domains and the xn-- prefix, also are not supported.

...
9. Paste in the deployment token in the _Value_ box.
    ...
    :::image type="content" source="media/publish-devops/yaml-token.png" alt-text="Variable token":::
...
13. Select **Save and run** to open the _Save and run_ dialog.
    ...
    :::image type="content" source="media/publish-devops/yaml-save.png" alt-text="Pipeline":::

...
> [!IMPORTANT]
> Functionality defined in the *routes.json* file is now deprecated and better implemented in the Azure Static Web Apps [configuration file](./configuration.md#routes).

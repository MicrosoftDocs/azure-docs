...
> [!NOTE]
>  If you don't see any repositories, you may need to authorize Azure Static Web Apps in GitHub. Browse GitHub homepage and go to your personal settings - accessible via the top-right menu. Then, go to **Applications > Authorized OAuth Apps**, select **Azure Static Web Apps**, and then select **Grant**. For organization repositories, you must be an owner of the organization to grant the permissions.

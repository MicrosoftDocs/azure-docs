...
Additionally, you can select **Yes** for **Alias recrod set** and select the your static web app instead of explicitly providing the URL to take advantages of Alias record sets like [prevention from dangling DNS records](https://learn.microsoft.com/en-us/azure/dns/dns-alias#prevent-dangling-dns-records).

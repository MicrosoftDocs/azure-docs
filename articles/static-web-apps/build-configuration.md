...
Each Azure Static Web Apps site has a YAML configuration file that controls how a site is built and deployed. This article explains the file's structure and options.
...
With these settings, you can set up [Azure DevOps pipeline](publish-devops.md) or GitHub Actions to run continuous integration/continuous delivery (CI/CD) for your static web app.
...
The configuration file is stored at the root of your repository with the name *azure-pipelines.yml*.

# [GitHub Actions](#tab/github-actions)

The configuration file is stored in *.github/workflows* folder, named using the following format: *azure-static-web-apps-<RANDOM_NAME>.yml*.

...
- **Build modern JavaScript applications** with frameworks and libraries like [Angular](getting-started.md?tabs=angular#tabpanel_CeZOj-G++Q_angular), [React](getting-started.md?tabs=react#tabpanel_CeZOj-G++Q_react), [Svelte](https://docs.microsoft.com/learn/modules/publish-app-service-static-web-app-api/), [Vue](getting-started.md?tabs=react#tabpanel_CeZOj-G++Q_vue) with an [Azure Functions](apis.md) back-end.

...
- **Publish static sites** with frameworks like [Gatsby](publish-gatsby.md), [Hugo](publish-hugo.md), [VuePress](publish-vuepress.md), [Jekyll](publish-jekyll.md) and [Hexo](publish-hexo.md).

...
> [!NOTE]
> [Distributed functions (preview)](./distributed-functions.md) is a feature for managed functions that automatically distributes your managed functions to regions of high request loads. Distributed functions is available for the Standard SKU.

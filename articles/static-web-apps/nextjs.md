...
Next.js can be deployed as a static site using the [static HTML export](https://nextjs.org/docs/advanced-features/static-html-export) feature of Next.js.

This will generate static HTML files from the Next.js application during the deployment process and allows Next.js to be deployed with no backend APIs.

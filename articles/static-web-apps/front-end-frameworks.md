...
| [Angular](https://angular.io/) | `dist/<APP_NAME>` <br><br>Note that if you do not include an `<APP_NAME>`, remove the trailing slash. | `npm run build -- --configuration production` |

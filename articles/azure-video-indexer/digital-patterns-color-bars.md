...
* Clapper board detection with metadata extraction. For more information, see [How to enable and view clapper board with metadata extraction](clapper-board-metadata.md).

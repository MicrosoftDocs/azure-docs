...
4. View the insights of the video. 
	...
	If you want to download artifact files, beware that these are intermediate outputs of the indexing process. For more information, see [Insights output](video-indexer-output-json-v2.md).

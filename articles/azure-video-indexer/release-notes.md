...
On January 01, 2023 we introduced the Advanced Audio and Video SKU for the Advanced presets. This was done on order to report the use of each preset, Basic, Standard & Advanced, with their own distinct meter on the Azure Billing statement. This can also be seen on Azure Cost Analysis reports.

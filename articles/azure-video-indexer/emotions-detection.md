...
Emotions detection is an Azure AI Video Indexer AI feature that automatically detects emotions in video's transcript lines. Each sentence can either be detected as: *Anger*, *Fear*, *Joy*, *Sad*; none of the above if no other emotion was detected.

...
Emotion detection is an Azure Video Indexer AI feature that automatically detects emotions video's transcript lines. Each sentence can either be detected as "Anger", "Fear", "Joy", "Sad", or none of the above if no other emotion was detected.

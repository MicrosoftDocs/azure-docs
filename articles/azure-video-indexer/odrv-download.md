...
This article shows how to index videos stored on OneDrive by using the Azure Video Indexer (formerly Azure Video Analyzer for Media) website.

## Supported file formats

For a list of file formats that you can use with Video Analyzer for Media, see [Standard Encoder formats and codecs](/azure/azure/media-services/latest/encode-media-encoder-standard-formats-reference).

...
Azure Video Indexer enables managing access to the Azure Video Indexer resource at account level with the following built-in role: **Video Indexer Restricted Viewer**. 

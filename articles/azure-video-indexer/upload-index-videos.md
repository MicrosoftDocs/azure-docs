...
When you're creating a Azure Video Indexer account, you choose between:
...
- A paid option where you're not limited by a quota. You create a Azure Video Indexer account that's [connected to your Azure subscription and an Azure Media Services account](connect-to-azure.md). You pay for indexed minutes.
...
For a list of file formats that you can use with Azure Video Indexer, see [Standard Encoder formats and codecs](/media-services/latest/encode-media-encoder-standard-formats-reference).

...
| **Language**                     | **Code**   | **Supported source language** | **Language identification** | **Customization (language model)** | **Pronunciation  (language model)** | **Website Translation** | **Website Language** |
|----------------------------------|------------|-------------------------------|-----------------------------|------------------------------------|-------------------------------------|-------------------------|----------------------|
| Afrikaans                        | af-ZA      |                               |                             |                                    |                                     | ✔                       |                      |
| Arabic (Israel)                  | ar-IL      | ✔                             |                             | ✔                                  |                                     |                         |                      |
| Arabic (Iraq)                    | ar-IQ      | ✔                             | ✔                           |                                    |                                     |                         |                      |

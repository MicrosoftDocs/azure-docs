<properties
   pageTitle="Qlik | Microsoft Azure"
   description="The solution that Qlik provides with SQL Data Warehouse."
...
Azure SQL Data Warehouse customers using Qlik’s platform gain the following advantages:

•	Reduce the time to make decisions that drive better business performance.

•	Empower people to perform their own analysis and data discovery with simplicity.
 
•	Perform visual ad hoc analytics in a self-service environment with an intuitive drag-and-drop experience leveraging smart-visualizations. 

•	Leverage responsive-design technology to create mobile ready applications in few hours.

•	Combine and analyze data easily from Azure SQL Data Warehouse and non-Microsoft sources.

•	Address any new analysis demands quickly.

•	Query the Azure SQL Data Warehouse directly, without having to make a local copy of the data.
...
[logo]:./media/sql-data-warehouse-partners/qlik_logo_med.png
...
[website1]: http://www.qlik.com/us/explore/products/sense

<properties
   pageTitle="Microsoft Azure Security and Audit Log Management"
...
Auditpol.exe used in the previous example is a command-line tool included in Windows Server operating system that allows you to manage audit policy settings. For more information, see [Auditpol](http://technet.microsoft.com/library/cc731451.aspx).
...
|Supports a variety of log formats, such as Windows event logs, Event Tracing for Windows traces, and IIS logs. For more information, see Azure Diagnostics Supported Data Sources |Supports Windows event logs only |
...
Azure Diagnostics moves logs from customer Cloud Services applications and virtual machines to Azure Storage. Based on a log format, some data is stored in Azure tables and some in blobs. Data that is collected in Azure Storage can be downloaded to on-premises SIEM systems by using Azure Storage client library for monitoring and analysis. For more information, see [Azure Storage](http://msdn.microsoft.com/library/azure/gg433040.aspx).
...
[6]: ./media/sec-azure-security-audit-log-management/sec-event-viewer.png
[7]: ./media/sec-azure-security-audit-log-management/sec-event-id100.png
[8]: ./media/sec-azure-security-audit-log-management/sec-diagnostics.png
[9]: ./media/sec-azure-security-audit-log-management/sec-event4732.png
[10]: ./media/sec-azure-security-audit-log-management/sec-step6.png
[11]: ./media/sec-azure-security-audit-log-management/sec-process-creation-event.png
[12]: ./media/sec-azure-security-audit-log-management/sec-process-creation-event-storage.png
[13]: ./media/sec-azure-security-audit-log-management/sec-event4946.png
[14]: ./media/sec-azure-security-audit-log-management/sec-event4946-storage.png
[15]: ./media/sec-azure-security-audit-log-management/sec-event-aggregation.png
[16]: ./media/sec-azure-security-audit-log-management/sec-status-code500.png
[17]: ./media/sec-azure-security-audit-log-management/sec-w3c-format.png
[18]: ./media/sec-azure-security-audit-log-management/sec-blob-iis-logs.png
[19]: ./media/sec-azure-security-audit-log-management/sec-view-blob-container.png
[20]: ./media/sec-azure-security-audit-log-management/sec-hdinsight-analysis.png

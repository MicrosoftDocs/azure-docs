...
If you have between 1 and 10 standard job collections, you'll be billed for one standard billing unit. If you have between 11 and 20 standard job collections, you'll be billed for two standard billing units. If you have between 21 and 30 standard job collections, you'll be billed for three standard billing units, and so on.
...
P20 premium job collections provide the same capabilities as P10 premium job collections but also supports a greater number jobs per job collection and a greater total number of jobs overall than P10 premium allowing you to have more scalability.

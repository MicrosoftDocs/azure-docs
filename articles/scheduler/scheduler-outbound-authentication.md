...
|---------|----------|-------------|
| **authentication** (parent element) | The authentication object for using an TLS client certificate |
| **type** | Yes | The authentication type. For TLS client certificates, the value is `ClientCertificate`. |
...
|---------|-------------| 
| **authentication** (parent element) | The authentication object for using an TLS client certificate |
| **type** | The authentication type. For TLS client certificates, the value is `ClientCertificate`. |

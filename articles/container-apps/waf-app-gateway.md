...
1. Enter the following values in the *Project details* section.
    ...
    | Availability zone | Select **None**. For production environments, [Availability Zones](../reliability/availability-zones-overview#availability-zones) are recommended for higher availability. |

...
> [!NOTE]
> When `maxConnections` isn't set, a default maximum of 10,240 concurrent connections applies. Set `maxConnections` to raise or lower this limit for your container app.

...
In this tutorial, you learn how to run a Semantic Kernel AI agent in a web API app. The API accepts user input and returns a response generated by the AI agent. The agent uses a code interpreter in dynamic sessions to perform calculations.

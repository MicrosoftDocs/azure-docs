...
# Read real time log data with .NET Aspire Dashboard in Azure Container Apps
...
https://learn.microsoft.com/en-us/dotnet/aspire/fundamentals/dashboard/overview#standalone-mode

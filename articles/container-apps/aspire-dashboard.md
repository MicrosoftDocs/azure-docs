...
The [.NET Aspire Dashboard](/dotnet/aspire/fundamentals/dashboard/overview) is hosted on the environment level and displays live data about how applications and other resources within the environment. 

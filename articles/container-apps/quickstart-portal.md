...
Azure Container Apps Preview lets you run microservices and containerized applications on a serverless platform. With Container Apps, you enjoy the benefits of running containers without the complexities of manually configuring cloud infrastructure and container orchestrators.

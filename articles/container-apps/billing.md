...
In addition, features such as private endpoints and planned maintenance are subject to additional charges which show up as a **Dedicated Plan Management Fee** regardless of whether you are using the Consumption or Dedicated plans.

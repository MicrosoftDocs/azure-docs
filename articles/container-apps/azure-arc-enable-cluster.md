...
> [!IMPORTANT]
> If deploying onto **AKS-Azure Local** ensure that you have [setup HAProxy or a custom load balancer](/azure/aks/hybrid/configure-load-balancer) before attempting to install the extension.

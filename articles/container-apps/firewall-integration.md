...
<sup>1</sup>The full range is required when creating your Azure Container Apps as a port within the range will by dynamically allocated. Once created, the required ports will be 2 static values, and you can update your NSG rules.

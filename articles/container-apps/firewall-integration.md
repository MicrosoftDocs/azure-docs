...
|--|--|--|--|--|--|
| TCP | Your client IPs | \* | Your container app's subnet<sup>1</sup> | `80`, `31080`<sup>2</sup> | Allow your Client IPs to access Azure Container Apps when using HTTP. |
| TCP | Your client IPs | \* | Your container app's subnet<sup>1</sup> | `443`, `31443`<sup>2</sup> | Allow your Client IPs to access Azure Container Apps when using HTTPS. |

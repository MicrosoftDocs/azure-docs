...
| [Launch Your First Java app](java-get-started.md?pivots=war#prepare-the-project) |A monolithic Java application called PetClinic built with Spring Framework. PetClinic is a well-known sample application provided by the Spring Framework community. |

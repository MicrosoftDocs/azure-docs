...
Below is a simple Kusto query that displays console log entries for the container app named *album-api*. 
...
Below is a simple Kusto query that displays system log entries for the container app named *album-api*. 

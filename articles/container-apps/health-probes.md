...
|---|---|
| Startup | Protocol: TCP<br>Port: ingress target port<br>Timeout: 3 second<br>Period: 1 second<br>Initial delay: 1 second<br>Success threshold: 1<br>Failure threshold: 240 |

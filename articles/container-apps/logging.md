...
Container console logs are written by your application to the `stdout` and `stderr` output streams of the application's container. By implementing detailed logging in your application you will be able to troubleshoot issues and monitor the health of your application. 
...
System logs are generated by the Azure Container Apps to inform you for the status of service level events.  The messages are (details are truncated):

---
title: Configure Azure Container Apps with Private Endpoints
description: Learn how to protect Azure Container Apps with Private Endpoints
...
# Create a private endpoint for Azure Container Apps
...
* An Azure Container App environment with a *Dedicated workload profile*, deployed in your Azure subscription. Having the container app environment be integrated with a virtual network is optional. 

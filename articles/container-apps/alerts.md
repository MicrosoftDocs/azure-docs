...
description: Learn how to set up alerts to monitor your application in Azure Container Apps. You can use metric alerts and log alerts.
...
#customer intent: As an application developer using Azure Container Apps, I want to create alerts to notify me of issues that concern my application.
---
...
For more information, see [Choose the right type of alert rule](/azure/azure-monitor/alerts/alerts-types).

You can create alert rules from metric charts in the metric explorer and from queries in Log Analytics. You can also define and manage alerts from the **Monitoring** > **Alerts** page. To learn more about alerts, see [Overview of alerts in Microsoft Azure](/azure/azure-monitor/alerts/alerts-overview).
...
When you create alert rules based on a metric chart in the metrics explorer, alerts are triggered when the metric data matches alert rule conditions. For more information about creating metrics charts, see [Using metrics explorer](metrics.md#using-metrics-explorer).
...
1. Select the condition.
   ...
   :::image type="content" source="media/observability/metrics-alert-create-condition.png" alt-text="Screenshot of the metric explorer alert rule editor that shows a condition that is automatically created based on the chart settings.":::
...
1. From the top menu, select **Alert rules**.
1. Select an alert from the table.
1. Select **Edit**.
1. Select **Condition**, then scroll down and select **Add condition**.
1. Select a popular signal or select **See all signals** for more options.
...
1. Configure the settings for your alert condition. For more information about configuring alerts, see [Create or edit a metric alert rule](/azure/azure-monitor/alerts/alerts-create-metric-alert-rule).
...
1. Configure the settings in the **Measurement** section
   ...
   :::image type="content" source="media/observability/screenshot-metrics-alerts-measurements.png" alt-text="Screenshot of metrics Create an alert rule measurement section.":::

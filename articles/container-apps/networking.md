...
Container Apps features two [environment types](environment.md#types), which share many of the same networking characteristics. However, there are some key differences.

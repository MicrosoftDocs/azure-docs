...
|[Private endpoint](how-to-use-private-endpoint.md) | Use a private endpoint to securely access your Azure Container App without exposing it to the public Internet. **Note**: Private endpoints incur additional charges. See [billing considerations](private-endpoints-with-dns.md#billing-and-cost-considerations). |

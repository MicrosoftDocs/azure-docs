...
For more information about scenarios, see [Ingress in Azure Container Apps](ingress-overview.md#scenarios).
...
-	**VNET-scope ingress**: If you plan to use VNET-scope [ingress](ingress-overview.md#ingress-configuration) in an internal Container Apps environment, configure your domains in one of the following ways:

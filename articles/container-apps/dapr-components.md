...
- For an **Azure Key Vault secret store**, use managed identity to establish the connection. [Learn more about using Azure Key Vault to manage secrets.](./manage-secrets.md#reference-secret-from-key-vault)

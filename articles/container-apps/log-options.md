...
Container Apps application logs consist these categories:
...
1. Select **Save**.
1. If you have selected **Azure Monitor** as your logs destination, you must configure **Diagnostic settings**.  To do this, select **Diagnostic settings** from the menu on the left after the Logging Options.

### Diagnostic settings



When you select **Azure Monitor** as your logs destination, you must configure the destination details. Select **Diagnostic settings** from the left side menu of your Container Apps Environment page.

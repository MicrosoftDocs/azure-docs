...
> [AZURE.NOTE] The procedures in this task apply to Azure Cloud Services; for Websites, see [Configuring an SSL certificate for an Azure website](app-service-web/web-sites-configure-ssl-certificate.md).

...
- For Windows instructions, see [Creating and Uploading a Windows Server VHD](http://azure.microsoft.com/documentation/articles/virtual-machines-create-upload-vhd-windows-server/).

...
description: This article provides information about migrating Azure media resources from Azure Germany to global Azure.
author: gitralf
services: germany
cloud: Azure Germany
ms.author: ralfwi 
...
- Refresh your knowledge by completing the [Media Services tutorials](https://docs.microsoft.com/azure/media-services/#step-by-step-tutorials).

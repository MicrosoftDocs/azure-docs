...
Azure Service Bus services don't have data export or import capabilities. To migrate Service Bus resources from Azure Germany to global Azure, you can export the resources [as an Azure Resource Manager template](../azure-resource-manager/manage-resources-portal.md#export-resource-groups-to-templates). Then, adapt the exported template for global Azure and re-create the resources.
...
- Become familiar with how to [export Resource Manager templates](../azure-resource-manager/manage-resources-portal.md#export-resource-groups-to-templates) or read the overview of [Azure Resource Manager](../azure-resource-manager/resource-group-overview.md).

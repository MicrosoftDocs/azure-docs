...
Azure Cloud Solution Providers need to take additional steps to support customers during and after the transition to the new German datacenter region. Learn more about the additional steps [here](/microsoft-365/enterprise/ms-cloud-germany-transition-add-csp).

...
The guidance on identity / tenants is intended for Azure-only customers. If you use common Azure AD tenants for Azure and O365 (or other Microsoft products), there are complexities in identity migration, and you should first contact your Account Manager prior to using this migration guidance.

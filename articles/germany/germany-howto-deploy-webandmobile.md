...
Open an existing app solution or project in Visual Studio or [create a project](../app-service/quickstart-dotnetcore.md?tabs=netframework48#create-and-publish-the-web-app). Then, run the app in Visual Studio to make sure it works locally.

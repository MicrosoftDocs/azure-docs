...
* There is currently an issue that causes the service not to resolve whenever your host IP address changes. In the Service Fabric Local Cluster Manager, select **Stop Local CLuster**, and then **Start Local Cluster**.  Then rerun the application.

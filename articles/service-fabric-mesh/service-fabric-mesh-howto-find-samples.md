...
| [Counter App](https://github.com/Azure-Samples/service-fabric-mesh/tree/master/templates/counter) for Azure File Volumes | Store state by mounting Azure Files based volume inside the container. <br><br> **Note:** This template requires an Azure Files file share to already be provisioned [Instructions](https://docs.microsoft.com/azure/storage/files/storage-how-to-create-file-share) | [Source Code](https://github.com/Azure-Samples/service-fabric-mesh/tree/master/templates/counter) | Visual Studio Mesh Tooling |
...
| [Counter App](https://github.com/Azure-Samples/service-fabric-mesh/tree/master/templates/counter) for Service Fabric Reliable Volumes| Store state by mounting Service Fabric Reliable Disk based volume inside the container.| [Source Code](https://github.com/Azure-Samples/service-fabric-mesh/tree/master/templates/counter) | Visual Studio Mesh Tooling |

...
This tutorial is part two of a series. Learn how to manually scale the number service instances of an application that was [previously deployed to Service Fabric Mesh](service-fabric-mesh-tutorial-template-deploy-app.md).  When you're finished, you'll have <!-- incomplete sentence -->.

<properties
   pageTitle="Configuring an Azure Cloud Service Project Using Multiple Service Configurations | Microsoft Azure"
...
To learn more about configuring Azure cloud service projects, see [Managing roles in the Azure cloud services projects with Visual Studio](vs-azure-tools-cloud-service-project-managing-roles.md).

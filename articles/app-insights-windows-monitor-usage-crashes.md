<properties pageTitle="Monitor usage and crashes in Windows Store and Phone apps" description="Analyze usage, availability and performance of your on-premises or Microsoft Azure web application with Application Insights." authors="alancameronwills" manager="kamrani"/>

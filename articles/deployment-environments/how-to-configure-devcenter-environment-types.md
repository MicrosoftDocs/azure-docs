...
:::image type="content" source="./media/configure-dev-center-environment-types/add-new-devcenter-environment-type.png" alt-text="Screenshot of **Add environment type** page.":::

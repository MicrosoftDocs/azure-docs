...
1. Create a [system-assigned managed identity](how-to-configure-managed-identity.md#configure-a-managed-identity).
...
1. Attach a [user assigned managed identity](how-to-configure-managed-identity.md#configure-a-managed-identity).

...
1. Choose the image type you want to use: a standard image or a custom image. If you use a custom image, you begin with a standard image and then customize it to fit your requirements.
1. Build the image.
...
After you complete the image customization, you must build the image and push it to your container registry by using a script provided by Microsoft to automate the process.

...
1. In the sidebar menu, select **Projects**, then select the project you want to manage.

1. Select **Access control (IAM)** in the sidebar menu.

1. Select **+ Add** > **Add role assignment**.

1. On the **Role** tab, search for and select the **DevCenter Project Admin** role. Then select **Next**.
...
1. On the **Members** tab, for **Assign access to**, select **User, group, or service principal**. Then select **+ Select members** to choose the users or groups you want to assign as project admins.

1. Select **Review + assign** to review your selections, then select **Review + assign** again to confirm.
...
1. In the sidebar menu, select **Projects**, then select the project your developers need to access.

1. Select **Access control (IAM)** in the sidebar menu.

1. Select **+ Add** > **Add role assignment**.

1. On the **Role** tab, search for and select the **Deployment Environments User** role. Then select **Next**.

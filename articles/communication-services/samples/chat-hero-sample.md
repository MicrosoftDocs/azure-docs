...
2. Clone the repo using the following CLI string: 
   ...
   Or clone the repo using any method described in [Clone an existing Git repo](/azure/devops/repos/git/clone.md)

   [Clone a repo](https://learn.microsoft.com/en-us/azure/devops/repos/git/clone)

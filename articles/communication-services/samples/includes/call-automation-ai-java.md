...
## Download code 
Find the project for this sample on [Github]([https://github.com/Azure-Samples/communication-services-dotnet-quickstarts/tree/callautomation-openai-sample-csharp/callautomation-openai-sample-csharp](https://github.com/Azure-Samples/communication-services-java-quickstarts/tree/carlosalm/callautomation-openai-sample/CallAutomation_OpenAI_Sample)). You can download this code and run it locally to try it for yourself. 

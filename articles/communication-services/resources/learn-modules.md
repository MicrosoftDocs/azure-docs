...
- [Introduction to Communication Services](https://docs.microsoft.com/learn/modules/intro-azure-communication-services/)
- [Send an SMS message from a C# console application with Azure Communication Services](https://docs.microsoft.com/learn/modules/communication-service-send-sms-console-app/)
- [Create a voice calling web app with Azure Communication Services](https://docs.microsoft.com/learn/modules/communication-services-voice-calling-web-app)

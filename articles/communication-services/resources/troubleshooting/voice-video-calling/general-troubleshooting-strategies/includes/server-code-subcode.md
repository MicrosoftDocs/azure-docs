...
| 4507 | 495 | Call ended as application did not provide valid Azure Communication Services token. | UnexpectedClientError |- Please make sure that your application implements token refresh mechanism correctly. |
...
| 10004 | 487 | Call was canceled on timeout, no callee endpoint accepted on time. Please make sure that user saw the notification and try to initiate that call again. | ExpectedError | |

...
This may indicate that the user is wanting to speak something but forgot to unmute their microphone. 
Since the microphone state in the SDK is muted, no audio is sent in this case.
...
The purpose of this UFD is for the application to show a message on your user interface as a hint, so the user can know that the microphone is muted if they intend to speak.

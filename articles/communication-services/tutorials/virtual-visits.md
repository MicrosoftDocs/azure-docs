...
![Booking services configuration experience](./media/sample-builder/bookings_services.png)

And then make sure "Add online meeting" is enable.

![Booking services online meeting configuration experience](./media/sample-builder/bookings_services_online_meeting.png)
...
![final view of bookings business information](./media/sample-builder/bookings-acs-app-integration-url.png)

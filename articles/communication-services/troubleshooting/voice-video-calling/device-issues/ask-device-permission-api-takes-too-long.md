...
the application can retry the API again and the user should see the permission prompt UI again.

If the device list update step takes a very long time, the user should check their audio device list and see if there is any device that could potentially be causing this issue.

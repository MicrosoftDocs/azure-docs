...
| [`RouterWorkerUpdated`](#microsoftcommunicationrouterworkerupdated)  | `Worker` | One of the following worker properties has been update: `AvailableForOffers`, `TotalCapacity`, `QueueAssignments`, `ChannelConfigurations`, `Labels`, `Tags`, `MaxConcurrentOffers` |

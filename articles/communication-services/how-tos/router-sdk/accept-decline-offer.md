...
This guide outlines the steps necessary to observe a Job Router offer. It also outlines how to accept or decline job offers.
...
## Observe job offer-issued events
...
The worker can decline job offers by using the SDK if the worker isn't willing to take a job:

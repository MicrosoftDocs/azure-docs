...
If you already have an Azure Event Grid viewer deployed or want a more robust viewer in place, follow the instructions to [deploy it](/azure/event-grid/). You need the endpoint generated by the Event Grid viewer.

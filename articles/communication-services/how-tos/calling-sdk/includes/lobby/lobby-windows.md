...
CallLobby object allows user with the Organizer, Co-organizer and Presenter roles to reject participant from Teams CallLobby. Method `RejectAsync` accepts identifier and `RejectLobbyParticipantOptions as input.
...
callLobby.LobbyParticipantsUpdated += Lobby_OnLobbyParticipantsUpdated;

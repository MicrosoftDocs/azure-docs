...
Trace.WriteLine("Admit result. success count: " + result.SuccessCount + ", failure count: " + rresult.FailedParticipants.Count + ", failure participants: " + result.FailedParticipants);

...
This guide assumes you have already gone through the QuickStart or have an application that is able to make and receive calls. If you have not completed the getting starting guide, refer to our [Quickstart: Add voice calling to your app](../../../quickstarts/voice-video-calling

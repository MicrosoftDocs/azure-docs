...
It assumes you have already install the Azure Calling SDK. If you did not install the calling SDK yet, please refer to our [Install guide](../install-sdk/install-sdk-web.md).

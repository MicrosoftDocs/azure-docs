...
In this tutorial, we will talk about how to move chat threads into your own storage once conversations are complete. Customers will be able to do analysis on 
conversations, maintain an archive for compliance reasons and/or enable co-pilot with ChatGPT to make your agents lives easier.
...
The backend application would run a job to do the following: 
...
2. Write it in the desired format you wish to store it in (JSON, CSV etc) 

...
Similarly for sentiment analysis as the users are talking the [Azure AI language](../../../ai-services/language-service/sentiment-opinion-mining.yml) service can be used.

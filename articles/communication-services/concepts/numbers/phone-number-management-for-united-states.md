...
Use the below tables to find all the relevenat information on number availability, eligibility and restrictions for phone numbers in United States.
...
\* In some countries/regions, number purchases are only allowed for own use. Reselling or suballcoating to another parties is not allowed. Due to this restriction, purchases for CSP and LSP customers is not allowed.

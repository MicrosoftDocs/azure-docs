...
| [Microsoft Copilot Studio](/microsoft-copilot-studio/voice-overview.md) | | ✅ | ✅ | Copilot studio is directly integrated with Azure Communication Services telephony. This integration is designed for voice bots and IVR. |
| [Azure Portal Copilot](/microsoft-copilot-studio/voice-overview.md) | | ✅ | ✅ | Copilot studio is directly integrated with Azure Communication Services telephony. This integration is designed for voice bots and IVR. |

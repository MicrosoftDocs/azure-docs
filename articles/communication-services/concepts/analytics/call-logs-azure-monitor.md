...
> [!IMPORTANT]
> The following refers to logs enabled through [Azure Monitor](https://docs.microsoft.com/en-us/azure/azure-monitor/overview) (see also [FAQ])(https://docs.microsoft.com/en-us/azure/azure-monitor/faq). To enable these logs for your Communications Services, see: [Enable logging in Diagnostic Settings](enable-logging)


## Data Concepts
The following are high level descriptions of data concepts specific to Voice and Video calling within you Communications Services that are important to reivew in order to understand the meaning of the data captured in the logs.
...
:::image type="content" source="media\call-logs-azure-monitor\Example 1_ P2P Call.png" alt-text="p2p Call streams":::
...
:::image type="content" source="media\call-logs-azure-monitor\Example 2_ Group Call Version A.png" alt-text="group Call detail":::
...
|     identifier                |     This is the unique ID for the user, matching the identity assigned by the Communications Authentication service. You can use this ID to correlate user events accross different logs. This ID can also be used to identify Microsoft Teams "Interoperability" scenarios described later in this document.                                                                                                                                                                                                                                                                                                                                                               |

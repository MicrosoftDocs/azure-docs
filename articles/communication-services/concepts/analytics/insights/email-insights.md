...
### Overview:
This section provides insights into the effectiveness of email notifications and message performance to enable the identification of patterns impacting message delivery. This graph measures the Total messages sent, messages delivered, messages failed, and messages blocked, messages viewed, and messages clicked, and the size of the message sent & delivered. 

#### Overall Email health

Overall email insight measures email delivery that assesses the effectiveness and efficiency of the email company. This metric enables you to optimize their marketing campaign efforts and improve customer engagement and conversion rate.
...
### Email Performance:
 This section provides insights into the email delivery rate, and delivery log indicating information about delivered emails, bounced, blocked, suppression, failed, etc. Analyzing the delivery log will help identify any issues or patterns and enable you to troubleshoot delivery problems and improve customer engagement.
   
...
** Suppression rate: It represents the number of recipients who expressed interest and agreed to receive email messages from you but have no valid mailbox with that address anymore or opt out of receiving emails from you.  
** Bounce rate: It represents the number of emails that couldn’t be delivered due to the recipient’s email address being invalid, the email server blocking the delivery, or an invalid domain name. 
** Blocked rate: It represents the number of emails that were not delivered through the recipient’s email server or were blocked by a spam filter

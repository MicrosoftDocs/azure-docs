...
| :-- | :-- |
| Plan your network | In this documentation you can find minimal requirements to your network for calls. Refer to the [Teams example for planning your network](https://docs.microsoft.com/en-us/microsoftteams/tutorial-network-planner-example) |

...
- When video is sent to a receiver with a large view and receiver with a small view. If video is sent to a receiver who has a larger view(a large view on a desktop receiver) than another receiver who has a smaller view(like a mobile receiver. Mobile screens are usually small), then the quality of the larger view will not be affected by the quality of the smaller view. Sender will send a high resolution to the larger view receiver and a smaller resolution to the smaller view receiver.

...
| Phone numbers _(beta)_| Azure.Communication.PhoneNumbers| [REST](/rest/api/communication/phonenumberadministration)| Acquire and manage phone numbers |
...
| API                                                                                                                          | Throttle            |
|------------------------------------------------------------------------------------------------------------------------------|---------------------|
| [All Search Telephone Number Plan APIs](/rest/api/communication/phonenumberadministration)         | 4 requests/day      |
| [Purchase Telephone Number Plan](/rest/api/communication/phonenumberadministration/purchasesearch) | 1 purchase a month  |

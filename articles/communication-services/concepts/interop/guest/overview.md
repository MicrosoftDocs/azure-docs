...
1. [Authenticate as Teams external user](../../../quickstarts/identity/access-token-teams-external-users.md) 
...
1. [Join Teams meeting audio and video as Teams external user](../../../quickstarts/voice-video-calling/get-started-teams-interop.md)
1. [Join Teams meeting chat as Teams external user](../../../quickstarts/chat/meeting-interop.md)

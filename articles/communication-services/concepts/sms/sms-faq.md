...
Carriers fees are fees charged by mobile carriers for sending/receiving SMS messages. Carrier fees for SMS are charged per message segment based on the destination. Azure Communication Services charges a standard carrier fee per message segment. Carrier fees are subject to change by mobile carriers. Please refer to [SMS pricing]((../../sms-pricing.md)) for more details.

...
*Messages with Spanish characters - There is a known limit of ~4 segments when sending/receiving a message with Spanish characters. Beyond 4 segments, the message may not be delivered with the right formatting.

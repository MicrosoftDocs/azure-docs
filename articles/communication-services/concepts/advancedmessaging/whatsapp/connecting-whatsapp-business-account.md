...
2.  A verifiable phone number to associate with your WhatsApp Business Account
    ...
    **Either**
    ...
    1.  An active Azure Communication Services phone number. [Get a phone number](https://learn.microsoft.com/azure/communication-services/quickstarts/telephony/get-phone-number?tabs=windows&pivots=platform-azp)

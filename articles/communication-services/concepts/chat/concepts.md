...
- Add a [Power Virtual Agent]([../../../power-platform/release-plan/2023wave2/power-virtual-agents/bring-bot-framework-bot-power-virtual-agents](https://powervirtualagents.microsoft.com/en-us/)) (PVA) in an Azure Communication Services Chat channel with an Azure Bot and a [relay bot](../../../power-virtual-agents/publication-connect-bot-to-azure-bot-service-channels#manage-conversation-sessions-with-your-power-virtual-agents-bot).

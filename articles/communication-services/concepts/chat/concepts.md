...
- Moreover, in Teams Interop scenarios, there are the following limitations:
    - The typing indicator event might contain a blank display name when sent from Teams user.
    - Read receipt feature isn't supported.
    - Certain identities are not supported (i.e. Bot users, Skype users, etc.)

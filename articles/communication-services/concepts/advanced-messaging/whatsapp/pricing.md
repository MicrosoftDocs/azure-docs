...
See [Pricing Updates on the WhatsApp Business Platform](https://developers.facebook.com/docs/whatsapp/pricing/updates-to-pricing/) for additional details. To view the original amount billed by Meta, prior to any Azure benefits or adjustments, refer to the Quantity column in your [Azure usage details file](https://learn.microsoft.com/en-us/azure/cost-management-billing/understand/download-azure-daily-usage).

...
## Relating humans to Communication Services identities
...
Using the Azure portal or Azure Resource Management APIs can create personal data. [Use this page to learn how to manage personal data in ARM systems.](https://docs.microsoft.com/azure/azure-resource-manager/management/resource-manager-personal-data)

...
*To find all countries where telephone numebrs are available, please refer to [subscription eligibility and number capabilities page](../numbers/sub-eligibility-number-capability.md).

...
Approval of brand registration might take two to three business days. Approval of campaign registration might take three to five business days.

You need to apply for brand and campaign registration before you acquire 10DLC numbers for SMS. If you previously acquired a 10DLC number for calling and want to enable it for SMS, you need to first register the brand and campaign and then associate the number.

> [!NOTE]
> 10DLC for SMS is available only in United States.
...
1. In the Azure portal, go to your Azure Communication Services resource. Then select **Regulatory Documents**.

1. On the **Regulatory Documents** pane, select **Add** to start the 10DLC brand registration wizard.

:::image type="content" source="./media/apply-for-brand-registration/regulatory-screen-1.png" alt-text="Screenshot showing Regulatory Documents pane." lightbox="./media/apply-for-brand-registration/regulatory-screen-1.png":::
...
On the **Application Type** tab, select **Add** and fill in these details:
...
> [!NOTE]
> This template is for informational purposes only and isn't intended as, and should not be substituted for, consultation with appropriate legal counsel and/or your organization's regulatory compliance team. This template is applicable only to approved uses of SMS from Azure Communication Services. Appropriate terms might vary depending on how you use this service and the nature of your business, and we recommend seeking legal counsel to ensure compliance with all applicable regulatory and legal obligations.
...
- **Sample Message**: Provide sample messages that align with the campaign's use case. You can add multiple sample messages if needed by selecting **Add Sample Message**.  The Sample Messages must include the following information:
...
On the **Campaign and Content Attributes** tab, fill in the campaign and content attributes as follows:
...
> [!TIP]
> Make Opt-In/Out and HELP Messages Clear and Compliant.
...
After submitting your brand and campaign registration, you can check the status on the **Regulatory Documents** pane. Follow these steps:

1. In the Azure portal, go to **Azure Communication Services**. On the left pane, select **Regulatory Documents**.

2. On the **Regulatory Documents** pane, in the **Brand Registration** section, locate your brand name. The status displays as one of these:
...
3. In the **Campaign Registration** section, find the campaign that you submitted. Campaign status options include:
...
Using the **Regulatory Documents** pane to monitor the status of your brand and campaign registration enables you to stay informed and quickly address any issues to keep your messaging operations uninterrupted.
...
1. In the Azure portal, go to **Azure Communication Services**. On the left pane, select **Phone Numbers**.

2. Select the phone number you want to associate with the approved campaign.

3. Under **Features**, select **Send SMS** or **Send and receive SMS** as needed.

4. In the **Campaign** section, select the appropriate campaign ID from the dropdown list.

...
| InteractiveNotificationContent  | This class defines which template you use and the content of the template properties for your message. |
| WhatsAppListActionBindings | This class defines the "who" and the "what" of the template message you intend to send.                |
| TextMessageContent     | This class defines the "who" and the "what" of the text message you intend to send.                    |
| InteractiveMessage    | This class defines the "who" and the "what" of the image media message you intend to send.             |
| ActionGroupItem | This class defines the "who" and the "what" of the Document media message you intend to send.             |
| ActionGroup    | This class defines the "who" and the "what" of the Video media message you intend to send.             |
| ActionGroupContent    | This class defines the "who" and the "what" of the Audio media message you intend to send.             |
...
- [Start sending intercative List options messages to a WhatsApp user](#start-sending-messages-between-a-business-and-a-whatsapp-user)
- [Send a Interactive Reply Button message to a WhatsApp user](#send-a-text-message-to-a-whatsapp-user)
- [Send a Interactive CTA Url based message to a WhatsApp user](#send-a-media-message-to-a-whatsapp-user)

...
> [!NOTE]
> To check which templates you have available, see the instructions at [List templates](../../../quickstarts/advanced-messaging/whatsapp/template-messages.md#list-whatsapp-templates-in-azure-portal).

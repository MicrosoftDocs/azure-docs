...
1.  Go to this Link [Azure Event Grid Viewer - Code Samples \| Microsoft Learn](/azure/event-grid/). Deploy the Event Grid Viewer sample by clicking **Deploy to Azure**.

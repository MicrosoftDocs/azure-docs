...
You can see the status of your WhatsApp Business account in the Azure portal. Accounts with different statuses will have different restrictions on messaging features. An account can have following types of status.

 - `Active` - when a WhatsApp account is ready to use.
 - `Revoked` - when a WhatsApp account is unshared or deleted from the WhatsApp side. If you no longer want to use the WhatsApp Business account, you can disconnect the account. If an error is made inadvertently resulting in the account in such a status, you can fix it by disconnecting and registering the same account again.
 - `Disconnected` - when a WhatsApp account is disconnected from the Azure portal side. You need to go to WhatsApp manager portal to unshare the WhatsApp Business Account or delete the phone number or delete the WhatsApp Business Account for a complete disconnection. If an error is made inadvertently resulting in the account in such a status, you can fix it by unsharing the account from the WhatsApp side and registering the same account again.
 - `Phone number deleted` - when a WhatsApp business phone number is deleted from the WhatsApp side. If you no longer want to use the WhatsApp Business account, you can disconnect the account. If an error is made inadvertently resulting in the account in such a status, you can fix it by disconnecting and registering the same account again with adding the same phone number.
 - `Business account review rejected` - when a WhatsApp account is disabled by WhatsApp because it doesn't comply with WhatsApp Business's Commerce Policy. Check details on WhatsApp manager portal and request a review if you believe that this rejection is incorrect.
 - `Display name review not started` - when WhatsApp hasn't started WhatsApp Business display name review for your business phone number. Typically, this is because your Meta business account has not yet finish Meta Business Verification. [See this link for details about Meta Business Verification.](https://www.facebook.com/business/help/2058515294227817) WhatsApp Business display name review isn't required to get started. You can immediately start sending messages to customers. You'll have limited number of messages and recipients per day until WhatsApp Business display name review is approved. 

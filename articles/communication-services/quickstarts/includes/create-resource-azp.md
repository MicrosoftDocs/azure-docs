...
![Screenshot highlighting the create a resource button in the Azure portal.](../media/create-a-communication-resource/create-resource-plus-sign.png)

Enter **Communication** into either the **Search the Marketplace** input or the search bar at the top of the portal.

![Screenshot showing a search for communication services in the search bar.](../media/create-a-communication-resource/searchbar-communication-portal.png)

Select **Communication Services** in the results, and then select **Add**.

![Screenshot showing the azure panel, highlighting the add button.](../media/create-a-communication-resource/add-communication-portal.png)

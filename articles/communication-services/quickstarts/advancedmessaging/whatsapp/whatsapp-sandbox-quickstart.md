...
:::image type="content" source="./media/whatsapp-sandbox/acs-resource.png" alt-text="Screenshot that shows Listing your WhatsApp accounts in the Azure portal.":::

2. Select "Try Advanced Messaging".  

:::image type="content" source="./media/whatsapp-sandbox/advancedmessaging-sandbox-blade.png" alt-text="Screenshot that shows Listing your WhatsApp accounts in the Azure portal.":::
...
:::image type="content" source="./media/whatsapp-sandbox/connect-to-whatsapp.png" alt-text="Screenshot that shows Listing your WhatsApp accounts in the Azure portal.":::
...
:::image type="content" source="./media/whatsapp-sandbox/connection-established.png" alt-text="Screenshot that shows Listing your WhatsApp accounts in the Azure portal.":::
 
5. Once connected, you will be able to send either a template message or a text message. There is one constraint from WhatsApp known as the 24-hour window. If a WhatsApp user has sent your application a message — whether it’s a reply to one of your outbound messages, or they have initiated communication themselves — your application has a 24-hour window (sometimes called a “24-hour session”) to send that user messages that don’t need to use a template. When your application sends a message to a WhatsApp user outside a 24-hour session, the message must use an approved template. 

:::image type="content" source="./media/whatsapp-sandbox/send-message.png" alt-text="Screenshot that shows Listing your WhatsApp accounts in the Azure portal.":::
...
:::image type="content" source="./media/whatsapp-sandbox/send-template.png" alt-text="Screenshot that shows Listing your WhatsApp accounts in the Azure portal.":::
 
7. Once the WhatsApp user has replied to the business phone number, you can also send a non-template text message from the sandbox within the 24-hour window.

:::image type="content" source="./media/whatsapp-sandbox/list-whatsapp-accounts.png" alt-text="Screenshot that shows Listing your WhatsApp accounts in the Azure portal.":::

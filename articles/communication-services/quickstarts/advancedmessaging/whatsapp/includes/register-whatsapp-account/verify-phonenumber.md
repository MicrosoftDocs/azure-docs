...
1. When you receive the verification code on your phone number, enter it into the setup page.
...
1. After providing the verification code, click on the **Next** button. This will complete the process.

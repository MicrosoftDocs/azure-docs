...
For a quick ramp-up on how to get these environment variables, you can follow the [Set up managed identities from CLI quickstart](../../managed-identity-from-cli.md).

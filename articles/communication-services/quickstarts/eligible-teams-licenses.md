...
You can find your current Teams license using [licenseDetails](https://docs.microsoft.com/en-us/graph/api/resources/licensedetails) Microsoft Graph API that returns licenses assigned to a user.

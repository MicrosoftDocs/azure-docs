...
1. The Fabrikam Administrator sets up a new service principal for Communication Services in the Fabrikam tenant. This step is required if the application is missing.

...
If you want to clean up and remove a Communication Services subscription, you can delete the resource or resource group. Deleting the resource group also deletes any other resources associated with it.You can find more information on cleaning up resources [here](../create-a-communication-resource.md#clean-up-resources).
...
You may also want to:
 ...
 - Familiarize yourself with [chat SDK](../../concepts/chat/chat-sdk-features.md)

...
Open and edit the file `MainActivity.java`. In this quick-start, we'll add our code to `MainActivity`, and view the output in the console. This quick-start does not address building a UI. At the top of file, import the `Communication common`, `Communication chat`, and other system libraries:

...
This quickstart does not cover creating a service tier for your chat application. See the following documentation for more detail [Chat Architecture](../../../concepts/chat/concepts.md)

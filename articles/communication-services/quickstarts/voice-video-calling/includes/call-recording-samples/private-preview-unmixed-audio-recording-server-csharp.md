...
- Make sure to provide the Azure Communication Services Call Recording team with your [immutable Azure resource ID](../../get-resourceid.md) to be allowlisted during the preview tests.

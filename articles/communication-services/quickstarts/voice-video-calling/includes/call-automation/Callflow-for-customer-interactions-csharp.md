...
4. Start NGROK by issuing the following command from a command prompt: “ngrok http <https://localhost:[your_web_service_port>]”. This will produce a public URI you can use to receive the events from the Event Grid subscription.
...
In the console window of your operating system, use the `dotnet` command to create a new web application with the name 'ContactCenterSample'

```console
dotnet new web -n ContactCenterSample
```
...
???? Pastebin code reference: <https://paste.microsoft.com/acbee6f9-1dd7-4990-920f-cc7d25742266>

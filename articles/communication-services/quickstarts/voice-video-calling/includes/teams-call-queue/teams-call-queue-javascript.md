...
Enter the Call Queue ObjectID, and select the "Start Call" button. Application will start the outgoing call and call queue will be connected. While introduction message and music will be played, call queue will try to reach and connent correspondent Teams user to the call.

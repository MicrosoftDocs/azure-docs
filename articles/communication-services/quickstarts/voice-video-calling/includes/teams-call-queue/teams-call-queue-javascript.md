...
- Complete the Teams tenant setup in [Teams calling and chat interoperability](https://learn.microsoft.com/en-us/azure/communication-services/concepts/interop/calling-chat)

...
- A [user access token](../../../identity/access-tokens.md) for Communication Services. You can also use the Azure CLI and run the command below with your connection string to create a user and an access token.

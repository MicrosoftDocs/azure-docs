...
> - Validate when the "Available Soon" items are actually available
> - This quickstart, doesn't provide any indication of what to do once a call has started. Without these is it even a call?:
>   - How do i send audio to the call
>   - How do i receive audio from the call.
> Clean Up
> Resources
...
oneToOneCall = callClient.call([PHONE TO CALL], placeCallOptions);
```
...
```js
const placeCallOptions = { fromCallerId: OWNED PHONE NUMBER };
oneToOneCall = callClient.call([PHONE TO CALL], placeCallOptions);
```

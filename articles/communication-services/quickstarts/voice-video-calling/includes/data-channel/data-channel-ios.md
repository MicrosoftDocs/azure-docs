...
| messageReady | Handles the event when a data message is received and ready to be fetched. |
...
extension CallObserver: DataChannelReceiverDelegate {
    public func dataChannelReceiver(_ dataChannelReceiver: DataChannelReceiver, messageReady args: DataChannelReceiverMessageReadyEventArgs) {
    ...
    public func dataChannelReceiver(_ dataChannelReceiver: DataChannelReceiver, didClose args: DataChannelReceiverCloseEventArgs) {

...
> [!NOTE]
> The `groupId` parameter is considered System Metadata, and may be used by Microsoft for operations required to run the system. You should not place Personal Data in this field. Microsoft does not treat this field as Personal Data, and it's content may be visible to Microsoft employees or may be stored long-term.
> The `groupId` field requires data in GUID format. We recommend using randomly generated GUIDs that are not considered Personal Data in your systems.
>

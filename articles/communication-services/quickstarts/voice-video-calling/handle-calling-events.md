...
:::image type="content" source="./media/handle-calling-events/select-events-voicevideocalling.png" alt-text="Screenshot showing the calling event types being selected.":::

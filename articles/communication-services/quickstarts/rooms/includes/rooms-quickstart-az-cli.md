...
- Use `<pstn-dial-out-enabled>` optionally set this flag ("True" or "False") to enable or disable PSTN dial out for a room. By default, this flag is set to "False" when creating a room.

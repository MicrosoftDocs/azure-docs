...
1. For **Endpoint**, select **Select an endpoint**, and then enter the URL of your web app.
   ...
   In this case, we use the URL from the [Event Grid viewer](/azure/event-grid/) that we set up earlier in the quickstart. The URL for the sample has this format: `https://{{site-name}}.azurewebsites.net/api/updates`

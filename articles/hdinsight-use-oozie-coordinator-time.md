<properties linkid="hdinsight-use-time-based-oozie-coordinator-with-hdinsight-Hadoop" urlDisplayName="Use time-based Oozie Coordinator with HDInsight Hadoop" pageTitle="Use time-based Oozie Coordinator with HDInsight Hadoop | Azure" metaKeywords="" description="Use time-based Oozie Coordinator with HDInsight Hadoop, a big data solution. Learn how to define Oozie workflows and coordinators, and submit coordinator jobs." metaCanonical="" services="hdinsight" documentationCenter="" title="Use time-based Oozie Coordinator with HDInsight Hadoop" authors="jgao" solutions="big-data" manager="paulettm" editor="cgronlun" />


# Use time-based Oozie Coordinator with HDInsight Hadoop

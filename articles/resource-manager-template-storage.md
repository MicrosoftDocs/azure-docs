...
| location | string | Yes | A region that supports storage for your subscription  | The region to host the storage account.<br /><br />To determine valid regions, see [supported regions](/resource-manager-supported-services.md/#supported-regions). |

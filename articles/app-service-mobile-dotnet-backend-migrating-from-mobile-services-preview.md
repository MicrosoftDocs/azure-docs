...
The first step in migrating is to create the App Service which will host the new version of your application. You can create a new Mobile App in the [Preview Azure Management Portal]. You can consult the [Get Started with Mobile Apps] topic for further detail.
...
This will allow the client to route requests to the components of your Mobile App. You can find more details specific to your target platform using the appropriate [Get Started with Mobile Apps] topic.
...
[Get Started with Mobile Apps]: /en-us/documentation/articles/app-service-mobile-dotnet-backend-xamarin-ios-get-started-preview

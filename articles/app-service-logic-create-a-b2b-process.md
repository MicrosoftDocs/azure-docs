...
2. **Data persistence**: Once the message has been received over AS2, Northwind wants to persist it before further processing. It can use a connector to persist messages in its Cloud storage. In this tutorial Azure Blobs is being leveraged as the cloud storage for Northwind.
...
# Before you begin #
This tutorial assumes that you have basic understanding of Azure App Services, and that you know how to create API apps and stitch a flow together.

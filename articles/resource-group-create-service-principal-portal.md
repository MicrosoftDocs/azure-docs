...
>
> The steps in this topic only apply when using the classic portal to create the AD application. If you use the Azure portal for creating the AD appplication, these steps will not succeed.

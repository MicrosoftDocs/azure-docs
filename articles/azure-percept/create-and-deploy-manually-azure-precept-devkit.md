...
If you have a device already created, you can skip to the [Manually deploy the deployment.json to the device](#Manually-deploy-the-deployment.json-to-the-Azure-Percept-device) section. 

...
1. Power on the devkit (connecting the power adaptor to the dev kit will automatically power it on). LED L02 will change to blinking white, which indicates that the device was powered on and is authenticating.

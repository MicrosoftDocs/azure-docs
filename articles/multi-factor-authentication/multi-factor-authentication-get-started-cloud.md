<properties
	pageTitle="Get started Azure MFA in the cloud | Microsoft Azure"
...
To start requiring two-start verification on for a user, you simply change the user's state from disabled to enabled.  For more information on user states see [User States in Azure Multi-Factor Authentication](multi-factor-authentication-get-started-user-states.md)
...
5.  At the bottom of the page, click **Manage Multi-Factor Auth**. This opens a new browser tab.
...
9.  Notice that the user's state has changed from **disabled** to **enabled**.

...
If your organization is federated with Azure Active Directory, use Azure Multi-Factor Authentication or Active Directory Federation Services to secure resources that are accessed by Azure AD. Use the procedures below to secure Azure Active Directory resources with either Azure Multi-Factor Authentication or Active Directory Federation Services.
...
7. Under Custom rule: add the following:
...
3. Under, Directory click on the directory where want to set up trusted IPs.

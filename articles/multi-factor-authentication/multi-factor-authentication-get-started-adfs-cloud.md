...
1. Use the steps outlined in [turn-on multi-factor authentication](multi-factor-authentication-get-started-could.md#turn-on-multi-factor-authentication-for-users) for users to enable an account.

...
| Multi-Factor Authentication for Azure Administrators | Azure administrators can enable two-step verification for their global admin accounts at no additional cost.|

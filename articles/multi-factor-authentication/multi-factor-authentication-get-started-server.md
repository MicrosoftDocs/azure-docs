...
| [Advanced scenarios with Azure Multi-Factor Authentication and third-party VPN](multi-factor-authentication-advanced-vpn-configurations.md) | Step-by-step configuration guides for Cisco, Citrix, and Juniper VNP appliances. |

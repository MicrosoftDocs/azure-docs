...
If your organization has federated your on-premises Active Directory with Azure Active Directory using AD FS, yhere are two options for using Azure Multi-Factor Authentication.
...
- You lose on-premises auth logging capability for app passwords.
- Account disable/deletion may take up to 3 hours for dirsync, delaying disable/deletion of app passwords in the cloud identity.

...
- **Quickstarts.** You can contribute example Bicep files and ARM templates to the Azure Quickstart Templates. For more information, see the [Azure Quickstart Templates contribution guide](https://github.com/Azure/azure-quickstart-templates/blob/master/1-CONTRIBUTION-GUIDE/README.md#contribution-guide).

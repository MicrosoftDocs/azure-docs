...
When you use `.bicepparam` file format, you can provide secure values to parameters by using [the `az.getSecret` function](bicep-functions-resource.md#az.getsecret).

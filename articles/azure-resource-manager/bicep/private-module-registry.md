...
To work with module registries, you must have [Bicep CLI](./install.md) version **0.4.1008 or later** and [Azure CLI](/cli/azure/install-azure-cli) version **2.31.0 or later**.

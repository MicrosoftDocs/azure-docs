...
The comparison operators compare values and return either `true` or `false`. To run the examples, use Azure CLI or Azure PowerShell to [deploy a Bicep file](./tutorial-create-first-bicep.md#deploy-bicep-file).

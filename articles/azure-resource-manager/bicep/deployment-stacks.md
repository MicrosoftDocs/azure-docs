...
> - Use the Set command instead of the `New-Az*DeploymentStack` cmdlets. The Set command doesn't output a warning prompt if the deployment stack already exists, which can help avoid the confusion caused by the current behavior.

...
## Available paths and modules

The [Deploy and manage resources in Azure by using Bicep](/learn/paths/bicep-deploy/) learning path is the best place to start. It starts with an introduction to infrastructure as code and takes you through the steps of building increasingly more complex Bicep files.

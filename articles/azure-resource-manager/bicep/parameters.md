...
See the [Build reusable Bicep files by using parameters](/training/modules/build-reusable-bicep-files-parameters) Learn module for step-by-step guidance about parameters.

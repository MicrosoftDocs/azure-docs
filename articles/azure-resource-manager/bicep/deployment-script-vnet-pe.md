...
- Create a private DNS zone `[file.core.windows.net](http://file.core.windows.net)` and register the private endpoint IP address as an A record. Link the private DNS zone to the created virtual network.

...
In this example, a *scale up* condition for the App Service plan based on the average CPU percentage over a 10 minute time period is. If the App Service plan exceeds 70% average CPU consumption over 10 minutes, the autoscale engine scales up the plan by one instance. 

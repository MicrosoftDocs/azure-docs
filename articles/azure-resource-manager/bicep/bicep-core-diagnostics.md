...
| <a id='BCP422' />[BCP422](./diagnostics/bcp422.md | Error | A resource of type `<resource-type>` may or may not exist when this function is called, which could cause the deployment to fail.|

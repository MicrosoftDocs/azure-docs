...
For every scope, the user deploying the Bicep file must have the required [!INCLUDE [permissions](C:\Users\daphnema\Repos\azure-docs-pr\includes\template-deploy-permissions.md)] to create resources.

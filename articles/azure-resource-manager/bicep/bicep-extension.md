...
Your deployment might fail with a 401 AuthenticationFailed error when you attempt to use the Graph extension (or any Bicep extension requiring the [OAuth On-Behalf-Of flow](/entra/identity-platform/v2-oauth2-on-behalf-of-flow)) within a nested module under specific conditions.

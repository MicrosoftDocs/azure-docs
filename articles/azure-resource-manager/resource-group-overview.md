...
* For information on migration of resources from Classic to ARM, see [Migrate from Classic to Azure Resource Manager](resource-manager-deployment-model#migrate-from-classic-to-resource-manager)

...
## Sample output
To access the output values of elements in `elements`, use the [basics()](create-uidefinition-referencing-functions.md#basics) or [steps()](create-uidefinition-referencing-functions.md#steps) functions and dot notation:

...
1. Add a new package. Fill out the **Package Details** section on the following form:
   ...
   * **Role Definition**: This property is a list of all the built-in Azure roles provided by Azure AD. You can select the role that's most appropriate to use to manage the resources on behalf of the customer.

...
> | galleries / applications/versions | application | 32-bit integer | Numbers and periods.<br/>(The periods are removed and converted to an integer. When converted max value is 2,147,483,647)  |
> | galleries / images | gallery | 1-80 | Alphanumerics, underscores, hyphens, and periods.<br><br>Start and end with alphanumeric. |
> | galleries / images / versions | image | 32-bit integer | Numbers and periods.<br/>(The periods are removed and converted to an integer. When converted max value is 2,147,483,647) |

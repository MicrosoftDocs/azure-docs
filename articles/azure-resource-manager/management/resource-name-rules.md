...
> | Entity | Scope | Length | Valid Characters |
> | --- | --- | --- | --- |
> | managedInstances | global | 1-63 | Lowercase letters, numbers, and hyphens. Can't have any special characters, such as `@`.<br><br> Can't start or end with hyphen. Can’t have hyphen twice in both third and fourth place. For example, `ab--cde` is not allowed. |
> | servers | global | 1-63 | Lowercase letters, numbers, and hyphens. Can't have any special characters, such as `@`.<br><br> Can't start or end with hyphen. Can’t have hyphen twice in both third and fourth place. For example, `ab--cde` is not allowed. |
...
> | servers | failoverGroups | 1-63 | Lowercase letters, numbers, and hyphens. Can't have any special characters, such as `@`.<br><br> Can't start or end with hyphen. Can’t have hyphen twice in both third and fourth place. For example, `ab--cde` is not allowed. |

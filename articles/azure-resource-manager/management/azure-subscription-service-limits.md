...
>
> The terms *soft limit* and *hard limit* often are used informally to describe the current, adjustable limit (soft limit) and the maximum limit
> (hard limit). If a limit isn't adjustable, there won't be a soft limit, only a hard limit.

...
This section provides information about limits for Azure API Management [service tiers](../../api-management/api-management-features.md), including the following:

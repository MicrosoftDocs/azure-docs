...
To export all resources in a resource group, use [az group export](/cli/azure/group?view=azure-cli-latest#az_group_export) and provide the resource group name.

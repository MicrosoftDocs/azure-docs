...
2. Select **Resource groups**
    ...
    :::image type="content" source="./media/manage-resource-groups-portal/manage-resource-groups-add-group.png" alt-text="Screenshot of the Azure portal with the Add Resource Group button highlighted.":::
3. Select **Add**.

...
1. To customize the information displayed for the resource groups, configure the filters. The following screenshot shows the other columns you can add to the display:
...
After you create a Resource Manager template, use the Azure portal to deploy your Azure resources. For information about creating a template, see [Quickstart: Create and deploy Azure Resource Manager templates by using the Azure portal](../templates/quickstart-create-templates-use-the-portal.md). For information about deploying a template using the portal, see [Deploy resources with Resource Manager templates and Azure portal](../templates/deploy-portal.md).
...
1. Open the resource group you want to lock. For more information, see [Open resource groups](#open-resource-groups).
...
Apply tags to resource groups and resources to logically organize your assets. For more information, see [Using tags to organize your Azure resources](tag-resources-portal.md).

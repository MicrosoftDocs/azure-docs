...
- A read-only lock on a **network security group (NSG)** prevents the creation or modification of the corresponding NSG flow log. A cannot-delete lock on a **network security group (NSG)** doesn't prevent the creation or modification of the corresponding NSG flow log.

...
> | AKS cluster | **pending** | **pending** | No<br/><br/> [Learn more](../../dev-spaces/index.yml#can-i-migrate-my-aks-cluster-with-azure-dev-spaces-to-another-region) about moving to another region.

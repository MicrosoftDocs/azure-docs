...
* (optional) **Visual Studio Code with Resource Manager Tools extension**. See [Use Visual Studio Code to create Azure Resource Manager templates](quickstart-create-templates-use-visual-studio-code.md).

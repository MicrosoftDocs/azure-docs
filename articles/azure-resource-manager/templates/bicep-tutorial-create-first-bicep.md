...
If you want to learn about the benefits of using Bicep and why you should automate deployment with Bicep files, see [Bicep language for Azure Resource Manager templates](./bicep-overview.md).

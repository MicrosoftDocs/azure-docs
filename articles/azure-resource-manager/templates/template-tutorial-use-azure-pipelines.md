...
1. Run the following command:
    ...
    ![Azure Resource Manager Azure DevOps Azure Pipelines create GitHub bash](./media/template-tutorial-use-azure-pipelines/azure-resource-manager-devops-pipelines-github-bash.png)

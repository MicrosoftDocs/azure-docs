...
* The function can't access template parameters. That is, the [parameters function](resource-group-template-functions-deployment#parameters) is restricted to function parameters.

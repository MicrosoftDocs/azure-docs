...
* **enabledForTemplateDeployment**: It is a property of Key Vault.  This value must be true.
...
In this section, you use a Resource Manager template to create a Key Vault. The template does:

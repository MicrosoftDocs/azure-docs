...
| BadRequest | You sent deployment values that don't match what is expected by Resource Manager. Check the inner status message for help with troubleshooting. | [Template reference](/azure/templates/) and [Supported locations](resource-group-authoring-templates.md#location) |
...
| LocationRequired | Provide a location for your resource. | [Set location](resource-group-authoring-templates.md#location) |

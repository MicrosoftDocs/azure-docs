...
To start using management groups, [go right to the management group page in the Azure portal](https://aka.ms/azuremg) and select "Start using management groups" to create your new hierarchy.

...
If either of these appear, the version of the Android SDK installed in Eclipse might not match the SDK target of the downloaded project.  To update the version, make the following changes:

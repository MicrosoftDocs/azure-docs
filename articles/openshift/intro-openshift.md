...
You can [connect an Azure Red Hat OpenShift cluster to an existing virtual network](https://docs.microsoft.com/en-us/azure/openshift/tutorial-create-cluster#optional-connect-the-clusters-virtual-network-to-an-existing-virtual-network) via peering. In this configuration, pods can connect to other services in a peered virtual network.

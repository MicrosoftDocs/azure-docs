...
* The cluster must have a minimum of two worker nodes. Worker nodes must be available and tainted for OpenShift components to be schedulable onto them.   Do not scale the cluster workers to zero, or attempt a graceful cluster shutdown.

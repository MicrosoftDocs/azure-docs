...
* The cluster must have a minimum of two worker nodes. Do not have taints that prevent OpenShift components to be schedulabled. Do not scale the cluster workers to zero, or attempt a graceful cluster shutdown.

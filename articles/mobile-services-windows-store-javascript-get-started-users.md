...
[4]: ./media/mobile-services-js-get-started-users/mobile-services-selection.png
[5]: ./media/mobile-services-js-get-started-users/mobile-service-uri.png
...
[13]: ./media/mobile-services-js-get-started-users/mobile-identity-tab.png
[14]: ./media/mobile-services-js-get-started-users/mobile-portal-data-tables.png
[15]: ./media/mobile-services-js-get-started-users/mobile-portal-change-table-perms.png


<!-- URLs. -->
[Microsoft Account login]: /en-us/develop/mobile/how-to-guides/mobile-services-register-ms-account-auth
...
[Single sign-on for Windows Store apps by using Live Connect]: /en-us/develop/mobile/tutorials/single-sign-on-windows-8-js

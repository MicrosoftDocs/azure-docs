<properties title="Adding a Shard To an Elastic Scale Application" pageTitle="Adding a Shard To an Elastic Scale Application" description="How to use Elastic Scale APIs to add new shards to a shard set." metaKeywords="sharding scaling, Azure SQL Database sharding, elastic scale, shardmapmanager" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>

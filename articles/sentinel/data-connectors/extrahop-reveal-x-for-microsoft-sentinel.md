...
description: Learn how to install the ExtraHop Reveal(x) connector for Microsoft Sentinel connector to connect your data source to Microsoft Sentinel.
author: cwatson-cat
ms.topic: how-to
ms.date: 11/11/2022
...
To integrate with ExtraHop Reveal(x) for Microsoft Sentinel make sure you have: 

...
description: "Learn how to install the Windows Firewall connector for Microsoft Sentinel connector to connect your data source to Microsoft Sentinel."
author: cwatson-cat
ms.topic: how-to
ms.date: 11/14/2022
...
# Windows Firewall connector for Microsoft Sentinel
...
| --- | --- |
| **Log Analytics table(s)** | WindowsFirewall<br/> |

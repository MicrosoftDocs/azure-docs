---
title: Azure Cognitive Search solution for Sentinel (Preview) connector for Microsoft Sentinel
description: Learn how to install the Azure Cognitive Search solution for Sentinel (Preview) connector for Microsoft Sentinel connector to connect your data source to Microsoft Sentinel.
author: cwatson-cat
ms.topic: how-to
ms.date: 11/11/2022
...
# Azure Cognitive Search solution for Sentinel (Preview) connector for Microsoft Sentinel
...
To integrate with Azure Cognitive Search solution for Sentinel (Preview) make sure you have: 

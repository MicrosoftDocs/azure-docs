...
- **Netskope API Token**: A Netskope API Token is required. [See the documentation to learn more about Netskope API](https://docs.netskope.com/en/rest-api-v1-overview.html). **Note:** A Netskope account is required

---
title: Elastic Agent Solution (Preview) connector for Microsoft Sentinel
description: Learn how to install the Elastic Agent Solution (Preview) connector for Microsoft Sentinel connector to connect your data source to Microsoft Sentinel.
author: cwatson-cat
ms.topic: how-to
ms.date: 11/11/2022
...
# Elastic Agent Solution (Preview) connector for Microsoft Sentinel
...
To integrate with Elastic Agent Solution (Preview) make sure you have: 

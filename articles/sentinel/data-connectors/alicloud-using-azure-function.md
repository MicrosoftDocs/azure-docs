---
title: "AliCloud (using Azure Function) connector for Microsoft Sentinel"
description: "Learn how to install the connector AliCloud (using Azure Function) to connect your data source to Microsoft Sentinel."
author: cwatson-cat
ms.topic: how-to
ms.date: 02/23/2023
...
# AliCloud (using Azure Function) connector for Microsoft Sentinel

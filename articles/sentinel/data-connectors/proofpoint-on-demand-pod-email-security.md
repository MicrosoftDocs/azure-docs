---
title: "Proofpoint On demand (POD) Email Security connector for Microsoft Sentinel"
description: "Learn how to install the connector Proofpoint On demand (POD) Email Security to connect your data source to Microsoft Sentinel."
author: cwatson-cat
ms.topic: how-to
ms.date: 12/12/2022
...
# Proofpoint On demand (POD) Email Security connector for Microsoft Sentinel
...
To integrate with Proofpoint On demand (POD) Email Security make sure you have: 

...
This connector can also be used for the ingestion of Exadata infrastructure logs directly into log analytics workspace, enabling advanced monitoring and security analytics while running ExaData workloads using [Oracle Database@Azure](https://learn.microsoft.com/en-us/azure/oracle/oracle-db/database-overview).

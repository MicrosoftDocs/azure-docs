...
| **Query execution has exceeded the allowed limits.** | KQL interactive queries in the data lake are limited to 30,000 rows. | Run the query in a KQL job or use Notebooks. |

...
# Start an investigation by searching historical data (Preview)
...
- Reduced KQL that supports advanced filtering in a where clause but doesn't support joins, unions, or aggregations.

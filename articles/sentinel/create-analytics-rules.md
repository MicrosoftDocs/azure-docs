...
#Customer intent: [AI]As a security analyst, I want to create custom scheduled analytics rules using Kusto Query Language so that I can detect and respond to unusual or suspicious activities in my digital estate.

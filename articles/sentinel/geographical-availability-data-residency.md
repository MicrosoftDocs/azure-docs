...
- Microsoft Sentinel is accessible in both the [Microsoft Defender and Azure portals](../microsoft-sentinel-defender-portal.md). Microsoft Sentinel data is stored in Azure regions.

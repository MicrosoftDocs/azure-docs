---
title: Use Azure Defender to respond to supply-chain attacks and systemic-identity compromises | Microsoft Docs
...
# Use Microsoft Defender to respond to supply-chain attacks and systemic-identity compromises
...
- [Find and block malware and malicious behavior on endpoints](#use-microsoft-defender-to-find-and-block-malware-and-malicious-behavior-on-endpoints)
- [Find malicious activity in an on-premises environment](#use-microsoft-defender-to-find-malicious-activity-in-an-on-premises-environment)
- [Find malicious activity in the cloud environment](#use-microsoft-defender-to-find-malicious-activity-in-the-cloud-environment)
...
### Use Microsoft Defender to find and block malware and malicious behavior on endpoints
...
### Use Microsoft Defender to find malicious activity in an on-premises environment
...
### Use Microsoft Defender to find malicious activity in the cloud environment

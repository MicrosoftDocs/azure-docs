...
#Customer intent: [AI]As a security administrator, I want to define an access restriction policy for playbooks so that I can ensure only authorized services can access sensitive workflows.

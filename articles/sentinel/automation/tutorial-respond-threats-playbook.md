...
You want to make sure that potentially compromised users can't move around your network and steal information. We recommend that you create an automated, multifaceted response to incidents generated by rules that detect compromised users.

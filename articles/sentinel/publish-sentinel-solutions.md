...
|**Marketplace media**| **Logos** – Upload a logo for your company/product. 
|**Screenshots**| Add relevant screenshots of the solution (ex- workbooks) to highlight the usefulness of the solution. Appropriate screenshots enable customers to understand the solution value better.|
|**Videos**| Add relevant screenshots of the solution. For instance, you can provide a quick overview of the solution and its benefits or have video on how customers can install the solution and get started.|

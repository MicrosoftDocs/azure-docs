...
- Third-party application access via OAuth enabled for [Azure DevOps application connection policies](../devops/organizations/accounts/change-application-access-policies.md#manage-a-policy).

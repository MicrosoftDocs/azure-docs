...
1. Select one of the following tabs, depending on your connection type:
    ...
    > [!NOTE]
    > You cannot create create duplicate connections, with the same repository and branch, in a single Microsoft Sentinel workspace.
    >
...
- [Microsoft Sentinel Information Model (ASIM) parsers (Public preview)](normalization-about-parsers.md)

...
|**SAP - Persistency &  Data Exfiltration**     |    Displays data about: <br><br>- Internet Communication Framework (ICF) services, including activations and deactivations and data about new services and service handlers <br>- Insecure operations, including both function modules and programs <br>- Direct access to sensitive tables      | Uses data from the following logs: <br><br>- [ABAPAuditLog_CL](sap-solution-log-reference.md#abap-security-audit-log) <br>-  [ABAPTableDataLog_CL](sap-solution-log-reference.md#abap-db-table-data-log)<br> - [ABAPSpoolLog_CL](sap-solution-log-reference.md#abap-spool-log)<br> - [ABAPSpoolOutputLog_CL](sap-solution-log-reference.md#apab-spool-output-log)<br>-  [Syslog](sap-solution-log-reference.md#abap-syslog) |
|     |         | |

...
**Description:** NetWeaver SDK file path. A valid SDK is required for the data collector to operate. For more information, see [SAP prerequisites for the agentless data connector](prerequisites-for-deploying-sap-continuous-threat-monitoring.md#sap-prerequisites-for-the-agentless-data-connector).

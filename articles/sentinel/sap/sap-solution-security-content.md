...
- [Detect anomalies with audit log monitoring rules (Preview)](deployment-solution-configuration.md#detect-anomalies-with-audit-log-monitoring-rules-preview)

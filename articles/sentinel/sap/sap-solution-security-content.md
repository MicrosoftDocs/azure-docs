...
| --------- | --------- | --------- |
| <a name="sap---system-applications-and-products-workbook"></a>**SAP - Audit Log Browser** | Displays data such as: <br>- General system health, including user sign-ins over time, events ingested by the system, message classes and IDs, and ABAP programs run <br><br>-Severities of events occurring in your system <br>- Authentication and authorization events occurring in your system |Uses data from the following log: <br><br>[ABAPAuditLog_CL](sap-solution-log-reference.md#abap-security-audit-log) |
| [**SAP Audit Controls**](sap-audit-controls-workbook.md) | Helps you check your SAP environment's security controls for compliance with your chosen control framework, using tools for you to do the following: <br><br>- Assign analytics rules in your environment to specific security controls and control families<br><br>- Monitor and categorize the incidents generated by the SAP solution-based analytics rules<br><br>- Report on your compliance | Uses data from the following tables: <br><br>- `SecurityAlert`<br>- `SecurityIncident`|

...
| **(Preview) SAP - AS JAVA - User creates and uses new user** |  Identifies the creation or manipulation of users by admins within the SAP AS Java environment. | Logon to the backend system using users that you have created or manipulated. <br><br>**Data sources**: SAPcon - SAPJAVAFilesLog | Create Account, Valid Accounts |

...
- Learn more about how to [configure the rule](configure-audit-log-rules.md#example-configure-event-types-with-the-sap_dynamic_audit_log_monitor_configuration-watchlist) (full procedure)

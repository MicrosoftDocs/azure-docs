...
ABAPJobLog = False
```
The list of available logs can be found in the [systemconfig.ini reference](https://learn.microsoft.com/en-us/azure/sentinel/sap/reference-systemconfig#logs-activation-status-section).

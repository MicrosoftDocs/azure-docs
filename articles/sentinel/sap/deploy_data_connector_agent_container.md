...
Azure CLI is used in this step-by-step guide. For more information on how to deploy Azure CLI see [How to install the Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli)

...
### Administrative workstation prerequisites

| Prerequisite | Description |
| ---- | ----------- |
| **Required software** | Azure Command-Line Interface (CLI) ([see installation instructions](/cli/azure/install-azure-cli)). |

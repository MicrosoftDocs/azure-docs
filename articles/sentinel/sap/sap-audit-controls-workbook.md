...
:::image type="content" source="media/sap-audit-controls-workbook/configure-rule.png" alt-text="Screenshot of selecting a rule to configure.":::

:::image type="content" source="media/sap-audit-controls-workbook/configure-rule-zoom.png" alt-text="Screenshot close up of selecting a rule to configure.":::

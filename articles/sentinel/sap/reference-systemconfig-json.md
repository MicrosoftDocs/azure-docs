...
> [!IMPORTANT]
> Microsoft Sentinel solution for SAP® applications uses the new *systemconfig.json* file from agent versions released on or after June 22, 2023. For previous agent versions, you must still use the *[systemconfig.ini file](reference-systemconfig.md)*.

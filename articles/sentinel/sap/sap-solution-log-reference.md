...
This article describes the functions, logs, and tables available as part of the Microsoft Sentinel solution for SAP applications and its data connector. This article is intended for advanced SAP users.
...
For more information, see [Functions in Azure Monitor log queries](/azure/azure-monitor/logs/functions).

...
| **Managed identity or service principal** | The SAP data connector agent requires a managed identity or service principal to authenticate to Microsoft Sentinel. |

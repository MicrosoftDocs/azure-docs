...
|Microsoft Copilot in Microsoft Defender| When investigating incidents, summarize incidents, analyze scripts and files, and  generate incident reports. When hunting for threats in advanced hunting, create ready-to-run KQL queries by using the query assistant.<br><br> For more information, see [Microsoft Copilot in Microsoft Defender](/defender-xdr/security-copilot-in-microsoft-365-defender).|
...
|Microsoft Copilot in Microsoft Defender| When investigating incidents, take action on incidents through guided responses, and generate device and identity summaries.  Summarize the relevant threats impacting your environment, to prioritize resolving threats based on your exposure levels, or to find threat actors that might be targeting your industry by using Copilot for Security in threat intelligence.<br><br> For more information, see [Microsoft Copilot in Microsoft Defender](/defender-xdr/security-copilot-in-microsoft-365-defender). |

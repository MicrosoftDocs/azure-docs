...
#Customer intent: As a security engineer, I want to add entities to threat intelligence so that analysts can track and manage indicators of compromise effectively during incident investigations.
---

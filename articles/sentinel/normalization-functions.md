...
| _ASIM_ResolveFQDN | field (String) | - `ExtractedHostname`<br> - `Domain`<br> - `DomainType` <br> - `FQDN` | Analyzes the value in the field specifies and set the output fields accordingly. For more information see [example](normalizatoin-develop-prasers.md#resolvefqnd) in the article about developing parsers. | 

...
- Bandwidth costs vary depending on the source and destination region and collection method. For more information, see:
    ...
    - [Data transfers charges using Log Analytics ](../azure-monitor/usage-estimated-charges.md#data-transfer-charges).
...
- Connectors that are based on diagnostics settings do not incur in-bandwidth costs. For more information, see [Data transfers charges using Log Analytics ](../azure-monitor/usage-estimated-charges.md#data-transfer-charges).

...
For example, if you select the **Azure Active Directory** data source, which lets you stream logs from Azure AD into Azure Sentinel, you can select what type of logs you want to get - sign-in logs and/or audit logs. <br> Follow the installation instructions or [refer to the relevant connection guide](data-connectors-reference.md) for more information. For information about data connectors, see [Azure Sentinel data connectors](connect-data-sources.md).

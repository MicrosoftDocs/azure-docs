...
The following sections provide more instructions for customers to perform system checks using Microsoft software and help ensure continued security:
...
- [something for sentinel](#azure-sentinel)

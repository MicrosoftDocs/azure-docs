...
1. **Set up the Azure Data Factory pipeline**:
    ...
    - Create a data pipeline with a copy activity, based on when the blobs where last modified properties (this step required deeper Azure Data Factory knowledge).

        For more information, see [Copy activity in Azure Data Factory and Azure Synapse Analytics](../data-factory/copy-activity-overview).

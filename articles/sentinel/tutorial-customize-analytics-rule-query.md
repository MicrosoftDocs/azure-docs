---
title: Tutorial - Detect threats and produce enriched alerts with Microsoft Sentinel
description: In this tutorial, learn how to detect security threats with Microsoft Sentinel analytics rules, taking advantage of alert enrichment capabilities to surface as much information as possible to benefit an investigation.
author: yelevin
ms.author: yelevin
ms.topic: tutorial
ms.date: 01/08/2023
...
# Tutorial: Detect threats and produce enriched alerts
...
In this tutorial, you'll learn how to customize and use Microsoft Sentinel analytics rules to search for specific events or sets of events across your environment, frame objects found in your logs as trackable entities, surface notable pieces of information in the alerts generated by the rules, and decide whether and when to package alerts as incidents to be investigated.

...
#Customer intent: [AI]As a security operations analyst, I want to extract and use non-native entity information from incidents so that I can enhance my investigative and remedial actions.

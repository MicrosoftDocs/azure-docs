...
- [Azure Sentinel scheduled analytics rules](/azure/sentinel/articles/sentinel/detect-threats-built-in.md#scheduled). Fusion only considers scheduled analytics rules with tactics information.

...
- Changing the status of an incident, keeping your workflow up to date.
  ...
  - When changing to “closed,” specifying the [closing reason](tutorial-investigate-cases.md#closing-an-incident) and adding a comment. This helps you keep track of your performance and effectiveness, and fine-tune to reduce false positives. For more information about reducing false positives, see [Handle false positives in Azure Sentinel](false-positives.md).

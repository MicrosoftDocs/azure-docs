...
| **Vendor documentation/<br>installation instructions** | <li>[ESET Enterprise Inspector REST API documentation]([https://help.eset.com/eei/1.5/en-US/api.html](https://help.eset.com/eei/1.6/en-US/api.html)) |

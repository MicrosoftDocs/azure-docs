...
- Use Microsoft Sentinel's execution management tools to [monitor and manage scheduled analytics rules' execution](monitor-manage-analytics-rule-execution.md).

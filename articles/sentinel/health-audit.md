...
- Use Microsoft Sentinel's execution management tools to [monitor and troubleshoot scheduled analytics rules](monitor-troubleshoot-analytics-rule-execution.md).

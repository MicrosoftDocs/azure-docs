...
| <a name = "targetdvcdescription"></a>**TargetDvcDescription** | Optional | String | A descriptive text associated with the device. For example: `Primary Domain Controller`. |
...
| <a name = "srcdvcdescription"></a>**SrcDvcDescription** | Optional | String | A descriptive text associated with the device. For example: `Primary Domain Controller`. |

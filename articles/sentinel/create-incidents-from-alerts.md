---
title: Create incidents from alerts in Azure Sentinel Preview?| Microsoft Docs
...
Alerts triggered in Azure Sentinel that stem from Microsoft solutions, such as Microsoft Cloud App Security and Azure Advanced Threat Protection, are handled differently from other alerts in Azure Sentinel. During connection to these data sources, you can select whether you want the alerts from these security solutions to automatically stream as raw data into Azure Sentinel and generate alerts. 

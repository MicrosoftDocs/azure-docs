...
> [!NOTE]
> This tutorial provides a scenario-based procedure for a top customer ask: viewing analysis reports in PowerBi for your Azure Sentinel data. For more information, see [Quickstart: Get started with Azure Sentinel](get-visibility.md).

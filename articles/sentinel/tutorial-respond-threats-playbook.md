...
> * Create a playbook
> * Run a playbook
> * Attach a playbook to an automation rule to automate threat response
...
For example, if you want to stop potentially compromised users from moving around your network and stealing information, you can create an automated, multifaceted response to incidents generated by rules that detect compromised users. Then, you can create a playbook that takes the following actions:

1. When the incident is generated, the playbook opens a ticket in [ServiceNow](/connectors/service-now/) or any other IT ticketing system.

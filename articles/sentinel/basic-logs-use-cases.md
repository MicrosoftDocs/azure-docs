...
This topic highlights log sources to consider configuring for Basic Logs when they're stored in Log Analytics tables. Before configuring tables as Basic Logs, [compare the log data plans](/azure/azure-monitor/logs/log-analytics-workspace-overview.md#log-data-plans-preview).

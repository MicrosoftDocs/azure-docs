...
1. Connect the [Azure Activity](./data-connectors-reference.md#azure-activityazure-activity) data source to start streaming audit events into a new table in the **Logs** screen called AzureActivity.

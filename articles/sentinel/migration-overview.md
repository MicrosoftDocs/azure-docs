...
This guide describes how to migrate your legacy SIEM to Microsoft Sentinel.
...
Enterprises usually invest in customizing their SIEM platform and this is why it’s important to invest the required time to map existing SIEM components and existing SOC Processes while designing and planning new use cases to protect cloud-based assets in Microsoft Azure/AWS/GCP and SaaS solutions such as Microsoft Office 365.  

Here are some general steps to help you begin planning your migration: 

- Define the main phases of your migration. It’s important that each phase includes clear goals for each phase, key activities and the outcome of that phase by specifying the deliverables. Learn about [migration phases](#migration-phases). 
- Map existing SIEM components and existing SOC processes. 
- Design and plan new use cases to protect cloud-based assets in Microsoft Azure/AWS/GCP and SaaS solutions such as Microsoft Office 365.

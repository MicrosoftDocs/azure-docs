---
title: 'Quickstart: Onboard to Azure Sentinel with ARM'
description: Learn how to on-board Azure Sentinel with ARM
services: sentinel
author: yelevin
ms.author: yelevin
...
# Quickstart: Onboard to Azure Sentinel with ARm

In this quickstart, learn how to on-board Azure Sentinel with an Azure Resource Manager template (ARM template).

---
title: # VMware Carbon Black Cloud connector for Microsoft Sentinel
description: Learn how to install the # VMware Carbon Black Cloud connector for Microsoft Sentinel connector to connect your data source to Microsoft Sentinel.
author: cwatson-cat
ms.topic: how-to
ms.date: 11/10/2022
...
# VMware Carbon Black Cloud connector for Microsoft Sentinel
...
<li>uri</li>
<li>timeInterval</li>
<li>CarbonBlackOrgKey</li>
<li>CarbonBlackLogTypes</li>
<li>s3BucketName</li>
<li>EventPrefixFolderName</li>
<li>AlertPrefixFolderName</li>
<li>AWSAccessKeyId</li>
<li>AWSSecretAccessKey</li>
<li>SIEMapiId (Optional)</li>
<li>SIEMapiKey (Optional)</li>
...
To integrate with VMware Carbon Black Cloud make sure you have: 

---
title: # Google Cloud Platform Cloud Monitoring Solution connector for Microsoft Sentinel
description: Learn how to install the # Google Cloud Platform Cloud Monitoring Solution connector for Microsoft Sentinel connector to connect your data source to Microsoft Sentinel.
author: cwatson-cat
ms.topic: how-to
ms.date: 11/10/2022
...
# Google Cloud Platform Cloud Monitoring Solution connector for Microsoft Sentinel
...
To integrate with Google Cloud Platform Cloud Monitoring Solution make sure you have: 

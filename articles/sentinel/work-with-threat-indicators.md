...
### Use Microsoft matched threat intelligence (Public preview)

If you have the built-in **Microsoft Threat Intelligence Matching Analytics** rule, which matches Microsoft-generated threat intelligence data with your logs, you'll have high-fidelity alerts and incidents generated based on data matched from your logs, with appropriate severities applied.

If you have a match found, any alerts generated are grouped into incidents. Use the following steps to triage through the incidents generated by the **Microsoft Threat Intelligence Matching Analytics** rule:
...
When a match is found, the indicator is also published to the Log Analytics **ThreatIntelligenceIndicators**, and displayed in the **Threat Intelligence** menu. For any indicators published from this rule, the source is defined as **Microsoft Threat Intelligence Analytics**.

...
- [Manage and monitor cross-workspace architecture](extend-sentinel-across-workspaces-tenants.md) 
- [Manage multiple workspaces with workspace manager](workspace-manager.md)

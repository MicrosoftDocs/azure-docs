...
If you have problems with Lookup Queries showing up in your Sentinel, follow these steps **in order** to see that everything comes through:
...
2. Make sure DNSEvents are in your Log Analytics collection list
3. Turn on the Azure DNS Analytics https://docs.microsoft.com/en-us/azure/azure-monitor/insights/dns-analytics
4. Inside Azure DNS Analytics, change one of the settings, save it - change it back if you need to, then save it again.
5. Check Azure DNS analytics to see that queries are showing in there

...
1. Design your Azure Sentinel workspace. Consider issues such as whether you'll use a single tenant or multiple tenants, any compliance requirements for data collection and storage, 

...
Starting in **July 2026**, Microsoft Sentinel will be supported in the Defender portal only, and any remaining customers using the Azure portal will be automatically redirected. [Microsoft Sentinel APIs](/rest/api/securityinsights/) are also planned for deprecation in three years' time, in July 2028.

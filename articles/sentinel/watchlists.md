...
- Watchlists must adhere to the same column and table restrictions as KQL entities. For more information, see [KQL entity names](../data-explorer/kusto/query/schema-entities/entity-names).

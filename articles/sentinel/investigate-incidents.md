...
- Select **Activity log** to view actions that have been taken and comments that have been made on this incident, whether by automation or by personnel. You can add your own comments here as well.

- Struck by sudden inspiration? Select **Logs** at any time to open a full, blank Log analytics query window *inside* the incident page. Compose and run a query, related or not, without leaving the incident.

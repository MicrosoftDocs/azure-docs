...
- **Info** contains basic information about the entity. For example, for a user account entity this might be things like the username, domain name, security identifier (SID), organizational information, security information, and for an IP address it would include geolocation, resolved hosts, time last observed, and others.

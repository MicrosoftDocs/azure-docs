...
| **SrcGeoLongtitude**|Optional |Longtitude <!--this originally read "Latitude" --> | Example: `-73.614830` <br><br>For more information, see [Logical types](normalization.md#logical-types).|
...
| **TargetAppType**|Optional |String |The type of the application authorizing on behalf of the Actor. Possible values include: <br>- `Process` <br>- `Service` <br>- `Resource` <br>- `URL` <br>- `Other`|
...
|**TargetDvcType** |Optional | Enumerated|The type of the target device. Possible values include: <br><br>- `Computer`<br>- `Mobile Device` <br>- `IOT Device` <br>- `Other` |

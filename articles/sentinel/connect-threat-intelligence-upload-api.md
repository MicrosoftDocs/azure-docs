...
1. Submit the indicators to the Microsoft Sentinel upload API endpoint. To learn more about the upload indicators API, see the reference document [Microsoft Sentinel upload indicators API](upload-indicators-api.md). 

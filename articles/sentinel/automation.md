...
|**Creating a new playbook** | When creating a new playbook in the unified SOC platform, you're redirected to a new tab to create a logic app in the Azure portal. |

...
| **Infoblox NIOS**<br><br>Note that the InfoBlox parsers<br>require [configuring the relevant sources](normalization-managing-parsers.md).<br> Use `InfobloxNIOS` as the source type. | `_ASim_DnsInfobloxNIOS` (regular)<br> `_Im_DnsInfobloxNIOS` (filtering) | `ASimDnsInfobloxNIOS` (regular)<br> `vimDnsInfobloxNIOS` (filtering) |
...
| **SrcProcessGuid**              | Optional     | String     |  A generated unique identifier (GUID) of the process initiating the DNS request.   <br><br> Example: `EF3BD0BD-2B74-60C5-AF5C-010000001E00`            |

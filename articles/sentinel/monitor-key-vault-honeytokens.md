...
- **Required data connectors**: Make sure that you've deployed the [Azure Key Vault](data-connectors/azure-key-vault.md) and the [Azure Activity](data-connectors/azure-activity.md) data connectors in your workspace, and that they're connected.

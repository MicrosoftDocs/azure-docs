...
|-|-|
|**Automation rules**|<ul><li>Can apply to several analytics rules.</li><li>Exceptions will automatically close new incidents that are created, maintaining an audit trail.</li><li>Are often generated by analysts.</li><li>Allow applying exceptions for a limited time. For example, maintenance work might trigger false positives that outside the maintenance timeframe would be true incidents.</li></ul>|

...
- For [analytics rules](monitor-analytics-rule-health.md)
...
| **[Analytics rules](monitor-analytics-rule-health.md)** | Scheduled analytics rule run<br>NRT analytics rule run | Success<br>Failure |
...
Extended properties for analytics rules reflect the [rule settings](detect-threats-custom.md).
...
| **CorrelationId**         | String         | The event correlation ID.                                     |
...
| **QueryPerformanceIndicators** | String    | The .                                   |

...
To ensure comprehensive, uninterrupted, and tampering-free threat detection in your Microsoft Sentinel service, keep track of your analytics rules' health and integrity and keep them functioning optimally, by monitoring their [execution insights](monitor-troubleshoot-analytics-rule-execution.md#view-analytics-rule-insights), by querying the health and audit logs, and by [using manual rerun to test and troubleshoot your rules](monitor-troubleshoot-analytics-rule-execution.md#use-cases-and-benefits-of-rule-rerun).
...
For information on rule insights and manual rerunning of rules, see [Monitor and troubleshoot the execution of your scheduled analytics rules](monitor-troubleshoot-analytics-rule-execution.md).
...
- [Monitor and troubleshoot analytics rule execution in Microsoft Sentinel](monitor-troubleshoot-analytics-rule-execution.md).

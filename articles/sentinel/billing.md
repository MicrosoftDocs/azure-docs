...
- **Data lake ingestion** charges are applied per GB of data ingested into tables configured for data lake tier retention only. No data lake ingestion charges apply when retention settings include both the analytic and data lake tiers.
- **Data processing** charges are applied per GB for all data as it ingests into the data lake and enables a broad array of transformations including redaction, splitting, filtering, and normalizing data. No data lake processing charges apply when retention settings include both the analytic and data lake tiers.

...
| **dvcaction** | dynamic | filter only the network sessions for which the [Device Action field](normalization-about-schemas.md#dvcaction) is any of the values listed. | 

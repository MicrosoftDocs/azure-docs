...
![image1](images/flowlogs-step-1.png)

3. Select **Create stack** → **With new resources (standard)**.

![image2](images/flowlogs-step-2.png)
...
![image3](images/flowlogs-step-3.png)
...
![image2](images/flowlogs-step-4.png)  
![image3](images/flowlogs-step-5.png)

After filling all required fields, click **Next**.

![image4](images/flowlogs-step-6.png)
...
![image5](images/flowlogs-step-7.png)
...
![image6](images/flowlogs-step-8.png)  
![image7](images/flowlogs-step-9.png)
...
![image10](images/flowlogs-step-12.png)

2. In the left pane, select **Your VPCs**.

![image11](images/flowlogs-step-13.png)

3. Select the VPC for which you want to enable Flow Logs and open its details.

![image12](images/flowlogs-step-14.png)

4. Navigate to the **Flow logs** tab.

![image13](images/flowlogs-step-15.png)

5. Click **Create flow log**.

![image14](images/flowlogs-step-16.png)
...
![image15](images/flowlogs-step-17.png)

   - **Partition logs by time**: Choose **Every 1 hour** or **Every 24 hours** (recommended: **Every 1 hour**).  
   - Leave all other settings at their default values.

![image16](images/flowlogs-step-18.png)  
![image17](images/flowlogs-step-19.png)

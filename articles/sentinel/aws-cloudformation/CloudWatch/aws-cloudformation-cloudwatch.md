---
title: Deploy AWS CloudWatch log collection for Microsoft Sentinel with CloudFormation
description: Use an AWS CloudFormation stack to export AWS CloudWatch logs to S3 and ingest them into Microsoft Sentinel with the AWS S3 connector.
author: KanenasCS
ms.author: bagol
...
# Deploy AWS CloudWatch log collection for Microsoft Sentinel with CloudFormation

...
The following playbooks are deployed to your Microsoft Sentinel workspace as part of the [IoT OT Threat Monitoring with Defender for IoT](#install-the-defender-for-iot-solution) solution.

###  Automatically close incidents

**Playbook name**: AD4IoT-AutoCloseIncidents

In some cases, maintenance activities generate alerts in Microsoft Sentinel that can distract a SOC team from handling the real problems. Use this playbook to automatically close incidents created from such alerts during a specified maintenance period.
...
> [!NOTE]
> The playbook explicitly parses the IoT device entity fields.
>

For more information, see <xref to AD4IoT-AutoCloseIncidents>.

### Mail by production line

**Playbook name**: 
|Playbook name  |Description  |
|---------|---------|
|**AD4IoT-AutoCloseIncidents**     |  Automatically close incidents. <br><br>      |

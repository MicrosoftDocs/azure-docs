...
1. Add the **Security Admin** role to the Azure subscription where the playbook is installed:
...
1. Ensure that you have valid connections for each of your connection steps in the playbook:
    ...
    1. Select a **Connections** step to expand it and add a valid connection.

1. Add a new Microsoft Sentinel automation to connect your incidents, relevant analytics rules, and the **AD4IoT-AutoAlertStatusSync** playbook.

    Define your analytics rule as follows:

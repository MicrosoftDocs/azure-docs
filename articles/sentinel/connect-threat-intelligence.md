...
- Learn how to [onboard your data to Azure Sentinel](qsuickstart-onboard.md), and [get visibility into your data, and potential threats](quickstart-get-visibility.md).

...
| **Azure Purview** | [Data connector](data-connectors-reference.md#azure-purview), workbook, analytics rules <br><br>For more information, see [Tutorial: Integrate Microsoft Sentinel and Azure Purview](purview-solution.md). | TBD | Microsoft |

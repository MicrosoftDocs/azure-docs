...
Integrate threat intelligence (TI) into Azure Sentinel through the following activities:
...
### Add threat indicators to Azure Sentinel with the Threat Intelligence Platforms data connector
...
**To import threat indicators to Azure Sentinel from your integrated TIP or custom threat intelligence platform**:
...
For more information, see [Connect your threat intelligence platform to Azure Sentinel](connect-threat-intelligence-tip.md).

### Add threat indicators to Azure Sentinel with the Threat Intelligence - TAXII data connector
...
**To import STIX-formatted threat indicators to Azure Sentinel from a TAXII server**:
...
For more information, see [Connect Azure Sentinel to STIX/TAXII threat intelligence feeds](connect-threat-intelligence-taxii.md).

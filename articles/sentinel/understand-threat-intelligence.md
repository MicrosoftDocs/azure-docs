...
Bring high fidelity indicators of compromise (IOC) generated by Microsoft Defender Threat Intelligence (MDTI) into your Microsoft Sentinel workspace. There is a standard MDTI data connector and a Premium MDTI (PMDTI) version available. These data connectors allow you to ingest Microsoft threat intelligence with a simple one-click setup. Use that TI to monitor, alert and hunt in the same way you utilize other feeds.

The freely available **MDTI Threat Analytics** rule gives you a taste of what the premium MDTI data connector provides. However with matching analytics, only premium threat intelligence that matches the rule is actually ingested into your environment. With the premium MDTI data connector, you have the TI available to match against more data sources. You also have more flexibility and understanding of that threat intelligence with the premium license. Here's a table showing the additional TI to expect when you license and enable the premium MDTI data connector.

...
CTI is used by organizations to provide essential context to unusual activity so that security personnel can quickly take action to protect their people, information, and assets. CTI can be sourced from many places, such as:
...
You can use threat indicators in Microsoft Sentinel to detect malicious activity observed in your environment. Then you can provide context to security investigators to inform response decisions.
...
- **Microsoft Defender Threat Intelligence data connector**: Used to ingest Microsoft's threat indicators.
- **Premium Microsoft Defender Threat Intelligence data connector**: Used to ingest Defender Threat Intelligence's premium intelligence feed.
...
- The API request endpoint is scoped at the workspace level. The Microsoft Entra application permissions required allow granular assignment at the workspace level.
...
You can view and manage your indicators on the **Threat Intelligence** page. You can sort, filter, and search your imported threat indicators without even writing a Log Analytics query.
...
For example, you can use `GeoLocation` data to find information like the organization or country for an IP indicator. You can use `WhoIs` data to find data like registrar and record creation data from a domain indicator.
...
There's also a rich community of [Azure Monitor workbooks on GitHub](https://github.com/microsoft/Application-Insights-Workbooks) where you can download more templates and contribute your own templates.
...
In this article, you learned about the threat intelligence capabilities of Microsoft Sentinel, including the **Threat Intelligence** pane. For practical guidance on using Microsoft Sentinel's threat intelligence capabilities, see the following articles:

- Connect Microsoft Sentinel to [STIX/TAXII threat intelligence feeds](./connect-threat-intelligence-taxii.md).
- [Connect threat intelligence platforms](./connect-threat-intelligence-tip.md) to Microsoft Sentinel.
- See which [TIP platforms, TAXII feeds, and enrichments](threat-intelligence-integration.md) you can readily integrate with Microsoft Sentinel.

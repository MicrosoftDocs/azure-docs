...
| Dataverse - Unusual sign-in following disabled IP address-based cookie binding protection | Identifies previously unseen IP and user agents in a Dataverse instance following disabling of cookie binding protection. For more information, see [Safeguarding Dataverse sessions with IP cookie binding](/power-platform/admin/block-cookie-replay-attack). |    |    |

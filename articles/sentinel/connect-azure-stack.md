...
For further information on installing and configuring the agent for Windows, see [Connect Windows computers](..azure/azure-monitor/platform/agent-windows#install-the-agent-using-setup-wizard.md).

For Linux troubleshooting of agent issues, see [Troubleshoot Azure Log Analytics Linux Agent](..azure/azure-monitor/platform/agent-linux-troubleshoot.md).

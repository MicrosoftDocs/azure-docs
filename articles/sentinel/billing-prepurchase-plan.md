...
Think of the prepurchase plan as a pool of credits, called commit units (CUs), where CUs are equivalent to your purchase currency value. So, in US dollars (USD), 1 CU = $1 USD. 

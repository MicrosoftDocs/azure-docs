---
title: Collecting CEF data in Azure Sentinel | Microsoft Docs
...
> - Azure Sentinel takes advantage of the native integration between **Barracuda** and Microsoft Azure OMS. To connect to a Barracuda appliance there is no need to install an agent. This connection is performed in a single click after you select the Barracuda tile in the Data collection gallery.
   ...
   1. In the **Direct agent** screen that opens, select **Agent for Linux** to download the agent or run this command to download it on your Linux machine:
    ...
    7. If your appliance is one of these, follow these additional steps:
        - Cisco - Run these commands:
            ...
            > [!NOTE] 
            > If you use Cisco ASA, it is not necessary to use CEF, because it has been natively integrated with Azure Sentinel.

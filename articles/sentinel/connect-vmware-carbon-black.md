...
---
# Connect your VMware Carbon Black to Azure Sentinel with Azure Function
...
## Configure and connect VMware Carbon Black

Azure Functions can integrate and pull events and logs directly from VMware Carbon Black and forward them to Azure Sentinel.
...
## Next steps
In this document, you learned how to connect VMware Carbon Black to Azure Sentinel using Azure Function Apps. To learn more about Azure Sentinel, see the following articles:

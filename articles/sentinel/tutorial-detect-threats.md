---
title: Investigate threats using custom rules with Azure Sentinel Preview| Microsoft Docs
description: Use this tutorial to learn how to investigate alerts with Azure Sentinel's custom rules.
services: sentinel
...
---
# Tutorial: Detect threats using custom rules

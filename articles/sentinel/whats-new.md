...
For more information, see [Create a new watchlist using a template](watchlists-create.md#create-a-new-watchlist-by-using-a-template-public-preview) and [Built-in watchlist schemas](watchlist-schemas.md).

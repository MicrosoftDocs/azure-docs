...
You've already been able to use the **alert details** feature to override these four default properties of alerts; now there are **nine more alert properties** that support this feature.

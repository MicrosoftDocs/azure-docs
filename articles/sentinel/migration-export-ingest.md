...
1. [Create an App registration to authenticate against the API](../azure-monitor/logs/tutorial-data-ingestion-portal.md#configure-application).
1. [Create a data collection endpoint](../azure-monitor/logs/tutorial-data-ingestion-portal.md#create-data-collection-endpoint). This endpoint acts as the API endpoint that accepts the data.
1. [Create a custom log table](../azure-monitor/logs/tutorial-data-ingestion-portal.md#add-custom-log-table) to store the data, and provide a data sample. In this step, you can also define a transformation before the data is ingested.
1. [Collect information from the data collection rule](../azure-monitor/logs/tutorial-data-ingestion-portal.md#collect-information-from-dcr) and assign permissions to the rule.

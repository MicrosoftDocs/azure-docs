...
You can manage access for students based on the domain they use to log into Azure Dev Tools for Teaching. Go into your [Management Portal](https://azureforeducation.microsoft.com/en-us/account/Subscriptions) for Azure Dev Tools for	Teaching. There, you will see all of your subscriptions. Choose the subscription you wish to manage access for.

...
> [!WARNING]
> If you choose to create a *new* service principal, it's better waiting around 30 minutes for service principal permission propagating accross all regions, and updating a large AKS cluster to use these credentials may take a long time to complete.

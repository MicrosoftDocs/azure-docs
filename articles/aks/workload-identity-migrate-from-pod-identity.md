---
title: Migrate from Pod Identity to Workload Identity
description: In this Azure Kubernetes Service (AKS) article, you learn how to migrate from Pod Identity to Workload Identity.

...
For more information about how to secure Kubernetes clusters with RBAC, see [Access and identity options for AKS)][rbac-authorization].

For best practices, see [][operator-best-practices-identity].

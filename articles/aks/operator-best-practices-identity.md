...
description: Learn the cluster operator best practices for how to manage access and identity for clusters in Azure Kubernetes Service (AKS)
...
This best practices article focuses on how a cluster operator can manage access and identity for AKS clusters. In this article, you learn:

> [!div class="checklist"]
> * How to authenticate AKS cluster users with Azure Active Directory
> * Ways to control access to resources with role-based access controls (RBAC)
> * How pods can use a managed identity to authenticate themselves with other services

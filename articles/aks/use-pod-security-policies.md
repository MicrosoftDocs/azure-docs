...
This article assumes that you have an existing AKS cluster. If you need an AKS cluster, see the AKS quickstart [using the Azure CLI][./learn/quick-kubernetes-deploy-cli] or [using the Azure portal][./learn/quick-kubernetes-deploy-quickstart-portal].

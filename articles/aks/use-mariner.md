...
[mariner-node-pool]: [use-multiple-node-pools.md](https://learn.microsoft.com/azure/aks/use-multiple-node-pools#add-a-mariner-node-pool)
[ubuntu-to-mariner]: [use-multiple-node-pools.md](https://learn.microsoft.com/azure/aks/use-multiple-node-pools#migrate-ubuntu-nodes-to-mariner)

...
:::image type="content" source="./media/release-tracker/regional-status.png" alt-text="The AKS release tracker's regional status table is displayed in a web browser.":::
...
:::image type="content" source="./media/release-tracker/sdp-process.png" alt-text="The AKS release tracker's SDP process table is displayed in a web browser.":::

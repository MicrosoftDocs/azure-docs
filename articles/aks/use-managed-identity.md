...
```
> [!NOTE]
> Once the System Assigned and User Assigned identities have been updated to managed identity, perform a az nodepool upgrade --node-image-only on your nodes to complete the update to managed identity.

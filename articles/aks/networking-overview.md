...
| Docker bridge address | IP address (in CIDR notation) used as the bridge ip address for VMs. Only needed if the default range is in-use in the VNet (172.17.0.1/16). |

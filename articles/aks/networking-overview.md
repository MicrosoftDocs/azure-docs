...
**Kubernetes service address range**: The *Kubernetes service address range* is the IP range from which addresses are assigned to Kubernetes services in your cluster. This is the set of virtual IPs that Kubernetes assigns to the services in your cluster. You can use any private address range that satisfies the following requirements:

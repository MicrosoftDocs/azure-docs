...
> [!Note]
> When you use proximity placement groups with AKS, you only improve the node to node and, therefore, pod to pod latency. There is no impact on the AKS control plane network traffic to the underlying nodes.

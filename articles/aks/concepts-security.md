...
For associated best practices, see [Best practices for cluster security and upgrades in AKS][operator-best-practices-cluster-security] and and [Best practices for pod security in AKS][developer-best-practices-pod-security].

...
AKS clusters are deployed on host VMs, which run a security-optimized OS used for containers running on AKS. This host OS is based on an **Ubuntu 18.04.LTS** image with more [security hardening](#security-hardening-features) and optimizations applied.

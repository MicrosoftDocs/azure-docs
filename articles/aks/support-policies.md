...
The only supported way to stop/de-allocate all node is to [stop the aks cluster](start-stop-cluster.md#stop-an-aks-cluster), which will preserve the cluster state for up to 12 months.

...
> [!NOTE]
> Currently, AKS doesn't allow you to completely lock down egress traffic from your cluster. To control the list of URLs and ports you cluster can use for outbound traffic see  [limit egress traffic](limit-egress-traffic.md).

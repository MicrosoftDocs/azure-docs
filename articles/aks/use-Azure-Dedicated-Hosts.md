...
In this example, we will use [az vm host group create](https://docs.microsoft.com/cli/azure/vm/host/group?view=azure-cli-latest#az_vm_host_group_create&preserve-view=true) to create a host group using both availability zones and fault domains.

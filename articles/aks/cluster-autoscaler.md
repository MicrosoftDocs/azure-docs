...
:::image type="content" source="media/autoscaler/cluster-autoscaler.png" alt-text="The cluster autoscaler and horizontal pod autoscaler often work together to support the required application demands":::

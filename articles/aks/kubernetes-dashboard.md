...
> [!WARNING]
> **The AKS dashboard add-on is now deprecated for versions 1.19+. Please use the [Kubernetes resource view in the Azure portal (preview)][kubernetes-portal] instead.** 

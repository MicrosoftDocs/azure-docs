...
> application.
>
> The open source Azure AD pod-managed identity (preview) in Azure Kubernetes Service has been deprecated as of 10/24/2022 and [the projected will be archived since Sept. 2023](https://github.com/Azure/aad-pod-identity#-announcement). The AKS Managed add-on will begin deprecation since Sept. 2023.

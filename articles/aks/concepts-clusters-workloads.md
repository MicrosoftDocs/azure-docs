...
> [!IMPORTANT]
> **AKS 1.28 will not include changes** to memory reservations. These changes will be releasing with AKS 1.29, which previews in January 2024.
>
> AKS 1.29 includes certain changes to memory reservations. These changes are detailed in the following section.

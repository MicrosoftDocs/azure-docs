...
:::image type="content" source="/media/portal-01-networking-advanced.png" alt-text="Screenshot that shows the Azure portal shows an example of configuring these settings during AKS cluster creation:.":::

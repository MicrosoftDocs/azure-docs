...
This article shares different upgrade options for AKS clusters. If you want to perform a basic Kubernetes version upgrade, see [Upgrade an AKS cluster](./upgrade-aks-cluster.md).

...
You may need to request an increase for [Network quotas](https://docs.microsoft.com/azure/azure-supportability/networking-quota-requests) to ensure you don't exhaust IPs. See [networking and IP ranges for AKS](https://docs.microsoft.com/en-us/azure/aks/configure-kubenet) for additional information.

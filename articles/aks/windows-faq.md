...
To get started with Windows Server containers in AKS, see [Create a node pool that runs Windows Server in AKS](learn/quick-windows-container-deploy-cli.md].

...
This quickstart assumes a basic understanding of [cluster extensions](cluster-extensions.md).
...
* Before you deploy a cluster extension, you must register the 'Microsoft.containterService' and 'Microsoft.KubernetesConfiguration' providers on your subscription by using the 'az provider register' command 
...
The below command creates a sample Kubernetes application (published on Marketplace) on your AKS cluster:

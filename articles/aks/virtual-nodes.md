...
* Volume mounting Azure Files share support [General-purpose V1 and General-purpose V2](../storage/common/storage-account-overview.md#types-of-storage-accounts). Follow the instructions for mounting [a volume with Azure Files share](azure-files-volume.md)

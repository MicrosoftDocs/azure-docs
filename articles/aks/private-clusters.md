...
* US Gov Texas isn't currently supported due to missing Private Link support.
...
* [Availability Zones][availability-zones] are currently supported for certain regions. 

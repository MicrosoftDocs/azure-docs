...
- If the private DNS zone is located on a different subscription when specifying --private-dns-zone argument. Microsoft.ContainerService should be registered on both subscriptions.

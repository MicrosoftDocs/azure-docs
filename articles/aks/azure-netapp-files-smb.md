...
Azure NetApp Files supports both the NFS and the SMB protocol types. This article describes details about provisioning the volumes for SMB, both statically and dynamically. For information about provisioning NFS volumes statically and dynamically, see [Provision Azure NetApp Files NFS volumes for Azure Kubernetes Service](azure-netapp-files-nfs.md).    

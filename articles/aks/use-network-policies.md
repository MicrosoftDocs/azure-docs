...
Azure Network Policy Manager for Linux supports scaling up to 250 nodes and 20k pods. If you attempt to scale beyond these supported limits, you may encounter Out of Memory (OOM) kills. To increaes your memory limit, contact us on [aks-acn-gitub].

...
This process takes several minutes to complete. You should not experience any downtime while your cluster tier is being upgraded. When finished, the following example JSON snippet shows updating the existing cluster to the Standard tier in the Base SKU.

...
- If you use [Azure Active Directory pod identity][aad-pod-identity], you must deploy this [Custom Resource Definition (CRD) exception][aad-pod-identity-exception] to prevent authentication issues.

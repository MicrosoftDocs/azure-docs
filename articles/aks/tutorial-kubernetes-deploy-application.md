...
Replace *microsoft* with your ACR login server name. The image name is found on line 57 of the manifest file. The following example shows the default image name:

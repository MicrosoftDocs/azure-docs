...
Replace `microsoft` with the ACR login server name. This value is found on line **47** of the manifest file. Use the FQDN of the ACR login server name (<yourname>.azurecr.io), otherwise the deployment of the frontend pod will fail.

...
The default storage classes cater to the most common scenarios but not all. For some cases you might want to have your own storage class customized with you own parameters. To exemplify we'll use an example where you might want to config the `mountOptions` of the file share.

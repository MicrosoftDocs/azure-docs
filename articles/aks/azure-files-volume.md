...
> Note: secret namespace in inline `azureFile` volume can only be set as pod namespace, to specify a different secret namespace, please use below persistent volume example instead.

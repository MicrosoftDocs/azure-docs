...
- [Local-gadget]([https://inspektor-gadget.io/docs/v0.18.1](https://inspektor-gadget.io/docs/v0.21.0)): Uses in-kernel eBPF helper programs to monitor events related to syscalls from userspace programs in a pod.

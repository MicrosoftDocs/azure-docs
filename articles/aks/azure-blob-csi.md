...
- To learn how to set up a static or dynamic persistent volume, see [Create and use a volume with Azure Blob storage][azure-csi-blob-storage].
...
[azure-csi-blob-storage]: azure-csi-blob-storage.md

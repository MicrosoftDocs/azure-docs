---
title: 'Azure CLI: Create a DocumentDB account and collection | Microsoft Docs'
...
*Content shown below is SQL DB CLI quickstart - needs to be replaced with DocDB CLI quickstart*

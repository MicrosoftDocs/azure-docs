...
If your application exceeds your reserved throughput for one or multiple collections, requests will be limited on a per collection basis. This means that some application requests may succeed while others may be throttled.

...
To use Microsoft Azure DocumentDB, you must create a DocumentDB database account by using the Azure Portal. 
...
- The Portal, as described in [Create a DocumentDB database using the Azure Portal](documentdb-create-database.md).

...
description: Learn about the Azure Cosmos's document data model. This document database is built for big data, elastic scalability, and high availability.
...
---
# Azure Cosmos DB: What is the DocumentDB API?

As a schema-free NoSQL database, Azure Cosmos DB provides rich and familiar SQL query capabilities with consistent low latencies on JSON data - ensuring that 99% of your reads are served under 10 milliseconds and 99% of your writes are served under 15 milliseconds. These unique benefits make DocumentDB a great fit for web, mobile, gaming, and IoT, and many other applications that need seamless scale and global replication.

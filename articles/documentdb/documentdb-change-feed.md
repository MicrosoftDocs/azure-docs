...
* Each change to a document will appear only once in the change feed. Only the most recent change for a given document will be included in the change log. Intermediate changes may not be available.

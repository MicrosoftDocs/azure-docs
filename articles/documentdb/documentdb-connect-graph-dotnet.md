---
title: Connect Azure DocumentDB to graph using .NET (C#) | Microsoft Docs
...
---
# Azure DocumentDB: Connect to graph using .NET
This article provides an overview of how to work with graph APIs in Azure DocumentDB using .NET. In this article, we cover:

* Setting up your development environment with DocumentDB graph APIs
...
For example, the following snippet shows a GraphSON representation of a vertex in DocumentDB. 

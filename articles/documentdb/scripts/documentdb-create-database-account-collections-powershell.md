---
title: Azure PowerShell Script-Create a DocumentDB account, database and collection | Microsoft Docs
description: Azure PowerShell Script Sample - Create a DocumentDB account, database and collection
services: documentdb
...
# Create a Document API account, database, and collection using PowerShell

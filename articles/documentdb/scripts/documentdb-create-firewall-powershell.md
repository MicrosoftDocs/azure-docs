---
title: Azure CLI Script-Create a firewall for DocumentDB | Microsoft Docs
description: Azure CLI Script Sample - Create a firewall for DocumentDB
services: documentdb
...
# Create a firewall for DocumentDB using the Azure CLI

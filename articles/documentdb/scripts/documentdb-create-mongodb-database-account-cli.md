---
title: Azure CLI Script-Create a DocumentDB MongoDB account, database and collection | Microsoft Docs
description: Azure CLI Script Sample - Create a DocumentDB MongoDB account, database and collection
services: documentdb

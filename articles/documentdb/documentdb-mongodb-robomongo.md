...
---
# Use Robomongo with a Cosmos DB: API for MongoDB account
...
1. Retrieve your Cosmos DB: API for MongoDB account connection information using the instructions [here](documentdb-connect-mongodb-account.md).

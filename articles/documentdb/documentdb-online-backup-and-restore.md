...
description: Learn how to perform automatic backup and restore of NoSQL databases with Azure Cosmos DB.
...
## Next steps
To replicate your NoSQL database in multiple data centers, see [distribute your data globally with Azure Cosmos DB](documentdb-distribute-data-globally.md). 

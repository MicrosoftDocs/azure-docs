...
Congratulations. You have completed the solution and have a mobile app with Xamarin and DocumentDB. Follow similar steps to build Cordova apps using the DocumentDB JavaScript SDK and native iOS/Android apps using DocumentDB REST APIs.

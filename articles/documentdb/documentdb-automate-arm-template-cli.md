...
![Screenshot showing the device login screen for Microsoft Azure CLI](media/documentdb-automate-arm-template-cli/azure-cli-login-code.png)

Once you've entered the code, select the identity you want to use in the browser.

![Screenshot showing where to select the Microsoft identity account associated with the Azure subscription you want to use](media/documentdb-automate-arm-template-cli/identity-cli-login.png)


![Screenshot showing confirmation of login to the Windows Azure Cross-platform Command Line Interface](media/documentdb-automate-arm-template-cli/login-confirmation.png)

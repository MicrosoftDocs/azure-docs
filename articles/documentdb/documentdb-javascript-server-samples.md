<properties 
	pageTitle="JavaScript server-side samples for DocumentDB | Microsoft Azure" 
	description="Find JavaScript server-side samples for common tasks in DocumentDB, including CRUD operations for database accounts, databases, and collections." 
	services="documentdb" 
	authors="mimig1" 
	manager="jhubbard" 
	editor="monicar" 

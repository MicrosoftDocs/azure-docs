...
- Step 1: Start the Windows Certificate manager by running certlm.msc and navigate to to the Personal->Certificates folder and open the certificate with the friendly name "DocumentDBEmulatorCertificate".

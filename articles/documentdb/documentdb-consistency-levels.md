<properties 
	pageTitle="Data consistency levels in DocumentDB | Microsoft Azure" 
	description="Review how DocumentDB has four data consistency levels with associated performance levels to help balance eventual consistency, availability, and latency trade-offs." 
	keywords="data consistency, eventual consistency, documentdb, azure, Microsoft azure"
	services="documentdb" 
	authors="mimig1" 
	manager="jhubbard" 
	editor="cgronlun" 
...
## Data consistency levels for databases

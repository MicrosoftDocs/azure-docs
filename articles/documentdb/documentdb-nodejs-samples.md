...
| Task | API reference |
| --- | --- |
| Create a collection with default indexing |[DocumentClient.createCollection](http://azure.github.io/azure-documentdb-node/DocumentClient.html#createCollection) |

...
The DocumentDB .NET Core Preview SDK enables you to build fast, cross-platform [ASP.NET Core](https://www.asp.net/core) and [.NET Core](https://www.microsoft.com/net/core#windows) apps to run on Windows, Mac, and Linux, as well as create and [Universal Windows Platform (UWP)](https://www.visualstudio.com/vs/universal-windows-platform/) apps for Windows.

...
### <a id="ConsistencyLevels"></a>Multiple, well-defined consistency models
DocumentDB exposes [multiple well-defined consistency levels](documentdb-consistency-levels.md) backed by SLAs. You can choose a specific consistency model (from the available list of options) depending on the workload/scenarios. We are working on operationalizing new consistency models, validating first with the internal Microsoft applications and eventually exposing it broadly to the Azure developers. 

### <a id="TunableConsistency"></a>Tunable consistency
...
### <a id="ManualFailover"></a>Ability to manually initiate regional failover
...
### <a id="AvailabilityAndConsistency"></a>Availability's relationship with consistency
Same as [Consistency's relationship with availability](#ConsistencyAndAvailability).

### <a id="AvailabilityAndLatency"></a>Availability's relationship with latency
Same as [Latency's relationship with availability](#LatencyAndAvailability).

### <a id="AvailabilityAndThroughput"></a>Availability's relationship with throughput
Same as [Throughput's relationship with availability](#ThroughputAndAvailability).

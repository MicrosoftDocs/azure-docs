...
![Table showing sample data](./media/documentdb-tutorial-query-table/cosmosdb-query-table.png)
...
![Table showing query results](./media/documentdb-tutorial-query-table/cosmosdb-query-table.png)

## Next steps

For more information about the Table API, see [What is Azure Cosmos DB: Table API?](documentdb-table-introduction.md)

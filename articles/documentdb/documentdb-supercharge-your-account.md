...
5. In the **Settings** blade, click **Pricing Tier** and notice that the estimated monthly cost estimate for each plan is displayed. In the **Choose your pricing tier** blade, click **Standard**, and then click **Select** to save your change.
...
8. Click **OK** to save your changes. Back on the **Database** blade, you can verify the supercharged throughput of the collection. 

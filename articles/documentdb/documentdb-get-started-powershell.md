---
title: 'Azure PowerShell: Create a DocumentDB account and collection | Microsoft Docs'
...
# Create an Azure DocumentDB account and collection using PowerShell

*Content shown below is SQL DB PowerShell quickstart - needs to be replaced with DocDB PowerShell quickstart*

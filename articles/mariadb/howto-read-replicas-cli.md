...
### List replicas
You can view the list of replicas of a master server using the [replica list API](/rest/api/mariadb/replicas/listbyserver):
...
### Stop replication to a replica server
You can stop replication between a master server and a read replica by using the [update API](/rest/api/mariadb/servers/update).
...
To delete a master or replica server, you use the [delete API](/rest/api/mariadb/servers/delete):

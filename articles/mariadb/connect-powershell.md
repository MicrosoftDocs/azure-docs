...
description: This quickstart provides an Azure PowerShell example to generate a connection string for connecting to Azure Database for MariaDB.
author: ajlam
ms.author: andrela
ms.service: mariadb
...
# Azure Database for MariaDB: Generate a connection string with PowerShell

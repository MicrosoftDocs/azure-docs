...
> [!NOTE]
> This article describes the cloud application as a single entity. See [Running an N-tier architecture on Azure][implementing-a-multi-tier-architecture-on-Azure] for detailed information.
> 
> 

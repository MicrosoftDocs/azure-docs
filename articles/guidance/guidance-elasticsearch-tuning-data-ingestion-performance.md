...
is described in the [Memory requirements](guidance-elasticsearch-running-on-azure.md#memory-requirements) section of  Running Elasticsearch on Azure.
...
in the [Memory requirements](guidance-elasticsearch-running-on-azure.md#memory-requirements) section of Running Elasticsearch on Azure. 
...
> odd number of master nodes. This topic is described in more detail in [Configuring resilience and recovery on Elasticsearch on Azure][].

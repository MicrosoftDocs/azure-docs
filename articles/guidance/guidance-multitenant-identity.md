...
- [Authentication with Azure AD](guidance-multitenant-identity-authenticate.md)
...
- [Defining and managing application roles](guidance-multitenant-identity-app-roles.md)

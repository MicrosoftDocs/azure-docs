...
Learn where to find technical information about Azure Managed Grafana, get answers to your questions, or open a support ticket.
...
- [Technical documentation for Azure Managed Grafana](./index.yml): Find how-to guides, tutorials, and the Azure Managed Grafana [troubleshooting guide](troubleshoot-managed-grafana.md).
- [Microsoft Q&A](/answers/tags/249/azure-managed-grafana): Browse existing questions and answers, or ask a question about Azure Managed Grafana.
- [Microsoft Technical Community](https://techcommunity.microsoft.com/): Collaborate, share, and learn with IT professionals and customers, and browse [Grafana-related content](https://techcommunity.microsoft.com/tag/Azure%20Managed%20Grafana?nodeId=board%3AAzureObservabilityBlog).
...
1. In the **3. Additional details** tab, fill out the required details. For example:
    ...
    1. Optionally, add a screenshot or another file under **File upload**.
...
1. Select **Next**.
1. Under **4. Review + create**, check that the summary of your support ticket is accurate. Select **Create** to submit the support ticket, or select **Previous** to make corrections.

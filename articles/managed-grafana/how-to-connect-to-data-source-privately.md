...
- Azure Databricks
- Azure Database for PostgreSQL flexible servers ([Only for servers that have public access networking](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/concepts-networking-private-link))

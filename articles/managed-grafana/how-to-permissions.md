...
By default, when an Azure Managed Grafana instance is created, Managed Grafana grants it the Monitoring Reader role for all Azure Monitor data and Log Analytics resources within a subscription.
...
- An Azure Managed Grafana instance. If you don't have one yet, [create an instance](./quickstart-managed-grafana-portal.md).
...
1. Click **Select** to confirm
      ...
      :::image type="content" source="media/managed-grafana-how-to-permissions-identity.png" alt-text="Screenshot of the Azure platform selecting the instance.":::

...
description: Learn how to create a zone-redundant Managed Grafana workspace for protection against datacenter failure.
...
Azure Managed Grafana offers a zone-redundant option to protect your workspace against datacenter failure. Enabling zone redundancy for Managed Grafana lets you deploy your Managed Grafana resources across a minimum of three [Azure availability zones](../reliability/availability-zones-region-support.md) within the same Azure region.

In this how-to guide, learn how to enable zone redundancy for Azure Managed Grafana during the creation of your Managed Grafana workspace.
...
1. In the **Basics** pane, enter the following settings.
    ...
    | Name                | Enter a unique resource name. It is used as the domain name in your Managed Grafana workspace URL. | *my-grafana*        |
    ...
    Zone redundancy automatically provisions and manages a standby replica of the Managed Grafana workspace in a different availability zone within one region. There's an [additional charge](https://azure.microsoft.com/pricing/details/managed-grafana/#pricing) for this option.
...
1. Run the code below to create an Azure Managed Grafana workspace.
    ...
    | --resource-group  | Choose a resource group for your Managed Grafana workspace.       | *my-resource-group*         |

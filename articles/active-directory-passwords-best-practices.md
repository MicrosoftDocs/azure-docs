<properties 
	pageTitle="Azure Active Directory Password Management - Best Practices" 
	description="This article describes deployment and usage best practices for password management in Azure AD." 
...
2.	The user must be licensed.
 - For cloud users, the user must have either an AAD Basic or AAD Premium license assigned.
...
3.	The user must have the minimum set of authentication data defined in accordance with the current password reset policy.
 - Authentication data is considered defined if the corresponding field in the directory (see table above) contains well-formed data.
...
2.	Assign the appropriate licenses to each user to whom you’d like to offer password reset in the by going to the Licenses tab in the Azure Management portal.
...
5.	Over time, review users registering by navigating to the Reports tab and viewing the Password Reset Registration Activity report.
6.	Once a good number of users have registered, watch them use password reset by navigating to the Reports tab and viewing the Password Reset Activity report.
...
[001]: /documentation/articles/media/active-directory-passwords-best-practices/001.jpg "Image_001.jpg"
[002]: /documentation/articles/media/active-directory-passwords-best-practices/002.jpg "Image_002.jpg"
[003]: /documentation/articles/media/active-directory-passwords-best-practices/003.jpg "Image_003.jpg"
[004]: /documentation/articles/media/active-directory-passwords-best-practices/004.jpg "Image_004.jpg"
[005]: /documentation/articles/media/active-directory-passwords-best-practices/005.jpg "Image_005.jpg"
[006]: /documentation/articles/media/active-directory-passwords-best-practices/006.jpg "Image_006.jpg"

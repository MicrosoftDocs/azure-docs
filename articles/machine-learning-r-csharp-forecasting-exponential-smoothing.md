<properties pageTitle="Forecasting-Exponential Smoothing | Azure" description="Web service: Forecasting-Exponential Smoothing" services="machine-learning" documentationCenter="" authors="jaymathe" manager="paulettm" editor="cgronlun"/>

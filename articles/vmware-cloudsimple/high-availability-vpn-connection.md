...
2. [Configure a Site-to-Site VPN gateway](vpn-gateway.md/#set-up-a-vpn-gateway-for-Site-to-Site-connection) between your on-premises network and your CloudSimple Private Cloud.
...
Create a tunnel group under the IPsec attributes. Configure the peer IP address and the tunnel pre-shared key, which you set when [configuring your Site-to-Site VPN gateway](vpn-gateway/#set-up-a-vpn-gateway-for-Site-to-Site-connection).

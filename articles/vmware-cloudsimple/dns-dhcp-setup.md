--- 
title: Set up workload DNS and DHCP for Private Cloud
...
<a href="https://www.digitalocean.com/community/tutorials/how-to-configure-bind-as-a-private-network-dns-server-on-centos-7" target="_blank">Example setup from DigitalOcean</a>

### Windows-based setup
These Microsoft topics describe how to set up a Windows server as a DNS server and as a DHCP server.

* <a href="https://docs.microsoft.com/en-us/windows-server/networking/dns/dns-top" target="_blank">Windows Server as DNS Server</a>
* <a href="https://docs.microsoft.com/en-us/windows-server/networking/technologies/dhcp/dhcp-top" target="_blank">Windows Server as DHCP Server</a>

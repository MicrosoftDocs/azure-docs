--- 
title: Migrate workload VMs to Private Cloud 
...
* [Site-to-Site VPN connection](vpn-gateway/#set-up-Site-to-Site-vpn-communication) between your on-premises environment and your Private Cloud.
...
[Migrate workloads using Layer 2 stretched networks](migration-layer2-vpn) describes how to use a Layer 2 VPN to stretch a Layer 2 network from your on-premises environment to your Private Cloud.
...
* [Back up workload virtual machines on CloudSimple Private Cloud using Veeam B&R](backup-workloads-veeam)
* [Set up CloudSimple Private Cloud as a disaster recovery site for on-premises VMware workloads](disaster-recovery-zerto)

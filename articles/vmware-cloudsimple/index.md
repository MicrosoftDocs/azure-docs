...
description: Documentation portal for Azure VMware Solutions (AVS). 
author: sharaths-cs
ms.author: b-mashar 
ms.date: 08/20/2019 
ms.topic: article 
...
manager: dikamath 
---
# Azure VMware Solution by AVS

Welcome to the one-stop portal for help with Azure VMware Solution by AVS.
In the documentation site you can learn about the following topics:

## Overview

Learn more about Azure VMware Solutions (AVS)

* Learn about the features, benefits, and usage scenarios at [What is Azure VMware Solution by AVS](cloudsimple-vmware-solutions-overview.md)
...
* Learn how to create a new VMware environment at [Configure an AVS Private Cloud Environment](quickstart-create-private-cloud.md)
...
* An [AVS Service](cloudsimple-service.md) (also known as "Azure VMware Solutions (AVS) - Service"). This resource must be created once per region.
* Purchase capacity for your environment by creating one or more [AVS Node](cloudsimple-node.md) resources. These resources are also referred to as "Azure VMware Solution by AVS - Node".
* Initialize and configure your VMware environment using the [AVS Private Clouds](cloudsimple-private-cloud.md).
* Unify management using [AVS Virtual Machines](cloudsimple-virtual-machines.md) (also known as "Azure VMware Solutions (AVS) - Virtual machine").
...
* [Create an AVS Service](create-cloudsimple-service.md), once per region where you want to deploy VMware environments.
* Manage core service functionality in the [AVS portal](access-cloudsimple-portal.md).
* Enable capacity and optimize billing for your infrastructure by [Purchasing AVS nodes](create-nodes.md).
* Manage VMware environment configurations using AVS Private Clouds. You can [create](create-private-cloud.md), [manage](manage-private-cloud.md), [expand](expand-private-cloud.md), or [shrink](shrink-private-cloud.md) AVS Private Clouds.
...
* View [users](users.md) that have accessed the AVS portal.

...
* For more about using the xplat-cli to work with resources in arm mode, see [Using the Azure Cross-Platform Command-Line Interface with the Resource Manager](xplat-cli-azure-resource-manager.md) and [Managing Role-Based Access Control with the Cross-Platform Command-Line Interface](role-based-access-control-xplat-cli.md).

...
### SQL Database limits
For SQL Database limits, see SQL Database resource limits for [single databases](sql-database/sql-database-vcore-resource-limits-single-databases.md), [elastic pools and pooled databases](sql-database/sql-database-vcore-resource-limits-elastic-pools.md), and [managed instances](sql-database/sql-database-managed-instance-resource-limits.md).

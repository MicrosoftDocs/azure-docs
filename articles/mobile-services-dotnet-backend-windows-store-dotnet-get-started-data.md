<properties pageTitle="Get started with data (Windows Store) | Mobile Dev Center" description="Learn how to get started using Mobile Services to leverage data in your Windows Store app." services="mobile-services" documentationCenter="windows" authors="wesmc7777" manager="dwrede" editor=""/>
...
<div class="dev-center-tutorial-subselector">
	...
	<a href="/en-us/documentation/articles/mobile-services-windows-store-dotnet-get-started-data/" title="JavaScript backend">JavaScript backend</a>
</div>
...
>[AZURE.NOTE]This topic shows you how to add Azure Mobile Services to a Windows Store project. You can use Visual Studio 2013 tools to add the same .NET backend mobile service to a universal Windows app project. For more information, see the [universal Windows app version](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-universal-dotnet-get-started-data) of this tutorial.
...
* An active Azure account. If you don't have an account, you can create a free trial account in just a couple of minutes. For details, see [Azure Free Trial](http://azure.microsoft.com/en-us/pricing/free-trial/?WT.mc_id=A0E0E5C02&amp;returnurl=http%3A%2F%2Fazure.microsoft.com%2Fen-us%2Fdocumentation%2Farticles%2Fmobile-services-dotnet-backend-windows-store-dotnet-get-started-data%2F).
...
##<a name="download-the-service-locally"></a>Download the mobile service project and add it to the solution
...
#<a name="update-app"></a>Update the Windows Store app to use the mobile service
...
##<a name="test-locally-hosted"></a>Test the Windows Store app with the service hosted locally
...
3. Enter some new todoitems and click **Save** for each one. Click the checkbox to complete some of the new items. Each new todoItem will be stored and updated in the SQL database you previously configured for your mobile service in the Azure Management Portal. 
    ...
    You can restart the app to see that the changes were persisted to the database in Azure. 

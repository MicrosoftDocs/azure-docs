...
##Update the Windows Store app to use the mobile service
...
##Test the Windows Store app with the service hosted locally
...
##Test the mobile service published to Azure

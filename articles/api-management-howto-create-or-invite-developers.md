<properties pageTitle="How manage developer accounts in Azure API Management" description="Learn how to create or invite developers in Azure API Management" services="api-management" documentationCenter="" authors="steved0x" manager="dwrede" editor=""/>

...
-   [**Endpoint** ACLs](./virtual-machines/virtual-machines-windows-classic-set-up-endpoints.md). You can control which machines are allowed inbound connections from the Internet to a virtual machine on your Azure Virtual Network by defining endpoint ACLs.

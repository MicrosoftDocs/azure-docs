<properties 
   ...
   description="Create and manage a SQL Database elastic pool using PowerShell" 
...
This article shows you how to create and manage an elastic pool using PowerShell.

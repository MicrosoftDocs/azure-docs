...
* An ID document. You can use our [sample ID document](https://github.com/MicrosoftDocs/azure-docs/blob/master/articles/applied-ai-services/form-recognizer/media/id-license.jpg).

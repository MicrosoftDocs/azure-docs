---
title: Add-on meters - Form Recognizer
titleSuffix: Azure Applied AI Services
description: How to add on meters to increase service limit capacity
author: jaep3347
manager: nitinme
...
# Azure Form Recognizer Add-On Meter

**This article applies to:** ![Form Recognizer v3.0 checkmark](media/yes-icon.png) **Form Recognizer v3.0**.

> [!NOTE]
>
> Add-on meters for Form Recognizer Studio are only available within the Read and Layout public preview (`2023-03-06`) release models.
>

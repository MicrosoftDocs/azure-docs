...
When you are done, you will have an environment thal looks like this
...
When securing resources in a virtual network, adding private endpoints will ensure both the storage account and the Form Recognizer resource are only accessible from the virtual network.

...
* If you are training a custom model, your assembled set of training documents **must** be uploaded to an Azure blob storage container. You can grant permission to your training resources with a user delegation SAS token.
...
Go to the [Azure portal](https://ms.portal.azure.com/#home) and navigate as follows:  **Your storage account** → **containers** → **your container**

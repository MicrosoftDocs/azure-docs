...
|**Mixed-type documents or forms with fields and values not covered by pre-trained models.**| You want to extract key-value pairs and selection marks. | Your document set is a mix of structured, semi-structured, and unstructured documents.| <ul><li>Use the [**Custom neural model**](concept-custom-neural.md).</li></ul>|

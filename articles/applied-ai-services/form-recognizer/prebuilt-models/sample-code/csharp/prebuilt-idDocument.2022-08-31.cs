...
namespace FormRecognizerSample
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var document in result.Documents)
            {
                switch (document.DocType)
                {
                    ...
                    case "idDocument.nationalIdentityCard": ProcessIdDocument_NationalIdentityCard(document); break;
                    case "idDocument.residencePermit": ProcessIdDocument_ResidencePermit(document); break;
                    case "idDocument.usSocialSecurityCard": ProcessIdDocument_UsSocialSecurityCard(document); break;
                    case "idDocument": ProcessIdDocument(document); break;
                }
            }
        }
        ...
        static void ProcessIdDocument_DriverLicense(AnalyzedDocument document)
        {
            ...
            {
                Console.WriteLine($"  Address: Value={addressField.AsAddress()}   Confidence={addressField.Confidence}");
            }
        ...
        static void ProcessIdDocument_Passport(AnalyzedDocument document)
        {
            ...
            if (document.Fields.TryGetValue("MiddleName", out DocumentField? middleNameField))
            {
                Console.WriteLine($"  MiddleName: Value={middleNameField.AsString()}   Confidence={middleNameField.Confidence}");
            }
            if (document.Fields.TryGetValue("LastName", out DocumentField? lastNameField))
            {
                Console.WriteLine($"  LastName: Value={lastNameField.AsString()}   Confidence={lastNameField.Confidence}");
            }
            if (document.Fields.TryGetValue("Aliases", out DocumentField? aliasesField))
            {
                var index = 0;
                foreach (var item in aliasesField.AsList())
                {
                    Console.WriteLine($"  Aliases[{index}]: Value={item.AsString()}   Confidence={item.Confidence}");
                    index++;
                }
            }
            if (document.Fields.TryGetValue("DateOfBirth", out DocumentField? dateOfBirthField))
            ...
            if (document.Fields.TryGetValue("DocumentType", out DocumentField? documentTypeField))
            {
                Console.WriteLine($"  DocumentType: Value={documentTypeField.AsString()}   Confidence={documentTypeField.Confidence}");
            }
            if (document.Fields.TryGetValue("Nationality", out DocumentField? nationalityField))
            {
                Console.WriteLine($"  Nationality: Value={nationalityField.AsCountryRegion()}   Confidence={nationalityField.Confidence}");
            }
            if (document.Fields.TryGetValue("PlaceOfBirth", out DocumentField? placeOfBirthField))
            {
                Console.WriteLine($"  PlaceOfBirth: Value={placeOfBirthField.AsString()}   Confidence={placeOfBirthField.Confidence}");
            }
            if (document.Fields.TryGetValue("PlaceOfIssue", out DocumentField? placeOfIssueField))
            {
                Console.WriteLine($"  PlaceOfIssue: Value={placeOfIssueField.AsString()}   Confidence={placeOfIssueField.Confidence}");
            }
            if (document.Fields.TryGetValue("IssuingAuthority", out DocumentField? issuingAuthorityField))
            {
                Console.WriteLine($"  IssuingAuthority: Value={issuingAuthorityField.AsString()}   Confidence={issuingAuthorityField.Confidence}");
            }
            if (document.Fields.TryGetValue("PersonalNumber", out DocumentField? personalNumberField))
            {
                Console.WriteLine($"  PersonalNumber: Value={personalNumberField.AsString()}   Confidence={personalNumberField.Confidence}");
            }
        ...
        static void ProcessIdDocument_NationalIdentityCard(AnalyzedDocument document)
        {
            Console.WriteLine($"Document: {document.DocType}");
            if (document.Fields.TryGetValue("CountryRegion", out DocumentField? countryRegionField))
            {
        ...
        static void ProcessIdDocument_ResidencePermit(AnalyzedDocument document)
        {
            Console.WriteLine($"Document: {document.DocType}");
            if (document.Fields.TryGetValue("CountryRegion", out DocumentField? countryRegionField))
            {
            ...
            if (document.Fields.TryGetValue("Category", out DocumentField? categoryField))
            {
                Console.WriteLine($"  Category: Value={categoryField.AsString()}   Confidence={categoryField.Confidence}");
            }
        }

        static void ProcessIdDocument_UsSocialSecurityCard(AnalyzedDocument document)
        {
            Console.WriteLine($"Document: {document.DocType}");
            if (document.Fields.TryGetValue("DocumentNumber", out DocumentField? documentNumberField))
            {
        ...
        static void ProcessIdDocument(AnalyzedDocument document)
        {
            Console.WriteLine($"Document: {document.DocType}");
            if (document.Fields.TryGetValue("DocumentNumber", out DocumentField? documentNumberField))
            {

...
namespace FormRecognizerSample
{
    internal class Program
    {
        ...
        static void ProcessInvoice(AnalyzedDocument document)
        {
            ...
            {
                Console.WriteLine($"  VendorAddress: Value={vendorAddressField.AsAddress()}   Confidence={vendorAddressField.Confidence}");
            }
            ...
            {
                Console.WriteLine($"  CustomerAddress: Value={customerAddressField.AsAddress()}   Confidence={customerAddressField.Confidence}");
            }
            ...
            {
                Console.WriteLine($"  BillingAddress: Value={billingAddressField.AsAddress()}   Confidence={billingAddressField.Confidence}");
            }
            ...
            {
                Console.WriteLine($"  ShippingAddress: Value={shippingAddressField.AsAddress()}   Confidence={shippingAddressField.Confidence}");
            }
            ...
            {
                Console.WriteLine($"  RemittanceAddress: Value={remittanceAddressField.AsAddress()}   Confidence={remittanceAddressField.Confidence}");
            }
            ...
            {
                Console.WriteLine($"  ServiceAddressRecipient: Value={serviceAddressRecipientField.AsAddress()}   Confidence={serviceAddressRecipientField.Confidence}");
            }

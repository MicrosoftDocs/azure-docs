...
* [**Prebuilt document (v3.0)**](concept-v3-prebuilt.md#general-document) model is a new API that extracts text, tables, structure, key-value pairs, and named entities from forms and documents.

...
> [!IMPORTANT]
>
> This tutorial and the Logic App Form Recognizer connector targets Form Recognizer REST API v2.1 and must be used in conjuction with the [FOTT tool]([https://azure.microsoft.com/free/cognitive-services/](https://fott-2-1.azurewebsites.net/). 

...
1. Next,  a OneDrive pop-up window appears and you're prompted to log into your OneDrive account. Select **Sign in** and follow the prompts to connect your account.
...
1. Now, you should see a window where you can create your connection. Specifically, you're going to connect your Document intelligence resource to the Logic Apps Designer Studio:
...
1. The Model Identifier allows you to specify which model you want to call, in this case we're calling the prebuilt invoice model, so enter **prebuilt-invoice**.
...
1. Now, you should see a window where to create your connection. Specifically, you're going to connect your Document intelligence resource to the Logic Apps Designer Studio:

...
Form Recognizer prebuilt models enable you to add intelligent form processing to your apps and flows without have to train and build your own models. The prebuilt model identifies and extracts predefined text and data common to specific form and document types. Form Recognizer currently supports invoices, receipts, identity documents, and business cards. 

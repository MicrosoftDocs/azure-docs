...
> [!NOTE]
> Form Recognizer studio currently does not support Microsoft Word, Excel, PowerPoint, and HTML file formats in the Read demo.
...
* Supported file formats: These include JPEG/JPG, PNG, BMP, TIFF, PDF (text-embedded or scanned). Additionally, the new preview API version, `2022-06-30-preview` supports Microsoft Word (DOCX), Excel (XLS), PowerPoint (PPT), and HTML files.

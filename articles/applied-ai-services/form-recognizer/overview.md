...
The following features  and development options are supported by Form Recognizer v3.0. Use the links in the table to learn more about each feature and browse the API references.

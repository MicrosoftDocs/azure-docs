...
* **Granularity**: The interval between consecutive data points in your time series data. Currently Metrics Advisor supports: Yearly, Monthly, Weekly, Daily, Hourly, minutely, and Custom. The lowest interval the customization option supports is 60 seconds.

...
|  nf-sku  |Fabric SKU ID is the SKU of the ordered BoM version. See [Network Fabric SKUs](./reference-operator-nexus-network-fabric-skus.md). | M4-A400-A100-C16-ab |True | String|

...
- Nexus supports :
    -   3500 Layer 2 isolation domains isolation domains per Nexus instance
    -   200 Layer 3 isolation domains per Nexus instance


## Information required for the Isolation Domain Resource

When creating an isolation domain resource, the following information must be specified:
...
-   **Location**: The Azure region where you want to create the isolation domain. It must match the location of the network fabric resource that you will use for the isolation domain.
...
-   **MTU**: The maximum transmission unit for the isolation domain. It is 1500 by default, if not specified.

...
| 1.25.6             | 5              | Csi-nfs v4.6.0   | Azure Linux 2.0  |  No breaking changes    |  |
...
| 1.25.11             | 3              | Csi-nfs v4.6.0 | Azure Linux 2.0  |  No breaking changes    | |
...
| 1.26.3             | 5              | Csi-nfs v4.6.0   | Azure Linux 2.0  |  No breaking changes    |  |
...
| 1.26.6             | 3              | Csi-nfs v4.6.0   | Azure Linux 2.0  |  No breaking changes    |  |
...
| 1.27.1             | 5              | Csi-nfs v4.6.0   | Azure Linux 2.0  |  No breaking changes    |  |
...
| 1.27.3             | 3              | Csi-nfs v4.6.0   | Azure Linux 2.0  |  No breaking changes    |  |
...
| 1.28.0             | 3              | Csi-nfs v4.6.0   | Azure Linux 2.0  |  No breaking changes    |  |

...
If you're unsure which Commit Workflow version applies to your setup, refer to the [Commit workflow compatible versions](./concepts-commit-workflow-v2.md#Commit-workflow-compatible-versions).

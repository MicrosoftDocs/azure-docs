...
Each connection has 2 peers. By filtering metrics for BGP (Border Gateway Protocol) peers, you can confirm the specific connections impacted during the update. [For more details on monitoring](../expressroute/monitor-expressroute-reference#count-of-routes-learned-from-peer---split-by-instance).

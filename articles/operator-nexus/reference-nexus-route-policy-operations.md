...
- **IpCommunityProperties**: If provided, at least one of the operations Add, Set, or Delete should be specified. Each operation should have at least one `IpCommunityId`.

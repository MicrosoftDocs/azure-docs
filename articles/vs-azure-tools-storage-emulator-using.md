...
For detailed information on the storage emulator, including system requirements and custom configuration instructions, see [Use the Azure Storage Emulator for Development and Testing](http://azure.microsoft.com/documentation/articles/storage-use-emulator/).

...
(For more complex queries over your data, use [Analytics](../query-language/get-started-analytics-portal.md).)
...
> [!NOTE]
> To write more complex queries, open [**Analytics**](../query-language/get-started-analytics-portal.md) from the top of the Search blade.
> 
...
* [Write complex queries in Analytics](../query-language/get-started-analytics-portal.md)

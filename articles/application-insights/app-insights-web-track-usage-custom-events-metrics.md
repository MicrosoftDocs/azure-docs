...
![Browse to your application resource in portal.azure.com](./media/app-insights-web-track-usage-custom-events-metrics/01-custom.png)
...
![Select the chart and set Grouping](./media/app-insights-web-track-usage-custom-events-metrics/02-segment.png)

From the list below the chart, select an event name. Click through to see individual occurrences of the event.

![Drill through the events](./media/app-insights-web-track-usage-custom-events-metrics/03-instances.png)
...
![Open metric explorer, select the chart, and select the metric](./media/app-insights-web-track-usage-custom-events-metrics/03-track-custom.png)
...
![Set Grouping, then select the property under Group by](./media/app-insights-web-track-usage-custom-events-metrics/04-segment-metric-event.png)
...
![Select an instance, then select '...'](./media/app-insights-web-track-usage-custom-events-metrics/appinsights-23-customevents-4.png)


Use the Search field to see event occurrences with a particular property value.


![Type a term into Search](./media/app-insights-web-track-usage-custom-events-metrics/appinsights-23-customevents-5.png)
...
![Add a new chart or select a chart, and under Custom select your metric](./media/app-insights-web-track-usage-custom-events-metrics/03-track-custom.png)
...
![Usage lens on Overview blade](./media/app-insights-web-track-usage-custom-events-metrics/appinsights-47usage-2.png)

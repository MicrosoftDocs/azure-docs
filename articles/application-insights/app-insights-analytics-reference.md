...
The series_outliers() function takes a column containing dynamic array as input and generates a dynamic numeric array of the same length the input. Each value of the array indicates a score of possible anomaly using Tukey's test. A value greater than 1.5 or less than -1.5 indicates a rise or decline anomaly respectively in the same element of the input. 

...
![In the Alert rules blade, choose Add Alert. Set the your app as the resource to measure, provide a name for the alert, and choose a metric.](./media/app-insights-set-alerts/01-set-metric.png)
...
![On the Overview blade, near the bottom, click 'Events in the past week'](./media/app-insights-set-alerts/09-alerts.png)

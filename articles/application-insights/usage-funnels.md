...
### Create your funnel
Before you create your funnel, you need to decide on the question you want to answer. For example, you might want to know how many users are viewing the home page, viewing a customer profile and creating a tickeet. In this example, the owners of the Fabrikam Fiber company want to know the percentage of customers who successfully create a customer ticket.
...
### Funnel Features
1. If your app is sampled, you will see a sampling banner. Clicking on the banner will open a context blade instructing how to turn sampling off. 

...
There's also an [Application Insights SDK for Android](https://github.com/Microsoft/ApplicationInsights-Android) which sends telemetry to the Application Insights portal.

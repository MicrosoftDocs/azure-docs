...
* Instrument your project during development. You can do this for [ASP.NET](../azure-monitor/app/asp-net.md) or [Java](../azure-monitor/app/java-get-started.md) apps, as well as [Node.js](../azure-monitor/app/nodejs.md) and a host of [other types](app-insights-platforms.md). 

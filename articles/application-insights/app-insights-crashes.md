...
If you haven't done this already, add [Application Insights to your app project][platforms], and republish it. 
...
![From the crashes chart, click Alert rules and then Add Alert](./media/app-insights-crashes/appinsights-d023-alert.png)

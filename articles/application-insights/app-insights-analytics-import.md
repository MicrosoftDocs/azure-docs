...
1. Upload the data to [Azure blob storage](../storage/blob/storage-dotnet-how-to-use-blobs.md). 
...
2. [Create a Shared Access Signature key for the blob](../storage/blob/storage-dotnet-shared-access-signature-part-2.md). The key should have an expiration period of one day and provide read access.

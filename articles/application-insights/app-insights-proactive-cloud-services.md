...
Note: In the examples below, an issue will be detected if more than three events are found during the analyzed time window. This default can be configured to change the sensitivity of the alert rule.
...
![Screenshot 001 of Create rule from](./media/app-insights-proactive-cloud-services/001.png)
...
![Screenshot 002 of Create rule from](./media/app-insights-proactive-cloud-services/002.png)
...
![Screenshot 003 of Create rule from](./media/app-insights-proactive-cloud-services/003.png)
...
![Screenshot 004 of Create rule from](./media/app-insights-proactive-cloud-services/004.png)

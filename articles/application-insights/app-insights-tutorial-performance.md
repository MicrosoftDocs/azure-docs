...
2. Application Insights Analytics opens with a query for each of the views in the blade.  You can run these queries as they are or modify them for your requirements.  The first query shows the duration for this operation over time.
...
2. Application Insights Analytics opens with a query for each of the views in the blade. The first query shows the duration for different page views over time.

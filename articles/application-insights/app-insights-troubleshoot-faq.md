...
Client usage basics: page views, sessions, ...|[JavaScript initializer in web pages](app-insights-start-monitoring-app-health-usage.md#webclient)|Usage analytics
Client custom metrics|[Tracking calls in web pages](app-insights-web-track-usage-custom-events-metrics.md)|Enhance user experience
Server custom metrics|[Tracking calls in server code](app-insights-web-track-usage-custom-events-metrics.md)|Business intelligence

...
---------------------------- |------------------ | --------------------
[Availability charts](app-insights-monitor-web-app-availability.md) | [Web tests](app-insights-monitor-web-app-availability.md) | Know your web app is up
...
[Get stack traces from exceptions](app-insights-search-diagnostic-logs.md/#exceptions) | [Insert TrackException calls in your code](app-insights-search-diagnostic-logs.md/#exceptions) (but some are reported automatically) | Detect and diagnose exceptions
...
Client custom metrics | [Tracking calls in web pages](app-insights-api-custom-events-metrics.md) | Enhance user experience
 [Server custom metrics](app-insights-api-custom-events-metrics.md) | [Tracking calls in server](app-insights-api-custom-events-metrics.md) | Business intelligence

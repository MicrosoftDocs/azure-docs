...
1. **Server code:** Install the appropriate module for your [ASP.NET](../azure-monitor/app/asp-net.md), [Azure](app-insights-overview.md), [Java](../azure-monitor/app/java-get-started.md), [Node.js](../azure-monitor/app/nodejs.md), or [other](app-insights-platforms.md) app.

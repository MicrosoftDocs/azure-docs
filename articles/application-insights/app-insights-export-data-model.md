...
|Path|Type|Notes|
|---|---|---|
| event [0] count | integer | Indicates the [sampling](app-insights-sampling.md) rate. E.g. 4 =&gt; 25%. |
...
| basicException [0] count | integer | Indicates the [sampling](app-insights-sampling.md) rate. E.g. 4 =&gt; 25%. |
...
| basicException [0] stack | string | Max 10k|
...
| remoteDependency [0] count | integer | Indicates the [sampling](app-insights-sampling.md) rate. E.g. 4 =&gt; 25%. |
...
|Path|Type|Notes|
|---|---|---|
| request [0] count | integer | Indicates the [sampling](app-insights-sampling.md) rate. E.g. 4 =&gt; 25%. |
...
|Path|Type|Notes|
|---|---|---|
| view [0] count | integer | Indicates the [sampling](app-insights-sampling.md) rate. E.g. 4 =&gt; 25%. |
...
| availability [0] count | integer | Indicates the [sampling](app-insights-sampling.md) rate. E.g. 4 =&gt; 25%. |

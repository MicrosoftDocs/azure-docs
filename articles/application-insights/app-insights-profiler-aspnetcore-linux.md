...
![You don't need to enable the Profiler again in performance pane to make profiler work on Linux App Services](./media/app-insights-profiler-aspnetcore-linux/issue-enable-profiler.png)

...
Application Insights Profiler is included with the Windows Azure Diagnostics (WAD) extension that can be installed on the VMs that are running your Service Fabric Application. The WAD extension can be installed using an Azure RM template for your Service Fabric cluster. Please see an example template here: [**Template that installs WAD on a Service Fabric Cluster.**](https://github.com/Azure/azure-docs-json-samples/blob/master/application-insights/ServiceFabricCluster.json)
...
1. Deploy your Service Fabric cluster using your Azure RM template and Application Insights Profiler will be installed and enabled with the WAD extension is installed. 
1. Add Application Insights to your Service Fabric application. Your application must be sending request data to application insights in order for the profiler to collect profiles for your requets. You can find instructions [here.](https://github.com/Microsoft/ApplicationInsights-ServiceFabric)
1. Redploy your application.

...
3. If Application Insights packages appear in Updates, select them. 
    ...
    * Microsoft.ApplicationInsights.ServiceFabric - for roles running in ServiceFabric and Docker containers
    * Microsoft.ApplicationInsights.ServiceFabric.Native - for native ServiceFabric applications
...
If a role runs in a Docker container in Azure, you can collect additional metrics from the container. Insert this in your [Azure diagnostics](../monitoring-and-diagnostics/azure-diagnostics.md) configuration file:

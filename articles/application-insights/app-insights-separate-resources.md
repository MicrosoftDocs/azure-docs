...
You can set the Application Version property so that you can filter [search](../azure-monitor/app/diagnostic-search.md) and [metric explorer](app-insights-metrics-explorer.md) results.

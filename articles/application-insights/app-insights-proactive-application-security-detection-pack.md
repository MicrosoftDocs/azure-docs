...
Application Insights automatically analyzes the telemetry generated by your application and detects potential security issues. These detections enable you to identify potential security problems, and handle them by fixing the application or by taking the necessary security measures.

This feature requires no special setup, other than [configuring your app to send telemetry](https://docs.microsoft.com/en-us/azure/application-insights/app-insights-usage-overview).

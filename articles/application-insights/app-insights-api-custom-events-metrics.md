...
> [AZURE.WARNING] Don't reuse the same telemetry item instance to call Track_() multiple times. This may cause telemetry to be sent with incorrect configuration.

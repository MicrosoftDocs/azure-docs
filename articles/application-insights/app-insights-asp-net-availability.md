<properties
	pageTitle="Monitor the availability and responsiveness of any web site | Microsoft Azure"
	description="Get alerts if a website becomes unavailable or responds slowly."
...
# Set up Application Insights: Availability web tests

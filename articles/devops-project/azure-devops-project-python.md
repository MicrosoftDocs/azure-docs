...
You can delete Azure App Service and related resources that you created in this quickstart when you don't need them anymore. Use the **Delete** functionality on the DevOps Projects dashboard.

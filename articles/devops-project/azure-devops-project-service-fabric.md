...
The Azure DevOps Project creates a CI/CD pipeline in Azure.  You can create a **new Azure DevOps** organization or use an **existing organization**.  The Azure DevOps Project also creates **Azure resources** such as a Service Fabric cluster in the **Azure subscription** of your choice.
...
1. It will take several minutes for the process to complete.  A sample ASP.NET Core application is set up in a repository in your Azure DevOps organization, a Service Fabric cluster is created, a build and release executes, and your application deploys to Azure.  
	...
	This dashboard provides visibility into your Azure DevOps **code repository**, **Azure CI/CD pipeline**, and **Service Fabric cluster**.  You can further configure additional options in Azure DevOps.  On the right-side of the dashboard, select **Browse** to view your running application.

...
The Azure DevOps Project presents a simplified experience which creates Azure resources and sets up a continuous integration (CI) and continuous delivery (CD) pipeline for your PHP app in Azure DevOps.  
...
The Azure DevOps Project creates a CI/CD pipeline in Azure.  You can create a free **new Azure DevOps** organization or use an **existing organization**.  The DevOps Project also creates **Azure resources** in the **Azure subscription** of your choice.
...
1. The default sample framework is **Laravel**. Leave the default setting, and then choose **Next**.  
...
When you configured your CI/CD process in this quickstart, a build and release definition were automatically created in your Azure DevOps project. You can modify these build and release definitions to meet the needs of your team. To learn more see this tutorial:

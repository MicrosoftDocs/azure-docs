...
DevOps Projects automatically configures function app, which you can explore and customize. To familiarize yourself with the function app, do the following:

...
1. It will take several minutes for the process to complete.  A sample ASP.NET Core application is set up in a repository in your Azure DevOps organization, an AKS cluster is created, a build and release executes, and your application deploys to Azure.  
	...
	This dashboard provides visibility into your Azure DevOps **code repository**, **Azure CI/CD pipeline**, and **AKS cluster**.  You can further configure additional options in Azure DevOps.  On the right-side of the dashboard, select **Browse** to view your running application.
...
1. From this view, **examine the various tasks** for your build definition.  The build performs various tasks such as fetching sources from the Azure DevOps Git repository, restoring dependencies, and publishing outputs used for deployments.

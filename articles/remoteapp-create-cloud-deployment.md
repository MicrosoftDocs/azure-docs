...
- Want to provide custom apps or LOB programs? Create a new [custom template image](remoteapp-create-custom-image.md) and use it in your cloud collection.
...
5. Choose the template to use for this collection. 
	...
	**Tip:** Your subscription for RemoteApp comes with [template images](remoteapp-images.md) that contain Office 365 or Office 2013 (for trial use) programs, some published (such as Word) and others ready to publish. You can also create a new [custom template image](remoteapp-create-custom-image.md) and use it in your cloud collection.

...
This article is a details listing of concepts and best practices for achieving business continuity and resiliency with Microsoft Azure for your on-premises, hybrid, and public cloud applications.
...
This article is a list of features, services, and designs to be used to help you increase the resiliency, and availability, of your application.
...
This article focuses on developing highly scalable cloud architectures. Many of the techniques that you employ to improve scalability also improve availability. Also, if your application can not scale under increased load, then scalability becomes an availability issue.
...
This article provides technical guidance on how to backup and restore Microsoft SQL Server running on Azure Virtual Machines.
...
This article is a technical case study showing how Microsoft IT used Azure to improve disaster recovery.

...
After you create the plan, open the plan from the Recovery Plans list. The plan is initially in the **Warning** state, indicating that resources require attention. The **Configure plan** tab shows two key sections: **Manage resource protection** and **Plan readiness check**.

### Manage resource protection

To view and manage the protection status of resources in your plan.
...
1. On the **Configure plan** tab, select **Manage resource protection**. The **Manage resource protection** page opens.
1. Locate the resource with **State not selected** inclusion state.
...
1. In **Manage resource protection** pane, on the **Start group order** tab, select **Manage groups**. 
...
1. In **Manage resource protection** pane, on the **Group action** tab, select the more icon (**...**) for the group you want to configure.
1. Select **Add Script**. 
...
1. In **Manage resource protection** pane, on the **Group action** tab, select the more icon (**...**) for the group.
...
During failover, manual actions pause the failover job. The job remains paused until you navigate to the Recovery Plan execution pane and manually acknowledge and resume the action.

## Review and update the plan

To update the plan, follow the steps:

1. In **Manage resource protection** pane, on **Group action** tab, select **Next** to navigate to the **Review + update** tab.

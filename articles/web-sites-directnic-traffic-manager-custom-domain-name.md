<properties title="Configure a Directnic domain name for an Azure web site using Traffic Manager" pageTitle="Configure a Directnic domain name for an Azure web site using Traffic Manager" metaKeywords="Windows Azure, Windows Azure Web Sites, Directnic, Traffic Manager" description="Learn how to configure an Azure Web Site to use a custom domain name" services="Web Sites" documentationCenter="" authors="larryfr,jroth" />

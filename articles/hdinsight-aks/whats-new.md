...
|	Auto-Scaling	|	Load based [Auto Scaling](./hdinsight-on-aks-autoscale-clusters.md) Support, Schedule based [Auto Scaling](./hdinsight-on-aks-autoscale-clusters.md) Support	|
|	Customize and configure	|	Support [script actions](./manage-script-actions.md) during cluster create, Support [library management](./spark/library-management.md), Service config settings after cluster creation	|	
|	Trino	|	Support for [Trino catalogs](./trino/trino-add-catalogs.md), Submit queries to the cluster using [Trino Cli](./trino/trino-ui-command-line-interface.md)/Dbeaver,	[Trino CLI](./trino/trino-ui-command-line-interface.md) Support,	Add or remove plugins/[connectors](./trino/trino-connectors.md), Support for [logging query](./trino/trino-query-logging.md) events, Support for [scan query statistics](./trino/trino-scan-stats.md) for any [Connector](./trino/trino-connectors.md) in Trino dashboard, Support Trino dashboard for query monitoring, [Query Caching](./trino/trino-caching.md), Integrate with `PowerBI`, Integrate with [Apache Superset](./trino/trino-superset.md)/Redash, Support for multiple connectors, |

...
Once the cluster pool deployment completes, continue to use the Azure portal to create a [Trino](./trino/trino-create-cluster-portal.md#create-a-trino-cluster), [Flink](./flink/flink-create-cluster-portal.md#create-a-flink-cluster), and [Spark](./spark/hdinsight-on-aks-spark-create-cluster-portal.md) cluster. 

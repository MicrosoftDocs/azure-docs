...
1. Go to "Configuration management" blade in the left menu.
    ...
    :::image type="content" source="./media/service-configuration/configuration-management-tab.png" alt-text="Screenshot showing Configuration Management tab." border="true" lightbox="./media/service-configuration/configuration-management-tab.png":::

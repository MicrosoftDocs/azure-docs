...
On [Secure Shell for Flink](../flink/flink-webssh-on-portal-to-flink-sql.md), you can use the following commands
...
:::image type="content" source="./media/kafka-flink-kibana/flink-elastic-job.png" alt-text="Screenshot showing Kibana UI to start Elasticsearch and Kibana and perform analytics on Kibana." lightbox="./media/kafka-flink-kibana/flink-elastic-job.png":::

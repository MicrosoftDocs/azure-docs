...
> [!NOTE]
> Setup a HDInsight [Kafka](/azure/hdinsight/kafka/apache-kafka-get-started) Cluster and Replace broker list with your own list before you get started for both Kafka 2.4 and 3.2.

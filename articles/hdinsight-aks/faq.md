...
1. What cluster shapes do HDInsight on AKS support?
...
1. How do I get started with HDInsight on AKS?
...
1. What happens to existing HDInsight on VM and the clusters I’m running today?
...
1. Which operating system is supported with HDInsight on AKS?
...
1. Can I install or add more plugins/libraries on my cluster?
...
1. What all connectors do you support?
...
1. Can I add catalogs to an existing cluster?
...
1.  Do you support both session and app mode in Apache Flink?

    In HDInsight on AKS, Flink currently support session mode clusters.  

1. What is state backend management and how it's done in HDInsight on AKS? 
...
1. What language APIs are supported in Spark? 

    Azure HDInsight on AKS supports Python and Scala. 

1. Are external metastore supported in HDInsight on AKS Spark? 

    HDInsight on AKS support external metastore connectivity. Currently only Azure SQL DB in supported as external metastore. 

1. What are the various ways to submit jobs in HDInsight on AKS Spark? 

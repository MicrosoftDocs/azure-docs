...
1. Modify the response with the following changes to turn it into a valid ARM template.
  ...
  1. Copy the modified response to the “resources” object in the ARM template format. For example:
      ...
      :::image type="content" source="./media/manage-cluster/modify-get-response.png" alt-text="Screenshot showing how to  modify the get response." border="true" lightbox="./media/manage-cluster/modify-get-response.png":::

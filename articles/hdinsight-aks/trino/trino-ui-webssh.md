...
3. Navigate to "Secure shell (SSH)" blade and click on the endpoint of a pod. You need to authenticate to open the SSH session.
   ...
   :::image type="content" source="./media/trino-ui-webssh/secure-shell-in-portal.png" alt-text="Screenshot showing secure shell and webssh endpoint"::: 
...
6. Type `trino-cli` command to run Trino CLI and connect to this cluster. Follow the command displayed to authenticate using device code.
   ...
   :::image type="content" source="./media/trino-ui-webssh/cmd-trino-cli.png" alt-text="Screenshot showing login to trino cli using webssh":::

...
>[!Note]
>The solution presented in this article is not limited to SQL Server connectivity. This approach can be used to connect and query any available on premises connectors which is supported in data factory. 

...
| **GitHub account**                                       | Your GitHub account name. This can be found from https://github.com/{account name}/{repository name}.This will prompt you to enter Github OAuth credentials to your GitHub account.                                                                                                                                                                                                                                               |                    |
...
| **Collaboration branch**                                 | Your GitHub collaboration branch that will be used for publishing. By default, it is master. Change this in case you want to publish resources from another branch.                                                                                                                                                                                                                                                               |                    |
...
| **Branch to import resource into**                       | Specifies which branch the data factory resources (pipelines, datasets, linked services etc.) will be imported into. You can use one of the following to import resources into a. Collaboration b. Create new c. Use Existing                                                                                                                                                                                                     |                    |

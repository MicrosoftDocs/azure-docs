...
---
title: SAP change data capture solution (Preview) - Generate pipeline with SAP data partitioning template 
titleSuffix: Azure Data Factory
description: This topic introduces and describes auto-generation of a pipeline with the SAP data partitioning template for SAP change data capture (Preview) in Azure Data Factory.
author: swinarko
ms.service: data-factory
ms.subservice: data-movement
ms.topic: conceptual
...
# Auto-generate pipeline from SAP data partitioning template

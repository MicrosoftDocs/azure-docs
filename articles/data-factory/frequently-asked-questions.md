...
### I need help troubleshooting my data flow logic, what do you need?
...
* From the code view, click "Plan" on the top-right corner. The Plan togglw will switch from JSON to the read-only formatted DSL script plan.

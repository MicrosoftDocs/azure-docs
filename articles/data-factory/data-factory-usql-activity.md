...
| Users accounts managed by Azure Active Directory (AAD) | 14 days after the last slice run. <p>90 days, if a slice based on OAuth-based linked service runs at least once every 14 days.</p> |

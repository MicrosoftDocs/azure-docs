...
:::image type="content" source="media/data-flow/move-nodes.png" alt-text="Move node" title="move node":::
...
:::image type="content" source="media/data-flow/hide-graph.png" alt-text="Hide graph" title="hide graph":::
...
:::image type="content" source="media/data-flow/show-graph.png" alt-text="Show graph" title="show graph":::
...
:::image type="content" source="media/data-flow/search-1.png" alt-text="Screenshot shows the Search button." title="Search graph":::

You can search by transformation name or description to locate a transformation.

:::image type="content" source="media/data-flow/search-2.png" alt-text="Screenshot shows the search text box." title="Search graph":::
...
:::image type="content" source="media/data-flow/hide-reference-nodes.png" alt-text="Hide reference nodes" title="Hide reference nodes":::

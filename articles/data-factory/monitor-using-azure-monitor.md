...
> [!NOTE]
> Azure Data Factory Analytics (Preview) solution sends diagnostic logs to _Resource-specific_ destination tables. You can also write query against _ADFPipelineRun_, _ADFTriggerRun_ and _ADFActivityRun_ tables.

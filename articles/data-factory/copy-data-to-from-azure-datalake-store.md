...
description: Learn how to copy data from/to supported source/sink data stores to/from an Azure Data Lake store by using Azure Data Factory.
...
For a full list of sections and properties available for defining datasets, see the [datasets](concepts-datasets.md) article. This section provides a list of properties supported by Azure Data Lake Store dataset.

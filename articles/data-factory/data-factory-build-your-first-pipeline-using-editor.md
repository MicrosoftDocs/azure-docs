...
In this step, you links your Azure Storage account to your data factory. For the purpose of this tutorial, you use the same Azure Storage account to store input/output data and the HQL script file. 
...
In this step, you links an on-demand HDInsight cluster to your data factory. The HDInsight cluster is automatically created at runtime and deleted after it is done processing and idle for the specified amount of time. 
...
2. Copy and paste the snippet below to the **Draft-1** window. The JSON snippet describes the properties that are used to create the HDInsight cluster on-demand. 
	...
	| :------- | :---------- |
	| Version | Secifies that the version of the HDInsight created to be 3.2. | 
...
8. To view all activities in the pipeline, right-click pipeline in the diagram and click Open Pipeline. 
...
12. In the **Diagram View**, double-click the dataset **AzureBlobOutput**. You see that the slice that is currently being processed.

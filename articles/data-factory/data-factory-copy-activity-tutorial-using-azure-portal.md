...
6. In the **New data factory** blade:
	...
	4. Select the **location** for the data factory. Only regions supported Data Factory service are shown in the drop-down list.

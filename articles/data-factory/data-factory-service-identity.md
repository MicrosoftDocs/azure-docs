...
See [Managed Identities for Azure Resources Overview](/azure/active-directory/msi-overview.md) for more background on managed identities for Azure resources, which data factory service identity is based upon. 

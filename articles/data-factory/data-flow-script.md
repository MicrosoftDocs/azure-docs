...
:::image type="content" source="media/data-flow/scriptbutton.png" alt-text="Script button" title="Script button":::
...
:::image type="content" source="media/data-flow/copybutton.png" alt-text="Copy button" title="Copy button":::

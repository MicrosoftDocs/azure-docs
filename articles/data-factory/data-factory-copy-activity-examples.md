...
- **type** is set to **OnPremisesSqlServer**.
...
See [On-premises SQL type properties](https://msdn.microsoft.com/library/mt185722.aspx#OnPremSQL) for details about JSON elements to define a Data Factory table that refers to an SQL Server table. 
...
See [Azure blob type properties](https://msdn.microsoft.com/library/mt185722.aspx#AzureBlob) for details about JSON elements to define a Data Factory table that refers to an Azure blob. 
...
The following sample JSON can be used to create a linked service named **FolderDataStore** of type **OnPremisesFileServer**.  
...
See [On-premises File System type properties](https://msdn.microsoft.com/library/mt185722.aspx#OnPremFileSystem) for details about JSON elements to define a Data Factory table that refers to an on-premises file system. 
...
The following JSON can be used to create a linked service that points to an on-premises Oracle database. Note that the **type** is set to **OnPremisesOracle**. 
...
### Create a linked service for the destination Azure blob
The following sample JSON can be used to create a linked service named **MyAzureStorage** of type **AzureStorage**.
...
### Create the input table
The following sample JSON can be used to create an Azure Data Factory table that refers to a table in an on-premises Oracle database. Note that the **type** is set to **OracleTable**.
...
See [On-premises Oracle type properties](https://msdn.microsoft.com/library/mt185722.aspx#Oracle) for details about JSON elements to define a Data Factory table that refers to a table in an on-premises Oracle database. 

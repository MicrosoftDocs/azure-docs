...
Using a JSON dataset as a source in your data flow allows you to set five additional settings. These settings can be found under the **JSON settings** accordion in the **Source Options** tab. For **Dcoument Form** type, you can select one of **Single document**, **Document per line**  and **Array of documents**. 

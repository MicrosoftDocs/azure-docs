---
title: Auto-generate a pipeline by using the SAP ODP (preview) data partitioning template
titleSuffix: Azure Data Factory
description: Learn how to use the SAP ODP (preview) data partitioning template for SAP CDC extraction in Azure Data Factory.
author: ukchrist
...
# Auto-generate a pipeline by using the SAP ODP (preview) data partitioning template

...
-	**Recommendation**: Provide the consent and then rerun the pipeline. To provide consent, refer to this link [How can I approve PAM requests via the Microsoft 365 admin center](../graph/data-connect-faq.md#how-can-i-approve-pam-requests-via-the-microsoft-365-admin-center).

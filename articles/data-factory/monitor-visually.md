...
:::image type="content" source="media/monitor-visually/pipeline-runs.png" alt-text="List view for monitoring pipeline runs":::
...
| Run | **Original**, **Rerun**, and **Rerun (Latest)** |
...
:::image type="content" source="media/monitor-visually/refresh.png" alt-text="Refresh button":::
...
:::image type="content" source="media/monitor-visually/view-activity-runs.png" alt-text="View activity runs":::
...
:::image type="content" source="media/monitor-visually/activity-runs.png" alt-text="There is information about SalesAnalyticsMLPipeline, followed by a list of activity runs.":::
...
:::image type="content" source="media/monitor-visually/activity-run-error.png" alt-text="A notification appears with error details including error code, failure type, and error details.":::
...
:::image type="content" source="media/monitor-visually/promote-user-properties.png" alt-text="Create user properties":::

After you create the user properties, you can monitor them in the monitoring list views.

:::image type="content" source="media/monitor-visually/choose-user-properties.png" alt-text="Add columns for user properties to the activity runs list":::
...
:::image type="content" source="media/monitor-visually/view-user-properties.png" alt-text="Activity runs list with columns for user properties":::
...
:::image type="content" source="media/monitor-visually/rerun-pipeline.png" alt-text="Rerun a pipeline":::
...
:::image type="content" source="media/monitor-visually/rerun-failed-activity.png" alt-text="Rerun failed activity":::

### View rerun history

You can view the rerun history for all the pipeline runs in the list view.

:::image type="content" source="media/monitor-visually/rerun-history-1.png" alt-text="View history":::

You can also view rerun history for a particular pipeline run.

:::image type="content" source="media/monitor-visually/view-rerun-history.png" alt-text="View history for a pipeline run":::
...
:::image type="content" source="media/monitor-visually/monitor-consumption-2.png" alt-text="Monitor consumption":::
...
:::image type="content" source="media/monitor-visually/select-gantt.png" alt-text="Example of a Gantt chart":::

The length of the bar informs the duration of the pipeline. You can also select the bar to see more details.

:::image type="content" source="media/monitor-visually/view-gantt-run.png" alt-text="Gantt chart duration":::
...
:::image type="content" source="media/monitor-visually/start-page.png" alt-text="Data factory Monitor page":::

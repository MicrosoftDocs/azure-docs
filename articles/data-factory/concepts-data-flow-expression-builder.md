...
:::image type="content" source="media/data-flow/open-expression-builder-derive.png" alt-text="Open Expression Builder derive" title="Open Expression Builder derive":::
...
:::image type="content" source="media/data-flow/expressionbox.png" alt-text="Blue expression box" title="Blue expression box":::
...
:::image type="content" source="media/data-flow/computedcolumn.png" alt-text="Computed column option" title="Computed column option":::
...
:::image type="content" source="media/data-flow/add-dynamic-content.png" alt-text="Add dynamic content option" title="Add dynamic content option":::
...
:::image type="content" source="media/data-flow/expression-elements.png" alt-text="Expression elements" title="Expression elements":::
...
:::image type="content" source="media/data-flow/expression-array.png" alt-text="Expression Builder array" title="Expression Data Preview":::
...
:::image type="content" source="media/data-flow/cached-lookup-example.png" alt-text="Cached lookup" title="Cached lookup":::
...
:::image type="content" source="media/data-flow/preview-expression.png" alt-text="In-progress preview" title="Expression Data Preview":::
...
:::image type="content" source="media/data-flow/comment-expression.png" alt-text="Comment in the transformation text box" title="Comments":::

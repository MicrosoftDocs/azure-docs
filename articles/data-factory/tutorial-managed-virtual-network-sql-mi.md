...
7. Enter the name of private endpoint and select **myPrivateLinkService** in private 
link service list.
8. Add FQDN of your target SQL Managed Instance and NAT IPs of your private link Service.

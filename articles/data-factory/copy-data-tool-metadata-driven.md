...
- OPENJSON is used in generated SQL scripts by copy data tool. If you are using SQL Server to host contorl table, it must be SQL Server 2016 (13.x) and later in order to support OPENJSON function.

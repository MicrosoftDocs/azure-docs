...
API permission must be enabled in Salesforce. For more information, see [Enable API access in Salesforce by permission set](https://www.findmycrm.com/faq/crm-migration-faqs/how-do-i-enable-api-access-in-salesforce-classic-by-the-permission-set)

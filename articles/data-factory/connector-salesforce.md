...
| Support objects that contain binary fields when selecting **Object API/Report ID** in **Use query**. The applicable self-hosted integration runtime version is 5.44.8984.1 or above. | Objects that contain binary fields are supported, like Attachment object.|
| Support objects within Bulk API when selecting **Object API/Report ID** in **Use query**. The applicable self-hosted integration runtime version is 5.44.8984.1 or above. For more information, see this [article](https://help.salesforce.com/s/articleView?id=000383508&type=1). |Support objects that aren't supported by Bulk API, like CaseStatus.|

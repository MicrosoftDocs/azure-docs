...
## Repeatable copy
When copying data to Azure SQL Data Warehouse, the copy activity appends data to the sink table by default. To perform an UPSERT instead,  See [Repeatable copy in Azure Data Factory](data-factory-repeatable-copy.md) article. 

...
8. In the **New Linked Service (Azure Data Lake Storage Gen1)** page, do the following steps: 
   ...
   > [!IMPORTANT]
   > In this walkthrough, you use a _managed service identity_ to authenticate your Data Lake Storage Gen1 account. Be sure to grant the MSI the proper permissions in Data Lake Storage Gen1 by following [these instructions](connector-azure-data-lake-store.md#managed-identity).

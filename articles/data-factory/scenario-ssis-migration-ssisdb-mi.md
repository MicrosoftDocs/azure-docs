...
[Migrate SSIS packages to an Azure SQL Managed instance](https://docs.microsoft.com/azure/dms/how-to-migrate-ssis-packages-managed-instance).

## SSIS jobs to Azure SQL Managed instance agent

Azure SQL Managed instance has a native, first-class scheduler just like SQL Server Agent on premises.  Since a migration tool for SSIS jobs is not yet available, they have to be migrated from SQL Server Agent on premises to Azure SQL Managed instance agent via scripts/manual copy.
...
- [Network topologies for Azure SQL Managed instance migrations using DMS](https://docs.microsoft.com/azure/dms/resource-network-topologies)
- [Migrate SSIS packages to an Azure SQL Managed instance](https://docs.microsoft.com/azure/dms/how-to-migrate-ssis-packages-managed-instance)

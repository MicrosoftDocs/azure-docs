...
The sample copies data from a SAP Business Warehouse instance to an Azure blob hourly. The JSON properties used in these samples are described in sections following the samples.
...
```json
{
    ...
    "properties":
    {
        ...
        "typeProperties":
        {
            ...
            "clientId": "<client id>",
            "username": "<SAP BW user>",
            "password": "<Password for SAP BW user>",
            ...
            "activities": [
                {
                    ...
                    "typeProperties": {
                        "source": {
            				...
            				"query": "<MDX query for SAP BW / SQL Query for HANA>"
                        },
                        "sink": {
                            "type": "BlobSink",
                            "writeBatchSize": 0,
...
username | Name of the user who has access to the SAP BW server | string | Yes

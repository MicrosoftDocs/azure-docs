...
| typeProperties | Properties corresponding to the selected typeSee [Dataset Type](#Type) section for details on the supported types and their properties. | Yes | NA |

...
3. **Create a pipeline with copy activity.** Refer to the following section.

### Syntax

Below is a template of copy activity which lists exhausted supported properties. Specify the ones fits your scenario.

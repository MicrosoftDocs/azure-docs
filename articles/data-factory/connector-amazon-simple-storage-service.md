...
| serviceUrl | Specify the custom S3 endpoint `https://<service url>`. This value specifies the endpoint to access to the S3 Connector. Change it only if you want to try a different service endpoint or want to switch between https and http.| No |

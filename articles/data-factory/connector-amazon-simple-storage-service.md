...
| serviceUrl | Specify the custom S3 endpoint if you are copying data from a S3-compatible storage provider other than the official Amazon S3 service. For example, to copy data from Google Cloud Storage, specificy `https://storage.googleapis.com`. | No |

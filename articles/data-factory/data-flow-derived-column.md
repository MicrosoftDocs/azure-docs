...
:::image type="content" source="media/data-flow/create-derive-column.png" alt-text="Derived column settings" title="Derived column settings":::
...
:::image type="content" source="media/data-flow/add-derived-column.png" alt-text="New derived column selection" title="New derived column selection":::
...
:::image type="content" source="media/data-flow/column-pattern-derive.png" alt-text="Column patterns" title="Column patterns":::
...
:::image type="content" source="media/data-flow/derive-add-column.png" alt-text="Create new column" title="Create new column":::
...
:::image type="content" source="media/data-flow/create-local.png" alt-text="Create local" title="Create local":::
...
:::image type="content" source="media/data-flow/create-local-2.png" alt-text="Create local 2" title="Create local 2":::
...
:::image type="content" source="media/data-flow/using-locals.png" alt-text="Using locals" title="Using locals":::
...
:::image type="content" source="media/data-flow/derive-script.png" alt-text="Derive example" title="Derive example":::

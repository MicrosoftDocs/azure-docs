...
To add additional derived columns, hover over an existing derived column and click th eplus icon. Choose either **Add column** or **Add column pattern**. Column patterns may come in handy if your column names are variable from your sources. For more information, see [Column Patterns](concepts-data-flow-column-pattern.md).

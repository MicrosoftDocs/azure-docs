...
The following procedure creates a SQL Server linked service based on a JSON definition file that has encrypted credentials:  

1. Create a JSON file named **SqlServerLinkedService.json** in any folder with the following content:  

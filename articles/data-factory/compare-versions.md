...
### Trigger-based flows
Pipelines can be triggered by on-demand(event based, ie: blob post) or wall-clock time. The [pipelines and triggers](concepts-pipeline-execution-triggers.md) article has detailed information about triggers. 

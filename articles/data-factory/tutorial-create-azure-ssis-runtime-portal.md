...
2. In the **General Settings** page of **Integration Runtime Setup**, do the following steps: 
   ...
   a. Specify a **name** for the integration runtime.

   b. Select the **location** for the integration runtime. Only supported locations are displayed.

   c. Select the **size of the node** that is to be configured with the SSIS runtime.

   d. Specify the **number of nodes** in the cluster.
...
1. In the **SQL Settings**, do the following steps: 
   ...
   a. Specify the Azure **subscription** that has the Azure SQL server.

   b. Select your Azure SQL server for the **Catalog Database Server Endpoint**.

   c. Enter the **administrator** user name.

   d. Enter the **password** for the administrator.

   e. Select the **service tier** for the SSISDB database. The default value is Basic.
...
5. This step is **optional**. If you have a classic virtual network (VNet) that you want the integration runtime to join, select the **Select a VNet for your Azure-SSIS integration runtime to join and allow Azure services to configure VNet permissions/settings** option, and do the following steps: 
   ...
   a. Specify the **subscription** that has the classic VNet.

...
title: What's changing with trusted service in Azure Data Factory
...
:::image type="content" source="media\whatsnew-trustedservice-adf\modern-ts.png" alt-text="Screenshot that shows the Modern trusted service option in Data Factory factory settings.":::
...
For more information, see [grant access from an internet IP range for Azure Storage](../storage/common/storage-network-security-overview.md?tabs=azure-portal#grant-access-from-an-internet-ip-range) and [Azure Key Vault network security](../key-vault/general/network-security).
...
For more information, see [Managed virtual networks and managed private endpoints in Azure Data Factory](../data-factory/managed-virtual-network-private-endpoint).
...
For more information, see [Join an Azure-SSIS integration runtime to a virtual network](../data-factory/join-azure-ssis-integration-runtime-virtual-network).

## Related content

- [Azure Storage network security](../storage/common/storage-network-security)
- [Trusted access based on a managed identity for Azure Storage](../storage/common/storage-network-security?tabs=azure-portal#trusted-access-based-on-a-managed-identity)
- [Azure Key Vault network security](../key-vault/general/network-security)
...
- [Managed virtual networks and managed private endpoints in Azure Data Factory](../data-factory/managed-virtual-network-private-endpoint)
- [Join an Azure-SSIS integration runtime to a virtual network](../data-factory/join-azure-ssis-integration-runtime-virtual-network)
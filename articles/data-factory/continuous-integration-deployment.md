...
-  Add the secrets to the parameters file. For more info, see [Use Azure Key Vault to pass a secure parameter value during deployment](../azure-resource-manager/resource-manager-keyvault-parameter.md).

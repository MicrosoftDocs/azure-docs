...
- By Design, Data Factory does not allow implemeting [RBAC Controls](https://docs.microsoft.com/en-us/azure/role-based-access-control/overview) on entities in a data factory (Datasets, Pipelines, etc). All developers using a single data factory should have access to all the entities inside that data factory. If you feel that you need to implement RBAC within a data factory, instead look at deploying a second data factory.

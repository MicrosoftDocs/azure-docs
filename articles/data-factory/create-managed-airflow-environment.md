...
1. **Airflow configuration overrides** Airflow configuration overrides you wish to use. For example. ``name: AIRFLOW__VAR__FOO``, ``value: BAR``. For more information, refer to [Airflow Configurations](https://airflow.apache.org/docs/apache-airflow/stable/configurations-ref.html)

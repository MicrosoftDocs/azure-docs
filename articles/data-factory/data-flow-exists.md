...
Next to each row in your column conditions for Exsits, you will find a + sign available when you hover over reach row. This will allow you to add multiple rows for Exists conditions. Each additional condition is an "And".

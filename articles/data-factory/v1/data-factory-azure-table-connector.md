...
> * [Version 1 - GA](data-factory-azure-table-connector.md)
> * [Version 2 - Preview](../connector-azure-table-storage.md)

> [!NOTE]
> This article applies to version 1 of Data Factory, which is generally available (GA). If you are using version 2 of the Data Factory service, which is in preview, see [Azure Table Storage connector in V2](../connector-azure-table-storage.md).

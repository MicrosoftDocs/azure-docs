...
You use a storage account to store the data in this tutorial. If you don't have a storage account, see [Create a storage account](../../storage/common/storage-create-account-quickstart.md). The sample solution uses blob storage.

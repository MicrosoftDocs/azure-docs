...
The following example provides a sample JSON definition for the Azure Machine Learning linked service. The linked service uses the apiKey for authentication.  

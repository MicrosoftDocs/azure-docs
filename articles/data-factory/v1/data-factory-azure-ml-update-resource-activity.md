...
If the scoring web service is a **classic web service**, create the second **non-default and updatable endpoint** by using the Azure portal. See [Create Endpoints](../../machine-learning/studio/machine-learning-create-endpoint.md) article for steps. After you create the non-default updatable endpoint, do the following steps:

...
![Screenshot that highlights the error message that indicates the gateway key is invalid or empty.](media/data-factory-troubleshoot-gateway-issues/gateway-key-is-invalid-or-empty.png)
...
![Screenshot that shows where you enter the path and password for the certificate.](media/data-factory-troubleshoot-gateway-issues/specify-certificate.png)
...
5. When you are satisfied with what you are about to upload, click **Send Logs** to actually send the logs from the last seven days to Microsoft for troubleshooting. You should see the status of the send-logs operation as shown in the following screenshot.
    ...
    ![Screenshot that shows where to view the status of the send-logs operation.](media/data-factory-troubleshoot-gateway-issues/data-management-gateway-send-logs-status.png)

...
| version                      | Version of the HDInsight cluster, refer to [supported HDInsight versions](https://docs.microsoft.com/en-us/azure/hdinsight/hdinsight-component-versioning#supported-hdinsight-versions) for allowed HDInsight versions. If not specified, it uses the [latest HDI default version](https://docs.microsoft.com/en-us/azure/hdinsight/hdinsight-component-versioning#hadoop-components-available-with-different-hdinsight-versions). | No       |

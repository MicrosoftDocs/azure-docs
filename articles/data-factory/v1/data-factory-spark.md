...
### Prerequisites
1. Create a general-purpose storage account by following the instructions in [Create a storage account](../../storage/common/storage-create-account-quickstart.md).

...
> [!NOTE]
> This article applies to version 1 of Azure Data Factory, which is generally availabile (GA). If you are using version 2 of the Data Factory service, which is in preview, see [transform data using spark activity in Data Factory version 2](../transform-data-using-spark.md).

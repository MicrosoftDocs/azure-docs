---
title: Integrate Azure data factory with SQL Server Integration Services | Microsoft Docs
...
# Integrate Azure data factory with SQL Server Integration Services (SSIS)

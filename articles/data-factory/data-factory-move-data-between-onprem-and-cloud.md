...
6.	In the Data Factory Editor, click **... More** on the toolbar and then click **New data gateway**. 
...
6. Wait until:
	2. Confirm that you see `adftutorial is connected to the cloud service` message. 

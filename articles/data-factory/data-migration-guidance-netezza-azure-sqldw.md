---
title: Use Azure Data Factory to migrate data from on-premise Netezza server to Azure | Microsoft Docs
description: Use Azure Data Factory to migrate data from on-premise Netezza server to Azure.
...
ADF offers a serverless architecture that allows parallelism at different levels, which allows developers to build pipelines to fully utilize your network bandwidth as well as database bandwidth to maximize data movement throughput for your environment.
...
When you encounter throttling errors reported by ADF copy activity, either reduce the concurrency or parallelCopies setting in ADF, or consider increasing the bandwidth/IOPS limits of the network and data stores. 
...
- [Copy data incrementally from one table](https://docs.microsoft.com/en-us/azure/data-factory/tutorial-incremental-copy-portal)
- [Copy data incrementally from multiple tables](https://docs.microsoft.com/en-us/azure/data-factory/tutorial-incremental-copy-multiple-tables-portal)

<properties
	...
	description="In this tutorial, you will create a sample Azure Data Factory pipeline using Data Factory REST API."
...
- [Using REST API](data-factory-build-your-first-pipeline-using-rest.md)

In this article, you will learn how to use Data Factory REST API to create your first Azure data factory.
...
> [AZURE.IMPORTANT] Replace **accountname>** and **accountkey** with name and key of your Azure storage account. To learn how to get your storage access key, see [View, copy and regenerate storage access keys](https://azure.microsoft.com/documentation/articles/storage-create-storage-account/#view-copy-and-regenerate-storage-access-keys).
...
- The HDInsight cluster creates a **default container** in the blob storage you specified in the JSON (**linkedServiceName**). HDInsight does not delete this container when the cluster is deleted. This is by design. With on-demand HDInsight linked service, a HDInsight cluster is created every time a slice needs to be processed unless there is an existing live cluster (**timeToLive**) and is deleted when the processing is done.
	...
	As more slices are processed, you will see a lot of containers in your Azure blob storage. If you do not need them for troubleshooting of the jobs, you may want to delete them to reduce the storage cost. The name of these containers follow a pattern: "adf**yourdatafactoryname**-**linkedservicename**-datetimestamp". Use tools such as [Microsoft Storage Explorer](http://storageexplorer.com/) to delete containers in your Azure blob storage.
...
3. View the results. It the data factory has been successfully created, you will see the JSON for the data factory in the **results**; otherwise, you will see an error message.  
		$results 
...
3. View the results. It the linked service has been successfully created, you will see the JSON for the linked service in the **results**; otherwise, you will see an error message.  
		$results 
...
In this step, you will create the input dataset to represent input data stored in the Azure Blob storage.
...
3. View the results. It the dataset has been successfully created, you will see the JSON for the dataset in the **results**; otherwise, you will see an error message.  
		$results 


### Create output dataset
In this step, you will create the output dataset to represent output data stored in the Azure Blob storage.
...
## Monitor pipeline
In this step, you will use Data Factory REST API to monitor what’s going on in an Azure data factory.

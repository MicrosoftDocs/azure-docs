...
You can start migrating your Azure Data Factory pipelines from either of two entry points:
...
Continue to [Step 4: Migrate pipelines](#step-4-migrate-pipelines).
...
| | Mapping data flows (MDF) | Supported (preview). Mapping data flows are converted to Spark transforms in Dataflow Gen2. See [Upgrade Azure Data Factory Mapping Data Flows pipelines to Fabric](https://aka.ms/datafactoryoverview). |

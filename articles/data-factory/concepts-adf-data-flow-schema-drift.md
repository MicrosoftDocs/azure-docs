...
description: Build resilient Data Flows in ADF with Schema Drift
author: kromerm
ms.author: makromer
...
# ADF Mapping Data Flow Schema Drift
...
In ADF Data Flow, those facilities are surfaced through this workflow:

1. Choose "Allow Schema Drift" in your Source Transformation

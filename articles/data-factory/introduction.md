...
> [!NOTE]
> This article applies to version 2 of Data Factory, which is currently in preview. If you are using version 1 of the Data Factory service, which is generally availabile (GA), see [Introduction to Data Factory version 1](v1/data-factory-introduction.md).

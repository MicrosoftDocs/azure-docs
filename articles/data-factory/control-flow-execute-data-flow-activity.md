...
:::image type="content" source="media/data-flow/activity-data-flow.png" alt-text="Execute Data Flow" title="Execute Data Flow":::
...
:::image type="content" source="media/data-flow/dyna1.png" alt-text="Dynamic Data Flow" title="Dynamic data flow":::
...
:::image type="content" source="media/data-flow/ir-new.png" alt-text="Azure Integration Runtime" title="Azure Integration Runtime":::
...
:::image type="content" source="media/data-flow/logging.png" alt-text="Logging level" title="Set logging level":::
...
:::image type="content" source="media/data-flow/sink-properties.png" alt-text="Sink properties" title="Set sink properties":::
...
:::image type="content" source="media/data-flow/params.png" alt-text="Execute Data Flow Parameters" title="Parameters":::
...
:::image type="content" source="media/data-flow/parameterize-compute.png" alt-text="Execute Data Flow Parameter Example" title="Parameter Example":::

...
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- | ------------------------------------------------------------ |
|[SAP Business Warehouse Open Hub](../connector-sap-business-warehouse-open-hub.md) | ✓/−                                                          |                                                              | ✓                                                            | SAP Business Warehouse version 7.01 or higher (in a recent SAP Support Package Stack released after the year 2015). SAP BW/4HANA isn't supported by this connector.                                                             | 
...
| [SAP Table](../connector-sap-table.md) | ✓/−                                                          |                                                              | ✓                                                            | SAP ERP Central Component (SAP ECC) version 7.01 or later (in a recent SAP Support Package Stack released after 2015). SAP Business Warehouse (SAP BW) version 7.01 or later (in a recent SAP Support Package Stack released after 2015). SAP S/4HANA. Other products in SAP Business Suite version 7.01 or later (in a recent SAP Support Package Stack released after 2015).                                                             |
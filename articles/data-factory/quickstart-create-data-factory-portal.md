...
10. On the **Let's get started** page, switch to the **Author** tab in the left panel. 
...
2. To trigger the pipeline manually, select **Trigger** on the pipeline toolbar, and then select **Trigger Now**. 

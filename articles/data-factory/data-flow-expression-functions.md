...
* ``regexReplace(normalize('bo²s'), `\p{M}`, '')``
* ``'boys'``
*********************************
### <code>not</code>
...
* ``toTimestamp('2016-12-31 00:12:00')``
* ``toTimestamp('2016-12-31T00:12:00', 'yyyy-MM-dd\'T\'HH:mm:ss', 'PST')``
* ``toTimestamp('2016-12-31 00:12:00')``

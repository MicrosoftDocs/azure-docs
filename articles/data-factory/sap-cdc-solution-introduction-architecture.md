...
:::image type="content" source="media/sap-cdc-solution/sap-supported-cdc-connectors.png" alt-text="Shows a list of the supported connectors for the SAP CDC solution.":::
...
:::image type="content" source="media/sap-cdc-solution/sap-cdc-architecture-diagram.png" alt-text="Shows a diagram of the architecture of SAP CDC.":::
...
:::image type="content" source="media/sap-cdc-solution/sap-cdc-shir-architecture-diagram.png" alt-text="Shows a diagram of the architecture of SAP CDC through the self-hosted integration runtime (SHIR).":::

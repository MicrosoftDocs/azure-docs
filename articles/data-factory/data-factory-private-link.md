...
If you want to restrict,  access for data factory resources in your subscriptions by private link, follow [Use portal to create private link for managing Azure resources](https://docs.microsoft.com/azure/azure-resource-manager/management/create-private-link-access-portal?source=docs)

...
:::image type="content" source="media/data-flow/new-branch2.png" alt-text="Screenshot shows the New branch option in the Multiple inputs / outputs menu." title="Adding a new branch":::
...
:::image type="content" source="media/data-flow/new-branch.png" alt-text="Screenshot shows the data flow with two branches from the source." title="Adding a new branch":::

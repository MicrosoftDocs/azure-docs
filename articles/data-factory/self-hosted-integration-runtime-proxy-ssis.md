...
>[!TIP]
>If you work in git-enabled ADF, a Linked Service without a key authentication will not immediately publish, which means you cannot save the integration runtime (that depends on the Linked Service) in your feature-branch. Authenticating with Account Key or SAS URI will immediately publish the Linked Service.

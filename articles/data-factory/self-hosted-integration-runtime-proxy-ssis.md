...
>[!TIP]
>When **Service Principal** is selected,  grant at least **Storage Blob Data Contributor role**. For more info, refer to [Azure Blob Storage connector](connector-azure-blob-storage.md#linked-service-properties).

...
> 
> As more and more slices are processed, you will see a lot of containers in your Azure blob storage, which you may want to delete to reduce the storage cost. The name of these containers follow a pattern: "adf<full/partial data factory name>-<full/partial name of linked service>-<datetime stamp>". Use tools such as [Microsoft Storage Explorer](http://storageexplorer.com/) to delete containers in your Azure blob storage.

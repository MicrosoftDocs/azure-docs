...
2.Search for Oracle and select the Oracle Eloqua connector.
   ...
   :::image type="content" source="media/connector-oracle-eloqua/oracle-eloqua-connector.png" alt-text="Select the Oracle Eloqua connector.":::    


1.Configure the service details, test the connection, and create the new linked service.

   :::image type="content" source="media/connector-oracle-eloqua/configure-oracle-eloqua-linked-service.png" alt-text="Configure a linked service to Oracle Eloqua.":::

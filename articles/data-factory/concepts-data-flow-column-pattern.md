...
:::image type="content" source="media/data-flow/add-column-pattern.png" alt-text="Screenshot shows the plus icon to Add column pattern." title="Column Patterns":::
...
:::image type="content" source="media/data-flow/edit-column-pattern.png" alt-text="Screenshot shows the Derived column's settings tab." title="Column Patterns":::
...
:::image type="content" source="media/data-flow/columnpattern3.png" alt-text="Screenshot shows the Output schema tab." title="Column Patterns":::
...
:::image type="content" source="media/data-flow/patterns-hierarchy.png" alt-text="Screenshot shows hierarchical column pattern." title="Column Patterns in Hierarchies":::
...
:::image type="content" source="media/data-flow/rule2.png" alt-text="Screenshot shows Rule-based mapping selected from Add mapping." title="Rule-based mapping":::
...
:::image type="content" source="media/data-flow/rule-based-mapping.png" alt-text="Screenshot shows a mapping." title="Rule-based mapping":::
...
:::image type="content" source="media/data-flow/regex-matching.png" alt-text="Screenshot shows the regex-mapping condition with Hierarchy level and Name matches." title="Rule-based mapping":::
...
:::image type="content" source="media/data-flow/rule-based-hierarchy.png" alt-text="Screenshot shows a rule-based mapping using for a hierarchy." title="Rule-based mapping":::

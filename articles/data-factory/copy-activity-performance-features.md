...
You need to grant delete permission to your Azure Data Factory in your staging Azure Blob Storage or Azure Data Lake Storage Gen2, so that the staged copy data can be deleted after the copy activity runs.

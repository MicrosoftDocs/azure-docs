...
- [Migrate data from on-premise hadoop cluster to Azure](data-migration-guidance-hdfs-azure-storage.md)
- [Migrate data from on-premise Netezza server to Azure](data-migration-guidance-netezza-azure-sqldw.md)

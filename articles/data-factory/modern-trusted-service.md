...
> [!NOTE]
> To ensure a smooth transition and avoid service disruptions, we recommend planning your migration to Modern mode before August 1, 2027.
After August 1, 2027, Legacy mode will be retired and will no longer be available. After this date, all Trusted Service configurations will operate only in Modern mode.

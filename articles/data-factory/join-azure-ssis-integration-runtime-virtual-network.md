...
- When you create Azure-SSIS IR, you can bring your own public IP addresses and specify them via [Data Factory UI or SDK](azure-ssis-integration-runtime-virtual-network-configuration.md#join-the-azure-ssis-ir-to-a-virtual-network). Only the outbound internet connectivity of Azure-SSIS IR will use your provided public IP addresses and other devices in the subnet will not use them.

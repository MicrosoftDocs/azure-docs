...
- You want to host SSIS catalog database (SSISDB) in an Azure SQL Database with IP firewall rules/virtual network service endpoints or a SQL Managed instance with private endpoint. 

...
> [!NOTE] If you are new to Azure Data Factory, read through [Introduction to Azure Data Factory](data-factory-introduction.md) and do the tutorial with step-by-step instructions [Build your first data pipeline](data-factory-buid-your-first-pipeline.md) before reading this article. 

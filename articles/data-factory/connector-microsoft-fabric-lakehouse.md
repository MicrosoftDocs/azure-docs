...
| schema | When you apply Lakehouse with schemas as the linked service, specify the name of your schema. If you don't specify a schema name, the service will use `dbo` as the default schema. | No |

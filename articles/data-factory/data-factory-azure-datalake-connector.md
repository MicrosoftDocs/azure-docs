...
> [!IMPORTANT]
> The authorization code you generated by using the **Authorize** button expires after sometime. **Reauthorize** using the **Authorize** button when the **token expires** and redeploy the linked service. See [Azure Data Lake Store Linked Service](#azure-data-lake-store-linked-service-properties) section for details. 
> 
> 

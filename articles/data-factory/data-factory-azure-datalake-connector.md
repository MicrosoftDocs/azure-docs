...
> [!IMPORTANT]
> When using copy wizard to author, make sure to grant the service principal at least Reader role in Access control (IAM) for the ADLS account AND at least Read+Execute permission to your ADLS root ("/"), in order to successfully navigate among the folders. Otherwise you may see "The credentials provided are invalid" error.
>

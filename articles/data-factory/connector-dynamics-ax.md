...
| aadResourceId | Specify the AAD resource you are requesting for authorization. For example, if your Dynamics URL is `https://sampledyanmics.sandbox.operations.dynamics.com/data/`, the corresponding AAD resource is usually `https://sampledyanmics.sandbox.operations.dynamics.com`. | Yes |
...
```json
{
    ...
    "properties": {
        ...
        "typeProperties": {
            ...
            "aadResourceId": "<AAD resource, e.g. https://sampledyanmics.sandbox.operations.dynamics.com>"
        }
    },
    "connectVia": {

...
:::image type="content" source="media/data-flow/unpivot1.png" alt-text="Screenshot shows Unpivot selected from the menu." title="Unpivot options 1":::

> [!VIDEO https://www.microsoft.com/en-us/videoplayer/embed/RE4B1RR]

## Ungroup By

:::image type="content" source="media/data-flow/unpivot5.png" alt-text="Screenshot shows the Unpivot Settings with the Ungroup by tab selected." title="Unpivot options 2":::
...
:::image type="content" source="media/data-flow/unpivot6.png" alt-text="Screenshot shows the Unpivot Settings with the Unpivot key tab selected." title="Unpivot options 3":::
...
:::image type="content" source="media/data-flow//unpivot7.png" alt-text="Screenshot shows the Unpivot Settings with the Data Preview tab selected." title="Unpivot options 4":::
...
:::image type="content" source="media/data-flow//unpivot7.png" alt-text="Screenshot shows the result of the transformation." title="Unpivot options 5":::

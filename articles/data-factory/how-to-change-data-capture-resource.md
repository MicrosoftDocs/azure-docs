...
1.	Navigate to the **Author** blade in your data factory. You will see a new top-level artifact under **Pipelines** called **Change data capture (preview)**. 
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-2.png" alt-text="Screenshot of new top level artifact shown under Factory resources panel.":::
...
2.	To create a new **Change data capture**, hover over **Change data capture (preview)** until you see 3 dots appear. Click on the **Change data capture actions**. 
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-3.png" alt-text="Screenshot of Change data capture (preview) Actions after hovering on the new top-level artifact.":::
...
9.	Then, select a **Target type** using the drop-down selection. For this tutorial, we will select **Azure SQL Database**. 
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-10.png" alt-text="Screenshot of a drop-down selection menu of all data target types.":::

10.	You will then be prompted to select a linked service. Create a new linked service or select an existing one. 
 
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-11.png" alt-text="Screenshot of the selection box to choose or create a new linked service to your data target.":::
...
11.	Create new **Target table(s)** or select an existing **Target table(s)**. Use the checkbox to make your selection(s). The **Preview** button will allow you to view your table data. 
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-12.png" alt-text="Screenshot of the create new tables button and the selection boxes to choose tables for your target.":::

12.	Click **Continue** when you have finalized your selection(s). 

  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-13.png" alt-text="Screenshot of the continue button in the guided process to proceed to the next step.":::
...
15.	Once you’ve selected your tables, you should see that there are columns mapped. Select the **Column mappings** button to view the column mappings. 
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-16.png" alt-text="Screenshot of the mapping icon to view column mappings.":::
...
16.	Here you can view your column mappings. Use the drop-down lists to edit your column mappings for **Mapping method**, **Source column**, and **Target** column.
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-17.png" alt-text="Screenshot of the column mappings.":::
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-18.png" alt-text="Screenshot of the Add new mapping icon to add new column mappings.":::

17.	When your mapping is complete, click the back arrow to return to the main canvas. 

   :::image type="content" source="media/adf-cdc/adf-cdc-artifact-19.png" alt-text="Screenshot of the arrow icon to return to the main change data capture canvas.":::
...
> You can add additional source to target mappings in one CDC artifact. Use the edit button to select more data sources and targets. Then, click **New mapping** and use the drop-down lists to set a new source and target mapping.
   ...
   :::image type="content" source="media/adf-cdc/adf-cdc-artifact-20.png" alt-text="Screenshot of the edit button to add new sources.":::
...
1.	To monitor your change data capture, navigate to the **Monitor** blade or click the monitoring icon from the CDC designer. 
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-27.png" alt-text="Screenshot of the monitoring blade.":::
...
3.	Here you can see the **Source**, **Target**, **Status**, and **Last processed** time of your change data capture. 
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-30.png" alt-text="Screenshot of an overview of the change data capture monitoring page.":::
...
4.	Click the name of your CDC to see more details. You can see how many rows were read and written and other diagnostic information. 
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-31.png" alt-text="Screenshot of the detailed monitoring of a selected change data capture.":::
...
> If you have multiple mappings set up in your Change data capture, each mapping will show as a different color. Click on the bar to see specific details for each mapping or use the Diagnostics at the bottom of the screen. 
  ...
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-32.png" alt-text="Screenshot of the detailed monitoring page of a change data capture with multiple source to target mappings.":::
  
  :::image type="content" source="media/adf-cdc/adf-cdc-artifact-33.png" alt-text="Screenshot of a detailed breakdown of each mapping in the change data capture artifact.":::

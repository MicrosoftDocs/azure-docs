...
* **Azure SQL Database**. You use the database as the source data store. If you don't have a database in Azure SQL Database, see [Create a dataqbase in Azure SQL Database](../azure-sql/database/single-database-create-quickstart.md) for steps to create one.

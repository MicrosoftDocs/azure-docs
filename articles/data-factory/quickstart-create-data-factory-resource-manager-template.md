---
title: Create a data factory using Azure Resource Manager template | Microsoft Docs
...
---
# Create a data factory using Azure Resource Manager template | Microsoft Docs

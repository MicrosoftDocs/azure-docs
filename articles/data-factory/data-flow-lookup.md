...
:::image type="content" source="media/data-flow/lookup1.png" alt-text="Screenshot shows the Lookup settings tab with the labels described in the following text." title="Lookup":::
...
:::image type="content" source="media/data-flow/non-equi-lookup.png" alt-text="Non-equi lookup" title="Non-equi lookup":::
...
:::image type="content" source="media/data-flow/lookup111.png" alt-text="Lookup pattern" title="Lookup pattern":::
...
:::image type="content" source="media/data-flow/lookup-dsl-example.png" alt-text="Screenshot shows the Lookup settings tab for the following code." title="Lookup":::

...
:::image type="content" source="media/sap-cdc-solution/sap-cdc-shir-diagnostics-send-logs.png" alt-text="Shows a screenshot of the self-hosted integration runtime (SHIR) configuration manager's Diagnostics tab highlighting the send logs button.":::
...
:::image type="content" source="media/sap-cdc-solution/sap-cdc-diagnostics-report-id.png" alt-text="Shows a screenshot of the self-hosted integration runtime's diagnostic log dialog with the Report ID and Timestamp highlighted.":::
 
## Next steps

[Auto-generate ADF pipeline from SAP data partitioning template](sap-cdc-data-partitioning-template.md)

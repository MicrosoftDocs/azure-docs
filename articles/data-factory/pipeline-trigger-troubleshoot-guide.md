...
Perform network tracing of your API call from ADF portal using Edge/Chrome browser **Develoepr tools**. You will see offending JSON payload, which could be due to a special characters, spaces and other types of user input. Once you fix the string expression, you will proceed with rest of  ADF usage calls in the browser.

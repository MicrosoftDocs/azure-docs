...
description: Learn how you can use Web Activity, one of the control flow activities supported by Azure Data Factory and Synapse Analytics, to invoke a REST endpoint from a pipeline.
author: nabhishek
ms.author: abnarain

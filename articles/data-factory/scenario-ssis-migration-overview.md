---
title: Migrate on-premises SSIS workloads to SSIS in ADF | Microsoft Docs
...
Get [DMA](https://docs.microsoft.com/en-us/sql/dma/dma-overview), and [perform your package assessment with it](https://docs.microsoft.com/en-us/sql/dma/dma-assess-ssis).

## Migration

Depending on the [storage types](#ssis-has-four-storage-types-for-packages) of source SSIS packages and the migration destination of database workloads, the steps to migrate  **SSIS packages** and **SQL Server Agent jobs** that schedule SSIS package executions may vary. There are two scenarios:

- [**Azure SQL Database managed instance** as database workload destination](#azure-sql-database-managed-instance-mi-as-database-workload-destination)
- [**Azure SQL Database** as database workload destination](#azure-sql-database-as-database-workload-destination)

### **Azure SQL Database managed instance** as database workload destination

| **Package storage type** |How to batch-migrate SSIS packages|How to batch-migrate SSIS jobs|
|-|-|-|
|SSISDB|[Migrate **SSISDB**](scenario-ssis-migration-ssisdb-mi.md)|[Migrate SSIS jobs to Azure SQL Database managed instance agent](scenario-ssis-migration-ssisdb-mi.md#redeploy-sql-server-agent-jobs-to-azure-sql-database-managed-instance)|
...
- [Lift and shift SSIS workloads to the cloud](https://docs.microsoft.com/en-us/sql/integration-services/lift-shift/ssis-azure-lift-shift-ssis-packages-overview?view=sql-server-2017)
- [Migrate SSIS packages to Azure SQL Database managed instance](https://docs.microsoft.com/en-us/azure/dms/how-to-migrate-ssis-packages-managed-instance)
- [Redeploy packages to Azure SQL Database](https://docs.microsoft.com/en-us/azure/dms/how-to-migrate-ssis-packages)

## Next steps

- [Validate SSIS packages deployed to Azure](https://docs.microsoft.com/en-us/sql/integration-services/lift-shift/ssis-azure-validate-packages)
...
- [Monitor Azure-SSIS Integration Runtime](https://docs.microsoft.com/en-us/azure/data-factory/monitor-integration-runtime#azure-ssis-integration-runtime)
- [Schedule SSIS package executions in Azure](https://docs.microsoft.com/en-us/sql/integration-services/lift-shift/ssis-azure-schedule-packages)

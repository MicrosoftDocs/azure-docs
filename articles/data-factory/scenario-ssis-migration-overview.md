...
- [**Azure SQL Managed instance** as database workload destination](#azure-sql-database-managed-instance-as-database-workload-destination)
...
|-|-|-|
|SSISDB|[Migrate **SSISDB**](scenario-ssis-migration-ssisdb-mi.md)|[Migrate SSIS jobs to Azure SQL Managed instance agent](scenario-ssis-migration-ssisdb-mi.md#ssis-jobs-to-azure-sql-database-managed-instance-agent)|

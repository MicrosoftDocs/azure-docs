...
---
# Move data from Amazon Redshift by using Azure Data Factory Copy Activity
This article explains how you can use Copy Activity in Azure Data Factory to move data from Amazon Redshift. You can copy data from Amazon Redshift to any store that is listed as a supported sink in the [Data Factory data movement activities](data-factory-data-movement-activities.md#supported-data-stores-and-formats) article. This topic builds on the Data Factory article, which presents an overview of data movement by using Copy Activity. 

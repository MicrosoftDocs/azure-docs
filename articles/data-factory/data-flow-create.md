...
:::image type="content" source="media/data-flow/v2portal.png" alt-text="Screenshot shows the New data factory pane with V2 selected for Version." title="data flow create":::
...
:::image type="content" source="media/data-flow/template.png" alt-text="Screenshot shows the Data Flow tab with Transform data using data flow selected." title="data flow create":::

You will be prompted to enter your Azure Blob Storage account information.

:::image type="content" source="media/data-flow/template2.png" alt-text="Screenshot shows the Transform data using data flow pane where you can enter User Inputs." title="data flow create 2":::
...
:::image type="content" source="media/data-flow/newresource.png" alt-text="Screenshot shows Data Flow selected from the Factory Resources menu." title="New Resource":::

...
:::image type="content" source="media/data-flow/surrogate.png" alt-text="Surrogate Key Transform" title="Surrogate Key Transformation":::
...
:::image type="content" source="media/data-flow/cached-lookup-example.png" alt-text="Surrogate Key lookup" title="Surrogate Key lookup":::
...
:::image type="content" source="media/data-flow/surrogate-key-max-database.png" alt-text="Surrogate Key Query" title="Surrogate Key Transformation Query":::
...
:::image type="content" source="media/data-flow/surrogate-key-max-file.png" alt-text="Surrogate Key File" title="Surrogate Key File":::

...
>[!NOTE]
>This connector only support copy data to/from Cosmos DB SQL API. For MongoDB API, refer to [Cosmos DB MongoDB API connector](connector-azure-cosmos-db-mongodb-api). Other API types are not supported now.

...
| [HubSpot](connector-hubspot.md) | The following HubSpot tables are supported for automatic upgrade:<br><br>Hubspot.Deal_Properties, Hubspot.Company_Properties, Hubspot.Deals, Hubspot.Deal_Associations_Associated_Vids, Hubspot.Contact_Properties, Hubspot.All_Deals, Hubspot.Contact_Lists, Hubspot.Deal_Properties_Options, Hubspot.Contact_Properties_Options, Hubspot.Companies_Properties_Values, Hubspot.Deal_Pipelines_Stages, Hubspot.Companies, Hubspot.Contacts, Hubspot.Deal_Properties_Values, Hubspot.Deal_Pipelines, CRM.Contact_Properties_Values, Hubspot.Deal_Associations_Associated_Company_Ids, Hubspot.Contacts_List_Memberships, Hubspot.Contacts_Identity_Profiles_Identities, Hubspot.TicketPipeLines, Hubspot.TicketPipeLinesStages, Hubspot.LineItemProperties, Hubspot.Deal_Property_Groups, Hubspot.CRMDealsPipeLinesStages, Hubspot.LineItemPropertiesOptions, Hubspot.Contact_Property_Groups, Hubspot.Contacts_Identity_Profiles, Hubspot.Users, Hubspot.EmailSubscriptions, Hubspot.CallEngagementDisposition, Hubspot.Tickets, Hubspot.Forms, CRM.CompanyProperties, CRM.DealProperties, CRM.Owners, CRM.LineItemProperties. <br><br>If your pipeline runs on self-hosted integration runtime, it requires SHIR version 5.64 or above. |
...
| [Xero](connector-xero.md) | Scenario that doesn't rely on below capability in Xero (version 1.0):<br><br>• Use OAuth 1.0 authentication type. <br><br>The following Xero tables are supported for automatic upgrade: <br><br>Accounts, AssetSettings, AssetTypes, Associations, Bank_Transaction_Line_Item_Tracking, Bank_Transaction_Line_Items, Bank_Transactions, Bank_Transfers, BankFeedConnections, Branding_Themes, Budgets, Contact_Group_Contacts, Contact_Groups, Contacts, Contacts_Addresses, Contacts_Contact_Persons, Contacts_Phones, Contacts_Purchases_Tracking_Categories, Contacts_Sales_Tracking_Categories, Credit_Note_Line_Items, Credit_Notes, Credit_Notes_Allocations, Credit_Notes_Line_Items_Tracking, Currencies, Employees, Expense_Claim_Payments, Expense_Claim_Receipts, Expense_Claim_Validation_Errors, Expense_Claims, Files, Folders, Invoice_Line_Items, Invoices, Invoices_Credit_Notes, Invoices_Line_Items_Tracking, Invoices_Overpayments, Invoices_Prepayments, Items, Journal_Line_Tracking_Categories, Journal_Line_Tracking_Categories_Options, Journal_Lines, Journals, Manual_Journal_Line_Tracking, Manual_Journal_Lines, Manual_Journals, Organisation_Addresses, Organisation_External_Links, Organisation_Phones, Organisations, Overpayment_Line_Items, Overpayment_Line_Items_Tracking, Overpayments, Overpayments_Allocations, Payments, Prepayment_Line_Item_Tracking, Prepayment_Line_Items, Prepayments, Prepayments_Allocations, ProjectTasks, ProjectUsers, Projects, Purchase_Order_Line_Item_Tracking, Purchase_Order_Line_Items, Purchase_Orders, Quotes, Receipt_Line_Item_Tracking, Receipt_Line_Items, Receipt_Validation_Errors, Receipts, Repeating_Invoice_Line_Item_Tracking, Repeating_Invoice_Line_Items, Repeating_Invoices, Statements, Tax_Rate_Tax_Components, Tax_Rates, Time, Tracking_Categories, Tracking_Category_Options, Users.   <br><br>If your pipeline runs on self-hosted integration runtime, it requires SHIR version 5.62 or above. |

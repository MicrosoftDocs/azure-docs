...
## Run Copy and Dataflow activity and push lineage data to Azure Purview
...
![Screenshot for creating a connection between Data Factory and Purview account](./media/data-factory-purview/connect-adf-to-purview.png)
...
![Screenshot of Purview account](./media/data-factory-purview/view-dataset.png)

You can see lineage data for Copy activity.
![Screenshot of Copy lineage](./media/data-factory-purview/copy-lineage.png)

You also can see lineage data for Dataflow activity.
![Screenshot of Dataflow lineage](./media/data-factory-purview/dataflow-lineage.png)

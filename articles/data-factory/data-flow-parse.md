...
:::image type="content" source="media/data-flow/data-flow-parse-1.png" alt-text="Parse settings" title="Parse":::
...
:::image type="content" source="media/data-flow/data-flow-parse-2.png" alt-text="Parse example" title="Parse example":::

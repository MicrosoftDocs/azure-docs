...
To copy data from FTP in **ORC/JSON format**, the following properties are supported:
...
To copy data from FTP in **ORC/JSON format**, the following properties are supported in the copy activity **source** section:

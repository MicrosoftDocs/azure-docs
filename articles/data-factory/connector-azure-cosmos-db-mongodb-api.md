...
>[!TIP]
>ADF support consuming BSON document in **Strict mode**. Make sure your filter query is in Strict mode instead of Shell mode. More description can be found in the [MongoDB manual](https://www.mongodb.com/docs/manual/reference/mongodb-extended-json/).

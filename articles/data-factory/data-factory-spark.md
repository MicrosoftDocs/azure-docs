...
You find sample pipelines in the **ADFJsons/Pipeline** folder. This is the most important entity that you need to review to understand how to invoke a Spark program by using the MapReduce activity. 
...
> [AZURE.IMPORTANT] Read through [README.TXT](https://github.com/Azure/Azure-DataFactory/blob/master/Samples/Spark/README.txt) for the latest and additional information before using the sample.  

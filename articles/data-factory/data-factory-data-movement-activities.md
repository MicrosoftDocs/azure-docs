...
| [SQL Server on IaaS](data-factory-sql-server-iaas-connector.md) | Azure Blob, Azure Table, Azure SQL Database, On-premises SQL Server, SQL Server on IaaS |
...
| [On-premises SQL Server](data-factory-onprem-sql-server-connector.md) | Azure Blob, Azure Table, Azure SQL Database, On-premises SQL Server, SQL Server on IaaS |

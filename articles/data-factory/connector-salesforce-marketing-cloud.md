---
title: Copy data from Salesforce Marketing Cloud using Azure Data Factory (Beta) | Microsoft Docs
...
---
# Copy data from Salesforce Marketing Cloud using Azure Data Factory (Beta)

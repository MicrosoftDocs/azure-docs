...
![Managed Identity Value](media/how-to-use-azure-key-vault-secrets-in-pipeline-activities/managedidentity.png)

2. Open the key vault access policies and add the managed identity permissions to Get and List secrets.
![Key Vault access policies](media/how-to-use-azure-key-vault-secrets-in-pipeline-activities/akvaccesspolicies.png)

    ![Key Vault access policies](media/how-to-use-azure-key-vault-secrets-in-pipeline-activities/akvaccesspolicies_2.png)

    Click **Add**, then click **Save**.

3. Navigate to your Key Vault secret and copy the Secret Identifier.
![Secret Identifier](media/how-to-use-azure-key-vault-secrets-in-pipeline-activities/secretidentifier.png)
...
4. In your Data Factory pipeline, add a new Web activity and configure it as follows.  
    ...
    ![Web activity](media/how-to-use-azure-key-vault-secrets-in-pipeline-activities/webactivity.png)
...
![Code expression](media/how-to-use-azure-key-vault-secrets-in-pipeline-activities/usewebactivity.png)

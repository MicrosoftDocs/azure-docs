...
- The Azure Resource Manager template required to deploy Data Factory itself is not included. Rather the integration assumes the Data Factory itself has been deployed and this integration applies to everything defined in the Data Factory.

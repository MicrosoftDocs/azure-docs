...
Follow the steps in [Provision an Azure Active Directory administrator for SQL Managed Instance](azure-sql/database/authentication-aad-configure#provision-azure-ad-admin-sql-managed-instance).

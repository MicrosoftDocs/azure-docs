...
* **Partition Root Path**: If you have partitioned folders in your file source of a ```key=value``` format (i.e. year=2019), then you can ask ADF to assign the top-level of that parition folder tree to a column name in your data flow data stream.

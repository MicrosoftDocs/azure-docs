...
:::image type="content" source="media/data-flow/syms-source.png" alt-text="Screenshot that shows workspacedb selected." title="Screenshot that shows workspace DB selected.":::
...
:::image type="content" source="media/data-flow/source1.png" alt-text="Screenshot that shows the Source settings tab." title="Screenshot that shows the Source settings tab.":::
...
:::image type="content" source="media/data-flow/source3.png" alt-text="Screenshot that shows settings on the Projection tab." title="Screenshot that shows settings on the Projection tab.":::
...
:::image type="content" source="media/data-flow/sourcepart3.png" alt-text="Screenshot that shows the Source partition settings." title="Screenshot that shows the Source partition settings.":::

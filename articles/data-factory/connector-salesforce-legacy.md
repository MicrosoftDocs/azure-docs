...
>[!IMPORTANT]
>Please kindly [upgrade your Salesforce connector](connector-salesforce.md#upgrade-the-salesforce-linked-service) before October 11, 2024. If not, connection will start to fail because of the deprecation of the legacy connector.
...
2. Search for Salesforce and select the Salesforce connector.
    ...
    :::image type="content" source="media/connector-salesforce-legacy/salesforce-legacy-connector.png" alt-text="Screenshot of the Salesforce connector.":::    

1. Configure the service details, test the connection, and create the new linked service.

    :::image type="content" source="media/connector-salesforce-legacy/configure-salesforce-legacy-linked-service.png" alt-text="Screenshot of linked service configuration for Salesforce.":::

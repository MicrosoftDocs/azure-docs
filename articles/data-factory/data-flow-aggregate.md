...
:::image type="content" source="media/data-flow/agg.png" alt-text="Aggregate transformation group by settings" title="Aggregate transformation group by settings":::
...
:::image type="content" source="media/data-flow/aggregate-columns.png" alt-text="Aggregate settings" title="Aggregate settings":::
...
:::image type="content" source="media/data-flow/agg-dedupe.png" alt-text="Deduplication" title="Deduplication":::
...
:::image type="content" source="media/data-flow/agg-script1.png" alt-text="Group by example" title="Group by example":::

:::image type="content" source="media/data-flow/agg-script2.png" alt-text="Aggregate example" title="Aggregate example":::
...
:::image type="content" source="media/data-flow/aggdfs1.png" alt-text="Aggregate data flow script" title="Aggregate data flow script":::

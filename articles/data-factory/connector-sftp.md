...
To copy data from SFTP in **ORC format**, the following properties are supported:
...
To copy data from SFTP in **ORC format**, the following properties are supported in the copy activity **source** section:

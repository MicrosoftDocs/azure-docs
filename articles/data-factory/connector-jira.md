...
> [!IMPORTANT]
> The Jira connector version 1.0 is at [removal stage](connector-release-stages-and-timelines.md). You are recommended to [upgrade the Jira connector](#jira-connector-lifecycle-and-upgrade) from version 1.0 to 2.0.

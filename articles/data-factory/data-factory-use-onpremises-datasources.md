...
2.	Replace the JSON in the right pane with the following text:    
	...
	- For an input table that is not generated by another pipeline in Azure Data Factory, you must set **external** property to **true**. You can optionally specify policies in the **externalData** section.   

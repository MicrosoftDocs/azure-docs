...
Once you see the data preview, you can generate a quick transformation to typecast, remove or do a simple modification on a column. Click on the column header and then select one of the options from the data preview toolbar.
...
The **Typecast** and **Modify** columns will generate a Derived Column transformation and the **Remove Column** will generate a Select transformation.

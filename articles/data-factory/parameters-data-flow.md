...
:::image type="content" source="media/data-flow/create-params.png" alt-text="Create Data Flow parameters" title="Create Data Flow parameters":::
...
:::image type="content" source="media/data-flow/parameter-expression.png" alt-text="Screenshot shows the available parameters in the Parameters tab." title="Data flow parameter expression":::

You can quickly add additional parameters by selecting **New parameter** and specifying the name and type.

:::image type="content" source="media/data-flow/new-parameter-expression.png" alt-text="Screenshot shows the parameters in the Parameters tab with new parameters added." title="Data flow parameter expression":::
...
:::image type="content" source="media/data-flow/parameter-assign.png" alt-text="Screenshot shows the Parameters tab with Data Flow expression selected for the value of myparam." title="Setting a Data Flow parameter":::
...
:::image type="content" source="media/data-flow/parameter-pipeline.png" alt-text="Screenshot shows the expression builder pane." title="Setting a Data Flow parameter":::
...
:::image type="content" source="media/data-flow/string-parameter.png" alt-text="Screenshot shows the Data flow parameters pane Expression selected for a parameter." title="Setting a Data Flow parameter":::
...
:::image type="content" source="media/data-flow/parameter-timestamp.png" alt-text="Screenshot shows the Parameters tab where you can enter a trigger time." title="Setting a Data Flow parameter":::
...
:::image type="content" source="media/data-flow/parameter-pipeline-2.png" alt-text="Screenshot shows the Parameters tab with parameters named stringParam and intParam." title="Setting a Data Flow parameter":::

`@pipeline.parameters.pipelineParam` is assigned a value of `abs(1)` at runtime.

:::image type="content" source="media/data-flow/parameter-pipeline-4.png" alt-text="Screenshot shows the Parameters tab with the value of a b s (1) selected." title="Setting a Data Flow parameter":::

When `$intParam` is referenced in an expression such as a derived column, it will evaluate `abs(1)` return `1`. 

:::image type="content" source="media/data-flow/parameter-pipeline-3.png" alt-text="Screenshot shows the columns value." title="Setting a Data Flow parameter":::
...
:::image type="content" source="media/data-flow/parameterize-column-name.png" alt-text="Passing in a column name as a parameter" title="Passing in a column name as a parameter":::

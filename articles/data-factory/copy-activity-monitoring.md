...
| rowsRead | Number of rows read from the source. It does not apply when copying files as-is. | Int64 value (no unit) |
| rowsCopied | Number of rows copied to sink. It does not apply when copying files as-is.  | Int64 value (no unit) |

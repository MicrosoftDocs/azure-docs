...
:::image type="content" source="media/data-flow/alter-row1.png" alt-text="Alter row settings" title="Alter Row Settings":::
...
:::image type="content" source="media/data-flow/alter-row4.png" alt-text="Alter row policy" title="Alter row policy":::
...
:::image type="content" source="media/data-flow/alter-row3.png" alt-text="Alter row policies" title="Alter Row Policies":::
...
:::image type="content" source="media/data-flow/alter-row2.png" alt-text="Alter row sink" title="Alter Row Sink":::
...
:::image type="content" source="media/data-flow/alter-row4.png" alt-text="Alter row example" title="Alter row example":::

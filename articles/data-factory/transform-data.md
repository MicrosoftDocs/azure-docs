...
The Azure Synapse Notebook Activity in a Synapse pipeline runs an Azure Synapse notebook in your Azure Synapse workspace. See [Transform data by running an Azure Synapse notebook](../synapse-analytics/synapse-notebook-activity.md).

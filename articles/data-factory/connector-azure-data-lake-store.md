...
>[!NOTE]
>When you use **Copy Data Tool** to author copy pipeline or use **ADF UI** to perform testing connection/navigating folders during authoring, it requires the permission of service principal being granted **at root level with "Execute" permission** in order to list folders starting from root. While, copy activity execution can work as long as the permission is granted to the data to be copied. You may skip the authoring operations if you need limit the permission.
...
>[!NOTE]
>When you use **Copy Data Tool** to author copy pipeline or use **ADF UI** to perform testing connection/navigating folders during authoring, it requires the permission being granted **at root level with "Execute" permission** in order to list folders starting from root. While, copy activity execution can work as long as the permission is granted to the data to be copied. You may skip the authoring operations if you need limit the permission.

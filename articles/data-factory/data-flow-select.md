...
:::image type="content" source="media/data-flow/fixedmapping.png" alt-text="Fixed mapping" title="Fixed mapping":::
...
:::image type="content" source="media/data-flow/select-hierarchy.png" alt-text="hierarchical mapping" title="hierarchical mapping":::
...
:::image type="content" source="media/data-flow/automap.png" alt-text="Auto mapping" title="Auto mapping":::
...
:::image type="content" source="media/data-flow/select-skip-dup.png" alt-text="Skip Duplicates" title="Skip Duplicates":::
...
:::image type="content" source="media/data-flow/select-script-example.png" alt-text="Select script example" title="Select script example":::

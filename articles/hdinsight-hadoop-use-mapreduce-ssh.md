...
In this article, you will learn how to use SSH to connect to a Hadoop on HDInsight cluster and then submit MapReduce jobs using the Hadoop command.
...
1. Once connected to the HDInsight cluster, use the following to use the **Hadoop** command to start a MapReduce job.

...
Outage impacted resource information can be retrieved programmatically using the Events API. The API documentation [here](../resourcehealth/impacted-resources/list-by-subscription-id-and-event-id?tabs=HTTP.md) provides the details around how customers can access this data. 

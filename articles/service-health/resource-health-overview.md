...
> [!NOTE]
> You can query data up to 1 year using the QueryStartTime parameter of [Events](https://docs.microsoft.com/en-us/rest/api/resourcehealth/events/list-by-subscription-id) REST API.

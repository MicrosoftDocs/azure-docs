...
If you're installing common apps like Office 365 ProPlus and OneDrive on your VM, see [Install Office on a master VHD image](install-office-on-wvd-master-image.md). When you're done following the instructions in that article, return to this article.

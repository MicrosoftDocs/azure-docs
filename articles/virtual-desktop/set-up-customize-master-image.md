...
To include the FSLogix container as part of the image, follow the instructions in [set up user profiles for a host pool](create-host-pools-user-profile-disk.md#configure-the-fslogix-profile-container).

...
* A Windows Server Active Directory in sync with Azure Active Directory. This can be enabled through:
  ...
  * Azure AD Domain Services
  >[!NOTE] Windows Virtual Desktop only supports Azure AD Domain Services users who are sourced from Azure Active Directory. Users sourced from Windows Server AD are not supported at this time.

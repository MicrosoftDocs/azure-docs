...
- Version 1.0.4009.1500: This update was released January 2022 and has the following changes:
    - Added logging to better capture agent update telemetry.
    - Updated the agent's Azure Instance Metadata Service health check to be HCI friendly

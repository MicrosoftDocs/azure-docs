...
- Fixed an issue with App Attach diagnostics that created constant timeout exception reports. Now the agent only reports timeout exceptions to diagnostics when app attach registration fails.

...
**Cause:** The subscription you're using is a type that can't access required features in the region where customer is trying to deploy. For example, MSDN, Free, or Edu subscriptions can show this error.

---
title: What's new in Azure Insights?
description: New features and product updates in Azure Insights.
author: Heidilohr
ms.topic: conceptual
ms.date: 08/16/2022
ms.author: helohr
...
---
# What's new in Azure Insights?

This article describes the changes we make to each new version of Azure Insights.

If you're not sure which version of Azure Insights you're currently using, you can find it in the bottom-right corner of your Insights page or configuration workbook. To access your workbook, go to [https://aka.ms/azmonwvdi](https://aka.ms/azmonwvdi).

## How to read version numbers

There are three numbers in each version of Azure Insights. Here's what each number means:
...
- We removed five expensive process performance counters from the default configuration. For more information, see our blog post at [Updated guidance on Azure Insights](https://techcommunity.microsoft.com/t5/windows-virtual-desktop/updated-guidance-on-azure-monitor-for-wvd/m-p/2236173).
...
To learn more about Azure Insights, see [Use Azure Insights to monitor your deployment](azure-insights.md).

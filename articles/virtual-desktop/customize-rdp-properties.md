...
>- A null CustomRdpProperty field will mean that all default RDP properties will be applied. An empty CustomRdpProperty field will mean that no default RDP properties will be applied.

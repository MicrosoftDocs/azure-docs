...
The Windows Virtual Desktop service (preview) offers FSLogix profile containers as the recommended user profile solution. We don't recommend using the FSLogix profile container solution, which will be deprecated in future versions of Windows Virtual Desktop.

---
title: Set up a user profile share for a Windows Virtual Desktop host pool  - Azure
description: How to set up an FSLogix profile container for a Windows Virtual Desktop host pool.
...
1. [Connect to the virtual machine](https://docs.microsoft.com/azure/virtual-machines/windows/quick-create-portal#connect-to-virtual-machine) with the credentials you provided when creating the virtual machine.
2. Launch an internet browser and navigate to [this link](https://go.microsoft.com/fwlink/?linkid=2084562) to download the FSLogix agent. Windows Virtual Desktop includes a license key to activate the FSLogix software. The key is the LicenseKey.txt file included in the FSLogix agent .zip file.

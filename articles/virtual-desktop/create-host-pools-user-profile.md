...
This article will tell you how to set up a FSLogix profile container share for a host pool using a virtual machine-based file share. Please note we recommend usign Azure File instead of file shares. For more FSLogix documentation, see the [FSLogix site](https://docs.fslogix.com/).

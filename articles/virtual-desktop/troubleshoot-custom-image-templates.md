...
To learn how to interpret Azure Image Builder logs, see [Troubleshoot Azure VM Image Builder](https://learn.microsoft.com/en-us/azure/virtual-machines/linux/image-builder-troubleshoot#customization-log).

...
| Azure Virtual Desktop app for Windows | [Connect to Azure Virtual Desktop with the Azure Virtual Desktop app for Windows](connect-windows-azure-virtual-desktop-app.md) | [What's new](../whats-new-client-windows-azure-virtual-desktop-app.md) |

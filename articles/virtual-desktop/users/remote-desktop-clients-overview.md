...
|--|--|--|
| Windows<br /><ul><li>Remote Desktop client (MSI)</li>| [Connect to Azure Virtual Desktop with the Remote Desktop client for Windows](connect-remote-desktop-client.md?tabs=windows) | [What's new](../whats-new-client-windows.md) |

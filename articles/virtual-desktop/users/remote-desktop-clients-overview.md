...
| Azure Virtual Desktop app for Windows | [Connect to Azure Virtual Desktop with the Azure Virtual Desktop app for Windows](connect-windows-avd-app.md) | [What's new](../whats-new-client-windows-avd-app.md) |

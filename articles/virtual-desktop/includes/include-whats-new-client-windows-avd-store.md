...
|--|--|--|
| Public | 1.2.5716  | [Microsoft Store](https://aka.ms/AVDStoreClient) |
| Insider | 1.2.5804 | Download the public release, then [Enable Insider releases](../users/client-features-windows.md#enable-insider-releases) and check for updates. |

## Updates for version 1.2.5900 (Insider) 
...
> [!NOTE]
> This version replaced the Insider versions 1.2.5799, 1.2.5800, 1.2.5802, and 1.2.5804. Changes noted above reflect all changes for these versions. 

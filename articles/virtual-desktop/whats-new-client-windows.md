...
>[!IMPORTANT]
>This is the final version of the Remote Desktop client with Windows 7 device support. After this version, if you try to use the Remote Desktop client with a device running Windows 7, it may not work as expected. For more information about which versions of Windows the Remote Desktop client supports, see [Prerequisites](./users/connect-windows.md?toc=%2Fazure%2Fvirtual-desktop%2Ftoc.json&tabs=subscribe#prerequisites).

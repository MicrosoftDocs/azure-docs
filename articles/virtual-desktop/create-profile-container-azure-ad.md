...
3- [Enable Azure Active Directory Kerberos authentication on Azure Files](https://docs.microsoft.com/azure/storage/files/storage-files-identity-auth-azure-active-directory-enable) to enable access from Azure AD-joined VMs.
...
1. Enable the Azure AD Kerberos functionality using one of the methods below. Once configured, restart the system for the changes to take effect.
    ...
    - Policy CSP: [Kerberos/CloudKerberosTicketRetrievalEnabled](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-kerberos#kerberos-cloudkerberosticketretrievalenabled)
...
Finally, verify the profile created in Azure Files after the user successfully signed in:

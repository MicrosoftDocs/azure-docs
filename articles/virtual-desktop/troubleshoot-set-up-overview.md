...
| Remote desktop clients malfunction on start                                                 | See [Troubleshoot the Remote Desktop client](troubleshoot-rdp-client.md) and if that doesn't resolve the issue,  **Open a support request for Windows Virtual Desktop (Compute)**.  <br> <br> If it's a network issue, your users need to contact their network administrator. |
| Connected but no feed                                                                 | Troubleshoot using the "User connects but nothing is displayed (no feed)" section of [Troubleshoot the Remote Desktop client](troubleshoot-rdp-client.md). <br> <br> If your users have been assigned to an app group,  **open a support request for Windows Virtual Desktop (Compute)**. |
...
- To learn about actions to determine errors during deployment, see [View deployment operations](../azure-resource-manager/azure-resource-manager/resource-manager-deployment-operations.md).

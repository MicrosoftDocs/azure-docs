...
| Managing Windows Virtual Desktop configuration tied to host pools and application groups (appgroups)      | See [Troubleshoot issues when using PowerShell with Windows Virtual Desktop](troubleshoot-powershell), or contact the **Remote Desktop Services/Windows Virtual Desktop support team**. <br> <br> If issues are tied to the sample graphical user interface (GUI), reach out to the Yammer community.|
| Remote desktop clients malfunction on start                                                 | See [Troubleshoot Windows Virtual Desktop client connection issues](troubleshoot-client-connection) and if that doesn't resolve the issue, contact **Remote Desktop Services/Windows Virtual Desktop support team**.  <br> <br> If it's a network issue, your users need to contact their network administrator. |
...
| Connecting clients                                                                    | See [Troubleshoot Windows Virtual Desktop client connection issues](troubleshoot-client-connection.md) and if that doesn't solve your issue, see [Troubleshoot Windows Virtual Desktop session host VM configuration](troubleshoot-vm-configuration). |
...
- To troubleshoot issues with Windows Virtual Desktop client connections, see [Troubleshoot Windows Virtual Desktop client connection issues](troubleshoot-client-connection).

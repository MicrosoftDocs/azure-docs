...
| App Attach health check | Verifies that the [App Attach](app-attach-overview.md) service is working as intended during package staging or destaging. | If this check fails, it isn't fatal. However, certain apps stop working for end-users. |

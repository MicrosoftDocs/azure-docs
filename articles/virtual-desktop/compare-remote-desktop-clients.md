...
| Feature | Windows Desktop and Azure Virtual Desktop app | Remote Desktop app | Android or Chrome OS | iOS or iPadOS | macOS | Web | Description |
|--|--|--|--|--|--|--|--|
...
| Input | Windows Desktop and Azure Virtual Desktop app | Remote Desktop app | Android or Chrome OS | iOS or iPadOS | macOS | Web client |
|--|--|--|--|--|--|--|
...
| Redirection | Windows Desktop and Azure Virtual Desktop app for Windows | Remote Desktop app | Android or Chrome OS | iOS or iPadOS | macOS | Web client |
|--|--|--|--|--|--|--|
| Serial port | X |  |  |  |  |  |
| USB | X |  |  |  |  |  |
...
| Redirection | Windows Desktop and Azure Virtual Desktop app | Remote Desktop app | Android or Chrome OS | iOS or iPadOS | macOS | Web client |
|--|--|--|--|--|--|--|

...
3. If you're deploying in a Cloud Solution Provider subscription, follow these steps to deploy to Azure:
...
7. Enter the appropriate information to connect and authenticate to Windows Virtual Desktop:
    ...
    7. For **Is Service Principal**, select the appropriate value for the **Tenant Admin Upn or Application Id** principal.
        1. If you selected **true** for **Is Service Principal**, enter your Azure AD Tenant ID for the **Aad Tenant Id** parameter to successfully authenticate to Windows Virtual Desktop as a service principal. Otherwise, leave this parameter empty.

...
>[!IMPORTANT]
>The Log Analytics Agent is currently being deprecated. While Azure Monitor currently uses the Log Analytics Agent for Azure Virtual Desktop support, you'll eventually need to migrate to Azure Monitor.

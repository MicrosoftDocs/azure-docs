...
- [Getting started with FSLogix profile containers on Azure Files in Windows Virtual Desktop](https://docs.microsoft.com/en-us/azure/virtual-desktop/create-file-share)

...
- Search for and select **Azure Monitor** from the Azure portal. Select **Insights Hub** under **Insights**, and select **Windows Virtual Desktop**.
...
If you already have performance counters enabled and want to remove them, follow the instructions in [Configuring performance counters](../azure-monitor/agents/data-sources-performance-counters.md).  While the article describes how to add counters, you can also remove them in the same location.
...
If you already have Windows Event logs enabled and want to remove them, follow the instructions in [Configuring Windows Event logs](../azure-monitor/agents/data-sources-windows-events#configuring-windows-event-logs.md).  While the article describes how to add Windows Event logs, you can also remove them in the same location.

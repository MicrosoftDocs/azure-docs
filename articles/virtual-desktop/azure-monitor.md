...
description: How to use Azure Insights.
author: Heidilohr
ms.topic: how-to
ms.date: 03/31/2020
ms.author: helohr
manager: femila
---
# Use Azure Insights to monitor your deployment

Azure Insights is a dashboard built on Azure Monitor Workbooks that helps IT professionals understand their Azure Virtual Desktop environments. This topic will walk you through how to set up Azure Insights to monitor your Azure Virtual Desktop environments.

## Requirements

Before you start using Azure Insights, you'll need to set up the following things:
...
Anyone monitoring Azure Insights for your environment will also need the following read-access permissions:
...
You can open Azure Insights with one of the following methods:
...
- Search for and select **Azure Insights** from the Azure portal. Select **Insights Hub** under **Insights**, then select **Azure Virtual Desktop**.
...
If it's your first time opening Azure Insights, you'll need set up Azure Insights for your Azure Virtual Desktop environment. To configure your resources:

1. Open Azure Insights in the Azure portal at [aka.ms/avdi](https://aka.ms/avdi), then select **configuration workbook**.
...
Azure Insights allows you to monitor Azure Monitor alerts happening within your selected subscription in the context of your Azure Virtual Desktop data. Azure Monitor alerts are an optional feature on your Azure subscriptions, and you need to set them up separately from Azure Insights. You can use the Azure Monitor alerts framework to set custom alerts on Azure Virtual Desktop events, diagnostics, and resources. To learn more about Azure Monitor alerts, see [Azure Monitor Log Alerts](../azure-monitor/alerts/alerts-log.md).

## Diagnostic and usage data

Microsoft automatically collects usage and performance data through your use of the Azure Insights service. Microsoft uses this data to improve the quality, security, and integrity of the service.
...
Now that you’ve configured Azure Insights for your Azure Virtual Desktop environment, here are some resources that might help you start monitoring your environment:

- Check out our [glossary](azure-monitor-glossary.md) to learn more about terms and concepts related to Azure Insights.
- To estimate, measure, and manage your data storage costs, see [Estimate Azure Insights costs](azure-monitor-costs.md).
- If you encounter a problem, check out our [troubleshooting guide](troubleshoot-azure-monitor.md) for help and known issues.
- To see what's new in each version update, see [What's new in Azure Insights](whats-new-azure-monitor.md).

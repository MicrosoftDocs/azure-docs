...
| [The Azure Virtual Desktop program icon with a red square with an x that indicates multimedia redirection isn't working.](/virtual-desktop/media/icon-disconnect.png) | The red square with an "X" inside of it means that the client couldn't connect to multimedia redirection. |
| [The Azure Virtual Desktop program icon with a green square with a check mark inside of it, indicating that multimedia redirection is working.](/virtual-desktop/media/icon-connect.png) | The green square with a check mark inside of it means that the client successfully connected to multimedia redirection. |

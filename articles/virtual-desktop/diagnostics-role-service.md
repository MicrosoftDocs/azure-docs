...
|8008|TenantConsentRequired|Follow the instructions [here](tenant-setup-azure-active-directory.md#grant-consent-to-the-windows-virtual-desktop-preview-service) to provide consent for your tenant.|

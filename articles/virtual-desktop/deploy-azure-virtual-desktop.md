...
1. *Optional*: On the **Virtual machines** tab, if you want to add session hosts, complete the following information:
   ...
   | Hibernate | Select the check box to enable hibernate. Hibernate is only available for personal host pools.<br /><br />For more information, see [Hibernation in virtual machines](/azure/virtual-machines/hibernate-resume). |

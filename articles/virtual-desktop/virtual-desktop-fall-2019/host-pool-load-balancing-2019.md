...
description: Learn about host pool load-balancing methods for a Windows Virtual Desktop (Fall 2019 version) environment.
...
manager: lizross
---
# Host pool load-balancing methods (Fall 2019)

...
description: How to configure the assignment type for a Windows Virtual Desktop (Fall 2019 version) personal desktop host pool.
...
manager: lizross
---
# Configure the personal desktop host pool assignment type (Fall 2019)

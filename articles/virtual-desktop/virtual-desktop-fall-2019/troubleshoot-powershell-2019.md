...
description: How to troubleshoot issues with PowerShell when you set up a Windows Virtual Desktop (Fall 2019 version) tenant environment.
...
manager: lizross
---
# Windows Virtual Desktop PowerShell (Fall 2019)

...
>[!NOTE]
>If you're using the Windows Virtual Desktop Spring 2020 release with Azure Resource Manager objects, use the web client link in [this article](../connect-web.md) to connect to your resources.

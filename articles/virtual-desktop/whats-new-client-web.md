...
> [!NOTE]
> What's new information used to be combined for the Remote Desktop Web client for Azure Virtual Desktop and Remote Desktop Services. You can find information for versions earlier than 2.0.1.1 at [What's new in the web client](/windows-server/remote/remote-desktop-services/clients/web-client-whatsnew).

## Updates for version 2.0.1.1 (preview)

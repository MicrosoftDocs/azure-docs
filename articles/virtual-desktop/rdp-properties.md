...
Organizations can configure Remote Desktop Protocol (RDP) properties centrally in Azure Virtual Desktop to determine how a connection to Azure Virtual Desktop should behave. There are a wide range of RDP properties that can be be set, such as for device redirection, display settings, session behavior, and more. For more information, see [Customize RDP properties for a host pool](customize-rdp-properties.md).

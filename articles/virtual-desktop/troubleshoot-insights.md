...
- •	To install the Azure Monitor Agent extension on a session host manually, see [Azure Monitor Agent virtual machine extension for Windows](../azure-monitor/agents/azure-monitor-agent-manage#install).
...
- •	To validate the Data Collection Rules in use, see [View data collection rules](../azure-monitor/essentials/data-collection-rule-overview#view-data-collection-rules).
...
- You may need to open outgoing ports in your server's firewall to allow Azure Monitor to send data to the portal. To learn how to do this, see the following articles:
      - [Azure Monitor Outgoing ports](../azure-monitor/app/ip-addresses.md)
      - [Define Azure Monitor Agent network settings - Firewall Requirements.](../azure-monitor/agents/azure-monitor-agent-data-collection-endpoint.md#firewall-requirements). 

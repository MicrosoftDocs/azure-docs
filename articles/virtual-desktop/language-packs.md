...
- The Language ISO, Feature on Demand (FOD) Disk 1 and Inbox Apps ISO of the OS version the image uses. You can download them here:
     ...
     - Inbox Apps ISO:
        ...
        - [Windows 10, version 2004 FOD Disk 1 ISO](https://software-download.microsoft.com/download/pr/19041.1.191206-1406.vb_release_amd64fre_InboxApps.iso)
...
```
>[!IMPORTANT]
>The inbox apps included in the ISO are not the latest versions of the pre-installed Windows apps. To get the latest version of all apps, you need to update the apps using the Windows Store App and perform an manual search for updates after you installed the additional languages.

When you are done, disconnect the share.

...
8. Enter the new number of session hosts you want into **Number of VMs**. For example, if you're expanding your host pool from five session hosts to eight, enter **3**. 

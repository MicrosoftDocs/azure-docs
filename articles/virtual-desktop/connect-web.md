...
description: How to connect to the Windows Virtual Desktop Preview from a web browser.
...
>[!NOTE]
>If you're already signed in using an Azure AD account that is different than the one you would like to use for Windows Virtual Desktop, you may need to sign out or use a private browser window.

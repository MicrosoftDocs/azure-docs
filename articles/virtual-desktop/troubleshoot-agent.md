...
>[!NOTE]
>For troubleshooting issues related to session connectivity and the Windows Virtual Desktop agent, we advise that you review the event logs in **Event Viewer** > **Windows Logs** > **Application**. Look for events that have one of the following sources:
>
>- WVD-Agent
>- WVD-Agent-Updater
>- RDAgentBootLoader
...
1. Sign in to your VM as an administrator. Note that the agent installer for Windows 7 and Windows 10 VMs are different. If you have a Windows 10 VM, follow the instructions in [Register virtual machines](create-host-pools-powershell.md#register-the-virtual-machines-to-the-windows-virtual-desktop-host-pool) to download the **Windows Virtual Desktop Agent** and the **Windows Virtual Desktop Agent Bootloader**. If you have a Windows 7 VM, follow steps 13-14 in [Register virtual machines](deploy-windows-7-virtual-machine.md#configure-a-windows-7-virtual-machine) to download the **Windows Virtual Desktop Agent** and the **Windows Virtual Desktop Agent Manager**.

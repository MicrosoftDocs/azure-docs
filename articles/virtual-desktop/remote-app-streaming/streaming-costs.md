...
- [Azure Insights for your Azure Virtual Desktop deployment](../azure-insights.md)

## Measure monthly user activity in a host pool

In order to estimate total costs for running a host pool, you'll first need to know the number of active users over the past month. You can use Azure Insights to find this number.

To check monthly active users on Azure Insights:

1. Open the Azure portal, then search for and select **Azure Virtual Desktop**. After that, select **Insights** to open Azure Insights.

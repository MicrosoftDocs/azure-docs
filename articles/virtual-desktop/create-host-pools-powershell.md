...
>[!NOTE]
>The token's expiration date can be no less than one day and no more than one month. If you set *-ExpirationHours* outside of that limit, the cmdlet won't create the token.

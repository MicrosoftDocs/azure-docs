...
> - **Use the ‘[WindowsVirtualDesktop’](/azure/virtual-desktop/required-fqdn-endpoint) service tag**: This tag now includes the new subnet, simplifying firewall and network rule configuration.

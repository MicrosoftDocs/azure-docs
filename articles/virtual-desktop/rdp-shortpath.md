...
> [!IMPORTANT]
> Due to change in the data flow between session host and client, there will be standard [Azure egress network charges](https://azure.microsoft.com/pricing/details/bandwidth/) for the internet bandwidth consumed. To learn more about estimating the bandwidth used by RDP, see [RDP bandwidth requirements](rdp-bandwidth.md).
...
- Understand how to estimate the bandwidth used by RDP, see [RDP bandwidth requirements](rdp-bandwidth.md).

...
- Review the valid configurations for setting up remote networks here - [Global Secure Access remote network configurations](https://learn.microsoft.com/azure/global-secure-access/reference-remote-network-configurations)

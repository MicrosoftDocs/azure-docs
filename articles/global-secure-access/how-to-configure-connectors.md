...
- For more information, see [Determine which .NET framework versions are installed](dotnet/framework/migration-guide/how-to-determine-which-versions-are-installed.md).

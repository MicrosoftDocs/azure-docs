...
Device links are the physical routers that connect your remote networks, such as branch locations, to Global Secure Access (preview). There are a specific set of combinations you must use if you choose the **custom** option when adding device links.

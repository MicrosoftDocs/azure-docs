...
## How to stream the logs

To stream the logs to a storage account or SIEM tool, you need to configure Diagnostic settings for the Microsoft Entra Private Access service. 

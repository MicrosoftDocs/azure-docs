...
The Global Secure Access network traffic dashboard provides you with visualizations of the network traffic acquired by the Microsoft Entra Private and Internet Access services. The dashboard compiles the data from your network configurations, including devices, users, and tenants into several widgets that provide you with answers to the following questions:
...
To view the Global Secure Access network traffic dashboard, you need the following roles and licenses:
...
1. Sign in to the [Entra admin center](https://entra.microsoft.com/#home) as a **Security Administrator** or **Global Administrator**.
...
![Screenshot of the network deployment widget.](media/concept-traffic-dashboard/network-deployment.png)

<properties linkid="web-sites-python-ptvs-bottle-table-storage" title="" pageTitle="Bottle and Azure Table Storage on Azure with Python Tools 2.1 for Visual Studio" description="Learn how to use the Python Tools for Visual Studio to create a Bottle application that stores data in Azure Table Storage and can be deployed to a web site." metaKeywords="" services="web-sites" solutions="" documentationCenter="python" authors="huguesv" videoId="" scriptId="" manager="wpickett" editor=""/>

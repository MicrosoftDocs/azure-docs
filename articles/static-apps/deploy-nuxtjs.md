...
In this tutorial, you will learn how to deploy a [Nuxt.js](https://nuxtjs.org) generated static website to [Azure App Service Static Apps](overview.md). You'll learn how to set up, configure, and deploy a Nuxt.js app. You wil also learn how to deal with the most prominent challenges you might come across when generating static pages with Nuxt.js
...
The reason for this is, when we generated a static site with Nuxt.js, we only did so for the home page. Nuxt.js can generate equivalent static `.html` files for every `.vue` pages file, but there's an exception. 
...
In this *tutorial*, you created a Nuxt.js static website with dynamic routes and deployed it to App Service Static Site using GitHub Actions.

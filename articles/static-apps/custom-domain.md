...
1. Click on **Custom domains** in the menu.
   ...
   ![Custom domains menu option]()

1. In the _Custom domains_ window, copy the URL in the **Value** field.

   ![Custom domains window with app url value highlighted]()
...
![Sample DNS provider configuration interface](media/custom-domain/example-record-ui.png)
...
1. Return to the _Custom domains_ window in the Azure portal.
   ...
   ![Custom domains window]()

1. Enter your domain, including the "www" portion in the _Validate custom domain_ section.

   ![Validate custom domain section]()

1. Click the **Validate** button.

   ![Validate custom domain section]()

1. The portal now shows the domain is validated.

   ![Domain validated message]()

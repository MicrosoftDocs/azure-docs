...
Refer to [Configuring Reliable Stateful Service](service-fabric-reliable-stateful-service-configuration.md) to read more about referencing endpoints from the config package settings file (settings.xml).

<properties pageTitle="Service-side authorization (Windows Phone) | Mobile Dev Center" description="Learn how to authorize users in the .NET backend of Azure Mobile Services." services="" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>

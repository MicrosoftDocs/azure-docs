...
1. Download and unzip the [completed solution](http://code.msdn.microsoft.com/todo).
...
[the completed application](http://code.msdn.microsoft.com/todo), do that now. Instead of creating new files and copying and pasting code into them, you'll copy files from the downloaded project into the new project.

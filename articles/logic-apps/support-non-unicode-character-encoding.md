...
For triggers and actions with the setting **Infer Content Type**, choose **No**. Some of the connectors that support disabling inferring the content type include:

...
1. Check the trigger's status by [checking the trigger history](../logic-apps/logic-apps-monitor-logic-apps.md#review-trigger-history). To view more information about the trigger attempt, select that trigger event, for example:
...
1. Check the workflow's run status by [checking the runs history](../logic-apps/logic-apps-monitor-logic-apps.md#review-runs-history). To view more information about a failed run, including all the steps in that run in their status, select the failed run.
...
* [Monitor your logic app](../logic-apps/logic-apps-monitor-logic-apps.md)

...
| Name | Limit | Notes |
| ---- | ----- | ----- |
| Workflows per region per subscription | - Consumption: 1,000 workflows where each logic app is limited to 1 workflow <br><br>- Standard: No specific limit, but varies based on the selected hosting plan, app activity, size of machine instances, and resource usage ||

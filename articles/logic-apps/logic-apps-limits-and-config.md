...
|------|--------------|-------------------------|-------|
| Array items | 100,000 items | - Stateful workflow: 100,000 items <p>- Stateless workflow: 100 items | The number of array items that a **For each** loop can process. <p><p>To filter larger arrays, you can use the [query action](logic-apps-perform-data-operations.md#filter-array-action). |

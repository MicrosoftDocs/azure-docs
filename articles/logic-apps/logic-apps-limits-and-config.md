...
1. Go to the [Azure portal](https://ms.portal.azure.com). Search for and select **Logic apps**.

1. Select the logic app you want to modify, and then select **Workflow settings**.

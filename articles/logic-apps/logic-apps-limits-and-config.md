...
| Triggers per workflow | - Consumption: 10 triggers <br><br>- Standard: 1 trigger | For Consumption, this limit applies only when you work on the JSON workflow definition, whether in code view or an Azure Resource Manager (ARM) template, not the designer. |

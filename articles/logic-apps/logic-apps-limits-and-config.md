...
Following are limits for count of artifacts added to Integration Account.
...
|----|----|----|
|Agreements|10||
|Other artifact types|25|The types include partners, schemas, certificates and maps. Each type can have up to the limit count of artifacts.|

Standard pricing tier

|Name|Limit|Notes|
|----|----|----|
|Any type of artifact|500|The types include agreements, partners, schemas, certificates and maps. Each type can have up to the limit count of artifacts.|

...
For EAI and EDI bridge-based integration, Logic Apps is the replacement. Logic Apps provides all the same capabilities as BizTalk Services, and more, including: 

* Logic Apps provides cloud-scale consumption-based workflow and orchestration features allowing you to quickly and easily building complex integration solutions using just a browser or with our tools for Visual Studio.

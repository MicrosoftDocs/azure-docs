...
* [Logic App Contributor](../role-based-access-control/built-in-roles.md#logic-app-contributor): Users can perform management tasks, such as view, edit, and update your logic app, but they can't change permissions or access to your logic app.

* [Logic App Operator](../role-based-access-control/built-in-roles.md#logic-app-operator): Users can read, view run history, and enable or disable your logic app, but they can't edit or update your logic app.

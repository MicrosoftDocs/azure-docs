...
* [Logic App Contributor](../role-based-access-control/built-in-roles.md#logic-app-contributor): Users can perform management tasks, such as view, edit, and update your logic app, but not change permissions or access.

* [Logic App Operator](../role-based-access-control/built-in-roles.md#logic-app-operator): Users can view your logic app and the run history, and enable or disable your logic app. This role can't edit or update your logic app.

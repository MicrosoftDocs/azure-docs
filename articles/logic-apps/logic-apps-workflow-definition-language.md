...
|dayOfWeek|Returns the day of week component of a string timestamp. For example `Wednesday`:<br /><br /> `dayOfWeek('2017-03-15T13:27:36Z')`<br /><br /> **Parameter number**: 1<br /><br /> **Name**: Timestamp<br /><br /> **Description**: Required. This is a string that contains the time.| 

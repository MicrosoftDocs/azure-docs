...
1. From the **Apps** page, select the application you want.
   ...
   | Item | Description |
   |------|-------------|
   | **Get started with your first workflow** | Appears only when the application doesn't contain any workflows. |
   | **Build a new workflow** | Appears only when the application contains workflows. |
   | Workflow description box | Where you describe the workflow for the AI assistant to generate. |
   | **Create workflow** | The option to open the workflow designer. |
   | Workflow list | Shows any previously built workflows. |

1. Choose a starting point to create your workflow.
...
1. On the **Workflows** page, in the workflow description box, enter a detailed description about the process you want to automate.
...
1. For **Workflow name**, enter a descriptive name, and select **Build**.
...
1. On the **Workflows** page, select **Create workflow**.

1. For **Workflow name**, enter a descriptive name, and select **Build**.

   The designer opens and shows an empty canvas with the **Add a trigger** placeholder.
...
|----------------|---------------|-------------|
| **Built-in operations** | Logic Apps Automation | Triggers and actions that directly and natively work in the isolated runtime with its own compute, networking, virtual network integration, and security. <br><br>These operations run faster, offer more capacity or throughput, and provide other benefits beyond their resource-sharing counterparts. |
...
- [Quickstart docs - Logic Apps Automation portal](https://auto.azure.com/docs/getting-started/quickstart/)

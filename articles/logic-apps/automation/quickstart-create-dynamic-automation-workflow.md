---
title: Create Dynamic Agentic Automated Workflows
...
This guide shows how to create a [workflow]() in Logic Apps Automation, while introducing key concepts along the way. You'll complete the following tasks:

---
title: Create parameters for varying values in single-tenant workflows
description: Define parameters to use for values in workflows that can differ across deployment environments for single-tenant Azure Logic Apps.
services: logic-apps

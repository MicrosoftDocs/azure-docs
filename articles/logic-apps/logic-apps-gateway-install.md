...
* Local computer requirements: Refer to the [install requirements guide](/data-integration/gateway/service-gateway-install) for operating system and hardware requirements

...
* [Power BI on-premises data gateway](https://docs.microsoft.com/power-bi/service-gateway-onprem)
* [Power Apps on-premises data gateway](https://docs.microsoft.com/powerapps/maker/canvas-apps/gateway-reference)

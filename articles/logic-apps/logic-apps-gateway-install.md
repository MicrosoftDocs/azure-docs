...
* Local computer requirements: For operating system and hardware requirements refer to the  [main how to guide for installing the on-premises data gateway](/data-integration/gateway/service-gateway-install)

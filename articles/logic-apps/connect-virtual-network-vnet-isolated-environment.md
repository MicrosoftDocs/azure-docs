...
1. After Azure successfully validates your ISE information, choose **Create**, for example:
   ...
   Azure starts deploying your environment, which *might* take up to two hours or more to finish. To check deployment status, on your Azure toolbar, choose the notifications icon, which opens the notifications pane.

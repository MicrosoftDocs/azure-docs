...
and then choose **Review + create**, for example:
   ...
   | **SKU** | **Premium** or **Developer** | Yes | The ISE level to create. For more information, see [ISE SKUs](../logic-apps/connect-virtual-network-vnet-isolated-environment-overview.md#ise-level). |

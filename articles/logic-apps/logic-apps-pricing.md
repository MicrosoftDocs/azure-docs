...
| Storage operations | The ISE model includes storage consumption, such as data retention, *for free*. For more information, review [Storage operations](#storage-operations). |

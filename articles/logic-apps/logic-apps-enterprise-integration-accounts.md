...
For your Logic apps to access to maps, schemas, agreements, and other artifacts located in your integration account, link the integration account to your Logic app.
...
5. You see a notification that indicates that your integration account has been linked to your logic app, and that all artifacts in your integration account are now available to your Logic app:  

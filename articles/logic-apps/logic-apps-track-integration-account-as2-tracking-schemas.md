...
| direction | Yes | String | Direction of the message flow, receive or send |
...
| isNrrEnabled | Yes | Boolean | Whether to use default value if the value is not known |
| isMdnExpected | Yes | Boolean | Whether to use the default value if the value is not known |
...
| isMessageFailed | Yes | Boolean | Whether the AS2 message failed |
| isMessageSigned | Yes | Boolean | Whether the AS2 message was signed |
| isNrrEnabled | Yes | Boolean | Whether to use the default value if the value is not known |

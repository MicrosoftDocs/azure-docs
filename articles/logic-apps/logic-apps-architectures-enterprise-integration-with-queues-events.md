...
This reference architecture shows a set of proven practices for an integration application that uses Azure Integration Services. This architecture can serve as the basis of many different application patterns requiring HTTP APIs, workflow and orchestration.

...
### [Trigger logic apps with event grids for virtual machine tagging](../event-grid/trigger-logic-app-event-grid-tag-virtual-machine-vm.md)
...
### [Add schemas for XML validation](logic-apps-enterprise-integration-schemas.md)
...
### [Custom APIs / web apps](logic-apps-create-api-app.md)
...
### [Flat file](logic-apps-enterprise-integration-flatfile.md)

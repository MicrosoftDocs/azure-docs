...
* At least two [partners](../logic-apps/logic-apps-enterprise-integration-partners.md) already defined in your integration account  
...
After you've [created an integration account](../logic-apps/logic-apps-enterprise-integration-accounts.md) and [added partners](../logic-apps/logic-apps-enterprise-integration-partners.md), you can create an X12 agreement by following these steps:  

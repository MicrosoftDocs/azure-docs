...
1. Now add one or more actions that process each batch.
   ...
   1. In the search box, enter `send email` as your filter. Based on your email provider, select an email connector.
      ...
      For example, if you have a work or school account, such as @fabrikam.com or @fabrikam.onmicrosoft.com, select the **Outlook for Microsoft 365** connector. If you have a personal account, such as @outlook.com or @hotmail.com, select the **Outlook.com** connector. This example uses the Outlook for Microsoft 365 connector.

...
| `SuppressWorkflowHeaders` | String | Logic Apps will send additonal metadata as part of headers on the outbound requests. These metadata headers will have 'x-ms-' prefix in the header name. <p><p>Some legacy services can be sensitive to any additional unknown headers and result in failure of the requests. <p>Setting this option will stop Logic Apps from sending 'x-ms-*' metadata headers as part of outbound requests. | Actions: <p>[Http](#http-action), <br>[Function](#function-action), <br>ApiManagement | 
| `SuppressWorkflowHeadersOnResponse` | String | Logic Apps will send additonal metadata as part of headers on the response to incoming trigger requests. These metadata headers will have 'x-ms-' prefix in the header name. <p><p>Some legacy services can be sensitive to any additional unknown headers and result in failure of the requests and reponses. <p>Setting this option will stop Logic Apps from sending 'x-ms-*' metadata headers as part of request trigger responses. | Triggers: <p>[Request](#request-trigger), <br>[HTTP Webhook](#http-webhook-trigger) | 
||||

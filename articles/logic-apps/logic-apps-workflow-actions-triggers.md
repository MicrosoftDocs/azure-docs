---
title: Schema reference for trigger and action types - Azure Logic Apps
...
* When concurrency is enabled, the [SplitOn limit](../logic-apps/logic-apps-limits-and-config.md) is reduced for [debatching arrays](#split-on-debatch). If the number of items exceeds this limit, the SplitOn capability is disabled.

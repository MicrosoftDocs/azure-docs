...
|200|10|Run the workflow, and check again for more content in 10 seconds subject to the defined recurrence. If the defined recurrence is less than 10 seconds the retry-after header will take precedence. Otherwise the defined recurrence is followed.|  

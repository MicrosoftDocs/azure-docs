...
* Your gateway resource and gateway installation don't exist in the same region. You need to ensure that your gateway installation matches the region that you are trying to create the gateway resource in in Azure. However, your logic app's location can differ from your gateway resource location.

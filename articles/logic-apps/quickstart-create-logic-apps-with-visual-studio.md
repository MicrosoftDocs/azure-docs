...
description: Quickstart for how to automate tasks and processes with Azure Logic Apps in Visual Studio
services: logic-apps
...
# Quickstart: Create logic apps that automate tasks and processes with Azure Logic Apps - Visual Studio

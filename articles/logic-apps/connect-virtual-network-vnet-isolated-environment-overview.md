---
title: Access to Azure virtual Network from Azure Logic Apps
...
instance into your virtual network. The private instance 
uses dedicated resources such as storage, and runs 

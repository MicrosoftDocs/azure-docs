...
* **Developer**
  ...
  > [!IMPORTANT]
  > This SKU has no service-level agreement (SLA), scale up capability, published limits, 
  > or redundancy during recycling, which means that you might experience delays or downtime. 

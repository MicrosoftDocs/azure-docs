...
1. Based on your SAP system configuration, provide the [required parameters](#connector-parameters), and add any other parameters available for this trigger, for example:

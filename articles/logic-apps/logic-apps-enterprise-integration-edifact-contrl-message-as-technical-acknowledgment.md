...
|UCI5|Syntax Error Code|Identifies the error condition (if any). For more information, see [EDIFACT CONTRL Acknowledgment Error Codes](./logic-apps-enterprise-integration-edifact-contrl-acknowledgment-error-codes.md).<br /><br /> This data element has conditional optionality.|  

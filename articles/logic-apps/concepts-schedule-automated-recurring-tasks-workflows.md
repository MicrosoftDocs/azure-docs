...
| Recurrence | Run at 8:00 AM every day (with start date and time) | 1 | Day | *startDate*T08:00:00Z | {unavailable} | {none} | {none} | With a start date and time but no minutes, this schedule uses the minutes from the start time. | 
...
| Recurrence | Run every Tuesday, Thursday at 5 PM | 1 | Week | {none} | "Tuesday", "Thursday" | 17 | {none} | Without minutes and a start date and time, this schedule runs every Tuesday and Thursday at uses the minutes from the start time. |

...
| Recurrence | Run at 8:00 AM every day (no start date and time) | 1 | Day | {none} | {unavailable} | 8 | {none} | Without minutes and a start date and time, this schedule uses the minutes from the time when you save the logic app (PUT operation). |
| Recurrence | Run at 8:00 AM every day (with start date and time) | 1 | Day | *startDate*T08:00:00Z | {unavailable} | {none} | {none} | This schedule runs at 8:00 AM every day, based on the specified start time. | 
| Recurrence | Run at 8:30 AM every day (no start date and time) | 1 | Day | {none} | {unavailable} | 8 | 30 | This schedule runs at 8:30 AM every day. |
...
| Recurrence | Run every Tuesday, Thursday at 5 PM | 1 | Week | {none} | "Tuesday", "Thursday" | 17 | {none} | Without minutes and a start date and time, this schedule runs every Tuesday and Thursday but uses the minutes from the start time. |

...
| Recurrence | Run at 8:00 AM every day (with start date and time) | 1 | Day | *startDate*T08:00:00Z | {unavailable} | {none} | {none} | With a start date and time, this schedule uses the minutes from the start time. | 

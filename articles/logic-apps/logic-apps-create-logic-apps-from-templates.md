...
3. Create your logic app with the settings in the table under this image:
   ...
   | **Log Analytics** | **Off** (default) or **On** | Set up [diagnostic logging](../logic-apps/logic-apps-monitor-your-logic-apps-oms.md) for your logic app by using [Azure Monitor logs](../log-analytics/log-analytics-overview.md). Requires that you already have a Log Analytics workspace. | 
   |||| 

...
4. Once you have selected your **Template**, hit **OK**.
    ...
    ![Deployment](../active-directory/connect/media/active-directory-aadconnect-azure-adfs/deployment.png)
...
1. Right-click on the project in the Solution Explorer and go to **Deploy** > **New Deployment...**
    ![New deployment](../app-service-web/media/app-service-deploy-complex-application-predictably/newdeployment.png)
...
5. The status of the deployment appears in the **Output** window (you may need to choose **Azure Provisioning**. 
    ![Output](../app-service-api/media/app-service-api-dotnet-get-started-template/output.png)

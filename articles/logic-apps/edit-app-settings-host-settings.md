...
Both of the following settings are used to manually stop and delete the specified workflows in Standard logic app. Use these settings with caution and only in preproduction environments, such as load or performance test environments, as you can't undo or recover from these operations.

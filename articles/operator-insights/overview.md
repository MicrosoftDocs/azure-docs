...
applications. Azure Operator Insights supports data analysis and monitoring by enabling data lake storage for data and analysis by Artificial Intelligence/Machine Learning (AI/ML) services, including:

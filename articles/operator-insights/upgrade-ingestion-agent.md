...
> - SFTP [Upgrade the agent software](how-to-manage-sftp-agent.md#upgrade-the-agent-software)
> - SFTP [Roll back upgrades or configuration changes](how-to-manage-sftp-agent.md#roll-back-upgrades-or-configuration-changes)
> - MCC [Upgrade the agent software](how-to-manage-mcc-edr-agent.md#upgrade-the-agent-software)

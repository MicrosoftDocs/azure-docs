...
> - SFTP [Update agent configuration](how-to-manage-sftp-agent.md#update-agent-configuration)
> - SFTP [Roll back upgrades or configuration changes](how-to-manage-sftp-agent.md#roll-back-upgrades-or-configuration-changes)
> - MCC [Update agent configuration](how-to-manage-mcc-edr-agent.md#update-agent-configuration)
> - MCC [Roll back upgrades or configuration changes](how-to-manage-mcc-edr-agent.md#roll-back-upgrades-or-configuration-changes)

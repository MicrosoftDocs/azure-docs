...
If you use templates, ensure that you follow the guidelines described in [Templates](./notification-hubs/notification-hubs-templates-cross-platform-push-messages.md)
...
For more information about programmatic access to [Azure Notification Hub Metrics](./monitor-notification-hubs-reference#metrics), see [Programmatic access](/azure-monitor/essentials/rest-api-walkthrough).

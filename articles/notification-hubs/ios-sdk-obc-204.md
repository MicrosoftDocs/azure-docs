...
# Tutorial: Send push notifications to iOS apps using Azure Notification Hubs SDK (v2.0.4)
...
5. Add the Azure Notification Hubs SDK modules.
   ...
   - Integration via Carthage: Add the following dependencies to your Cartfile to include the Azure Notification Hubs SDK in your app:
      ...
      - For more information about using Carthage, see the [Carthage GitHub repository](https://github.com/Carthage/Carthage). You can integrate by copying the binaries into your project, as follows:

         1. Download the [Azure Notification Hubs SDK](https://github.com/Azure/azure-notificationhubs-android/releases) framework provided as a zip file, and unzip it.

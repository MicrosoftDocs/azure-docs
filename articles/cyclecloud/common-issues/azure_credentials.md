...
ms.author: adjohnso
---
# Common Issues: Azure CycleCloud Credentials Resources
...
For more information on Azure CLI operations with service principals, see [Service Principals](/cli/azure/ad/sp?view=azure-cli-latest)

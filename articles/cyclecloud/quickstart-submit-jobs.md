...
Once the jobs are complete and the nodes become idle, the cluster will scale down by terminating the compute VMs.
...
[Continue to Quickstart 3](quickstart-clean-up-resources.md)

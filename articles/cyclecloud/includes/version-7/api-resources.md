...
|**maxCoreCount**  <br>*required*|The maximum number of cores in this bucket, including global and node array limits. Always a multiple of maxCount.  <br>**Example** : `16`|integer|
|**maxCount**  <br>*required*|The maximum number of nodes in this bucket, including global and node array limits  <br>**Example** : `4`|integer|
|**maxPlacementGroupCoreSize**  <br>*required*|The maximum total number of cores in a placement group in this bucket. Always a multiple of maxPlacementGroupSize.  <br>**Example** : `64`|integer|
|**maxPlacementGroupSize**  <br>*required*|The maximum total number of instances in a placement group in this bucket  <br>**Example** : `16`|integer|

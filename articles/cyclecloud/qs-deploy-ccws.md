...
>[!NOTE]
>A Microsoft Entra ID application is necessary for user authentication. Create an application manually if one has not been created by our scripts. See [How to register a Microsoft Entra ID application for Open OnDemand](./how-to/ccws/register-entra-id-app.md) for more information.

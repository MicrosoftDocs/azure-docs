...
:::image type="content" source="../images_7x/create-cluster-selection.png" alt-text="CycleCloud Create New Cluster Screen":::
::: moniker-end

::: moniker range="=cyclecloud-8"
:::image type="content" source="../images_8x/create-cluster-selection.png" alt-text="CycleCloud Create New Cluster Screen":::
::: moniker-end

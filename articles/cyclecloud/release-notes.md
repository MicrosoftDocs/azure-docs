...
|  |  |
| --- | --- |
| [**OpenPBS is a Supported Scheduler Type**](~/openpbs.md)<br/> Need a two sentence blurb for this [Can we link to blog article?](https://techcommunity.microsoft.com/t5/azure-compute/univa-grid-engine-cluster-arrives-in-azure-cyclecloud-8-1/ba-p/1863043) | ![OpenPBS Logo](./images/release-notes/openpbs-logo.jpg) |
...
| [**HPC Pack is a Supported Scheduler Type**](~/hpcpack.md)<br/> HPC is now a supported scheduler type. Need more info in here. [Learn more about HPC Pack + CycleCloud here]() | ![HPC Pack Logo](./images/release-notes/hpcpack-logo.jpg) |

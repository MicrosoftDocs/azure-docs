<properties title="Using Diagnostic Search in Application Insights" pageTitle="Using Diagnostic Search" description="Search and filter individual events, requests, and log traces." metaKeywords="analytics web test" authors="alancameronwills"  manager="kamrani" />

                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>What is Azure IoT?</h3>
                                <p>Learn the basics of Azure IoT, use cases, and an introduction to the services available.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>Security in Azure IoT services</h3>
                                <p>Learn how security forms an integral part of the Azure IoT infrastructure, from devices to cloud.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            <a href="../iot-dps/about-iot-dps.md">What is Azure IoT Hub Device Provisioning Service?</a><br>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            <a href="../time-series-insights/time-series-insights-update-overview.md">What is Azure Time Series Insights?</a><br>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <br><br>
                                                        <h3><a href="/azure-maps/index.yml">Mapping service for your enterprise</a></h3>
                                                        <p>

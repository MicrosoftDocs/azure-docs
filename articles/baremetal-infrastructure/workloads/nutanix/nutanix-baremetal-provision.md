---
title: Provision BareMetal for Nutanix
description: Learn about provisioning your BareMetal Infrastructure for Nutanix.
ms.topic: reference
ms.subservice: baremetal-nutanix
ms.date: 04/14/2021
---

# Provision BareMetal for Nutanix

In this article, we'll look at how to provision your BareMetal Infrastructure instances for Nutanix workloads. 

The first step to provision your BareMetal instances is to work with your Microsoft CSA. They'll help you based on your specific workload needs and the architecture you're deploying. For more information on these topologies, see [Architecture of BareMetal Infrastructure for Nutanix](nutanix-baremetal-architecture.md).
...
> * Nutanix support contract 
> * Licenses and software installation components for Nutanix
> * ExpressRoute connected **on-premises to Azure** (**Optionally**, configure ExpressRoute Global Reach for direct connectivity from on-premises to the Nutanix Database)   
> * Virtual network
> * Gateway creation
...
For volumes, we follow Nutanix's [Optimal Flexible Architecture (OFA) standard](https://docs.nutanix.com/en/database/nutanix/nutanix-database/19/ladbi/about-the-optimal-flexible-architecture-standard.html#GUID-6619CDB7-9667-426E-8471-5A996707D093), with Basic tier and Enterprise configuration. If you have custom storage requirements other than standard "T-shirt sizing," make your custom request through your CSA.

| Basic Configuration(POC/ Testing) | Description | Small | Medium | Large |
| --- | --- | --- | --- | --- |
| /u01 | Nutanix binaries | 500 GB | 500 GB | 500 GB |
...
| --- | --- | --- | --- | --- | --- |
| /u01 | Nutanix binaries | 500 GB | 500 GB | 500 GB | 500 GB |
...
Learn more about BareMetal Infrastructure for Nutanix.

...
|Connectivity from BareMetal to to [service endpoints](https://learn.microsoft.com/azure/virtual-network/virtual-network-service-endpoints-overview) or [private endpoints][def] in a different spoke Vnet connected to vWAN|Yes|

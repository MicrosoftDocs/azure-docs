...
|On Prem Connectivity to Delegated Subnet via Global and Local Expressroute |Yes|
...
|On Prem Connectivity to Delegated Subnet via VPN GW| Yes |
...
|On prem connectivity to Delegated subnet via vWAN attached SD-WAN| No|
|On prem Connectivity via Secured HUB(Az Firewall NVA) | No|

...
1. The MSFT response will include the ESU Keys and the following language:

##### [As a customer](#tab/esu-rep)

1. Draft an email that incluses the following:
   1. Customer name and TPID
   1. Specific Deployment Scenario: Nutanix Cloud Clusters on Azure
   1. Number of Servers, nodes, or both where applicable (for example,HUB) requested to be covered by ESUs
   1. Point of Contact: Name and email address for the person in your company will install or manage the keys once provided. Manage in this context means ensuring that:
      1. Keys are not disclosed to anyone outside your company
      2. Keys are not publicly exposed
1. The MSFT response will include the ESU Keys and [Terms of Use].

##### [As a customer representatove](#tab/esu-rep)

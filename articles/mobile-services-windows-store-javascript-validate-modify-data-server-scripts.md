<properties 
	pageTitle="Use server scripts to validate and modify data (JavaScript) | Mobile Dev Center" 
	description="Learn how to validate and modify data sent using server scripts from your Windows Store JavaScript app." 

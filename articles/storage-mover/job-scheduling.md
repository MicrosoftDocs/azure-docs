...
:::image type="content" source="../media/create-job-scheduling-settings.png" alt-text="Screenshot of the job scheduling settings in Azure Storage Mover.":::

1. Select *Create*.
1. After the job is created, open the job and select *Enable* to activate the schedule.

:::image type="content" source="../media/enable-schedulinge-for-job.png" alt-text="Screenshot of enabling a schedule for a job in Azure Storage Mover.":::
...
:::image type="content" source="../media/edit-job-schedule-settings.png" alt-text="Screenshot of editing schedule settings for an existing job.":::
...
| <a name="AZSM2063"></a>**AZSM2063** |Encountered I/O error while reading source file.  | Verify that the source endpoint location is accessible and has not been changed for the source endpoint. Investigate potential hardware/storage subsystem issues on your server or NAS device. |
| <a name="AZSM2069"></a>**AZSM2069** |Failed to read target file due to permission issues.  | Verify that the agent has been granted permissions to the source location. |
...
| <a name="AZSM2080"></a>**AZSM2080** |Copy failed due to an unknown error.  | This is probably a transient error. Rerun the migration job. |

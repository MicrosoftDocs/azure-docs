...
| GCS S3 Preview                | Azure blob container                         | Ensure the GCS bucket is accessible through the S3-compatible API before migration. Objects in archival storage classes must be restored before migratio |

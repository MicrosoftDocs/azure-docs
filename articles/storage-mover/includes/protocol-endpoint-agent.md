...
| Azure blob container  | Azure blob container       | Blob containers can be in two different subscriptions and storage accounts but have to be within the same tenant |   

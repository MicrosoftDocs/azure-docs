...
> [AZURE.SELECTOR]
[PowerShell](../manage/install-and-configure-windows-powershell.md) 
[Azure  CLI](../manage/install-and-configure-cli.md)
...
| Command                        | Result                                                                                                                                                                                                                         |
|--------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Get-Help                       | Describes how to use the Help system.                                                                                                                                                                                         *Note:* The description includes some information about Help files that does not apply to the Azure module. Specifically, Help files are installed when the module is installed. They are not available for download separately. |

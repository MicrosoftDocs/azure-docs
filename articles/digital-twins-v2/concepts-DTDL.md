...
We strongly recommend using reverse internet addresses as namespaces in DTMI. For example, any dtmi published by Contoso Corp, which has the domain name www.contosocorp.com, should start with:
dtmi:com:contosocorp:
For example:

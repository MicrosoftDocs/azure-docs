...
Using the Azure CLI via the [Azure Cloud Shell](../cloud-shell/overview.md), you can quickly run commands to delete Azure resources. Use this link to [launch Cloud Shell in a new window](https://shell.azure.com).

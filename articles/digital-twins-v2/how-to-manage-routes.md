...
Endpoints and routes are managed with the [**EventRoutes APIs**](how-to-use-apis-sdks.md), the [C# SDK](https://github.com/Azure/azure-sdk-for-net-pr/tree/feature/digitaltwins/sdk/digitaltwins/Azure.DigitalTwins.Core), or with the [Azure Digital Twins CLI](how-to-use-cli.md).

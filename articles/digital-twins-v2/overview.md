...
* Downstream services to handle tasks such as workflow integration (like [Logic Apps](../logic-apps/logic-apps-overview), cold storage, time series integration, or analytics. 

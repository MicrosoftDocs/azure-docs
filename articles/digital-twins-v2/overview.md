...
* Which assembly lines has an average temperature outside the range of 77 and 79 degrees F?
...
* Downstream services to handle tasks such as workflow integration (like [Logic Apps](https://azure.microsoft.com/en-us/services/logic-apps/)), cold storage, time series integration, or analytics. 

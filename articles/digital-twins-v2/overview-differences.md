...
| **Scalability**<br>*Greater* | The previous release had scale limitations for devices, messages, graphs, and scale units. | The new release relies on a new architecture with improved scalability, and has greater compute power.<br><br>See [Reference: Public preview service limits](reference-service-limits.md) for details of the limits in public preview now. |

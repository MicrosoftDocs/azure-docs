...
To create an Azure Function for Azure Digital Twins, you need to follow these steps. The remainder of this article will walk you through these actions one-by-one.
...
Visit [Use the Azure Digital Twins APIs](how-to-use-apis.md) to see how to generate the Azure Digital Twins SDK using AutoRest, and compile it as a re-usable project.

---
title: Tutorial - Sample steps to interact with Seismic DDMS  #Required; page title is displayed in search results. Include the brand.
description: This tutorial shows you how to interact with Seismic DDMS in Project Oak #Required; article description that is displayed in search results. 
...
Seismic DDMS provides the capability to operate on seismic data in the Project Oak Forest instance.
...
* Import the following files into Postman:
  ...
  * [Seismic DDMS Postman collection](https://community.opengroup.org/osdu/platform/pre-shipping/-/blob/main/R3-M10/Azure-M10/Services/DDMS/Seismic.postman_collection.json)

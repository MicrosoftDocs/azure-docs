...
##In this article	
This tutorial shows you how to run the sample, presents the Java code for the MapReduce program, summarizes what you have learned, and outlines some next steps. It has the following sections:
	
1. [Run the sample by using Azure PowerShell](#run-sample)	
2. [Java code for the WordCount MapReduce program](#java-code)
3. [Summary](#summary)	

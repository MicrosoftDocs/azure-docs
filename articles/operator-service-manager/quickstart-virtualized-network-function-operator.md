...
:::image type="content" source="media/identity-for-ubuntu-vm-sns.png" alt-text="Screenshot showing Managed Identity Properties and Id under Essentials.":::
...
You can find this information within the Properties section of the respective objects in the portal or within the outputs generated by the "az deployment group create" command previously executed. These Resource IDs are required in the "SNS Config Group Values" during the creation of Site Network Service.

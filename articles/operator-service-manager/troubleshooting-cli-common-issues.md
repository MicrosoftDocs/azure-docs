...
Configuration group schemas generated by the Azure CLI AOSM Extension exposes a `deployParameters` field which, by default, is an array of JSON objects. There are several reasons you may want to create a CGV with an empty `deployParameters` field:

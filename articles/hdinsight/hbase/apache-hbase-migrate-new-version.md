...
8. **This step is needed only for HBase clusters with Enhanced Writes feature, if you are not using Enhanced Writes feature, skip this step. Change the hbase.rootdir path to point to the container of the original cluster.**

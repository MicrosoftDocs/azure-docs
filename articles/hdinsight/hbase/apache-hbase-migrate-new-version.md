...
8. Change the hbase.rootdir path to point to the container of the original cluster.  This step is only required when migrating to an HBase Enhanced Writes cluster.

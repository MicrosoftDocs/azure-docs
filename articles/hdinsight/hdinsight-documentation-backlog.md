...
------------- | ------------- | -------------- | -------------- | --------------- | --------------
Cluster creation   | Use Azure Data Factory to provision HDInsight clusters		 | 2 | Pending |  [@mumian](https://github.com/mumian) | - |
Automation  | Update the article on [how to create a Spark cluster](hdinsight-apache-spark-jupyter-spark-sql.md) to use an ARM template		| 1 |  Pending | [@mumian](https://github.com/mumian) | -
Automation  | Update the article on [how to create a Storm cluster and run Storm starter samples](hdinsight-apache-storm-tutorial-get-started-linux.md) to use an ARM template		| 1 |  Pending | [@mumian](https://github.com/mumian) | -
Automation  | Update the article on [how to use Sqoop with HDInsight cluster using SSH](hdinsight-use-sqoop-mac-linux.md) to use an ARM template| 1 |  Pending | [@mumian](https://github.com/mumian) | -
Automation  | Update the article on [analyzing sensor data using Apache Storm clusters](hdinsight-storm-sensor-data-analysis.md) to use an ARM template| 1 |  Pending | [@mumian](https://github.com/mumian) | -

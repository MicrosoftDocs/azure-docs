...
2. Use the following command to start an example topology:
	...
	> [AZURE.NOTE] The `*` portion of the file name is used to match the various version numbers in the file name, which is different between HDInsight cluster versions.

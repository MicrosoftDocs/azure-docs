...
> [AZURE.NOTE] While the steps in this document are specific to Windows-based clusters. For steps that will work with a Linux-based cluster, see [Analyze flight delay data using Hive in HDInsight](hdinsight-analyze-flight-delay-data-linux.md)

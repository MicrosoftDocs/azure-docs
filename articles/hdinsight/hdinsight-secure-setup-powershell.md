...
In this section, you will add a virtual machine to the Azure AD VNet, you will install some administrative tools on this VM so you can configure Azure AD organizational unit.

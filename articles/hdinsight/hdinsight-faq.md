...
### I installed a custom component. Is it supported by Microsoft?

No, Microsoft supports only HDInsight cluster components. Microsoft does not support custom components.

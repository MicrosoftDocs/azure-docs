...
- When a new, higher version of HDInsight cluster is created against an existing metastore database, the system upgrades the schema of the metastore, which is irrversable.

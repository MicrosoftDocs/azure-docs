...
* [Use .NET with Apache Hive and Apache Pig on HDInsight](hadoop/apache-hadoop-hive-pig-udf-dotnet-csharp.md)
* [Develop C# solutions with Apache Storm on HDInsight](storm/apache-storm-develop-csharp-visual-studio-topology.md)

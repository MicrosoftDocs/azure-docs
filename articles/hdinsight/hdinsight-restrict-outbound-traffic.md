...
1. Six addresses from [this list of required HDInsight management IP addresses](../hdinsight/hdinsight-management-ip-addresses.md#hdinsight-ip) with a next hop of **Internet**:

...
![Diagram of the data flow through the topology](./media/apache-storm-correlation-topology/correlationtopology.png)
...
2. In **Solution Explorer**, right-click the **SessionInfo** project and select **Properties**.
    ...
    ![Screenshot of menu with properties selected](./media/apache-storm-correlation-topology/selectproperties.png)
...
3. Select **Settings**, then set the following values:
   ...
   * HBaseTableColumnFamily: The column family name
     ...
     ![Image of settings dialog](./media/apache-storm-correlation-topology/settings.png)
...
5. In **Solution Explorer**, right-click the project and select **Submit to Storm on HDInsight**. If prompted, enter the credentials for your Azure subscription.
   ...
   ![Image of the submit to storm menu item](./media/apache-storm-correlation-topology/submittostorm.png)
...
7. Once the topology has been uploaded and submitted to the cluster, the **Storm Topology View** opens and displays the running topology. To refresh the data, select the **CorrelationTopology** and use the refresh button at the top right of the page.
   ...
   ![Image of the topology view](./media/apache-storm-correlation-topology/topologyview.png)
...
For more Storm examples, see [Example topologies for Storm on HDInsight](apache-storm-example-topology.md).

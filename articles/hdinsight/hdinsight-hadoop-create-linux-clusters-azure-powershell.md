...
Azure PowerShell is a powerful scripting environment that you can use to control and automate the deployment and management of your workloads in Azure. This document provides information on how to create a Linux-based HDInsight cluster by using Azure PowerShell, as well as an example script.
...
The two most important parameters that you must set to create Linux clusters are the ones where you specify the OS type and the SSH user details:

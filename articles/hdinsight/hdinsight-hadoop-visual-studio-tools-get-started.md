<properties
	pageTitle="Learn to use Data Lake (HDInsight) Tools for Visual Studio | Microsoft Azure"
...
- A workstation with the following software:
	...
	>[AZURE.NOTE] Currently, the Data Lake Tools for Visual Studio only come with the English version.

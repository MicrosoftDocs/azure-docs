...
| Spark Thrift server |443 |HTTPS |Spark |Spark Thrift server used to submit Hive queries. See [Use Beeline with Hive on HDInsight](apache-hadoop-use-hive-beeline.md) |

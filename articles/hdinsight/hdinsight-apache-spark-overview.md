...
| Ease of use |Spark in HDInsight clusters includes Jupyter notebooks pre-configured. You can use these for interactive data processing and visualization. The URLs is https://CLUSTERNAME.azurehdinsight.net/jupyter. Replace **CLUSTERNAME** with the name of your Spark HDInsight cluster. |

...
For standard clusters, the recommended setting for HiveServer2 authentication is the default which is none. To enable authentication, we recommend upgrading to an [ESP](https://docs.microsoft.com/en-us/azure/hdinsight/domain-joined/hdinsight-security-overview)(Enterprise Security Package) cluster. 
...
Enabling Hiveserver2 SSL is not recommended for either standard or ESP clusters. SSL is enabled on gateway instead.
...
* [Apache Ranger with Hive](https://docs.microsoft.com/en-us/azure/hdinsight/domain-joined/apache-domain-joined-run-hive#:~:text=Create%20Hive%20ODBC%20data%20source%20%20%20,Enter%20hiveuser1%40contoso158.onmicrosoft.c%20...%20%205%20more%20rows%20)

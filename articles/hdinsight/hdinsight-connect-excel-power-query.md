...
3. Perform the following steps based on the Excel version:
    ...
    - Excel 2016
        ...
        a. Click the **Data** menu, click **Get Data** from the **Get & Transform Data** ribbon, click **From Azure**, and then click **From Azure HDInsight(HDFS)**.
    ...
    - Excel 2013/2010
        ...
        a. Click the **Power Query** menu, click **From Azure**, and then click **From Microsoft Azure HDInsight**.

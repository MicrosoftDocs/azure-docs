...
* Execute .NET activities on Azure Batch pool. See the Use Azure Batch linked service section of [Use custom activities in an Azure Data Factory pipeline](../data-factory/dot-net-custom-activity.md)
* Implement the activity as a MapReduce activity. For more information, see [Invoke MapReduce Programs from Data Factory](../data-factory/map-reduce-activity.md).

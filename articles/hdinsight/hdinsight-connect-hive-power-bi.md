...
* **HDInsight cluster**. The cluster can be either a HDInsight cluster with Hive or a newly released Interactive Query cluster. For creating clusters, see [Create cluster](hdinsight-hadoop-linux-tutorial-get-started.md#create-cluster) and create an Interactive Query type cluster.

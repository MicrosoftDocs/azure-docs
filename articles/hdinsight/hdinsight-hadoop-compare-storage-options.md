...
|---|---|---|---|---|---|---|---|
|Azure Data Lake Storage Gen2| General-purpose V2 | Hierarchical (filesystem) | Blob | Standard | Hot, Cool, Archive | 3.6+ | All Except ML Services and Apache Storm|
...
> [!Note]
> Azure Data Lake Storage Gen2 is only supported with Apache Spark 2.3 and above

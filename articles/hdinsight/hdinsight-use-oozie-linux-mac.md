...
1. To obtain the URL to the Oozie service, use the following command:
    ...
    <value>http://ACTIVE-HEADNODE-NAME.randomcharacters.cx.internal.cloudapp.net:11000/oozie</value>
    ```

    The `http://ACTIVE-HEADNODE-NAME.randomcharacters.cx.internal.cloudapp.net:11000/oozie` portion is the URL to use with the Oozie command.

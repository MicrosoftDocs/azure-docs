...
1. Use [Query editor](../sql-database/sql-database-single-database-get-started?tabs=azure-portal.md#query-the-database) to execute the following SQL statements to create the `dailyflights` table that will store the summarized data from each run of the pipeline.

...
1. Create an Azure SQL Database. See [Create an Azure SQL Database in the Azure portal](../azure-sql/database/quickstart-create-single-database.md).
...
1. Use [Query editor](../azure-sql/database/quickstart-create-single-database.md#query-the-database) to execute the following SQL statements to create the `dailyflights` table that will store the summarized data from each run of the pipeline.

...
The backing store for HDInsight can be either Azure Storage or Azure Data Lake Store, and there are a variety of ways to get at the data depending on which one you use. For more information on how to work with Azure Storage and Azure Data Lake Store, see the [HDFS, Blob storage, and Data Lake Store](hdinsight-hadoop-linux-information.md#hdfs-azure-storage-and-data-lake-store) section of the HDInsight on Linux document.

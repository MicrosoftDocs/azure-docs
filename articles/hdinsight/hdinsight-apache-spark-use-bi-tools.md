...
> [!NOTE]
> Connectivity with BI tools described in this article is not supported on Spark 2.1 Preview on Azure HDInsight HDInsight 3.6. Only Spark versions 1.6 and 2.0 (HDInsight 3.4, 3.5 respectively) are supported.
>

...
Read more about IO Cache, including performance benchmarks in this blog post: [Apache Spark jobs gain up to 9x speed up with HDInsight IO Cache](https://learn.microsoft.com/azure/hdinsight/spark/apache-spark-improve-performance-iocache)

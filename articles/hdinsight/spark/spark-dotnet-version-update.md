...
If you don't want to change the current version of .NET for Apache Spark in your application, you would have to change the version on your HDI cluster from v1.0 (default on new clusters) to whichever version you are using. Refer to the [following section](#changing-version-of-.net-for-apache-spark-on-hdinsight-cluster) to learn how to do that.  
...
3. Upload the above mentioned files to the Azure Storage account your cluster has access to. You can refer to [this article](https://docs.microsoft.com/en-us/dotnet/spark/tutorials/hdinsight-deployment#upload-files-to-azure) to see in detail how to do that.  

...
1. Run the following code to add the external Apache Maven libraries:
    ...
    ```
    %%configure
    {"conf":{"spark.jars.packages":"com.microsoft.azure:azure-eventhubs-spark_2.11:2.3.12,org.twitter4j:twitter4j-core:4.0.6"}}
    ```
...
1. Run the following code to add an external Apache Maven library:
    ...
    ```
    %%configure -f
    {"conf":{"spark.jars.packages":"com.microsoft.azure:azure-eventhubs-spark_2.11:2.3.12"}}
    ```

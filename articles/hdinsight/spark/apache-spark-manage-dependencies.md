...
* [Configure jar dependencies for Spark cluster](#cluster-scoped-jar-dependencies)
...
* [Safely manage Python packages for Spark cluster](#set-up-cluster-scoped-python-packages)

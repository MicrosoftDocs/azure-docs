...
## Create Domain users
See [Create a Domain-joined HDInsight cluster](apache-domain-joined-configure.using-azure-adds.md#create-a-domain-joined-hdinsight-cluster), for information to create hiveruser1 and hiveuser2. You use the two user accounts in this tutorial.

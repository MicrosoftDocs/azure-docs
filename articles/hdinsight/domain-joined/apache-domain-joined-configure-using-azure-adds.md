...
If you are using Network Security Groups (NSG) rules in your HDInsight subnet, you should allow the [required IPs](../hdinsight-required-ip-addresses.md) for both Inbound and Outbound traffic. 

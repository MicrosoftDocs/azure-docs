...
After enabling Azure AD-DS, all users and objects will start synchronizing from Azure Active Directory (AAD) to AAD-DS by default. The length of the sync operation depends on the number of objects in AAD. For hundreds of thousands of objects, it could take a few days.

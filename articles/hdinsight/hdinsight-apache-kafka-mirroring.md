...
ms.assetid: 015d276e-f678-4f2b-9572-75553c56625bQQWERTYms.service: hdinsight
ms.devlang: na
ms.topic: article
ms.tgt_pltfrm: na
...
1. Connect to the **source** cluster using SSH. The following is an example of using the `ssh` command:
   ...
   * [Use SSH with HDInsight from a Linux, Mac OS, or Unix client](hdinsight-hadoop-linux-use-ssh-unix.md)

...
> [AZURE.NOTE] The steps in this document require an R Server on HDInsight cluster type and will not work correctly if you are using an HDInsight cluster where R was installed using the [Install R Script Action](hdinsight-hadoop-r-scripts-linux.md).

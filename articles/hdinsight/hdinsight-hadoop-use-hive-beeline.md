...
4. Use the following to run the file using Beeline. Replease __HOSTNAME__ with the name obtained earlier for the head node:

        beeline -u 'jdbc:hive2://HOSTNAME:10001/;transportMode=http' -n admin -p GiantR0b0! -f query.hql

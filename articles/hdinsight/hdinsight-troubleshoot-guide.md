...
| Logs and dumps | [Access Hadoop YARN application logs on Linux](hdinsight-hadoop-access-yarn-app-logs-linux.md)<br>[Enable heap dumps for Hadoop services](hdinsight-hadoop-collect-debug-heap-dump-linux.md)|

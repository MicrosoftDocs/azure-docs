...
When creating a virtual network, Azure provides default name resolution for Azure services such as HDInsight that are installed in the network. However you may need to use your own DNS server for situations such as cross network domain name resolution. For more information on using your own DNS server, see the __Name resolution using your own DNS server__ section of the [Name Resolution for VMs and Role Instances](../virtual-network/virtual-networks-name-resolution-for-vms-and-role-instances.md/#name-resolution-using-your-own-dns-server) document.

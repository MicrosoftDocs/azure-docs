...
* Use Visual Studio Code
    ...
    See [Use Visual Studio Code for Hive, LLAP or pySpark](hdinsight-for-vscode).
...
* Learn how to [use Visual Studio Code for Hive, LLAP or pySpark](hdinsight-for-vscode).

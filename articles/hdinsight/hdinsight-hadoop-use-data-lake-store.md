...
* [Create an HDInsight cluster to use Data Lake Store using the Azure portal](data-lake-store-hdinsight-hadoop-use-portal.md)
* [Create an HDInsight cluster to use Data Lake Store using the Azure PowerShell](data-lake-store-hdinsight-hadoop-use-powershell.md)

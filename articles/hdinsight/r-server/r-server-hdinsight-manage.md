...
In this article, you learn how to manage an existing ML Services cluster on Azure HDInsight to perform tasks like adding multiple concurrent users, connecting remotely to an ML Server (Microsoft ML Server) or client, changing compute context, etc.

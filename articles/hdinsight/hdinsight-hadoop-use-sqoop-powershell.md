...
* A workstation with Azure PowerShell.
  ...
  >
  >To install the latest version of Azure PowerShell, see [Install and configure Azure PowerShell](/powershell/azureps-cmdlets-docs). If you have scripts that must be modified to use the new cmdlets, see [Migrate to Azure Resource Manager-based development tools for HDInsight clusters](hdinsight-hadoop-development-using-azure-resource-manager.md).
  > 

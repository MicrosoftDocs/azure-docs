...
:::image type="content" source="media/hdinsight-restrict-public-connectivity/outbound-resource-provider-connection-only.svg" alt-text="Diagram of the HDInsight architecture using an outbound resource provider connection.":::

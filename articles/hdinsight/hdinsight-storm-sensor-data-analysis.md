...
> [AZURE.NOTE] The information in this document is based on using a Windows-based Storm on HDInsight cluster version 3.2. For information on working with Azure Event Hub from Linux-based Storm on HDInsight, see [Process events from Azure Event Hubs with Storm on HDInsight](hdinsight-storm-develop-java-event-hub-topology.md)

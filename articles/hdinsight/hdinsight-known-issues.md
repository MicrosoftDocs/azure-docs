...
When submitting cluster creation requests using Azure Resource Manager (ARM) templates, Runbooks, PowerShell, the Azure CLI, and other automation tools, you might receive a BadRequest error message if you specify `clusterType = "Kafka"`, `HDI version = "5.0"`, and `Kafka version = "2.4.1"`.
...
The last 10 digits in your image version indicate the date and time of HDInsight image. For example, a cluster image of 5.0.3000.1.2208310943 indicates that the date of your image is August 31, 2022. [Learn how to verify your HDInsight image version](/azure/hdinsight/view-hindsight-cluster-image-version).

...
In addition to Blob, another storage option is use of Azure Data Lake Storage.  If you choose Azure Data Lake Storage rather than Blob when creating your cluster, then the HDFS file system associated with your cluster will be hosted there.  

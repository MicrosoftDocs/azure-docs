...
To subscribe, click the **watch** button in the banner and watch out for [HDInsight Releases](https://github.com/Azure/HDInsight/releases/tag/2026-06-29).
...
> [!NOTE]
> This release is a hotfix or maintenance release for the Resource Provider. For more information, see [Resource Provider](.//hdinsight-overview-versioning.md#hdinsight-resource-provider).
...
Azure HDInsight releases are available to all regions over several days. This release note is applicable for image number **2606012120**. [How to check the image number?](./view-hindsight-cluster-image-version.md)
...
> [!NOTE]
> Ubuntu 18.04 is supported under [Extended Security Maintenance(ESM)](https://techcommunity.microsoft.com/t5/linux-and-open-source-blog/canonical-ubuntu-18-04-lts-reaching-end-of-standard-support/ba-p/3822623) by the Azure Linux team for [Azure HDInsight July 2023](./hdinsight-release-notes-archive.md#release-date-july-25-2023), release onwards. 
...
* Previous [release note](./hdinsight-release-notes-archive.md)

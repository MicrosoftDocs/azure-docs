...
Spark 3.1 is now Generally Available on HDInsight 4.0 release.  This includes Adaptive Query Execution, Convert Sort Merge Join to Broadcast Hash Join, Spark Catalyst Optimizer, and Dynamic Partition Pruning. Customers will be able to create new Spark 3.1 clusters and not Spark 3.0 (preview) clusters.
For more details, please refer to the [Apache Spark 3.1](https://techcommunity.microsoft.com/t5/analytics-on-azure-blog/spark-3-1-is-now-generally-available-on-hdinsight/ba-p/3253679) is now Generally Available on HDInsight - Microsoft Tech Community.
...
For more details on migration, please refer to the [migration guide.](https://spark.apache.org/docs/latest/migration-guide.html)
...
### Here are the OSS Back Ported Apache JIRAs for this release:
...
Starting 01 March 2022, HDInsight will only support manual scale for HBase, there is no impact on running clusters.  New HBase clusters won't be able to enable schedule based Autoscaling.  For more information on how to  manually scale your HBase cluster, please refer our documentation on [Manually scaling Azure HDInsight clusters](https://docs.microsoft.com/azure/hdinsight/hdinsight-scaling-best-practices)

## HDInsight 3.6 end of support extension 

HDInsight 3.6 end of support is extended till September 30, 2022.

...
## New features
### Spark 3.0 preview
HDInsight added [Spark 3.0.0](https://spark.apache.org/docs/3.0.0/) support to HDInsight 4.0. 

### Kafka 2.4 preview
HDInsight added [Kafka 2.4.1](http://kafka.apache.org/24/documentation.html) support to HDInsight 4.0.
...
### Default cluster VM size is changed to Ev3-series 
...
### Remove LLAP component from secure Spark cluster


### VM host name will be changed on July 1 2021
...
Added support for Spark 3.0.0 and Kafka 2.4.1. 

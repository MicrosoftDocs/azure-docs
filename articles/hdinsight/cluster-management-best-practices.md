...
| Service issues,planned maintenance,health & security advisories | [Subscribe to subscription specific service health alerts](https://docs.microsoft.com/en-us/azure/service-health/alerts-activity-log-service-notifications-portal) |

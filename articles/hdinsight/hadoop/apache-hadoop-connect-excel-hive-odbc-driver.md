...
6. Select **OK** to close the Test window.  

7. Select **OK** to close the **Microsoft Hive ODBC Driver DSN Setup** window.  

8. Select **OK** to close the **ODBC Data Source Administrator** window.  

...
* A client to query the Azure SQL Database. Consider using [SQL Server Management Studio](../../azure-sql/database/connect-query-ssms.md) or [Visual Studio Code](../../sql-database/sql-database-connect-query-vscode.md).

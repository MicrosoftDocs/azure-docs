---
title: Connect to Hive Server using Beeline or install Beeline locally to connect from your local - Azure HDInsight 
...
ms.date: 04/07/2021
---
# Connect to Hive Server using Beeline or install Beeline locally to connect from your local

[Apache Beeline](https://cwiki.apache.org/confluence/display/Hive/HiveServer2+Clients#HiveServer2Clients-Beeline–NewCommandLineShell) is a Hive client that is included on the head nodes of your HDInsight cluster. This article describes how to connect to Hive Server using the Beeline client installed on your HDInsight cluster across different types of connections. It also discusses how to [Install the Beeline client locally](#install-beeline-client). 

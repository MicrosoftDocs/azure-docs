...
2. Enter the following properties:
    ...
    The [logical SQL server](../../sql-database/sql-database-servers.md) name will be  `<ClusterName>dbserver`. The database name will be `<ClusterName>db`. The default storage account name will be `e6qhezrh2pdqu`.

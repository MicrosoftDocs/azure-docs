...
Using data compression will increase the number of records that can be stored on a disk. It will also increase CPU usage as the data must be compressed before sending and then decompressed before processing.

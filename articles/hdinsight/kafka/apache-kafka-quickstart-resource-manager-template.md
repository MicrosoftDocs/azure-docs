...
* **To create a topic**, use the following command in the SSH connection:
    ...
    * Each partition is replicated across three worker nodes in the cluster.
        ...
        For information on the number of fault domains in a region, see the [Availability of Linux virtual machines](../../virtual-machines/availability.md#use-managed-disks-for-vms-in-an-availability-set) document.

...
1. From **the Basics** tab, provide the following information:
   ...
   ![Azure portal create cluster basics](./media/apache-kafka-get-started/azure-portal-cluster-basics.png)
    ...
    For high availability of data, select a region (location) that contains __three fault domains__. For information on the number of fault domains in a region, see the [Availability of Linux virtual machines](../../virtual-machines/availability.md#use-managed-disks-for-vms-in-an-availability-set) document.

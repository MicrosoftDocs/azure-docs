...
Each Azure region has a specific number of fault domains. For a list of domains and the number of fault domains they contain, see the [Availability sets](/azure/virtual-machines/availability#availability-sets) documentation.

---
title: Cluster creation failed due to not sufficient fault domains in region in Azure HDInsight
...
Each Azure region has a specific number of fault domains. For a list of domains and the number of fault domains they contain, refer to documentation on [Availability Sets](../../virtual-machines/windows/manage-availability.md).

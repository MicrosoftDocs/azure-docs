...
>
> For HDInsight 3.4 or greater, see [Run Hive queries in Ambari Hive View](hadoop/apache-hadoop-use-hive-ambari-view.md) for information on running Hive queries from a web browser.

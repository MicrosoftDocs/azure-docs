...
7. Use the following values for the __Add Alias__ dialog.
    ...
    * __User Name__: The admin account name for your cluster. The default is `admin`.
    * __Password__: The password for the HDInsight cluster admin account. This is a password you provided when creating the HDInsight cluster.

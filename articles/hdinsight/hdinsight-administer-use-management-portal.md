...
* User Azure Data Factory. See [Azure HDInsight Linked Service](../data-factory/compute-linked-services.md) and [Transform and analyze using Azure Data Factory](../data-factory/data-transformation-activities.md) for on-demand and self-defined HDInsight linked services.

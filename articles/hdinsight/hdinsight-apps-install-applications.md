...
|[Starburst Presto for Azure HDInsight](https://www.starburst.io/press-releases/starburst-presto-azure-hdinsight/) |Hadoop |Presto is a fast and scalable distributed SQL query engine. Architected for the separation of storage and compute, Presto is perfect for querying data in Azure Data Lake Storage, Azure Blob Storage, SQL and NoSQL databases, and other data sources. |

...
If you also need to create a new service bus namespace for your notification hubs, see [Manage Service Bus with PowerShell](service-bus-powershell-how-to-provision.md).

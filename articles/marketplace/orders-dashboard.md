...
| Is New Customer | Is New Customer | The value will identify whether a new customer acquired one or more of your offers for the first time. Value will be "Yes" if within the same calendar month for "Date Acquired". Value will be "No" if the customer has purchased any of your offers prior to the calendar month reported. |
...
| Asset Count | Asset Count | The number of assets associated with the order ID |
||||

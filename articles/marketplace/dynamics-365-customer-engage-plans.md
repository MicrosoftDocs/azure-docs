...
1. Add the Service IDs you copied in the previous step to your solution package. To learn how, see Adding license metadata to your solution and [Create an AppSource package for your app](/powerapps/developer/data-platform/create-package-app-appsource).

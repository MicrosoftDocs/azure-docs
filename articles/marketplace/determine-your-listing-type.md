---  
title: Determine your listing type in the Azure Marketplace | Azure
...
Storefronts in the Azure Marketplace support many publishing options under the categories of listing type and offer type. Select an offer type that best represents your solution and service details. All publishing options provide you with access to lead sharing.   

| Storefront | Listing type | App type | Technical guidelines |  
|:--- |:--- |:--- |:--- |  
| AppSource | [List](#list) | [Consulting services](#requirements-appSource-list-consulting-service) | [Microsoft AppSource Consulting services listing guidelines](https://smp-cdn-prod.azureedge.net/documents/Microsoft%20AppSource%20Partner%20Listing%20Guidelines.pdf) |  
...
| AppSource |  | Cortana Intelligence | [Cortana Intelligence AppSource publishing guide](https://docs.microsoft.com/azure/machine-learning/team-data-science-process/cortana-intelligence-appsource-publishing-guide) |  
| AppSource |  |Dynamics 365 for Customer Engagement | [Publish your app on AppSource](https://docs.microsoft.com/dynamics365/customer-engagement/developer/publish-app-appsource) |  
| AppSource |  | Dynamics 365 for Finance and Operations | [Publishing apps for Microsoft Dynamics 365 for Finance and Operations on AppSource](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/lcs-solutions/lcs-solutions-app-source) |  
...
| AppSource |  | Office 365 | [Make your solutions available in AppSource and within Office](https://docs.microsoft.com/office/dev/store/submit-to-the-office-store) |  
| AppSource |  | Power BI | [Publish custom visuals to AppSource](https://docs.microsoft.com/power-bi/developer/office-store) | | Azure Marketplace | [Transact](#transact) | [Azure apps - Managed app](#requirements-azure-marketplace-transact-azure-apps-managed-app) |  [docs.microsoft.com/azure/managed-applications/overview](https://docs.microsoft.com/azure/managed-applications/overview) |  
...
|:--- |:--- |:--- |  
| [List](#list) | [Consulting services](#requirements-appSource-list-consulting-service) | [Microsoft AppSource consulting services listing guidelines](https://smp-cdn-prod.azureedge.net/documents/Microsoft%20AppSource%20Partner%20Listing%20Guidelines.pdf) |  
|  | Cortana Intelligence | [Cortana Intelligence AppSource publishing guide](https://docs.microsoft.com/azure/machine-learning/team-data-science-process/cortana-intelligence-appsource-publishing-guide) |  
|  |Dynamics 365 for Customer Engagement | [Publish your app on AppSource](https://docs.microsoft.com/dynamics365/customer-engagement/developer/publish-app-appsource) |  
|  | Dynamics 365 for Finance and Operations | [Publishing apps for Microsoft Dynamics 365 for Finance and Operations on AppSource](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/lcs-solutions/lcs-solutions-app-source) |  
|  | Office 365 | [Make your solutions available in AppSource and within Office](https://docs.microsoft.com/office/dev/store/submit-to-the-office-store) |  
|  | Power BI | [Publish custom visuals to AppSource](https://docs.microsoft.com/power-bi/developer/office-store) |  


## Azure Marketplace publishing by product  

![Diagram that shows an overview of the Azure Marketplace Offer and Listing types](./media/marketplace-publishers-guide/workflow-azure-marketplace.png)  
...
|:--- |:--- |:--- |  
| [List](#list) | [Consulting services](#requirements-azure-marketplace-list-consulting-service) | [](#) |  
...
| [Transact](#transact) | [Azure apps - Managed app](#requirements-azure-marketplace-transact-azure-apps-managed-app) |  [Azure managed applications overview](https://docs.microsoft.com/azure/managed-applications/overview) |  
...
### List  
The List listing type includes the following offer types in storefronts in the Marketplace:  

| Offer type | Storefront | Details |  
|:---        |:---        |:---     |  
| Consulting Services | AppSource | [AppSource List requirements: Consulting services](#requirements-appsource-list-consulting-service) |  
| Consulting Services | Azure Marketplace | [Azure Marketplace List requirements: Consulting services](#requirements-azure-marketplace-list-consulting-service) |
| Contact Me | AppSource | [](#) |  
| Contact Me | Azure Marketplace | [AppSource List requirements: Contact Me](#requirements-azure-marketplace-list-contact-me) |  

#### AppSource List requirements: Consulting services  
...
#### Azure Marketplace List requirements: Consulting Services  
...
#### Azure Marketplace List requirements: Contact Me  
Use the Contact Me offer type when using a Trial or Transact listing type is not feasible. The benefit of a Contact Me offer type is that you can immediately receive leads with an in-market solution. Your leads should be nurtured into the foundational deals to start your business flywheel. The drawback is that customer engagement is limited compared to other offer types.  

> [!IMPORTANT]
> Customer engagement is best with Trial and Transact offer types. The value of the Contact Me listing type is the lead that you receive. If you choose the Contact Me listing type, you must verify that your lead destination is configured and that you are ready to maximize your lead.  
...
#### Azure Marketplace Trial requirements: Free trial/SaaS trial  
...
#### Azure Marketplace Trial requirements: Interactive demo  
...
| Benefit | Requirement |  
|:--- |:--- |  
| Enables your customers to see your solution in action without the complexity of setup. | Your solution requires complex settings that would be hard to achieve within the trial period. |  

#### Azure Marketplace Trial requirements: Test drive  
...
### Transact  
The Transact listing type includes the following offer types in Marketplace storefronts:  

| Offer type | Storefront | Details |   
|:---        |:---        | :--- |  
| Azure apps: Managed app | Azure Marketplace | [Azure Marketplace Transact requirements: Azure apps - Managed app](#requirements-azure-marketplace-transact-azure-apps-managed-app) |  
| Azure apps: Solution template | Azure Marketplace | [Azure Marketplace Transact requirements: Azure apps - Solution template](#requirements-azure-marketplace-transact-azure-apps-solution-template) |  
| Containers | Azure Marketplace | [Azure Marketplace Transact requirements: Container](#requirements-azure-marketplace-transact-container) |  
| SaaS app  | Azure Marketplace | [Azure Marketplace Transact requirements: SaaS app](#requirements-azure-marketplace-transact-saas-app) |  
| Virtual machine | Azure Marketplace | [Azure Marketplace Transact requirements: Virtual machine](#requirements-azure-marketplace-transact-virtual-machine) |  

#### Azure Marketplace Transact requirements: Azure apps - Managed app  
...
#### Azure Marketplace Transact requirements: Azure apps - Solution template  
...
#### Azure Marketplace Transact requirements: Container  
...
#### Azure Marketplace Transact requirements: SaaS app  
...
#### Azure Marketplace Transact requirements: Virtual machine  
...
>
> For more information about private offers, see [Private offers in Azure Marketplace](https://azure.microsoft.com/blog/private-offers-on-azure-marketplace).  

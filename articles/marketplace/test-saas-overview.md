...
This article provides guidance about how to test a software as a service (SaaS) test offer for testing a plan. 
...
- For instructions for creating offers and plans, see [Create a SaaS offer](create-new-saas-offer.md).
...
- [Create a SaaS plan in your production offer](create-new-saas-offer-plans.md) with the prices you want to charge customers.

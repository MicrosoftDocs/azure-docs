...
* **Reduced Marketplace Service Fee:** For certain SaaS Products that you publish on our Commercial Marketplace, Microsoft may reduce its Marketplace Service Fee from 20% (as described in the Microsoft Publisher Agreement) to 10%.  In order for your product to qualify, it must be designated by Microsoft as either an IP co-sell ready SaaS Product, or a SaaS product with prioritized status by Microsoft. To receive this reduced Marketplace Service Fee for the Month, this criteria must be met at least five (5) business days before the end of that calendar month.  Reduced Marketplace Service fee does not apply to VMs, Managed Apps or any other products made available through our Commercial Marketplace.  This Reduced Marketplace Service Fee will be available only to qualified offers for license charges collected by Microsoft between May 31, 2019 and June 30, 2020. After such time, the Marketplace Service Fee will return to its normal amount.

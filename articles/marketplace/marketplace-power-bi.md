---
title: Publishing guide for Power BI app offers in Microsoft AppSource 
description: This article describes the requirements to publish Power BI app offers in Microsoft AppSource.
...
:::image type="content" source="media/power-bi/power-bi-app-publishing-steps.png" alt-text="Overview of the steps to publish a Power BI app" border="false":::
...
After your app is created and tested in Power BI, save the application installation web address, as you'll need it to [create the Power BI app offer](power-bi-app-offer-setup.md).
...
## Licensing options <font color="red">[ rest is from other offer types, pick what you want ]</font>
...
## Test drive <font color="red">[ no test drive, right? ]</font>
...
Here's an example of how offer information appears in Microsoft AppSource (any listed prices are for example purposes only and do not reflect actual costs): <font color="red">[ this is azure container ]</font>

:::image type="content" source="media/azure-container/example-azure-container.png" alt-text="Illustrates how this offer appears in Microsoft AppSource.":::
...
To help create your offer more easily, prepare these items ahead of time. All are required except where noted.<font color="red">[ these should be accurate for PBI ]</font>

- **Alias** – A descriptive name that we'll use to refer to this offer solely within Partner Center. The offer alias won't be used in the marketplace and is different than the offer name shown to customers.
- **Category** – The category of your offer.
- **Industry**  – The industry of your offer.
...
- **Search keywords** (optional) – Provide up to three.
- **Products your app works with** (optional) – Provide up to three.
...
- **Contact information**
  ...
  - **Supporting documents** (optional) – Provide up to three.
- **Media**

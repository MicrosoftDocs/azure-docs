...
| ***Lead management*** | You must enable your CRM (Marketo, Microsoft Dynamics, or Salesforce) or another supported lead interface (an [https endpoint](https://cloudpartner.azure.com/#documentation/lead-management-instructions-https) or an [Azure Table](https://cloudpartner.azure.com/#documentation/lead-management-instructions-azure-table)) to accept lead data before you receive leads from the storefront. Note: for detailed instructions on setting up lead management, you will need to log in to the [Cloud Partner Portal](https://cloudpartner.azure.com)</li> </ul> | Required |  
...
| ***Lead management*** | You must enable your CRM (Marketo, Microsoft Dynamics, or Salesforce) or another supported lead interface (an [https endpoint](https://cloudpartner.azure.com/#documentation/lead-management-instructions-https) or an [Azure Table](https://cloudpartner.azure.com/#documentation/lead-management-instructions-azure-table)) to accept lead data before you receive leads from the storefront. Note: for detailed instructions on setting up lead management, you will need to log in to the [Cloud Partner Portal](https://cloudpartner.azure.com)| list<br />transact<br />trial |  

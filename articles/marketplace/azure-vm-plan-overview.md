...
Hidden plans do not generate preview links. However, you can test you them by [following these steps](azure-vm-faq.yml#how-do-i-test-a-hidden-preview-image-). 
...
- **Remote desktop or SSH disabled**: Enable this property if virtual Machines deployed with these images do not allow customers to access it using Remote Desktop or SSH. Learn more about [locked VM images](./azure-vm-certification-faq.yml#locked-down-or-ssh-disabled-offer).
...
- **OS VHD link**: The image stored in Azure shared image gallery. Learn how to capture your image in a [shared image gallery](azure-vm-use-approved-base.md#capture-image).

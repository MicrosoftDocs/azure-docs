...
> [!NOTE]
> If you need to create a VM from a vhd file, follow the instructions in the following articles, [Prepare an Azure Resource Manager template](#prepare-an-azure-resource-manager-template) or [Deploy an Azure VM using PowerShell](#deploy-an-azure-vm-using-powershell).

...
Provide at least one (and up to three) related PDF marketing documents here, such as white papers, brochures, checklists, or presentations.
...
Add up to four optional videos that demonstrate your offer. They should be hosted on an external video service. Enter each video's name, web address, and a thumbnail PNG image of the video at 1280 x 720 pixels.

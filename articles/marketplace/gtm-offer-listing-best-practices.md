---
title: Go-To-Market Services - Offer listing best practices | Azure Marketplace
...
The tables in this section provide suggestions for creating and engaging marketplace offers. To write and configure your marketing materials, go to [Partner Center](https://partner.microsoft.com/dashboard/commercial-marketplace/analytics/marketplaceinsights). 
...
By adding the parameters to your AppSource URL, you can review the effectiveness of your campaign in the analytics dashboard in [Partner Center](https://partner.microsoft.com/dashboard/commercial-marketplace/analytics/marketplaceinsights).

...
| Step 4: Register deal | The ISV registers the purchase with Microsoft in Partner Center. As part of [deal registration](https://docs.microsoft.com/partner-center/csp-commercial-marketplace-licensing), the ISV will specify the type and quantity of each licensing plan purchased by the customer. |

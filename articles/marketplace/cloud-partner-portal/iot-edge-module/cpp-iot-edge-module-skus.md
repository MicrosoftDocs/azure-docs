...
You can target multiple platforms and provide several versions through tags. Learn more about [tags guidelines](./cpp-iot-edge-module-technical-assets.md#tags-and-versioning).
...
| **Default createOptions**  | The createOptions must be fewer than 512 characters. It must be valid JSON, non-escaped. Learn more about [createOptions](https://docs.microsoft.com/en-us/azure/iot-edge/module-composition#configure-modules). <br/> For example, if a module requires bind a port, you can define the following createOptions:<br/>  `"HostConfig":{"PortBindings":{"5012/tcp":[{"HostPort":"5012"}]}`|

<br/> Select **Save** to save your SKU settings. 

## Next Steps

Use the [Marketplace tab](cpp-iot-edge-module-marketplace.md) to create a marketplace description for your offer.

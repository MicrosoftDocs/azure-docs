...
- Use the [Marketplace tab](./cpp-iot-edge-module-marketplace.md) to provide a link to at least one IoT Edge device in the [Azure IoT Edge Certified](https://catalog.azureiotsolutions.com/) device catalog.
...
IoT Edge modules must be able to start with the default settings provided in [SKU tab of the Cloud Partner portal](./cpp-iot-edge-module-skus.md). The following default settings are available:
...
- [C\#](https://docs.microsoft.com/en-us/dotnet/api/microsoft.azure.devices.client.deviceclient.productinfo?view=azure-dotnet#Microsoft_Azure_Devices_Client_DeviceClient_ProductInfo) 

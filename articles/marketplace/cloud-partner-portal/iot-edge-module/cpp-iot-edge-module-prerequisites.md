---
title: IoT Edge module prerequisites | Microsoft Docs
...
- Agreement to the [Azure Marketplace Terms](https://azure.microsoft.com/en-us/support/legal/marketplace-terms/)
- Host your IoT Edge module technical asset in an Azure Container Registry.  For more information, see [how to prepare your IoT Edge module technical asset](./cpp-iot-edge-module-technical-assets.md)
...
- [Prepare your IoT Edge module technical asset](./cpp-iot-edge-module-technical-assets.md)
- [Create your IoT Edge module offer](./cpp-iot-edge-module-create-offer.md)

...
See [AppSource Marketing Lead Management](./cloud-partner-portal-get-customer-leads.md) for details of the overall process and how can you find the right info to setup AppSource's leads.    

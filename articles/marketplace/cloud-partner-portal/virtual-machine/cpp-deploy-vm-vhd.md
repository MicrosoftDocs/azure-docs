---
title: Deploy a VM from your VHDs | Microsoft Docs
...
-  PowerShell: [How to create an unmanaged VM image from an Azure VM](../../virtual-machines/windows/capture-image.md)
...
| ![./media/image1.png](./media/publishvm_023.png)  | ![./media/image2.png](./media/publishvm_024.png) |
|   |   |
...
For help with issues, see [Troubleshooting common issues encountered during VHD creation](https://docs.microsoft.com/en-us/azure/marketplace-publishing/marketplace-publishing-vm-image-creation-troubleshooting) for additional assistance.
-->

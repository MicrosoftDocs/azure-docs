...
After you sign in to the Cloud Partner Portal, select the **New Offer** in the left pane. Then, to display the New Offer form and start the process of defining assets for a new app offer, select **Power BI Apps**.

![Power BI offer menu item](./media/new-offer-menu.png)

> [!NOTE] 
> If the **Power BI Apps** option is not shown or is not enabled, your account does not have permission to create this offer type. Check to ensure that you've met all the [prerequisites](./cpp-prerequisites.md) for this offer type, including registering for a developer account.


## Next steps

The following articles mirror the tabs on the **New Offer** page for a Power BI App offer type. Each article describes the asset groups and supporting services for your new app offer.

...
When you open the **New Offer** page for service apps, you'll first see the **Offer Settings** tab. You'll provide the primary identifiers and the name for your offer on this tab. An asterisk (*) indicates a required field.
...
On the **Offer Settings** tab, you need to enter information in the following required fields.

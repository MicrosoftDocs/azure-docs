...
- To update the app's content in Power BI and get an installation URL from the
    newly packaged app
- To update the offer's marketplace metadata (sales, marketing, or support information and assets)
...
Power BI apps are updated often with new content, security patches, features, and so on. After you change an app, follow these steps to update its installation URL:
...
1.  Sign in to the [Cloud Partner Portal](https://cloudpartner.azure.com/).
2.  Under **All offers**, find the offer you want to update.
3.  On the **Storefront Details** tab, change the metadata by following the instructions in the article [Power BI Apps Storefront Details tab](./cpp-storefront-details-tab.md).

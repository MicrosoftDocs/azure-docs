...
* *Role*: Use one of the following roles in this field in the template.
...
* *States/Provinces:* (Optional) When filling out the template use the XX-XX format as listed in the table below.

    |   Country/Region Name               |   ISO-2   |   ISO-3      |
    |-------------------------------------|-----------|--------------|
    | Afghanistan                         | AF        | AFG          |
    ...
    | Spain                               | ES        | ESP          |
    | Sri Lanka                           | LK        | LKA          |
    | St Helena, Ascension, Tristan da Cunha | SH     | SHN          |
    | Sudan                               | SD        | SDN          |
    | Suriname                            | SR        | SUR          |
    | Svalbard                            | SJ        | SJM          |
    | Sweden                              | SE        | SWE          |

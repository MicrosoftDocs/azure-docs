...
Azure Table
Https Endpoint
Read the documentation linked above to your selected lead destination to see how to set up the lead destination to receive leads from your marketplace offer.
Connect your offer to the lead destination while publishing the offer to the marketplace in Partner Center. See the documentation linked above for how to do this.
...
Make sure the connection to the lead destination stays up-to-date so that you don’t lose any leads, so make sure you update these connections whenever something has changed on your end.

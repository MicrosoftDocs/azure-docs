...
If you have difficulties creating an SAS URI, see [Common SAS URL issues](partner-center-portal/common-sas-uri-issues.md). Otherwise, save the SAS URI(s) to a secure location for later use. You'll need it to publish your VM offer in Partner Center.

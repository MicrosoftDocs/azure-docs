...
| Store logos (Small, Medium, Large)  | The Large logo (from 216 x 216 to 350 x 350 px) is required. Partner Center will use this to create a Small (48 x 48 px) and a Medium (90 x 90 px) logo. You can optionally replace these with different images later. Logos must be in PNG format. |

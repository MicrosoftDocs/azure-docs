...
|  authorization     |  [Get JSON web token (JWT) bearer token](./marketplace-metering-service-authentication#get-a-token-based-on-the-azure-ad-app). For example: "`Bearer <access_token>`". |

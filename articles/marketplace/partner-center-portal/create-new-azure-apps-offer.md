...
All new Azure application offers must include an [Azure partner customer usage attribution GUID](https://docs.microsoft.com/en-us/azure/marketplace/azure-partner-customer-usage-attribution).

...
Once you've created your [Commercial Marketplace account in Partner Center](https://partner.microsoft.com/dashboard/commercial-marketplace), using your work email plus your business information, there are a variety of roles and permissions settings that can help you with adding or managing customers, selling subscriptions, working with billing and invoicing, creating business profiles, managing referrals, working with incentives programs, and providing support. 
...
If you have not already done so,  you (or your organization's administrator) will need to:
- set up your company’s profile including support details, tax exemptions if appropriate, and primary contact information
- create user accounts for anyone who will use your business account in Partner Center

### Open developer settings

Account settings is located at the upper right corner of your [Commercial Marketplace dashboard in Partner Center](https://partner.microsoft.com/dashboard/commercial-marketplace). Select the gear icon (near the upper right corner of the dashboard) and then select **Developer settings**. 
...
To manage your account users, you must sign in with your associated Azure AD credentials. 

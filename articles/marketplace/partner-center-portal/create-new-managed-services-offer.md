...
This topic explains how to create a new Managed Services offer... These offers blah blah
All offers for Dynamics 365 Business Central must go through our certification process.
...
Select the **+ New offer** button, then select the **Managed Services** menu item. The **New offer** dialog box will appear. NEED TO UPDATE THE REST OBVS.

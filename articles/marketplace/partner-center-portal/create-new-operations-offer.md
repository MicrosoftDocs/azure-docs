...
To enable a test drive, check the **Enable a test drive** box. You'll then need to configure a demonstration environment in the [Test drive technical configuration](#test-drive-technical-configuration) configure to let customers to try your offer for a fixed period of time. 
...
- Clearly describe your offer's value proposition in the first few sentences of your description. Include the following in your value proposition:
...
You must provide your offer's logo in two sizes: **Small (48 x 48)** and **Large (216 x 216)**.
...
The **Marketplace listing** option found under the **Test drive** tab displays the languages in which your test drive is available. Note that currently **English (United States)** is the only location available. Select the language name to enter info that describes the test drive experience.
...
You must upload a [Customization Analysis Report (CAR)](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/dev-tools/customization-analysis-report) in this section. This report is generated by analyzing your customization and extension models, based on a predefined set of best practice rules.
...
### Does solution include localizations? (required)
...
### Does solution enable translations? (required)

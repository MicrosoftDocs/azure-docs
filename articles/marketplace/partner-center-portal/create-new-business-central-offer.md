...
Select the option that applies to your offer: **Add On** or **Connect**.

### File upload

If you selected **Add On** above, this is where you'll upload your offer's package file, along with the package files for any extension on which it has dependencies..

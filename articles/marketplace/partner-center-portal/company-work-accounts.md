...
description: Get help with checking on whether your company already has a work account set up with Microsoft, creating a new work account, or setting up multiple work accounts to use with Partner Center. 
author: mattwojo
manager: evansma
ms.author: parthp 

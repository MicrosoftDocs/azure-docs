...
- If you don't have a new VM image to replace the only VM image in a plan, or if you're done with the plan, [stop selling the plan](update-existing-offer.md#stop-distribution-of-an-offer-or-plan).
- If you don't plan to replace the only VM image in the offer, we recommend you [stop selling the offer](update-existing-offer.md#stop-distribution-of-an-offer-or-plan).

...
> [!Note]
> If you are using a Linux base image not taken from Azure Marketplace, you can offset the first partition by 2048 Sectors (1MB). This allows the unformatted space to be used for adding new billing info and lets Azure proceed with publishing your VM to Azure Marketplace.  
...
## First partition starts at 1 MB (2048 Sectors) (Linux only)

When you submit the VHD, ensure that the first 2048 sectors of the VHD is empty. Otherwise, your request will fail.
...
1. Create a partition on your VHD.
   ...
   1. Enter 2048 as _first sector_ value. You can leave _last sector_ as the default value.
      ...
      >[!IMPORTANT]
      >Any existing data will be erased till sector 2048. Backup of the VHD before you create a new partition.

...
| Pending deprecate(formerly stop sell) | Publisher selected "deprecate(formerly stop sell)" on an offer or plan, but the action has not yet been completed. |
...
|Initiated plan deprecate(formerly stop sell): *plan name*    |A user initiated a plan deprecate(formerly stop sell) by selecting **deprecate(formerly stop sell)** from the **Plan overview** page.</br>*This event applies only to offer types that support plans*.    |
|Undo plan deprecate(formerly stop sell): *plan name*    |A user canceled a plan deprecate(formerly stop sell) by selecting **Undo deprecate(formerly stop sell)** from the **Plan overview** page.</br>*This event applies only to offer types that support plans*.    |
...
|deprecate(formerly stop sell) offer    |A user stopped selling the offer by selecting **deprecate(formerly stop sell)** from the **Offer overview** page.    |

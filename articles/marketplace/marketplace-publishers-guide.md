...
*   [How to Publish in the storefronts on the marketplace](#How-to-Publish-in-the-storefronts-on-the-marketplace)  
    ...
    *   [Requirements by Listing Type](#Requirements-by-Listing-Type)  
        ...
        *   [Transact-specific](#Transact-specific)  
    *   [Cloud Partner Portal Pre-publishing Checklist for the Azure Marketplace](#Cloud-Partner-Portal-Pre-publishing-Checklist-for-the-Azure-Marketplace)  
    ...
    *   [Using Azure Active Directory to enable trials](#Using-Azure-Active-Directory-to-enable-trials)  
        *   [Certify Your Azure AD Integration for the Marketplace: Multitenant Apps](#Certify-Your-Azure-AD-Integration-for-the-Marketplace:-Multitenant-Apps)  
    ...
    *   [Azure Marketplace vs. AppSource](#Azure-Marketplace-vs.-AppSource)  
        *   [Understanding the Differences Between Storefronts](#Understanding-the-Differences-Between-Storefronts)  
        *   [AppSource](#AppSource)  
...
## Overview  
Welcome to the Azure Marketplace and AppSource publisher guide. This guide helps new and existing publishers (you) to understand how to use the Azure Marketplace and AppSource storefronts, how to publish your apps and services, and how to grow your business in partnership with Microsoft.  
*   For more information about AppSource, visit the Microsoft AppSource page located at [appsource.microsoft.com](https://appsource.microsoft.com).  
*   For more information about Azure Marketplace, visit the Microsoft Azure Marketplace page located at [azuremarketplace.microsoft.com](https://azuremarketplace.microsoft.com).  
...
*   What kinds of apps and services offers are able to be published
...
*   **Get actionable insights**  
    Your success is mutual success. Get insights on the performance of your listings using the Cloud Partner Portal. Learn what is performing, what leads you have generated, and how to maximize your campaign activities.  
...
## Storefronts  
<!-- Note: the first two paragraphs of the section + a new added sentence summarizing the table and linking out the Azure Marketplace vs. AppSource child doc -->  
...
*   AppSource 
    *   For more information about AppSource, visit the AppSource page located at [appsource.microsoft.com](https://appsource.microsoft.com).  
*   Azure Marketplace 
    *   For more information about Azure Marketplace, visit the Azure Marketplace page located at [azuremarketplace.microsoft.com](https://azuremarketplace.microsoft.com).  
...
Each storefront offers specialized options to help you maximize your publishing investment. The following table summarizes these options.  
|  | [Azure Marketplace](#Azure-Marketplace) | [AppSource](#AppSource) |  
|:--- |:--- |:--- |  
| Target audience | IT pros and developers<table><tr><th>specialist roles </th></tr><tr><td>DBAs</td></tr><tr><td>SecOps</td></tr><tr><td>DevOps</td></tr></table> | Line-of-business decision makers<table><tr><th>specialist roles </th></tr><tr><td>procurement</td></tr><tr><td>manufacturing</td></tr><tr><td>accounting</td></tr></table> |  
| Built with or to extend | Azure | Azure<br />Dynamics 365<br />Office 365<br />Power BI<br />PowerApps |  
| Types of solutions and services | professional services<br />Infrastructure solutions | professional services<br />Finished line-of-business cloud apps<br />Office 365 add-ins |  
| Offer type | Consulting Services<br />Contact Me<br />Azure apps: managed apps<br />Azure apps: solution templates<br />trial<br />virtual machine | Consulting Services<br />Contact Me<br />Free trial<br />Get Now<br />test drive |  
| In-app experience to give users access<br />to apps and services in the context of<br />your app | Azure portal<br />Azure Resource Manager CLI | Office 365<br />Dynamics 365<br />Power BI<br />Office client apps |  
...
<!-- Note: Probably should write this section, which is the parent of the next three child docs below) -->  
Become a publisher in the storefront on the marketplace in three easy steps.  
...
|:--- |:--- |  
| [List](#List) | Contact Me, Consulting Services |  
| [Transact](#Transact) | Virtual machine, Azure apps: solution template, Azure apps: managed app, containers, SaaS subscriptions |  
| [Trial](#Trial) | Free trial, SaaS trial, interactive demo, test drive |  
...
| Azure apps: managed apps | Azure Marketplace |  
| SaaS subscriptions  | Azure Marketplace |  
| Azure apps: solution templates | Azure Marketplace |  
...
| Offer type | storefront |  
|:---        |:---        |  
| Free trial | Azure Marketplace, AppSource |  
| interactive demo | Azure Marketplace, AppSource |  
| SaaS trial | Azure Marketplace, AppSource |  
| test drive | Azure Marketplace, AppSource |  
...
| 5. Sign into the Cloud Partner Portal | 15 minutes | [Sign into the Cloud Partner Portal](#Sign-into-the-Cloud-Partner-Portal) |  


#### Register in Microsoft Partner Network  
| 15 min |  
Join the Microsoft Partner Network (MPN) to become an official Microsoft partner and receive additional benefits and support for being an Publisher in the Azure Marketplace. Register in MPN and click "Enroll".  
...
| 15 minutes |  
Your Microsoft ID enables you to access the Cloud Partner Portal. The email address must be registered as a Microsoft ID and is used for both Cloud Partner Portal and Dev Center. The selected email address should preferably be in your corporate domain and controlled by your IT team.  
*   For more information about registering in Dev Center, visit the [Register in Dev Center](#Register-in-Dev-Center) section.  
*   For more information about signing into Cloud Partner Portal, visit the [Sign into the Cloud Partner Portal](#Sign-into-the-Cloud-Partner-Portal) section.  
...
#### Sign into the Cloud Partner Portal
| 15 minutes |  
After your Nomination is approved and you have registered in both the MPN and Dev Center, a marketplace account is created for you to access the Cloud Partner Portal. First-time sign in credentials are sent in your Nomination approval email. 
...
*   For more information about using the Cloud Partner Portal, visit the Learn section located at [cloudpartner.azure.com/#Learn](https://cloudpartner.azure.com/#Learn).  
*   For documentation in the Cloud Partner Portal, visit the Documentation section located at [cloudpartner.azure.com/#documentation](https://cloudpartner.azure.com/#documentation).
...
*   Azure AD deep dive content  
<!-- Note: link out to Azure AD deep dive in this document -->

#### Storefront Requirements: AppSource  
The following table describes the prerequisite requirements for publishing on the AppSource.  
...
| **Lead management** | You must enable your CRM (Marketo, Microsoft Dynamics, or Salesforce) to accept lead data prior to receive leads from the storefront. | Required |  
...
The following table describes the prerequisite requirements for listing types on the Azure Marketplace.  
...
#### Listing Type Requirements: Transact  
| Requirement | Details |  
|:--- |:--- | 
| **Billing and metering** | Your virtual machine (VM) must support either Bring Your Own License (BYOL) or Pay-As-You-Go monthly billing. |  
...
#### Listing Type Requirements: Transact (Containers only)  
| Requirement | Details |  
|:--- |:--- |  
| **Billing and metering** | Your container must support either the free or BYOL billing model. |  
| **Docker-based image** | Your container images must be based on the Docker image format and must be pulled from Azure Container Registries. |  

#### Listing Type Requirements: Transact (SaaS App Subscriptions only)  
| Requirement | Details |  
|:--- |:--- |  
...
| **Transaction Landing Page** | You must host an Azure co-branded transaction landing page where users create and manage the SaaS service account. |  
| **SaaS Subscription API** | You must expose a service that interacts with the SaaS Subscription to create, update, and delete a user account and service plan. All critical API changes must be supported within 24 hours. Any non-critical API changes are released periodically. |  

#### Listing Type Requirements: Trial  
| Requirement | Details |  
|:--- |:--- |  
| **Free trial period and trial experience** | A customer must be able to use your app for free for a limited time.<br /><br />This means that the customer is not subject to license or subscription fees for your offer or app, nor the cost of the underlying Microsoft first-party product or service. Because all trial options are deployed to the your Microsoft product subscription, you solely controls trial cost optimization and management.<br /><br />You choose a free trial, interactive demo, or test drive. No matter what you choose, the free trial must offer the customer a minimum amount of time to try the app for no additional cost.<ul> <li>To begin the process of creating a test drive, send an email to [amp-testdrive@microsoft.com](mailto:amp-testdrive@microsoft.com).</li> </ul>Note: Azure Marketplace SaaS trial experiences must allow users to use their work crendentials to sign in.<ul> <li>For more information, visit the AppSource trial experiences section located at [docs.microsoft.com/azure/active-directory/develop/active-directory-devhowto-appsource-certified#appsource-trial-experiences](https://docs.microsoft.com/azure/active-directory/develop/active-directory-devhowto-appsource-certified#appsource-trial-experiences).</li> </ul> |  
| **Easily configurable, turnkey solution** | Your app must be easy and quick to configure and set up. |  
...
Before you start the publishing process, it is helpful to understand the required components for building an offer. The following artifacts are required to complete the Create Offer publishing workflow in the Cloud Partner Portal. 
...
#### Checklist: Storefronts  
| Required publishing artifact | Listing type | Offer type |  
|:--- |:--- |:--- |  
| **Title (maximum 50 characters)** | Transact | virtual machines<br />Azure apps: solution templates<br />Azure apps: managed apps<br />containers<br />SaaS subscriptions | 
| **Summary (maximum 200 characters)** | Transact | virtual machines<br />Azure apps: solution templates<br />Azure apps: managed apps<br />containers<br />SaaS subscriptions | 
| **Long summary (maximum 256 characters)** | Transact | virtual machines<br />Azure apps: solution templates<br />Azure apps: managed apps<br />containers<br />SaaS subscriptions | 
| **HTML-based description (maximum 3,000 characters)** | Transact | virtual machines<br />Azure apps: solution templates<br />Azure apps: managed apps<br />containers<br />SaaS subscriptions | 
| **Company logos (40x40, 90x90, 115x115, 255x115, 815x290)** | Transact | virtual machines<br />Azure apps: solution templates<br />Azure apps: managed apps<br />containers<br />SaaS subscriptions |  

#### Checklist: SKU  
| Required publishing artifact | Listing type | Offer type |  
|:--- |:--- |:--- |  
| **Version number** | Transact | Azure apps: solution templates<br />Azure apps: managed apps | 
| **Package file that contains all the template files and createUIDefinition file** | Transact | Azure apps: solution templates<br />Azure apps: managed apps | 
...
| **Azure Container Registry (ACR) Image repository details including the Subscription ID, Resource group name, Registry name, Repository name, User name, Password, and Image Tags** *(optional)* | Transact | containers |  

### Using Azure AD to enable trials  
Azure AD is a cloud identity service that enables authentication with a Microsoft work or school account by using industry-standard frameworks: OAuth and OpenID Connect.  
...
Microsoft authenticates all marketplace users with Azure AD. When an authenticated user clicks through your trial listing in the marketplace and is redirected to your trial environment, you are able to provision the user directly into a trial without requiring additional sign in steps. Your app receives a token from Azure AD during authentication that includes valuable user information for creating a user account in your app. You are able to automate the provisioning experience and increase the likelihood of conversion.  
...
You may use Azure AD to enable one-click authentication in your app or trial.  
...
Each storefront serves unique customer requirements. The storefronts enable targeting by role, so you are able to offer the right solution or service based upon your customer.  

#### Understanding the Differences Between Storefronts  
Choosing a storefront starts with identifying the target audience for your offer. If your solution targets both audiences, then you are able to publish once in order to list in both storefronts.  
 
You should consider the additional benefits of each storefront.  
| Storefront benefit | [Azure Marketplace](#Azure-Marketplace) | [AppSource](#AppSource) | 
|:--- |:--- |:--- | 
| **Billing flexibility** | For VMs), Pay-As-You-Go billing options use Microsoft Enterprise Agreements (EAs) or web direct sales models. Pricing options also include a Free Tier subscription where an offering is perpetually free. They also include a Try It Now subscription that is promotionally free for a limited period, after which the VM is converted to a paid subscription. BYOL activation is also an option for supporting you.<br /><br />For both billing options, in scenarios where virtual machines are deployed using Azure apps: solution templates or Azure apps: managed apps, all provisioned Azure resources are billed directly to the customer. | AppSource offers provisioning of a trial experience, but does not currently offer a commerce-enabled publishing option. You may use your current ordering and billing infrastructure with no additional investment or changes. | 
| **Facilitation of connections with other partners** | The Azure Marketplace does not currently enable you to link a service provider or delivery partners to the offer, but this functionality is launching in 2018. | Independent software vendors, systems integrators, and managed service providers are able to be linked for specific implementation scenarios. This ability supports collaborative selling to new customers. | 
| **Automation** | The Azure Marketplace does not currently enable you to link a service provider or delivery partners to the offer. | Take advantage of automated SaaS with add-in provisioning. Use Azure apps: solution templates to automate SaaS-based data collection and deployment scenarios. | Independent software vendors, systems integrators, and managed service providers are able to be linked for specific implementation scenarios, supporting collaborative selling to new customers.
...
| **In-context presentation to customers** | Make your solution available in the Azure in-portal experience for contextual search using virtual machines and Azure apps: solution templates. | Reach more customers through the in-app experience for Microsoft products such as Dynamics 365, Power BI, and Office 365. |  
...
| Customer Ask | Azure Marketplace | 
|:--- |:--- | 
| **Demands additional cloud platform functionality to meet business and technical requirements** | Offers a growing portfolio of complementary apps and services optimized to run on Azure Marketplace | 
...
| [Stack Overflow: Azure](https://stackoverflow.com/questions/tagged/azure) | Stack Overflow environment to get solutions and ask questions about everything related to Azure and the Azure Marketplace:<ul> <li>[Azure Marketplace](https://stackoverflow.com/questions/tagged/azure-marketplace)</li> <li>[Azure Resource Manager](https://stackoverflow.com/questions/tagged/azure-resource-manager)</li> <li>[Azure Virtual Machines](https://stackoverflow.com/questions/tagged/azure-virtual-machine)</li> </ul> |  
...
3.  In the Registration - Account Info section, select your account country or region from the *Account country/region* drop-down menu.  
    ...
    >[!WARNING]
    >To sell your services on the Azure Marketplace, verify that your registered entity is from one of the approved *sell-from* countries. The location restriction is required for payout and taxation reasons. 
...
5.  For *Publisher display name*, enter the display name (typically the name of your company).  
    ...
    >[!NOTE]
    >The publisher display name entered in Dev Center is not displayed in the Azure Marketplace when your offer is listed, but you must fill this box to complete the registration process. 
...
11. Choose the next steps using the billing model for your offer.  
    ...
    |:--- |:--- |  
    | free | Go to the Cloud Partner Portal.<ul> <li>To publish on the Marketplace, visit the Cloud Partner Portal page located at [cloudpartner.azure.com](https://cloudpartner.azure.com).</li> </ul> |  

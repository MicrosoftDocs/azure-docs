...
description: Find out how to link a company work email account domain to Partner Center. Learn how to create an account and use multiple accounts. See troubleshooting tips.
...
If you link your company's work email account domain to your Partner Center account, employees of your company can sign in to Partner Center to manage marketplace offers by using their own work account usernames and passwords.

## Check whether your company already has a work account

If your company subscribes to a Microsoft cloud service such as Azure, Microsoft Intune, or Microsoft 365, you already have a work email account domain (also referred to as an Azure AD tenant) that you can use with Partner Center.

Follow these steps to check for a work account:

1. Sign in to the [Azure portal](https://portal.azure.com).
1. In the left pane, select **Azure Active Directory**, and then select **Custom Domain Names**.
1. If you already have a work account, your domain name will be listed.
...
1. Complete the other required fields, and then select **Create** to save the new user. 

The email address for the user account must be a verified domain name in your directory. You can list all the verified domains in your directory. In the left pane, select **Azure Active Directory** > **Custom domain names**.
...
If you're having trouble signing in to your work account (also known as your Azure AD tenant), find the scenario on the following diagram that best matches your situation, and take the recommended steps.
...
:::image type="content" source="media/manage-accounts/onboarding-aad-flow.png" alt-text="Flowchart that helps users solve sign-in problems. Steps in the chart check for a domain, explain how to add a domain, and provide other troubleshooting tips." lightbox="media/manage-accounts/onboarding-aad-flow.png":::

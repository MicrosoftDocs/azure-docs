...
| 7 | Marketing artifacts | Logos are displayed correctly. | <ul><li>LLogos: Small (48 x 48 px, optional), Medium (90 x 90 px, optional), and Large (from 216 x 216 to 350 x 350 px, required).</li><li>Screenshot (max. 5): Requires a .PNG image with a resolution of 1280x720 pixels. |

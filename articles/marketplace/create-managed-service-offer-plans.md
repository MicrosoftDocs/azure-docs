...
- **Approvers**: You may specify a list of users or user groups as approvers for an eligible authorization. All approvers will be notified when the approval is requested and when approval has been granted. If none are provided, the authorization will activate automatically.

...
| ------------ | ------------- | ------------- |
| Offers, VM | Many unique plan properties are now available for Azure Virtual Machine offers. On the [Create Plans tab](azure-vm-create-plans.md#properties) in Partner Center, choose from Supports backup, Supports accelerated networking, Supports extensions, and several others. | 2021-07-26 |
| Fees | Microsoft has changed its fees for certain services. See [Commercial marketplace transact capabilities](marketplace-commercial-transaction-capabilities-and-considerations#examples-of-pricing-and-store-fees) and Common questions about payouts and taxes, "[Why is my earnings amount different than what I expected?](/partner-center/payout-faq)" and "[How do I find the current Store Service Fee and the payout rate?](/partner-center/payout-faq)". | 2021-07-14 |

...
| --- | --- | --- |
| Added a [Revenue Dashboard](revenue-dashboard.md) to Partner Center, including a revenue report, [sample queries](analytics-sample-queries.md#revenue-report-queries), and [FAQs](analytics-faq.md#revenue) page. | 2021-12-08 |
...
| Policy | The SaaS customer [refund window](/marketplace/refund-policies) is now [72 hours](marketplace-faq-publisher-guide.md) for all offers. | 2021-09-01 |
...
| Offers | We have updated the names of [Dynamics 365](https://docs.microsoft.com/azure/marketplace/marketplace-dynamics-365#licensing-options) offer types:

...
This deployment template contains all the Azure resources that comprise your solution. Products that fit this scenario use only Azure resources. The Azure Resource Manager test drive is available for these offer types: virtual machines, Azure applications, SaaS, Dynamics 365 for Business Central, Dynamics 365 for Customer Engagement, and Dynamics 365 for Operations.

>[!NOTE]
>This is the only test drive option for virtual machine or Azure app offers.

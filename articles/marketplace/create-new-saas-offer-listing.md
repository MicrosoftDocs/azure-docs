...
2. In the **Search results summary** box, enter up to 50 characters of text. This summary is used in the marketplace listing search results.
...
3. (Optional) In the **CSP Program Contact** boxes, enter a name, email address, and phone number.
4. To extend your offer to the [Cloud Solution Provider (CSP)](cloud-solution-providers.md) program, in the **CSP Program Marketing Materials** box, provide a link to your marketing materials.

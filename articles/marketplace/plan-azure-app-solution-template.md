...
| Azure-compatible virtual hard disk (VHD) | VMs must be built on Windows or Linux. For more information, see:<ul><li>[Create an Azure VM technical asset](./azure-vm-create-certification-faq.md#how-to-address-a-vulnerability-or-exploit-in-a-vm-offer.md) (for Windows VHDs)</li><li>[Linux distributions endorsed on Azure](../virtual-machines/linux/endorsed-distros.md) (for Linux VHDs).</li></ul> |

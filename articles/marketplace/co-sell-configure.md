...
| :------------------- | :-------------------|
| *Solution/offer one-pager (Required)* | Drive awareness among potential customers with a professionally designed one-pager that showcases the value proposition of your solution.<br><br>You can use one of the relevant templates to provide a customer-ready description of your offering:<br><ul><li> [Microsoft Azure one-pager template](https://assetsprod.microsoft.com/mpn/customer-one-pager-microsoft-azure-partner.pptx)</li><li>[Microsoft Dynamics 365 one-pager template](https://assetsprod.microsoft.com/mpn/customer-one-pager-dynamics-365-partner.pptx)</li> <li>[Microsoft 365 one-pager template](https://assetsprod.microsoft.com/mpn/customer-one-pager-office-365-partner.pptx) </li><li>[Windows 10 one-pager template](https://assetsprod.microsoft.com/mpn/customer-one-pager-windows-partner.pptx)</li></ul><br>Microsoft sales teams may share this information with customers to help determine if your offering may be a good fit, and to ensure that it is customer ready. |
| *Solution/offer pitch deck (Required)* | You can use the [Customer presentation template](https://assetsprod.microsoft.com/mpn/customer-presentation-template.pptx) to create your pitch deck. This deck should reference the [Reference architecture diagram](reference-architecture-diagram.md). The purpose of this slide deck is to pitch your offer and its value proposition. After ensuring that your offer is customer ready, Microsoft sales teams may share this presentation with customers to articulate the value that your company and Microsoft bring when deploying a joint solution. The presentation should cover what your offer does, how it can help customers, what industries the offer is relevant for, and how it compares with competing solutions. |
| *Customer case study* (Optional)| Use the [Case study template](https://assetsprod.microsoft.com/mpn/customer-case-study-template.pptx) to create your customer case study. This information shows a potential customer how you and Microsoft have successfully deployed your offer in prior cases. |

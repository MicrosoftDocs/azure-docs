...
1. On the **Offer overview** page, in the **Marketplace programs** section the **Microsoft Azure consumption commitment** status will show either _Enrolled_ or _Not Enrolled_.
    ...
    :::image type="content" source="media/azure-benefit/enrolled-workspaces.png" alt-text="Screenshot of the Offer overview page in Partner Center that shows the Microsoft Azure consumption commitment status.":::

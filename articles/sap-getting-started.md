<properties
   pageTitle="Using SAP on Azure Virtual Machines (VMs)"
...
![Download this guide now](./sap-getting-started/media/SAP NetWeaver on Windows Azure Virtual Machine Guide Deployment Guide V2.docx)
...
![Download this guide now](./sap-getting-started/media/SAP DBMS Deployment Guide on Microsoft Azure Virtual Machine Services v3_10.docx)
...
![Download this guide now](./sap-getting-started/media/SAP NetWeaver - Building an Azure based Disaster Recovery Solution V1_5 .docx)
...
![Download this guide now](./sap-getting-started/media/SAP ASCS_SCS - Windows Server Failover on Azure with SIOS Datakeeper v2 .docx)
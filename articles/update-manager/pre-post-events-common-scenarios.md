...
1. The cancellation flow is honored from T-40 when the pre maintenance event is triggered until T-10. [Learn more](pre-post-scripts-overview.md#timeline-of-schedules-for-pre-and-post-events). 

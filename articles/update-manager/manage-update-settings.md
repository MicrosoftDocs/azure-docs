...
- For information on HotPatching see [Hotpatch for Windows Server](https://learn.microsoft.com/windows-server/get-started/hotpatch)
- For information on Automatic Guest Patching for Azure Virtual Machines and Scale Sets see [Automatic Guest Patching for Azure Virtual Machines and Scale Sets](https://learn.microsoft.com/azure/virtual-machines/automatic-vm-guest-patching)

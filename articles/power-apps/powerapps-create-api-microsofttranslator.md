...
When you add the Microsoft Translator API, you add the API to your organization's (tenant) app service environment. 
...
[Microsoft Translator REST API](../connectors/create-api-microsofttranslator.md) reference.

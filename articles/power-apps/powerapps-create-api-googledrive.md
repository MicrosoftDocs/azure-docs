...
When you add the Google Drive API, you add the API to your organization's (tenant) app service environment. 
...
[Google Drive REST API](../connectors/create-api-googledrive.md) reference.

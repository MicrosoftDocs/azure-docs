...
When you add the Bing Search API, you add the API to your organization's (tenant) app service environment. 
...
[Bing Search REST API](../connectors/create-api-bingsearch.md) reference.

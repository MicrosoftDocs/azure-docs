...
To learn how to customize Swagger 2.0 API definition in general, please refer to [Customize Swashbuckle-generated API definitions](../app-service-api-dotnet-swashbuckle-customize.md).

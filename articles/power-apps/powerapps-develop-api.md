<properties
	pageTitle="Develop API for PowerApps | Microsoft Azure"
	description="Develop API for PowerApps"
	services=""
    suite="powerapps"
	documentationCenter="" 
	authors="rajram"
...
Building and deploying an API for PowerApps is just like creating any API. You can choose your favorite programming language and framework. You can also choose to host your API anywhere. We recommend you to host it in your PowerApps' App Service Environment as [API app](https://azure.microsoft.com/services/app-service/api/).

Following are some articles showing you how to build and deploy a .Net, Java or Node.js API in App Service Environment:
...
If you follow one of the referenced articles in step 1, a standard Swagger 2.0 API definition will be generated automatically for your API. To optimize it for PowerApps, you can optionally customize the generaged Swagger 2.0 API definition using the schema extensions described below.

To learn how to customize Swagger 2.0 API definition in general, please refer to [Customize Swashbuckle-generated API definitions](../app-service-api/app-service-api-dotnet-swashbuckle-customize.md).

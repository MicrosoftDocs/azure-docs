...
If you're new to Azure AD Application Proxy and want to learn more, see [Remote access to on-premises applications through Azure AD Application Proxy](../../active-directory-domain-services/application-proxy.md).
...
1. On the Application proxy page in the Azure portal, the new connector is listed with a status of *Active*, as shown in the following example:
    ...
    ![The new Azure AD Application Proxy connector shown as active in the Azure portal](./media/active-directory-app-proxy-protect-ndes/azure-active-directory-enterprise-applications.png)
...
1. Change the NDES URL provided (via Microsoft Intune) to devices. You can make this change either in Microsoft Endpoint Configuration Center or in Intune Cloud.

...
Yes.  Members of the 'AAD DC Administrators' group are granted 'DNS Administrator' prvileges, to create and modify zones of their choosing.  The zones that are created do not neccessarily need to be a part of the verfieid domain names added to your Azure AD tenant, they can be of any domain name of your choosing.

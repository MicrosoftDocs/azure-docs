...
* An Azure Active Directory Domain Services managed domain enabled and configured in your Azure AD tenant.
    * If needed, the first tutorial [create and configures an Azure Active Directory Domain Services instance][create-azure-ad-ds-instance].
* A Windows Server VM that is joined to the Azure AD DS managed domain.
    * If needed, the previous tutorial [create a Windows Server VM and joins it to a managed domain][create-join-windows-vm].

...
| AADDS105 | *The service principal with the application ID “d87dcbc6-a371-462e-88e3-28ad15ec4e64” was deleted and then recreated. This service principal manages another service principal and an application that are used for password synchronization. The managed service principal and/or application was not authorized under the newly created service principal so they cannot be managed by our service. This means that the newly created service principal will be unable to update the old managed applications and synchronization of passwords will be affected.* | [The password synchronization application is out of date](active-directory-ds-troubleshoot-service-principals.md#alert-aadds105-password-synchronization-application-is-out-of-date) |

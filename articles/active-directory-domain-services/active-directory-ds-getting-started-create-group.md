...
This article describes and walks through the configuration tasks that are required for you to enable Azure Active Directory (Azure AD) Domain Services for your Azure AD tenant.

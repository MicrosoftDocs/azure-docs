...
You can't modify or delete the default built-in fine grained password policy. Members of the *AAD DC Administrators* group can a create custom FGPP and configure it to override (take precedence over) the default built-in FGPP, as shown in the next section.
...
1. Un-check **Protect from accidental deletion**. If this option is selected, you can't save the FGPP.

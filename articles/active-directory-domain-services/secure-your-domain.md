...
You can check if a failed authentication was using Kerberos or NTLM by enabling security audits for **Logon/Logoff** > **Audit Logon** event category. For more information, see [Enable security audits for Azure Active Directory Domain Services](security-audit-events.md).

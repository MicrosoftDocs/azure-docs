...
* Ensure that you have [enabled password synchronization](tutorial-create-instance.md#enable-password-hash-synchronization-to-azure-ad-ds) in accordance with the steps outlined in the Getting Started guide.
...
* **Synced accounts:** If the affected user accounts are synchronized from an on-premises directory, verify that:
  ...
  * You have configured Azure AD Connect to [perform a full synchronization](tutorial-create-instance.md#enable-password-hash-synchronization-to-azure-ad-ds).

...
You can use the script at https://github.com/mbendana/AADDS/tree/UbuntuVMJoin to automatically configure and install all necessary components to join the Ubuntu VM to the AADDS managed instance.

...
1. Try to ping the domain using the domain name of the Azure AD DS managed domain, such as `ping aaddscontoso.com`.
...
1. Try to use the credentials for a user account that's a part of the Azure AD DS managed domain to join VMs to the managed domain.

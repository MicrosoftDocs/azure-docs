...
1. Use the `adcli info` command to discover the Azure AD DS managed domain. The following example discovers the realm *ADDDSCONTOSO.COM*. Specify your own Azure AD DS managed domain name in ALL UPPERCASE:

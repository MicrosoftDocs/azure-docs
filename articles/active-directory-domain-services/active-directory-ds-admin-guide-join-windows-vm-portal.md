...
This article shows how to deploy a Windows Server virtual machine using the Azure portal and then join it to an Azure AD Domain Services managed domain.
...
8. The VM will be pinned to the Azure portal dashboard.

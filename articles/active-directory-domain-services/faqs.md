...
Users and groups that are synchronized from Azure Active Directory to Azure AD Domain Services cannot be modified because their source of origin is Azure Active Directory. This includes moving users or groups from the managed organizational unit AADDC Users to a custom organizational unit. Any user or group originating in the managed domain may be modified.  

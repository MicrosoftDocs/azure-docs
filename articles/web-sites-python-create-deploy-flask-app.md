...
![](./media/web-sites-python-create-deploy-flask-app/portal-deployment-history.png)

Click on **View Log** to see the output of the custom deployment script:

![](./media/web-sites-python-create-deploy-flask-app/portal-deployment-log.png)
...
<!--Link references-->
[Flask and MongoDB on Azure with Python Tools 2.1 for Visual Studio]: ../web-sites-python-ptvs-flask-table-storage
[Flask and Azure Table Storage on Azure with Python Tools 2.1 for Visual Studio]: ../web-sites-python-ptvs-flask-mongodb

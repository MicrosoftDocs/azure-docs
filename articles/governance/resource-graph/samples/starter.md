...
- [List all virtual network subnets](#list-all-virtual-network-subnets)
...
- [List alerts by severity and resource type](#list-alerts-by-severity-and-resource-type)
- [List alerts by severity and resource type with a specific tag](#list-alerts-by-severity-and-resource-type-with-a-specific-tag)

...
| `propertyChangeType` | This is depreciated and can be derived as follows  previousValue being empty indicates Insert, empty newValue indicates Remove, when both are present, it is Update.|
...
| `isTruncated` | When the number of property changes reaches beyond a certain number they are truncated and this property becomes present. |

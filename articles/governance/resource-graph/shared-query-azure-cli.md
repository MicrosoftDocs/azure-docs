...
1. Create the Azure Resource Graph shared query using the `graph` extension and
   [az graph shared-query create](https://docs.azure.cn/cli/ext/resource-graph/graph/shared-query#ext_resource_graph_az_graph_shared_query_create)
   command:
...
1. List the shared queries in the new resource group. The
   [az graph shared-query list](https://docs.azure.cn/cli/ext/resource-graph/graph/shared-query#ext_resource_graph_az_graph_shared_query_list)
...
1. To get just a single shared query result, use the
   [az graph shared-query show](https://docs.azure.cn/cli/ext/resource-graph/graph/shared-query#ext_resource_graph_az_graph_shared_query_show)
   command.

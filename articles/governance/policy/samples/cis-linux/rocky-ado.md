...
|Rocky Linux 8|[CIS Rocky Linux 8 Benchmark 3.0.0 Level 1 + Level 2 - Server](#cis-rocky-linux-8-benchmark-300-level-1--level-2---server)|
|Rocky Linux 9|[CIS Rocky Linux 9 Benchmark 2.0.0 Level 1 + Level 2 - Server](#cis-rocky-linux-9-benchmark-200-level-1--level-2---server)|
...
## CIS Rocky Linux 8 Benchmark 3.0.0 Level 1 + Level 2 - Server

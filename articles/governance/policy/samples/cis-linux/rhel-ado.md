...
|Red Hat Enterprise Linux Version|Benchmark Title|
|---|---|
|Red Hat Enterprise Linux 10|[CIS Red Hat Enterprise Linux 10 Benchmark 1.0.1 Level 1 + Level 2 - Server](#cis-red-hat-enterprise-linux-10-benchmark-101-level-1--level-2---server)|
|Red Hat Enterprise Linux 8|[CIS Red Hat Enterprise Linux 8 Benchmark 3.0.0 Level 1 + Level 2 - Server](#cis-red-hat-enterprise-linux-8-benchmark-300-level-1--level-2---server)|
|Red Hat Enterprise Linux 8|[CIS Red Hat Enterprise Linux 8 Benchmark 4.0.0 Level 1 + Level 2 - Server](#cis-red-hat-enterprise-linux-8-benchmark-400-level-1--level-2---server)|
|Red Hat Enterprise Linux 9|[CIS Red Hat Enterprise Linux 9 Benchmark 2.0.0 Level 1 + Level 2 - Server](#cis-red-hat-enterprise-linux-9-benchmark-200-level-1--level-2---server)|

## CIS Red Hat Enterprise Linux 10 Benchmark 1.0.1 Level 1 + Level 2 - Server
...
||requiredMountOptions|noexec|
|Ensure access to bootloader config is configured|directory|/boot/grub2|
||filePattern|*|
||mask|0177|
||group|root|
||owner|root|
...
|Ensure dhcp server services are not in use|unitNameKeaDhcp4Service|kea-dhcp4.service|
||expectedUnitFileState|enabled|
||expectedActiveState|active|
...
|Ensure sshd MACs are configured|macsDisallowedValues|hmac-md5,hmac-md5-96,hmac-sha1-96,umac-64@openssh\.com,hmac-md5-etm@openssh\.com,hmac-md5-96-etm@openssh\.com,hmac-sha1-etm@openssh\.com,hmac-sha1-96-etm@openssh\.com,umac-64-etm@openssh\.com,umac-128-etm@openssh\.com|
...
## CIS Red Hat Enterprise Linux 8 Benchmark 4.0.0 Level 1 + Level 2 - Server

...
ms.author: dacoulte
---
# Sample - Allowed peering location for ExpressRoute

This policy requires that ExpressRoute use specified peering locations. You specify an array of allowed peering locations.

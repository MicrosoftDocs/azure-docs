---
title: Azure Policy sample - Use approved subnet for VM network interfaces
description: This sample policy requires that network interfaces use an approved subnet.

...
description: This sample policy requires that virtual machines use a specific version of UbuntuServer.
...
Requires that virtual machines use a specific version of UbuntuServer.

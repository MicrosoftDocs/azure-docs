---
title: Azure Policy sample - Audit transparent data encryption status
description: This sample policy audits SQL database transparent data encryption if it is not enabled.

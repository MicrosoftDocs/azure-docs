...
marks the resource as non-compliant. On a new resource, Azure Policy also adds a
`Microsoft.Authorization/policies/audit/action` operation to the activity log.

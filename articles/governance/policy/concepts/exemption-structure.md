...
- Study the [Microsoft.Authorization policyExemptions resource type](https://docs.microsoft.com/en-us/azure/templates/microsoft.authorization/policyexemptions?tabs=json).

...
•	Component-level [exemptions](https://learn.microsoft.com/azure/governance/policy/concepts/exemption-structure) aren’t supported for [Resource Provider modes](https://learn.microsoft.com/azure/governance/policy/concepts/definition-structure#resource-provider-modes). Parameters are supported in Azure Policy definitions to exclude namespaces.

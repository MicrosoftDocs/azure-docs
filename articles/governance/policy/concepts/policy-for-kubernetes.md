...
#### 1.13.0
EU Data Boundary now supported by Azure Policy for Kubernetes on AKS. To learn more generally about the EU Data Boundary visit: [Overview of EU Data Boundary](https://learn.microsoft.com/privacy/eudb/eu-data-boundary-learn).

...
## Compliance state
Describes a resource's adherence to applicable policies. Can be compliant, non-compliant, exempt, conflict, not started, or protected. Learn more about [how compliance works](../how-to/get-compliance-data#how-compliance-works.md).
## Compliant
...
## Exemption
A JSON-defined object that eliminates a resource hierarchy or an individual resource from evaluation. Resources that are exempt count toward overall compliance, but are not evaluated. Learn more about the exemption JSON structure here: [Azure Policy exempotion structure](../concepts/exemption-structure.md).
## Group

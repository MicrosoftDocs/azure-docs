---
title: Create a policy for non-compliant resources with Azure PowerShell
...
In this quickstart, you create a policy assignment and assign the *Audit VMs without managed disks*
definition. This policy definition identifies resources that aren't compliant to the conditions set

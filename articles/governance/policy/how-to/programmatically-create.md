...
1. Create the policy definition using one of the following calls:
   ...
   [Azure Policy Definitions - Create or Update](/rest/api/policy-definitions/create-or-update)
   and
   [Policy Definitions - Create or Update At Management Group](/rest/api/policy-definitions/create-or-update-at-management-group).

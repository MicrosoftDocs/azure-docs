...
Parameters in Azure Policy that pass values to Guest Configuration assignments must be _string_
...
Create a DSC configuration to audit settings. The following PowerShell script example creates a

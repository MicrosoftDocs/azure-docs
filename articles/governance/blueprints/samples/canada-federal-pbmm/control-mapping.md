...
description: Control mapping of the Canada Federal PBMM blueprint samples. Each control is mapped to one or more Azure Policies that assists with assessment.
author: DCtheGeek
ms.author: dacoulte
ms.date: 09/04/2019
ms.topic: sample

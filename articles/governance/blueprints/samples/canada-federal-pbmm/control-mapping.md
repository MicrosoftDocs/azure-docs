...
**\[Preview\]: Audit Canada Federal PBMM controls** built-in policy initiative.
...
groups to "Canada Central" and "Canada East" by assigning following Azure Policy definitions:
...
- Deploy requirements to audit Windows VMs that do not restrict the minimum password length to 14
  characters

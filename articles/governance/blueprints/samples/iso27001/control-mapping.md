...
description: Control mapping of the ISO 27001 blueprint sample. Each control is mapped to one or more Azure Policies that assists with assessment.
author: DCtheGeek
ms.author: dacoulte
ms.date: 07/22/2019
ms.topic: sample
...
The following article details how the Azure Blueprints ISO 27001  blueprint sample

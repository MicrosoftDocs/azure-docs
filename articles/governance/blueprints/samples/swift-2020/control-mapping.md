...
description: Control mapping of the SWIFT CSP-CSCF v2020 blueprint sample. Each control is mapped to one or more Azure Policies that assists with assessment.
author: DCtheGeek
ms.author: dacoulte
ms.date: 09/24/2019
ms.topic: sample
...
Audit SWIFT CSP-CSCF v2020 controls and deploy specific VM Extensions to support audit requirements**

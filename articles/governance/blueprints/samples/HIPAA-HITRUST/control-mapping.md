---
title: HIPAA HITRUST blueprint sample - Control mapping
...
- Deploy default Microsoft IaasAntimwalware extension for windows server
...
## Inforamtion Excahnge Policies and Procedures
...
- Deploy prerequisites to auit Windows VMs that do not have the specified applications installed.

## Control of Operaional Software 
...
- [Preview] Show audiot reslts from Windows VMs configurations in "System Audit Policies- Account Management'
...
- [Preview] Deploy requirments to audit Windows VMs configurations in 'Security Options- Microsoft Network Server'
- {Preview] Deploy requiremnts to audit Windows VMs configurations in 'Administrative Templates- Network'

## Control of Technical Vulnerabilities 

A hardened configuration standard exists for all system and network components.Systems are appropriately hardened (e.g., configured with only necessary and secure services, ports and protocols enabled).Vulnerability scanning tools include the capability to readily update the information system vulnerabilities scanned.
...
- Automatic Provisioning of Secuirty Monitoring agent.
...
- [Preview] Show audit results from Windows VMs configration in 'Windows Firewall Propertiess'
...
- Access through Internet faing endpoints should be restriced.
- SQL mangaed instance TDE protector should be encrypted with your own key.
...
- [Preview] Show audits results from Windows VMs configurations in 'Secuirty Options- Network Access'
- Audit unrestricted network access to storage accounts
- [Preview] Show audits results from Windows VMs Configuration in ' Windows Firewall Propoerties'
- Deploy Diagnostics settings from Network Security Groups
- Access through Internet facing endpoints should be restricted

## Senstive System Isolation
...
- Vitrual Machines should be migrated to new Azure Resource Manager resources.
...
- Adaptive Application Controls should be enabled on virtaul Machines
...
- Audit unrestircted network access to storage accounts.
...
- [Preview] Show audit results from Linux VMs that do not have the passowrd file permissions set to 0644
...
- [Preview] Show audit results from windows VMs that do not thave the password complexity setting enabled.

## User Authentication for Extenal Connections
...
## User Identitifaction and Authentication
...
## Adminstrator and Operator Logs
...
- [Preview] Show audit results from Windows VMs conifguraion in 'Security Options- Recovery Console'
...
You've reviewed the control mapping of the HIPAA HITRUST PBMM blueprint sample. Next, visit the
following articles to learn about the overview and how to deploy this sample:

> [!div class="nextstepaction"]
> [HIPAA HITRUST PBMM blueprint - Overview](./control-mapping.md)
> [HIPAA HITRUST PBMM blueprint - Deploy steps](./deploy.md)

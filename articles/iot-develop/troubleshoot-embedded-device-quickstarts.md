...
* Follow the instructions in [Maximum Path Length Limitation](/windows/win32/fileio/maximum-file-path-limitation) to enable long paths in in Windows 11 and in Windows 10, version 1607 and later.

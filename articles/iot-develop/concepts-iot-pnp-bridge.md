...
To learn how to extend the IoT Plug and Play bridge to support additional device protocols, see [Extend the IoT Plug and Play bridge](https://github.com/Azure/iot-plug-and-play-bridge/pnpbridge/docs/author_adapter.md). To learn how to build and deploy the IoT Plug and Play bridge, see [Build and deploy the IoT Plug and Play bridge](https://github.com/Azure/iot-plug-and-play-bridge/pnpbridge/docs/build_deploy.md).
...
- [How to connect an IoT Plug and Play bridge sample running on Linux or Windows to IoT Hub](https://github.com/Azure/iot-plug-and-play-bridge/pnpbridge/docs/quick_start.md)
- [Build and deploy IoT Plug and Play bridge](https://github.com/Azure/iot-plug-and-play-bridge/pnpbridge/docs/build_deploy.md)
- [Extend IoT Plug and Play bridge](https://github.com/Azure/iot-plug-and-play-bridge/pnpbridge/docs/author_adapter.md)

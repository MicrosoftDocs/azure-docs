...
The Azure IoT Device SDKs are a set of device client libraries, developer guides, samples, and documentation created to make it easy to programmatically connect your devices to Azure IoT and interact with Azure IoT services. They are designed to be consistent, approachable, diagnosable, and dependable. These device SDKs fit into the broader suite of Azure IoT offerings, which includes a variety of services and tools to enable your IoT solutions. 

    :::image type="content" source="media/quickstart-send-telemetry-python/sdk_explanation_graphic.png" alt-text="IoT SDKs explanation":::

As the above graphic shows, Azure IoT Device SDKs enable you to easily connect your devices to the cloud. A variety of SDKs are available to fit your device and programming language needs, further described [below](#which-sdk-should-i-use). Additionally, Azure IoT offers Service SDKs--these SDKs allow your cloud-based application to connect with Azure IoT services on the backend. This article will focus on device SDKs, but you can learn more about Service SDKs by following the links below. 
...
| --: | :------------------------------------------------: | :---------------------------------------- |
| Support | Need to support and document whatever you build | Have access to Microsoft support (GitHub, Microsoft Q&A, Microsoft Docs, Customer Support teams, etc.) |
| New Features | Need to add new Azure features to their middleware | Be able to immediately take advantage of new features that Microsoft constantly adds to the IoT SDKs | 
| Investment | Invest hundreds of hours of embedded development to design, build, test, and maintain their own version | Be able to take advantage of free, open source tools. The only cost associated with the SDKs is the learning curve. |

## Which SDK should I use?
Azure IoT Device SDKs are available in a variety of programming languages—C, C#, Java, Node.js, and Python—so you can choose what works best for your familiarity and scenario. However, there are three primary aspects you should consider before choosing an SDK to begin developing with:

**1) Device capabilities**

The primary decision factor affecting your SDK choice will be the constraints imposed by the device for which you are writing your application. If you are working with a constrained device—that is, a device with a single microcontroller (MCU) and limited memory—we recommend that you use the Embedded C SDK. This SDK is specifically designed to provide the bare minimum set of functionalities to connect to Azure IoT and fit onto the limited resources of MCUs. You can also select components (MQTT client, TLS and socket libraries) that are most optimized for your embedded device. Similarly, if your device is running Azure RTOS, you can take advantage of the Azure RTOS middleware, which wraps additional functionality over the Embedded C SDK, to easily connect to Azure IoT.
...
**2) Your team’s familiarity with the programming language**
...
* [Reference Documentation](https://docs.microsoft.com/en-us/azure/rtos/threadx/)
...
[**Learn more about IoT Hub**](https://azure.microsoft.com/en-us/services/iot-hub/) | [**Try controlling a device**](https://docs.microsoft.com/en-us/azure/iot-hub/quickstart-control-device-python)
...
[**Learn more about Azure Digital Twins**](https://azure.microsoft.com/en-us/services/digital-twins/) | [**Code an ADT application**](https://docs.microsoft.com/en-us/azure/digital-twins/tutorial-code)
...
[**Learn more about the Device Provisioning Service**](https://docs.microsoft.com/en-us/azure/iot-dps/) | [**Try creating a group enrollment for X.509 Devices**](https://docs.microsoft.com/en-us/azure/iot-dps/quick-enroll-device-x509-csharp)

...
1. **Power Consumption**
    ...
    * **Connection**: Consider the physical connection to the power source. If you need battery power, check if there's a battery connection port available on the board.
        * If there's no battery connector, seek another comparable board or consider other ways to add battery power to your device.
...
1. **Development**
    ...
    * **Programming Language**: Consider if your project require higher-level languages beyond C/C++.
        * If so, identify the common programming languages for the application you need (for example, Machine Learning is often done in Python).
    ...
    * **Documentation**: Take a look at the device documentation. Identify if it's complete and easy to follow.
...
1. **Security**
    ...
    * **Physical location**: Consider if your device or any of the peripherals it's connected to will be accessible to the public.
...
The following is a comparison table of MCUs in alphabetical order. Note that this isn't an exhaustive list and is intended to be short.
...
The following is a comparison table of SBCs in alphabetical order. Note that this isn't an exhaustive list and is intended to be short.

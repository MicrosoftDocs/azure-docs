...
Now, remove the "scott-" part of the URL, and refresh the browser. You should see the old behavior (exhibited by the `mywebapi` version running in `default`).
...
- A Kubernetes cluster running Kubernetes 1.9.6, in the EastUS, CentralUS, WestUS2, WestEurope, CanadaCentral, or CanadaEast region, with Http Application Routing enabled.

...
To fix this issue, apply an [AzurePodIdentityException](https://github.com/Azure/aad-pod-identity/blob/b438ba37efa102d0c71015ca8a54a1d4bcdae3c5/docs/readmes/README.app-exception.md) for the *azds-injector-webhook* and update pods instrumented by Azure Dev Spaces to access the managed identity.

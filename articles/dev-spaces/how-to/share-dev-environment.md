...
With Azure Dev Spaces, you can share your development environment with others on your team. Each developer can work in their own space without fear of breaking others. Also, working together in one environment can enable you to test code end-to-end without having to create mocks or simulate dependencies. See the [Learn about team development](../get-started-nodejs-06.md) guide for more information.
...
1. Ask team members to **select the environment** in order to develop in it.
     * **Command line or VS Code**: To see existing Azure Dev Spacess you have access to: `vsce env list`. To select an environment: `vsce env select`.

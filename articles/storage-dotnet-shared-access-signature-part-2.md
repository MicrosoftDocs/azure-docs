<properties pageTitle="Create and use a SAS with the Blob Service | Microsoft Azure" description="Explore generating and using shared access signatures with the Blob service" services="storage" documentationCenter="" authors="tamram" manager="adinah" editor="cgronlun"/>

...
1. Download a transparent one-pixel test image [here](https://fpc.msedge.net/apc/trans.gif). This is the asset the client JavaScript will fetch to measure performance.

...
In this tutorial, you learn how to use the [Terraform](http://terriform.io) to perform the following tasks:
...
## Deploy pods with the Kubernetes Terraform provider
A Kubernetes *pod* is a group of containers deployed as a unit to the same host. 

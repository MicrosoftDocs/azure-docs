...
- Get started by [installing Terraform and configuring it to use Azure](terraform-install-configure.md).
- [Create an Azure virtual machine using Terraform](terraform-create-complete-vm.md)

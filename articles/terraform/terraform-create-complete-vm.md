...
## Create or get your SSH public key
To create and use SSH private and public key you can follow the steps mentioned in [here](https://docs.microsoft.com/en-us/azure/virtual-machines/linux/mac-create-ssh-keys). You need this information to create OS profile configuration for Linux.
...
resource "azurerm_virtual_machine" "myterraformvm" {
    ...
    os_profile_linux_config {
        ...
        ssh_keys {
            ...
            key_data = "ssh-rsa Your public SSH key created above"
        }
    }
...
resource "azurerm_virtual_machine" "myterraformvm" {
    ...
    os_profile_linux_config {
        disable_password_authentication = true
        # Create the SSH key as explained above and copy the public key in the key data parameter. 
        ssh_keys {
            path     = "/home/azureuser/.ssh/authorized_keys"

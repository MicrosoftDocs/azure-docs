...
Site Recovery automatically discovers VMs located and on vSphere ESXi hosts, and/or managed by vCenter servers.  To do this, Site Recovery needs credentials that can access vCenter servers and vSphere ESXi hosts. Create those as follows:

...
> [!NOTE]
> * Tutorials show you the simplest deployment path for a scenario. They use default options where possible, and they don't show all possible settings and paths. For detailed instructions, review the article in the How To section of the Site Recovery Table of Contents.
...
1. In **Create virtual network** page, under the **Basics** tab, do the following:
    ...
    1. In **Resource group**, select the resource group in which to create the network. For this tutorial, use the existing resource group **contosoRG**.
...
1. In **Create virtual network**  > **IP addresses** tab, do the following:
    ...
    1. After you delete the pre-existing address range, select **Add an IP address space**.

---
title: Azure Site Recovery (ASR) Deployment Planner Version History | Microsoft Docs
...
> - For Hyper-V to Azure disaster recovery, VM with name containing the characters like: , “” [] ` are not supported.  If profiled, report generation will fail or will have an incorrect result.

...
**Azure resources** | For the target Azure region that you want to use as your disaster recovery location, you need to have a subscription with sufficient resources for virtual machines, storage accounts, and network components. You can contact support to add sufficient resources.

...
* You'll need to make sure that virtual machines you want to protect comply with the [Azure virtual machine prerequisites](site-recovery-support-matrix-to-azure.md#support-for-replicated-machines).
...
* Virtual machines must meet Azure requirements. Check these in [Prerequisites and Support](site-recovery-support-matrix-to-azure.md#support-for-replicated-machines) in the planning guide.

...
This article discusses the various Site Recovery operations that can be performed on a VMware vCenter. Verify the [prerequisites](site-recovery-support-matrix-to-azure#support-for-datacenter-management-servers)s before you start.

...
**Azure Local integration (preview)** | Azure Site Recovery is integrated with Azure Local environments. You can replicate and recover Hyper-V virtual machine workloads running on Azure Local clusters and enables seamless disaster recovery for your hybrid infrastructure. [Learn more](/azure/azure-local/manage/azure-site-recovery?view=azloc-2602).

...
For exhaustive list of URLs to be whitelisted for communication between on-premises ASR infrastructure and Azure services, refer to [network requirements section in the prerequisites article](vmware-azure-deploy-configuration-server.md#prerequisites).

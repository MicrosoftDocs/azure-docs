<properties
	pageTitle="Migrate Windows virtual machines from Amazon Web Services to Azure"
...
7. [Set up virtual machines](site-recovery-vmware-to-azure/#step-8-set-up-machines-you-want-to-protect.md). You'll need to get the Mobility service installed on each instance (either automatically or manually).
8. [Enable protection for virtual machines](site-recovery-vmware-to-azure/#step-9-enable-protection.md). You enable protection for instances by adding them to a protection group. Note that:
...
9. [Run an unplanned failover](site-recovery-failover/#run-an-unplanned-failover.md). After initial replication is complete you can run an unplanned failover from AWS to Azure. Optionally, you can create a recovery plan and run an unplanned failover, to migrate multiple virtual machines from AWS to Azure. [Learn more](site-recovery-create-recovery-plans.md) about recovery plans.

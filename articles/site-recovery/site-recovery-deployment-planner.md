...
Number of servers that can be profiled per running instance of the Site Recovery Deployment Planner |Single (VMs belonging to one vCenter Server or one ESXi server can be profiled at a time)|Multiple (VMs across multiple hosts or host clusters can be profiled at a time)| NA |Multiple (VMs across multiple hosts or host clusters can be profiled at a time)| NA
...
## Next steps
* [Run the Site Recovery Deployment Planner](site-recovery-vmware-deployment-planner-run.md)

...
No, Site Recovery will keep all your previous recovery points. To understand it we must know how the recovery point retention process work. Depending upon the recovery points retention window, 24 hours in this case, Site Recovery saves any new recovery point. Once the window is reached, oldest point gets replaced with any new successive recovery point. It is to be noted that old points only gets replaced if there is a generation of new points. In-case, as there is no new recovery point generated due to some issue, all the old points will remain intact  once we reach the window of retention.

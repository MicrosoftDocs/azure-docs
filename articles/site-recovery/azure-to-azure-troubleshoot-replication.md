...
For example, if we look at  Premium P20 disk in the below table, Site Recovery should be able to handle 5 MB/s churn per disk with at max of five such disk per VM  due to the limit of 25 MB/s total churn per VM.

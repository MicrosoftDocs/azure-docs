...
Limitations and known issues while migrating are listed in the last section of this tutorial.
...
Before you get started, perform the following tasks to prepare the Azure subscription and on-premises VMware/Physical environment:

...
**Network mapping** | If you replicate Microsoft Hyper-V Server VMs in VMM clouds, you must set up network mapping. This ensures that Azure VMs connect to appropriate networks when they're created after failover.

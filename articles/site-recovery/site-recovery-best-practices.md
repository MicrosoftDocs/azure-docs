...
**Virtual machines** | You'll need at least one VM on the source Hyper-V server. VMs replicating to Azure must conform with [Azure virtual machine prerequisites](#azure-virtual-machine-requirements). Install or upgrade [Integration Services](https://technet.microsoft.com/en-us/library/dn798297.aspx) in the VM using the steps given [here](https://technet.microsoft.com/en-us/library/hh846766.aspx#BKMK_step4). | At least one VM on the source Hyper-V server. VMs replicating to Azure must conform with [Azure virtual machine prerequisites](#azure-virtual-machine-requirements). Install or upgrade [Integration Services](https://technet.microsoft.com/en-us/library/dn798297.aspx) in the VM using the steps given [here](https://technet.microsoft.com/en-us/library/hh846766.aspx#BKMK_step4). | At least one VM in the source VMM cloud.  Install or upgrade [Integration Services](https://technet.microsoft.com/en-us/library/dn798297.aspx) in the VM using the steps given [here](https://technet.microsoft.com/en-us/library/hh846766.aspx#BKMK_step4).

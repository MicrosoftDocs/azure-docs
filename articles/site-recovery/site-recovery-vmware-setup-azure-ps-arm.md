---
title: 'How to setup a failback Process Server (Resource Manager) In Azure | Microsoft Docs'
...
2. In the Configuration Server details page that opens click on "+ Process server"
...
| Resource Group | You can create a new Resource Group to deploy this Process Server or choose to deploy the Process Server in an existing Resource Group|
...
|**Field Name**|**Value**|
|-|-|
|Server Name| Display name & Host name for you Process Server virtual machine|
| User Name | A user name that will become an Administrator on that virtual machine|

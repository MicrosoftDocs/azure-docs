...
- If your VM was deployed as a single instance VM or as part of availability set and you want to increase the availability SLAsm you can **move your VMs into an Availability Zone**. 

...
Post comments and questions at the bottom of this article or on the [Microsoft Azure Site Recovery](https://social.msdn.microsoft.com/forums/azure/home?forum=hypervrecovmgr).
...
**Mobility service** | This service will be installed on each machine you want to replicate.
...
1. [Set up an Azure network](../virtual-network/virtual-networks-create-vnet-arm-pportal.md).
      ...
      a. Azure VMs will be placed in this network when they're created after failover.
...
9. In **Physical Machines**, click the "+" button and enter the **Name** and **IP address**.  Choose the operating system of the machine you want to replicate.
...
11. In **Replication settings** > **Configure replication settings**, verify that the correct replication policy is selected. If you modify a policy, changes will be applied to the replicating machine and to new machines.
12. Enable **Multi-VM consistency** if you want to gather machines into a replication group. Specify a name for the group, and then click **OK**. Note that:
    ...
    * We recommend that you gather VMs and physical servers together so that they mirror your workloads. Enabling multi-VM consistency can impact workload performance. It should only be used if machines are running the same workload and you need consistency.

...
> [!IMPORTANT]
> Replicating to a target storage account is no longer supported. Using a storage account as the replication target was deprecated in 2019, and only replication to managed disks is supported. You still need to create a log storage account as described in this section.

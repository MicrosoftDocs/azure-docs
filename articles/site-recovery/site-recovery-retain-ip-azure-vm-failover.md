...
For more information, refer to the [peering documentation](../virtual-network/tutorial-connect-virtual-networks-portal.md#register) and [pricing](https://azure.microsoft.com/en-us/pricing/details/virtual-network/).

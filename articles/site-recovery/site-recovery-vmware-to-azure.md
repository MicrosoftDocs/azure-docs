...
- [Learn more about failback](site-recovery-failback-azure-to-vmware.md), to fail back and start replicating Azure VMs back to the primar on-premises site.

...
description: Learn about failover and failable in Azure Site Recovery - Classic
ms.topic: conceptual
ms.date: 12/24/2019
...
See information for Preview releases, [here](failover-failback-overview-preview.md).

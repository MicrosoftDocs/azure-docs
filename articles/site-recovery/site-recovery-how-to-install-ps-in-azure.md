...
* The Process server should be deployed in a Azure virtual network such that the following communications channel are met
...
After the PS deployment in Azure completes, you can see the  succeed, the VM will enter into a protected state.

...
Premium storage | Supported | Use Premium Block Blob storage accounts to get High Churn support in Public Preview. For more information, see Azure VM Disaster Recovery - High Churn Support.

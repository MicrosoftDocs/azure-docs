...
The Site Recovery data encryption feature was available for customers who wanted to protect replicated data for Hyper-V VMs against security threats. Microsoft deprecated this feature on *April 30, 2022*. It replaced by the [encryption at rest](https://learn.microsoft.com/azure/site-recovery/encryption-feature-deprecation) feature, which uses [service-side encryption](../storage/common/storage-service-encryption.md) (SSE).

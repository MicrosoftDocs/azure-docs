...
Welcome to Azure Site Recovery! Use this article if you want to migrate VMWare virtual machines to Azure. Before you start, note that:
...
- The migration instructions in this article are based on the instructions for replicating a VMware virtual machine to Azure. It includes links to the steps in [Replicate VMware VMs or physical servers to Azure](site-recovery-vmware-to-azure.md), which describes how to replicate a physical server in the Azure portal.

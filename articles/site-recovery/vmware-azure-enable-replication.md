...
* Powershell support for replicating to managed disks is available from [Az module version 2.0 onwards](https://www.powershellgallery.com/packages/Az.RecoveryServices/2.0.0-preview) 

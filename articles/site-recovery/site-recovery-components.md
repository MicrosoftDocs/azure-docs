...
**Component** | **Details**
--- | ---
**Azure** | **Account**: You need an Azure account.<br/><br/> **Storage**: You need an Azure storage account to store replicated data. You can use a classic account or a Resource Manager storage account. The account can be LRS or GRS when you deploy in the Azure portal. Replicated data is stored in Azure storage and Azure VMs are spun up when failover occurs.<br/><br/> **Network**: You need an Azure virtual network that Azure VMs connect to when they're created at failover. In the Azure portal, networks can be created in the classic service manager model or in the Resource Manager model.
...
**Component** | **Details**
--- | ---
**Azure** | **Account**: You need an Azure account.<br/><br/> **Storage**: You need an Azure storage account to store replicated data. You can use a classic account or a Resource Manager storage account. The account can be LRS or GRS when you deploy in the Azure portal. Replicated data is stored in Azure storage and Azure VMs are spun up when failover occurs.<br/><br/> **Network**: You need an Azure virtual network that Azure VMs will connect to when they're created at failover. In the Azure portal, networks can be created in the classic service manager model or in the Resource Manager model.

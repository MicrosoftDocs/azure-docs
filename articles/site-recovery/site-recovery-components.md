...
- **Hyper-v host**: You'll need one or more Windows Server 2012 R2 Hyper-V host server. During Site Recovery deployment you'll install the Site Recovery Provider and Recovery Services agent on the host.

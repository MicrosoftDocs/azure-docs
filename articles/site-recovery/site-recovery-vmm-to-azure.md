...
Use this article to replicate on-premises Hyper-V virtual machines managed in System Center Virtual Machine Manager (VMM) clouds to Azure, using the Azure Site Recovery service in the Azure portal.
...
> [AZURE.NOTE] [Migration of networks](../resource-group-move-resources.md) across resource groups within the same subscription or across subscriptions, isn't supported for networks used for deploying Site Recovery.

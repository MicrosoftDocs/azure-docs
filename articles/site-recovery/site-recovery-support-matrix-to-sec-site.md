...
--- | --- | --- | ---
**Azure portal** | On-premises VMware VMs to a secondary VMware site.<br/><br/> Download the [help guide](http://download.microsoft.com/download/E/0/8/E08B3BCE-3631-4CED-8E65-E3E7D252D06D/InMage_Scout_Standard_User_Guide_8.0.1.pdf) the InMage Scout user guide. Not available in the Azure portal. | Not supported | On-premises Hyper-V VMs in System Center Virtual Machine Manager (VMM) clouds to a secondary VMM cloud.<br/><br/> Standard Hyper-V replication only. SAN not supported.
...
**Deployment** | **Support**
--- | ---
**VMware VM/physical server** | vSphere 6.0, 5.5, or 5.1 with latest updates
...
**Hyper-V (no VMM)** | Not supported
**Hyper-V with VMM** | Windows Server 2016, Windows Server 2012 R2. Servers should be running the latest updates.

## Operating systems for replicated machines

Site Recovery supports replication of any workload running on a supported operating system.

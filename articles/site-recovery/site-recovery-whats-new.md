...
--- | --- | --- | --- | --- | ---
[Rollup 53](https://support.microsoft.com/topic/update-rollup-54-for-azure-site-recovery-50873c7c-272c-4a7a-b9bb-8cd59c230533)  | 9.41.5888.1 | 5.1.6620.0 | 9.41.5888.1 | 5.1.6620.0  | 2.0.9202.0
...
**VMware VM/physical disaster recovery to Azure** | The update includes portal support for VMware to Azure replication to select Proximity Placements Groups after enabling replication.<br/><br/> Protecting VMware machines with data disk size up to 32 TB are now supported.

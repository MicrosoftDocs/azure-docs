...
description: This article explains how to get the list of Hyper-VMs for profiling using Azure Site Recovery deployment planner for Hyper-V to Azure scenario.
...
|-ServerListFile | The file with the list of servers containing the VMs to be profiled. The file path can be absolute or relative. This file should contain one of the following in each line:<br><ul><li>Hyper-V host name or IP address</li><li>Hyper-V cluster name or IP address</li><ul><br>Example: File "ServerList.txt" contains the following servers:<ul><li>Host_A</li><li>10.8.59.27</li><li>Cluster_1</li><li>Host_B</li><ul>|

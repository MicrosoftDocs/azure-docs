...
> [!IMPORTANT]
> Currently, Azure Site Recovery supports moving VMs from one region to another. It only supports moving across zones within a region in a few regions. [Learn more](https://docs.microsoft.com/en-us/azure/site-recovery/azure-to-azure-how-to-enable-zone-to-zone-disaster-recovery).
...
3. In **Configure disaster recovery** > **Target region**, select the target region to which you'll replicate. Ensure this region [supports](https://docs.microsoft.com/azure/availability-zones/az-region) Availability Zones.

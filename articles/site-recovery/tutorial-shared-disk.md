...
> [!NOTE]
> For Azure VMs using shared disks, shared disk details appear under the Cluster Group and might not appear under the Disks section of individual replicated items. To verify shared disk replication, review the corresponding Cluster Group.

...
Azure Site Recovery provides default alerts via Azure Monitor. Once you register this feature, Azure Site Recovery surfaces a default alert via Azure Monitor whenever any of the following critical events occur:

...
| **Protected machines** | VMs you want to protect should comply with [Azure requirements](ssite-recovery-support-matrix-to-azure.md#failed-over-azure-vm-requirements). |

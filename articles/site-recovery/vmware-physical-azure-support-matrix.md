...
Boot directory | Boot disks must not be GPT partition format, this is an Azure architecture limitation.  GPT disks are supported as data disks.<br/><br/> Multiple boot disks on a virtual machine is not supported<br/><br/> A machine without boot disk cannot be protected

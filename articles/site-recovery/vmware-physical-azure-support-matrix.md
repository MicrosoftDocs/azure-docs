...
Linux Red Hat Enterprise | 5.2 to 5.11</b><br/> 6.1 to 6.10</b><br/> 7.0 to 7.7<br/><br/> 8.0<br/> <br/> Servers running Red Hat Enterprise Linux 5.2-5.11 & 6.1-6.10 do not have [Linux Integration Services (LIS) components](https://www.microsoft.com/download/details.aspx?id=55106) pre-installed. Ensure to install the [components](https://www.microsoft.com/download/details.aspx?id=55106) before enabling replication for the machines to boot in Azure.
Linux: CentOS | 5.2 to 5.11</b><br/> 6.1 to 6.10</b><br/> 7.0 to 7.7<br/><br/> 8.0<br/> <br/> Servers running  CentOS 5.2-5.11 & 6.1-6.10 do not have  [Linux Integration Services (LIS) components](https://www.microsoft.com/download/details.aspx?id=55106) pre-installed. Ensure to install the [components](https://www.microsoft.com/download/details.aspx?id=55106) before enabling replication for the machines to boot in Azure.
...
|||
16.04 LTS | [9.29][9.29 UR] | 4.4.0-21-generic to 4.4.0-161-generic,<br/>4.8.0-34-generic to 4.8.0-58-generic,<br/>4.10.0-14-generic to 4.10.0-42-generic,<br/>4.11.0-13-generic to 4.11.0-14-generic,<br/>4.13.0-16-generic to 4.13.0-45-generic,<br/>4.15.0-13-generic to 4.15.0-62-generic<br/>4.11.0-1009-azure to 4.11.0-1016-azure,<br/>4.13.0-1005-azure to 4.13.0-1018-azure <br/>4.15.0-1012-azure to 4.15.0-1057-azure|
...
|||
18.04 LTS | [9.29][9.29 UR]  | 4.15.0-1009-azure to 4.15.0-1037-azure,<br/>4.15.0-20-generic to 4.15.0-62-generic,<br/>4.18.0-1006-azure to 4.18.0-1025-azure,<br/>4.18.0-13-generic to 4.18.0-25-generic,<br/>5.0.0-1012-azure to 5.0.0-1018-azure,<br/>5.0.0-15-generic to 5.0.0-27-generic|
...
**Supported release** | **Mobility service version** | **Kernel version** |
--- | --- | --- |
Debian 7 | [9.26][9.26 UR], [9.27][9.27 UR], [9.28][9.28 UR], [9.29][9.29 UR]| 3.2.0-4-amd64 to 3.2.0-6-amd64, 3.16.0-0.bpo.4-amd64 |
|||
...
Debian 8 | [9.26][9.26 UR] | 3.16.0-4-amd64 to 3.16.0-8-amd64, 4.9.0-0.bpo.4-amd64 to 4.9.0-0.bpo.8-amd64 |

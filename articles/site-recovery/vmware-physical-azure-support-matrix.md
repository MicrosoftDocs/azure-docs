...
Volume manager | Before 9.20 version, <br/> 1. LVM2 is supported. <br/> 2. LVM is supported for data disks only. <br/> 3. Azure VMs have only a single OS disk.<br/><br/>From [9.20 version](https://support.microsoft.com/en-us/help/4468181/azure-site-recovery-update-rollup-30) onwards, LVM and LVM2 are supported

...
6. In Linux virtual machines, device name or mount point name should be unique. Ensure that no two devices/mount points have case isensitive names. For example, naming two devices of same virtual machine as *device1* and *Device1* is not allowed.

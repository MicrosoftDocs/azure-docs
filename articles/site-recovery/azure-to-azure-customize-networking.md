...
- [Network security group](https://docs.microsoft.com/azure/virtual-network/manage-network-security-group) both for the subnet and for the NIC
 ...
 > [!IMPORTANT]
  > These settings are supported only in the failover operation at the moment and not for test failover.
...
4. Select **Edit** near the NIC you want to configure. In the next blade that opens, select the corresponding pre-created resources in the target.

---
title: Deprecation of Hyper-V (with VMM) disaster recovery to Azure using Site Recovery | Microsoft Docs
...
---
# Deprecation of Hyper-V (with VMM) disaster recovery to Azure

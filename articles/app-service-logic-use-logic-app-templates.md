...
### BizTalk Templates
Configurations of BizTalk VETR (validate, extract, transform, route) pipelines as well as EDIFACT, EDI and AS2 message handling.

### Message Routing Templates
Patterns for doing messaging routing patterns including synchronous request-response, routing messages across different protocols and content based routing.

### Service Integration Templates
Examples of how to integrate across different SaaS connectors.  Here you can find various examples integrating Facebook, Salesforce, Box, SharePoint and other services.
...
### Social Templates
Simple templates that integrate with social media services such as Twitter, Facebook, Yammer and email.  These can be great personal productivity applications that constantly listen for updates and takes action when new items arrive.

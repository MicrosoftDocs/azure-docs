...
The namespace is the client-facing pseudofilesystem that allows you to swap out back-end storage without changing 

In this tutorial you will learn: 

> [!div class="checklist"]
> * How to add back-end storage to the cluster 
...
FXT Edge Filer is compatible with several popular NAS hardware systems, and can use empty containers from Azure Blob or other cloud storage. (The FXT operating system must be able to manage all of the data on the cloud storage, but you can move your data to the cloud container after adding it as a cluster core filer.)
...
> 
> Support for Azure Blob storage is included in the FXT Edge Filer software license. 

For more detailed information about adding core filers, read the [Cluster Configuration Guide](https://azure.github.io/Avere/legacy/ops_guide/4_7/html/ops_conf_index.html):
...
* For NAS core filers, provide the fully qualified domain name (or IP address). (FQDN is recommended for all core filers, and required for SMB access.)
...
* VServers’ namespace junctions map the client-facing virtual directory structure to exports on backend storage

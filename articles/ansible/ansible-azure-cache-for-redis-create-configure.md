---
title: Tutorial - Create and configure an Azure Cache for Redis using Ansible | Microsoft Docs
...
# Tutorial: Create and configure an Azure Cache for Redis using Ansible

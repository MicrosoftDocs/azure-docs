...
If the user performs an action that displays a progress bar, such as tab completing while in the `Azure:` drive, then it is possible that the cursor is not set properly and a gap appears where the progress bar was previously.

<properties title="Manage your Search service on Microsoft Azure" pageTitle="Manage your Search service on Microsoft Azure" description="Manage your Search service on Microsoft Azure" metaKeywords="" services="" solutions="" documentationCenter="" authors="" videoId="" scriptId="" />

# Manage your Search service on Microsoft Azure

Search service administration tasks can be performed using the service dashboard on the Preview Portal. You can adjust resource allocation, adding partitions, replicas, or both, depending on where you need to scale the solution. Once peak volumes subside, you can scale back to a resource level that is more appropriate to your current requirements.

Access to a Search service is predicated on having the service URL and api-key that authenticates search application API requests to your Search service on Microsoft Azure. Primary and secondary api-keys are generated when you create the service but can be regenerated at any time.

Service names are a fixed property. You cannot rename a service after its created.
...
<!--Anchors-->
[Scale up]: #subheading-1
[Scale down]: #subheading-2
[Key Management]: #subheading-3

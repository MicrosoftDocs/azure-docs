...
> [WACOM.NOTE] If you have a converter which is not listed above, you can try running the WAImportExport tool using your converter to prepare the drive and see if it works before purchasing a supported converter.
...
- In shipping your packages, you must follow the terms at [Microsoft Azure Service Terms](http://azure.microsoft.com/en-us/support/legal/services-terms/) and [Supplemental Terms of Use for Microsoft Azure Previews](http://azure.microsoft.com/en-us/support/legal/preview-supplemental-terms/). 

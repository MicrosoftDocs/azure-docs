...
6. 	In Step 5, select your return carrier from the list, and enter your carrier account number. Microsoft will use this account to ship your drives back to you once your import job is complete.
	...
	If you do not have a tracking number yet, choose <strong>I will provide my shipping information for this import job once I have shipped my package</strong>, then complete the import process.
...
- For regions in the US and Europe, only [Federal Express](http://www.fedex.com/us/oadr/ ) (FedEx) is supported. Package(s) for an import job can be shipped either with FedEx Express or FedEx Ground. All packages will be returned via FedEx Ground.

- For regions in Asia, only [DHL](http://www.dhl-welcome.com/Tutorial/) is supported. 

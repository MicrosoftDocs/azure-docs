...
- **Network security group for private endpoints**: For private endpoints associated with Private Link Service Direct Connect (PLSDC), configurations with PrivateEndpointNetworkPolicies enabled, including NetworkSecurityGroupEnabled, aren't supported during preview.

...
**For private DNS zone settings for Azure services that support a a private endpoint, see [Azure Private Endpoint private DNS zone values](private-endpoint-dns-values.md).**

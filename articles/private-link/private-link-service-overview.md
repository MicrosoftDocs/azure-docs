...
### Share your service 
Once you create a Private Link Service, Azure infrastructure will generate a globally unique "alias" based on the name you provide for your service.  You can share the alias with your customers offline or advertise it publicly. Consumers can start a Private Link connection using this alias.  

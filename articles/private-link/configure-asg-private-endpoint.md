...
- An Azure web app on a Basic, Standard, Premium v2, Premium v3, or Isolated v2 App Service plan (or a function app on the Functions Premium plan) deployed in your Azure subscription. For the App Service plan tiers that support private endpoints, see [Azure Private Link availability](availability.md).

<properties pageTitle="Get Started with Azure Notification Hubs" description="Learn how to use Azure Notification Hubs to push notifications to users" services="notification-hubs" documentationCenter="Mobile" authors="piyushjo" manager="dwrede" editor=""/>

...
For full details on how network security groups work see the following [information][NetworkSecurityGroups].  The details below will touch on highlights of network security groups, but with a focus on the unique aspects  of configuring and applying a network security group to an App Service Environment.

...
By clicking the following button, you will be transferred to the Azure portal page that allows you to start creating a new Azure DevTest Lab will appear.

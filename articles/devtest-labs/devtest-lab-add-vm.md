...
1. On the **Basic Settings** tab of the **Create lab resource** screen, provide the following information:
   ...
   - **Security type**: You can select **Trusted launch** to enable trusted launch for Generation 2 VMs. If you select Trusted Launch, you can select the **Enable secure boot**, **Enable vTPM**, and **Integrity monitoring** checkboxes as needed. For more information, see [Trusted Launch for Azure virtual machines](/azure/virtual-machines/trusted-launch).

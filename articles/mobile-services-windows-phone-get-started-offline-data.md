...
* To support synchronization of deleted records with offline data sync, you should enable [Soft Delete]. Otherwise, you have call `IMobileServiceSyncTable.PurgeAsync()` to purge the local store.

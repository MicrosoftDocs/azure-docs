---
title: Deploy a network function on Nexus Azure Kubernetes Services
description: Learn the high-level process to deploy a network function on Nexus Advanced Kubernetes services.
author: HollyCl
ms.author: HollyCl
ms.service: azure
...
# Quickstart: Deploy a network function on Nexus Advanced Kubernetes Services (NAKS)

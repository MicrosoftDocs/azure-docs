<properties pageTitle="Pagination in Azure Search" description="Pagination in Azure Search" services="search" documentationCenter="" authors="HeidiSteen" manager="mblythe" editor=""/>

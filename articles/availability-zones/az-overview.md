...
You can build high availability into your application architecture by using Azure services that deliver resiliency. Co-locate your compute, storage, networking, and data resources across an availability zone, and replicate this arrangement in other availability zones.

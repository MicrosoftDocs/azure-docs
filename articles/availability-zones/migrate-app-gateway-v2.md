...
[Application Gateway Standard v2](/azure/application-gateway/overview-v2) or WAF v2 now supports zonal and zone redundant deployments. For more information about zone redundancy, see [Regions and availability zones](az-overview.md). 

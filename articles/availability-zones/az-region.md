...
- **Zone-redundant services** – Resources replicated or distributed across zones automatically. (For example, Load Balancer, Application Gateway, Service Bus, VPN, Zone-Redundant Storage).  

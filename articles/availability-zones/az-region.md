...
| SQL Database                       | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: (Preview) |
...
| Azure App Service Environments ILB | :heavy_check_mark: | :heavy_check_mark: |  |

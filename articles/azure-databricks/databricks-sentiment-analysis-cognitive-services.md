...
That's it! Using Azure Databricks, you have successfully streamed data into Azure Event Hubs in near real-time, consumed the stream data using the Event Hubs connector, and then ran sentiment analysis on streaming data.

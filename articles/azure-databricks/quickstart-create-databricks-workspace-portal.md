...
2. Under **Azure Databricks Service**, provide the values to create a Databricks workspace.
    ...
    |**Virtual Network**     |  Choose to deploy an Azure Databricks workspace in your own Virtual Network (VNet). For more information, see [Deploy Azure Databricks in your Azure Virtual Network (VNet Injection)](https://docs.azuredatabricks.net/administration-guide/cloud-configurations/azure/vnet-inject.html).        |

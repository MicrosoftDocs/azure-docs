...
| user       | JSON                     | *Optional* `{ displayName: <display_name>, id: <user_id>, name: <user_name>, }` Identifies users of your application. It can be used by your application to identify your users by using the Fluid Framework Audience. <add link here>  |

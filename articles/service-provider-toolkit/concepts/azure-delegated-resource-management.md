...
As a service provider, you can define user groups in your own tenant for the roles that are required to perform tasks for your customers. Your users can then manage the customers’ resources using their own account credentials. They can also [view and manage all delegated customer subscriptions in the new **My customers** page](../how-to/view-manage-customers.md) in the Azure portal. The [cross-tenant management experience](cross-tenant-management-experience.md) helps you work more efficiently with services and governance experiences like Azure Policy, Azure Security Center, and more. All activity is tracked in Azure Monitor logs, so you can easily identify the user associated with any changes.

...
We are going to move your Azure subscription from its current directory into the Office 365 directory we worked with in Phase 1.

Follow the instructions described [here](https://msdn.microsoft.com/3d6c4fd1-c981-4c57-9402-59fe31b11883). Pay particular attention to the following steps:

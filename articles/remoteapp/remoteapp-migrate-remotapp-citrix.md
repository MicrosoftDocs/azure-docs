...
Fortunately you can reuse majority of the investments you've already made in Azure RemoteApp, but there a few high level prerequisites for deploying XenApp Essentials.

## Prerequisites

1. Create a new VNET, or determine which Azure VNET in ARM that you'll deploy Citrix XenApp Essentials into. Azure RemoteApp uses Azure classic; Citrix XenApp Essentials only supports ARM.  

<properties 
	pageTitle="Add paging to data (JavaScript) - Azure Mobile Services" 
	description="Learn how to use paging to manage the amount of data returned to your Windows Store JavaScript app from Mobile Services." 

...
- **App Configuration Endpoint**: A drop-down that loads your available configuration stores endpoint under the selected subscription. To update and refresh your list of available configuration stores endpoint, press the **Refresh App Configuration Name** button to the right of the textbox. **Refresh App Configuration Name** button to the right of the textbox.

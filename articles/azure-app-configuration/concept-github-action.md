...
For more information about Azure App Configuration CLI commands, see the Azure [AppConfifguration CLI documentation.](https://learn.microsoft.com/en-us/cli/azure/appconfig?view=azure-cli-latest)
...
## Authentication to AppConfiguration from Github Actions
To push configurations to your Azure App Configuration you can authenticate using one of the following methods:

### 1. Using Azure login.
The recommended way to authenticate is by using the [Azure login](https://learn.microsoft.com/en-us/azure/developer/github/connect-from-azure?tabs=azure-portal%2Cwindows) Github action.
...
In this article, you learned how to use the Azure CLI in GitHub Actions to automate updates to your Azure App Configuration instance. To learn how Azure App Configuration reacts to changes in key-value pairs, continue to the next [article](./concept-app-configuration-event.md).

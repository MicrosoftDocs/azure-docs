...
| [az appconfig credential list](cli/azure/ext/appconfig/appconfig/credential#ext-appconfig-az-appconfig-credential-list) | List access keys for an App Configuration store. |

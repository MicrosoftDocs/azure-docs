...
```azurecli 
az resource move --destination-group <resource-group> --destination-subscription-id <SubscriptionId> --ids <"store-resource-ID-1>" <"store-resource-ID-2"> <"store-resource-ID-3">
```

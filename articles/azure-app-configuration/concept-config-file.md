...
Files provide a common way of storing configuration data. If you use files but want to store your configuration data in Azure App Configuration, you don't have to enter your data manually. You can use tools to [import your configuration files](./howto-import-export-data.md).

If you plan to manage your data in App Configuration, the import operation is a one-time data migration. In other cases, for example, where you adopt [configuration as code](./howto-best-practices.md#configuration-as-code), you might continue managing your configuration data in files and importing them recurrently as part of your CI/CD process. In this situation, one of the following scenarios might apply to you:

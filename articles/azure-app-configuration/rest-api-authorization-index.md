...
The [authorization model](./rest-api-authorization-aad.md) associated with Azure Active Directory (AAD) authentication uses Azure RBAC to control permissions. See the [AAD authorization](./rest-api-authorization-aad.md) page for details.

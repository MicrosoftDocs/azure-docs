...
1. [Containerize the application](./quickstart-azure-kubernetes-service.md#containerize-the-application) and [Push the image to Container Registry](./quickstart-azure-kubernetes-service.md#push-the-image-to-container-registry). 

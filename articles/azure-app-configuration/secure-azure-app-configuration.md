...
- **Use network security perimeter (preview)**: Define a logical network boundary for your App Configuration store and other PaaS resources using [network security perimeter](INSERT LINK). 

...
In this tutorial, you created an App Configuration key that references a value stored in Key Vault.
To learn how to automatically reload secrets from Key Vault, continue to the next tutorial:

> [!div class="nextstepaction"]
> [Automatically reload secrets from Key Vault](./howto-reload-key-vault-secrets.md)

 To learn how to add an Azure-managed service identity that streamlines access to App Configuration and Key Vault, refer to the following tutorial:

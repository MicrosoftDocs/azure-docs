...
| SnapshotStorageSize | Count | Represents the total storage usage of key value snapshot(s) in bytes. |
...
| SnapshotStorageSize | This metric does not have any dimensions.  |

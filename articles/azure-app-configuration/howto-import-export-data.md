...
1. Enter the export command `az appconfig kv export`  and enter the following parameters:
    ...
    | `--export-as-reference` `-r` | Optional. Flag to specify whether key-values are exported to App Service as App Configuration references. [Learn more](../app-service/app-service-configuration-references.md). |

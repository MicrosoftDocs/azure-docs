...
This article provides a guide for importing and exporting data with App Configuration. To continue using your existing source control practices while benefiting from App Configuration, follow this guide to [import configuration files from your GitHub repository](./import-configuration-from-github.md) or use the [Azure Pipelines Tasks](./pull-key-value-devops-pipeline.md).

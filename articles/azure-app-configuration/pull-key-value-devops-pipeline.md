...
- **App Configuration endpoint**: A drop-down that loads your available store configuration endpoints under the selected subscription. To update and refresh your list of available store configuration endpoints, press the **Refresh App Configuration endpoint** button to the right of the textbox.

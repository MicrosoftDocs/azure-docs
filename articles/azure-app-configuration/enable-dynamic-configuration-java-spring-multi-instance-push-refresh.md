---
title: "Tutorial: Use dynamic configuration using push refresh in a multi instance Java Spring app"
titleSuffix: Azure App Configuration
description: In this tutorial, you learn how to dynamically update the configuration data for a Java Spring app using push refresh that is running multiple instances.
...
> * Deploy an a Spring Boot application to App Service, with multiple instances.
...
```xml
        ...
        <dependency>
         ...
         <!-- Adds the Push Bus Endpoint - Will still need additional dependency for Service Bus -->
        <dependency>
        ...
        <!-- This or Similar needs to be added at the same time as spring-cloud-bus -->
        <dependency>
            <groupId>com.azure.spring</groupId>
...
spring.cloud.azure.appconfiguration.stores[0].monitoring.push-notification.primary-token.secret= myTokenSecret
      servicebus:
        namespace: spring-multi-instance-test
        connection-string: Endpoint=sb://spring-multi-instance-test.servicebus.windows.net/;SharedAccessKeyName=springcloudbus;SharedAccessKey=mPV/dOxC3hhiTbBdgY3nnmiRPYRcwqbyE5BsyRTtSUM=;EntityPath=springcloudbus
    stream:
      bindings:
        springCloudBusInput:
          destination: springCloudBus
          group: sub-${SUB_ID}-${COMPUTERNAME}
...
> [!NOTE]
> When an app configuration instance scales it should have a unique 

...
You've registered the feature management service in your ASP.NET Core app in the [Quickstart](./quickstart-feature-flag-aspnet-core.md). The `TimeWindowFilter` has been automatically.

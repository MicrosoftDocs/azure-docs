...
1. Optional: If you wish to grant access to Key Vault as well, follow the directions in [Assign a Key Vault access policy](/azure/key-vault/assign-access-policy-portal).

...
> [!IMPORTANT]
> Previously Azure Media Services integration with Azure CDN was implemented only on **Azure CDN from Verizon**.  From January 2017, Azure Media Services integration with Azure CDN is implemented on all Azure CDN (both **Azure CDN from Verizon** and **Azure CDN from Akamai**).  You can associate Azure CDN profile with Azure Media Services streaming endpoint to enable CDN integration on streaming endpoint. For more information about Azure CDN features, see the [CDN overview](cdn-overview.md).
> 
> 

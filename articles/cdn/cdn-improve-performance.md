...
These profiles support only **gzip** encoding. When a profile endpoint requests a **gzip** encoded file, it is always requested from the origin, regardless of the client request. 

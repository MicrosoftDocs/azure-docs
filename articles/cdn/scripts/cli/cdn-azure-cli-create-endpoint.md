...
As an alternative to using the Azure portal, you can use these sample Azure CLI scripts to manage the following CDN operations:
...
If you don't already have a resource group for your CDN profile, create the group with the command `az group create`:

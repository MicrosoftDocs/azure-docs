...
3. Select **Get****Secret permissions** and Select get and list **Certificate permissions** to allow CDN to perform these permissions to get and list the certificates. 

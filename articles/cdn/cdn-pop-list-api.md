...
Use Azure Front Door [service tags](../virtual-network/service-tags-overview.md) with Azure CDN from Microsoft to configure Microsoft's backend IP ranges. IP Ranges and Service tags for Microsoft services can be found [here](https://www.microsoft.com/en-us/download/details.aspx?id=56519).

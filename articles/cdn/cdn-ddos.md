...
Azure CDN form Microsoft is protected by [Azure Basic DDoS](https://docs.microsoft.com/azure/virtual-network/ddos-protection-overview). It is integrated into the Azure CDN from Microsoft platform by default and at no additional cost. The full scale and capacity of Azure CDN from Microsoft’s globally deployed network provides defense against common network layer attacks through always-on traffic monitoring and real-time mitigation. Basic DDoS protection also defends against the most common, frequently occurring Layer 7 DNS Query Floods and Layer 3 and 4 volumetric attacks that target CDN endpoints. This service also has a proven track record in protecting Microsoft’s enterprise and consumer services from large scale attacks.

## Azure CDN from Verizon

Azure CDN from Verizon is protected by Verzion's proprietary DDoS mitigation platform. Is is integrated into Azure CDN from Verizon by default and at no additional cost. It provide's basic protection against against the most common, frequently occurring Layer 7 DNS Query Floods and Layer 3 and 4 volumetric attacks that target CDN endpoints.

## Azure CDN from Akamai

Azure CDN from Akamai is protected by Akamai's proprietary DDoS mitigation platform. Is is integrated into Azure CDN from Akamai by default and at no additional cost. It provide's basic protection against against the most common, frequently occurring Layer 7 DNS Query Floods and Layer 3 and 4 volumetric attacks that target CDN endpoints.

...
-	We will not be able to rollback the automatic migration.
-	Microsoft will not always be able to maintain feature level parity in the new Front Door configuration.
-	Automatic migration will not be possible for endpoints with `*.vo.msecnd.net` domains.
...
| January 3, 2025   | No more profile changes will be allowed on Azure CDN from Edgio. |
...
| January 7-14, 2025 | All remaining Azure CDN from Edgio profiles will be migrated to Azure Front Door if the said Feature Flag is not set. |
...
### Can I be informed regarding the the exact date and time my Edgio profile will be automatically migrated?

No. We are doing this migration on a "best effort" basis between January 7th and 14th, 2025 for customers who did not take action prior. Therefore we will not be able to inform each customer regarding migration timings, but as noted previously after the migration we will inform you whether it was successful or not.

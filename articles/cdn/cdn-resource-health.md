...
>
> The signals that feed Azure CDN resource health might be up to 15 minutes delayed.
...
|---|---|
|You might have stopped, removed, or misconfigured one or more of your CDN endpoints | You might have stopped, removed, or misconfigured one or more of your CDN endpoints.|
...
|We're sorry, your CDN endpoints might be affected by ongoing issues with some of our CDN providers | Check back here for status updates; Use the Troubleshoot tool to learn how to test your origin and CDN endpoint; If your problem persists after the expected resolution time, contact support. |

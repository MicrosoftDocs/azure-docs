...
### Verify the request
First, we should do a quick sanity check on the request.  You can use your browser's [developer tools](/microsoft-edge/devtools-guide-chromium/overview) to view the requests being made.

...
High-definition video is becoming an ever-larger part of the Internet, which creates  difficulties for efficient delivery of such large files across the Internet. Customers expect smooth playback of video on demand (VOD) or live video assets on a variety of networks and clients all over the world. A fast and efficient delivery mechanism for media streaming files is critical to ensure smooth and enjoyable consumer experience.  
...
## Media streaming optimizations for Azure Content Delivery Network from Verizon

Azure Content Delivery Network from Verizon is capable of delivery streaming media assets directly using the general web delivery optimization type. There are also a few features on the CDN by default that directly assist in delivery media assets.

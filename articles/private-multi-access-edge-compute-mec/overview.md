...
## Next steps
- Learn more about [Azure Private 5G Core](https://learn.microsoft.com/azure/private-5g-core/private-5g-core-overview)
- Learn more about [Azure Network Function Manager](https://learn.microsoft.com/azure/network-function-manager/overview)
- Learn more about [Azure Kubernetes Service (AKS) hybrid deployment](https://learn.microsoft.com/azure/aks/hybrid/)
- Learn more about [Azure Stack Edge](https://learn.microsoft.com/azure/databox-online/)

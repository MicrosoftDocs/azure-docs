...
> [!NOTE]
> This document covers Virtual Machine Scale Sets using Flexible as well as Uniform Orchestration modes. We recommend using Flexible Orchestration for new workloads. For more information, see [Orchesration modes for Virtual Machine Scale Sets in Azure](virtual-machine-scale-sets-orchestration-modes.md).

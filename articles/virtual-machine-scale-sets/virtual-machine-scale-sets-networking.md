...
For more information on load balancer and virtual machine scale sets, see **[Virtual networks and virtual machines in Azure](../../includes/virtual-machines-common-network-overview.md).

...
There are three different modes an Upgrade Policy can be set to. The modes are **Automatic**, **Rolling** and **Manual**. Each mode is unique in the way upgrades are performed and can impact the overall service uptime of your Virtual Machine Scale Set. 

...
To modify the default settings associated with Rolling Upgrades, please review [RollingUpgradePolicy](https://learn.microsoft.com/en-us/rest/api/compute/virtual-machine-scale-sets/create-or-update?tabs=HTTP#rollingupgradepolicy).

...
1. Go to 'Create a virtual machine scale set' page on the portal.
    :::image type="content" source="./media/azure-hybrid-benefit-linux/create-vmss-ahb.png" alt-text="Image shows the virtual machine create blade in the Azure portal..":::

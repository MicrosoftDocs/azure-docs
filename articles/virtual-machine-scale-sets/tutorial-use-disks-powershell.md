---
title: Create and use disks for scale sets with Azure PowerShell | Microsoft Docs
description: Learn how to create and use Managed Disks with virtual machine scale set using Azure PowerShell, including how to add, prepare, list, and detach disks.
...
---
# Create and use Disks with virtual machine scale set using Azure PowerShell

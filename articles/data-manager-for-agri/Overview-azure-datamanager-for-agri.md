...
Adopting sustainable agriculture practices is crucial for the future of our planet, that’s why Microsoft Azure Data Manager for Agriculture is built to enable the industry to accelerate agriculture and sustainability digital solutions. Azure Data Manager for Agriculture helps enable a more sustainable future and a more productive agriculture industry by empowering organizations to drive innovation through insight, reduce their environmental impact, optimize agriculture operations, and build trust rooted in transparency. 
...
* Agriculture Data Model, the underlying logic to store data, help generate insights and actions.
* Solution framework for ISVs to enable industry leading models (yield, risk)
* Coverage for Farm Equipment, sensors, weather stations, satellites, soil reports and weather forecasting data providers.

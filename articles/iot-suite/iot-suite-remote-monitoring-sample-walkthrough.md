...
The Remote Monitoring [solution accelerator](../iot-solutions/iot-solutions-what-are-solution-accelerators.md) implements an end-to-end monitoring solution for multiple machines in remote locations. The solution combines key Azure services to provide a generic implementation of the business scenario. You can use the solution as a starting point for your own implementation and [customize](../iot-solutions/iot-solutions-remote-monitoring-customize.md) it to meet your own specific business requirements.
...
The following diagram outlines the logical components of the remote monitoring solution accelerator overlaid on the [IoT architecture](../iot-solutions/iot-solutions-what-is-azure-iot.md):
...
For more conceptual information about the remote monitoring solution accelerator, see [Customize the solution accelerator](../iot-solutions/iot-solutions-remote-monitoring-customize.md).

...
The next thing to try is [customizing the device simulator microservice in the Remote Monitoring solution](../iot-solutions/iot-solutions-remote-monitoring-test.md)

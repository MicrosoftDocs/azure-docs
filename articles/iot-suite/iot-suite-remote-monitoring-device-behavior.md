...
The article [Understand the device model schema](../iot-solutions/iot-solutions-remote-monitoring-device-schema.md) described the schema that defines a simulated device model. That article referred to two types of JavaScript file that implement the behavior of a simulated device:
...
The [Simulation](../iot-solutions/iot-solutions-remote-monitoring-device-schema.md#simulation) section of the device model schema defines the internal state of a simulated device:
...
The [CloudToDeviceMethods](../iot-solutions/iot-solutions-remote-monitoring-device-schema.md#cloudtodevicemethods) section of the device model schema defines the methods a simulated device responds to.
...
The [Create a simulated device](../iot-solutions/iot-solutions-remote-monitoring-test.md) article shows you how to run the device simulation service locally. Running the service locally makes it easier to debug your simulated devices before you deploy them to the cloud.
...
Now you have learned how to specify the behavior of a simulated device, the suggested next step is to learn how to [Create a simulated device](../iot-solutions/iot-solutions-remote-monitoring-test.md).

...
1. [Configure a new station in the Connected Factory topology](../iot-solutions/iot-solutions-connected-factory-configure.md) in the `ContosoTopologyDescription.json` file.

...
Learn more about standard vCPU quotas on the [Virtual machine vCPU quotas page](https://docs.microsoft.com/en-us/azure/virtual-machines/windows/quotas) and [Azure subscription and service limits page](https://docs.microsoft.com/en-us/azure/azure-supportability/classic-deployment-model-quota-increase-requests). 

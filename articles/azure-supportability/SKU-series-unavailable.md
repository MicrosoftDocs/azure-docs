...
To request access to a SKU that has been restricted from your subscription, please follow the instructions below to open a support request.
1. Click on "New Support request" in the portal. Select Issue type as "Subscription Management" on the Basics page and click "Next".
...
3. On the Contact Information page enter your contact details and click on "Create".

...
With Azure AD Premium, you can add your company's logo and other branding to the Azure sign in page and Access Panel pages. [Learn more about Azure AD editions](https://msdn.microsoft.com/library/azure/dn532272.aspx) and [get started with Azure AD Premium](https://msdn.microsoft.com/library/azure/dn499825.aspx)

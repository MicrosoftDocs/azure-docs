...
-	[Azure AD](../web-sites-dotnet-lob-application-with-azure-ad/) - You can implement authentication and authorization for your website with Azure AD. Using Azure AD as the identity provider has the following characteristics:
...
-	[On-premise secure token service (STS), such as AD FS](../web-sites-dotnet-lob-application-with-adfs/) - You can implement authentication and authorization for your website with an on-premise STS like AD FS. Using on-premise AD FS has the following characteristics:

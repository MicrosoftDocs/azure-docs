...
###<a name="1getdata"></a>Step 1: Get data
...
###<a name="2processdata"></a>Step 2: Pre-process data
...
###<a name="3definefeatures"></a>Step 3: Define, extract and enrich features
...
###<a name="4applyalgorithm"></a>Step 4: Choose and apply a learning algorithm
...
###<a name="5predictnewdata"></a>Step 5: Predict over new data 

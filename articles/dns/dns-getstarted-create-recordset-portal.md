...
7. Add the IP addresses, one IP address per line. Use the suggested record set name and record type from this example. This adds the IPv4 IP addresses to the **A** record for the www record set.

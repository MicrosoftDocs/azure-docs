---
title: Create a DNS zone using Azure CLI 1.0| Microsoft Docs
description: Learn how to create DNS zones in Azure DNS. This is a step-by-step guide to create and manage your first DNS zone using the Azure CLI 1.0.
services: dns
...
# Create an Azure DNS zone using Azure CLI 1.0

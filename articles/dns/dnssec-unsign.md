...
> This DNSSEC preview is offered without a requirement to enroll in a preview. You can use Cloud Shell to sign or unsign a zone using Azure PowerShell or Azure CLI. Signing a zone by using the Azure portal is available in the next portal update.

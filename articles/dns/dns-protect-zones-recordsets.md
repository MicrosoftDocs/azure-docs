...
This article explains how Azure DNS enables you to protect your public DNS zones and records against such changes.  We apply two powerful securities features provided by Azure Resource Manager: [Azure role-based access control (Azure RBAC)](../role-based-access-control/overview.md) and [resource locks](../azure-resource-manager/management/lock-resources.md).
...
:::image type="content" source="./media/dns-protect-zones-recordsets/resource-group-rbac.png" alt-text="Screenshot of access control page for resource group.":::
...
There are two types of resource lock: **CanNotDelete** and **ReadOnly**. These lock types can be applied either to a public DNS zone, or to an individual record set. The following sections describe several common scenarios, and how to support them using resource locks.

...
1. Interrupt connectivity from on-prem to one of your Vnets by disabling or disconnecting the interface. Verify that the connection does not automatically reconnect on-demand.

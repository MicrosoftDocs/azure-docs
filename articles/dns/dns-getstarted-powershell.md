...
These instructions assume you have already installed and signed in to Azure PowerShell. If not, see [How to manage DNS zones using PowerShell](dns-operations-dnszones.md).

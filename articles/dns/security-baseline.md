...
**Guidance**: Enable diagnostic settings in Azure Monitor for access to audit, security, and diagnostic logs. Activity logs, which are automatically available, include event source, date, user, timestamp, source addresses, destination addresses, and other useful elements.
...
- [Understand RBAC in Azure DNS](https://docs.microsoft.com/azure/dns/dns-protect-zones-recordsets#role-based-access-control)
...
- [Azure DNS Protection API information](https://docs.microsoft.com/rest/api/dns/)
...
- [How to protect against changes in Azure DNS](https://docs.microsoft.com/azure/dns/dns-protect-zones-recordsets)

...
DNS name resolution is a multi-step process, which can fail for many reasons. The steps below help you investigate why DNS resolution is failing for a DNS record in a zone hosted in Azure DNS.

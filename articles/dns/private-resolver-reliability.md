...
Azure DNS Private Resolver supports availability zones without any further configuration!
...
Azure DNS Private Resolver supports Availability Zones without any other configuration required. When the service is provisioned, it's deployed across the different Availability Zones and will provide zonal resiliency out of the box.

### Prerequisites

The regions listed in this location [include availability zone support](/azure/availability-zones/az-region.md#azure-regions-with-availability-zones). You won't need to take any other action beyond provisioning the service.
...
For Azure DNS Private Resolver, you do not need to do any other steps. Just [create the resource](dns-private-resolver-get-started-portal.md) in the region with AZ support and it will be available across all AZs

...
- [How to integrate Key Vault with Azure Disk Encryption for Windows and Linux IaaS VMs](https://azure.microsoft.com/documentation/articles/azure-security-disk-encryption/) - This disk encryption solution is integrated with Azure Key Vault to help control and manage the disk encryption keys and secrets in your key vault subscription, while ensuring that all data in the virtual machine disks are encrypted at rest in your Azure storage.

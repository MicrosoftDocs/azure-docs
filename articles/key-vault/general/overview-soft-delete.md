...
The soft-delete feature is initially available through the [REST](/rest/api/keyvault/), [CLI](soft-delete-cli.md), [PowerShell](soft-delete-powershell.md) , [.NET/C#](/dotnet/api/microsoft.azure.keyvault?view=azure-dotnet) interfaces and [ARM template](https://docs.microsoft.com/azure/templates/microsoft.keyvault/2019-09-01/vaults).

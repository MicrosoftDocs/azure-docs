...
- **Store secrets backed by Hardware Security Modules** - The secrets, keys, and certificates at store are encrypted either with software key (Standard tier) or FIPS 140-2 Level 2 validated HSMs key (Premium tier) 

...
> [!NOTE]
> If Key Vault is created through [Azure Lighthouse](https://docs.microsoft.com/azure/lighthouse/overview), it is tied to managing tenant id instead. Azure Lighthouse is only supported by vault access policy permission model.
> For more information about tenants in Azure Lighthouse, see [Tenants, users, and roles in Azure Lighthouse](https://docs.microsoft.com/azure/lighthouse/concepts/tenants-users-roles).

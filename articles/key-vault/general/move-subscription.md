...
You can check existing roles using the [Azure portal](../../role-based-access-control/role-assignments-list-portal.md), [PowerShell](../../role-based-access-control/role-assignments-list-powershell.yml), [Azure CLI](../../role-based-access-control/role-assignments-list-cli.yml), or [REST API](../../role-based-access-control/role-assignments-list-rest.md).

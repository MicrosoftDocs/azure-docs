...
Follow the steps in the "Audit your key vaults to check if soft-delete is enabled" section in this article. Any key vault that doesn't have soft-delete turned on will be affected by this change.

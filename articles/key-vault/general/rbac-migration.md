...
> [!NOTE]
> Changing permission model requires 'Microsoft.Authorization/roleAssignments/write' and 'Microsoft.KeyVault/vaults/write' permissions, which is part of [Owner](../../role-based-access-control/built-in-roles.md#owner) role. Classic subscription administrator roles like 'Service Administrator' and 'Co-Administrator' are not supported.

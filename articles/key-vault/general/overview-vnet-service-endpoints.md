...
| Azure Firewall Premium| Azure Firewall Premium provides advanced threat protection for highly sensitive and regulated environments. For more information, see [Azure Firewall Premium Features](../../firewall/premium-features.md).

...
| Azure Database for PostgreSQL Flexible server | [Data encryption for Azure Database for PostgreSQL Single server](../../postgresql/flexible-server/concepts-data-encryption.md) |

...
| Azure Bot Service | [Azure AI Bot Service encryption for data at rest](/azure/bot-service/bot-service-encryption?view=azure-bot-service-4.0#grant-azure-bot-service-access-to-a-key-vault) |

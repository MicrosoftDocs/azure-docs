...
After you create one or more key vaults, you'll likely want to monitor how and when your key vaults are accessed, and by whom. Key Vault logging saves information about the activities performed on your vault, including:
...
You can do this by enabling logging for Azure Key Vault, which saves information in an Azure storage account that you provide.

You can access your logging information 10 minutes after the key vault operation. In most cases, it will be quicker than this.  It's up to you to manage your logs in your storage account.

For steps on enabling logging, see [How to enable Key Vault logging](howto-logging.md)
...
- For steps on enabling logging, see [How to enable Key Vault logging](howto-logging.md)
- For an overview of Azure Key Vault security features, including logging, see [Azure Key Vault security](overview-security.md).

...
> [!NOTE]
> Azure App Service certificate configuration through Azure Portal does not support Key Vault RBAC permission model. Client libraries like Azure PowerShell, Azure CLI, ARM templates require **Key Vault Secrets User** and **Key Vault Reader** role assignemnts.

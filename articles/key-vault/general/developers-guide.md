...
For more information about Key Vault management plane, see [Key Vault Management Plane](./security-overview.md#management-plane-and-azure-rbac)
...
For more information about Key Vault data plane security, see [Key Vault Data Plane and access policies](./security-overview.md#data-plane-and-access-policies) and [Key Vault Data Plane and Azure RBAC (preview)](./security-overview.md#data-plane-and-azure-rbac-preview)

...
>
> This article provides Azure PowerShell instructions for updating the diagnostic Logging, however the same can be enabled using Azure Monitor on the Azure portal using Diagnostic logs section. 
>
>

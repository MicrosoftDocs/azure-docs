...
Before we go any further, please read the [basic concepts](../key-vault-whatis#basic-concepts) especially [Managed Service Identity](../active-directory/managed-service-identity/overview.md)

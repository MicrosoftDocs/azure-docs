...
| Type of operation | Endpoint:port |
|----------------|---------------|
| Key Vault operations like cryptographic operations<br> on keys, Created/read/update/delete keys and secrets,<br> set/get tags and other attributes on<br> key vault objects (keys/secrets)     | **Global:**<br> &lt;vault-name&gt;.vault.azure.net:443<br><br> **Azure China:**<br> &lt;vault-name&gt;.vault.azure.cn:443<br><br> **Azure US Government:**<br> &lt;vault-name&gt;.vault.usgovcloudapi.net:443<br><br> **Azure Germany:**<br> &lt;vault-name&gt;.vault.microsoftazure.de:443 |

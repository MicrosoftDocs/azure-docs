...
| User/Service principal using Org ID+ADFS<br> or other federated endpoint<br> (e.g. user@contoso.com) | All the above endpoints for Org ID plus ADFS or other federated endpoints |

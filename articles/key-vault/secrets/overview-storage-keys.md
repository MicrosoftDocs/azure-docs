...
>[Note]
> Shared access signature tokens are versioned. Key Vault only supports SAS token versions 2020-08-04 or older. SAS tokens generated using Azure CLI / Powershell may use a higher version. This is specified using the 'sv=' query parameter. If the version is higher than 2020-08-04 refer to Shared Access Signature documentation for Azure Storage to generate a template for the supported version.

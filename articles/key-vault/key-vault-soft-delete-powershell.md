...
>[!NOTE]
> There is an outdated version of our Key Vault Powershell output formatting file that some other Microsoft teams have inadvertently distributed. If you notice you're not seeing the soft-delete enabeled property described in this topic, try the following:

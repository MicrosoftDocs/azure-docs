...
>[!NOTE]
> There is an outdated version of our Key Vault Powershell output formatting file that may be loaded instead of the correct version. If you notice you're not seeing the soft-delete enabeled property described in this topic, try the following:

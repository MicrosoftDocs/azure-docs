...
>[!NOTE]
> There is an outdated version of our Key Vault Powershell output formatting file that may be loaded into your environement instead of the correct version. If you notice you're not seeing the soft-delete enabeled property described in this topic, try the following:
`$vault = Get-AzureRmKeyVault -VaultName myvault; $vault.EnableSoftDelete`.
> You may also upgrade to version 5.0.0 of Azure Powershell to address this issue.

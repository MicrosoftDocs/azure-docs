...
|Azure Event Hubs|[Allow access to a key valut for customer-managed keys scenario](https://docs.microsoft.com/en-us/azure/event-hubs/configure-customer-managed-key)|
|Azure Service Bus|[Allow access to a key valut for customer-managed keys scenario](https://docs.microsoft.com/en-us/azure/service-bus-messaging/configure-customer-managed-key)|

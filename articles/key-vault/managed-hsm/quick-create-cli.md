...
* **hsmUri**: In the example, the URI is <code>https://contosohsm.managedhsm.azure.net.</code> Applications that use your HSM through its REST API must use this URI.

...
> [!NOTE]
> If you are using Managed Identities as the initial admins of your Managed HSM, you should input the OID/PrinicpalID of the Managed Identities after '--administrators' and not the ClientID.

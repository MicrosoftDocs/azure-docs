...
> [!Note] 
> If a Key Vault certificate expires it can still be retrieved, but certificate may become ineporable in scenarios like TLS protection where expiration of certificate is validated.  

...
- For a follow-up tutorial that uses Azure Key Vault in a .NET web application, see [Use Azure Key Vault with an Azure web app in .NET](tutorial-net-create-vault-azure-web-app.md).

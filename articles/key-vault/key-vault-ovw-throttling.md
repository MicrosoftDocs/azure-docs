...
description: Information on Key Vault throttling, which limits the number of concurrent calls to prevent overuse of resources
services: key-vault
author: author: lleonard-msft
manager: mbaldwin
tags:

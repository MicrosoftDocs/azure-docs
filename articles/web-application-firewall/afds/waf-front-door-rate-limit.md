...
description: Learn how to use Web Application Firewall (WAF) rate limiting to protect your web applications from malicious attacks.
author: johndowns

...
This article shows how to configure a WAF rate limit rule that controls the number of requests allowed from a particular client to a web application that contains */promo* in the URL.
...
Before you install Front Door module, make sure the current version of PowerShellGet is installed. Run the following command and reopen PowerShell.

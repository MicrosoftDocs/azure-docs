...
:::image type="content" source="../media/waf-frontdoor-monitor/waf-diagnostic setting.png" alt-text="Screenshot of the Azure portal showing how to enable the WAF logs.":::

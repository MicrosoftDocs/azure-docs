...
2. In the details page, under the **Manage rules** section, from the drop-down menu, select the check box in front of the rule **Microsoft_BotManager_1.0**, and then select **Save** above.

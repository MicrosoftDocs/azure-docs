...
WAF on Application Gateway is based on [Core Rule Set (CRS)](https://owasp.org/www-project-modsecurity-core-rule-set/) 3.2, 3.1, 3.0, or 2.2.9 from the Open Web Application Security Project (OWASP). 

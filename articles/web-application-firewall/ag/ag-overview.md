...
* AnomalyScoring: This is the default action for OWASP and CRS rulesets where total anomaly score is incremented when a rule with this action is matched. The Bot Manager ruleset does not support this action.

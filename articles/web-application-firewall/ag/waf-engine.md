...
* [Increased scale limits](../../azure-resource-manager/management/azure-subscription-service-limits.md#application-gateway-limits): HTTP listener limits, WAF IP address ranges per match condition, and exclusion limits.

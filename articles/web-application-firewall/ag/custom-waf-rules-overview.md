...
> [!NOTE]
> If your WAF is running Core Rule Set (CRS) 3.1, or any other earlier CRS version, the match value only allows letters, numbers and punctuation marks. Quotation marks `&#8220;`, `&#8221;`, `&#8217;`, and `&#8216;` and spaces ` ` are not supported.

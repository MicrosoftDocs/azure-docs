...
> [!NOTE]
> WAF custom rules don't support evaluating or taking actions based on uploaded file names. As a result, you can't use custom rules to block or allow requests based on file names or file types.

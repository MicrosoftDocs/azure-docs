...
\* Request IP Address Sensitive Data Protection rules only support the *equals any* operator and scrubs all instances of the requestor's IP address that appears in the WAF logs.
...
Use the following Azure PowerShell commands to enable and configure Sensitive Data Protection:

...
- Disable request body inspection
   ...
   By setting **Inspect request body** to off, the request bodies of all traffic won't be evaluated by your WAF. This may be useful if you know that the request bodies aren’t malicious to your application.

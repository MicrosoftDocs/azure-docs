...
- To learn more about Web Application Firewall, see [Introduction to Azure Web Application Firewall](/learn/modules/introduction-azure-web-application-firewall/).

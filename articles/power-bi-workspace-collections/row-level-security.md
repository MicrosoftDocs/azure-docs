...
![Model diagrame in Power BI Desktop](media/row-level-security/diagram-view-3.png)
...
![Diagrame view with relationships highlighted](media/row-level-security/diagram-view-9.png)
...
![Cross fitler direction for relationship](media/row-level-security/edit-relationship-10.png)

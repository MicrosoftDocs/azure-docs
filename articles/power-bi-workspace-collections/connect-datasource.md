...
You can import using all of the available data sources within Power BI Desktop. You will **not** be able to refresh that data within Power BI Workspace Collections. You will have to upload changes to your PBIX file to Power BI Workspace Collections. This is due to no available gateway. 

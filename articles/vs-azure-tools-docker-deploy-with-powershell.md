<properties
   pageTitle="Deploy an ASP.NET Core Linux Docker container to a remote Docker host with PowerShell | Microsoft Azure"
   description="Learn how to use Visual Studio Tools for Docker to deploy an ASP.NET Core web app to a Docker container running on an Azure Docker Host Linux VM with PowerShell"   
...
- [An ASP.NET Core Web Application](./vs-azure-tools-docker-hosting-web-apps-in-docker.md)

## Use the DockerTask.ps1 PowerShell Script 

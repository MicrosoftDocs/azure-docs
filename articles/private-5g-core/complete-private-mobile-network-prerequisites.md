...
You may allocate a single subnet for the Azure Stack Edge interfaces marked with an asterisk (*). This arrangement, called a flat network, should only be chosen when a limited set of subnets is available.

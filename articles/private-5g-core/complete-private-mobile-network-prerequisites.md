...
| 11. | Create a Network Function Manager Device resource and register it with your Azure Stack Edge Pro device. | [Quickstart: Create a Network Function Manager Device resource (Preview)](/azure/network-function-manager/create-device) |

...
> [!IMPORTANT] 
> Log Analytics currently can only be used to monitor private mobile networks that support 5G devices. You can still monitor private mobile networks supporting 4G devices from the local network using the [packet core dashboards](packet-core-dashboards.md). 

...
You can use Azure Policy to mandate CMK for SIM groups. See [Azure Policy built-in policy definitions for Azure Private 5G Core](azure-policy-reference.md).
...
You can use Azure Policy to mandate Entra ID for accessing diagnostics. See [Azure Policy built-in policy definitions for Azure Private 5G Core](azure-policy-reference.md).

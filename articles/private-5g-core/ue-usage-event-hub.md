...
Azure Private 5G Core can be configured to integrate with Azure Event Hub, allowing you to monitor UE usage. This can be configured during site creation, see [Collect UE usage tracking values](collect-required-information-for-a-site.md#collect-ue-usage-tracking-values) or at a later stage by [modifying the packet core](modify-packet-core).

## UE usage attributes

When configured, AP5GC will send Data Usage Reports per-QoS flow level for all PDU sessions. The following attributes are reported:
...
|**Total data Volume (Bytes)** |Integer ||
|**Uplink data volume** |Integer ||
|**Downlink data volume** |Integer ||
...
|**ARP**<br> - **ArpPriorityLevel**<br>- **Preemption Capability** <br>- **Preemption Vulnerability** |String <br> - Int (1-15) <br>- String <br>- String |The address resolution protocol, including the: priority level, preemption capability and preemption vulnerability. See [5G quality of service (QoS) and QoS flows](policy-control.md#5g-quality-of-service-qos-and-qos-flows) for more information. |

...
- Contact your SIM vendor to discuss programming your SIMs with the public keys.
...
1. Navigate to your Key Vault in the portal and select the secret you just created. Make a note of the **secret identifier** URL. You will need to configure the packet core with this URL.

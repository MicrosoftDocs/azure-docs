...
2. Select or enter the following values, using the information you retrieved in [Prerequisites](#prerequisites).
    ...
    | **Custom Location** | Enter the resource ID of the custom location that targets the Azure Kubernetes Service on Azure Local instance on the Azure Stack Edge Pro device in the site. |

...
1. On the **Configuration** tab, set **Custom ARC location** to the custom location that targets the AKS-HCI cluster on the Azure Stack Edge Pro device in the site. You must ensure that you select the correct resource, as this can't be reversed once you've applied it.
1. Select **Apply**.

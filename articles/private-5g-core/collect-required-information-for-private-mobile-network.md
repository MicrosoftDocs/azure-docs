...
Collect all of the following values for the mobile network resource that will represent your private mobile network.
   ...
   |The mobile country code for the private mobile network. For more information on MCCs, see <https://www.itu.int/rec/T-REC-E.212>.   |**Network configuration: Mobile country code (MCC)**|
   |The mobile network code for the private mobile network. For more information on MNCs, see <https://www.itu.int/rec/T-REC-E.212>.     |**Network configuration: Mobile network code (MNC)**|

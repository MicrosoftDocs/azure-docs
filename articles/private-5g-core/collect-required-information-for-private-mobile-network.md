...
Collect all of the following values for the mobile network resource that will represent your private mobile network.
   ...
   |The mobile country code for the private mobile network. If you do not already have this, contact your national telecom regulator.    |**Network configuration: Mobile country code (MCC)**|
   |The mobile network code for the private mobile network. If you do not already have this, contact your national telecom regulator.     |**Network configuration: Mobile network code (MNC)**|

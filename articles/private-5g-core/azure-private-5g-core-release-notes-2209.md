...
This article applies to the Azure Private 5G Core 2209 version (PMN-4-17). This release is compatible with the Azure Stack Edge Pro GPU running the <!-- TODO --> release and is supported by the 2022-04-01-preview [Microsoft.MobileNetwork API version](/rest/api/mobilenetwork).

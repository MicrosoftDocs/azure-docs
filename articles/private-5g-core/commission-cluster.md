...
:::zone pivot="ase-pro-2"
3. Carry out the following procedure up to ten times, plus once for each of the supplementary data networks (twelve times in total if you have the maximum ten data networks):

...
| C#/.NET | [WebApp-WebAPI-OAuth2-UserIdentity-Dotnet](http://github.com/AzureADSamples/WebApp-WebAPI-OAuth2-UserIdentity-Dotnet) | Add authorization with [https://msdn.microsoft.com/en-us/library/azure/dn645545.aspx](OAuth 2.0 in Azure AD) to an existing web application so it can call a web API.
...
| C#/.NET | [WebApp-WebAPI-MultiTenant-OpenIdConnect-DotNet](https://github.com/AzureADSamples/WebApp-WebAPI-MultiTenant-OpenIdConnect-DotNet) |  A multi-tenant MVC web application that uses OpenID Connect (ASP.Net OpenID Connect OWIN middleware) to authenticate users from an Azure AD tenant. Uses an authorization code to invoke the Graph API.o
...
| C#/.NET |  [AAL - Windows Store app to REST service - Authentication](http://go.microsoft.com/fwlink/?LinkId=330605) |  Use [http://go.microsoft.com/fwlink/?LinkID=258232](Azure AD Authentication Library (ADAL)) (formerly AAL) for Windows Store Beta to add user authentication capabilities to a Windows Store app.
| C#/.NET | [ADAL - Native App to REST service - Authentication with AAD via Browser Dialog](http://go.microsoft.com/fwlink/?LinkId=259814) |  Use [http://go.microsoft.com/fwlink/?LinkID=258232](Azure AD Authentication Library (ADAL) to add user authentication capabilities to a WPF client.
...
| C#/.NET | [ADAL - Server to Server Authentication](http://go.microsoft.com/fwlink/?LinkId=259816) | Use [http://go.microsoft.com/fwlink/?LinkID=258232](Azure AD Authentication Library %28ADAL%29) to secure service calls from a server side process to an MVC4 Web API REST service.

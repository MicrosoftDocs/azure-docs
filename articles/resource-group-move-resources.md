...
5. If you are moving classic resources, you have reviewed [Classic resource limitations](#classic-resource-limitations).
...
- Batch
- CDN
- Cloud Services - see [Classic resource limitations](#classic-resource-limitations)
- Data Factory
- DocumentDB
- HDInsight clusters
- Key Vault
...
- Scheduler
- Search
- Storage (classic) - see [Classic resource limitations](#classic-resource-limitations)
...
- Virtual Machines (classic) - see [Classic resource limitations](#classic-resource-limitations)
...
- Storage
- Virtual Machines
- Virtual Networks (classic) - see [Classic resource limitations](#classic-resource-limitations)
...
## Classic resource limitations

The options for moving classic resources differ based on whether you are moving the resources within a subscription or to a new subscription. To move classic resources from **one resource group to another resource group within the same subscription**, the following restrictions apply:
...
To move classic resource **to a new subscription**, the following restrictions apply:

- All classic resources in the subscription must be moved in the same operation.
- The move can only be requested through the portal or through a seperate REST API for classic moves. The standard Resource Manager move commands do not work when moving classic resources to a new subscription. The steps to use either the portal or the REST API are shown in sections below.
...
When moving classic resources to a new resource group, you can use the edit icon next to the name of the resource group.

![move classic resources](./media/resource-group-move-resources/edit-rg-icon.png)

Select the resources to move while keeping in mind the [Classic resource limitations](#classic-resource-limitations). Select **OK** to start the move.

 ![select classic resources](./media/resource-group-move-resources/select-classic-resources.png)
 
 When moving classic resources to a new subscription, use the edit icon next to the subscription.

<properties 
	pageTitle="Enable diagnostic logging - Azure Websites" 
...
For information on working with Application Diagnostics using Visual Studio, see [Troubleshooting Azure Web Sites in Visual Studio](/develop/net/tutorials/troubleshoot-web-sites-in-visual-studio/).
...
Diagnostics can be enabled by visiting the **Configure** page of your Azure Website in the [Azure Management Portal](https://manage.windowsazure.com). On the **Configure** page, use the **application diagnostics** and **site diagnostics** sections to enable logging.
...
> [AZURE.NOTE] If you have not installed the Azure Command-Line Tools, or have not configured it to use your Azure Subscription, see [How to Use Azure Command-Line Tools](/develop/nodejs/how-to-guides/command-line-tools/).
...
- [Tutorial - Troubleshooting Web Sites](/develop/net/best-practices/troubleshooting-web-sites/)
- [Troubleshooting Azure Web Sites in Visual Studio](/develop/net/tutorials/troubleshoot-web-sites-in-visual-studio/)

...
* **Use samples immediately**. This is optimized for you seeing analytics in action as fast as possible. If you want a quick example of how Synapse works, choose this option.
* **Browser available sample**. This lets you link sample data sets and add sample code in the form of SQL scripts, notebooks, and pipelines.
* **Tour Synapse studio". This takes you on a brief tour of the basic parts of Synapse Studio. This is useful if you have never used Synapse Studio before.
...
1. CLick Run. This will run the text you selected.

## Loading the more NYC Taci Data

1. The **Knowledge Center** click **Use samples immediately**
1. Select **Browse available samples** 
1. Select the **SQL scipts** tab at the top

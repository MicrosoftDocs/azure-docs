...
- **Output C:** We will have tested and determined the data ingestion rate achievable in our environment and can determine whether our data ingestion rate is sufficient to migrate historical data during the available time window.
    ...
    - **Test C2:** Identify allocated bandwidth of ExpressRoute and if there is any throttling setup by the infra team. For more information, see  [What is Azure ExpressRoute? (Bandwidth options)](../../expressroute/expressroute-introduction.md#bandwidth-options.md).
...
1. Load POC dataset:
    - Make data available in Azure by extracting from the source or by creating sample data in Azure. For more information, see:
        ...
        - [Copy activity performance and scalability guide](../../data-factory/copy-activity-performance.md#copy-performance-and-scalability-achievable-using-adf.md)

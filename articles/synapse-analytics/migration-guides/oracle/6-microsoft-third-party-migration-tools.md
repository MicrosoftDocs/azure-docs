...
- Third-party tools to bridge the [SQL differences](5-minimize-sql-issues.md#sql-dml-differences-between-oracle-and-azure-synapse) between your existing data warehouse DBMS and Azure Synapse.

...
* **Initial:** a link connection is created but not started. You won't be charged in initial state.
...
* **Stopped:** a link connection is stopped. You won't be charged in stopped state.
* **Pausing:** a link connection is going to be paused. The compute engine is being shut down. 
* **Paused:** a link connection is paused. You won't be charged in paused state.
...
For more information, see [Manage Azure Synapse Link for SQL change feed](/sql/sql-server/synapse-link/synapse-link-sql-server-change-feed-manage).
...
* To learn more, see how to [Configure Azure Synapse Link for SQL Server 2022](connect-synapse-link-sql-server-2022.md).

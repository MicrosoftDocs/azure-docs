...
1. Input your link connection settings:
   ...
   * Select your **Core count** for the [link connection compute](sql-server-2022-synapse-link.md#link-connection). We recommend starting from small number and increasing as needed.

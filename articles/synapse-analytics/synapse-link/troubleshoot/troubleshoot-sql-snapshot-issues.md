...
If errors have forced the snapshot to retry, find more information in the changefeed.change_feed_errors dynamic management view. Run the following T-SQL command in the source database:

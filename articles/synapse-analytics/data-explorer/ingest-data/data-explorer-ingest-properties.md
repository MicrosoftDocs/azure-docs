...
|`format` |The data format (see [supported data formats](data-explorer-ingest-supported-formats.md)).|`with (format="csv")`|
...
* Learn more about [supported data formats](data-explorer-ingest-supported-formats.md).

...
1. Select the pool 'SQLDB1'(pool created in [STEP 1](https://docs.microsoft.com/en-us/azure/synapse-analytics/get-started-create-workspace#create-a-sql-pool) of this tutorial) in 'Connect to' section of the script.

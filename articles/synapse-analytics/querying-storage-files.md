---
title: Querying storage files #Required; update as needed page title displayed in search results. Include the brand.
...
This section contains sample queries you can use to query files in storage via SQL on-demand service.
<!---Required:

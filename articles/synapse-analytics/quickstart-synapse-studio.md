...
2. Select one or more files and then create a new SQL script or a Spark notebook to see the content of the files. If you want to create a notebook, you would need to create a [serverless Apache Spark pool in Synapse workspaces](quickstart-create-apache-spark-pool-studio.md).

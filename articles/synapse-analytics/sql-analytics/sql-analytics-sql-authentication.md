...
![SQL Server Admins](../../sql-database/media/sql-database-manage-logins/sql-admins.png)
...
articles\sql-database\media\sql-database-manage-logins
![configuration of the two administration accounts](../../sql-database/media/sql-database-manage-logins/1sql-db-administrator-access.png)
...
![Non-administrator access path](../../sql-database/media/sql-database-manage-logins/2sql-db-nonadmin-access.png)

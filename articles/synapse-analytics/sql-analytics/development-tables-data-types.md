...
| [table](/sql/t-sql/data-types/table-transact-sql) |If using SQL Analytics pool, you can convert to temporary tables. If using SQL Analytics on-demand, you may consider storing data to storage using [CETAS](development-tables-cetas.md). |

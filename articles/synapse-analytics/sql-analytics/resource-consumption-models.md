...
To learn more about managing performance, see [Resource classes for workload management](../../sql-data-warehouse/resource-classes-for-workload-management.md) and [Memory and concurrency limits](../synapse-analytics/sql-data-warehouse/memory-concurrency-limits.md).

---
title: Best practices for SQL on-demand
...
SQL on-demand is an additional resource within Azure Synapse Analytics. In this article, you'll find a collection of best practices for using SQL on-demand. 
...
Also see our [Troubleshooting](sql-data-warehouse\sql-data-warehouse-troubleshoot.md) article for common issues and solutions. If you're working with SQL pools rather than SQL on-demand, see our [Best Practices for SQL pools](synapse-analytics\sql-analytics\best-practices-sql-pool.md) article.
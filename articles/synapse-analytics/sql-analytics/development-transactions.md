...
To optimize and minimize the amount of data written to the log, please refer to the [Transactions best practices](../../sql-data-warehouse/sql-data-warehouse-develop-best-practices-transactions.md) article.
...
## Next steps
To learn more about optimizing transactions, see [Transactions best practices](../../sql-data-warehouse/sql-data-warehouse-develop-best-practices-transactions.md). To learn about other SQL Data Warehouse best practices, see [SQL Data Warehouse best practices](../../sql-data-warehouse/sql-data-warehouse-best-practices.md).

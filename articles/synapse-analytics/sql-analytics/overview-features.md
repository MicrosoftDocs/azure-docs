...
| Storage AAD passthrough authentication | Yes, using User identity, assigned Service identity, or [Application identity](https://docs.microsoft.com/sql/t-sql/statements/create-external-data-source-transact-sql?view=azure-sqldw-latest) | Yes, using User identity  or assigned Service identity |
...
| Permissions - [Database-level](https://docs.microsoft.com/en-us/sql/relational-databases/security/authentication-access/database-level-roles?view=sql-server-ver15) | Yes | Yes |

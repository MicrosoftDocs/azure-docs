...
- To change the resource class for a query, see [Change a user resource class example](../../sql-data-warehouse/resource-classes-for-workload-management.md#change-a-users-resource-class).

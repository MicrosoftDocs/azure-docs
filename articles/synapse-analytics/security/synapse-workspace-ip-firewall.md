...
Make sure that the firewall on your network and local computer allows outgoing communication on TCP ports 80, 443 and 1433 for Synapse Studio and outgoing communication on TCP port 443 for private endpoints of your workspace target sub-resources (Sql, SqlOnDemand, Dev).

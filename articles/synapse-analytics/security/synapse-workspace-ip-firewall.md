...
![Azure portal Synapse workspace IP configuration.](../media/security/ip-firewall-2.png).
...
![Azure portal Synapse workspace IP configuration.](../media/security/ip-firewall-3.png).
...
>[!NOTE] 
> The communication that currently uses TCP port 1443 will use port 443 in the future. This document will be updated when that change is in effect. 

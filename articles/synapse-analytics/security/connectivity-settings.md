...
1.    Select the **Networking** tab when you create your workspace in [Azure portal](http://aka.ms/azureportal).
...
1.    Select your Synapse workspace in [Azure portal](http://aka.ms/azureportal).

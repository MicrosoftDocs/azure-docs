...
description: This article describes the mechanisms used to control access to a Azure Synapse workspace and the resources and code artifacts it contains.

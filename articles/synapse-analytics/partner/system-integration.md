...
| :::image type="content" source="./media/system-integration/blue-granite-logo.png" alt-text="The logo of Blue Granite."::: | **Blue Granite**<br />The BlueGranite Catalyst for Analytics is an engagement approach that features their "think big, but start small" philosophy. Starting with collaborative envisioning and strategy sessions, Blue Granite works with clients to discover, create, and realize the value of new modern data and analytics solutions, using the latest technologies on the Microsoft platform. | [Blue Granite](https://www.microsoft.com/power-platform/products/power-bi/partners)<br />|

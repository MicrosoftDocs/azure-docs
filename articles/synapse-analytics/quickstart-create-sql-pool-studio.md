...
1. From the workspace overview, click on link near **Workspace web URL** to open the location where the SQL pool will be created. Type the service name or resource name directly into the search bar.

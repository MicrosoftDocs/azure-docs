...
* Synapse Spark Dedicated SQL Pool (DW) Connector now supports Python. To learn more, see [Working with DW Connector in Python](./spark/synapse-spark-sql-pool-import-export.md#Using-the-Connector-with-Python).

...
|Azure Synapse Workspace|[REST API PUT operations or ARM/Bicep files to update network settings fail](#rest-api-put-operations-or-armbicep-templates-to-update-network-settings-fail)|Has workaround|
...
### REST API PUT operations or ARM/Bicep files to update network settings fail

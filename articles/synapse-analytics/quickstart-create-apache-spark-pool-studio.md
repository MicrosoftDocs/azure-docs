---
title: 'Quickstart: Create an serverless Apache Spark pool (preview) using Synapse Studio'
...
# Quickstart: Create an serverless Apache Spark pool (preview) using Synapse Studio

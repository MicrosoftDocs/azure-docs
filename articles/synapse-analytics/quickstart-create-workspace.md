...
1. OPTION 1 Creating a new ADLSGEN2 account 
    1. Under **Select Data Lake Storage Gen 2 / Account Name**, click **Create New** and provide a global unique name to it e.g. **contosolake**.
    1. Under **Select Data Lake Storage Gen 2 / File system name**, click **File System** and name it **users**.
1. OPTION 2 See the [**Prepare a Storage Account**](https://learn.microsoft.com/en-us/azure/synapse-analytics/quickstart-create-workspace#prepare-an-existing-storage-account-for-use-with-azure-synapse-analytics) instructions at the bottom of this document.

...
You can also find sample notebooks and SQL scripts in our repository. If you need to connect to a public dataset, create a new linked service with the following attributes:

...
1. The linked service needs to be published to the Workspace before it can be referenced in a notebook. Click **Publish** in the toolbar. Review the pending changes and click **OK**.

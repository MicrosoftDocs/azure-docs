---
title: Use Livy Spark to submit jobs to Spark cluster on Azure Synapse Analytics
description: Learn how to use Apache Spark REST API to submit Spark jobs remotely to an Azure Synapse pool.
author: euangMS
...
# Use Apache Spark REST API to submit remote jobs to an Azure Synapse Analytics Spark pool
...
* An Apache Spark pool on Synapse Analytics. For instructions, see [Create Apache Spark pools in Azure Synapse Analytics](apache-spark-notebook-create-spark-use-sql.md).

* [cURL](https://curl.haxx.se/). This article uses cURL to demonstrate how to make REST API calls against a Synapse Analytics Spark pool.
...
* [Manage resources for the Apache Spark pool in Azure Synapse Analytics](apache-spark-resource-manager.md)
* [Track and debug jobs running on an Apache Spark pools in Synapse](apache-spark-job-debugging.md)
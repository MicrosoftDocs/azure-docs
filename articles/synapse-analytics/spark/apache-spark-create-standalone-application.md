---
title: 'Tutorial: Scala Maven application for Spark with IntelliJ - Azure Synapse Analytics'
...
#customer intent: As a developer new to Apache Spark and to Apache Spark in Azure Synapse Analytics, I want to learn how to create a Scala Maven application for Spark in Azure Synapse Analytics using IntelliJ.
---

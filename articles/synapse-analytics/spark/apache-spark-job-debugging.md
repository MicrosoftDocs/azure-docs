...
ms.date: 09/15/2019
---
# Debug Apache Spark jobs running on Azure Synapse Analytics

In this article, you learn how to track and debug [Apache Spark](https://spark.apache.org/) jobs running on Synapse Analytics pools. You start a Spark job using a notebook available with the Spark pool, **Machine learning: Predictive analysis on food inspection data using MLLib**. You can use the following steps to track an application that you submitted using any other approach as well, for example, **spark-submit**.
...
* An Apache Spark pool on Azure Synapse Analytics. For instructions, see [Create Apache Spark clusters in Azure Synapse Analytics](apache-spark-notebook-create-spark-use-sql.md).
* You should have started running the notebook, **[Machine learning: Predictive analysis on NYC Taxi data using MLLib](apache-spark-machine-learning-mllib-notebook.md)**. For instructions on how to run this notebook, follow the link.  

> [!IMPORTANT]
> TODO The rest of this document needs updates

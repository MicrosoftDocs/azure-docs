...
![Show Taxi Dataframe](./media/apache-spark-machine-learning-aml-notebook/aml-show-dataset.png)
...
```
![Upload Dataset](./media/apache-spark-machine-learning-aml-notebook/upload-dataset-aml.png)
...
```
![Regression Plot](./media/apache-spark-machine-learning-aml-notebook/aml-fareAmount.png)

...
- [Python workspace packages: ](./apache-spark-manage-python-packages.md#Install-wheel-files) Upload Python wheel files as a workspace package and later add these these packages to specific serverless Apache Spark pools.
...
## Pool management
In some cases, you may want to standardize the set of packages that are used on a given Apache Spark pool. This can be particularly useful if the same packages are commonly installed by multiple people on your team. 

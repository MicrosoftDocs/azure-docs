...
> * **We strongly recommend that you upgrade your Apache Spark 3.2 workloads to** **[Azure Synapse Runtime for Apache Spark 3.4](https://learn.microsoft.com/azure/synapse-analytics/spark/apache-spark-34-runtime).**

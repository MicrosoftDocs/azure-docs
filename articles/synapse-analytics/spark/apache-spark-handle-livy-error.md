...
Spark_Ambiguous_JDBC_ConnectionFailed
...
Spark_Ambiguous_SparkSQL_AnalysisException
No TSG is available yet for this error code.

Spark_Ambiguous_TypeChecker_IncompatibleJar
No TSG is available yet for this error code.

Spark_Ambiguous_Unknown_AllNodesDisallowed
No TSG is available yet for this error code.

Spark_Ambiguous_Unknown_ClassInstantiationError
...
Spark_Ambiguous_Unknown_ClassNotFound
...
Spark_Ambiguous_UserApp_IllegalStateException
No TSG is available yet for this error code.

Spark_Ambiguous_UserApp_JobAborted
...
Spark_Ambiguous_UserApp_NullPointer
...
Spark_Ambiguous_UserApp_SparkContextShutDown
...
Spark_Ambiguous_YARN_AllNodesDisallowed
...
Spark_Ambiguous_YARN_ApplicationAttemptNotFound
No TSG is available yet for this error code.
...
Spark_System_ABFS_ReadTimedOut
...
Spark_System_AMRMTokenSecretManager_AppAttemptNotFound
...
Spark_System_CustomTokenProvider_TimeOut
A operation timed out during acquisition of a authorization token.

This is a system error. Please retry your job and if the failure persists, please contact support for further assistance. Please include the Synapse workspace name, Synapse Spark pool name and this error description in your bug report.

Spark_System_InteractiveSessionDriver_ClientClosedBeforeSASLNegotiation
The interactive session could not be started.

This is a system error. Please retry your job and if the failure persists, please contact support for further assistance. Please include the Synapse workspace name, Synapse Spark pool name and this error description in your bug report.

Spark_System_InteractiveSessionDriver_NoRouteToHost
No TSG is available yet for this error code.

Spark_System_InteractiveSessionDriver_RSCDriverInitializeServerFailure
The interactive session driver failed to start up.

This is a system error. Please retry your job and if the failure persists, please contact support for further assistance. Please include the Synapse workspace name, Synapse Spark pool name and this error description in your bug report.

Spark_System_InteractiveSessionDriver_ThreadPoolExecutorRejectedTask
The Livy session failed to create a new session.

This is a system error. Please retry your job and if the failure persists, please contact support for further assistance. Please include the Synapse workspace name, Synapse Spark pool name and this error description in your bug report.

Spark_System_InteractiveSessionDriver_UnableToConnectToPorts
No TSG is available yet for this error code.

Spark_System_MetaStore_ConnectionTimeOut
No TSG is available yet for this error code.

Spark_System_MetaStore_HiveException
...
Spark_System_MetaStore_HiveException_InsertFailed
...
Check the logs for this Spark application by clicking the Monitor tab in left side of the Synapse Studio UI, select "Apache Spark Applications" from the "Activities" section, and find your Spark job from this list. Inspect the logs available in the "Logs" tab in the bottom part of this page for a clearer indication of which table relation is causing this issue.
Spark_System_MetaStore_UnableToInstantiateSessionHiveMetaStoreClient
...
Spark_System_NonJvmUserApp_FileDoesNotMatchContent
No TSG is available yet for this error code.

Spark_System_NonJvmUserApp_UncaughtException
No TSG is available yet for this error code.

Spark_System_SQLAnalyticsConnector_CouldNotFindServer
Could not find server associated with with SQL Analytics for this workspace.

This is a system error. Please retry your job and if the failure persists, please contact support for further assistance. Please include the Synapse workspace name, Synapse Spark pool name and this error description in your bug report.

Spark_System_SqlAnalytics_CouldNotFindPrecreatedFolder
No TSG is available yet for this error code.

Spark_System_SqlAnalytics_InvalidABFSRestOperation
No TSG is available yet for this error code.

Spark_System_SqlAnalytics_WriteFail
No TSG is available yet for this error code.

Spark_User_ABFS_DirectoryNotFound
No TSG is available yet for this error code.

Spark_User_ABFS_OutputDirectoryAlreadyExists
...
Spark_User_ADLS_OutputDirectoryAlreadyExist
No TSG is available yet for this error code.

Spark_User_DataError_NoNumericTypesToAggregate
No TSG is available yet for this error code.

Spark_User_FileInput_FileNotFound
...
Spark_User_FileInput_InputPathDoesNotExist
...
Spark_User_HDFS_UnsupportedFileSystem
...
Spark_User_ImportError_CannotImportName
No TSG is available yet for this error code.

Spark_User_JDBC_LoginFailed
...
Spark_User_Jackson_CouldNotResolveTypeId
No TSG is available yet for this error code.

Spark_User_Jackson_InvalidDeserializationFormat
No TSG is available yet for this error code.

Spark_User_Kusto_InternalServiceError
No TSG is available yet for this error code.

Spark_User_Kusto_OperationFailure
No TSG is available yet for this error code.

Spark_User_LinkedServiceName_ConfigurationNotProvided
...
Spark_User_MetaStore_NoSuchDatabase
No TSG is available yet for this error code.

Spark_User_MetaStore_TableOrViewNotFound
No TSG is available yet for this error code.

Spark_User_MicrosoftSQLServer_ObjectAlreadyExist
No TSG is available yet for this error code.

Spark_User_NameError_NameIsNotDefined
No TSG is available yet for this error code.
...
Check the logs for this Spark application by clicking the Monitor tab in left side of the Synapse Studio UI, select "Apache Spark Applications" from the "Activities" section, and find your Spark job from this list. Inspect the logs available in the "Logs" tab in the bottom part of this page to identify the exact storage URL that is encountering this issue.
Spark_User_SparkPerformanceToolkit_OutputDirectoryAlreadyExists
No TSG is available yet for this error code.

Spark_User_SparkSQL_CannotResolve
No TSG is available yet for this error code.

Spark_User_SparkSQL_FailedToMergeIncompatibleDataTypes
No TSG is available yet for this error code.

Spark_User_SparkSQL_PathAlreadyExists
No TSG is available yet for this error code.

Spark_User_SparkSQL_PathDoesNotExist
No TSG is available yet for this error code.

Spark_User_SparkSQL_ReadTimedOut
No TSG is available yet for this error code.

Spark_User_Storage_FailedToAuthenticateException
No TSG is available yet for this error code.

Spark_User_TypeError_BytesLikeObjectRequired
No TSG is available yet for this error code.

Spark_User_TypeError_IntegerIsRequiredGotBytes
No TSG is available yet for this error code.

Spark_User_TypeError_ObjectIsNotCallable
No TSG is available yet for this error code.

Spark_User_TypeError_SubclassArgMustBeAClass
No TSG is available yet for this error code.
...
Spark_User_TypeError_UnableToInferSchemaForParquet
No TSG is available yet for this error code.

Spark_User_TypesafeConfig_MissingConfigurationSetting
No TSG is available yet for this error code.
...
Spark_User_UserApp_AssertionError
No TSG is available yet for this error code.

Spark_User_UserApp_AttributeError
No TSG is available yet for this error code.

Spark_User_UserApp_CalledSystemExit
...
Spark_User_UserApp_ChangingPermissionsFailedError
No TSG is available yet for this error code.

Spark_User_UserApp_DriverOutOfMemory
No TSG is available yet for this error code.

Spark_User_UserApp_IllegalArgument
...
Spark_User_UserApp_IncompatibleDataTypes
No TSG is available yet for this error code.

Spark_User_UserApp_InvalidNumberFormat
...
Spark_User_UserApp_JSONDecodeError
No TSG is available yet for this error code.

Spark_User_UserApp_JobCancelledException
No TSG is available yet for this error code.

Spark_User_UserApp_KeyError
No TSG is available yet for this error code.

Spark_User_UserApp_MethodNotImplemented
No TSG is available yet for this error code.

Spark_User_UserApp_ModuleNotFoundError
No TSG is available yet for this error code.

Spark_User_UserApp_NoSuchElementException
...
Spark_User_UserApp_NoSuchMethod
...
Spark_User_UserApp_NotImplementedError
No TSG is available yet for this error code.

Spark_User_UserApp_OutOfMemory
No TSG is available yet for this error code.

Spark_User_UserApp_ResultSizeExceedsMaxResultSize
No TSG is available yet for this error code.

Spark_User_UserApp_RpcMessageExceedsMaxAllowed
No TSG is available yet for this error code.

Spark_User_UserApp_SchemaConversionError
No TSG is available yet for this error code.

Spark_User_UserApp_SparkContextNotStarted
User application did not start SparkContext. Spark treats this as a user error, and marks the application as FAILED.

Spark_User_UserApp_StreamNotFoundError
No TSG is available yet for this error code.

Spark_User_UserApp_TaskNotSerializable
...
Spark_User_UserApp_TooManySparkContexts
...
Spark_User_WASB_PathDoesNotExist

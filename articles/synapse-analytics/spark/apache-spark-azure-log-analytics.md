...
> [!NOTE]
> You need to grant read secret permission to the users who will submit Apache Spark applications. For more information, see [Provide access to Key Vault keys, certificates, and secrets with an Azure role-based access control](../../key-vault/general/rbac-guide.md).
...
1. If there is no existing AMPLS, please follow [Azure Monitor Private Link connection setup](https://docs.microsoft.com/azure/azure-monitor/logs/private-link-security) to create one.
...
> [!NOTE] 
>  - The AMPLS object has a number of limits you should consider when planning your Private Link setup. See [AMPLS limits](https://docs.microsoft.com/azure/azure-monitor/logs/private-link-security) for a deeper review of these limits. 

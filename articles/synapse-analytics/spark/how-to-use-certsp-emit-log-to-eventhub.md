...
- If you are new to Azure Event Hubs, read through [Event Hubs overview](/event-hubs/event-hubs-about) and [Event Hubs features](/azure/event-hubs/event-hubs-features).

...
> [!WARNING]
> End of Support Notification for Azure Synapse Runtime for Apache Spark 3.1 
> * Effective January 26, 2023, the Azure Synapse will discontinue official support for Spark 3.1 Runtimes. 
> * Post January 26, 2023, we will not be addressing any support tickets related to Spark 3.1. There will be no release pipeline in place for bug or security fixes for Spark 3.1. Utilizing Spark 3.1 post the support cutoff date is undertaken at one's own risk. We strongly discourage its continued use due to potential security and functionality concerns.

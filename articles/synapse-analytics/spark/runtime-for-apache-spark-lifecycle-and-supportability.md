...
> [!CAUTION]
> Azure Synapse Runtime for Apache Spark 3.3 and 3.4 are unsupported and deprecated. Using this runtime after the deprecation date is at one's own risk, and with the agreement and acceptance of the risks that existing jobs running on Apache Spark 3.3 and 3.4 pools will eventually stop executing.

...
1. Hello:
    ...
    |Pool size | Driver size options | Driver cores | Driver Memory (GB) |
    | :------ | :-------------- | :---------- | :------------- |
    | GPU-Large | Small driver | 4 | 30 |
    | GPU-Large | Medium driver | 7 | 30 |
    | GPU-XLarge | Medium driver | 8 | 40 |
    | GPU-XLarge | Large driver | 12 | 40 |

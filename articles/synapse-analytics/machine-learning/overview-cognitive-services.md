...
- Microsoft Machine Learning for Apache Spark (MMLSpark) allows you to build powerful and highly scalable predictive and analytical models from various Spark data sources. Synapse Spark provide built-in MMLSpark libraries including [Cognitive Services on Spark](https://github.com/microsoft/SynapseML/blob/master/docs/cogsvc.md).

    - The tutorial [Form recognizer using Microsoft Machine Learning for Apache Spark](tutorial-form-recognizer-use-mmlspark.md) demonstrates how to use MMLSpark to access [Azure Form Recognizer](https://azure.microsoft.com/services/form-recognizer/#overview) on Synapse Spark.
...
- [Form recognizer using MMLSpark](tutorial-form-recognizer-use-mmlspark.md) demonstrates how to use MMLSpark to access [Azure Form Recognizer](https://azure.microsoft.com//services/form-recognizer/#overview) from Cognitive Services on Synapse Spark.

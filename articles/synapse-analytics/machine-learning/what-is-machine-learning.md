...
*For a more detailed template, see [Base template for overview articles](https://review.docs.microsoft.com/help/contribute/global-overview-template?branch=master) in the Contributor Guide.*

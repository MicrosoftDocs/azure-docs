...
1. [Install the Apache Spark 2.4.0 helm chart](https://hub.helm.sh/charts/microsoft/spark) - warning: [Spark 2.4](./apache-spark-24-runtime.md) is retired and out of the support.

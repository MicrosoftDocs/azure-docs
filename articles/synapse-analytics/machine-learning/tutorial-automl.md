...
1. Right-click the Spark table that you created in the previous step. Then select **Machine Learning** > **Predict with a model**.
![Screenshot of the Spark table, with Machine Learning and Predict with a model highlighted.](media/tutorial-automl-wizard/tutorial-automl-wizard-00d.png)

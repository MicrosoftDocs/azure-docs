---
title: Access ADLSg2 data from Azure ML
description: This article provides an overview on how you can access data in your Azure Data Lake Storage Gen 2 (ADLSg2) account directly from AzureML. 
author: midesa
...
In this tutorial, we'll guide you through the process of accessing data stored in Azure Synapse Azure Data Lake Storage Gen2 (ADLS Gen2) from Azure Machine Learning (Azure ML). This capability is especially valuable when you aim to streamline your machine learning workflow by leveraging tools such as Automated ML, integrated model and experiment tracking, or specialized hardware like GPUs available in Azure ML.
...
You can learn more about creating and managing Azure ML datastores using this [tutorial on AzureML data stores](../../machine-learning/concept-data.md).

## Mount your ADLS Gen2 Storage Account

Once you have set up your data store, you can then access this data by creating a **mount** to your ADLSg2 account. In Azure ML, creating a mount to your ADLS Gen2 account entails establishing a direct link between your workspace and the storage account, enabling seamless access to the data stored within. Essentially, a mount acts as a pathway that allows AzureML to interact with the files and folders in your ADLS Gen2 account as if they were part of the local filesystem within your workspace. 

Once the storage account is mounted, you can effortlessly read, write, and manipulate data stored in ADLS Gen2 using familiar filesystem operations directly within your AzureML environment, simplifying data preprocessing, model training, and experimentation tasks.
...
## Next steps
- [Create and manage GPUs in Azure ML](../../machine-learning/how-to-train-distributed-gpu.md)
- [Create Automated ML jobs in Azure ML](../../machine-learning/concept-automated-ml.md)
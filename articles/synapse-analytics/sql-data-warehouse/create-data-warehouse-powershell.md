...
* **RequestedServiceObjectiveName**: The amount of [data warehouse units](../sql-analytics/resource-consumption-models.md) you're requesting. Increasing this amount increases compute cost. For a list of supported values, see [memory and concurrency limits](../../sql-data-warehouse/memory-concurrency-limits.md).

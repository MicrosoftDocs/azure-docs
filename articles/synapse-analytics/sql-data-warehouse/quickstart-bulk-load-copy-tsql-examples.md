...
2. Configure Azure AD authentication by going through the following [documentation](../../azure-sql/database/authentication-aad-configure.md?tabs=azure-powershell#create-an-azure-ad-administrator-for-azure-sql-server). 
...
2. [Get application ID](../../active-directory/develop/howto-create-service-principal-portal.md#get-values-for-signing-in)
3. [Get the authentication key](../../active-directory/develop/howto-create-service-principal-portal.md#create-a-new-application-secret)

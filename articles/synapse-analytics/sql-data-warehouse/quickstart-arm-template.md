...
The template used in this quickstart is from [Azure Quickstart Templates](https://azure.microsoft.com/en-us/resources/templates/201-sql-data-warehouse-transparent-encryption-create/).

...
| sp_rename (preview) for columns does not work on schemas outside of *dbo* | This is a current limitation of Synapse sp_rename (preview) for columns.  Columns in objects that are not a part of *dbo* schema can renamed via a CTAS into a new table. |

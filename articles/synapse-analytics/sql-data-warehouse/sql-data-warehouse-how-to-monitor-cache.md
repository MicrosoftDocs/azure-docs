...
## Next steps
For more information on general query performance tuning, see [Monitor query execution](../sql-data-warehouse/../../../sql-data-warehouse/sql-data-warehouse-manage-monitor.md#monitor-query-execution).

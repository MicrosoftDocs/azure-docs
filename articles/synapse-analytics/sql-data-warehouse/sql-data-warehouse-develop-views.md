...
To use a standard view, a query needs to make direct reference to it. For more information, see the [CREATE VIEW](/sql/t-sql/statements/create-view-transact-sql) documentation.

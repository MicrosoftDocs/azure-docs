...
> by [requesting access to Azure Synapse (workspace preview)](https://aka.ms/synapsepreview). Explore the [Azure Synapse (workspace preview) documentation](../overview-what-is.md).

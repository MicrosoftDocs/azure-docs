...
This quickstart assumes you already have a SQL pool that you can pause and resume. If you need to create one, you can use [Create and Connect - portal](../../sql-data-warehouse/create-data-warehouse-portal.md) to create a SQL pool called **mySampleDataWarehouse**.
...
To learn more about SQL pool, continue to the [Load data into SQL pool](load-data-from-azure-blob-storage-using-polybase.md) article. For additional information about managing compute capabilities, see the [Manage compute overview](../../sql-data-warehouse/sql-data-warehouse-manage-compute-overview.md) article. 
...
Finally, by using Gen2 of [SQL pool](sql-data-warehouse-overview-what-is.md#dedicated-sql-pool-in-azure-synapse), each resource class gets 2.5 times more memory than Gen1.

...
Scale compute in Azure Synapse Analytics (formerly SQL DW) using T-SQL and SQL Server Management Studio (SSMS). [Scale out compute](../../sql-data-warehouse/sql-data-warehouse-manage-compute-overview.md) for better performance, or scale back compute to save costs. 

...
To create your data warehouse solution using the Synapse SQL pool feature of Azure Synapse, you have a wide variety of industry-leading tools to choose from. This article highlights Microsoft partner companies with data management tools and solutions supporting Azure Synapse.
...
| ![SqlDBM](./media/sql-data-warehouse-partner-data-management/sqldbm-logo.png) |**SqlDBM**<br>SqlDBM is a Cloud-based Data Modeling Tool that offers you an easy, convenient way to develop your database anywhere on any browser. All while incorporating any needed database rules and objects such as database keys, schemas, indexes, column constraints, and relationships. |[Product page](http://sqldbm.com/)<br>|<br>[Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/sqldbm1583438206845.sqldbm-data-modeling-tool?tab=Overview)<br>|

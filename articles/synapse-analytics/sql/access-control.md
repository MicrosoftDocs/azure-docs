...
description: Learn how to manage access control to workspaces, data, and pipelines in Azure Synapse Analytics.
...
Learn how to manage access control to workspaces, data, and pipelines in Azure Synapse Analytics.

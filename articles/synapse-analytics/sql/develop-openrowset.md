...
The following example shows how you can use [JSON path expressions](https://docs.microsoft.com/en-us/sql/relational-databases/json/json-path-expressions-sql-server?view=sql-server-ver15) in WITH clause and demonstrates difference between strict and lax path modes: 

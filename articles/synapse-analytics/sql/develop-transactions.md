...
| [DWU](resource-consumption-models#data-warehouse-units) | Cap per distribution (GB) | Number of Distributions | MAX transaction size (GB) | # Rows per distribution | Max Rows per transaction |
| --- | --- | --- | --- | --- | --- |

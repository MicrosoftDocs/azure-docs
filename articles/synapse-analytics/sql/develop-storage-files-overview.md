...
This document describes how can users read data from the files stored on Azure Storage in serverless SQL pool. Users have the following options to access storage:

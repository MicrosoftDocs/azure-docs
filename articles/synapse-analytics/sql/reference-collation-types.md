---
title: Collation
description: Collation types supported in Azure SQL Analytics
author: filippopovic
...
# Database collation support for SQL Analytics
...
Additionally, SQL Analytics pool does not support following collation types:

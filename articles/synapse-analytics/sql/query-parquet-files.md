...
The sample below shows the automatic schema inference capabilities for Parquet files. It returns the number of rows in year 2018 without specifying a schema.

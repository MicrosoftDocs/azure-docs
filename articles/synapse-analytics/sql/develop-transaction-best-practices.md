...
## Next steps
See [Transactions in SQL pool](../sql-analytics/development-transactions.md) to learn more about isolation levels and transactional limits.  For an overview of other Best Practices, see [SQL pool best practices](../sql-analytics/best-practices-sql-pool.md).

...
One example of data source definition that references public [ECDC COVID 19 Azure Open Data Set](https://docs.microsoft.com/en-us/azure/open-datasets/dataset-ecdc-covid-cases) is shown in the following example:

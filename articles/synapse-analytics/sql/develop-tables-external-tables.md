...
| Azure Data Lake Store Gen 1 | `https`         | `<storage_account>.blob.core.windows.net/<container>/subfolders` |
| Azure Data Lake Store Gen 2 | `https`         | `<storage_account>.dfs.core.windows.net/<container>/subfolders`  |

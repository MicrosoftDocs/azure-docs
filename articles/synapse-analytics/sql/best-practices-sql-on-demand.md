...
You can use [sp_describe_first_results_set](/sql/relational-databases/system-stored-procedures/sp-describe-first-result-set-transact-sql?view=azure-sqldw-latest&preserve-view=true) to check the resulting data types of your query.

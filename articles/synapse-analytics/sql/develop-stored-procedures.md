...
Note, SQL pool does not currently support [@@NESTLEVEL](https://docs.microsoft.com/sql/t-sql/functions/nestlevel-transact-sql?view=sql-server-ver15). You need to track the nest level. It is unlikely for you to exceed the eight nest level limit, but if you do, you need to rework your code to fit the nesting levels within this limit.

---
title: Authentication in Azure Synapse Analytics SQL Pools
...
ms.reviewer: sngun
---
# Authentication in Azure Synapse Analytics SQL Pools
...
- **SQL admin username**
  ...
  When you create an Azure Synapse Analytics, you must name a **SQL admin username**. SQL server creates that account as a login in the master database. This account connects using SQL Server authentication (user name and password). Only one of these accounts can exist.

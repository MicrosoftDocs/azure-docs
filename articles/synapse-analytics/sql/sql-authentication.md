...
For more information on configuring logins for geo-replication, see  [Configure and manage Azure SQL Database security for geo-restore or failover](/azure/azure-sql/database/active-geo-replication-security-configure).

...
An ExpressRoute Gateway is required to establish connectivity between the physical HSM device and the customers virtual network in Azure. For more information on ExpressRoute Gateway, see the article [About virtual network gateways for ExpressRoute](../expressroute/expressroute-about-virtual-network-gateways.md).

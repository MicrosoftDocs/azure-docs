...
* For an API Management instance that's injected or integrated in a virtual network, any OpenID configuration endpoints must be reachable and resolvable by the gateway at runtime.

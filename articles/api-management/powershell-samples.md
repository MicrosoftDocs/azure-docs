---
title: Azure API Management PowerShell samples | Microsoft Docs
description: Learn about the PowerShell scripts available for use in Azure API Management.
...
# API Management PowerShell samples

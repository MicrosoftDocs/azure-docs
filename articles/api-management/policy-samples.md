...
| [Authorize requests using external authorizer](./policies/policies/authorize-request-using-external-authorizer.md)                                                   | Shows how to use external authorizer for securing API access.                                                                                                                                                               |

...
>[!WARNING]
> When using stv2, it is required to assign a Network Security Group to your VNET in order for the Azure Load Balancer to work. Learn more in the [Azure Load Balancer documentation](https://learn.microsoft.com/security/benchmark/azure/baselines/azure-load-balancer-security-baseline#network-security-group-support)

...
> [!NOTE]
> The above `openid-config` URL corresponds to the v1 endpoint. For the v2 `openid-config`endpoint, use `https://login.microsoftonline.com/common/v2.0/.well-known/openid-configuration`.

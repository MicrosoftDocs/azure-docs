...
This article shows how to import an [Azure OpenAI](/azure/ai-services/openai/overview) API from its OpenAPI specification into an Azure API Management instance. After importing the API, you can manage and secure it, and publish it to developers.

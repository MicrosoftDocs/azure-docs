...
> [!NOTE]
> * API analytics provides data on requests that are matched with an API and operation, including failed and unauthorized requests. Other calls aren't reported.

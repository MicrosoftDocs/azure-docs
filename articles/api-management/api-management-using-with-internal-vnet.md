...
>	Specific reserved zone names (azure-api.net) will be blocked from creation to prevent disruption of services in Private DNS zone as mentioned [here](../dns/private-dns-privatednszone.md).
>	So for default APIM Gateway endpoint - APIMserviceName.azure-api.net, create A-record in Custom DNS server associated to APIM Vnet.

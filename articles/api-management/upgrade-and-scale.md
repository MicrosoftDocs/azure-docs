...
> [!NOTE]
> * In the classic **Basic**, **Standard**, and **Premium** tiers, the **v2** tiers, and [workspace gateways](workspaces-overview.md#workspace-gateway), you can configure an instance to [scale automatically](api-management-howto-autoscale.md) based on a set of rules.

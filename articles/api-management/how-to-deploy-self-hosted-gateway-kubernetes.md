...
9. Run the commands to create the necessary Kubernetes objects in the [default namespace](https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/) and start self-hosted gateway pods from the [container image](https://mcr.microsoft.com/product/azure-api-management/gateway/about) downloaded from the Microsoft Artifact Registry.

...
* [Add custom HTML](developer-portal-extend-custom-functionality.md#use-custom-html-code-widget) for small customizations - for example, add HTML for a form or to embed a video player. The custom code is rendered in an inline frame (iframe).
...
For extensibility details and instructions, refer to the [GitHub repository](https://github.com/Azure/api-management-developer-portal). 

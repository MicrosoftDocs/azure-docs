...
|:------------|:---------------------|:---------------------|:------|
| Hostname of the configuration endpoint | `<apim-service-name>.management.azure-api.net` | `<apim-service-name>.configuration.azure-api.net` | Connectivity to v2 endpoint requires DNS resolution of the default hostname. Currently, a custom domain name isn't supported for the v2 endpoint<sup>1</sup>. |

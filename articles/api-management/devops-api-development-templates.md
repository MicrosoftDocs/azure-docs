...
The following images illustrates the proposed approach. 
...
* After the changes are approved and merged successfully, API publishers can choose to deploy them to the Production instance either on schedule or on demand. They can automate the deployment of the templates by using [GitHub Actions](https://github.com/Azure/apimanagement-devops-samples), [Azure Pipelines](/devops/pipelines/), [Azure PowerShell](../azure-resource-manager/templates/deploy-powershell.md), the [Azure CLI](../azure-resource-manager/templates/deploy-cli.md), or other tools.

...
In [multi-regional deployments](api-management-howto-deploy-multi-region.md), the regional IP address changes: 

* If a region is vacated and then reinstated. 
* If you enable, add, or remove [availability zones](zone-redundancy.md).

...
| Sampling (%)                        | decimal                           | Values from 0 to 100 (percent). <br/> Specifies the percentage of requests that will be logged to Application Insights. 0% sampling means zero requests logged, while 100% sampling means all requests logged. <br/> Use this setting to reduce performance impacts of logging requests to Application Insights. See [Performance implications and log sampling](performance-implications-and-log-sampling). |

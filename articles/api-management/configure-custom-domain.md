...
1. Select **Custom domains**.
    ...
    > 
    > Only API Management instance owners can use **Management** and **SCM** endpoints internally and are less frequently assigned a custom domain name.
    >
...
1. Under **Certificate**, select either **Key Vault** or **Custom**.
    ...
    - **Custom**
        ...
        - If you upload a valid .PFX file and provide its **Password**, if the certificate is protected with a password.
1. Select or deselect other options as necessary, like **Negotiate client certificate** or **Default SSL binding**.
1. Select **Update**.

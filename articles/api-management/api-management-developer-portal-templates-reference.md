...
-   [User Profile](User-profile-templates-in-Azure-API-Management.md)  
    -   [Profile](User-profile-templates-in-Azure-API-Management.md#Profile)  
    -   [Subscriptions](User-profile-templates-in-Azure-API-Management.md#Subscriptions)  
    -   [Applications](User-profile-templates-in-Azure-API-Management.md#Applications)  
    -   [Update account info](User-profile-templates-in-Azure-API-Management.md#UpdateAccountInfo)  

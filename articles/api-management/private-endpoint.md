...
* Connections aren't supported on the [self-hosted gateway](self-hosted-gateway-overview.md) or on a managed [workspace gateway](workspaces-overview.md#workspace-gateway). 

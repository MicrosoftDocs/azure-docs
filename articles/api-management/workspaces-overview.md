...
* The platform team can apply API policies spanning APIs in workspaces and can use a built-in [Azure Policy definition](policy-reference.md) for `base` element use to enforce and audit best practices for policy inheritance.

...
> [!NOTE]
> Workspace gateway support will be rolled out starting August 2024 in the following regions, which is a subset of the regions where API Management is available.

...
- Workspaces support using managed identities by using the service's identity. To learn more, see [our capabilities and security considerations](api-management-howto-use-managed-service-identity#create-a-system-assigned-managed-identity.md).

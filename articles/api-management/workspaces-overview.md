...
* Each workspace team can gather and analyze gateway resource logs to monitor their own workspace APIs, while the platform team can access logs all-up for the API Management service, providing oversight, security, and compliance across the entire API ecosystem.

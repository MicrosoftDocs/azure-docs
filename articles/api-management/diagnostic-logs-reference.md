...
| Verbosity         |                                   | Specifies the verbosity of the logs.    <br/><br/>* Error - only failed requests are logged<br/>* Information -  failed and successful requests are logged<br/> * Verbose - failed and successful requests are logged, including verbose messages when provided<br/><br/>Default: Information  | 

...
-   [Azure API Management: Backing Up and Restoring Configuration](https://docs.microsoft.com/archive/blogs/stuartleeks/azure-api-management-backing-up-and-restoring-configuration)

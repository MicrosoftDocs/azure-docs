...
```
2. Log out and log back in to the Azure portal and navigate to the App Registeration page for the application that was registered in the previous section. 

...
1. In the left navigation of your API Management instance, select **Products** > **+ Add**.
1.  In the **Add prouct** window, use the values from the following table to create your product.
    ...
    | Description              | Optionally provide information about the product such as its purpose, the APIs it provides access to, and other details.                                                                                                                                               |
    ...
    | APIs                     | You can add one or more APIs during the product creation, or later. For more information, see [Add APIs to a product](#add-apis-to-a-product) later in this article |

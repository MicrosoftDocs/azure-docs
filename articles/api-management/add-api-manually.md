...
This article shows how to manually add an API to Azure API Management. To create mock API responses, you can create a blank API. For more information, see [Mock API responses](mock-api-responses.md).

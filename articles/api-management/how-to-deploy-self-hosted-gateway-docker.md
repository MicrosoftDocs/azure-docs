...
9. Execute the command. The command instructs your Docker environment to run the container using a [container image](https://mcr.microsoft.com/product/azure-api-management/gateway/about) from the Microsoft Artifact Registry, and to map the container's HTTP (8080) and HTTPS (8081) ports to ports 80 and 443 on the host.

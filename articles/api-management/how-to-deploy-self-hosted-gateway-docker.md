...
> [!NOTE]
> Hosting self-hosted gateway in Docker is best suited for evaluation and development use cases. Kubernetes is recommended for production use. See [this](how-to-deploy-self-hosted-gateway-kubernetes-helm.md) document to learn how to deploy self-hosted gateway to Kubernetes.

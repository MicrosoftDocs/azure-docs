...
|<a id="ref-context-graphql"></a>`context.GraphQL`|`GraphQLArguments`: [`IGraphQLDataObject`](#ref-igraphqldataobject)<br /><br /> `Parent`: [`IGraphQLDataObject`](#ref-igraphqldataobject)|<br /><br /> |
...
|<a id="ref-igraphqldataobject"></a>`IGraphQLDataObject`|<br /><br />|

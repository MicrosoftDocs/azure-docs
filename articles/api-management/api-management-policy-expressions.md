...
- See how to perform content filtering. Remove data elements from the response received from the backend using the [Control flow](choose-policy.md) and [Set body](api-management-transformation-policies.md#SetBody) policies.

...
- [SQL Azure data source for resolver](cosmosdb-data-source-policy.md) - Configures the SQL Azure request and optional response to resolve data for an object type and field in a GraphQL schema.

...
|---------|---------|---------|---------|---------|
| [Limit call rate by subscription](rate-limit-policy.md) | Prevents API usage spikes by limiting call rate, on a per subscription basis. | Yes | Yes | Yes |
| [Limit call rate by key](rate-limit-by-key-policy.md) | Prevents API usage spikes by limiting call rate, on a per key basis. | Yes | No | Yes | 
| [Set usage quota by subscription](quota-policy.md) | Allows you to enforce a renewable or lifetime call volume and/or bandwidth quota, on a per subscription basis. | Yes | Yes | Yes
...
|Policy  |Description  |Dedicated gateway  | Consumption gateway |Self-hosted gateway  |
|---------|---------|---------|---------|---------|
| [Check HTTP header](check-header-policy.md) | Enforces existence and/or value of an HTTP header. | Yes | Yes | Yes |
...
|Policy  |Description  |Dedicated gateway  | Consumption gateway |Self-hosted gateway  |
|---------|---------|---------|---------|---------|
| [Validate content](validate-content-policy.md) | Validates the size or content of a request or response body against one or more API schemas. The supported schema formats are JSON and XML. | Yes | Yes | Yes |

---
title: Options to authorize access to API Management developer portal 
titleSuffix: Azure API Management
description: Learn about options to enable identity providers for sign-in to the API Management developer portal.
...
In this article, you'll learn about authentication methods you can configure for users of the developer portal. By default, API Management requires username and password authentication, but you can also configure online identity providers, including Azure Active Directory or Azure Active Directory B2C.
...
By default, API Management enables username and password authentication (basic authentication) to the developer portal. 

To add a username and password using the portal:

1. In the left menu, under **Developer portal**, select **Users** > **+ Add**.

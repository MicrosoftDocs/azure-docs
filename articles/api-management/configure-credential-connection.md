...
You can manage credential provider settings and credential connections in the portal. For example, you might need to update a client secret for a credential provider.

...
- When imported inline to API Management, an OpenAPI specification can be up to 4 MB in size. The size limit doesn't apply to an OpenAPI specification hosted on a publicly accessible internet address. 

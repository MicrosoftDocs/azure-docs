...
Additionally, API Management contains a built-in Administrators group whose membership is managed by the system. Microsoft Azure subscription administrators fall into this group automatically.
...
https://docs.microsoft.com/azure/api-management/api-management-role-based-access-control 
...
How to get a list of users assigned to a directory role in Azure AD with PowerShell:

https://docs.microsoft.com/powershell/module/az.resources/get-azroleassignment?view=azps-3.7.0 

How to get a directory role definition in Azure AD with PowerShell:

https://docs.microsoft.com/powershell/module/az.resources/get-azroledefinition?view=azps-3.7.0 
...
Understand the Azure API Management DevOps Resource Kit: 
https://docs.microsoft.com/azure/api-management/api-management-security-controls#configuration-management

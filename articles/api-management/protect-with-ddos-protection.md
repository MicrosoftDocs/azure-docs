...
* An Azure DDoS Protection plan
    ...
    * You may use a plan in either the Network DDoS protection SKU or IP DDoS Protection SKU (preview). See [Azure DDoS Protection SKU Comparison](../ddos-protection/ddos-protection-sku-comparison.md).
...
To enable DDoS Protection on the virtual network used for your API Management instance.
...
To enable DDoS protection on the IP address, see [Enable DDoS IP Protection for a public IP address](../manage-ddos-protection-powershell-ip.md#enable-ddos-ip-protection-for-a-public-ip-address).

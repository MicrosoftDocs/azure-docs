...
These requests execute in sequence, which is not ideal. In an upcoming release, we will be introducing a new policy called `wait` that will enable all of these requests to execute in parallel.

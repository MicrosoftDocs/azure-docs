...
The data that you'll upload to an Azure Search index should be a flat data file, where each field in your dataset maps to an equivalent field in the index. If your organizational data is in a relational database, you will need to identify or create a single view or table that can be used to load data into your index.

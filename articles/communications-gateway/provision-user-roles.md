...
|Using the Number Management Portal| **Reader** access to your subscription and some or all of the following roles for the Project Synergy enterprise application: <!-- Must be kept in sync with step below for configuring and with manage-enterprise-operator-connect.md  --><br> - To view existing configuration: **PartnerSettings.Read**, **NumberManagement.Read**, and **TrunkManagement.Read**<br>- To configure the status of an enterprise (a "consent"): **NumberManagement.Write** and **PartnerSettings.Write**<br> - To configure numbers: **NumberManagement.Write** |

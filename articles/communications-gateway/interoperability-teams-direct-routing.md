...
The domain for your Azure Communications Gateway deployment is visible to customer administrators in their Microsoft 365 admin center. By default, each Azure Communications Gateway deployment receives an automatically generated domain name similar to `a1b2c3d4efghij5678.<subdomain>.commsgw.azure.com`, where `<subdomain>` is autogenerated and specific to the operator.

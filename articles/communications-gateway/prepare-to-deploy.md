...
This article guides you through each of the tasks you need to complete before you can start to deploy Azure Communications Gateway. In order to be successfully deployed, the Azure Communications Gateway may depend on the state of your Operator Connect or Teams Phone Mobile environments.

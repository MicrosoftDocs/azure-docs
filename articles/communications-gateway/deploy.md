...
> [!IMPORTANT]
> When configuring SBCs, firewalls and ACLs ensure that your network can receive traffic from both of the /28 IP ranges provided to you by your onboarding team as the IP addresses used by Azure Communications Gateway can change as a result of maintenance, scaling or in disaster scenarios.

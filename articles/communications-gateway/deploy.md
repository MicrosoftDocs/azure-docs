...
|**Value**|**Field name(s) in Azure portal**|
 ...
 |Whether your Azure Communications Gateway resource should handle emergency calls as standard calls or directly route them to the Emergency Services Routing Proxy (US only). |**Call Handling: Emergency call handling**|

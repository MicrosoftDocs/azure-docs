...
>     - Make a DNS SRV lookup on the domain name for the service region, for example `r1.<subdomain>.commsgw.azure.com`, where `<subdomain>` is autogenerated and specific to the deployment.

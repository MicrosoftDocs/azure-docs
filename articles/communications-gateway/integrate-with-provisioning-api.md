...
| Azure Operator Call Protection Preview |Supported |-  Indicating that numbers are enabled for Azure Operator Call Protection (alternative to the Number Management Portal). <br>-(Not supported) Configuring a custom header for messages to your network.|

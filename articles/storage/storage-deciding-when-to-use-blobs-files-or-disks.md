...
Microsoft Azure provides several ways to store and access data in the cloud. The following table describes your choices when deciding how to store and access data:  

...
> [!NOTE]
> Storage accounts with a replication type of Zone-Redundant Storage (ZRS) now support metrics or logging capability. ZRS Classic accounts do not support metrics or logging. For more information on ZRS, see [Zone-redundant storage](storage-redundancy.md#zone-redundant-storage). 

...
> [!NOTE] 
> This article describes an older version of AzCopy (AzCopy v8.1). To install the most recent version of AzCopy (AzCopy v10), see [AzCopy v10](storage-use-azcopy-v10.md).

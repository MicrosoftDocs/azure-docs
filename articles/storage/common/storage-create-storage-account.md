...
If you try to delete a storage account associated with an Azure virtual machine, you may have an error when trying to delete the storage account. For help troubleshooting this error, please see [Troubleshoot errors when you delete storage accounts](../common/storage-resource-manager-cannot-delete-storage-account-container-vhd).

...
For Blob storage accounts, changing the access tier may incur charges for the change in addition to changing your pricing. Please see the [Blob storage accounts - Pricing and Billing](../blobs/storage-account-options.md#pricing-and-billing) for more details.

...
>
> For new Azure regions that have come online after October 1, 2020, pricing for general-purpose v1 accounts has increased and is equivalent to pricing for general-purpose v2 accounts. Pricing for general-purpose v1 accounts in Azure regions that existed prior to October 1, 2020 has not changed. For pricing details for general-purpose v1 accounts in a specific region, see the Azure Storage pricing page. Choose your region, and then next to **Pricing offers**, select **Other**.

---
title: Configure customer-managed keys with Azure Key Vault by using PowerShell - Azure Storage
...
# Configure customer-managed keys for Azure Storage by using PowerShell

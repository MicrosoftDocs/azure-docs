...
You need to locate the corrupted connections first.
...
After going through all your connections, you should have a list of connection names that are corrupted. You need to clear their corrupted data and add them back through normal steps using Storage Explorer.

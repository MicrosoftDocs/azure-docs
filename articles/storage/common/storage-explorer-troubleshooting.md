...
1. Run the command `openssl s_client -showcerts -connect <hostname>:443` for any of the Microsoft or Azure host names that your storage resources are behind. You can find a list of host names that are frequently accessed by Storage Explorer [here].(https://docs.microsoft.com/en-us/azure/storage/common/storage-explorer-network)

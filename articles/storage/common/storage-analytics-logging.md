...
To learn more about how to download specific files, see [Download specific files](./storage-use-azcopy-v10.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#download-specific-files).

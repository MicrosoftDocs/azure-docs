...
> [!NOTE]
> This guide assumes that you are already familiar with [Azure Storage](https://azure.microsoft.com/services/storage/). If not, reading the [Introduction to Azure Storage](common/storage-introduction.md) documentation is helpful. Most importantly, you need to [create a Storage account](../storage-create-storage-account.md#create-a-storage-account) to start using the Data Movement Library.
> 
> 

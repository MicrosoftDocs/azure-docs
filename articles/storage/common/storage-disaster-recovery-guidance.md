...
- **Files:** Use [Azure Backup](https://docs.microsoft.com/azure/backup/azure-file-share-backup-overview) to back up your file shares. Also enable [soft delete](https://docs.microsoft.com/azure/storage/files/storage-files-prevent-file-share-deletion) to protect against accidental file share deletions. For geo-redundancy when GRS is not available, use [AzCopy](./storage-use-azcopy-v10.md) or [Azure PowerShell](/powershell/module/az.storage/) to copy your files to another storage account in a different region.

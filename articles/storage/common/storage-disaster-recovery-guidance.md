...
- SSH File Transfer Protocol (SFTP) is not supported for storage account failover. To failover an account with SFTP enabled, you must first [disable SFTP for the account](../blobs/secure-file-transfer-protocol-support-how-to.md#disable-sftp-support).

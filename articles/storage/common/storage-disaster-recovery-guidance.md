...
> [!NOTE]
> This feature is not yet supported in accounts that have a hierarchical namespace (Azure Data Lake Storage Gen2). To learn more, see [Blob storage features available in Azure Data Lake Storage Gen2](../blobs/data-lake-storage-supported-blob-storage-features.md).

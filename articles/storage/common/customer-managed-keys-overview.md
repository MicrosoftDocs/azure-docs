...
- [Delete Directory](/rest/api/storageservices/delete-directory)
...
- [List Handles](/rest/api/storageservices/list-handles)
- [Force Close Handles](/rest/api/storageservices/force-close-handles)
...
- [List Ranges](/rest/api/storageservices/list-ranges)
- [Get File Metadata](/rest/api/storageservices/get-file-metadata)
- [Set File Metadata](/rest/api/storageservices/set-file-metadata)
- [Delete File](/rest/api/storageservices/delete-file2)
- [Copy File](/rest/api/storageservices/copy-file)
- [Abort Copy File](/rest/api/storageservices/abort-copy-file)
- [List Handles](/rest/api/storageservices/list-handles)
- [Force Close Handles](/rest/api/storageservices/force-close-handles)
- [Lease File](/rest/api/storageservices/lease-file)

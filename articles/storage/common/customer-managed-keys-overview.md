...
When you enable or disable customer-managed keys, or when you modify the key or the key version, the protection of the root encryption key changes, but the data in your Azure Storage account remains encrypted. There is no additional action required on your part to ensure that your data is protected.
...
When you update the key version, the protection of the root encryption key changes, but the data in your Azure Storage account remains encrypted. There is no additional action required on your part to ensure that your data is protected.

...
|    Key usage                           |    Microsoft                                          |    Azure portal<br /><br />Storage Resource Provider REST API<br /><br />Azure Storage management libraries<br /><br />PowerShell<br /><br />CLI        |    Azure Storage REST API (Blob storage)<br /><br />Azure Storage client libraries    |

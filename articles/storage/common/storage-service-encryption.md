...
|    Azure Storage services supported    |    All                                                |    <ul><li>Blob storage</li><br /><li>Azure Files</li></ul>                                                                                                               |    Blob storage                                                                  |
|    Key storage                         |    Microsoft data center secret management service    |    Azure Key Vault                                                                                                                              |    Any key store                                                                 |
|    Key rotation responsibility         |    Microsoft                                          |    Customer                                                                                                                                     |    Customer                                                                      |
|    Key usage                           |    Microsoft                                          |    <ul><li>Management console (portal???)</li><br /><li>Storage Resource Provider REST API</li><br /><li>Azure Storage management libraries</li><br /><li>PowerShell</li><br /><li>CLI</li></ul>        |    <ul><li>Azure Storage REST API (Blob storage)</li><br /><li>Azure Storage client libraries</li></ul>    |
|    Key access                          |    Microsoft only                                     |    <ul><li>Microsoft</li><br /><li>Customer</li></ul>                                                                                                                    |    Customer only                                                                 |

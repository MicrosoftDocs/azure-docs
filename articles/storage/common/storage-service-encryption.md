...
Customer-managed keys are also available for Azure managed disks as a public preview, customer-managed keys work a bit differently for managed disks than the rest of storage. For details, see our article [Server side encryption of Azure managed disks](../../virtual-machines/linux/disk-encryption.md#customer-managed-keys-public-preview).

...
5. If you've created alert rules that are based on classic storage metrics, then [create alert rules](/azure/azure-monitor/platform/alerts-overview) that are based on metrics in Azure Monitor. 
...
To learn more about metrics in Azure Monitor, see [Metrics in Azure Monitor](/azure/azure-monitor/platform/data-platform-metrics).

...
If you do not know the number of drives you need, go to the [Check the number of drives](#check-the-number-of-drives). 
...
1. After you receive the drives with your exported data, you can view and copy the BitLocker keys generated by the service for your drive. Go to the export job in the Azure portal. Click Import/Export tab. 
2. Select and cick your export job from the list. Go to **BitLocker keys** and view the keys.
   
   ![View BitLocker keys for export job](./media/storage-import-export-service/export-job-bitlocker-keys.png)

3. Copy and use the BitLocker keys to unlock the disks.

...
| Number of copies of data maintained on separate nodes | Three within a single region | Three across separate availability zones within a single region | Six total, including three within the primary region and three in the secondary region | Six total, including three across separate availability zones in the primary region and three in the secondary region |

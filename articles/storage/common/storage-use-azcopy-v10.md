...
| Operating system  | Command |
|--------|-----------|
| **Linux** | `wget -O azcopyv10.tar https://aka.ms/downloadazcopy-v10-linux && tar -xf azcopyv10.tar --strip-components=1` |
| **Windows** | `Invoke-WebRequest https://aka.ms/downloadazcopy-v10-windows -OutFile azcopyv10.zip <<Unzip here>>` |

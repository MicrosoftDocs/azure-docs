...
To learn how to verify and assign roles, see [Grant access to Azure blob and queue data with Azure RBAC in the Azure portal](https://docs.microsoft.com/azure/storage/common/storage-auth-aad-rbac-portal?toc=%2fazure%2fstorage%2fblobs%2ftoc.json).

...
## AzCopy v10 Authentication Options
...
## Getting started with AzCopy v10
...
## Copy data to Azure Storage using AzCopy v10
...
## Copy data between two storage accounts using AzCopy v10
...
## Copy a VHD image to a storage account using AzCopy v10
...
## Sync local file system to a storage account using AzCopy v10
...
The command allows you to incrementally sync the source to the destination. If you add or delete a file to the source, AzCopy v10 will do the same on the storage account.

## Advanced configuration

### Configure AzCopy v10 proxy settings
...
### Optimize AzCopy v10 throughput
...
## Troubleshooting with AzCopy v10

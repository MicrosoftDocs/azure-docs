...
1. Save your changes.
    ...
    :::image type="content" source="media/azure-defender-storage-overview/enable-azure-defender-security-center.png" alt-text="Screenshot showing how to enable Azure Defender for Azure Storage in Security Center":::
...
1. Select **Enable Azure Defender for Storage**.
    ...
    :::image type="content" source="media/azure-defender-storage-overview/enable-azure-defender-portal.png" alt-text="Screenshot showing how to enable Azure Defender for an Azure Storage account":::
...
1. Search for the **Deploy Azure Defender on Storage Accounts** policy.
    ...
    :::image type="content" source="media/azure-defender-storage-overview/storage-atp-policy-definitions.png" alt-text="Apply policy to enable Azure Defender for Azure Storage accounts":::

1. Select an Azure subscription or resource group.

    :::image type="content" source="media/azure-defender-storage-overview/storage-atp-policy2.png" alt-text="Select subscription or resource group for scope of policy ":::

1. Assign the policy.

    :::image type="content" source="media/azure-defender-storage-overview/storage-atp-policy1.png" alt-text="Assign policy to enable Azure Defender for Azure Storage":::
...
:::image type="content" source="media/azure-defender-storage-overview/storage-advanced-threat-protection-alert-email.png" alt-text="Azure Storage advanced threat protection alert email":::
...
:::image type="content" source="media/azure-defender-storage-overview/storage-advanced-threat-protection-alert.png" alt-text="Azure Storage advanced threat protection alert":::

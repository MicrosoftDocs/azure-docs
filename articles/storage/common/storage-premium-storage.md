...
* **VM scale limits and performance**
    ...
    For the most up-to-date information about maximum IOPS and throughput (bandwidth) for Premium Storage-supported VMs, see [Windows VM sizes](https://docs.microsoft.com/en-us/azure/virtual-machines/windows/sizes) or [Linux VM sizes](../../virtual-machines/windows/sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).

...
Today, you can use either the Azure portal or the Storage Resource Provider API to change your account's redundancy type, as long as you are migrating to or from LRS, GRS, and RA-GRS. With ZRS, however, migration isn't as straightforward because it involves the physical data movement from a single storage stamp to multiple stamps within a region. 
...
- Build your own tooling that leverages one flavor of the storage SDK.

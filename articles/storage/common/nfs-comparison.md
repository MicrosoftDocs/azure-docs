...
|Available protocols     |Supports NFS 3.0, REST, and ADLS Gen2         |Supports SMB or NFS 4.1 (preview) (no interoperability between either protocol)         |Supports NFS 3.0, 4.1, and SMB         |

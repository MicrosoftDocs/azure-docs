...
| Azure Networking         | Microsoft.Network          | Store and analyze network traffic logs through the Network Watcher and Traffic Analytics services. [Learn more](https://docs.microsoft.com/azure/network-watcher/network-watcher-nsg-flow-logging-overview). |

...
|Azure Site Recovery|Microsoft.SiteRecovery |Enable replication for disaster recovery for Azure IaaS virtual machines. This is required if you are using firewall enabled cache storage account or source storage account or target storage account.  [Learn more](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-tutorial-enable-replication).|

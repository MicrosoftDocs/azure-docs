...
> [!NOTE]
> IP network rules will have no effect on requests originating from the same Azure region as the Storage account.  Use virtual network rules to allow same-region requests.
>

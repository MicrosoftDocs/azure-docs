...
- [Read an overview of AzCopy](/azure/storage/common/storage-use-azcopy-v10).
...
- Learn about:
    ...
    - [Azure Data Box, Azure Data Box Disk, and Azure Data Box Heavy for offline transfers](/azure/databox/).
    - [Azure Data Box Gateway and Azure Stack Edge for online transfers](/azure/databox-online/).
- [Learn what is Azure Data Factory](/azure/data-factory/copy-activity-overview).

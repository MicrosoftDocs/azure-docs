...
This command lists accounts, containers, and directories. Blob Storage, Azure Data Lake Storage Gen2, and File Storage are supported. Auth for Files is currently not supported, please use SAS to authenticate for Files.

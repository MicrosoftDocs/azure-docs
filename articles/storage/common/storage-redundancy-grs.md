...
* If you initiate a forced failover (preview) of a GRS or RA-GRS account to the secondary region, write access to that account is restored after the failover has completed. For more information, see [Disaster recovery and forced failover (preview)](storage-disaster-recovery-guidance.md).

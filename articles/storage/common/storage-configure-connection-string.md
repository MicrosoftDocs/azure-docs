...
- [Authorize access and connect to Blob Storage with JavaScript](../blobs/storage-blob-javascript-get-started#authorize-access-and-connect-to-blob-storage)
- [Authorize access and connect to Blob Storage with Python](../blobs/storage-blob-python-get-started#authorize-access-and-connect-to-blob-storage)

...
2. On the _Hub_ menu, select **All resources**. Go to the storage account, under **Blob Service** select **Containers** and navigate to the blob to be deleted.
...
4. In Blob metadata pane, check and record the value for **MicrosoftAzureCompute_VMName**. This value is the name of the VM that the VHD is attached to. (See **Note** if this field does not exist)
5. In Blob metadata pane, check and record the value of **MicrosoftAzureCompute_DiskType**. This identifies if the attached disk is OS or data disk (See **Note** if this field does not exist). 
...
1. Sign in to the [Azure portal](https://portal.azure.com).
2. On the _Hub_ menu, select **All resources**. Go to the storage account, under **Blob Service** select **Containers**.
...
1. Sign in to the [Azure portal](https://portal.azure.com).
2. On the _Hub_ menu, select **Virtual Machines**.

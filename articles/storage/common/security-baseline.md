...
- [How to configure the Azure Storage Firewall](/azure/storage/common/storage-network-security#change-the-default-network-access-rule)

- [How to configure Private Endpoints for Azure Storage](/azure/storage/common/storage-private-endpoints)
...
- [Understanding Private Endpoints for Azure Storage](/azure/storage/common/storage-private-endpoints#known-issues)
...
- [How to enable Advanced Threat Protection](/azure/storage/common/storage-advanced-threat-protection?tabs=azure-portal)
...
- [Manage packet captures with Azure Network Watcher using the portal](/azure/network-watcher/network-watcher-packet-capture-manage-portal)
...
- [Configure advanced threat protection for Azure Storage](/azure/storage/common/storage-advanced-threat-protection)
...
- [For more information about using Service Tags](/azure/virtual-network/service-tags-overview)

- [For more information about Virtual network service endpoint policies for Azure Storage](/azure/virtual-network/virtual-network-service-endpoint-policies-overview)
...
- [Azure Policy samples for Storage](/azure/governance/policy/samples/built-in-policies#storage)

- [Azure Policy samples for Network](/azure/governance/policy/samples/built-in-policies#network)
...
- [Log and review data](/azure/storage/common/storage-analytics-logging#how-logs-are-stored)
...
- [Configure advanced threat protection for Azure Storage](/azure/storage/common/storage-advanced-threat-protection?tabs=azure-portal)
...
- [Gather insights about your DNS infrastructure with the DNS Analytics Preview solution](/azure/azure-monitor/insights/dns-analytics)
...
- [Understanding security principals and access control for Azure Storage account](/azure/storage/common/storage-introduction)
...
- [Understand Azure Security Center Identity and Access](/azure/security-center/security-center-identity-access)
...
- [How to setup Advanced Threat Protection for Azure Storage account](/azure/storage/common/storage-advanced-threat-protection)
...
- [Use the Azure Storage resource provider to access management resources](/azure/storage/common/authorization-resource-provider)

- [How to configure access to Azure Blob and Queue data with Azure RBAC in Azure portal](/azure/storage/common/storage-auth-aad-rbac-portal)
...
- [How to view and change access at the Azure Storage account level](/azure/storage/common/storage-auth-aad-rbac-portal)

- [Grant limited access to Azure Storage resources using shared access signatures (SAS)](/azure/storage/common/storage-sas-overview)

- [Manage anonymous read access to containers and blobs](/azure/storage/blobs/storage-manage-access-to-resources)
...
- [Configure Azure Storage firewalls and virtual networks](/azure/virtual-network/virtual-network-service-endpoint-policies-overview)

- [Virtual network service endpoint policies for Azure Storage](/azure/private-link/create-private-endpoint-storage-portal)
...
- [How to require secure transfer in Azure Storage](/azure/storage/common/storage-require-secure-transfer)

- [Azure security policies monitored by Security Center](/azure/security-center/security-center-policy-definitions)
...
- [How to assign Azure roles for Azure Storage account](/azure/storage/common/storage-auth-aad-rbac-portal#assign-azure-roles-using-the-azure-portal)

- [Use the Azure Storage resource provider to access management resources](/azure/storage/common/authorization-resource-provider)

- [How to configure access to Azure Blob and Queue data with Azure RBAC in Azure portal](/azure/storage/common/storage-auth-aad-rbac-portal)

- [How to create and configure an AAD instance](/azure/active-directory/fundamentals/active-directory-access-create-new-tenant)
...
- [Understanding Azure Storage encryption at rest](/azure/storage/common/storage-service-encryption)
...
- [How to configure Conditional Access to block access to ARM](/azure/role-based-access-control/conditional-access-azure-management)
...
- [Understanding Azure Policy Effects](/azure/governance/policy/concepts/effects)
...
- [How to grant access to Azure blob and queue data using a managed identity](/azure/storage/common/storage-auth-aad-rbac-portal)
...
- [Set and manage immutability policies for Blob storage](/azure/storage/blobs/storage-blob-immutability-policies-manage?tabs=azure-portal)

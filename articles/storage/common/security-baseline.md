...
https://docs.microsoft.comazure/network-watcher/network-watcher-packet-capture-manage-portal
...
**Guidance**: 
Create standard operating procedures around the use of dedicated administrative accounts that have access to your Storage account. Use Azure Security Center Identity and access management to monitor the number of administrative accounts. 
...
https://docs.microsoft.com/azure/storage/common/authorization-resource-provider

How to configure access to  Azure Blob and Queue data with RBAC in Azure portal:
...
How to view and change access at the Azure Storage account level:
https://docs.microsoft.com/azure/storage/common/storage-auth-aad-rbac-portal
...
How to configure metrics alerts for Azure Storage Accounts:
...
**Guidance**: 
Use Azure Policy aliases in the "Microsoft.Storage" namespace to create custom policies to audit or enforce the configuration of your Storage account instances. You may also use built-in Azure policy definitions for Azure Storage account such as: 

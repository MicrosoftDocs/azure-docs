...
- [Use AzCopy to copy blobs between Azure storage accounts with network restrictions](https://learn.microsoft.com/troubleshoot/azure/azure-storage/copy-blobs-between-storage-accounts-network-restriction)

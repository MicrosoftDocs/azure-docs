...
|-----------------|--------|-----|------|---------|
| <b>…from:       |        | --- |  --- |  ---    |
| <b> LRS</b>     |  ---   | manual migration <br><b> -or- </b><br> [live migration](#live-migration) | manual migration <br><b> -or- </b><br> Switch to GRS using the Azure portal, PowerShell, or the Azure CLI,<br> then migrate to GZRS <br>([live](#live-migration) or [manual](#manual-migration)) | manual migration <br><b> -or- </b><br> Switch to RA-GRS using the Azure portal, PowerShell, or the Azure CLI,<br> then migrate to RA-GZRS <br>([live](#live-migration) or [manual](#manual-migration)) |
| <b> GRS</b>     |  ---   | manual migration <br><b> -or- </b><br> Switch to LRS using the Azure portal, PowerShell, or the Azure CLI,<br> then migrate to ZRS <br>([live](#live-migration) or [manual](#manual-migration)) | manual migration <br><b> -or- </b><br> [live migration](#live-migration) | manual migration <br><b> -or- </b><br> Switch to RA-GRS using the Azure portal, PowerShell, or the Azure CLI,<br>then migrate to RA-GZRS <br>([live](#live-migration) or [manual](#manual-migration)) |
| <b> RA-GRS</b>  |  ---   | manual migration <br><b> -or- </b><br> Switch to LRS using the Azure portal, PowerShell, or the Azure CLI,<br> then migrate to ZRS <br>([live](#live-migration) or [manual](#manual-migration)) | manual migration <br><b> -or- </b><br> Switch to GRS using the Azure portal, PowerShell, or the Azure CLI,<br> then migrate to GZRS <br>([live](#live-migration) or [manual](#manual-migration)) | manual migration <br><b> -or- </b><br> [live migration](#live-migration) |
...
|-----------------|--------|-----|------|---------|
| <b>…from:       |        | --- |  --- |  ---    |
| <b> ZRS</b>     |  ---   | manual migration <br><b> -or- </b><br> [live migration](#live-migration) | manual migration <br><b> -or- </b><br> Switch to GZRS using the Azure portal, PowerShell, or the Azure CLI,<br> then migrate to GRS <br>([live](#live-migration) or [manual](#manual-migration)) | manual migration <br><b> -or- </b><br> Switch to RA-GZRS using the Azure portal, PowerShell, or the Azure CLI, <br>then migrate to RA-GRS <br>([live](#live-migration) or [manual](#manual-migration)) |
| <b> GZRS</b>    |  ---   | manual migration <br><b> -or- </b><br> Switch to ZRS using the Azure portal, PowerShell, or the Azure CLI,<br> then migrate to LRS <br>([live](#live-migration) or [manual](#manual-migration)) | manual migration <br><b> -or- </b><br> [live migration](#live-migration) | manual migration <br><b> -or- </b><br> Switch to RA-GZRS using the Azure portal, PowerShell, or the Azure CLI,<br> then migrate to RA-GRS <br>([live](#live-migration) or [manual](#manual-migration)) |
| <b> RA-GZRS</b> |  ---   | manual migration <br><b> -or- </b><br> Switch to ZRS using the Azure portal, PowerShell, or the Azure CLI,<br> then migrate to LRS <br>([live](#live-migration) or [manual](#manual-migration)) | manual migration <br><b> -or- </b><br> Switch to GZRS using the Azure portal, PowerShell, or the Azure CLI,<br> then migrate to RA-GRS <br>([live](#live-migration) or [manual](#manual-migration)) | manual migration <br><b> -or- </b><br> [live migration](#live-migration) |

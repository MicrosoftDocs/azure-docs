...
<sup>1</sup> Conversion for premium file shares is available by [opening a support request](#support-initiated-conversion); Customer-initiated conversion can be undertaken using either [PowerShell](redundancy-migration?tabs=powershell#customer-initiated-conversion) or the [Azure CLI](redundancy-migration?tabs=azure-cli#customer-initiated-conversion).<br />

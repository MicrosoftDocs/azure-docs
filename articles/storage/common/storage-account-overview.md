...
| Premium general-purpose v2<sup>4</sup> | Page blobs only | LRS | Resource Manager<sup>3</sup> | Premium storage account type for page blobs only. |
...
All data in your storage account is encrypted on the service side. For more information about encryption, see [Azure Storage encryption for data at rest](storage-service-encryption.md).

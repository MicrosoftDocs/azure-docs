...
<br/><br/><sup>2</sup> As a core capability of Azure Data Lake Storage (ADLS), the [hierarchical namespace](../common/data-lake-storage-namespace.md) enhances data organization and access efficiency for large amounts of data, making it ideal for analytics workloads.

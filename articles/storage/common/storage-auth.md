...
|---------|---------|---------|---------|---------|
|Azure Blobs     |[Supported](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Supported](storage-sas-overview.md)         |[Supported](storage-auth-aad.md)         |[Supported](../blobs/storage-manage-access-to-resources.md)         |
...
|Azure Files (REST)     |[Supported](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Supported](storage-sas-overview.md)         |Not supported         |Not supported         |
|Azure Queues     |[Supported](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Supported](storage-sas-overview.md)         |[Supported](storage-auth-aad.md)         |Not supported         |
|Azure Tables     |[Supported](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Supported](storage-sas-overview.md)         |Not supported         |Not supported         |

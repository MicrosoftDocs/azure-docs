...
To have access to all the diagnostic data available for your account, [configure diagnostics logs](storage-monitor-storage-account.md#configure-logging) for read, write, and delete requests for the blob services.
...
* Learn more about [Logs in Azure Storage accounts ](../../postgresql/concepts-server-logs.md)

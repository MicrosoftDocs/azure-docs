...
> [!NOTE]
> Advanced threat protection for Azure Storage is currently available only for Blob storage. This service is available in US government clouds, but no other sovereign or Azure government cloud regions. For pricing details, including a free 30 day trial, see the [Azure Security Center pricing page](https://azure.microsoft.com/pricing/details/security-center/).

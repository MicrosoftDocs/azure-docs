...
- You'll need an Azure Kubernetes Service (AKS) cluster with a node pool of at least three general purpose virtual machines (VMs) such as **standard_ds4_v2**. We recommend that each VM have at least four virtual CPUs.

...
Azure Container Storage is a cloud-based volume management, deployment, and orchestration service built natively for containers. This article shows you how to configure Azure Container Storage (version 1.x.x) to use Ephemeral Disk with local NVMe as backend storage for your Kubernetes workloads. At the end, you have a pod that's using local NVMe as its storage.
...
You now have a pod that uses local NVMe as its storage, and you can use it for your Kubernetes workloads.
...
You now have a pod that uses local NVMe, and you can use it for your Kubernetes workloads.

## Manage volumes and storage pools

In this section, you learn how to check the available capacity of ephemeral disk for a single node, how to expand or delete a storage pool, and how to optimize performance.
...
> [!NOTE]
> RAM and hugepages consumption stays consistent across all tiers: 1 GiB of RAM and 2 GiB of hugepages.

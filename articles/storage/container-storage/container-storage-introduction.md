...
|-------------|----------------|---------------|-----------------|-------------------------------|
| Storage pool expansion/resize | Supported | Supported | Not supported |
...
<sup>1</sup> With explicit annotation that the data is not persistent.
...
Based on feedback from customers, we've included the following capabilities:

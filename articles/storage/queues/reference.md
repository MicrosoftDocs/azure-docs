...
| ----------------------- | -------- |
| [Queue Storage REST API reference](/rest/api/storageservices/queue-service-rest-api) | [Queue Storage concepts](/rest/api/storageservices/queue-service-concepts) |

...
For information about the built-in roles that support access to queue data, see [Azure roles for queues](assign-azure-role-data-access.md#azure-rbac-roles-for-queues).

...
For a comparison between the Azure Queue Storage discussed in this article and Azure Service Bus queues discussed in the [how to use Service Bus queues](https://azure.microsoft.com/develop/ruby/how-to-guides/service-bus-queues/) article, see [Azure Queue Storage and Service Bus queues - compared and contrasted](../../service-bus-messaging/service-bus-azure-and-service-bus-queues-compared-contrasted.md)

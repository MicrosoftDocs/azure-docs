...
|--------|-----------|
| **Diagnostic logs** | Use diagnostic logs to audit operations on your data and to detect and troubleshoot errors. Both Version 1.0 and Version 2.0 logs are supported.|
| **SDKs** | Use Java, .NET, and Python SDKs to perform all of your management and data plane operations. Custom applications that target blob storage now work with storage accounts that have a hierarchical namespace.|
| **Powershell support** | Use Powershell cmdlets to interact with your data.|
...
| **Lifecycle management policies** | Use lifecycle management policies to automatically transition data to different access tiers based on rules that you define. |
| **Change notifications** | Put something here.|
| **Azure Ecosystem** | Use these Azure services with accounts that have a hierarchical namespace: <br><br>
> [!div class="checklist"]

...
| **SDKs** | Use Java, .NET, and Python SDKs to perform all of your management and data plane operations. Custom applications that target blob storage now work with storage accounts that have a hierarchical namespace. <br><br>To learn more, see any of these articles:<br><br><UL>&nbsp;&nbsp;<li>[Use .NET with Azure Data Lake Storage Gen2](storage-dot-net-how-to-use-blobs.md)&nbsp;&nbsp;<li>[Use Java with Azure Data Lake Storage Gen2](storage-java-how-to-use-blobs.md) &nbsp;&nbsp;<li>[Use Python with Azure Data Lake Storage Gen2](storage-python-how-to-use-blobs.md)<UL>|
...
| **Azure service ecosystem** | Use these Azure services with accounts that have a hierarchical namespace: <br><br><UL>&nbsp;&nbsp;<li> Azure Stream Analytics&nbsp;&nbsp;<li>IOT Hub Capture&nbsp;&nbsp;<li>Event Hubs Capture&nbsp;&nbsp;<li>Data Box&nbsp;&nbsp;<li>Power BI|

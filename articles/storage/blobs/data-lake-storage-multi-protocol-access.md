...
Multi-protocol access on Data Lake Storage enables you to connect more Azure services with your Data Lake Storage. This table lists the  services that are enabled by multi-protocol access on Data Lake Storage. 
The items that appear in this table will change over time as support for Azure services continues to expand. 
...
Just like the list of Azure supported Azure services, the items that appear in this table will change over time as support for Blob storage features continues to expand. 
...
|[Lifecycle management policies](storage-lifecycle-management-concepts?tabs=azure-portal.md)| Preview|
|[Diagnostic logs](storage-analytics-logging.md)| Preview|

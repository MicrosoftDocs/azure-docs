...
- Exclude Prefix: Use this filter to exclude some specific subset from it. This approach also helps narrow the scope of your inventory report. To learn more, see [articles/storage/blobs/blob-inventory.md#rule-filters.](https://github.com/MicrosoftDocs/azure-docs-pr/blob/main/articles/storage/blobs/blob-inventory.md#rule-definition)

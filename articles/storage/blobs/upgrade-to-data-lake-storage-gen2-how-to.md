...
1. Review feature support
   ...
   > [!NOTE]
   > Blob soft delete is supported in Data Lake Storage Gen2 enabled accounts, but it's not yet supported by the upgrade process. Therefore, before you upgrade your account, disable blob soft delete and then allow all soft-delete blobs to expire.

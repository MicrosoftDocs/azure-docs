...
1. For the origin hostname, enter your the static website endpoint. To find your static website endpoint, navigate to the **Static websites (preview)** section for your storage account and copy the endpoint. 

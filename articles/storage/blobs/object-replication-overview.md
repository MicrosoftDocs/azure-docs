...
<sup>3</sup>    Object replication copies the whole version to destination - not only the unique blocks of the version and incurs the cost of network egress. See [Bandwidth pricing](https://azure.microsoft.com/pricing/details/bandwidth/).

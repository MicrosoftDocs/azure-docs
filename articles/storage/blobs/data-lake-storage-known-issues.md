...
| **Azure Storage Explorer** | Version-specific support <br><br>Use only versions `1.6.0` through `1.10.0`. <br> Version `1.10.0` is available as a [free download](https://docs.microsoft.com/azure/vs-azure-tools-storage-explorer-relnotes).|

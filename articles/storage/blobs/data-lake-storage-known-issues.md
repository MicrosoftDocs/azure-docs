...
> [!NOTE]
> If you enroll in the public preview of Blob interoperability with ADLS Gen2, then blob APIs and Data Lake Storage Gen2 APIs can operate on the same data. To learn more, see [Blob interoperability with ADLS Gen2](data-lake-storage-interop.md).
...
| **Object-level tiers** |Cool and archive tiers are supported only if you enroll in the the [Blob interoperability with Data Lake Storage Gen2](data-lake-storage-interop.md) preview. <br><br> All other access tiers are not yet supported.|
| **Powershell and CLI support** | Limited functionality <br><br>Management operations such as creating an account is supported. Data plane operations such as uploading and downloading files is in public preview as part of [Blob interoperability with ADLS Gen2](data-lake-storage-interop.md). Working with directories and setting access control lists (ACLs) is not yet supported. |

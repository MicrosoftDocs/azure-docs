...
- An understanding of how ACLs are applied to directories and files. See [Access control in Azure Data Lake Storage Gen2](./data-lake-storage-access-control.md). 
...
1. Verify that the version of PowerShell that have installed is `5.1` or higher by using the following command.    
   ...
   To upgrade your version of PowerShell, see [Upgrading existing Windows PowerShell](/powershell/scripting/install/installing-windows-powershell)
...
1. Download the [Azure Data Lake Storage client library for Python](https://recursiveaclpr.blob.core.windows.net/privatedrop/azure_storage_file_datalake-12.1.0b99-py2.py3-none-any.whl?sv=2019-02-02&st=2020-08-24T07%3A47%3A01Z&se=2021-08-25T07%3A47%3A00Z&sr=b&sp=r&sig=H1XYw4FTLJse%2BYQ%2BfamVL21UPVIKRnnh2mfudA%2BfI0I%3D).
...
3. Add these import statements to the top of your code file.
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/dotnet/dotnet-v12/Authorize_DataLake.java" id="Snippet_AuthorizeWithAAD":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/dotnet/dotnet-v12/Authorize_DataLake.java" id="Snippet_AuthorizeWithKey":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/dotnet/dotnet-v12/ACL_DataLake.java" id="Snippet_SetACLRecursively":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/Java/Java-v12/src/main/java/com/datalake/manage/CRUD_DataLake.java" id="Snippet_SetACLRecursively":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/dotnet/dotnet-v12/ACL_DataLake.java" id="Snippet_UpdateACLsRecursively":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/Java/Java-v12/src/main/java/com/datalake/manage/CRUD_DataLake.java" id="Snippet_UpdateACLRecursively":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/dotnet/dotnet-v12/ACL_DataLake.java" id="Snippet_RemoveACLRecursively":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/Java/Java-v12/src/main/java/com/datalake/manage/CRUD_DataLake.java" id="Snippet_RemoveACLRecursively":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/dotnet/dotnet-v12/ACL_DataLake.java" id="Snippet_ResumeContinuationToken":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/Java/Java-v12/src/main/java/com/datalake/manage/CRUD_DataLake.java" id="Snippet_ResumeSetACLRecursively":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/dotnet/dotnet-v12/ACL_DataLake.java" id="Snippet_ContinueOnFailure":::
...
:::code language="csharp" source="~/azure-storage-snippets/blobs/howto/Java/Java-v12/src/main/java/com/datalake/manage/CRUD_DataLake.java" id="Snippet_ContinueOnFailure":::

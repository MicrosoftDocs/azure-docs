...
>
> When choosing which APIs to use in a given scenario, consider the workload and the needs of your application along with the [known issues](data-lake-storage-known-issues.md#blob-storage-apis).

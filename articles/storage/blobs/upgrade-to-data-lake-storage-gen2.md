...
There is no cost to perform the upgrade. After you upgrade, the cost to store your data doesn't change, but the cost a transaction does change. Use these pages to assess compare costs. 

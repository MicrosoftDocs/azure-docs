...
During the public preview, the use of SFTP does not incur any additional charges beyond the ordinary transaction and data storage prices. SFTP might incur additional charges when the feature becomes generally available. Any changes to the way SFTP is billed will be announced along with that release.

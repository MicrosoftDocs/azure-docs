...
|Azure Synapse Analytics (formerly SQL Data Warehouse)|Generally available|[Use with Azure Synapse Analytics (formerly SQL Data Warehouse)](https://docs.microsoft.com/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#azure-sql-data-warehouse-polybase)|

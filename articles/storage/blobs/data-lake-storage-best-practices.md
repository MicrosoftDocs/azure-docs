...
To access your storage account from Azure Databricks, deploy Azure Databricks in your virtual network, and then add that Virtual Network to your firewall. See Configure Azure Storage firewalls and virtual networks 

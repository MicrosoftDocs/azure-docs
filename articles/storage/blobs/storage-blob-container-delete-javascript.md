...
To delete a container in JavaScript, create a [BlobServiceClient](storage-blob-javascript-get-started#create-a-blobserviceclient-object) or [ContainerClient](storage-blob-javascript-get-started#create-a-containerclient-object) then use one of the following methods:
...
The following example deletes the specified container. Use the [BlobServiceClient](storage-blob-javascript-get-started#create-a-blobserviceclient-object) to delete a container:
...
The following example shows how to delete all of the containers whose name starts with a specified prefix using a [ContainerClient](storage-blob-javascript-get-started#create-a-containerclient-object).

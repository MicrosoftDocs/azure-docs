...
ms.custom: devx-track-javascript, devguide-javascript
---

# Create and manage container leases with JavaScript

This article shows how to create and manage container leases using the [Azure Storage client library for JavaScript](https://www.npmjs.com/package/@azure/storage-blob). You can use the client library to acquire, renew, release, and break container leases.

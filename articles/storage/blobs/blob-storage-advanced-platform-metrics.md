...
> [!NOTE]
> Advanced platform metrics is supported only on storage accounts that support Azure Blob Storage. Standard Azure Files accounts, Premium Azure Files accounts, and Premium Page Blob accounts are not supported.

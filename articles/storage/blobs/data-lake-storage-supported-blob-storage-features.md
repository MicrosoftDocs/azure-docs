...
- Learn about limitations and known issues when using Blob Storage features with Data Lake Storage Gen2. See [Known issues with Blob Storage features](known-issues-blob-features).

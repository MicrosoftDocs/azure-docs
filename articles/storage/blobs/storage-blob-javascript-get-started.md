...
If you're looking to start with a complete example, see the client library quickstart for [JavaScript](storage-quickstart-blobs-javascript.md) or [TypeScript](storage-quickstart-blobs-typescript.md).

...
| Developer SDKs | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| Blob SDK - *Available now*. [Azure Data Lake Storage Gen2 SDK](https://azure.microsoft.com/en-us/blog/extended-filesystem-programming-capabilities-in-azure-data-lake-storage/)- *Available now - .NET, Java, Python (public preview)*  |
...
| Data Management                             | File Expiration                                                                                                                                        | Lifecycle policies                                                                                                                                                                                                                                                                                                                                                                                                          | Lifecycle policies *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md).                                                                                                                     |

### Programming interfaces

This table describes which API sets that are available for your custom applications. SDK support for ACL and directory-level operations are not yet supported.
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| .NET SDK                  | [Link](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet) | *Available now* | *Available now* |
| Java SDK                | [Link](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *Available now*                                                      | *Available now*                                     |
| Node.js                | [Link](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | *Available now*                                                     | *Available now*                                                                                           |
| Python SDK                   | [Link](https://docs.microsoft.com/python/api/overview/azure/datalakestore/management?view=azure-python)                                                                                                                                                                                                                 | *Available now*                                                      | *Available now*                                        |
| REST API                 | [Link](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Available now*                                                      | *Available now*                                                                                                                                               |
| PowerShell | [Link](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | *Available now* |
| CLI                 | [Link](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *Available now*                                                      | *Available now*                                                               |
| Azure Resource Manager templates - management             | [Template1](https://azure.microsoft.com/resources/templates/101-data-lake-store-no-encryption/)  [Template2](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-adls/)  [Template3](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-key-vault/)  | *Available now*                                                      | *Available now*                                          |
...
|                      | [SQL Server Integration Services](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-data-lake-store-connection-manager?view=sql-server-2017) | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
...
|                      | [Logic Apps](https://docs.microsoft.com/connectors/azuredatalake/)                                                                                                      | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
| IoT                  | [Event Hubs – Capture](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-archive-eventhub-capture)                                                       | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
|                      | [Stream Analytics](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-stream-analytics)                                                                   | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
| Consumption          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
...
| Diagnostic logs                                                                                        | [Link](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md). <br>Azure Monitoring integration - *Not yet available* |

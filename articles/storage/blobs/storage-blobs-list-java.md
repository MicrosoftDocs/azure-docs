...
- The authorization mechanism needs appropriate permissions to list blobs. To learn more, see the authorization guidance for the following REST API operations:

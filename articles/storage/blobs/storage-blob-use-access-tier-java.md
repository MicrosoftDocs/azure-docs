...
- The authorization mechanism needs appropriate permissions to set the blob's access tier. To learn more, see the authorization guidance for the following REST API operation:

...
> [!NOTE]
> The hierarchical namespace feature in a block blob storage account (the premium tier for Azure Data Lake Storage Gen2) is in GA, and is available in the East US, East US 2, Central US, West US, West US 2, West Central US, South Central US, Canada Central, Canada East, North Europe, West Europe, UK South, UK West, France Central, Germany West Central, Asia East, South East Asia, Australia East, Australia South East, Brazil South, Korea Central, Korea South, Central India, West India and UAE North regions. To review limitations, see [Blob storage features available in Azure Data Lake Storage Gen2](data-lake-storage-supported-blob-storage-features.md) and [Known issues](data-lake-storage-known-issues.md). 

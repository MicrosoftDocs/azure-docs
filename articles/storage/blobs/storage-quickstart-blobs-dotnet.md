...
### Deploy resources and run the code

From an empty directory, follow these steps to initialize the project, provision Azure resources, and get started with the code:

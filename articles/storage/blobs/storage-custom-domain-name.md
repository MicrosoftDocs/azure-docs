...
1. Enable [Azure CDN](../../cdn/cdn-overview.md) on your blob or web endpoint. For step-by-step guidance, see [Integrate a static website with Azure CDN](static-website-content-delivery-network.md).

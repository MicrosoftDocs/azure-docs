...
The creation time of a storage account, which is part of the account-level metadata, determines which stage applies. This policy applies to block blobs and append blobs. 

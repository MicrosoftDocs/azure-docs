...
This section describes known issues and conditions in the current public preview of blob index. As with most previews, this feature should not be used for production workloads until it reaches GA as behaviors may change.

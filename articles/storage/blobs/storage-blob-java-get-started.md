---
title: Get started with Azure Blob Storage and Java
...
This article shows you how to connect to Azure Blob Storage by using the Azure Blob Storage client library Java. Once connected, your code can operate on containers, blobs, and features of the Blob Storage service.
...
| [Create and manage leases](storage-blob-container-lease-java.md) | Establish and manage a lock on a container or the blobs in a container. |

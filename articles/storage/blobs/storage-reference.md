...
- [Microsoft.Storage resource types](/azure/templates/microsoft.storage/allversions) lists the available versions for each resource type across all versions.
...
- [Azure Storage monitoring data reference](/azure/storage/common/monitor-storage-reference) describes the monitoring data that is generated by Azure Storage.
...
This section contains reference material for Azure tools.

- [Azurite storage emulator](/azure/storage/common/storage-use-azurite)

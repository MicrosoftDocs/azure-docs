...
A service SAS is signed with the account access key. Use the [StorageSharedKeyCredential](/javascript/api/@azure/storage-blob/storagesharedkeycredential) class to create the credential that is used to sign the SAS. Next, call the [generateBlobSASQueryParameters](/javascript/api/preview-docs/@azure/storage-blob/#@azure-storage-blob-generateblobsasqueryparameters) function providing the required parameters to get the SAS token string.
...
To create a service SAS for a blob, call the [generateBlobSASQueryParameters](/javascript/api/preview-docs/@azure/storage-blob/#@azure-storage-blob-generateblobsasqueryparameters) function providing the required parameters.

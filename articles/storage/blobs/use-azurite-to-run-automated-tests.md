...
1. Create a container and initialize environment variables. Use a [PyTest](https://docs.pytest.org/) [conftest.py](https://docs.pytest.org/en/latest/how-to/plugins.html) file to generate tests. Here is an example of a conftest.py file:

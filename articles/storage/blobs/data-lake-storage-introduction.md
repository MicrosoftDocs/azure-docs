...
|---|---|---|
|Low-cost storage|:heavy_check_mark:||:heavy_check_mark:|
|Tiered storage|:heavy_check_mark:||:heavy_check_mark:|
|High availability /<br> disaster recovery|:heavy_check_mark:||:heavy_check_mark:|
|File system semantics||:heavy_check_mark:|:heavy_check_mark:|
|Directory and file-level security||:heavy_check_mark:|:heavy_check_mark:|

...
| creationTime | Number |  Specifies the number of days ago within which the blob must have been created to be included in the inventory. For example, a value of `3` includes only blobs that were created in the last 3 days. | No |

...
> :::image type="content" source="./media/storage-blob-block-blob-premium/create-block-blob-storage-account.png" alt-text="Screenshot of the Create storage account page with Premium performance and Block blobs account type selected.":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="./media/create-data-lake-storage-account/hierarchical-namespace-feature.png" alt-text="Screenshot of the Advanced tab showing the Hierarchical namespace setting enabled during storage account creation.":::

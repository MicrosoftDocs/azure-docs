...
* **Page blobs** store random access files up to 8 TB in size. Page blobs store the virtual hard drive (VHD) files serve as disks for Azure virtual machines. Fore more information about page blobs, see [Overview of Azure page blobs](../articles/storage/blobs/storage-page-blob-overview.md)

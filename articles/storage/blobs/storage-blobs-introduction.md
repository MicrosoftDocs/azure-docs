...
a **General-purpose storage account (v1 or v2).** You can also use **Blob storage accounts**, but all features available in those are avialable in General-purpose v2 (GPv2) storage accounts. See [About Azure storage accounts](../common/storage-create-storage-account.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json) for more information.

...
In this quickstart, you learn how to use the Azure portal to create a container in Azure Storage, and to upload, download, and list block blobs in that container.

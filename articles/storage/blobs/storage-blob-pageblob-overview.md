...
> [!WARNING]
> Page blobs in premium storage accounts are designed for use as VHDs only. Microsoft does not recommend storing other types of data in page blobs in premium storage accounts, as the storage cost may be significantly greater. Use block blobs for storing data that is not in a VHD.

...
* When performing the steps in the [Get values for signing in](../../active-directory/develop/howto-create-service-principal-portal.md#get-values-for-signing-in) section of the article, save application ID, and client secret values into a text file. You'll need those soon.

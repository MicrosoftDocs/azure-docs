...
## How DNS forwarding works with Azure Files
...
If name resolution is successful, the resolved IP address matches the private IP address of your storage account's private endpoint.

...
Standard file shares up to 1 TiB in size are available as a GA service. While, larger file shares, which is any share larger than 1 TiB, up to 100 TiB, are currently in available and in preview. While in preview, these larger shares have some limitations:

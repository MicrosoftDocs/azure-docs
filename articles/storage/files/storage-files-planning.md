...
This article primarily addresses deployment considerations for deploying an Azure file share to be directly mounted by an on-premises or cloud client. To plan for an Azure File Sync deployment, see [Planning for an Azure File Sync deployment](../filesync/file-sync-planning.md).
...
* [Deploying Azure File Sync](../filesync/file-sync-deployment-guide.md)

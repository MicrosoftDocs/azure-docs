...
* Encryption at-rest: Azure Storage is in the process of rolling at encryption at-rest, by default for all storage accounts. If you are creating a new storage account in a region with encryption at-rest on default, you don't have to do anything to enable. For other regions, please consult [Server Side Encryption](../common/storage-service-encryption.md?toc=%2fazure%2fstorage%2ffiles%2ftoc.json). Data at-rest encrypted with fully-managed keys. Encryption at-rest does not increase storage costs or reduce performance. 

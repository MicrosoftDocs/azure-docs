...
If you intend to use the storage account key to access your Azure file shares, we recommend using private endpoints as described in the [Networking](#networking) section.

...
## Region availability
Azure Files geo-redundancy for large file shares is generally available in the majority of geo-regions. Use the table below to see which regions are generally available (GA) or preview.

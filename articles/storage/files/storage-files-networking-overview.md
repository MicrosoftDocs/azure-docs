...
Regardless of how you access your Azure file shares, the Azure storage account exposes two two basic sets of settings to secure the network: encryption in transit and firewalls and virtual networks (VNets).
...
- [Configure ExpressRoute for use with Azure Files](storage-files-configure-expressroute.md)

...
**How do I back up my Azure file share?**  
    You can use periodic [share snapshots (preview)](storage-snapshots-files.md) for protection against accidental deletions. You also can use AzCopy, Robocopy, or a third-party backup tool that can back up a mounted file share. 

...
> [!IMPORTANT]
> While the service is in preview, production usage of this service isn't recommended. See [Troubleshoot Azure NFS file shares](https://docs.microsoft.com/azure/storage/files/storage-troubleshooting-files-nfs) article for a list of known issues.

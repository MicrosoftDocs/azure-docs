...
| 0x8007000e | -2147024882 | ERROR_OUTOFMEMORY | The file failed to recall due to out of memory error. | If the error persists, investigate which application or kernel-mode driver is causing the low memory condition. |

...
Microsoft Entra Kerberos supports hybrid identities in all regions of the [Azure Public, Azure US Gov, and Azure China 21Vianet clouds](https://azure.microsoft.com/global-infrastructure/locations/). Cloud-only identities are supported in all regions of the Azure Public cloud, but are not supported in Azure US Gov or Azure China 21Vianet clouds.

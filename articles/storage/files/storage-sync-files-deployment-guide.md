...
2.	Pre-seed Azure file shares with the server data using any data transfer tool e.g. [AzCopy](https://docs.microsoft.com/en-us/azure/storage/common/storage-use-azcopy), SMB copy
...
- Azure File Sync is slow to detect the files in the cloud and can take up to 32 hours. Even if pre-seeding runs fast, the overall time to get a fully running system may be significantly longer when data is pre-seeded in the cloud.

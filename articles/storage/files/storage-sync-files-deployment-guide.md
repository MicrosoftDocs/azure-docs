...
The Storage Sync Service is the top-level Azure resource that represents Azure File Sync. To deploy a Storage Sync Service, go to the [Azure portal](https://portal.azure.com/), and then search for Azure File Sync. In the search results, select **Azure File Sync (preview)**, and then select **Create** to open the **Deploy Storage Sync** tab.

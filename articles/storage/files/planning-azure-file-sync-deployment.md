...
### Backup solutions
Similiar to anti-virus solutions, backup solutions may cause the recall of tiered files. We recommend using a cloud backup solution with Azure File Sync. See [Understanding how to backup Azure Files](understanding-file-share-backup.md) for more information.

...
> [!WARNING]
> If you have an Azure File Sync agent version older than v12 installed, using the Robocopy /B switch with a tiered file as the source will lead to file corruption.

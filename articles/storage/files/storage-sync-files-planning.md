...
- You are migrating from a DFS-R deployment to an Azure File Sync deployment. For more information, see [DFS-R migration guidance](storage-sync-files-deployment-guide.md).

...
## Case Studies
* Organizations across the world are leveraging Azure Files & Azure Files Sync to optimize file access & storage. [Checkout their case studies here](azure-files-case-study.md).

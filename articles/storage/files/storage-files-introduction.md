...
Applications running in Azure can access data in the share via file [system I/O APIs](/dotnet/api/system.io.file). Developers can use their existing code and skills to migrate applications. In addition to system I/O APIs, you can use [Azure Storage Client Libraries](/dotnet/api/overview/azure/storage.files.shares-readme) or the [Azure Files REST API](/rest/api/storageservices/file-service-rest-api).

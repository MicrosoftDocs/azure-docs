...
- Maximum number of channels is four, for details see [here](/troubleshoot/azure/azure-storage/files-troubleshoot-performance#cause-4-number-of-smb-channels-exceeds-four?toc=/azure/storage/files/toc.json).

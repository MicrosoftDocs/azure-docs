...
# 'StandardV2_GRS' (HDD Geo Pv2), 'StandardV2_ZRS' (HDD Zone Pv2),
# 'StandardV2_GZRS (HDD GeoZone Pv2)'
...
New-AzRmStorageShare -ResourceGroupName $resourceGroup -AccountName $accountName -ShareName $shareName -QuotaGiB $provisionedStorageGib;
...
Update-AzRmStorageShare -ResourceGroupName $resourceGroup -AccountName $accountName -ShareName $shareName -ProvisionedBandwidthMibps 500 -ProvisionedIops 3034 -QuotaGiB 55;
$f = Get-AzRmStorageShare -ResourceGroupName $resourceGroup -AccountName $accountName -ShareName $shareName;
$f | fl
```

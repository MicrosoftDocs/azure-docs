...
```
> [!NOTE]
> To mount NFS share with custom CA certificate, add cafile=<absolute-path> as an additional parameter to the mount command. Absolute path for the CA file should start from the root directory.

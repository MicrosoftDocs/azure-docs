...
Login-AzureRmStorageSync -SubscriptionID "fill in sub ID" -TenantID "fill in TenantID"
Register-AzureRmStorageSyncServer -SubscriptionId "SubID" - ResourceGroupName "ResourceGroup" - StorageSyncService "fill in Storage Sync Service name"
```

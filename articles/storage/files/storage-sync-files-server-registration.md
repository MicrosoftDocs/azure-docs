...
* Your server must be running a supported version of Windows Server. For more information, see [Azure File Sync system requirements and interoperability](storage-sync-files-planning.md#storage-sync-files-planning.md#windows-file-server-considerations).

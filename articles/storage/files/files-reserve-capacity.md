...
Azure Files reserved capacity is available for premium, hot, and cool file shares deployed. Reserved capacity is not available for Azure file shares in transaction optimized tiers. All storage redundancies support for reservations. For more information about redundancy options, see [Azure Files redundancy](storage-files-planning.md#redundancy).

...
## Mount an SMB file share snapshot
...
3. Select **Operations > Snapshots** and take note of the name of the snapshot you want to mount. The snapshot name will be a GMT timestamp, such as in the following screenshot.

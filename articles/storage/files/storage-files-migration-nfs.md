...
This article explains how to use fpsync to move data from a Linux file server to NFS Azure file shares.
...
The following table lists the different datasets used to compare copy tool performance under different workloads.
...
The following chart shows the results of a baseline copy from source to destination.
...
The following chart shows the results of an incremental copy (delta change).
...
The following chart shows the results of a baseline copy of 191,345 small files in 3,906 directories with a total size of 3 GiB.
...
The following chart shows the results of a baseline copy of 5,000 large files (10 MiB) in a single directory with a total size of 50 GiB.

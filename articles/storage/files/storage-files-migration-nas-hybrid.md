...
* Provision or add Direct Attached Storage (DAS as compared to NAS, which is not supported).
    ...
    The amount of storage you provision can be smaller than what you are currently using on your NAS appliance. This configuration choice requires that you also make use of Azure File Syncs [cloud tiering](../filesync/storage-sync-cloud-tiering-overview.md) feature.

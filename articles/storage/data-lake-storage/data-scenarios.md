...
| Azure Storage Blob |<ul> <li>[Azure Data Factory](../../data-factory/connector-azure-data-lake-store.md)</li> <li>[AzCopy tool](../common/storage-use-azcopy-v10.md)</li><li>[DistCp running on HDInsight cluster](copy-data-wasb-distcp.md)</li> </ul> |

...
![Ingest data into Data Lake Storage Gen2](./media/data-lake-store-data-scenarios/ingest-data.png "Ingest data into Data Lake Storage Gen2")
...
| --- | --- |
| Local computer |<ul> <li>[Storage Explorer](storage-explorer.md)</ul> |
| Azure Storage Blob |<ul> <li>[Azure Data Factory](../data-factory/connector-azure-data-lake-store.md)</li> <li>[AzCopy tool](storage-use-azcopy-v10.md)</li><li>[DistCp running on HDInsight cluster](copy-data-wasb-distcp.md)</li> </ul> |
...
* **"Offline" upload of data**. If using Azure ExpressRoute is not feasible for any reason, you can use [Azure Import/Export service](../storage/common/storage-import-export-service.md) to ship hard disk drives with your data to an Azure data center. Your data is first uploaded to Azure Storage Blobs.
...
![Analyze data in Data Lake Storage Gen2](./media/data-lake-store-data-scenarios/analyze-data.png "Analyze data in Data Lake Storage Gen2")

You can look at the following examples.

* [Create an HDInsight cluster with Data Lake Storage Gen2 as storage](hdinsight-hadoop-use-portal.md)
...
![Egress data from Data Lake Storage Gen2](./media/data-lake-store-data-scenarios/egress-data.png "Egress data from Data Lake Storage Gen2")
...
![Visualize data in Data Lake Storage Gen2](./media/data-lake-store-data-scenarios/visualize-data.png "Visualize data in Data Lake Storage Gen2")

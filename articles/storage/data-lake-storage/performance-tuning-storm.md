...
* **An Azure Data Lake Storage Gen2 account**. For instructions on how to create one, see [Quickstart: Create a storage account for analytic](quickstart-create-account.md).
* **An Azure HDInsight cluster** with access to a Data Lake Storage Gen2 account. See [Create an HDInsight cluster with Data Lake Storage Gen2](hdinsight-hadoop-use-portal.md). Make sure you enable Remote Desktop for the cluster.

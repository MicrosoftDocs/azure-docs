...
To request access for these regions, follow the process in [this document](https://docs.microsoft.com/en-us/troubleshoot/azure/general/region-access-request-process).

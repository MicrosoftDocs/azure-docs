...
Sign in to the [Azure portal](https://portal.azure.com/) and search for **Storage Sync Services**. Select the appropriate storage sync service and sync group. Then select the server endpoint you'd like to monitor, and scroll down to the cloud tiering section. Under **Properties**, you'll see the following.

...
|----|----------------------|--------------|------------------|
| V12.1 Release - [KB4588751](https://support.microsoft.com/topic/497dc33c-d38b-42ca-8015-01c906b96132)| 12.1.0.0 | May 17, 2021 | Supported |
...
The following release notes are for version 12.1.0.0 of the Azure File Sync agent released May 17, 2021. These notes are in addition to the release notes listed for version 12.0.0.0.

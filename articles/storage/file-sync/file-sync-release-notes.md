...
- Server registration using the [Register-AzStorageSyncServer](../module/az.storagesync/register-azstoragesyncserver.md) and ServerRegistration.exe require .NET Framework 4.7.2. or higher

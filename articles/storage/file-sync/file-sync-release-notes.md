...
|----|----------------------|--------------|------------------|
| V14.1 Release - [KB5001873](https://support.microsoft.com/topic/d06b8723-c4cf-4c64-b7ec-3f6635e044c5)| 14.1.0.0 | November 30, 2021 | Supported - Flighting |
...
The following release notes are for version 14.1.0.0 of the Azure File Sync agent released November 30, 2021. These notes are in addition to the release notes listed for version 14.0.0.0.

### Improvements and issues that are fixed 
- Tiered files deleted on Windows Server 2022 are not detected by cloud tiering filter driver
	- This issue occurs because the DeleteFile API in Windows Server 2022 uses the FILE_DISPOSITION_INFORMATION_EX class to delete files. The v14.1 release adds support for detecting tiered files deleted using the FILE_DISPOSITION_INFORMATION_EX class.

...
|----|----------------------|--------------|------------------|
| v23 Release - [KB5072558](https://support.microsoft.com/topic/65d9bc34-92bd-4a05-8813-1f05112a6236) |23.00.0| July 22, 2026 | Supported – Flighting|
...
## Version V23.0.0.0
The following release notes are for Azure File Sync version 23.0.0.0 (released July 22, 2026). This release contains improvements for the Azure File Sync service and agent. 

## **Improvements and issues that are fixed**

**Recommended alerts**
You can now enable a set of preconfigured recommended alerts for your Storage Sync Service to monitor sync health, server connectivity, storage availability, and agent expiration. See [Monitor Azure File Sync](/azure/storage/file-sync/file-sync-monitoring#set-up-recommended-alerts). 
...
- Server registration by using the [Register-AzStorageSyncServer](/powershell/module/az.storagesync/register-azstoragesyncserver) and ServerRegistration.exe requires .NET Framework 4.7.2 or higher.
...
- Azure File Sync supports all characters that the [NTFS file system](/windows/win32/fileio/naming-a-file) supports, except invalid surrogate pairs. For more information, see [Troubleshooting guide](/troubleshoot/azure/azure-storage/file-sync-troubleshoot-sync-errors?toc=/azure/storage/file-sync/toc.json#handling-unsupported-characters).
...
### Cloud endpoint
- Azure File Sync supports making changes to the Azure file share directly. However, an Azure File Sync change detection job first needs to discover any changes made on the Azure file share. A change detection job initiates for a cloud endpoint once every 24 hours. To immediately sync files that are changed in the Azure file share, use the [Invoke-AzStorageSyncChangeDetection](/powershell/module/az.storagesync/invoke-azstoragesyncchangedetection) PowerShell cmdlet to manually initiate the detection of changes in the Azure file share.

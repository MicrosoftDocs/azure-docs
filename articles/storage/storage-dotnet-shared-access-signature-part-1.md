...
- **IP.** An optional parameter that specifies an IP address or a range of IP addresses outside of Azure (see the section [Routing session configuration state](../service-directory/expressroute-workflows.md) for Express Route) from which to accept requests. 

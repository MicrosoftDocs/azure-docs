...
- **IP.** An optional parameter that specifies an IP address or a range of IP addresses outside of Azure (see the section [Routing session configuration state](https://azure.microsoft.com/en-us/documentation/articles/expressroute-workflows/) for Express Route) from which to accept requests. 

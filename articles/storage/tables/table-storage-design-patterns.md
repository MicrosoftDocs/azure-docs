...
You use LINQ to retrieve multiple entities from the Table service with Azure Cosmos Tables library. 

```cli
dotnet add package Microsoft.Azure.Cosmos.Table
```

To make the below example work you need to include namespaces:

...
For more details on listing operations, see [List Azure Storage Resources with the Microsoft Azure Storage Client Library for C++](storage-c-plus-plus-enumeration.md).

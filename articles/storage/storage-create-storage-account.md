...
5. Select the type of storage account: **General purpose** or **Blob storage**. **General purpose** is the default.
    ...
    If **Blob Storage** was selected, then specify the access tier: **Hot** or **Cool**. The default is **Hot**. See [Azure Blob Storage: Cool and Hot tiers](blob/storage-blob-storage-tiers.md) for more details.
...
* [Azure Blob Storage: Cool and Hot tiers](blob/storage-blob-storage-tiers.md)

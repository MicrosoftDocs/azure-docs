...
Note! If your Elastic SAN and the private endpoint are in different subscriptions, you must register the Microsoft.ElasticSan resource provider in the subscription that contains the private endpoint. 

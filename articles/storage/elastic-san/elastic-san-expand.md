...
For CLI, ensure you are using version 1.2.0b1 or above of the elastic-san extension. For PowerShell, ensure you are using version 1.2.1 or above of the Az.ElasticSan module.

...
For CLI, ensure you are using a version that is 1.2.0b1 or higher of the elastic-san extension. For PowerShell, ensure you are using a version that is  1.2.1 or higher of the Az.ElasticSan module.

...
| **WEKA** | **WEKA Data Platform** provides a fast, scalable file storage system for Enterprise AI, Generative AI and HPC workloads in Microsoft Azure. WEKA provides a transformational software-defined approach to data by accelerating storage performance, reducing cloud storage costs and simplifying data operations across on-premises, and cloud environments. | - Enterprise, and Generative AI <br> - High-Performance Computing (HPC) <br> - Containerized workloads <br> - Tiering, backup, and disaster recovery (DR) from on-premises WEKA systems |
...
| **De-duplication**                                  | Yes                  | Yes                            | Yes                       | No                    | No                    | Yes                   | No                    |

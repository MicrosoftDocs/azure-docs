...
1. Standalone hybrid configuration
    :::image type="content" source="./media/tigerbridge-deployment-guide/tigerbridge-reference-architecture-1.png" alt-text="Diagram that shows reference architecture for Tiger Bridge in hybrid configuration":::
...
- [Running ISV file services in Azure](./isv-file-services)

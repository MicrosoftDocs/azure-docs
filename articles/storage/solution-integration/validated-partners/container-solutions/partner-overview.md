...
| ------- | ----------- | -------------------- |
| ![CloudCasa by Catalogic logo](./media/cloudcasa-logo.png)| **CloudCasa by Catalogic** is an award-winning backup, recovery, migration, and replication service, built specifically for Kubernetes, and cloud native applications. It supports AKS, and all other major Kubernetes distributions and managed services. From a single dashboard, CloudCasa makes managing cross-cluster, cross-tenant, cross-region and cross-cloud backup and recovery easy. With CloudCasa's Azure integration, cluster recoveries, and migrations include the ability to automatically re-create entire AKS clusters along with their vNETs, add-ons, and load balancers.|[Partner page](https://cloudcasa.io/partners/microsoft-azure/)<br>[Azure Marketpalce](https://azuremarketplace.microsoft.com/marketplace/apps/catalogicsoftware1625626770507.cloudcasa-aks-app)|

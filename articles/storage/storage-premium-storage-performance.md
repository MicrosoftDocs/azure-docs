...
To view a complete list of all available Azure VM sizes, refer [Sizes for Azure virtual m achines](../virtual-machines/virtual-machines-size-specs.md). Choose a VM size that can meet and scale to your desired application performance requirements. In addition to this, take into account following important considerations when choosing VM sizes.

...
For getting this started, we'll be creating an app that targets Android, iOS, and Windows. This app will simply create a container and upload a blob into this container. We'll be using Visual Studio on Windows for getting this started, but the same learnings can be applied when creating an app using Xamarin Studio on Mac OS.

...
Note: For some disks the DriveID may appear with letters swapped, eg BCDEFGHI could be returned as CBEDGFIH. Azure Import/Export service handles this automatically and proceeds to complete the job.

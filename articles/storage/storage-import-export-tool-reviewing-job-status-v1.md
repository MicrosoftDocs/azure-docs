...
The following are example URLs for copy log files for an import job with two drives:  
 ...
 See [Import/Export service Log File Format](common/storage-import-export-file-format-log.md) for the format of copy logs and the full list of status codes.  

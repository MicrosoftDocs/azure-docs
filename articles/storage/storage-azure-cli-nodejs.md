...
Here are some additional resources for learning more about working with the Azure CLI 1.0:

* [Azure CLI commands in Resource Manager mode](../virtual-machines-command-line-tools.md)
* [Azure CLI commands in Azure Service Management mode](../virtual-machines-command-line-tools.md)

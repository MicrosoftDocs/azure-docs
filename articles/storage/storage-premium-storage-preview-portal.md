...
For a complete walk-through inside an Azure environment, see [Create a Virtual Machine Running Windows in the Azure Portal](../virtual-machines/virtual-machines-windows-tutorial.md).

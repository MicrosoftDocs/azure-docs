...
1. Select **Save** on the *Custom domain* blade to register your custom domain.

If the registration is successful, you will see a message stating that your storage account was successfully updated. Once your CNAME record has propagated through DNS, your users can now view blob data by using custom domain, so long as they have the appropriate permissions.

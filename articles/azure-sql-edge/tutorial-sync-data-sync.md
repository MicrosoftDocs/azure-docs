---
title: Sync data from Azure SQL Edge by using SQL Data Sync | Microsoft Docs
...
* [Use PowerShell to sync between Azure SQL Database and Azure SQL Edge](../sql-database/scripts/sql-database-sync-data-between-azure-onprem.md). In this tutorial, replace the `OnPremiseServer` database details with the Azure SQL Edge details.

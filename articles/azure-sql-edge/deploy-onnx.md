...
This quickstart is based on **scikit-learn** and uses the [Boston Housing dataset](https://scikit-learn.org/0.16/modules/generated/sklearn.datasets.load_boston.html).

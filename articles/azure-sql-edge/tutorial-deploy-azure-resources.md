...
1. Open Azure Data Studio and configure Python for notebooks. For details, see [Configure Python for Notebooks](/azure-data-studio/notebooks/sql-notebooks#configure-python-for-notebooks). This step can take several minutes.

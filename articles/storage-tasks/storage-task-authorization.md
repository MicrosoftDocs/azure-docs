...
For information about how to authorize a storage task to perform operations on a target storage account, see [Storage task assignment](storage-task-assignment.md).
...
## Required permissions to authorize a security principal
...
To learn how to assign an Azure role, see [Assign Azure roles using the Azure portal](../role-based-access-control/role-assignments-portal.md).

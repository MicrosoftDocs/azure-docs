...
The **Overview** page in the Azure portal for each storage task includes these metrics:
...
Azure Storage Tasks support the [activity log](/azure/azure-monitor/essentials/activity-log), but not resource logs.

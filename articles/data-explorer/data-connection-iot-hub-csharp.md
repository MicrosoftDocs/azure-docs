---
title: 'Create an Azure Data Explorer data connection from IoT Hub by using C#'
description: In this article, you learn how to create an Azure Data Explorer data connection from IoT Hub by using C#.
...
# Create an Azure Data Explorer data connection from IoT Hub by using C#

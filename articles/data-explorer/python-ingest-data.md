...
RESPONSE = ENGINE_CLIENT.execute_mgmt(KUSTO_DATABASE, CREATE_TABLE_COMMAND)
...
RESPONSE = ENGINE_CLIENT.execute_mgmt(KUSTO_DATABASE, CREATE_MAPPING_COMMAND)
...
RESPONSE = ENGINE_CLIENT.execute_query(KUSTO_DATABASE, QUERY)

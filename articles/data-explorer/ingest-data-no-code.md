...
you have a pipeline with data flowing. Ingestion via the cluster takes 5 minutes, by default, so allow the data flow for a few minutes prior to query.

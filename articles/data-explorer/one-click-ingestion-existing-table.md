...
One-click ingestion enables you to quickly ingest data in JSON, CSV, and other formats into an existing table. You can ingest data from storage, from a local file, or from a container. 

...
Now you connect to the IoT Hub from Azure Data Explorer. When this connection is complete, data that flows into the iot hub streams to the [target table you created](#create-a-target-table-in-azure-data-explorer). To learn about how to connect Azure Data Explorer table to IoT hub programmatically, see [Add an IoT Hub data connection](data-connection-csharp.md#add-an-iot-hub-data-connection-preview).

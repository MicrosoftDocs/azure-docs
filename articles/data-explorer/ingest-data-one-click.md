...
This article shows how to use one-click ingestion for quick ingestion of a new table in json or csv formats from storage or local file into existing table or to create new table n Azure Data Explorer with intuitive wizard and with couple of minutes. Once the data is ingested, you can edit the table and run queries using the Web UI.

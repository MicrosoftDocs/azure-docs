...
To authenticate an application, Azure Data Explorer uses your AAD tenant ID. To find your tenant ID, follow [these steps](https://docs.microsoft.com/en-us/onedrive/find-your-office-365-tenant-id).

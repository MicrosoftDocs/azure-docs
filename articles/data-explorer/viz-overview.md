...
Use can use [Redash](https://redash.io/) to build dashboards and visualize data. You [set up Azure Data Explorer as a data source for Redash, and then visualize the data](/azure/data-explorer/redash).
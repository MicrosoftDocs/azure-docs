...
The following examples show how to delete well and wellbore data records in your Microsoft Energy Data Services instance by using Well Delivery DDMS APIs:

#### Delete a well record

To delete a well record:

...
1. In the Postman environment, update **CURRENT VALUE** with the information from your [Azure Data Manager for Energy instance](#get-your-azure-data-manager-for-energy-preview-instance-details):

   1. In Postman, in the left menu, select **Environments**, and then select **WellDelivery Environment**.

   1. In the **CURRENT VALUE** column, enter the information that's described in the table in [Get your Azure Data Manager for Energy instance details](#get-your-azure-data-manager-for-energy-preview-instance-details). Scroll to see all relevant variables.

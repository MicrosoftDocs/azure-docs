...
1. Go to any of the private endpoints, to the DNS configuration, and to Private DNS Zone associated with ADME resource. [![Screenshot that shows DNS Config.](media/how-to-manage-private-links/private-links-17-dns-config.png)](media/how-to-manage-private-links/private-links-17-dns-config.png#lightbox)
2. In the private DNS zone, check the IP associated with the entry for your Azure Data Manager for Energy instance. [![Screenshot that shows DNS Zone.](media/how-to-manage-private-links/private-links-18-dns-zone.png)](media/how-to-manage-private-links/private-links-18-dns-zone.png#lightbox)

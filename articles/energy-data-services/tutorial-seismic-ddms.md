...
> For more information on the Seismic REST APIs in Azure Data Manager for Energy, refer to the OpenAPI specifications available in the [adme-samples](https://microsoft.github.io/adme-samples/) GitHub repository.
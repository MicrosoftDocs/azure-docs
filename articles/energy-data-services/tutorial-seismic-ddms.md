---
title: Tutorial - Sample steps to interact with Seismic DDMS in Microsoft Azure Data Manager for Energy  #Required; page title is displayed in search results. Include the brand.
description: This tutorial shows you how to interact with Seismic DDMS Azure Data Manager for Energy  #Required; article description that is displayed in search results. 
...
3. Update the **CURRENT_VALUE** of the Postman Environment with the information obtained in [Azure Data Manager for Energy instance details](#microsoft-energy-data-services-instance-details)

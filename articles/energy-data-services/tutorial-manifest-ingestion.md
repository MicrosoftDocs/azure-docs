---
title: Microsoft Azure Data Manager for Energy - Steps to perform a manifest-based file ingestion #Required; page title is displayed in search results. Include the brand.
...
* Update the **CURRENT_VALUE** of the postman environment with the information obtained in [Get Azure Data Manager for Energy Preview instance details](#get-microsoft-energy-data-services-preview-instance-details)

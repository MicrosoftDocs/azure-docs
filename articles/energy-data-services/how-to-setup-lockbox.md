...
5.	To approve the lockbox request from portal, you can select Approve.
  ...
  [![Screenshot of approve or deny Lockboxrequest.](media/how-to-create-lockbox/pending_request_on_lockbox_portal.png)](media/how-to-create-lockbox/approve_deny_lockbox.png#lightbox)

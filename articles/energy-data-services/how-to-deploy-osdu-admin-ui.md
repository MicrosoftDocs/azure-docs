...
## Prerequisites
- Tools - [Visual Studio Code with Dev Containers](https://code.visualstudio.com/docs/devcontainers/tutorial)
> [!NOTE]
> While it is possible to deploy the OSDU Admin UI from your local computer using either Linux or Windows WSL, we recommend using a Dev Container to eliminate potential conflicts (i.e. tooling versions, environments etc.). 

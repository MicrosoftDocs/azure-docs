...
[![Screenshot that shows the API call to create a seismic dataset in Postman](media/how-to-convert-segy-to-vds/postman-api-create-headermapping.png)](media/how-to-convert-segy-to-vds/postman-api-create-headermapping.png#lightbox)
...
[![Screenshot that shows the API call to start the conversion workflow in Postman](media/how-to-convert-segy-to-vds/postman-api-check-workflow-status.png)](media/how-to-convert-segy-to-vds/postman-api-check-workflow-status.png#lightbox)

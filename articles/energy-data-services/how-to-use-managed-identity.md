...
2. Use the [Add Member API](https://github.com/microsoft/adme-samples/blob/main/rest-apis/M12/entitlements_openapi.yaml#L293) to add the application ID of the user-assigned managed identity to the appropriate entitlement groups. 
...
Now Azure Functions is ready to access Azure Data Manager for Energy Preview APIs.  

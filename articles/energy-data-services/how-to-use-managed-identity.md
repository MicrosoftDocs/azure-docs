...
5.	Step 5: Generate token for accessing Microsoft Energy Data Services from Azure Function.
...
[![Screenshot of ApplicationId for user assigned identity.](media/how-to-use-managed-identity/3-objectid-applicationid-user-assigned-identity.png)](media/how-to-use-managed-identity/3-objectid-applicationid-user-assigned-identity.png#lightbox)
...
b.	client-id
c.	client-secret
d.	microsoft energy data services uri
e.	data-partition-id
f.	access token

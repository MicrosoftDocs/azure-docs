---
title: Integrate airflow logs with Azure Monitor - Microsoft Azure Data Manager for Energy Preview
...
In this article, you'll learn how to start collecting Airflow Logs for your Azure Data Manager for Energy instances into Azure Monitor. This integration feature helps you debug Airflow DAG ([Directed Acyclic Graph](https://airflow.apache.org/docs/apache-airflow/stable/concepts/dags.html)) run failures. 
...
You can integrate Airflow logs with Log Analytics Workspace by using **Diagnostic Settings** under the left panel of your Azure Data Manager for Energy instance overview page. 

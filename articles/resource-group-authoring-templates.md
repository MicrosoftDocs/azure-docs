...
The values for the **properties** element are exactly the same as the values you provide in the request body for REST API operation to create (PUT method) the resource. See [Azure reference](https://msdn.microsoft.com/library/azure/mt420159.aspx) for REST API for the resource you wish to provide.

...
>[!NOTE]
>IoT Central uses Azure IoT Device Provisioning service (DPS) underneath for all device registration and connection, [learn more about DPS](https://docs.microsoft.com/en-us/azure/iot-dps/about-iot-dps).
...
1. Get connection details such as **Scope ID, Device ID, and Primary key** for the added device by clicking **Connect** on the device page.
    * **[Scope ID](https://docs.microsoft.com/en-us/azure/iot-dps/concepts-device#id-scope)** is per IoT Central App and is generated by DPS, used to ensure unique device ID within an App.

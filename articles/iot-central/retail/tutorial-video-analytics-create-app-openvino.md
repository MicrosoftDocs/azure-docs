...
> [!TIP]
> To use YOLO v3 instead of OpenVINO&trade; for object an motion detection, see [Tutorial: Create a video analytics - object and motion detection application in Azure IoT Central (YOLO v3)](tutorial-video-analytics-create-app-yolov3.md).

...
:::image type="content" source="media/concept-connected-logistics-architecture/connected-logistics-architecture.png" alt-text="Connected logistics dashboard." border="false":::

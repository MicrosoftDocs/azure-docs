...
3. **Create app** will open New application form and fill up the requested details as show below.
   ...
   * **URL**: you can use suggested default URL or enter your friendly unique memorable URL. Next, default setting is recommended if you already have an Azure Subscription.Else you can start with seven day free trial and choose to convert standard at any time before the free trail expiration.

---
title: Architecture IoT Smart Inventory Mgmt | Microsoft Docs
description: An architecture of IoT Smart Inventory Mgmt template for IoT Central
author: nandab
ms.author: nandab
...
![Connected Logistics Dashboard](./media/concept-smart-inventory-mgmt-architecture/smart_inventory_management_architecture.png)
...
Telemetry ingestion from RFID, BLE tags

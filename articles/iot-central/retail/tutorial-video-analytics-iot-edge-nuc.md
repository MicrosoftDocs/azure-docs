...
* The [IoT Edge runtime installed](../../iot-edge/how-to-provision-single-device-linux-symmetric.md) and running on the device.
...
If you don't have the IoT Edge runtime installed in your Intel NUC machine, see [Install the Azure IoT Edge runtime on Debian-based Linux systems](../../iot-edge/how-to-provision-single-device-linux-symmetric.md) instructions.

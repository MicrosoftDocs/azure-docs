...
To upload an image on the application dashboard, navigate to the **Dashboard** of your application and click on **Edit**. You must be a builder to complete this task:

...
* View the telemetry on the **Measurements** page:
    ...
    ![View telemetry](media/howto-connect-nodejs-pnp/viewtelemetry.png)

* View the location on the **Measurements** page:

    ![View location measurements](media/howto-connect-nodejs-pnp/viewlocation.png)
...
* View the device property values sent from your device on the **Properties** page. The device property tiles update when the device connects:
    ...
    ![View device properties](media/howto-connect-nodejs-pnp/viewproperties.png)

* Set the fan speed and target temperature from the **Settings** page:

    ![Set fan speed](media/howto-connect-nodejs-pnp/setfanspeed.png)

* Call the countdown command from the **Commands** page:

    ![Call countdown command](media/howto-connect-nodejs-pnp/callcountdown.png)

## Next steps

Now that you've learned how to connect a generic Node.js client to your Azure IoT Central application, the suggested next step is to learn how to [set up a custom device template](howto-set-up-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) for your own IoT device.

...
2. Enter the email address and password you use to access your Azure subscription:
    ...
    ![Enter your organization account](./media/tutorial-define-device-type-experimental/sign-in.png)

3. To start creating a new Azure IoT Central application, click **New Application**:

    ![Azure IoT Central Application Manager page](./media/tutorial-define-device-type-experimental/iotcentralhome.png)
...
![Device Templates page](./media/tutorial-define-device-type-experimental/devicetemplates.png)
...
3. On the **Custom Device Template** page, enter **Connected Air Conditioner** as the name of your device, and then click **Create**. You can also upload an image of your device that's visible to operators in the device explorer:
    ...
    ![Custom Device](./media/tutorial-define-device-type-experimental/createcustomdevice.png)

4. In the **Connected Air Conditioner** device template, make sure you're on the **Measurements** page where you define the telemetry. Each device template you define has separate pages for you to:
    ...
    * Customize the device _dashboard_ for your operators.
    ...
    ![Air conditioner measurements](./media/tutorial-define-device-type-experimental/airconmeasurements.png)
...
6. Each type of telemetry you define for a device template includes [configuration options](howto-set-up-template-experimental-experimental.md) such as:
    ...
    * Simulation parameters.
    ...
    ![Configure Temperature simulation](./media/tutorial-define-device-type-experimental/temperaturesimulation.png)
...
7. After a short while, the **Measurements** page shows a chart of the temperature telemetry from your simulated connected air conditioner device. Use the controls to manage visibility, aggregation, or to edit the telemetry definition:
    ...
    ![View temperature simulation](./media/tutorial-define-device-type-experimental/viewsimulation.png)

8. You can also customize the chart using the **Line**, **Stacked**, and **Edit Time Range** controls:

    ![Customize the chart](./media/tutorial-define-device-type-experimental/customizechart.png)
...
2. Each type of Event you define for a device template includes [configuration options](howto-set-up-template-experimental.md) such as:
   ...
   * Severity.
    ...
    ![Configure Event measurement](./media/tutorial-define-device-type-experimental/eventconfiguration.png)
...
3. After a short while, the **Measurements** page shows a chart of the events randomly generated from your simulated connected air conditioner device. Use the controls to manage visibility, or to edit the event definition:
    ...
    ![View event simulation](./media/tutorial-define-device-type-experimental/eventview.png)

1. To see additional details about the event, click the event on the chart:

    ![View Event Details](./media/tutorial-define-device-type-experimental/eventviewdetail.png)
...
2. Each type of state you define for a device template includes [configuration options](howto-set-up-template-experimental.md) such as:
   ...
   * Color for each value.
    ...
    ![Configure State measurement](./media/tutorial-define-device-type-experimental/stateconfiguration.png)
...
3. After a short while, the **Measurements** page shows a chart of the states randomly generated from your simulated connected air conditioner device. Use the controls to manage visibility, or to edit the state definition:
    ...
    ![View state simulation](./media/tutorial-define-device-type-experimental/stateview.png)
...
1. Navigate to the **Settings** page for your **Connected Air Conditioner** device template:
    ...
    ![Prepare to add a setting](./media/tutorial-define-device-type-experimental/deviceaddsetting.png)

    You can create settings of different types such as numbers or text.

2. Click **Number** to add a number setting to your device.
...
3. To configure your **Set Temperature** setting, use the information in the following table:
    ...
    ![Configure Set Temperature setting](./media/tutorial-define-device-type-experimental/configuresetting.png)
...
4. You can customize the layout of the **Settings** page by moving and resizing settings tiles:
    ...
    ![Customize settings layout](./media/tutorial-define-device-type-experimental/settingslayout.png)
...
1. Navigate to the **Properties** page for your **Connected Air Conditioner** device template:
    ...
    ![Prepare to add a property](./media/tutorial-define-device-type-experimental/deviceaddproperty.png)
...
1. To configure your location property, use the information in the following table:
    ...
    ![Configure the device properties](./media/tutorial-define-device-type-experimental/configureproperties.png)
...
1. To configure your last service date property, use the information in the following table:
    ...
    ![Configure the device properties](./media/tutorial-define-device-type-experimental/configureproperties2.png)

    Click **Save**.

1. You can customize the layout of the **Properties** page by moving and resizing property tiles.
...
1. To configure your firmware version, use the information in the following table:
    ...
    ![Configure firmware version](./media/tutorial-define-device-type-experimental/configureproperties3.png)
...
1. To configure the serial number, use the information in the following table:
    ...
    ![Configure serial number](./media/tutorial-define-device-type-experimental/configureproperties4.png)
...
1. To configure your new command, use the information in the following table:
    ...
    ![Prepare to add a setting](./media/tutorial-define-device-type-experimental/commandsecho1.png)

     Click **Save**.

1. You can customize the layout of the **Commands** page by moving and resizing the command tiles.
...
1. Configure the **Line Chart** component using the information in the following table:
    ...
    ![Line chart settings](./media/tutorial-define-device-type-experimental/linechartsettings.png)
...
1. Configure the **State History** component using the information in the following table:
    ...
    ![Line chart settings](./media/tutorial-define-device-type-experimental/dashboardstatechartsetting.png)
...
1. Configure the **Settings and Properties** component using the information in the following table:
    ...
    ![Set temperature property settings](./media/tutorial-define-device-type-experimental/propertysettings4.png)
...
1. You can now see simulated data for your Connected Air Conditioner on the dashboard. You can edit the tiles and layout for the dashboard:
    ...
    ![View dashboard](./media/tutorial-define-device-type-experimental/dashboard.png)

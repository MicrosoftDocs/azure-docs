...
3. Optionally, choose **Image** and upload an image to display on your home page. An image can have a URL to which you navigate when you click on it:
    ...
    To learn more, see [How to prepare and upload images to your Azure IoT Central application](howto-prepare-images-experimental.md).
...
* [Monitor your devices (as an operator)](tutorial-monitor-devices-experimental.md)
* [Add a new device to your application (as an operator and device developer)](tutorial-add-device-experimental.md)

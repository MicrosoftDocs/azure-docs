...
# Group multiple actions to run from one or more rules (preview features)
...
| Webhook     | { "schemaId" : "AzureIoTCentralRuleWebhook", "data": {[regular webhook payload](../core/howto-create-webhooks.md#payload)}} |

...
* **Device sets:** A [device set](howto-use-device-sets-experimental.md) is a user-defined group of your devices. For example, all Refrigerators in Oakland, or All rev 2.0 wind turbines.
...
* **Aggregation:** By default we aggregate data by its average, but you can choose to change the data aggregation to something else to fit your needs. 
   ...
   ![Analytics visualization split by](media/howto-create-analytics-experimental/analytics-splitby.png)
...
* **Show chart:** Your results will be displayed in a line format to easily spots upward/downward trends and anomalies. 
 ...
 ![Showing the grid view for your analytics](media/howto-create-analytics-experimental/analytics-showgrid.png)
...
* **Zoom reset:** Once you've performed various levels of zooming, you can use the zoom reset control to return to your original result set. 
 ...
 ![Perform zooming on your data](media/howto-create-analytics-experimental/analytics-zoom.png)
...
* **Scatter:** All points will be plotted on the chart without lines connecting them. 
 ...
 ![Different line types available in Analytics](media/howto-create-analytics-experimental/analytics-linetypes.png)
...
* **Shared Y-axis:** All the graphs share the same Y-axis and the values for the axis do not change. Shared Y-axis graphs are useful when you want to look at a single measure while slicing the data with split-by.
 ...
 ![Arrange data across y-axis with different visualization modes](media/howto-create-analytics-experimental/analytics-yaxis.png)
...
> [Prepare and connect a Node.js application](howto-connect-nodejs-experimental.md)
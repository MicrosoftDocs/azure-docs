---
title: Create Create a solar PV monitoring app with IoT Central | Microsoft Docs
description: Learn to build Create a solar PV monitoring application using Azure IoT Central application templates.
author: philmea
ms.author: philmea
ms.date: 09/24/2019
ms.topic: tutorial

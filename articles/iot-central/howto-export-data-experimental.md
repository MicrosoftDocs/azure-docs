---
title: Export your data from Azure IoT Central | Microsoft Docs
...
# Export your data from Azure IoT Central
...
3. Choose a subscription.
    ...
    > [!Note]
    > You can now export data to other subscriptions that are **not the same** as the one for your Pay-As-You-Go IoT Central application. You connect using a connection string in this case.
...
3. Click the **+ New** button in the top right. Choose one of **Azure Blob Storage**, **Azure Event Hubs**, or **Azure Service Bus** as the destination of your export.
    ...
    ![Create new continuous data export](media/howto-export-data-experimental/export_new.png)
...
4. In the drop-down list box, select your **Storage Account/Event Hubs namespace/Service Bus namespace**. You can also pick the last option in the list which is **Enter a connection string**. 
    ...
    > [!NOTE]
    > You only see Storage Accounts/Event Hubs namespaces/Service Bus namespaces in the **same subscription as your IoT Central app**. If you want to export to a destination outside of this subscription, choose **Enter a connection string** and see step 5.
    ...
    ![Create new cde Event Hub](media/howto-export-data-experimental/export_create.png)
...
8. To turn on continuous data export, make sure **Data export** is **On**. Select **Save**.
    ...
    ![Configure continuous data export](media/howto-export-data-experimental/export_list.png)

...
!["Configure Number" form with details for speed settings](./media/howto-set-up-template-experimental/settingsform.png)
...
!["Configure Last Serviced" form on the "Properties" tab](./media/howto-set-up-template-experimental/propertiesform.png)
...
3. Configure **Display Name**, **Field Name**, and (optionally) **Initial Value** for the location.
   ...
   !["Configure Location" form with details for location](./media/howto-set-up-template-experimental/locationcloudproperty2.png)
...
3. Configure the display name and field name, and select **Location** as the data type:
   ...
   !["Configure Device Properties" form with details for location](./media/howto-set-up-template-experimental/locationdeviceproperty2.png)
...
!["Configure Command" form with details for echo](./media/howto-set-up-template-experimental/commandsecho.png)
...
!["Configure Device Details" form with details for settings and properties](./media/howto-set-up-template-experimental/dashboardsettingsandpropertiesform.png)

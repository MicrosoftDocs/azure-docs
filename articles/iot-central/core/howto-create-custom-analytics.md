...
![IoT Central analysis resource group](media/howto-create-custom-analytics/resource-group-2.png)
...
![Event Hubs namespace](media/howto-create-custom-analytics/event-hubs-namespace-2.png)
...
![Data export configuration](media/howto-create-custom-analytics/cde-configuration-2.png)
...
1. The library status is now **Installed**:
    ...
    ![Library installed](media/howto-create-custom-analytics/cluster-libraries-2.png)
...
1. Select the **Workspace** to view the imported notebook:
    ...
    ![Imported notebook](media/howto-create-custom-analytics/import-notebook-2.png)
...
![Smoothed telemetry plot](media/howto-create-custom-analytics/telemetry-plot-2.png)
...
![Box plots](media/howto-create-custom-analytics/box-plots-2.png)

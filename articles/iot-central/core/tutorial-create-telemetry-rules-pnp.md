...
1. Select **Telemetry** to create a rule to monitor device telemetry.
    ...
    ![Rule Types](media/tutorial-create-telemetry-rules-pnp/rule-types1.png)
...
1. Next, choose an **Operator** and provide a **Value**.
     ...
     ![Condition](media/tutorial-create-telemetry-rules-pnp/aggregate-condition-filled-out1.png)
...
1. Click the **+ Action** in the **Action** sections. Here you see the list of available actions.  
    ...
    ![Add Action](media/tutorial-create-telemetry-rules-pnp/add-action1.png)

...
<<<<<<< HEAD
After you publish a device template, it's visible on the **Devices** page. Publishing a template will make it available for your operator to create devices, device groups, rules, exports, and jobs. Once a template is published, any modifications to capabilities, interfaces, or modules will directly impact your device instances and other the behavior of other areas of the application.
=======

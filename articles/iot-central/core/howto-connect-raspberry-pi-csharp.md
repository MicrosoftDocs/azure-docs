...
1. Select **+New** from device templates
   ![Device Template](media/howto-connect-raspberry-pi-csharp/adddevicetemplate.png)
   

2. Select **Raspberry Pi** and create the Raspberry Pi device template
   ![Add Device template](media/howto-connect-raspberry-pi-csharp/newdevicetemplate.png)

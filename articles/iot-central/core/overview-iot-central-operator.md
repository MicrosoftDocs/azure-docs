...
Operators can create personal dashboards in an IoT Central application that contain links to the resources they use most often. To learn more, see [Manage dashboards](howto-create-personal-dashboards.md#manage-dashboards).

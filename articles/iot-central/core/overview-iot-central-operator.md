...
1. Select **Import**.
    ...
    ![Screenshot of Import Action](./media/howto-manage-devices/bulkimport-1-a.png)
...
1. Once the import completes, a success message is shown in the Device Operations panel.
    ...
    ![Screenshot of Import Success](./media/howto-manage-devices/bulkimport-3-a.png)
...
1. On the left panel, choose **All devices**:
    ...
    ![Screenshot of Unassociated Devices](./media/howto-manage-devices/unassociateddevices-1-a.png)
...
1. Select **Migrate**:
    ...
    ![Screenshot of Associate Devices](./media/howto-manage-devices/unassociateddevices-2-a.png)
...
1. Select the devices that you want to export and then select the **Export** action.
    ...
    ![Screenshot of Export](./media/howto-manage-devices/export-1-a.png)
...
1. Select the **Download File** link to download the file to a local folder on the disk.
    ...
    ![Screenshot of Export Success](./media/howto-manage-devices/export-2-a.png)

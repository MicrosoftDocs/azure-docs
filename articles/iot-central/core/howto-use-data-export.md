...
>
> - For information about the legacy data export features, see [Export IoT data to cloud destinations using data export (legacy)](./howto-export-data.md).
...
The following table shows the differences between the [legacy data export](howto-export-data.md) and preview data export features:

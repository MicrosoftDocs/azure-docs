...
> [!TIP]
> To see sample device code that handles failovers in various programming languages, see [IoT Central high availability clients](https://github.com/Azure/iot-central-high-availability-clients).

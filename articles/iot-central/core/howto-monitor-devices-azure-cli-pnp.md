...
[Visit the Azure CLI extensions reference for more details](https://docs.microsoft.com/en-us/cli/azure/ext/azure-cli-iot-ext/iot/central)
...
### Get the app id of your IoT Central app

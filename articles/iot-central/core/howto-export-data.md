...
- `component`: The component that sent this message. This field only appears if the capabilities sent in the message were modelled as a [component in the device template](howto-set-up-template#create-a-component).

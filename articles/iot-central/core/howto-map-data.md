...
# Map data for your device in IoT Central

Data mapping lets you transform complex device data into structured data inside IoT Central. For each of your device, you can map a specific JSON path in the device data message to an Alias, a friendly name to indicate what the JSON path is leading to. IoT Central will then use the device data mapping information to provide a stream of mapped data that customers can use to create their device templates.

This article shows you how to add data mappings to your device.

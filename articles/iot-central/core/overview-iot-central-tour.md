...
* To get help and support, choose the **Help** drop-down for a list of resources. You can [find the version of your application](./howto-find-app-version.md) from the **About your app** link. In an application on the free pricing plan, the support resources include access to [live chat](howto-show-hide-chat.md).

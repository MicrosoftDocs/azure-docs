...
* An Azure IoT Central application created from the **DevKits** application template. For more information, see the [create an application quickstart](quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
1. Add a device from Device Explorer. Select **+ New > Real** to add a real device.
    ...
    * Enter a **Device Name**, or use the suggested name
    ...
    ![Add Device](media/howto-connect-sensortile-pnp/real-device.png)

1. To get the device connection details, **Scope ID**, **Device ID**, and **Primary key**, select **Connect** on the device page.

    ![Connection details](media/howto-connect-sensortile-pnp/connect-device.png)
...
1. Open the ST BLE Sensor app and press the **Create a new app** button.
    ...
    ![Create app](media/howto-connect-sensortile-pnp/create-app.png)

1. Select the **Barometer** application.
1. Press the upload button.

    ![Barometer upload](media/howto-connect-sensortile-pnp/barometer-upload.png)
...
1. Using the left menu, select the **Cloud Logging** button.
    ...
    ![Cloud logging](media/howto-connect-sensortile-pnp/cloud-logging.png)

1. Select **Azure IoT Central** as the cloud provider.
1. Insert the Device ID and Scope ID that were previously noted.

    ![Credentials](media/howto-connect-sensortile-pnp/credentials.png)
...
Now that you've learned how to connect a SensorTile.box to your Azure IoT Central application, the suggested next step is to learn [how to set up a custom device template](howto-set-up-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) for your own IoT device.

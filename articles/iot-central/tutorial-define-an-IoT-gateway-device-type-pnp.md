---
title: Define a new IoT device as a gateway device type in Azure IoT Central | Microsoft Docs
description: This tutorial shows you, as a builder, how to create a new Azure IoT device as a gateway device in your Azure IoT Central application. You define the telemetry, state, properties, and commands for your type.
author: rangv
ms.author: rangv
ms.date: 10/22/2019
ms.topic: tutorial
...
A **device template** defines the capabilities of your IoT gateway device. Capabilities include telemetry the gateway sends, properties, and the commands a gateway responds to.

In this tutorial, you create an **Smart Building Gateway** device template. An Smart Building gateway device:
...
> [!div class="checklist"]
> * Create a new IoT device as a gateway device template.
> * Create a downstream device template
...
Downstream devices can connect to Azure IoT gateway device 

![Central Application page](./media/tutorial-define-an-IoT-gateway-device-type-pnp/gatewaypattern.png)
...
You will create downstream device templates which will be used during the gateway device template creation. 
...
![Downstream Device](./media/tutorial-define-an-IoT-gateway-device-type-pnp/gateway-downstream-new.png)

You will be presented the review page. Click **Create** button. 

![Downstream Device](./media/tutorial-define-an-IoT-gateway-device-type-pnp/gateway-downstream-review.png)

New device template is created. 

![Downstream Device](./media/tutorial-define-an-IoT-gateway-device-type-pnp/occupancy-sensor.png)

You will create a device template for S1 Sensor. 

Click on Device Templates in the left navigation, click **+ New**, select **IoT Device** tile and select occupancy sensor tile and click **Next: Customize**

![Downstream Device](./media/tutorial-define-an-IoT-gateway-device-type-pnp/s1-sensor.png)

You will be presented the review page. Click **Create** button. 

![Downstream Device](./media/tutorial-define-an-IoT-gateway-device-type-pnp/s1-review.png)

New device template is created. 

![Downstream Device](./media/tutorial-define-an-IoT-gateway-device-type-pnp/s1-template.png)
...
![Central Application page](./media/tutorial-define-an-IoT-gateway-device-type-pnp/devicetemplate.png)

Click **+ New** to start creating a new device template.

![Device Templates - New](./media/tutorial-define-an-IoT-gateway-device-type-pnp/devicetemplatenew.png)

You will land on device template type selection page. Select **Azure IoT ** Tile and click **Next: Customize** button at the bottom

![Device Templates Selection - Gateway](./media/tutorial-define-an-IoT-gateway-device-type-pnp/gateway-review.png)

You will land on device template type selection page. Select **Azure IoT** Tile and click **Next: Customize** button at the bottom

Select Gateway checkbox and click **Create** 

![Device Templates Selection - Gateway](./media/tutorial-define-an-IoT-gateway-device-type-pnp/gateway-customize.png)

You will be presented with a review page, click **Create** 

![Device Template - Gateway](./media/tutorial-define-an-IoT-gateway-device-type-pnp/gateway-review.png)
...
![Device Template - Gateway](./media/tutorial-define-an-IoT-gateway-device-type-pnp/gateway-occupancy-s1-rel.png)
...
![Device Template - Gateway](./media/tutorial-define-an-IoT-gateway-device-type-pnp/smartbuildingdevice.png)

## Create Downstream Simulated Devices

From the device explorer create a simulated occupancy sensor. 

![Device Template - occupancy](./media/tutorial-define-an-IoT-gateway-device-type-pnp/occupancydevice.png)

From the device explorer create a simulated s1 sensor. 

![Device Template - s1](./media/tutorial-define-an-IoT-gateway-device-type-pnp/s1device.png)

## Add Downstream Devices relationships to Gateway DEvice

Select S1 Sensor and Occupancy Sensor and click **Connect to gateway**. 

![Device Template - s1](./media/tutorial-define-an-IoT-gateway-device-type-pnp/connecttogateway.png)

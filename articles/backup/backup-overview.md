...
- You can manage backups for multiple machines that you gather into protection groups in a single console. This is useful when apps are tiered over multiple machines and you want to back them up together.
...
|  | Azure Backup (MARS) agent| System Center DPM | Azure Backup Server | Azure IaaS VM Backup |
| --- | --- | --- | --- | --- |

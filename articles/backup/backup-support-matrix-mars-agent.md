...
- [Learn more](backup-architecture.md#architecture-direct-backup-of-on-premises-windows-machines) about backup architecture using the MARS agent.
...
- For details about which DPM and MABS servers can be backed up with the MARS agent, review [this table]((backup-support-matrix-mabs-dpm.md#supported-dpmmabs-operating-system)).
...
## Next steps
- [Learn more](backup-architecture.md#architecture-direct-backup-of-on-premises-windows-machines) about backup architecture with the MARS agent.

...
- [Learn more](backup-architecture.md#architecture-direct-backup-of-on-premises-windows-machines-or-azure-vm-files-or-folders) about backup architecture using the MARS agent.
...
## Next steps
- [Learn more](backup-architecture.md#architecture-direct-backup-of-on-premises-windows-machines-or-azure-vm-files-or-folders) about backup architecture with the MARS agent.

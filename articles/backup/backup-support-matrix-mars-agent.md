...
- For details about which DPM and MABS servers can be backed up with the MARS agent, review [this table]((backup-support-matrix-mabs-dpm.md#supported-dpm-mabs-operating-system)).

...
<<<<<<< HEAD
- [Learn more](backup-architecture.md#architecture-direct-backup-of-on-premises-windows-server-machines-or-azure-vm-files-or-folders) about backup architecture using the MARS agent.
...
>>>>>>> e7d2bcabcb5a1a1c758280128e84c42d94f996a1
...
<<<<<<< HEAD
## Next steps
- [Learn more](backup-architecture.md#architecture-direct-backup-of-on-premises-windows-server-machines-or-azure-vm-files-or-folders) about backup architecture with the MARS agent.

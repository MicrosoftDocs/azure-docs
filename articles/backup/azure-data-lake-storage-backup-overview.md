...
# Customer intent: As a data engineer, I want to configure vaulted backups for Azure Data Lake Storage, so that I can ensure reliable data protection and restore capabilities for my storage accounts.
--- 

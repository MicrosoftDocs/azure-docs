...
For a step-by-step procedure to setup and backup using the MARS agent, refer this [article](https://review.docs.microsoft.com/azure/backup/backup-configure-vault?branch=pr-en-us-97600#create-a-recovery-services-vault).

...
By default, **Soft delete** is set to **Enabled** on newly created vaults to help protect backup data from accidental or malicious deletions. To review and modify the settings, [follow these steps](./backup-azure-security-feature-cloud.md#enabe-and-disable-soft-delete).
...
1. Follow [these steps](backup-azure-security-feature-cloud.md?tabs=azure-portal#disabl-soft-delete) to disable soft delete in the GRS vault's properties.

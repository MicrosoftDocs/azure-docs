...
* Verify if the machine where the script is executed meets the OS requirements. [Learn more](./backup-azure-restore-files-from-vm.md#os-requirements-to-succesfully-run-the-script).  
* Ensure you are not restoring to the same source, [Learn more](./backup-azure-restore-files-from-vm.md#ensure-the-machine-meets-the-requirements-before-executing-the-script).

...
1. On the vault item dashboard, select **All settings**.
...
1. On the vault item dashboard, under **Protected Item**, select **Backup Item**.
...
1. On the vault item dashboard, select **Delete backup**.

...
* Snapshot on the Write Accelerator enabled disk is not supported today. However during the backup, Azure Backup service  automatically exclude the Write Accelerator enabled disk attached with the VM. 

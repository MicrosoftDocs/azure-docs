...
1. Monitor the portal notifications.<br><br>To  monitor the job progress, navigate to **Backup center** -> **Backup Jobs** and filter the list for **In progress** jobs.<br><br>Depending on the size of your VM, creating the initial backup may take a while.

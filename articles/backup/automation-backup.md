...
| Manage | Delete Recovery Services vault | Supported    <br><br> [See the examples](/azure/backup/backup-azure-delete-vault?tabs=powershell). | Supported    <br><br> [See the examples](/azure/backup/backup-azure-delete-vault?tabs=cli). | Supported    <br><br> [See the examples](/azure/backup/backup-azure-delete-vault?tabs=arm). | N/A | N/A |

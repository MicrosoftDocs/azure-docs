...
1. Restore the disks from backup vault using [Azure Backup PowerShell](https://azure.microsoft.com/documentation/articles/backup-azure-vms-automation/#restore-an-azure-vm)

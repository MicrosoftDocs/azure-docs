...
- The number of restore points across restore point collections and resource groups for a VM can't exceed 18 for the Standard policy or 500 for the Enhanced policy. To create a new restore point, delete existing restore points.

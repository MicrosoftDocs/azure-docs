...
Your backup operation could fail when backing up VM with disk size greater than 4095GB. To sign up for private preview of Azure Backup large disk support for disks greater than 4TB up to 30TB in size, write back to us [@Ask Azure Backup Team](https://askazurebackupteam@microsoft.com).

...
Your backup operation could fail when backing up VM with disk size greater than 4095GB. To sign up for private preview of Azure Backup large disk support, write back to us [@Ask Azure Backup Team](@microsoft.com).

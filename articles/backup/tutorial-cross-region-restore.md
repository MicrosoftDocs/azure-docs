...
# Configure and run Cross Region Restore for Azure database for PostgreSQL
...
1. Select **Instance Region** = *Secondary Region* on the filters. 
     ...
     :::image type="content" source="./media/tutorial-cross-region-restore/backup-instances-secondary-region.png" alt-text="Screenshot showing the secondary region filter.":::

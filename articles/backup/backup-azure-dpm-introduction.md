...
Azure ExpressRoute | If Azure ExpressRoute is configured with Private peering, it cannot be used to back up the data to Azure.<br/><br/> If Azure ExpressRoute is configured with Public or Microsoft peering, it can be used to back up the data to Azure.<br/><br/> **Note:** Public peering is deprecated for new circuits.

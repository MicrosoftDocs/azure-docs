...
- Azure Backup for AKS supports [various backup-related reports](monitoring-and-alerts-overview#monitoring-and-reporting-scenarios). Currently, backup data can only be viewed by selecting “All” for workload type in the report filters.

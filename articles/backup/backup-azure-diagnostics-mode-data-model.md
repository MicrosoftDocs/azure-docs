...
Refer to the third column 'Description' in the [data model](#use-the-azure-backup-data-model) described above to identify which columns belong to V1 schema only.

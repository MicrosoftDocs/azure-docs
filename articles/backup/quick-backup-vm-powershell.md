...
The Azure PowerShell module is used to create and manage Azure resources from the PowerShell command line or in scripts. This article details using Azure PowerShell cmdlets to back up an Azure virtual machine. Backing up your data is a good practice for business and data continuity.
...
### Create a vault
Use **New-AzureRmRecoveryServicesVault** to create a Recovery Services vault. Specify the same location for the vault as was used for the virtual machine's resource group.
...
[Use Azure portal to back up Azure virtual machines](backup-azure-arm-vms.md)

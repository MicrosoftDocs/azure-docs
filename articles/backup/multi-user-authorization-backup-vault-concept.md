---
title: Multi-user authorization using Resource Guard for Backup vault
description: An overview of Multi-user authorization using Resource Guard for Backup vault.
ms.topic: conceptual
ms.date: 09/07/2022
author: v-amallick
ms.service: backup

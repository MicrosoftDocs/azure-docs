...
To resolve this issue, tollow these [troubleshooting steps](https://docs.microsoft.com/en-us/azure/backup/backup-azure-mabs-troubleshoot#registration-and-agent-related-issues).
...
| Backup | Backup failure for BMR | If THE BMR size is large, retry after moving some application files to the OS drive. |
...
At any time during this process, you can clear our these settings by closing the DPM console and editing the following registry keys:<br/> HKLM\SOFTWARE\Microsoft\Microsoft Data Protection Manager\Notification\ <br/> Delete SMTPPassword and SMTPUserName keys. <br/> 

...
- [Ensure 5-10% free volume space is available on scratch folder location](./backup-azure-file-folder-backup-faq.yml#whats-the-minimum-size-requirement-for-the-cache-folder)

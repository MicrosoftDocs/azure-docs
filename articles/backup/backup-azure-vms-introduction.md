...
1. After Backup takes the snapshot, it transfers the data to the vault.
 ...
 1. Changes made to a VM after Azure Backup is enabled on it are:
    -	Microsoft Visual C++ 2013 Redistributable(x64) - 12.0.40660 is added to Program
    -	Startup type of Volume Shadow Copy service changed to Automatic from Manual
    -	IaaSVmProvider service is added

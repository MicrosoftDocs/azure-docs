...
> [!NOTE]
> This article was originally for use with unmanaged disks. If you use [Azure Managed Disks](../../virtual-machines/windows/managed-disks-overview.md), you don't have to worry about performance or resource utilization issues. Azure optimizes storage utilization for you.
>

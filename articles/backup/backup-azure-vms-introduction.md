...
- To restore VMs with managed disks using PowerShell, provide an additional parameter ***TargetResourceGroupName*** to specify the Resource Group to which managed disks will be restored, [Learn more](https://docs.microsoft.com/azure/backup/backup-azure-vms-automation#restore-managed-disks).

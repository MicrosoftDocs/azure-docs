...
author: jyothisuri
ms.author: jsuri
# Customer intent: "As a system administrator managing Azure Linux VMs, I want to configure application-consistent backups using custom scripts, so that I can ensure my applications remain functional and data integrity is maintained after restoration."
---

...
5. Using Authentication method "Key", enter the storage account key for this storage account. You can find your storage account access keys in the Azure portal. For more information, see [Manage storage account access keys](../storage/common/account-keys-manage.md).

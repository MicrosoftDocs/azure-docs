...
5. Enter the storage account key for this storage account. You can [Storage account access keys](../storage/common/storage-account-manage.md#access-keys) by navigating to your storage account in Azure portal. 

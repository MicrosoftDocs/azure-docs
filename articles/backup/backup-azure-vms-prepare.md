...
- Restoring virtual machines with following special network configurations is supported only through PowerShell. VMs created using restore flow in UI will not have these network configurations post restore. Read more about [Restoring VMs with special network configurations](backup-azure-restore-vms.md#restoring-vms-with-special-netwrok-configurations) 

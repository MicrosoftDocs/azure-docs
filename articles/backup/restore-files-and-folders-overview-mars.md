...
- Ensure that high-speed storage with sufficient space for the [agent cache folder](backup-azure-file-folder-backup-faq.md#manage-the-backup-cache-folder) is available.

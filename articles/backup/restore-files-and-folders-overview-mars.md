...
- Ensure that high-speed storage with sufficient space for the [agent cache folder](backup-azure-file-folder-backup-faq.yml "name: Manage the backup cache folder") is available.

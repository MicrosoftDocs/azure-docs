...
- **Stop Protection and Delete Data**: This option helps you to stop all future backup jobs from protecting your disks and delete all the recovery points. You won't be able to restore the disk or use the **Resume backup** option.

### Stop Protection and Retain Data

1. Go to **Backup center** and select the disk backup instance that you want to delete from the list of backup instances.
...
1. Go to **Backup center** and select the disk from the list of backup instances.

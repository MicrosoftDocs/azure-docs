---
title: List of built-in policy definitions for Azure Backup
description: Lists Azure Policy built-in policy definitions for Azure Backup. These built-ins provide common approaches to managing your Azure resources.
ms.date: 04/30/2020
ms.topic: sample
ms.custom: subject-policy-samples
---
# Azure Policy built-in policy definitions for Azure Backup

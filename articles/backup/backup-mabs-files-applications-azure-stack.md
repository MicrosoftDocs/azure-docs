...
To configure Azure Backup Server to protect Files in Azure Stack VMs, open the Azure Backup Server console. You'll use the console to configure protection groups and to protect the data on your virtual machines.

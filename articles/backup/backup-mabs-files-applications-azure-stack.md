...
author: jyothisuri
ms.author: jsuri
# Customer intent: As an IT administrator managing Azure Stack environments, I want to back up files and applications using Azure Backup Server, so that I can ensure the data's protection and recoverability.
---

...
1. [Restore the VM disk](backup-azure-arm-restore-vms.md#restore-disks).
   >[!NOTE]
   >After restoring the VM disk, swap the OS Disk of the original VM with the restored VM disk without recreating it. [Learn more](https://azure.microsoft.com/en-in/blog/os-disk-swap-managed-disks/).

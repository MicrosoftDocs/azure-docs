...
1. [Restore the VM disk](backup-azure-arm-restore-vms.md#restore-disks).
  + Note: After restoring the VM disk swap the OS Disk of the Original VM with the restored VM disk without having to recreate it again learn more: https://azure.microsoft.com/en-in/blog/os-disk-swap-managed-disks/ +

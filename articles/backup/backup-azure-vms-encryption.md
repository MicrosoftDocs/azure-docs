...
Azure Backup now supports restore of [Azure encrypted VM without AAD](https://docs.microsoft.com/azure/security/azure-security-disk-encryption-prerequisites-aad).<br>

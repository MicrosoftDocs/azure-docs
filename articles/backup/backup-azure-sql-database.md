...
1. Make sure you have a SQL Server instance running in Azure. You can [quickly create a SQL Server instance](../azure-sql/virtual-machines/windows/quickstart-create-sql-vm-portal.md) in the marketplace.

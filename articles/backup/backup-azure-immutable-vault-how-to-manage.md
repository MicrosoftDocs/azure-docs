...
>[!NOTE]
> When you stop backups and retain as per the policy, the last RP is saved to ensure recovery against any ransomware scenarios. Ensure to manually delete this RP after the backup policy expires to stop incurring PI charges.

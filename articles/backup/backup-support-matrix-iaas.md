...
Storage type | Standard HDD, Standard SSD, Premium SSD. <br><br> **Note** <br> Standard SDD with Zone-redundant storage (ZRS) enabled disk isn't currently supported for backup.
...
Dynamic disk with spanned/ striped volumes | Supported

...
**Action** | **Support**
--- | ---
Enable backup when you create a Windows Azure VM | Supported for:  Windows Server 2019 (Datacenter/Datacenter Core/Standard), Windows Server 2016 (Datacenter/Datacenter Core/Standard); Windows Server 2012 R2 (Datacenter/Standard); Windows Server 2008 R2 (RTM and SP1 Standard)

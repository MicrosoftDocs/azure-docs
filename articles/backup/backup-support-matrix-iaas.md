...
For Linux VM backups using the Linux Azure VM agent, Azure Backup supports the list of [Linux distributions endorsed by Azure](../virtual-machines/linux/endorsed-distros.md). Note the following:

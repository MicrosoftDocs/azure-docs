...
1. From the **Recovery Services vaults** blade, click the new vault.
    ...
    When you select the vault, the Recovery Services vault blade narrows, and the **Overview** blade (which has the name of the vault at the top) (*which has the name of the vault at the top*) the vault details blade open.

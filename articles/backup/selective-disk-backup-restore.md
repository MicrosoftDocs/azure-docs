...
>- If you're using selective disk backup with *Enhanced policy* on a Linux VM, ensure that *lsblk* and *lssci* are available in your distribution to exclude the disks are [excluded](selective-disk-backup-restore.md#enhanced-policy). 

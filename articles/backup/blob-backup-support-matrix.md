...
- If a blob to be restored has immutability enabled, it won't be restored to its state as per the selected point-in-time. However, a blob that doesn't have immutability enabled will be restored to the selected point-in-time as expected.

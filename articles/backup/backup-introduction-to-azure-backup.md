...
Backup of VMs on managed disks is no different than back up of Resource manager VMs. You can backup directly from VM view or from Recovery Services vault view. Azure Backup currently doesm't support backup of managed disk VMs encrypted using Azure Disk encryption(ADE).

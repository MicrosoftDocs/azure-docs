...
| **OS versions**            | SLES 12 with SP2, SP3, and SP4; SLES 15 with SP0 and SP1 <br><br>   **Preview** - RHEL 7.4, 7.6, 7.7 and 8.1  <br>     [Get started](./tutorial-backup-sap-hana-db.md) with SAP HANA backup  for RHEL (7.4, 7.6, 7.7 and 8.1), which is now generally available. For further queries write to us at [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com).                |                                             |
...
> [!NOTE]
> You can now [monitor the backup and restore](./sap-hana-db-manage.md#monitor-manual-backup-jobs-in-the-portal) (to the same machine) jobs triggered from HANA native clients (SAP HANA Studio/ Cockpit/ DBA Cockpit) in the Azure portal.

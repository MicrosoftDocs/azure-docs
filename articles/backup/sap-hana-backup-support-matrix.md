...
| **HANA deployments** | HANA System Replication (HSR), including instance snapshot backups <br><br> HANA Scale-out system i.e one HANA system distributed across multiple nodes(PREVIEW)|           |

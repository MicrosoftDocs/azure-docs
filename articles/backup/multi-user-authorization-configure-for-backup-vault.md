---
title: Configure Multi-user authorization using Resource Guard for Backup vault
description: This article explains how to configure Multi-user authorization using Resource Guard for Backup vault.
ms.topic: how-to
ms.date: 09/07/2022
author: v-amallick
ms.service: backup

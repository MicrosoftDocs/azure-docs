...
>[!NOTE]
>Refer to [this document](https://docs.microsoft.com/en-us/azure/backup/backup-rbac-rs-vault#minimum-role-requirements-for-the-azure-file-share-backup) to ensure you have sufficient permissions for performing backup or restore operations.

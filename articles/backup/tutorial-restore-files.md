...
>[!NOTE]
> Check [here](backup-azure-restore-files-from-vm.md#ensure-the-machine-meets-the-requirements-before-executing-the-script) to see if you can run the script on your VM before continuing.

...
To know more details about policy creation, refer to the [PostGreSQL database Backup policy](backup-azure-database-postgresql#create-backup-policy) document.

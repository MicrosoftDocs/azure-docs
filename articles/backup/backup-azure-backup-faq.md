...
- Role-based access control permissions and custom roles will not be transferred. You must recreate the permissions and roles in the new Azure AD.
...
- If the vault uses features which leverage MI, such as [Private Endpoints](private-endpoints.md#before-you-start) and [Customer Managed Keys](encryption-at-rest-with-cmk.md#before-you-start), you must reconfigure the features.

...
Yes, the article, [Usages - List by Vaults](https://docs.microsoft.com/en-us/rest/api/recoveryservices/usages/usages_listbyvaults), lists the information that can be obtained from the Recovery Services vault.

---
title: Tutorial - Create a Resource Guard and enable Multi-user authorization for Azure Backup
description: In this tutorial, learn about how create a resource guard and enable Multi-user authorization on the vaults for Azure Backup.
ms.topic: tutorial
ms.date: 05/05/2022
ms.service: backup
...
---
# Tutorial: Create a Resource Guard and enable Multi-user authorization for Azure Backup

This tutorial describes how to create a Resource Guard and enable Multi-user authorization (MUA) on vaults. This adds an additional layer of protection to critical operations on your vaults.

>[!NOTE]
>- MUA is now Generally Available for both Recovery Services Vaults and Backup Vaults.
>- MUA for Azure Backup is available in all public Azure regions.
...
1. Go to **Properties** on the left navigation panel, then to **Multi-User Authorization** and select **Update**.

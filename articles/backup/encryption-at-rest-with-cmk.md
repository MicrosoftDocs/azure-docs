...
Use the [Update-AzRecoveryServicesVault](https://docs.microsoft.com/powershell/module/az.recoveryservices/update-azrecoveryservicesvault?view=azps-5.3.0) command to enable system-assigned managed identity for the recovery services vault.
...
Use the [Set-AzRecoveryServicesVaultProperty](https://docs.microsoft.com/powershell/module/az.recoveryservices/set-azrecoveryservicesvaultproperty?view=azps-5.3.0) command to enable encryption using customer-managed keys, and to assign or update the encryption key to be used.
...
Use the [Get-AzRecoveryServicesBackupItem](https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesbackupitem?view=azps-5.3.0) command with the parameter [`-DiskEncryptionSetId <string>`] to [specify the DES](https://docs.microsoft.com/powershell/module/az.compute/get-azdiskencryptionset?view=azps-5.3.0) to be used for encrypting the restored disk. For more information about restoring disks from VM backup, see [this article](https://docs.microsoft.com/azure/backup/backup-azure-vms-automation#restore-an-azure-vm).

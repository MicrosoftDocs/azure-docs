...
:::image type="content" source="./media/backup-multiple-user-authentication/testvault-properties-security-settings.png" alt-text="TestVault1 properties-security settings.":::

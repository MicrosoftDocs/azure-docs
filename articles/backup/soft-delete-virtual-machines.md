...
The **DeleteState'**of the backup item changes from `NotDeleted` to `ToBeDeleted`. The backup data will be retained for 14 days. If you wish to revert the delete operation, then undo-delete should be performed.

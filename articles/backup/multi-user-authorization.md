...
The following screenshot shows an example of [disabling soft delete](backup-azure-security-feature-cloud.md?tabs=azure-portal#disabl-soft-delete) for an MUA-enabled vault.

...
-  If you are using a separate Tenant for the Resource Guard. You must register the Microsoft.RecoveryServices resource provider on the subscription you plan to deploy the Resource Guard to. See [Azure resource providers and types](https://docs.microsoft.com/azure/azure-resource-manager/management/resource-providers-and-types#register-resource-provider-1).

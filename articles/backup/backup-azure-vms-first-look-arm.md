...
3. If your VMs have disks larger than 4TB, then [enroll for public preview](https://docs.microsoft.com/azure/backup/quick-backup-vm-powershell#vm-with-disk-sizes-up-to-30tb)

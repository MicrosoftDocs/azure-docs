...
Today, Microsoft Azure Backup server is available for the English locale only. At the same time, Microsoft Azure Backup server is available in all geographies in which Azure is available other than Microsoft Azure Government datacenter and Mooncake.

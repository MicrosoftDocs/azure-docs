...
For information about the UR2 issues fixes and the installation instructions, see the [KB article]().

### Support for Azure Stack HCI

With MABS v3 UR2, you can backup Virtual Machines on Azure Stack HCI. Learn more. <link of Azure Stack HCI doc https://docs.microsoft.com/en-us/azure-stack/hci/ >

### Support for VMware 7.0

With MABS v3 UR2, you can back up VMware 7.0 VMs. Learn more. < https://docs.microsoft.com/en-us/azure/backup/backup-support-matrix-mabs-dpm >
...
MABS v3 UR2 supports optimized volume migration. The optimized Volume-to-Volume Migration allows you to move data sources to the new volume much faster. The enhanced migration process migrates only the active backup copy (Active Replica) to the new volume. All new recovery points are created on the new volume, while existing recovery points are maintained on the existing volume and are purged based on the retention policy. [Learn more](https://support.microsoft.com/en-us/topic/microsoft-azure-backup-server-v3-feb4523f-8da7-da61-2f47-eaa9fca9a3de).

...
author: jyothisuri
ms.author: jsuri
# Customer intent: As a backup administrator, I want to configure multi-user authorization using Resource Guard, so that I can enhance the security of critical operations on my Recovery Services vaults and ensure only authorized users can perform those operations.
---

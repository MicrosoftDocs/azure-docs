...
# PowerShell Script to install the latest MARS agent on on-premises Windows Server in a storage account

This script installs the latest MARS agent on your on-premises Windows server.

...
1. Select the Backup vault to configure backup.
    ...
    :::image type="content" source="./media/quick-backup-aks/backup-vault.png" alt-text="Screenshot showing **Configure backup** homepage." lightbox="./media/quick-backup-aks/backup-vault.png":::
...
1. Select the backup policy, which defines the schedule for backups and their retention period. Then select **Next**.
    :::image type="content" source="./media/quick-backup-aks/backup-policy.png" alt-text="Screenshot showing Backup policy page." lightbox="./media/quick-backup-aks/backup-policy.png":::

1. Select **Add/Edit** to define the Backup Instance configuration.
    
    :::image type="content" source="./media/quick-backup-aks/add-edit.png" alt-text="Screenshot showing the Add/Edit option for configure backup." lightbox="./media/quick-backup-aks/add-edit.png":::
...
1. Select **Snapshot resource group** where the Persistent volumes (Azure Disk) snapshots will be stored. Then select **Validate**.  
    :::image type="content" source="./media/quick-backup-aks/validate-snapshot-group.png" alt-text="Screenshot showing **Snapshot resource group** blade." lightbox="./media/quick-backup-aks/validate-snapshot-group.png":::
...
1. After validation is complete, if appropriate roles aren't assigned to the vault on **Snapshot resource group**, an error appears. See the following screenshot to check the error.
    :::image type="content" source="./media/quick-backup-aks/validation-error-message.png" alt-text="Screenshot showing validation error message." lightbox="./media/quick-backup-aks/validation-error-message.png":::  

1. To resolve the error, select the checkbox next to the **Datasource name** > **Assign missing roles**.
    :::image type="content" source="./media/quick-backup-aks/resolve-validation-error.png" alt-text="Screenshot showing how to resolve validation error." lightbox="./media/quick-backup-aks/validation-error-message.png":::
...
1. Once the configuration is complete, the Backup Instance is created.
    :::image type="content" source="./media/quick-backup-aks/backup-instance-details.png" alt-text="Screenshot showing configured backup for AKS cluster." lightbox="./media/quick-backup-aks/backup-instance-details.png":::

...
- To enable sensitivity labeling in the data map, follow the steps in [Automatically apply sensitivity labels to your data in Microsoft Purview](./how-to-automatically-label-your-content.md).

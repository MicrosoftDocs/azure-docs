...
This tutorial is *part 4 of a six-part tutorial series* in which you learn the fundamentals of how to manage data governance across a data estate using Azure Purview. This tutorial builds on the work you completed in [Part 3: Browse assets in Azure Purview (preview) and view their lineage](starter-kit-tutorial-3.md).
...
* Complete [Tutorial:  Browse assets in Azure Purview (preview) and view their lineage](starter-kit-tutorial-3.md).
...
1. Under **Properties**, note the following two fields:
   ...
   * **schemaCount**: Indicates the number of variations of schema that were found within this resource set.
   ...
   Azure Purview populates these properties within 24 hours after you complete the scan in [part 1 of this tutorial series](starter-kit-tutorial-1.md).

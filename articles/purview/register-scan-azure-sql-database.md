...
> This asset will no longer update the schema if re-name the column name on the source table and rescan the source table after editing the description of the schema tab of Purview.

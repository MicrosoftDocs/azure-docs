...
You can assign Azure Purview roles to users, security groups, and service principals from the Azure Active Directory that is associated with your purview account's subscription.

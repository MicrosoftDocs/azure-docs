...
Azure PurviewAzure PurviewAzure PurviewAzure PurviewAzure Purview
...
> You can use [this Azure CLI command](/cli/azure/purview/account#az_purview_account_add_root_coAzure Purviewn_admin):
>
>   ```azurecli

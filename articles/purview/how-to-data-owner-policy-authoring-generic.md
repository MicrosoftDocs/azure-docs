...
Before authoring data policies in Microsoft Purview governance portal, you'll need to configure the data sources so that they can enforce those policies.

...
|Azure|Non-Azure|
|---------|---------|
|Azure Blob storage|SAP S/4 HANA|
|Azure Cognitive Search|SAP ECC|
|Azure Cosmos DB|Teradata|
|Azure Databricks|SQL Server|
...
### What version of Apache Atlas does Azure Purview support? 

### Is Azure Purview extensible?
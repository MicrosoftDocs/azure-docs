...
Data Producers want to know who will be impacted upon making a change to their dataset. Using lineage, a data producer can easily understand the impact of the downstream internal/external partners who are consuming data using Azure Data Share.
...
In the home page of Purview account, select Browse by asset type and select Azure Data Share tile. You can search for an account name, share name, share snapshot, or partner organization. Otherwise apply filters on the Search result page for account name, share type (Sent vs Received Shares). 

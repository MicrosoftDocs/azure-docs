...
# Connect to and manage Cassandra in Azure Purview

This article outlines how to register Cassandra, as well as how to authenticate and interact with Cassandra in Azure Purview. For more information about Azure Purview, read the [introductory article](overview.md).

...
1. Do a browser refresh. At the bottom of the page, confirm that the Microsoft Purview Governance Status shows `Governed`. Note that it may take up to 15 minutes for the correct status to be reflected.

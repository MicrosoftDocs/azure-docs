...
---
- Get [SQL Server on-premises version 2022](https://www.microsoft.com/en-us/sql-server/sql-server-downloads) running on Windows and install it. For this configuration only versions 2022 or more recent are supported and only Windows based SQL Server. You can try the free Developer edition.

...
2) In addition, the same user needs to have Microsoft Purview Data source administrator role at the **root collection level**. See the guide on [managing Microsoft Purview role assignments](../catalog-permissions.md#assign-permissions-to-your-users).

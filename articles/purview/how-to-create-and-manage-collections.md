...
In order to create and manage collections in the Microsoft Purview Data Map, you'll need to be a **Collection Admin** within the Microsoft Purview governance portal. We can check these permissions in the [Microsoft Purview governance portal](https://web.purview.azure.com/resource/). You can find the governance portal in the overview page of the account in the [Azure portal](https://portal.azure.com) or you can browse directly to [https://web.purview.azure.com](https://web.purview.azure.com) and select your Microsoft Purview account.

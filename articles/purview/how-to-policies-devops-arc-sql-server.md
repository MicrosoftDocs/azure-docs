...
This how-to guide covers how to configure SQL Server 2022 to onboard with Azure Arc, enable Azure AD and provision access to its system metadata (DMVs and DMFs) from Microsoft Purview using DevOps policies actions *SQL Performance Monitoring* or *SQL Security Auditing*. Microsoft Purview access policies apply to Azure AD Accounts only.

...
This how-to guide covers how to provision access from Microsoft Purview to Arc-enabled SQL Server system metadata (DMVs and DMFs) via *Read* actions. Microsoft Purview access policies apply to Azure AD Accounts only.

...
- Review the [Microsoft Purview account best practices](./deployment-best-practices.md#determine-the-number-of-azure-purview-instances) and define the adequate number of Microsoft Purview accounts required in your organization before you plan the collection structure.  

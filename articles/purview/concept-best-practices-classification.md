...
3.	**How to use multiple column patterns?**
    ...
    Refer to [regex alternation construct](https://docs.microsoft.com/en-us/dotnet/standard/base-types/regular-expression-language-quick-reference#alternation-constructs) for more details.

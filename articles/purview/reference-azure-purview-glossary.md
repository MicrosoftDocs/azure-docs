...
## Management Center
An area within Microsoft Purview where you can manage connections, users, roles, and credentials.
...
## Search
A data discovery feature of Microsoft Purview that returns a list of assets that match to a keyword.
## Search relevance

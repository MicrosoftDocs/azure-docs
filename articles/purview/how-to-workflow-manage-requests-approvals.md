...
To view requests and approvals generated by a workflow instance, navigate to management center, and click on ‘Requests and Approvals’. 

You will be presented with three tabs:
    * [Waiting for a response](#waiting-for-a-response) - This tab shows the requests (tasks) and approvals which are waiting for you to act upon. 
    * [Pending requests](#pending-requests) - You can view all the approval requests and tasks you have submitted in this tab. 
    * [History](#history) -  All the completed approvals and tasks are moved to this tab.

## Waiting for a response

This tab shows the requests (tasks) and approvals which are waiting for you to act upon. 

### Approvals

1. To Approve/Reject a request, click on the request and you will be presented with the following blade.
...
1. In case of Updates, you will also to be able to see the current value and proposed value.
1. Choose your response, optionally add comments, and click on ‘Confirm’. 

### Tasks

1. To complete a task, click on the task request and you will be presented with the following blade: 
1. A task has the following statues:
    - Not started – This is the status of the task when it is initially created by a workflow. 
    - In Progress – A task owner can mark the task as ‘In progress’ to indicate that they are currently working on it.
...
## Pending requests
You can view all the approval requests and tasks you have submitted in this tab. 

...
While Microsoft Purview provides an out of the box user experience with Microsoft Purview governance portal, not all tasks are suited to the point-and-click nature of the graphical user experience. 

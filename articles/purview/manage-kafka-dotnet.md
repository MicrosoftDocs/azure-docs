---
title: Send or receive events about metadata changes from Azure Purview's Atlas Kafka topics through Event Hub using .NET 
...
# Send events to and receive events from Azure Purview's Atlas Kafka topics through Event Hubs - .NET (Azure.Messaging.EventHubs) 
...
3. In **Project name**, enter **PurviewKafkaConsumer**.
...
You can get event hub namespace associated with purview account by looking at Altas kafka endpoint primary/secondary connection strings in properties tab of Purview account

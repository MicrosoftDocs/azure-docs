...
Microsoft Purview Data Map provides the foundation for data discovery and effective data governance. Microsoft Purview Data Map is a cloud native PaaS service that captures metadata about your enterprise data whether it is stored on-premises or in the cloud. Microsoft Purview Data Map has a built in automated scanning and classification system that means it is automatically kept up to date. Business users can configure and use the Microsoft Purview Data Map through an intuitive UI and developers can interact programmatically with the Data Map using open-source Apache Atlas 2.0 APIs.
...
## Data Insights
With Microsoft Purview Data Insights, data and security officers can get a bird’s eye view of their data estate, and at a glance understand what data is actively scanned, where sensitive data is located and how that data moves.

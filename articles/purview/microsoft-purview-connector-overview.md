...
||    **SQL Server on Azure-Arc**| No |No | No |Preview: [1.DevOps](how-to-policies-devops-arc-sql-server.md), [2.Data Owner](how-to-policies-data-owner-arc-sql-server.md) | No |

...
||    **SQL Server on Azure-Arc**| No |No | No |[1.DevOps policies](how-to-policies-devops-arc-sql-server.md)(GA) [2.Data Owner](how-to-policies-data-owner-arc-sql-server.md)(preview)| No |

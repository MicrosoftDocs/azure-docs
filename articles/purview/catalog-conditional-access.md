...
- When multi-factor authentication is enabled, to sign in to Microsoft Purview governance portal, you must perform multi-factor authentication.
...
- [Use Microsoft Purview governance portal](./use-purview-studio.md)

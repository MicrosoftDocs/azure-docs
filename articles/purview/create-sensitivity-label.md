...
* **Apply labels to files and database columns:** Labels can be applied to files in storage like Azure Data Lake, Azure Files, etc. and to schematized data like tables and  columns in Azure SQL DB, Cosmos DB, etc.

...
> [!Note]
> Our asset deletion job runs in a separate offline process that executes after a scan completes. So, it can take 6-12 hours before the deleted assets are removed from the catalog. 

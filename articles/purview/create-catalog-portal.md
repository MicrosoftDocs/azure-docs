...
1. You can choose to enable the optional Event Hubs namespace by selecting the toggle. It's disabled by default.
    **Enable this option if you want to be able to programmatically monitor your Microsoft Purview account using Event Hubs and Atlas Kafka**:

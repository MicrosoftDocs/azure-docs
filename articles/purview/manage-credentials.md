...
Navigate to your key vault -> Access policies -> Add Access Policy. **Grant both Get and List permission** in the Secrets permissions dropdown, and Select Principal to be the Purview MSI. 

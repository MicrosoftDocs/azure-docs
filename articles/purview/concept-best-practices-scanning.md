...
- To understand the behavior of subsequent scans after *manually* editing a data asset or an underlying schema through Microsoft Purview governance portal, see [Catalog asset details](./catalog-asset-details.md#scans-on-edited-assets).

...
Allow up to 15 minutes to start receiving logs in the newly created storage account. [See data retention and schema of resource logs in Azure Storage account](../azure-monitor/platform/resource-logs.md#send-to-azure-storagesend-to-azure-storage). Once the diagnostic logs are configured, the events flow to the storage account.

...
1. Open [Microsoft Purview governance portal](https://web.purview.azure.com/resource/), navigate to the **Data Map**, **Sources**, and select **Register**.

   :::image type="content" source="media/manage-data-sources/purview-studio.png" alt-text="Microsoft Purview governance portal":::
...
You can view all registered sources on the **Data Map** tab of Microsoft Purview governance portal. There are two view types: map view and list view.
...
You can group your data sources into collections. To create a new collection, select **+ New collection** on the *Sources* page of Microsoft Purview governance portal. Give the collection a name and select *None* as the Parent. The new collection appears in the map view.
...
:::image type="content" source="media/manage-data-sources/collections.png" alt-text="A hierarchy of collections in Microsoft Purview governance portal":::

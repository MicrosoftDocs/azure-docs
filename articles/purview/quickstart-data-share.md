...
* **Both storage accounts must be in the same Azure region as each other**. And they both either need to be ADLS Gen 2 or Azure Storage accounts.
* Your storage accounts can be in a different Azure region from your Microsoft Purview account.

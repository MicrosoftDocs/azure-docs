...
- [Integrate on-premises management console users with Active Directory](legacy-central-management/install-software-on-premises-management-console.md#integrate-users-with-active-directory)

...
1. Copy the command to a safe location, and continue with installing the sensor. For more information, see [Install sensor software](eiot-sensor.md#install-sensor-software).

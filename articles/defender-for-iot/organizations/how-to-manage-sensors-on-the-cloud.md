...
| **Download SNMP MIB file** | Available from the **Sites and sensors** toolbar **More actions** menu. <br><br>For more information, see [Set up OT sensor health monitoring via SNMP](ot-deploy/activate-deploy-sensor.md#set-up-ot-sensor-health-monitoring-via-snmp).|

...
|:::image type="icon" source="media/how-to-manage-sensors-on-the-cloud/icon-edit.png" border="false"::: **Edit a site owner**     |    OT sensors only.  <br><br> Select the site name to open the **Edit site** blade. Add the email address of the site owner (multiple email addresses can be added), and select **Save** to save your changes. The owner of all devices at this site will be the site owner as defined here. You can connect and run automatic playbooks in Microsoft Sentinel that automatically notify the device owner of important alerts or incidents related to a specific device. You can see the owner of a device in Microsoft Sentinel incidents, and on the IoT device entity page for the specific device. For more information, see [Automate response to Defender for IoT alerts](../../sentinel/iot-solution.md#automate-response-to-defender-for-iot-alerts) |

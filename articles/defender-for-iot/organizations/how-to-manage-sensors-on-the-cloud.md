...
|:::image type="icon" source="media/how-to-manage-sensors-on-the-cloud/icon-edit.png" border="false"::: **Add or edit a site owner**     |    OT sensors only.  <br><br> Select the site name to open the **Edit site** blade. Define the **Owner** of the devices at this site by entering the email address of the point of contact (more than one email address can be added). Select **Save** to save your changes. <br><br> The device owner is defined here at the site level, and inherited to all underlying devices at this site. Once the owner contact details are added here, you can see the device owner in Microsoft Sentinel under incidents and on the **IoT device entity page** of the specific device. [Automatic playbooks](../../sentinel/iot-solution.md#automate-response-to-defender-for-iot-alerts) can be added in Microsoft Sentinel that will notify the device owner of important alerts or incidents.  |

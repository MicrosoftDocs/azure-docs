...
- **Owner**: For sites with OT sensors only. Enter one or more email addresses for the user you want to designate as the owner of the devices at this site. The site owner is inherited by all devices at the site, and is shown on the device entity pages and in incident details in Microsoft Sentinel. <br><br>In Microsoft Sentinel, use the **AD4IoT-SendEmailtoIoTOwner** playbook to automatically notify device owners about important alerts or incidents. For more information, see [Investigate and detect threats for IoT devices](../../sentinel/iot-advanced-threat-monitoring.md).
...
|:::image type="icon" source="media/how-to-manage-sensors-on-the-cloud/icon-edit.png" border="false"::: **Add or edit a site owner**     |    OT sensors only. <br><br>Select the site name to open the **Edit site** pane. In the **Owner** field, enter the email address of the point of contact for the devices at this site. More than one email address can be added. Select **Save** to save your changes. <br><br> The site owner defined here is inherited to all underlying devices at this site. Once the owner is added here, you will be able to see the device owners in Microsoft Sentinel, on the IoT device entity page of specific devices and in incident details. [Automatic playbooks](../../sentinel/iot-advanced-threat-monitoring.md#automate-response-to-defender-for-iot-alerts) can be added in Microsoft Sentinel that will notify the device owner of important alerts or incidents.  |

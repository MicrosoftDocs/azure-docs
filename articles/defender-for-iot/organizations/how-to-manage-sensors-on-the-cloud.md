...
1. Copy the command to a safe location, and continue with installing the sensor. For more information, see [Install the Enterprise IoT monitoring software](tutorial-getting-started-eiot-sensor.md#install-the-enterprise-iot-monitoring-software).

...
### Muting alert traffic (OT sensor only)

Learning an alert isn't supported for alerts generated by the *Anomaly*, *Protocol Violation*, or *Operational* engines. To instruct your sensor to ignore such alerts, sign into your OT sensor and mute the alert instead.

...
> [!TIP]
> Any alerts generated from different sensors in the same zone within a 10-minute timeframe, with the same type, status, protocol, and associated devices, are listed as a single, unified alert.
>

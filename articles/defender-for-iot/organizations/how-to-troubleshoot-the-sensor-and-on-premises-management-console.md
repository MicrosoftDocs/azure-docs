...
1. Sign in to the sensor as the **cyberx** user. For more information, see [Default privileged on-premises users](roles-operational.md#default-privileged-on-premises-users).

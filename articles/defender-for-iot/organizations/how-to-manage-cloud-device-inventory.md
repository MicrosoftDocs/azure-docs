...
:::image type="content" source="media/device-inventory.png" alt-text="A total overview of Defender for IoT's device inventory screen.":::
...
1. Select the Edit columns icon and then select the drop-down menu to change the value of a column.
...
[Investigate all enterprise sensor detections in the device inventory](how-to-investigate-all-enterprise-sensor-detections-in-a-device-inventory.md#investigate-all-enterprise-sensor-detections-in-the-device-inventory)
...
Before you can deploy Defender for IoT on your network you must do the following steps:
...
Perform each step methodologically, requesting the information and reviewing the data you receive. Prepare and configure your site and then validate your configuration.
...
- <a name="networking-requirements"></a>Make sure the required firewall rules are open on the workstation. Verify that your organizational security policy allows access as described in the following tables:

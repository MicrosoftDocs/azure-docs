...
1. In the **Update sensor** pane that appears, a list of all available updates, from your current version to the latest version appears. Select the update version to apply to the sensor. <!-- placeholder for image of the update screen -->

...
Sending or downloading an update package and running the update are two separate steps, which can be done one right after the other or at different times. 

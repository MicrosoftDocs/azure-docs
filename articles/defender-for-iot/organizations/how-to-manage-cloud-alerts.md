...
- On each [OT network sensor console](how-to-view-alerts.md), or a connected [on-premises management console](how-to-work-with-alerts-on-premises-management-console.md)

- Microsoft Sentinel, if you've connected the [Microsoft Defender for IoT data connector](concept-sentinel-integration.md)

If you have an [Enterprise IoT plan](eiot-defender-for-endpoint.md) with Microsoft Defender for Endpoint, alerts for Enterprise IoT devices detected by Microsoft Defender for Endpoint are available in Defender for Endpoint only. For more information, see [Securing IoT devices in the enterprise](concept-enterprise.md) and the [Alerts queue in Microsoft 365 Defender](/microsoft-365/security/defender-endpoint/alerts-queue-endpoint-detection-response).

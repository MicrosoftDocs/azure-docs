...
An OT network sensor starts monitoring your network automatically after it's connected to the network and you've signed in. Network devices start appearing in your device inventory, and [alerts](../alerts.md) are triggered for any security or operational incidents that occur in your network.
...
- An OT sensor [installed, configured, and activated](install-software-ot-sensor.md), with alerts being triggered by detected traffic.

...
- One or more OT sensors [installed](install-software-ot-sensor.md), activated, and configured. To assign your OT sensor to a site and zone, make sure that you have at least one site and zone configured.

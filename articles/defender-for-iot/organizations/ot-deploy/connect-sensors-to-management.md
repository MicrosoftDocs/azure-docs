...
- One or more OT sensors [installed, configured, and activated](install-software-ot-sensor.md). To assign your OT sensor to a site and zone, make sure that you have at least one site and zone configured.

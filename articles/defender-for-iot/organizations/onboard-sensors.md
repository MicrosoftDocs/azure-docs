...
> [!NOTE]
> Sites and zones configured on the Azure portal are not synchronized with [sites and zones configured on an on-premises management console](legacy-on-premises-management/sites-and-zones-on-premises.md).
>

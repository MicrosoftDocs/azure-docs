...
To send the data discovered by Defender for IoT to QRadar, do the following:

1. In Defender for IoT, under **Manage**, select **Forwarding**. 
1. Select *Create new rule*.
1. In the **Add forwarding rule** page, specify a rule name, and select the **Remote support alert handling** option. With this option selected, the following additional fields appear in QRadar:

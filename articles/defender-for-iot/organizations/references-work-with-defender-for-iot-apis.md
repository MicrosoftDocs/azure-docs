...
<!--what about the following - is there a reason they're not documented (this is P2): serial, database, endpoints, address mapping, traffic. nothing was missing in v2-->

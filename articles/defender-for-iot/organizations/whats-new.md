...
> [!NOTE]
> If the [alert was merged with other alerts](alerts.md#alert-management-options) from sensors that detected the same alert, the Azure portal displays the alert ID of the first sensor that generated the alerts. The Azure portal doesn't display the unified alert ID for the alerts generated by the other sensors.

...
:::image type="content" source="media/whats-new/send-package-multiple-versions-500.png" alt-text="screenshot of sensor update pane with option to choose sensor update version" border="false":::

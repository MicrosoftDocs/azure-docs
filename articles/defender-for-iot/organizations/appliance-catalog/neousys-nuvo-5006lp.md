...
> [!NOTE]
> Neousys Nuvo-5006LP is a legacy appliance, and is supported for Defender for IoT software up to the latest patch for versions [22.2.x](../ot-sensor-archive.md#versions-222x). We recommend that you replace these appliances with newer certified models, such as the [YS-FIT2](ys-techsystems-ys-fit2.md) or [HPE DL20 (NHP 2LFF)](hpe-proliant-dl20-plus-smb.md).
...
|**Status** | Supported up to the latest Defender for IoT software patch for versions [22.2.x](../ot-sensor-archive.md#versions-222x)|

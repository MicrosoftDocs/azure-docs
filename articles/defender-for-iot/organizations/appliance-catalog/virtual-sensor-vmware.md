...
For more information, see [Purdue reference model and Defender for IoT](../best-practices/plan-network-monitoring.md#purdue-reference-model-and-defender-for-iot).

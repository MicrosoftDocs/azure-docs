...
| **[View Defender for IoT settings](define-sensor-settings-portal.md)** <br>Apply per subscription | ✔ | ✔ |✔ | ✔ |
| **[Configure Defender for IoT settings](define-sensor-settings-portal.md)** <br>Apply per subscription | - | ✔ |✔ | ✔ |

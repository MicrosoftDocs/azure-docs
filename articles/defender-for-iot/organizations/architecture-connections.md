...
- **Improved security**, without additional security configurations. [Connect to Azure using specific and secure endpoints](how-to-set-up-your-network#sensor-access-to-azure-portal.md), without the need for any wildcards.

...
We recommend that you configure your system to automatically transfer backup files to your own internal network, or an [on-premises management console](legacy-central-management/back-up-sensors-from-management.md).
...
- [Backup OT network sensors from the on-premises management console](legacy-central-management/back-up-sensors-from-management.md)

...
Versions **22.1.7** and **22.2.7** use our newest support model, and are supported for 1 year from their release. For example, version **22.2.7** was released in **October 2022** and is supported through **September 2023**.

...
|**An encapsulated remote switched port analyzer (ERSPAN)**     | Mirrors input interfaces to your OT sensor's monitoring interface | [ERSPAN ports](#erspan-ports) <br><br> [Update a sensor's monitoring interfaces](../how-to-manage-individual-sensors.md#update-a-sensors-monitoring-interfaces). |

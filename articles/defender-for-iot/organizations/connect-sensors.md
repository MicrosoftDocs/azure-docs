...
>
> Make sure to download the new JSON file each week and make the required changes on your site to correctly identify services running in Azure. You'll need the updated IP ranges for **AzureIoTHub**, **Storage**, and **EventHub**. The latest IP ranges can be [found here.](https://www.microsoft.com/en-us/download/details.aspx?id=56519)
>

...
After you've set up your network sensor and have full visibilty into all devices, you can [edit your plan](#update-committed-devices-in-a-subscription) to update the number of committed devices as needed.

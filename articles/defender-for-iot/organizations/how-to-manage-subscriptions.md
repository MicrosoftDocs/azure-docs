...
Your Defender for IoT deployment is managed through your Microsoft Defender for IoT subscriptions. You can onboard, edit, and remove a Defender for IoT plan from your subscriptions in the [Azure portal](https://portal.azure.com/#blade/Microsoft_Azure_IoT_Defender/IoTDefenderDashboard/Getting_Started).
...
1. Make your changes as needed: 
   ...
   - Remove OT or EIoT from the plan by toggling off the one you want to remove
...
## Remove a Defender for IoT plan from a subscription

You may need to remove a Defender for IoT plan from a subscription, for example, if you need to work with a new payment entity. Your changes take effect one hour after confirmation. Your upcoming monthly bill will reflect this change.
...
1.  In the confirmation popup, select **Accept** to confirm you would like to remove the Defender for IoT plan from the subscription.
...
1. [Onboard a new plan to the new subscription you want to use](#onboard-a-defender-for-iot-plan-to-a-subscription) To avoid double billing, onboard the new plan as a [trial](#about-defender-for-iot-trials) until you have removed the sensors from the old subscription. 
...
1. If relevant, [remove the plan](#remove-a-defender-for-iot-plan-from-a-subscription) from the old subscription.

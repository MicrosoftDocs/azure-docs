...
For more information, see [Active Directory support on sensors and on-premises management consoles](../manage-users-overview.md#entra-id-support-on-sensors-and-on-premises-management-consoles).

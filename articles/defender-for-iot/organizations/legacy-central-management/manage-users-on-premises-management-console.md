...
For more information, see [Install OT monitoring software on an on-premises management console](legacy-central-management/install-software-on-premises-management-console.md) and [Default privileged on-premises users](roles-on-premises.md#default-privileged-on-premises-users).
...
**To edit a user**, select the **Edit** :::image type="icon" source="media/legacy-central-management/install-software-on-premises-management-console/icon-edit.png" border="false"::: button for the user you want to edit, and change any values as needed.

**To delete a user**, select the **Delete**  :::image type="icon" source="media/legacy-central-management/install-software-on-premises-management-console/icon-delete.png" border="false"::: button for the user you want to delete.
...
- Carefully set up your business topology. For a rule to be successfully applied, you must assign sensors to zones in the **Site Management** window. For more information, see [Create OT sites and zones on an on-premises management console](legacy-on-premises-management/sites-and-zones-on-premises.md).

...
|---------|---------|---------|---------|
|C5600 (Corporate)    | 3Gbps        | 12K        |Physical / Virtual         |
...
We cannot guarantee functionality of hardware components not certified by our lab.
...
|Column1  |Column2  |
|---------|---------|
|C5600 (Corporate)     |[x]  Intel Xeon Silver 4215 R 3.2 GHz, 11M cache, 8c/16T, 130 W       |
|E1800 (Enterprise)     | [x] Intel Xeon E-2234, 3.6 GHz, 4C/8T, 71 W using Intel C242  [x] Intel Xeon E-2224, 3.4 GHz, 4C, 71 W using Intel C242 [x] Intel Xeon E-2144G 3.6GHz, 8M cache,4C/8T, turbo (71W) with Intel C246|
|L500 (Line) L100 (Line) L60 (Line)|[x]Intel Core i7-8650U (1.9GHz/4-core/15W) using Intel Q170 [x]Intel Core i5-6500TE (6M Cache, up to 3.30 GHz) S1151Intel Atom® x7-E3950 Processor 
         |
...
|  |  |
|---------|---------|
|C5600 (Corporate)     | [x]Intel X710        |
|E1800 (Enterprise)    | [x]Intel I350        |
|L500 (Line)           | [x]Intel I219        |
|L100 (Line)           |[x]Broadcom BCM5720   |
|L60 (Line)            |[x]Broadcom BCM5719   |
...
|  | |
|---------|---------|
|C5600 (Corporate)     |[x] 6 x 1.2-TB SAS 12G Enterprise 10K SFF (2.5 in) in Hot-Plug Hard Drive - RAID 5 with HPE Smart Array P408i-a SR Gen10 Controller [x]3 x 1-TB SATA 6G Midline 7.2 K SFF (2.5 in) – RAID 5 with HPE Smart Array P408i-a SR Controller       |
|E1800 (Enterprise)    | [x]2 x 1-TB SATA 6G Midline 7.2 K SFF (2.5 in) – RAID 1 with HPE Smart Array P208i-a [x]3 X 2TB 7.2K RPM SATA 6Gbps 512n 3.5in Hot-plug Hard Drive - RAID 5 with HPE Smart Array P208i-a  [x]3 X 2TB 7.2K RPM SATA 6Gbps 512n 3.5in Hot-plug Hard Drive - RAID 5 with Dell PERC H330      |
|Row3     |         |

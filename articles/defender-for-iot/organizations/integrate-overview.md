...
| **Aruba ClearPass** (recommended, on-premises) | View Defender for IoT data together with Aruba ClearPass data by configuring your sensor to send syslog files directly to ClearPass.| - OT networks <br>- Air-gapped or cloud managed OT sensors | Microsoft |  [Forward on-premises OT alert information](how-to-forward-alert-information-to-partners.md) |

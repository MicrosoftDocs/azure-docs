---
title: View detected devices in Microsoft Defender for IoT
description: Learn how to view and manage OT and IoT devices (assets) from the Device inventory pages in the Azure portal, sensor console, and on-premises management console.
ms.date: 06/27/2022
ms.topic: how-to
zone_pivot_groups: on-prem-exp-d4iot
---

# View detected devices and assets
...
Each location provides, similar but different options for viewing and managing devices. Select one of the options at the top of this page to view the relevant procedures for you, depending on where you're viewing your network devices.

For more information, see [Devices monitored by Defender for IoT](architecture.md#devices-monitored-by-defender-for-iot).


::: zone pivot="experience-azure"

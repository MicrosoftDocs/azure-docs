...
The retention of backup files depends on the sensor's architecture, as each type of device has a set amount of hard disk space allocated for backup history:

...
4. In **Authentication** section, select the SNMP version.
    ...
    - If you select V3, specify the following:
        ...
        | **Encryption** | Select DES (56 bit key size)<sup>1</sup> or AES (AES 128 bits supported)<sup>2</sup>. |
...
<sup>1</sup> RFC3414 User-based Security Model (USM) for version 3 of the Simple Network Management Protocol (SNMPv3)
<sup>2</sup> RFC3826 The Advanced Encryption Standard (AES) Cipher Algorithm in the SNMP User-based Security Model

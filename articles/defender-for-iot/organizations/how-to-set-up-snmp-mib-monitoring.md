...
- **An OT network sensor** [installed, configured, and activated](ot-deploy/install-software-ot-sensor.md), with access as an **Admin** user. For more information, see [On-premises users and roles for OT monitoring with Defender for IoT](roles-on-premises.md).

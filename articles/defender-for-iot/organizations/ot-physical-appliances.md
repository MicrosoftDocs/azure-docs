...
|Model / bandwidth capacity|Monitoring ports|Max bandwidth|Max protected devices|Mounting|
|:----|:----|:----|:----|:----|
...
|Model / bandwidth capacity| Monitoring ports|Monitored sensors|Mounting|
|:----|:----|:----|:----|
...
|Dimensions   |4 x 3.5" chassis: 4.29 x 43.46 x 70.7 cm /  1.69 x 17.11 x 27.83 in         |
...
The following options are available for enterprise deployments:
...
|---------|---------|
|Chassis     |1U rack server         |
|Dimensions   |4 x 3.5" chassis: 4.29 x 43.46 x 38.22 cm  /  1.70 x 17.11 x 15.05 in         |

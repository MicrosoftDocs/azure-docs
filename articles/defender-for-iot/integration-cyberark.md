...
description: Defender for IoT delivers the only ICS and IIoT cybersecurity platform built by blue-team experts with a track record defending critical national infrastructure, and the only platform with patented ICS-aware threat analytics and machine learning.
author: shhazam-ms
manager: rkarlin
ms.author: shhazam
ms.date: 1/4/2021 
...
:::image type="content" source="media/integration-cyberark/unauthorized.png" alt-text="The Unauthorized Remote Session alert.":::
...
:::image type="content" source="media/integration-cyberark/architecture.png" alt-text="The CyberArk PSM solution deployment":::
...
:::image type="content" source="media/integration-cyberark/toggle.png" alt-text="The server status toggle.":::
...
:::image type="content" source="media/integration-cyberark/toggle.png" alt-text="A view of th Server status.":::

...
> [!NOTE]
> The Microsoft Defender for IoT legacy agent has been replaced by our new micro-agent experience. For more information, see [Create custom alerts](quickstart-create-custom-alerts.md).
>

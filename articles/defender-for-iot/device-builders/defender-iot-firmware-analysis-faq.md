...
## Where can I find the CLI documentation for Defender for IoT Firmware Analysis?
You can find the documentation for our Azure CLI [here](/azure/service-page/firmware%20analysis).

...
Agent installation on your IoT devices isn't mandatory in order to enable Defender for IoT. You can choose between the following four options There are four different levels of security monitoring, and management capabilities which will provide different levels of protection:
...
- **Installation** - Install the Defender for IoT embedded security agent with or without modifications. This option provides the highest level of enhanced security insights into device behavior and access.

- **Custom** - Create your own agent and implement the Defender for IoT security message schema. This option enables usage of Defender for IoT analysis tools on top of your device security agent.

- **Basic** - No security agent installation on your IoT devices. This option enables IoT Hub communication monitoring, with reduced security monitoring, and management capabilities.

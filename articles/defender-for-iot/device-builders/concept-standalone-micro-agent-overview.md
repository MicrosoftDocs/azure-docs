...
description: The Microsoft Defender for IoT security agents allows you to build security directly into your new IoT devices and Azure IoT projects.
ms.date: 1/19/2021
ms.topic: article
---
...
The Microsoft Defender for IoT micro agent includes source code, allowing you to incorporate the micro agent into firmware, or customize it to include only what you need. Micro agent is also available as a binary package, or integrated directly into other Azure IoT solutions. 
...
- **Plug and Play**: There are no specific OS kernel dependencies, or support necessary for all major IoT operating systems. Microsoft Defender for IoT micro agent meets your devices where they are. 

- **Flexible deployment**: As a standalone agent, Microsoft Defender for IoT’s micro agent supports different distribution models and flexible deployment.

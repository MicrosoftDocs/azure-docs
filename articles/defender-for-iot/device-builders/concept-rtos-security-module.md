...
:::image type="content" source="media//sconcept-rtos-security-module/security-module-state-diagram.png" alt-text="Azure IoT Defender-IoT-micro-agent state diagram and information flow":::

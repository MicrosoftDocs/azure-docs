---
title: How to Import Asset Information to the Sensor
description: 
author: shhazam-ms
manager: rkarlin
ms.author: shhazam
...
2. In the right top corner of the **Assets** window, select :::image type="content" source="media/how-to-import-asset-information-to-the-sensor/image124.png" alt-text="file":::.

   :::image type="content" source="media/how-to-import-asset-information-to-the-sensor/image125.png" alt-text="Assets window":::
...
5. From the **Import/Export** drop-down menu in the **Asset** window, select **Import Assets**.
   ...
   :::image type="content" source="media/how-to-import-asset-information-to-the-sensor/image127.png" alt-text="Import Assets":::
...
2. Enter the information as:
   ...
   - **Name:** The authorized asset name. Make sure that names are accurate. Names given to the assets in the imported list overwrite names shown in the asset map.
     ...
     :::image type="content" source="media/how-to-import-asset-information-to-the-sensor/image130.png" alt-text="Asset map":::

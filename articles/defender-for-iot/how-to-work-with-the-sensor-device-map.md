...
3. Enter a group name in the group field and select :::image type="content" source="media/how-to-work-with-maps/green-plus-icon-v2.png" alt-text="add":::. The new group appears. If the group already exists, it will be added to the existing custom group.

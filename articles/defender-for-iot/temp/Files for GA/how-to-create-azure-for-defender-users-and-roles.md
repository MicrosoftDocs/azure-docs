...
:::image type="content" source="media/image96.png" alt-text="Screenshot of on-premises management console view":::
...
2. In the Users window, select :::image type="content" source="media/image97.png" alt-text="Icon of Create User button":::, the **Crate User** pane appears.

:::image type="content" source="media/image98.png" alt-text="Screenshot of Create User view":::
...
4. Select :::image type="content" source="media/image99.png" alt-text="Icon of Create button":::. The new user appears in the list of users in the Users pane.

:::image type="content" source="media/image100.png" alt-text="Screenshot of Manage Users view":::
...
1. Select **Users** on the side menu.
    ...
    :::image type="content" source="media/image271.png" alt-text="Users 1":::
...
3. Select **CCCC**.
    ...
    :::image type="content" source="media/image272.png" alt-text="Users 2":::
...
3. Select **Update** to save the changes.
    ...
    :::image type="content" source="media/image273.png" alt-text="Update":::
...
1. Select the :::image type="content" source="media/image274.png" alt-text="select"::: icon at the top right of any page. 
...
3. The user may edit the following fields:
    ...
    - Change Password
      ...
      :::image type="content" source="media/image275.png" alt-text="Change Password":::
...
1. In the Event Timeline, enable the User Operations option. See Event Timeline for details.
    ...
    :::image type="content" source="media/image276.png" alt-text="view user activity":::

...
:::image type="content" source="media/forescout-device-inventory.png" alt-text="Device inventory":::

:::image type="content" source="media/forescout-device-details.png" alt-text="Device details":::
...
- To access the Defender for IoT user guide from the console, select :::image type="content" source="media/person-icon.png" alt-text="icon"::: and select **Download User Guide**.
...
2. Select **System Settings** and then select **Access Tokens** from the **General** section. The Access Tokens dialog box opens.
   :::image type="content" source="media/generate-access-tokens-screen.png" alt-text="Access tokens":::
...
4. Enter a token description in the **New access token** dialog box.
   :::image type="content" source="media/new-forescout-token.png" alt-text="New access token":::
5. Select **Next.** The token is displayed in the dialog box. :::image type="content" source="media/forescout-access-token-display-screen.png" alt-text="View token":::
   > [!NOTE]
   > *Record the token in a safe place. You will need it when configuring the Forescout Platform*.
6. Select **Finish**.
   :::image type="content" source="media/forescout-access-token-added-successfully.png" alt-text="Finish adding token":::
...
4. In the **Modules** pane, select **Defender for IoT Platform**. The Defender for IoT platform pane opens.
   :::image type="content" source="media/settings-for-module.png" alt-text="Azure Defender for IoT module settings":::
...
:::image type="content" source="media/forescout-access-token-added-successfully.png" alt-text="Verify token was received":::
...
:::image type="content" source="media/device-firmware-attributes-in-forescout.png" alt-text="View firmware attributes":::

:::image type="content" source="media/vendor-attributes-in-forescout.png" alt-text="View vendor attributes":::
...
1. Right-click on a device from the device inventory hosts section. The host details dialog box opens with additional information.
   :::image type="content" source="media/details-dialog-box-in-forescout.png" alt-text="Host Details":::
...
:::image type="content" source="media/forescout-property-tree.png" alt-text="Properties":::

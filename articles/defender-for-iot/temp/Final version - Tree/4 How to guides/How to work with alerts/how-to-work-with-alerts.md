...
:::image type="content" source="media/image159.png" alt-text="Address Scan Detected":::
...
:::image type="content" source="media/image160.png" alt-text="Alerts":::
...
:::image type="content" source="media/image161.png" alt-text="Learning":::
...
:::image type="content" source="media/image162.png" alt-text="Alerts Learning":::
...
:::image type="content" source="media/image163.png" alt-text="Security":::
...
:::image type="content" source="media/image164.png" alt-text="Unauthorized":::
...
:::image type="content" source="media/image165.png" alt-text="RPC Operation Failed":::
...
:::image type="content" source="media/image166.png" alt-text="Assets":::
...
:::image type="content" source="media/image167.png" alt-text="Suspicion":::
...
To download a PCAP file, select :::image type="content" source="media/image168.png" alt-text="download"::: at the upper right of the Alert details dialog box.

:::image type="content" source="media/image169.png" alt-text="Device is Suspected":::

:::image type="content" source="media/image170.png" alt-text="CyberX XSense":::
...
:::image type="content" source="media/image171.png" alt-text="Address Scan Detected":::
...
:::image type="content" source="media/image172.png" alt-text="Slave Device Received":::
...
:::image type="content" source="media/image173.png" alt-text="Illegal HTTP Header Content":::
...
**Once muted:**
  ...
  - The Mute action will be displayed in the Event Timeline.
    ...
    :::image type="content" source="media/image174.png" alt-text="Event Detected and Muted":::
...
1. Select the mute icon on the alert.
    ...
    :::image type="content" source="media/image175.png" alt-text="RPC operation failed":::
...
2. Hover over an alert to see if it muted
    ...
    :::image type="content" source="media/image176.png" alt-text="Alerts":::

## Generate a PDF for an alert event

You can generate a PDF report with alert event information.

:::image type="content" source="media/image177.png" alt-text="Alert Report":::

**To generate a PDF:**

1. Select the PDF icon from the alert.

   :::image type="content" source="media/image178.png" alt-text="MODBUS Device":::

### Alert window options

Alert messages provide the following actions:

  - Select :::image type="content" source="media/image179.png" alt-text="tick":::to acknowledge an alert

  - Select :::image type="content" source="media/image180.png" alt-text="Tick":::to unacknowledge an alert

  - Select :::image type="content" source="media/image181.png" alt-text="pin"::: to pin an alert

  - Select :::image type="content" source="media/image182.png" alt-text="unpin":::to unpin an alert

  - Select :::image type="content" source="media/image183.png" alt-text="acknowledge"::: to acknowledge all alerts

  - Select :::image type="content" source="media/image184.png" alt-text="learn"::: to learn and acknowledge all the alerts

  - Select :::image type="content" source="media/image185.png" alt-text="CSV"::: to export the alert list to a CSV file and select the export option. Choose Alert Export for the regular export to CSV option or Extended Alert Export for the possibility to add a separate row for each additional info about an alert in the alert export CSV file.

  - Select the :::image type="content" source="media/image36.png" alt-text="PDF"::: icon to download an alert report as a PDF file.

  - Select the :::image type="content" source="https://www.wireshark.org/" alt-text="download](media/image38.png) icon to download the PCAP file, viewable with [<span class="underline">Wireshark</span>":::, the free network protocol analyzer.

  - Select :::image type="content" source="https://www.wireshark.org/" alt-text="packets](media/image39.png) to download a filtered PCAP file that contains only the alert-relevant packets, thereby reducing output file size and allowing a more focused analysis. You can view it using <span class="underline">[Wireshark":::.</span>

  - Select the :::image type="content" source="media/image186.png" alt-text="Event"::: icon to show the Alert in the Event Timeline.

  - Select the :::image type="content" source="media/image181.png" alt-text="Pin"::: icon to pin the alert.

  - Select the :::image type="content" source="media/image182.png" alt-text="Unpin":::icon to unpin the alert.

  - Select the :::image type="content" source="media/image42.png) icon to approve the traffic (Security Analysts and Administrators only" alt-text="Learn":::.

  - Select the :::image type="content" source="media/image187.png" alt-text="Close":::icon to close the alert details window.
...
:::image type="content" source="media/image167.png" alt-text="Malicious Activity":::
...
:::image type="content" source="media/image188.png" alt-text="Alert Comments":::
...
:::image type="content" source="media/image189.png" alt-text="Create Forwarding Rule":::
...
:::image type="content" source="media/image190.png" alt-text="TimeGenerated UTC":::
...
:::image type="content" source="media/image191.png" alt-text="Alert information":::
...
1. Select **Forwarding** on the side menu.
   ...
   :::image type="content" source="media/image192.png" alt-text="Forwarding":::

2. Select **Create Forwarding Rule.**

   :::image type="content" source="media/image193.png" alt-text="Create forwarding rule":::
...
:::image type="content" source="media/image194.png" alt-text="Create Forwarding Rule":::
...
:::image type="content" source="media/image195.png" alt-text="Configure Encruption":::

**SYSLOG Text Message Output**

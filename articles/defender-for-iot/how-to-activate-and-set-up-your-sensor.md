...
The approximate period of time learning mode needs is between 2 to 6 weeks, depending on your network size and its complexity. After you disable learning mode, alerts will be triggered by any activity that differs from your baseline activity. For more information, see [Enable or disable sensors](how-to-manage-sensors-from-the-on-premises-management-console.md#enable-or-disable-sensors) about learning mode. For example, learn about working in the learning mode in environments with IT devices.

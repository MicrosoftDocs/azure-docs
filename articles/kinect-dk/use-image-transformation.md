...
## k4a_transformation functions
 ...
 All functions prefixed with *k4a_transformation* operate on whole images. They require the transformation handle [k4a_transformation_t](~/api/k4a-transformation-t.md) obtained via [k4a_transformation_create()](~/api/k4a-transformation-create.md) and are unallocated via [k4a_transformation_destroy()](~/api/k4a-transformation-destroy.md). You can also refer to the SDK [Transformation Example](https://github.com/Microsoft/Azure-Kinect-Sensor-SDK/tree/develop/examples/transformation) which demonstrates how to use the 3 functions in this topic.

---
title: k4a_calibration_camera_t structure
...
---
# k4a_calibration_camera_t structure
...
[`k4a_calibration_extrinsics_t`](~/api/current/k4a-calibration-extrinsics-t.md) `extrinsics`

extrinsic calibration data 

[`k4a_calibration_intrinsics_t`](~/api/current/k4a-calibration-intrinsics-t.md) `intrinsics`

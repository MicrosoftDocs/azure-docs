---
title: k4a_calibration_3d_to_3d function
...
---
# k4a_calibration_3d_to_3d function
...
[`const k4a_calibration_t *`](~/api/current/k4a-calibration-t.md) `calibration`

Location to read the camera calibration obtained by k4a_transformation_get_calibration().

[`const k4a_float3_t *`](~/api/current/k4a-float3-t.md) `source_point3d`

The 3d coordinates in millimeters representing a point in 
`source_camera`

[`const k4a_calibration_type_t`](~/api/current/k4a-calibration-type-t.md) `source_camera`

The current camera

[`const k4a_calibration_type_t`](~/api/current/k4a-calibration-type-t.md) `target_camera`

The target camera

[`k4a_float3_t *`](~/api/current/k4a-float3-t.md) `target_point3d`

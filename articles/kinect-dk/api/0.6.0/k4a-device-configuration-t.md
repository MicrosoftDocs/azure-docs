...
[`k4a_image_format_t`](~/api/0.6.0/k4a-image-format-t.md) `color_format`
...
[`k4a_fps_t`](~/api/0.6.0/k4a-fps-t.md) `camera_fps`
...
[`k4a_wired_sync_mode_t`](~/api/0.6.0/k4a-wired-sync-mode-t.md) `wired_sync_mode`

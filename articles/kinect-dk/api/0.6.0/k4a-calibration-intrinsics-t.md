...
typedef struct {
    ...
    k4a_intrinsic_parameters_t parameters;
...
[`k4a_calibration_model_type_t`](~/api/0.6.0/k4a-calibration-model-type-t.md) `type`
...
[`k4a_intrinsic_parameters_t`](~/api/0.6.0/k4a-intrinsic-parameters-t.md) `parameters`

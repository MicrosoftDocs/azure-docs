---
title: k4a_calibration_2d_to_3d function
...
---
# k4a_calibration_2d_to_3d function
...
[`k4a_float3_t *`](~/api/0.6.0/k4a-float3-t.md) `target_point3d`
...
`target_camera`
 using k4a_transformation_3d_to_3d(). In practice, 
`source_camera`
 and 
`target_camera`

---
title: k4a_capture_get_image_iso_speed function
description: Get the ISO speed of the capture. 
author: brenta
ms.author: brenta
ms.date: 01/18/2019
ms.topic: article
...
---
# k4a_capture_get_image_iso_speed function

Get the ISO speed of the capture. 

## Syntax

```C
uint32_t k4a_capture_get_image_iso_speed(
...
ISO speed applied to capture, 0 if image format is not supported by the given capture.

...
[K4A_WIRED_SYNC_MODE_STANDALONE](~/api/0.5.2/k4a-wired-sync-mode-t.md)
 or 
[K4A_WIRED_SYNC_MODE_MASTER](~/api/0.5.2/k4a-wired-sync-mode-t.md)
. If sync_in_jack_connected is true then 
[k4a_device_configuration_t](~/api/0.5.2/k4a-device-configuration-t.md)
 wired_sync_mode mode can be set to 
[K4A_WIRED_SYNC_MODE_STANDALONE](~/api/0.5.2/k4a-wired-sync-mode-t.md)
 or 
[K4A_WIRED_SYNC_MODE_SUBORDINATE](~/api/0.5.2/k4a-wired-sync-mode-t.md)
.

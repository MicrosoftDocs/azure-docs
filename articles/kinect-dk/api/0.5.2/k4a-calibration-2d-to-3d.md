...
[`const k4a_calibration_t *`](~/api/0.5.2/k4a-calibration-t.md) `calibration`

Location to read the camera calibration obtained by k4a_transformation_get_calibration().

[`const k4a_float2_t *`](~/api/0.5.2/k4a-float2-t.md) `source_point2d`
...
[`const k4a_calibration_type_t`](~/api/0.5.2/k4a-calibration-type-t.md) `source_camera`

The current camera

[`const k4a_calibration_type_t`](~/api/0.5.2/k4a-calibration-type-t.md) `target_camera`

The target camera

[`k4a_float3_t *`](~/api/0.5.2/k4a-float3-t.md) `target_point3d`

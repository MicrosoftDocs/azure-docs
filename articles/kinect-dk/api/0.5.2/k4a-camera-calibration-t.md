...
[`k4a_calibration_extrinsics_t`](~/api/0.5.2/k4a-calibration-extrinsics-t.md) `extrinsics`

extrinsic calibration data 

[`k4a_calibration_intrinsics_t`](~/api/0.5.2/k4a-calibration-intrinsics-t.md) `intrinsics`

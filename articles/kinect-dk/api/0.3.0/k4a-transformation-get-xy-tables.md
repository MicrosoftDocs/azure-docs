...
[`const k4a_calibration_type_t`](~/api/0.3.0/k4a-calibration-type-t.md) `camera`
...
[`k4a_transformation_xy_tables_t *`](~/api/0.3.0/k4a-transformation-xy-tables-t.md) `xy_tables`

...
[`k4a_calibration_extrinsics_t`](~/api/0.2.0/k4a-calibration-extrinsics-t.md) `extrinsics`

extrinsic calibration data 

[`k4a_calibration_intrinsics_t`](~/api/0.2.0/k4a-calibration-intrinsics-t.md) `intrinsics`
...
|  Title | Description |
|--------|-------------|
| [k4a_device_get_raw_calibration](~/api/0.2.0/k4a-device-get-raw-calibration.md) | Get the raw calibration blob for the entire K4A device.  |

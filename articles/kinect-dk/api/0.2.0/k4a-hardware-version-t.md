...
[`k4a_version_t`](~/api/0.2.0/k4a-version-t.md) `rgb`

RGB version. 

[`k4a_version_t`](~/api/0.2.0/k4a-version-t.md) `depth`

Depth version. 

[`k4a_version_t`](~/api/0.2.0/k4a-version-t.md) `audio`

Audio version. 

[`k4a_version_t`](~/api/0.2.0/k4a-version-t.md) `depth_sensor`

Depth Sensor. 

[`k4a_firmware_build_t`](~/api/0.2.0/k4a-firmware-build-t.md) `firmware_build`

Firmware reported hardware build. 

[`k4a_firmware_signature_t`](~/api/0.2.0/k4a-firmware-signature-t.md) `firmware_signature`

---
title: k4a_device_get_color_control function
description: Get the K4A color sensor control value. 
author: brenta
ms.author: brenta
ms.date: 01/18/2019
ms.topic: article
...
---
# k4a_device_get_color_control function
...
```C
k4a_result_t k4a_device_get_color_control(
...
[`k4a_color_control_command_t`](~/api/0.2.0/k4a-color-control-command-t.md) `command`

Color sensor control command

[`k4a_color_control_mode_t *`](~/api/0.2.0/k4a-color-control-mode-t.md) `mode`

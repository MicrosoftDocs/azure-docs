...
![Dns-nameserver](../media/dns-domain-delegation/dns-domain-delegation-nameserver.png)
...
The following PowerShell example demonstrates.
...
Next, we retrieve the authoritative NS records from child zone:
	...
	Finally, we create corresponding NS records in the parent zone to complete the delegation:
	PS C:\> $parent_ns_recordset = New-AzureDnsRecordSet -Zone $parent -Name "partners" -RecordType NS -Ttl 300

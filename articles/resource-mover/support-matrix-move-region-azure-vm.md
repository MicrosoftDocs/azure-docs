...
Ubuntu 20.04 LTS Server | Includes support for all 20.04.*x* versions. [Supported kernel versions](https://learn.microsoft.com/azure/site-recovery/azure-to-azure-support-matrix#supported-ubuntu-kernel-versions-for-azure-vms).
Ubuntu 22.04 LTS Server | Includes support for all 22.04.*x* versions. [Supported kernel versions](https://learn.microsoft.com/azure/site-recovery/azure-to-azure-support-matrix#supported-ubuntu-kernel-versions-for-azure-vms).
Ubuntu 24.04 LTS Server | Includes support for all 24.04.*x* versions. [Supported kernel versions](https://learn.microsoft.com/azure/site-recovery/azure-to-azure-support-matrix#supported-ubuntu-kernel-versions-for-azure-vms).

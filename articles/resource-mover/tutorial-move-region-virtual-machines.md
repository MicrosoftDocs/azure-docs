...
1. Dependencies are validated at the background when you add the resources. If  you still see the **Validate dependencies** button, select it to trigger the validation manually.
...
4. Dependencies are validated at the background once you add them. If you see a **Validate dependencies** button, select it to trigger the manual validation. 

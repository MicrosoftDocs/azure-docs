...
1. Dependencies are validated in the background when you add the resources. If you still see the **validate dependencies** button, select it to trigger the validation manually.
...
4. Dependencies are validated in the background once you add the dependencies. If you see a **Validate dependencies** button, select it to trigger the manual validation.. 

...
For specific code samples, see the "Create an environment" section of [How to use environments](v1/how-to-use-environments.md#create-an-environment). 
...
For code samples, see the "Manage environments" section of [How to use environments](v1/how-to-use-environments.md#manage-environments).

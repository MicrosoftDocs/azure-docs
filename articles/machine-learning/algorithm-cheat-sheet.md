...
To learn more about the algorithms in Azure Machine Learning designer, go to the [Algorithm and component reference](algorithm-module-reference/component-reference.md).

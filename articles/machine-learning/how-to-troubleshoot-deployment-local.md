...
* To debug locally, you can deploy model to [Azure Machine Learning Compute Instance](./how-to-deploy-local-container-notebook-vm.md) or have a working Docker installation on your local system.

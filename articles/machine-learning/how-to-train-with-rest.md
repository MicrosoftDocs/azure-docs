...
:::code language="rest" source="~/azureml-examples-cli-preview/cli/train-rest.sh" id="create_environment":::
...
:::code language="rest" source="~/azureml-examples-cli-preview/cli/train-rest.sh" id="create_data":::
...
:::code language="rest" source="~/azureml-examples-cli-preview/cli/train-rest.sh" id="create_code":::
...
:::code language="rest" source="~/azureml-examples-cli-preview/cli/train-rest.sh" id="create_job":::
...
:::code language="rest" source="~/azureml-examples-cli-preview/cli/train-rest.sh" id="create_a_sweep_job":::

...
ms.custom: devx-track-python, automl, references_regions, sdkv1
---
...
+ Learn more about [how to train a regression model with Automated machine learning](tutorial-auto-train-models.md) or [how to train using Automated machine learning on a remote resource](./v1/concept-automated-ml.md#local-remote).

...
- (Optional) To create resources using the extension, you need to install the 2.0 CLI. For setup instructions, see [Install, set up, and use the 2.0 CLI](how-to-configure-cli.md).

...
These environment are already set for you when the Web service is running on a cluster in Azure. When running locally you have to set them yourself. If you are using Docker, use the -e parameter of docker run command to pass environment variables.

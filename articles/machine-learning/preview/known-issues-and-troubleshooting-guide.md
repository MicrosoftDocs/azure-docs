...
This issue will be addressed in the Sprint 2 update. In the meantime, the workaround is to avoid launching the app from the shortcut pinned to the Taskbar. Instead to launch the app by using the Start menu or Start search-bar, or the shortcut on your desktop (if you have one). 
...
Perform the following steps to download the latest application :   
   ...
   - clean install using https://aka.ms/azureml-wb-msi 

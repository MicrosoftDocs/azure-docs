...
# AzureML Reinforcement Learning imports
...
worker_conf = WorkerConfiguration(
    ...
    # AzureML compute cluster to run Ray workers
...
rl_estimator = ReinforcementLearningEstimator(
    ...
    # The AzureML compute target set up for Ray head nodes

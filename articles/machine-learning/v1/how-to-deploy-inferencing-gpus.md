...
> [!IMPORTANT]
> When using the AzureML __SDK v1__, GPU inference is only supported on Azure Kubernetes Service. When using the AzureML __SDK v2__ or __CLI v2__, you can use an online endpoint for GPU inference. For more information, see [Deploy and score a machine learning model with an online endpoint](../how-to-deploy-online-endpoints.md).
...
dependencies:
  ...
  # Currently AzureML only supports 3.5.2 and later.
- python=3.7

...
3. To use that dataset in your machine learning experiment you can either
    ...
    * Consume it directly in Azure Machine Learning solutions like, automated machine learning (automated ML) experiment runs, machine learning pipelines, or the [Azure Machine Learning designer](../concept-designer-v1.md).

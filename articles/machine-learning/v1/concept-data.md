...
:::image type="content" source="./media/concept-data/data-concept-diagram.svg" alt-text="Screenshot showing the Azure Storage Service, which flows into a datastore and then into a dataset":::

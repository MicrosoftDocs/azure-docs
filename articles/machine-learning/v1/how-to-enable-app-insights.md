...
To log custom traces, follow the standard deployment process for AKS or ACI in the [How to deploy and where](how-to-deploy-managed-online-endpoints.md) document. Then, use the following steps:
...
3. Build an image and deploy it on AKS or ACI. For more information, see [How to deploy and where](how-to-deploy-managed-online-endpoints.md).

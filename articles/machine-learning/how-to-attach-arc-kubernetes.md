...
| Configuration Setting Key Name  | Description  | Training | Inference | Training and Inference |
   ...
   |```reuseExistingPromOp```|True or False, default False. AzureML extension needs prometheus operator to manage prometheus. Set to True to reuse existing promethues operator. | Optional| Optional |  Optional |

...
description: Learn to set up a development environment in Azure Machine Learning and Azure Databricks. Use the AzureML SDKs for Databricks and Databricks with AutoML.
...
+ With [automated machine learning](concept-automated-ml.md) capabilities using an AzureML SDK.
...
## Add the AzureML SDK to Databricks
...
To use automated ML, skip to [Add the AzureML SDK with AutoML](#add-the-azure-ml-sdk-with-automl-to-databricks).
...
## Add the AzureML SDK with AutoML to Databricks

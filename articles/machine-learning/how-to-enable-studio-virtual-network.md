...
This step is only required if you added the Azure storage account to your virtual network with a [private endpoint](how-to-secure-workspace-vnet.md#secure-azure-storage-accounts-with-private-endpoints). For information, see the [Reader](../role-based-access-control/built-in-roles.md#reader) built-in role.

...
Let's create a simple first R script to experiment with in Azure Machine Learning Studio @Classic@. I have created and tested the following script in RStudio.  

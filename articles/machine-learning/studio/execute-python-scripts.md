...
It's possible to return multiple figures by saving them into different images. The Studio @Classic@ runtime picks up all images and concatenates them for visualization.

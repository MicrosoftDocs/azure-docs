...
description: Syntax guide for the Net# neural networks specification language. Learn how to create custom neural network models using Net# with Azure Machine Learning Studio.

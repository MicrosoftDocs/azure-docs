...
description: Manage access to Azure Machine Learning Studio workspaces, and deploy and manage Machine Learning API web services
...
2. In the search box at the top of the page, enter "machine learning Studio workspaces" and then select **Machine Learning Studio workspaces**.
...
To manage the web services associated with this Studio workspace, use the Machine Learning Web Services portal. See [Manage a Web service using the Azure Machine Learning Web Services portal](manage-new-webservice.md) for complete information.

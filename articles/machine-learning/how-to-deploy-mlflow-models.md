...
> [!NOTE]
> - <sup>1</sup> Deployment to online endpoints in private link-enabled workspaces requires [packaging models before deployment (preview)](how-to-package-models.md#package-a-model-before-deployment).

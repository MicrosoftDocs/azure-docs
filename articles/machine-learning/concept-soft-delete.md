...
> [!IMPORTANT]    
> Workspace soft delete is currently in public preview and will start roll region roll out for general availability from June 9th 2023. The preview is provided without a service level agreement, and it's not recommended for production workloads. Certain features might not be supported or might have constrained capabilities.     

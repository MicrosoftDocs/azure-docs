...
> [AZURE.TIP] To make changes to the experiment you published, go back to the experiment in Machine Learning Studio, make changes, and publish it again. Your existing published experiment will be updated (this won't create a new experiment).

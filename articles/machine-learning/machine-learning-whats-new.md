...
* Web services are now managed as Azure resources managed through [Azure Resource Manager](../resource-group-overview.md) (ARM) interfaces, allowing for the following enhancements:

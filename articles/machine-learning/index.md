...
|   |   |
| - | - |
| [![](./media/index/machine-learning-workbench.png)<br>**Azure Machine Learning preview features**](preview/index.yml?toc=/azure/machine-learning/preview/toc.json)| *(currently in public preview)*<br>An integrated, end-to-end data science solution for professional data scientists working in Python and the Azure Command-Line Interface.<p>The preview features include five components:<br><ul><li>[**Workbench**](preview/preview-features-workbench.md?toc=/azure/machine-learning/preview/toc.json)</li><li>[**Experimentation Service**](preview/preview-features-experimentation.md?toc=/azure/machine-learning/preview/toc.json)</li><li>[**Model Management Service**](preview/preview-features-model-management.md?toc=/azure/machine-learning/preview/toc.json)</li><li>[**MMLSpark Library**](preview/preview-features-mmlspark.md?toc=/azure/machine-learning/preview/toc.json)</li><li>[**OpenMind**](preview/preview-features-openmind.md?toc=/azure/machine-learning/preview/toc.json)</li></ul> |

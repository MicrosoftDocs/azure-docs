...
|  |  |
|:--:|:--:|
| [![](./media/index/machine-learning-workbench.png)<br>**Azure Machine Learning<br>for Professionals**](professional/what-is-ml-workbench.md?toc=%2fazure%2fmachine-learning%2fprofessional%2ftoc.json) <br>An integrated, end-to-end data science solution for professional data scientists working in Python and the Azure Command-Line Interface. | [![](./media/index/machine-learning-studio.png)<br>**Azure Machine Learning<br>for Beginners**](beginner/what-is-ml-studio.md?toc=%2fazure%2fmachine-learning%2fbeginner%2ftoc.json) <br>A collaborative, drag-and-drop tool that provides predefined machine learning algorithms and push-button model deployment. |
| | |

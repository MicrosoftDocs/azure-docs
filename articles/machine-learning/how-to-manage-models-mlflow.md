...
> [!IMPORTANT]
> Stages can only be accessed using the MLflow SDK. They don't show up in the [AzureML Studio portal](https://ml.azure.com) and can't be retrieved using neither AzureML SDK, AzureML CLI, or AzureML REST API. Creating deployment from a given model's stage is not supported by the moment.
...
| Feature | MLflow | AzureML with MLflow | AzureML CLIv2 | AzureML Studio |
| :- | :-: | :-: | :-: | :-: |
...
> - <sup>4</sup> Use search box in AzureML Studio. Partial match supported.

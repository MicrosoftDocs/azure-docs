...
> [!NOTE]
> To use Azure Kubernetes Service cluster for training, see [Set up compute targets for model training and deployment](how-to-attach-compute-targets.md#aks).

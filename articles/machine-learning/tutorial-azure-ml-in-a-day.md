...
1. Open or create a notebook in your workspace:
    ...
    * Or, open **tutorials/get-started-notebooks/quickstart.ipynb** from the **Samples** section of studio.  Then select **Clone** to add the notebook to your **Files**. [!INCLUDE [find samples](includes/prereq-find-samples.md)]

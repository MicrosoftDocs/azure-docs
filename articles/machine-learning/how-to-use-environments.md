...
runconfig = ScriptRunConfig(source_directory=".", script="example.py", compute_target="local")
...
runconfig = ScriptRunConfig(source_directory=".", script="train.py", target="local", environment=myenv)

...
1. Give the pipeline a meaningful name by clicking the pencil icon besides the autogenerated name. 
...
1. In asset library, you can see **Data**, **Model** and **Components** tabs. Switch to **Components** tab, you can see the components registered from previous section. If there are too many components, you can search with the component name.
...
1. Double click one component, you'll see a right pane where you can configure the component.
...
In *Inputs & Outputs* step, you can configure the Inputs/Outputs that are promoted to pipeline level. In previous step, we promoted the *max_epocs* of *train* component to pipeline input, so you should be able to see and edit *max_epocs* here.

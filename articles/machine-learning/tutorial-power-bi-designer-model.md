...
* [Option C: Train and deploy models by using automated ML](tutorial-power-bi-automated-model.md). This no-code authoring experience fully automates data preparation and model training.

...
* Python - [Microsoft Authentication Library to MSAL migration guide for Python](/entra/msal/python/advanced/active-directory/develop/migrate-python-adal-msal).

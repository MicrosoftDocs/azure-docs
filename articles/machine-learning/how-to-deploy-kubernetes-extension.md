...
- Azure Machine Learning does not support attaching an AKS cluster corss subscription. If you have an AKS cluster in a different subscription, you must first [connect it to Azure-Arc](../azure-arc/kubernetes/quickstart-connect-cluster.md)) and specify in the same subscription as your Azure Machine Learning workspace.

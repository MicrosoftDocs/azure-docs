...
1. Select **Outputs+logs** tab and you can explore all the outputs and logs of this node.
    ...
    ![Screenshot showing user logs of a node](./media/new-pipeline-ui/view-user-log.png)
    ...
    ![Screenshot showing driver logs of a node](./media/new-pipeline-ui/view-driver-logs.png)

...
Currently, only a maximum of 10 workspaces can be designated for a particular subscription. If a user creates an 11th workspace, they will get access to the models but their jobs will fail. If you are receiving failed jobs, ensure you are not working on an 11th workspace. 

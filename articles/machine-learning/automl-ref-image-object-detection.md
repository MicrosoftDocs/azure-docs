...
| `box_detections_per_img` | integer | Maximum number of detections per image, for all classes. <br> <br> *Note: This setting isno't supported for the 'yolov5' algorithm.* | | 100 |

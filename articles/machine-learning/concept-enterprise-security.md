...
The `hbi_workspace` flag controls the amount of [data Microsoft collects for diagnostic purposes](#microsoft-collected-data) and enables additional encryption in Microsoft-managed environments. In addition, it enables the following actions:

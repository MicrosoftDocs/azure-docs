...
For a sweep job, you can specify a search space for literal inputs to be chosen from. For the full range of options for search space inputs, see the [search space YAML syntax reference documentation](TODO).

...
:::code language="yaml" source="~/azureml-examples/cli/jobs/hello-world.yml":::
...
:::code language="yaml" source="~/azureml-examples/cli/jobs/train/lightgbm/iris/job.yml":::
...
:::code language="azurecli" source="~/azureml-examples/cli/how-to-train-cli.sh" id="lightgbm_iris_local":::
...
:::code language="azurecli" source="~/azureml-examples/cli/setup.sh" id="create_computes":::
...
:::code language="azurecli" source="~/azureml-examples/cli/how-to-train-cli.sh" id="lightgbm_iris":::

Once the job is complete, you can download the outputs:

:::code language="azurecli" source="~/azureml-examples/cli/how-to-train-cli.sh" id="download_outputs":::
...
:::code language="yaml" source="~/azureml-examples/cli/jobs/train/lightgbm/iris/job-sweep.yml":::
...
:::code language="azurecli" source="~/azureml-examples/cli/how-to-train-cli.sh" id="lightgbm_iris_sweep":::
...
:::code language="yaml" source="~/azureml-examples/cli/jobs/train/pytorch/cifar-distributed/job.yml":::
...
:::code language="bash" source="~/azureml-examples/cli/how-to-train-cli.sh" id="download_cifar":::

Create the job and open in the studio:

:::code language="azurecli" source="~/azureml-examples/cli/how-to-train-cli.sh" id="pytorch_cifar":::

### TensorFlow

An example YAML file for distributed TensorFlow training on the MNIST dataset:

:::code language="yaml" source="~/azureml-examples/cli/jobs/train/tensorflow/mnist-distributed/job.yml":::

Create the job and open in the studio:

:::code language="azurecli" source="~/azureml-examples/cli/how-to-train-cli.sh" id="tensorflow_mnist":::
...
:::code language="yaml" source="~/azureml-examples/cli/jobs/train/tensorflow/mnist-distributed-horovod/job.yml":::

Create the job and open in the studio:

:::code language="azurecli" source="~/azureml-examples/cli/how-to-train-cli.sh" id="tensorflow_mnist_horovod":::

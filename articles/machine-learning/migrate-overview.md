...
1. [Clean up Studio (classic) assets](/azure/machine-learning/classic/export-delete-personal-data-dsr) to avoid extra charges. You may want to retain assets for fallback until you have validated Azure Machine Learning workloads.

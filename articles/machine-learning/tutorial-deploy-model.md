...
1. Create a new notebook or copy the contents of our notebook.
    * Follow the [Quickstart: Run Juypter notebook in Azure Machine Learning studio](quickstart-run-notebooks) steps to create a new notebook.
    * Or open the notebook by opening  **update these locations** from the **Samples** section of studio. Then select **Clone this notebook**  to add the notebook to your **Files**.<!-- MA: update this location** -->

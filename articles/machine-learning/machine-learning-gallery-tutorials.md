...
### Create a tutorial
To create and contribute a tutorial to the Cortana Intelligence Gallery:
...
4. For **ITEM TYPE**, select **Tutorial**. Enter a name for your tutorial, a brief summary, a detailed description, and any tags that might help other users find your tutorial.
  
    ![Enter information for new tutorial](media/machine-learning-gallery-tutorials/create-tutorial-page-1.png)
5. Select **Next**. You can choose an image that is displayed with the collection. You can upload your own image file, or select a stock image. Choose an image that might help users identify the content and purpose of the tutorial.
  
    ![Enter information for new tutorial](media/machine-learning-gallery-tutorials/create-tutorial-page-2.png)

6. Select **Next**. You can choose whether the collection is **Public** (anyone can view the tutorial) or **Unlisted** (only people with a direct link can view the tutorial).
  
    > [!IMPORTANT]
    > After you set a tutorial to **Public** and select **Create**, you cannot later change the tutorial to **Unlisted**.
    > 
    > 

...
> [!IMPORTANT]
> Credentials registred with datastores are saved in your Azure Key Vault associated with the workspace. If you have [soft-delete](../key-vault/general/soft-delete-overview.md) enabled for your Key Vault, make sure to follow this article for updating credentials. Unregistering the datastore and re-registering it under the same name will fail.

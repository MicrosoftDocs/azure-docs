...
| `code_configuration.code.path` | The directory on the development environment that contains all the Python source code for scoring the model. You can use nested directories and packages. |

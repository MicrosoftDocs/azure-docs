...
1. In the [Azure portal](https://portal.azure.com), select your Azure Machine Learning workspace. From __Overview__, select the __Application Insights__ link.
    ...
    :::image type="content" source=".media/tutorial-create-secure-workspace/workspace-application-insights.png" alt-text="Screenshot of the Application Insights link.":::

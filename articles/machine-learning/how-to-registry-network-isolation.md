...
Due to data exfiltration protection, it is not possible to share an asset from secure workspace to a public registry if the storage account containing the asset has public access disabled. 

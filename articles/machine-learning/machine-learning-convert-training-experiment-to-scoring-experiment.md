...
2. It removes modules that are clearly not needed. In our example, this includes the [Split Data][split], 2<sup>nd</sup> [Score Model][score-model], and [Evaluate Model][evaluate-model] modules.

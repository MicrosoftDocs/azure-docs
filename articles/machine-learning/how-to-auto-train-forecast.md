...
This data set is of daily sales data for a company that has two different stores, A and B. Additionally, there are features for
...
The following table summarizes these additional parameters.

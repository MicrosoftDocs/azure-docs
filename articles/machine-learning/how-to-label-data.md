...
Projects support DICOM image format for X-ray file images. These images can be used to train machine learning models for clinical use.
...
While you label the medical images with the same tools as any other images, there is an additional tool for DICOM images.  Select the **Window and level** tool to change the intensity of the image.

...
For more information on logging metrics using the SDK authoring experience, see [Monitor Azure ML experiment runs and metrics](how-to-log-and-view-metrics.md).
...
1. Connect an __Execute Python Script__ module to the output of the __Evaluate Model__ module.
    ...
    ![Connect Execute Python Script module to Evaluate Model module](./media/how-to-log-and-view-metrics/designer-logging-pipeline.png)
...
For more information on how to use the Python SDK to log values, see [Enable logging in Azure ML training runs](how-to-log-and-view-metrics.md).
...
1. Select **Metrics**.
    ...
    ![View run metrics in the studio](./media/how-to-log-and-view-metrics/experiment-page-metrics-across-runs.png)
...
* Learn how to use the Python SDK to log metrics in the SDK authoring experience, see [Enable logging in Azure ML training runs](how-to-log-and-view-metrics.md).

...
|[StepSequence](/python/api/azureml-core/azureml.pipeline.core.stepsequence?view=azure-ml-py&preserve-view=true)|[Data dependency](https://github.com/Azure/azureml-examples/tree/main/cli/jobs/pipelines-with-components/basics/3b_pipeline_with_data)|

...
:::image type="content" source="media/how-to-create-managed-online-endpoint-studio/models_page_deployment_latest.png" alt-text="Create a managed online endpoint from the Models tab":::

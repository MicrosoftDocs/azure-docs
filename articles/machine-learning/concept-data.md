...
df = pd.read_csv(args.folder_path)
print(df.head(10))
```
...
- the store location is an index that is useful for subsetting
...
The MLTable file has the following definition that the Azure Machine Learning Data Prep Engine knows how to process:

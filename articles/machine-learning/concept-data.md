...
Azure Machine Learning datasets aren't copies of your data. By creating an Azure Machine Learning dataset, you create a reference to the data in its storage service, along with a copy of its metadata. 

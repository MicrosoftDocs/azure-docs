...
> [!NOTE]
> Azure machine learning [inference source directory](https://docs.microsoft.com/python/api/azureml-core/azureml.core.model.inferenceconfig?view=azure-ml-py#constructor) upload does not respect **.gitignore** or **.amlignore**

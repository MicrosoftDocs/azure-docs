...
- To view the transformed values, right-click the module, and click **Visualize**.
...
- To save the transformation so that you can apply the same normalization method to another similar dataset, select the module, click on **Register dataset** under **Outputs** tab in the right panel.

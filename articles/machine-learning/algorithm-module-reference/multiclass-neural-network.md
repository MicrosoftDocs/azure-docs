...
This article describes how to use the **Multiclass Neural Network** module in Azure Machine Learning to create a neural network model that can be used to predict a target that has multiple values. 

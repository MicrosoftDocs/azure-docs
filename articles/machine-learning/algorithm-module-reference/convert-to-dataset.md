...
This article describes how to use the Convert to Dataset module in the Azure Machine Learning designer (preview) to convert any data for a pipeline to the designer's internal format.

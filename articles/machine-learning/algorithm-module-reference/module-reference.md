...
| Python  and R modules | Write code and embed it in a module to integrate Python and R with your pipeline. | [Create Python Model](create-python-model.md) <br/> [Execute Python Script](execute-python-script.md)   <br/>  [Execute R Script](execute-r-script.md)
...
| Train   | Run data through the algorithm. | [Cross Validate Model](cross-validate-model.md) <br/> [Train Model](train-model.md)  <br/> [Train Clustering Model](train-clustering-model.md) <br/>  [Tune Model Hyperparameters](tune-model-hyperparameters.md) |

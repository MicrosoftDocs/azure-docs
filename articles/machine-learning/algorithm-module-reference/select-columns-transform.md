...
description: Learn how to use the Select Columns Transform module in the Azure Machine Learning to create a transformation that selects the same subset of columns as in the given dataset.

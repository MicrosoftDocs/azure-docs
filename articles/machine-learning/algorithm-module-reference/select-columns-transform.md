...
description: Learn how to use the Select Columns Transform module in the Azure Machine Learning service to create a transformation that selects the same subset of columns as in the given dataset.
...
This article describes how to use the Select Columns Transform module in the Azure Machine Learning designer (preview). The purpose of the Select Columns Transform module is to ensure that a predictable, consistent set of columns is used in downstream machine learning operations.

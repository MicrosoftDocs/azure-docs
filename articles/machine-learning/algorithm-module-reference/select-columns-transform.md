...
description: Learn how to use the Select Columns Transform module in Azure Machine Learning service to create a transformation that selects the same subset of columns as in the given dataset.

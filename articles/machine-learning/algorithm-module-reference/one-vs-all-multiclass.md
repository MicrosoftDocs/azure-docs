...
This article describes how to use the One-vs-All Multiclass module in the Azure Machine Learning designer (preview). The goal is to create a classification model that can predict multiple classes, by using the *one-versus-all* approach.

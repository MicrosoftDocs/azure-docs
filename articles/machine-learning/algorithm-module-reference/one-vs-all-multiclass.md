...
description: Learn how to use the One-vs-All Multiclass module in the Azure Machine Learning to create a multiclass classification model from an ensemble of binary classification models.

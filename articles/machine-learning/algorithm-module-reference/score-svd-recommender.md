...
This article describes how to use the Score SVD Recommender module in the Azure Machine Learning designer (preview). Use this module to create predictions by using a trained recommendation model based on the Single Value Decomposition (SVD) algorithm.

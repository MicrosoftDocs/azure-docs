...
This article describes how to use the **ResNet** module in Azure Machine Learning designer (preview), to create an image classification model using the ResNet algorithm..  

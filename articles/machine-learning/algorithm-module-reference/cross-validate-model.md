...
description: Learn how to use the Cross-Validate Model module in the Azure Machine Learning to cross-validate parameter estimates for classification or regression models by partitioning the data.

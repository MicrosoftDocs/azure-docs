...
This article describes how to use the Evaluate Recommender module in the Azure Machine Learning designer (preview). The goal is to measure the accuracy of predictions made by a recommendation model. By using this module, you can evaluate different kinds of recommendations:  
  
-   Ratings predicted for a user and item  
...
The Evaluate Recommender module compares the predictions output by using a recommendation model with the corresponding "ground truth" data. For example, the [Score SVD Recommender](score-svd-recommender.md) module produces scored datasets that you can analyze with Evaluate Recommender.

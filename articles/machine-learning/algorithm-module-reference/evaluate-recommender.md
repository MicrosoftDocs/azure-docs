...
This article describes how to use the **Evaluate Recommender** module in Azure Machine Learning designer, to measure the accuracy of predictions made by a recommendation model. Using this module, you can evaluet four different kinds of recommendations:  

...
+ To see a complete list of the feature columns that were analyzed, and their scores, right-click the module and then select **Visualize**.  

+ To view the dataset that's generated based on your feature selection criteria, right-click the module. and then select **Visualize**. 

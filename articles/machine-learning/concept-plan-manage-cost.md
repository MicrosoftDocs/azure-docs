...
author: sdgilley
ms.author: sgilley
ms.custom: subject-cost-optimization, sdkv1, event-tier1-build-2022, build-2023
ms.reviewer: nigup
...
* [Enable idle shutdown (preview)](how-to-create-compute-instance.md#enable-idle-shutdown) to save on cost when the VM has been idle for a specified time period.

...
* Create Azure Machine Learning compute with [SDK](how-to-create-attach-compute-sdk.#amlcompute) or in [studio](how-to-create-attach-compute-studio.#amlcompute).

...
description: Learn how to use an Azure Resource Manager and Bicep templates to create a new Azure Machine Learning hub workspace.
...
# Use an Azure Resource Manager template to create a hub workspace for Azure Machine Learning

...
For examples executing steps in the Team Data Science Process that use Azure Machine Learning Studio, see the [With Azure ML](https://aka.ms/datascienceprocess) learning path.
...
> [!NOTE]
> For a topic that shows you how to use Python rather than Scala to complete tasks for an end-to-end Data Science process, see [Data Science using Spark on Azure HDInsight](data-science-spark-overview.md).
> 
> 
...
![HDInsight cluster type configuration](./media/data-science-process-scala-walkthrough/spark-cluster-on-portal.png)

> [!INCLUDE [delete-cluster-warning](../../../includes/hdinsight-delete-cluster-warning.md)]
> 
> 

For a description of the NYC taxi trip data and instructions on how to execute code from a Jupyter notebook on the Spark cluster, see the relevant sections in [Overview of Data Science using Spark on Azure HDInsight](data-science-spark-overview.md).  
...
![Cluster dashboard and Jupyter notebooks](./media/data-science-process-scala-walkthrough/spark-jupyter-on-portal.png)
...
![Go to Jupyter notebooks by using the cluster name](./media/data-science-process-scala-walkthrough/spark-jupyter-notebook.png)
...
![Tip amount histogram](./media/data-science-process-scala-walkthrough/plot-tip-amount-histogram.png)

![Tip amount by passenger count](./media/data-science-process-scala-walkthrough/plot-tip-amount-by-passenger-count.png)

![Tip amount by fare amount](./media/data-science-process-scala-walkthrough/plot-tip-amount-by-fare-amount.png)
...
![Tip or no tip ROC curve](./media/data-science-process-scala-walkthrough/plot-roc-curve-tip-or-not.png)
...
![Tip amount: Actual vs. predicted](./media/data-science-process-scala-walkthrough/plot-actual-vs-predicted-tip-amount.png)

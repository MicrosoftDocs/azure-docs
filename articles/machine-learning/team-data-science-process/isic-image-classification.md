...
This article is a summary document about the sample. More extensive documentation can be found on the [GitHub site](https://github.com/Azure/MachineLearningSamples-AMLVisionPackage-ISICImageClassification).
...
Define the model architecture that's used in the training step. Six different pre-trained deep neural network models are supported in the Azure Machine Learning Package for Computer Vision: AlexNet, Resnet-18, Resnet-34, Resnet-50, Resnet-101, and Resnet-152.
...
The substeps are explained in detail in the corresponding Jupyter Notebook. Guidelines for turning the parameters, such as the learning rate, mini batch size, and dropout rate to further improve the model performance are provided.

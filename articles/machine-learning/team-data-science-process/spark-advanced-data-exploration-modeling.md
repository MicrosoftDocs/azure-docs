...
![Frequency of trips by passenger count](./media/data-science-spark-advanced-data-exploration-modeling/frequency-of-trips-by-passenger-count.png)
...
![Tip amount distribution](./media/data-science-spark-advanced-data-exploration-modeling/tip-amount-distribution.png)

![Tip amount by passenger count](./media/data-science-spark-advanced-data-exploration-modeling/tip-amount-by-passenger-count.png)

![Tip amount by fare Amount](./media/data-science-spark-advanced-data-exploration-modeling/tip-amount-by-fare-amount.png)
...
![Logistic regression ROC curve for generic approach](./media/data-science-spark-advanced-data-exploration-modeling/logistic-regression-roc-curve.png)
...
![Logistic regression ROC curve using MLlib's CrossValidator](./media/data-science-spark-advanced-data-exploration-modeling/mllib-crossvalidator-roc-curve.png)
...
![Actual-vs-predicted-tip-amounts](./media/data-science-spark-advanced-data-exploration-modeling/actual-vs-predicted-tips.png)

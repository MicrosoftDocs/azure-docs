...
![Hive query for Import Data module](./media/data-science-process-hive-walkthrough/1eTYf52.png)
...
![Experiment snapshot](./media/data-science-process-hive-walkthrough/QGxRz5A.png)
...
![Distribution of tip class labels](./media/data-science-process-hive-walkthrough/9mM4jlD.png)

As a result, we obtain an AUC of 0.987 as shown in the figure below.

![AUC value](./media/data-science-process-hive-walkthrough/8JDT0F8.png)
...
![Experiment snapshot](./media/data-science-process-hive-walkthrough/5ztv0n0.png)
...
![Test class distribution](./media/data-science-process-hive-walkthrough/Vy1FUKa.png)

b. For this experiment, we use a confusion matrix to look at our prediction accuracies. This is shown below.

![Confusion matrix](./media/data-science-process-hive-walkthrough/cxFmErM.png)
...
![Experiment snapshot](./media/data-science-process-hive-walkthrough/11TZWgV.png)
...
![Prediction statistics](./media/data-science-process-hive-walkthrough/Jat9mrz.png)
...
[2]: ./media/data-science-process-hive-walkthrough/output-hive-results-3.png
[11]: ./media/data-science-process-hive-walkthrough/hive-reader-properties.png
[12]: ./media/data-science-process-hive-walkthrough/binary-classification-training.png
[13]: ./media/data-science-process-hive-walkthrough/create-scoring-experiment.png
[14]: ./media/data-science-process-hive-walkthrough/binary-classification-scoring.png
[15]: ./media/data-science-process-hive-walkthrough/amlreader.png

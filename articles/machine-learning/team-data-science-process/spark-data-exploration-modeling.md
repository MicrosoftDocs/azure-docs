...
## Prerequisites
You need an Azure account and a Spark 1.6 (or Spark 2.0) HDInsight cluster to complete this walkthrough. See the [Overview of Data Science using Spark on Azure HDInsight](data-science-spark-overview.md) for instructions on how to satisfy these requirements. That topic also contains a description of the NYC 2013 Taxi data used here and instructions on how to execute code from a Jupyter notebook on the Spark cluster. 
...
![Trip frequency by passenger count](./media/data-science-spark-data-exploration-modeling/trip-freqency-by-passenger-count.png)
...
![Tip amount distribution](./media/data-science-spark-data-exploration-modeling/tip-amount-distribution.png)

![Tip amount by passenger count](./media/data-science-spark-data-exploration-modeling/tip-amount-by-passenger-count.png)

![Tip amount by fare amount](./media/data-science-spark-data-exploration-modeling/tip-amount-by-fare-amount.png)
...
![Logistic regression ROC curve.png](./media/data-science-spark-data-exploration-modeling/logistic-regression-roc-curve.png)
...
![Actual-vs-predicted-tip-amounts](./media/data-science-spark-data-exploration-modeling/actual-vs-predicted-tips.png)

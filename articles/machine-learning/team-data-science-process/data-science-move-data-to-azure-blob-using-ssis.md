...
This is typically be the first step for the [SQL](data-science-process-sql-walkthrough.md) and [HDInsight](data-science-process-hive-walkthrough.md) walkthroughs.

...
>[!Note]
>**This article is deprecated.** Support for earlier versions of this service will end incrementally. [View the support timeline](../articles/machine-learning/service/overview-what-happened-to-workbench.md#timeline). Read the [newest article](../articles/machine-learning/service/how-to-export-delete-data.md) on this topic.

...
| **Cluster sizing (scaling)** | Managed manual and autoscale, supporting additional nodes provisioning                                                             | Manual and autoscale using Kubernetes scaler within fixed nodes                                                         |

...
| **Cluster sizing (scaling)** | Manual and Auto-scale supported                                              | Manual scale supported                                                                                                     |
| **Compute type**              | Managed by the service                                                                                                              | Customer-managed Kubernetes cluster (Kubernetes)                                                                                         |
| **Out-of-box monitoring**     | [Azure Monitor and Log Analytics powered](how-to-monitor-online-endpoints.md) <br> (includes key metrics like latency/throughput for endpoints and CPU/GPU utilization for deployments, consumable with charts and tables)                    | Unsupported                                                                                                               |

...
| **Cluster sizing (scaling)** | Managed manual and autoscale, supporting additional nodes provisioning                                                             | Manual and autoscale, supporting scaling the number of replicas within fixed cluster boundearis                         |

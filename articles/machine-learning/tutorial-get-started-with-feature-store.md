...
A point-in-time join [!notebook-python[](~/azureml-examples-featurestore/sdk/python/featurestore_sample/notebooks/sdk_only/1.%20hello_world.ipynb?name=pitjoin)] appends the features to the training data.

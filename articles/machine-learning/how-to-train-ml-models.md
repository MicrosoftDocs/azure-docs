...
With Azure Machine Learning, you can easily submit your training script to [various compute targets](how-to-submit-training.md), using a [RunConfiguration object](how-to-submit-training.md#whats-a-run-configuration) and a [ScriptRunConfig object](how-to-submit-training.md#submit). That pattern gives you a lot of flexibility and maximum control.

...
You can also add results from queries to an [Azure Dashboard](../azure-monitor/learn/tutorial-app-dashboards.md#add-logs-analytics-query) for additional insights.
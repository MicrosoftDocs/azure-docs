...
* You don't need features like AutoML in pipelines, Parallel Job Steps, Scheduling Pipelines and Spark Jobs. These features are not yet available in SDK v2.

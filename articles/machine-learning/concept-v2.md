...
Azure Machine Learning CLI v2 and Azure Machine Learning Python SDK v2 (preview) introduce a consistency of features and terminology across the interfaces.  In order to do this, the syntax of commands differs, in some cases significantly, from the first versions (v1).
...
* Perform managed inferencing (realtime and batch)

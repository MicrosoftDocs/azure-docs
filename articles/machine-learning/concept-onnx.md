...
- For example Python notebooks that create and deploy ONNX models, see [how-to-use-azureml](https://github.com/Azure/MachineLearningNotebooks/tree/master/how-to-use-azureml).

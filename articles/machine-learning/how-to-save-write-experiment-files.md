...
* Learn more about creating compute targets with the [Python SDK](how-to-create-attach-compute-sdk.md) or using [studio](how-to-create-attach-compute-portal.md).

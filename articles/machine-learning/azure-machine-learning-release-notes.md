...
+ Azure ML Hardware Accelerated Models on [FPGAs](v1/how-to-deploy-fpga-web-service.md) is generally available.
  + You can now [use the azureml-accel-models package](v1/how-to-deploy-fpga-web-service.md) to:

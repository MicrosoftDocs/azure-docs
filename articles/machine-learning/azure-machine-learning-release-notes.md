...
+ **New features**
  ...
  + **azureml-pipeline-steps**
    + [Experimental feature] Add support for [SynapseSparkStep](https://docs.microsoft.com/en-us/python/api/azureml-pipeline-steps/azureml.pipeline.steps.synapsesparkstep?view=azure-ml-py)
  + **azureml-synapse**

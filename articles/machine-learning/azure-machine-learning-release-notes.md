...
### Azure Machine Learning SDK for Python v1.39.0
  + **azureml-automl-core**
    +  This change does not require release notes - Updating AutoML dependencies to support python 3.8.
    ...
    +  This change does not require release notes Fix incorrect form displayed in PBI for integration with AutoML regression models
    +  This change does not require release notes Adding min-label-classes check for both classification tasks (multi-class and multi-label).
  ...
  + **azureml-automl-dnn-nlp**
    +  This change does not require release notes - Updating AutoML dependencies to support python 3.8. This change will break compatibility with models trained with SDK 1.37 or below due to newer Pandas interfaces being saved in the model.
    +  This change does not require release notes Adding min-label-classes check for both classification tasks (multi-class and multi-label).
    +   It will throw an error for the customer's run if the unique number of classes in the input training dataset is fewer than 2. It is meaningless to run classification on fewer than two classes.
  + **azureml-automl-runtime**
    +  This change does not require release notes fix automl reset index logic for ensemble models in automl_setup_model_explanations API
    +  This change does not require release notes Automl training now supports numpy version 1.8
    +  This change does not require release notes - Updating AutoML dependencies to support python 3.8. This change will break compatibility with models trained with SDK 1.37 or below due to newer Pandas interfaces being saved in the model.
    +  This change is not visible to customers and does not require release notes - All internal intermediate artifacts that are produced by AutoML are now stored transparently on the parent run (instead of being sent to the default workspace blob store). Users should be able to see the artifacts that AutoML generates under the 'outputs/` directory on the parent run. This is a required change to a. Improve transparency of what data is generated by AutoML, b. Allow configurability to switch data stores at the Run level in the future (e.g. for bring-your-own-datastore scenarios).
  + **azureml-contrib-automl-dnn-forecasting**
    +  This change does not require release notes Fixed a bug in the TCNForecaster model where not all training data would be used when cross-validation settings were provided.
    +  This change does not require release notes Fixed a bug in the TCNForecaster wrapper's forecast method that was corrupting inference-time predictions. Also fixed an issue where the forecast method would not use the most recent context data in train-valid scenarios.
    +  This change does not require release notes - Updating AutoML dependencies to support python 3.8. This change will break compatibility with models trained with SDK 1.37 or below due to newer Pandas interfaces being saved in the model.
  ...
  + **azureml-mlflow**
    +  This change does not require release notes - Updating AutoML dependencies to support python 3.8. This change will break compatibility with models trained with SDK 1.37 or below due to newer Pandas interfaces being saved in the model.
  + **azureml-synapse**
    +  This change does not require release notes Fix the issue that magic widget is disappeared.
  + **azureml-train-automl**
    +  This change does not require release notes - Updating AutoML dependencies to support python 3.8. This change will break compatibility with models trained with SDK 1.37 or below due to newer Pandas interfaces being saved in the model.
  + **azureml-train-automl-client**
    +  This change does not require release notes - Updating AutoML dependencies to support python 3.8. This change will break compatibility with models trained with SDK 1.37 or below due to newer Pandas interfaces being saved in the model.
  + **azureml-train-automl-runtime**
    +  This change does not require release notes Automl training now supports numpy version 1.19
    +  This change does not require release notes fix automl reset index logic for ensemble models in automl_setup_model_explanations API
    +  This change does not require release notes in automl, use lightgbm surrogate model instead of linear surrogate model for sparse case after latest lightgbm version upgrade
    +  This change does not require release notes - Updating AutoML dependencies to support python 3.8. This change will break compatibility with models trained with SDK 1.37 or below due to newer Pandas interfaces being saved in the model.
    +  This change does not require release notes - All internal intermediate artifacts that are produced by AutoML are now stored transparently on the parent run (instead of being sent to the default workspace blob store). Users should be able to see the artifacts that AutoML generates under the 'outputs/` directory on the parent run. This is a required change to a. Improve transparency of what data is generated by AutoML, b. Allow configurability to switch data stores at the Run level in the future (e.g. for bring-your-own-datastore scenarios).

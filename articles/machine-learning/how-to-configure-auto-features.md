...
BERT generally runs longer than most other featurizers. It can be sped up though by providing more compute in your cluster. AutoML will distribute BERT training across multiple nodes if they are available (upto a max of 8 nodes). This is done by setting [max_concurrent_iterations](https://docs.microsoft.com/en-us/python/api/azureml-train-automl-client/azureml.train.automl.automlconfig.automlconfig?view=azure-ml-py) to higher than 1. For better performance, we recommend using skus with RDMA capabilities while running BERT (such as "STANDARD_NC24r" or "STANDARD_NC24rs_V3")

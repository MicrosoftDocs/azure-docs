...
| `environment_variables` | object | Dictionary of environment variable name-value pairs to set in the deployment container. You can access these environment variables from your scoring scripts. | | |

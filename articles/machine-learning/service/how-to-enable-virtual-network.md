...
1. On the __Firewalls and virtual networks__ page, do the following:
    ...
    > [!IMPORTANT]
    > When working with the Azure Machine Learning SDK, your development environment must be able to connect to the Azure Storage Account. When the storage account is inside a virtual network, the firewall must allow access from the development environment's IP address. This includes Azure Machine Learning service Notebook VMs.
    >

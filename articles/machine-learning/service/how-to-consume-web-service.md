...
To generate a web service that is supported for consumption in Power BI, the schema must support the format required by Power BI, [learn how to create a Power BI supported schema](https://docs.microsoft.com/en-us/azure/machine-learning/service/how-to-deploy-and-where#Example-script-with-dictionary-input-Support-consumption-from-Power-BI).

Once the wb service is deployed, it is consumable from Power BI dataflows. [Learn how to consume an Azure machine learning web service from Power BI](https://docs.microsoft.com/en-us/power-bi/service-machine-learning-integration).

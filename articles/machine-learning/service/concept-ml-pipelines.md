...
The following notebook demonstrates pipelines with Azure Machine Learning:  [how-to-use-azureml/machine-learning-pipelines/pipeline-batch-scoring.ipynb](https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/machine-learning-pipelines/pipeline-batch-scoring.ipynb).

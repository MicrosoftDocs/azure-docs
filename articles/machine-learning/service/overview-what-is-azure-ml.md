...
2. Follow the full-length [tutorial](tutorial-build-tutorial-train-models-with-aml.md) to learn how to train and deploy models with Azure Machine Learning Services. 

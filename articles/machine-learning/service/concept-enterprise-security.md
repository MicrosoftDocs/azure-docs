...
See the [how-to](how-to-setup-authentication.md) for detailed examples and instructions on setting up authentication, including service principal authentication for automated workflows.
...
See the [web-service authentication section](how-to-setup-authentication.md#web-service-authentication) in the how-to for code examples on authenticating to web-services in Azure Machine Learning.

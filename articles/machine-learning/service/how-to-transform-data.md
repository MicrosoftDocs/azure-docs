...
The [Azure Machine Learning Data Prep SDK](https://aka.ms/data-prep-sdk) offers different transform methods to clean your data. These methods make it simple to add columns, filter out unwanted rows or columns, and impute missing values.

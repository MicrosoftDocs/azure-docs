...
- An Azure Machine Learning service workspace and the Azure Machine Learning SDK for Python installed. Learn how to get these prerequisites using [Create a Azure Machine Learning service workspace](setup-create-workspace.md).

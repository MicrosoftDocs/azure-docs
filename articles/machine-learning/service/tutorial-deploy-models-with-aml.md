...
For your convenience, this tutorial is available as a Jupyter notebook. Run the `02.deploy-models.ipynb` notebook either in Azure Notebooks or in your own Jupyter notebook server.

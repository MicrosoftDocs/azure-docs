...
Next, create the necessary environment dependencies in the container for the deployed model. Please note that you must list azureml-defaults with version >= 1.0.53 as a pip dependency. This package contains tools necessary for running inferencing logic.

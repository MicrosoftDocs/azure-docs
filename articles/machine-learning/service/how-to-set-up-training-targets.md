...
|Compute&nbsptarget for training| GPU support |Automated ML | ML pipelines | Visual interface
|----|:----:|:----:|:----:|:----:|
|[Local computer](#local)| maybe | yes | &nbsp; | &nbsp; |
|[Azure Machine Learning Compute](#amlcompute)| yes | yes & hyperparameter tuning | yes | yes |
|[Remote VM](#vm) |yes | yes & hyperparameter tuning | yes | &nbsp; |
|[Azure&nbspDatabricks](how-to-create-your-first-pipeline.md#databricks)| &nbsp; | yes | yes | &nbsp; |

...
1. From the list of subscriptions, select the subscription whose quota you are looking for.
   ...
   **There is a caveat**, specifically for viewing the Batch AI quota. As mentioned above, that quota is separate from the compute quota on your subscription. After selecting **All services**, search for Batch AI and open the service.

1. In the new blade, select **Usage + quotas** under **Settings** to view your current quota limits and usage.

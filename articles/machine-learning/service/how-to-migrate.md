...
Get started with the latest version by creating an Azure Machine Learning service workspace in the [Azure portal](quickstart-get-started.md). The portal's workspace dashboard is supported on Microsoft Edge, Chrome and Firefox browsers only.

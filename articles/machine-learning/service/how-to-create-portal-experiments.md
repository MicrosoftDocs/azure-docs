...
1. (Optional) Advanced settings: additional settings you can use to better control the training job.
    ...
    Validation| Select one of the cross validation options to use in the training job. [Learn more about cross validation](how-to-configure-auto-train.md#cross-validation-split-options).

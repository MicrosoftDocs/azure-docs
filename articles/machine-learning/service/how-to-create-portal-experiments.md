...
You are able to drill down on any of the output models which opens the details of that model including performance and distribution charts and metrics.[Learn more about charts](https://docs.microsoft.com/en-us/azure/machine-learning/service/how-to-track-experiments#understanding-automated-ml-charts).
...
1. Scoring script and environment file are auto generated by default. You can override and provide your own files. [Learn more about scoring script](https://docs.microsoft.com/en-us/azure/machine-learning/service/how-to-deploy-and-where#script).

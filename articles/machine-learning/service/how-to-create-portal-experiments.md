...
1. Populate the **Deploy Model** pane.
    ...
    Use custom deployment assets| Enable this feature if you want to upload your own scoring file and environment scripte. [Learn more about scoring scripts](how-to-deploy-and-where.md#script).

...
Images are catalogued in the **image registry** in your workspace. You can provide additional metadata tags when you create the image so you can query them to find your image later.

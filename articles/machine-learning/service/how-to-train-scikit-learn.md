...
In this tutorial, the training script **train_iris.py** is already provided for you. In practice, you should be able to take any custom training script as is and run it with Azure Machine Learning without having to modify your code.

To use the Azure Machine Learning tracking and metrics capabilities, add a small amount of Azure Machine Learning code inside your training script.  The training script **train_iris.py** shows how to log some metrics to your Azure Machine Learning run using the `Run` object within the script.

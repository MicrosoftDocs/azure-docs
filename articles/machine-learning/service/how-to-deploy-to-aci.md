...
[!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=load_workspace)]
...
1. Use these two files to configure the Docker image in Python using the SDK as follows:
    ...
    [!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=configure-image)]
...
[!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=configure-aci)]
...
[!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=retrieve-image)]
...
[!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=register-model)]
...
1. Deploy your model file.
    ...
    [!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=option1-deploy)]
...
1. Run the code to configure the Docker container and the ACI container and specify the registered model.
    ...
    [!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=option2-deploy)]
...
1. Build and register the Docker image under the workspace using `ContainerImage.create()`
    ...
    [!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=option3-create-image)]
...
1. Deploy the Docker image as a service using `Webservice.deploy_from_image()`
    ...
    [!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=option3-deploy)]
...
[!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=test-service)]
...
[!code-python[](service-code/how-to-deploy-to-aci/how-to-deploy-to-aci.py?name=delete-service)]

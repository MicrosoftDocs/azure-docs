...
+ A workspace can contain [AzureML Compute Instances](tutorial-1st-experiment-sdk-setup.md), cloud resources configured with the Python environment necessary to run Azure Machine Learning.

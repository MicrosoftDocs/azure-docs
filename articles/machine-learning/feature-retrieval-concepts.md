...
1. Train a model with the generated training data resource.
1. Package the feature retrieval specification in the model artifact.
...
Review these notebooks for examples that the build-in component:

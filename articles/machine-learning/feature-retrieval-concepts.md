...
Find detailed examples at [this resource](~/azureml-examples/sdk/python/featurestore_sample/notebooks/sdk_only/2. Experiment and train models using features.ipynb)
...
Review this [tutorial notebook](~/azureml-examples/sdk/python/featurestore_sample/notebooks/sdk_only/2. Experiment and train models using features.ipynb)) for a complete pipeline example that uses a built-in feature retrieval component to generate training data and run the training job with the packaging.
...
Visit [this notebook](~/azureml-examples/sdk/python/featurestore_sample/notebooks/sdk_only/4. Enable online store and run online inference.ipynb) for a detailed code snippet.
...
The [Enable recurrent materialization and run batch inference](~/azureml-examples/sdk/python/featurestore_sample/notebooks/sdk_only/3. Enable recurrent materialization and run batch inference.ipynb) notebook provides a detailed code snippet.
...
Review these notebooks for examples of the built-in component:
 ...
 - [Experiment and train models using features](~/azureml-examples/sdk/python/featurestore_sample/notebooks/sdk_only/2. Experiment and train models using features.ipynb)
 - [Enable recurrent materialization and run batch inference](~/azureml-examples/sdk/python/featurestore_sample/notebooks/sdk_only/3. Enable recurrent materialization and run batch inference.ipynb)

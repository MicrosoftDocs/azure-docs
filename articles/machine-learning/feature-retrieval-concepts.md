...
Find detailed examples at [this resource](~/azureml-examples-main/sdk/python/featurestore_sample/notebooks/sdk_only/2. Experiment and train models using features.ipynb)
...
Visit [this notebook](~/azureml-examples-main/sdk/python/featurestore_sample/notebooks/sdk_only/4. Enable online store and run online inference.ipynb) for a detailed code snippet.
...
The [Enable recurrent materialization and run batch inference](~/azureml-examples-main/sdk/python/featurestore_sample/notebooks/sdk_only/3. Enable recurrent materialization and run batch inference.ipynb) notebook provides a detailed code snippet.
...
Review these notebooks for examples of the built-in component:
 ...
 - [Experiment and train models using features](~/azureml-examples-main/sdk/python/featurestore_sample/notebooks/sdk_only/2. Experiment and train models using features.ipynb)
 - [Enable recurrent materialization and run batch inference](~/azureml-examples-main/sdk/python/featurestore_sample/notebooks/sdk_only/3. Enable recurrent materialization and run batch inference.ipynb)

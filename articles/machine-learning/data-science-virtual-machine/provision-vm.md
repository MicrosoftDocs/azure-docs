...
* Machine learning and data analytics tools:
  * Deep learning frameworks - a rich set of AI frameworks are included on the VM: [TensorFlow](https://www.tensorflow.org/), [Chainer](https://chainer.org/), mxNet, and Keras

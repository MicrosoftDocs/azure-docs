...
| How is it configured / installed on the DSVM?  | CNTK is installed in Python 3.5 on [Linux](./dsvm-tools-languages.md#python-linux-edition)) |
...
| Supported DSVM editions      | Linux   |
| How is it configured / installed on the DSVM?  | MXNet is installed in `/dsvm/tools/mxnet` on Ubuntu. Python bindings are installed in Python 3.5 on [Linux](./dsvm-tools-languages.md#python-linux-edition)) R bindings are also included in the Ubuntu DSVM. |
...
| Supported DSVM editions      | Linux   |
| How is it configured / installed on the DSVM?  | MXNet Model Server is installed in Python 3.5 on [Linux](./dsvm-tools-languages.md#python-linux-edition)) |
...
| Supported DSVM editions      | Windows and Linux |
| How is it configured / installed on the DSVM?  | Installed on Python 3.6 on [Windows 2016](dsvm-tools-languages.md#python-windows-server-2016-edition) and in [Python 3.5](dsvm-tools-languages.md#python-linux-edition) on Linux. Sample Jupyter notebooks are included, and samples are in /dsvm/samples/pytorch. |

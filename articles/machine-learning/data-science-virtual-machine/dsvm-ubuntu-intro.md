...
The Ubuntu DSVM runs [JupyterHub](https://github.com/jupyterhub/jupyterhub), a multiuser Jupyter server. To connect, browse to https:\//your-vm-ip:8000 on your laptop or desktop. Enter the username and password that you used to create the VM, and sign in. Many sample notebooks are available for you to browse and try out.

...
| **MXnet** Notebooks  | Deep Learning samples utilizing **MXnet** based neural networks. This contains a variety of notebooks ranging from beginner to advanced scenarios.  <br/> [Screenshot](#mxnet) | <br/>`~notebooks/mxnet`<br/> <br/>|
...
You can access Jupyter Home on your VM by visiting **`https://localhost:8000`** on your browser. See screenshot below to add exception and enable Jupyter access over the browser.

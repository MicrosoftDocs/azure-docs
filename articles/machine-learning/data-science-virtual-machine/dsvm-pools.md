...
This article discusses how you can create a shared pool of Data Science Virtual Machines (DSVMs) for a team to use. The benefits of using a shared pool are better resource utilization, facilitating sharing and collaboration, and allowing IT to manage the DSVM resources more effectively. 

There are many methods and technologies that you can use to create a pool of DSVMs. This article focuses on pools for batch processing and interactive VMs.

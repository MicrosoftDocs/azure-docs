...
This technique has shown strong empirical results and high correlation with human judgment when compared to standard generative AI evaluation metrics. You can understand the generative AI monitoring metrics in the following sections, and learn more about [prompt flow bulk test and evaluation (preview)](how-to-bulk-test-evaluate-flow.md). The following metrics are supported: 

#### Coherence

Coherence evaluates how well the language model can produce output that is coherent: it flows smoothly, reads naturally, and resembles human-like language. Answers are scored according to their clarity, brevity, linguistic quality, and ability to match defined user needs and expectations.  
...
1. **Managed identity:**  Create a User Assigned Identity (UAI) and attach it to your workspace [using this guidance](../how-to-submit-spark-jobs.md#attach-user-assigned-managed-identity-using-cli-v2)
...
1. **Prompt flow deployment:** Create a prompt flow runtime [following this guidance](how-to-create-manage-runtime.md), run your flow, and ensure your [deployment is configured using this article as a guide](how-to-deploy-for-real-time-inference.md) 
    - **Flow inputs & outputs:** You'll need to name your flow outputs appropriately and remember these column names when creating your monitor. In this article, we use the following:
...
:::image type="content" source="./media/how-to-monitor-generative-ai-applications/gsq-create-monitor.png" alt-text="Screenshot showing how to create a monitor for your application." lightbox="./media/how-to-monitor-generative-ai-applications/gsq-create-monitor.png":::

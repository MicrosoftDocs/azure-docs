...
![Screenshot of prompt flow creation from scratch or gallery](./media/how-to-develop-flow/gallery.png)
...
![Runtime creation](./media/how-to-develop-flow/runtime-creation.png)
...
![Flow input and output](./media/how-to-develop-flow/flow-input-output.png)
...
![Click View outputs button to view the output](./media/how-to-develop-flow/view-flow-output.png)
![View flow output in output right panel](./media/how-to-develop-flow/flow-output.png)
...
![Chat flow authoring page](./media/how-to-develop-flow/chat-authoring-layout.png)

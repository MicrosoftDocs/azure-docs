...
Or use this [assessment]() to determine your organization's current LLMOps maturity level. The questionnaire is designed to help you understand your organization's current capabilities and identify areas for improvement.
...
> [!TIP]
> Score from [assessment](): initial (0-9).
...
> [!TIP]
> Score from [assessment](): optimized (19-28).

...
> [!NOTE]
> When legacy tools switching to code first mode, if you encounter "embeddingstore.tool.vector_db_lookup.search" error, please refer to [Vector DB/Faiss Index/Vector Index Lookup tool rename reminder](faq.md).

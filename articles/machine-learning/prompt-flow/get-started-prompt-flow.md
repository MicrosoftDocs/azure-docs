...
:::image type="content" source="./media/get-started-prompt-flow/aoai_connection.png" alt-text="Screenshot of the add Azure OpenAI connections." lightbox = "./media/get-started-prompt-flow/aoai_connection.png":::

...
1. Select **Create AzureML compute instance**.

    If you already have an available compute target, you can select it from the **Select AzureML compute instance** drop-down to run this pipeline.

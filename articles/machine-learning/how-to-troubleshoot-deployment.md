...
The first step in debugging errors is to get your deployment logs. First, follow the [instructions here to connect to your workspace](how-to-deploy-managed-online-endpoints.md).
...
* [How to deploy and where](how-to-deploy-managed-online-endpoints.md)

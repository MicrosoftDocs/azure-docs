...
There are many ways to create an Azure Machine Learning batch endpoint, including [the Azure CLI](batch-inference/how-to-use-batch-endpoint.md), and visually with [the studio](batch-inference/how-to-use-batch-endpoints-studio.md). The following example creates a batch endpoint and a batch deployment with the REST API.

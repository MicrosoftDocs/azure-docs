...
r2_score|R^2 is the coefficient of determination or the percent reduction in squared errors compared to a baseline model that outputs the mean. <br> <br> **Objective:** Closer to 1 the better <br> **Range:** [-1, 1] <br><br> Note: R^2 often has the range (-inf, 1], but Automated ML clips scores at -1.|[Calculation](https://scikit-learn.org/0.16/modules/generated/sklearn.metrics.r2_score.html)|

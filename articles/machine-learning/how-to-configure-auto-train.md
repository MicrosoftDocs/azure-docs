...
> [!NOTE]
> If you plan to export your Auto ML model as an [ONNX model](concept-onnx.md) only those algorithms indicated with an * are able to be converted to the ONNX format. 

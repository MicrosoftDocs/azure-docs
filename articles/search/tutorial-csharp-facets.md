...
This tutorial extends the paging project created in the [Add paging to search results](https://learn.microsoft.com/azure/search/tutorial-csharp-paging) tutorial.

A finished version of the code in this tutorial can be found in the following project:

* [4-add-facet-navigation (GitHub)](https://github.com/Azure-Samples/azure-search-sample-archive/tree/main/create-first-app/v11)

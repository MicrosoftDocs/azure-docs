...
2. We will not be changing any tags in this tutorial. Be aware that a facet search will throw an error if a field requested in the search is not tagged appropriately.

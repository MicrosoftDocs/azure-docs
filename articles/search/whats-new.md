...
| [Spell check query terms](speller-how-to-add.md) | Before a query string reaches the parser, you can check it for spelling errors. The `speller` option works with any query type (simple, full, or semantic). |  Public preview, REST only, api-version=2020-06-30-Preview|

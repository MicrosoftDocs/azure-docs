...
| [**Higher limits for vectors**](vector-search-index-size.md#vector-limits-for-services-created-after-april-3-2024) | Feature | Vector storage limits are also higher on new services created after April 3, 2024 in selected regions. |
| [**2024-03-01-preview Search REST API**](/rest/api/searchservice/search-service-api-versions#2024-03-01-preview) | API | New preview version of the Search REST APIs for vector compression and storage optimization all-up. This preview adds [new vector data types](/rest/api/searchservice/supported-data-types), vector compression, and more flexible vector field storage options.|

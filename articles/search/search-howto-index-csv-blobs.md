...
> [!IMPORTANT]
> This functionality is currently in public preview and should not be used in production environments. For more information, see [REST api-version=2017-11-11-Preview](search-api-2017-11-11.md). 
> 

...
> [!Note]
> `delimitedText` parsing mode is in public preview and should not be used in production workloads. REST `api-version=2019-05-06-Preview` `api-version=2017-11-11-Preview` provide this feature. There is no portal or .NET SDK support.
>

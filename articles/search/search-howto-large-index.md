...
We recommend using a newer search service, created after April 1, 2024, for [maximum storage per partition](search-limits-quotas-capacity.md#service-limits).

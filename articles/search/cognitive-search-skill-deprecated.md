...
If you're using [Entity Recognition skill](#microsoftskillstextentityrecognitionskill), this article will help you upgrade your skillset to use [Microsoft.Skills.Text.V3.EntityRecognitionSkill](cognitive-search-skill-entity-recognition-v3.md) which is generally available and introduces new features. 

If you're using [Sentiment Analysis skill](#microsoftskillstextsentimentskill), this article will help you upgrade your skillset to use [Microsoft.Skills.Text.V3.SentimentSkill](cognitive-search-skill-sentiment-v3.md) which is generally available and introduces new features. 

If you're using [Named Entity Recognition skill](#microsoftskillstextnamedentityrecognitionskill), this article will help you upgrade your skillset to use [Microsoft.Skills.Text.V3.EntityRecognitionSkill](cognitive-search-skill-entity-recognition-v3.md) which is generally available and introduces new features.
...
* Last available api version: The last version of the Azure Cognitive Search public API through which skillsets containing the corresponding deprecated skill can be created/updated. Indexers with attached skillsets with these skills will continue to work even in future API versions until the End of support date, at which point they will return errors.

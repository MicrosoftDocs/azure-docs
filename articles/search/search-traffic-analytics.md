...
To create an object that sends events to Application Insights by using JavaScript, see [Microsoft Azure Monitor Application Insights JavaScript SDK](../azure-monitor/app/javascript-sdk.md).

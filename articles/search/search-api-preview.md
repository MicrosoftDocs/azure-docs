...
|---------|------------------|-------------|---------------|
|  [**Integrated vectorization**](vector-search-integrated-vectorization.md) | Index, skillset, queries | Skills-driven data chunking and vectorization during indexing, and text-to-vector converstion during query execution. | [Create or Update Index (preview)](/rest/api/searchservice/2023-10-01-preview/indexes/create-or-update) to create a vectorizer and [Search POST](/rest/api/searchservice/2023-10-01-preview/documents/search-post) to specify "kind" and "text" parameters on a vector or hybrid query, 2023-10-01-Preview or later. |

...
|---------|------------------|-------------|---------------|
| [**Vector search public preview**](vector-search-overview.md) | Vector search | Adds vector fields to a search index for similarity search scenarios over vector representations of text, image, and multilingual content. Use the [Search REST API 2023-07-01-Preview](/rest/api/searchservice/index-preview) to explore vector search.|

...
This code snippet illustrates the addition of a synonymMap to an index that already exists. This code is from the [Synonym (preview) C# example for Azure Search](https://docs.microsoft.com/azure/search/search-synonyms-example-sdk).

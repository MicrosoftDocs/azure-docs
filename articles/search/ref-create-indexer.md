...
| `"documentRoot"` | [JSON](search-howto-indexing-azure-blob-storage.md#nested-json-arrays) | String<br/>User-defined | Given a nested JSON array, you can specify a path to the array using this property. JSON arrays are a preview feature. |

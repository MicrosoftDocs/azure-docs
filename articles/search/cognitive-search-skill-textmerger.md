...
description: Merge text from a collection of fields into one consolidated field. Use this cognitive skill in an enrichment pipeline in Azure Cognitive Search.

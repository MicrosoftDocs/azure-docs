...
For guidance on creating a [custom skill](cognitive-search-custom-skill-web-api.md), see [How to define a custom interface](cognitive-search-custom-skill-interface.md) and [Example: Creating an Azure Cognitive Search custom skill](cognitive-search-create-custom-skill-example.md).

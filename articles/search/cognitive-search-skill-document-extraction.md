---
title: Document Extraction cognitive search skill - Azure Search
...
1. Setting the `allowSkillsetToReadFileData` parameter on your indexer definition to "true".  This will create a path `/document/file_data` that is a object representing the original file data downloaded from your blob data source.  This will not work with data sources that are not blob storage.

...
There are multiple API versions for Azure Search. See [Search Service Versioning](http://msdn.microsoft.com/library/azure/dn864560.aspx) for a list of the available versions.

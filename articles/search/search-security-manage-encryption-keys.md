...
> [!TIP]
> You can use [Postman](search-get-started-rest.md) or [Azure PowerShell](./search-get-started-powershell.md) to call REST APIs that create indexes and synonym maps that include an encryption key parameter. There is no portal support for adding a key to indexes or synonym maps at this time.

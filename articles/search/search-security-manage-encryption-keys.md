...
[Postman](search-fiddler.md) or [Azure PowerShell](search-create-index-rest-api.md) can be used to call the preview REST API. There is no portal or .NET SDK support for customer-managed encryption at this time.

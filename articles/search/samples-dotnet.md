...
| Samples | Repository | Description |
|---------|------------|-------------|
| DotNetVectorDemo | [azure-search-vector](https://github.com/Azure/cognitive-search-vector-pr) | Calls Azure OpenAI to generate embeddings and Azure AI Search to create, load, and query an index. |

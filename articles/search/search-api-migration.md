...
If you're using a previous version of the [Azure Cognitive Search Service REST API](https://docs.microsoft.com/rest/api/searchservice/), this article will help you upgrade your application to use the newest generally available API version, 2019-05-06.
...
Version 2019-05-06 is the newest generally available release of the Azure Cognitive Search Service REST API. Features that have transitioned to generally available status in this API version include:

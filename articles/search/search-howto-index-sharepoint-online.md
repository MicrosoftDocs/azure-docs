...
+ If there is a requirement to implement a SharePoint content indexing solution with Cognitive Search in a production environment, consider create a custom connector using [Microsoft Graph Data Connect](../../../../../data-connect-concept-overview.md) with [Blob indexer](search-howto-indexing-azure-blob-storage.md) and [Microsoft Graph API](../../../../../use-the-api.md) for incremental indexing.

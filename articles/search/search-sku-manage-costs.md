...
1. If possible, create a search service [in a region that has more storage per partition](search-create-service-portal.md#choose-a-region). If you're using multiple Azure resources in your solution, create them in the same region, or in as few regions as possible, to minimize or eliminate bandwidth charges.

...
| [Shared private link](search-indexer-howto-access-private.md) <sup>1</sup> | Billed as long as the endpoint exists, and [billed for bandwidth](https://azure.microsoft.com/pricing/details/private-link/). |

...
You can find out the IP address by pinging the FQDN (for example, `<your-search-service-name>.search.windows.net`) of your search service. Although it is possible that the search service IP address might change in the future, it is currently unlikely that it will change in the near future.

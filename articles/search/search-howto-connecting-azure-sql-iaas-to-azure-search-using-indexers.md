...
* For a **Resource Manager** VM, see [Connect to a SQL Server Virtual Machine on Azure using Resource Manager](../sql-database/virtual-machines/windows/connect.md). 

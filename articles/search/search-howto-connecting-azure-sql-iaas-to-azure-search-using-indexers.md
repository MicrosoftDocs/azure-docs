...
> [AZURE.NOTE] For background, see [What is a Network Security Group?](../virtual-network/virtual-networks-nsg.md). You can also refer to [How to create NSGs for ARM deployments](../virtual-network/virtual-networks-create-nsg-arm-pportal.md) and [How to create NSGs for Classic deployments](../virtual-network/virtual-networks-create-nsg-classic-ps.md) for instructions. The following recommendations assume you already understand your NSG configuration and how to ACL an Azure Search endpoint based on its IP address.

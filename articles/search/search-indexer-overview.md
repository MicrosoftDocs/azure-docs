...
description: Crawl Azure SQL database, Cosmos DB, or Azure storage to extract searchable data and populate an Azure Search index.
services: search
documentationcenter: ''
author: HeidiSteen
manager: jhubbard
...
> * [Cosmos DB](search-howto-index-documentdb.md)
...
For generally available indexers like Azure SQL or Cosmos DB, you can create and manage indexers using these approaches:

...
+ A query string must not be null and should be formulated as question. In this preview, the "queryType" and "queryLanguage" must be set to a [supported language](#supported-languages).

...
# Create a search indexer in Azure Cognitive Search
...
For Cognitive Search, the Azure SDKs implement generally available features. As such, you can use any of the SDKs to create indexer-related objects. All of them provide a **SearchIndexerClient** that has methods to creating indexers and related objects, including skillsets.

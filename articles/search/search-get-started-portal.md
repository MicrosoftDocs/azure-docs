...
* [Creating an index using .NET SDK](https://docs.microsoft.com/en-us/azure/search/search-create-index-dotnet)
* [Creating an index using REST APIs](https://docs.microsoft.com/en-us/azure/search/search-create-index-rest-api)

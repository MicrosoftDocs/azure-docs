...
+ [Management REST API](/rest/api/searchmanagement/2021-04-01-preview/services)
...
1. Use the [Management REST API](/rest/api/searchmanagement/2021-04-01-preview/services), [Azure PowerShell](search-manage-powershell.md), or [Azure CLI](/cli/azure/search) to get service status.
1. Call [Get Service](/rest/api/searchmanagement/2021-04-01-preview/services/get)
1. Check the response for ["provisioningState": "provisioning"](/rest/api/searchmanagement/2021-04-01-preview/services/get#provisioningstate)

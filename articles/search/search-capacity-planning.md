...
> [!NOTE]
> There is no way to directly manipulate or manage which indexes run on a replica. One copy of each index per replica is part of the service architecture.
> 
> 
...
> [!NOTE]
> Once a service is provisioned, it cannot be upgraded in place to a higher SKU. You will need to create a search service at the new tier and reload your indexes. See [Create an Azure Search service in the portal](search-create-service-portal.md) for help with service provisioning.
> 
> 

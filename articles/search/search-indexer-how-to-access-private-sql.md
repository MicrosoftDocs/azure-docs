...
This article explains how to configure an indexer in Azure Cognitive Search for a private connection to a SQL managed mnstance that runs within a virtual network.

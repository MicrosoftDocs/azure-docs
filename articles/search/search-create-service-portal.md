...
## I. Find Azure Search in the Azure Portal
1. Go the [Azure Portal](https://portal.azure.com/) and log in.
...
## II. Pick a service name and URL endpoint for your service
...
## III. Select a subscription where you will keep your service
...
## VII. Select the "Create" button to provision your service

![](./media/search-create-service-portal/create-service.png)

## VIII. Scale your service
...
## Next
After provisioning an Azure Search service, you will be ready to define an Azure Search index so you can upload and search your data.

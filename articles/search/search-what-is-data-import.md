...
This guide will only cover the push model of data upload, which is supported only in the [REST API](search-import-data-rest-api.md) and [.NET SDK](search-import-data-dotnet.md).

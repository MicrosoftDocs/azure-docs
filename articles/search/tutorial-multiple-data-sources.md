...
[Create an Azure Cosmos DB account](https://docs.microsoft.com/azure/storage/common/storage-quickstart-create-account) for storing the sample data.
...
1. Locate the sample repository on GitHub: [Azure Search Multiple Data Sources](https://github.com/Azure-Samples/azure-search-dotnet-samples).
...
The **Program.cs** file, the index is defined with a name and a field collection generated by the FieldBuilder.BuildForType() method, and then created as follows:

...
Already familiar with the workflow and composition? Skip ahead to [How to configure a Blob indexer](search-howto-indexing-azure-blob-storage.md) to create an indexer.

...
This tutorial uses a REST client and the [Search REST APIs](/rest/api/searchservice/) to perform the following tasks:
...
[Clinical-trials-pdf-19](https://github.com/Azure-Samples/azure-search-sample-data/tree/main/clinical-trials/clinical-trials-pdf-19) contains PDF files used in this tutorial. Download a zip file of the sample data repository and extract the contents. Data originates from [clinicaltrials.gov](https://clinicaltrials.gov/ct2/results).

### Upload sample data to Azure Storage

1. In Azure Storage, create a new container and name it *clinical-trials*.

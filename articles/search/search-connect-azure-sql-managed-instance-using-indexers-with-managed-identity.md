...
3. From the left pane, locate the SQL database you will be using as data source for indexing and right-click it. Select **New Query**. 
   ...
   :::image type="content" source="/media/search-connect-azure-sql-managed-instance-using-indexers-with-managed-identity/new-query.png" alt-text="Showing screenshot of the SQL new query.":::
...
4. In the T-SQL window, copy the following commands and include the brackets around your search service name. Click on **Execute**.
   ...
   :::image type="content" source="/media/search-connect-azure-sql-managed-instance-using-indexers-with-managed-identity/execute-query.png" alt-text="Showing screenshot of T-SQL commands and Execute query.":::

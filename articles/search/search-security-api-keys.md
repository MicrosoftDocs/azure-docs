...
You can obtain access keys in the portal or through the [Management REST API](/rest/api/searchmanagement/). For more information, see [Manage admin and query api-keys](search-security-api-keys.md).

...
To get started with AAD, you'll first need to [create a search service](search-create-service-portal.md) and configure it to use role-based access control (RBAC).

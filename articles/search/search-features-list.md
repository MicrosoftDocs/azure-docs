...
| Geospatial search | Azure Cognitive Search provides [geospatial functions](search-query-odata-geo-spatial-functions.md) that filter over and return geographic locations. It enables users to explore data based on the distance of a search result to a physical location. |

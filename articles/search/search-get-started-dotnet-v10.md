...
For new solutions, we recommend the new Azure.Search.Documents library. For an introduction, see [Quickstart: Create a search index using Azure.Search.Documents library](search-get-started-dotnet.md).

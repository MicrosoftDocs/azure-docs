...
+ Force a re-evaluation of skillset. You might make internal changes to a custom skillset that the indexer cannot detect. In this case, you can use the [Reset Skills](https://docs.microsoft.com/rest/api/searchservice/reset-skills) API to force reprocessing of a particular skill, including any downstream skills that have a dependency on that skill's output.

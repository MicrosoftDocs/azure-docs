...
Although Azure Cosmos DB supports a variety of data models and APIs, Azure Search indexer production support extends to the SQL API only. Support for Azure Cosmos DB API for MongoDB is currently in public preview.  

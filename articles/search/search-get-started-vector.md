...
In Cognitive Search, semantic search and vector search are separate features, but you can use them together as described in this example. Semantic search adds large language models that rerank search results based on query intent. This feature is optional and billable for the transactions against the language models.

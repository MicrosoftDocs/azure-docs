...
> [!NOTE]
> Looking for built-in data chunking and vectorization? Try [Get started with integrated vectorization (preview)](search-get-started-portal-import-vectors.md.md) and the **Import and vectorize data** wizard in Azure portal.
...
> [!NOTE]
> This quickstart is for the generally available version of [vector search](vector-search-overview.md). If you want to try integrated vectorization, currently in public preview, try [this quickstart](search-get-started-portal-import-vectors.md.md) instead.  

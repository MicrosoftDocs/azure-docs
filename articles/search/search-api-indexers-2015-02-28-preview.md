...
* **Azure Cosmos DB**. For a targeted walk-through, see [this article](search-howto-index-documentdb.md). 
...
> [!NOTE]
> The maximum number of data sources allowed varies by pricing tier. The free service allows up to 3 data sources. Standard service allows 50 data sources. See [Service Limits](search-limits-quotas-capacity.md) for details.
> 
> 

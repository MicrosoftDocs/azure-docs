...
description: Create a knowledge store using the REST API and Postman.
...
+ Recommended: [Postman](tk). The REST API can be used with any tool that can generate and accept HTTP requests and responses. This tutorial uses Postman and the [source code]{tk} is a Postman collection {>>check terminology<<}. 

...
> [!IMPORTANT] 
> Whenever possible, use a filter on PartitionKey for better performance. Any other query does a full table scan, resulting in poor performance for large tables. See [Performance Considerations](#Performance) section.

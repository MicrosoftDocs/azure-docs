...
This skill uses the machine learning models provided by [Computer Vision](../ai-services/computer-vision/overview.md) in Cognitive Services. **Image Analysis** works on images that meet the following requirements:

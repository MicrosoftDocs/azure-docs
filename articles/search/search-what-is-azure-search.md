...
+ AI-powered indexing extracts text from images or audio, or entities and key phrases from undifferentiated text.
+ Add geo-search for "find near me", language analyzers for non-English full text search, and scoring logic for search rank.
+ Create intuitive user experiences with facet navigation and filters, synonyms, auto-complete, and text analysis for "did you mean" auto-corrected search terms.

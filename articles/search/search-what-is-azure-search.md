...
|--|--|
|Bing | Bing offers search solutions for web content, crawling a web site and web content types such as HTML and XML for search terms. <br/><br/>Azure Search is for private data you own, stored in an index you create. Often, data originates from diverse content types, ranging from databases to doc files to geospatial coordinates, or even metadata associated with video or images. |

...
|-------------|-----------------|
| Microsoft Search | [Microsoft Search](../microsoftsearch/overview-microsoft-search) searches over content stored in SharePoint or that is accessible through SharePoint. As a software-as-a-service (SaaS) option, it can be enabled and configured for use by administrators, and it can accept external content through connectors, but is otherwise offered as a ready-to-use feature from within SharePoint and Microsoft 365. |

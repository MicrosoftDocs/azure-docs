...
![Enrichment with search index and knowledge store](./media/knowledge-store-concept-intro/annotationstore_sans_internalcache.png "Enrichment with search index and knowledge store")
...
The knowledge store can contain [cached enrichments for reuse in skillsets](cognitive-search-incremental-indexing-conceptual.md), or projections intended for consumption in knowledge mining scenarios.

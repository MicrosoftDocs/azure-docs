...
description: Describes concepts, scenarios, and availability of vector stores in Azure AI Search.
...
A *vector store* contains vectors and vector-related configurations used for indexing and queries. In Azure AI Search, it also contains nonvector fields for filters, and also to support hybrid queries for keyword search over strings.

...
5. Click the **Scale** tab.
	...
	For the paid tiers of App Service Web App, the [Scale](/en-us/documentation/articles/web-sites-scale/) tab enables you to control the size and number of machines that service your web application in order to handle variations in traffic.

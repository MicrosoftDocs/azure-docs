...
Origin support for direct private endpoint connectivity is currently limited to Azure resources listed below:
* Blob Storage
* Web App
...
* Learn how to [connect Azure Front Door Premium to a Web App with Private Link](standard-premium/how-to-enable-private-link-web-app.md).

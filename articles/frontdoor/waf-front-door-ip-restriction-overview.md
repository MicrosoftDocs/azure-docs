...
Azure web application firewall (WAF) with Front Door stops malicious attacks at Azure network edge, close to the attack sources, far away from your web applications or virtual networks.  

...
- **Managed TLS certificates:** Front Door can [issue and manage certificates](standard-premium/how-to-configure-https-custom-domain.md#afd-managed-certificates-for-non-azure-pre-validated-domain). This feature means you don't need to manage certificate renewals, and you reduce the likelihood of an outage that's caused by using an invalid or expired TLS certificate.

---
title: Azure Front Door Service - URL Redirect | Microsoft Docs
description: This article helps you understand how Azure Front Door Service supports URL redirection for their routes, if configured.
services: front-door
documentationcenter: ''
author: sharad4u
...
- **HTTP only**: This redirects the incoming request to HTTP. Use this value only if you want to keep your traffic HTTP i.e. non-encrypted.
- **Match request**: This option retains the protocol used by the incoming request. So, an HTTP requests remains HTTP and an HTTPS request remains HTTPS post redirection.

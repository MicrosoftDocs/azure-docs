...
Cache behavior and duration can be configured in both the Front Door manager routing rule and in Rules Engine. Rules Engine caching configuration will always override the Front Door designer routing rule configuration.

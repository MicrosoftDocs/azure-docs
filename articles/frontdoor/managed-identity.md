...
> [!NOTE]
> Managed identity support on Azure Front Door is limited to accessing Azure Key Vault. You can not use this feature for authenticating from Front Door to the origins like blob storage or web app.

...
1. On the *Application* tab, if you're using a system managed identity then the application has already been selected for you. If you're using a user assigned managed identity, enter **Microsoft.AzureFrontDoor-Cdn** into the search box and select the application listed.
...
1. Select **Next** to review the access policy settings and then select **Create** to complete the set up of the access policy.

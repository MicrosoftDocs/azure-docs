...
* Storage Static Website is enabled on your storage account. Learn how to [enable static website](https://docs.microsoft.com/azure/storage/blobs/storage-blob-static-website-how-to?tabs=azure-portal).

...
Grant Azure Front Door permission to access the  certificates under Secrets in your Azure Key Vault account.
...
4. Select **OK**. 
    ...
    Azure Front Door can now access this key vault and the certificates (secrets) that are stored in this key vault.

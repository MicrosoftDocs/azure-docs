...
| X-Azure-FDID | X-Azure-FDID: ea328812-1213-ea13-bada-e3821903216c <br/> Contains the frontDoorID. You may use it to restrict traffic on your backend to only allow requests from your Front Door instance. How to do that is described at [Frequently asked questions for Azure Front Door](front-door-faq.md#general).

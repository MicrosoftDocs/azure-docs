...
> [!NOTE]
> For customers with very low RPS (Requests per second), due to the nature of how distributed AFD POPs and machines are, we cannot guarantee that the weights configured by the customer will be strictly followed and load balancing may appear skewed.

...
| [Create Front Door with geo filtering ](https://github.com/Azure/azure-quickstart-templates/tree/master/101-front-door-geo-filtering)| Create a Front Door that allows/blocks traffic from certain countries. |
...
| [Onboard a custom domain with custom SSL certificate (for HTTPS) for your Front Door](https://github.com/Azure/azure-quickstart-templates/tree/master/201-front-door-custom-byoc) | Onboards a custom domain for a Front Door with custom SSL certificate also called as Bring Your Own Certificate scenario. |
